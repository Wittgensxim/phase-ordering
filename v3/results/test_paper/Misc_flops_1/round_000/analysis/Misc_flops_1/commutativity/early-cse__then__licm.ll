...
34:                                               ; preds = %50, %0
  %35 = phi double [ %49, %50 ], [ %.promoted5, %0 ]
  %36 = phi double [ %42, %50 ], [ %.promoted3, %0 ]
  %37 = phi double [ %41, %50 ], [ %.promoted1, %0 ]
  %38 = phi i32 [ %51, %50 ], [ %.promoted, %0 ]
  %39 = icmp sle i32 %38, %25
  br i1 %39, label %40, label %52

40:                                               ; preds = %34
  %41 = fadd double %37, %26
  %42 = fmul double %41, %27
  %43 = call double @llvm.fmuladd.f64(double %42, double %30, double %29)
  %44 = call double @llvm.fmuladd.f64(double %42, double %43, double %28)
  %45 = call double @llvm.fmuladd.f64(double %42, double %33, double %32)
  %46 = call double @llvm.fmuladd.f64(double %42, double %45, double %28)
  %47 = call double @llvm.fmuladd.f64(double %42, double %46, double %31)
...
52:                                               ; preds = %34
  %.lcssa6 = phi double [ %35, %34 ]
  %.lcssa4 = phi double [ %36, %34 ]
  ...
  %54 = load double, ptr @D2, align 8
  %55 = fadd double %53, %54
  %56 = load double, ptr @D3, align 8
  ...
  %83 = fsub double %82, 2.520000e+01
