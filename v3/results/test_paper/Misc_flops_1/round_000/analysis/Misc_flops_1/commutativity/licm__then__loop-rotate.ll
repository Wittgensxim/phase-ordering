...
41:                                               ; preds = %.lr.ph, %54
  %42 = phi i32 [ %.promoted, %.lr.ph ], [ %55, %54 ]
  %43 = phi double [ %.promoted1, %.lr.ph ], [ %45, %54 ]
  %44 = phi double [ %.promoted5, %.lr.ph ], [ %53, %54 ]
  %45 = fadd double %43, %31
  %46 = fmul double %45, %32
  %47 = call double @llvm.fmuladd.f64(double %46, double %35, double %34)
  %48 = call double @llvm.fmuladd.f64(double %46, double %47, double %33)
  %49 = call double @llvm.fmuladd.f64(double %46, double %39, double %38)
  %50 = call double @llvm.fmuladd.f64(double %46, double %49, double %37)
...
54:                                               ; preds = %41
  ...
  br i1 %56, label %41, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %54
  %split = phi double [ %53, %54 ]
  %split7 = phi double [ %46, %54 ]
  %split8 = phi double [ %45, %54 ]
  %split9 = phi i32 [ %55, %54 ]
  br label %57
