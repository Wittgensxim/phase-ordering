...
23:                                               ; preds = %20
  %24 = trunc nsw i64 %indvars.iv3 to i32
  br label %28
...
6:                                                ; preds = %8, %4
  ...
  %invariant.gep = getelementptr inbounds i8, ptr %5, i64 %.idx75
  br label %7
...
28:                                               ; preds = %32, %27
  ...
  %invariant.gep1 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 2048), i64 %30
  br label %31
...
38:                                               ; preds = %42, %37
  ...
  %invariant.gep5 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 6144), i64 %40
  br label %41
...
50:                                               ; preds = %54, %49
  ...
  %invariant.gep7 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 10240), i64 %52
  br label %53
...
65:                                               ; preds = %74, %64
  %66 = phi i1 [ true, %64 ], [ false, %74 ]
  %67 = phi i32 [ 0, %64 ], [ 1, %74 ]
  br label %68

68:                                               ; preds = %68, %65
  %69 = phi i1 [ true, %65 ], [ false, %68 ]
  %70 = phi i32 [ 0, %65 ], [ 8, %68 ]
  %71 = or disjoint i32 %70, %67
  %72 = zext nneg i32 %71 to i64
  %73 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 18432), i64 %72
  store i32 1, ptr %73, align 4
  br i1 %69, label %68, label %74, !llvm.loop !34

74:                                               ; preds = %68
  br i1 %66, label %65, label %75, !llvm.loop !35
...
76:                                               ; preds = %80, %75
  %77 = phi i1 [ true, %75 ], [ false, %80 ]
  %78 = phi i64 [ 0, %75 ], [ 1, %80 ]
  %invariant.gep9 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %78
  br label %79

79:                                               ; preds = %79, %76
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %79 ], [ 0, %76 ]
  ...
  br i1 %exitcond66.not, label %80, label %79, !llvm.loop !36

80:                                               ; preds = %79
  br i1 %77, label %76, label %81, !llvm.loop !37
...
82:                                               ; preds = %86, %81
  %83 = phi i1 [ true, %81 ], [ false, %86 ]
  %84 = phi i64 [ 0, %81 ], [ 8, %86 ]
  %invariant.gep11 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %84
  br label %85

85:                                               ; preds = %85, %82
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %85 ], [ 0, %82 ]
  ...
  br i1 %exitcond70.not, label %86, label %85, !llvm.loop !38

86:                                               ; preds = %85
  br i1 %83, label %82, label %87, !llvm.loop !39
...
88:                                               ; preds = %96, %87
  ...
  %invariant.gep17 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %90
  br label %91

91:                                               ; preds = %95, %88
  %92 = phi i1 [ true, %88 ], [ false, %95 ]
  %93 = phi i64 [ 0, %88 ], [ 8, %95 ]
  %gep18 = getelementptr inbounds [4 x i8], ptr %invariant.gep17, i64 %93
  br label %94

94:                                               ; preds = %94, %91
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %94 ], [ 0, %91 ]
  ...
  br i1 %exitcond74.not, label %95, label %94, !llvm.loop !40

95:                                               ; preds = %94
  br i1 %92, label %91, label %96, !llvm.loop !41

96:                                               ; preds = %95
  br i1 %89, label %88, label %97, !llvm.loop !42
...
110:                                              ; preds = %109, %105
  ...
  %112 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %111) #3
  %113 = load i32, ptr @kount, align 4
  %114 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %113) #3
  ret void
}
