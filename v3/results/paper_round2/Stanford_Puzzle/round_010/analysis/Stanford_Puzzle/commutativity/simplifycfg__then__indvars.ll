...
12:                                               ; preds = %10, %7
  ...
  br i1 %exitcond, label %7, label %._crit_edge.loopexit, !llvm.loop !7

._crit_edge.loopexit:                             ; preds = %10, %12
  %.ph = phi i32 [ 1, %12 ], [ 0, %10 ]
  br label %._crit_edge
...
25:                                               ; preds = %29, %24
  ...
  %invariant.gep1 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 2048), i64 %27
  br label %28
...
35:                                               ; preds = %39, %34
  ...
  %invariant.gep5 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 6144), i64 %37
  br label %38
...
47:                                               ; preds = %51, %46
  ...
  %invariant.gep7 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 10240), i64 %49
  br label %50
...
73:                                               ; preds = %77, %72
  ...
  %invariant.gep9 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %75
  br label %76
...
79:                                               ; preds = %83, %78
  ...
  %invariant.gep11 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %81
  br label %82
...
85:                                               ; preds = %93, %84
  ...
  %invariant.gep17 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %87
  br label %88

88:                                               ; preds = %92, %85
  %89 = phi i1 [ true, %85 ], [ false, %92 ]
  %90 = phi i64 [ 0, %85 ], [ 8, %92 ]
  %gep18 = getelementptr inbounds [4 x i8], ptr %invariant.gep17, i64 %90
  br label %91
