...
5:                                                ; preds = %7, %3
  ...
  %invariant.gep = getelementptr inbounds nuw i8, ptr %4, i64 %.idx75
  br label %6
...
62:                                               ; preds = %70, %61
  %63 = phi i1 [ true, %61 ], [ false, %70 ]
  %64 = phi i64 [ 0, %61 ], [ 1, %70 ]
  br label %65

65:                                               ; preds = %65, %62
  %66 = phi i1 [ true, %62 ], [ false, %65 ]
  %67 = phi i64 [ 0, %62 ], [ 8, %65 ]
  %68 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 18432), i64 %64
  %69 = getelementptr inbounds nuw [4 x i8], ptr %68, i64 %67
  store i32 1, ptr %69, align 4
  br i1 %66, label %65, label %70, !llvm.loop !34

70:                                               ; preds = %65
  br i1 %63, label %62, label %71, !llvm.loop !35
...
72:                                               ; preds = %76, %71
  %73 = phi i1 [ true, %71 ], [ false, %76 ]
  %74 = phi i64 [ 0, %71 ], [ 1, %76 ]
  %invariant.gep9 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %74
  br label %75

75:                                               ; preds = %75, %72
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %75 ], [ 0, %72 ]
  ...
  br i1 %exitcond66.not, label %76, label %75, !llvm.loop !36

76:                                               ; preds = %75
  br i1 %73, label %72, label %77, !llvm.loop !37
...
78:                                               ; preds = %82, %77
  %79 = phi i1 [ true, %77 ], [ false, %82 ]
  %80 = phi i64 [ 0, %77 ], [ 8, %82 ]
  %invariant.gep11 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %80
  br label %81

81:                                               ; preds = %81, %78
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %81 ], [ 0, %78 ]
  ...
  br i1 %exitcond70.not, label %82, label %81, !llvm.loop !38

82:                                               ; preds = %81
  br i1 %79, label %78, label %83, !llvm.loop !39
...
84:                                               ; preds = %92, %83
  %85 = phi i1 [ true, %83 ], [ false, %92 ]
  %86 = phi i64 [ 0, %83 ], [ 1, %92 ]
  %invariant.gep17 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %86
  br label %87

87:                                               ; preds = %91, %84
  %88 = phi i1 [ true, %84 ], [ false, %91 ]
  %89 = phi i64 [ 0, %84 ], [ 8, %91 ]
  %gep18 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep17, i64 %89
  br label %90

90:                                               ; preds = %90, %87
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %90 ], [ 0, %87 ]
  ...
  br i1 %exitcond74.not, label %91, label %90, !llvm.loop !40

91:                                               ; preds = %90
  br i1 %88, label %87, label %92, !llvm.loop !41

92:                                               ; preds = %91
  br i1 %85, label %84, label %93, !llvm.loop !42
...
105:                                              ; preds = %102, %104, %101
  ...
  %107 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %106) #3
  %108 = load i32, ptr @kount, align 4
  %109 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %108) #3
  ret void
}
