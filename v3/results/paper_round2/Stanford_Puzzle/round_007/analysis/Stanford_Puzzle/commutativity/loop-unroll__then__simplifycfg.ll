...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  ...
  br i1 %.not3.epil, label %._crit_edge, label %19
...
._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %19, %.epil.preheader, %2
...
28:                                               ; preds = %33, %.lr.ph6
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %33 ], [ %27, %.lr.ph6 ]
  %29 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv3
  %30 = load i32, ptr %29, align 4
  %.not2 = icmp eq i32 %30, 0
  br i1 %.not2, label %31, label %33

31:                                               ; preds = %28
  %indvars.iv3.lcssa = phi i64 [ %indvars.iv3, %28 ]
  %32 = trunc nsw i64 %indvars.iv3.lcssa to i32
  br label %._crit_edge7

33:                                               ; preds = %28
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, 1
  %34 = and i64 %indvars.iv.next4, 4294967295
  %exitcond6.not = icmp eq i64 %34, 512
  br i1 %exitcond6.not, label %._crit_edge7, label %28, !llvm.loop !10

._crit_edge7:                                     ; preds = %._crit_edge, %33, %31
  %35 = phi i32 [ %32, %31 ], [ 0, %33 ], [ 0, %._crit_edge ]
  ret i32 %35
}
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  ...
  br i1 %.not2.epil, label %._crit_edge, label %19
...
7:                                                ; preds = %18, %6
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %18 ], [ 0, %6 ]
  %8 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv18
  br label %9

9:                                                ; preds = %9, %7
  %indvars.iv14 = phi i64 [ 0, %7 ], [ %indvars.iv.next15.7, %9 ]
  %10 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv14
  store i32 0, ptr %10, align 4
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %11 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv.next15
  store i32 0, ptr %11, align 4
  %indvars.iv.next15.1 = add nuw nsw i64 %indvars.iv14, 2
  %12 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv.next15.1
  store i32 0, ptr %12, align 4
  %indvars.iv.next15.2 = add nuw nsw i64 %indvars.iv14, 3
  %13 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv.next15.2
  store i32 0, ptr %13, align 4
  %indvars.iv.next15.3 = add nuw nsw i64 %indvars.iv14, 4
  %14 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv.next15.3
  store i32 0, ptr %14, align 4
  %indvars.iv.next15.4 = add nuw nsw i64 %indvars.iv14, 5
  %15 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv.next15.4
  store i32 0, ptr %15, align 4
  %indvars.iv.next15.5 = add nuw nsw i64 %indvars.iv14, 6
  %16 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv.next15.5
  store i32 0, ptr %16, align 4
  %indvars.iv.next15.6 = add nuw nsw i64 %indvars.iv14, 7
  %17 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %indvars.iv.next15.6
  store i32 0, ptr %17, align 4
  %indvars.iv.next15.7 = add nuw nsw i64 %indvars.iv14, 8
  %exitcond17.not.7 = icmp eq i64 %indvars.iv.next15.7, 512
  br i1 %exitcond17.not.7, label %18, label %9, !llvm.loop !14

18:                                               ; preds = %9
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond21.not = icmp eq i64 %indvars.iv.next19, 13
  br i1 %exitcond21.not, label %19, label %7, !llvm.loop !15
...
19:                                               ; preds = %18
  ...
  %20 = call i32 @Fit(i32 noundef 0, i32 noundef 73)
  %.not = icmp eq i32 %20, 0
  br i1 %.not, label %23, label %21

21:                                               ; preds = %19
  %22 = call i32 @Place(i32 noundef 0, i32 noundef 73)
...
28:                                               ; preds = %24
  %29 = load i32, ptr @kount, align 4
  %.not3 = icmp eq i32 %29, 2005
...
31:                                               ; preds = %28, %30, %27
  ...
  %33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %32) #4
  %34 = load i32, ptr @kount, align 4
  %35 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %34) #4
  ret void
}
