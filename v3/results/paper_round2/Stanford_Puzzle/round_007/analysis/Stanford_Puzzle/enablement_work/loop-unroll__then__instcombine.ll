; ModuleID = 'results\paper_round2\Stanford_Puzzle\round_006\output.ll'
...
define dso_local range(i32 -2147483648, 512) i32 @Place(i32 noundef %0, i32 noundef %1) #0 {
  ...
  br i1 %.not4, label %20, label %.lr.ph
...
7:                                                ; preds = %15, %.lr.ph.new
  %indvars.iv = phi i64 [ 0, %.lr.ph.new ], [ %indvars.iv.next.1, %15 ]
  %niter = phi i64 [ 0, %.lr.ph.new ], [ %niter.next.1, %15 ]
...
11:                                               ; preds = %10, %7
  ...
  %12 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv.next
  %13 = load i32, ptr %12, align 4
  %.not3.1 = icmp eq i32 %13, 0
  br i1 %.not3.1, label %15, label %14
...
16:                                               ; preds = %.epil.preheader
  %17 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv.epil.init
  %18 = load i32, ptr %17, align 4
  %.not3.epil = icmp eq i32 %18, 0
  br i1 %.not3.epil, label %._crit_edge.epilog-lcssa, label %19
...
._crit_edge.epilog-lcssa:                         ; preds = %19, %16
  br label %._crit_edge
...
20:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %27, label %.lr.ph6, label %36
...
32:                                               ; preds = %29
  %33 = trunc nsw i64 %indvars.iv3 to i32
  br label %37
...
34:                                               ; preds = %29
  ...
  br i1 %exitcond6.not, label %._crit_edge7, label %29, !llvm.loop !10

._crit_edge7:                                     ; preds = %34
  br label %36

36:                                               ; preds = %._crit_edge7, %20
  br label %37
...
define dso_local void @Remove(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %.pre = load i32, ptr %.phi.trans.insert1, align 4
  %.not1 = icmp slt i32 %.pre, 0
  br i1 %.not1, label %20, label %.lr.ph
...
11:                                               ; preds = %10, %7
  ...
  %12 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv.next
  %13 = load i32, ptr %12, align 4
  %.not2.1 = icmp eq i32 %13, 0
  br i1 %.not2.1, label %15, label %14
...
16:                                               ; preds = %.epil.preheader
  %17 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv.epil.init
  %18 = load i32, ptr %17, align 4
  %.not2.epil = icmp eq i32 %18, 0
  br i1 %.not2.epil, label %._crit_edge.epilog-lcssa, label %19
...
41:                                               ; preds = %59, %40
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %59 ], [ 0, %40 ]
  %42 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv18
  br label %43

43:                                               ; preds = %43, %41
  %indvars.iv14 = phi i64 [ 0, %41 ], [ %indvars.iv.next15.7, %43 ]
  %44 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  store i32 0, ptr %44, align 4
  %45 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  %46 = getelementptr inbounds nuw i8, ptr %45, i64 4
  store i32 0, ptr %46, align 4
  %47 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  %48 = getelementptr inbounds nuw i8, ptr %47, i64 8
  store i32 0, ptr %48, align 4
  %49 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  %50 = getelementptr inbounds nuw i8, ptr %49, i64 12
  store i32 0, ptr %50, align 4
  %51 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  %52 = getelementptr inbounds nuw i8, ptr %51, i64 16
  store i32 0, ptr %52, align 4
  %53 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  %54 = getelementptr inbounds nuw i8, ptr %53, i64 20
  store i32 0, ptr %54, align 4
  %55 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  %56 = getelementptr inbounds nuw i8, ptr %55, i64 24
  store i32 0, ptr %56, align 4
  %57 = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %indvars.iv14
  ...
  br i1 %exitcond17.not.7, label %59, label %43, !llvm.loop !14

59:                                               ; preds = %43
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond21.not = icmp eq i64 %indvars.iv.next19, 13
  br i1 %exitcond21.not, label %60, label %41, !llvm.loop !15
...
103:                                              ; preds = %102
  ...
  %104 = call i32 @Fit(i32 noundef 0, i32 noundef 73)
  %.not = icmp eq i32 %104, 0
  br i1 %.not, label %107, label %105

105:                                              ; preds = %103
  %106 = call i32 @Place(i32 noundef 0, i32 noundef 73)
  store i32 %106, ptr @n, align 4
  br label %108
...
108:                                              ; preds = %107, %105
  %109 = phi i32 [ %.pre, %107 ], [ %106, %105 ]
  %110 = call i32 @Trial(i32 noundef %109)
  %.not1 = icmp eq i32 %110, 0
  br i1 %.not1, label %111, label %112
...
112:                                              ; preds = %108
  ...
  %.not3 = icmp eq i32 %113, 2005
  br i1 %.not3, label %115, label %114
...
116:                                              ; preds = %115, %111
  ...
  %118 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %117) #4
  %119 = load i32, ptr @kount, align 4
  %120 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %119) #4
  ret void
}
