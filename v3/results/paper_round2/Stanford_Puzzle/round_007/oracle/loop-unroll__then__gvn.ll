...
._crit_edge.epilog-lcssa:                         ; preds = %19, %.epil.preheader
  br label %._crit_edge
...
32:                                               ; preds = %31, %27
  ...
  %34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %33) #4
  %35 = load i32, ptr @kount, align 4
  %36 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %35) #4
  ret void
}
