...
69:                                               ; preds = %68
  ...
  br i1 %71, label %57, label %72, !llvm.loop !22
...
77:                                               ; preds = %77, %74
  ...
  br i1 %84, label %77, label %85, !llvm.loop !23

85:                                               ; preds = %77
  %86 = add nuw nsw i32 %75, 1
  %87 = icmp samesign ult i32 %86, 4
  br i1 %87, label %74, label %88, !llvm.loop !24
...
102:                                              ; preds = %99
  ...
  br i1 %104, label %90, label %105, !llvm.loop !26
...
109:                                              ; preds = %109, %108
  ...
  br i1 %116, label %109, label %117, !llvm.loop !27
...
118:                                              ; preds = %117
  ...
  br i1 %120, label %106, label %121, !llvm.loop !28
...
126:                                              ; preds = %126, %123
  ...
  br i1 %133, label %126, label %134, !llvm.loop !29

134:                                              ; preds = %126
  %135 = add nuw nsw i32 %124, 1
  %136 = icmp samesign ult i32 %135, 2
  br i1 %136, label %123, label %137, !llvm.loop !30
...
146:                                              ; preds = %145
  ...
  br i1 %148, label %139, label %149, !llvm.loop !31
...
157:                                              ; preds = %156
  ...
  br i1 %159, label %151, label %160, !llvm.loop !32
...
164:                                              ; preds = %164, %163
  ...
  br i1 %170, label %164, label %171, !llvm.loop !33
...
174:                                              ; preds = %186, %173
  %175 = phi i32 [ 0, %173 ], [ 1, %186 ]
  br label %176

176:                                              ; preds = %183, %174
  %177 = phi i32 [ 0, %174 ], [ 1, %183 ]
...
183:                                              ; preds = %182
  ...
  br i1 %185, label %176, label %186, !llvm.loop !34

186:                                              ; preds = %183
  %187 = add nuw nsw i32 %175, 1
  %188 = icmp samesign ult i32 %187, 2
  br i1 %188, label %174, label %189, !llvm.loop !35
...
193:                                              ; preds = %193, %192
  ...
  br i1 %200, label %193, label %201, !llvm.loop !36
...
202:                                              ; preds = %201
  ...
  br i1 %204, label %190, label %205, !llvm.loop !37
...
210:                                              ; preds = %210, %207
  ...
  br i1 %217, label %210, label %218, !llvm.loop !38

218:                                              ; preds = %210
  %219 = add nuw nsw i32 %208, 1
  %220 = icmp samesign ult i32 %219, 2
  br i1 %220, label %207, label %221, !llvm.loop !39
...
223:                                              ; preds = %238, %222
  %224 = phi i32 [ 0, %222 ], [ 1, %238 ]
  br label %225

225:                                              ; preds = %235, %223
  %226 = phi i32 [ 0, %223 ], [ 1, %235 ]
...
228:                                              ; preds = %228, %225
  ...
  br i1 %234, label %228, label %235, !llvm.loop !40
...
238:                                              ; preds = %235
  ...
  br i1 %240, label %223, label %241, !llvm.loop !42
