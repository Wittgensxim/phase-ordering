...
21:                                               ; preds = %20, %4
  ...
  br i1 %exitcond, label %4, label %22, !llvm.loop !12
...
36:                                               ; preds = %32
  br i1 false, label %._crit_edge118, label %37, !llvm.loop !23

._crit_edge118:                                   ; preds = %36
...
47:                                               ; preds = %46
  br i1 false, label %._crit_edge119, label %48, !llvm.loop !27

._crit_edge119:                                   ; preds = %47
...
51:                                               ; preds = %._crit_edge120, %50
  ...
  br i1 false, label %._crit_edge120, label %55, !llvm.loop !28

._crit_edge120:                                   ; preds = %51
...
64:                                               ; preds = %60
  br i1 false, label %._crit_edge121, label %65, !llvm.loop !32

._crit_edge121:                                   ; preds = %64
...
75:                                               ; preds = %74
  br i1 false, label %._crit_edge122, label %76, !llvm.loop !36

._crit_edge122:                                   ; preds = %75
...
78:                                               ; preds = %._crit_edge124, %77
  br label %79

79:                                               ; preds = %._crit_edge123, %78
  %80 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 12288), i64 %indvars.iv70
  store i32 1, ptr %80, align 4
  br i1 false, label %._crit_edge123, label %81, !llvm.loop !37

._crit_edge123:                                   ; preds = %79
  br label %79, !llvm.loop !37

81:                                               ; preds = %79
  br i1 false, label %._crit_edge124, label %82, !llvm.loop !38

._crit_edge124:                                   ; preds = %81
...
86:                                               ; preds = %._crit_edge125, %85
  ...
  br i1 false, label %._crit_edge125, label %89, !llvm.loop !40
...
90:                                               ; preds = %89
  br i1 false, label %._crit_edge126, label %91, !llvm.loop !42

._crit_edge126:                                   ; preds = %90
...
92:                                               ; preds = %._crit_edge128, %91
  br label %93

93:                                               ; preds = %._crit_edge127, %92
  br label %94
...
97:                                               ; preds = %94
  br i1 false, label %._crit_edge127, label %98, !llvm.loop !44

._crit_edge127:                                   ; preds = %97
  br label %93, !llvm.loop !44

98:                                               ; preds = %97
  br i1 false, label %._crit_edge128, label %99, !llvm.loop !45
...
102:                                              ; preds = %._crit_edge129, %101
  ...
  br i1 false, label %._crit_edge129, label %106, !llvm.loop !46
...
115:                                              ; preds = %111
  br i1 false, label %._crit_edge130, label %116, !llvm.loop !50
...
126:                                              ; preds = %125
  br i1 false, label %._crit_edge131, label %127, !llvm.loop !54

._crit_edge131:                                   ; preds = %126
