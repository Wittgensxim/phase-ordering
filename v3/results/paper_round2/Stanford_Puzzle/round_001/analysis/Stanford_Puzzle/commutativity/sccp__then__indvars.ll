...
14:                                               ; preds = %5
  ...
  %smax7 = call i32 @llvm.smax.i32(i32 %1, i32 512)
  %wide.trip.count8 = sext i32 %smax7 to i64
  br label %21

21:                                               ; preds = %27, %14
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %27 ], [ %3, %14 ]
  %exitcond9 = icmp ne i64 %indvars.iv4, %wide.trip.count8
  br i1 %exitcond9, label %22, label %28

22:                                               ; preds = %21
  %23 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv4
  %24 = load i32, ptr %23, align 4
  %.not2 = icmp eq i32 %24, 0
  br i1 %.not2, label %25, label %27

25:                                               ; preds = %22
  %.lcssa2.wide = phi i64 [ %indvars.iv4, %22 ]
  %26 = trunc nsw i64 %.lcssa2.wide to i32
  br label %29
...
5:                                                ; preds = %17, %4
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %17 ], [ 1, %4 ]
  %exitcond42 = icmp ne i64 %indvars.iv39, 6
  br i1 %exitcond42, label %6, label %18

6:                                                ; preds = %5
  br label %7

7:                                                ; preds = %16, %6
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %16 ], [ 1, %6 ]
  %exitcond38 = icmp ne i64 %indvars.iv35, 6
  br i1 %exitcond38, label %8, label %17

8:                                                ; preds = %7
  br label %9

9:                                                ; preds = %10, %8
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %10 ], [ 1, %8 ]
  %exitcond34 = icmp ne i64 %indvars.iv31, 6
  br i1 %exitcond34, label %10, label %16

10:                                               ; preds = %9
  %11 = shl nuw nsw i64 %indvars.iv31, 6
  %12 = shl nuw nsw i64 %indvars.iv35, 3
  %13 = or disjoint i64 %11, %12
  %14 = or disjoint i64 %indvars.iv39, %13
...
19:                                               ; preds = %25, %18
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %25 ], [ 0, %18 ]
  %exitcond50 = icmp ne i64 %indvars.iv47, 13
  br i1 %exitcond50, label %20, label %26

20:                                               ; preds = %19
  br label %21

21:                                               ; preds = %22, %20
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %22 ], [ 0, %20 ]
  %exitcond46 = icmp ne i64 %indvars.iv43, 512
  br i1 %exitcond46, label %22, label %25

22:                                               ; preds = %21
  %23 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv47
  %24 = getelementptr inbounds nuw [4 x i8], ptr %23, i64 %indvars.iv43
...
27:                                               ; preds = %38, %26
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %38 ], [ 0, %26 ]
  %exitcond58 = icmp ne i64 %indvars.iv55, 4
  br i1 %exitcond58, label %28, label %39

28:                                               ; preds = %27
  br label %29

29:                                               ; preds = %37, %28
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %37 ], [ 0, %28 ]
  %exitcond54 = icmp ne i64 %indvars.iv51, 2
  br i1 %exitcond54, label %30, label %38
...
33:                                               ; preds = %31
  %34 = shl nuw nsw i64 %indvars.iv51, 3
  %35 = or disjoint i64 %indvars.iv55, %34
...
40:                                               ; preds = %51, %39
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %51 ], [ 0, %39 ]
  %exitcond66 = icmp ne i64 %indvars.iv63, 2
  br i1 %exitcond66, label %41, label %52
...
45:                                               ; preds = %46, %44
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %46 ], [ 0, %44 ]
  %exitcond62 = icmp ne i64 %indvars.iv59, 4
  br i1 %exitcond62, label %46, label %50

46:                                               ; preds = %45
  %47 = shl nuw nsw i64 %indvars.iv59, 6
  %48 = or disjoint i64 %indvars.iv63, %47
...
56:                                               ; preds = %64, %55
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %64 ], [ 0, %55 ]
  %exitcond74 = icmp ne i64 %indvars.iv71, 4
  br i1 %exitcond74, label %57, label %65

57:                                               ; preds = %56
  br label %58

58:                                               ; preds = %59, %57
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %59 ], [ 0, %57 ]
  %exitcond70 = icmp ne i64 %indvars.iv67, 2
  br i1 %exitcond70, label %59, label %64

59:                                               ; preds = %58
  %60 = shl nuw nsw i64 %indvars.iv67, 6
  %61 = shl nuw nsw i64 %indvars.iv71, 3
...
67:                                               ; preds = %78, %66
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %78 ], [ 0, %66 ]
  %exitcond82 = icmp ne i64 %indvars.iv79, 2
  br i1 %exitcond82, label %68, label %79

68:                                               ; preds = %67
  br label %69

69:                                               ; preds = %77, %68
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %77 ], [ 0, %68 ]
  %exitcond78 = icmp ne i64 %indvars.iv75, 4
  br i1 %exitcond78, label %70, label %78
...
73:                                               ; preds = %71
  %74 = shl nuw nsw i64 %indvars.iv75, 3
  %75 = or disjoint i64 %indvars.iv79, %74
...
80:                                               ; preds = %91, %79
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %91 ], [ 0, %79 ]
  %exitcond90 = icmp ne i64 %indvars.iv87, 4
  br i1 %exitcond90, label %81, label %92
...
85:                                               ; preds = %86, %84
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %86 ], [ 0, %84 ]
  %exitcond86 = icmp ne i64 %indvars.iv83, 2
  br i1 %exitcond86, label %86, label %90

86:                                               ; preds = %85
  %87 = shl nuw nsw i64 %indvars.iv83, 6
  %88 = or disjoint i64 %indvars.iv87, %87
...
96:                                               ; preds = %104, %95
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %104 ], [ 0, %95 ]
  %exitcond98 = icmp ne i64 %indvars.iv95, 2
  br i1 %exitcond98, label %97, label %105

97:                                               ; preds = %96
  br label %98

98:                                               ; preds = %99, %97
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %99 ], [ 0, %97 ]
  %exitcond94 = icmp ne i64 %indvars.iv91, 4
  br i1 %exitcond94, label %99, label %104

99:                                               ; preds = %98
  %100 = shl nuw nsw i64 %indvars.iv91, 6
  %101 = shl nuw nsw i64 %indvars.iv95, 3
...
107:                                              ; preds = %117, %106
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %117 ], [ 0, %106 ]
  %exitcond102 = icmp ne i64 %indvars.iv99, 3
  br i1 %exitcond102, label %108, label %118
...
114:                                              ; preds = %112
  %115 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 12288), i64 %indvars.iv99
...
122:                                              ; preds = %129, %121
  %indvars.iv103 = phi i64 [ %indvars.iv.next104, %129 ], [ 0, %121 ]
  %exitcond106 = icmp ne i64 %indvars.iv103, 3
  br i1 %exitcond106, label %123, label %130
...
126:                                              ; preds = %124
  %127 = shl nuw nsw i64 %indvars.iv103, 3
...
138:                                              ; preds = %139, %137
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %139 ], [ 0, %137 ]
  %exitcond110 = icmp ne i64 %indvars.iv107, 3
  br i1 %exitcond110, label %139, label %142

139:                                              ; preds = %138
  %140 = shl nuw nsw i64 %indvars.iv107, 6
...
145:                                              ; preds = %156, %144
  %indvars.iv115 = phi i64 [ %indvars.iv.next116, %156 ], [ 0, %144 ]
  %exitcond118 = icmp ne i64 %indvars.iv115, 2
  br i1 %exitcond118, label %146, label %157

146:                                              ; preds = %145
  br label %147

147:                                              ; preds = %155, %146
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %155 ], [ 0, %146 ]
  %exitcond114 = icmp ne i64 %indvars.iv111, 2
  br i1 %exitcond114, label %148, label %156
...
151:                                              ; preds = %149
  %152 = shl nuw nsw i64 %indvars.iv111, 3
  %153 = or disjoint i64 %indvars.iv115, %152
...
158:                                              ; preds = %169, %157
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %169 ], [ 0, %157 ]
  %exitcond126 = icmp ne i64 %indvars.iv123, 2
  br i1 %exitcond126, label %159, label %170
...
163:                                              ; preds = %164, %162
  %indvars.iv119 = phi i64 [ %indvars.iv.next120, %164 ], [ 0, %162 ]
  %exitcond122 = icmp ne i64 %indvars.iv119, 2
  br i1 %exitcond122, label %164, label %168

164:                                              ; preds = %163
  %165 = shl nuw nsw i64 %indvars.iv119, 6
  %166 = or disjoint i64 %indvars.iv123, %165
...
174:                                              ; preds = %182, %173
  %indvars.iv131 = phi i64 [ %indvars.iv.next132, %182 ], [ 0, %173 ]
  %exitcond134 = icmp ne i64 %indvars.iv131, 2
  br i1 %exitcond134, label %175, label %183

175:                                              ; preds = %174
  br label %176

176:                                              ; preds = %177, %175
  %indvars.iv127 = phi i64 [ %indvars.iv.next128, %177 ], [ 0, %175 ]
  %exitcond130 = icmp ne i64 %indvars.iv127, 2
  br i1 %exitcond130, label %177, label %182

177:                                              ; preds = %176
  %178 = shl nuw nsw i64 %indvars.iv127, 6
  %179 = shl nuw nsw i64 %indvars.iv131, 3
...
185:                                              ; preds = %197, %184
  %indvars.iv143 = phi i64 [ %indvars.iv.next144, %197 ], [ 0, %184 ]
  %exitcond146 = icmp ne i64 %indvars.iv143, 2
  br i1 %exitcond146, label %186, label %198

186:                                              ; preds = %185
  br label %187

187:                                              ; preds = %196, %186
  %indvars.iv139 = phi i64 [ %indvars.iv.next140, %196 ], [ 0, %186 ]
  %exitcond142 = icmp ne i64 %indvars.iv139, 2
  br i1 %exitcond142, label %188, label %197

188:                                              ; preds = %187
  br label %189

189:                                              ; preds = %190, %188
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %190 ], [ 0, %188 ]
  %exitcond138 = icmp ne i64 %indvars.iv135, 2
  br i1 %exitcond138, label %190, label %196

190:                                              ; preds = %189
  %191 = shl nuw nsw i64 %indvars.iv135, 6
  %192 = shl nuw nsw i64 %indvars.iv139, 3
  %193 = or disjoint i64 %191, %192
  %194 = or disjoint i64 %indvars.iv143, %193
