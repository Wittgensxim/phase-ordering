...
16:                                               ; preds = %13
  ...
  %invariant.op = or disjoint i32 %17, %10
  br label %18
...
21:                                               ; preds = %18
  ...
  %.reass = or disjoint i32 %22, %invariant.op
...
287:                                              ; preds = %284
  ...
  %invariant.op30 = or disjoint i32 %288, %281
  br label %289
...
292:                                              ; preds = %289
  ...
  %.reass31 = or disjoint i32 %293, %invariant.op30
  %294 = zext nneg i32 %.reass31 to i64
