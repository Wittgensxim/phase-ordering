...
10:                                               ; preds = %6
  ...
  br i1 %.not3, label %14, label %._crit_edge.loopexit

14:                                               ; preds = %10, %6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp ne i64 %indvars.iv.next, %5
  br i1 %exitcond, label %6, label %._crit_edge.loopexit, !llvm.loop !7

._crit_edge.loopexit:                             ; preds = %10, %14
  %.ph = phi i32 [ 1, %14 ], [ 0, %10 ]
  br label %._crit_edge
...
12:                                               ; preds = %9, %5
  ...
  br i1 %exitcond, label %._crit_edge.loopexit, label %5, !llvm.loop !9
...
26:                                               ; preds = %21
  ...
  br i1 %exitcond6.not, label %._crit_edge7.loopexit, label %21, !llvm.loop !10

._crit_edge7.loopexit:                            ; preds = %26
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7.loopexit, %._crit_edge, %24
  %28 = phi i32 [ %25, %24 ], [ 0, %._crit_edge ], [ 0, %._crit_edge7.loopexit ]
  ret i32 %28
}
...
12:                                               ; preds = %9, %5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge.loopexit, label %5, !llvm.loop !11
...
3:                                                ; preds = %.preheader2, %10
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %10 ], [ 1, %.preheader2 ]
  br label %4
...
11:                                               ; preds = %.preheader1, %15
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %15 ], [ 0, %.preheader1 ]
  br label %12
...
15:                                               ; preds = %12
  ...
  br i1 %exitcond21.not, label %.preheader, label %11, !llvm.loop !18

.preheader:                                       ; preds = %15
  br label %16

16:                                               ; preds = %.preheader, %24
