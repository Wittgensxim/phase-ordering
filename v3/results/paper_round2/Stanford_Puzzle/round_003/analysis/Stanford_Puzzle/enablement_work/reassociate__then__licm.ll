...
10:                                               ; preds = %20, %8
  ...
  %invariant.op = add nuw nsw i32 %12, %9
  br label %13
...
120:                                              ; preds = %112
  %121 = icmp samesign ult i32 %110, 1
...
148:                                              ; preds = %148, %146
  ...
  %154 = icmp samesign ult i32 %149, 1
  br i1 %154, label %148, label %155, !llvm.loop !34

155:                                              ; preds = %148
  %156 = icmp samesign ult i32 %147, 1
...
168:                                              ; preds = %160
  %169 = icmp samesign ult i32 %159, 1
...
182:                                              ; preds = %174
  %183 = icmp samesign ult i32 %172, 1
...
187:                                              ; preds = %197, %185
  ...
  %invariant.op1 = add nuw nsw i32 %189, %186
  br label %190

190:                                              ; preds = %190, %187
  %191 = phi i32 [ 0, %187 ], [ %195, %190 ]
  %192 = shl nuw nsw i32 %191, 6
  %.reass2 = add nuw nsw i32 %192, %invariant.op1
...
197:                                              ; preds = %190
  %198 = icmp samesign ult i32 %188, 1
  br i1 %198, label %187, label %199, !llvm.loop !41

199:                                              ; preds = %197
  %200 = icmp samesign ult i32 %186, 1
