...
33:                                               ; preds = %32
  ...
  %39 = getelementptr inbounds [13 x i32], ptr @piecemax, i64 0, i64 %38
  %40 = load i32, ptr %39, align 4
  %41 = icmp sle i32 %36, %40
  br i1 %41, label %13, label %._crit_edge, !llvm.loop !7
...
29:                                               ; preds = %28
  ...
  br i1 %37, label %13, label %._crit_edge, !llvm.loop !9
...
38:                                               ; preds = %._crit_edge, %2
  ...
  %49 = getelementptr inbounds [13 x i32], ptr @class, i64 0, i64 %48
  %50 = load i32, ptr %49, align 4
  %51 = sext i32 %50 to i64
  %52 = getelementptr inbounds [4 x i32], ptr @piececount, i64 0, i64 %51
...
28:                                               ; preds = %27
  ...
  br i1 %36, label %12, label %._crit_edge, !llvm.loop !11
...
37:                                               ; preds = %._crit_edge, %2
  ...
  %48 = getelementptr inbounds [13 x i32], ptr @class, i64 0, i64 %47
  %49 = load i32, ptr %48, align 4
  %50 = sext i32 %49 to i64
  %51 = getelementptr inbounds [4 x i32], ptr @piececount, i64 0, i64 %50
...
19:                                               ; preds = %10
  ...
  %22 = call i32 @Fit(i32 noundef %20, i32 noundef %21)
  %23 = icmp ne i32 %22, 0
...
24:                                               ; preds = %19
  ...
  %27 = call i32 @Place(i32 noundef %25, i32 noundef %26)
...
41:                                               ; preds = %40
  ...
  br i1 %45, label %10, label %._crit_edge, !llvm.loop !12
...
58:                                               ; preds = %.lr.ph11, %65
  ...
  %61 = getelementptr inbounds [13 x [512 x i32]], ptr @p, i64 0, i64 %60
  %62 = load i32, ptr %4, align 4
  %63 = sext i32 %62 to i64
  %64 = getelementptr inbounds [512 x i32], ptr %61, i64 0, i64 %63
