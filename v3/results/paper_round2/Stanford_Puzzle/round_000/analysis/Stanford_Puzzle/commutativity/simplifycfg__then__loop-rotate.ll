...
28:                                               ; preds = %13, %22
  ...
  br i1 %36, label %13, label %._crit_edge, !llvm.loop !9
...
37:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %54, label %.lr.ph2, label %68
...
55:                                               ; preds = %.lr.ph2, %63
  ...
  %58 = getelementptr inbounds [512 x i32], ptr @puzzl, i64 0, i64 %57
...
63:                                               ; preds = %55
  ...
  %67 = icmp sle i32 %66, 511
  br i1 %67, label %55, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %63
  br label %68

68:                                               ; preds = %._crit_edge3, %37
  store i32 0, ptr %3, align 4
  br label %69
...
27:                                               ; preds = %12, %21
  ...
  br i1 %35, label %12, label %._crit_edge, !llvm.loop !11
...
36:                                               ; preds = %._crit_edge, %2
  ...
  %47 = getelementptr inbounds [13 x i32], ptr @class, i64 0, i64 %46
  %48 = load i32, ptr %47, align 4
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds [4 x i32], ptr @piececount, i64 0, i64 %49
...
34:                                               ; preds = %24
  ...
  call void @Remove(i32 noundef %35, i32 noundef %36)
  br label %37
...
37:                                               ; preds = %10, %34, %19
  ...
  br i1 %41, label %10, label %._crit_edge, !llvm.loop !12
