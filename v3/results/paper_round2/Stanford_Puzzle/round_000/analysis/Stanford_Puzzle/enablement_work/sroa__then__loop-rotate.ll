...
23:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %36, label %.lr.ph20, label %47

.lr.ph20:                                         ; preds = %23
  br label %37

37:                                               ; preds = %.lr.ph20, %44
  %.118 = phi i32 [ %1, %.lr.ph20 ], [ %45, %44 ]
  %38 = sext i32 %.118 to i64
...
44:                                               ; preds = %43
  %45 = add nsw i32 %.118, 1
  %46 = icmp sle i32 %45, 511
  br i1 %46, label %37, label %._crit_edge21, !llvm.loop !10

._crit_edge21:                                    ; preds = %44
  br label %47

47:                                               ; preds = %._crit_edge21, %23
  br label %48

48:                                               ; preds = %47, %42
  %.015 = phi i32 [ %.1.lcssa16, %42 ], [ 0, %47 ]
  ret i32 %.015
}
...
4:                                                ; preds = %1, %26
  %.01213 = phi i32 [ 0, %1 ], [ %27, %26 ]
  %5 = sext i32 %.01213 to i64
...
12:                                               ; preds = %4
  %13 = call i32 @Fit(i32 noundef %.01213, i32 noundef %0)
  %14 = icmp ne i32 %13, 0
  br i1 %14, label %15, label %24

15:                                               ; preds = %12
  %16 = call i32 @Place(i32 noundef %.01213, i32 noundef %0)
...
22:                                               ; preds = %19
  call void @Remove(i32 noundef %.01213, i32 noundef %0)
  br label %23
...
1:                                                ; preds = %0, %4
  %.0167 = phi i32 [ 0, %0 ], [ %5, %4 ]
  %2 = sext i32 %.0167 to i64
  %3 = getelementptr inbounds [512 x i32], ptr @puzzl, i64 0, i64 %2
  store i32 1, ptr %3, align 4
  br label %4

4:                                                ; preds = %1
  %5 = add nsw i32 %.0167, 1
...
8:                                                ; preds = %7, %25
  %.0153170 = phi i32 [ 1, %7 ], [ %26, %25 ]
  br label %9

9:                                                ; preds = %8, %21
  %.0139169 = phi i32 [ 1, %8 ], [ %22, %21 ]
  br label %10

10:                                               ; preds = %9, %17
  %.0137168 = phi i32 [ 1, %9 ], [ %18, %17 ]
  %11 = mul nsw i32 8, %.0137168
  %12 = add nsw i32 %.0139169, %11
  %13 = mul nsw i32 8, %12
  %14 = add nsw i32 %.0153170, %13
...
29:                                               ; preds = %28, %39
  %.1154172 = phi i32 [ 0, %28 ], [ %40, %39 ]
  br label %30

30:                                               ; preds = %29, %35
  %.1171 = phi i32 [ 0, %29 ], [ %36, %35 ]
  %31 = sext i32 %.1154172 to i64
  %32 = getelementptr inbounds [13 x [512 x i32]], ptr @p, i64 0, i64 %31
  %33 = sext i32 %.1171 to i64
  %34 = getelementptr inbounds [512 x i32], ptr %32, i64 0, i64 %33
  store i32 0, ptr %34, align 4
  br label %35

35:                                               ; preds = %30
  %36 = add nsw i32 %.1171, 1
...
43:                                               ; preds = %42, %60
  %.2155175 = phi i32 [ 0, %42 ], [ %61, %60 ]
  br label %44

44:                                               ; preds = %43, %56
  %.1140174 = phi i32 [ 0, %43 ], [ %57, %56 ]
  br label %45

45:                                               ; preds = %44, %52
  %.1138173 = phi i32 [ 0, %44 ], [ %53, %52 ]
  %46 = mul nsw i32 8, %.1138173
  %47 = add nsw i32 %.1140174, %46
  %48 = mul nsw i32 8, %47
  %49 = add nsw i32 %.2155175, %48
...
64:                                               ; preds = %63, %81
  %.3156178 = phi i32 [ 0, %63 ], [ %82, %81 ]
  br label %65

65:                                               ; preds = %64, %77
  %.2141177 = phi i32 [ 0, %64 ], [ %78, %77 ]
  br label %66

66:                                               ; preds = %65, %73
  %.2176 = phi i32 [ 0, %65 ], [ %74, %73 ]
  %67 = mul nsw i32 8, %.2176
  %68 = add nsw i32 %.2141177, %67
  %69 = mul nsw i32 8, %68
  %70 = add nsw i32 %.3156178, %69
...
85:                                               ; preds = %84, %102
  %.4157181 = phi i32 [ 0, %84 ], [ %103, %102 ]
  br label %86

86:                                               ; preds = %85, %98
  %.3142180 = phi i32 [ 0, %85 ], [ %99, %98 ]
  br label %87

87:                                               ; preds = %86, %94
  %.3179 = phi i32 [ 0, %86 ], [ %95, %94 ]
  %88 = mul nsw i32 8, %.3179
  %89 = add nsw i32 %.3142180, %88
  %90 = mul nsw i32 8, %89
  %91 = add nsw i32 %.4157181, %90
...
106:                                              ; preds = %105, %123
  %.5158184 = phi i32 [ 0, %105 ], [ %124, %123 ]
  br label %107

107:                                              ; preds = %106, %119
  %.4143183 = phi i32 [ 0, %106 ], [ %120, %119 ]
  br label %108

108:                                              ; preds = %107, %115
  %.4182 = phi i32 [ 0, %107 ], [ %116, %115 ]
  %109 = mul nsw i32 8, %.4182
  %110 = add nsw i32 %.4143183, %109
  %111 = mul nsw i32 8, %110
  %112 = add nsw i32 %.5158184, %111
...
127:                                              ; preds = %126, %144
  %.6159187 = phi i32 [ 0, %126 ], [ %145, %144 ]
  br label %128

128:                                              ; preds = %127, %140
  %.5144186 = phi i32 [ 0, %127 ], [ %141, %140 ]
  br label %129

129:                                              ; preds = %128, %136
  %.5185 = phi i32 [ 0, %128 ], [ %137, %136 ]
  %130 = mul nsw i32 8, %.5185
  %131 = add nsw i32 %.5144186, %130
  %132 = mul nsw i32 8, %131
  %133 = add nsw i32 %.6159187, %132
...
148:                                              ; preds = %147, %165
  %.7160190 = phi i32 [ 0, %147 ], [ %166, %165 ]
  br label %149

149:                                              ; preds = %148, %161
  %.6145189 = phi i32 [ 0, %148 ], [ %162, %161 ]
  br label %150

150:                                              ; preds = %149, %157
  %.6188 = phi i32 [ 0, %149 ], [ %158, %157 ]
  %151 = mul nsw i32 8, %.6188
  %152 = add nsw i32 %.6145189, %151
  %153 = mul nsw i32 8, %152
  %154 = add nsw i32 %.7160190, %153
...
169:                                              ; preds = %168, %186
  %.8161193 = phi i32 [ 0, %168 ], [ %187, %186 ]
  br label %170

170:                                              ; preds = %169, %182
  %.7146192 = phi i32 [ 0, %169 ], [ %183, %182 ]
  br label %171

171:                                              ; preds = %170, %178
  %.7191 = phi i32 [ 0, %170 ], [ %179, %178 ]
  %172 = mul nsw i32 8, %.7191
  %173 = add nsw i32 %.7146192, %172
  %174 = mul nsw i32 8, %173
  %175 = add nsw i32 %.8161193, %174
...
190:                                              ; preds = %189, %207
  %.9162196 = phi i32 [ 0, %189 ], [ %208, %207 ]
  br label %191

191:                                              ; preds = %190, %203
  %.8147195 = phi i32 [ 0, %190 ], [ %204, %203 ]
  br label %192

192:                                              ; preds = %191, %199
  %.8194 = phi i32 [ 0, %191 ], [ %200, %199 ]
  %193 = mul nsw i32 8, %.8194
  %194 = add nsw i32 %.8147195, %193
  %195 = mul nsw i32 8, %194
  %196 = add nsw i32 %.9162196, %195
...
211:                                              ; preds = %210, %228
  %.10163199 = phi i32 [ 0, %210 ], [ %229, %228 ]
  br label %212

212:                                              ; preds = %211, %224
  %.9148198 = phi i32 [ 0, %211 ], [ %225, %224 ]
  br label %213

213:                                              ; preds = %212, %220
  %.9197 = phi i32 [ 0, %212 ], [ %221, %220 ]
  %214 = mul nsw i32 8, %.9197
  %215 = add nsw i32 %.9148198, %214
  %216 = mul nsw i32 8, %215
  %217 = add nsw i32 %.10163199, %216
...
232:                                              ; preds = %231, %249
  %.11164202 = phi i32 [ 0, %231 ], [ %250, %249 ]
  br label %233

233:                                              ; preds = %232, %245
  %.10149201 = phi i32 [ 0, %232 ], [ %246, %245 ]
  br label %234

234:                                              ; preds = %233, %241
  %.10200 = phi i32 [ 0, %233 ], [ %242, %241 ]
  %235 = mul nsw i32 8, %.10200
  %236 = add nsw i32 %.10149201, %235
  %237 = mul nsw i32 8, %236
  %238 = add nsw i32 %.11164202, %237
...
253:                                              ; preds = %252, %270
  %.12165205 = phi i32 [ 0, %252 ], [ %271, %270 ]
  br label %254

254:                                              ; preds = %253, %266
  %.11150204 = phi i32 [ 0, %253 ], [ %267, %266 ]
  br label %255

255:                                              ; preds = %254, %262
  %.11203 = phi i32 [ 0, %254 ], [ %263, %262 ]
  %256 = mul nsw i32 8, %.11203
  %257 = add nsw i32 %.11150204, %256
  %258 = mul nsw i32 8, %257
  %259 = add nsw i32 %.12165205, %258
...
274:                                              ; preds = %273, %291
  %.13166208 = phi i32 [ 0, %273 ], [ %292, %291 ]
  br label %275

275:                                              ; preds = %274, %287
  %.12151207 = phi i32 [ 0, %274 ], [ %288, %287 ]
  br label %276

276:                                              ; preds = %275, %283
  %.12206 = phi i32 [ 0, %275 ], [ %284, %283 ]
  %277 = mul nsw i32 8, %.12206
  %278 = add nsw i32 %.12151207, %277
  %279 = mul nsw i32 8, %278
  %280 = add nsw i32 %.13166208, %279
...
295:                                              ; preds = %294, %312
  %.14211 = phi i32 [ 0, %294 ], [ %313, %312 ]
  br label %296

296:                                              ; preds = %295, %308
  %.13152210 = phi i32 [ 0, %295 ], [ %309, %308 ]
  br label %297

297:                                              ; preds = %296, %304
  %.13209 = phi i32 [ 0, %296 ], [ %305, %304 ]
  %298 = mul nsw i32 8, %.13209
  %299 = add nsw i32 %.13152210, %298
  %300 = mul nsw i32 8, %299
  %301 = add nsw i32 %.14211, %300
