...
16:                                               ; preds = %13
  %17 = call i32 @Place(i32 noundef %.01, i32 noundef %0)
...
2:                                                ; preds = %.lr.ph, %5
  %.0161 = phi i32 [ 0, %.lr.ph ], [ %6, %5 ]
  %3 = sext i32 %.0161 to i64
  %4 = getelementptr inbounds [512 x i32], ptr @puzzl, i64 0, i64 %3
  store i32 1, ptr %4, align 4
  br label %5

5:                                                ; preds = %2
  %6 = add nsw i32 %.0161, 1
...
14:                                               ; preds = %.lr.ph2, %21
  %.0147 = phi i32 [ 1, %.lr.ph2 ], [ %22, %21 ]
  %15 = mul nsw i32 8, %.0147
  %16 = add nsw i32 %.0133, %15
  %17 = mul nsw i32 8, %16
  %18 = add nsw i32 %.0, %17
...
54:                                               ; preds = %.lr.ph17, %61
  %.1148 = phi i32 [ 0, %.lr.ph17 ], [ %62, %61 ]
  %55 = mul nsw i32 8, %.1148
  %56 = add nsw i32 %.1134, %55
  %57 = mul nsw i32 8, %56
  %58 = add nsw i32 %.2, %57
...
78:                                               ; preds = %.lr.ph26, %85
  %.2149 = phi i32 [ 0, %.lr.ph26 ], [ %86, %85 ]
  %79 = mul nsw i32 8, %.2149
  %80 = add nsw i32 %.2135, %79
  %81 = mul nsw i32 8, %80
  %82 = add nsw i32 %.3, %81
...
100:                                              ; preds = %.lr.ph38, %113
  %.3136 = phi i32 [ 0, %.lr.ph38 ], [ %114, %113 ]
...
102:                                              ; preds = %.lr.ph35, %109
  %.3150 = phi i32 [ 0, %.lr.ph35 ], [ %110, %109 ]
  %103 = mul nsw i32 8, %.3150
  %104 = add nsw i32 %.3136, %103
...
124:                                              ; preds = %.lr.ph47, %137
  %.4137 = phi i32 [ 0, %.lr.ph47 ], [ %138, %137 ]
...
126:                                              ; preds = %.lr.ph44, %133
  %.4151 = phi i32 [ 0, %.lr.ph44 ], [ %134, %133 ]
  %127 = mul nsw i32 8, %.4151
  %128 = add nsw i32 %.4137, %127
  %129 = mul nsw i32 8, %128
  %130 = add nsw i32 %.5, %129
...
148:                                              ; preds = %.lr.ph56, %161
  %.5138 = phi i32 [ 0, %.lr.ph56 ], [ %162, %161 ]
...
150:                                              ; preds = %.lr.ph53, %157
  %.5152 = phi i32 [ 0, %.lr.ph53 ], [ %158, %157 ]
  %151 = mul nsw i32 8, %.5152
  %152 = add nsw i32 %.5138, %151
...
172:                                              ; preds = %.lr.ph65, %185
  %.6139 = phi i32 [ 0, %.lr.ph65 ], [ %186, %185 ]
...
174:                                              ; preds = %.lr.ph62, %181
  %.6153 = phi i32 [ 0, %.lr.ph62 ], [ %182, %181 ]
  %175 = mul nsw i32 8, %.6153
  %176 = add nsw i32 %.6139, %175
  %177 = mul nsw i32 8, %176
  %178 = add nsw i32 %.7, %177
...
196:                                              ; preds = %.lr.ph74, %209
  %.7140 = phi i32 [ 0, %.lr.ph74 ], [ %210, %209 ]
...
198:                                              ; preds = %.lr.ph71, %205
  %.7154 = phi i32 [ 0, %.lr.ph71 ], [ %206, %205 ]
  %199 = mul nsw i32 8, %.7154
  %200 = add nsw i32 %.7140, %199
...
220:                                              ; preds = %.lr.ph83, %233
  %.8141 = phi i32 [ 0, %.lr.ph83 ], [ %234, %233 ]
...
222:                                              ; preds = %.lr.ph80, %229
  %.8155 = phi i32 [ 0, %.lr.ph80 ], [ %230, %229 ]
  %223 = mul nsw i32 8, %.8155
  %224 = add nsw i32 %.8141, %223
  %225 = mul nsw i32 8, %224
  %226 = add nsw i32 %.9, %225
...
244:                                              ; preds = %.lr.ph92, %257
  %.9142 = phi i32 [ 0, %.lr.ph92 ], [ %258, %257 ]
...
246:                                              ; preds = %.lr.ph89, %253
  %.9156 = phi i32 [ 0, %.lr.ph89 ], [ %254, %253 ]
  %247 = mul nsw i32 8, %.9156
  %248 = add nsw i32 %.9142, %247
  %249 = mul nsw i32 8, %248
  %250 = add nsw i32 %.10, %249
...
268:                                              ; preds = %.lr.ph101, %281
  %.10143 = phi i32 [ 0, %.lr.ph101 ], [ %282, %281 ]
...
270:                                              ; preds = %.lr.ph98, %277
  %.10157 = phi i32 [ 0, %.lr.ph98 ], [ %278, %277 ]
  %271 = mul nsw i32 8, %.10157
  %272 = add nsw i32 %.10143, %271
  %273 = mul nsw i32 8, %272
  %274 = add nsw i32 %.11, %273
...
292:                                              ; preds = %.lr.ph110, %305
  %.11144 = phi i32 [ 0, %.lr.ph110 ], [ %306, %305 ]
...
294:                                              ; preds = %.lr.ph107, %301
  %.11158 = phi i32 [ 0, %.lr.ph107 ], [ %302, %301 ]
  %295 = mul nsw i32 8, %.11158
  %296 = add nsw i32 %.11144, %295
  %297 = mul nsw i32 8, %296
  %298 = add nsw i32 %.12, %297
...
316:                                              ; preds = %.lr.ph119, %329
  %.12145 = phi i32 [ 0, %.lr.ph119 ], [ %330, %329 ]
...
318:                                              ; preds = %.lr.ph116, %325
  %.12159 = phi i32 [ 0, %.lr.ph116 ], [ %326, %325 ]
  %319 = mul nsw i32 8, %.12159
  %320 = add nsw i32 %.12145, %319
  %321 = mul nsw i32 8, %320
  %322 = add nsw i32 %.13, %321
...
340:                                              ; preds = %.lr.ph128, %353
  %.13146 = phi i32 [ 0, %.lr.ph128 ], [ %354, %353 ]
...
342:                                              ; preds = %.lr.ph125, %349
  %.13160 = phi i32 [ 0, %.lr.ph125 ], [ %350, %349 ]
  %343 = mul nsw i32 8, %.13160
  %344 = add nsw i32 %.13146, %343
