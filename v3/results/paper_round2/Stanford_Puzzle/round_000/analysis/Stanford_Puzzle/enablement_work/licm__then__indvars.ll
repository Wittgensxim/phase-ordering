...
define dso_local i32 @Fit(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %18 = add nsw i64 %17, 1
  %smax = call i64 @llvm.smax.i64(i64 %18, i64 %15)
  br label %19

19:                                               ; preds = %34, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %34 ], [ %15, %2 ]
  %20 = icmp sle i64 %indvars.iv, %17
  br i1 %20, label %21, label %35

21:                                               ; preds = %19
  %22 = getelementptr inbounds [512 x i32], ptr %13, i64 0, i64 %indvars.iv
  %23 = load i32, ptr %22, align 4
  %24 = icmp ne i32 %23, 0
  br i1 %24, label %25, label %33

25:                                               ; preds = %21
  %26 = add nsw i64 %16, %indvars.iv
...
30:                                               ; preds = %25
  ...
  %31 = trunc nsw i64 %.lcssa1.wide to i32
...
18:                                               ; preds = %28, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %28 ], [ %15, %2 ]
  %19 = icmp sle i64 %indvars.iv, %17
  br i1 %19, label %20, label %29

20:                                               ; preds = %18
  %21 = getelementptr inbounds [512 x i32], ptr %13, i64 0, i64 %indvars.iv
  %22 = load i32, ptr %21, align 4
  %23 = icmp ne i32 %22, 0
  br i1 %23, label %24, label %27

24:                                               ; preds = %20
  %25 = add nsw i64 %16, %indvars.iv
...
29:                                               ; preds = %18
  %.lcssa.wide = phi i64 [ %indvars.iv, %18 ]
  %30 = trunc nsw i64 %.lcssa.wide to i32
  ...
  %46 = sext i32 %.promoted1 to i64
  %smax = call i32 @llvm.smax.i32(i32 %.promoted1, i32 512)
  %wide.trip.count = sext i32 %smax to i64
  br label %47

47:                                               ; preds = %56, %29
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %56 ], [ %46, %29 ]
  %exitcond = icmp ne i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond, label %48, label %57

48:                                               ; preds = %47
  %49 = getelementptr inbounds [512 x i32], ptr @puzzl, i64 0, i64 %indvars.iv5
  %50 = load i32, ptr %49, align 4
  %51 = icmp ne i32 %50, 0
  br i1 %51, label %55, label %52

52:                                               ; preds = %48
  %.lcssa3.wide = phi i64 [ %indvars.iv5, %48 ]
  %53 = trunc nsw i64 %.lcssa3.wide to i32
...
57:                                               ; preds = %47
  %.lcssa2.wide = phi i64 [ %indvars.iv5, %47 ]
  %58 = trunc nsw i64 %.lcssa2.wide to i32
...
17:                                               ; preds = %27, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %27 ], [ %14, %2 ]
  %18 = icmp sle i64 %indvars.iv, %16
  br i1 %18, label %19, label %28

19:                                               ; preds = %17
  %20 = getelementptr inbounds [512 x i32], ptr %12, i64 0, i64 %indvars.iv
  %21 = load i32, ptr %20, align 4
  %22 = icmp ne i32 %21, 0
  br i1 %22, label %23, label %26

23:                                               ; preds = %19
  %24 = add nsw i64 %15, %indvars.iv
...
28:                                               ; preds = %17
  %.lcssa.wide = phi i64 [ %indvars.iv, %17 ]
