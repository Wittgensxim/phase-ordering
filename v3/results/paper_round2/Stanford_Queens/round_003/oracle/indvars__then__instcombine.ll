; ModuleID = 'results\paper_round2\Stanford_Queens\round_002\output.ll'
...
9:                                                ; preds = %32, %6
  %indvars.iv = phi i64 [ %indvars.iv.next, %32 ], [ 0, %6 ]
...
12:                                               ; preds = %9
  %13 = getelementptr [4 x i8], ptr %2, i64 %indvars.iv.next
...
26:                                               ; preds = %21
  %27 = add nsw i32 %0, 1
  call void @Try(i32 noundef %27, ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5)
  %28 = load i32, ptr %1, align 4
  %.not4 = icmp eq i32 %28, 0
  br i1 %.not4, label %29, label %32
...
32:                                               ; preds = %31, %29, %26, %16, %12, %9
  %.pre = phi i1 [ false, %31 ], [ %30, %29 ], [ false, %26 ], [ true, %16 ], [ true, %12 ], [ true, %9 ]
  %33 = icmp ne i64 %indvars.iv.next, 8
  %spec.select = and i1 %.pre, %33
  br i1 %spec.select, label %9, label %34, !llvm.loop !7
...
2:                                                ; preds = %2, %1
  ...
  %exitcond.not = icmp eq i32 %3, 51
  br i1 %exitcond.not, label %4, label %2, !llvm.loop !10
