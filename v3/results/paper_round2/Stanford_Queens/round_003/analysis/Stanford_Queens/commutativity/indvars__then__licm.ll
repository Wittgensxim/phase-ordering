...
27:                                               ; preds = %25
  call void @Try(i32 noundef %12, ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5)
...
31:                                               ; preds = %30, %29, %27, %20, %16, %13
  %.pre = phi i32 [ 1, %30 ], [ %.pre.pre, %29 ], [ %28, %27 ], [ 0, %20 ], [ 0, %16 ], [ 0, %13 ]
  %.not = icmp eq i32 %.pre, 0
  %32 = icmp ne i64 %indvars.iv.next, 8
  %spec.select = and i1 %.not, %32
  br i1 %spec.select, label %13, label %33, !llvm.loop !7
