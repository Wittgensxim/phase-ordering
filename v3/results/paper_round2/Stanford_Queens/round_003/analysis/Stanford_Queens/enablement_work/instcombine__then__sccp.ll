...
33:                                               ; preds = %32, %30, %27, %17, %12, %7
  %.pre = phi i1 [ false, %32 ], [ %31, %30 ], [ false, %27 ], [ true, %17 ], [ true, %12 ], [ true, %7 ]
  %34 = icmp ne i32 %8, 8
  %spec.select = and i1 %.pre, %34
  br i1 %spec.select, label %7, label %35, !llvm.loop !7
