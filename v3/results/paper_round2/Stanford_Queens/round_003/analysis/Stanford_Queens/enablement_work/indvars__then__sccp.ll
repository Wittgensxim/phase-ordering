...
31:                                               ; preds = %30, %29, %26, %16, %12, %9
  %.pre = phi i32 [ 1, %30 ], [ %.pre.pre, %29 ], [ %28, %26 ], [ 0, %16 ], [ 0, %12 ], [ 0, %9 ]
  %.not = icmp eq i32 %.pre, 0
  %32 = icmp ne i64 %indvars.iv.next, 8
  %spec.select = and i1 %.not, %32
  br i1 %spec.select, label %9, label %33, !llvm.loop !7
