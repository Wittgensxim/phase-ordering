...
33:                                               ; preds = %32, %30, %28, %21, %16, %11
  %.pre = phi i1 [ false, %32 ], [ %31, %30 ], [ false, %28 ], [ true, %21 ], [ true, %16 ], [ true, %11 ]
  %34 = icmp ne i32 %12, 8
  %spec.select = and i1 %.pre, %34
  br i1 %spec.select, label %11, label %35, !llvm.loop !7
