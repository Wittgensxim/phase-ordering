...
32:                                               ; preds = %31, %30, %28, %21, %16, %11
  %.pre = phi i32 [ 1, %31 ], [ %.pre.pre, %30 ], [ %29, %28 ], [ 0, %21 ], [ 0, %16 ], [ 0, %11 ]
  %.not = icmp eq i32 %.pre, 0
  %33 = icmp ne i32 %12, 8
  %spec.select = and i1 %33, %.not
  br i1 %spec.select, label %11, label %34, !llvm.loop !7
