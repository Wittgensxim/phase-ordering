...
11:                                               ; preds = %29, %6
  ...
  br i1 %.not1, label %29, label %14

14:                                               ; preds = %11
  %15 = add nsw i64 %indvars.iv.next, %7
...
29:                                               ; preds = %28, %27, %25, %18, %14, %11
  %.pre = phi i32 [ 1, %28 ], [ %.pre.pre, %27 ], [ %26, %25 ], [ 0, %18 ], [ 0, %14 ], [ 0, %11 ]
  %.not = icmp eq i32 %.pre, 0
  %30 = icmp ne i64 %indvars.iv.next, 8
  %spec.select = and i1 %30, %.not
  br i1 %spec.select, label %11, label %31, !llvm.loop !7
