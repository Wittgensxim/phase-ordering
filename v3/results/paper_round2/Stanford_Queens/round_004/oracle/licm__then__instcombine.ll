; ModuleID = 'results\paper_round2\Stanford_Queens\round_003\output.ll'
...
11:                                               ; preds = %30, %6
  %indvars.iv = phi i64 [ %indvars.iv.next, %30 ], [ 0, %6 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  store i32 0, ptr %1, align 4
  %12 = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv.next
  %13 = load i32, ptr %12, align 4
  %.not1 = icmp eq i32 %13, 0
  br i1 %.not1, label %30, label %14

14:                                               ; preds = %11
  %15 = getelementptr [4 x i8], ptr %2, i64 %indvars.iv.next
  %16 = getelementptr [4 x i8], ptr %15, i64 %7
  %17 = load i32, ptr %16, align 4
  %.not2 = icmp eq i32 %17, 0
  br i1 %.not2, label %30, label %18

18:                                               ; preds = %14
  %19 = sub nsw i64 %7, %indvars.iv.next
  %20 = getelementptr [4 x i8], ptr %4, i64 %19
  %21 = getelementptr i8, ptr %20, i64 28
  %22 = load i32, ptr %21, align 4
  %.not3 = icmp eq i32 %22, 0
  br i1 %.not3, label %30, label %23
...
30:                                               ; preds = %29, %27, %25, %18, %14, %11
  %.pre = phi i1 [ false, %29 ], [ %28, %27 ], [ false, %25 ], [ true, %18 ], [ true, %14 ], [ true, %11 ]
  %31 = icmp ne i64 %indvars.iv.next, 8
  %spec.select = and i1 %.pre, %31
  br i1 %spec.select, label %11, label %32, !llvm.loop !7
