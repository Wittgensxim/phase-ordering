...
32:                                               ; preds = %27, %24
  ...
  br i1 %36, label %.lr.ph, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %32, %0
  %37 = getelementptr inbounds [17 x i32], ptr %4, i64 0, i64 0
  %38 = getelementptr inbounds [9 x i32], ptr %3, i64 0, i64 0
  %39 = getelementptr inbounds [15 x i32], ptr %5, i64 0, i64 0
  %40 = getelementptr inbounds [9 x i32], ptr %6, i64 0, i64 0
  call void @Try(i32 noundef 1, ptr noundef %2, ptr noundef %37, ptr noundef %38, ptr noundef %39, ptr noundef %40)
