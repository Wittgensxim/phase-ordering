...
9:                                                ; preds = %.lr.ph, %28
  %10 = phi i32 [ %.promoted, %.lr.ph ], [ %29, %28 ]
  %11 = icmp sge i32 %10, 1
  br i1 %11, label %12, label %17

12:                                               ; preds = %9
  %13 = icmp sle i32 %10, 8
...
28:                                               ; preds = %24, %22
  ...
  br i1 %30, label %9, label %._crit_edge, !llvm.loop !9
...
31:                                               ; preds = %._crit_edge, %0
  %32 = getelementptr inbounds [17 x i32], ptr %4, i64 0, i64 0
  %33 = getelementptr inbounds [9 x i32], ptr %3, i64 0, i64 0
  %34 = getelementptr inbounds [15 x i32], ptr %5, i64 0, i64 0
  %35 = getelementptr inbounds [9 x i32], ptr %6, i64 0, i64 0
  call void @Try(i32 noundef 1, ptr noundef %2, ptr noundef %32, ptr noundef %33, ptr noundef %34, ptr noundef %35)
