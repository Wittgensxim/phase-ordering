...
define dso_local void @Try(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5) #0 {
  ...
  %8 = icmp ne i32 %7, 0
  %spec.select1 = select i1 %8, i1 false, i1 true
  br i1 %spec.select1, label %.lr.ph, label %42

.lr.ph:                                           ; preds = %6
  br label %9

9:                                                ; preds = %.lr.ph, %38
  %.02 = phi i32 [ 0, %.lr.ph ], [ %10, %38 ]
  %10 = add nsw i32 %.02, 1
  store i32 0, ptr %1, align 4
...
32:                                               ; preds = %28
  %33 = add nsw i32 %0, 1
  call void @Try(i32 noundef %33, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5)
...
38:                                               ; preds = %37, %36, %32, %21, %15, %9
  %39 = load i32, ptr %1, align 4
  %40 = icmp ne i32 %39, 0
  %41 = icmp ne i32 %10, 8
  %spec.select = select i1 %40, i1 false, i1 %41
  br i1 %spec.select, label %9, label %._crit_edge, !llvm.loop !7
...
12:                                               ; preds = %9, %6
  %13 = icmp sge i32 %.01, 2
  br i1 %13, label %14, label %17

14:                                               ; preds = %12
  %15 = sext i32 %.01 to i64
  %16 = getelementptr inbounds [17 x i32], ptr %3, i64 0, i64 %15
  store i32 1, ptr %16, align 4
  br label %17

17:                                               ; preds = %14, %12
  %18 = icmp sle i32 %.01, 7
