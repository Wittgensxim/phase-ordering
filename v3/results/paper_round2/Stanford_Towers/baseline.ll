...
; Function Attrs: noinline nounwind uwtable
define dso_local range(i32 0, -2147483648) i32 @Getelement() #0 {
...
3:                                                ; preds = %0
  ...
  %5 = getelementptr inbounds [8 x i8], ptr @cellspace, i64 %4
...
7:                                                ; preds = %2
  ...
  %9 = getelementptr inbounds [8 x i8], ptr @cellspace, i64 %8
...
.critedge:                                        ; preds = %7, %2
  ...
  %15 = getelementptr inbounds nuw [8 x i8], ptr @cellspace, i64 %14
...
4:                                                ; preds = %.lr.ph, %4
  %.01 = phi i32 [ %1, %.lr.ph ], [ %5, %4 ]
  call void @Push(i32 noundef %.01, i32 noundef %0)
  %5 = add nsw i32 %.01, -1
  %6 = icmp sgt i32 %5, 0
  br i1 %6, label %4, label %._crit_edge, !llvm.loop !7
...
1:                                                ; preds = %0, %1
  ...
  %4 = getelementptr inbounds nuw [8 x i8], ptr @cellspace, i64 %3
  %5 = getelementptr inbounds nuw i8, ptr %4, i64 4
  store i32 %2, ptr %5, align 4
  %6 = add nuw nsw i32 %.01, 1
  %7 = icmp samesign ult i32 %6, 19
...
11:                                               ; preds = %10, %8
  %12 = phi i32 [ %.pre, %10 ], [ 16383, %8 ]
  %13 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %12) #3
  ret void
}
