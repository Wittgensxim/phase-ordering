; ModuleID = 'results\paper_round2\Stanford_Towers\round_005\output.ll'
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %4 = phi i32 [ %5, %.lr.ph ], [ %1, %.lr.ph.preheader ]
  call void @Push(i32 noundef %4, i32 noundef %0)
  %5 = add nsw i32 %4, -1
  %6 = icmp sgt i32 %4, 1
  br i1 %6, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !7
...
1:                                                ; preds = %1, %0
  ...
  %2 = getelementptr inbounds nuw [8 x i8], ptr @cellspace, i64 %indvars.iv
