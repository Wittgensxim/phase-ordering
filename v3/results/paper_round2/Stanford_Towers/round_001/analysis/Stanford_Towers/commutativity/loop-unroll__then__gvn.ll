...
2:                                                ; preds = %0
  ...
  %3 = load i32, ptr @movesdone, align 4
  %.not = icmp eq i32 %3, 16383
...
5:                                                ; preds = %4, %2
  %6 = phi i32 [ %.pre, %4 ], [ 16383, %2 ]
  %7 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %6) #3
  ret void
}
