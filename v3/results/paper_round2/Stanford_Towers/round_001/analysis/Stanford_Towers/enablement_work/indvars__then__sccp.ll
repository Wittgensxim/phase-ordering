; ModuleID = 'results\paper_round2\Stanford_Towers\round_000\output.ll'
...
13:                                               ; preds = %12, %2
  %.not1 = phi i1 [ %.not, %12 ], [ true, %2 ]
  br i1 %.not1, label %14, label %20

14:                                               ; preds = %13
  %15 = call i32 @Getelement()
...
2:                                                ; preds = %1
  ...
  %4 = getelementptr inbounds nuw [8 x i8], ptr @cellspace, i64 %indvars.iv
...
10:                                               ; preds = %9, %7
  %11 = phi i32 [ %.pre, %9 ], [ 16383, %7 ]
  %12 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %11) #3
  ret void
}
