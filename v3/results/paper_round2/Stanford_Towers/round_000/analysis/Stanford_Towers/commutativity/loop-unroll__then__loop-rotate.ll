...
10:                                               ; preds = %.lr.ph, %13
  ...
  call void @Push(i32 noundef %11, i32 noundef %12)
  br label %13
...
13:                                               ; preds = %10
  ...
  br i1 %17, label %10, label %._crit_edge, !llvm.loop !7
...
4:                                                ; preds = %.lr.ph, %11
  ...
  %10 = getelementptr inbounds nuw %struct.element, ptr %9, i32 0, i32 1
...
11:                                               ; preds = %4
  ...
  br i1 %15, label %4, label %._crit_edge, !llvm.loop !9
...
6:                                                ; preds = %5
  ...
  br i1 %10, label %5, label %._crit_edge, !llvm.loop !10
