...
7:                                                ; preds = %2
  %8 = sext i32 %1 to i64
  %9 = getelementptr inbounds [4 x i8], ptr @stack, i64 %8
  %10 = load i32, ptr %9, align 4
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds [8 x i8], ptr @cellspace, i64 %11
...
16:                                               ; preds = %15, %2
  ...
  br i1 %.not1, label %17, label %29

17:                                               ; preds = %16
  %18 = call i32 @Getelement()
  %19 = sext i32 %1 to i64
  %20 = getelementptr inbounds [4 x i8], ptr @stack, i64 %19
  %21 = load i32, ptr %20, align 4
  %22 = sext i32 %18 to i64
  %23 = getelementptr inbounds [8 x i8], ptr @cellspace, i64 %22
  %24 = getelementptr inbounds nuw i8, ptr %23, i64 4
  store i32 %21, ptr %24, align 4
  %25 = sext i32 %1 to i64
  %26 = getelementptr inbounds [4 x i8], ptr @stack, i64 %25
  store i32 %18, ptr %26, align 4
  %27 = sext i32 %18 to i64
  %28 = getelementptr inbounds [8 x i8], ptr @cellspace, i64 %27
...
6:                                                ; preds = %1
  ...
  %20 = load i32, ptr @freelist, align 4
  %21 = sext i32 %0 to i64
  %22 = getelementptr inbounds [4 x i8], ptr @stack, i64 %21
  %23 = load i32, ptr %22, align 4
  %24 = sext i32 %23 to i64
  %25 = getelementptr inbounds [8 x i8], ptr @cellspace, i64 %24
  %26 = getelementptr inbounds nuw i8, ptr %25, i64 4
  store i32 %20, ptr %26, align 4
  %27 = sext i32 %0 to i64
  %28 = getelementptr inbounds [4 x i8], ptr @stack, i64 %27
  %29 = load i32, ptr %28, align 4
  store i32 %29, ptr @freelist, align 4
  %30 = sext i32 %0 to i64
  %31 = getelementptr inbounds [4 x i8], ptr @stack, i64 %30
...
1:                                                ; preds = %8, %0
  %storemerge = phi i32 [ 1, %0 ], [ %9, %8 ]
  %2 = icmp slt i32 %storemerge, 19
...
13:                                               ; preds = %12, %10
  ...
  %15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %14) #3
  ret void
}
