...
10:                                               ; preds = %.lr.ph, %12
  %11 = phi i32 [ %.promoted, %.lr.ph ], [ %13, %12 ]
  call void @Push(i32 noundef %11, i32 noundef %8)
  br label %12
...
define dso_local void @Towers() #0 {
  ...
  %2 = icmp sle i32 %.promoted, 18
  br i1 %2, label %.lr.ph, label %12

.lr.ph:                                           ; preds = %0
  br label %3

3:                                                ; preds = %.lr.ph, %9
  %4 = phi i32 [ %.promoted, %.lr.ph ], [ %10, %9 ]
  %5 = sub nsw i32 %4, 1
  %6 = sext i32 %4 to i64
...
9:                                                ; preds = %3
  ...
  br i1 %11, label %3, label %._crit_edge, !llvm.loop !9
...
17:                                               ; preds = %15, %12
  %18 = load i32, ptr @movesdone, align 4
...
6:                                                ; preds = %4
  ...
  br i1 %8, label %4, label %._crit_edge, !llvm.loop !10
