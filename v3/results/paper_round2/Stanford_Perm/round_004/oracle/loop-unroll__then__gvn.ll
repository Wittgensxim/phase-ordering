; ModuleID = 'results\paper_round2\Stanford_Perm\round_003\output.ll'
...
8:                                                ; preds = %8, %.lr.ph
  ...
  call void @Swap(ptr noundef nonnull %10, ptr noundef nonnull %11)
  call void @Permute(i32 noundef %5)
  call void @Swap(ptr noundef nonnull %10, ptr noundef nonnull %11)
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %12 = icmp sgt i64 %indvars.iv.next, 0
  br i1 %12, label %8, label %._crit_edge.loopexit, !llvm.loop !7

._crit_edge.loopexit:                             ; preds = %8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %1
  ret void
}
...
3:                                                ; preds = %2, %0
  %4 = phi i32 [ %.pre, %2 ], [ 43300, %0 ]
  %5 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4) #3
  ret void
}
...
1:                                                ; preds = %1, %0
  ...
  br i1 %exitcond, label %1, label %4, !llvm.loop !9
