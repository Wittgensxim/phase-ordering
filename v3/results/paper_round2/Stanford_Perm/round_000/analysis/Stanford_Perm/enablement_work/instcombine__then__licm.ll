...
16:                                               ; preds = %23, %6
  %storemerge.in = phi i32 [ %7, %6 ], [ %storemerge, %23 ]
  %storemerge = add nsw i32 %storemerge.in, -1
  %17 = icmp sgt i32 %storemerge.in, 1
  br i1 %17, label %18, label %24

18:                                               ; preds = %16
  %19 = sext i32 %storemerge to i64
  %20 = getelementptr inbounds [4 x i8], ptr @permarray, i64 %19
  call void @Swap(ptr noundef nonnull %11, ptr noundef nonnull %20)
  call void @Permute(i32 noundef %13)
  %21 = sext i32 %storemerge to i64
  %22 = getelementptr inbounds [4 x i8], ptr @permarray, i64 %21
  call void @Swap(ptr noundef nonnull %15, ptr noundef nonnull %22)
  br label %23
