...
define dso_local void @Initialize() #0 {
  ...
  %2 = sext i32 %.promoted to i64
  %smax = call i32 @llvm.smax.i32(i32 %.promoted, i32 8)
  %wide.trip.count = sext i32 %smax to i64
  br label %3

3:                                                ; preds = %8, %0
  %indvars.iv = phi i64 [ %indvars.iv.next, %8 ], [ %2, %0 ]
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %4, label %9

4:                                                ; preds = %3
  %5 = sub nsw i64 %indvars.iv, 1
  %6 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
...
9:                                                ; preds = %3
  %.lcssa.wide = phi i64 [ %indvars.iv, %3 ]
  %10 = trunc nsw i64 %.lcssa.wide to i32
...
22:                                               ; preds = %27, %8
  %indvars.iv = phi i64 [ %indvars.iv.next, %27 ], [ %21, %8 ]
  %23 = icmp sge i64 %indvars.iv, 1
  br i1 %23, label %24, label %28

24:                                               ; preds = %22
  %25 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
  call void @Swap(ptr noundef %15, ptr noundef %25)
  call void @Permute(i32 noundef %17)
  %26 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
  call void @Swap(ptr noundef %20, ptr noundef %26)
  br label %27
...
28:                                               ; preds = %22
  %.lcssa.wide = phi i64 [ %indvars.iv, %22 ]
...
2:                                                ; preds = %5, %0
  %3 = phi i32 [ %6, %5 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %3, %smax
