...
4:                                                ; preds = %1
  ...
  %7 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %6
...
16:                                               ; preds = %24, %6
  %17 = phi i32 [ %25, %24 ], [ %.promoted, %6 ]
  %18 = icmp sgt i32 %17, 0
  br i1 %18, label %19, label %26

19:                                               ; preds = %16
  %20 = zext nneg i32 %17 to i64
  %21 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %20
  call void @Swap(ptr noundef nonnull %11, ptr noundef nonnull %21)
  call void @Permute(i32 noundef %13)
  %22 = zext nneg i32 %17 to i64
  %23 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %22
  call void @Swap(ptr noundef nonnull %15, ptr noundef nonnull %23)
  br label %24
