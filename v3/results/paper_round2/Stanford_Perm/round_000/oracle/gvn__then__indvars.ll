...
3:                                                ; preds = %2
  %4 = sub nuw nsw i64 %indvars.iv, 1
  %5 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
...
10:                                               ; preds = %12, %7
  %indvars.iv = phi i64 [ %indvars.iv.next, %12 ], [ %9, %7 ]
  %11 = icmp sge i64 %indvars.iv, 1
  br i1 %11, label %12, label %17

12:                                               ; preds = %10
  %13 = sext i32 %0 to i64
  %14 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %13
  %15 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
  call void @Swap(ptr noundef %14, ptr noundef %15)
  call void @Permute(i32 noundef %8)
  call void @Swap(ptr noundef %14, ptr noundef %15)
