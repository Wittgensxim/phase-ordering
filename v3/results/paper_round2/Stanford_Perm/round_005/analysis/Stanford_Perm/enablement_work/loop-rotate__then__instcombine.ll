...
1:                                                ; preds = %1, %0
  ...
  %2 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %indvars.iv
...
8:                                                ; preds = %8, %.lr.ph
  ...
  %10 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %9
  ...
  br i1 %12, label %8, label %._crit_edge.loopexit, !llvm.loop !9
