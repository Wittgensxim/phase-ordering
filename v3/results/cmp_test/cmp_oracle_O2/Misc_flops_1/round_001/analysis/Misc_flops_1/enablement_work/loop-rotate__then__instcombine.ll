...
3:                                                ; preds = %0, %4
  %.03 = phi double [ 0.000000e+00, %0 ], [ %18, %4 ]
  %.012 = phi i32 [ 1, %0 ], [ %19, %4 ]
  %.021 = phi double [ 0.000000e+00, %0 ], [ %5, %4 ]
  br label %4
...
4:                                                ; preds = %3
  ...
  %18 = fadd double %.03, %17
  %19 = add nuw nsw i32 %.012, 1
  %20 = icmp samesign ult i32 %.012, 312499999
...
21:                                               ; preds = %4
  ...
  %37 = call double @llvm.fmuladd.f64(double %36, double %18, double %35)
  %38 = fmul double %2, %37
