...
7:                                                ; preds = %9, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %10, %9 ]
  %.01 = phi i32 [ 1, %0 ], [ %24, %9 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %23, %9 ]
  %8 = icmp sle i32 %.01, 312499999
...
9:                                                ; preds = %7
  ...
  %21 = call double @llvm.fmuladd.f64(double %11, double %20, double %5)
...
25:                                               ; preds = %7
  ...
  %39 = call double @llvm.fmuladd.f64(double %38, double %.0, double %37)
  %40 = fmul double %6, %39
  ...
  %46 = fsub double %42, 2.520000e+01
  store double %46, ptr @sc, align 8
