...
13:                                               ; preds = %0, %23
  %.03 = phi double [ 0.000000e+00, %0 ], [ %22, %23 ]
  %.012 = phi i32 [ 1, %0 ], [ %24, %23 ]
  %.021 = phi double [ 0.000000e+00, %0 ], [ %14, %23 ]
  %14 = fadd double %.021, %6
  %15 = fmul double %14, %7
  %16 = call double @llvm.fmuladd.f64(double %15, double %10, double %9)
  %17 = call double @llvm.fmuladd.f64(double %15, double %16, double %8)
  %18 = call double @llvm.fmuladd.f64(double %15, double %12, double %11)
  %19 = call double @llvm.fmuladd.f64(double %15, double %18, double %8)
  %20 = call double @llvm.fmuladd.f64(double %15, double %19, double %6)
...
23:                                               ; preds = %13
  ...
  %25 = icmp sle i32 %24, 312499999
  br i1 %25, label %13, label %26, !llvm.loop !7

26:                                               ; preds = %23
  %.0.lcssa = phi double [ %22, %23 ]
  ...
  %43 = call double @llvm.fmuladd.f64(double %42, double %.0.lcssa, double %41)
  %44 = fmul double %7, %43
  ...
  %53 = fsub double %47, 2.520000e+01
