...
3:                                                ; preds = %6, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %7, %6 ]
  %.01 = phi i32 [ 1, %0 ], [ %21, %6 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %20, %6 ]
...
6:                                                ; preds = %5
  ...
  %16 = call double @llvm.fmuladd.f64(double %8, double %14, double %15)
  %17 = call double @llvm.fmuladd.f64(double %8, double %16, double %12)
