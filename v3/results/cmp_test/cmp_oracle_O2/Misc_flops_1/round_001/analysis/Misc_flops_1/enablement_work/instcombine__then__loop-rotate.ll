...
3:                                                ; preds = %0, %4
  %.05 = phi double [ 0.000000e+00, %0 ], [ %18, %4 ]
  %.014 = phi i32 [ 1, %0 ], [ %19, %4 ]
  %.023 = phi double [ 0.000000e+00, %0 ], [ %5, %4 ]
  br label %4

4:                                                ; preds = %3
  %5 = fadd double %.023, %1
  %6 = fmul double %5, %2
  %7 = load double, ptr @D3, align 8
  ...
  %14 = call double @llvm.fmuladd.f64(double %6, double %12, double %13)
  %15 = call double @llvm.fmuladd.f64(double %6, double %14, double %10)
  %16 = call double @llvm.fmuladd.f64(double %6, double %15, double %1)
  %17 = fdiv double %11, %16
  %18 = fadd double %.05, %17
  %19 = add nuw nsw i32 %.014, 1
  %20 = icmp samesign ult i32 %19, 312500000
  br i1 %20, label %3, label %21, !llvm.loop !7

21:                                               ; preds = %4
  %.0.lcssa = phi double [ %18, %4 ]
