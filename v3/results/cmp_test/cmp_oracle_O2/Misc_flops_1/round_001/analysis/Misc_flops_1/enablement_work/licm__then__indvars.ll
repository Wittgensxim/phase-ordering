...
13:                                               ; preds = %24, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %15, %24 ]
...
14:                                               ; preds = %13
  %15 = fadd double %.02, %6
  %16 = fmul double %15, %7
  %17 = call double @llvm.fmuladd.f64(double %16, double %10, double %9)
  %18 = call double @llvm.fmuladd.f64(double %16, double %17, double %8)
  %19 = call double @llvm.fmuladd.f64(double %16, double %12, double %11)
  %20 = call double @llvm.fmuladd.f64(double %16, double %19, double %8)
  %21 = call double @llvm.fmuladd.f64(double %16, double %20, double %6)
