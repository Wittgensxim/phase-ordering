...
3:                                                ; preds = %5, %0
  ...
  %exitcond.not = icmp eq i32 %.01, 312500000
  br i1 %exitcond.not, label %21, label %4
...
21:                                               ; preds = %3
  ...
  %37 = call double @llvm.fmuladd.f64(double %36, double %.0, double %35)
  %38 = fmul double %2, %37
  ...
  %42 = fadd double %41, -2.520000e+01
