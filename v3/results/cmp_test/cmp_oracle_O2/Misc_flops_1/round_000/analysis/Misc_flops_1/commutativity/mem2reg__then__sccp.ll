...
9:                                                ; preds = %27, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %12, %27 ]
  %.01 = phi i32 [ 1, %0 ], [ %28, %27 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %26, %27 ]
  %10 = icmp sle i32 %.01, 312499999
...
29:                                               ; preds = %9
  ...
  %48 = call double @llvm.fmuladd.f64(double %47, double %.0, double %46)
  %49 = fmul double %7, %48
