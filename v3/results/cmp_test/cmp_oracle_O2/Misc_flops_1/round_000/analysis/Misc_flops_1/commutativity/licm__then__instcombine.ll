...
22:                                               ; preds = %28, %0
  %23 = phi double [ %37, %28 ], [ %.promoted5, %0 ]
  %24 = phi double [ %30, %28 ], [ %.promoted3, %0 ]
  %25 = phi double [ %29, %28 ], [ %.promoted1, %0 ]
  %26 = phi i32 [ %38, %28 ], [ %.promoted, %0 ]
  %.not.not = icmp slt i32 %26, %15
  br i1 %.not.not, label %27, label %39

27:                                               ; preds = %22
  br label %28

28:                                               ; preds = %27
  %29 = fadd double %25, %12
  %30 = fmul double %29, %14
  %31 = call double @llvm.fmuladd.f64(double %30, double %18, double %17)
  %32 = call double @llvm.fmuladd.f64(double %30, double %31, double %16)
  %33 = call double @llvm.fmuladd.f64(double %30, double %21, double %20)
  %34 = call double @llvm.fmuladd.f64(double %30, double %33, double %16)
  %35 = call double @llvm.fmuladd.f64(double %30, double %34, double %19)
...
39:                                               ; preds = %22
  ...
  %69 = fadd double %68, -2.520000e+01
