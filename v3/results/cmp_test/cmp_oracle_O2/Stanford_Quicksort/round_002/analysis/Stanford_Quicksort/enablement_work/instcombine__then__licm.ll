...
15:                                               ; preds = %14, %9
  ...
  %17 = icmp samesign ult i32 %.01, 5000
...
16:                                               ; preds = %10
  ...
  %.lcssa = phi i32 [ %15, %10 ]
  %17 = getelementptr inbounds [4 x i8], ptr %0, i64 %.lcssa7
  br label %18
...
24:                                               ; preds = %18
  %.lcssa8 = phi i64 [ %19, %18 ]
  %.1.lcssa = phi i32 [ %.1, %18 ]
  %.lcssa5 = phi i32 [ %21, %18 ]
  %.lcssa4 = phi i32 [ %23, %18 ]
  %25 = getelementptr inbounds [4 x i8], ptr %0, i64 %.lcssa8
  %.not = icmp sgt i32 %.12.lcssa, %.1.lcssa
  br i1 %.not, label %27, label %26

26:                                               ; preds = %24
  store i32 %.lcssa5, ptr %17, align 4
  store i32 %.lcssa2, ptr %25, align 4
  br label %27

27:                                               ; preds = %26, %24
  %.23 = phi i32 [ %.lcssa, %26 ], [ %.12.lcssa, %24 ]
  %.2 = phi i32 [ %.lcssa4, %26 ], [ %.1.lcssa, %24 ]
  %.not1 = icmp sgt i32 %.23, %.2
  br i1 %.not1, label %28, label %9, !llvm.loop !11

28:                                               ; preds = %27
  %.23.lcssa = phi i32 [ %.23, %27 ]
  %.2.lcssa = phi i32 [ %.2, %27 ]
  %29 = icmp slt i32 %1, %.2.lcssa
