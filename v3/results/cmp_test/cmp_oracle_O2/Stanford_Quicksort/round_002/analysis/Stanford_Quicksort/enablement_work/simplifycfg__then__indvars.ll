...
1:                                                ; preds = %15, %0
  %indvars.iv = phi i64 [ %indvars.iv.next, %15 ], [ 1, %0 ]
  %2 = call i32 @Rand()
  %3 = sdiv i32 %2, 100000
...
15:                                               ; preds = %11, %14, %10
  ...
  br i1 %exitcond, label %1, label %16, !llvm.loop !7
...
21:                                               ; preds = %15
  %.1.lcssa = phi i32 [ %.1, %15 ]
  %.lcssa5 = phi ptr [ %17, %15 ]
  %.lcssa4 = phi i32 [ %18, %15 ]
  %.lcssa3 = phi i32 [ %20, %15 ]
  %22 = trunc nsw i64 %.12.lcssa.wide to i32
  %23 = trunc nsw i64 %.lcssa.wide to i32
  %24 = icmp sle i32 %22, %.1.lcssa
...
26:                                               ; preds = %25, %21
  %.23 = phi i32 [ %23, %25 ], [ %22, %21 ]
  %.2 = phi i32 [ %.lcssa3, %25 ], [ %.1.lcssa, %21 ]
  %27 = icmp sle i32 %.23, %.2
  br i1 %27, label %9, label %28, !llvm.loop !11

28:                                               ; preds = %26
  %.23.lcssa = phi i32 [ %.23, %26 ]
