; ModuleID = 'results\cmp_test\cmp_oracle_O2\Stanford_Quicksort\round_001\output.ll'
...
1:                                                ; preds = %13, %0
  ...
  %2 = call i32 @Rand()
  %.reass = sub i32 %2, 50000
  %3 = sext i32 %.01 to i64
  %4 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %3
  store i32 %.reass, ptr %4, align 4
  %5 = load i32, ptr @biggest, align 4
  %6 = icmp sgt i32 %.reass, %5
  br i1 %6, label %7, label %8

7:                                                ; preds = %1
  store i32 %.reass, ptr @biggest, align 4
  br label %13

8:                                                ; preds = %1
  %9 = load i32, ptr @littlest, align 4
  %10 = icmp slt i32 %.reass, %9
  br i1 %10, label %11, label %12

11:                                               ; preds = %8
  store i32 %.reass, ptr @littlest, align 4
  br label %12
...
16:                                               ; preds = %10
  %.lcssa12 = phi i64 [ %11, %10 ]
  %.12.lcssa = phi i32 [ %.12, %10 ]
  %.lcssa7 = phi i32 [ %13, %10 ]
  %.lcssa = phi i32 [ %15, %10 ]
  %17 = getelementptr inbounds i32, ptr %0, i64 %.lcssa12
  br label %18

18:                                               ; preds = %18, %16
  %.1 = phi i32 [ %.0, %16 ], [ %23, %18 ]
  %19 = sext i32 %.1 to i64
  %20 = getelementptr inbounds i32, ptr %0, i64 %19
  %21 = load i32, ptr %20, align 4
  %22 = icmp slt i32 %8, %21
  %23 = sub nsw i32 %.1, 1
  br i1 %22, label %18, label %24, !llvm.loop !10

24:                                               ; preds = %18
  %.lcssa13 = phi i64 [ %19, %18 ]
  %.1.lcssa = phi i32 [ %.1, %18 ]
  %.lcssa10 = phi i32 [ %21, %18 ]
  %.lcssa9 = phi i32 [ %23, %18 ]
  %25 = getelementptr inbounds i32, ptr %0, i64 %.lcssa13
  %26 = icmp sle i32 %.12.lcssa, %.1.lcssa
  br i1 %26, label %27, label %28

27:                                               ; preds = %24
  store i32 %.lcssa10, ptr %17, align 4
  store i32 %.lcssa7, ptr %25, align 4
  br label %28

28:                                               ; preds = %27, %24
  %.23 = phi i32 [ %.lcssa, %27 ], [ %.12.lcssa, %24 ]
  %.2 = phi i32 [ %.lcssa9, %27 ], [ %.1.lcssa, %24 ]
  %29 = icmp sle i32 %.23, %.2
  br i1 %29, label %9, label %30, !llvm.loop !11

30:                                               ; preds = %28
  %.23.lcssa = phi i32 [ %.23, %28 ]
  %.2.lcssa = phi i32 [ %.2, %28 ]
  %31 = icmp slt i32 %1, %.2.lcssa
