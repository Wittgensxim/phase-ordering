...
15:                                               ; preds = %11
  ...
  %.lcssa2 = phi i32 [ %13, %11 ]
  %.lcssa.wide = phi i64 [ %indvars.iv.next, %11 ]
  %16 = sext i32 %.0 to i64
  br label %17

17:                                               ; preds = %17, %15
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %17 ], [ %16, %15 ]
  %18 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv8
...
21:                                               ; preds = %17
  %.1.lcssa.wide = phi i64 [ %indvars.iv8, %17 ]
  %.lcssa6 = phi ptr [ %18, %17 ]
  %.lcssa5 = phi i32 [ %19, %17 ]
  %.lcssa4.wide = phi i64 [ %indvars.iv.next9, %17 ]
  %22 = trunc nsw i64 %.12.lcssa.wide to i32
  %23 = trunc nsw i64 %.lcssa.wide to i32
  %24 = trunc nsw i64 %.1.lcssa.wide to i32
  %25 = trunc nsw i64 %.lcssa4.wide to i32
  %.not = icmp sgt i32 %22, %24
  br i1 %.not, label %27, label %26

26:                                               ; preds = %21
  store i32 %.lcssa5, ptr %.lcssa3, align 4
  store i32 %.lcssa2, ptr %.lcssa6, align 4
  br label %27

27:                                               ; preds = %26, %21
  %.23 = phi i32 [ %23, %26 ], [ %22, %21 ]
  %.2 = phi i32 [ %25, %26 ], [ %24, %21 ]
