...
15:                                               ; preds = %11
  ...
  %16 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv.lcssa
  br label %17

17:                                               ; preds = %17, %15
  %.1 = phi i32 [ %.0, %15 ], [ %22, %17 ]
...
23:                                               ; preds = %17
  ...
  %.lcssa4 = phi i32 [ %20, %17 ]
  %.lcssa3 = phi i32 [ %22, %17 ]
  %24 = getelementptr inbounds i32, ptr %0, i64 %.lcssa
  %25 = trunc nsw i64 %.12.lcssa.wide to i32
  %26 = trunc nsw i64 %.lcssa.wide to i32
  %27 = icmp sle i32 %25, %.1.lcssa
  br i1 %27, label %28, label %29

28:                                               ; preds = %23
  store i32 %.lcssa4, ptr %16, align 4
  store i32 %.lcssa1, ptr %24, align 4
  br label %29

29:                                               ; preds = %28, %23
  %.23 = phi i32 [ %26, %28 ], [ %25, %23 ]
  %.2 = phi i32 [ %.lcssa3, %28 ], [ %.1.lcssa, %23 ]
  %30 = icmp sle i32 %.23, %.2
  br i1 %30, label %9, label %31, !llvm.loop !11

31:                                               ; preds = %29
  %.23.lcssa = phi i32 [ %.23, %29 ]
  %.2.lcssa = phi i32 [ %.2, %29 ]
  %32 = icmp slt i32 %1, %.2.lcssa
