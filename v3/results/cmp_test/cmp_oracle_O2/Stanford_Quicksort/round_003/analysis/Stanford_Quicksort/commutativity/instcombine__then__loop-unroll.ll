...
25:                                               ; preds = %24, %23
  %.23 = phi i32 [ %.lcssa, %24 ], [ %.12.lcssa, %23 ]
  %.2 = phi i32 [ %.lcssa4, %24 ], [ %.1.lcssa, %23 ]
  %.not1 = icmp sgt i32 %.23, %.2
  br i1 %.not1, label %26, label %9, !llvm.loop !11

26:                                               ; preds = %25
  %.23.lcssa = phi i32 [ %.23, %25 ]
  %.2.lcssa = phi i32 [ %.2, %25 ]
  %27 = icmp slt i32 %1, %.2.lcssa
