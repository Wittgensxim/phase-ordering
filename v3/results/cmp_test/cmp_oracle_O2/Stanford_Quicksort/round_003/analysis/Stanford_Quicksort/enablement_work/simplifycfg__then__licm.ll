...
.preheader:                                       ; preds = %10
  ...
  %.lcssa = phi i32 [ %15, %10 ]
  %16 = getelementptr inbounds i32, ptr %0, i64 %.lcssa6
  br label %17

17:                                               ; preds = %.preheader, %17
  %.1 = phi i32 [ %22, %17 ], [ %.0, %.preheader ]
...
23:                                               ; preds = %17
  %.lcssa7 = phi i64 [ %18, %17 ]
  %.1.lcssa = phi i32 [ %.1, %17 ]
  %.lcssa4 = phi i32 [ %20, %17 ]
  %.lcssa3 = phi i32 [ %22, %17 ]
  %24 = getelementptr inbounds i32, ptr %0, i64 %.lcssa7
  %25 = icmp sle i32 %.12.lcssa, %.1.lcssa
...
27:                                               ; preds = %26, %23
  %.23 = phi i32 [ %.lcssa, %26 ], [ %.12.lcssa, %23 ]
  %.2 = phi i32 [ %.lcssa3, %26 ], [ %.1.lcssa, %23 ]
