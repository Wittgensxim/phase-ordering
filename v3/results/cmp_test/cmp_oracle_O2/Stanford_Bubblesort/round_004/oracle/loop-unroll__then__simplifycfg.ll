...
2:                                                ; preds = %.epilog-lcssa, %1
  %indvar = phi i64 [ %indvar.next, %.epilog-lcssa ], [ 0, %1 ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %.epilog-lcssa ], [ 500, %1 ]
...
7:                                                ; preds = %21, %.new
  ...
  %8 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %2
  ...
  %22 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.epil.init
...
.epilog-lcssa:                                    ; preds = %.epil.preheader, %27, %.unr-lcssa
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, -1
  %28 = icmp sgt i64 %indvars.iv2, 2
  %indvar.next = add i64 %indvar, 1
  br i1 %28, label %2, label %29, !llvm.loop !10
