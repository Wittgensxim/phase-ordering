; ModuleID = 'results\cmp_test\cmp_oracle_O2\Stanford_Bubblesort\round_003\output.ll'
...
2:                                                ; preds = %29, %1
  %indvar = phi i64 [ %indvar.next, %29 ], [ 0, %1 ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %29 ], [ 500, %1 ]
...
7:                                                ; preds = %21, %.new
  %8 = phi i32 [ %.pre, %.new ], [ %22, %21 ]
  %indvars.iv = phi i64 [ 1, %.new ], [ %indvars.iv.next.1, %21 ]
  %niter = phi i64 [ 0, %.new ], [ %niter.next.1, %21 ]
...
14:                                               ; preds = %13, %7
  ...
  %16 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %17 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next.1
...
21:                                               ; preds = %20, %14
  %22 = phi i32 [ %15, %20 ], [ %18, %14 ]
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %7, !llvm.loop !9

.unr-lcssa:                                       ; preds = %21
  %.unr = phi i32 [ %22, %21 ]
  %indvars.iv.unr = phi i64 [ %indvars.iv.next.1, %21 ]
  %lcmp.mod = icmp ne i64 %xtraiter, 0
  br i1 %lcmp.mod, label %.epil.preheader, label %29

.epil.preheader:                                  ; preds = %.unr-lcssa, %2
  %.epil.init = phi i32 [ %.pre, %2 ], [ %.unr, %.unr-lcssa ]
  %indvars.iv.epil.init = phi i64 [ 1, %2 ], [ %indvars.iv.unr, %.unr-lcssa ]
  %lcmp.mod1 = icmp ne i64 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod1)
  br label %23

23:                                               ; preds = %.epil.preheader
  %24 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.epil.init
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil.init, 1
  %25 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next.epil
  %26 = load i32, ptr %25, align 4
  %27 = icmp sgt i32 %.epil.init, %26
  br i1 %27, label %28, label %.epilog-lcssa

28:                                               ; preds = %23
  store i32 %26, ptr %24, align 4
  store i32 %.epil.init, ptr %25, align 4
  br label %.epilog-lcssa

.epilog-lcssa:                                    ; preds = %28, %23
  br label %29

29:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, -1
  %30 = icmp sgt i64 %indvars.iv2, 2
  %indvar.next = add i64 %indvar, 1
  br i1 %30, label %2, label %31, !llvm.loop !10
...
38:                                               ; preds = %37, %34
  ...
  %43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %42) #4
  ret void
}
