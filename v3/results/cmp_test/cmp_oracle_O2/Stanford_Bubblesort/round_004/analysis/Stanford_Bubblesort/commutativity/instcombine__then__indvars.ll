...
2:                                                ; preds = %11, %1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %11 ], [ 500, %1 ]
  br label %3

3:                                                ; preds = %10, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %10 ], [ 1, %2 ]
...
10:                                               ; preds = %9, %3
  %exitcond.not = icmp eq i64 %indvars.iv.next, %indvars.iv2
...
13:                                               ; preds = %11
  ...
  %14 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %15 = load i32, ptr @littlest, align 4
  %.not = icmp eq i32 %14, %15
  br i1 %.not, label %16, label %19

16:                                               ; preds = %13
  %17 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
...
20:                                               ; preds = %19, %16
  ...
  %22 = getelementptr [4 x i8], ptr @sortlist, i64 %21
  %23 = getelementptr i8, ptr %22, i64 4
  %24 = load i32, ptr %23, align 4
  %25 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %24) #3
  ret void
}
