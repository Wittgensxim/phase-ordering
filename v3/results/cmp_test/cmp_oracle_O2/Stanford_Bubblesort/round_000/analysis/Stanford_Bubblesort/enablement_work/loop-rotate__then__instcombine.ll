...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %43
...
34:                                               ; preds = %18, %8
  ...
  br i1 %38, label %8, label %._crit_edge, !llvm.loop !9
...
39:                                               ; preds = %._crit_edge, %5
  ...
  br i1 %42, label %5, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %39
  br label %43

43:                                               ; preds = %._crit_edge3, %1
  %44 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %45 = load i32, ptr @littlest, align 4
  %.not = icmp eq i32 %44, %45
  br i1 %.not, label %46, label %49

46:                                               ; preds = %43
  %47 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
  %48 = load i32, ptr @biggest, align 4
  %.not4 = icmp eq i32 %47, %48
