...
1:                                                ; preds = %0, %14
  %indvars.iv2 = phi i64 [ 1, %0 ], [ %indvars.iv.next, %14 ]
  %2 = call i32 @Rand()
  %.fr = freeze i32 %2
  %3 = srem i32 %.fr, 100000
  %4 = add nsw i32 %3, -50000
  %5 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv2
...
2:                                                ; preds = %1, %11
  %indvars.iv26 = phi i64 [ 500, %1 ], [ %indvars.iv.next3, %11 ]
  br label %3

3:                                                ; preds = %2, %10
  %indvars.iv5 = phi i64 [ 1, %2 ], [ %indvars.iv.next, %10 ]
  %4 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv5
...
10:                                               ; preds = %9, %3
  %exitcond = icmp ne i64 %indvars.iv.next, %indvars.iv26
  br i1 %exitcond, label %3, label %11, !llvm.loop !9

11:                                               ; preds = %10
  %indvars.iv.next3 = add nsw i64 %indvars.iv26, -1
  %12 = trunc nuw nsw i64 %indvars.iv.next3 to i32
  store i32 %12, ptr @top, align 4
  %13 = icmp samesign ugt i64 %indvars.iv.next3, 1
  br i1 %13, label %2, label %14, !llvm.loop !10

14:                                               ; preds = %11
  %15 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %16 = load i32, ptr @littlest, align 4
  %.not = icmp eq i32 %15, %16
  br i1 %.not, label %17, label %20

17:                                               ; preds = %14
  %18 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
...
21:                                               ; preds = %20, %17
  ...
  %23 = getelementptr [4 x i8], ptr @sortlist, i64 %22
  %24 = getelementptr i8, ptr %23, i64 4
  %25 = load i32, ptr %24, align 4
  %26 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %25) #3
  ret void
}
