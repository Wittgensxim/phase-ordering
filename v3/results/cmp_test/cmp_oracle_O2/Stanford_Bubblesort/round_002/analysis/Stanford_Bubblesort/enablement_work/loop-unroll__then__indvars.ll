...
7:                                                ; preds = %22, %.new
  %indvars.iv = phi i64 [ %indvars.iv.next, %22 ], [ 1, %.new ]
...
15:                                               ; preds = %14, %7
  %16 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %10
...
.unr-lcssa:                                       ; preds = %22
  %.unr.wide = phi i64 [ %indvars.iv.next, %22 ]
  %23 = trunc nuw i64 %.unr.wide to i32
  %lcmp.mod = icmp ne i32 %xtraiter, 0
  br i1 %lcmp.mod, label %.epil.preheader, label %34

.epil.preheader:                                  ; preds = %.unr-lcssa, %2
  %.epil.init = phi i32 [ 1, %2 ], [ %23, %.unr-lcssa ]
  %lcmp.mod1 = icmp ne i32 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod1)
  br label %24

24:                                               ; preds = %.epil.preheader
  %25 = zext nneg i32 %.epil.init to i64
  %26 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %25
  %27 = load i32, ptr %26, align 4
  %28 = add nuw nsw i32 %.epil.init, 1
...
.epilog-lcssa:                                    ; preds = %33, %24
  br label %34

34:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  %indvar.next = add nuw nsw i32 %indvar, 1
  %exitcond = icmp ne i32 %indvar.next, 499
  br i1 %exitcond, label %2, label %35, !llvm.loop !10
