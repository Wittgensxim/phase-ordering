...
34:                                               ; preds = %._crit_edge, %20
  %.lcssa = phi i32 [ %32, %._crit_edge ], [ %.pre, %20 ]
...
50:                                               ; preds = %._crit_edge5, %34
  ...
  %55 = icmp samesign ult i32 %.16, 99999999
...
14:                                               ; preds = %4, %14
  ...
  %18 = add nsw i32 %.01, 1
  %.not.not = icmp slt i32 %.01, %8
  br i1 %.not.not, label %14, label %19, !llvm.loop !12
...
12:                                               ; preds = %11, %3
  br i1 %.not, label %13, label %3, !llvm.loop !13

13:                                               ; preds = %12
  %14 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #5
