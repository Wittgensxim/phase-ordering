...
34:                                               ; preds = %74, %20
  %.lcssa28 = phi i8 [ %61, %74 ], [ undef, %20 ]
  %35 = phi i32 [ %79, %74 ], [ undef, %20 ]
  %36 = phi i32 [ %81, %74 ], [ 0, %20 ]
...
55:                                               ; preds = %46
  ...
  %57 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %47, i32 noundef %56)
