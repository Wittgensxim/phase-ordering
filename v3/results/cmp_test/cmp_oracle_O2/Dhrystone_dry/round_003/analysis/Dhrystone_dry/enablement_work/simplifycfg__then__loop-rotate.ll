...
34:                                               ; preds = %._crit_edge, %20
  ...
  %.not11 = icmp sgt i8 65, %39
  br i1 %.not11, label %50, label %.lr.ph4

.lr.ph4:                                          ; preds = %34
  br label %40

40:                                               ; preds = %.lr.ph4, %47
  %.012 = phi i8 [ 65, %.lr.ph4 ], [ %48, %47 ]
  %41 = sext i8 %.012 to i32
...
47:                                               ; preds = %45, %40
  ...
  br i1 %.not1, label %._crit_edge5, label %40, !llvm.loop !10

._crit_edge5:                                     ; preds = %47
  br label %50

50:                                               ; preds = %._crit_edge5, %34
