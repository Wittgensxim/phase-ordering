; ModuleID = 'results\cmp_test\cmp_oracle_O2\Dhrystone_dry\round_002\output.ll'
...
24:                                               ; preds = %.lr.ph, %24
  %25 = phi i32 [ %.pre, %.lr.ph ], [ %30, %24 ]
  %26 = mul nsw i32 %25, 5
  %27 = add nsw i32 %26, -3
  store i32 %27, ptr %2, align 4
  %28 = call i32 @Proc7(i32 noundef %25, i32 noundef 3, ptr noundef nonnull %2)
  %29 = load i32, ptr %1, align 4
  %30 = add nsw i32 %29, 1
  store i32 %30, ptr %1, align 4
  %31 = icmp slt i32 %30, 3
  br i1 %31, label %24, label %._crit_edge, !llvm.loop !9
...
32:                                               ; preds = %._crit_edge, %18
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %18 ]
  %33 = load i32, ptr %2, align 4
  %34 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %.lcssa, i32 noundef %33)
  %35 = load ptr, ptr @PtrGlb, align 8
  %36 = call i32 @Proc1(ptr noundef %35)
  %37 = load i8, ptr @Char2Glob, align 1
  %.not11 = icmp sgt i8 65, %37
  br i1 %.not11, label %48, label %.lr.ph4

.lr.ph4:                                          ; preds = %32
  br label %38

38:                                               ; preds = %.lr.ph4, %45
  %.012 = phi i8 [ 65, %.lr.ph4 ], [ %46, %45 ]
  %39 = sext i8 %.012 to i32
  %40 = load i32, ptr %3, align 4
  %41 = call i32 @Func1(i32 noundef %39, i32 noundef 67)
...
45:                                               ; preds = %43, %38
  ...
  %.not1 = icmp sgt i8 %46, %47
  br i1 %.not1, label %._crit_edge5, label %38, !llvm.loop !10

._crit_edge5:                                     ; preds = %45
  br label %48

48:                                               ; preds = %._crit_edge5, %32
  %49 = load i32, ptr %1, align 4
  %50 = mul nsw i32 %49, 3
  store i32 %50, ptr %2, align 4
  %51 = call i32 @Proc2(ptr noundef nonnull %1)
  %52 = add nuw nsw i32 %.16, 1
  %exitcond = icmp ne i32 %52, 100000000
  br i1 %exitcond, label %18, label %53, !llvm.loop !11
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %exitcond2 = icmp eq i64 %15, %wide.trip.count
  br i1 %exitcond2, label %20, label %.lr.ph

.lr.ph:                                           ; preds = %4
  br label %17

17:                                               ; preds = %.lr.ph, %17
  %indvars.iv3 = phi i64 [ %15, %.lr.ph ], [ %indvars.iv.next, %17 ]
  %18 = getelementptr inbounds [204 x i8], ptr %1, i64 %6
  %19 = getelementptr inbounds [4 x i8], ptr %18, i64 %indvars.iv3
  store i32 %5, ptr %19, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv3, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge, label %17, !llvm.loop !12
...
20:                                               ; preds = %._crit_edge, %4
  ...
  %22 = getelementptr [4 x i8], ptr %21, i64 %11
  %23 = getelementptr i8, ptr %22, i64 16
  %24 = load i32, ptr %23, align 4
  %25 = add nsw i32 %24, 1
  store i32 %25, ptr %23, align 4
  %26 = load i32, ptr %7, align 4
  %27 = getelementptr [204 x i8], ptr %1, i64 %11
  %28 = getelementptr i8, ptr %27, i64 5100
  %29 = getelementptr inbounds [4 x i8], ptr %28, i64 %6
