...
10:                                               ; preds = %7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %18, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #6
...
20:                                               ; preds = %10, %._crit_edge5
  %.16 = phi i32 [ 0, %10 ], [ %50, %._crit_edge5 ]
  %21 = call i32 @Proc5()
  %22 = call i32 @Proc4()
  ...
  %25 = icmp slt i32 %.pre, 3
  br i1 %25, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %20, %.lr.ph
  %26 = phi i32 [ %31, %.lr.ph ], [ %.pre, %20 ]
  %27 = mul nsw i32 %26, 5
  %28 = add nsw i32 %27, -3
...
.lr.ph4:                                          ; preds = %._crit_edge, %44
  %.012 = phi i8 [ %45, %44 ], [ 65, %._crit_edge ]
  %38 = sext i8 %.012 to i32
  %39 = load i32, ptr %3, align 4
  %40 = call i32 @Func1(i32 noundef %38, i32 noundef 67)
...
14:                                               ; preds = %4, %14
  ...
  %18 = add nsw i32 %.01, 1
  %.not = icmp sgt i32 %18, %8
  br i1 %.not, label %19, label %14, !llvm.loop !12
...
19:                                               ; preds = %14
  ...
  %26 = getelementptr [204 x i8], ptr %1, i64 %11
...
3:                                                ; preds = %2, %3
  ...
  %14 = icmp eq i32 %13, 0
  %spec.select = select i1 %14, i32 %8, i32 %.011
