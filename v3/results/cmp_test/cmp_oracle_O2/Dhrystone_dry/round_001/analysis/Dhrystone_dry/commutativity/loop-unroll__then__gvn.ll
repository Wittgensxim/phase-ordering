...
37:                                               ; preds = %34
  ...
  %40 = call i32 @Proc7(i32 noundef %35, i32 noundef 3, ptr noundef %2)
...
43:                                               ; preds = %34
  ...
  %45 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %35, i32 noundef %44)
...
53:                                               ; preds = %48
  ...
  %55 = call i32 @Func1(i32 noundef %49, i32 noundef 67)
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  br i1 true, label %14, label %._crit_edge
...
14:                                               ; preds = %4
  ...
  %16 = getelementptr inbounds [51 x i32], ptr %15, i64 0, i64 %6
  store i32 %5, ptr %16, align 4
  %17 = add nsw i32 %2, 6
  %18 = sext i32 %17 to i64
  %19 = getelementptr inbounds [51 x i32], ptr %15, i64 0, i64 %18
  store i32 %5, ptr %19, align 4
  %20 = add nsw i32 %2, 7
  br i1 false, label %21, label %._crit_edge1

._crit_edge1:                                     ; preds = %14
  br label %25

21:                                               ; preds = %14
  %.pre-phi = phi i64 [ %6, %14 ]
  %22 = getelementptr inbounds [51 x i32], ptr %1, i64 %.pre-phi
