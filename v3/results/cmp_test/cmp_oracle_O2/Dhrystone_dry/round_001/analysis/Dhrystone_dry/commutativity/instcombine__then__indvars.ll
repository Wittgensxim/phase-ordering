...
21:                                               ; preds = %59, %10
  %.1 = phi i32 [ 0, %10 ], [ %60, %59 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %22, label %61
...
30:                                               ; preds = %27
  ...
  %34 = call i32 @Proc7(i32 noundef %31, i32 noundef 3, ptr noundef nonnull %2)
...
20:                                               ; preds = %25, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %25 ], [ %18, %4 ]
