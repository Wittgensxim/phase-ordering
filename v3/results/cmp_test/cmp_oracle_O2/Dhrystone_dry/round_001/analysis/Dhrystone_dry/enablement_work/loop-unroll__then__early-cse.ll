...
26:                                               ; preds = %7
  ...
  %40 = call ptr @strcpy(ptr noundef %4, ptr noundef @.str.1) #5
  store i32 10, ptr getelementptr inbounds nuw (i8, ptr @Array2Glob, i64 1660), align 4
  %41 = call i32 @clock()
  br label %42

42:                                               ; preds = %85, %26
  %.1 = phi i32 [ 0, %26 ], [ %86, %85 ]
  %43 = icmp ult i32 %.1, 100000000
...
44:                                               ; preds = %42
  ...
  %47 = call ptr @strcpy(ptr noundef %5, ptr noundef @.str.2) #5
  store i32 10000, ptr %3, align 4
  %48 = call i32 @Func2(ptr noundef %4, ptr noundef %5)
  %49 = icmp ne i32 %48, 0
  %50 = xor i1 %49, true
...
62:                                               ; preds = %52
  ...
  %64 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %53, i32 noundef %63)
  %65 = load ptr, ptr @PtrGlb, align 8
  %66 = call i32 @Proc1(ptr noundef %65)
  br label %67

67:                                               ; preds = %79, %62
  %.01 = phi i8 [ 65, %62 ], [ %80, %79 ]
...
76:                                               ; preds = %72
  %77 = call i32 @Proc6(i32 noundef 0, ptr noundef %3)
  br label %78
...
81:                                               ; preds = %67
  ...
  %84 = call i32 @Proc2(ptr noundef %1)
  br label %85
...
14:                                               ; preds = %4
  br i1 true, label %15, label %29

15:                                               ; preds = %14
  %16 = getelementptr inbounds [51 x i32], ptr %1, i64 %6
  %17 = getelementptr inbounds [51 x i32], ptr %16, i64 0, i64 %6
...
20:                                               ; preds = %18
  ...
  %22 = getelementptr inbounds [51 x i32], ptr %16, i64 0, i64 %21
...
25:                                               ; preds = %23
  ...
  %27 = getelementptr inbounds [51 x i32], ptr %16, i64 0, i64 %26
...
29:                                               ; preds = %23, %14
  %30 = getelementptr inbounds [51 x i32], ptr %1, i64 %6
  %31 = sub nsw i32 %5, 1
  ...
  %40 = getelementptr inbounds [51 x i32], ptr %39, i64 0, i64 %6
