...
40:                                               ; preds = %._crit_edge, %23
  ...
  br i1 %47, label %.lr.ph7, label %61

.lr.ph7:                                          ; preds = %40
  br label %48

48:                                               ; preds = %.lr.ph7, %55
  %49 = phi i32 [ 65, %.lr.ph7 ], [ %57, %55 ]
  %.015 = phi i8 [ 65, %.lr.ph7 ], [ %56, %55 ]
...
55:                                               ; preds = %53, %48
  ...
  br i1 %60, label %48, label %._crit_edge8, !llvm.loop !10

._crit_edge8:                                     ; preds = %55
  br label %61

61:                                               ; preds = %._crit_edge8, %40
