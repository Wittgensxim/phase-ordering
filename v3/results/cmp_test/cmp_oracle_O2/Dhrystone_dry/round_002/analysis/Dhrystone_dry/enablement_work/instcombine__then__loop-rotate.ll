...
34:                                               ; preds = %._crit_edge, %20
  ...
  %.not12 = icmp sgt i8 65, %39
  br i1 %.not12, label %50, label %.lr.ph5

.lr.ph5:                                          ; preds = %34
  br label %40

40:                                               ; preds = %.lr.ph5, %47
  %.013 = phi i8 [ 65, %.lr.ph5 ], [ %48, %47 ]
  %41 = sext i8 %.013 to i32
...
47:                                               ; preds = %45, %40
  ...
  br i1 %.not1, label %._crit_edge6, label %40, !llvm.loop !10

._crit_edge6:                                     ; preds = %47
  br label %50

50:                                               ; preds = %._crit_edge6, %34
