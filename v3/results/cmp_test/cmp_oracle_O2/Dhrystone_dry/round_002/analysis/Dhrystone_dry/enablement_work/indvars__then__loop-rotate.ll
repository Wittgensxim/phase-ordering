...
38:                                               ; preds = %._crit_edge, %21
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %21 ]
  ...
  br i1 %45, label %.lr.ph3, label %59

.lr.ph3:                                          ; preds = %38
  br label %46

46:                                               ; preds = %.lr.ph3, %53
  %47 = phi i32 [ 65, %.lr.ph3 ], [ %55, %53 ]
  %.011 = phi i8 [ 65, %.lr.ph3 ], [ %54, %53 ]
...
53:                                               ; preds = %51, %46
  ...
  br i1 %58, label %46, label %._crit_edge4, !llvm.loop !10

._crit_edge4:                                     ; preds = %53
  br label %59

59:                                               ; preds = %._crit_edge4, %38
  %60 = load i32, ptr %1, align 4
  %61 = mul nsw i32 3, %60
  store i32 %61, ptr %2, align 4
  %62 = call i32 @Proc2(ptr noundef %1)
  %63 = add nuw nsw i32 %.15, 1
  %exitcond = icmp ne i32 %63, 100000000
  br i1 %exitcond, label %21, label %64, !llvm.loop !11
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  br i1 %17, label %.lr.ph, label %22

.lr.ph:                                           ; preds = %4
  br label %18

18:                                               ; preds = %.lr.ph, %18
  %indvars.iv2 = phi i64 [ %15, %.lr.ph ], [ %indvars.iv.next, %18 ]
  %19 = getelementptr inbounds [51 x i32], ptr %1, i64 %6
  %20 = getelementptr inbounds [51 x i32], ptr %19, i64 0, i64 %indvars.iv2
  store i32 %5, ptr %20, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv2, 1
  %21 = icmp sle i64 %indvars.iv.next, %16
  br i1 %21, label %18, label %._crit_edge, !llvm.loop !12
