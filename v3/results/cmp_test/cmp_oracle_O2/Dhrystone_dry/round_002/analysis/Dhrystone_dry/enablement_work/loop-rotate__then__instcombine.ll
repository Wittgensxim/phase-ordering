...
34:                                               ; preds = %._crit_edge, %20
  ...
  br i1 %40, label %.lr.ph3, label %52

.lr.ph3:                                          ; preds = %34
  br label %41

41:                                               ; preds = %.lr.ph3, %48
  %42 = phi i32 [ 65, %.lr.ph3 ], [ %50, %48 ]
  %.011 = phi i8 [ 65, %.lr.ph3 ], [ %49, %48 ]
...
48:                                               ; preds = %46, %41
  ...
  %.not6 = icmp sgt i8 %49, %51
  br i1 %.not6, label %._crit_edge4, label %41, !llvm.loop !10
...
52:                                               ; preds = %._crit_edge4, %34
  ...
  %57 = icmp samesign ult i32 %.15, 99999999
  br i1 %57, label %20, label %58, !llvm.loop !11
