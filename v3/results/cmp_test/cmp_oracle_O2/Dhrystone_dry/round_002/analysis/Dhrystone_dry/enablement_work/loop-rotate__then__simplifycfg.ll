...
23:                                               ; preds = %10, %._crit_edge4
  %.15 = phi i32 [ 0, %10 ], [ %61, %._crit_edge4 ]
  %24 = call i32 @Proc5()
  %25 = call i32 @Proc4()
...
._crit_edge:                                      ; preds = %.lr.ph, %23
  ...
  br i1 %45, label %.lr.ph3, label %._crit_edge4

.lr.ph3:                                          ; preds = %._crit_edge, %52
  %46 = phi i32 [ %54, %52 ], [ 65, %._crit_edge ]
  %.011 = phi i8 [ %53, %52 ], [ 65, %._crit_edge ]
...
52:                                               ; preds = %50, %.lr.ph3
  ...
  br i1 %57, label %.lr.ph3, label %._crit_edge4, !llvm.loop !10
...
._crit_edge4:                                     ; preds = %52, %._crit_edge
  ...
  br i1 %62, label %23, label %63, !llvm.loop !11

63:                                               ; preds = %._crit_edge4
  ret i32 undef
}
