...
23:                                               ; preds = %.lr.ph, %23
  %24 = phi i32 [ 1, %.lr.ph ], [ %36, %23 ]
  %25 = phi double [ 0.000000e+00, %.lr.ph ], [ %27, %23 ]
  %26 = phi double [ 0.000000e+00, %.lr.ph ], [ %35, %23 ]
  %27 = fadd double %25, %16
  %28 = fmul double %27, %17
  %29 = call double @llvm.fmuladd.f64(double %28, double %20, double %19)
  %30 = call double @llvm.fmuladd.f64(double %28, double %29, double %18)
  %31 = call double @llvm.fmuladd.f64(double %28, double %22, double %21)
  %32 = call double @llvm.fmuladd.f64(double %28, double %31, double %18)
  %33 = call double @llvm.fmuladd.f64(double %28, double %32, double %16)
  %34 = fdiv double %30, %33
  %35 = fadd double %26, %34
  %36 = add i32 %24, 1
  %exitcond = icmp ne i32 %36, 312500000
  br i1 %exitcond, label %23, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %23
  br label %37

37:                                               ; preds = %._crit_edge4, %._crit_edge
  %.lcssa6 = phi double [ %35, %._crit_edge ], [ poison, %._crit_edge4 ]
  %.lcssa4 = phi double [ %28, %._crit_edge ], [ poison, %._crit_edge4 ]
  %.lcssa2 = phi double [ %27, %._crit_edge ], [ poison, %._crit_edge4 ]
  ...
  %38 = fadd double %18, %19
  %39 = fadd double %38, %20
  %40 = fadd double %16, %18
  %41 = fadd double %40, %21
  %42 = fadd double %41, %22
  %43 = fdiv double %39, %42
  store double %43, ptr @sa, align 8
  store double %18, ptr @sb, align 8
  %44 = fadd double %43, %18
  %45 = load double, ptr @two, align 8
  %46 = call double @llvm.fmuladd.f64(double %45, double %.lcssa6, double %44)
  %47 = fmul double %17, %46
  %48 = fdiv double %47, %45
  store double %48, ptr @sa, align 8
  %49 = fdiv double %16, %48
  store double %49, ptr @sb, align 8
  %50 = fptosi double %49 to i32
  %51 = mul nsw i32 40000, %50
  %52 = sitofp i32 %51 to double
  %53 = load double, ptr @scale, align 8
  %54 = fdiv double %52, %53
  %55 = fptosi double %54 to i32
  store i32 %55, ptr %11, align 4
  %56 = fsub double %49, 2.520000e+01
