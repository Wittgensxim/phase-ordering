...
39:                                               ; preds = %44, %0
  %40 = phi double [ %53, %44 ], [ %.promoted5, %0 ]
  %41 = phi double [ %46, %44 ], [ %.promoted3, %0 ]
  %42 = phi double [ %45, %44 ], [ %.promoted1, %0 ]
  %43 = phi i32 [ %54, %44 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %43, %smax
  br i1 %exitcond, label %44, label %55
