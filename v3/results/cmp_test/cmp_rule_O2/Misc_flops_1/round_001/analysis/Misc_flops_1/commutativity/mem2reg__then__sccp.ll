...
15:                                               ; preds = %30, %0
  %16 = phi double [ %29, %30 ], [ 0.000000e+00, %0 ]
  %17 = phi double [ %22, %30 ], [ undef, %0 ]
  %18 = phi double [ %21, %30 ], [ 0.000000e+00, %0 ]
  %19 = phi i32 [ %31, %30 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %19, 312500000
  br i1 %exitcond, label %20, label %32

20:                                               ; preds = %15
  %21 = fadd double %18, %8
  %22 = fmul double %21, %7
  %23 = call double @llvm.fmuladd.f64(double %22, double %11, double %10)
  %24 = call double @llvm.fmuladd.f64(double %22, double %23, double %9)
...
32:                                               ; preds = %15
  %.lcssa6 = phi double [ %16, %15 ]
  %.lcssa4 = phi double [ %17, %15 ]
  %.lcssa2 = phi double [ %18, %15 ]
  ...
  %51 = call double @llvm.fmuladd.f64(double %50, double %.lcssa6, double %49)
  %52 = fmul double %7, %51
