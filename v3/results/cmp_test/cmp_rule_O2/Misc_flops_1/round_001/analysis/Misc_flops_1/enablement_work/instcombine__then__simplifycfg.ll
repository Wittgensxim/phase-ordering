...
20:                                               ; preds = %25, %0
  %21 = phi double [ %34, %25 ], [ %.promoted5, %0 ]
  %22 = phi double [ %27, %25 ], [ %.promoted3, %0 ]
  %23 = phi double [ %26, %25 ], [ %.promoted1, %0 ]
  %24 = phi i32 [ %35, %25 ], [ %.promoted, %0 ]
  %exitcond.not = icmp eq i32 %24, %smax
  br i1 %exitcond.not, label %36, label %25

25:                                               ; preds = %20
  %26 = fadd double %23, %11
  %27 = fmul double %26, %13
  %28 = call double @llvm.fmuladd.f64(double %27, double %17, double %16)
  %29 = call double @llvm.fmuladd.f64(double %27, double %28, double %15)
  %30 = call double @llvm.fmuladd.f64(double %27, double %19, double %18)
  %31 = call double @llvm.fmuladd.f64(double %27, double %30, double %15)
  %32 = call double @llvm.fmuladd.f64(double %27, double %31, double %11)
