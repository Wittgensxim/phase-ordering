...
15:                                               ; preds = %20, %0
  %16 = phi double [ %29, %20 ], [ 0.000000e+00, %0 ]
  %17 = phi double [ %22, %20 ], [ undef, %0 ]
  %18 = phi double [ %21, %20 ], [ 0.000000e+00, %0 ]
  %19 = phi i32 [ %30, %20 ], [ 1, %0 ]
  %exitcond.not = icmp eq i32 %19, 312500000
  br i1 %exitcond.not, label %31, label %20

20:                                               ; preds = %15
  %21 = fadd double %18, %8
  %22 = fmul double %21, %9
  %23 = call double @llvm.fmuladd.f64(double %22, double %12, double %11)
  %24 = call double @llvm.fmuladd.f64(double %22, double %23, double %10)
  %25 = call double @llvm.fmuladd.f64(double %22, double %14, double %13)
  %26 = call double @llvm.fmuladd.f64(double %22, double %25, double %10)
  %27 = call double @llvm.fmuladd.f64(double %22, double %26, double %8)
...
31:                                               ; preds = %15
  ...
  %32 = fadd double %10, %11
  %33 = fadd double %32, %12
  %34 = fadd double %8, %10
  %35 = fadd double %34, %13
  %36 = fadd double %35, %14
  %37 = fdiv double %33, %36
  store double %37, ptr @sa, align 8
  store double %10, ptr @sb, align 8
  %38 = fadd double %37, %10
  %39 = load double, ptr @two, align 8
  %40 = call double @llvm.fmuladd.f64(double %39, double %16, double %38)
  %41 = fmul double %9, %40
  ...
  %50 = fadd double %43, -2.520000e+01
