...
20:                                               ; preds = %.lr.ph, %33
  %21 = phi i32 [ 1, %.lr.ph ], [ %34, %33 ]
  %22 = phi double [ 0.000000e+00, %.lr.ph ], [ %24, %33 ]
  %23 = phi double [ 0.000000e+00, %.lr.ph ], [ %32, %33 ]
  %24 = fadd double %22, %13
  ...
  %29 = call double @llvm.fmuladd.f64(double %25, double %28, double %17)
  %30 = call double @llvm.fmuladd.f64(double %25, double %29, double %13)
...
33:                                               ; preds = %20
  %34 = add i32 %21, 1
  %exitcond = icmp ne i32 %34, %smax
  br i1 %exitcond, label %20, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %33
  %split = phi double [ %32, %33 ]
  %split2 = phi double [ %25, %33 ]
  %split3 = phi double [ %24, %33 ]
  br label %35

35:                                               ; preds = %._crit_edge, %0
  %.lcssa6 = phi double [ %split, %._crit_edge ], [ 0.000000e+00, %0 ]
  %.lcssa4 = phi double [ %split2, %._crit_edge ], [ undef, %0 ]
  %.lcssa2 = phi double [ %split3, %._crit_edge ], [ 0.000000e+00, %0 ]
  ...
  %54 = call double @llvm.fmuladd.f64(double %53, double %.lcssa6, double %52)
