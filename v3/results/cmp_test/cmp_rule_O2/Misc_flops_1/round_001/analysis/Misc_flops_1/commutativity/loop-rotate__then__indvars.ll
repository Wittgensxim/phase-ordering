...
define dso_local i32 @main() #0 {
  ...
  br i1 %exitcond1, label %.lr.ph, label %54

.lr.ph:                                           ; preds = %0
  br label %39

39:                                               ; preds = %.lr.ph, %52
  %40 = phi i32 [ %.promoted, %.lr.ph ], [ %53, %52 ]
  %41 = phi double [ %.promoted1, %.lr.ph ], [ %43, %52 ]
  %42 = phi double [ %.promoted5, %.lr.ph ], [ %51, %52 ]
...
52:                                               ; preds = %39
  %53 = add i32 %40, 1
  %exitcond = icmp ne i32 %53, %smax
  br i1 %exitcond, label %39, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %52
  %split = phi double [ %51, %52 ]
  %split2 = phi double [ %44, %52 ]
  %split3 = phi double [ %43, %52 ]
  br label %54
