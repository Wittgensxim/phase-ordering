...
define dso_local i32 @main() #0 {
  ...
  %smax = call i32 @llvm.smax.i32(i32 %.promoted, i32 %14)
  %exitcond.not5 = icmp eq i32 %.promoted, %smax
  br i1 %exitcond.not5, label %35, label %.lr.ph

.lr.ph:                                           ; preds = %0
  br label %20

20:                                               ; preds = %.lr.ph, %24
  %21 = phi i32 [ %.promoted, %.lr.ph ], [ %34, %24 ]
  %22 = phi double [ %.promoted1, %.lr.ph ], [ %25, %24 ]
  %23 = phi double [ %.promoted5, %.lr.ph ], [ %33, %24 ]
  br label %24

24:                                               ; preds = %20
  %25 = fadd double %22, %11
  %26 = fmul double %25, %13
  %27 = call double @llvm.fmuladd.f64(double %26, double %17, double %16)
  %28 = call double @llvm.fmuladd.f64(double %26, double %27, double %15)
  %29 = call double @llvm.fmuladd.f64(double %26, double %19, double %18)
  %30 = call double @llvm.fmuladd.f64(double %26, double %29, double %15)
  %31 = call double @llvm.fmuladd.f64(double %26, double %30, double %11)
...
._crit_edge:                                      ; preds = %24
  %split = phi double [ %33, %24 ]
  %split6 = phi double [ %26, %24 ]
  %split7 = phi double [ %25, %24 ]
  br label %35
