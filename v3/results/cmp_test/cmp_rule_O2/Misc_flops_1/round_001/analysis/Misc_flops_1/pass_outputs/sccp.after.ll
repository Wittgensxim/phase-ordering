...
39:                                               ; preds = %54, %0
  %40 = phi double [ %53, %54 ], [ %.promoted5, %0 ]
  %41 = phi double [ %46, %54 ], [ %.promoted3, %0 ]
  %42 = phi double [ %45, %54 ], [ %.promoted1, %0 ]
  %43 = phi i32 [ %55, %54 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %43, %smax
  br i1 %exitcond, label %44, label %56

44:                                               ; preds = %39
  %45 = fadd double %42, %30
  %46 = fmul double %45, %31
  %47 = call double @llvm.fmuladd.f64(double %46, double %34, double %33)
  %48 = call double @llvm.fmuladd.f64(double %46, double %47, double %32)
  %49 = call double @llvm.fmuladd.f64(double %46, double %38, double %37)
  %50 = call double @llvm.fmuladd.f64(double %46, double %49, double %36)
  %51 = call double @llvm.fmuladd.f64(double %46, double %50, double %35)
...
56:                                               ; preds = %39
  ...
  %77 = call double @llvm.fmuladd.f64(double %75, double %76, double %74)
  ...
  %92 = fsub double %91, 2.520000e+01
