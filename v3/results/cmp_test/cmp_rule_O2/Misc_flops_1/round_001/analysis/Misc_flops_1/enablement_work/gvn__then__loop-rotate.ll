...
23:                                               ; preds = %0, %23
  %24 = phi i32 [ 1, %0 ], [ %36, %23 ]
  %25 = phi double [ 0.000000e+00, %0 ], [ %27, %23 ]
  %26 = phi double [ 0.000000e+00, %0 ], [ %35, %23 ]
  ...
  br i1 %exitcond, label %23, label %37, !llvm.loop !7

37:                                               ; preds = %23
  %.lcssa2 = phi double [ %35, %23 ]
  %.lcssa1 = phi double [ %28, %23 ]
  %.lcssa = phi double [ %27, %23 ]
  ...
  %46 = call double @llvm.fmuladd.f64(double %45, double %.lcssa2, double %44)
