...
38:                                               ; preds = %.lr.ph, %51
  %39 = phi i32 [ %.promoted, %.lr.ph ], [ %52, %51 ]
  %40 = phi double [ %.promoted1, %.lr.ph ], [ %42, %51 ]
  %41 = phi double [ %.promoted5, %.lr.ph ], [ %50, %51 ]
  %42 = fadd double %40, %29
  %43 = fmul double %42, %30
  %44 = call double @llvm.fmuladd.f64(double %43, double %33, double %32)
  %45 = call double @llvm.fmuladd.f64(double %43, double %44, double %31)
  %46 = call double @llvm.fmuladd.f64(double %43, double %37, double %36)
  %47 = call double @llvm.fmuladd.f64(double %43, double %46, double %35)
  %48 = call double @llvm.fmuladd.f64(double %43, double %47, double %34)
...
51:                                               ; preds = %38
  ...
  br i1 %exitcond, label %38, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %51
  %split = phi double [ %50, %51 ]
  %split2 = phi double [ %43, %51 ]
  %split3 = phi double [ %42, %51 ]
  br label %53
