...
20:                                               ; preds = %34, %0
  %21 = phi double [ %33, %34 ], [ 0.000000e+00, %0 ]
  %22 = phi double [ %25, %34 ], [ 0.000000e+00, %0 ]
  %23 = phi i32 [ %35, %34 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %23, %smax
  br i1 %exitcond, label %24, label %36

24:                                               ; preds = %20
  %25 = fadd double %22, %13
  ...
  %30 = call double @llvm.fmuladd.f64(double %26, double %29, double %17)
  %31 = call double @llvm.fmuladd.f64(double %26, double %30, double %13)
...
36:                                               ; preds = %20
  ...
  %55 = call double @llvm.fmuladd.f64(double %54, double %.lcssa6, double %53)
