...
define dso_local i32 @main() #0 {
  ...
  %smax = call i32 @llvm.smax.i32(i32 1, i32 %9)
  br label %20

20:                                               ; preds = %35, %0
  %21 = phi double [ %34, %35 ], [ 0.000000e+00, %0 ]
  %22 = phi double [ %27, %35 ], [ undef, %0 ]
  %23 = phi double [ %26, %35 ], [ 0.000000e+00, %0 ]
  %24 = phi i32 [ %36, %35 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %24, %smax
  br i1 %exitcond, label %25, label %37

25:                                               ; preds = %20
  %26 = fadd double %23, %13
  %27 = fmul double %26, %12
  %28 = call double @llvm.fmuladd.f64(double %27, double %16, double %15)
  %29 = call double @llvm.fmuladd.f64(double %27, double %28, double %14)
  %30 = call double @llvm.fmuladd.f64(double %27, double %19, double %18)
  %31 = call double @llvm.fmuladd.f64(double %27, double %30, double %17)
  %32 = call double @llvm.fmuladd.f64(double %27, double %31, double %13)
...
37:                                               ; preds = %20
  ...
  %56 = call double @llvm.fmuladd.f64(double %55, double %.lcssa6, double %54)
  ...
  %65 = mul nsw i32 40000, %64
  %66 = sitofp i32 %65 to double
  %67 = load double, ptr @scale, align 8
  %68 = fdiv double %66, %67
  %69 = fptosi double %68 to i32
  %70 = load double, ptr @sb, align 8
  %71 = fsub double %70, 2.520000e+01
  store double %71, ptr @sc, align 8
