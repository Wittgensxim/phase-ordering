...
23:                                               ; preds = %28, %0
  %24 = phi double [ %37, %28 ], [ 0.000000e+00, %0 ]
  %25 = phi double [ %30, %28 ], [ undef, %0 ]
  %26 = phi double [ %29, %28 ], [ 0.000000e+00, %0 ]
  %27 = phi i32 [ %38, %28 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %27, 312500000
  br i1 %exitcond, label %28, label %39

28:                                               ; preds = %23
  %29 = fadd double %26, %16
  %30 = fmul double %29, %17
  %31 = call double @llvm.fmuladd.f64(double %30, double %20, double %19)
  %32 = call double @llvm.fmuladd.f64(double %30, double %31, double %18)
  %33 = call double @llvm.fmuladd.f64(double %30, double %22, double %21)
  %34 = call double @llvm.fmuladd.f64(double %30, double %33, double %18)
  %35 = call double @llvm.fmuladd.f64(double %30, double %34, double %16)
...
39:                                               ; preds = %23
  %.lcssa2 = phi double [ %24, %23 ]
  %.lcssa1 = phi double [ %25, %23 ]
  %.lcssa = phi double [ %26, %23 ]
