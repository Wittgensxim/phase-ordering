...
define dso_local i32 @main() #0 {
  ...
  %smax = call i32 @llvm.smax.i32(i32 %.promoted, i32 %28)
  br label %38

38:                                               ; preds = %53, %0
  %39 = phi double [ %52, %53 ], [ %.promoted5, %0 ]
  %40 = phi double [ %45, %53 ], [ %.promoted3, %0 ]
  %41 = phi double [ %44, %53 ], [ %.promoted1, %0 ]
  %42 = phi i32 [ %54, %53 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %42, %smax
  br i1 %exitcond, label %43, label %55

43:                                               ; preds = %38
  %44 = fadd double %41, %29
  %45 = fmul double %44, %30
  %46 = call double @llvm.fmuladd.f64(double %45, double %33, double %32)
  %47 = call double @llvm.fmuladd.f64(double %45, double %46, double %31)
  %48 = call double @llvm.fmuladd.f64(double %45, double %37, double %36)
  %49 = call double @llvm.fmuladd.f64(double %45, double %48, double %35)
  %50 = call double @llvm.fmuladd.f64(double %45, double %49, double %34)
...
55:                                               ; preds = %38
  ...
  %64 = load double, ptr @E2, align 8
  %65 = fadd double %63, %64
  %66 = load double, ptr @E3, align 8
  ...
  %91 = fsub double %90, 2.520000e+01
