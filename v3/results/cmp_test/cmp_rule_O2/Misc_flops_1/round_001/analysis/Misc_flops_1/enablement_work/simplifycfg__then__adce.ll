...
38:                                               ; preds = %43, %0
  %39 = phi double [ %52, %43 ], [ %.promoted5, %0 ]
  %40 = phi double [ %45, %43 ], [ %.promoted3, %0 ]
  %41 = phi double [ %44, %43 ], [ %.promoted1, %0 ]
  %42 = phi i32 [ %53, %43 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %42, %smax
  br i1 %exitcond, label %43, label %54
...
54:                                               ; preds = %38
  ...
  %90 = fsub double %89, 2.520000e+01
