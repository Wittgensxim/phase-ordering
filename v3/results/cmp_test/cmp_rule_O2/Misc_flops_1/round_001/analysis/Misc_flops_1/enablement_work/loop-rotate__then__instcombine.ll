...
define dso_local i32 @main() #0 {
  ...
  %exitcond1.not.not = icmp slt i32 %.promoted, %14
  br i1 %exitcond1.not.not, label %.lr.ph, label %35
...
35:                                               ; preds = %._crit_edge, %0
  %.lcssa6 = phi double [ %33, %._crit_edge ], [ %.promoted5, %0 ]
  %.lcssa4 = phi double [ %26, %._crit_edge ], [ %.promoted3, %0 ]
  %.lcssa2 = phi double [ %25, %._crit_edge ], [ %.promoted1, %0 ]
