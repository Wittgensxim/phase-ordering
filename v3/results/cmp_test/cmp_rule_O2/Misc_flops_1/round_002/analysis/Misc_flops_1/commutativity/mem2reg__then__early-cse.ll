...
13:                                               ; preds = %28, %0
  %14 = phi double [ %27, %28 ], [ 0.000000e+00, %0 ]
  %15 = phi double [ %20, %28 ], [ undef, %0 ]
  %16 = phi double [ %19, %28 ], [ 0.000000e+00, %0 ]
  %17 = phi i32 [ %29, %28 ], [ 1, %0 ]
...
18:                                               ; preds = %13
  %19 = fadd double %16, %6
  %20 = fmul double %19, %7
  %21 = call double @llvm.fmuladd.f64(double %20, double %10, double %9)
  %22 = call double @llvm.fmuladd.f64(double %20, double %21, double %8)
  %23 = call double @llvm.fmuladd.f64(double %20, double %12, double %11)
  %24 = call double @llvm.fmuladd.f64(double %20, double %23, double %8)
  %25 = call double @llvm.fmuladd.f64(double %20, double %24, double %6)
...
30:                                               ; preds = %13
  ...
  %47 = call double @llvm.fmuladd.f64(double %46, double %14, double %45)
  %48 = fmul double %7, %47
  ...
  %57 = fsub double %51, 2.520000e+01
