...
define dso_local i32 @main() #0 {
  ...
  %exitcond1.not = icmp slt i32 %13, 2
  br i1 %exitcond1.not, label %34, label %.lr.ph
...
34:                                               ; preds = %._crit_edge, %0
  %.lcssa2 = phi double [ %32, %._crit_edge ], [ %.promoted5, %0 ]
  %.lcssa1 = phi double [ %25, %._crit_edge ], [ %.promoted3, %0 ]
  %.lcssa = phi double [ %24, %._crit_edge ], [ %.promoted1, %0 ]
  store double %.lcssa, ptr %3, align 8
  store double %.lcssa1, ptr %2, align 8
  store double %.lcssa2, ptr %1, align 8
