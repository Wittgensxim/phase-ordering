...
8:                                                ; preds = %13, %0
  %9 = phi double [ %22, %13 ], [ 0.000000e+00, %0 ]
  %10 = phi double [ %14, %13 ], [ 0.000000e+00, %0 ]
  %11 = phi i32 [ %23, %13 ], [ 1, %0 ]
  %exitcond.not = icmp eq i32 %11, 312500000
  br i1 %exitcond.not, label %24, label %12
...
13:                                               ; preds = %12
  %14 = fadd double %10, %1
  %15 = fmul double %14, %2
  %16 = call double @llvm.fmuladd.f64(double %15, double %5, double %4)
  %17 = call double @llvm.fmuladd.f64(double %15, double %16, double %3)
  %18 = call double @llvm.fmuladd.f64(double %15, double %7, double %6)
  %19 = call double @llvm.fmuladd.f64(double %15, double %18, double %3)
  %20 = call double @llvm.fmuladd.f64(double %15, double %19, double %1)
...
24:                                               ; preds = %8
  ...
  %40 = call double @llvm.fmuladd.f64(double %39, double %9, double %38)
  %41 = fmul double %2, %40
  ...
  %45 = fadd double %44, -2.520000e+01
