...
17:                                               ; preds = %22, %0
  %18 = phi double [ %31, %22 ], [ 0.000000e+00, %0 ]
  %19 = phi double [ %24, %22 ], [ undef, %0 ]
  %20 = phi double [ %23, %22 ], [ 0.000000e+00, %0 ]
  %21 = phi i32 [ %32, %22 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %21, %smax
  br i1 %exitcond, label %22, label %33
...
33:                                               ; preds = %17
  ...
  %50 = call double @llvm.fmuladd.f64(double %49, double %.lcssa2, double %48)
