...
19:                                               ; preds = %25, %0
  %20 = phi double [ %34, %25 ], [ %.promoted5, %0 ]
  %21 = phi double [ %27, %25 ], [ %.promoted3, %0 ]
  %22 = phi double [ %26, %25 ], [ %.promoted1, %0 ]
  %23 = phi i32 [ %35, %25 ], [ 1, %0 ]
  %exitcond.not = icmp eq i32 %23, %smax
  br i1 %exitcond.not, label %36, label %24

24:                                               ; preds = %19
  br label %25

25:                                               ; preds = %24
  %26 = fadd double %22, %10
  ...
  %30 = call double @llvm.fmuladd.f64(double %27, double %18, double %17)
  %31 = call double @llvm.fmuladd.f64(double %27, double %30, double %14)
  %32 = call double @llvm.fmuladd.f64(double %27, double %31, double %10)
...
36:                                               ; preds = %19
  %.lcssa4 = phi double [ %20, %19 ]
  %.lcssa3 = phi double [ %21, %19 ]
  %.lcssa = phi double [ %22, %19 ]
  ...
  %66 = fadd double %65, -2.520000e+01
  store double %66, ptr @sc, align 8
  %67 = fmul double %66, 1.000000e-30
  %68 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %67, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
