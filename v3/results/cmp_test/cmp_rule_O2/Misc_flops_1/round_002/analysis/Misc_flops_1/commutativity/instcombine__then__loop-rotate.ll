...
define dso_local i32 @main() #0 {
  ...
  %exitcond.not5 = icmp eq i32 1, %smax
  br i1 %exitcond.not5, label %34, label %.lr.ph

.lr.ph:                                           ; preds = %0
  br label %19

19:                                               ; preds = %.lr.ph, %23
  %20 = phi i32 [ 1, %.lr.ph ], [ %33, %23 ]
  %21 = phi double [ %.promoted1, %.lr.ph ], [ %24, %23 ]
  %22 = phi double [ %.promoted5, %.lr.ph ], [ %32, %23 ]
  br label %23

23:                                               ; preds = %19
  %24 = fadd double %21, %10
  %25 = fmul double %24, %12
  %26 = call double @llvm.fmuladd.f64(double %25, double %16, double %15)
  %27 = call double @llvm.fmuladd.f64(double %25, double %26, double %14)
  %28 = call double @llvm.fmuladd.f64(double %25, double %18, double %17)
  %29 = call double @llvm.fmuladd.f64(double %25, double %28, double %14)
...
._crit_edge:                                      ; preds = %23
  %split = phi double [ %32, %23 ]
  %split6 = phi double [ %25, %23 ]
  %split7 = phi double [ %24, %23 ]
  br label %34

34:                                               ; preds = %._crit_edge, %0
  %.lcssa4 = phi double [ %split, %._crit_edge ], [ %.promoted5, %0 ]
  %.lcssa3 = phi double [ %split6, %._crit_edge ], [ %.promoted3, %0 ]
  %.lcssa = phi double [ %split7, %._crit_edge ], [ %.promoted1, %0 ]
  ...
  %64 = fadd double %63, -2.520000e+01
