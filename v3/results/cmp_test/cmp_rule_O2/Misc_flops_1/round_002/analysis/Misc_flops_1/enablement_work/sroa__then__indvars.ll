...
17:                                               ; preds = %31, %0
  %18 = phi double [ %30, %31 ], [ 0.000000e+00, %0 ]
  %19 = phi double [ %22, %31 ], [ 0.000000e+00, %0 ]
  %20 = phi i32 [ %32, %31 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %20, %smax
  br i1 %exitcond, label %21, label %33

21:                                               ; preds = %17
  %22 = fadd double %19, %11
  %23 = fmul double %22, %10
  %24 = call double @llvm.fmuladd.f64(double %23, double %14, double %13)
  %25 = call double @llvm.fmuladd.f64(double %23, double %24, double %12)
  %26 = call double @llvm.fmuladd.f64(double %23, double %16, double %15)
  %27 = call double @llvm.fmuladd.f64(double %23, double %26, double %12)
  %28 = call double @llvm.fmuladd.f64(double %23, double %27, double %11)
