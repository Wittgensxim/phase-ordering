...
define dso_local i32 @main() #0 {
  ...
  br i1 %exitcond1, label %.lr.ph, label %46
...
32:                                               ; preds = %.lr.ph, %32
  ...
  %34 = phi double [ %.promoted1, %.lr.ph ], [ %36, %32 ]
  %35 = phi double [ %.promoted5, %.lr.ph ], [ %44, %32 ]
  %36 = fadd double %34, %25
  %37 = fmul double %36, %26
  %38 = call double @llvm.fmuladd.f64(double %37, double %29, double %28)
  %39 = call double @llvm.fmuladd.f64(double %37, double %38, double %27)
  %40 = call double @llvm.fmuladd.f64(double %37, double %31, double %30)
  %41 = call double @llvm.fmuladd.f64(double %37, double %40, double %27)
  %42 = call double @llvm.fmuladd.f64(double %37, double %41, double %25)
  %43 = fdiv double %39, %42
  %44 = fadd double %35, %43
  %45 = add nuw i32 %33, 1
  %exitcond = icmp ne i32 %45, %smax
  br i1 %exitcond, label %32, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %32
  %split = phi double [ %44, %32 ]
  %split2 = phi double [ %37, %32 ]
  %split3 = phi double [ %36, %32 ]
  br label %46

46:                                               ; preds = %._crit_edge, %0
  %.lcssa2 = phi double [ %split, %._crit_edge ], [ %.promoted5, %0 ]
  %.lcssa1 = phi double [ %split2, %._crit_edge ], [ %.promoted3, %0 ]
  %.lcssa = phi double [ %split3, %._crit_edge ], [ %.promoted1, %0 ]
  ...
  %48 = load double, ptr @D2, align 8
  %49 = fadd double %47, %48
  %50 = load double, ptr @D3, align 8
  %51 = fadd double %49, %50
  %52 = load double, ptr @one, align 8
  %53 = fadd double %52, %47
  %54 = load double, ptr @E2, align 8
  %55 = fadd double %53, %54
  %56 = load double, ptr @E3, align 8
  ...
  %77 = fsub double %76, 2.520000e+01
