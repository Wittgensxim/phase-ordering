...
17:                                               ; preds = %32, %0
  %18 = phi double [ %31, %32 ], [ 0.000000e+00, %0 ]
  %19 = phi double [ %24, %32 ], [ undef, %0 ]
  %20 = phi double [ %23, %32 ], [ 0.000000e+00, %0 ]
  %21 = phi i32 [ %33, %32 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %21, %smax
  br i1 %exitcond, label %22, label %34

22:                                               ; preds = %17
  %23 = fadd double %11, %20
  %24 = fmul double %10, %23
  %25 = call double @llvm.fmuladd.f64(double %24, double %14, double %13)
  %26 = call double @llvm.fmuladd.f64(double %24, double %25, double %12)
  %27 = call double @llvm.fmuladd.f64(double %24, double %16, double %15)
  %28 = call double @llvm.fmuladd.f64(double %24, double %27, double %12)
  %29 = call double @llvm.fmuladd.f64(double %24, double %28, double %11)
...
34:                                               ; preds = %17
  %.lcssa2 = phi double [ %18, %17 ]
  %.lcssa1 = phi double [ %19, %17 ]
  %.lcssa = phi double [ %20, %17 ]
  ...
  %51 = call double @llvm.fmuladd.f64(double %50, double %.lcssa2, double %49)
  ...
  %57 = mul nsw i32 %56, 40000
  %58 = sitofp i32 %57 to double
  %59 = load double, ptr @scale, align 8
  %60 = fdiv double %58, %59
  %61 = fptosi double %60 to i32
  %62 = load double, ptr @sb, align 8
  %63 = fsub double %62, 2.520000e+01
  store double %63, ptr @sc, align 8
  %64 = fmul double %63, 1.000000e-30
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %64, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
