...
define dso_local i32 @main() #0 {
  ...
  br i1 %exitcond1, label %.lr.ph, label %47

.lr.ph:                                           ; preds = %0
  br label %32

32:                                               ; preds = %.lr.ph, %45
  %33 = phi i32 [ 1, %.lr.ph ], [ %46, %45 ]
  %34 = phi double [ %.promoted1, %.lr.ph ], [ %36, %45 ]
  %35 = phi double [ %.promoted5, %.lr.ph ], [ %44, %45 ]
...
._crit_edge:                                      ; preds = %45
  %split = phi double [ %44, %45 ]
  %split2 = phi double [ %37, %45 ]
  %split3 = phi double [ %36, %45 ]
  br label %47
...
47:                                               ; preds = %._crit_edge, %0
  ...
  %78 = fsub double %77, 2.520000e+01
