...
define dso_local i32 @main() #0 {
  ...
  %9 = load double, ptr @E2, align 8
  %10 = load double, ptr @E3, align 8
  %smax = call i32 @llvm.smax.i32(i32 %2, i32 1)
  br label %11

11:                                               ; preds = %17, %0
  %12 = phi double [ %26, %17 ], [ 0.000000e+00, %0 ]
  %13 = phi double [ %19, %17 ], [ undef, %0 ]
  %14 = phi double [ %18, %17 ], [ 0.000000e+00, %0 ]
  %15 = phi i32 [ %27, %17 ], [ 1, %0 ]
  %exitcond.not = icmp eq i32 %15, %smax
  br i1 %exitcond.not, label %28, label %16
...
17:                                               ; preds = %16
  %18 = fadd double %14, %3
  %19 = fmul double %18, %5
  %20 = call double @llvm.fmuladd.f64(double %19, double %8, double %7)
  %21 = call double @llvm.fmuladd.f64(double %19, double %20, double %6)
  %22 = call double @llvm.fmuladd.f64(double %19, double %10, double %9)
  %23 = call double @llvm.fmuladd.f64(double %19, double %22, double %6)
  %24 = call double @llvm.fmuladd.f64(double %19, double %23, double %3)
...
28:                                               ; preds = %11
  ...
  %44 = call double @llvm.fmuladd.f64(double %43, double %12, double %42)
  %45 = fmul double %5, %44
