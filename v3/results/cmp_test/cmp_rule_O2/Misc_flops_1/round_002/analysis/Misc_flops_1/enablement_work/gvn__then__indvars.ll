...
22:                                               ; preds = %27, %0
  %23 = phi double [ %36, %27 ], [ 0.000000e+00, %0 ]
  %24 = phi double [ %29, %27 ], [ undef, %0 ]
  %25 = phi double [ %28, %27 ], [ 0.000000e+00, %0 ]
  %26 = phi i32 [ %37, %27 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %26, 312500000
  br i1 %exitcond, label %27, label %38

27:                                               ; preds = %22
  %28 = fadd double %25, %15
  %29 = fmul double %28, %16
  %30 = call double @llvm.fmuladd.f64(double %29, double %19, double %18)
  %31 = call double @llvm.fmuladd.f64(double %29, double %30, double %17)
  %32 = call double @llvm.fmuladd.f64(double %29, double %21, double %20)
  %33 = call double @llvm.fmuladd.f64(double %29, double %32, double %17)
...
38:                                               ; preds = %22
  ...
  %.lcssa1 = phi double [ %24, %22 ]
  %.lcssa = phi double [ %25, %22 ]
  ...
  %39 = fadd double %17, %18
  %40 = fadd double %39, %19
  %41 = fadd double %15, %17
  %42 = fadd double %41, %20
  %43 = fadd double %42, %21
  %44 = fdiv double %40, %43
  store double %44, ptr @sa, align 8
  store double %17, ptr @sb, align 8
  %45 = fadd double %44, %17
  %46 = load double, ptr @two, align 8
  %47 = call double @llvm.fmuladd.f64(double %46, double %.lcssa2, double %45)
  ...
  %52 = mul nsw i32 40000, %51
  %53 = sitofp i32 %52 to double
  %54 = load double, ptr @scale, align 8
  %55 = fdiv double %53, %54
  %56 = fptosi double %55 to i32
  store i32 %56, ptr %10, align 4
  %57 = fsub double %50, 2.520000e+01
