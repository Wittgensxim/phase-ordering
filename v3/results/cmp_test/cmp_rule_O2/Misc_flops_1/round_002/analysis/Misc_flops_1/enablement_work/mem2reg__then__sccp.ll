...
14:                                               ; preds = %29, %0
  %15 = phi double [ %28, %29 ], [ 0.000000e+00, %0 ]
  %16 = phi double [ %21, %29 ], [ undef, %0 ]
...
19:                                               ; preds = %14
  ...
  %26 = call double @llvm.fmuladd.f64(double %21, double %25, double %8)
...
31:                                               ; preds = %14
  ...
  %.lcssa1 = phi double [ %16, %14 ]
  %.lcssa = phi double [ %17, %14 ]
  ...
  %60 = fsub double %59, 2.520000e+01
