...
22:                                               ; preds = %.lr.ph, %22
  %23 = phi i32 [ 1, %.lr.ph ], [ %35, %22 ]
  %24 = phi double [ 0.000000e+00, %.lr.ph ], [ %26, %22 ]
  %25 = phi double [ 0.000000e+00, %.lr.ph ], [ %34, %22 ]
  %26 = fadd double %24, %15
  %27 = fmul double %26, %16
  %28 = call double @llvm.fmuladd.f64(double %27, double %19, double %18)
  %29 = call double @llvm.fmuladd.f64(double %27, double %28, double %17)
  %30 = call double @llvm.fmuladd.f64(double %27, double %21, double %20)
  %31 = call double @llvm.fmuladd.f64(double %27, double %30, double %17)
  %32 = call double @llvm.fmuladd.f64(double %27, double %31, double %15)
  %33 = fdiv double %29, %32
  %34 = fadd double %25, %33
  %35 = add nuw i32 %23, 1
  %exitcond = icmp ne i32 %35, 312500000
  br i1 %exitcond, label %22, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %22
  br label %36

36:                                               ; preds = %._crit_edge4, %._crit_edge
  %.lcssa2 = phi double [ %34, %._crit_edge ], [ poison, %._crit_edge4 ]
  %.lcssa1 = phi double [ %27, %._crit_edge ], [ poison, %._crit_edge4 ]
  %.lcssa = phi double [ %26, %._crit_edge ], [ poison, %._crit_edge4 ]
  store i32 312500000, ptr %9, align 4
  store double %.lcssa, ptr %4, align 8
  store double %.lcssa1, ptr %3, align 8
  store double %.lcssa2, ptr %2, align 8
  %37 = fadd double %17, %18
  %38 = fadd double %37, %19
  %39 = fadd double %15, %17
  %40 = fadd double %39, %20
  %41 = fadd double %40, %21
  %42 = fdiv double %38, %41
  store double %42, ptr @sa, align 8
  store double %17, ptr @sb, align 8
  %43 = fadd double %42, %17
  %44 = load double, ptr @two, align 8
  %45 = call double @llvm.fmuladd.f64(double %44, double %.lcssa2, double %43)
  %46 = fmul double %16, %45
  %47 = fdiv double %46, %44
  store double %47, ptr @sa, align 8
  %48 = fdiv double %15, %47
  store double %48, ptr @sb, align 8
  %49 = fptosi double %48 to i32
  %50 = mul nsw i32 40000, %49
  %51 = sitofp i32 %50 to double
  %52 = load double, ptr @scale, align 8
  %53 = fdiv double %51, %52
  %54 = fptosi double %53 to i32
  store i32 %54, ptr %10, align 4
  %55 = fsub double %48, 2.520000e+01
