...
26:                                               ; preds = %68, %15
  %storemerge2.lcssa6 = phi i8 [ %.promoted5, %15 ], [ %storemerge2.lcssa, %68 ]
  %27 = phi i32 [ %.promoted, %15 ], [ %66, %68 ]
  %storemerge1 = phi i32 [ 0, %15 ], [ %69, %68 ]
...
37:                                               ; preds = %34
  ...
  %41 = call i32 @Proc7(i32 noundef %40, i32 noundef 3, ptr noundef nonnull %3)
...
49:                                               ; preds = %59, %44
  %storemerge2 = phi i8 [ 65, %44 ], [ %60, %59 ]
...
61:                                               ; preds = %49
  %storemerge2.lcssa = phi i8 [ %storemerge2, %49 ]
...
68:                                               ; preds = %61
  %69 = add i32 %storemerge1, 1
  br label %26, !llvm.loop !11

70:                                               ; preds = %26
  %storemerge2.lcssa6.lcssa = phi i8 [ %storemerge2.lcssa6, %26 ]
  %.lcssa4 = phi i32 [ %27, %26 ]
  %storemerge1.lcssa = phi i32 [ %storemerge1, %26 ]
  store i32 %storemerge1.lcssa, ptr %8, align 4
  store i32 %.lcssa4, ptr %2, align 4
  store i8 %storemerge2.lcssa6.lcssa, ptr %4, align 1
  ret i32 undef
}
