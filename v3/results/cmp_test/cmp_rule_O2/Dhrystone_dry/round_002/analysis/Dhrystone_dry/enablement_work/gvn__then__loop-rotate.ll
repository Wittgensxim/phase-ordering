...
41:                                               ; preds = %.lr.ph, %41
  ...
  br i1 %48, label %41, label %._crit_edge, !llvm.loop !9
...
49:                                               ; preds = %._crit_edge, %31
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %31 ]
...
57:                                               ; preds = %.lr.ph2, %65
  %58 = phi i32 [ 65, %.lr.ph2 ], [ %67, %65 ]
  %59 = phi i8 [ 65, %.lr.ph2 ], [ %66, %65 ]
...
63:                                               ; preds = %57
  %64 = call i32 @Proc6(i32 noundef 0, ptr noundef %6)
  br label %65
...
65:                                               ; preds = %63, %57
  ...
  br i1 %70, label %57, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %65
  br label %71

71:                                               ; preds = %._crit_edge3, %49
  ...
  %79 = icmp ult i32 %78, 100000000
  br i1 %79, label %31, label %80, !llvm.loop !11
...
23:                                               ; preds = %22, %8
  %24 = phi i8 [ 65, %22 ], [ %10, %8 ]
  %25 = phi i32 [ %15, %22 ], [ %9, %8 ]
...
33:                                               ; preds = %32, %30, %27
  %34 = phi i32 [ 7, %32 ], [ %.lcssa, %30 ], [ %.lcssa, %27 ]
