...
11:                                               ; preds = %10
  ...
  %13 = icmp samesign ult i32 %12, 100000000
  br i1 %13, label %10, label %14, !llvm.loop !7
...
25:                                               ; preds = %14, %72
  ...
  br i1 %32, label %.lr.ph, label %46

.lr.ph:                                           ; preds = %25
  br label %33

33:                                               ; preds = %.lr.ph, %33
  %34 = phi i32 [ %31, %.lr.ph ], [ %44, %33 ]
  %35 = phi i32 [ %30, %.lr.ph ], [ %43, %33 ]
  %36 = mul nsw i32 %35, 5
  ...
  br i1 %45, label %33, label %._crit_edge, !llvm.loop !9
...
46:                                               ; preds = %._crit_edge, %25
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %30, %25 ]
  ...
  %.not35 = icmp sgt i8 65, %51
  br i1 %.not35, label %64, label %.lr.ph8

.lr.ph8:                                          ; preds = %46
  br label %52

52:                                               ; preds = %.lr.ph8, %60
  %storemerge26 = phi i8 [ 65, %.lr.ph8 ], [ %62, %60 ]
  %53 = sext i8 %storemerge26 to i32
...
60:                                               ; preds = %59
  ...
  br i1 %.not3, label %._crit_edge9, label %52, !llvm.loop !10

._crit_edge9:                                     ; preds = %60
  br label %64

64:                                               ; preds = %._crit_edge9, %46
