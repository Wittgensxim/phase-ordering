...
20:                                               ; preds = %._crit_edge, %0
  ...
  br i1 %39, label %.lr.ph8, label %105
...
40:                                               ; preds = %.lr.ph8, %89
  ...
  br i1 %50, label %.lr.ph2, label %64

.lr.ph2:                                          ; preds = %40
  br label %51

51:                                               ; preds = %.lr.ph2, %51
  %52 = phi i32 [ %49, %.lr.ph2 ], [ %62, %51 ]
  %53 = phi i32 [ %48, %.lr.ph2 ], [ %61, %51 ]
  %54 = mul nsw i32 5, %53
  %55 = sub nsw i32 %54, %52
  store i32 %55, ptr %4, align 4
  %56 = load i32, ptr %2, align 4
  %57 = load i32, ptr %3, align 4
  %58 = call i32 @Proc7(i32 noundef %56, i32 noundef %57, ptr noundef %4)
  ...
  br i1 %63, label %51, label %._crit_edge3, !llvm.loop !9
...
64:                                               ; preds = %._crit_edge3, %40
  %.lcssa = phi i32 [ %split, %._crit_edge3 ], [ %48, %40 ]
  ...
  br i1 %73, label %.lr.ph5, label %89

.lr.ph5:                                          ; preds = %64
  br label %74

74:                                               ; preds = %.lr.ph5, %81
  %75 = phi i32 [ %70, %.lr.ph5 ], [ %85, %81 ]
  %76 = load i32, ptr %6, align 4
  %77 = call i32 @Func1(i32 noundef %75, i32 noundef 67)
  %78 = icmp eq i32 %76, %77
  br i1 %78, label %79, label %81

79:                                               ; preds = %74
  %80 = call i32 @Proc6(i32 noundef 0, ptr noundef %6)
  br label %81
...
81:                                               ; preds = %74, %79
  ...
  %86 = load i8, ptr @Char2Glob, align 1
  %87 = sext i8 %86 to i32
  %88 = icmp sle i32 %85, %87
  br i1 %88, label %74, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %81
  br label %89

89:                                               ; preds = %._crit_edge6, %64
  ...
  %104 = icmp ult i32 %103, 100000000
  br i1 %104, label %40, label %._crit_edge9, !llvm.loop !11

._crit_edge9:                                     ; preds = %89
  br label %105

105:                                              ; preds = %._crit_edge9, %20
...
36:                                               ; preds = %.lr.ph, %36
  %37 = phi i32 [ %33, %.lr.ph ], [ %47, %36 ]
  %38 = phi i32 [ %32, %.lr.ph ], [ %46, %36 ]
  ...
  br i1 %49, label %36, label %._crit_edge, !llvm.loop !12
