...
.lr.ph8:                                          ; preds = %._crit_edge, %._crit_edge6
  ...
  %40 = call ptr @strcpy(ptr noundef %8, ptr noundef @.str.2) #5
...
.lr.ph2:                                          ; preds = %.lr.ph8, %.lr.ph2
  %48 = phi i32 [ %58, %.lr.ph2 ], [ %46, %.lr.ph8 ]
  %49 = phi i32 [ %57, %.lr.ph2 ], [ %45, %.lr.ph8 ]
  %50 = mul nsw i32 5, %49
  ...
  br i1 %59, label %.lr.ph2, label %._crit_edge3, !llvm.loop !9

._crit_edge3:                                     ; preds = %.lr.ph2, %.lr.ph8
  %.lcssa = phi i32 [ %45, %.lr.ph8 ], [ %57, %.lr.ph2 ]
  ...
  br i1 %68, label %.lr.ph5, label %._crit_edge6

.lr.ph5:                                          ; preds = %._crit_edge3, %75
  %69 = phi i32 [ %79, %75 ], [ %65, %._crit_edge3 ]
  %70 = load i32, ptr %6, align 4
  %71 = call i32 @Func1(i32 noundef %69, i32 noundef 67)
...
75:                                               ; preds = %.lr.ph5, %73
  ...
  br i1 %82, label %.lr.ph5, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %75, %._crit_edge3
  ...
  br i1 %97, label %.lr.ph8, label %._crit_edge9, !llvm.loop !11
...
.lr.ph:                                           ; preds = %4, %.lr.ph
  %36 = phi i32 [ %46, %.lr.ph ], [ %33, %4 ]
  %37 = phi i32 [ %45, %.lr.ph ], [ %32, %4 ]
...
._crit_edge:                                      ; preds = %.lr.ph, %4
  %.lcssa = phi i32 [ %33, %4 ], [ %46, %.lr.ph ]
  %49 = load ptr, ptr %7, align 8
  %50 = sext i32 %.lcssa to i64
  %51 = getelementptr inbounds [51 x i32], ptr %49, i64 %50
  %52 = sub nsw i32 %.lcssa, 1
  %53 = sext i32 %52 to i64
  %54 = getelementptr inbounds [51 x i32], ptr %51, i64 0, i64 %53
  ...
  %63 = add nsw i32 %58, 20
  %64 = sext i32 %63 to i64
  %65 = getelementptr inbounds [51 x i32], ptr %62, i64 %64
  %66 = getelementptr inbounds [51 x i32], ptr %65, i64 0, i64 %59
