...
16:                                               ; preds = %15
  %17 = add nuw nsw i32 %storemerge, 2
...
19:                                               ; preds = %18
  %20 = add nuw nsw i32 %storemerge, 3
...
22:                                               ; preds = %21
  %23 = add nuw nsw i32 %storemerge, 4
...
35:                                               ; preds = %80, %24
  %storemerge1 = phi i32 [ 0, %24 ], [ %82, %80 ]
  store i32 %storemerge1, ptr %8, align 4
  %36 = icmp ult i32 %storemerge1, 100000000
...
37:                                               ; preds = %35
  ...
  %40 = call i32 @Func2(ptr noundef nonnull %6, ptr noundef nonnull %7)
...
46:                                               ; preds = %42
  ...
  %51 = call i32 @Proc7(i32 noundef %49, i32 noundef %50, ptr noundef nonnull %3)
...
59:                                               ; preds = %69, %54
  %storemerge2 = phi i8 [ 65, %54 ], [ %71, %69 ]
  store i8 %storemerge2, ptr %4, align 1
  %60 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %60
  br i1 %.not3, label %72, label %61

61:                                               ; preds = %59
  %62 = sext i8 %storemerge2 to i32
...
66:                                               ; preds = %61
  %67 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %5)
  br label %68
