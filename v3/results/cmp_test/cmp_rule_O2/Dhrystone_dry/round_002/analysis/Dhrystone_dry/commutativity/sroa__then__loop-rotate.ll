...
48:                                               ; preds = %._crit_edge, %28
  ...
  br i1 %55, label %.lr.ph14, label %70

.lr.ph14:                                         ; preds = %48
  br label %56

56:                                               ; preds = %.lr.ph14, %64
  %57 = phi i32 [ 65, %.lr.ph14 ], [ %66, %64 ]
  %.01012 = phi i8 [ 65, %.lr.ph14 ], [ %65, %64 ]
...
64:                                               ; preds = %63
  ...
  br i1 %69, label %56, label %._crit_edge15, !llvm.loop !10

._crit_edge15:                                    ; preds = %64
  br label %70
...
25:                                               ; preds = %24, %22, %19
  %.2 = phi i32 [ 7, %24 ], [ %.09.lcssa, %22 ], [ %.09.lcssa, %19 ]
