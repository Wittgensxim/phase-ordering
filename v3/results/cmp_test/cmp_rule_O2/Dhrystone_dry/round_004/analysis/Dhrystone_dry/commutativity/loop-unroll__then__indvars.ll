...
35:                                               ; preds = %72, %24
  %storemerge1 = phi i32 [ 0, %24 ], [ %73, %72 ]
  %exitcond = icmp ne i32 %storemerge1, 100000000
  br i1 %exitcond, label %36, label %74
...
44:                                               ; preds = %41
  ...
  %48 = call i32 @Proc7(i32 noundef %47, i32 noundef 3, ptr noundef nonnull %2)
...
51:                                               ; preds = %41
  ...
  %53 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %.lcssa, i32 noundef %52)
  %54 = load ptr, ptr @PtrGlb, align 8
  %55 = call i32 @Proc1(ptr noundef %54)
  br label %56

56:                                               ; preds = %66, %51
  %storemerge2 = phi i8 [ 65, %51 ], [ %67, %66 ]
  %57 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %57
  br i1 %.not3, label %68, label %58

58:                                               ; preds = %56
  %59 = sext i8 %storemerge2 to i32
...
72:                                               ; preds = %68
  %73 = add nuw nsw i32 %storemerge1, 1
...
26:                                               ; preds = %23
  %27 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #5
