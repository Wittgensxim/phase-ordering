...
8:                                                ; preds = %7
  ...
  %exitcond.not = icmp eq i32 %9, 100000000
...
21:                                               ; preds = %10, %58
  %storemerge19 = phi i32 [ 0, %10 ], [ %59, %58 ]
  %22 = call i32 @Proc5()
  %23 = call i32 @Proc4()
...
28:                                               ; preds = %.lr.ph, %28
  ...
  br i1 %36, label %28, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %28
  br label %37

37:                                               ; preds = %._crit_edge, %21
  %.lcssa = phi i32 [ %35, %._crit_edge ], [ %26, %21 ]
...
58:                                               ; preds = %54
  ...
  %60 = icmp samesign ult i32 %storemerge19, 99999999
...
23:                                               ; preds = %18
  ...
  %.not.not = icmp slt i32 %storemerge1, %17
  br i1 %.not.not, label %18, label %25, !llvm.loop !12
