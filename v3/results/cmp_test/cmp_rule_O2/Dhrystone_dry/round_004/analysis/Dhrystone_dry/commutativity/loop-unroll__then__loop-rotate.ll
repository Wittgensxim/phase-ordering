...
22:                                               ; preds = %21
  %23 = add nuw nsw i32 %storemerge3, 8
  %exitcond = icmp ne i32 %23, 100000000
  br i1 %exitcond, label %7, label %24, !llvm.loop !7
...
24:                                               ; preds = %22
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %33, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #5
...
35:                                               ; preds = %24, %73
  %storemerge19 = phi i32 [ 0, %24 ], [ %74, %73 ]
  %36 = call i32 @Proc5()
  %37 = call i32 @Proc4()
  ...
  %38 = call i32 @Func2(ptr noundef nonnull %4, ptr noundef nonnull %5)
  %.not = icmp eq i32 %38, 0
  %39 = zext i1 %.not to i32
  store i32 %39, ptr @BoolGlob, align 4
  %40 = load i32, ptr %1, align 4
  %41 = icmp slt i32 %40, 3
  br i1 %41, label %.lr.ph, label %52

.lr.ph:                                           ; preds = %35
  br label %42

42:                                               ; preds = %.lr.ph, %42
  %43 = phi i32 [ %40, %.lr.ph ], [ %50, %42 ]
  %44 = mul nsw i32 %43, 5
  %45 = sub nsw i32 %44, 3
  store i32 %45, ptr %2, align 4
  %46 = load i32, ptr %1, align 4
  %47 = call i32 @Proc7(i32 noundef %46, i32 noundef 3, ptr noundef nonnull %2)
  %48 = load i32, ptr %1, align 4
  %49 = add nsw i32 %48, 1
  store i32 %49, ptr %1, align 4
  %50 = load i32, ptr %1, align 4
  %51 = icmp slt i32 %50, 3
  br i1 %51, label %42, label %._crit_edge, !llvm.loop !9
...
52:                                               ; preds = %._crit_edge, %35
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %40, %35 ]
  ...
  %.not34 = icmp sgt i8 65, %57
  br i1 %.not34, label %69, label %.lr.ph7

.lr.ph7:                                          ; preds = %52
  br label %58

58:                                               ; preds = %.lr.ph7, %66
  %storemerge25 = phi i8 [ 65, %.lr.ph7 ], [ %67, %66 ]
  %59 = sext i8 %storemerge25 to i32
  %60 = load i32, ptr %3, align 4
  %61 = call i32 @Func1(i32 noundef %59, i32 noundef 67)
...
66:                                               ; preds = %65
  %67 = add i8 %storemerge25, 1
  %68 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %67, %68
  br i1 %.not3, label %._crit_edge8, label %58, !llvm.loop !10

._crit_edge8:                                     ; preds = %66
  br label %69

69:                                               ; preds = %._crit_edge8, %52
...
73:                                               ; preds = %69
  %74 = add i32 %storemerge19, 1
  %75 = icmp ult i32 %74, 100000000
  br i1 %75, label %35, label %76, !llvm.loop !11
...
25:                                               ; preds = %23
  ...
  %27 = getelementptr inbounds [204 x i8], ptr %1, i64 %26
...
32:                                               ; preds = %30
  ...
  %34 = getelementptr inbounds [204 x i8], ptr %1, i64 %33
...
38:                                               ; preds = %30, %17
  ...
  %40 = getelementptr inbounds [204 x i8], ptr %1, i64 %39
  ...
  %50 = getelementptr [204 x i8], ptr %1, i64 %49
  %51 = getelementptr i8, ptr %50, i64 4080
  %52 = getelementptr inbounds [4 x i8], ptr %51, i64 %46
