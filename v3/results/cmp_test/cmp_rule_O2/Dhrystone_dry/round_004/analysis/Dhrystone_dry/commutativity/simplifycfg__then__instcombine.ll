...
7:                                                ; preds = %8, %0
  ...
  br i1 %exitcond.not, label %10, label %8
...
21:                                               ; preds = %54, %10
  %storemerge1 = phi i32 [ 0, %10 ], [ %58, %54 ]
  %22 = icmp samesign ult i32 %storemerge1, 100000000
...
38:                                               ; preds = %28
  ...
  %40 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %29, i32 noundef %39)
...
54:                                               ; preds = %43
  ...
  %58 = add nuw nsw i32 %storemerge1, 1
...
5:                                                ; preds = %3
  ...
  %spec.select = add nuw nsw i32 %.01, %17
