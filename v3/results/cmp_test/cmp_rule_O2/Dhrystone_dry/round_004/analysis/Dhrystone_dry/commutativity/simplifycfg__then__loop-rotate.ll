...
20:                                               ; preds = %9, %53
  %storemerge16 = phi i32 [ 0, %9 ], [ %57, %53 ]
  %21 = call i32 @Proc5()
  %22 = call i32 @Proc4()
...
37:                                               ; preds = %._crit_edge, %20
  ...
  br i1 %.not31, label %53, label %.lr.ph4

.lr.ph4:                                          ; preds = %37
  br label %43

43:                                               ; preds = %.lr.ph4, %50
  %storemerge22 = phi i8 [ 65, %.lr.ph4 ], [ %51, %50 ]
  %44 = sext i8 %storemerge22 to i32
...
50:                                               ; preds = %43, %48
  %51 = add i8 %storemerge22, 1
  %52 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %51, %52
  br i1 %.not3, label %._crit_edge5, label %43, !llvm.loop !10

._crit_edge5:                                     ; preds = %50
  br label %53

53:                                               ; preds = %._crit_edge5, %37
  %54 = load i32, ptr %1, align 4
  %55 = mul nsw i32 3, %54
  store i32 %55, ptr %2, align 4
  %56 = call i32 @Proc2(ptr noundef nonnull %1)
  %57 = add i32 %storemerge16, 1
  %58 = icmp ult i32 %57, 100000000
  br i1 %58, label %20, label %59, !llvm.loop !11
