...
21:                                               ; preds = %58, %10
  ...
  %exitcond.not = icmp eq i32 %storemerge1, 100000000
  br i1 %exitcond.not, label %60, label %22
...
37:                                               ; preds = %27
  ...
  %39 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %28, i32 noundef %38)
...
19:                                               ; preds = %26, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %26 ], [ %18, %4 ]
  %20 = add nsw i32 %2, 6
