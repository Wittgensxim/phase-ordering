...
19:                                               ; preds = %56, %8
  %storemerge1 = phi i32 [ 0, %8 ], [ %57, %56 ]
  %exitcond = icmp ne i32 %storemerge1, 100000000
  br i1 %exitcond, label %20, label %58
...
40:                                               ; preds = %50, %35
  %storemerge2 = phi i8 [ 65, %35 ], [ %51, %50 ]
  %41 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %41
  br i1 %.not3, label %52, label %42

42:                                               ; preds = %40
  %43 = sext i8 %storemerge2 to i32
  %44 = load i32, ptr %3, align 4
  %45 = call i32 @Func1(i32 noundef %43, i32 noundef 67)
...
56:                                               ; preds = %52
  %57 = add nuw nsw i32 %storemerge1, 1
