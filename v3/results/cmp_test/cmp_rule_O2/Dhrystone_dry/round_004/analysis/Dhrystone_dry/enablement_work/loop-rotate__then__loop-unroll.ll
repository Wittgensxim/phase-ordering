...
17:                                               ; preds = %16
  %18 = add nuw nsw i32 %storemerge3, 10
  %exitcond.9 = icmp ne i32 %18, 100000000
  br i1 %exitcond.9, label %7, label %19, !llvm.loop !7
...
19:                                               ; preds = %17
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %28, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #5
...
30:                                               ; preds = %19, %68
  %storemerge19 = phi i32 [ 0, %19 ], [ %69, %68 ]
  %31 = call i32 @Proc5()
  %32 = call i32 @Proc4()
...
37:                                               ; preds = %.lr.ph, %37
  ...
  %42 = call i32 @Proc7(i32 noundef %41, i32 noundef 3, ptr noundef nonnull %2)
...
47:                                               ; preds = %._crit_edge, %30
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %35, %30 ]
  ...
  %.not34 = icmp sgt i8 65, %52
  br i1 %.not34, label %64, label %.lr.ph7

.lr.ph7:                                          ; preds = %47
  br label %53

53:                                               ; preds = %.lr.ph7, %61
  %storemerge25 = phi i8 [ 65, %.lr.ph7 ], [ %62, %61 ]
  %54 = sext i8 %storemerge25 to i32
...
61:                                               ; preds = %60
  %62 = add i8 %storemerge25, 1
  %63 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %62, %63
  br i1 %.not3, label %._crit_edge8, label %53, !llvm.loop !10

._crit_edge8:                                     ; preds = %61
  br label %64

64:                                               ; preds = %._crit_edge8, %47
...
68:                                               ; preds = %64
  %69 = add i32 %storemerge19, 1
  %70 = icmp ult i32 %69, 100000000
  br i1 %70, label %30, label %71, !llvm.loop !11
...
31:                                               ; preds = %30, %23
  %.lcssa = phi i32 [ %5, %23 ], [ %5, %30 ]
  %32 = sext i32 %.lcssa to i64
  %33 = getelementptr inbounds [204 x i8], ptr %1, i64 %32
  ...
  %43 = getelementptr [204 x i8], ptr %1, i64 %42
  %44 = getelementptr i8, ptr %43, i64 4080
