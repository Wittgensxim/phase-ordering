...
21:                                               ; preds = %58, %10
  %storemerge1 = phi i32 [ 0, %10 ], [ %59, %58 ]
...
42:                                               ; preds = %52, %37
  %storemerge2 = phi i8 [ 65, %37 ], [ %53, %52 ]
  %43 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %43
  br i1 %.not3, label %54, label %44

44:                                               ; preds = %42
  %45 = sext i8 %storemerge2 to i32
...
58:                                               ; preds = %54
  %59 = add nuw nsw i32 %storemerge1, 1
...
19:                                               ; preds = %4
  ...
  %.not = icmp sgt i64 %18, %21
  br i1 %.not, label %39, label %22

22:                                               ; preds = %19
  %23 = sext i32 %5 to i64
  %24 = getelementptr inbounds [204 x i8], ptr %1, i64 %23
  %25 = getelementptr inbounds [4 x i8], ptr %24, i64 %18
  store i32 %5, ptr %25, align 4
  br label %26

26:                                               ; preds = %22
  %indvars.iv.next = add nsw i64 %17, 6
  br label %27

27:                                               ; preds = %26
  %28 = sext i32 %5 to i64
  %29 = getelementptr inbounds [204 x i8], ptr %1, i64 %28
  %30 = getelementptr inbounds [4 x i8], ptr %29, i64 %indvars.iv.next
  store i32 %5, ptr %30, align 4
  br label %31

31:                                               ; preds = %27
  %indvars.iv.next.1 = add nsw i64 %17, 7
  %32 = add nsw i32 %2, 6
  %33 = sext i32 %32 to i64
  %.not.2 = icmp sgt i64 %indvars.iv.next.1, %33
  br i1 %.not.2, label %39, label %34

34:                                               ; preds = %31
  %35 = sext i32 %5 to i64
  %36 = getelementptr inbounds [204 x i8], ptr %1, i64 %35
  %37 = getelementptr inbounds [4 x i8], ptr %36, i64 %indvars.iv.next.1
...
39:                                               ; preds = %31, %19
  %.lcssa = phi i32 [ %5, %19 ], [ %5, %31 ]
  %40 = sext i32 %.lcssa to i64
  %41 = getelementptr inbounds [204 x i8], ptr %1, i64 %40
  ...
  %51 = getelementptr [204 x i8], ptr %1, i64 %50
