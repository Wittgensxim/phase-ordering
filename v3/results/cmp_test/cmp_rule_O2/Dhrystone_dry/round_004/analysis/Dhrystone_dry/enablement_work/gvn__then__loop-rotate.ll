...
19:                                               ; preds = %9, %49
  %storemerge16 = phi i32 [ 0, %9 ], [ %53, %49 ]
  %20 = call i32 @Proc5()
  %21 = call i32 @Proc4()
...
33:                                               ; preds = %._crit_edge, %19
  ...
  %.not31 = icmp sgt i8 65, %38
  br i1 %.not31, label %49, label %.lr.ph4

.lr.ph4:                                          ; preds = %33
  br label %39

39:                                               ; preds = %.lr.ph4, %46
  %storemerge22 = phi i8 [ 65, %.lr.ph4 ], [ %47, %46 ]
  %40 = sext i8 %storemerge22 to i32
  %41 = load i32, ptr %3, align 4
  %42 = call i32 @Func1(i32 noundef %40, i32 noundef 67)
...
46:                                               ; preds = %44, %39
  %47 = add i8 %storemerge22, 1
  %48 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %47, %48
  br i1 %.not3, label %._crit_edge5, label %39, !llvm.loop !10
...
49:                                               ; preds = %._crit_edge5, %33
  ...
  %53 = add i32 %storemerge16, 1
  %54 = icmp ult i32 %53, 100000000
  br i1 %54, label %19, label %55, !llvm.loop !11
...
18:                                               ; preds = %13
  %19 = getelementptr [204 x i8], ptr %1, i64 %6
  ...
  %25 = getelementptr i8, ptr %19, i64 4080
