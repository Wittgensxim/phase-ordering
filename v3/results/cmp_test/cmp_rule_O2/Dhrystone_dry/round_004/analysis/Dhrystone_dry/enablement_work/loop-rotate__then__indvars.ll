...
8:                                                ; preds = %7
  br i1 false, label %7, label %9, !llvm.loop !7
...
27:                                               ; preds = %.lr.ph, %27
  ...
  br i1 %36, label %27, label %._crit_edge, !llvm.loop !9
...
37:                                               ; preds = %._crit_edge, %20
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %25, %20 ]
...
21:                                               ; preds = %4, %25
  %indvars.iv = phi i64 [ %19, %4 ], [ %indvars.iv.next, %25 ]
...
25:                                               ; preds = %21
  ...
  br i1 %.not, label %26, label %21, !llvm.loop !12
