...
define dso_local i32 @Proc0() #0 {
  ...
  %6 = call i32 @clock() #5
  %7 = call i32 @clock() #5
  %8 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #6
  store ptr %8, ptr @PtrGlbNext, align 8
  %9 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #6
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %15, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #5
...
17:                                               ; preds = %49, %0
  %storemerge1 = phi i32 [ 0, %0 ], [ %53, %49 ]
  %exitcond = icmp ne i32 %storemerge1, 100000000
  br i1 %exitcond, label %18, label %54
...
26:                                               ; preds = %23
  ...
  %30 = call i32 @Proc7(i32 noundef %29, i32 noundef 3, ptr noundef nonnull %2)
...
38:                                               ; preds = %47, %33
  %storemerge2 = phi i8 [ 65, %33 ], [ %48, %47 ]
  %39 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %39
  br i1 %.not3, label %49, label %40

40:                                               ; preds = %38
  %41 = sext i8 %storemerge2 to i32
...
19:                                               ; preds = %22, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %22 ], [ %18, %4 ]
  %20 = add nsw i32 %5, 1
  %21 = sext i32 %20 to i64
  %.not = icmp sgt i64 %indvars.iv, %21
...
20:                                               ; preds = %18
  %21 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #5
