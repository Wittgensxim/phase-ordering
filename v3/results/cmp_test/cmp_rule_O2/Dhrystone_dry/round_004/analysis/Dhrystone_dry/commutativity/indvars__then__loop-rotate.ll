...
20:                                               ; preds = %9, %58
  %storemerge19 = phi i32 [ 0, %9 ], [ %59, %58 ]
  %21 = call i32 @Proc5()
  %22 = call i32 @Proc4()
...
27:                                               ; preds = %.lr.ph2, %27
  %28 = phi i32 [ %25, %.lr.ph2 ], [ %35, %27 ]
  %29 = mul nsw i32 %28, 5
  %30 = sub nsw i32 %29, 3
  store i32 %30, ptr %2, align 4
  %31 = load i32, ptr %1, align 4
  %32 = call i32 @Proc7(i32 noundef %31, i32 noundef 3, ptr noundef nonnull %2)
  %33 = load i32, ptr %1, align 4
  %34 = add nsw i32 %33, 1
  store i32 %34, ptr %1, align 4
  %35 = load i32, ptr %1, align 4
  %36 = icmp slt i32 %35, 3
  br i1 %36, label %27, label %._crit_edge3, !llvm.loop !9

._crit_edge3:                                     ; preds = %27
  %split = phi i32 [ %35, %27 ]
  br label %37

37:                                               ; preds = %._crit_edge3, %20
  ...
  %.not34 = icmp sgt i8 65, %42
  br i1 %.not34, label %54, label %.lr.ph7

.lr.ph7:                                          ; preds = %37
  br label %43

43:                                               ; preds = %.lr.ph7, %51
  %storemerge25 = phi i8 [ 65, %.lr.ph7 ], [ %52, %51 ]
  %44 = sext i8 %storemerge25 to i32
...
51:                                               ; preds = %50
  %52 = add i8 %storemerge25, 1
  %53 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %52, %53
  br i1 %.not3, label %._crit_edge8, label %43, !llvm.loop !10

._crit_edge8:                                     ; preds = %51
  br label %54

54:                                               ; preds = %._crit_edge8, %37
...
58:                                               ; preds = %54
  %59 = add nuw nsw i32 %storemerge19, 1
  %exitcond = icmp ne i32 %59, 100000000
  br i1 %exitcond, label %20, label %60, !llvm.loop !11
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %.not2 = icmp sgt i64 %18, %20
  br i1 %.not2, label %26, label %.lr.ph

.lr.ph:                                           ; preds = %4
  br label %21

21:                                               ; preds = %.lr.ph, %25
  %indvars.iv3 = phi i64 [ %18, %.lr.ph ], [ %indvars.iv.next, %25 ]
  %22 = sext i32 %5 to i64
  %23 = getelementptr inbounds [204 x i8], ptr %1, i64 %22
  %24 = getelementptr inbounds [4 x i8], ptr %23, i64 %indvars.iv3
  store i32 %5, ptr %24, align 4
  br label %25

25:                                               ; preds = %21
  %indvars.iv.next = add nsw i64 %indvars.iv3, 1
  %.not = icmp sgt i64 %indvars.iv.next, %20
