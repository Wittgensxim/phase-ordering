...
32:                                               ; preds = %11, %90
  %.120 = phi i32 [ 0, %11 ], [ %91, %90 ]
  %33 = call i32 @Proc5()
  %34 = call i32 @Proc4()
  store i32 2, ptr %1, align 4
  %35 = getelementptr inbounds [31 x i8], ptr %5, i64 0, i64 0
  %36 = call ptr @strcpy(ptr noundef %35, ptr noundef @.str.2) #5
...
55:                                               ; preds = %._crit_edge, %32
  ...
  %58 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %56, i32 noundef %57)
  %59 = load ptr, ptr @PtrGlb, align 8
  %60 = call i32 @Proc1(ptr noundef %59)
  %61 = load i8, ptr @Char2Glob, align 1
  %62 = sext i8 %61 to i32
  %63 = icmp sle i32 65, %62
  br i1 %63, label %.lr.ph18, label %78

.lr.ph18:                                         ; preds = %55
  br label %64

64:                                               ; preds = %.lr.ph18, %72
  %.01416 = phi i8 [ 65, %.lr.ph18 ], [ %73, %72 ]
  %65 = load i32, ptr %3, align 4
  %66 = sext i8 %.01416 to i32
...
72:                                               ; preds = %71
  ...
  br i1 %77, label %64, label %._crit_edge19, !llvm.loop !10

._crit_edge19:                                    ; preds = %72
  br label %78

78:                                               ; preds = %._crit_edge19, %55
...
3:                                                ; preds = %2, %17
  %.01213 = phi i32 [ 1, %2 ], [ %.1, %17 ]
  %4 = sext i32 %.01213 to i64
  %5 = getelementptr inbounds i8, ptr %0, i64 %4
  %6 = load i8, ptr %5, align 1
  %7 = sext i8 %6 to i32
  %8 = add nsw i32 %.01213, 1
  %9 = sext i32 %8 to i64
...
17:                                               ; preds = %15, %3
  %.1 = phi i32 [ %16, %15 ], [ %.01213, %3 ]
  %18 = icmp sle i32 %.1, 1
  br i1 %18, label %3, label %19, !llvm.loop !13

19:                                               ; preds = %17
  %.012.lcssa = phi i32 [ %.1, %17 ]
...
26:                                               ; preds = %25, %22, %19
  %.2 = phi i32 [ 7, %25 ], [ %.012.lcssa, %22 ], [ %.012.lcssa, %19 ]
