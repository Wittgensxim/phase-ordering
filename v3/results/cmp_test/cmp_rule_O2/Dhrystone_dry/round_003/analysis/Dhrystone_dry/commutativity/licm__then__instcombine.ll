...
9:                                                ; preds = %11, %0
  ...
  br i1 %exitcond.not, label %13, label %10
...
24:                                               ; preds = %63, %13
  %storemerge2.lcssa3 = phi i8 [ %.promoted2, %13 ], [ %storemerge2, %63 ]
  %25 = phi i32 [ %.promoted, %13 ], [ %66, %63 ]
  %storemerge1 = phi i32 [ 0, %13 ], [ %67, %63 ]
  %26 = icmp samesign ult i32 %storemerge1, 100000000
...
42:                                               ; preds = %32
  ...
  %44 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %33, i32 noundef %43)
  %45 = load ptr, ptr @PtrGlb, align 8
  %46 = call i32 @Proc1(ptr noundef %45)
  br label %47

47:                                               ; preds = %57, %42
  %storemerge2 = phi i8 [ 65, %42 ], [ %58, %57 ]
  %48 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %48
  br i1 %.not3, label %59, label %49
...
63:                                               ; preds = %59
  ...
  %67 = add nuw nsw i32 %storemerge1, 1
  br label %24, !llvm.loop !11

68:                                               ; preds = %24
  store i32 %25, ptr %2, align 4
  store i8 %storemerge2.lcssa3, ptr %4, align 1
  ret i32 undef
}
...
27:                                               ; preds = %31, %4
  %storemerge = phi i32 [ %18, %4 ], [ %32, %31 ]
  %.not = icmp sgt i32 %storemerge, %23
...
33:                                               ; preds = %27
  ...
  %36 = getelementptr inbounds [204 x i8], ptr %34, i64 %35
  ...
  %49 = getelementptr [204 x i8], ptr %47, i64 %48
  %50 = getelementptr i8, ptr %49, i64 4080
  %51 = getelementptr inbounds [4 x i8], ptr %50, i64 %44
