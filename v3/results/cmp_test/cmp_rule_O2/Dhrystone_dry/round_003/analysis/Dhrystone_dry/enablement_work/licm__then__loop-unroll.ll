...
26:                                               ; preds = %25
  %27 = add nuw nsw i32 %storemerge, 8
...
28:                                               ; preds = %10
  ...
  %31 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #6
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %37, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #5
...
39:                                               ; preds = %81, %28
  %storemerge2.lcssa3 = phi i8 [ %.promoted2, %28 ], [ %storemerge2.lcssa, %81 ]
  %40 = phi i32 [ %.promoted, %28 ], [ %79, %81 ]
  %storemerge1 = phi i32 [ 0, %28 ], [ %82, %81 ]
  %41 = icmp ult i32 %storemerge1, 100000000
...
42:                                               ; preds = %39
  ...
  %45 = call i32 @Func2(ptr noundef nonnull %6, ptr noundef nonnull %7)
...
50:                                               ; preds = %47
  ...
  %54 = call i32 @Proc7(i32 noundef %53, i32 noundef 3, ptr noundef nonnull %3)
...
57:                                               ; preds = %47
  ...
  %59 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %.lcssa, i32 noundef %58)
  %60 = load ptr, ptr @PtrGlb, align 8
  %61 = call i32 @Proc1(ptr noundef %60)
  br label %62

62:                                               ; preds = %72, %57
  %storemerge2 = phi i8 [ 65, %57 ], [ %73, %72 ]
  %63 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %63
  br i1 %.not3, label %74, label %64

64:                                               ; preds = %62
  %65 = sext i8 %storemerge2 to i32
...
69:                                               ; preds = %64
  %70 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %5)
  br label %71
...
72:                                               ; preds = %71
  %73 = add i8 %storemerge2, 1
  br label %62, !llvm.loop !10

74:                                               ; preds = %62
  %storemerge2.lcssa = phi i8 [ %storemerge2, %62 ]
  ...
  %80 = call i32 @Proc2(ptr noundef nonnull %1)
  br label %81

81:                                               ; preds = %74
  %82 = add i32 %storemerge1, 1
  br label %39, !llvm.loop !11

83:                                               ; preds = %39
  %storemerge2.lcssa3.lcssa = phi i8 [ %storemerge2.lcssa3, %39 ]
  %.lcssa1 = phi i32 [ %40, %39 ]
  %storemerge1.lcssa = phi i32 [ %storemerge1, %39 ]
