...
32:                                               ; preds = %.lr.ph, %32
  ...
  br i1 %43, label %32, label %._crit_edge, !llvm.loop !9
...
44:                                               ; preds = %._crit_edge, %24
  ...
  %.not34 = icmp sgt i8 65, %49
  br i1 %.not34, label %62, label %.lr.ph7

.lr.ph7:                                          ; preds = %44
  br label %50

50:                                               ; preds = %.lr.ph7, %58
  %storemerge25 = phi i8 [ 65, %.lr.ph7 ], [ %60, %58 ]
...
58:                                               ; preds = %57
  ...
  br i1 %.not3, label %._crit_edge8, label %50, !llvm.loop !10

._crit_edge8:                                     ; preds = %58
  br label %62

62:                                               ; preds = %._crit_edge8, %44
...
70:                                               ; preds = %62
  ...
  br i1 %73, label %24, label %74, !llvm.loop !11
...
37:                                               ; preds = %._crit_edge, %4
  %.lcssa = phi i32 [ %35, %._crit_edge ], [ %23, %4 ]
...
define dso_local i32 @Func2(ptr noundef %0, ptr noundef %1) #0 {
  ...
  br i1 true, label %.lr.ph, label %28

.lr.ph:                                           ; preds = %2
  br label %8

8:                                                ; preds = %.lr.ph, %25
  %9 = phi i32 [ 1, %.lr.ph ], [ %26, %25 ]
...
25:                                               ; preds = %22, %8
  ...
  br i1 %27, label %8, label %._crit_edge, !llvm.loop !13
