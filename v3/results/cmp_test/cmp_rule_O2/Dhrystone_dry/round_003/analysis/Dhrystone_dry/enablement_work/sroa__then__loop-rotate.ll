...
7:                                                ; preds = %0, %8
  %storemerge5 = phi i32 [ 0, %0 ], [ %9, %8 ]
  br label %8

8:                                                ; preds = %7
  %9 = add nuw nsw i32 %storemerge5, 1
...
21:                                               ; preds = %10, %62
  %storemerge111 = phi i32 [ 0, %10 ], [ %63, %62 ]
  %22 = call i32 @Proc5()
  %23 = call i32 @Proc4()
...
38:                                               ; preds = %._crit_edge, %21
  ...
  %.not36 = icmp sgt i8 65, %43
  br i1 %.not36, label %55, label %.lr.ph9

.lr.ph9:                                          ; preds = %38
  br label %44

44:                                               ; preds = %.lr.ph9, %52
  %storemerge27 = phi i8 [ 65, %.lr.ph9 ], [ %53, %52 ]
  %45 = sext i8 %storemerge27 to i32
...
52:                                               ; preds = %51
  %53 = add i8 %storemerge27, 1
  %54 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %53, %54
  br i1 %.not3, label %._crit_edge10, label %44, !llvm.loop !10

._crit_edge10:                                    ; preds = %52
  br label %55

55:                                               ; preds = %._crit_edge10, %38
...
62:                                               ; preds = %55
  %63 = add i32 %storemerge111, 1
  %64 = icmp ult i32 %63, 100000000
...
18:                                               ; preds = %4, %23
  %storemerge9 = phi i32 [ %5, %4 ], [ %24, %23 ]
  %19 = sext i32 %5 to i64
  %20 = getelementptr inbounds [204 x i8], ptr %1, i64 %19
  %21 = sext i32 %storemerge9 to i64
  %22 = getelementptr inbounds [4 x i8], ptr %20, i64 %21
  store i32 %5, ptr %22, align 4
  br label %23

23:                                               ; preds = %18
  %24 = add nsw i32 %storemerge9, 1
  %.not = icmp sgt i32 %24, %17
  br i1 %.not, label %25, label %18, !llvm.loop !12
...
25:                                               ; preds = %23
  ...
  %37 = getelementptr [204 x i8], ptr %1, i64 %36
  %38 = getelementptr i8, ptr %37, i64 4080
  %39 = getelementptr inbounds [4 x i8], ptr %38, i64 %33
...
3:                                                ; preds = %2, %17
  %.0910 = phi i32 [ 1, %2 ], [ %.1, %17 ]
  %4 = sext i32 %.0910 to i64
  %5 = getelementptr inbounds i8, ptr %0, i64 %4
  %6 = load i8, ptr %5, align 1
  %7 = sext i8 %6 to i32
  %8 = sext i32 %.0910 to i64
...
15:                                               ; preds = %3
  %16 = add nsw i32 %.0910, 1
  br label %17

17:                                               ; preds = %15, %3
  %.1 = phi i32 [ %16, %15 ], [ %.0910, %3 ]
  %18 = icmp slt i32 %.1, 2
  br i1 %18, label %3, label %19, !llvm.loop !13

19:                                               ; preds = %17
  %.09.lcssa = phi i32 [ %.1, %17 ]
  %20 = icmp sgt i8 65, 86
  br i1 %20, label %21, label %24

21:                                               ; preds = %19
  %22 = icmp ult i8 65, 91
...
24:                                               ; preds = %23, %21, %19
  %.2 = phi i32 [ 7, %23 ], [ %.09.lcssa, %21 ], [ %.09.lcssa, %19 ]
  %25 = icmp eq i8 65, 88
...
27:                                               ; preds = %24
  %28 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #5
