...
31:                                               ; preds = %.lr.ph, %31
  %32 = phi i32 [ %29, %.lr.ph ], [ %42, %31 ]
  %33 = phi i32 [ %28, %.lr.ph ], [ %41, %31 ]
  %34 = mul nsw i32 %33, 5
  %35 = sub nsw i32 %34, %32
  store i32 %35, ptr %3, align 4
  %36 = load i32, ptr %1, align 4
  %37 = load i32, ptr %2, align 4
  %38 = call i32 @Proc7(i32 noundef %36, i32 noundef %37, ptr noundef nonnull %3)
  ...
  br i1 %43, label %31, label %._crit_edge, !llvm.loop !9
...
44:                                               ; preds = %._crit_edge, %23
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %28, %23 ]
  ...
  %.not31 = icmp sgt i8 65, %49
  br i1 %.not31, label %61, label %.lr.ph4

.lr.ph4:                                          ; preds = %44
  br label %50

50:                                               ; preds = %.lr.ph4, %57
  %storemerge22 = phi i8 [ 65, %.lr.ph4 ], [ %59, %57 ]
  %51 = sext i8 %storemerge22 to i32
...
57:                                               ; preds = %50, %55
  ...
  br i1 %.not3, label %._crit_edge5, label %50, !llvm.loop !10

._crit_edge5:                                     ; preds = %57
  br label %61

61:                                               ; preds = %._crit_edge5, %44
  ...
  %71 = icmp ult i32 %70, 100000000
  br i1 %71, label %23, label %72, !llvm.loop !11
...
26:                                               ; preds = %.lr.ph, %26
  %27 = phi i32 [ %24, %.lr.ph ], [ %35, %26 ]
  %storemerge2 = phi i32 [ %19, %.lr.ph ], [ %34, %26 ]
