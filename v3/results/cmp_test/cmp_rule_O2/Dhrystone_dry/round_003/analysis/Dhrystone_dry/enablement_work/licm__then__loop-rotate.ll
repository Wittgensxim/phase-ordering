...
13:                                               ; preds = %11
  %storemerge.lcssa = phi i32 [ %12, %11 ]
...
24:                                               ; preds = %13, %65
  %storemerge111 = phi i32 [ 0, %13 ], [ %66, %65 ]
  %25 = call i32 @Proc5()
  %26 = call i32 @Proc4()
...
31:                                               ; preds = %.lr.ph, %31
  %32 = phi i32 [ %29, %.lr.ph ], [ %39, %31 ]
  %33 = mul nsw i32 %32, 5
  %34 = sub nsw i32 %33, 3
  store i32 %34, ptr %3, align 4
  %35 = load i32, ptr %1, align 4
  %36 = call i32 @Proc7(i32 noundef %35, i32 noundef 3, ptr noundef nonnull %3)
  %37 = load i32, ptr %1, align 4
  %38 = add nsw i32 %37, 1
  store i32 %38, ptr %1, align 4
  %39 = load i32, ptr %1, align 4
  %40 = icmp slt i32 %39, 3
  br i1 %40, label %31, label %._crit_edge, !llvm.loop !9
...
41:                                               ; preds = %._crit_edge, %24
  ...
  %.not35 = icmp sgt i8 65, %46
  br i1 %.not35, label %58, label %.lr.ph8

.lr.ph8:                                          ; preds = %41
  br label %47

47:                                               ; preds = %.lr.ph8, %55
  %storemerge26 = phi i8 [ 65, %.lr.ph8 ], [ %56, %55 ]
  %48 = sext i8 %storemerge26 to i32
...
55:                                               ; preds = %54
  %56 = add i8 %storemerge26, 1
  %57 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %56, %57
  br i1 %.not3, label %._crit_edge9, label %47, !llvm.loop !10

._crit_edge9:                                     ; preds = %55
  %split10 = phi i8 [ %56, %55 ]
  br label %58

58:                                               ; preds = %._crit_edge9, %41
  %storemerge2.lcssa = phi i8 [ %split10, %._crit_edge9 ], [ 65, %41 ]
...
65:                                               ; preds = %58
  %66 = add i32 %storemerge111, 1
  %67 = icmp ult i32 %66, 100000000
  br i1 %67, label %24, label %68, !llvm.loop !11

68:                                               ; preds = %65
  %storemerge2.lcssa3.lcssa = phi i8 [ %storemerge2.lcssa, %65 ]
  %.lcssa1 = phi i32 [ %63, %65 ]
  %storemerge1.lcssa = phi i32 [ %66, %65 ]
...
29:                                               ; preds = %.lr.ph, %32
  %storemerge2 = phi i32 [ %19, %.lr.ph ], [ %33, %32 ]
...
32:                                               ; preds = %29
  ...
  %.not = icmp sgt i32 %33, %25
  br i1 %.not, label %._crit_edge, label %29, !llvm.loop !12

._crit_edge:                                      ; preds = %32
  %split = phi i32 [ %33, %32 ]
  %split3 = phi i32 [ %24, %32 ]
  br label %34

34:                                               ; preds = %._crit_edge, %4
  %storemerge.lcssa = phi i32 [ %split, %._crit_edge ], [ %19, %4 ]
  %.lcssa = phi i32 [ %split3, %._crit_edge ], [ %24, %4 ]
  store i32 %storemerge.lcssa, ptr %8, align 4
