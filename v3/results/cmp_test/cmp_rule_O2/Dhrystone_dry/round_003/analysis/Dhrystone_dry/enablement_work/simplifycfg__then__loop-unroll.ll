...
38:                                               ; preds = %74, %27
  %storemerge1 = phi i32 [ 0, %27 ], [ %83, %74 ]
  store i32 %storemerge1, ptr %8, align 4
  %39 = icmp ult i32 %storemerge1, 100000000
...
49:                                               ; preds = %45
  ...
  %54 = call i32 @Proc7(i32 noundef %52, i32 noundef %53, ptr noundef nonnull %3)
...
62:                                               ; preds = %71, %57
  %storemerge2 = phi i8 [ 65, %57 ], [ %73, %71 ]
...
74:                                               ; preds = %62
  ...
  %81 = call i32 @Proc2(ptr noundef nonnull %1)
