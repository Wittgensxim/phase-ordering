...
13:                                               ; preds = %11
  %14 = add nuw nsw i32 %storemerge3, 2
  store i32 %14, ptr %8, align 4
  br label %15

15:                                               ; preds = %13
  %16 = add nuw nsw i32 %storemerge3, 3
  store i32 %16, ptr %8, align 4
  br label %17

17:                                               ; preds = %15
  %18 = add nuw nsw i32 %storemerge3, 4
  store i32 %18, ptr %8, align 4
  br label %19

19:                                               ; preds = %17
  %20 = add nuw nsw i32 %storemerge3, 5
  store i32 %20, ptr %8, align 4
  br label %21

21:                                               ; preds = %19
  %22 = add nuw nsw i32 %storemerge3, 6
  store i32 %22, ptr %8, align 4
  br label %23

23:                                               ; preds = %21
  %24 = add nuw nsw i32 %storemerge3, 7
  store i32 %24, ptr %8, align 4
  br label %25

25:                                               ; preds = %23
  %26 = add nuw nsw i32 %storemerge3, 8
  store i32 %26, ptr %8, align 4
  %exitcond.7 = icmp ne i32 %26, 100000000
  br i1 %exitcond.7, label %10, label %27, !llvm.loop !7
...
27:                                               ; preds = %25
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %36, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #5
...
38:                                               ; preds = %27, %85
  ...
  %41 = call i32 @Func2(ptr noundef nonnull %6, ptr noundef nonnull %7)
...
46:                                               ; preds = %.lr.ph, %46
  %47 = phi i32 [ %44, %.lr.ph ], [ %57, %46 ]
  %48 = phi i32 [ %43, %.lr.ph ], [ %56, %46 ]
  %49 = mul nsw i32 %48, 5
  %50 = sub nsw i32 %49, %47
  store i32 %50, ptr %3, align 4
  %51 = load i32, ptr %1, align 4
  %52 = load i32, ptr %2, align 4
  %53 = call i32 @Proc7(i32 noundef %51, i32 noundef %52, ptr noundef nonnull %3)
  ...
  br i1 %58, label %46, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %46
  %split = phi i32 [ %56, %46 ]
  br label %59

59:                                               ; preds = %._crit_edge, %38
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %43, %38 ]
  %60 = load i32, ptr %3, align 4
  %61 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %.lcssa, i32 noundef %60)
  %62 = load ptr, ptr @PtrGlb, align 8
  %63 = call i32 @Proc1(ptr noundef %62)
  store i8 65, ptr %4, align 1
  %64 = load i8, ptr @Char2Glob, align 1
  %.not34 = icmp sgt i8 65, %64
  br i1 %.not34, label %77, label %.lr.ph7

.lr.ph7:                                          ; preds = %59
  br label %65

65:                                               ; preds = %.lr.ph7, %73
  %storemerge25 = phi i8 [ 65, %.lr.ph7 ], [ %75, %73 ]
  %66 = sext i8 %storemerge25 to i32
  %67 = load i32, ptr %5, align 4
  %68 = call i32 @Func1(i32 noundef %66, i32 noundef 67)
  %69 = icmp eq i32 %67, %68
  br i1 %69, label %70, label %72

70:                                               ; preds = %65
  %71 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %5)
  br label %72
...
73:                                               ; preds = %72
  ...
  %.not3 = icmp sgt i8 %75, %76
  br i1 %.not3, label %._crit_edge8, label %65, !llvm.loop !10

._crit_edge8:                                     ; preds = %73
  br label %77

77:                                               ; preds = %._crit_edge8, %59
  ...
  %84 = call i32 @Proc2(ptr noundef nonnull %1)
  br label %85
...
85:                                               ; preds = %77
  ...
  br i1 %88, label %38, label %89, !llvm.loop !11
