...
21:                                               ; preds = %54, %10
  %storemerge1 = phi i32 [ 0, %10 ], [ %61, %54 ]
  %22 = icmp ult i32 %storemerge1, 100000000
...
31:                                               ; preds = %28
  ...
  %35 = call i32 @Proc7(i32 noundef %34, i32 noundef 3, ptr noundef nonnull %2)
...
43:                                               ; preds = %52, %38
  %storemerge2 = phi i8 [ 65, %38 ], [ %53, %52 ]
  %44 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %storemerge2, %44
  br i1 %.not3, label %54, label %45

45:                                               ; preds = %43
  %46 = sext i8 %storemerge2 to i32
...
5:                                                ; preds = %3
  ...
  %16 = icmp eq i32 %15, 0
  %17 = add nsw i32 %.09, 1
  %spec.select = select i1 %16, i32 %17, i32 %.09
  br label %3, !llvm.loop !13

18:                                               ; preds = %3
  %19 = icmp sgt i8 65, 86
  %20 = icmp ult i8 65, 91
  %or.cond = and i1 %19, %20
  %.2 = select i1 %or.cond, i32 7, i32 %.09
  %21 = icmp eq i8 65, 88
  br i1 %21, label %25, label %22

22:                                               ; preds = %18
  %23 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #5
  %24 = icmp sgt i32 %23, 0
  %spec.select10 = select i1 %24, i32 1, i32 0
  br label %25

25:                                               ; preds = %22, %18
  %.0 = phi i32 [ 1, %18 ], [ %spec.select10, %22 ]
  ret i32 %.0
}
