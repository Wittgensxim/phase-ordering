...
11:                                               ; preds = %10
  ...
  %15 = add nuw nsw i32 %storemerge, 4
...
37:                                               ; preds = %34
  ...
  %40 = call i32 @Proc7(i32 noundef %35, i32 noundef 3, ptr noundef nonnull %3)
...
43:                                               ; preds = %34
  ...
  %45 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %35, i32 noundef %44)
  %46 = load ptr, ptr @PtrGlb, align 8
  %47 = call i32 @Proc1(ptr noundef %46)
  br label %48

48:                                               ; preds = %58, %43
  %49 = phi i8 [ 65, %43 ], [ %59, %58 ]
  store i8 %49, ptr %4, align 1
  %50 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %49, %50
  br i1 %.not3, label %60, label %51
