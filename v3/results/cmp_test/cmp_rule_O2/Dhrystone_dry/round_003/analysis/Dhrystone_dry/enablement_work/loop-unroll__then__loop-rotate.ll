...
14:                                               ; preds = %13
  %15 = add nuw nsw i32 %storemerge3, 2
...
17:                                               ; preds = %16
  %18 = add nuw nsw i32 %storemerge3, 3
...
20:                                               ; preds = %19
  %21 = add nuw nsw i32 %storemerge3, 4
  store i32 %21, ptr %8, align 4
  %exitcond = icmp ne i32 %21, 100000000
  br i1 %exitcond, label %10, label %22, !llvm.loop !7

22:                                               ; preds = %20
  %23 = call i32 @clock() #5
  %24 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #6
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %31, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #5
...
33:                                               ; preds = %22, %80
  ...
  %36 = call i32 @Func2(ptr noundef nonnull %6, ptr noundef nonnull %7)
  ...
  br i1 %40, label %.lr.ph, label %54

.lr.ph:                                           ; preds = %33
  br label %41

41:                                               ; preds = %.lr.ph, %41
  %42 = phi i32 [ %39, %.lr.ph ], [ %52, %41 ]
  %43 = phi i32 [ %38, %.lr.ph ], [ %51, %41 ]
  %44 = mul nsw i32 %43, 5
  %45 = sub nsw i32 %44, %42
  store i32 %45, ptr %3, align 4
  %46 = load i32, ptr %1, align 4
  %47 = load i32, ptr %2, align 4
  %48 = call i32 @Proc7(i32 noundef %46, i32 noundef %47, ptr noundef nonnull %3)
  ...
  br i1 %53, label %41, label %._crit_edge, !llvm.loop !9
...
54:                                               ; preds = %._crit_edge, %33
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %38, %33 ]
  ...
  %.not34 = icmp sgt i8 65, %59
  br i1 %.not34, label %72, label %.lr.ph7

.lr.ph7:                                          ; preds = %54
  br label %60

60:                                               ; preds = %.lr.ph7, %68
  %storemerge25 = phi i8 [ 65, %.lr.ph7 ], [ %70, %68 ]
  %61 = sext i8 %storemerge25 to i32
...
68:                                               ; preds = %67
  ...
  %.not3 = icmp sgt i8 %70, %71
  br i1 %.not3, label %._crit_edge8, label %60, !llvm.loop !10

._crit_edge8:                                     ; preds = %68
  br label %72

72:                                               ; preds = %._crit_edge8, %54
  ...
  %79 = call i32 @Proc2(ptr noundef nonnull %1)
  br label %80
...
80:                                               ; preds = %72
  ...
  br i1 %83, label %33, label %84, !llvm.loop !11
