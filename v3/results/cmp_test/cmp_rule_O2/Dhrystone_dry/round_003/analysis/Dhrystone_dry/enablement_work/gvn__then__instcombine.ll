...
20:                                               ; preds = %54, %10
  ...
  %22 = icmp samesign ult i32 %21, 100000000
...
42:                                               ; preds = %52, %37
  %43 = phi i8 [ 65, %37 ], [ %53, %52 ]
  %44 = load i8, ptr @Char2Glob, align 1
  %.not3 = icmp sgt i8 %43, %44
...
7:                                                ; preds = %3
  ...
  %16 = call i32 @Func1(i32 noundef %11, i32 noundef %15)
  %17 = icmp eq i32 %16, 0
