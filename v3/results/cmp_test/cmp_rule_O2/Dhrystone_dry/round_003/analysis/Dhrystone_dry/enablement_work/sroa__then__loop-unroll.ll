...
7:                                                ; preds = %23, %0
  ...
  br i1 %exitcond, label %8, label %25
...
36:                                               ; preds = %77, %25
  %storemerge1 = phi i32 [ 0, %25 ], [ %78, %77 ]
  %37 = icmp ult i32 %storemerge1, 100000000
...
70:                                               ; preds = %58
  ...
  %76 = call i32 @Proc2(ptr noundef nonnull %1)
  br label %77

77:                                               ; preds = %70
  %78 = add i32 %storemerge1, 1
...
25:                                               ; preds = %24, %22, %20
  %.2 = phi i32 [ 7, %24 ], [ %.09.lcssa, %22 ], [ %.09.lcssa, %20 ]
  %26 = icmp eq i8 65, 88
