...
26:                                               ; preds = %71, %15
  %storemerge4 = phi i32 [ 0, %15 ], [ %73, %71 ]
  store i32 %storemerge4, ptr %8, align 4
  %27 = icmp ult i32 %storemerge4, 100000000
...
50:                                               ; preds = %60, %45
  %storemerge5 = phi i8 [ 65, %45 ], [ %62, %60 ]
  store i8 %storemerge5, ptr %4, align 1
  %51 = load i8, ptr @Char2Glob, align 1
  %.not6 = icmp sgt i8 %storemerge5, %51
  br i1 %.not6, label %63, label %52

52:                                               ; preds = %50
  %53 = sext i8 %storemerge5 to i32
