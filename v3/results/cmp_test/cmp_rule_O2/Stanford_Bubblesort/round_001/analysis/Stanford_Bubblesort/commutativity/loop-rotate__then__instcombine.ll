...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %39
...
36:                                               ; preds = %._crit_edge, %5
  %.lcssa = phi i32 [ %34, %._crit_edge ], [ %6, %5 ]
  %37 = add nsw i32 %.lcssa, -1
  store i32 %37, ptr @top, align 4
  %38 = icmp sgt i32 %.lcssa, 2
  br i1 %38, label %5, label %._crit_edge3, !llvm.loop !10
...
46:                                               ; preds = %45, %42
  ...
  %52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %51) #3
  ret void
}
