...
2:                                                ; preds = %29, %1
  ...
  %.lcssa13 = phi i32 [ undef, %1 ], [ %.lcssa1, %29 ]
...
4:                                                ; preds = %26, %.preheader
  %5 = phi i32 [ %27, %26 ], [ %.lcssa13, %.preheader ]
  %storemerge2 = phi i32 [ %28, %26 ], [ 1, %.preheader ]
  %6 = icmp slt i32 %storemerge2, %storemerge
...
26:                                               ; preds = %16, %7
  %27 = phi i32 [ %10, %16 ], [ %5, %7 ]
  %28 = add nsw i32 %storemerge2, 1
  br label %4, !llvm.loop !9

29:                                               ; preds = %4
  %.lcssa1 = phi i32 [ %5, %4 ]
  %storemerge2.lcssa = phi i32 [ %storemerge2, %4 ]
