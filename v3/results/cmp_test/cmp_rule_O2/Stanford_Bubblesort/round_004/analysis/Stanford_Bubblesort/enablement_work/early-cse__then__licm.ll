...
5:                                                ; preds = %28, %1
  %storemerge2.lcssa4 = phi i32 [ poison, %1 ], [ %storemerge2.lcssa, %28 ]
  %.lcssa13 = phi i32 [ %.promoted2, %1 ], [ %.lcssa1, %28 ]
  %storemerge = phi i32 [ 500, %1 ], [ %29, %28 ]
  %6 = icmp sgt i32 %storemerge, 1
  br i1 %6, label %.preheader, label %30

.preheader:                                       ; preds = %5
  br label %7

7:                                                ; preds = %25, %.preheader
  %8 = phi i32 [ %26, %25 ], [ %.lcssa13, %.preheader ]
  %storemerge2 = phi i32 [ %27, %25 ], [ 1, %.preheader ]
