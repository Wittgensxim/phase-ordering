...
7:                                                ; preds = %.lr.ph, %29
  %storemerge21 = phi i32 [ 1, %.lr.ph ], [ %31, %29 ]
  %8 = sext i32 %storemerge21 to i64
  %9 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %8
  %10 = load i32, ptr %9, align 4
  %11 = sext i32 %storemerge21 to i64
...
29:                                               ; preds = %16, %7
  ...
  br i1 %33, label %7, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %29
  br label %34

34:                                               ; preds = %._crit_edge, %.preheader
  %.lcssa = phi i32 [ %32, %._crit_edge ], [ %5, %.preheader ]
  %35 = add nsw i32 %.lcssa, -1
  store i32 %35, ptr @top, align 4
  %36 = icmp sgt i32 %.lcssa, 2
  br i1 %36, label %.preheader, label %37, !llvm.loop !10
