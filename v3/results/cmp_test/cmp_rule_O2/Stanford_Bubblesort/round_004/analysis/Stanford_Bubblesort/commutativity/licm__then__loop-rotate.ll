...
.preheader:                                       ; preds = %1, %29
  %storemerge7 = phi i32 [ 500, %1 ], [ %30, %29 ]
  %.lcssa136 = phi i32 [ %.promoted2, %1 ], [ %.lcssa1, %29 ]
  br label %5

5:                                                ; preds = %.preheader, %25
  %storemerge25 = phi i32 [ 1, %.preheader ], [ %27, %25 ]
  %6 = phi i32 [ %.lcssa136, %.preheader ], [ %26, %25 ]
  %7 = sext i32 %storemerge25 to i64
  %8 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %7
  %9 = load i32, ptr %8, align 4
  %10 = sext i32 %storemerge25 to i64
...
15:                                               ; preds = %5
  %16 = sext i32 %storemerge25 to i64
  %17 = getelementptr [4 x i8], ptr @sortlist, i64 %16
  %18 = getelementptr i8, ptr %17, i64 4
  %19 = load i32, ptr %18, align 4
  %20 = sext i32 %storemerge25 to i64
  %21 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %20
  store i32 %19, ptr %21, align 4
  %22 = sext i32 %storemerge25 to i64
...
25:                                               ; preds = %15, %5
  %26 = phi i32 [ %9, %15 ], [ %6, %5 ]
  %27 = add nsw i32 %storemerge25, 1
  %28 = icmp slt i32 %27, %storemerge7
  br i1 %28, label %5, label %29, !llvm.loop !9

29:                                               ; preds = %25
  %.lcssa1 = phi i32 [ %26, %25 ]
  %storemerge2.lcssa = phi i32 [ %27, %25 ]
  %.lcssa = phi i32 [ %storemerge7, %25 ]
  %30 = add nsw i32 %.lcssa, -1
  %31 = icmp sgt i32 %30, 1
  br i1 %31, label %.preheader, label %32, !llvm.loop !10

32:                                               ; preds = %29
  %storemerge2.lcssa4.lcssa = phi i32 [ %storemerge2.lcssa, %29 ]
  %.lcssa13.lcssa = phi i32 [ %.lcssa1, %29 ]
  %storemerge.lcssa = phi i32 [ %30, %29 ]
...
2:                                                ; preds = %0, %2
  ...
  br i1 %4, label %2, label %5, !llvm.loop !11
