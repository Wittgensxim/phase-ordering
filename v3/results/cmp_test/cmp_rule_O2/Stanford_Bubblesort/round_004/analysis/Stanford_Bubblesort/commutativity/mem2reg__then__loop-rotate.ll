...
.preheader:                                       ; preds = %1, %27
  ...
  %3 = icmp slt i32 1, %2
  br i1 %3, label %.lr.ph, label %27

.lr.ph:                                           ; preds = %.preheader
  br label %4

4:                                                ; preds = %.lr.ph, %23
  %storemerge21 = phi i32 [ 1, %.lr.ph ], [ %24, %23 ]
  %5 = sext i32 %storemerge21 to i64
  %6 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %5
  %7 = load i32, ptr %6, align 4
  %8 = sext i32 %storemerge21 to i64
  %9 = getelementptr [4 x i8], ptr @sortlist, i64 %8
...
23:                                               ; preds = %13, %4
  %24 = add nsw i32 %storemerge21, 1
  %25 = load i32, ptr @top, align 4
  %26 = icmp slt i32 %24, %25
  br i1 %26, label %4, label %._crit_edge, !llvm.loop !9
...
27:                                               ; preds = %._crit_edge, %.preheader
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %2, %.preheader ]
