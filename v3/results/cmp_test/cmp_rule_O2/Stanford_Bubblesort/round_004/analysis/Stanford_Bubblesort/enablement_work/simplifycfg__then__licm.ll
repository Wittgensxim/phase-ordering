...
5:                                                ; preds = %31, %1
  %.lcssa14 = phi i32 [ %.promoted3, %1 ], [ %.lcssa1, %31 ]
  %storemerge2.lcssa2 = phi i32 [ poison, %1 ], [ %storemerge2.lcssa, %31 ]
  %storemerge = phi i32 [ 500, %1 ], [ %32, %31 ]
  %6 = icmp sgt i32 %storemerge, 1
  br i1 %6, label %.preheader.preheader, label %33

.preheader.preheader:                             ; preds = %5
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %28
  %7 = phi i32 [ %29, %28 ], [ %.lcssa14, %.preheader.preheader ]
  %storemerge2 = phi i32 [ %30, %28 ], [ 1, %.preheader.preheader ]
...
18:                                               ; preds = %9
  %19 = sext i32 %storemerge2 to i64
...
31:                                               ; preds = %.preheader
  %.lcssa1 = phi i32 [ %7, %.preheader ]
  %storemerge2.lcssa = phi i32 [ %storemerge2, %.preheader ]
  %.lcssa = phi i32 [ %storemerge, %.preheader ]
  %32 = add nsw i32 %.lcssa, -1
  br label %5, !llvm.loop !10

33:                                               ; preds = %5
  %.lcssa14.lcssa = phi i32 [ %.lcssa14, %5 ]
  %storemerge2.lcssa2.lcssa = phi i32 [ %storemerge2.lcssa2, %5 ]
  %storemerge.lcssa = phi i32 [ %storemerge, %5 ]
  store i32 %storemerge.lcssa, ptr @top, align 4
  store i32 %storemerge2.lcssa2.lcssa, ptr %3, align 4
  store i32 %.lcssa14.lcssa, ptr %4, align 4
