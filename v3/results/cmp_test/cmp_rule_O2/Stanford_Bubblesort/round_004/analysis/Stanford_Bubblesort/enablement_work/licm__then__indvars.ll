...
18:                                               ; preds = %2
  %19 = trunc nuw nsw i64 501 to i32
...
5:                                                ; preds = %25, %1
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %25 ], [ 500, %1 ]
  %storemerge2.lcssa4 = phi i32 [ poison, %1 ], [ %26, %25 ]
  %.lcssa13 = phi i32 [ %.promoted2, %1 ], [ %.lcssa1, %25 ]
...
7:                                                ; preds = %23, %.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %23 ], [ 1, %.preheader ]
  %8 = phi i32 [ %24, %23 ], [ %.lcssa13, %.preheader ]
...
23:                                               ; preds = %16, %9
  %24 = phi i32 [ %11, %16 ], [ %8, %9 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %7, !llvm.loop !9

25:                                               ; preds = %7
  %.lcssa1 = phi i32 [ %8, %7 ]
  %storemerge2.lcssa.wide = phi i64 [ %indvars.iv, %7 ]
  %26 = trunc nuw nsw i64 %storemerge2.lcssa.wide to i32
...
30:                                               ; preds = %27
  %31 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
...
34:                                               ; preds = %33, %30
  ...
  %40 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %39) #3
  ret void
}
