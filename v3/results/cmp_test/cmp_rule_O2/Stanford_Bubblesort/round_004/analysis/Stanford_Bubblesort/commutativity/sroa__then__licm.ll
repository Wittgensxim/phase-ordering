...
2:                                                ; preds = %27, %1
  %storemerge = phi i32 [ 500, %1 ], [ %28, %27 ]
  %3 = icmp sgt i32 %storemerge, 1
  br i1 %3, label %.preheader, label %29

.preheader:                                       ; preds = %2
  br label %4

4:                                                ; preds = %25, %.preheader
  %storemerge2 = phi i32 [ %26, %25 ], [ 1, %.preheader ]
  %5 = icmp slt i32 %storemerge2, %storemerge
...
15:                                               ; preds = %6
  %16 = sext i32 %storemerge2 to i64
...
25:                                               ; preds = %15, %6
  %26 = add nsw i32 %storemerge2, 1
  br label %4, !llvm.loop !9

27:                                               ; preds = %4
  %.lcssa = phi i32 [ %storemerge, %4 ]
