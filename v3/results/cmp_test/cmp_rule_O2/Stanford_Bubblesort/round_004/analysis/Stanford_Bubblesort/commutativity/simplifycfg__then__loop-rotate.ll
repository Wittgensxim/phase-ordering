...
.preheader.preheader:                             ; preds = %1, %33
...
7:                                                ; preds = %.lr.ph, %.preheader
  %storemerge21 = phi i32 [ 1, %.lr.ph ], [ %30, %.preheader ]
...
.preheader:                                       ; preds = %16, %7
  %29 = load i32, ptr %3, align 4
  %30 = add nsw i32 %29, 1
  store i32 %30, ptr %3, align 4
  %31 = load i32, ptr @top, align 4
  %32 = icmp slt i32 %30, %31
  br i1 %32, label %7, label %.preheader._crit_edge, !llvm.loop !9

.preheader._crit_edge:                            ; preds = %.preheader
  %split = phi i32 [ %31, %.preheader ]
  br label %33

33:                                               ; preds = %.preheader._crit_edge, %.preheader.preheader
  %.lcssa = phi i32 [ %split, %.preheader._crit_edge ], [ %5, %.preheader.preheader ]
  %34 = add nsw i32 %.lcssa, -1
  store i32 %34, ptr @top, align 4
  %35 = icmp sgt i32 %34, 1
  br i1 %35, label %.preheader.preheader, label %36, !llvm.loop !10
