...
.lr.ph:                                           ; preds = %.lr.ph2, %32
  %10 = phi i32 [ %35, %32 ], [ %7, %.lr.ph2 ]
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %11
...
._crit_edge:                                      ; preds = %32, %.lr.ph2
  %.lcssa = phi i32 [ %8, %.lr.ph2 ], [ %36, %32 ]
  %38 = sub nsw i32 %.lcssa, 1
  store i32 %38, ptr @top, align 4
  %39 = load i32, ptr @top, align 4
  %40 = icmp sgt i32 %39, 1
  br i1 %40, label %.lr.ph2, label %._crit_edge3, !llvm.loop !10
