...
5:                                                ; preds = %33, %1
  %storemerge2.lcssa6 = phi i32 [ poison, %1 ], [ %storemerge2.lcssa, %33 ]
  %.lcssa35 = phi i32 [ %.promoted4, %1 ], [ %.lcssa3, %33 ]
  %storemerge = phi i32 [ 500, %1 ], [ %34, %33 ]
...
8:                                                ; preds = %30, %7
  %9 = phi i32 [ %.lcssa35, %7 ], [ %31, %30 ]
  %storemerge2 = phi i32 [ 1, %7 ], [ %32, %30 ]
...
20:                                               ; preds = %11
  ...
  %26 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %25
  store i32 %24, ptr %26, align 4
  %27 = sext i32 %storemerge2 to i64
...
33:                                               ; preds = %8
  ...
  %.lcssa = phi i32 [ %storemerge, %8 ]
  %34 = add nsw i32 %.lcssa, -1
  br label %5, !llvm.loop !10

35:                                               ; preds = %5
  %storemerge2.lcssa6.lcssa = phi i32 [ %storemerge2.lcssa6, %5 ]
  %.lcssa35.lcssa = phi i32 [ %.lcssa35, %5 ]
  %storemerge.lcssa = phi i32 [ %storemerge, %5 ]
  store i32 %storemerge.lcssa, ptr @top, align 4
  store i32 %.lcssa35.lcssa, ptr %4, align 4
  store i32 %storemerge2.lcssa6.lcssa, ptr %3, align 4
