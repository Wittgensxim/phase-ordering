...
30:                                               ; preds = %._crit_edge, %4
  ...
  br i1 %33, label %4, label %._crit_edge9, !llvm.loop !10

._crit_edge9:                                     ; preds = %30
  br label %34

34:                                               ; preds = %._crit_edge9, %1
...
1:                                                ; preds = %0, %2
  %.02 = phi i32 [ 0, %0 ], [ %3, %2 ]
  call void @Bubble(i32 noundef %.02)
  br label %2
