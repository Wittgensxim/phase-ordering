...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  %5 = icmp sgt i32 %top.promoted, 1
  br i1 %5, label %.lr.ph, label %36

.lr.ph:                                           ; preds = %1
  br label %6

6:                                                ; preds = %.lr.ph, %33
  %7 = phi i32 [ %top.promoted, %.lr.ph ], [ %34, %33 ]
  %.lcssa367 = phi i32 [ %.promoted, %.lr.ph ], [ %.lcssa3, %33 ]
  br label %8

8:                                                ; preds = %6, %29
  %9 = phi i32 [ 1, %6 ], [ %31, %29 ]
  %10 = phi i32 [ %.lcssa367, %6 ], [ %30, %29 ]
...
33:                                               ; preds = %29
  ...
  %.lcssa1 = phi i32 [ %31, %29 ]
  %.lcssa = phi i32 [ %7, %29 ]
  %34 = sub nsw i32 %.lcssa, 1
  store i32 %34, ptr @top, align 4
  %35 = icmp sgt i32 %34, 1
  br i1 %35, label %6, label %._crit_edge, !llvm.loop !10

._crit_edge:                                      ; preds = %33
  %split = phi i32 [ %.lcssa3, %33 ]
  %split8 = phi i32 [ %.lcssa1, %33 ]
  br label %36

36:                                               ; preds = %._crit_edge, %1
  %.lcssa36.lcssa = phi i32 [ %split, %._crit_edge ], [ %.promoted, %1 ]
  %.lcssa15.lcssa = phi i32 [ %split8, %._crit_edge ], [ %.promoted4, %1 ]
