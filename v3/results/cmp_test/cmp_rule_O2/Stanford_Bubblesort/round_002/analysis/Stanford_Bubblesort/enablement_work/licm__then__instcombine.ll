...
2:                                                ; preds = %24, %0
  %3 = phi i32 [ %.fr, %24 ], [ %.promoted1, %0 ]
  %4 = phi i32 [ %25, %24 ], [ 1, %0 ]
  %5 = icmp samesign ult i32 %4, 501
  br i1 %5, label %6, label %26

6:                                                ; preds = %2
  %7 = call i32 @Rand()
  %.fr = freeze i32 %7
  %8 = srem i32 %.fr, 100000
...
5:                                                ; preds = %35, %1
  %.lcssa36 = phi i32 [ %10, %35 ], [ %.promoted, %1 ]
  %.lcssa15 = phi i32 [ %11, %35 ], [ %.promoted4, %1 ]
  %6 = phi i32 [ %36, %35 ], [ 500, %1 ]
  %7 = icmp sgt i32 %6, 1
...
37:                                               ; preds = %5
  ...
  store i32 %.lcssa36, ptr %4, align 4
...
44:                                               ; preds = %43, %40
  ...
  %50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %49) #3
  ret void
}
