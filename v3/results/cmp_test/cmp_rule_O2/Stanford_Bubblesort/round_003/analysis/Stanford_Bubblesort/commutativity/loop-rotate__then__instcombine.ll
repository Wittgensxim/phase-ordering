...
8:                                                ; preds = %.lr.ph, %30
  %storemerge21 = phi i32 [ 1, %.lr.ph ], [ %32, %30 ]
  %9 = sext i32 %storemerge21 to i64
  %10 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %9
  %11 = load i32, ptr %10, align 4
  %12 = sext i32 %storemerge21 to i64
...
30:                                               ; preds = %17, %8
  ...
  br i1 %34, label %8, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %30
  br label %35

35:                                               ; preds = %._crit_edge, %5
  %.lcssa = phi i32 [ %33, %._crit_edge ], [ %6, %5 ]
  %36 = add nsw i32 %.lcssa, -1
  store i32 %36, ptr @top, align 4
  %37 = icmp sgt i32 %.lcssa, 2
  br i1 %37, label %5, label %38, !llvm.loop !10
