...
5:                                                ; preds = %.lr.ph, %24
  %storemerge25 = phi i32 [ 1, %.lr.ph ], [ %25, %24 ]
  %6 = sext i32 %storemerge25 to i64
  %7 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %6
  %8 = load i32, ptr %7, align 4
  %9 = sext i32 %storemerge25 to i64
...
14:                                               ; preds = %5
  %15 = sext i32 %storemerge25 to i64
  %16 = getelementptr [4 x i8], ptr @sortlist, i64 %15
  %17 = getelementptr i8, ptr %16, i64 4
  %18 = load i32, ptr %17, align 4
  %19 = sext i32 %storemerge25 to i64
