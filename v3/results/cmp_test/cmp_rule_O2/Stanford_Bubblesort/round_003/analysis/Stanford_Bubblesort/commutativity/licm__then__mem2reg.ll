...
2:                                                ; preds = %30, %1
  %storemerge2.lcssa4 = phi i32 [ poison, %1 ], [ %storemerge2.lcssa, %30 ]
  %.lcssa13 = phi i32 [ undef, %1 ], [ %.lcssa1, %30 ]
...
5:                                                ; preds = %27, %4
  %6 = phi i32 [ %.lcssa13, %4 ], [ %28, %27 ]
  %storemerge2 = phi i32 [ 1, %4 ], [ %29, %27 ]
  %7 = icmp slt i32 %storemerge2, %storemerge
...
27:                                               ; preds = %17, %8
  %28 = phi i32 [ %11, %17 ], [ %6, %8 ]
  %29 = add nsw i32 %storemerge2, 1
  br label %5, !llvm.loop !9

30:                                               ; preds = %5
  %.lcssa1 = phi i32 [ %6, %5 ]
  %storemerge2.lcssa = phi i32 [ %storemerge2, %5 ]
  %.lcssa = phi i32 [ %storemerge, %5 ]
  %31 = add nsw i32 %.lcssa, -1
  br label %2, !llvm.loop !10

32:                                               ; preds = %2
  %storemerge2.lcssa4.lcssa = phi i32 [ %storemerge2.lcssa4, %2 ]
  %.lcssa13.lcssa = phi i32 [ %.lcssa13, %2 ]
...
39:                                               ; preds = %38, %35
  ...
  %44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %43) #3
  ret void
}
