...
5:                                                ; preds = %32, %1
  %.lcssa14 = phi i32 [ %.promoted3, %1 ], [ %.lcssa1, %32 ]
  %storemerge2.lcssa2 = phi i32 [ poison, %1 ], [ %storemerge2.lcssa, %32 ]
...
7:                                                ; preds = %.preheader, %29
  %8 = phi i32 [ %30, %29 ], [ %.lcssa14, %.preheader ]
  %storemerge2 = phi i32 [ %31, %29 ], [ 1, %.preheader ]
...
10:                                               ; preds = %7
  ...
  %14 = sext i32 %storemerge2 to i64
...
19:                                               ; preds = %10
  %20 = sext i32 %storemerge2 to i64
  ...
  %26 = sext i32 %storemerge2 to i64
...
32:                                               ; preds = %7
  %.lcssa1 = phi i32 [ %8, %7 ]
  %storemerge2.lcssa = phi i32 [ %storemerge2, %7 ]
  %.lcssa = phi i32 [ %storemerge, %7 ]
