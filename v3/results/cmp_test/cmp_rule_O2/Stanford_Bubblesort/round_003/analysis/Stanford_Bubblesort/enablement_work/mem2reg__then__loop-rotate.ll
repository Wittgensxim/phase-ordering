...
2:                                                ; preds = %1, %28
  ...
  %4 = icmp slt i32 1, %3
  br i1 %4, label %.lr.ph, label %28

.lr.ph:                                           ; preds = %2
  br label %5

5:                                                ; preds = %.lr.ph, %24
  %storemerge21 = phi i32 [ 1, %.lr.ph ], [ %25, %24 ]
  %6 = sext i32 %storemerge21 to i64
...
14:                                               ; preds = %5
  %15 = sext i32 %storemerge21 to i64
  %16 = getelementptr [4 x i8], ptr @sortlist, i64 %15
  %17 = getelementptr i8, ptr %16, i64 4
  %18 = load i32, ptr %17, align 4
  %19 = sext i32 %storemerge21 to i64
  %20 = getelementptr inbounds [4 x i8], ptr @sortlist, i64 %19
  store i32 %18, ptr %20, align 4
  %21 = sext i32 %storemerge21 to i64
...
24:                                               ; preds = %14, %5
  %25 = add nsw i32 %storemerge21, 1
  %26 = load i32, ptr @top, align 4
  %27 = icmp slt i32 %25, %26
  br i1 %27, label %5, label %._crit_edge, !llvm.loop !9
...
28:                                               ; preds = %._crit_edge, %2
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %3, %2 ]
