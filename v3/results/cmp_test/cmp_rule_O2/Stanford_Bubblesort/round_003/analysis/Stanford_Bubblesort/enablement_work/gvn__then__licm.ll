...
5:                                                ; preds = %24, %1
  %.lcssa5 = phi i32 [ poison, %1 ], [ %.lcssa, %24 ]
  %.lcssa14 = phi i32 [ %.promoted3, %1 ], [ %.lcssa1, %24 ]
  %6 = phi i32 [ 500, %1 ], [ %25, %24 ]
  %7 = icmp sgt i32 %6, 1
...
9:                                                ; preds = %21, %8
  %10 = phi i32 [ %.lcssa14, %8 ], [ %22, %21 ]
  %11 = phi i32 [ 1, %8 ], [ %23, %21 ]
