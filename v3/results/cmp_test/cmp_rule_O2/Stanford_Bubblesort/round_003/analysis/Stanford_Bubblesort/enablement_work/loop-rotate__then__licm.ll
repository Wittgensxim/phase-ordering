...
5:                                                ; preds = %1, %33
  %.lcssa210 = phi i32 [ %.promoted8, %1 ], [ %.lcssa29, %33 ]
  %6 = phi i32 [ %top.promoted, %1 ], [ %34, %33 ]
  %7 = icmp slt i32 1, %6
...
8:                                                ; preds = %.lr.ph, %29
  %9 = phi i32 [ 1, %.lr.ph ], [ %31, %29 ]
  %10 = phi i32 [ %.lcssa210, %.lr.ph ], [ %30, %29 ]
...
29:                                               ; preds = %19, %8
  %30 = phi i32 [ %13, %19 ], [ %10, %8 ]
  %31 = add nsw i32 %9, 1
  %32 = icmp slt i32 %31, %6
  br i1 %32, label %8, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %29
  %.lcssa4 = phi i32 [ %31, %29 ]
  %.lcssa2 = phi i32 [ %30, %29 ]
  %split = phi i32 [ %6, %29 ]
  br label %33

33:                                               ; preds = %._crit_edge, %5
  %.lcssa29 = phi i32 [ %.lcssa2, %._crit_edge ], [ %.lcssa210, %5 ]
  %.lcssa46 = phi i32 [ %.lcssa4, %._crit_edge ], [ 1, %5 ]
...
36:                                               ; preds = %33
  %.lcssa29.lcssa = phi i32 [ %.lcssa29, %33 ]
  %.lcssa7 = phi i32 [ %34, %33 ]
  %.lcssa46.lcssa = phi i32 [ %.lcssa46, %33 ]
