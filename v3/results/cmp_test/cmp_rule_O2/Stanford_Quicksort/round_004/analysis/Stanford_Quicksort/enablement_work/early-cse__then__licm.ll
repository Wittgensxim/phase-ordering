...
22:                                               ; preds = %54, %3
  %23 = phi i32 [ %55, %54 ], [ %.promoted11, %3 ]
  %.lcssa59 = phi i32 [ %.lcssa510, %54 ], [ %.promoted, %3 ]
  %.lcssa37 = phi i32 [ %.lcssa38, %54 ], [ %.promoted6, %3 ]
  br label %24

24:                                               ; preds = %30, %22
  %25 = phi i32 [ %31, %30 ], [ %.lcssa37, %22 ]
...
32:                                               ; preds = %38, %.preheader
  %33 = phi i32 [ %39, %38 ], [ %.lcssa59, %.preheader ]
...
40:                                               ; preds = %32
  ...
  %.lcssa1 = phi ptr [ %19, %32 ]
  %.lcssa = phi i32 [ %33, %32 ]
  %.not = icmp sgt i32 %.lcssa3, %.lcssa
  br i1 %.not, label %54, label %41

41:                                               ; preds = %40
  %42 = sext i32 %.lcssa3 to i64
  %43 = getelementptr inbounds [4 x i8], ptr %.lcssa1, i64 %42
  %44 = load i32, ptr %43, align 4
  %45 = sext i32 %.lcssa5 to i64
  ...
  %53 = add nsw i32 %.lcssa5, -1
  br label %54

54:                                               ; preds = %41, %40
  %55 = phi i32 [ %44, %41 ], [ %23, %40 ]
  %.lcssa510 = phi i32 [ %53, %41 ], [ %.lcssa5, %40 ]
  %.lcssa38 = phi i32 [ %52, %41 ], [ %.lcssa3, %40 ]
  %.not1 = icmp sgt i32 %.lcssa38, %.lcssa510
  br i1 %.not1, label %56, label %22, !llvm.loop !11

56:                                               ; preds = %54
  %.lcssa12 = phi i32 [ %55, %54 ]
  %.lcssa510.lcssa = phi i32 [ %.lcssa510, %54 ]
  %.lcssa38.lcssa = phi i32 [ %.lcssa38, %54 ]
  %.lcssa2 = phi i32 [ %.lcssa510, %54 ]
  store i32 %.lcssa38.lcssa, ptr %7, align 4
  store i32 %.lcssa510.lcssa, ptr %8, align 4
  store i32 %.lcssa12, ptr %10, align 4
  %57 = load i32, ptr %5, align 4
  %58 = icmp slt i32 %57, %.lcssa2
  br i1 %58, label %59, label %61

59:                                               ; preds = %56
  %60 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %60, i32 noundef %57, i32 noundef %.lcssa2)
  br label %61
