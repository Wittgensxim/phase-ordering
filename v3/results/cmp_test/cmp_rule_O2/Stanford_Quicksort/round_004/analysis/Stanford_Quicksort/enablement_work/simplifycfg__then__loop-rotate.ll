...
..preheader.preheader_crit_edge:                  ; preds = %31
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %..preheader.preheader_crit_edge, %16
  ...
  br i1 %30, label %.lr.ph1, label %50

.lr.ph1:                                          ; preds = %.preheader.preheader
  br label %.preheader

31:                                               ; preds = %.lr.ph, %31
  %32 = phi i32 [ %18, %.lr.ph ], [ %35, %31 ]
  %33 = add nsw i32 %32, 1
  ...
  br i1 %40, label %31, label %..preheader.preheader_crit_edge, !llvm.loop !9

.preheader:                                       ; preds = %.lr.ph1, %.preheader
  %41 = phi i32 [ %26, %.lr.ph1 ], [ %45, %.preheader ]
  %42 = add nsw i32 %41, -1
  ...
  br i1 %49, label %.preheader, label %.preheader._crit_edge, !llvm.loop !10

.preheader._crit_edge:                            ; preds = %.preheader
  %split = phi ptr [ %44, %.preheader ]
  %split2 = phi i32 [ %45, %.preheader ]
  br label %50

50:                                               ; preds = %.preheader._crit_edge, %.preheader.preheader
  %.lcssa2 = phi ptr [ %split, %.preheader._crit_edge ], [ %25, %.preheader.preheader ]
  %.lcssa = phi i32 [ %split2, %.preheader._crit_edge ], [ %26, %.preheader.preheader ]
...
73:                                               ; preds = %52, %50
  ...
  %.not1 = icmp sgt i32 %74, %75
  br i1 %.not1, label %76, label %16, !llvm.loop !11

76:                                               ; preds = %73
  %.lcssa3 = phi i32 [ %75, %73 ]
  %77 = load i32, ptr %5, align 4
  %78 = icmp slt i32 %77, %.lcssa3
  br i1 %78, label %79, label %81

79:                                               ; preds = %76
  %80 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %80, i32 noundef %77, i32 noundef %.lcssa3)
  br label %81
...
85:                                               ; preds = %81
  ...
  call void @Quicksort(ptr noundef %86, i32 noundef %82, i32 noundef %83)
  br label %87
