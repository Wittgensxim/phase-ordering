...
17:                                               ; preds = %25, %16
  ...
  br i1 %24, label %25, label %.preheader.preheader
...
36:                                               ; preds = %.preheader
  %.lcssa2 = phi ptr [ %28, %.preheader ]
  %.lcssa = phi i32 [ %29, %.preheader ]
  %37 = load i32, ptr %7, align 4
  %.not = icmp sgt i32 %37, %.lcssa
  br i1 %.not, label %59, label %38

38:                                               ; preds = %36
  %39 = sext i32 %37 to i64
  %40 = getelementptr inbounds [4 x i8], ptr %.lcssa2, i64 %39
...
59:                                               ; preds = %38, %36
  ...
  %.not1 = icmp sgt i32 %60, %61
  br i1 %.not1, label %62, label %16, !llvm.loop !11

62:                                               ; preds = %59
  %.lcssa3 = phi i32 [ %61, %59 ]
  %63 = load i32, ptr %5, align 4
  %64 = icmp slt i32 %63, %.lcssa3
  br i1 %64, label %65, label %67

65:                                               ; preds = %62
  %66 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %66, i32 noundef %63, i32 noundef %.lcssa3)
  br label %67
...
71:                                               ; preds = %67
  ...
  call void @Quicksort(ptr noundef %72, i32 noundef %68, i32 noundef %69)
  br label %73
