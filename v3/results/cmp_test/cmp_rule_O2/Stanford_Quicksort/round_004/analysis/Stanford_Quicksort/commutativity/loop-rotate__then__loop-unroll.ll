...
.preheader:                                       ; preds = %..preheader_crit_edge, %16
  ...
  br i1 %30, label %.lr.ph1, label %51
...
._crit_edge:                                      ; preds = %41
  %split = phi ptr [ %45, %41 ]
  %split2 = phi i32 [ %46, %41 ]
  br label %51

51:                                               ; preds = %._crit_edge, %.preheader
  %.lcssa2 = phi ptr [ %split, %._crit_edge ], [ %25, %.preheader ]
  %.lcssa = phi i32 [ %split2, %._crit_edge ], [ %26, %.preheader ]
...
53:                                               ; preds = %51
  ...
  %55 = getelementptr inbounds [4 x i8], ptr %.lcssa2, i64 %54
...
80:                                               ; preds = %77
  ...
  call void @Quicksort(ptr noundef %81, i32 noundef %78, i32 noundef %.lcssa3)
  br label %82
