...
17:                                               ; preds = %21, %.preheader
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %21 ], [ %15, %.preheader ]
  %18 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv25
...
22:                                               ; preds = %17
  %.122.lcssa.wide = phi i64 [ %indvars.iv25, %17 ]
  %.lcssa2 = phi ptr [ %0, %17 ]
  %.lcssa.wide = phi i64 [ %indvars.iv25, %17 ]
  %23 = trunc nsw i64 %.1.lcssa.wide to i32
  %24 = trunc nsw i64 %.122.lcssa.wide to i32
