...
.lr.ph:                                           ; preds = %16, %.lr.ph
  ...
  br i1 %39, label %.lr.ph, label %.preheader, !llvm.loop !9

.lr.ph1:                                          ; preds = %.preheader, %.lr.ph1
  %40 = phi i32 [ %44, %.lr.ph1 ], [ %26, %.preheader ]
  %41 = add nsw i32 %40, -1
  ...
  br i1 %48, label %.lr.ph1, label %._crit_edge, !llvm.loop !10

._crit_edge:                                      ; preds = %.lr.ph1, %.preheader
  %.lcssa2 = phi ptr [ %25, %.preheader ], [ %43, %.lr.ph1 ]
  %.lcssa = phi i32 [ %26, %.preheader ], [ %44, %.lr.ph1 ]
  %49 = load i32, ptr %7, align 4
  %.not = icmp sgt i32 %49, %.lcssa
...
71:                                               ; preds = %50, %._crit_edge
  %72 = load i32, ptr %7, align 4
  %73 = load i32, ptr %8, align 4
  %.not1 = icmp sgt i32 %72, %73
  br i1 %.not1, label %74, label %16, !llvm.loop !11

74:                                               ; preds = %71
  %.lcssa3 = phi i32 [ %73, %71 ]
  %75 = load i32, ptr %5, align 4
  %76 = icmp slt i32 %75, %.lcssa3
  br i1 %76, label %77, label %79

77:                                               ; preds = %74
  %78 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %78, i32 noundef %75, i32 noundef %.lcssa3)
  br label %79
...
83:                                               ; preds = %79
  ...
  call void @Quicksort(ptr noundef %84, i32 noundef %80, i32 noundef %81)
  br label %85
