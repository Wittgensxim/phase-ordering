...
17:                                               ; preds = %40, %3
  %18 = phi i32 [ %41, %40 ], [ %.promoted10, %3 ]
  %.lcssa48 = phi i32 [ %.lcssa49, %40 ], [ %.promoted, %3 ]
  %.lcssa16 = phi i32 [ %.lcssa17, %40 ], [ %.promoted5, %3 ]
  br label %19

19:                                               ; preds = %25, %17
  %20 = phi i32 [ %26, %25 ], [ %.lcssa16, %17 ]
...
27:                                               ; preds = %33, %.preheader
  %28 = phi i32 [ %34, %33 ], [ %.lcssa48, %.preheader ]
...
40:                                               ; preds = %36, %35
  %41 = phi i32 [ %37, %36 ], [ %18, %35 ]
  %.lcssa49 = phi i32 [ %39, %36 ], [ %28, %35 ]
  %.lcssa17 = phi i32 [ %38, %36 ], [ %20, %35 ]
  %.not1 = icmp sgt i32 %.lcssa17, %.lcssa49
  br i1 %.not1, label %42, label %17, !llvm.loop !11
...
42:                                               ; preds = %40
  ...
  %44 = icmp slt i32 %43, %.lcssa49
  br i1 %44, label %45, label %47

45:                                               ; preds = %42
  %46 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %46, i32 noundef %43, i32 noundef %.lcssa49)
  br label %47
...
51:                                               ; preds = %47
  ...
  call void @Quicksort(ptr noundef %52, i32 noundef %48, i32 noundef %49)
  br label %53
