...
16:                                               ; preds = %16, %.preheader
  %.122 = phi i32 [ %.021, %.preheader ], [ %21, %16 ]
  %17 = sext i32 %.122 to i64
...
22:                                               ; preds = %16
  %.122.lcssa = phi i32 [ %.122, %16 ]
  %.lcssa2 = phi ptr [ %0, %16 ]
  %.lcssa = phi i32 [ %.122, %16 ]
  %.not = icmp sgt i32 %.1.lcssa, %.lcssa
  br i1 %.not, label %36, label %23

23:                                               ; preds = %22
  %24 = sext i32 %.1.lcssa to i64
  %25 = getelementptr inbounds [4 x i8], ptr %.lcssa2, i64 %24
  %26 = load i32, ptr %25, align 4
  %27 = sext i32 %.122.lcssa to i64
  ...
  %32 = sext i32 %.122.lcssa to i64
  %33 = getelementptr inbounds [4 x i8], ptr %0, i64 %32
  store i32 %26, ptr %33, align 4
  %34 = add nsw i32 %.1.lcssa, 1
  %35 = add nsw i32 %.122.lcssa, -1
  br label %36

36:                                               ; preds = %23, %22
  %.223 = phi i32 [ %.122.lcssa, %22 ], [ %35, %23 ]
  %.2 = phi i32 [ %.1.lcssa, %22 ], [ %34, %23 ]
  %.not1 = icmp sgt i32 %.2, %.223
  br i1 %.not1, label %37, label %9, !llvm.loop !11

37:                                               ; preds = %36
  %.2.lcssa = phi i32 [ %.2, %36 ]
  %.lcssa3 = phi i32 [ %.223, %36 ]
  %38 = icmp slt i32 %1, %.lcssa3
