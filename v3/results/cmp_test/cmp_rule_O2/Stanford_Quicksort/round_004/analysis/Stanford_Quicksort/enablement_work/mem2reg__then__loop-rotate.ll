...
36:                                               ; preds = %23, %22
  %.23 = phi i32 [ %.12.lcssa, %22 ], [ %34, %23 ]
  %.2 = phi i32 [ %.1.lcssa, %22 ], [ %35, %23 ]
  %.not1 = icmp sgt i32 %.23, %.2
  br i1 %.not1, label %37, label %9, !llvm.loop !11

37:                                               ; preds = %36
  %.23.lcssa = phi i32 [ %.23, %36 ]
  %.lcssa3 = phi i32 [ %.2, %36 ]
