...
.preheader:                                       ; preds = %..preheader_crit_edge, %16
  ...
  br i1 %30, label %.lr.ph3, label %51
...
31:                                               ; preds = %.lr.ph, %31
  ...
  br i1 %40, label %31, label %..preheader_crit_edge, !llvm.loop !9

41:                                               ; preds = %.lr.ph3, %41
  %42 = phi i32 [ %26, %.lr.ph3 ], [ %46, %41 ]
  %43 = add nsw i32 %42, -1
  ...
  br i1 %50, label %41, label %._crit_edge, !llvm.loop !10

._crit_edge:                                      ; preds = %41
  %split = phi ptr [ %45, %41 ]
  %split4 = phi i32 [ %46, %41 ]
  br label %51

51:                                               ; preds = %._crit_edge, %.preheader
  %.lcssa1 = phi ptr [ %split, %._crit_edge ], [ %25, %.preheader ]
  %.lcssa = phi i32 [ %split4, %._crit_edge ], [ %26, %.preheader ]
  %52 = load i32, ptr %7, align 4
  %.not = icmp sgt i32 %52, %.lcssa
  br i1 %.not, label %74, label %53

53:                                               ; preds = %51
  %54 = sext i32 %52 to i64
  %55 = getelementptr inbounds [4 x i8], ptr %.lcssa1, i64 %54
...
77:                                               ; preds = %74
  %.lcssa2 = phi i32 [ %76, %74 ]
  %78 = load i32, ptr %5, align 4
  %79 = icmp slt i32 %78, %.lcssa2
  br i1 %79, label %80, label %82

80:                                               ; preds = %77
  %81 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %81, i32 noundef %78, i32 noundef %.lcssa2)
  br label %82
