...
23:                                               ; preds = %.preheader
  %.lcssa2 = phi ptr [ %0, %.preheader ]
  %.lcssa = phi i32 [ %.122, %.preheader ]
...
37:                                               ; preds = %24, %23
  %.223 = phi i32 [ %.122, %23 ], [ %36, %24 ]
  %.2 = phi i32 [ %.1, %23 ], [ %35, %24 ]
  %.not1 = icmp sgt i32 %.2, %.223
  br i1 %.not1, label %38, label %9, !llvm.loop !11

38:                                               ; preds = %37
  %.lcssa3 = phi i32 [ %.223, %37 ]
  %39 = icmp slt i32 %1, %.lcssa3
