...
.preheader:                                       ; preds = %..preheader_crit_edge, %9
  %.1 = phi i32 [ %20, %..preheader_crit_edge ], [ %.0, %9 ]
...
32:                                               ; preds = %._crit_edge, %.preheader
  %.130 = phi i32 [ %27, %._crit_edge ], [ %.029, %.preheader ]
  %.lcssa2 = phi ptr [ %split, %._crit_edge ], [ %0, %.preheader ]
  %.lcssa = phi i32 [ %split2, %._crit_edge ], [ %.029, %.preheader ]
