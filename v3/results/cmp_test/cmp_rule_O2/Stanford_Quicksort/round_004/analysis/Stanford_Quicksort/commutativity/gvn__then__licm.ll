...
.preheader:                                       ; preds = %20
  ...
  %26 = getelementptr inbounds [4 x i8], ptr %19, i64 %.lcssa7
  br label %29
...
29:                                               ; preds = %35, %.preheader
  %30 = phi i32 [ %36, %35 ], [ %17, %.preheader ]
...
37:                                               ; preds = %29
  ...
  %38 = getelementptr inbounds [4 x i8], ptr %19, i64 %.lcssa
...
50:                                               ; preds = %39, %37
  %51 = phi i32 [ %49, %39 ], [ %.lcssa3, %37 ]
  %52 = phi i32 [ %48, %39 ], [ %.lcssa1, %37 ]
  %53 = phi ptr [ %43, %39 ], [ %19, %37 ]
  %.not1 = icmp sgt i32 %52, %51
  br i1 %.not1, label %54, label %16, !llvm.loop !11

54:                                               ; preds = %50
  %.lcssa6 = phi i32 [ %51, %50 ]
  %.lcssa5 = phi i32 [ %52, %50 ]
  %.lcssa4 = phi ptr [ %53, %50 ]
  %55 = load i32, ptr %5, align 4
  %56 = icmp slt i32 %55, %.lcssa6
  br i1 %56, label %57, label %58

57:                                               ; preds = %54
  call void @Quicksort(ptr noundef %.lcssa4, i32 noundef %55, i32 noundef %.lcssa6)
  %.pre = load i32, ptr %7, align 4
  br label %58

58:                                               ; preds = %57, %54
  %59 = phi i32 [ %.pre, %57 ], [ %.lcssa5, %54 ]
