...
17:                                               ; preds = %17, %16
  %.127 = phi i32 [ %.026, %16 ], [ %22, %17 ]
  %18 = sext i32 %.127 to i64
  %19 = getelementptr inbounds i32, ptr %0, i64 %18
  %20 = load i32, ptr %19, align 4
  %21 = icmp slt i32 %8, %20
  %22 = sub nsw i32 %.127, 1
...
1:                                                ; preds = %0, %2
  %.02 = phi i32 [ 0, %0 ], [ %3, %2 ]
  call void @Quick(i32 noundef %.02)
  br label %2
