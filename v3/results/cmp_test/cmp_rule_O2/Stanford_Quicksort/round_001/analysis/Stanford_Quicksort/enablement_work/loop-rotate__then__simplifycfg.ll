...
.lr.ph2:                                          ; preds = %._crit_edge, %.lr.ph2
  %45 = phi i32 [ %49, %.lr.ph2 ], [ %40, %._crit_edge ]
  %46 = sub nsw i32 %45, 1
...
._crit_edge3:                                     ; preds = %.lr.ph2, %._crit_edge
  %.lcssa1 = phi ptr [ %39, %._crit_edge ], [ %48, %.lr.ph2 ]
  %.lcssa = phi i32 [ %40, %._crit_edge ], [ %49, %.lr.ph2 ]
  %54 = load i32, ptr %7, align 4
  %55 = icmp sle i32 %54, %.lcssa
  br i1 %55, label %56, label %77

56:                                               ; preds = %._crit_edge3
  %57 = sext i32 %54 to i64
  %58 = getelementptr inbounds i32, ptr %.lcssa1, i64 %57
...
81:                                               ; preds = %77
  %.lcssa2 = phi i32 [ %79, %77 ]
  %82 = load i32, ptr %5, align 4
  %83 = icmp slt i32 %82, %.lcssa2
  br i1 %83, label %84, label %86

84:                                               ; preds = %81
  %85 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %85, i32 noundef %82, i32 noundef %.lcssa2)
  br label %86
...
90:                                               ; preds = %86
  ...
  call void @Quicksort(ptr noundef %91, i32 noundef %87, i32 noundef %88)
  br label %92
