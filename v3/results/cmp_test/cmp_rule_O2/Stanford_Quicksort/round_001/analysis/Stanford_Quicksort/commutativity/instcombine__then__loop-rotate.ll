...
42:                                               ; preds = %.lr.ph5, %42
  ...
  br i1 %51, label %42, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %42
  %split = phi ptr [ %46, %42 ]
  %split7 = phi i32 [ %47, %42 ]
  br label %52

52:                                               ; preds = %._crit_edge6, %34
  %.lcssa2 = phi ptr [ %split, %._crit_edge6 ], [ %36, %34 ]
  %.lcssa = phi i32 [ %split7, %._crit_edge6 ], [ %37, %34 ]
