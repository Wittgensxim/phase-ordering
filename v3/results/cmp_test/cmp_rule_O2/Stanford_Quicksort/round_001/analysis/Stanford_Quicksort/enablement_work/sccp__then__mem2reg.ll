...
9:                                                ; preds = %41, %3
  %.04 = phi i32 [ %1, %3 ], [ %.26, %41 ]
  %.0 = phi i32 [ %2, %3 ], [ %.2, %41 ]
  br label %10

10:                                               ; preds = %15, %9
  %.15 = phi i32 [ %.04, %9 ], [ %16, %15 ]
  %11 = sext i32 %.15 to i64
...
40:                                               ; preds = %27, %25
  %.26 = phi i32 [ %38, %27 ], [ %.15, %25 ]
  %.2 = phi i32 [ %39, %27 ], [ %.1, %25 ]
  br label %41

41:                                               ; preds = %40
  %42 = icmp sle i32 %.26, %.2
...
48:                                               ; preds = %46
  call void @Quicksort(ptr noundef %0, i32 noundef %.26, i32 noundef %2)
  br label %49
