...
42:                                               ; preds = %32
  %.lcssa1 = phi ptr [ %34, %32 ]
  %.lcssa = phi i32 [ %35, %32 ]
  %43 = load i32, ptr %7, align 4
  %44 = icmp sle i32 %43, %.lcssa
  br i1 %44, label %45, label %66

45:                                               ; preds = %42
  %46 = sext i32 %43 to i64
  %47 = getelementptr inbounds i32, ptr %.lcssa1, i64 %46
...
66:                                               ; preds = %42, %45
  ...
  br i1 %69, label %21, label %70, !llvm.loop !11

70:                                               ; preds = %66
  %.lcssa2 = phi i32 [ %68, %66 ]
  %71 = load i32, ptr %5, align 4
  %72 = icmp slt i32 %71, %.lcssa2
  br i1 %72, label %73, label %75

73:                                               ; preds = %70
  %74 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %74, i32 noundef %71, i32 noundef %.lcssa2)
  br label %75
