...
50:                                               ; preds = %._crit_edge3, %33
  %.lcssa1 = phi ptr [ %45, %._crit_edge3 ], [ %35, %33 ]
...
52:                                               ; preds = %50
  ...
  %54 = getelementptr inbounds [4 x i8], ptr %.lcssa1, i64 %53
...
74:                                               ; preds = %73
  ...
  %.not5 = icmp sgt i32 %75, %76
  br i1 %.not5, label %77, label %16, !llvm.loop !11
