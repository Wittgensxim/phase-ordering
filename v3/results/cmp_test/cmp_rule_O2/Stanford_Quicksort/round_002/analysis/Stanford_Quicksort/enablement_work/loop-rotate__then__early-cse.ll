...
55:                                               ; preds = %._crit_edge3, %38
  %.lcssa1 = phi ptr [ %50, %._crit_edge3 ], [ %40, %38 ]
  %.lcssa = phi i32 [ %48, %._crit_edge3 ], [ %41, %38 ]
  %56 = load i32, ptr %7, align 4
  %57 = icmp sle i32 %56, %.lcssa
  br i1 %57, label %58, label %79

58:                                               ; preds = %55
  %59 = sext i32 %56 to i64
  %60 = getelementptr inbounds i32, ptr %.lcssa1, i64 %59
...
87:                                               ; preds = %84
  ...
  call void @Quicksort(ptr noundef %88, i32 noundef %85, i32 noundef %82)
  br label %89
