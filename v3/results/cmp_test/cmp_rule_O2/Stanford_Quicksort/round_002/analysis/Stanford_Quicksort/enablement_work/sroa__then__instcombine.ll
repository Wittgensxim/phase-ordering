...
23:                                               ; preds = %18
  %24 = add nsw i32 %.127, -1
  br label %18, !llvm.loop !10

25:                                               ; preds = %18
  %.not = icmp sgt i32 %.1, %.127
...
26:                                               ; preds = %25
  ...
  %30 = sext i32 %.127 to i64
  %31 = getelementptr inbounds [4 x i8], ptr %0, i64 %30
  %32 = load i32, ptr %31, align 4
  %33 = sext i32 %.1 to i64
  %34 = getelementptr inbounds [4 x i8], ptr %0, i64 %33
  store i32 %32, ptr %34, align 4
  %35 = sext i32 %.127 to i64
  %36 = getelementptr inbounds [4 x i8], ptr %0, i64 %35
  store i32 %29, ptr %36, align 4
  %37 = add nsw i32 %.1, 1
  %38 = add nsw i32 %.127, -1
  br label %39

39:                                               ; preds = %26, %25
  %.228 = phi i32 [ %38, %26 ], [ %.127, %25 ]
  %.2 = phi i32 [ %37, %26 ], [ %.1, %25 ]
  br label %40

40:                                               ; preds = %39
  %.not29 = icmp sgt i32 %.2, %.228
  br i1 %.not29, label %41, label %9, !llvm.loop !11

41:                                               ; preds = %40
  %42 = icmp slt i32 %1, %.228
  br i1 %42, label %43, label %44

43:                                               ; preds = %41
  call void @Quicksort(ptr noundef %0, i32 noundef %1, i32 noundef %.228)
  br label %44
