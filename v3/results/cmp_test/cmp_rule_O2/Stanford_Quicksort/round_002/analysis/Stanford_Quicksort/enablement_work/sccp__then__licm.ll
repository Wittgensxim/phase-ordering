...
3:                                                ; preds = %23, %0
  %4 = phi i32 [ %8, %23 ], [ %.promoted1, %0 ]
  %5 = phi i32 [ %24, %23 ], [ %.promoted, %0 ]
  %6 = icmp sle i32 %5, 5000
  br i1 %6, label %7, label %25

7:                                                ; preds = %3
  %8 = call i32 @Rand()
  %.reass = sub i32 %8, 50000
  %9 = sext i32 %5 to i64
...
27:                                               ; preds = %63, %3
  %28 = phi i32 [ %62, %63 ], [ %.promoted12, %3 ]
  %.lcssa610 = phi i32 [ %.lcssa611, %63 ], [ %.promoted, %3 ]
  %.lcssa48 = phi i32 [ %.lcssa49, %63 ], [ %.promoted7, %3 ]
  br label %29

29:                                               ; preds = %35, %27
  %30 = phi i32 [ %36, %35 ], [ %.lcssa48, %27 ]
...
37:                                               ; preds = %29
  %.lcssa4 = phi i32 [ %30, %29 ]
  br label %38

38:                                               ; preds = %44, %37
  %39 = phi i32 [ %45, %44 ], [ %.lcssa610, %37 ]
...
46:                                               ; preds = %38
  %.lcssa6 = phi i32 [ %39, %38 ]
  %.lcssa1 = phi ptr [ %24, %38 ]
  %.lcssa = phi i32 [ %39, %38 ]
  %47 = icmp sle i32 %.lcssa4, %.lcssa
...
48:                                               ; preds = %46
  ...
  %52 = sext i32 %.lcssa6 to i64
  %53 = getelementptr inbounds i32, ptr %25, i64 %52
  %54 = load i32, ptr %53, align 4
  %55 = sext i32 %.lcssa4 to i64
  %56 = getelementptr inbounds i32, ptr %25, i64 %55
  store i32 %54, ptr %56, align 4
  %57 = sext i32 %.lcssa6 to i64
  %58 = getelementptr inbounds i32, ptr %26, i64 %57
  store i32 %51, ptr %58, align 4
  %59 = add nsw i32 %.lcssa4, 1
  %60 = sub nsw i32 %.lcssa6, 1
  br label %61

61:                                               ; preds = %48, %46
  %62 = phi i32 [ %51, %48 ], [ %28, %46 ]
  %.lcssa611 = phi i32 [ %60, %48 ], [ %.lcssa6, %46 ]
  %.lcssa49 = phi i32 [ %59, %48 ], [ %.lcssa4, %46 ]
  br label %63

63:                                               ; preds = %61
  %64 = icmp sle i32 %.lcssa49, %.lcssa611
  br i1 %64, label %27, label %65, !llvm.loop !11

65:                                               ; preds = %63
  %.lcssa13 = phi i32 [ %62, %63 ]
  %.lcssa611.lcssa = phi i32 [ %.lcssa611, %63 ]
  %.lcssa49.lcssa = phi i32 [ %.lcssa49, %63 ]
  %.lcssa2 = phi i32 [ %.lcssa611, %63 ]
