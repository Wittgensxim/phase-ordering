...
39:                                               ; preds = %._crit_edge, %21
  ...
  br i1 %46, label %.lr.ph5, label %57

.lr.ph5:                                          ; preds = %39
  br label %47

47:                                               ; preds = %.lr.ph5, %47
  %48 = phi i32 [ %42, %.lr.ph5 ], [ %52, %47 ]
  %49 = sub nsw i32 %48, 1
  ...
  br i1 %56, label %47, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %47
  %split = phi ptr [ %51, %47 ]
  %split7 = phi i32 [ %52, %47 ]
  br label %57

57:                                               ; preds = %._crit_edge6, %39
  %.lcssa1 = phi ptr [ %split, %._crit_edge6 ], [ %41, %39 ]
  %.lcssa = phi i32 [ %split7, %._crit_edge6 ], [ %42, %39 ]
