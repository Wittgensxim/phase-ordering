...
9:                                                ; preds = %40, %3
  %.02 = phi i32 [ %1, %3 ], [ %.24, %40 ]
  %.0 = phi i32 [ %2, %3 ], [ %.2, %40 ]
  br label %10

10:                                               ; preds = %15, %9
  %.13 = phi i32 [ %.02, %9 ], [ %16, %15 ]
  %11 = sext i32 %.13 to i64
...
39:                                               ; preds = %26, %25
  %.24 = phi i32 [ %.13, %25 ], [ %37, %26 ]
  %.2 = phi i32 [ %.1, %25 ], [ %38, %26 ]
  br label %40

40:                                               ; preds = %39
  %.not1 = icmp sgt i32 %.24, %.2
...
46:                                               ; preds = %44
  call void @Quicksort(ptr noundef %0, i32 noundef %.24, i32 noundef %2)
  br label %47
