...
9:                                                ; preds = %45, %3
  ...
  %.lcssa26 = phi i32 [ %.lcssa27, %45 ], [ %2, %3 ]
  %.lcssa4 = phi i32 [ %.lcssa5, %45 ], [ %1, %3 ]
  br label %11

11:                                               ; preds = %17, %9
  %12 = phi i32 [ %18, %17 ], [ %.lcssa4, %9 ]
...
30:                                               ; preds = %28
  ...
  %41 = add nsw i32 %.lcssa, 1
  %42 = sub nsw i32 %.lcssa2, 1
  br label %43

43:                                               ; preds = %30, %28
  %44 = phi i32 [ %33, %30 ], [ %10, %28 ]
  %.lcssa27 = phi i32 [ %42, %30 ], [ %.lcssa2, %28 ]
  %.lcssa5 = phi i32 [ %41, %30 ], [ %.lcssa, %28 ]
  br label %45

45:                                               ; preds = %43
  %46 = icmp sle i32 %.lcssa5, %.lcssa27
  br i1 %46, label %9, label %47, !llvm.loop !11

47:                                               ; preds = %45
  %.lcssa9 = phi i32 [ %44, %45 ]
  %.lcssa27.lcssa = phi i32 [ %.lcssa27, %45 ]
  %.lcssa5.lcssa = phi i32 [ %.lcssa5, %45 ]
  %48 = icmp slt i32 %1, %.lcssa27.lcssa
  br i1 %48, label %49, label %50

49:                                               ; preds = %47
  call void @Quicksort(ptr noundef %0, i32 noundef %1, i32 noundef %.lcssa27.lcssa)
  br label %50

50:                                               ; preds = %49, %47
  %51 = icmp slt i32 %.lcssa5.lcssa, %2
  br i1 %51, label %52, label %53

52:                                               ; preds = %50
  call void @Quicksort(ptr noundef %0, i32 noundef %.lcssa5.lcssa, i32 noundef %2)
  br label %53
