...
17:                                               ; preds = %17, %16
  %.122 = phi i32 [ %.021, %16 ], [ %22, %17 ]
  %18 = sext i32 %.122 to i64
  %19 = getelementptr inbounds [4 x i8], ptr %0, i64 %18
  %20 = load i32, ptr %19, align 4
  %21 = icmp slt i32 %8, %20
  %22 = add nsw i32 %.122, -1
  br i1 %21, label %17, label %23, !llvm.loop !10

23:                                               ; preds = %17
  %.122.lcssa = phi i32 [ %.122, %17 ]
  %.lcssa2 = phi ptr [ %0, %17 ]
  %.lcssa = phi i32 [ %.122, %17 ]
  %.not = icmp sgt i32 %.1.lcssa, %.lcssa
  br i1 %.not, label %37, label %24

24:                                               ; preds = %23
  %25 = sext i32 %.1.lcssa to i64
  %26 = getelementptr inbounds [4 x i8], ptr %.lcssa2, i64 %25
  %27 = load i32, ptr %26, align 4
  %28 = sext i32 %.122.lcssa to i64
  %29 = getelementptr inbounds [4 x i8], ptr %0, i64 %28
  %30 = load i32, ptr %29, align 4
  %31 = sext i32 %.1.lcssa to i64
  %32 = getelementptr inbounds [4 x i8], ptr %0, i64 %31
  store i32 %30, ptr %32, align 4
  %33 = sext i32 %.122.lcssa to i64
  %34 = getelementptr inbounds [4 x i8], ptr %0, i64 %33
  store i32 %27, ptr %34, align 4
  %35 = add nsw i32 %.1.lcssa, 1
  %36 = add nsw i32 %.122.lcssa, -1
  br label %37

37:                                               ; preds = %24, %23
  %.223 = phi i32 [ %.122.lcssa, %23 ], [ %36, %24 ]
  %.2 = phi i32 [ %.1.lcssa, %23 ], [ %35, %24 ]
  br label %38

38:                                               ; preds = %37
  %.not1 = icmp sgt i32 %.2, %.223
  br i1 %.not1, label %39, label %9, !llvm.loop !11

39:                                               ; preds = %38
  %.2.lcssa = phi i32 [ %.2, %38 ]
  %.lcssa3 = phi i32 [ %.223, %38 ]
  %40 = icmp slt i32 %1, %.lcssa3
