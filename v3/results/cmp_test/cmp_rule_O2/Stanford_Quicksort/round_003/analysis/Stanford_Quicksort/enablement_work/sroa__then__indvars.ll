...
18:                                               ; preds = %22, %16
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %22 ], [ %17, %16 ]
  %19 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv25
...
23:                                               ; preds = %18
  %.122.lcssa.wide = phi i64 [ %indvars.iv25, %18 ]
  %.lcssa2 = phi ptr [ %0, %18 ]
  %.lcssa.wide = phi i64 [ %indvars.iv25, %18 ]
  %24 = trunc nsw i64 %.1.lcssa.wide to i32
  %25 = trunc nsw i64 %.122.lcssa.wide to i32
...
27:                                               ; preds = %23
  ...
  %29 = getelementptr inbounds [4 x i8], ptr %.lcssa2, i64 %28
...
40:                                               ; preds = %27, %23
  %.223 = phi i32 [ %25, %23 ], [ %39, %27 ]
  %.2 = phi i32 [ %24, %23 ], [ %38, %27 ]
  br label %41

41:                                               ; preds = %40
  %.not1 = icmp sgt i32 %.2, %.223
  br i1 %.not1, label %42, label %9, !llvm.loop !11

42:                                               ; preds = %41
  %.2.lcssa = phi i32 [ %.2, %41 ]
  %.lcssa3 = phi i32 [ %.223, %41 ]
  %43 = icmp slt i32 %1, %.lcssa3
