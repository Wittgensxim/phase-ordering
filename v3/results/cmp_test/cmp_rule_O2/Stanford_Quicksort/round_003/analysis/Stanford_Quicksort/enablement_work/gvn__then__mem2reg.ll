...
9:                                                ; preds = %38, %3
  %.01 = phi i32 [ %1, %3 ], [ %.23, %38 ]
  %.0 = phi i32 [ %2, %3 ], [ %.2, %38 ]
  %10 = phi i32 [ %39, %38 ], [ %2, %3 ]
  %11 = phi i32 [ %40, %38 ], [ %1, %3 ]
  %12 = phi ptr [ %41, %38 ], [ %0, %3 ]
  br label %13
...
38:                                               ; preds = %31, %30
  %.23 = phi i32 [ %.12, %30 ], [ %36, %31 ]
  %.2 = phi i32 [ %.1, %30 ], [ %37, %31 ]
  %39 = phi i32 [ %37, %31 ], [ %23, %30 ]
  %40 = phi i32 [ %36, %31 ], [ %14, %30 ]
  %41 = phi ptr [ %0, %31 ], [ %12, %30 ]
  %.not1 = icmp sgt i32 %40, %39
  br i1 %.not1, label %42, label %9, !llvm.loop !11

42:                                               ; preds = %38
  %43 = icmp slt i32 %1, %39
  br i1 %43, label %44, label %45

44:                                               ; preds = %42
  call void @Quicksort(ptr noundef %41, i32 noundef %1, i32 noundef %39)
  br label %45

45:                                               ; preds = %44, %42
  %46 = phi i32 [ %.23, %44 ], [ %40, %42 ]
  %47 = icmp slt i32 %46, %2
  br i1 %47, label %48, label %49

48:                                               ; preds = %45
  call void @Quicksort(ptr noundef %0, i32 noundef %46, i32 noundef %2)
  br label %49
