...
34:                                               ; preds = %._crit_edge, %16
  ...
  br i1 %41, label %.lr.ph4, label %52

.lr.ph4:                                          ; preds = %34
  br label %42

42:                                               ; preds = %.lr.ph4, %42
  %43 = phi i32 [ %37, %.lr.ph4 ], [ %47, %42 ]
  %44 = add nsw i32 %43, -1
  ...
  br i1 %51, label %42, label %._crit_edge5, !llvm.loop !10

._crit_edge5:                                     ; preds = %42
  %split = phi ptr [ %46, %42 ]
  %split6 = phi i32 [ %47, %42 ]
  br label %52

52:                                               ; preds = %._crit_edge5, %34
  %.lcssa1 = phi ptr [ %split, %._crit_edge5 ], [ %36, %34 ]
  %.lcssa = phi i32 [ %split6, %._crit_edge5 ], [ %37, %34 ]
...
54:                                               ; preds = %52
  ...
  %56 = getelementptr inbounds [4 x i8], ptr %.lcssa1, i64 %55
...
79:                                               ; preds = %76
  %.lcssa2 = phi i32 [ %78, %76 ]
  %80 = load i32, ptr %5, align 4
  %81 = icmp slt i32 %80, %.lcssa2
  br i1 %81, label %82, label %84

82:                                               ; preds = %79
  %83 = load ptr, ptr %4, align 8
  call void @Quicksort(ptr noundef %83, i32 noundef %80, i32 noundef %.lcssa2)
  br label %84
