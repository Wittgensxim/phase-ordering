...
33:                                               ; preds = %._crit_edge3, %21
  %.1 = phi i32 [ %28, %._crit_edge3 ], [ %.0, %21 ]
  %.lcssa2 = phi ptr [ %split, %._crit_edge3 ], [ %0, %21 ]
  %.lcssa = phi i32 [ %split4, %._crit_edge3 ], [ %.0, %21 ]
  %.not = icmp sgt i32 %.16, %.lcssa
...
47:                                               ; preds = %34, %33
  %.27 = phi i32 [ %.16, %33 ], [ %45, %34 ]
  %.2 = phi i32 [ %.1, %33 ], [ %46, %34 ]
  br label %48

48:                                               ; preds = %47
  %.not1 = icmp sgt i32 %.27, %.2
...
52:                                               ; preds = %51, %49
  %53 = icmp slt i32 %.27, %2
  br i1 %53, label %54, label %55

54:                                               ; preds = %52
  call void @Quicksort(ptr noundef %0, i32 noundef %.27, i32 noundef %2)
  br label %55
