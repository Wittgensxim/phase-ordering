...
16:                                               ; preds = %55, %3
  %17 = phi i32 [ %56, %55 ], [ %2, %3 ]
  %18 = phi i32 [ %57, %55 ], [ %1, %3 ]
  %19 = phi ptr [ %58, %55 ], [ %0, %3 ]
...
36:                                               ; preds = %.lr.ph9, %36
  ...
  %40 = getelementptr inbounds [4 x i8], ptr %19, i64 %39
...
44:                                               ; preds = %43
  %45 = load i32, ptr %.lcssa, align 4
  store i32 %45, ptr %10, align 4
  %46 = load i32, ptr %.lcssa2, align 4
  store i32 %46, ptr %.lcssa, align 4
...
55:                                               ; preds = %44, %43
  %56 = phi i32 [ %54, %44 ], [ %.lcssa3, %43 ]
  %57 = phi i32 [ %53, %44 ], [ %.lcssa1, %43 ]
  %58 = phi ptr [ %48, %44 ], [ %19, %43 ]
  %.not1 = icmp sgt i32 %57, %56
  br i1 %.not1, label %59, label %16, !llvm.loop !11

59:                                               ; preds = %55
  %.lcssa6 = phi i32 [ %56, %55 ]
  %.lcssa5 = phi i32 [ %57, %55 ]
  %.lcssa4 = phi ptr [ %58, %55 ]
  %60 = load i32, ptr %5, align 4
  %61 = icmp slt i32 %60, %.lcssa6
  br i1 %61, label %62, label %63

62:                                               ; preds = %59
  call void @Quicksort(ptr noundef %.lcssa4, i32 noundef %60, i32 noundef %.lcssa6)
  %.pre = load i32, ptr %7, align 4
  br label %63

63:                                               ; preds = %62, %59
  %64 = phi i32 [ %.pre, %62 ], [ %.lcssa5, %59 ]
