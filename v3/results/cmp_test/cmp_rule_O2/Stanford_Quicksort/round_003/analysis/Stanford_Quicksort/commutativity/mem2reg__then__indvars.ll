...
18:                                               ; preds = %22, %16
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %22 ], [ %17, %16 ]
  %19 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv5
...
23:                                               ; preds = %18
  %.1.lcssa.wide = phi i64 [ %indvars.iv5, %18 ]
  %.lcssa2 = phi ptr [ %0, %18 ]
  %.lcssa.wide = phi i64 [ %indvars.iv5, %18 ]
  %24 = trunc nsw i64 %.12.lcssa.wide to i32
...
40:                                               ; preds = %27, %23
  %.23 = phi i32 [ %24, %23 ], [ %38, %27 ]
  %.2 = phi i32 [ %25, %23 ], [ %39, %27 ]
  br label %41
