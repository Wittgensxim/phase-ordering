...
37:                                               ; preds = %._crit_edge, %.preheader
  ...
  br i1 %41, label %.preheader, label %._crit_edge1, !llvm.loop !9

._crit_edge1:                                     ; preds = %37
  br label %42

42:                                               ; preds = %._crit_edge1, %.preheader1
  %43 = load i32, ptr %7, align 4
  %44 = add nsw i32 %43, 1
  store i32 %44, ptr %7, align 4
  %45 = load i32, ptr %3, align 4
  %46 = icmp slt i32 %44, %45
  br i1 %46, label %.preheader1, label %._crit_edge2, !llvm.loop !10

._crit_edge2:                                     ; preds = %42
  br label %47

47:                                               ; preds = %._crit_edge2, %.preheader2
  %48 = load i32, ptr %6, align 4
  %49 = add nsw i32 %48, 1
  store i32 %49, ptr %6, align 4
  %50 = load i32, ptr %3, align 4
  %51 = icmp slt i32 %49, %50
  br i1 %51, label %.preheader2, label %._crit_edge3, !llvm.loop !11

._crit_edge3:                                     ; preds = %47
  br label %52

52:                                               ; preds = %._crit_edge3, %.preheader3
  %53 = load i32, ptr %5, align 4
  %54 = add nsw i32 %53, 1
  store i32 %54, ptr %5, align 4
  %55 = load i32, ptr %3, align 4
  %56 = icmp slt i32 %54, %55
  br i1 %56, label %.preheader3, label %._crit_edge4, !llvm.loop !12

._crit_edge4:                                     ; preds = %52
  br label %57

57:                                               ; preds = %._crit_edge4, %.preheader4
