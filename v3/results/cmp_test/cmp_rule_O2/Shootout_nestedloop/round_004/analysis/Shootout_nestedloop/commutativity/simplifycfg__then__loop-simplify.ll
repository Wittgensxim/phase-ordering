...
18:                                               ; preds = %48, %16
  ...
  br i1 %20, label %.preheader4.preheader, label %51

.preheader4.preheader:                            ; preds = %18
  br label %.preheader4

.preheader4:                                      ; preds = %.preheader4.preheader, %45
  %storemerge1 = phi i32 [ %47, %45 ], [ 0, %.preheader4.preheader ]
  store i32 %storemerge1, ptr %5, align 4
  %21 = load i32, ptr %3, align 4
  %22 = icmp slt i32 %storemerge1, %21
  br i1 %22, label %.preheader3.preheader, label %48

.preheader3.preheader:                            ; preds = %.preheader4
  br label %.preheader3

.preheader3:                                      ; preds = %.preheader3.preheader, %42
  %storemerge2 = phi i32 [ %44, %42 ], [ 0, %.preheader3.preheader ]
  store i32 %storemerge2, ptr %6, align 4
  %23 = load i32, ptr %3, align 4
  %24 = icmp slt i32 %storemerge2, %23
  br i1 %24, label %.preheader2.preheader, label %45

.preheader2.preheader:                            ; preds = %.preheader3
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %39
  %storemerge3 = phi i32 [ %41, %39 ], [ 0, %.preheader2.preheader ]
  store i32 %storemerge3, ptr %7, align 4
  %25 = load i32, ptr %3, align 4
  %26 = icmp slt i32 %storemerge3, %25
  br i1 %26, label %.preheader1.preheader, label %42

.preheader1.preheader:                            ; preds = %.preheader2
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader1.preheader, %36
  %storemerge4 = phi i32 [ %38, %36 ], [ 0, %.preheader1.preheader ]
  store i32 %storemerge4, ptr %8, align 4
  %27 = load i32, ptr %3, align 4
  %28 = icmp slt i32 %storemerge4, %27
  br i1 %28, label %.preheader.preheader, label %39

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %31
  %storemerge5 = phi i32 [ %35, %31 ], [ 0, %.preheader.preheader ]
