...
12:                                               ; preds = %31, %.preheader4
  %.1 = phi i32 [ %.0, %.preheader4 ], [ %.2, %31 ]
  %storemerge1 = phi i32 [ 0, %.preheader4 ], [ %32, %31 ]
...
14:                                               ; preds = %29, %.preheader3
  %.2 = phi i32 [ %.1, %.preheader3 ], [ %.3, %29 ]
  %storemerge2 = phi i32 [ 0, %.preheader3 ], [ %30, %29 ]
...
16:                                               ; preds = %27, %.preheader2
  %.3 = phi i32 [ %.2, %.preheader2 ], [ %.4, %27 ]
  %storemerge3 = phi i32 [ 0, %.preheader2 ], [ %28, %27 ]
...
18:                                               ; preds = %25, %.preheader1
  %.4 = phi i32 [ %.3, %.preheader1 ], [ %.5, %25 ]
  %storemerge4 = phi i32 [ 0, %.preheader1 ], [ %26, %25 ]
...
20:                                               ; preds = %22, %.preheader
  ...
  %storemerge5 = phi i32 [ 0, %.preheader ], [ %24, %22 ]
...
27:                                               ; preds = %18
  %28 = add nuw nsw i32 %storemerge3, 1
...
31:                                               ; preds = %14
  %32 = add nuw nsw i32 %storemerge1, 1
...
35:                                               ; preds = %10
  %36 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %.0) #2
  ret i32 0
}
