...
22:                                               ; preds = %.lr.ph, %24
  %.021 = phi i32 [ 0, %.lr.ph ], [ %25, %24 ]
  %.10 = phi i32 [ %.8, %.lr.ph ], [ %23, %24 ]
  %23 = add nsw i32 %.10, 1
  br label %24

24:                                               ; preds = %22
  %25 = add nsw i32 %.021, 1
