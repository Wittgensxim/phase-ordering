...
12:                                               ; preds = %10, %31
  %.1 = phi i32 [ %.0, %10 ], [ %.2, %31 ]
  %storemerge1 = phi i32 [ %32, %31 ], [ 0, %10 ]
  %13 = icmp slt i32 %storemerge1, %9
  br i1 %13, label %14, label %33

14:                                               ; preds = %12, %29
  %.2 = phi i32 [ %.1, %12 ], [ %.3, %29 ]
  %storemerge2 = phi i32 [ %30, %29 ], [ 0, %12 ]
  %15 = icmp slt i32 %storemerge2, %9
  br i1 %15, label %16, label %31

16:                                               ; preds = %14, %27
  %.3 = phi i32 [ %.2, %14 ], [ %.4, %27 ]
  %storemerge3 = phi i32 [ %28, %27 ], [ 0, %14 ]
  %17 = icmp slt i32 %storemerge3, %9
  br i1 %17, label %18, label %29

18:                                               ; preds = %16, %25
  %.4 = phi i32 [ %.3, %16 ], [ %.5, %25 ]
  %storemerge4 = phi i32 [ %26, %25 ], [ 0, %16 ]
  %19 = icmp slt i32 %storemerge4, %9
  br i1 %19, label %20, label %27

20:                                               ; preds = %18, %22
  %.5 = phi i32 [ %.4, %18 ], [ %23, %22 ]
  %storemerge5 = phi i32 [ %24, %22 ], [ 0, %18 ]
