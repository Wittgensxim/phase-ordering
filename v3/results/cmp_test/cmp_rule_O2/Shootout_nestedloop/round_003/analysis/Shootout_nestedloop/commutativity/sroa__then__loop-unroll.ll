...
11:                                               ; preds = %45, %9
  %.0 = phi i32 [ 0, %9 ], [ %.1.lcssa, %45 ]
  %storemerge = phi i32 [ 0, %9 ], [ %46, %45 ]
...
14:                                               ; preds = %42, %13
  %.1 = phi i32 [ %.0, %13 ], [ %.2.lcssa, %42 ]
  %storemerge1 = phi i32 [ 0, %13 ], [ %43, %42 ]
...
17:                                               ; preds = %39, %16
  %.2 = phi i32 [ %.1, %16 ], [ %.3.lcssa, %39 ]
  %storemerge2 = phi i32 [ 0, %16 ], [ %40, %39 ]
...
20:                                               ; preds = %36, %19
  %.3 = phi i32 [ %.2, %19 ], [ %.4.lcssa, %36 ]
  %storemerge3 = phi i32 [ 0, %19 ], [ %37, %36 ]
...
23:                                               ; preds = %33, %22
  %.4 = phi i32 [ %.3, %22 ], [ %.5.lcssa, %33 ]
  %storemerge4 = phi i32 [ 0, %22 ], [ %34, %33 ]
...
26:                                               ; preds = %30, %25
  ...
  %storemerge5 = phi i32 [ 0, %25 ], [ %31, %30 ]
...
30:                                               ; preds = %28
  %31 = add nsw i32 %storemerge5, 1
  br label %26, !llvm.loop !7

32:                                               ; preds = %26
  %.5.lcssa = phi i32 [ %.5, %26 ]
  br label %33

33:                                               ; preds = %32
  %34 = add nsw i32 %storemerge4, 1
  br label %23, !llvm.loop !9

35:                                               ; preds = %23
  %.4.lcssa = phi i32 [ %.4, %23 ]
  br label %36
