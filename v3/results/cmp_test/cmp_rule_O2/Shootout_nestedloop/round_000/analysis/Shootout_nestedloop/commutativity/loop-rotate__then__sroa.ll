...
22:                                               ; preds = %.lr.ph, %24
  %.048 = phi i32 [ 0, %.lr.ph ], [ %25, %24 ]
  %.10 = phi i32 [ %.8, %.lr.ph ], [ %23, %24 ]
  %23 = add nsw i32 %.10, 1
  br label %24

24:                                               ; preds = %22
  %25 = add nsw i32 %.048, 1
...
47:                                               ; preds = %._crit_edge15, %9
  ...
  %48 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %.1)
  ret i32 0
}
