...
15:                                               ; preds = %0, %31
  %.05 = phi double [ 0.000000e+00, %0 ], [ %30, %31 ]
  %.014 = phi i32 [ 1, %0 ], [ %32, %31 ]
  %.023 = phi double [ 0.000000e+00, %0 ], [ %16, %31 ]
  %16 = fadd double %.023, %13
  ...
  %30 = fadd double %.05, %29
  br label %31

31:                                               ; preds = %15
  %32 = add nsw i32 %.014, 1
  %33 = icmp sle i32 %32, %14
  br i1 %33, label %15, label %34, !llvm.loop !7

34:                                               ; preds = %31
  %.0.lcssa = phi double [ %30, %31 ]
  ...
  %53 = call double @llvm.fmuladd.f64(double %52, double %.0.lcssa, double %51)
