...
25:                                               ; preds = %39, %0
  %26 = phi double [ %.promoted5, %0 ], [ %38, %39 ]
  %27 = phi double [ %.promoted3, %0 ], [ %31, %39 ]
  %28 = phi double [ %.promoted, %0 ], [ %30, %39 ]
  %storemerge = phi i32 [ 1, %0 ], [ %40, %39 ]
  %.not.not = icmp slt i32 %storemerge, %15
  br i1 %.not.not, label %29, label %41

29:                                               ; preds = %25
  %30 = fadd double %28, %16
  %31 = fmul double %30, %17
  %32 = call double @llvm.fmuladd.f64(double %31, double %20, double %19)
  %33 = call double @llvm.fmuladd.f64(double %31, double %32, double %18)
  %34 = call double @llvm.fmuladd.f64(double %31, double %24, double %23)
  %35 = call double @llvm.fmuladd.f64(double %31, double %34, double %22)
  %36 = call double @llvm.fmuladd.f64(double %31, double %35, double %21)
...
41:                                               ; preds = %25
  %.lcssa6 = phi double [ %26, %25 ]
  %.lcssa4 = phi double [ %27, %25 ]
  %.lcssa = phi double [ %28, %25 ]
  ...
  %71 = fadd double %70, -2.520000e+01
  store double %71, ptr @sc, align 8
  %72 = fmul double %71, 1.000000e-30
  %73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %72, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
