...
11:                                               ; preds = %10
  ...
  %13 = fmul double %12, %2
  %14 = call double @llvm.fmuladd.f64(double %13, double %5, double %4)
  %15 = call double @llvm.fmuladd.f64(double %13, double %14, double %3)
  %16 = call double @llvm.fmuladd.f64(double %13, double %7, double %6)
  %17 = call double @llvm.fmuladd.f64(double %13, double %16, double %3)
...
22:                                               ; preds = %8
  ...
  %38 = call double @llvm.fmuladd.f64(double %37, double %.019, double %36)
  %39 = fmul double %2, %38
