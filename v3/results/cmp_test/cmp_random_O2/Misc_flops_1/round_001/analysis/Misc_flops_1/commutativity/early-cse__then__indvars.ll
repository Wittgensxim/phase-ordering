...
8:                                                ; preds = %24, %0
  %.020 = phi double [ 0.000000e+00, %0 ], [ %10, %24 ]
  %.019 = phi double [ 0.000000e+00, %0 ], [ %23, %24 ]
  %.0 = phi i32 [ 1, %0 ], [ %25, %24 ]
  %exitcond = icmp ne i32 %.0, 312500000
  br i1 %exitcond, label %9, label %26

9:                                                ; preds = %8
  %10 = fadd double %.020, %6
  %11 = fmul double %10, %7
...
26:                                               ; preds = %8
  ...
  %43 = call double @llvm.fmuladd.f64(double %42, double %.019.lcssa, double %41)
  %44 = fmul double %7, %43
