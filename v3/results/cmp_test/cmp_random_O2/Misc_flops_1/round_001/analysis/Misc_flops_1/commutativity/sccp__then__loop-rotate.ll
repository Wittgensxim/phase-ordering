...
9:                                                ; preds = %0, %25
  %.03 = phi i32 [ 1, %0 ], [ %26, %25 ]
  %.0192 = phi double [ 0.000000e+00, %0 ], [ %24, %25 ]
  %.0201 = phi double [ 0.000000e+00, %0 ], [ %10, %25 ]
  %10 = fadd double %.0201, %8
  %11 = fmul double %10, %7
  ...
  %20 = call double @llvm.fmuladd.f64(double %11, double %19, double %18)
  %21 = call double @llvm.fmuladd.f64(double %11, double %20, double %17)
  %22 = call double @llvm.fmuladd.f64(double %11, double %21, double %8)
  %23 = fdiv double %16, %22
  %24 = fadd double %.0192, %23
  br label %25

25:                                               ; preds = %9
  %26 = add nsw i32 %.03, 1
  %27 = icmp sle i32 %26, 312499999
  br i1 %27, label %9, label %28, !llvm.loop !7

28:                                               ; preds = %25
  %.019.lcssa = phi double [ %24, %25 ]
