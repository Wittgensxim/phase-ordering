...
9:                                                ; preds = %26, %0
  %.020 = phi double [ 0.000000e+00, %0 ], [ %11, %26 ]
  %.019 = phi double [ 0.000000e+00, %0 ], [ %25, %26 ]
  %.0 = phi i32 [ 1, %0 ], [ %27, %26 ]
  %exitcond = icmp ne i32 %.0, 312500000
  br i1 %exitcond, label %10, label %28

10:                                               ; preds = %9
  %11 = fadd double %.020, %8
  %12 = fmul double %11, %7
  %13 = load double, ptr @D1, align 8
  %14 = load double, ptr @D2, align 8
  %15 = load double, ptr @D3, align 8
  %16 = call double @llvm.fmuladd.f64(double %12, double %15, double %14)
  %17 = call double @llvm.fmuladd.f64(double %12, double %16, double %13)
  %18 = load double, ptr @D1, align 8
  %19 = load double, ptr @E2, align 8
  %20 = load double, ptr @E3, align 8
  %21 = call double @llvm.fmuladd.f64(double %12, double %20, double %19)
  %22 = call double @llvm.fmuladd.f64(double %12, double %21, double %18)
  %23 = call double @llvm.fmuladd.f64(double %12, double %22, double %8)
  %24 = fdiv double %17, %23
  %25 = fadd double %.019, %24
  br label %26
...
28:                                               ; preds = %9
  ...
  %44 = load double, ptr @sb, align 8
  %45 = fadd double %43, %44
  %46 = load double, ptr @two, align 8
  %47 = call double @llvm.fmuladd.f64(double %46, double %.019.lcssa, double %45)
  %48 = fmul double %7, %47
  ...
  %54 = load double, ptr @sb, align 8
  %55 = fptosi double %54 to i32
  %56 = mul nsw i32 40000, %55
  %57 = sitofp i32 %56 to double
  %58 = load double, ptr @scale, align 8
  %59 = fdiv double %57, %58
  %60 = fptosi double %59 to i32
  %61 = load double, ptr @sb, align 8
  %62 = fsub double %61, 2.520000e+01
