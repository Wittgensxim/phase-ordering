...
8:                                                ; preds = %0, %23
  ...
  %.0192 = phi double [ 0.000000e+00, %0 ], [ %22, %23 ]
  %.0201 = phi double [ 0.000000e+00, %0 ], [ %9, %23 ]
  %9 = fadd double %.0201, %6
  %10 = fmul double %9, %7
...
26:                                               ; preds = %23
  ...
  %38 = call double @llvm.fmuladd.f64(double %37, double %22, double %36)
  %39 = fmul double %7, %38
