...
21:                                               ; preds = %20
  %22 = fadd double %.020, %13
  %23 = fmul double %22, %12
  %24 = call double @llvm.fmuladd.f64(double %23, double %16, double %15)
  %25 = call double @llvm.fmuladd.f64(double %23, double %24, double %14)
  %26 = call double @llvm.fmuladd.f64(double %23, double %19, double %18)
  %27 = call double @llvm.fmuladd.f64(double %23, double %26, double %17)
  %28 = call double @llvm.fmuladd.f64(double %23, double %27, double %13)
