...
19:                                               ; preds = %31, %0
  %.020 = phi double [ 0.000000e+00, %0 ], [ %22, %31 ]
  %.019 = phi double [ 0.000000e+00, %0 ], [ %30, %31 ]
  %.0 = phi i32 [ 1, %0 ], [ %32, %31 ]
  %20 = icmp sle i32 %.0, %12
  br i1 %20, label %21, label %33

21:                                               ; preds = %19
  %22 = fadd double %11, %.020
  %23 = fmul double %10, %22
  %24 = call double @llvm.fmuladd.f64(double %23, double %15, double %14)
  %25 = call double @llvm.fmuladd.f64(double %23, double %24, double %13)
  %26 = call double @llvm.fmuladd.f64(double %23, double %18, double %17)
  %27 = call double @llvm.fmuladd.f64(double %23, double %26, double %16)
...
33:                                               ; preds = %19
  ...
  %52 = call double @llvm.fmuladd.f64(double %51, double %.019.lcssa, double %50)
