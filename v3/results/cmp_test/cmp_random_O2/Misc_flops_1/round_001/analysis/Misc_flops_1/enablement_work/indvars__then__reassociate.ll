...
12:                                               ; preds = %29, %0
  %.020 = phi double [ 0.000000e+00, %0 ], [ %14, %29 ]
  %.019 = phi double [ 0.000000e+00, %0 ], [ %28, %29 ]
  %.0 = phi i32 [ 1, %0 ], [ %30, %29 ]
  %exitcond = icmp ne i32 %.0, 312500000
  br i1 %exitcond, label %13, label %31

13:                                               ; preds = %12
  %14 = fadd double %11, %.020
  %15 = fmul double %10, %14
  %16 = load double, ptr @D1, align 8
  %17 = load double, ptr @D2, align 8
  %18 = load double, ptr @D3, align 8
  %19 = call double @llvm.fmuladd.f64(double %15, double %18, double %17)
  %20 = call double @llvm.fmuladd.f64(double %15, double %19, double %16)
  %21 = load double, ptr @D1, align 8
  %22 = load double, ptr @E2, align 8
  %23 = load double, ptr @E3, align 8
  %24 = call double @llvm.fmuladd.f64(double %15, double %23, double %22)
  %25 = call double @llvm.fmuladd.f64(double %15, double %24, double %21)
  %26 = call double @llvm.fmuladd.f64(double %15, double %25, double %11)
  %27 = fdiv double %20, %26
  %28 = fadd double %.019, %27
  br label %29
...
31:                                               ; preds = %12
  ...
  %50 = call double @llvm.fmuladd.f64(double %49, double %.019.lcssa, double %48)
  ...
  %64 = fsub double %63, 2.520000e+01
