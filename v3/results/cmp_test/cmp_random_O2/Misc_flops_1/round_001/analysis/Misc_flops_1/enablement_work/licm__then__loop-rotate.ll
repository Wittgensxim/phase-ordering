...
21:                                               ; preds = %0, %31
  %.03 = phi i32 [ 1, %0 ], [ %32, %31 ]
  %.0192 = phi double [ 0.000000e+00, %0 ], [ %30, %31 ]
  %.0201 = phi double [ 0.000000e+00, %0 ], [ %22, %31 ]
  %22 = fadd double %.0201, %13
  %23 = fmul double %22, %12
  %24 = call double @llvm.fmuladd.f64(double %23, double %17, double %16)
  %25 = call double @llvm.fmuladd.f64(double %23, double %24, double %15)
  %26 = call double @llvm.fmuladd.f64(double %23, double %20, double %19)
  %27 = call double @llvm.fmuladd.f64(double %23, double %26, double %18)
  %28 = call double @llvm.fmuladd.f64(double %23, double %27, double %13)
  %29 = fdiv double %25, %28
  %30 = fadd double %.0192, %29
  br label %31

31:                                               ; preds = %21
  %32 = add nsw i32 %.03, 1
  %33 = icmp sle i32 %32, %14
  br i1 %33, label %21, label %34, !llvm.loop !7

34:                                               ; preds = %31
  %.019.lcssa = phi double [ %30, %31 ]
  ...
  %53 = call double @llvm.fmuladd.f64(double %52, double %.019.lcssa, double %51)
