...
3:                                                ; preds = %0, %4
  %.05 = phi i32 [ 1, %0 ], [ %19, %4 ]
  %.0194 = phi double [ 0.000000e+00, %0 ], [ %18, %4 ]
  %.0203 = phi double [ 0.000000e+00, %0 ], [ %5, %4 ]
  br label %4

4:                                                ; preds = %3
  %5 = fadd double %.0203, %1
  %6 = fmul double %5, %2
