...
14:                                               ; preds = %0, %30
  %.03 = phi i32 [ 1, %0 ], [ %31, %30 ]
  %.0192 = phi double [ 0.000000e+00, %0 ], [ %29, %30 ]
  %.0201 = phi double [ 0.000000e+00, %0 ], [ %15, %30 ]
  %15 = fadd double %.0201, %13
  ...
  %27 = call double @llvm.fmuladd.f64(double %16, double %26, double %13)
  %28 = fdiv double %21, %27
  %29 = fadd double %.0192, %28
  br label %30

30:                                               ; preds = %14
  %31 = add nuw nsw i32 %.03, 1
  %exitcond = icmp ne i32 %31, 312500000
  br i1 %exitcond, label %14, label %32, !llvm.loop !7

32:                                               ; preds = %30
  %.019.lcssa = phi double [ %29, %30 ]
