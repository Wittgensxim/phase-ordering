...
7:                                                ; preds = %8, %0
  %.020 = phi double [ 0.000000e+00, %0 ], [ %9, %8 ]
  %.019 = phi double [ 0.000000e+00, %0 ], [ %22, %8 ]
  %.0 = phi i32 [ 1, %0 ], [ %23, %8 ]
  %exitcond = icmp ne i32 %.0, 312500000
  br i1 %exitcond, label %8, label %24
...
8:                                                ; preds = %7
  ...
  %20 = call double @llvm.fmuladd.f64(double %10, double %19, double %5)
  %21 = fdiv double %15, %20
  %22 = fadd double %.019, %21
  %23 = add nuw nsw i32 %.0, 1
  br label %7, !llvm.loop !7

24:                                               ; preds = %7
  %.019.lcssa = phi double [ %.019, %7 ]
