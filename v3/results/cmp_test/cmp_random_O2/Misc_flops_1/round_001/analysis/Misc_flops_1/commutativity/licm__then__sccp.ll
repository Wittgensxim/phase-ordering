...
15:                                               ; preds = %27, %0
  %.020 = phi double [ 0.000000e+00, %0 ], [ %18, %27 ]
  %.019 = phi double [ 0.000000e+00, %0 ], [ %26, %27 ]
  %.0 = phi i32 [ 1, %0 ], [ %28, %27 ]
  %16 = icmp sle i32 %.0, 312499999
  br i1 %16, label %17, label %29

17:                                               ; preds = %15
  %18 = fadd double %.020, %8
  %19 = fmul double %18, %7
  %20 = call double @llvm.fmuladd.f64(double %19, double %11, double %10)
  %21 = call double @llvm.fmuladd.f64(double %19, double %20, double %9)
  %22 = call double @llvm.fmuladd.f64(double %19, double %14, double %13)
  %23 = call double @llvm.fmuladd.f64(double %19, double %22, double %12)
  %24 = call double @llvm.fmuladd.f64(double %19, double %23, double %8)
  %25 = fdiv double %21, %24
  %26 = fadd double %.019, %25
  br label %27
...
29:                                               ; preds = %15
  %.019.lcssa = phi double [ %.019, %15 ]
  %30 = load double, ptr @D1, align 8
  %31 = load double, ptr @D2, align 8
  ...
  %48 = call double @llvm.fmuladd.f64(double %47, double %.019.lcssa, double %46)
  %49 = fmul double %7, %48
