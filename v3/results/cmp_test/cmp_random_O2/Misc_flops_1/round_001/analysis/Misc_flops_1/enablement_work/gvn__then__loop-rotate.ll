...
7:                                                ; preds = %0, %7
  %.03 = phi i32 [ 1, %0 ], [ %22, %7 ]
  %.0192 = phi double [ 0.000000e+00, %0 ], [ %21, %7 ]
  ...
  %17 = call double @llvm.fmuladd.f64(double %9, double %16, double %15)
  %18 = call double @llvm.fmuladd.f64(double %9, double %17, double %10)
  %19 = call double @llvm.fmuladd.f64(double %9, double %18, double %5)
  %20 = fdiv double %14, %19
  %21 = fadd double %.0192, %20
  %22 = add nsw i32 %.03, 1
  %23 = icmp sle i32 %22, 312499999
  br i1 %23, label %7, label %24, !llvm.loop !7

24:                                               ; preds = %7
  %.019.lcssa = phi double [ %21, %7 ]
  ...
  %43 = mul nsw i32 40000, %42
  %44 = sitofp i32 %43 to double
  %45 = load double, ptr @scale, align 8
  %46 = fdiv double %44, %45
  %47 = fptosi double %46 to i32
  %48 = fsub double %41, 2.520000e+01
