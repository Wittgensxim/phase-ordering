...
9:                                                ; preds = %11, %0
  ...
  %.019 = phi double [ 0.000000e+00, %0 ], [ %26, %11 ]
  %.0 = phi i32 [ 1, %0 ], [ %27, %11 ]
  %10 = icmp sle i32 %.0, 312499999
  br i1 %10, label %11, label %28

11:                                               ; preds = %9
  %12 = fadd double %.020, %8
  %13 = fmul double %12, %7
  %14 = load double, ptr @D1, align 8
  %15 = load double, ptr @D2, align 8
  %16 = load double, ptr @D3, align 8
  %17 = call double @llvm.fmuladd.f64(double %13, double %16, double %15)
  %18 = call double @llvm.fmuladd.f64(double %13, double %17, double %14)
  %19 = load double, ptr @D1, align 8
  %20 = load double, ptr @E2, align 8
  %21 = load double, ptr @E3, align 8
  %22 = call double @llvm.fmuladd.f64(double %13, double %21, double %20)
  %23 = call double @llvm.fmuladd.f64(double %13, double %22, double %19)
  %24 = call double @llvm.fmuladd.f64(double %13, double %23, double %8)
...
28:                                               ; preds = %9
  ...
  %47 = call double @llvm.fmuladd.f64(double %46, double %.019, double %45)
  %48 = fmul double %7, %47
