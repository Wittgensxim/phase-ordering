...
1:                                                ; preds = %22, %0
  %indvars.iv = phi i64 [ %indvars.iv.next, %22 ], [ 1, %0 ]
  %exitcond.not = icmp eq i64 %indvars.iv, 5001
  br i1 %exitcond.not, label %23, label %2
...
18:                                               ; preds = %22, %16
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %22 ], [ %17, %16 ]
  %19 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv3
...
23:                                               ; preds = %18
  %.138.lcssa.wide = phi i64 [ %indvars.iv3, %18 ]
