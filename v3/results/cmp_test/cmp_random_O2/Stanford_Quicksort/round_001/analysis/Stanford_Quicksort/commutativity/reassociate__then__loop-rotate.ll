...
1:                                                ; preds = %0, %24
  %indvars.iv1 = phi i64 [ 1, %0 ], [ %indvars.iv.next, %24 ]
  %2 = call i32 @Rand()
  %3 = sdiv i32 %2, 100000
  %.neg = mul i32 %3, -100000
  %4 = add i32 %2, -50000
  %5 = add i32 %4, %.neg
  %6 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
  store i32 %5, ptr %6, align 4
  %7 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
...
11:                                               ; preds = %1
  %12 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
  %13 = load i32, ptr %12, align 4
  store i32 %13, ptr @biggest, align 4
  br label %23

14:                                               ; preds = %1
  %15 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
...
19:                                               ; preds = %14
  %20 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
  %21 = load i32, ptr %20, align 4
  store i32 %21, ptr @littlest, align 4
  br label %22
...
24:                                               ; preds = %23
  ...
  br i1 %exitcond, label %1, label %25, !llvm.loop !7
...
15:                                               ; preds = %11
  %.1.lcssa.wide = phi i64 [ %indvars.iv, %11 ]
  br label %16
...
16:                                               ; preds = %16, %15
  ...
  %21 = sub nsw i32 %.138, 1
  br i1 %20, label %16, label %22, !llvm.loop !10

22:                                               ; preds = %16
  %.138.lcssa = phi i32 [ %.138, %16 ]
  %23 = trunc nsw i64 %.1.lcssa.wide to i32
  %24 = icmp sle i32 %23, %.138.lcssa
...
38:                                               ; preds = %25, %22
  %.239 = phi i32 [ %37, %25 ], [ %.138.lcssa, %22 ]
  %.2 = phi i32 [ %36, %25 ], [ %23, %22 ]
  br label %39
...
2:                                                ; preds = %1
  ...
  br i1 %exitcond, label %1, label %4, !llvm.loop !12
