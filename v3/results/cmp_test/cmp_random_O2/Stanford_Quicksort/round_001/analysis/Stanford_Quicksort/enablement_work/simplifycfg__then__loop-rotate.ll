...
1:                                                ; preds = %0, %23
  %indvars.iv1 = phi i64 [ 1, %0 ], [ %indvars.iv.next, %23 ]
  %2 = call i32 @Rand()
  %3 = sdiv i32 %2, 100000
  ...
  %8 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
...
12:                                               ; preds = %1
  %13 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
  %14 = load i32, ptr %13, align 4
  store i32 %14, ptr @biggest, align 4
  br label %23

15:                                               ; preds = %1
  %16 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
...
20:                                               ; preds = %15
  %21 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv1
