...
1:                                                ; preds = %0, %17
  %indvars.iv1 = phi i64 [ 1, %0 ], [ %indvars.iv.next, %17 ]
  %2 = call i32 @Rand()
  %3 = sdiv i32 %2, 100000
...
17:                                               ; preds = %16
  ...
  br i1 %exitcond, label %1, label %18, !llvm.loop !7
...
25:                                               ; preds = %22
  ...
  store i32 %28, ptr %.lcssa1, align 4
  %29 = add nsw i32 %23, 1
  %30 = sub nsw i32 %.138.lcssa, 1
  br label %31

31:                                               ; preds = %25, %22
  %.239 = phi i32 [ %30, %25 ], [ %.138.lcssa, %22 ]
  %.2 = phi i32 [ %29, %25 ], [ %23, %22 ]
  br label %32

32:                                               ; preds = %31
  %33 = icmp sle i32 %.2, %.239
  br i1 %33, label %9, label %34, !llvm.loop !11

34:                                               ; preds = %32
  %.239.lcssa = phi i32 [ %.239, %32 ]
  %.2.lcssa = phi i32 [ %.2, %32 ]
  %35 = icmp slt i32 %1, %.239.lcssa
