...
1:                                                ; preds = %24, %0
  %indvars.iv = phi i64 [ %indvars.iv.next, %24 ], [ 1, %0 ]
  %exitcond = icmp ne i64 %indvars.iv, 5001
  br i1 %exitcond, label %2, label %25
...
2:                                                ; preds = %1
  ...
  %9 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv
...
13:                                               ; preds = %2
  %14 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv
  %15 = load i32, ptr %14, align 4
  store i32 %15, ptr @biggest, align 4
  br label %24

16:                                               ; preds = %2
  %17 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv
...
21:                                               ; preds = %16
  %22 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv
  %23 = load i32, ptr %22, align 4
  store i32 %23, ptr @littlest, align 4
  br label %24
...
22:                                               ; preds = %17
  %23 = sub nsw i32 %.138, 1
  br label %17, !llvm.loop !10

24:                                               ; preds = %17
  %.138.lcssa = phi i32 [ %.138, %17 ]
  %25 = trunc nsw i64 %.1.lcssa.wide to i32
  %26 = icmp sle i32 %25, %.138.lcssa
...
27:                                               ; preds = %24
  ...
  %31 = sext i32 %.138.lcssa to i64
  %32 = getelementptr inbounds i32, ptr %0, i64 %31
  %33 = load i32, ptr %32, align 4
  %34 = sext i32 %25 to i64
  %35 = getelementptr inbounds i32, ptr %0, i64 %34
  store i32 %33, ptr %35, align 4
  %36 = sext i32 %.138.lcssa to i64
  %37 = getelementptr inbounds i32, ptr %0, i64 %36
  store i32 %30, ptr %37, align 4
  %38 = add nsw i32 %25, 1
  %39 = sub nsw i32 %.138.lcssa, 1
  br label %40

40:                                               ; preds = %24, %27
  %.239 = phi i32 [ %39, %27 ], [ %.138.lcssa, %24 ]
  %.2 = phi i32 [ %38, %27 ], [ %25, %24 ]
  %41 = icmp sle i32 %.2, %.239
  br i1 %41, label %9, label %42, !llvm.loop !11

42:                                               ; preds = %40
  %.239.lcssa = phi i32 [ %.239, %40 ]
  %.2.lcssa = phi i32 [ %.2, %40 ]
  %43 = icmp slt i32 %1, %.239.lcssa
