...
1:                                                ; preds = %23, %0
  %indvars.iv = phi i64 [ %indvars.iv.next, %23 ], [ 1, %0 ]
  %exitcond = icmp ne i64 %indvars.iv, 5001
  br i1 %exitcond, label %2, label %24

2:                                                ; preds = %1
  %3 = call i32 @Rand()
  %4 = sdiv i32 %3, 100000
  %.neg = mul i32 %4, -100000
  %5 = add i32 %3, -50000
  %6 = add i32 %5, %.neg
...
15:                                               ; preds = %2
  %16 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv
