...
1:                                                ; preds = %0, %21
  %indvars.iv1 = phi i64 [ 1, %0 ], [ %indvars.iv.next, %21 ]
  %2 = call i32 @Rand()
  %.fr = freeze i32 %2
...
20:                                               ; preds = %19, %8
  %indvars.iv2 = phi i64 [ %indvars.iv1, %19 ], [ %indvars.iv1, %8 ]
  br label %21

21:                                               ; preds = %20
  %indvars.iv.next = add nuw nsw i64 %indvars.iv2, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 5001
  br i1 %exitcond.not, label %22, label %1, !llvm.loop !7
...
38:                                               ; preds = %37
  ...
  br i1 %.not2, label %39, label %9, !llvm.loop !11

39:                                               ; preds = %38
  %.239.lcssa = phi i32 [ %.239, %38 ]
  %.2.lcssa = phi i32 [ %.2, %38 ]
  %40 = icmp slt i32 %1, %.239.lcssa
