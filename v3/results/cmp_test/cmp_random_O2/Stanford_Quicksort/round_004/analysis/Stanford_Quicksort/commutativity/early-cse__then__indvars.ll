; ModuleID = 'results\cmp_test\cmp_random_O2\Stanford_Quicksort\round_003\output.ll'
...
17:                                               ; preds = %17, %15
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %17 ], [ %16, %15 ]
  %18 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv3
...
21:                                               ; preds = %17
  %.138.lcssa.wide = phi i64 [ %indvars.iv3, %17 ]
  %.lcssa2 = phi ptr [ %18, %17 ]
  %.lcssa1 = phi i32 [ %19, %17 ]
  %.lcssa.wide = phi i64 [ %indvars.iv.next4, %17 ]
  %22 = trunc nsw i64 %.138.lcssa.wide to i32
  %23 = trunc nsw i64 %.lcssa.wide to i32
...
25:                                               ; preds = %21
  ...
  store i32 %.lcssa1, ptr %27, align 4
  store i32 %28, ptr %.lcssa2, align 4
  %29 = add nsw i32 %24, 1
  br label %30

30:                                               ; preds = %25, %21
  %.239 = phi i32 [ %23, %25 ], [ %22, %21 ]
  %.2 = phi i32 [ %29, %25 ], [ %24, %21 ]
  %.not2 = icmp sgt i32 %.2, %.239
  br i1 %.not2, label %31, label %9, !llvm.loop !11

31:                                               ; preds = %30
  %.239.lcssa = phi i32 [ %.239, %30 ]
  %.2.lcssa = phi i32 [ %.2, %30 ]
  %32 = icmp slt i32 %1, %.239.lcssa
