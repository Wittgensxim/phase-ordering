...
24:                                               ; preds = %22
  ...
  store i32 %.lcssa1, ptr %26, align 4
  store i32 %27, ptr %.lcssa2, align 4
  %28 = add nsw i32 %23, 1
  br label %29

29:                                               ; preds = %24, %22
  %.239 = phi i32 [ %.lcssa, %24 ], [ %.138.lcssa, %22 ]
  %.2 = phi i32 [ %28, %24 ], [ %23, %22 ]
  %.not2 = icmp sgt i32 %.2, %.239
  br i1 %.not2, label %30, label %9, !llvm.loop !11

30:                                               ; preds = %29
  %.239.lcssa = phi i32 [ %.239, %29 ]
  %.2.lcssa = phi i32 [ %.2, %29 ]
  %31 = icmp slt i32 %1, %.239.lcssa
