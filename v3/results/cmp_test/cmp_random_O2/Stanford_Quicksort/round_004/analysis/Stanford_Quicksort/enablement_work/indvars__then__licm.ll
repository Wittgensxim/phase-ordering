...
21:                                               ; preds = %17
  %indvars.iv1.lcssa = phi i64 [ %indvars.iv1, %17 ]
  %.138.lcssa.wide = phi i64 [ %indvars.iv1, %17 ]
  %.lcssa = phi i32 [ %19, %17 ]
  %22 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv1.lcssa
...
31:                                               ; preds = %25, %21
  %.239 = phi i32 [ %30, %25 ], [ %23, %21 ]
  %.2 = phi i32 [ %29, %25 ], [ %24, %21 ]
  %.not2 = icmp sgt i32 %.2, %.239
  br i1 %.not2, label %32, label %9, !llvm.loop !11

32:                                               ; preds = %31
  %.239.lcssa = phi i32 [ %.239, %31 ]
  %.2.lcssa = phi i32 [ %.2, %31 ]
  %33 = icmp slt i32 %1, %.239.lcssa
