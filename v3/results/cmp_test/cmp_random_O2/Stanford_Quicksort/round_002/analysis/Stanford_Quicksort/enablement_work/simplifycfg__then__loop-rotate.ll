; ModuleID = 'results\cmp_test\cmp_random_O2\Stanford_Quicksort\round_001\output.ll'
...
1:                                                ; preds = %0, %19
  %indvars.iv1 = phi i64 [ 1, %0 ], [ %indvars.iv.next, %19 ]
  %2 = call i32 @Rand()
  %.fr = freeze i32 %2
...
8:                                                ; preds = %1
  %9 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1
...
16:                                               ; preds = %11
  %17 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1
...
19:                                               ; preds = %16, %11, %8
  ...
  br i1 %exitcond.not, label %20, label %1, !llvm.loop !7
...
11:                                               ; preds = %11, %9
  ...
  br i1 %14, label %11, label %.preheader, !llvm.loop !9

.preheader:                                       ; preds = %11
  %indvars.iv.lcssa = phi i64 [ %indvars.iv, %11 ]
  br label %15

15:                                               ; preds = %15, %.preheader
  %.138 = phi i32 [ %20, %15 ], [ %.037, %.preheader ]
...
21:                                               ; preds = %15
  %.138.lcssa = phi i32 [ %.138, %15 ]
  %22 = trunc nsw i64 %indvars.iv.lcssa to i32
  %.not = icmp slt i32 %.138.lcssa, %22
...
23:                                               ; preds = %21
  ...
  %27 = sext i32 %.138.lcssa to i64
  %28 = getelementptr inbounds [4 x i8], ptr %0, i64 %27
  %29 = load i32, ptr %28, align 4
  %sext1 = shl i64 %indvars.iv.lcssa, 32
  %30 = ashr exact i64 %sext1, 30
  %31 = getelementptr inbounds i8, ptr %0, i64 %30
  store i32 %29, ptr %31, align 4
  %32 = sext i32 %.138.lcssa to i64
  %33 = getelementptr inbounds [4 x i8], ptr %0, i64 %32
  store i32 %26, ptr %33, align 4
  %34 = add nsw i32 %22, 1
  %35 = add nsw i32 %.138.lcssa, -1
  br label %36

36:                                               ; preds = %23, %21
  %.239 = phi i32 [ %35, %23 ], [ %.138.lcssa, %21 ]
  %.2 = phi i32 [ %34, %23 ], [ %22, %21 ]
  %.not2 = icmp sgt i32 %.2, %.239
  br i1 %.not2, label %37, label %9, !llvm.loop !11

37:                                               ; preds = %36
  %.239.lcssa = phi i32 [ %.239, %36 ]
  %.2.lcssa = phi i32 [ %.2, %36 ]
  %38 = icmp slt i32 %1, %.239.lcssa
...
1:                                                ; preds = %0, %1
  ...
  br i1 %exitcond.not, label %3, label %1, !llvm.loop !12
