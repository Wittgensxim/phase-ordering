...
18:                                               ; preds = %22, %16
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %22 ], [ %17, %16 ]
  %19 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv2
...
23:                                               ; preds = %18
  %.138.lcssa.wide = phi i64 [ %indvars.iv2, %18 ]
...
26:                                               ; preds = %23
  ...
  store i32 %29, ptr %.lcssa1, align 4
  %30 = add nsw i32 %25, 1
  %31 = add nsw i32 %24, -1
  br label %32

32:                                               ; preds = %26, %23
  %.239 = phi i32 [ %31, %26 ], [ %24, %23 ]
  %.2 = phi i32 [ %30, %26 ], [ %25, %23 ]
  %.not2 = icmp sgt i32 %.2, %.239
  br i1 %.not2, label %33, label %9, !llvm.loop !11

33:                                               ; preds = %32
  %.239.lcssa = phi i32 [ %.239, %32 ]
  %.2.lcssa = phi i32 [ %.2, %32 ]
  %34 = icmp slt i32 %1, %.239.lcssa
