...
17:                                               ; preds = %17, %15
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %17 ], [ %16, %15 ]
  %18 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv1
...
21:                                               ; preds = %17
  %.138.lcssa.wide = phi i64 [ %indvars.iv1, %17 ]
  %22 = trunc nsw i64 %.138.lcssa.wide to i32
...
37:                                               ; preds = %24, %21
  %.239 = phi i32 [ %36, %24 ], [ %22, %21 ]
  %.2 = phi i32 [ %35, %24 ], [ %23, %21 ]
