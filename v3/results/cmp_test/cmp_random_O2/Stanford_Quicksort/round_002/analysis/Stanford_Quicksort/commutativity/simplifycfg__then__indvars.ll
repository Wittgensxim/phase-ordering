...
1:                                                ; preds = %20, %0
  ...
  br i1 %exitcond.not, label %21, label %2
...
9:                                                ; preds = %2
  %10 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv
...
17:                                               ; preds = %12
  %18 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv
  %19 = load i32, ptr %18, align 4
  store i32 %19, ptr @littlest, align 4
  br label %20
...
17:                                               ; preds = %.preheader, %21
  %indvars.iv1 = phi i64 [ %15, %.preheader ], [ %indvars.iv.next2, %21 ]
...
22:                                               ; preds = %17
  ...
  %23 = trunc nsw i64 %.138.lcssa.wide to i32
  %24 = trunc nsw i64 %indvars.iv.lcssa to i32
...
38:                                               ; preds = %25, %22
  %.239 = phi i32 [ %37, %25 ], [ %23, %22 ]
  %.2 = phi i32 [ %36, %25 ], [ %24, %22 ]
