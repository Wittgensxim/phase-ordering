...
25:                                               ; preds = %.lr.ph2, %25
  %.147 = phi i32 [ %.046, %.lr.ph2 ], [ %26, %25 ]
  %26 = sub nsw i32 %.147, 1
...
31:                                               ; preds = %._crit_edge3, %20
  %.248 = phi i32 [ %26, %._crit_edge3 ], [ %.046, %20 ]
  %32 = icmp sle i32 %.2, %.248
...
33:                                               ; preds = %31
  ...
  %44 = add nsw i32 %.2, 1
  %45 = sub nsw i32 %.248, 1
  br label %46

46:                                               ; preds = %33, %31
  %.349 = phi i32 [ %45, %33 ], [ %.248, %31 ]
  %.3 = phi i32 [ %44, %33 ], [ %.2, %31 ]
  br label %47

47:                                               ; preds = %46
  %48 = icmp sle i32 %.3, %.349
  br i1 %48, label %9, label %49, !llvm.loop !11

49:                                               ; preds = %47
  %50 = icmp slt i32 %1, %.349
  br i1 %50, label %51, label %52

51:                                               ; preds = %49
  call void @Quicksort(ptr noundef %0, i32 noundef %1, i32 noundef %.349)
  br label %52
...
54:                                               ; preds = %52
  call void @Quicksort(ptr noundef %0, i32 noundef %.3, i32 noundef %2)
  br label %55
