...
0:                                                ; preds = %12, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %12 ], [ 1, %.lr.ph ]
  %1 = call i32 @Rand()
  %.fr = freeze i32 %1
  %2 = srem i32 %.fr, 100000
  %3 = add nsw i32 %2, -50000
  %4 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv
  store i32 %3, ptr %4, align 4
  %5 = load i32, ptr @biggest, align 4
  %6 = icmp sgt i32 %3, %5
...
12:                                               ; preds = %8, %11, %7
  ...
  br i1 %exitcond, label %0, label %._crit_edge, !llvm.loop !7
...
.lr.ph:                                           ; preds = %._crit_edge, %.lr.ph2
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %._crit_edge ], [ 500, %.lr.ph2 ]
  %.pre = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  br label %1

1:                                                ; preds = %8, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %8 ], [ 1, %.lr.ph ]
  %2 = phi i32 [ %9, %8 ], [ %.pre, %.lr.ph ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %3 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
...
8:                                                ; preds = %6, %1
  ...
  br i1 %exitcond, label %1, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %8
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, -1
  %10 = trunc nuw nsw i64 %indvars.iv.next3 to i32
  store i32 %10, ptr @top, align 4
  %11 = icmp samesign ugt i64 %indvars.iv2, 2
  br i1 %11, label %.lr.ph, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %._crit_edge
  %12 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %13 = load i32, ptr @littlest, align 4
  %.not = icmp eq i32 %12, %13
  br i1 %.not, label %14, label %17

14:                                               ; preds = %._crit_edge3
  %15 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
  %16 = load i32, ptr @biggest, align 4
  %.not2 = icmp eq i32 %15, %16
  br i1 %.not2, label %18, label %17

17:                                               ; preds = %14, %._crit_edge3
...
18:                                               ; preds = %17, %14
  ...
  %23 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %22) #3
  ret void
}
...
0:                                                ; preds = %0, %.lr.ph
  ...
  br i1 %exitcond, label %0, label %._crit_edge, !llvm.loop !11
