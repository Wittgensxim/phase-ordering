...
2:                                                ; preds = %9, %.lr.ph
  ...
  %3 = phi i32 [ %10, %9 ], [ %.pre, %.lr.ph ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %4 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
...
9:                                                ; preds = %7, %2
  ...
  br i1 %exitcond, label %2, label %._crit_edge.loopexit, !llvm.loop !9
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %1
  ...
  %11 = trunc nuw nsw i64 %indvars.iv.next3 to i32
  store i32 %11, ptr @top, align 4
  %12 = icmp samesign ugt i64 %indvars.iv2, 2
  br i1 %12, label %1, label %._crit_edge3, !llvm.loop !10
