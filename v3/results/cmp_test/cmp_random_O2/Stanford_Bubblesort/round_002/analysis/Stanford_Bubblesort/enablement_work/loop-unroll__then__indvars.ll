...
2:                                                ; preds = %35, %.lr.ph2
  %indvar = phi i32 [ %indvar.next, %35 ], [ 0, %.lr.ph2 ]
  %3 = phi i32 [ %36, %35 ], [ 500, %.lr.ph2 ]
...
8:                                                ; preds = %23, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next, %23 ], [ 1, %.lr.ph.new ]
  %9 = phi i32 [ %.pre, %.lr.ph.new ], [ %24, %23 ]
...
14:                                               ; preds = %8
  %15 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv
  store i32 %12, ptr %15, align 4
  store i32 %9, ptr %11, align 4
  br label %16

16:                                               ; preds = %14, %8
  %17 = phi i32 [ %9, %14 ], [ %12, %8 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 2
  %18 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
  %19 = load i32, ptr %18, align 4
  %20 = icmp sgt i32 %17, %19
  br i1 %20, label %21, label %23

21:                                               ; preds = %16
  %22 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %10
  store i32 %19, ptr %22, align 4
  store i32 %17, ptr %18, align 4
  br label %23

23:                                               ; preds = %21, %16
  %24 = phi i32 [ %17, %21 ], [ %19, %16 ]
  %niter.next.1 = add i32 %niter, 2
  %niter.ncmp.1 = icmp ne i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %8, label %._crit_edge.unr-lcssa, !llvm.loop !9

._crit_edge.unr-lcssa:                            ; preds = %23
  %.unr = phi i32 [ %24, %23 ]
  %.unr1.wide = phi i64 [ %indvars.iv.next, %23 ]
  %25 = trunc nuw i64 %.unr1.wide to i32
  %lcmp.mod = icmp ne i32 %xtraiter, 0
  br i1 %lcmp.mod, label %.epil.preheader, label %._crit_edge

.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  %.epil.init = phi i32 [ %.pre, %.lr.ph ], [ %.unr, %._crit_edge.unr-lcssa ]
  %.epil.init2 = phi i32 [ 1, %.lr.ph ], [ %25, %._crit_edge.unr-lcssa ]
  %lcmp.mod3 = icmp ne i32 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod3)
  br label %26

26:                                               ; preds = %.epil.preheader
  %27 = add nuw nsw i32 %.epil.init2, 1
  %28 = zext nneg i32 %27 to i64
  %29 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %28
  %30 = load i32, ptr %29, align 4
  %31 = icmp sgt i32 %.epil.init, %30
  br i1 %31, label %32, label %._crit_edge.epilog-lcssa

32:                                               ; preds = %26
  %33 = zext nneg i32 %.epil.init2 to i64
  %34 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %33
  store i32 %30, ptr %34, align 4
  store i32 %.epil.init, ptr %29, align 4
  br label %._crit_edge.epilog-lcssa

._crit_edge.epilog-lcssa:                         ; preds = %32, %26
  br label %._crit_edge
...
37:                                               ; preds = %._crit_edge3, %._crit_edge1
  %38 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %39 = load i32, ptr @littlest, align 4
...
44:                                               ; preds = %43, %40
  ...
  %49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %48) #4
  ret void
}
