...
19:                                               ; preds = %._crit_edge, %._crit_edge1
  ret void
}
...
2:                                                ; preds = %39, %.lr.ph2
  %indvar = phi i32 [ %indvar.next, %39 ], [ 0, %.lr.ph2 ]
  %3 = phi i32 [ %40, %39 ], [ 500, %.lr.ph2 ]
  %4 = sub i32 499, %indvar
...
7:                                                ; preds = %28, %.lr.ph.new
  %8 = phi i32 [ %.pre, %.lr.ph.new ], [ %29, %28 ]
  %9 = phi i32 [ 1, %.lr.ph.new ], [ %20, %28 ]
  %niter = phi i32 [ 0, %.lr.ph.new ], [ %niter.next.1, %28 ]
...
28:                                               ; preds = %25, %18
  %29 = phi i32 [ %19, %25 ], [ %23, %18 ]
  %niter.next.1 = add i32 %niter, 2
  %niter.ncmp.1.not = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1.not, label %._crit_edge.unr-lcssa, label %7, !llvm.loop !9
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  %.epil.init = phi i32 [ %.pre, %.lr.ph ], [ %29, %._crit_edge.unr-lcssa ]
  %.epil.init2 = phi i32 [ 1, %.lr.ph ], [ %20, %._crit_edge.unr-lcssa ]
  %lcmp.mod3 = trunc i32 %4 to i1
  call void @llvm.assume(i1 %lcmp.mod3)
  br label %30

30:                                               ; preds = %.epil.preheader
  %31 = sext i32 %.epil.init2 to i64
  %32 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %31
  %33 = getelementptr inbounds nuw i8, ptr %32, i64 4
  %34 = load i32, ptr %33, align 4
  %35 = icmp sgt i32 %.epil.init, %34
  br i1 %35, label %36, label %._crit_edge.epilog-lcssa

36:                                               ; preds = %30
  %37 = zext nneg i32 %.epil.init2 to i64
  %38 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %37
  store i32 %34, ptr %38, align 4
  store i32 %.epil.init, ptr %33, align 4
  br label %._crit_edge.epilog-lcssa

._crit_edge.epilog-lcssa:                         ; preds = %36, %30
  br label %._crit_edge
...
39:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %41, label %2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %39
  br label %42

42:                                               ; preds = %._crit_edge3, %._crit_edge1
...
5:                                                ; preds = %._crit_edge, %._crit_edge1
  ret i32 0
}
