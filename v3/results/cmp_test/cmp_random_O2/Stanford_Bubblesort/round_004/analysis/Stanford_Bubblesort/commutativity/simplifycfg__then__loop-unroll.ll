...
1:                                                ; preds = %._crit_edge, %.lr.ph2
  %indvar = phi i32 [ %indvar.next, %._crit_edge ], [ 0, %.lr.ph2 ]
  %2 = phi i32 [ %40, %._crit_edge ], [ 500, %.lr.ph2 ]
...
8:                                                ; preds = %29, %.lr.ph.new
  %9 = phi i32 [ %.pre, %.lr.ph.new ], [ %30, %29 ]
  %10 = phi i32 [ 1, %.lr.ph.new ], [ %21, %29 ]
  %niter = phi i32 [ 0, %.lr.ph.new ], [ %niter.next.1, %29 ]
...
19:                                               ; preds = %16, %8
  %20 = phi i32 [ %9, %16 ], [ %14, %8 ]
  %21 = add nuw nsw i32 %10, 2
  %22 = zext nneg i32 %21 to i64
  %23 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %22
...
29:                                               ; preds = %26, %19
  %30 = phi i32 [ %20, %26 ], [ %24, %19 ]
  %niter.next.1 = add i32 %niter, 2
  %niter.ncmp.1 = icmp ne i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %8, label %._crit_edge.loopexit.unr-lcssa, !llvm.loop !9
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  %.epil.init = phi i32 [ %.pre, %.lr.ph ], [ %.unr, %._crit_edge.loopexit.unr-lcssa ]
  %.epil.init2 = phi i32 [ 1, %.lr.ph ], [ %.unr1, %._crit_edge.loopexit.unr-lcssa ]
  %lcmp.mod3 = icmp ne i32 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod3)
  br label %31

31:                                               ; preds = %.epil.preheader
  %32 = add nuw nsw i32 %.epil.init2, 1
  %33 = zext nneg i32 %32 to i64
  %34 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %33
  %35 = load i32, ptr %34, align 4
  %36 = icmp sgt i32 %.epil.init, %35
  br i1 %36, label %37, label %._crit_edge.loopexit.epilog-lcssa

37:                                               ; preds = %31
  %38 = zext nneg i32 %.epil.init2 to i64
  %39 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %38
  store i32 %35, ptr %39, align 4
  store i32 %.epil.init, ptr %34, align 4
  br label %._crit_edge.loopexit.epilog-lcssa

._crit_edge.loopexit.epilog-lcssa:                ; preds = %37, %31
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %1
  ...
  br i1 %41, label %1, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %._crit_edge
  %.lcssa = phi i32 [ %40, %._crit_edge ]
...
44:                                               ; preds = %._crit_edge3
  ...
  %.not2 = icmp eq i32 %45, %46
  br i1 %.not2, label %48, label %47

47:                                               ; preds = %44, %._crit_edge3
  %puts = call i32 @puts(ptr nonnull dereferenceable(1) @str)
  br label %48

48:                                               ; preds = %47, %44
  %49 = sext i32 %0 to i64
  %50 = getelementptr [4 x i8], ptr @sortlist, i64 %49
  %51 = getelementptr i8, ptr %50, i64 4
  %52 = load i32, ptr %51, align 4
  %53 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %52) #4
  ret void
}
