...
2:                                                ; preds = %38, %.lr.ph2
  %indvar = phi i32 [ %indvar.next, %38 ], [ 0, %.lr.ph2 ]
  %3 = phi i32 [ %39, %38 ], [ 500, %.lr.ph2 ]
...
9:                                                ; preds = %28, %.lr.ph.new
  %10 = phi i32 [ %.pre, %.lr.ph.new ], [ %29, %28 ]
  %11 = phi i32 [ 1, %.lr.ph.new ], [ %22, %28 ]
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  ...
  %.epil.init2 = phi i32 [ 1, %.lr.ph ], [ %22, %._crit_edge.unr-lcssa ]
  %lcmp.mod3 = icmp ne i32 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod3)
  %30 = add nuw nsw i32 %.epil.init2, 1
  %31 = zext nneg i32 %30 to i64
  %32 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %31
  %33 = load i32, ptr %32, align 4
  %34 = icmp sgt i32 %.epil.init, %33
  br i1 %34, label %35, label %._crit_edge.epilog-lcssa

35:                                               ; preds = %.epil.preheader
  %36 = zext nneg i32 %.epil.init2 to i64
  %37 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %36
  store i32 %33, ptr %37, align 4
  store i32 %.epil.init, ptr %32, align 4
  br label %._crit_edge.epilog-lcssa

._crit_edge.epilog-lcssa:                         ; preds = %35, %.epil.preheader
  br label %._crit_edge
...
38:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %40, label %2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %38
  store i32 %39, ptr @top, align 4
  br label %41

41:                                               ; preds = %._crit_edge3, %._crit_edge1
