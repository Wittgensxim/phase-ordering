...
1:                                                ; preds = %._crit_edge, %.lr.ph2
  ...
  %2 = phi i32 [ %39, %._crit_edge ], [ 500, %.lr.ph2 ]
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  ...
  %31 = add nuw nsw i32 %.epil.init2, 1
...
._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %36, %.epil.preheader, %1
  %39 = add nsw i32 %2, -1
  %40 = icmp sgt i32 %2, 2
  %indvar.next = add i32 %indvar, 1
  br i1 %40, label %1, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %._crit_edge
  %.lcssa = phi i32 [ %39, %._crit_edge ]
...
43:                                               ; preds = %._crit_edge3
  ...
  %.not2 = icmp eq i32 %44, %45
  br i1 %.not2, label %47, label %46

46:                                               ; preds = %43, %._crit_edge3
