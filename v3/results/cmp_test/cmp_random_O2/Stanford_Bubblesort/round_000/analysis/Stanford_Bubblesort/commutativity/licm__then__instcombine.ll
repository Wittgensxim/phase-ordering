...
5:                                                ; preds = %38, %1
  %.lcssa25 = phi i32 [ %10, %38 ], [ %.promoted, %1 ]
  %.lcssa4 = phi i32 [ %11, %38 ], [ %.promoted3, %1 ]
  %6 = phi i32 [ %39, %38 ], [ 500, %1 ]
  %7 = icmp sgt i32 %6, 1
...
9:                                                ; preds = %35, %8
  %10 = phi i32 [ %36, %35 ], [ %.lcssa25, %8 ]
  %11 = phi i32 [ %37, %35 ], [ 1, %8 ]
...
47:                                               ; preds = %46, %43
  ...
  %53 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %52) #3
  ret void
}
