...
5:                                                ; preds = %16, %.lr.ph
  %6 = phi i32 [ %17, %16 ], [ %.pre, %.lr.ph ]
  %7 = phi i32 [ %8, %16 ], [ 1, %.lr.ph ]
...
19:                                               ; preds = %._crit_edge, %2
  ...
  %21 = icmp sgt i32 %3, 2
  br i1 %21, label %2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %19
  br label %22

22:                                               ; preds = %._crit_edge3, %._crit_edge1
...
25:                                               ; preds = %22
  %26 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
  %27 = load i32, ptr @biggest, align 4
  %.not2 = icmp eq i32 %26, %27
...
29:                                               ; preds = %28, %25
  ...
  %34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %33) #3
  ret void
}
