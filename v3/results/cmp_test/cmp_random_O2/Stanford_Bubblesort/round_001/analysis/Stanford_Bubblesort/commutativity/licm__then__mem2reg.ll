...
22:                                               ; preds = %21
  ...
  br i1 %24, label %1, label %._crit_edge, !llvm.loop !7
...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %33
...
2:                                                ; preds = %30, %.lr.ph2
  %.lcssa27 = phi i32 [ %.lcssa26, %30 ], [ undef, %.lr.ph2 ]
  %3 = phi i32 [ %31, %30 ], [ %top.promoted, %.lr.ph2 ]
  %4 = icmp slt i32 1, %3
...
5:                                                ; preds = %26, %.lr.ph
  %6 = phi i32 [ %27, %26 ], [ %.lcssa27, %.lr.ph ]
  %7 = phi i32 [ %28, %26 ], [ 1, %.lr.ph ]
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %8
...
26:                                               ; preds = %16, %5
  %27 = phi i32 [ %10, %16 ], [ %6, %5 ]
  %28 = add nsw i32 %7, 1
  %29 = icmp slt i32 %28, %3
  br i1 %29, label %5, label %._crit_edge, !llvm.loop !9
...
30:                                               ; preds = %._crit_edge, %2
  %.lcssa26 = phi i32 [ %.lcssa2, %._crit_edge ], [ %.lcssa27, %2 ]
  %.lcssa4 = phi i32 [ %.lcssa, %._crit_edge ], [ 1, %2 ]
  %31 = sub nsw i32 %3, 1
  %32 = icmp sgt i32 %31, 1
  br i1 %32, label %2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %30
  %.lcssa26.lcssa = phi i32 [ %.lcssa26, %30 ]
  %.lcssa5 = phi i32 [ %31, %30 ]
  %.lcssa4.lcssa = phi i32 [ %.lcssa4, %30 ]
...
define dso_local i32 @main() #0 {
  br i1 true, label %.lr.ph, label %6

.lr.ph:                                           ; preds = %0
  br label %1

1:                                                ; preds = %3, %.lr.ph
  %2 = phi i32 [ %4, %3 ], [ 0, %.lr.ph ]
...
3:                                                ; preds = %1
  ...
  br i1 %5, label %1, label %._crit_edge, !llvm.loop !11
