...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %26
...
5:                                                ; preds = %23, %.lr.ph2
  %.lcssa27 = phi i32 [ %.lcssa26, %23 ], [ %.promoted, %.lr.ph2 ]
  %6 = phi i32 [ %24, %23 ], [ 500, %.lr.ph2 ]
  %7 = icmp slt i32 1, %6
...
8:                                                ; preds = %20, %.lr.ph
  %9 = phi i32 [ %21, %20 ], [ %.lcssa27, %.lr.ph ]
  %10 = phi i32 [ %14, %20 ], [ 1, %.lr.ph ]
...
20:                                               ; preds = %19, %8
  %21 = phi i32 [ %13, %19 ], [ %9, %8 ]
  %22 = icmp slt i32 %14, %6
  br i1 %22, label %8, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %20
  br label %23

23:                                               ; preds = %._crit_edge, %5
  %.lcssa26 = phi i32 [ %21, %._crit_edge ], [ %.lcssa27, %5 ]
  %.lcssa4 = phi i32 [ %14, %._crit_edge ], [ 1, %5 ]
  %24 = sub nsw i32 %6, 1
  %25 = icmp sgt i32 %24, 1
  br i1 %25, label %5, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %23
  store i32 %.lcssa4, ptr %3, align 4
  store i32 %24, ptr @top, align 4
  store i32 %.lcssa26, ptr %4, align 4
  br label %26
