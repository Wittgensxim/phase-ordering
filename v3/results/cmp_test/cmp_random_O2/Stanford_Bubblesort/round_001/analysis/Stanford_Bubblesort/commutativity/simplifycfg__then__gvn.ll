...
18:                                               ; preds = %13, %17, %14
  ...
  br i1 %20, label %2, label %._crit_edge, !llvm.loop !7
...
4:                                                ; preds = %._crit_edge, %.lr.ph2
  %5 = phi i32 [ %20, %._crit_edge ], [ 500, %.lr.ph2 ]
  store i32 1, ptr %2, align 4
  %6 = icmp slt i32 1, %5
  br i1 %6, label %..lr.ph_crit_edge, label %._crit_edge

..lr.ph_crit_edge:                                ; preds = %4
  %.pre = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  br label %.lr.ph

.lr.ph:                                           ; preds = %..lr.ph_crit_edge, %17
  %7 = phi i32 [ %.pre, %..lr.ph_crit_edge ], [ %18, %17 ]
  %8 = phi i32 [ 1, %..lr.ph_crit_edge ], [ %11, %17 ]
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %9
  %11 = add nsw i32 %8, 1
...
17:                                               ; preds = %16, %.lr.ph
  %18 = phi i32 [ %7, %16 ], [ %14, %.lr.ph ]
  store i32 %11, ptr %2, align 4
  %19 = icmp slt i32 %11, %5
...
._crit_edge:                                      ; preds = %17, %4
  ...
  br i1 %21, label %4, label %._crit_edge3, !llvm.loop !10
