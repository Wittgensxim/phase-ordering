...
17:                                               ; preds = %16, %11
  ...
  %19 = icmp slt i32 %3, 500
  br i1 %19, label %2, label %._crit_edge, !llvm.loop !7
...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %._crit_edge2
...
17:                                               ; preds = %16, %8
  ...
  br i1 %19, label %8, label %._crit_edge, !llvm.loop !9
...
20:                                               ; preds = %._crit_edge, %5
  ...
  %22 = icmp sgt i32 %6, 2
  br i1 %22, label %5, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %20
  br label %23

23:                                               ; preds = %._crit_edge2, %._crit_edge3
...
30:                                               ; preds = %29, %26
  ...
  %32 = getelementptr [4 x i8], ptr @sortlist, i64 %31
  %33 = getelementptr i8, ptr %32, i64 4
  %34 = load i32, ptr %33, align 4
  %35 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %34) #3
  ret void
}
