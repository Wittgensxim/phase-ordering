...
3:                                                ; preds = %18, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %18 ], [ 1, %.lr.ph ]
  %4 = call i32 @Rand()
...
20:                                               ; preds = %._crit_edge1, %._crit_edge
  ret void
}
...
5:                                                ; preds = %16, %.lr.ph2
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %16 ], [ 500, %.lr.ph2 ]
  store i32 1, ptr %3, align 4
  br i1 true, label %.lr.ph, label %16
...
6:                                                ; preds = %13, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %13 ], [ 1, %.lr.ph ]
  %7 = phi i32 [ %14, %13 ], [ %.pre, %.lr.ph ]
...
13:                                               ; preds = %12, %6
  ...
  %exitcond = icmp ne i64 %indvars.iv.next, %indvars.iv3
  br i1 %exitcond, label %6, label %._crit_edge, !llvm.loop !9
...
16:                                               ; preds = %._crit_edge, %5
  ...
  %18 = icmp samesign ugt i64 %indvars.iv.next4, 1
  br i1 %18, label %5, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %16
  br label %19

19:                                               ; preds = %._crit_edge1, %._crit_edge3
...
23:                                               ; preds = %19
  %24 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
