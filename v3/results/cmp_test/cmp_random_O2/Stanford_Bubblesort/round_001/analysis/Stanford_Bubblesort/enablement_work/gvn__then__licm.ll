...
5:                                                ; preds = %24, %.lr.ph2
  %.lcssa6 = phi i32 [ %.lcssa5, %24 ], [ %.promoted4, %.lr.ph2 ]
  %6 = phi i32 [ %25, %24 ], [ 500, %.lr.ph2 ]
  %7 = icmp slt i32 1, %6
...
8:                                                ; preds = %20, %.lr.ph
  %9 = phi i32 [ %21, %20 ], [ %.lcssa6, %.lr.ph ]
  %10 = phi i32 [ %22, %20 ], [ %.pre, %.lr.ph ]
  %11 = phi i32 [ %14, %20 ], [ 1, %.lr.ph ]
...
20:                                               ; preds = %19, %8
  %21 = phi i32 [ %10, %19 ], [ %9, %8 ]
  %22 = phi i32 [ %10, %19 ], [ %17, %8 ]
  %23 = icmp slt i32 %14, %6
  br i1 %23, label %8, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %20
  %.lcssa2 = phi i32 [ %14, %20 ]
  %.lcssa = phi i32 [ %21, %20 ]
  br label %24

24:                                               ; preds = %._crit_edge, %5
  %.lcssa5 = phi i32 [ %.lcssa, %._crit_edge ], [ %.lcssa6, %5 ]
  %.lcssa23 = phi i32 [ %.lcssa2, %._crit_edge ], [ 1, %5 ]
  %25 = sub nsw i32 %6, 1
  %26 = icmp sgt i32 %25, 1
  br i1 %26, label %5, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %24
  %.lcssa7 = phi i32 [ %25, %24 ]
  %.lcssa5.lcssa = phi i32 [ %.lcssa5, %24 ]
  %.lcssa23.lcssa = phi i32 [ %.lcssa23, %24 ]
  store i32 %.lcssa23.lcssa, ptr %3, align 4
  store i32 %.lcssa5.lcssa, ptr %4, align 1
  store i32 %.lcssa7, ptr @top, align 4
  br label %27

27:                                               ; preds = %._crit_edge1, %._crit_edge3
