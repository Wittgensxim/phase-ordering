...
17:                                               ; preds = %16, %11
  ...
  br i1 %19, label %1, label %._crit_edge, !llvm.loop !7
...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %._crit_edge6
...
15:                                               ; preds = %14, %5
  ...
  %17 = icmp slt i32 %9, %3
  br i1 %17, label %5, label %._crit_edge, !llvm.loop !9
...
18:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %20, label %2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %18
  br label %21

21:                                               ; preds = %._crit_edge6, %._crit_edge3
...
1:                                                ; preds = %1, %.lr.ph
  %.0 = phi i32 [ 0, %.lr.ph ], [ %2, %1 ]
  call void @Bubble(i32 noundef %.0)
  %2 = add nsw i32 %.0, 1
  %3 = icmp slt i32 %2, 100
  br i1 %3, label %1, label %._crit_edge, !llvm.loop !11

._crit_edge:                                      ; preds = %1
  br label %4

4:                                                ; preds = %._crit_edge2, %._crit_edge
  ret i32 0
}
