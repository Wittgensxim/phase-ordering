...
3:                                                ; preds = %19, %.lr.ph
  %4 = phi i32 [ %20, %19 ], [ 1, %.lr.ph ]
  %5 = call i32 @Rand()
  store i32 %5, ptr %2, align 4
  %6 = sdiv i32 %5, 100000
  %.neg = mul i32 %6, -100000
  %7 = add i32 %5, -50000
  %8 = add i32 %7, %.neg
  %9 = sext i32 %4 to i64
...
19:                                               ; preds = %18, %13
  ...
  br i1 %21, label %3, label %._crit_edge, !llvm.loop !7
...
8:                                                ; preds = %19, %.lr.ph
  %9 = phi i32 [ %20, %19 ], [ %.pre, %.lr.ph ]
  %10 = phi i32 [ %13, %19 ], [ 1, %.lr.ph ]
...
25:                                               ; preds = %._crit_edge1, %._crit_edge3
