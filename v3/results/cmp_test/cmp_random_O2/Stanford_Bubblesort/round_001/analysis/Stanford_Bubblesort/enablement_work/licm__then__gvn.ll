...
23:                                               ; preds = %._crit_edge2, %._crit_edge
  ret void
}
...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %._crit_edge8
...
5:                                                ; preds = %24, %.lr.ph2
  %.lcssa27 = phi i32 [ %.lcssa26, %24 ], [ undef, %.lr.ph2 ]
...
8:                                                ; preds = %20, %.lr.ph
  %9 = phi i32 [ %21, %20 ], [ %.pre, %.lr.ph ]
  %10 = phi i32 [ %22, %20 ], [ %.lcssa27, %.lr.ph ]
...
20:                                               ; preds = %19, %8
  %21 = phi i32 [ %9, %19 ], [ %17, %8 ]
  %22 = phi i32 [ %9, %19 ], [ %10, %8 ]
...
24:                                               ; preds = %._crit_edge, %5
  %.lcssa26 = phi i32 [ %22, %._crit_edge ], [ %.lcssa27, %5 ]
...
27:                                               ; preds = %._crit_edge8, %._crit_edge3
