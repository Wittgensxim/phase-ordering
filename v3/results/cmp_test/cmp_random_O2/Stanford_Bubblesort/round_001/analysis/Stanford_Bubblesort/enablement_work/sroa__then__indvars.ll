...
define dso_local void @bInitarr() #0 {
  ...
  br i1 true, label %.lr.ph, label %20

.lr.ph:                                           ; preds = %0
  br label %1

1:                                                ; preds = %19, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %19 ], [ 1, %.lr.ph ]
  %2 = call i32 @Rand()
  %3 = sdiv i32 %2, 100000
...
define dso_local void @Bubble(i32 noundef %0) #0 {
  ...
  br i1 true, label %.lr.ph2, label %24
...
5:                                                ; preds = %16, %.lr.ph
  ...
  %6 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv
...
11:                                               ; preds = %5
  %12 = getelementptr inbounds [5001 x i32], ptr @sortlist, i64 0, i64 %indvars.iv.next
...
16:                                               ; preds = %11, %5
  ...
  br i1 %19, label %5, label %._crit_edge, !llvm.loop !9
...
20:                                               ; preds = %._crit_edge, %2
  ...
  %22 = sub nsw i32 %21, 1
  store i32 %22, ptr @top, align 4
  %23 = icmp sgt i32 %22, 1
  br i1 %23, label %2, label %._crit_edge3, !llvm.loop !10
...
define dso_local i32 @main() #0 {
  br i1 true, label %.lr.ph, label %4

.lr.ph:                                           ; preds = %0
  br label %1

1:                                                ; preds = %2, %.lr.ph
  %.0 = phi i32 [ 0, %.lr.ph ], [ %3, %2 ]
