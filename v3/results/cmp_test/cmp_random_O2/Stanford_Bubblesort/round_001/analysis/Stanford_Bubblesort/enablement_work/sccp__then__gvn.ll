...
2:                                                ; preds = %16, %.lr.ph
  %3 = phi i32 [ %17, %16 ], [ 1, %.lr.ph ]
  %4 = call i32 @Rand()
  store i32 %4, ptr %1, align 4
  %5 = sub nsw i32 %4, 50000
  %6 = sext i32 %3 to i64
...
16:                                               ; preds = %15, %10
  ...
  br i1 %18, label %2, label %._crit_edge, !llvm.loop !7
...
7:                                                ; preds = %18, %.lr.ph
  %8 = phi i32 [ %19, %18 ], [ %.pre, %.lr.ph ]
  %9 = phi i32 [ %12, %18 ], [ 1, %.lr.ph ]
...
21:                                               ; preds = %._crit_edge, %4
  ...
  br i1 %23, label %4, label %._crit_edge3, !llvm.loop !10
