...
21:                                               ; preds = %20
  ...
  br i1 %23, label %1, label %._crit_edge, !llvm.loop !7
...
2:                                                ; preds = %27, %.lr.ph2
  %3 = phi i32 [ %28, %27 ], [ %top.promoted, %.lr.ph2 ]
  %4 = icmp slt i32 1, %3
...
24:                                               ; preds = %14, %5
  ...
  br i1 %26, label %5, label %._crit_edge, !llvm.loop !9
...
27:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %29, label %2, label %._crit_edge3, !llvm.loop !10
