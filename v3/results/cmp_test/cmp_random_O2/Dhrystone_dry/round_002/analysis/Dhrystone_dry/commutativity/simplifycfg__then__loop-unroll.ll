...
42:                                               ; preds = %._crit_edge3, %28
  %43 = phi i32 [ 0, %28 ], [ %85, %._crit_edge3 ]
  %44 = call i32 @Proc5()
  %45 = call i32 @Proc4()
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %52 = phi i32 [ %57, %.lr.ph ], [ %.pre, %.lr.ph.preheader ]
  %53 = mul nsw i32 5, %52
  %54 = sub nsw i32 %53, 3
  ...
  br i1 %58, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !9

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %.lcssa1 = phi i32 [ %57, %.lr.ph ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %42
  %.lcssa = phi i32 [ %.pre, %42 ], [ %.lcssa1, %._crit_edge.loopexit ]
  ...
  br i1 %65, label %.lr.ph2.preheader, label %._crit_edge3

.lr.ph2.preheader:                                ; preds = %._crit_edge
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %73
  %66 = phi i32 [ %75, %73 ], [ 65, %.lr.ph2.preheader ]
  %67 = phi i8 [ %74, %73 ], [ 65, %.lr.ph2.preheader ]
...
73:                                               ; preds = %71, %.lr.ph2
  ...
  br i1 %78, label %.lr.ph2, label %._crit_edge3.loopexit, !llvm.loop !10

._crit_edge3.loopexit:                            ; preds = %73
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit, %._crit_edge
  ...
  %84 = call i32 @Proc2(ptr noundef %2)
  %85 = add i32 %43, 1
  store i32 %85, ptr %10, align 4
  %86 = icmp ult i32 %85, 100000000
  br i1 %86, label %42, label %87, !llvm.loop !11
