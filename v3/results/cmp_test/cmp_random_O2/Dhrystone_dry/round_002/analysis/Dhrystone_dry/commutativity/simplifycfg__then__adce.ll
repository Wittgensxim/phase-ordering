...
30:                                               ; preds = %._crit_edge3, %16
  %31 = phi i32 [ 0, %16 ], [ %73, %._crit_edge3 ]
  %32 = call i32 @Proc5()
  %33 = call i32 @Proc4()
...
._crit_edge:                                      ; preds = %.lr.ph, %30
  ...
  br i1 %53, label %.lr.ph2, label %._crit_edge3

.lr.ph2:                                          ; preds = %._crit_edge, %61
  %54 = phi i32 [ %63, %61 ], [ 65, %._crit_edge ]
  %55 = phi i8 [ %62, %61 ], [ 65, %._crit_edge ]
  %56 = load i32, ptr %5, align 4
  %57 = call i32 @Func1(i32 noundef %54, i32 noundef 67)
  %58 = icmp eq i32 %56, %57
  br i1 %58, label %59, label %61

59:                                               ; preds = %.lr.ph2
  %60 = call i32 @Proc6(i32 noundef 0, ptr noundef %5)
  br label %61
...
61:                                               ; preds = %59, %.lr.ph2
  ...
  br i1 %66, label %.lr.ph2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %61, %._crit_edge
  ...
  br i1 %74, label %30, label %75, !llvm.loop !11

75:                                               ; preds = %._crit_edge3
  ret i32 undef
}
...
27:                                               ; preds = %20
  %28 = getelementptr inbounds [51 x i32], ptr %1, i64 %12
  %29 = sub nsw i32 %11, 1
