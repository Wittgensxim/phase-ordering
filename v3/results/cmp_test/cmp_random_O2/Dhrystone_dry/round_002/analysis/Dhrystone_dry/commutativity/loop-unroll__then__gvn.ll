...
60:                                               ; preds = %._crit_edge, %42
  %.lcssa = phi i32 [ %58, %._crit_edge ], [ %.pre, %42 ]
...
82:                                               ; preds = %._crit_edge3, %60
  ...
  %90 = icmp ult i32 %89, 100000000
  br i1 %90, label %42, label %91, !llvm.loop !11
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %22 = getelementptr inbounds [51 x i32], ptr %21, i64 0, i64 %13
