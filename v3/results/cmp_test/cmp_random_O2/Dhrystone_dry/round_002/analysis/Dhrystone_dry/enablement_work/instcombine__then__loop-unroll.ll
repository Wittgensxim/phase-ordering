...
7:                                                ; preds = %7, %0
  ...
  %10 = add nuw nsw i32 %8, 25
  %11 = icmp samesign ult i32 %9, 99999999
...
._crit_edge:                                      ; preds = %29
  %.lcssa2 = phi i32 [ %35, %29 ]
  br label %37

37:                                               ; preds = %._crit_edge, %22
  %.lcssa = phi i32 [ %.lcssa2, %._crit_edge ], [ %.pre, %22 ]
...
52:                                               ; preds = %50, %44
  ...
  %.not1 = icmp sgt i8 %53, %55
  br i1 %.not1, label %._crit_edge3, label %44, !llvm.loop !10
