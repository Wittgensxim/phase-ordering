...
12:                                               ; preds = %12, %0
  ...
  br i1 %exitcond, label %12, label %15, !llvm.loop !7
...
15:                                               ; preds = %12
  ...
  %27 = call ptr @strcpy(ptr noundef %6, ptr noundef @.str.1) #5
...
29:                                               ; preds = %69, %15
  %30 = phi i32 [ 0, %15 ], [ %76, %69 ]
  %31 = call i32 @Proc5()
  %32 = call i32 @Proc4()
  store i32 2, ptr %1, align 4
  store i32 3, ptr %2, align 4
  %33 = call ptr @strcpy(ptr noundef %7, ptr noundef @.str.2) #5
  store i32 10000, ptr %5, align 4
  %34 = call i32 @Func2(ptr noundef %6, ptr noundef %7)
  %35 = icmp ne i32 %34, 0
  %36 = xor i1 %35, true
...
39:                                               ; preds = %39, %.lr.ph
  ...
  %43 = call i32 @Proc7(i32 noundef %40, i32 noundef 3, ptr noundef %3)
...
47:                                               ; preds = %._crit_edge, %29
  %.lcssa = phi i32 [ %45, %._crit_edge ], [ %.pre, %29 ]
...
55:                                               ; preds = %63, %.lr.ph2
  %56 = phi i32 [ 65, %.lr.ph2 ], [ %65, %63 ]
  %57 = phi i8 [ 65, %.lr.ph2 ], [ %64, %63 ]
...
61:                                               ; preds = %55
  %62 = call i32 @Proc6(i32 noundef 0, ptr noundef %5)
  br label %63
...
63:                                               ; preds = %61, %55
  ...
  br i1 %68, label %55, label %._crit_edge3, !llvm.loop !10
...
69:                                               ; preds = %._crit_edge3, %47
  ...
  %exitcond1 = icmp ne i32 %76, 100000000
  br i1 %exitcond1, label %29, label %77, !llvm.loop !11
...
22:                                               ; preds = %22, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %22 ], [ %21, %4 ]
  %23 = getelementptr inbounds [51 x i32], ptr %1, i64 %12
  %24 = getelementptr inbounds [51 x i32], ptr %23, i64 0, i64 %indvars.iv
  store i32 %11, ptr %24, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %25 = trunc nsw i64 %indvars.iv.next to i32
  store i32 %25, ptr %10, align 4
  %26 = icmp sle i64 %indvars.iv.next, %15
  br i1 %26, label %22, label %27, !llvm.loop !12

27:                                               ; preds = %22
  %28 = sub nsw i32 %11, 1
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds [51 x i32], ptr %23, i64 0, i64 %29
