...
15:                                               ; preds = %15, %0
  ...
  %exitcond.9 = icmp ne i32 %26, 100000000
  br i1 %exitcond.9, label %15, label %27, !llvm.loop !7
...
27:                                               ; preds = %15
  ...
  %39 = call ptr @strcpy(ptr noundef %8, ptr noundef @.str.1) #5
...
41:                                               ; preds = %81, %27
  %42 = phi i32 [ 0, %27 ], [ %88, %81 ]
  %43 = call i32 @Proc5()
  %44 = call i32 @Proc4()
  store i32 2, ptr %2, align 4
  store i32 3, ptr %3, align 4
  %45 = call ptr @strcpy(ptr noundef %9, ptr noundef @.str.2) #5
  store i32 10000, ptr %7, align 4
  %46 = call i32 @Func2(ptr noundef %8, ptr noundef %9)
  %47 = icmp ne i32 %46, 0
  %48 = xor i1 %47, true
  %49 = zext i1 %48 to i32
  store i32 %49, ptr @BoolGlob, align 4
  %.pre = load i32, ptr %2, align 4
  %50 = icmp slt i32 %.pre, 3
...
51:                                               ; preds = %51, %.lr.ph
  %52 = phi i32 [ %.pre, %.lr.ph ], [ %57, %51 ]
  %53 = mul nsw i32 5, %52
  %54 = sub nsw i32 %53, 3
  store i32 %54, ptr %4, align 4
  %55 = call i32 @Proc7(i32 noundef %52, i32 noundef 3, ptr noundef %4)
  %56 = load i32, ptr %2, align 4
  %57 = add nsw i32 %56, 1
  store i32 %57, ptr %2, align 4
  %58 = icmp slt i32 %57, 3
  br i1 %58, label %51, label %._crit_edge, !llvm.loop !9
...
59:                                               ; preds = %._crit_edge, %41
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %41 ]
...
67:                                               ; preds = %75, %.lr.ph2
  %68 = phi i32 [ 65, %.lr.ph2 ], [ %77, %75 ]
  %69 = phi i8 [ 65, %.lr.ph2 ], [ %76, %75 ]
...
75:                                               ; preds = %73, %67
  ...
  br i1 %80, label %67, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %75
  br label %81

81:                                               ; preds = %._crit_edge3, %59
  ...
  %exitcond1 = icmp ne i32 %88, 100000000
  br i1 %exitcond1, label %41, label %89, !llvm.loop !11
...
24:                                               ; preds = %4
  ...
  %26 = getelementptr inbounds [51 x i32], ptr %25, i64 0, i64 %22
  store i32 %12, ptr %26, align 4
  %indvars.iv.next = add nsw i64 %21, 6
...
29:                                               ; preds = %24
  ...
  %31 = getelementptr inbounds [51 x i32], ptr %30, i64 0, i64 %indvars.iv.next
  store i32 %12, ptr %31, align 4
  %indvars.iv.next.1 = add nsw i64 %21, 7
  %32 = trunc nsw i64 %indvars.iv.next.1 to i32
...
33:                                               ; preds = %29, %24
  ...
  %41 = add nsw i32 %12, 20
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds [51 x i32], ptr %1, i64 %42
  %44 = getelementptr inbounds [51 x i32], ptr %43, i64 0, i64 %13
