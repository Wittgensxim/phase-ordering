...
._crit_edge:                                      ; preds = %40
  %.lcssa1 = phi i32 [ %46, %40 ]
  br label %48

48:                                               ; preds = %._crit_edge, %30
  %.lcssa = phi i32 [ %.lcssa1, %._crit_edge ], [ %.pre, %30 ]
...
70:                                               ; preds = %._crit_edge3, %48
  %.lcssa35 = phi i8 [ %.lcssa3, %._crit_edge3 ], [ 65, %48 ]
...
79:                                               ; preds = %70
  %.lcssa6 = phi i32 [ %77, %70 ]
  %.lcssa35.lcssa = phi i8 [ %.lcssa35, %70 ]
  %.lcssa4 = phi i32 [ %75, %70 ]
  store i32 %.lcssa4, ptr %2, align 1
  store i8 %.lcssa35.lcssa, ptr %4, align 1
...
9:                                                ; preds = %18, %1
  %10 = phi i32 [ %.promoted1, %1 ], [ %19, %18 ]
  %11 = phi i32 [ %.promoted, %1 ], [ %20, %18 ]
  %12 = phi i32 [ undef, %1 ], [ %21, %18 ]
  %13 = phi i32 [ %6, %1 ], [ %22, %18 ]
...
21:                                               ; preds = %21, %4
  %22 = phi i32 [ %11, %4 ], [ %25, %21 ]
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [51 x i32], ptr %20, i64 0, i64 %23
...
27:                                               ; preds = %21
  %.lcssa1 = phi i32 [ %25, %21 ]
  %.lcssa = phi ptr [ %20, %21 ]
  store i32 %.lcssa1, ptr %10, align 4
  %28 = sub nsw i32 %11, 1
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds [51 x i32], ptr %.lcssa, i64 0, i64 %29
