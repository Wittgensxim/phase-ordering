...
.lr.ph2:                                          ; preds = %._crit_edge, %64
  %57 = phi i32 [ %66, %64 ], [ 65, %._crit_edge ]
  %58 = phi i8 [ %65, %64 ], [ 65, %._crit_edge ]
...
64:                                               ; preds = %62, %.lr.ph2
  ...
  br i1 %69, label %.lr.ph2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %64, %._crit_edge
  %.lcssa24 = phi i8 [ 65, %._crit_edge ], [ %65, %64 ]
...
78:                                               ; preds = %._crit_edge3
  %.lcssa5 = phi i32 [ %76, %._crit_edge3 ]
  %.lcssa24.lcssa = phi i8 [ %.lcssa24, %._crit_edge3 ]
  %.lcssa3 = phi i32 [ %74, %._crit_edge3 ]
  store i32 %.lcssa3, ptr %3, align 1
  store i8 %.lcssa24.lcssa, ptr %6, align 1
  store i32 %.lcssa5, ptr %10, align 1
  ret i32 undef
}
