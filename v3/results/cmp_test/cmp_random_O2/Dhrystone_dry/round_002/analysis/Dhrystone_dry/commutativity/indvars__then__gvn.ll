...
50:                                               ; preds = %._crit_edge, %32
  %.lcssa = phi i32 [ %48, %._crit_edge ], [ %.pre, %32 ]
...
23:                                               ; preds = %23, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %23 ], [ %22, %4 ]
  ...
  %27 = icmp sle i64 %indvars.iv.next, %16
  br i1 %27, label %23, label %28, !llvm.loop !12

28:                                               ; preds = %23
  %29 = sub nsw i32 %12, 1
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds [51 x i32], ptr %24, i64 0, i64 %30
