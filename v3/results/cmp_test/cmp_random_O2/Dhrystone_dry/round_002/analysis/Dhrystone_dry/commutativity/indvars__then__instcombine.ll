...
35:                                               ; preds = %._crit_edge, %20
  %.lcssa = phi i32 [ %33, %._crit_edge ], [ %.pre, %20 ]
...
42:                                               ; preds = %50, %.lr.ph2
  %43 = phi i32 [ 65, %.lr.ph2 ], [ %52, %50 ]
  %44 = phi i8 [ 65, %.lr.ph2 ], [ %51, %50 ]
...
50:                                               ; preds = %48, %42
  ...
  %.not2 = icmp sgt i8 %51, %53
  br i1 %.not2, label %._crit_edge3, label %42, !llvm.loop !10
...
54:                                               ; preds = %._crit_edge3, %35
  ...
  %exitcond1.not = icmp eq i32 %58, 100000000
  br i1 %exitcond1.not, label %59, label %20, !llvm.loop !11
...
17:                                               ; preds = %17, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %17 ], [ %15, %4 ]
  ...
  br i1 %.not.not, label %17, label %20, !llvm.loop !12
