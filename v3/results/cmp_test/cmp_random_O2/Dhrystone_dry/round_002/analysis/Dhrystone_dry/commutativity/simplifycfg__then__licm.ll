...
33:                                               ; preds = %._crit_edge3, %19
  %34 = phi i32 [ 0, %19 ], [ %76, %._crit_edge3 ]
  %35 = call i32 @Proc5()
  %36 = call i32 @Proc4()
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %43 = phi i32 [ %48, %.lr.ph ], [ %.pre, %.lr.ph.preheader ]
  %44 = mul nsw i32 5, %43
  %45 = sub nsw i32 %44, 3
  ...
  br i1 %49, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !9

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %.lcssa1 = phi i32 [ %48, %.lr.ph ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %33
  %.lcssa = phi i32 [ %.pre, %33 ], [ %.lcssa1, %._crit_edge.loopexit ]
  ...
  br i1 %56, label %.lr.ph2.preheader, label %._crit_edge3

.lr.ph2.preheader:                                ; preds = %._crit_edge
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %64
  %57 = phi i32 [ %66, %64 ], [ 65, %.lr.ph2.preheader ]
  %58 = phi i8 [ %65, %64 ], [ 65, %.lr.ph2.preheader ]
...
64:                                               ; preds = %62, %.lr.ph2
  ...
  br i1 %69, label %.lr.ph2, label %._crit_edge3.loopexit, !llvm.loop !10

._crit_edge3.loopexit:                            ; preds = %64
  %.lcssa3 = phi i8 [ %65, %64 ]
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3.loopexit, %._crit_edge
  %.lcssa35 = phi i8 [ %.lcssa3, %._crit_edge3.loopexit ], [ 65, %._crit_edge ]
  ...
  br i1 %77, label %33, label %78, !llvm.loop !11

78:                                               ; preds = %._crit_edge3
  %.lcssa6 = phi i32 [ %76, %._crit_edge3 ]
  %.lcssa35.lcssa = phi i8 [ %.lcssa35, %._crit_edge3 ]
  %.lcssa4 = phi i32 [ %74, %._crit_edge3 ]
