...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %42 = phi i32 [ %47, %.lr.ph ], [ %.pre, %.lr.ph.preheader ]
  %43 = mul nsw i32 5, %42
  %44 = sub nsw i32 %43, 3
  ...
  br i1 %48, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !9

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %.lcssa1 = phi i32 [ %47, %.lr.ph ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %32
  %.lcssa = phi i32 [ %.pre, %32 ], [ %.lcssa1, %._crit_edge.loopexit ]
  ...
  br i1 %55, label %.lr.ph2.preheader, label %._crit_edge3

.lr.ph2.preheader:                                ; preds = %._crit_edge
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %63
  %56 = phi i32 [ %65, %63 ], [ 65, %.lr.ph2.preheader ]
  %57 = phi i8 [ %64, %63 ], [ 65, %.lr.ph2.preheader ]
...
63:                                               ; preds = %61, %.lr.ph2
  ...
  br i1 %68, label %.lr.ph2, label %._crit_edge3.loopexit, !llvm.loop !10

._crit_edge3.loopexit:                            ; preds = %63
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit, %._crit_edge
  ...
  %exitcond2 = icmp ne i32 %75, 100000000
  br i1 %exitcond2, label %32, label %76, !llvm.loop !11
