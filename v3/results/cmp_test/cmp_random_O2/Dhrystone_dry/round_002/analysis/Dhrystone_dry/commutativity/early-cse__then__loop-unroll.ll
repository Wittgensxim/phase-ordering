...
._crit_edge:                                      ; preds = %49
  %.lcssa1 = phi i32 [ %55, %49 ]
  br label %57

57:                                               ; preds = %._crit_edge, %39
  %.lcssa = phi i32 [ %.lcssa1, %._crit_edge ], [ %.pre, %39 ]
...
31:                                               ; preds = %26, %20
  %.lcssa = phi ptr [ %21, %20 ], [ %27, %26 ]
  %32 = sub nsw i32 %11, 1
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds [51 x i32], ptr %.lcssa, i64 0, i64 %33
  ...
  %41 = getelementptr inbounds [51 x i32], ptr %40, i64 0, i64 %12
