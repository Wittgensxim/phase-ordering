...
51:                                               ; preds = %._crit_edge, %33
  %.lcssa = phi i32 [ %49, %._crit_edge ], [ %.pre, %33 ]
...
73:                                               ; preds = %._crit_edge3, %51
  %.lcssa24 = phi i8 [ %68, %._crit_edge3 ], [ 65, %51 ]
...
82:                                               ; preds = %73
  store i32 %78, ptr %3, align 1
  store i8 %.lcssa24, ptr %6, align 1
  store i32 %80, ptr %10, align 1
  ret i32 undef
}
...
10:                                               ; preds = %19, %1
  %11 = phi i32 [ undef, %1 ], [ %20, %19 ]
  %12 = phi i32 [ %7, %1 ], [ %21, %19 ]
...
28:                                               ; preds = %22
  ...
  %31 = getelementptr inbounds [51 x i32], ptr %21, i64 0, i64 %30
