...
._crit_edge:                                      ; preds = %39
  %.lcssa1 = phi i32 [ %45, %39 ]
  br label %47

47:                                               ; preds = %._crit_edge, %29
  %.lcssa = phi i32 [ %.lcssa1, %._crit_edge ], [ %.pre, %29 ]
...
69:                                               ; preds = %._crit_edge3, %47
  ...
  %exitcond2 = icmp ne i32 %76, 100000000
  br i1 %exitcond2, label %29, label %77, !llvm.loop !11
...
23:                                               ; preds = %23, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %23 ], [ %21, %4 ]
  %24 = getelementptr inbounds [51 x i32], ptr %1, i64 %12
  %25 = getelementptr inbounds [51 x i32], ptr %24, i64 0, i64 %indvars.iv
  store i32 %11, ptr %25, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %26 = trunc nsw i64 %indvars.iv.next to i32
  store i32 %26, ptr %10, align 4
  %27 = icmp sle i64 %indvars.iv.next, %22
...
28:                                               ; preds = %23
  ...
  %35 = add nsw i32 %11, 20
  %36 = sext i32 %35 to i64
  %37 = getelementptr inbounds [51 x i32], ptr %1, i64 %36
  %38 = getelementptr inbounds [51 x i32], ptr %37, i64 0, i64 %12
