...
44:                                               ; preds = %44, %.lr.ph
  ...
  %48 = call i32 @Proc7(i32 noundef %45, i32 noundef 3, ptr noundef %2)
...
60:                                               ; preds = %68, %.lr.ph2
  %61 = phi i32 [ 65, %.lr.ph2 ], [ %70, %68 ]
  %62 = phi i8 [ 65, %.lr.ph2 ], [ %69, %68 ]
...
68:                                               ; preds = %66, %60
  ...
  br i1 %73, label %60, label %._crit_edge3, !llvm.loop !10
