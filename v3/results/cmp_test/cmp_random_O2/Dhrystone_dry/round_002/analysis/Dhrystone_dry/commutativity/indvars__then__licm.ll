...
72:                                               ; preds = %._crit_edge3, %50
  %.lcssa35 = phi i8 [ %.lcssa3, %._crit_edge3 ], [ 65, %50 ]
...
80:                                               ; preds = %72
  %.lcssa6 = phi i32 [ %79, %72 ]
  %.lcssa35.lcssa = phi i8 [ %.lcssa35, %72 ]
  %.lcssa4 = phi i32 [ %77, %72 ]
...
25:                                               ; preds = %25, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %25 ], [ %22, %4 ]
  %26 = getelementptr inbounds [51 x i32], ptr %24, i64 0, i64 %indvars.iv
