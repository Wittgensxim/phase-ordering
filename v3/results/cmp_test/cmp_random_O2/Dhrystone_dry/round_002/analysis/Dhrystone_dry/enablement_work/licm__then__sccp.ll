...
51:                                               ; preds = %._crit_edge, %33
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %33 ]
...
73:                                               ; preds = %._crit_edge3, %51
  %.lcssa24 = phi i8 [ %.lcssa2, %._crit_edge3 ], [ 65, %51 ]
...
82:                                               ; preds = %73
  %.lcssa5 = phi i32 [ %80, %73 ]
  %.lcssa24.lcssa = phi i8 [ %.lcssa24, %73 ]
  %.lcssa3 = phi i32 [ %78, %73 ]
...
15:                                               ; preds = %11, %10
  %16 = phi i32 [ 0, %11 ], [ %.promoted1, %10 ]
  %17 = phi i32 [ %12, %11 ], [ %.promoted, %10 ]
  %18 = phi i32 [ %12, %11 ], [ %7, %10 ]
  br label %19
...
8:                                                ; preds = %20, %2
  %9 = phi i32 [ %.promoted3, %2 ], [ %21, %20 ]
  %10 = phi i8 [ %.promoted, %2 ], [ %22, %20 ]
  ...
  %17 = call i32 @Func1(i32 noundef %13, i32 noundef %16)
  %18 = icmp eq i32 %17, 0
