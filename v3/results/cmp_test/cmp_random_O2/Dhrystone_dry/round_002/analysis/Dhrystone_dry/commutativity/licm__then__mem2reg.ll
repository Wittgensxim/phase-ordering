...
65:                                               ; preds = %._crit_edge3, %43
  %.lcssa24 = phi i8 [ %.lcssa2, %._crit_edge3 ], [ 65, %43 ]
...
74:                                               ; preds = %65
  %.lcssa5 = phi i32 [ %72, %65 ]
  %.lcssa24.lcssa = phi i8 [ %.lcssa24, %65 ]
  %.lcssa3 = phi i32 [ %70, %65 ]
  ret i32 undef
}
...
6:                                                ; preds = %15, %1
  %7 = phi i32 [ undef, %1 ], [ %16, %15 ]
  %8 = phi i32 [ %3, %1 ], [ %17, %15 ]
  %9 = phi i32 [ undef, %1 ], [ %18, %15 ]
  %10 = phi i32 [ %3, %1 ], [ %19, %15 ]
...
15:                                               ; preds = %15, %4
  ...
  %18 = getelementptr inbounds [51 x i32], ptr %14, i64 0, i64 %17
  store i32 %5, ptr %18, align 4
  %19 = add nsw i32 %16, 1
  %20 = icmp sle i32 %19, %8
  br i1 %20, label %15, label %21, !llvm.loop !12
...
3:                                                ; preds = %20, %2
  %4 = phi i32 [ 1, %2 ], [ %21, %20 ]
  %5 = phi i8 [ undef, %2 ], [ %22, %20 ]
  %6 = phi i8 [ undef, %2 ], [ %24, %20 ]
  %7 = phi i32 [ 1, %2 ], [ %23, %20 ]
  %8 = sext i32 %7 to i64
...
20:                                               ; preds = %19, %3
  %21 = phi i32 [ %12, %19 ], [ %4, %3 ]
  %22 = phi i8 [ 65, %19 ], [ %5, %3 ]
  %23 = phi i32 [ %12, %19 ], [ %7, %3 ]
  %24 = phi i8 [ 65, %19 ], [ %6, %3 ]
  %25 = icmp sle i32 %23, 1
  br i1 %25, label %3, label %26, !llvm.loop !13

26:                                               ; preds = %20
  %.lcssa4 = phi i32 [ %21, %20 ]
  %.lcssa2 = phi i8 [ %22, %20 ]
  %.lcssa1 = phi i32 [ %23, %20 ]
  %.lcssa = phi i8 [ %24, %20 ]
  %27 = sext i8 %.lcssa to i32
  %28 = icmp sge i32 %27, 87
  %29 = icmp sle i32 %27, 90
...
31:                                               ; preds = %30, %26
  %32 = phi i32 [ 7, %30 ], [ %.lcssa1, %26 ]
  %33 = icmp eq i32 %27, 88
