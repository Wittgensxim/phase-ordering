...
.lr.ph:                                           ; preds = %42, %.lr.ph
  ...
  br i1 %58, label %.lr.ph, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %.lr.ph, %42
  %.lcssa = phi i32 [ %.pre, %42 ], [ %57, %.lr.ph ]
  ...
  br i1 %65, label %.lr.ph2, label %._crit_edge3

.lr.ph2:                                          ; preds = %._crit_edge, %73
  %66 = phi i32 [ %75, %73 ], [ 65, %._crit_edge ]
  %67 = phi i8 [ %74, %73 ], [ 65, %._crit_edge ]
...
73:                                               ; preds = %71, %.lr.ph2
  ...
  br i1 %78, label %.lr.ph2, label %._crit_edge3, !llvm.loop !10
