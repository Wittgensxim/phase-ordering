...
15:                                               ; preds = %33, %0
  %16 = phi i32 [ poison, %0 ], [ %34, %33 ]
  %17 = phi i32 [ 0, %0 ], [ %34, %33 ]
...
35:                                               ; preds = %15
  ...
  store ptr %38, ptr @PtrGlbNext, align 8
  %39 = call ptr @malloc(i64 noundef 56) #4
  store ptr %39, ptr @PtrGlb, align 8
  %40 = load ptr, ptr @PtrGlbNext, align 8
  store ptr %40, ptr %39, align 8
  %41 = load ptr, ptr @PtrGlb, align 8
  %42 = getelementptr inbounds nuw %struct.Record, ptr %41, i32 0, i32 1
  store i32 0, ptr %42, align 8
  %43 = getelementptr inbounds nuw %struct.Record, ptr %41, i32 0, i32 2
  store i32 10001, ptr %43, align 4
  %44 = getelementptr inbounds nuw %struct.Record, ptr %41, i32 0, i32 3
  store i32 40, ptr %44, align 8
  %45 = getelementptr inbounds nuw %struct.Record, ptr %41, i32 0, i32 4
  %46 = call ptr @strcpy(ptr noundef %45, ptr noundef @.str) #5
  %47 = call ptr @strcpy(ptr noundef %8, ptr noundef @.str.1) #5
...
49:                                               ; preds = %91, %35
  %50 = phi i32 [ %98, %91 ], [ %.promoted, %35 ]
  %.lcssa26 = phi i8 [ %.lcssa2, %91 ], [ %.promoted5, %35 ]
  %51 = phi i32 [ %96, %91 ], [ %.promoted3, %35 ]
  %52 = phi i32 [ %98, %91 ], [ 0, %35 ]
  %53 = icmp ult i32 %52, 100000000
...
54:                                               ; preds = %49
  ...
  %57 = call ptr @strcpy(ptr noundef %9, ptr noundef @.str.2) #5
  store i32 10000, ptr %7, align 4
  %58 = call i32 @Func2(ptr noundef %8, ptr noundef %9)
  %59 = icmp ne i32 %58, 0
  %60 = xor i1 %59, true
  %61 = zext i1 %60 to i32
  store i32 %61, ptr @BoolGlob, align 4
  %.pre = load i32, ptr %2, align 4
  br label %62

62:                                               ; preds = %65, %54
  %63 = phi i32 [ %70, %65 ], [ %.pre, %54 ]
...
65:                                               ; preds = %62
  ...
  %68 = call i32 @Proc7(i32 noundef %63, i32 noundef 3, ptr noundef %4)
...
71:                                               ; preds = %62
  ...
  %73 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %.lcssa, i32 noundef %72)
  %74 = load ptr, ptr @PtrGlb, align 8
  %75 = call i32 @Proc1(ptr noundef %74)
  br label %76

76:                                               ; preds = %89, %71
  %77 = phi i8 [ %90, %89 ], [ 65, %71 ]
  %78 = phi i8 [ %90, %89 ], [ 65, %71 ]
...
83:                                               ; preds = %76
  ...
  %85 = call i32 @Func1(i32 noundef %79, i32 noundef 67)
  %86 = icmp eq i32 %84, %85
  br i1 %86, label %87, label %89

87:                                               ; preds = %83
  %88 = call i32 @Proc6(i32 noundef 0, ptr noundef %7)
  br label %89
...
91:                                               ; preds = %76
  ...
  %97 = call i32 @Proc2(ptr noundef %2)
  %98 = add i32 %52, 1
  br label %49, !llvm.loop !11

99:                                               ; preds = %49
  %.lcssa7 = phi i32 [ %50, %49 ]
  %.lcssa26.lcssa = phi i8 [ %.lcssa26, %49 ]
  %.lcssa4 = phi i32 [ %51, %49 ]
