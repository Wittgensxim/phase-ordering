...
8:                                                ; preds = %23, %2
  %9 = phi i32 [ %24, %23 ], [ %.promoted3, %2 ]
  %10 = phi i8 [ %25, %23 ], [ %.promoted, %2 ]
  %11 = phi i32 [ %26, %23 ], [ 1, %2 ]
...
13:                                               ; preds = %8
  ...
  %20 = call i32 @Func1(i32 noundef %16, i32 noundef %19)
  %21 = icmp eq i32 %20, 0
...
23:                                               ; preds = %22, %13
  %24 = phi i32 [ 2, %22 ], [ %9, %13 ]
  %25 = phi i8 [ 65, %22 ], [ %10, %13 ]
  %26 = phi i32 [ 2, %22 ], [ 1, %13 ]
