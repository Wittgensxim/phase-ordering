...
34:                                               ; preds = %74, %20
  %35 = phi i32 [ %81, %74 ], [ %.promoted, %20 ]
  %.lcssa26 = phi i8 [ %.lcssa2, %74 ], [ %.promoted5, %20 ]
  %36 = phi i32 [ %79, %74 ], [ %.promoted3, %20 ]
  %37 = phi i32 [ %81, %74 ], [ 0, %20 ]
  %exitcond8 = icmp ne i32 %37, 100000000
  br i1 %exitcond8, label %38, label %82
...
70:                                               ; preds = %66
  %71 = call i32 @Proc6(i32 noundef 0, ptr noundef %7)
  br label %72
...
82:                                               ; preds = %34
  ...
  %.lcssa26.lcssa = phi i8 [ %.lcssa26, %34 ]
  %.lcssa4 = phi i32 [ %36, %34 ]
...
25:                                               ; preds = %28, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %28 ], [ %23, %4 ]
  %26 = phi i32 [ %30, %28 ], [ poison, %4 ]
  %27 = icmp sle i64 %indvars.iv, %24
  br i1 %27, label %28, label %31

28:                                               ; preds = %25
  %29 = getelementptr inbounds [51 x i32], ptr %21, i64 0, i64 %indvars.iv
