...
40:                                               ; preds = %37
  ...
  %43 = call i32 @Proc7(i32 noundef %38, i32 noundef 3, ptr noundef %2)
...
46:                                               ; preds = %37
  ...
  %48 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %38, i32 noundef %47)
  %49 = load ptr, ptr @PtrGlb, align 8
  %50 = call i32 @Proc1(ptr noundef %49)
  br label %51

51:                                               ; preds = %63, %46
  %52 = phi i8 [ %64, %63 ], [ 65, %46 ]
...
3:                                                ; preds = %7, %2
  %4 = phi i32 [ %spec.select, %7 ], [ 1, %2 ]
  %5 = phi i8 [ %spec.select1, %7 ], [ undef, %2 ]
  %6 = icmp sle i32 %4, 1
...
7:                                                ; preds = %3
  ...
  %18 = icmp eq i32 %17, 0
  %spec.select = select i1 %18, i32 %12, i32 %4
  %spec.select1 = select i1 %18, i8 65, i8 %5
  br label %3, !llvm.loop !13

19:                                               ; preds = %3
  %20 = sext i8 %5 to i32
  %21 = icmp sge i32 %20, 87
  %22 = icmp sle i32 %20, 90
  %or.cond = and i1 %21, %22
  %23 = select i1 %or.cond, i32 7, i32 %4
  %24 = icmp eq i32 %20, 88
  br i1 %24, label %28, label %25

25:                                               ; preds = %19
  %26 = call i32 @strcmp(ptr noundef %0, ptr noundef %1) #5
  %27 = icmp sgt i32 %26, 0
  %spec.select2 = select i1 %27, i32 1, i32 0
  br label %28

28:                                               ; preds = %25, %19
  %29 = phi i32 [ 1, %19 ], [ %spec.select2, %25 ]
  ret i32 %29
}
