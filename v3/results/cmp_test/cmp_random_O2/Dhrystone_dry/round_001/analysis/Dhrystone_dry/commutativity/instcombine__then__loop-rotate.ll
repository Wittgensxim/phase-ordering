...
36:                                               ; preds = %._crit_edge, %21
  ...
  %.not12 = icmp sgt i8 65, %41
  br i1 %.not12, label %53, label %.lr.ph4

.lr.ph4:                                          ; preds = %36
  br label %42

42:                                               ; preds = %.lr.ph4, %50
  %43 = phi i8 [ 65, %.lr.ph4 ], [ %51, %50 ]
...
53:                                               ; preds = %._crit_edge5, %36
  %54 = load i32, ptr %1, align 4
  %55 = mul nsw i32 %54, 3
  store i32 %55, ptr %2, align 4
  %56 = call i32 @Proc2(ptr noundef nonnull %1)
  %57 = add nuw nsw i32 %22, 1
  %58 = icmp samesign ult i32 %57, 100000000
  br i1 %58, label %21, label %59, !llvm.loop !11
...
14:                                               ; preds = %4, %14
  ...
  %19 = add nsw i32 %15, 1
  %.not = icmp sgt i32 %19, %8
  br i1 %.not, label %20, label %14, !llvm.loop !12
...
22:                                               ; preds = %18
  %.lcssa = phi i8 [ %20, %18 ]
  %23 = icmp sgt i8 %.lcssa, 86
  br i1 %23, label %24, label %27

24:                                               ; preds = %22
  %25 = icmp slt i8 %.lcssa, 91
...
30:                                               ; preds = %27
  %31 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #5
