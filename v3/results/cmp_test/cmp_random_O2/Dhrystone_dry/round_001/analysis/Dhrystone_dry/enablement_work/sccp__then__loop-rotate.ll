...
51:                                               ; preds = %._crit_edge, %33
  ...
  br i1 %58, label %.lr.ph5, label %73

.lr.ph5:                                          ; preds = %51
  br label %59

59:                                               ; preds = %.lr.ph5, %67
  %60 = phi i32 [ 65, %.lr.ph5 ], [ %69, %67 ]
  %61 = phi i8 [ 65, %.lr.ph5 ], [ %68, %67 ]
...
67:                                               ; preds = %65, %59
  ...
  br i1 %72, label %59, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %67
  br label %73

73:                                               ; preds = %._crit_edge6, %51
