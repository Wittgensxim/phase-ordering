...
15:                                               ; preds = %15, %0
  %16 = phi i32 [ %19, %15 ], [ poison, %0 ]
  %17 = phi i32 [ %19, %15 ], [ 0, %0 ]
  %18 = icmp ult i32 %17, 100000000
  %19 = add i32 %17, 1
  br i1 %18, label %15, label %20, !llvm.loop !7
...
34:                                               ; preds = %20, %74
  %35 = phi i32 [ 0, %20 ], [ %81, %74 ]
  %36 = call i32 @Proc5()
  %37 = call i32 @Proc4()
  store i32 2, ptr %2, align 4
  %38 = call ptr @strcpy(ptr noundef %9, ptr noundef @.str.2) #5
  store i32 10000, ptr %7, align 4
  %39 = call i32 @Func2(ptr noundef %8, ptr noundef %9)
  %40 = icmp ne i32 %39, 0
  %41 = xor i1 %40, true
...
44:                                               ; preds = %.lr.ph, %44
  ...
  br i1 %51, label %44, label %._crit_edge, !llvm.loop !9
...
52:                                               ; preds = %._crit_edge, %34
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %34 ]
  ...
  br i1 %59, label %.lr.ph9, label %74

.lr.ph9:                                          ; preds = %52
  br label %60

60:                                               ; preds = %.lr.ph9, %68
  %61 = phi i32 [ 65, %.lr.ph9 ], [ %70, %68 ]
  %62 = phi i8 [ 65, %.lr.ph9 ], [ %69, %68 ]
  %63 = load i32, ptr %7, align 4
  %64 = call i32 @Func1(i32 noundef %61, i32 noundef 67)
...
68:                                               ; preds = %66, %60
  ...
  br i1 %73, label %60, label %._crit_edge10, !llvm.loop !10

._crit_edge10:                                    ; preds = %68
  %split11 = phi i8 [ %69, %68 ]
  br label %74

74:                                               ; preds = %._crit_edge10, %52
  %.lcssa2 = phi i8 [ %split11, %._crit_edge10 ], [ 65, %52 ]
  ...
  br i1 %82, label %34, label %83, !llvm.loop !11

83:                                               ; preds = %74
  %.lcssa7 = phi i32 [ %81, %74 ]
  %.lcssa26.lcssa = phi i8 [ %.lcssa2, %74 ]
  %.lcssa4 = phi i32 [ %79, %74 ]
...
10:                                               ; preds = %19, %1
  %11 = phi i32 [ %20, %19 ], [ %.promoted1, %1 ]
  %12 = phi i32 [ %21, %19 ], [ %.promoted, %1 ]
  %13 = phi i32 [ %22, %19 ], [ undef, %1 ]
  %14 = phi i32 [ %23, %19 ], [ %7, %1 ]
...
8:                                                ; preds = %2, %25
  %9 = phi i8 [ undef, %2 ], [ %29, %25 ]
  %10 = phi i32 [ 1, %2 ], [ %28, %25 ]
  %11 = phi i8 [ %.promoted, %2 ], [ %27, %25 ]
  %12 = phi i32 [ %.promoted3, %2 ], [ %26, %25 ]
...
25:                                               ; preds = %24, %8
  %26 = phi i32 [ %17, %24 ], [ %12, %8 ]
  %27 = phi i8 [ 65, %24 ], [ %11, %8 ]
  %28 = phi i32 [ %17, %24 ], [ %10, %8 ]
  %29 = phi i8 [ 65, %24 ], [ %9, %8 ]
...
37:                                               ; preds = %36, %34, %31
  %38 = phi i32 [ 7, %36 ], [ %.lcssa1, %34 ], [ %.lcssa1, %31 ]
...
41:                                               ; preds = %37
  %42 = call i32 @strcmp(ptr noundef %0, ptr noundef %1) #5
