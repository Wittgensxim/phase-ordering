...
42:                                               ; preds = %.lr.ph, %42
  ...
  br i1 %49, label %42, label %._crit_edge, !llvm.loop !9
...
50:                                               ; preds = %._crit_edge, %32
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %32 ]
  ...
  br i1 %57, label %.lr.ph3, label %72

.lr.ph3:                                          ; preds = %50
  br label %58

58:                                               ; preds = %.lr.ph3, %66
  %59 = phi i32 [ 65, %.lr.ph3 ], [ %68, %66 ]
  %60 = phi i8 [ 65, %.lr.ph3 ], [ %67, %66 ]
...
66:                                               ; preds = %64, %58
  ...
  br i1 %71, label %58, label %._crit_edge4, !llvm.loop !10

._crit_edge4:                                     ; preds = %66
  br label %72

72:                                               ; preds = %._crit_edge4, %50
  ...
  %exitcond1 = icmp ne i32 %79, 100000000
  br i1 %exitcond1, label %32, label %80, !llvm.loop !11
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  br i1 %24, label %.lr.ph, label %30

.lr.ph:                                           ; preds = %4
  br label %25

25:                                               ; preds = %.lr.ph, %25
  %indvars.iv2 = phi i64 [ %22, %.lr.ph ], [ %indvars.iv.next, %25 ]
  %26 = getelementptr inbounds [51 x i32], ptr %1, i64 %13
  %27 = getelementptr inbounds [51 x i32], ptr %26, i64 0, i64 %indvars.iv2
  store i32 %12, ptr %27, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv2, 1
  %28 = trunc nsw i64 %indvars.iv.next to i32
  store i32 %28, ptr %11, align 4
  %29 = icmp sle i64 %indvars.iv.next, %23
  br i1 %29, label %25, label %._crit_edge, !llvm.loop !12
