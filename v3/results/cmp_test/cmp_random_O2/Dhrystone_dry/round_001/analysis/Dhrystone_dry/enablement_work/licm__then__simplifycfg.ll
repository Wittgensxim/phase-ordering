...
35:                                               ; preds = %76, %21
  %36 = phi i32 [ %83, %76 ], [ %.promoted, %21 ]
  %.lcssa26 = phi i8 [ %.lcssa2, %76 ], [ %.promoted5, %21 ]
  %37 = phi i32 [ %81, %76 ], [ %.promoted3, %21 ]
  %38 = phi i32 [ %83, %76 ], [ 0, %21 ]
...
76:                                               ; preds = %62
  ...
  %82 = call i32 @Proc2(ptr noundef %2)
  %83 = add i32 %38, 1
...
37:                                               ; preds = %36, %32
  %38 = phi i32 [ 7, %36 ], [ %.lcssa1, %32 ]
  %39 = icmp eq i32 %33, 88
