...
48:                                               ; preds = %86, %34
  %49 = phi i32 [ %93, %86 ], [ 0, %34 ]
  %exitcond = icmp ne i32 %49, 100000000
  br i1 %exitcond, label %50, label %94
...
50:                                               ; preds = %48
  ...
  %53 = call ptr @strcpy(ptr noundef %9, ptr noundef @.str.2) #5
  store i32 10000, ptr %7, align 4
  %54 = call i32 @Func2(ptr noundef %8, ptr noundef %9)
  %55 = icmp ne i32 %54, 0
  %56 = xor i1 %55, true
...
61:                                               ; preds = %58
  ...
  %64 = call i32 @Proc7(i32 noundef %59, i32 noundef 3, ptr noundef %4)
...
67:                                               ; preds = %58
  ...
  %69 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %.lcssa, i32 noundef %68)
