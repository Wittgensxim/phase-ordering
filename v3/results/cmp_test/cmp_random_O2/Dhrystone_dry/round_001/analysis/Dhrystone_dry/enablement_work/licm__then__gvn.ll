...
35:                                               ; preds = %75, %21
  %36 = phi i32 [ %82, %75 ], [ 0, %21 ]
  %.lcssa26 = phi i8 [ %62, %75 ], [ undef, %21 ]
  %37 = phi i32 [ %80, %75 ], [ undef, %21 ]
  %38 = icmp ult i32 %36, 100000000
...
39:                                               ; preds = %35
  ...
  %42 = call ptr @strcpy(ptr noundef %9, ptr noundef @.str.2) #5
  store i32 10000, ptr %7, align 4
  %43 = call i32 @Func2(ptr noundef %8, ptr noundef %9)
  %44 = icmp ne i32 %43, 0
  %45 = xor i1 %44, true
...
50:                                               ; preds = %47
  ...
  %53 = call i32 @Proc7(i32 noundef %48, i32 noundef 3, ptr noundef %4)
...
56:                                               ; preds = %47
  ...
  %58 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %48, i32 noundef %57)
  %59 = load ptr, ptr @PtrGlb, align 8
  %60 = call i32 @Proc1(ptr noundef %59)
  br label %61

61:                                               ; preds = %73, %56
  %62 = phi i8 [ %74, %73 ], [ 65, %56 ]
...
83:                                               ; preds = %35
  store i32 %37, ptr %3, align 1
  store i8 %.lcssa26, ptr %6, align 1
  store i32 %36, ptr %10, align 1
  ret i32 undef
}
...
10:                                               ; preds = %26, %1
  %11 = phi i32 [ %20, %26 ], [ undef, %1 ]
  %12 = phi i32 [ %21, %26 ], [ %7, %1 ]
...
25:                                               ; preds = %19
  store i32 %21, ptr %4, align 1
  store i32 %20, ptr %5, align 1
  ret i32 undef
...
30:                                               ; preds = %22
  ...
  %33 = getelementptr inbounds [51 x i32], ptr %21, i64 0, i64 %32
