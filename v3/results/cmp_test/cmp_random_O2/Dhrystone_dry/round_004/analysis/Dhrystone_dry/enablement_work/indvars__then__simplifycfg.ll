...
.lr.ph:                                           ; preds = %19, %.lr.ph
  %29 = phi i32 [ %34, %.lr.ph ], [ %.pre, %19 ]
  %30 = mul nsw i32 5, %29
  %31 = sub nsw i32 %30, 3
  store i32 %31, ptr %2, align 4
  %32 = call i32 @Proc7(i32 noundef %29, i32 noundef 3, ptr noundef %2)
...
._crit_edge:                                      ; preds = %.lr.ph, %19
  %.lcssa = phi i32 [ %.pre, %19 ], [ %34, %.lr.ph ]
  %36 = load i32, ptr %2, align 4
  %37 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %.lcssa, i32 noundef %36)
...
.lr.ph2:                                          ; preds = %._crit_edge, %50
  %43 = phi i32 [ %52, %50 ], [ 65, %._crit_edge ]
  %44 = phi i8 [ %51, %50 ], [ 65, %._crit_edge ]
  %45 = load i32, ptr %3, align 4
  %46 = call i32 @Func1(i32 noundef %43, i32 noundef 67)
  %47 = icmp eq i32 %45, %46
  br i1 %47, label %48, label %50

48:                                               ; preds = %.lr.ph2
  %49 = call i32 @Proc6(i32 noundef 0, ptr noundef %3)
  br label %50
...
50:                                               ; preds = %48, %.lr.ph2
  ...
  br i1 %55, label %.lr.ph2, label %._crit_edge3, !llvm.loop !9

._crit_edge3:                                     ; preds = %50, %._crit_edge
  ...
  %exitcond = icmp ne i32 %62, 100000000
  br i1 %exitcond, label %19, label %63, !llvm.loop !10

63:                                               ; preds = %._crit_edge3
  %64 = sub nsw i32 %7, %6
  ret i32 undef
}
