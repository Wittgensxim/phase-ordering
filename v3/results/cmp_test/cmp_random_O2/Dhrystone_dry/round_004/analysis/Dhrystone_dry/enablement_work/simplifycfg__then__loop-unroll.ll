...
25:                                               ; preds = %._crit_edge3, %11
  %26 = phi i32 [ 0, %11 ], [ %68, %._crit_edge3 ]
  %27 = call i32 @Proc5()
  %28 = call i32 @Proc4()
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %35 = phi i32 [ %40, %.lr.ph ], [ %.pre, %.lr.ph.preheader ]
  %36 = mul nsw i32 5, %35
  %37 = sub nsw i32 %36, 3
  ...
  br i1 %41, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !9

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %.lcssa1 = phi i32 [ %40, %.lr.ph ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %25
  %.lcssa = phi i32 [ %.pre, %25 ], [ %.lcssa1, %._crit_edge.loopexit ]
  ...
  br i1 %48, label %.lr.ph2.preheader, label %._crit_edge3

.lr.ph2.preheader:                                ; preds = %._crit_edge
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %56
  %49 = phi i32 [ %58, %56 ], [ 65, %.lr.ph2.preheader ]
  %50 = phi i8 [ %57, %56 ], [ 65, %.lr.ph2.preheader ]
...
56:                                               ; preds = %54, %.lr.ph2
  ...
  br i1 %61, label %.lr.ph2, label %._crit_edge3.loopexit, !llvm.loop !10

._crit_edge3.loopexit:                            ; preds = %56
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit, %._crit_edge
  ...
  br i1 %69, label %25, label %70, !llvm.loop !11

70:                                               ; preds = %._crit_edge3
  ret i32 undef
}
