...
48:                                               ; preds = %46, %.lr.ph2
  ...
  %.not = icmp sgt i8 %49, %51
  br i1 %.not, label %._crit_edge3, label %.lr.ph2, !llvm.loop !10
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %26 = getelementptr [204 x i8], ptr %1, i64 %25
...
3:                                                ; preds = %3, %2
  ...
  br i1 %.not, label %11, label %3, !llvm.loop !12

11:                                               ; preds = %3
  %12 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #6
  %13 = icmp sgt i32 %12, 0
  %. = select i1 %13, i32 1, i32 0
  ret i32 %.
}
