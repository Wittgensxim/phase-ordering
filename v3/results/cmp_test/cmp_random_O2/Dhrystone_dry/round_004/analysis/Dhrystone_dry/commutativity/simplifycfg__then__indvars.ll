...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %31 = phi i32 [ %36, %.lr.ph ], [ %.pre, %.lr.ph.preheader ]
  %32 = mul nsw i32 5, %31
  %33 = sub nsw i32 %32, 3
  ...
  br i1 %37, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !9

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %.lcssa1 = phi i32 [ %36, %.lr.ph ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %21
  %.lcssa = phi i32 [ %.pre, %21 ], [ %.lcssa1, %._crit_edge.loopexit ]
  ...
  br i1 %44, label %.lr.ph2.preheader, label %._crit_edge3

.lr.ph2.preheader:                                ; preds = %._crit_edge
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %52
  %45 = phi i32 [ %54, %52 ], [ 65, %.lr.ph2.preheader ]
  %46 = phi i8 [ %53, %52 ], [ 65, %.lr.ph2.preheader ]
...
50:                                               ; preds = %.lr.ph2
  %51 = call i32 @Proc6(i32 noundef 0, ptr noundef %3)
  br label %52
...
52:                                               ; preds = %50, %.lr.ph2
  ...
  br i1 %57, label %.lr.ph2, label %._crit_edge3.loopexit, !llvm.loop !10

._crit_edge3.loopexit:                            ; preds = %52
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3.loopexit, %._crit_edge
  ...
  %exitcond = icmp ne i32 %64, 100000000
  br i1 %exitcond, label %21, label %65, !llvm.loop !11
...
3:                                                ; preds = %3, %2
  ...
  %12 = icmp sle i32 %spec.select, 1
  br i1 %12, label %3, label %13, !llvm.loop !12

13:                                               ; preds = %3
  %14 = call i32 @strcmp(ptr noundef %0, ptr noundef %1) #5
