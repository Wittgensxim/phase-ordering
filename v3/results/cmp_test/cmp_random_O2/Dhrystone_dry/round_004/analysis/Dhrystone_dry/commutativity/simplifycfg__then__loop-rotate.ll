...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %44 = phi i32 [ %49, %.lr.ph ], [ %.pre, %.lr.ph.preheader ]
  %45 = mul nsw i32 5, %44
  %46 = sub nsw i32 %45, 3
  ...
  br i1 %50, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !9

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %.lcssa1 = phi i32 [ %49, %.lr.ph ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %34
  %.lcssa = phi i32 [ %.pre, %34 ], [ %.lcssa1, %._crit_edge.loopexit ]
  ...
  br i1 %57, label %.lr.ph2.preheader, label %._crit_edge3

.lr.ph2.preheader:                                ; preds = %._crit_edge
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %65
  %58 = phi i32 [ %67, %65 ], [ 65, %.lr.ph2.preheader ]
  %59 = phi i8 [ %66, %65 ], [ 65, %.lr.ph2.preheader ]
...
65:                                               ; preds = %63, %.lr.ph2
  ...
  br i1 %70, label %.lr.ph2, label %._crit_edge3.loopexit, !llvm.loop !10

._crit_edge3.loopexit:                            ; preds = %65
