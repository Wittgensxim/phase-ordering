...
40:                                               ; preds = %30
  ...
  %43 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %41, i32 noundef %42)
  %44 = load ptr, ptr @PtrGlb, align 8
  %45 = call i32 @Proc1(ptr noundef %44)
  br label %46

46:                                               ; preds = %56, %40
  %.014 = phi i8 [ 65, %40 ], [ %57, %56 ]
  %47 = load i8, ptr @Char2Glob, align 1
  %.not15 = icmp sgt i8 %.014, %47
...
21:                                               ; preds = %20
  br i1 poison, label %22, label %23
