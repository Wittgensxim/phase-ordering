...
34:                                               ; preds = %._crit_edge, %20
  ...
  %.not25 = icmp sgt i8 65, %39
  br i1 %.not25, label %50, label %.lr.ph8

.lr.ph8:                                          ; preds = %34
  br label %40

40:                                               ; preds = %.lr.ph8, %47
  %.016 = phi i8 [ 65, %.lr.ph8 ], [ %48, %47 ]
  %41 = load i32, ptr %3, align 4
  %42 = sext i8 %.016 to i32
...
47:                                               ; preds = %40, %45
  ...
  %.not2 = icmp sgt i8 %48, %49
  br i1 %.not2, label %._crit_edge9, label %40, !llvm.loop !10

._crit_edge9:                                     ; preds = %47
  br label %50

50:                                               ; preds = %._crit_edge9, %34
  %51 = load i32, ptr %1, align 4
  %52 = mul nsw i32 %51, 3
  store i32 %52, ptr %2, align 4
  %53 = call i32 @Proc2(ptr noundef nonnull %1)
  %54 = add nuw nsw i32 %.110, 1
...
14:                                               ; preds = %3
  %15 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #5
