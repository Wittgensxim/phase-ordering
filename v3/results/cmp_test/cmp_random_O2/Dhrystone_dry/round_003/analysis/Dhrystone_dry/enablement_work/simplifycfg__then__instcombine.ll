...
21:                                               ; preds = %._crit_edge3, %11
  %22 = phi i32 [ 0, %11 ], [ %55, %._crit_edge3 ]
  %23 = call i32 @Proc5()
  %24 = call i32 @Proc4()
...
.lr.ph2:                                          ; preds = %._crit_edge, %48
  %41 = phi i32 [ %50, %48 ], [ 65, %._crit_edge ]
  %42 = phi i8 [ %49, %48 ], [ 65, %._crit_edge ]
...
48:                                               ; preds = %46, %.lr.ph2
  ...
  br i1 %.not1, label %._crit_edge3, label %.lr.ph2, !llvm.loop !10

._crit_edge3:                                     ; preds = %48, %._crit_edge
  %52 = load i32, ptr %1, align 4
  %53 = mul nsw i32 %52, 3
  store i32 %53, ptr %2, align 4
  %54 = call i32 @Proc2(ptr noundef nonnull %1)
  %55 = add nuw nsw i32 %22, 1
  %56 = icmp samesign ult i32 %22, 99999999
  br i1 %56, label %21, label %57, !llvm.loop !11
...
22:                                               ; preds = %17, %4
  ...
  %31 = getelementptr [204 x i8], ptr %1, i64 %30
  %32 = getelementptr i8, ptr %31, i64 5100
  %33 = getelementptr inbounds [4 x i8], ptr %32, i64 %6
...
3:                                                ; preds = %3, %2
  ...
  %17 = icmp slt i32 %spec.select, 2
  br i1 %17, label %3, label %18, !llvm.loop !12

18:                                               ; preds = %3
  %19 = icmp eq i8 %spec.select1, 88
...
23:                                               ; preds = %20, %18
  %24 = phi i32 [ 1, %18 ], [ %spec.select3, %20 ]
  ret i32 %24
}
