...
7:                                                ; preds = %0
  ...
  %12 = load ptr, ptr @PtrGlb, align 8
  %13 = getelementptr inbounds nuw %struct.Record, ptr %12, i32 0, i32 1
  store i32 0, ptr %13, align 8
  %14 = getelementptr inbounds nuw %struct.Record, ptr %12, i32 0, i32 2
  store i32 10001, ptr %14, align 4
  %15 = getelementptr inbounds nuw %struct.Record, ptr %12, i32 0, i32 3
  store i32 40, ptr %15, align 8
  %16 = getelementptr inbounds nuw %struct.Record, ptr %12, i32 0, i32 4
  %17 = call ptr @strcpy(ptr noundef %16, ptr noundef @.str) #5
  %18 = call ptr @strcpy(ptr noundef %4, ptr noundef @.str.1) #5
  store i32 10, ptr getelementptr inbounds nuw (i8, ptr @Array2Glob, i64 1660), align 4
  %19 = call i32 @clock()
  br label %20

20:                                               ; preds = %60, %7
  %21 = phi i32 [ 0, %7 ], [ %67, %60 ]
  %22 = call i32 @Proc5()
  %23 = call i32 @Proc4()
  store i32 2, ptr %1, align 4
  %24 = call ptr @strcpy(ptr noundef %5, ptr noundef @.str.2) #5
  store i32 10000, ptr %3, align 4
  %25 = call i32 @Func2(ptr noundef %4, ptr noundef %5)
  %26 = icmp ne i32 %25, 0
  %27 = xor i1 %26, true
  %28 = zext i1 %27 to i32
  store i32 %28, ptr @BoolGlob, align 4
  %.pre = load i32, ptr %1, align 4
  %29 = icmp slt i32 %.pre, 3
...
30:                                               ; preds = %30, %.lr.ph
  %31 = phi i32 [ %.pre, %.lr.ph ], [ %36, %30 ]
  %32 = mul nsw i32 5, %31
  %33 = sub nsw i32 %32, 3
  store i32 %33, ptr %2, align 4
  %34 = call i32 @Proc7(i32 noundef %31, i32 noundef 3, ptr noundef %2)
...
38:                                               ; preds = %._crit_edge, %20
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %20 ]
  %39 = load i32, ptr %2, align 4
  %40 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %.lcssa, i32 noundef %39)
  %41 = load ptr, ptr @PtrGlb, align 8
  %42 = call i32 @Proc1(ptr noundef %41)
  %43 = load i8, ptr @Char2Glob, align 1
  %44 = sext i8 %43 to i32
  %45 = icmp sle i32 65, %44
  br i1 %45, label %.lr.ph2, label %60

.lr.ph2:                                          ; preds = %38
  br label %46

46:                                               ; preds = %54, %.lr.ph2
  %47 = phi i32 [ 65, %.lr.ph2 ], [ %56, %54 ]
  %48 = phi i8 [ 65, %.lr.ph2 ], [ %55, %54 ]
  %49 = load i32, ptr %3, align 4
  %50 = call i32 @Func1(i32 noundef %47, i32 noundef 67)
...
54:                                               ; preds = %52, %46
  ...
  br i1 %59, label %46, label %._crit_edge3, !llvm.loop !9
...
60:                                               ; preds = %._crit_edge3, %38
  ...
  %exitcond = icmp ne i32 %67, 100000000
  br i1 %exitcond, label %20, label %68, !llvm.loop !10
...
25:                                               ; preds = %20, %14
  %26 = getelementptr inbounds [51 x i32], ptr %1, i64 %6
  %27 = sub nsw i32 %5, 1
  %28 = sext i32 %27 to i64
  %29 = getelementptr inbounds [51 x i32], ptr %26, i64 0, i64 %28
  ...
  %35 = getelementptr inbounds [51 x i32], ptr %1, i64 %34
  %36 = getelementptr inbounds [51 x i32], ptr %35, i64 0, i64 %6
...
18:                                               ; preds = %17, %3
  ...
  br i1 %21, label %3, label %22, !llvm.loop !11
...
27:                                               ; preds = %26, %22
  %28 = phi i32 [ 7, %26 ], [ %.lcssa1, %22 ]
  %29 = icmp eq i32 %23, 88
