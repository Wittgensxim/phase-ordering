...
._crit_edge:                                      ; preds = %34
  %.lcssa1 = phi i32 [ %40, %34 ]
  br label %42

42:                                               ; preds = %._crit_edge, %24
  %.lcssa = phi i32 [ %.lcssa1, %._crit_edge ], [ %.pre, %24 ]
...
64:                                               ; preds = %._crit_edge3, %42
  ...
  br i1 %71, label %24, label %72, !llvm.loop !11
...
19:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [51 x i32], ptr %15, i64 0, i64 %20
...
22:                                               ; preds = %19, %14
  ...
  %25 = getelementptr inbounds [51 x i32], ptr %15, i64 0, i64 %24
