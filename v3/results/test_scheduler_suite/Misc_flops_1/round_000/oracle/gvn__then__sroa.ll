...
7:                                                ; preds = %12, %0
  %8 = phi double [ %13, %12 ], [ 0.000000e+00, %0 ]
  %9 = phi double [ %26, %12 ], [ 0.000000e+00, %0 ]
  %10 = phi i32 [ %27, %12 ], [ 1, %0 ]
  %11 = icmp sle i32 %10, 312499999
...
12:                                               ; preds = %7
  ...
  %18 = call double @llvm.fmuladd.f64(double %14, double %17, double %16)
  %19 = call double @llvm.fmuladd.f64(double %14, double %18, double %15)
  %20 = load double, ptr @E2, align 8
  %21 = load double, ptr @E3, align 8
  %22 = call double @llvm.fmuladd.f64(double %14, double %21, double %20)
  %23 = call double @llvm.fmuladd.f64(double %14, double %22, double %15)
  %24 = call double @llvm.fmuladd.f64(double %14, double %23, double %5)
...
28:                                               ; preds = %7
  ...
  store double %29, ptr @sb, align 8
  %40 = fadd double %39, %29
  %41 = load double, ptr @two, align 8
  %42 = call double @llvm.fmuladd.f64(double %41, double %9, double %40)
  %43 = fmul double %6, %42
  ...
  %47 = mul nsw i32 40000, %46
  %48 = sitofp i32 %47 to double
  %49 = load double, ptr @scale, align 8
  %50 = fdiv double %48, %49
  %51 = fptosi double %50 to i32
  %52 = fsub double %45, 2.520000e+01
