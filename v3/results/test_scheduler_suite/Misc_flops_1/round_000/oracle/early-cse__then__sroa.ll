...
12:                                               ; preds = %30, %0
  %.012 = phi double [ 0.000000e+00, %0 ], [ %16, %30 ]
  %.011 = phi double [ 0.000000e+00, %0 ], [ %29, %30 ]
  %.0 = phi i32 [ 1, %0 ], [ %31, %30 ]
  %13 = sub nsw i32 %7, 1
...
32:                                               ; preds = %12
  ...
  %49 = call double @llvm.fmuladd.f64(double %48, double %.011, double %47)
