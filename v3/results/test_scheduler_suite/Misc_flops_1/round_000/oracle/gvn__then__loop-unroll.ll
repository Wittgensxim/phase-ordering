...
18:                                               ; preds = %23, %0
  %19 = phi double [ %24, %23 ], [ 0.000000e+00, %0 ]
  %20 = phi double [ %37, %23 ], [ 0.000000e+00, %0 ]
  %21 = phi i32 [ %38, %23 ], [ 1, %0 ]
  %22 = icmp sle i32 %21, 312499999
  br i1 %22, label %23, label %39

23:                                               ; preds = %18
  %24 = fadd double %19, %16
  ...
  %35 = call double @llvm.fmuladd.f64(double %25, double %34, double %16)
...
39:                                               ; preds = %18
  ...
  %53 = call double @llvm.fmuladd.f64(double %52, double %.lcssa, double %51)
  ...
  %58 = mul nsw i32 40000, %57
  %59 = sitofp i32 %58 to double
  %60 = load double, ptr @scale, align 8
  %61 = fdiv double %59, %60
  %62 = fptosi double %61 to i32
  store i32 %62, ptr %11, align 4
  %63 = fsub double %56, 2.520000e+01
