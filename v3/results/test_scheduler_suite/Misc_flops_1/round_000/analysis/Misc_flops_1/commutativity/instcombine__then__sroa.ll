...
6:                                                ; preds = %23, %0
  %.012 = phi double [ 0.000000e+00, %0 ], [ %8, %23 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %22, %23 ]
  %storemerge = phi i32 [ 1, %0 ], [ %24, %23 ]
  %.not.not = icmp slt i32 %storemerge, %2
  br i1 %.not.not, label %7, label %25
...
7:                                                ; preds = %6
  ...
  %13 = call double @llvm.fmuladd.f64(double %9, double %12, double %11)
  %14 = call double @llvm.fmuladd.f64(double %9, double %13, double %10)
  %15 = load double, ptr @D1, align 8
  %16 = load double, ptr @E2, align 8
  %17 = load double, ptr @E3, align 8
  %18 = call double @llvm.fmuladd.f64(double %9, double %17, double %16)
  %19 = call double @llvm.fmuladd.f64(double %9, double %18, double %15)
  %20 = call double @llvm.fmuladd.f64(double %9, double %19, double %3)
...
25:                                               ; preds = %6
  ...
  %41 = call double @llvm.fmuladd.f64(double %40, double %.0, double %39)
  %42 = fmul double %5, %41
