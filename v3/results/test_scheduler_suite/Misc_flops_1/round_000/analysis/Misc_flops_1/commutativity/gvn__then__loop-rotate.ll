...
18:                                               ; preds = %0, %18
  %19 = phi i32 [ 1, %0 ], [ %36, %18 ]
  %20 = phi double [ 0.000000e+00, %0 ], [ %35, %18 ]
  ...
  %33 = call double @llvm.fmuladd.f64(double %23, double %32, double %16)
...
38:                                               ; preds = %18
  ...
  %52 = call double @llvm.fmuladd.f64(double %51, double %.lcssa, double %50)
  %53 = fmul double %17, %52
  %54 = fdiv double %53, %51
  store double %54, ptr @sa, align 8
  %55 = fdiv double %16, %54
