...
15:                                               ; preds = %37, %0
  ...
  br i1 %.not.not, label %17, label %40
...
17:                                               ; preds = %15
  ...
  %32 = call double @llvm.fmuladd.f64(double %22, double %31, double %30)
  %33 = call double @llvm.fmuladd.f64(double %22, double %32, double %24)
  %34 = call double @llvm.fmuladd.f64(double %22, double %33, double %29)
...
40:                                               ; preds = %15
  ...
  %70 = fadd double %69, -2.520000e+01
