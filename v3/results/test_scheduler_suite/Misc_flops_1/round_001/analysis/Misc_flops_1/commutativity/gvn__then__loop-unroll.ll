...
3:                                                ; preds = %8, %0
  %4 = phi double [ %9, %8 ], [ 0.000000e+00, %0 ]
  %5 = phi double [ %22, %8 ], [ 0.000000e+00, %0 ]
  %6 = phi i32 [ %23, %8 ], [ 1, %0 ]
  %7 = icmp samesign ult i32 %6, 312500000
...
8:                                                ; preds = %3
  ...
  %20 = call double @llvm.fmuladd.f64(double %10, double %19, double %1)
...
24:                                               ; preds = %3
  ...
  %38 = call double @llvm.fmuladd.f64(double %37, double %.lcssa, double %36)
  %39 = fmul double %2, %38
