...
20:                                               ; preds = %0, %20
  %21 = phi i32 [ 1, %0 ], [ %54, %20 ]
  %22 = phi double [ 0.000000e+00, %0 ], [ %53, %20 ]
  ...
  %52 = fdiv double %39, %51
  %53 = fadd double %22, %52
  store double %53, ptr %2, align 8
  %54 = add nsw i32 %21, 1
  store i32 %54, ptr %9, align 4
  %55 = icmp sle i32 %54, 156249999
  br i1 %55, label %20, label %56, !llvm.loop !7

56:                                               ; preds = %20
  %.lcssa = phi double [ %53, %20 ]
  %57 = fdiv double %16, %17
  ...
  %87 = call double @llvm.fmuladd.f64(double %86, double %.lcssa, double %85)
