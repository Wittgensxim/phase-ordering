...
43:                                               ; preds = %._crit_edge1, %._crit_edge
  ...
  %46 = phi double [ %.pre26, %._crit_edge1 ], [ %.pre13, %._crit_edge ]
  %47 = phi double [ %.pre25, %._crit_edge1 ], [ %.pre12, %._crit_edge ]
  %48 = phi double [ %.pre24, %._crit_edge1 ], [ %.pre11, %._crit_edge ]
  %49 = phi double [ %.pre23, %._crit_edge1 ], [ %.pre10, %._crit_edge ]
  %50 = phi double [ %.pre22, %._crit_edge1 ], [ %.pre9, %._crit_edge ]
  %51 = phi double [ %.pre21, %._crit_edge1 ], [ %.pre8, %._crit_edge ]
  %52 = phi double [ %.pre20, %._crit_edge1 ], [ %.pre7, %._crit_edge ]
  %53 = phi double [ %.pre19, %._crit_edge1 ], [ %.pre6, %._crit_edge ]
  %54 = phi double [ %.pre18, %._crit_edge1 ], [ %.pre5, %._crit_edge ]
  %55 = phi double [ %.pre17, %._crit_edge1 ], [ %.pre4, %._crit_edge ]
  %56 = phi double [ %.pre16, %._crit_edge1 ], [ %.pre3, %._crit_edge ]
  %57 = phi double [ %.pre15, %._crit_edge1 ], [ %.pre2, %._crit_edge ]
  %58 = phi double [ %.pre14, %._crit_edge1 ], [ %.pre, %._crit_edge ]
  ...
  %76 = call double @llvm.fmuladd.f64(double %75, double %44, double %74)
  %77 = fmul double %19, %76
  %78 = fdiv double %77, %75
  store double %78, ptr @sa, align 8
  store double f0x3FE62E42FEFA39EF, ptr @sb, align 8
  %79 = fsub double %78, f0x3FE62E42FEFA39EF
  store double %79, ptr @sc, align 8
  %80 = fmul double %79, 1.000000e-30
  %81 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %80, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
