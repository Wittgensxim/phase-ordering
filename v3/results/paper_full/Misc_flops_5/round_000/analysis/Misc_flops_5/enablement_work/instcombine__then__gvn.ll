...
11:                                               ; preds = %14, %0
  %12 = phi double [ 0.000000e+00, %0 ], [ %45, %14 ]
  %13 = phi i32 [ 1, %0 ], [ %46, %14 ]
...
47:                                               ; preds = %11
  ...
  %75 = call double @llvm.fmuladd.f64(double %49, double %74, double %61)
  store double %75, ptr @sb, align 8
  %76 = fdiv double %63, %75
  store double %76, ptr @sa, align 8
  %77 = load double, ptr @two, align 8
  %78 = call double @llvm.fmuladd.f64(double %77, double %12, double %76)
