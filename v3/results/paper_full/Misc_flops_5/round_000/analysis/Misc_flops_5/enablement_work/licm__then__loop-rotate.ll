...
43:                                               ; preds = %.lr.ph, %64
  %44 = phi i32 [ %.promoted, %.lr.ph ], [ %65, %64 ]
  %45 = phi double [ %.promoted7, %.lr.ph ], [ %63, %64 ]
...
64:                                               ; preds = %43
  ...
  br i1 %66, label %43, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %64
  %split = phi double [ %63, %64 ]
  %split9 = phi double [ %55, %64 ]
  %split10 = phi double [ %48, %64 ]
  %split11 = phi double [ %47, %64 ]
  %split12 = phi i32 [ %65, %64 ]
  br label %67
...
67:                                               ; preds = %._crit_edge, %0
  ...
  %100 = load double, ptr @B6, align 8
  %101 = load double, ptr %5, align 8
  %102 = load double, ptr @B5, align 8
  %103 = call double @llvm.fmuladd.f64(double %100, double %101, double %102)
  %104 = load double, ptr @B4, align 8
  %105 = call double @llvm.fmuladd.f64(double %99, double %103, double %104)
  %106 = load double, ptr @B3, align 8
  %107 = call double @llvm.fmuladd.f64(double %98, double %105, double %106)
  %108 = load double, ptr @B2, align 8
  %109 = call double @llvm.fmuladd.f64(double %97, double %107, double %108)
  %110 = load double, ptr @B1, align 8
  %111 = call double @llvm.fmuladd.f64(double %96, double %109, double %110)
  %112 = load double, ptr @one, align 8
  %113 = call double @llvm.fmuladd.f64(double %95, double %111, double %112)
  ...
  %130 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %129, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
