...
10:                                               ; preds = %45, %0
  %.040 = phi i32 [ 1, %0 ], [ %46, %45 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %44, %45 ]
...
47:                                               ; preds = %10
  ...
  %49 = load double, ptr @three, align 8
  %50 = fdiv double %48, %49
  %51 = fmul double %50, %50
  %52 = load double, ptr @A6, align 8
  %53 = load double, ptr @A5, align 8
  %54 = call double @llvm.fmuladd.f64(double %52, double %51, double %53)
  %55 = load double, ptr @A4, align 8
  %56 = call double @llvm.fmuladd.f64(double %54, double %51, double %55)
  %57 = load double, ptr @A3, align 8
  %58 = call double @llvm.fmuladd.f64(double %56, double %51, double %57)
  %59 = load double, ptr @A2, align 8
  %60 = call double @llvm.fmuladd.f64(double %58, double %51, double %59)
  %61 = load double, ptr @A1, align 8
  %62 = call double @llvm.fmuladd.f64(double %60, double %51, double %61)
  %63 = load double, ptr @one, align 8
  %64 = call double @llvm.fmuladd.f64(double %62, double %51, double %63)
  %65 = fmul double %50, %64
  store double %65, ptr @sa, align 8
  %66 = load double, ptr @B6, align 8
  %67 = load double, ptr @B5, align 8
  %68 = call double @llvm.fmuladd.f64(double %66, double %51, double %67)
  %69 = load double, ptr @B4, align 8
  %70 = call double @llvm.fmuladd.f64(double %51, double %68, double %69)
  %71 = load double, ptr @B3, align 8
  %72 = call double @llvm.fmuladd.f64(double %51, double %70, double %71)
  %73 = load double, ptr @B2, align 8
  %74 = call double @llvm.fmuladd.f64(double %51, double %72, double %73)
  %75 = load double, ptr @B1, align 8
  %76 = call double @llvm.fmuladd.f64(double %51, double %74, double %75)
  %77 = load double, ptr @one, align 8
  %78 = call double @llvm.fmuladd.f64(double %51, double %76, double %77)
  ...
  %84 = call double @llvm.fmuladd.f64(double %83, double %.0, double %82)
  %85 = fmul double %9, %84
