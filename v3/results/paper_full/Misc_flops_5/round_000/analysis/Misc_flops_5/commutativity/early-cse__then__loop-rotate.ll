...
72:                                               ; preds = %._crit_edge, %0
  ...
  %111 = call double @llvm.fmuladd.f64(double %109, double %110, double %107)
  %112 = fmul double %108, %111
  %113 = fdiv double %112, %109
  store double %113, ptr @sa, align 8
  store double f0x3FE62E42FEFA39EF, ptr @sb, align 8
  %114 = load double, ptr @sa, align 8
  %115 = fsub double %114, f0x3FE62E42FEFA39EF
  store double %115, ptr @sc, align 8
  %116 = fmul double %115, 1.000000e-30
  %117 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %116, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
