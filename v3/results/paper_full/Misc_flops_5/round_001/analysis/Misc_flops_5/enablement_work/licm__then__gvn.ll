...
42:                                               ; preds = %18
  ...
  %45 = call double @llvm.fmuladd.f64(double %5, double %44, double %6)
  %46 = call double @llvm.fmuladd.f64(double %45, double %44, double %7)
  %47 = call double @llvm.fmuladd.f64(double %46, double %44, double %8)
  %48 = call double @llvm.fmuladd.f64(double %47, double %44, double %9)
  %49 = call double @llvm.fmuladd.f64(double %48, double %44, double %10)
  %50 = call double @llvm.fmuladd.f64(double %49, double %44, double %11)
  %51 = fmul double %43, %50
  store double %51, ptr @sa, align 8
  %52 = call double @llvm.fmuladd.f64(double %12, double %44, double %13)
  %53 = call double @llvm.fmuladd.f64(double %44, double %52, double %14)
  %54 = call double @llvm.fmuladd.f64(double %44, double %53, double %15)
  %55 = call double @llvm.fmuladd.f64(double %44, double %54, double %16)
  %56 = call double @llvm.fmuladd.f64(double %44, double %55, double %17)
  ...
  %60 = call double @llvm.fmuladd.f64(double %59, double %19, double %58)
  %61 = fmul double %4, %60
  %62 = fdiv double %61, %59
  store double %62, ptr @sa, align 8
  store double f0x3FE62E42FEFA39EF, ptr @sb, align 8
  %63 = fadd double %62, f0xBFE62E42FEFA39EF
  store double %63, ptr @sc, align 8
  %64 = fmul double %63, 1.000000e-30
  %65 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %64, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
