...
97:                                               ; preds = %101, %55
  ...
  %exitcond19 = icmp eq i32 %100, %96
  br i1 %exitcond19, label %105, label %101
...
112:                                              ; preds = %111, %105
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %84, i32 0)
...
118:                                              ; preds = %126, %112
  ...
  %exitcond21 = icmp eq i32 %125, %117
  br i1 %exitcond21, label %136, label %126
...
136:                                              ; preds = %118
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %148, i32 1)
  br label %182
...
182:                                              ; preds = %186, %136
  ...
  %exitcond23 = icmp ne i32 %185, %smax22
  br i1 %exitcond23, label %186, label %198
...
252:                                              ; preds = %255, %198
  ...
  %exitcond24 = icmp ne i32 %254, %smax22
  br i1 %exitcond24, label %255, label %267
...
335:                                              ; preds = %338, %267
  ...
  %exitcond25 = icmp ne i32 %337, %smax22
  br i1 %exitcond25, label %338, label %358
...
425:                                              ; preds = %428, %358
  ...
  %exitcond26 = icmp ne i32 %427, %smax22
  br i1 %exitcond26, label %428, label %447
...
499:                                              ; preds = %502, %447
  ...
  %exitcond27 = icmp ne i32 %501, %smax22
  br i1 %exitcond27, label %502, label %516
...
516:                                              ; preds = %499
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %545, i32 1)
  br label %572

572:                                              ; preds = %575, %516
  %573 = phi double [ %593, %575 ], [ 0.000000e+00, %516 ]
  %574 = phi i32 [ %594, %575 ], [ 1, %516 ]
  %exitcond29 = icmp ne i32 %574, %smax28
  br i1 %exitcond29, label %575, label %595
