...
42:                                               ; preds = %.loopexit, %40
  ...
  %45 = phi i32 [ 512000000, %40 ], [ %.lcssa26, %.loopexit ]
...
119:                                              ; preds = %127, %114
  %120 = phi double [ %129, %127 ], [ %sa.promoted33, %114 ]
  %121 = phi double [ %135, %127 ], [ 0.000000e+00, %114 ]
  %122 = phi double [ %130, %127 ], [ %116, %114 ]
  %123 = phi double [ %128, %127 ], [ %.lcssa24, %114 ]
...
137:                                              ; preds = %119
  %.lcssa23 = phi double [ %121, %119 ]
  %.lcssa22 = phi double [ %124, %119 ]
  %.lcssa21 = phi double [ %125, %119 ]
...
199:                                              ; preds = %183
  ...
  %228 = call double @llvm.fmuladd.f64(double %227, double %.lcssa20, double %225)
...
268:                                              ; preds = %253
  ...
  %295 = call double @llvm.fmuladd.f64(double %294, double %.lcssa19, double %293)
...
359:                                              ; preds = %336
  ...
  %399 = call double @llvm.fmuladd.f64(double %398, double %.lcssa18, double %396)
...
448:                                              ; preds = %426
  ...
  %488 = call double @llvm.fmuladd.f64(double %487, double %.lcssa17, double %485)
...
517:                                              ; preds = %500
  ...
  %539 = call double @llvm.fmuladd.f64(double %538, double %.lcssa16, double %536)
...
596:                                              ; preds = %573
  ...
  %637 = call double @llvm.fmuladd.f64(double %636, double %.lcssa, double %634)
