...
.lr.ph:                                           ; preds = %.lr.ph20, %.lr.ph
  %18 = phi i32 [ %35, %.lr.ph ], [ 1, %.lr.ph20 ]
  %19 = phi double [ %34, %.lr.ph ], [ 0.000000e+00, %.lr.ph20 ]
  %20 = phi double [ %21, %.lr.ph ], [ 0.000000e+00, %.lr.ph20 ]
  ...
  %32 = call double @llvm.fmuladd.f64(double %22, double %31, double %14)
...
.lr.ph26:                                         ; preds = %46, %.lr.ph26
  ...
  %93 = phi double [ %94, %.lr.ph26 ], [ %88, %46 ]
  %94 = fneg double %93
...
._crit_edge27:                                    ; preds = %.lr.ph26, %46
  %.lcssa9 = phi double [ %88, %46 ], [ %94, %.lr.ph26 ]
...
.lr.ph31:                                         ; preds = %._crit_edge27, %.lr.ph31
  %106 = phi i32 [ %122, %.lr.ph31 ], [ 1, %._crit_edge27 ]
  %107 = phi double [ %118, %.lr.ph31 ], [ 0.000000e+00, %._crit_edge27 ]
  %108 = phi double [ %119, %.lr.ph31 ], [ 0.000000e+00, %._crit_edge27 ]
  %109 = phi double [ %112, %.lr.ph31 ], [ %.lcssa9, %._crit_edge27 ]
  %110 = phi double [ %116, %.lr.ph31 ], [ %104, %._crit_edge27 ]
  %111 = phi double [ %121, %.lr.ph31 ], [ 0.000000e+00, %._crit_edge27 ]
  %112 = fneg double %109
  ...
  %119 = call double @llvm.fmuladd.f64(double %109, double %116, double %108)
...
.lr.ph38:                                         ; preds = %._crit_edge32, %.lr.ph38
  %159 = phi i32 [ %181, %.lr.ph38 ], [ 1, %._crit_edge32 ]
  %160 = phi double [ %180, %.lr.ph38 ], [ 0.000000e+00, %._crit_edge32 ]
  %161 = phi double [ %163, %.lr.ph38 ], [ 0.000000e+00, %._crit_edge32 ]
  %162 = load double, ptr @one, align 8
  %163 = fadd double %161, %162
  %164 = fmul double %163, %157
  %165 = fmul double %164, %164
  %166 = load double, ptr @A6, align 8
  %167 = load double, ptr @A5, align 8
  %168 = fneg double %167
  %169 = call double @llvm.fmuladd.f64(double %166, double %165, double %168)
  %170 = load double, ptr @A4, align 8
  %171 = call double @llvm.fmuladd.f64(double %169, double %165, double %170)
  %172 = load double, ptr @A3, align 8
  %173 = fneg double %172
  %174 = call double @llvm.fmuladd.f64(double %171, double %165, double %173)
  %175 = load double, ptr @A2, align 8
  %176 = call double @llvm.fmuladd.f64(double %174, double %165, double %175)
  %177 = load double, ptr @A1, align 8
  %178 = call double @llvm.fmuladd.f64(double %176, double %165, double %177)
  %179 = call double @llvm.fmuladd.f64(double %178, double %165, double %162)
  %180 = call double @llvm.fmuladd.f64(double %164, double %179, double %160)
  %181 = add nuw nsw i32 %159, 1
...
.lr.ph43:                                         ; preds = %._crit_edge39, %.lr.ph43
  %228 = phi i32 [ %247, %.lr.ph43 ], [ 1, %._crit_edge39 ]
  %229 = phi double [ %246, %.lr.ph43 ], [ 0.000000e+00, %._crit_edge39 ]
  %230 = uitofp nneg i32 %228 to double
  %231 = fmul double %226, %230
  %232 = fmul double %231, %231
  %233 = load double, ptr @B6, align 8
  %234 = load double, ptr @B5, align 8
  %235 = call double @llvm.fmuladd.f64(double %233, double %232, double %234)
  %236 = load double, ptr @B4, align 8
  %237 = call double @llvm.fmuladd.f64(double %232, double %235, double %236)
  %238 = load double, ptr @B3, align 8
  %239 = call double @llvm.fmuladd.f64(double %232, double %237, double %238)
  %240 = load double, ptr @B2, align 8
  %241 = call double @llvm.fmuladd.f64(double %232, double %239, double %240)
  %242 = load double, ptr @B1, align 8
  %243 = call double @llvm.fmuladd.f64(double %232, double %241, double %242)
  %244 = call double @llvm.fmuladd.f64(double %232, double %243, double %229)
  %245 = load double, ptr @one, align 8
  %246 = fadd double %244, %245
  %247 = add nuw nsw i32 %228, 1
...
.lr.ph48:                                         ; preds = %._crit_edge44, %.lr.ph48
  %302 = phi i32 [ %335, %.lr.ph48 ], [ 1, %._crit_edge44 ]
  %303 = phi double [ %334, %.lr.ph48 ], [ 0.000000e+00, %._crit_edge44 ]
  %304 = uitofp nneg i32 %302 to double
  ...
  %323 = call double @llvm.fmuladd.f64(double %321, double %306, double %322)
  %324 = load double, ptr @B4, align 8
  %325 = call double @llvm.fmuladd.f64(double %306, double %323, double %324)
  %326 = load double, ptr @B3, align 8
  %327 = call double @llvm.fmuladd.f64(double %306, double %325, double %326)
  %328 = load double, ptr @B2, align 8
  %329 = call double @llvm.fmuladd.f64(double %306, double %327, double %328)
  %330 = load double, ptr @B1, align 8
  %331 = call double @llvm.fmuladd.f64(double %306, double %329, double %330)
  %332 = call double @llvm.fmuladd.f64(double %306, double %331, double %318)
  %333 = fdiv double %320, %332
  %334 = fadd double %303, %333
  %335 = add nuw nsw i32 %302, 1
...
.lr.ph53:                                         ; preds = %._crit_edge49, %.lr.ph53
  %389 = phi i32 [ %421, %.lr.ph53 ], [ 1, %._crit_edge49 ]
  %390 = phi double [ %420, %.lr.ph53 ], [ 0.000000e+00, %._crit_edge49 ]
  %391 = uitofp nneg i32 %389 to double
  %392 = fmul double %387, %391
  %393 = fmul double %392, %392
  %394 = load double, ptr @A6, align 8
  %395 = load double, ptr @A5, align 8
  %396 = call double @llvm.fmuladd.f64(double %394, double %393, double %395)
  %397 = load double, ptr @A4, align 8
  %398 = call double @llvm.fmuladd.f64(double %396, double %393, double %397)
  %399 = load double, ptr @A3, align 8
  %400 = call double @llvm.fmuladd.f64(double %398, double %393, double %399)
  %401 = load double, ptr @A2, align 8
  %402 = call double @llvm.fmuladd.f64(double %400, double %393, double %401)
  %403 = load double, ptr @A1, align 8
  %404 = call double @llvm.fmuladd.f64(double %402, double %393, double %403)
  %405 = load double, ptr @one, align 8
  %406 = call double @llvm.fmuladd.f64(double %404, double %393, double %405)
  %407 = fmul double %392, %406
  %408 = load double, ptr @B6, align 8
  %409 = load double, ptr @B5, align 8
  %410 = call double @llvm.fmuladd.f64(double %408, double %393, double %409)
  %411 = load double, ptr @B4, align 8
  %412 = call double @llvm.fmuladd.f64(double %393, double %410, double %411)
  %413 = load double, ptr @B3, align 8
  %414 = call double @llvm.fmuladd.f64(double %393, double %412, double %413)
  %415 = load double, ptr @B2, align 8
  %416 = call double @llvm.fmuladd.f64(double %393, double %414, double %415)
  %417 = load double, ptr @B1, align 8
  %418 = call double @llvm.fmuladd.f64(double %393, double %416, double %417)
  %419 = call double @llvm.fmuladd.f64(double %393, double %418, double %405)
  %420 = call double @llvm.fmuladd.f64(double %407, double %419, double %390)
  %421 = add nuw nsw i32 %389, 1
...
.lr.ph63:                                         ; preds = %._crit_edge59, %.lr.ph63
  %530 = phi i32 [ %563, %.lr.ph63 ], [ 1, %._crit_edge59 ]
  %531 = phi double [ %562, %.lr.ph63 ], [ 0.000000e+00, %._crit_edge59 ]
  %532 = uitofp nneg i32 %530 to double
  %533 = fmul double %528, %532
  %534 = fmul double %533, %533
  %535 = load double, ptr @B6, align 8
  %536 = load double, ptr @B5, align 8
  %537 = call double @llvm.fmuladd.f64(double %535, double %534, double %536)
  %538 = load double, ptr @B4, align 8
  %539 = call double @llvm.fmuladd.f64(double %534, double %537, double %538)
  %540 = load double, ptr @B3, align 8
  %541 = call double @llvm.fmuladd.f64(double %534, double %539, double %540)
  %542 = load double, ptr @B2, align 8
  %543 = call double @llvm.fmuladd.f64(double %534, double %541, double %542)
  %544 = load double, ptr @B1, align 8
  %545 = call double @llvm.fmuladd.f64(double %534, double %543, double %544)
  %546 = load double, ptr @one, align 8
  %547 = call double @llvm.fmuladd.f64(double %534, double %545, double %546)
  %548 = fmul double %547, %547
  %549 = fmul double %548, %533
  %550 = load double, ptr @A6, align 8
  %551 = load double, ptr @A5, align 8
  %552 = call double @llvm.fmuladd.f64(double %550, double %534, double %551)
  %553 = load double, ptr @A4, align 8
  %554 = call double @llvm.fmuladd.f64(double %552, double %534, double %553)
  %555 = load double, ptr @A3, align 8
  %556 = call double @llvm.fmuladd.f64(double %554, double %534, double %555)
  %557 = load double, ptr @A2, align 8
  %558 = call double @llvm.fmuladd.f64(double %556, double %534, double %557)
  %559 = load double, ptr @A1, align 8
  %560 = call double @llvm.fmuladd.f64(double %558, double %534, double %559)
  %561 = call double @llvm.fmuladd.f64(double %560, double %534, double %546)
  %562 = call double @llvm.fmuladd.f64(double %549, double %561, double %531)
  %563 = add nuw nsw i32 %530, 1
