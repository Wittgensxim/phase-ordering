...
define dso_local i32 @main() #0 {
  ...
  br i1 %4, label %.lr.ph21, label %.loopexit
...
12:                                               ; preds = %.lr.ph21, %5
  ...
  %.not.not19 = icmp slt i32 1, %14
  br i1 %.not.not19, label %.lr.ph, label %38
...
..loopexit_crit_edge:                             ; preds = %5
  %split22 = phi double [ %6, %5 ]
  %split23 = phi double [ %7, %5 ]
  %split24 = phi i32 [ %8, %5 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %0
  %.lcssa15 = phi double [ %split22, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa13 = phi double [ %split23, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa11 = phi i32 [ %split24, %..loopexit_crit_edge ], [ 15625, %0 ]
  br label %43
...
58:                                               ; preds = %57, %51
  ...
  %.not25 = icmp sgt i32 1, %87
  br i1 %.not25, label %106, label %.lr.ph27

.lr.ph27:                                         ; preds = %58
  br label %99

99:                                               ; preds = %.lr.ph27, %99
  %100 = phi i32 [ 1, %.lr.ph27 ], [ %105, %99 ]
  %101 = phi double [ %95, %.lr.ph27 ], [ %103, %99 ]
  %102 = phi double [ %sa.promoted, %.lr.ph27 ], [ %104, %99 ]
  %103 = fneg double %101
  %104 = fsub double %102, %101
  store double %104, ptr @sa, align 8
  %105 = add nuw nsw i32 %100, 1
  %.not = icmp sgt i32 %105, %87
  br i1 %.not, label %._crit_edge28, label %99, !llvm.loop !11

._crit_edge28:                                    ; preds = %99
  %split29 = phi double [ %103, %99 ]
  br label %106

106:                                              ; preds = %._crit_edge28, %58
  %.lcssa9 = phi double [ %split29, %._crit_edge28 ], [ %95, %58 ]
...
113:                                              ; preds = %112, %106
  ...
  %.not430 = icmp sgt i32 1, %87
  br i1 %.not430, label %135, label %.lr.ph32

.lr.ph32:                                         ; preds = %113
  br label %118

118:                                              ; preds = %.lr.ph32, %118
  %119 = phi i32 [ 1, %.lr.ph32 ], [ %134, %118 ]
  %120 = phi double [ 0.000000e+00, %.lr.ph32 ], [ %130, %118 ]
  %121 = phi double [ 0.000000e+00, %.lr.ph32 ], [ %131, %118 ]
  %122 = phi double [ %.lcssa9, %.lr.ph32 ], [ %126, %118 ]
  %123 = phi double [ %115, %.lr.ph32 ], [ %128, %118 ]
  %124 = phi double [ 0.000000e+00, %.lr.ph32 ], [ %133, %118 ]
  %125 = phi double [ %sa.promoted18, %.lr.ph32 ], [ %127, %118 ]
  %126 = fneg double %122
  %127 = fsub double %125, %122
  store double %127, ptr @sa, align 8
  %128 = fadd double %123, %117
  %129 = fsub double %126, %128
  %130 = fadd double %120, %129
  %131 = call double @llvm.fmuladd.f64(double %122, double %128, double %121)
  %132 = fdiv double %122, %128
  %133 = fsub double %124, %132
  %134 = add nuw nsw i32 %119, 1
  %.not4 = icmp sgt i32 %134, %87
  br i1 %.not4, label %._crit_edge33, label %118, !llvm.loop !12

._crit_edge33:                                    ; preds = %118
  %split34 = phi double [ %133, %118 ]
  %split35 = phi double [ %131, %118 ]
  %split36 = phi double [ %130, %118 ]
  br label %135

135:                                              ; preds = %._crit_edge33, %113
  %.lcssa8 = phi double [ %split34, %._crit_edge33 ], [ 0.000000e+00, %113 ]
  %.lcssa7 = phi double [ %split35, %._crit_edge33 ], [ 0.000000e+00, %113 ]
  %.lcssa6 = phi double [ %split36, %._crit_edge33 ], [ 0.000000e+00, %113 ]
  ...
  %.not5.not37 = icmp slt i32 1, %147
  br i1 %.not5.not37, label %.lr.ph39, label %196

.lr.ph39:                                         ; preds = %135
  br label %181

181:                                              ; preds = %.lr.ph39, %181
  %182 = phi i32 [ 1, %.lr.ph39 ], [ %195, %181 ]
  %183 = phi double [ 0.000000e+00, %.lr.ph39 ], [ %194, %181 ]
  %184 = phi double [ 0.000000e+00, %.lr.ph39 ], [ %185, %181 ]
  ...
  br i1 %.not5.not, label %181, label %._crit_edge40, !llvm.loop !13

._crit_edge40:                                    ; preds = %181
  %split41 = phi double [ %194, %181 ]
  br label %196

196:                                              ; preds = %._crit_edge40, %135
  %.lcssa5 = phi double [ %split41, %._crit_edge40 ], [ 0.000000e+00, %135 ]
  ...
  %.not6.not42 = icmp slt i32 1, %147
  br i1 %.not6.not42, label %.lr.ph44, label %264

.lr.ph44:                                         ; preds = %196
  br label %250

250:                                              ; preds = %.lr.ph44, %250
  %251 = phi i32 [ 1, %.lr.ph44 ], [ %263, %250 ]
  %252 = phi double [ 0.000000e+00, %.lr.ph44 ], [ %262, %250 ]
  ...
  br i1 %.not6.not, label %250, label %._crit_edge45, !llvm.loop !14

._crit_edge45:                                    ; preds = %250
  %split46 = phi double [ %262, %250 ]
  br label %264

264:                                              ; preds = %._crit_edge45, %196
  %.lcssa4 = phi double [ %split46, %._crit_edge45 ], [ 0.000000e+00, %196 ]
  ...
  %.not7.not47 = icmp slt i32 1, %147
  br i1 %.not7.not47, label %.lr.ph49, label %354

.lr.ph49:                                         ; preds = %264
  br label %332

332:                                              ; preds = %.lr.ph49, %332
  %333 = phi i32 [ 1, %.lr.ph49 ], [ %353, %332 ]
  %334 = phi double [ 0.000000e+00, %.lr.ph49 ], [ %352, %332 ]
  ...
  br i1 %.not7.not, label %332, label %._crit_edge50, !llvm.loop !15

._crit_edge50:                                    ; preds = %332
  %split51 = phi double [ %352, %332 ]
  br label %354

354:                                              ; preds = %._crit_edge50, %264
  %.lcssa3 = phi double [ %split51, %._crit_edge50 ], [ 0.000000e+00, %264 ]
  ...
  %.not8.not52 = icmp slt i32 1, %147
  br i1 %.not8.not52, label %.lr.ph54, label %442

.lr.ph54:                                         ; preds = %354
  br label %421

421:                                              ; preds = %.lr.ph54, %421
  %422 = phi i32 [ 1, %.lr.ph54 ], [ %441, %421 ]
  %423 = phi double [ 0.000000e+00, %.lr.ph54 ], [ %440, %421 ]
  ...
  br i1 %.not8.not, label %421, label %._crit_edge55, !llvm.loop !16

._crit_edge55:                                    ; preds = %421
  %split56 = phi double [ %440, %421 ]
  br label %442

442:                                              ; preds = %._crit_edge55, %354
  %.lcssa2 = phi double [ %split56, %._crit_edge55 ], [ 0.000000e+00, %354 ]
  ...
  %.not9.not57 = icmp slt i32 1, %147
  br i1 %.not9.not57, label %.lr.ph59, label %510

.lr.ph59:                                         ; preds = %442
  br label %494

494:                                              ; preds = %.lr.ph59, %494
  %495 = phi i32 [ 1, %.lr.ph59 ], [ %509, %494 ]
  %496 = phi double [ 0.000000e+00, %.lr.ph59 ], [ %508, %494 ]
  ...
  br i1 %.not9.not, label %494, label %._crit_edge60, !llvm.loop !17

._crit_edge60:                                    ; preds = %494
  %split61 = phi double [ %508, %494 ]
  br label %510

510:                                              ; preds = %._crit_edge60, %442
  %.lcssa1 = phi double [ %split61, %._crit_edge60 ], [ 0.000000e+00, %442 ]
  ...
  %.not10.not62 = icmp slt i32 1, %539
  br i1 %.not10.not62, label %.lr.ph64, label %588

.lr.ph64:                                         ; preds = %510
  br label %566

566:                                              ; preds = %.lr.ph64, %566
  %567 = phi i32 [ 1, %.lr.ph64 ], [ %587, %566 ]
  %568 = phi double [ 0.000000e+00, %.lr.ph64 ], [ %586, %566 ]
  ...
  br i1 %.not10.not, label %566, label %._crit_edge65, !llvm.loop !18

._crit_edge65:                                    ; preds = %566
  %split66 = phi double [ %586, %566 ]
  br label %588

588:                                              ; preds = %._crit_edge65, %510
  %.lcssa = phi double [ %split66, %._crit_edge65 ], [ 0.000000e+00, %510 ]
