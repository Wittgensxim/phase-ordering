...
112:                                              ; preds = %120, %102
  %113 = phi double [ %122, %120 ], [ %sa.promoted18, %102 ]
  %114 = phi double [ %128, %120 ], [ 0.000000e+00, %102 ]
  %115 = phi double [ %123, %120 ], [ %109, %102 ]
  %116 = phi double [ %121, %120 ], [ %96, %102 ]
...
192:                                              ; preds = %176
  ...
  %221 = call double @llvm.fmuladd.f64(double %220, double %178, double %218)
...
261:                                              ; preds = %246
  ...
  %286 = fadd double %283, %284
  %287 = load double, ptr @two, align 8
  %288 = call double @llvm.fmuladd.f64(double %287, double %247, double %286)
...
352:                                              ; preds = %329
  ...
  %392 = call double @llvm.fmuladd.f64(double %391, double %330, double %389)
...
441:                                              ; preds = %419
  ...
  %481 = call double @llvm.fmuladd.f64(double %480, double %420, double %478)
...
496:                                              ; preds = %493
  ...
  %500 = fadd double %490, %498
  %501 = fdiv double %490, %500
  %502 = fsub double %494, %501
  %503 = fadd double %490, %499
...
510:                                              ; preds = %493
  ...
  %520 = fneg double %490
  %521 = fadd double %490, %518
  %522 = fdiv double %490, %521
  %523 = fsub double %520, %522
  %524 = fadd double %490, %519
...
589:                                              ; preds = %566
  ...
  %630 = call double @llvm.fmuladd.f64(double %629, double %567, double %627)
