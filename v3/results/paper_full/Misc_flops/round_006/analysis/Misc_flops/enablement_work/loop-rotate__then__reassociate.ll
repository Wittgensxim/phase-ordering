...
99:                                               ; preds = %.lr.ph26, %99
  ...
  %101 = phi double [ %95, %.lr.ph26 ], [ %103, %99 ]
  %102 = phi double [ %sa.promoted, %.lr.ph26 ], [ %104, %99 ]
  %103 = fneg double %101
...
118:                                              ; preds = %.lr.ph31, %118
  %119 = phi i32 [ 1, %.lr.ph31 ], [ %134, %118 ]
  %120 = phi double [ 0.000000e+00, %.lr.ph31 ], [ %130, %118 ]
  %121 = phi double [ 0.000000e+00, %.lr.ph31 ], [ %131, %118 ]
  %122 = phi double [ %.lcssa9, %.lr.ph31 ], [ %126, %118 ]
  %123 = phi double [ %115, %.lr.ph31 ], [ %128, %118 ]
  %124 = phi double [ 0.000000e+00, %.lr.ph31 ], [ %133, %118 ]
  %125 = phi double [ %sa.promoted18, %.lr.ph31 ], [ %127, %118 ]
  %126 = fneg double %122
