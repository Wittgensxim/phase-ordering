...
24:                                               ; preds = %.lr.ph, %24
  ...
  br i1 %exitcond, label %24, label %._crit_edge, !llvm.loop !9
...
97:                                               ; preds = %.lr.ph26, %97
  ...
  %99 = phi double [ %92, %.lr.ph26 ], [ %101, %97 ]
  %100 = phi double [ %sa.promoted, %.lr.ph26 ], [ %102, %97 ]
  %101 = fneg double %99
...
117:                                              ; preds = %.lr.ph31, %117
  %118 = phi i32 [ 1, %.lr.ph31 ], [ %133, %117 ]
  %119 = phi double [ 0.000000e+00, %.lr.ph31 ], [ %129, %117 ]
  %120 = phi double [ 0.000000e+00, %.lr.ph31 ], [ %130, %117 ]
  %121 = phi double [ %.lcssa9, %.lr.ph31 ], [ %125, %117 ]
  %122 = phi double [ %113, %.lr.ph31 ], [ %127, %117 ]
  %123 = phi double [ 0.000000e+00, %.lr.ph31 ], [ %132, %117 ]
  %124 = phi double [ %sa.promoted18, %.lr.ph31 ], [ %126, %117 ]
  %125 = fneg double %121
  ...
  %exitcond67 = icmp eq i32 %133, %116
  br i1 %exitcond67, label %._crit_edge32, label %117, !llvm.loop !12

._crit_edge32:                                    ; preds = %117
  %split33 = phi double [ %132, %117 ]
  %split34 = phi double [ %130, %117 ]
  %split35 = phi double [ %129, %117 ]
  br label %134
...
180:                                              ; preds = %.lr.ph38, %180
  %181 = phi i32 [ 1, %.lr.ph38 ], [ %194, %180 ]
  %182 = phi double [ 0.000000e+00, %.lr.ph38 ], [ %193, %180 ]
  %183 = phi double [ 0.000000e+00, %.lr.ph38 ], [ %184, %180 ]
  ...
  br i1 %exitcond68, label %180, label %._crit_edge39, !llvm.loop !13

._crit_edge39:                                    ; preds = %180
  %split40 = phi double [ %193, %180 ]
  br label %195
...
249:                                              ; preds = %.lr.ph43, %249
  %250 = phi i32 [ 1, %.lr.ph43 ], [ %262, %249 ]
  %251 = phi double [ 0.000000e+00, %.lr.ph43 ], [ %261, %249 ]
  ...
  br i1 %exitcond69, label %249, label %._crit_edge44, !llvm.loop !14

._crit_edge44:                                    ; preds = %249
  %split45 = phi double [ %261, %249 ]
  br label %263
...
331:                                              ; preds = %.lr.ph48, %331
  %332 = phi i32 [ 1, %.lr.ph48 ], [ %352, %331 ]
  %333 = phi double [ 0.000000e+00, %.lr.ph48 ], [ %351, %331 ]
  ...
  br i1 %exitcond70, label %331, label %._crit_edge49, !llvm.loop !15

._crit_edge49:                                    ; preds = %331
  %split50 = phi double [ %351, %331 ]
  br label %353
...
420:                                              ; preds = %.lr.ph53, %420
  %421 = phi i32 [ 1, %.lr.ph53 ], [ %440, %420 ]
  %422 = phi double [ 0.000000e+00, %.lr.ph53 ], [ %439, %420 ]
  ...
  br i1 %exitcond71, label %420, label %._crit_edge54, !llvm.loop !16

._crit_edge54:                                    ; preds = %420
  %split55 = phi double [ %439, %420 ]
  br label %441
...
565:                                              ; preds = %.lr.ph63, %565
  %566 = phi i32 [ 1, %.lr.ph63 ], [ %586, %565 ]
  %567 = phi double [ 0.000000e+00, %.lr.ph63 ], [ %585, %565 ]
  ...
  %586 = add nuw nsw i32 %566, 1
  %exitcond73 = icmp ne i32 %586, %538
  br i1 %exitcond73, label %565, label %._crit_edge64, !llvm.loop !18

._crit_edge64:                                    ; preds = %565
  %split65 = phi double [ %585, %565 ]
  br label %587
