...
5:                                                ; preds = %44, %0
  %6 = phi double [ %.lcssa23, %44 ], [ undef, %0 ]
...
100:                                              ; preds = %103, %58
  ...
  %exitcond31 = icmp eq i32 %102, %99
  br i1 %exitcond31, label %108, label %103
...
115:                                              ; preds = %114, %108
  ...
  %smax32 = call i32 @llvm.smax.i32(i32 %87, i32 0)
  %119 = add nuw i32 %smax32, 1
  br label %120

120:                                              ; preds = %126, %115
  %121 = phi double [ %131, %126 ], [ %117, %115 ]
  %122 = phi double [ %127, %126 ], [ %.lcssa22, %115 ]
  %123 = phi double [ %134, %126 ], [ 0.000000e+00, %115 ]
  %124 = phi double [ %133, %126 ], [ 0.000000e+00, %115 ]
  %125 = phi i32 [ %138, %126 ], [ 1, %115 ]
  %exitcond33 = icmp eq i32 %125, %119
  br i1 %exitcond33, label %139, label %126
...
139:                                              ; preds = %120
  %.lcssa21 = phi double [ %123, %120 ]
  %.lcssa20 = phi double [ %124, %120 ]
  ...
  %157 = fdiv double %155, %.lcssa21
  %158 = fadd double %156, %157
  store double %158, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %159 = fmul double %.lcssa21, %.lcssa21
  %160 = fmul double %159, %.lcssa21
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %151, i32 1)
  br label %177
...
177:                                              ; preds = %181, %139
  ...
  %exitcond35 = icmp ne i32 %180, %smax34
  br i1 %exitcond35, label %181, label %202
...
202:                                              ; preds = %177
  ...
  %231 = call double @llvm.fmuladd.f64(double %230, double %.lcssa19, double %228)
...
249:                                              ; preds = %252, %202
  ...
  %exitcond36 = icmp ne i32 %251, %smax34
  br i1 %exitcond36, label %252, label %271
...
271:                                              ; preds = %249
  ...
  %298 = call double @llvm.fmuladd.f64(double %297, double %.lcssa18, double %296)
...
326:                                              ; preds = %329, %271
  ...
  %exitcond37 = icmp ne i32 %328, %smax34
  br i1 %exitcond37, label %329, label %362
...
362:                                              ; preds = %326
  ...
  %402 = call double @llvm.fmuladd.f64(double %401, double %.lcssa17, double %399)
...
416:                                              ; preds = %419, %362
  ...
  %exitcond38 = icmp ne i32 %418, %smax34
  br i1 %exitcond38, label %419, label %451
...
451:                                              ; preds = %416
  ...
  %491 = call double @llvm.fmuladd.f64(double %490, double %.lcssa16, double %488)
...
503:                                              ; preds = %506, %451
  ...
  %exitcond39 = icmp ne i32 %505, %smax34
  br i1 %exitcond39, label %506, label %521
...
521:                                              ; preds = %503
  ...
  %544 = call double @llvm.fmuladd.f64(double %543, double %.lcssa15, double %541)
  ...
  %smax40 = call i32 @llvm.smax.i32(i32 %551, i32 1)
  br label %565

565:                                              ; preds = %568, %521
  %566 = phi double [ %599, %568 ], [ 0.000000e+00, %521 ]
  %567 = phi i32 [ %600, %568 ], [ 1, %521 ]
  %exitcond41 = icmp ne i32 %567, %smax40
  br i1 %exitcond41, label %568, label %601
