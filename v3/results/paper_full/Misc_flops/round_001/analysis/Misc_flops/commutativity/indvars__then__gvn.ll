...
44:                                               ; preds = %.loopexit, %42
  %45 = phi double [ %20, %42 ], [ %6, %.loopexit ]
  %46 = phi double [ %16, %42 ], [ %7, %.loopexit ]
...
118:                                              ; preds = %125, %114
  ...
  %exitcond19 = icmp eq i32 %124, %98
  br i1 %exitcond19, label %137, label %125
...
174:                                              ; preds = %178, %137
  ...
  %exitcond21 = icmp ne i32 %177, %smax20
  br i1 %exitcond21, label %178, label %199
...
246:                                              ; preds = %249, %199
  ...
  %exitcond22 = icmp ne i32 %248, %smax20
  br i1 %exitcond22, label %249, label %268
...
323:                                              ; preds = %326, %268
  ...
  %exitcond23 = icmp ne i32 %325, %smax20
  br i1 %exitcond23, label %326, label %359
...
359:                                              ; preds = %323
  ...
  store double %369, ptr %1, align 8
...
413:                                              ; preds = %416, %359
  ...
  %exitcond24 = icmp ne i32 %415, %smax20
  br i1 %exitcond24, label %416, label %448

416:                                              ; preds = %413
  %417 = uitofp nneg i32 %415 to double
  %418 = fmul double %411, %417
  %419 = fmul double %418, %418
  store double %419, ptr %1, align 8
...
448:                                              ; preds = %413
  ...
  store double %458, ptr %1, align 8
  ...
  store double %497, ptr %1, align 8
...
500:                                              ; preds = %503, %448
  ...
  %exitcond25 = icmp ne i32 %502, %smax20
  br i1 %exitcond25, label %503, label %517
...
517:                                              ; preds = %500
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %546, i32 1)
  br label %560

560:                                              ; preds = %563, %517
  %561 = phi double [ %594, %563 ], [ 0.000000e+00, %517 ]
  %562 = phi i32 [ %595, %563 ], [ 1, %517 ]
  %exitcond27 = icmp ne i32 %562, %smax26
  br i1 %exitcond27, label %563, label %596
