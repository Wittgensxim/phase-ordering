...
21:                                               ; preds = %14, %21
  %22 = phi i32 [ 1, %14 ], [ %40, %21 ]
  %23 = phi double [ 0.000000e+00, %14 ], [ %39, %21 ]
  %24 = phi double [ 0.000000e+00, %14 ], [ %26, %21 ]
  ...
  br i1 %exitcond, label %21, label %41, !llvm.loop !9

41:                                               ; preds = %21
  %.lcssa9 = phi double [ %39, %21 ]
...
..loopexit_crit_edge:                             ; preds = %7
  %split = phi double [ %8, %7 ]
  %split28 = phi double [ %9, %7 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %0
  %.lcssa14 = phi double [ %split, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa12 = phi double [ %split28, %..loopexit_crit_edge ], [ undef, %0 ]
  br label %46
...
58:                                               ; preds = %57, %51
  ...
  %exitcond1729 = icmp eq i32 1, %99
  br i1 %exitcond1729, label %107, label %.lr.ph30

.lr.ph30:                                         ; preds = %58
  br label %100

100:                                              ; preds = %.lr.ph30, %100
  %101 = phi i32 [ 1, %.lr.ph30 ], [ %106, %100 ]
  %102 = phi double [ %95, %.lr.ph30 ], [ %103, %100 ]
  %103 = fneg double %102
  %104 = load double, ptr @sa, align 8
  %105 = fsub double %104, %102
  store double %105, ptr @sa, align 8
  %106 = add nuw i32 %101, 1
  %exitcond17 = icmp eq i32 %106, %99
  br i1 %exitcond17, label %._crit_edge, label %100, !llvm.loop !11

._crit_edge:                                      ; preds = %100
  %split31 = phi double [ %103, %100 ]
  br label %107

107:                                              ; preds = %._crit_edge, %58
  %.lcssa8 = phi double [ %split31, %._crit_edge ], [ %95, %58 ]
...
114:                                              ; preds = %113, %107
  ...
  %exitcond1932 = icmp eq i32 1, %118
  br i1 %exitcond1932, label %137, label %.lr.ph34

.lr.ph34:                                         ; preds = %114
  br label %119

119:                                              ; preds = %.lr.ph34, %119
  %120 = phi i32 [ 1, %.lr.ph34 ], [ %136, %119 ]
  %121 = phi double [ 0.000000e+00, %.lr.ph34 ], [ %131, %119 ]
  %122 = phi double [ 0.000000e+00, %.lr.ph34 ], [ %132, %119 ]
  %123 = phi double [ %.lcssa8, %.lr.ph34 ], [ %125, %119 ]
  %124 = phi double [ %116, %.lr.ph34 ], [ %129, %119 ]
  %125 = fneg double %123
  ...
  %exitcond19 = icmp eq i32 %136, %118
  br i1 %exitcond19, label %._crit_edge35, label %119, !llvm.loop !12

._crit_edge35:                                    ; preds = %119
  %split36 = phi double [ %132, %119 ]
  %split37 = phi double [ %131, %119 ]
  br label %137

137:                                              ; preds = %._crit_edge35, %114
  %.lcssa7 = phi double [ %split36, %._crit_edge35 ], [ 0.000000e+00, %114 ]
  %.lcssa6 = phi double [ %split37, %._crit_edge35 ], [ 0.000000e+00, %114 ]
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %149, i32 1)
  %exitcond2138 = icmp ne i32 1, %smax20
  br i1 %exitcond2138, label %.lr.ph40, label %199

.lr.ph40:                                         ; preds = %137
  br label %175

175:                                              ; preds = %.lr.ph40, %175
  %176 = phi i32 [ 1, %.lr.ph40 ], [ %198, %175 ]
  %177 = phi double [ 0.000000e+00, %.lr.ph40 ], [ %197, %175 ]
  %178 = phi double [ 0.000000e+00, %.lr.ph40 ], [ %180, %175 ]
  ...
  %198 = add nuw i32 %176, 1
  %exitcond21 = icmp ne i32 %198, %smax20
  br i1 %exitcond21, label %175, label %._crit_edge41, !llvm.loop !13

._crit_edge41:                                    ; preds = %175
  %split42 = phi double [ %197, %175 ]
  br label %199

199:                                              ; preds = %._crit_edge41, %137
  %.lcssa5 = phi double [ %split42, %._crit_edge41 ], [ 0.000000e+00, %137 ]
  ...
  %exitcond2243 = icmp ne i32 1, %smax20
  br i1 %exitcond2243, label %.lr.ph45, label %267

.lr.ph45:                                         ; preds = %199
  br label %246

246:                                              ; preds = %.lr.ph45, %246
  %247 = phi i32 [ 1, %.lr.ph45 ], [ %266, %246 ]
  %248 = phi double [ 0.000000e+00, %.lr.ph45 ], [ %265, %246 ]
  ...
  %266 = add nuw i32 %247, 1
  %exitcond22 = icmp ne i32 %266, %smax20
  br i1 %exitcond22, label %246, label %._crit_edge46, !llvm.loop !14

._crit_edge46:                                    ; preds = %246
  %split47 = phi double [ %265, %246 ]
  br label %267

267:                                              ; preds = %._crit_edge46, %199
  %.lcssa4 = phi double [ %split47, %._crit_edge46 ], [ 0.000000e+00, %199 ]
  ...
  %exitcond2348 = icmp ne i32 1, %smax20
  br i1 %exitcond2348, label %.lr.ph50, label %357

.lr.ph50:                                         ; preds = %267
  br label %322

322:                                              ; preds = %.lr.ph50, %322
  %323 = phi i32 [ 1, %.lr.ph50 ], [ %356, %322 ]
  %324 = phi double [ 0.000000e+00, %.lr.ph50 ], [ %355, %322 ]
  ...
  %exitcond23 = icmp ne i32 %356, %smax20
  br i1 %exitcond23, label %322, label %._crit_edge51, !llvm.loop !15

._crit_edge51:                                    ; preds = %322
  %split52 = phi double [ %355, %322 ]
  br label %357

357:                                              ; preds = %._crit_edge51, %267
  %.lcssa3 = phi double [ %split52, %._crit_edge51 ], [ 0.000000e+00, %267 ]
  ...
  %exitcond2453 = icmp ne i32 1, %smax20
  br i1 %exitcond2453, label %.lr.ph55, label %445

.lr.ph55:                                         ; preds = %357
  br label %411

411:                                              ; preds = %.lr.ph55, %411
  %412 = phi i32 [ 1, %.lr.ph55 ], [ %444, %411 ]
  %413 = phi double [ 0.000000e+00, %.lr.ph55 ], [ %443, %411 ]
  ...
  %444 = add nuw i32 %412, 1
  %exitcond24 = icmp ne i32 %444, %smax20
  br i1 %exitcond24, label %411, label %._crit_edge56, !llvm.loop !16

._crit_edge56:                                    ; preds = %411
  %split57 = phi double [ %443, %411 ]
  br label %445

445:                                              ; preds = %._crit_edge56, %357
  %.lcssa2 = phi double [ %split57, %._crit_edge56 ], [ 0.000000e+00, %357 ]
  ...
  %exitcond2558 = icmp ne i32 1, %smax20
  br i1 %exitcond2558, label %.lr.ph60, label %514

.lr.ph60:                                         ; preds = %445
  br label %497

497:                                              ; preds = %.lr.ph60, %497
  %498 = phi i32 [ 1, %.lr.ph60 ], [ %513, %497 ]
  %499 = phi double [ 0.000000e+00, %.lr.ph60 ], [ %512, %497 ]
  ...
  %exitcond25 = icmp ne i32 %513, %smax20
  br i1 %exitcond25, label %497, label %._crit_edge61, !llvm.loop !17

._crit_edge61:                                    ; preds = %497
  %split62 = phi double [ %512, %497 ]
  br label %514

514:                                              ; preds = %._crit_edge61, %445
  %.lcssa1 = phi double [ %split62, %._crit_edge61 ], [ 0.000000e+00, %445 ]
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %544, i32 1)
  %exitcond2763 = icmp ne i32 1, %smax26
  br i1 %exitcond2763, label %.lr.ph65, label %593

.lr.ph65:                                         ; preds = %514
  br label %558

558:                                              ; preds = %.lr.ph65, %558
  %559 = phi i32 [ 1, %.lr.ph65 ], [ %592, %558 ]
  %560 = phi double [ 0.000000e+00, %.lr.ph65 ], [ %591, %558 ]
  ...
  %592 = add nuw i32 %559, 1
  %exitcond27 = icmp ne i32 %592, %smax26
  br i1 %exitcond27, label %558, label %._crit_edge66, !llvm.loop !18

._crit_edge66:                                    ; preds = %558
  %split67 = phi double [ %591, %558 ]
  br label %593

593:                                              ; preds = %._crit_edge66, %514
  %.lcssa = phi double [ %split67, %._crit_edge66 ], [ 0.000000e+00, %514 ]
