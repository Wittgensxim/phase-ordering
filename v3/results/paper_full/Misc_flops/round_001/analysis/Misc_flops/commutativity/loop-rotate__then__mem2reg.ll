...
define dso_local i32 @main() #0 {
  ...
  br i1 %4, label %.lr.ph19, label %.loopexit

.lr.ph19:                                         ; preds = %0
  br label %12

5:                                                ; preds = %38
  %6 = phi double [ %.lcssa9, %38 ]
  %7 = phi double [ %17, %38 ]
  %8 = phi i32 [ %14, %38 ]
  %9 = phi double [ %40, %38 ]
...
12:                                               ; preds = %.lr.ph19, %5
  %13 = phi i32 [ 15625, %.lr.ph19 ], [ %8, %5 ]
  %14 = shl nsw i32 %13, 1
  %15 = load double, ptr @one, align 8
  %16 = sitofp i32 %14 to double
  %17 = fdiv double %15, %16
  %18 = call i32 @dtime(ptr noundef nonnull @TimeArray)
  %.not.not17 = icmp slt i32 1, %14
  br i1 %.not.not17, label %.lr.ph, label %38
...
38:                                               ; preds = %._crit_edge, %12
  %.lcssa9 = phi double [ %split, %._crit_edge ], [ 0.000000e+00, %12 ]
...
42:                                               ; preds = %38
  %.lcssa16 = phi double [ %17, %38 ]
  %.lcssa9.lcssa = phi double [ %.lcssa9, %38 ]
  br label %43

..loopexit_crit_edge:                             ; preds = %5
  %split20 = phi double [ %6, %5 ]
  %split21 = phi double [ %7, %5 ]
  %split22 = phi i32 [ %8, %5 ]
  br label %.loopexit
...
43:                                               ; preds = %.loopexit, %42
  %44 = phi double [ %.lcssa9.lcssa, %42 ], [ %.lcssa14, %.loopexit ]
  %45 = phi double [ %.lcssa16, %42 ], [ %.lcssa12, %.loopexit ]
  %46 = phi i32 [ 512000000, %42 ], [ %.lcssa10, %.loopexit ]
...
58:                                               ; preds = %57, %51
  ...
  br i1 %.not23, label %106, label %.lr.ph25

.lr.ph25:                                         ; preds = %58
  br label %99

99:                                               ; preds = %.lr.ph25, %99
  %100 = phi i32 [ 1, %.lr.ph25 ], [ %105, %99 ]
  %101 = phi double [ %95, %.lr.ph25 ], [ %102, %99 ]
  %102 = fneg double %101
  ...
  br i1 %.not, label %._crit_edge26, label %99, !llvm.loop !11

._crit_edge26:                                    ; preds = %99
  %split27 = phi double [ %102, %99 ]
  br label %106

106:                                              ; preds = %._crit_edge26, %58
...
117:                                              ; preds = %.lr.ph30, %117
  %.0 = phi double [ 0.000000e+00, %.lr.ph30 ], [ %132, %117 ]
  %118 = phi i32 [ 1, %.lr.ph30 ], [ %133, %117 ]
  %119 = phi double [ 0.000000e+00, %.lr.ph30 ], [ %129, %117 ]
  %120 = phi double [ 0.000000e+00, %.lr.ph30 ], [ %130, %117 ]
  %121 = phi double [ %.lcssa8, %.lr.ph30 ], [ %123, %117 ]
  %122 = phi double [ %115, %.lr.ph30 ], [ %127, %117 ]
  %123 = fneg double %121
  ...
  %132 = fsub double %.0, %131
  %133 = add nuw nsw i32 %118, 1
  %.not4 = icmp sgt i32 %133, %87
  br i1 %.not4, label %._crit_edge31, label %117, !llvm.loop !12

._crit_edge31:                                    ; preds = %117
  %split32 = phi double [ %130, %117 ]
  %split33 = phi double [ %129, %117 ]
  br label %134

134:                                              ; preds = %._crit_edge31, %113
  %.1 = phi double [ 0.000000e+00, %113 ], [ %132, %._crit_edge31 ]
  %.lcssa7 = phi double [ %split32, %._crit_edge31 ], [ 0.000000e+00, %113 ]
  %.lcssa6 = phi double [ %split33, %._crit_edge31 ], [ 0.000000e+00, %113 ]
  ...
  %.not5.not34 = icmp slt i32 1, %146
  br i1 %.not5.not34, label %.lr.ph36, label %195

.lr.ph36:                                         ; preds = %134
  br label %171

171:                                              ; preds = %.lr.ph36, %171
  %172 = phi i32 [ 1, %.lr.ph36 ], [ %194, %171 ]
  %173 = phi double [ 0.000000e+00, %.lr.ph36 ], [ %193, %171 ]
  %174 = phi double [ 0.000000e+00, %.lr.ph36 ], [ %176, %171 ]
  ...
  br i1 %.not5.not, label %171, label %._crit_edge37, !llvm.loop !13

._crit_edge37:                                    ; preds = %171
  %split38 = phi double [ %193, %171 ]
  br label %195

195:                                              ; preds = %._crit_edge37, %134
  %.lcssa5 = phi double [ %split38, %._crit_edge37 ], [ 0.000000e+00, %134 ]
  ...
  %.not6.not39 = icmp slt i32 1, %146
  br i1 %.not6.not39, label %.lr.ph41, label %263

.lr.ph41:                                         ; preds = %195
  br label %242

242:                                              ; preds = %.lr.ph41, %242
  %243 = phi i32 [ 1, %.lr.ph41 ], [ %262, %242 ]
  %244 = phi double [ 0.000000e+00, %.lr.ph41 ], [ %261, %242 ]
  ...
  br i1 %.not6.not, label %242, label %._crit_edge42, !llvm.loop !14

._crit_edge42:                                    ; preds = %242
  %split43 = phi double [ %261, %242 ]
  br label %263

263:                                              ; preds = %._crit_edge42, %195
  %.lcssa4 = phi double [ %split43, %._crit_edge42 ], [ 0.000000e+00, %195 ]
  ...
  %.not7.not44 = icmp slt i32 1, %146
  br i1 %.not7.not44, label %.lr.ph46, label %353

.lr.ph46:                                         ; preds = %263
  br label %318

318:                                              ; preds = %.lr.ph46, %318
  %319 = phi i32 [ 1, %.lr.ph46 ], [ %352, %318 ]
  %320 = phi double [ 0.000000e+00, %.lr.ph46 ], [ %351, %318 ]
  ...
  br i1 %.not7.not, label %318, label %._crit_edge47, !llvm.loop !15

._crit_edge47:                                    ; preds = %318
  %split48 = phi double [ %351, %318 ]
  br label %353

353:                                              ; preds = %._crit_edge47, %263
  %.lcssa3 = phi double [ %split48, %._crit_edge47 ], [ 0.000000e+00, %263 ]
  ...
  %.not8.not49 = icmp slt i32 1, %146
  br i1 %.not8.not49, label %.lr.ph51, label %441

.lr.ph51:                                         ; preds = %353
  br label %407

407:                                              ; preds = %.lr.ph51, %407
  %408 = phi i32 [ 1, %.lr.ph51 ], [ %440, %407 ]
  %409 = phi double [ 0.000000e+00, %.lr.ph51 ], [ %439, %407 ]
  ...
  br i1 %.not8.not, label %407, label %._crit_edge52, !llvm.loop !16

._crit_edge52:                                    ; preds = %407
  %split53 = phi double [ %439, %407 ]
  br label %441

441:                                              ; preds = %._crit_edge52, %353
  %.lcssa2 = phi double [ %split53, %._crit_edge52 ], [ 0.000000e+00, %353 ]
  ...
  %.not9.not54 = icmp slt i32 1, %146
  br i1 %.not9.not54, label %.lr.ph56, label %509

.lr.ph56:                                         ; preds = %441
  br label %493

493:                                              ; preds = %.lr.ph56, %493
  %494 = phi i32 [ 1, %.lr.ph56 ], [ %508, %493 ]
  %495 = phi double [ 0.000000e+00, %.lr.ph56 ], [ %507, %493 ]
  ...
  br i1 %.not9.not, label %493, label %._crit_edge57, !llvm.loop !17

._crit_edge57:                                    ; preds = %493
  %split58 = phi double [ %507, %493 ]
  br label %509

509:                                              ; preds = %._crit_edge57, %441
  %.lcssa1 = phi double [ %split58, %._crit_edge57 ], [ 0.000000e+00, %441 ]
  ...
  %.not10.not59 = icmp slt i32 1, %538
  br i1 %.not10.not59, label %.lr.ph61, label %587

.lr.ph61:                                         ; preds = %509
  br label %552

552:                                              ; preds = %.lr.ph61, %552
  %553 = phi i32 [ 1, %.lr.ph61 ], [ %586, %552 ]
  %554 = phi double [ 0.000000e+00, %.lr.ph61 ], [ %585, %552 ]
  ...
  br i1 %.not10.not, label %552, label %._crit_edge62, !llvm.loop !18

._crit_edge62:                                    ; preds = %552
  %split63 = phi double [ %585, %552 ]
  br label %587

587:                                              ; preds = %._crit_edge62, %509
  %.lcssa = phi double [ %split63, %._crit_edge62 ], [ 0.000000e+00, %509 ]
