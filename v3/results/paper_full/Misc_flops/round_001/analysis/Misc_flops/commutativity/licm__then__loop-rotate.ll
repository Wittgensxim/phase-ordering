...
define dso_local i32 @main() #0 {
  ...
  br i1 %6, label %.lr.ph34, label %.loopexit
...
7:                                                ; preds = %41
  %8 = phi double [ %18, %41 ]
  %9 = phi double [ %.lcssa9, %41 ]
  %10 = phi double [ %20, %41 ]
  %11 = phi i32 [ %17, %41 ]
  %12 = phi double [ %43, %41 ]
  %13 = load double, ptr @TLimit, align 8
  %14 = fcmp olt double %12, %13
  br i1 %14, label %15, label %..loopexit_crit_edge, !llvm.loop !7

15:                                               ; preds = %.lr.ph34, %7
  %16 = phi i32 [ 15625, %.lr.ph34 ], [ %11, %7 ]
  %17 = shl nsw i32 %16, 1
  %18 = load double, ptr @one, align 8
  %19 = sitofp i32 %17 to double
  %20 = fdiv double %18, %19
  %21 = call i32 @dtime(ptr noundef nonnull @TimeArray)
  %22 = load double, ptr @D1, align 8
  %23 = load double, ptr @D2, align 8
  %24 = load double, ptr @D3, align 8
  %25 = load double, ptr @E2, align 8
  %26 = load double, ptr @E3, align 8
  %.not.not32 = icmp slt i32 1, %17
  br i1 %.not.not32, label %.lr.ph, label %41

.lr.ph:                                           ; preds = %15
  br label %27

27:                                               ; preds = %.lr.ph, %27
  %28 = phi i32 [ 1, %.lr.ph ], [ %40, %27 ]
  %29 = phi double [ 0.000000e+00, %.lr.ph ], [ %39, %27 ]
  %30 = phi double [ 0.000000e+00, %.lr.ph ], [ %31, %27 ]
  %31 = fadd double %30, %18
  %32 = fmul double %31, %20
  %33 = call double @llvm.fmuladd.f64(double %32, double %24, double %23)
  %34 = call double @llvm.fmuladd.f64(double %32, double %33, double %22)
  %35 = call double @llvm.fmuladd.f64(double %32, double %26, double %25)
  %36 = call double @llvm.fmuladd.f64(double %32, double %35, double %22)
  %37 = call double @llvm.fmuladd.f64(double %32, double %36, double %18)
  %38 = fdiv double %34, %37
  %39 = fadd double %29, %38
  %40 = add nuw nsw i32 %28, 1
  %.not.not = icmp slt i32 %40, %17
  br i1 %.not.not, label %27, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %27
  %split = phi double [ %39, %27 ]
  br label %41

41:                                               ; preds = %._crit_edge, %15
  %.lcssa9 = phi double [ %split, %._crit_edge ], [ 0.000000e+00, %15 ]
  ...
  %44 = icmp eq i32 %16, 256000000
  br i1 %44, label %45, label %7

45:                                               ; preds = %41
  %.lcssa18 = phi double [ %18, %41 ]
  %.lcssa16 = phi double [ %20, %41 ]
  %.lcssa9.lcssa = phi double [ %.lcssa9, %41 ]
  store double %.lcssa18, ptr %1, align 8
  br label %46

..loopexit_crit_edge:                             ; preds = %7
  %split35 = phi double [ %8, %7 ]
  %split36 = phi double [ %9, %7 ]
  %split37 = phi double [ %10, %7 ]
  %split38 = phi i32 [ %11, %7 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %0
  %.lcssa17 = phi double [ %split35, %..loopexit_crit_edge ], [ %.promoted, %0 ]
  %.lcssa14 = phi double [ %split36, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa12 = phi double [ %split37, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa10 = phi i32 [ %split38, %..loopexit_crit_edge ], [ 15625, %0 ]
...
61:                                               ; preds = %60, %54
  ...
  %.not39 = icmp sgt i32 1, %90
  br i1 %.not39, label %109, label %.lr.ph41

.lr.ph41:                                         ; preds = %61
  br label %102

102:                                              ; preds = %.lr.ph41, %102
  %103 = phi i32 [ 1, %.lr.ph41 ], [ %108, %102 ]
  %104 = phi double [ %98, %.lr.ph41 ], [ %106, %102 ]
  %105 = phi double [ %sa.promoted, %.lr.ph41 ], [ %107, %102 ]
  %106 = fneg double %104
  %107 = fsub double %105, %104
  store double %107, ptr @sa, align 8
  %108 = add nuw nsw i32 %103, 1
  %.not = icmp sgt i32 %108, %90
  br i1 %.not, label %._crit_edge42, label %102, !llvm.loop !11

._crit_edge42:                                    ; preds = %102
  %split43 = phi double [ %106, %102 ]
  br label %109

109:                                              ; preds = %._crit_edge42, %61
  %.lcssa8 = phi double [ %split43, %._crit_edge42 ], [ %98, %61 ]
...
116:                                              ; preds = %115, %109
  ...
  %.not444 = icmp sgt i32 1, %90
  br i1 %.not444, label %138, label %.lr.ph46

.lr.ph46:                                         ; preds = %116
  br label %121

121:                                              ; preds = %.lr.ph46, %121
  %122 = phi i32 [ 1, %.lr.ph46 ], [ %137, %121 ]
  %123 = phi double [ 0.000000e+00, %.lr.ph46 ], [ %133, %121 ]
  %124 = phi double [ 0.000000e+00, %.lr.ph46 ], [ %134, %121 ]
  %125 = phi double [ %.lcssa8, %.lr.ph46 ], [ %129, %121 ]
  %126 = phi double [ %118, %.lr.ph46 ], [ %131, %121 ]
  %127 = phi double [ %sa.promoted19, %.lr.ph46 ], [ %130, %121 ]
  %128 = phi double [ %.promoted20, %.lr.ph46 ], [ %136, %121 ]
  %129 = fneg double %125
  %130 = fsub double %127, %125
  store double %130, ptr @sa, align 8
  %131 = fadd double %126, %120
  %132 = fsub double %129, %131
  %133 = fadd double %123, %132
  %134 = call double @llvm.fmuladd.f64(double %125, double %131, double %124)
  %135 = fdiv double %125, %131
  %136 = fsub double %128, %135
  %137 = add nuw nsw i32 %122, 1
  %.not4 = icmp sgt i32 %137, %90
  br i1 %.not4, label %._crit_edge47, label %121, !llvm.loop !12

._crit_edge47:                                    ; preds = %121
  %split48 = phi double [ %136, %121 ]
  %split49 = phi double [ %134, %121 ]
  %split50 = phi double [ %133, %121 ]
  br label %138

138:                                              ; preds = %._crit_edge47, %116
  %.lcssa21 = phi double [ %split48, %._crit_edge47 ], [ %.promoted20, %116 ]
  %.lcssa7 = phi double [ %split49, %._crit_edge47 ], [ 0.000000e+00, %116 ]
  %.lcssa6 = phi double [ %split50, %._crit_edge47 ], [ 0.000000e+00, %116 ]
  ...
  %184 = load double, ptr @A1, align 8
  %.promoted22 = load double, ptr %1, align 1
  %.not5.not51 = icmp slt i32 1, %150
  br i1 %.not5.not51, label %.lr.ph53, label %200

.lr.ph53:                                         ; preds = %138
  br label %185

185:                                              ; preds = %.lr.ph53, %185
  %186 = phi i32 [ 1, %.lr.ph53 ], [ %199, %185 ]
  %187 = phi double [ 0.000000e+00, %.lr.ph53 ], [ %198, %185 ]
  %188 = phi double [ 0.000000e+00, %.lr.ph53 ], [ %189, %185 ]
  %189 = fadd double %188, %176
  %190 = fmul double %189, %174
  %191 = fmul double %190, %190
  %192 = call double @llvm.fmuladd.f64(double %177, double %191, double %179)
  %193 = call double @llvm.fmuladd.f64(double %192, double %191, double %180)
  %194 = call double @llvm.fmuladd.f64(double %193, double %191, double %182)
  %195 = call double @llvm.fmuladd.f64(double %194, double %191, double %183)
  %196 = call double @llvm.fmuladd.f64(double %195, double %191, double %184)
  %197 = call double @llvm.fmuladd.f64(double %196, double %191, double %176)
  %198 = call double @llvm.fmuladd.f64(double %190, double %197, double %187)
  %199 = add nuw nsw i32 %186, 1
  %.not5.not = icmp slt i32 %199, %150
  br i1 %.not5.not, label %185, label %._crit_edge54, !llvm.loop !13

._crit_edge54:                                    ; preds = %185
  %split55 = phi double [ %191, %185 ]
  %split56 = phi double [ %198, %185 ]
  br label %200

200:                                              ; preds = %._crit_edge54, %138
  %.lcssa23 = phi double [ %split55, %._crit_edge54 ], [ %.promoted22, %138 ]
  %.lcssa5 = phi double [ %split56, %._crit_edge54 ], [ 0.000000e+00, %138 ]
  ...
  %.not6.not57 = icmp slt i32 1, %150
  br i1 %.not6.not57, label %.lr.ph59, label %268

.lr.ph59:                                         ; preds = %200
  br label %254

254:                                              ; preds = %.lr.ph59, %254
  %255 = phi i32 [ 1, %.lr.ph59 ], [ %267, %254 ]
  %256 = phi double [ 0.000000e+00, %.lr.ph59 ], [ %266, %254 ]
  %257 = uitofp nneg i32 %255 to double
  %258 = fmul double %245, %257
  %259 = fmul double %258, %258
  %260 = call double @llvm.fmuladd.f64(double %247, double %259, double %248)
  %261 = call double @llvm.fmuladd.f64(double %259, double %260, double %249)
  %262 = call double @llvm.fmuladd.f64(double %259, double %261, double %250)
  %263 = call double @llvm.fmuladd.f64(double %259, double %262, double %251)
  %264 = call double @llvm.fmuladd.f64(double %259, double %263, double %252)
  %265 = call double @llvm.fmuladd.f64(double %259, double %264, double %256)
  %266 = fadd double %265, %253
  %267 = add nuw nsw i32 %255, 1
  %.not6.not = icmp slt i32 %267, %150
  br i1 %.not6.not, label %254, label %._crit_edge60, !llvm.loop !14

._crit_edge60:                                    ; preds = %254
  %split61 = phi double [ %259, %254 ]
  %split62 = phi double [ %266, %254 ]
  br label %268

268:                                              ; preds = %._crit_edge60, %200
  %.lcssa25 = phi double [ %split61, %._crit_edge60 ], [ %.promoted24, %200 ]
  %.lcssa4 = phi double [ %split62, %._crit_edge60 ], [ 0.000000e+00, %200 ]
  ...
  %.not7.not63 = icmp slt i32 1, %150
  br i1 %.not7.not63, label %.lr.ph65, label %358

.lr.ph65:                                         ; preds = %268
  br label %336

336:                                              ; preds = %.lr.ph65, %336
  %337 = phi i32 [ 1, %.lr.ph65 ], [ %357, %336 ]
  %338 = phi double [ 0.000000e+00, %.lr.ph65 ], [ %356, %336 ]
  %339 = uitofp nneg i32 %337 to double
  %340 = fmul double %321, %339
  %341 = fmul double %340, %340
  %342 = call double @llvm.fmuladd.f64(double %323, double %341, double %324)
  %343 = call double @llvm.fmuladd.f64(double %342, double %341, double %325)
  %344 = call double @llvm.fmuladd.f64(double %343, double %341, double %326)
  %345 = call double @llvm.fmuladd.f64(double %344, double %341, double %327)
  %346 = call double @llvm.fmuladd.f64(double %345, double %341, double %328)
  %347 = call double @llvm.fmuladd.f64(double %346, double %341, double %329)
  %348 = fmul double %340, %347
  %349 = call double @llvm.fmuladd.f64(double %330, double %341, double %331)
  %350 = call double @llvm.fmuladd.f64(double %341, double %349, double %332)
  %351 = call double @llvm.fmuladd.f64(double %341, double %350, double %333)
  %352 = call double @llvm.fmuladd.f64(double %341, double %351, double %334)
  %353 = call double @llvm.fmuladd.f64(double %341, double %352, double %335)
  %354 = call double @llvm.fmuladd.f64(double %341, double %353, double %329)
  %355 = fdiv double %348, %354
  %356 = fadd double %338, %355
  %357 = add nuw nsw i32 %337, 1
  %.not7.not = icmp slt i32 %357, %150
  br i1 %.not7.not, label %336, label %._crit_edge66, !llvm.loop !15

._crit_edge66:                                    ; preds = %336
  %split67 = phi double [ %341, %336 ]
  %split68 = phi double [ %356, %336 ]
  br label %358

358:                                              ; preds = %._crit_edge66, %268
  %.lcssa27 = phi double [ %split67, %._crit_edge66 ], [ %.promoted26, %268 ]
  %.lcssa3 = phi double [ %split68, %._crit_edge66 ], [ 0.000000e+00, %268 ]
  ...
  %.not8.not69 = icmp slt i32 1, %150
  br i1 %.not8.not69, label %.lr.ph71, label %446

.lr.ph71:                                         ; preds = %358
  br label %425

425:                                              ; preds = %.lr.ph71, %425
  %426 = phi i32 [ 1, %.lr.ph71 ], [ %445, %425 ]
  %427 = phi double [ 0.000000e+00, %.lr.ph71 ], [ %444, %425 ]
  %428 = uitofp nneg i32 %426 to double
  %429 = fmul double %410, %428
  %430 = fmul double %429, %429
  %431 = call double @llvm.fmuladd.f64(double %412, double %430, double %413)
  %432 = call double @llvm.fmuladd.f64(double %431, double %430, double %414)
  %433 = call double @llvm.fmuladd.f64(double %432, double %430, double %415)
  %434 = call double @llvm.fmuladd.f64(double %433, double %430, double %416)
  %435 = call double @llvm.fmuladd.f64(double %434, double %430, double %417)
  %436 = call double @llvm.fmuladd.f64(double %435, double %430, double %418)
  %437 = fmul double %429, %436
  %438 = call double @llvm.fmuladd.f64(double %419, double %430, double %420)
  %439 = call double @llvm.fmuladd.f64(double %430, double %438, double %421)
  %440 = call double @llvm.fmuladd.f64(double %430, double %439, double %422)
  %441 = call double @llvm.fmuladd.f64(double %430, double %440, double %423)
  %442 = call double @llvm.fmuladd.f64(double %430, double %441, double %424)
  %443 = call double @llvm.fmuladd.f64(double %430, double %442, double %418)
  %444 = call double @llvm.fmuladd.f64(double %437, double %443, double %427)
  %445 = add nuw nsw i32 %426, 1
  %.not8.not = icmp slt i32 %445, %150
  br i1 %.not8.not, label %425, label %._crit_edge72, !llvm.loop !16

._crit_edge72:                                    ; preds = %425
  %split73 = phi double [ %430, %425 ]
  %split74 = phi double [ %444, %425 ]
  br label %446

446:                                              ; preds = %._crit_edge72, %358
  %.lcssa29 = phi double [ %split73, %._crit_edge72 ], [ %.promoted28, %358 ]
  %.lcssa2 = phi double [ %split74, %._crit_edge72 ], [ 0.000000e+00, %358 ]
  ...
  %498 = load double, ptr %1, align 8
  %.not9.not75 = icmp slt i32 1, %150
  br i1 %.not9.not75, label %.lr.ph77, label %515

.lr.ph77:                                         ; preds = %446
  br label %499

499:                                              ; preds = %.lr.ph77, %499
  %500 = phi i32 [ 1, %.lr.ph77 ], [ %514, %499 ]
  %501 = phi double [ 0.000000e+00, %.lr.ph77 ], [ %513, %499 ]
  %502 = uitofp nneg i32 %500 to double
  %503 = fmul double %496, %502
  %504 = fmul double %503, %503
  %505 = fadd double %503, %498
  %506 = fdiv double %498, %505
  %507 = fsub double %501, %506
  %508 = fadd double %504, %498
  %509 = fdiv double %503, %508
  %510 = fsub double %507, %509
  %511 = call double @llvm.fmuladd.f64(double %503, double %504, double %498)
  %512 = fdiv double %504, %511
  %513 = fsub double %510, %512
  %514 = add nuw nsw i32 %500, 1
  %.not9.not = icmp slt i32 %514, %150
  br i1 %.not9.not, label %499, label %._crit_edge78, !llvm.loop !17

._crit_edge78:                                    ; preds = %499
  %split79 = phi double [ %513, %499 ]
  br label %515

515:                                              ; preds = %._crit_edge78, %446
  %.lcssa1 = phi double [ %split79, %._crit_edge78 ], [ 0.000000e+00, %446 ]
  ...
  %.not10.not80 = icmp slt i32 1, %545
  br i1 %.not10.not80, label %.lr.ph82, label %594

.lr.ph82:                                         ; preds = %515
  br label %572

572:                                              ; preds = %.lr.ph82, %572
  %573 = phi i32 [ 1, %.lr.ph82 ], [ %593, %572 ]
  %574 = phi double [ 0.000000e+00, %.lr.ph82 ], [ %592, %572 ]
  %575 = uitofp nneg i32 %573 to double
  %576 = fmul double %557, %575
  %577 = fmul double %576, %576
  %578 = call double @llvm.fmuladd.f64(double %559, double %577, double %560)
  %579 = call double @llvm.fmuladd.f64(double %577, double %578, double %561)
  %580 = call double @llvm.fmuladd.f64(double %577, double %579, double %562)
  %581 = call double @llvm.fmuladd.f64(double %577, double %580, double %563)
  %582 = call double @llvm.fmuladd.f64(double %577, double %581, double %564)
  %583 = call double @llvm.fmuladd.f64(double %577, double %582, double %565)
  %584 = fmul double %583, %583
  %585 = fmul double %584, %576
  %586 = call double @llvm.fmuladd.f64(double %566, double %577, double %567)
  %587 = call double @llvm.fmuladd.f64(double %586, double %577, double %568)
  %588 = call double @llvm.fmuladd.f64(double %587, double %577, double %569)
  %589 = call double @llvm.fmuladd.f64(double %588, double %577, double %570)
  %590 = call double @llvm.fmuladd.f64(double %589, double %577, double %571)
  %591 = call double @llvm.fmuladd.f64(double %590, double %577, double %565)
  %592 = call double @llvm.fmuladd.f64(double %585, double %591, double %574)
  %593 = add nuw nsw i32 %573, 1
  %.not10.not = icmp slt i32 %593, %545
  br i1 %.not10.not, label %572, label %._crit_edge83, !llvm.loop !18

._crit_edge83:                                    ; preds = %572
  %split84 = phi double [ %577, %572 ]
  %split85 = phi double [ %592, %572 ]
  br label %594

594:                                              ; preds = %._crit_edge83, %515
  %.lcssa31 = phi double [ %split84, %._crit_edge83 ], [ %.promoted30, %515 ]
  %.lcssa = phi double [ %split85, %._crit_edge83 ], [ 0.000000e+00, %515 ]
