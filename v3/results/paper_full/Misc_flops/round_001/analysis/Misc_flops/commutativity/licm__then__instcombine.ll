...
45:                                               ; preds = %.loopexit, %43
  %storemerge32 = phi double [ %6, %.loopexit ], [ %15, %43 ]
  %46 = phi double [ %7, %.loopexit ], [ %26, %43 ]
  %47 = phi double [ %8, %.loopexit ], [ %17, %43 ]
  %48 = phi i32 [ %9, %.loopexit ], [ 512000000, %43 ]
  store double %storemerge32, ptr %1, align 8
...
140:                                              ; preds = %122
  ...
  %158 = fdiv double %156, %127
  %159 = fadd double %157, %158
  store double %159, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %160 = fmul double %127, %127
  %161 = fmul double %160, %127
...
187:                                              ; preds = %192, %140
  %188 = phi double [ %195, %192 ], [ %.promoted22, %140 ]
...
204:                                              ; preds = %187
  store double %188, ptr %1, align 1
  ...
  %233 = call double @llvm.fmuladd.f64(double %232, double %190, double %230)
...
258:                                              ; preds = %262, %204
  %259 = phi double [ %265, %262 ], [ %.promoted24, %204 ]
...
274:                                              ; preds = %258
  store double %259, ptr %1, align 1
  ...
  %301 = call double @llvm.fmuladd.f64(double %300, double %260, double %299)
...
342:                                              ; preds = %346, %274
  %343 = phi double [ %349, %346 ], [ %.promoted26, %274 ]
...
366:                                              ; preds = %342
  store double %343, ptr %1, align 1
  ...
  %406 = call double @llvm.fmuladd.f64(double %405, double %344, double %403)
...
433:                                              ; preds = %437, %366
  %434 = phi double [ %440, %437 ], [ %.promoted28, %366 ]
...
456:                                              ; preds = %433
  store double %434, ptr %1, align 1
  ...
  %496 = call double @llvm.fmuladd.f64(double %495, double %435, double %493)
...
525:                                              ; preds = %508
  ...
  %546 = fmul nnan double %506, 1.800000e+01
  %547 = load double, ptr @two, align 8
  %548 = call double @llvm.fmuladd.f64(double %547, double %509, double %545)
...
582:                                              ; preds = %586, %525
  ...
  %.not10.not = icmp slt i32 %585, %555
  br i1 %.not10.not, label %586, label %606
...
586:                                              ; preds = %582
  ...
  %605 = add nuw nsw i32 %585, 1
  br label %582, !llvm.loop !18

606:                                              ; preds = %582
  store double %583, ptr %1, align 1
  ...
  %647 = call double @llvm.fmuladd.f64(double %646, double %584, double %644)
