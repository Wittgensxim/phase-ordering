...
define dso_local i32 @main() #0 {
  ...
  br i1 %6, label %.lr.ph33, label %.loopexit

.lr.ph33:                                         ; preds = %0
  br label %14

7:                                                ; preds = %41
  %8 = phi double [ %.lcssa23, %41 ]
  %9 = phi double [ %19, %41 ]
  %10 = phi i32 [ %16, %41 ]
  %11 = phi double [ %43, %41 ]
...
14:                                               ; preds = %.lr.ph33, %7
  ...
  %.not.not31 = icmp slt i32 1, %16
  br i1 %.not.not31, label %.lr.ph, label %41
...
41:                                               ; preds = %._crit_edge, %14
  %.lcssa23 = phi double [ %split, %._crit_edge ], [ 0.000000e+00, %14 ]
...
45:                                               ; preds = %41
  %.lcssa30 = phi double [ %19, %41 ]
  %.lcssa23.lcssa = phi double [ %.lcssa23, %41 ]
  br label %46

..loopexit_crit_edge:                             ; preds = %7
  %split34 = phi double [ %8, %7 ]
  %split35 = phi double [ %9, %7 ]
  %split36 = phi i32 [ %10, %7 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %0
  %.lcssa28 = phi double [ %split34, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa26 = phi double [ %split35, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa24 = phi i32 [ %split36, %..loopexit_crit_edge ], [ 15625, %0 ]
  br label %46

46:                                               ; preds = %.loopexit, %45
  %47 = phi double [ %.lcssa23.lcssa, %45 ], [ %.lcssa28, %.loopexit ]
  %48 = phi double [ %.lcssa30, %45 ], [ %.lcssa26, %.loopexit ]
  %49 = phi i32 [ 512000000, %45 ], [ %.lcssa24, %.loopexit ]
...
61:                                               ; preds = %60, %54
  ...
  %.not37 = icmp sgt i32 1, %90
  br i1 %.not37, label %109, label %.lr.ph39

.lr.ph39:                                         ; preds = %61
  br label %102

102:                                              ; preds = %.lr.ph39, %102
  %103 = phi i32 [ 1, %.lr.ph39 ], [ %108, %102 ]
  %104 = phi double [ %98, %.lr.ph39 ], [ %105, %102 ]
  %105 = fneg double %104
  ...
  br i1 %.not, label %._crit_edge40, label %102, !llvm.loop !11

._crit_edge40:                                    ; preds = %102
  %split41 = phi double [ %105, %102 ]
  br label %109

109:                                              ; preds = %._crit_edge40, %61
  %.lcssa22 = phi double [ %split41, %._crit_edge40 ], [ %98, %61 ]
...
116:                                              ; preds = %115, %109
  ...
  %.not442 = icmp sgt i32 1, %90
  br i1 %.not442, label %138, label %.lr.ph44

.lr.ph44:                                         ; preds = %116
  br label %120

120:                                              ; preds = %.lr.ph44, %120
  %121 = phi i32 [ 1, %.lr.ph44 ], [ %137, %120 ]
  %122 = phi double [ 0.000000e+00, %.lr.ph44 ], [ %132, %120 ]
  %123 = phi double [ 0.000000e+00, %.lr.ph44 ], [ %133, %120 ]
  %124 = phi double [ %.lcssa22, %.lr.ph44 ], [ %126, %120 ]
  %125 = phi double [ %118, %.lr.ph44 ], [ %130, %120 ]
  %126 = fneg double %124
  ...
  br i1 %.not4, label %._crit_edge45, label %120, !llvm.loop !12

._crit_edge45:                                    ; preds = %120
  %split46 = phi double [ %133, %120 ]
  %split47 = phi double [ %132, %120 ]
  br label %138

138:                                              ; preds = %._crit_edge45, %116
  %.lcssa21 = phi double [ %split46, %._crit_edge45 ], [ 0.000000e+00, %116 ]
  %.lcssa20 = phi double [ %split47, %._crit_edge45 ], [ 0.000000e+00, %116 ]
  ...
  %156 = fdiv double %154, %.lcssa21
  %157 = fadd double %155, %156
  store double %157, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %158 = fmul double %.lcssa21, %.lcssa21
  %159 = fmul double %158, %.lcssa21
  ...
  %.not5.not48 = icmp slt i32 1, %150
  br i1 %.not5.not48, label %.lr.ph50, label %200

.lr.ph50:                                         ; preds = %138
  br label %176

176:                                              ; preds = %.lr.ph50, %176
  %177 = phi i32 [ 1, %.lr.ph50 ], [ %199, %176 ]
  %178 = phi double [ 0.000000e+00, %.lr.ph50 ], [ %198, %176 ]
  %179 = phi double [ 0.000000e+00, %.lr.ph50 ], [ %181, %176 ]
  ...
  br i1 %.not5.not, label %176, label %._crit_edge51, !llvm.loop !13

._crit_edge51:                                    ; preds = %176
  %split52 = phi double [ %198, %176 ]
  br label %200

200:                                              ; preds = %._crit_edge51, %138
  %.lcssa19 = phi double [ %split52, %._crit_edge51 ], [ 0.000000e+00, %138 ]
  ...
  %229 = call double @llvm.fmuladd.f64(double %228, double %.lcssa19, double %226)
  ...
  %.not6.not53 = icmp slt i32 1, %150
  br i1 %.not6.not53, label %.lr.ph55, label %268

.lr.ph55:                                         ; preds = %200
  br label %247

247:                                              ; preds = %.lr.ph55, %247
  %248 = phi i32 [ 1, %.lr.ph55 ], [ %267, %247 ]
  %249 = phi double [ 0.000000e+00, %.lr.ph55 ], [ %266, %247 ]
  ...
  br i1 %.not6.not, label %247, label %._crit_edge56, !llvm.loop !14

._crit_edge56:                                    ; preds = %247
  %split57 = phi double [ %266, %247 ]
  br label %268

268:                                              ; preds = %._crit_edge56, %200
  %.lcssa18 = phi double [ %split57, %._crit_edge56 ], [ 0.000000e+00, %200 ]
  ...
  %295 = call double @llvm.fmuladd.f64(double %294, double %.lcssa18, double %293)
  ...
  %.not7.not58 = icmp slt i32 1, %150
  br i1 %.not7.not58, label %.lr.ph60, label %358

.lr.ph60:                                         ; preds = %268
  br label %323

323:                                              ; preds = %.lr.ph60, %323
  %324 = phi i32 [ 1, %.lr.ph60 ], [ %357, %323 ]
  %325 = phi double [ 0.000000e+00, %.lr.ph60 ], [ %356, %323 ]
  ...
  br i1 %.not7.not, label %323, label %._crit_edge61, !llvm.loop !15

._crit_edge61:                                    ; preds = %323
  %split62 = phi double [ %356, %323 ]
  br label %358

358:                                              ; preds = %._crit_edge61, %268
  %.lcssa17 = phi double [ %split62, %._crit_edge61 ], [ 0.000000e+00, %268 ]
  ...
  %398 = call double @llvm.fmuladd.f64(double %397, double %.lcssa17, double %395)
  ...
  %.not8.not63 = icmp slt i32 1, %150
  br i1 %.not8.not63, label %.lr.ph65, label %446

.lr.ph65:                                         ; preds = %358
  br label %412

412:                                              ; preds = %.lr.ph65, %412
  %413 = phi i32 [ 1, %.lr.ph65 ], [ %445, %412 ]
  %414 = phi double [ 0.000000e+00, %.lr.ph65 ], [ %444, %412 ]
  ...
  br i1 %.not8.not, label %412, label %._crit_edge66, !llvm.loop !16

._crit_edge66:                                    ; preds = %412
  %split67 = phi double [ %444, %412 ]
  br label %446

446:                                              ; preds = %._crit_edge66, %358
  %.lcssa16 = phi double [ %split67, %._crit_edge66 ], [ 0.000000e+00, %358 ]
  ...
  %486 = call double @llvm.fmuladd.f64(double %485, double %.lcssa16, double %483)
  ...
  %.not9.not68 = icmp slt i32 1, %150
  br i1 %.not9.not68, label %.lr.ph70, label %515

.lr.ph70:                                         ; preds = %446
  br label %498

498:                                              ; preds = %.lr.ph70, %498
  %499 = phi i32 [ 1, %.lr.ph70 ], [ %514, %498 ]
  %500 = phi double [ 0.000000e+00, %.lr.ph70 ], [ %513, %498 ]
  ...
  br i1 %.not9.not, label %498, label %._crit_edge71, !llvm.loop !17

._crit_edge71:                                    ; preds = %498
  %split72 = phi double [ %513, %498 ]
  br label %515

515:                                              ; preds = %._crit_edge71, %446
  %.lcssa15 = phi double [ %split72, %._crit_edge71 ], [ 0.000000e+00, %446 ]
  ...
  %538 = call double @llvm.fmuladd.f64(double %537, double %.lcssa15, double %535)
  ...
  %.not10.not73 = icmp slt i32 1, %545
  br i1 %.not10.not73, label %.lr.ph75, label %594

.lr.ph75:                                         ; preds = %515
  br label %559

559:                                              ; preds = %.lr.ph75, %559
  %560 = phi i32 [ 1, %.lr.ph75 ], [ %593, %559 ]
  %561 = phi double [ 0.000000e+00, %.lr.ph75 ], [ %592, %559 ]
  ...
  br i1 %.not10.not, label %559, label %._crit_edge76, !llvm.loop !18

._crit_edge76:                                    ; preds = %559
  %split77 = phi double [ %592, %559 ]
  br label %594

594:                                              ; preds = %._crit_edge76, %515
  %.lcssa = phi double [ %split77, %._crit_edge76 ], [ 0.000000e+00, %515 ]
