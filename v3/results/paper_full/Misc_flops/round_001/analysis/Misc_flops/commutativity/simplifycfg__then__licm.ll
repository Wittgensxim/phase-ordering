...
43:                                               ; preds = %39, %5
  %44 = phi double [ %6, %5 ], [ %15, %39 ]
  %45 = phi double [ %7, %5 ], [ %.lcssa9, %39 ]
  %46 = phi double [ %8, %5 ], [ %17, %39 ]
  %47 = phi i32 [ %9, %5 ], [ 512000000, %39 ]
...
107:                                              ; preds = %99
  ...
  %sa.promoted10 = load double, ptr @sa, align 8
  %.promoted11 = load double, ptr %1, align 8
  br label %117

117:                                              ; preds = %125, %107
  %118 = phi double [ %133, %125 ], [ %.promoted11, %107 ]
  %119 = phi double [ %127, %125 ], [ %sa.promoted10, %107 ]
...
135:                                              ; preds = %117
  %.lcssa12 = phi double [ %118, %117 ]
  %.lcssa7 = phi double [ %122, %117 ]
  %.lcssa6 = phi double [ %123, %117 ]
  store double %.lcssa12, ptr %1, align 8
  ...
  %.promoted13 = load double, ptr %1, align 1
  br label %182

182:                                              ; preds = %187, %135
  %183 = phi double [ %190, %187 ], [ %.promoted13, %135 ]
...
199:                                              ; preds = %182
  %.lcssa14 = phi double [ %183, %182 ]
  %.lcssa5 = phi double [ %185, %182 ]
  store double %.lcssa14, ptr %1, align 1
  ...
  %.promoted15 = load double, ptr %1, align 1
  br label %253

253:                                              ; preds = %257, %199
  %254 = phi double [ %260, %257 ], [ %.promoted15, %199 ]
...
269:                                              ; preds = %253
  %.lcssa16 = phi double [ %254, %253 ]
  %.lcssa4 = phi double [ %255, %253 ]
  store double %.lcssa16, ptr %1, align 1
  ...
  %.promoted17 = load double, ptr %1, align 1
  br label %337

337:                                              ; preds = %341, %269
  %338 = phi double [ %344, %341 ], [ %.promoted17, %269 ]
...
361:                                              ; preds = %337
  ...
  %.promoted19 = load double, ptr %1, align 1
  br label %428

428:                                              ; preds = %432, %361
  %429 = phi double [ %435, %432 ], [ %.promoted19, %361 ]
...
451:                                              ; preds = %428
  %.lcssa20 = phi double [ %429, %428 ]
  %.lcssa2 = phi double [ %430, %428 ]
  store double %.lcssa20, ptr %1, align 1
...
578:                                              ; preds = %582, %521
  %579 = phi double [ %585, %582 ], [ %.promoted21, %521 ]
