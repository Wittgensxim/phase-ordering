...
97:                                               ; preds = %100, %55
  ...
  %exitcond21 = icmp eq i32 %99, %96
  br i1 %exitcond21, label %105, label %100
...
112:                                              ; preds = %111, %105
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %84, i32 0)
  %116 = add nuw i32 %smax22, 1
  br label %117

117:                                              ; preds = %123, %112
  %.0 = phi double [ 0.000000e+00, %112 ], [ %133, %123 ]
  %118 = phi double [ %128, %123 ], [ %114, %112 ]
  %119 = phi double [ %124, %123 ], [ %.lcssa12, %112 ]
  %120 = phi double [ %131, %123 ], [ 0.000000e+00, %112 ]
  %121 = phi double [ %130, %123 ], [ 0.000000e+00, %112 ]
  %122 = phi i32 [ %134, %123 ], [ 1, %112 ]
  %exitcond23 = icmp eq i32 %122, %116
  br i1 %exitcond23, label %135, label %123
...
123:                                              ; preds = %117
  ...
  %133 = fsub double %.0, %132
  %134 = add nuw i32 %122, 1
  br label %117, !llvm.loop !12

135:                                              ; preds = %117
  %.0.lcssa = phi double [ %.0, %117 ]
  %.lcssa11 = phi double [ %120, %117 ]
  %.lcssa10 = phi double [ %121, %117 ]
  ...
  %smax24 = call i32 @llvm.smax.i32(i32 %147, i32 1)
  br label %172
...
172:                                              ; preds = %176, %135
  ...
  %exitcond25 = icmp ne i32 %175, %smax24
  br i1 %exitcond25, label %176, label %197
...
197:                                              ; preds = %172
  ...
  %226 = call double @llvm.fmuladd.f64(double %225, double %.lcssa9, double %223)
...
244:                                              ; preds = %247, %197
  ...
  %exitcond26 = icmp ne i32 %246, %smax24
  br i1 %exitcond26, label %247, label %266
...
266:                                              ; preds = %244
  ...
  %293 = call double @llvm.fmuladd.f64(double %292, double %.lcssa8, double %291)
...
321:                                              ; preds = %324, %266
  ...
  %exitcond27 = icmp ne i32 %323, %smax24
  br i1 %exitcond27, label %324, label %357
...
357:                                              ; preds = %321
  ...
  %397 = call double @llvm.fmuladd.f64(double %396, double %.lcssa7, double %394)
...
411:                                              ; preds = %414, %357
  ...
  %exitcond28 = icmp ne i32 %413, %smax24
  br i1 %exitcond28, label %414, label %446
...
446:                                              ; preds = %411
  ...
  %486 = call double @llvm.fmuladd.f64(double %485, double %.lcssa6, double %483)
...
498:                                              ; preds = %501, %446
  ...
  %exitcond29 = icmp ne i32 %500, %smax24
  br i1 %exitcond29, label %501, label %515
...
515:                                              ; preds = %498
  ...
  %537 = call double @llvm.fmuladd.f64(double %536, double %.lcssa5, double %534)
  ...
  %smax30 = call i32 @llvm.smax.i32(i32 %544, i32 1)
  br label %558

558:                                              ; preds = %561, %515
  %559 = phi double [ %592, %561 ], [ 0.000000e+00, %515 ]
  %560 = phi i32 [ %593, %561 ], [ 1, %515 ]
  %exitcond31 = icmp ne i32 %560, %smax30
  br i1 %exitcond31, label %561, label %594
