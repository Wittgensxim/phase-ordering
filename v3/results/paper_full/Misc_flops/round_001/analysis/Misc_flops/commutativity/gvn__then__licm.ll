...
define dso_local i32 @main() #0 {
  ...
  %.promoted = load double, ptr %1, align 1
  br label %5

5:                                                ; preds = %44, %0
  %6 = phi double [ %15, %44 ], [ %.promoted, %0 ]
  %7 = phi double [ %.lcssa10, %44 ], [ undef, %0 ]
...
43:                                               ; preds = %39
  %.lcssa19 = phi double [ %15, %39 ]
  %.lcssa17 = phi double [ %17, %39 ]
  %.lcssa10.lcssa = phi double [ %.lcssa10, %39 ]
  store double %.lcssa19, ptr %1, align 1
  br label %45
...
.loopexit:                                        ; preds = %5
  %.lcssa18 = phi double [ %6, %5 ]
  %.lcssa15 = phi double [ %7, %5 ]
  %.lcssa13 = phi double [ %8, %5 ]
  %.lcssa11 = phi i32 [ %9, %5 ]
  store double %.lcssa18, ptr %1, align 1
  br label %45

45:                                               ; preds = %.loopexit, %43
  %46 = phi double [ %.lcssa10.lcssa, %43 ], [ %.lcssa15, %.loopexit ]
  %47 = phi double [ %.lcssa17, %43 ], [ %.lcssa13, %.loopexit ]
  %48 = phi i32 [ 512000000, %43 ], [ %.lcssa11, %.loopexit ]
...
117:                                              ; preds = %116, %110
  ...
  %sa.promoted20 = load double, ptr @sa, align 8
  %.promoted21 = load double, ptr %1, align 1
  br label %122

122:                                              ; preds = %131, %117
  %123 = phi double [ %139, %131 ], [ %.promoted21, %117 ]
  %124 = phi double [ %133, %131 ], [ %sa.promoted20, %117 ]
  %125 = phi double [ %139, %131 ], [ 0.000000e+00, %117 ]
  %126 = phi double [ %134, %131 ], [ %119, %117 ]
  %127 = phi double [ %132, %131 ], [ %.lcssa9, %117 ]
  %128 = phi double [ %137, %131 ], [ 0.000000e+00, %117 ]
  %129 = phi double [ %136, %131 ], [ 0.000000e+00, %117 ]
  %130 = phi i32 [ %140, %131 ], [ 1, %117 ]
  %.not4 = icmp sgt i32 %130, %90
  br i1 %.not4, label %141, label %131

131:                                              ; preds = %122
  %132 = fneg double %127
  %133 = fsub double %124, %127
  store double %133, ptr @sa, align 8
  %134 = fadd double %126, %121
  %135 = fsub double %132, %134
  %136 = fadd double %129, %135
  %137 = call double @llvm.fmuladd.f64(double %127, double %134, double %128)
...
141:                                              ; preds = %122
  %.lcssa22 = phi double [ %123, %122 ]
  %.lcssa8 = phi double [ %125, %122 ]
  %.lcssa7 = phi double [ %128, %122 ]
  %.lcssa6 = phi double [ %129, %122 ]
  store double %.lcssa22, ptr %1, align 1
  %142 = call i32 @dtime(ptr noundef nonnull @TimeArray)
  %143 = load double, ptr getelementptr inbounds nuw (i8, ptr @T, i64 8), align 8
  %144 = load double, ptr getelementptr inbounds nuw (i8, ptr @TimeArray, i64 8), align 8
  %145 = fmul double %143, %144
  store double %145, ptr getelementptr inbounds nuw (i8, ptr @T, i64 48), align 16
  %146 = load double, ptr getelementptr inbounds nuw (i8, ptr @T, i64 40), align 8
  %147 = fsub double %145, %146
  %148 = fdiv double %147, 7.000000e+00
  store double %148, ptr getelementptr inbounds nuw (i8, ptr @T, i64 56), align 8
  %149 = load double, ptr @sa, align 8
  %150 = fmul double %149, %.lcssa6
  %151 = load double, ptr @sc, align 8
  %152 = fdiv double %150, %151
  %153 = fptosi double %152 to i32
  store i32 %153, ptr %2, align 4
  %154 = load double, ptr @four, align 8
  %155 = fmul double %154, %.lcssa8
  %156 = load double, ptr @five, align 8
  %157 = fdiv double %155, %156
  store double %157, ptr @sa, align 8
  %158 = fdiv double %156, %.lcssa7
  %159 = fadd double %157, %158
  store double %159, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %160 = fmul double %.lcssa7, %.lcssa7
  %161 = fmul double %160, %.lcssa7
  ...
  %.promoted23 = load double, ptr %1, align 1
  br label %187

187:                                              ; preds = %192, %141
  %188 = phi double [ %195, %192 ], [ %.promoted23, %141 ]
  %189 = phi double [ %193, %192 ], [ 0.000000e+00, %141 ]
  %190 = phi double [ %202, %192 ], [ 0.000000e+00, %141 ]
  %191 = phi i32 [ %203, %192 ], [ 1, %141 ]
  %.not5.not = icmp slt i32 %191, %153
...
204:                                              ; preds = %187
  %.lcssa24 = phi double [ %188, %187 ]
  %.lcssa5 = phi double [ %190, %187 ]
  store double %.lcssa24, ptr %1, align 1
  ...
  %233 = call double @llvm.fmuladd.f64(double %232, double %.lcssa5, double %230)
  ...
  %.promoted25 = load double, ptr %1, align 1
  br label %258

258:                                              ; preds = %262, %204
  %259 = phi double [ %265, %262 ], [ %.promoted25, %204 ]
  %260 = phi double [ %272, %262 ], [ 0.000000e+00, %204 ]
  %261 = phi i32 [ %273, %262 ], [ 1, %204 ]
  %.not6.not = icmp slt i32 %261, %153
...
274:                                              ; preds = %258
  %.lcssa26 = phi double [ %259, %258 ]
  %.lcssa4 = phi double [ %260, %258 ]
  store double %.lcssa26, ptr %1, align 1
  ...
  %301 = call double @llvm.fmuladd.f64(double %300, double %.lcssa4, double %299)
  ...
  %.promoted27 = load double, ptr %1, align 1
  br label %342

342:                                              ; preds = %346, %274
  %343 = phi double [ %349, %346 ], [ %.promoted27, %274 ]
  %344 = phi double [ %364, %346 ], [ 0.000000e+00, %274 ]
  %345 = phi i32 [ %365, %346 ], [ 1, %274 ]
  %.not7.not = icmp slt i32 %345, %153
...
366:                                              ; preds = %342
  %.lcssa28 = phi double [ %343, %342 ]
  %.lcssa3 = phi double [ %344, %342 ]
  store double %.lcssa28, ptr %1, align 1
  ...
  %406 = call double @llvm.fmuladd.f64(double %405, double %.lcssa3, double %403)
  ...
  %.promoted29 = load double, ptr %1, align 1
  br label %433

433:                                              ; preds = %437, %366
  %434 = phi double [ %440, %437 ], [ %.promoted29, %366 ]
  %435 = phi double [ %454, %437 ], [ 0.000000e+00, %366 ]
  %436 = phi i32 [ %455, %437 ], [ 1, %366 ]
  %.not8.not = icmp slt i32 %436, %153
...
456:                                              ; preds = %433
  %.lcssa30 = phi double [ %434, %433 ]
  %.lcssa2 = phi double [ %435, %433 ]
  store double %.lcssa30, ptr %1, align 1
  ...
  %496 = call double @llvm.fmuladd.f64(double %495, double %.lcssa2, double %493)
...
508:                                              ; preds = %511, %456
  %509 = phi double [ %523, %511 ], [ 0.000000e+00, %456 ]
  %510 = phi i32 [ %524, %511 ], [ 1, %456 ]
  %.not9.not = icmp slt i32 %510, %153
  br i1 %.not9.not, label %511, label %525

511:                                              ; preds = %508
  %512 = uitofp nneg i32 %510 to double
  %513 = fmul double %506, %512
  %514 = fmul double %513, %513
  %515 = fadd double %513, %505
  %516 = fdiv double %505, %515
  %517 = fsub double %509, %516
  %518 = fadd double %514, %505
  %519 = fdiv double %513, %518
  %520 = fsub double %517, %519
  %521 = call double @llvm.fmuladd.f64(double %513, double %514, double %505)
  %522 = fdiv double %514, %521
  %523 = fsub double %520, %522
  %524 = add nuw nsw i32 %510, 1
...
525:                                              ; preds = %508
  ...
  %535 = fneg double %505
  %536 = fadd double %533, %505
  %537 = fdiv double %505, %536
  %538 = fsub double %535, %537
  %539 = fadd double %534, %505
  %540 = fdiv double %533, %539
  %541 = fsub double %538, %540
  %542 = call double @llvm.fmuladd.f64(double %533, double %534, double %505)
  %543 = fdiv double %534, %542
  %544 = fsub double %541, %543
  store double %544, ptr @sa, align 8
  %545 = fmul nnan double %506, 1.800000e+01
  %546 = load double, ptr @two, align 8
  %547 = call double @llvm.fmuladd.f64(double %546, double %.lcssa1, double %544)
  %548 = fmul double %545, %547
  store double %548, ptr @sa, align 8
  %549 = fptosi double %548 to i32
  %550 = mul nsw i32 %549, -2000
  store i32 %550, ptr %2, align 4
  %551 = sitofp i32 %550 to double
  %552 = load double, ptr @scale, align 8
  %553 = fdiv double %551, %552
  %554 = fptosi double %553 to i32
  store i32 %554, ptr %2, align 4
  %555 = fadd double %548, 5.002000e+02
  store double %555, ptr @sc, align 8
  %556 = load double, ptr @one, align 8
  %557 = fdiv double %556, %532
  store double %557, ptr getelementptr inbounds nuw (i8, ptr @T, i64 184), align 8
  %558 = fmul double %555, 1.000000e-30
  %559 = fmul double %531, 1.000000e-30
  %560 = fmul double %557, 1.000000e-30
  %561 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.10, double noundef %558, double noundef %559, double noundef %560) #4
  %562 = load double, ptr @piref, align 8
  %563 = load double, ptr @three, align 8
  %564 = sitofp i32 %554 to double
  %565 = fmul double %563, %564
  %566 = fdiv double %562, %565
  %567 = call i32 @dtime(ptr noundef nonnull @TimeArray)
  ...
  %579 = load double, ptr @A2, align 8
  %580 = load double, ptr @A1, align 8
  %.promoted31 = load double, ptr %1, align 1
  br label %581

581:                                              ; preds = %585, %525
  %582 = phi double [ %588, %585 ], [ %.promoted31, %525 ]
  %583 = phi double [ %603, %585 ], [ 0.000000e+00, %525 ]
  %584 = phi i32 [ %604, %585 ], [ 1, %525 ]
  %.not10.not = icmp slt i32 %584, %554
  br i1 %.not10.not, label %585, label %605

585:                                              ; preds = %581
  %586 = uitofp nneg i32 %584 to double
  %587 = fmul double %566, %586
  %588 = fmul double %587, %587
  %589 = call double @llvm.fmuladd.f64(double %568, double %588, double %569)
  %590 = call double @llvm.fmuladd.f64(double %588, double %589, double %570)
  %591 = call double @llvm.fmuladd.f64(double %588, double %590, double %571)
  %592 = call double @llvm.fmuladd.f64(double %588, double %591, double %572)
  %593 = call double @llvm.fmuladd.f64(double %588, double %592, double %573)
  %594 = call double @llvm.fmuladd.f64(double %588, double %593, double %574)
  %595 = fmul double %594, %594
  %596 = fmul double %595, %587
  %597 = call double @llvm.fmuladd.f64(double %575, double %588, double %576)
  %598 = call double @llvm.fmuladd.f64(double %597, double %588, double %577)
  %599 = call double @llvm.fmuladd.f64(double %598, double %588, double %578)
  %600 = call double @llvm.fmuladd.f64(double %599, double %588, double %579)
  %601 = call double @llvm.fmuladd.f64(double %600, double %588, double %580)
  %602 = call double @llvm.fmuladd.f64(double %601, double %588, double %574)
  %603 = call double @llvm.fmuladd.f64(double %596, double %602, double %583)
  %604 = add nuw nsw i32 %584, 1
  br label %581, !llvm.loop !18

605:                                              ; preds = %581
  %.lcssa32 = phi double [ %582, %581 ]
  %.lcssa = phi double [ %583, %581 ]
  store double %.lcssa32, ptr %1, align 1
  ...
  store double %615, ptr %1, align 8
  ...
  %646 = call double @llvm.fmuladd.f64(double %645, double %.lcssa, double %643)
  %647 = fmul double %566, %646
