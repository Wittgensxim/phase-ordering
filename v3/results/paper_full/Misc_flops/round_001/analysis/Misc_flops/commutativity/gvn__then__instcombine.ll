...
17:                                               ; preds = %21, %11
  %18 = phi double [ %22, %21 ], [ 0.000000e+00, %11 ]
  %19 = phi double [ %35, %21 ], [ 0.000000e+00, %11 ]
  %20 = phi i32 [ %36, %21 ], [ 1, %11 ]
  %.not.not = icmp slt i32 %20, %12
  br i1 %.not.not, label %21, label %37

21:                                               ; preds = %17
  %22 = fadd double %18, %13
  ...
  %33 = call double @llvm.fmuladd.f64(double %23, double %32, double %13)
...
43:                                               ; preds = %41, %4
  %44 = phi double [ %19, %41 ], [ %5, %4 ]
  %45 = phi double [ %15, %41 ], [ %6, %4 ]
  %46 = phi i32 [ 512000000, %41 ], [ %7, %4 ]
...
100:                                              ; preds = %103, %59
  %101 = phi double [ %104, %103 ], [ %96, %59 ]
  %102 = phi i32 [ %107, %103 ], [ 1, %59 ]
  %.not = icmp sgt i32 %102, %88
...
119:                                              ; preds = %126, %115
  %120 = phi double [ %136, %126 ], [ 0.000000e+00, %115 ]
  %121 = phi double [ %131, %126 ], [ %117, %115 ]
  %122 = phi double [ %127, %126 ], [ %101, %115 ]
  %123 = phi double [ %134, %126 ], [ 0.000000e+00, %115 ]
  %124 = phi double [ %133, %126 ], [ 0.000000e+00, %115 ]
  %125 = phi i32 [ %137, %126 ], [ 1, %115 ]
  %.not4 = icmp sgt i32 %125, %88
  br i1 %.not4, label %138, label %126
...
175:                                              ; preds = %179, %138
  ...
  %.not5.not = icmp slt i32 %178, %150
  br i1 %.not5.not, label %179, label %200
...
200:                                              ; preds = %175
  ...
  %229 = call double @llvm.fmuladd.f64(double %228, double %177, double %226)
...
247:                                              ; preds = %250, %200
  ...
  %.not6.not = icmp slt i32 %249, %150
  br i1 %.not6.not, label %250, label %269
...
269:                                              ; preds = %247
  ...
  %296 = call double @llvm.fmuladd.f64(double %295, double %248, double %294)
...
324:                                              ; preds = %327, %269
  ...
  %.not7.not = icmp slt i32 %326, %150
  br i1 %.not7.not, label %327, label %360
...
360:                                              ; preds = %324
  ...
  %400 = call double @llvm.fmuladd.f64(double %399, double %325, double %397)
...
414:                                              ; preds = %417, %360
  ...
  %.not8.not = icmp slt i32 %416, %150
  br i1 %.not8.not, label %417, label %449
...
449:                                              ; preds = %414
  ...
  %489 = call double @llvm.fmuladd.f64(double %488, double %415, double %486)
...
501:                                              ; preds = %504, %449
  ...
  %.not9.not = icmp slt i32 %503, %150
  br i1 %.not9.not, label %504, label %518
...
518:                                              ; preds = %501
  ...
  %540 = call double @llvm.fmuladd.f64(double %539, double %502, double %537)
...
561:                                              ; preds = %564, %518
  ...
  %.not10.not = icmp slt i32 %563, %547
  br i1 %.not10.not, label %564, label %597
...
597:                                              ; preds = %561
  ...
  %638 = call double @llvm.fmuladd.f64(double %637, double %562, double %635)
