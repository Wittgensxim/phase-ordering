...
526:                                              ; preds = %509
  ...
  %549 = call double @llvm.fmuladd.f64(double %548, double %510, double %546)
...
607:                                              ; preds = %583
  store double %584, ptr %1, align 1
  ...
  %648 = call double @llvm.fmuladd.f64(double %647, double %585, double %645)
