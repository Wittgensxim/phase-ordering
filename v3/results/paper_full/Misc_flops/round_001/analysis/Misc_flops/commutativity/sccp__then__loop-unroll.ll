...
121:                                              ; preds = %127, %117
  ...
  %123 = phi double [ %128, %127 ], [ %.lcssa22, %117 ]
...
140:                                              ; preds = %121
  %.lcssa21 = phi double [ %124, %121 ]
  %.lcssa20 = phi double [ %125, %121 ]
...
203:                                              ; preds = %178
  ...
  %232 = call double @llvm.fmuladd.f64(double %231, double %.lcssa19, double %229)
...
272:                                              ; preds = %250
  ...
  %299 = call double @llvm.fmuladd.f64(double %298, double %.lcssa18, double %297)
...
363:                                              ; preds = %327
  ...
  %403 = call double @llvm.fmuladd.f64(double %402, double %.lcssa17, double %400)
...
452:                                              ; preds = %417
  ...
  %492 = call double @llvm.fmuladd.f64(double %491, double %.lcssa16, double %489)
...
522:                                              ; preds = %504
  ...
  %545 = call double @llvm.fmuladd.f64(double %544, double %.lcssa15, double %542)
