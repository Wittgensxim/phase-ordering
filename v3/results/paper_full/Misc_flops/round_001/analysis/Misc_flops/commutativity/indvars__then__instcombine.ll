...
18:                                               ; preds = %22, %12
  ...
  br i1 %exitcond.not, label %39, label %22
...
45:                                               ; preds = %.loopexit, %43
  %46 = phi double [ %20, %43 ], [ %6, %.loopexit ]
  %47 = phi double [ %16, %43 ], [ %7, %.loopexit ]
...
139:                                              ; preds = %120
  ...
  %157 = fdiv double %155, %123
  %158 = fadd double %156, %157
  store double %158, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %159 = fmul double %123, %123
  %160 = fmul double %159, %123
...
177:                                              ; preds = %181, %139
  ...
  %exitcond21.not = icmp eq i32 %180, %smax20
  br i1 %exitcond21.not, label %202, label %181
...
202:                                              ; preds = %177
  ...
  %231 = call double @llvm.fmuladd.f64(double %230, double %179, double %228)
...
249:                                              ; preds = %252, %202
  ...
  %exitcond22.not = icmp eq i32 %251, %smax20
  br i1 %exitcond22.not, label %271, label %252
...
271:                                              ; preds = %249
  ...
  %298 = call double @llvm.fmuladd.f64(double %297, double %250, double %296)
...
326:                                              ; preds = %329, %271
  ...
  %exitcond23.not = icmp eq i32 %328, %smax20
  br i1 %exitcond23.not, label %362, label %329
...
362:                                              ; preds = %326
  ...
  %402 = call double @llvm.fmuladd.f64(double %401, double %327, double %399)
...
416:                                              ; preds = %419, %362
  ...
  %exitcond24.not = icmp eq i32 %418, %smax20
  br i1 %exitcond24.not, label %451, label %419
...
451:                                              ; preds = %416
  ...
  %491 = call double @llvm.fmuladd.f64(double %490, double %417, double %488)
...
503:                                              ; preds = %506, %451
  ...
  %exitcond25.not = icmp eq i32 %505, %smax20
  br i1 %exitcond25.not, label %521, label %506
...
521:                                              ; preds = %503
  ...
  %544 = call double @llvm.fmuladd.f64(double %543, double %504, double %541)
...
565:                                              ; preds = %568, %521
  ...
  %exitcond27.not = icmp eq i32 %567, %smax26
  br i1 %exitcond27.not, label %601, label %568
...
601:                                              ; preds = %565
  ...
  %642 = call double @llvm.fmuladd.f64(double %641, double %566, double %639)
