...
98:                                               ; preds = %.lr.ph25, %98
  ...
  %.not = icmp sgt i32 %104, %86
  br i1 %.not, label %._crit_edge26, label %98, !llvm.loop !11
...
112:                                              ; preds = %111, %105
  ...
  br i1 %.not23, label %134, label %.lr.ph30
...
116:                                              ; preds = %.lr.ph30, %116
  ...
  %.not4 = icmp sgt i32 %133, %86
  br i1 %.not4, label %._crit_edge31, label %116, !llvm.loop !12
...
196:                                              ; preds = %._crit_edge37, %134
  ...
  br i1 %.not5.not34, label %.lr.ph41, label %264
...
264:                                              ; preds = %._crit_edge42, %196
  ...
  br i1 %.not5.not34, label %.lr.ph46, label %354
...
354:                                              ; preds = %._crit_edge47, %264
  ...
  br i1 %.not5.not34, label %.lr.ph51, label %442
...
442:                                              ; preds = %._crit_edge52, %354
  ...
  br i1 %.not5.not34, label %.lr.ph56, label %511
...
511:                                              ; preds = %._crit_edge57, %442
  ...
  %.not10.not59 = icmp slt i32 1, %541
