...
121:                                              ; preds = %127, %117
  ...
  %123 = phi double [ %128, %127 ], [ %.lcssa8, %117 ]
...
140:                                              ; preds = %121
  %.lcssa7 = phi double [ %124, %121 ]
  %.lcssa6 = phi double [ %125, %121 ]
...
272:                                              ; preds = %250
  ...
  %297 = fadd double %294, %295
  %298 = load double, ptr @two, align 8
  %299 = call double @llvm.fmuladd.f64(double %298, double %.lcssa4, double %297)
...
452:                                              ; preds = %417
  ...
  %492 = call double @llvm.fmuladd.f64(double %491, double %.lcssa2, double %489)
...
522:                                              ; preds = %504
  ...
  %545 = call double @llvm.fmuladd.f64(double %544, double %.lcssa1, double %542)
