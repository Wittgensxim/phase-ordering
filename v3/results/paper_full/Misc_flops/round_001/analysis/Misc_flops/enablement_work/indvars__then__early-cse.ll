...
119:                                              ; preds = %125, %115
  %120 = phi double [ %130, %125 ], [ %117, %115 ]
  %121 = phi double [ %126, %125 ], [ %101, %115 ]
  %122 = phi double [ %133, %125 ], [ 0.000000e+00, %115 ]
  %123 = phi double [ %132, %125 ], [ 0.000000e+00, %115 ]
  %124 = phi i32 [ %137, %125 ], [ 1, %115 ]
  %exitcond19 = icmp eq i32 %124, %99
...
138:                                              ; preds = %119
  ...
  %156 = fdiv double %154, %122
  %157 = fadd double %155, %156
  store double %157, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %158 = fmul double %122, %122
  %159 = fmul double %158, %122
...
520:                                              ; preds = %502
  ...
  %543 = call double @llvm.fmuladd.f64(double %542, double %503, double %540)
...
600:                                              ; preds = %564
  ...
  %641 = call double @llvm.fmuladd.f64(double %640, double %565, double %638)
