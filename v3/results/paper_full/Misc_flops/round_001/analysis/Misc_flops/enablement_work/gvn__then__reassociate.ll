...
505:                                              ; preds = %502
  ...
  %509 = fadd double %499, %507
  %510 = fdiv double %499, %509
  %511 = fsub double %503, %510
  %512 = fadd double %499, %508
...
519:                                              ; preds = %502
  ...
  %529 = fneg double %499
  %530 = fadd double %499, %527
  %531 = fdiv double %499, %530
  %532 = fsub double %529, %531
  %533 = fadd double %499, %528
