...
45:                                               ; preds = %.loopexit, %43
  ...
  %48 = phi i32 [ 512000000, %43 ], [ %.lcssa10, %.loopexit ]
...
122:                                              ; preds = %130, %117
  %123 = phi double [ %138, %130 ], [ %.promoted20, %117 ]
  %124 = phi double [ %132, %130 ], [ %sa.promoted19, %117 ]
  %125 = phi double [ %133, %130 ], [ %119, %117 ]
  %126 = phi double [ %131, %130 ], [ %.lcssa8, %117 ]
...
140:                                              ; preds = %122
  %.lcssa21 = phi double [ %123, %122 ]
  %.lcssa7 = phi double [ %127, %122 ]
  %.lcssa6 = phi double [ %128, %122 ]
...
192:                                              ; preds = %187
  %193 = fadd double %178, %189
  %194 = fmul double %176, %193
...
512:                                              ; preds = %509
  ...
  %516 = fadd double %508, %514
  %517 = fdiv double %508, %516
  %518 = fsub double %510, %517
  %519 = fadd double %508, %515
...
526:                                              ; preds = %509
  ...
  %549 = call double @llvm.fmuladd.f64(double %548, double %.lcssa1, double %546)
...
583:                                              ; preds = %587, %526
  %584 = phi double [ %590, %587 ], [ %.promoted30, %526 ]
