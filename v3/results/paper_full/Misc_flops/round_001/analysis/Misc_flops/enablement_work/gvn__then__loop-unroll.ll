...
44:                                               ; preds = %.loopexit, %42
  ...
  %47 = phi i32 [ 512000000, %42 ], [ %.lcssa11, %.loopexit ]
...
120:                                              ; preds = %127, %116
  ...
  %123 = phi double [ %128, %127 ], [ %.lcssa9, %116 ]
...
139:                                              ; preds = %120
  %.lcssa8 = phi double [ %121, %120 ]
  %.lcssa7 = phi double [ %124, %120 ]
  %.lcssa6 = phi double [ %125, %120 ]
...
519:                                              ; preds = %502
  ...
  %541 = call double @llvm.fmuladd.f64(double %540, double %.lcssa1, double %538)
...
598:                                              ; preds = %562
  ...
  %639 = call double @llvm.fmuladd.f64(double %638, double %.lcssa, double %636)
