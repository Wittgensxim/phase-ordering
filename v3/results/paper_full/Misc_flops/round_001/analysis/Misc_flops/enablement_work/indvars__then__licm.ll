...
43:                                               ; preds = %39
  %.lcssa29 = phi double [ %15, %39 ]
  %.lcssa16 = phi double [ %17, %39 ]
  %.lcssa9.lcssa = phi double [ %.lcssa9, %39 ]
  store double %.lcssa29, ptr %1, align 8
  br label %45
...
.loopexit:                                        ; preds = %5
  %.lcssa28 = phi double [ %6, %5 ]
  %.lcssa14 = phi double [ %7, %5 ]
  %.lcssa12 = phi double [ %8, %5 ]
  store double %.lcssa28, ptr %1, align 8
  br label %45
...
100:                                              ; preds = %104, %58
  ...
  %exitcond17 = icmp eq i32 %103, %99
  br i1 %exitcond17, label %108, label %104
...
115:                                              ; preds = %114, %108
  ...
  %.promoted31 = load double, ptr %1, align 8
  br label %121

121:                                              ; preds = %129, %115
  %122 = phi double [ %137, %129 ], [ %.promoted31, %115 ]
  %123 = phi double [ %131, %129 ], [ %sa.promoted30, %115 ]
  ...
  %exitcond19 = icmp eq i32 %128, %119
  br i1 %exitcond19, label %139, label %129

129:                                              ; preds = %121
  %130 = fneg double %125
  %131 = fsub double %123, %125
  store double %131, ptr @sa, align 8
  %132 = fadd double %124, %120
...
139:                                              ; preds = %121
  ...
  %.promoted33 = load double, ptr %1, align 1
  br label %186

186:                                              ; preds = %191, %139
  %187 = phi double [ %194, %191 ], [ %.promoted33, %139 ]
  %188 = phi double [ %192, %191 ], [ 0.000000e+00, %139 ]
  %189 = phi double [ %201, %191 ], [ 0.000000e+00, %139 ]
  %190 = phi i32 [ %202, %191 ], [ 1, %139 ]
  %exitcond21 = icmp ne i32 %190, %smax20
  br i1 %exitcond21, label %191, label %203
...
203:                                              ; preds = %186
  %.lcssa34 = phi double [ %187, %186 ]
  %.lcssa5 = phi double [ %189, %186 ]
  store double %.lcssa34, ptr %1, align 1
  ...
  %.promoted35 = load double, ptr %1, align 1
  br label %257

257:                                              ; preds = %261, %203
  %258 = phi double [ %264, %261 ], [ %.promoted35, %203 ]
  %259 = phi double [ %271, %261 ], [ 0.000000e+00, %203 ]
  %260 = phi i32 [ %272, %261 ], [ 1, %203 ]
  %exitcond22 = icmp ne i32 %260, %smax20
  br i1 %exitcond22, label %261, label %273
...
273:                                              ; preds = %257
  %.lcssa36 = phi double [ %258, %257 ]
  %.lcssa4 = phi double [ %259, %257 ]
  store double %.lcssa36, ptr %1, align 1
  ...
  %.promoted37 = load double, ptr %1, align 1
  br label %341

341:                                              ; preds = %345, %273
  %342 = phi double [ %348, %345 ], [ %.promoted37, %273 ]
  %343 = phi double [ %363, %345 ], [ 0.000000e+00, %273 ]
  %344 = phi i32 [ %364, %345 ], [ 1, %273 ]
  %exitcond23 = icmp ne i32 %344, %smax20
  br i1 %exitcond23, label %345, label %365
...
365:                                              ; preds = %341
  %.lcssa38 = phi double [ %342, %341 ]
  %.lcssa3 = phi double [ %343, %341 ]
  store double %.lcssa38, ptr %1, align 1
  ...
  %.promoted39 = load double, ptr %1, align 1
  br label %432

432:                                              ; preds = %436, %365
  %433 = phi double [ %439, %436 ], [ %.promoted39, %365 ]
  %434 = phi double [ %453, %436 ], [ 0.000000e+00, %365 ]
  %435 = phi i32 [ %454, %436 ], [ 1, %365 ]
  %exitcond24 = icmp ne i32 %435, %smax20
  br i1 %exitcond24, label %436, label %455
...
455:                                              ; preds = %432
  %.lcssa40 = phi double [ %433, %432 ]
  %.lcssa2 = phi double [ %434, %432 ]
  store double %.lcssa40, ptr %1, align 1
...
508:                                              ; preds = %511, %455
  ...
  %exitcond25 = icmp ne i32 %510, %smax20
  br i1 %exitcond25, label %511, label %525
...
525:                                              ; preds = %508
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %555, i32 1)
  ...
  %.promoted41 = load double, ptr %1, align 1
  br label %582

582:                                              ; preds = %586, %525
  %583 = phi double [ %589, %586 ], [ %.promoted41, %525 ]
  %584 = phi double [ %604, %586 ], [ 0.000000e+00, %525 ]
  %585 = phi i32 [ %605, %586 ], [ 1, %525 ]
  %exitcond27 = icmp ne i32 %585, %smax26
  br i1 %exitcond27, label %586, label %606
...
606:                                              ; preds = %582
  %.lcssa42 = phi double [ %583, %582 ]
  %.lcssa = phi double [ %584, %582 ]
  store double %.lcssa42, ptr %1, align 1
