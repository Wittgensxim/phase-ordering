...
133:                                              ; preds = %114
  ...
  %151 = fdiv double %149, %117
  %152 = fadd double %150, %151
  store double %152, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %153 = fmul double %117, %117
  %154 = fmul double %153, %117
...
196:                                              ; preds = %171
  ...
  %225 = call double @llvm.fmuladd.f64(double %224, double %173, double %222)
...
265:                                              ; preds = %243
  ...
  %292 = call double @llvm.fmuladd.f64(double %291, double %244, double %290)
...
356:                                              ; preds = %320
  ...
  %396 = call double @llvm.fmuladd.f64(double %395, double %321, double %393)
...
445:                                              ; preds = %410
  ...
  %485 = call double @llvm.fmuladd.f64(double %484, double %411, double %482)
...
515:                                              ; preds = %497
  ...
  %538 = call double @llvm.fmuladd.f64(double %537, double %498, double %535)
