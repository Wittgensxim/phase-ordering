...
3:                                                ; preds = %41, %0
  %4 = phi double [ %.lcssa9, %41 ], [ undef, %0 ]
...
40:                                               ; preds = %36
  %.lcssa16 = phi double [ %14, %36 ]
  %.lcssa9.lcssa = phi double [ %.lcssa9, %36 ]
  br label %42
...
.loopexit:                                        ; preds = %3
  %.lcssa14 = phi double [ %4, %3 ]
  %.lcssa12 = phi double [ %5, %3 ]
  br label %42

42:                                               ; preds = %.loopexit, %40
  %43 = phi double [ %.lcssa9.lcssa, %40 ], [ %.lcssa14, %.loopexit ]
  %44 = phi double [ %.lcssa16, %40 ], [ %.lcssa12, %.loopexit ]
...
97:                                               ; preds = %100, %55
  ...
  %exitcond17 = icmp eq i32 %99, %96
  br i1 %exitcond17, label %105, label %100
...
135:                                              ; preds = %117
  ...
  %.lcssa7 = phi double [ %120, %117 ]
  %.lcssa6 = phi double [ %121, %117 ]
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %147, i32 1)
  br label %172
...
172:                                              ; preds = %176, %135
  ...
  %exitcond21 = icmp ne i32 %175, %smax20
  br i1 %exitcond21, label %176, label %197
...
197:                                              ; preds = %172
  ...
  %226 = call double @llvm.fmuladd.f64(double %225, double %.lcssa5, double %223)
...
244:                                              ; preds = %247, %197
  ...
  %exitcond22 = icmp ne i32 %246, %smax20
  br i1 %exitcond22, label %247, label %266
...
321:                                              ; preds = %324, %266
  ...
  %exitcond23 = icmp ne i32 %323, %smax20
  br i1 %exitcond23, label %324, label %357
...
411:                                              ; preds = %414, %357
  ...
  %exitcond24 = icmp ne i32 %413, %smax20
  br i1 %exitcond24, label %414, label %446
...
498:                                              ; preds = %501, %446
  ...
  %exitcond25 = icmp ne i32 %500, %smax20
  br i1 %exitcond25, label %501, label %515
...
558:                                              ; preds = %561, %515
  ...
  %exitcond27 = icmp ne i32 %560, %smax26
  br i1 %exitcond27, label %561, label %594
