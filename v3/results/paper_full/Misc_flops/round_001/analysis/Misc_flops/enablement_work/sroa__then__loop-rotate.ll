...
define dso_local i32 @main() #0 {
  ...
  br i1 %4, label %.lr.ph23, label %.loopexit

.lr.ph23:                                         ; preds = %0
  br label %12

5:                                                ; preds = %38
  %6 = phi double [ %.lcssa13, %38 ]
  %7 = phi double [ %17, %38 ]
  %8 = phi i32 [ %14, %38 ]
  %9 = phi double [ %40, %38 ]
...
12:                                               ; preds = %.lr.ph23, %5
  %13 = phi i32 [ 15625, %.lr.ph23 ], [ %8, %5 ]
  %14 = shl nsw i32 %13, 1
  %15 = load double, ptr @one, align 8
  %16 = sitofp i32 %14 to double
  %17 = fdiv double %15, %16
  %18 = call i32 @dtime(ptr noundef nonnull @TimeArray)
  %.not.not21 = icmp slt i32 1, %14
  br i1 %.not.not21, label %.lr.ph, label %38
...
38:                                               ; preds = %._crit_edge, %12
  %.lcssa13 = phi double [ %split, %._crit_edge ], [ 0.000000e+00, %12 ]
...
42:                                               ; preds = %38
  %.lcssa20 = phi double [ %17, %38 ]
  %.lcssa13.lcssa = phi double [ %.lcssa13, %38 ]
  br label %43

..loopexit_crit_edge:                             ; preds = %5
  %split24 = phi double [ %6, %5 ]
  %split25 = phi double [ %7, %5 ]
  %split26 = phi i32 [ %8, %5 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %0
  %.lcssa18 = phi double [ %split24, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa16 = phi double [ %split25, %..loopexit_crit_edge ], [ undef, %0 ]
  %.lcssa14 = phi i32 [ %split26, %..loopexit_crit_edge ], [ 15625, %0 ]
  br label %43

43:                                               ; preds = %.loopexit, %42
  %44 = phi double [ %.lcssa13.lcssa, %42 ], [ %.lcssa18, %.loopexit ]
  %45 = phi double [ %.lcssa20, %42 ], [ %.lcssa16, %.loopexit ]
  %46 = phi i32 [ 512000000, %42 ], [ %.lcssa14, %.loopexit ]
...
58:                                               ; preds = %57, %51
  ...
  %.not27 = icmp sgt i32 1, %87
  br i1 %.not27, label %106, label %.lr.ph29

.lr.ph29:                                         ; preds = %58
  br label %99

99:                                               ; preds = %.lr.ph29, %99
  %100 = phi i32 [ 1, %.lr.ph29 ], [ %105, %99 ]
  %101 = phi double [ %95, %.lr.ph29 ], [ %102, %99 ]
  %102 = fneg double %101
  ...
  br i1 %.not, label %._crit_edge30, label %99, !llvm.loop !11

._crit_edge30:                                    ; preds = %99
  %split31 = phi double [ %102, %99 ]
  br label %106

106:                                              ; preds = %._crit_edge30, %58
  %.lcssa12 = phi double [ %split31, %._crit_edge30 ], [ %95, %58 ]
...
113:                                              ; preds = %112, %106
  ...
  %.not432 = icmp sgt i32 1, %87
  br i1 %.not432, label %134, label %.lr.ph35
...
117:                                              ; preds = %.lr.ph35, %117
  ...
  %121 = phi double [ %.lcssa12, %.lr.ph35 ], [ %123, %117 ]
  %122 = phi double [ %115, %.lr.ph35 ], [ %127, %117 ]
  %.033 = phi double [ 0.000000e+00, %.lr.ph35 ], [ %132, %117 ]
  %123 = fneg double %121
  ...
  %132 = fsub double %.033, %131
  %133 = add nuw nsw i32 %118, 1
  %.not4 = icmp sgt i32 %133, %87
  br i1 %.not4, label %._crit_edge36, label %117, !llvm.loop !12
...
134:                                              ; preds = %._crit_edge36, %113
  %.0.lcssa = phi double [ %split37, %._crit_edge36 ], [ 0.000000e+00, %113 ]
  %.lcssa11 = phi double [ %split38, %._crit_edge36 ], [ 0.000000e+00, %113 ]
  %.lcssa10 = phi double [ %split39, %._crit_edge36 ], [ 0.000000e+00, %113 ]
  ...
  %.not5.not40 = icmp slt i32 1, %146
  br i1 %.not5.not40, label %.lr.ph42, label %195

.lr.ph42:                                         ; preds = %134
  br label %171

171:                                              ; preds = %.lr.ph42, %171
  %172 = phi i32 [ 1, %.lr.ph42 ], [ %194, %171 ]
  %173 = phi double [ 0.000000e+00, %.lr.ph42 ], [ %193, %171 ]
  %174 = phi double [ 0.000000e+00, %.lr.ph42 ], [ %176, %171 ]
  ...
  %.not5.not = icmp slt i32 %194, %146
  br i1 %.not5.not, label %171, label %._crit_edge43, !llvm.loop !13

._crit_edge43:                                    ; preds = %171
  %split44 = phi double [ %193, %171 ]
  br label %195

195:                                              ; preds = %._crit_edge43, %134
  %.lcssa9 = phi double [ %split44, %._crit_edge43 ], [ 0.000000e+00, %134 ]
  ...
  %224 = call double @llvm.fmuladd.f64(double %223, double %.lcssa9, double %221)
  ...
  %.not6.not45 = icmp slt i32 1, %146
  br i1 %.not6.not45, label %.lr.ph47, label %263

.lr.ph47:                                         ; preds = %195
  br label %242

242:                                              ; preds = %.lr.ph47, %242
  %243 = phi i32 [ 1, %.lr.ph47 ], [ %262, %242 ]
  %244 = phi double [ 0.000000e+00, %.lr.ph47 ], [ %261, %242 ]
  ...
  %.not6.not = icmp slt i32 %262, %146
  br i1 %.not6.not, label %242, label %._crit_edge48, !llvm.loop !14

._crit_edge48:                                    ; preds = %242
  %split49 = phi double [ %261, %242 ]
  br label %263

263:                                              ; preds = %._crit_edge48, %195
  %.lcssa8 = phi double [ %split49, %._crit_edge48 ], [ 0.000000e+00, %195 ]
  ...
  %290 = call double @llvm.fmuladd.f64(double %289, double %.lcssa8, double %288)
  ...
  %.not7.not50 = icmp slt i32 1, %146
  br i1 %.not7.not50, label %.lr.ph52, label %353

.lr.ph52:                                         ; preds = %263
  br label %318

318:                                              ; preds = %.lr.ph52, %318
  %319 = phi i32 [ 1, %.lr.ph52 ], [ %352, %318 ]
  %320 = phi double [ 0.000000e+00, %.lr.ph52 ], [ %351, %318 ]
  ...
  %.not7.not = icmp slt i32 %352, %146
  br i1 %.not7.not, label %318, label %._crit_edge53, !llvm.loop !15

._crit_edge53:                                    ; preds = %318
  %split54 = phi double [ %351, %318 ]
  br label %353

353:                                              ; preds = %._crit_edge53, %263
  %.lcssa7 = phi double [ %split54, %._crit_edge53 ], [ 0.000000e+00, %263 ]
  ...
  %393 = call double @llvm.fmuladd.f64(double %392, double %.lcssa7, double %390)
  ...
  %.not8.not55 = icmp slt i32 1, %146
  br i1 %.not8.not55, label %.lr.ph57, label %441

.lr.ph57:                                         ; preds = %353
  br label %407

407:                                              ; preds = %.lr.ph57, %407
  %408 = phi i32 [ 1, %.lr.ph57 ], [ %440, %407 ]
  %409 = phi double [ 0.000000e+00, %.lr.ph57 ], [ %439, %407 ]
  ...
  %.not8.not = icmp slt i32 %440, %146
  br i1 %.not8.not, label %407, label %._crit_edge58, !llvm.loop !16

._crit_edge58:                                    ; preds = %407
  %split59 = phi double [ %439, %407 ]
  br label %441

441:                                              ; preds = %._crit_edge58, %353
  %.lcssa6 = phi double [ %split59, %._crit_edge58 ], [ 0.000000e+00, %353 ]
  ...
  %481 = call double @llvm.fmuladd.f64(double %480, double %.lcssa6, double %478)
  ...
  %.not9.not60 = icmp slt i32 1, %146
  br i1 %.not9.not60, label %.lr.ph62, label %509
...
493:                                              ; preds = %.lr.ph62, %493
  ...
  %.not9.not = icmp slt i32 %508, %146
  br i1 %.not9.not, label %493, label %._crit_edge63, !llvm.loop !17
...
509:                                              ; preds = %._crit_edge63, %441
  %.lcssa5 = phi double [ %split64, %._crit_edge63 ], [ 0.000000e+00, %441 ]
  ...
  %531 = call double @llvm.fmuladd.f64(double %530, double %.lcssa5, double %528)
  ...
  %.not10.not65 = icmp slt i32 1, %538
  br i1 %.not10.not65, label %.lr.ph67, label %587

.lr.ph67:                                         ; preds = %509
  br label %552

552:                                              ; preds = %.lr.ph67, %552
  %553 = phi i32 [ 1, %.lr.ph67 ], [ %586, %552 ]
  %554 = phi double [ 0.000000e+00, %.lr.ph67 ], [ %585, %552 ]
  ...
  %.not10.not = icmp slt i32 %586, %538
  br i1 %.not10.not, label %552, label %._crit_edge68, !llvm.loop !18

._crit_edge68:                                    ; preds = %552
  %split69 = phi double [ %585, %552 ]
  br label %587
