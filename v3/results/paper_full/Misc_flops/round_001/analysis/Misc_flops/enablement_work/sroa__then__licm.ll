...
3:                                                ; preds = %41, %0
  %4 = phi double [ %.lcssa13, %41 ], [ undef, %0 ]
...
40:                                               ; preds = %36
  %.lcssa20 = phi double [ %14, %36 ]
  %.lcssa13.lcssa = phi double [ %.lcssa13, %36 ]
  br label %42
...
.loopexit:                                        ; preds = %3
  %.lcssa18 = phi double [ %4, %3 ]
  %.lcssa16 = phi double [ %5, %3 ]
  %.lcssa14 = phi i32 [ %6, %3 ]
  br label %42

42:                                               ; preds = %.loopexit, %40
  %43 = phi double [ %.lcssa13.lcssa, %40 ], [ %.lcssa18, %.loopexit ]
  %44 = phi double [ %.lcssa20, %40 ], [ %.lcssa16, %.loopexit ]
  %45 = phi i32 [ 512000000, %40 ], [ %.lcssa14, %.loopexit ]
...
114:                                              ; preds = %113, %107
  ...
  %sa.promoted21 = load double, ptr @sa, align 8
  br label %119

119:                                              ; preds = %126, %114
  %120 = phi double [ %sa.promoted21, %114 ], [ %128, %126 ]
  %.0 = phi double [ 0.000000e+00, %114 ], [ %134, %126 ]
  %121 = phi double [ %129, %126 ], [ %116, %114 ]
  %122 = phi double [ %127, %126 ], [ %.lcssa12, %114 ]
  %123 = phi double [ %132, %126 ], [ 0.000000e+00, %114 ]
  %124 = phi double [ %131, %126 ], [ 0.000000e+00, %114 ]
  %125 = phi i32 [ %135, %126 ], [ 1, %114 ]
  %.not4 = icmp sgt i32 %125, %87
  br i1 %.not4, label %136, label %126

126:                                              ; preds = %119
  %127 = fneg double %122
  %128 = fsub double %120, %122
  store double %128, ptr @sa, align 8
  %129 = fadd double %121, %118
...
136:                                              ; preds = %119
  %.0.lcssa = phi double [ %.0, %119 ]
  %.lcssa11 = phi double [ %123, %119 ]
  %.lcssa10 = phi double [ %124, %119 ]
...
182:                                              ; preds = %186, %136
  ...
  %.not5.not = icmp slt i32 %185, %148
  br i1 %.not5.not, label %186, label %198
...
198:                                              ; preds = %182
  ...
  %227 = call double @llvm.fmuladd.f64(double %226, double %.lcssa9, double %224)
...
252:                                              ; preds = %255, %198
  ...
  %.not6.not = icmp slt i32 %254, %148
  br i1 %.not6.not, label %255, label %267
...
267:                                              ; preds = %252
  ...
  %294 = call double @llvm.fmuladd.f64(double %293, double %.lcssa8, double %292)
...
335:                                              ; preds = %338, %267
  ...
  %.not7.not = icmp slt i32 %337, %148
  br i1 %.not7.not, label %338, label %358
...
358:                                              ; preds = %335
  ...
  %398 = call double @llvm.fmuladd.f64(double %397, double %.lcssa7, double %395)
...
425:                                              ; preds = %428, %358
  ...
  %.not8.not = icmp slt i32 %427, %148
  br i1 %.not8.not, label %428, label %447
...
428:                                              ; preds = %425
  ...
  %446 = add nuw nsw i32 %427, 1
  br label %425, !llvm.loop !16

447:                                              ; preds = %425
  %.lcssa6 = phi double [ %426, %425 ]
  ...
  %487 = call double @llvm.fmuladd.f64(double %486, double %.lcssa6, double %484)
...
516:                                              ; preds = %499
  ...
  %538 = call double @llvm.fmuladd.f64(double %537, double %.lcssa5, double %535)
...
572:                                              ; preds = %575, %516
  ...
  %.not10.not = icmp slt i32 %574, %545
  br i1 %.not10.not, label %575, label %595
