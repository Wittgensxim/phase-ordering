...
8:                                                ; preds = %43, %0
  %.0284 = phi double [ undef, %0 ], [ %16, %43 ]
  %.0273 = phi double [ undef, %0 ], [ %.2275, %43 ]
...
18:                                               ; preds = %36, %12
  %.0288 = phi double [ 0.000000e+00, %12 ], [ %22, %36 ]
  %.2275 = phi double [ 0.000000e+00, %12 ], [ %35, %36 ]
  %.0271 = phi i32 [ 1, %12 ], [ %37, %36 ]
  %19 = sub nsw i32 %13, 1
  %20 = icmp sle i32 %.0271, %19
  br i1 %20, label %21, label %38

21:                                               ; preds = %18
  %22 = fadd double %.0288, %14
  ...
  %35 = fadd double %.2275, %34
  br label %36

36:                                               ; preds = %21
  %37 = add nsw i32 %.0271, 1
...
44:                                               ; preds = %42, %8
  %.1285 = phi double [ %16, %42 ], [ %.0284, %8 ]
  %.1274 = phi double [ %.2275, %42 ], [ %.0273, %8 ]
  %.1 = phi i32 [ %13, %42 ], [ %.0, %8 ]
...
46:                                               ; preds = %50, %44
  %.1272 = phi i32 [ 1, %44 ], [ %51, %50 ]
  %47 = sub nsw i32 %.1, 1
  %48 = icmp sle i32 %.1272, %47
...
59:                                               ; preds = %58, %52
  ...
  %84 = call double @llvm.fmuladd.f64(double %83, double %.1274, double %82)
  %85 = fmul double %.1285, %84
...
110:                                              ; preds = %116, %59
  %.3276 = phi double [ %106, %59 ], [ %113, %116 ]
  %.2 = phi i32 [ 1, %59 ], [ %117, %116 ]
  %111 = icmp sle i32 %.2, %94
  br i1 %111, label %112, label %118

112:                                              ; preds = %110
  %113 = fneg double %.3276
...
129:                                              ; preds = %142, %125
  %.1289 = phi double [ 0.000000e+00, %125 ], [ %139, %142 ]
  %.0287 = phi double [ 0.000000e+00, %125 ], [ %141, %142 ]
  %.2286 = phi double [ 0.000000e+00, %125 ], [ %138, %142 ]
  %.0283 = phi double [ %127, %125 ], [ %136, %142 ]
  %.4277 = phi double [ %.3276, %125 ], [ %132, %142 ]
  %.3 = phi i32 [ 1, %125 ], [ %143, %142 ]
  %130 = icmp sle i32 %.3, %94
  br i1 %130, label %131, label %144

131:                                              ; preds = %129
  %132 = fneg double %.4277
  %133 = load double, ptr @sa, align 8
  %134 = fadd double %133, %132
  store double %134, ptr @sa, align 8
  %135 = load double, ptr @two, align 8
  %136 = fadd double %.0283, %135
  %137 = fsub double %132, %136
  %138 = fadd double %.2286, %137
  %139 = call double @llvm.fmuladd.f64(double %.4277, double %136, double %.1289)
  %140 = fdiv double %132, %136
  %141 = fadd double %.0287, %140
  br label %142
...
188:                                              ; preds = %211, %144
  %.2290 = phi double [ 0.000000e+00, %144 ], [ %193, %211 ]
  %.5278 = phi double [ 0.000000e+00, %144 ], [ %210, %211 ]
  %.4 = phi i32 [ 1, %144 ], [ %212, %211 ]
  %189 = sub nsw i32 %156, 1
  %190 = icmp sle i32 %.4, %189
  br i1 %190, label %191, label %213

191:                                              ; preds = %188
  %192 = load double, ptr @one, align 8
  %193 = fadd double %.2290, %192
  ...
  %210 = call double @llvm.fmuladd.f64(double %194, double %209, double %.5278)
  br label %211
...
213:                                              ; preds = %188
  ...
  %244 = call double @llvm.fmuladd.f64(double %243, double %.5278, double %242)
...
267:                                              ; preds = %287, %213
  %.6279 = phi double [ 0.000000e+00, %213 ], [ %286, %287 ]
  %.5 = phi i32 [ 1, %213 ], [ %288, %287 ]
  %268 = icmp sle i32 %.5, %189
  br i1 %268, label %269, label %289

269:                                              ; preds = %267
  %270 = sitofp i32 %.5 to double
  ...
  %284 = call double @llvm.fmuladd.f64(double %272, double %283, double %.6279)
...
289:                                              ; preds = %267
  ...
  %319 = call double @llvm.fmuladd.f64(double %318, double %.6279, double %317)
...
356:                                              ; preds = %390, %289
  %.7280 = phi double [ 0.000000e+00, %289 ], [ %389, %390 ]
  %.6 = phi i32 [ 1, %289 ], [ %391, %390 ]
  %357 = icmp sle i32 %.6, %189
  br i1 %357, label %358, label %392

358:                                              ; preds = %356
  %359 = sitofp i32 %.6 to double
...
392:                                              ; preds = %356
  ...
  %436 = call double @llvm.fmuladd.f64(double %435, double %.7280, double %434)
...
455:                                              ; preds = %488, %392
  %.8281 = phi double [ 0.000000e+00, %392 ], [ %487, %488 ]
  %.7 = phi i32 [ 1, %392 ], [ %489, %488 ]
  %456 = icmp sle i32 %.7, %189
  br i1 %456, label %457, label %490

457:                                              ; preds = %455
  %458 = sitofp i32 %.7 to double
  ...
  %487 = call double @llvm.fmuladd.f64(double %474, double %486, double %.8281)
  br label %488
...
490:                                              ; preds = %455
  ...
  %534 = call double @llvm.fmuladd.f64(double %533, double %.8281, double %532)
...
551:                                              ; preds = %566, %490
  %.9282 = phi double [ 0.000000e+00, %490 ], [ %565, %566 ]
  %.8 = phi i32 [ 1, %490 ], [ %567, %566 ]
  %552 = icmp sle i32 %.8, %189
  br i1 %552, label %553, label %568

553:                                              ; preds = %551
  %554 = sitofp i32 %.8 to double
  %555 = fmul double %554, %549
  %556 = fmul double %555, %555
  %557 = fadd double %555, %548
  %558 = fdiv double %548, %557
  %559 = fsub double %.9282, %558
...
568:                                              ; preds = %551
  ...
  %590 = call double @llvm.fmuladd.f64(double %589, double %.9282, double %587)
...
614:                                              ; preds = %649, %568
  ...
  %.9 = phi i32 [ 1, %568 ], [ %650, %649 ]
  %615 = sub nsw i32 %597, 1
  %616 = icmp sle i32 %.9, %615
  br i1 %616, label %617, label %651

617:                                              ; preds = %614
  %618 = sitofp i32 %.9 to double
