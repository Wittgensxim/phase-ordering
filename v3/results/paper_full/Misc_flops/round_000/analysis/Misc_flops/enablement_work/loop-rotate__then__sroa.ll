...
26:                                               ; preds = %.lr.ph, %42
  %.0340 = phi double [ 0.000000e+00, %.lr.ph ], [ %27, %42 ]
  %.1324 = phi double [ 0.000000e+00, %.lr.ph ], [ %41, %42 ]
  %.0320 = phi i32 [ 1, %.lr.ph ], [ %43, %42 ]
  %27 = fadd double %.0340, %22
  ...
  %41 = fadd double %.1324, %40
  br label %42

42:                                               ; preds = %26
  %43 = add nsw i32 %.0320, 1
  %44 = sub nsw i32 %18, 1
...
46:                                               ; preds = %._crit_edge, %17
  %.2325 = phi double [ %41, %._crit_edge ], [ 0.000000e+00, %17 ]
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %0
  %.3337 = phi double [ %21, %..loopexit_crit_edge ], [ undef, %0 ]
  %.18 = phi double [ %.2325, %..loopexit_crit_edge ], [ undef, %0 ]
  %.2 = phi i32 [ %18, %..loopexit_crit_edge ], [ 15625, %0 ]
  br label %51

51:                                               ; preds = %.loopexit, %50
  %.0334 = phi double [ %21, %50 ], [ %.3337, %.loopexit ]
  %.0323 = phi double [ %.2325, %50 ], [ %.18, %.loopexit ]
...
56:                                               ; preds = %.lr.ph4, %57
  %.1321 = phi i32 [ 1, %.lr.ph4 ], [ %58, %57 ]
  br label %57

57:                                               ; preds = %56
  %58 = add nsw i32 %.1321, 1
  %59 = sub nsw i32 %.1, 1
...
69:                                               ; preds = %68, %61
  ...
  %95 = call double @llvm.fmuladd.f64(double %94, double %.0323, double %93)
  %96 = fmul double %.0334, %95
...
127:                                              ; preds = %.lr.ph7, %131
  %.3326 = phi double [ %122, %.lr.ph7 ], [ %128, %131 ]
  %.2322 = phi i32 [ 1, %.lr.ph7 ], [ %132, %131 ]
  %128 = fneg double %.3326
...
134:                                              ; preds = %._crit_edge8, %69
  %.4327 = phi double [ %128, %._crit_edge8 ], [ %122, %69 ]
...
147:                                              ; preds = %.lr.ph10, %159
  %.1341 = phi double [ 0.000000e+00, %.lr.ph10 ], [ %156, %159 ]
  %.0338 = phi double [ 0.000000e+00, %.lr.ph10 ], [ %158, %159 ]
  %.1335 = phi double [ 0.000000e+00, %.lr.ph10 ], [ %154, %159 ]
  %.0333 = phi double [ %144, %.lr.ph10 ], [ %152, %159 ]
  %.5328 = phi double [ %.4327, %.lr.ph10 ], [ %148, %159 ]
  %.3 = phi i32 [ 1, %.lr.ph10 ], [ %160, %159 ]
  %148 = fneg double %.5328
  %149 = load double, ptr @sa, align 8
  %150 = fadd double %149, %148
  store double %150, ptr @sa, align 8
  %151 = load double, ptr @two, align 8
  %152 = fadd double %.0333, %151
  %153 = fsub double %148, %152
  %154 = fadd double %.1335, %153
  %155 = fneg double %148
  %156 = call double @llvm.fmuladd.f64(double %155, double %152, double %.1341)
  %157 = fdiv double %148, %152
  %158 = fadd double %.0338, %157
  br label %159
...
162:                                              ; preds = %._crit_edge11, %142
  %.2342 = phi double [ %156, %._crit_edge11 ], [ 0.000000e+00, %142 ]
  %.1339 = phi double [ %158, %._crit_edge11 ], [ 0.000000e+00, %142 ]
  %.2336 = phi double [ %154, %._crit_edge11 ], [ 0.000000e+00, %142 ]
  ...
  %186 = fmul double %.2342, %.2342
  %187 = fmul double %186, %.2342
...
213:                                              ; preds = %.lr.ph13, %234
  %.3343 = phi double [ 0.000000e+00, %.lr.ph13 ], [ %215, %234 ]
  %.6329 = phi double [ 0.000000e+00, %.lr.ph13 ], [ %233, %234 ]
  %.4 = phi i32 [ 1, %.lr.ph13 ], [ %235, %234 ]
  %214 = load double, ptr @one, align 8
  %215 = fadd double %.3343, %214
  ...
  %233 = call double @llvm.fmuladd.f64(double %216, double %232, double %.6329)
  br label %234
...
238:                                              ; preds = %._crit_edge14, %162
  %.7330 = phi double [ %233, %._crit_edge14 ], [ 0.000000e+00, %162 ]
  ...
  %269 = call double @llvm.fmuladd.f64(double %268, double %.7330, double %267)
...
298:                                              ; preds = %.lr.ph16, %316
  %.8331 = phi double [ 0.000000e+00, %.lr.ph16 ], [ %315, %316 ]
  %.5 = phi i32 [ 1, %.lr.ph16 ], [ %317, %316 ]
  %299 = sitofp i32 %.5 to double
  ...
  %313 = call double @llvm.fmuladd.f64(double %301, double %312, double %.8331)
...
320:                                              ; preds = %._crit_edge17, %238
  %.9332 = phi double [ %315, %._crit_edge17 ], [ 0.000000e+00, %238 ]
  ...
  %350 = call double @llvm.fmuladd.f64(double %349, double %.9332, double %348)
...
393:                                              ; preds = %.lr.ph19, %426
  ...
  %.6 = phi i32 [ 1, %.lr.ph19 ], [ %427, %426 ]
  %394 = sitofp i32 %.6 to double
...
500:                                              ; preds = %.lr.ph22, %532
  ...
  %.7 = phi i32 [ 1, %.lr.ph22 ], [ %533, %532 ]
  %501 = sitofp i32 %.7 to double
...
605:                                              ; preds = %.lr.ph25, %618
  ...
  %.8 = phi i32 [ 1, %.lr.ph25 ], [ %619, %618 ]
  %606 = sitofp i32 %.8 to double
...
675:                                              ; preds = %.lr.ph28, %708
  ...
  %.9 = phi i32 [ 1, %.lr.ph28 ], [ %709, %708 ]
  %676 = sitofp i32 %.9 to double
