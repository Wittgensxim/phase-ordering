...
3:                                                ; preds = %37, %0
  %.0133 = phi double [ undef, %0 ], [ %11, %37 ]
  %.0130 = phi double [ undef, %0 ], [ %.2, %37 ]
  %.0 = phi i32 [ 15625, %0 ], [ %8, %37 ]
...
13:                                               ; preds = %30, %7
  %.0137 = phi double [ 0.000000e+00, %7 ], [ %15, %30 ]
...
38:                                               ; preds = %36, %3
  %.1134 = phi double [ %11, %36 ], [ %.0133, %3 ]
  %.1131 = phi double [ %.2, %36 ], [ %.0130, %3 ]
  %.1 = phi i32 [ %8, %36 ], [ %.0, %3 ]
...
40:                                               ; preds = %42, %38
  ...
  %.not.not4 = icmp slt i32 %storemerge3, %.1
...
51:                                               ; preds = %50, %44
  ...
  %74 = call double @llvm.fmuladd.f64(double %73, double %.1131, double %72)
  %75 = fmul double %.1134, %74
...
118:                                              ; preds = %131, %114
  %.1138 = phi double [ 0.000000e+00, %114 ], [ %128, %131 ]
  %.0136 = phi double [ 0.000000e+00, %114 ], [ %130, %131 ]
  %.2135 = phi double [ 0.000000e+00, %114 ], [ %126, %131 ]
  %.0132 = phi double [ %116, %114 ], [ %124, %131 ]
...
119:                                              ; preds = %118
  ...
  %124 = fadd double %.0132, %123
  %125 = fsub double %120, %124
  %126 = fadd double %.2135, %125
  %127 = fneg double %120
  %128 = call double @llvm.fmuladd.f64(double %127, double %124, double %.1138)
  %129 = fdiv double %120, %124
  %130 = fadd double %.0136, %129
  br label %131
...
174:                                              ; preds = %196, %133
  %.2139 = phi double [ 0.000000e+00, %133 ], [ %177, %196 ]
