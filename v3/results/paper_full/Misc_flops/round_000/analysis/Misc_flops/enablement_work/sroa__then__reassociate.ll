...
10:                                               ; preds = %47, %0
  ...
  %.0273 = phi double [ undef, %0 ], [ %.2275, %47 ]
...
48:                                               ; preds = %46, %10
  %.1285 = phi double [ %18, %46 ], [ %.0284, %10 ]
  %.1274 = phi double [ %.2275, %46 ], [ %.0273, %10 ]
...
142:                                              ; preds = %156, %138
  ...
  %.4277 = phi double [ %.3276, %138 ], [ %145, %156 ]
...
158:                                              ; preds = %142
  ...
  %182 = fmul double %.1289, %.1289
  %183 = fmul double %.1289, %182
...
233:                                              ; preds = %207
  ...
  %264 = call double @llvm.fmuladd.f64(double %263, double %.5278, double %262)
...
314:                                              ; preds = %291
  ...
  %344 = call double @llvm.fmuladd.f64(double %343, double %.6279, double %342)
...
423:                                              ; preds = %385
  ...
  %468 = call double @llvm.fmuladd.f64(double %467, double %.7280, double %466)
...
528:                                              ; preds = %491
  ...
  %573 = call double @llvm.fmuladd.f64(double %572, double %.8281, double %571)
...
613:                                              ; preds = %595
  ...
  %624 = fneg double %590
  %625 = fadd double %590, %622
  %626 = fdiv double %590, %625
  %627 = fsub double %624, %626
  %628 = fadd double %590, %623
