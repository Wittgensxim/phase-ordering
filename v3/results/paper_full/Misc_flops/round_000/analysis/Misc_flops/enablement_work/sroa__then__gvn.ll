...
17:                                               ; preds = %20, %11
  %.0288 = phi double [ 0.000000e+00, %11 ], [ %21, %20 ]
  %.2275 = phi double [ 0.000000e+00, %11 ], [ %34, %20 ]
  %.0271 = phi i32 [ 1, %11 ], [ %35, %20 ]
  %18 = sub nsw i32 %12, 1
  %19 = icmp sle i32 %.0271, %18
  br i1 %19, label %20, label %36

20:                                               ; preds = %17
  %21 = fadd double %.0288, %13
  ...
  %34 = fadd double %.2275, %33
  %35 = add nsw i32 %.0271, 1
...
42:                                               ; preds = %40, %7
  %.1285 = phi double [ %15, %40 ], [ %.0284, %7 ]
  %.1274 = phi double [ %.2275, %40 ], [ %.0273, %7 ]
...
44:                                               ; preds = %47, %42
  %.1272 = phi i32 [ 1, %42 ], [ %48, %47 ]
  %45 = sub nsw i32 %.1, 1
  %46 = icmp sle i32 %.1272, %45
  br i1 %46, label %47, label %49

47:                                               ; preds = %44
  %48 = add nsw i32 %.1272, 1
...
56:                                               ; preds = %55, %49
  ...
  %76 = call double @llvm.fmuladd.f64(double %75, double %.1274, double %74)
  %77 = fmul double %.1285, %76
...
97:                                               ; preds = %99, %56
  %.3276 = phi double [ %93, %56 ], [ %100, %99 ]
  %.2 = phi i32 [ 1, %56 ], [ %103, %99 ]
  %98 = icmp sle i32 %.2, %85
  br i1 %98, label %99, label %104

99:                                               ; preds = %97
  %100 = fneg double %.3276
...
115:                                              ; preds = %117, %111
  %.1289 = phi double [ 0.000000e+00, %111 ], [ %125, %117 ]
  %.0287 = phi double [ 0.000000e+00, %111 ], [ %127, %117 ]
  %.2286 = phi double [ 0.000000e+00, %111 ], [ %124, %117 ]
  %.0283 = phi double [ %113, %111 ], [ %122, %117 ]
  %.4277 = phi double [ %.3276, %111 ], [ %118, %117 ]
  %.3 = phi i32 [ 1, %111 ], [ %128, %117 ]
  %116 = icmp sle i32 %.3, %85
  br i1 %116, label %117, label %129

117:                                              ; preds = %115
  %118 = fneg double %.4277
  ...
  %124 = fadd double %.2286, %123
  %125 = call double @llvm.fmuladd.f64(double %.4277, double %122, double %.1289)
  %126 = fdiv double %118, %122
  %127 = fadd double %.0287, %126
  %128 = add nsw i32 %.3, 1
...
166:                                              ; preds = %169, %129
  %.2290 = phi double [ 0.000000e+00, %129 ], [ %171, %169 ]
  %.5278 = phi double [ 0.000000e+00, %129 ], [ %188, %169 ]
  %.4 = phi i32 [ 1, %129 ], [ %189, %169 ]
...
169:                                              ; preds = %166
  ...
  %188 = call double @llvm.fmuladd.f64(double %172, double %187, double %.5278)
  %189 = add nsw i32 %.4, 1
...
190:                                              ; preds = %166
  ...
  %219 = call double @llvm.fmuladd.f64(double %218, double %.5278, double %216)
...
237:                                              ; preds = %239, %190
  %.6279 = phi double [ 0.000000e+00, %190 ], [ %256, %239 ]
  %.5 = phi i32 [ 1, %190 ], [ %257, %239 ]
  %238 = icmp sle i32 %.5, %167
  br i1 %238, label %239, label %258

239:                                              ; preds = %237
  %240 = sitofp i32 %.5 to double
  ...
  %254 = call double @llvm.fmuladd.f64(double %242, double %253, double %.6279)
...
258:                                              ; preds = %237
  ...
  %285 = call double @llvm.fmuladd.f64(double %284, double %.6279, double %283)
...
313:                                              ; preds = %315, %258
  %.7280 = phi double [ 0.000000e+00, %258 ], [ %346, %315 ]
  %.6 = phi i32 [ 1, %258 ], [ %347, %315 ]
  %314 = icmp sle i32 %.6, %167
  br i1 %314, label %315, label %348

315:                                              ; preds = %313
  %316 = sitofp i32 %.6 to double
...
348:                                              ; preds = %313
  ...
  %388 = call double @llvm.fmuladd.f64(double %387, double %.7280, double %385)
...
402:                                              ; preds = %404, %348
  %.8281 = phi double [ 0.000000e+00, %348 ], [ %434, %404 ]
  %.7 = phi i32 [ 1, %348 ], [ %435, %404 ]
  %403 = icmp sle i32 %.7, %167
  br i1 %403, label %404, label %436

404:                                              ; preds = %402
  %405 = sitofp i32 %.7 to double
  ...
  %434 = call double @llvm.fmuladd.f64(double %421, double %433, double %.8281)
  %435 = add nsw i32 %.7, 1
...
436:                                              ; preds = %402
  ...
  %476 = call double @llvm.fmuladd.f64(double %475, double %.8281, double %473)
...
488:                                              ; preds = %490, %436
  %.9282 = phi double [ 0.000000e+00, %436 ], [ %502, %490 ]
  %.8 = phi i32 [ 1, %436 ], [ %503, %490 ]
  %489 = icmp sle i32 %.8, %167
  br i1 %489, label %490, label %504

490:                                              ; preds = %488
  %491 = sitofp i32 %.8 to double
  %492 = fmul double %491, %486
  %493 = fmul double %492, %492
  %494 = fadd double %492, %485
  %495 = fdiv double %485, %494
  %496 = fsub double %.9282, %495
...
504:                                              ; preds = %488
  ...
  %526 = call double @llvm.fmuladd.f64(double %525, double %.9282, double %523)
...
547:                                              ; preds = %550, %504
  ...
  %.9 = phi i32 [ 1, %504 ], [ %582, %550 ]
  %548 = sub nsw i32 %533, 1
  %549 = icmp sle i32 %.9, %548
  br i1 %549, label %550, label %583

550:                                              ; preds = %547
  %551 = sitofp i32 %.9 to double
