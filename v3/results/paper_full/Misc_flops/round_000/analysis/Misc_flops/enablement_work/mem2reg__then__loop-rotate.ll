...
define dso_local i32 @main() #0 {
  ...
  br i1 %12, label %.lr.ph30, label %.loopexit
...
17:                                               ; preds = %.lr.ph30, %13
  %.028 = phi i32 [ 15625, %.lr.ph30 ], [ %.0, %13 ]
  %18 = mul nsw i32 2, %.028
...
26:                                               ; preds = %.lr.ph, %42
  %.227 = phi double [ 0.000000e+00, %.lr.ph ], [ %41, %42 ]
  %.0426 = phi double [ 0.000000e+00, %.lr.ph ], [ %27, %42 ]
  %.01125 = phi i32 [ 1, %.lr.ph ], [ %43, %42 ]
  %27 = fadd double %.0426, %22
  ...
  %41 = fadd double %.227, %40
  br label %42

42:                                               ; preds = %26
  %43 = add nsw i32 %.01125, 1
...
45:                                               ; preds = %._crit_edge, %17
  %.2.lcssa = phi double [ %split, %._crit_edge ], [ 0.000000e+00, %17 ]
...
49:                                               ; preds = %45
  %.lcssa24 = phi i32 [ %18, %45 ]
  %.lcssa = phi double [ %21, %45 ]
  %.2.lcssa.lcssa = phi double [ %.2.lcssa, %45 ]
  br label %50

..loopexit_crit_edge:                             ; preds = %13
  %split31 = phi double [ %.08, %13 ]
  %split32 = phi double [ %.01, %13 ]
  %split33 = phi i32 [ %.0, %13 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %0
  %.08.lcssa = phi double [ %split31, %..loopexit_crit_edge ], [ undef, %0 ]
  %.01.lcssa = phi double [ %split32, %..loopexit_crit_edge ], [ undef, %0 ]
  %.0.lcssa = phi i32 [ %split33, %..loopexit_crit_edge ], [ 15625, %0 ]
  br label %50

50:                                               ; preds = %.loopexit, %49
  %.19 = phi double [ %.lcssa, %49 ], [ %.08.lcssa, %.loopexit ]
  %.12 = phi double [ %.2.lcssa.lcssa, %49 ], [ %.01.lcssa, %.loopexit ]
  %.1 = phi i32 [ %.lcssa24, %49 ], [ %.0.lcssa, %.loopexit ]
  ...
  br i1 %54, label %.lr.ph36, label %59

.lr.ph36:                                         ; preds = %50
  br label %55

55:                                               ; preds = %.lr.ph36, %56
  %.11234 = phi i32 [ 1, %.lr.ph36 ], [ %57, %56 ]
  br label %56

56:                                               ; preds = %55
  %57 = add nsw i32 %.11234, 1
  %58 = icmp sle i32 %57, %53
  br i1 %58, label %55, label %._crit_edge37, !llvm.loop !10

._crit_edge37:                                    ; preds = %56
  br label %59

59:                                               ; preds = %._crit_edge37, %50
...
67:                                               ; preds = %66, %59
  ...
  %93 = call double @llvm.fmuladd.f64(double %92, double %.12, double %91)
  ...
  br i1 %124, label %.lr.ph41, label %132

.lr.ph41:                                         ; preds = %67
  br label %125

125:                                              ; preds = %.lr.ph41, %129
  %.339 = phi double [ %120, %.lr.ph41 ], [ %126, %129 ]
  %.21338 = phi i32 [ 1, %.lr.ph41 ], [ %130, %129 ]
  %126 = fneg double %.339
...
129:                                              ; preds = %125
  %130 = add nsw i32 %.21338, 1
  %131 = icmp sle i32 %130, %106
  br i1 %131, label %125, label %._crit_edge42, !llvm.loop !11

._crit_edge42:                                    ; preds = %129
  %split43 = phi double [ %126, %129 ]
  br label %132

132:                                              ; preds = %._crit_edge42, %67
  %.3.lcssa = phi double [ %split43, %._crit_edge42 ], [ %120, %67 ]
...
140:                                              ; preds = %139, %132
  ...
  br i1 %144, label %.lr.ph51, label %160

.lr.ph51:                                         ; preds = %140
  br label %145

145:                                              ; preds = %.lr.ph51, %157
  %.449 = phi double [ %.3.lcssa, %.lr.ph51 ], [ %146, %157 ]
  %.0348 = phi double [ %142, %.lr.ph51 ], [ %150, %157 ]
  %.1547 = phi double [ 0.000000e+00, %.lr.ph51 ], [ %154, %157 ]
  %.0746 = phi double [ 0.000000e+00, %.lr.ph51 ], [ %156, %157 ]
  %.21045 = phi double [ 0.000000e+00, %.lr.ph51 ], [ %152, %157 ]
  %.31444 = phi i32 [ 1, %.lr.ph51 ], [ %158, %157 ]
  %146 = fneg double %.449
  %147 = load double, ptr @sa, align 8
  %148 = fadd double %147, %146
  store double %148, ptr @sa, align 8
  %149 = load double, ptr @two, align 8
  %150 = fadd double %.0348, %149
  %151 = fsub double %146, %150
  %152 = fadd double %.21045, %151
  %153 = fneg double %146
  %154 = call double @llvm.fmuladd.f64(double %153, double %150, double %.1547)
  %155 = fdiv double %146, %150
  %156 = fadd double %.0746, %155
  br label %157

157:                                              ; preds = %145
  %158 = add nsw i32 %.31444, 1
  %159 = icmp sle i32 %158, %106
  br i1 %159, label %145, label %._crit_edge52, !llvm.loop !12

._crit_edge52:                                    ; preds = %157
  %split53 = phi double [ %152, %157 ]
  %split54 = phi double [ %156, %157 ]
  %split55 = phi double [ %154, %157 ]
  br label %160

160:                                              ; preds = %._crit_edge52, %140
  %.210.lcssa = phi double [ %split53, %._crit_edge52 ], [ 0.000000e+00, %140 ]
  %.07.lcssa = phi double [ %split54, %._crit_edge52 ], [ 0.000000e+00, %140 ]
  %.15.lcssa = phi double [ %split55, %._crit_edge52 ], [ 0.000000e+00, %140 ]
  ...
  %184 = fmul double %.15.lcssa, %.15.lcssa
  %185 = fmul double %184, %.15.lcssa
  ...
  br i1 %210, label %.lr.ph60, label %235

.lr.ph60:                                         ; preds = %160
  br label %211

211:                                              ; preds = %.lr.ph60, %232
  %.558 = phi double [ 0.000000e+00, %.lr.ph60 ], [ %231, %232 ]
  %.2657 = phi double [ 0.000000e+00, %.lr.ph60 ], [ %213, %232 ]
  %.41556 = phi i32 [ 1, %.lr.ph60 ], [ %233, %232 ]
  %212 = load double, ptr @one, align 8
  %213 = fadd double %.2657, %212
  ...
  %231 = call double @llvm.fmuladd.f64(double %214, double %230, double %.558)
  br label %232

232:                                              ; preds = %211
  %233 = add nsw i32 %.41556, 1
  %234 = icmp sle i32 %233, %209
  br i1 %234, label %211, label %._crit_edge61, !llvm.loop !13

._crit_edge61:                                    ; preds = %232
  %split62 = phi double [ %231, %232 ]
  br label %235

235:                                              ; preds = %._crit_edge61, %160
  %.5.lcssa = phi double [ %split62, %._crit_edge61 ], [ 0.000000e+00, %160 ]
  ...
  %266 = call double @llvm.fmuladd.f64(double %265, double %.5.lcssa, double %264)
  ...
  br i1 %294, label %.lr.ph66, label %316

.lr.ph66:                                         ; preds = %235
  br label %295

295:                                              ; preds = %.lr.ph66, %313
  %.664 = phi double [ 0.000000e+00, %.lr.ph66 ], [ %312, %313 ]
  %.51663 = phi i32 [ 1, %.lr.ph66 ], [ %314, %313 ]
  %296 = sitofp i32 %.51663 to double
  ...
  %310 = call double @llvm.fmuladd.f64(double %298, double %309, double %.664)
  %311 = load double, ptr @one, align 8
  %312 = fadd double %310, %311
  br label %313

313:                                              ; preds = %295
  %314 = add nsw i32 %.51663, 1
  %315 = icmp sle i32 %314, %293
  br i1 %315, label %295, label %._crit_edge67, !llvm.loop !14

._crit_edge67:                                    ; preds = %313
  %split68 = phi double [ %312, %313 ]
  br label %316

316:                                              ; preds = %._crit_edge67, %235
  %.6.lcssa = phi double [ %split68, %._crit_edge67 ], [ 0.000000e+00, %235 ]
  ...
  %346 = call double @llvm.fmuladd.f64(double %345, double %.6.lcssa, double %344)
  ...
  br i1 %388, label %.lr.ph72, label %425

.lr.ph72:                                         ; preds = %316
  br label %389

389:                                              ; preds = %.lr.ph72, %422
  %.770 = phi double [ 0.000000e+00, %.lr.ph72 ], [ %421, %422 ]
  %.61769 = phi i32 [ 1, %.lr.ph72 ], [ %423, %422 ]
  %390 = sitofp i32 %.61769 to double
  ...
  %421 = fadd double %.770, %420
  br label %422

422:                                              ; preds = %389
  %423 = add nsw i32 %.61769, 1
  %424 = icmp sle i32 %423, %387
  br i1 %424, label %389, label %._crit_edge73, !llvm.loop !15

._crit_edge73:                                    ; preds = %422
  %split74 = phi double [ %421, %422 ]
  br label %425

425:                                              ; preds = %._crit_edge73, %316
  %.7.lcssa = phi double [ %split74, %._crit_edge73 ], [ 0.000000e+00, %316 ]
  ...
  %470 = call double @llvm.fmuladd.f64(double %469, double %.7.lcssa, double %468)
  ...
  br i1 %494, label %.lr.ph78, label %530

.lr.ph78:                                         ; preds = %425
  br label %495

495:                                              ; preds = %.lr.ph78, %527
  %.876 = phi double [ 0.000000e+00, %.lr.ph78 ], [ %526, %527 ]
  %.71875 = phi i32 [ 1, %.lr.ph78 ], [ %528, %527 ]
  %496 = sitofp i32 %.71875 to double
  ...
  %526 = call double @llvm.fmuladd.f64(double %512, double %525, double %.876)
  br label %527

527:                                              ; preds = %495
  %528 = add nsw i32 %.71875, 1
  %529 = icmp sle i32 %528, %493
  br i1 %529, label %495, label %._crit_edge79, !llvm.loop !16

._crit_edge79:                                    ; preds = %527
  %split80 = phi double [ %526, %527 ]
  br label %530

530:                                              ; preds = %._crit_edge79, %425
  %.8.lcssa = phi double [ %split80, %._crit_edge79 ], [ 0.000000e+00, %425 ]
  ...
  %575 = call double @llvm.fmuladd.f64(double %574, double %.8.lcssa, double %573)
  ...
  br i1 %598, label %.lr.ph84, label %615

.lr.ph84:                                         ; preds = %530
  br label %599

599:                                              ; preds = %.lr.ph84, %612
  %.982 = phi double [ 0.000000e+00, %.lr.ph84 ], [ %611, %612 ]
  %.81981 = phi i32 [ 1, %.lr.ph84 ], [ %613, %612 ]
  %600 = sitofp i32 %.81981 to double
  %601 = fmul double %600, %595
  %602 = fmul double %601, %601
  %603 = fadd double %601, %592
  %604 = fdiv double %592, %603
  %605 = fsub double %.982, %604
...
612:                                              ; preds = %599
  %613 = add nsw i32 %.81981, 1
  %614 = icmp sle i32 %613, %597
  br i1 %614, label %599, label %._crit_edge85, !llvm.loop !17

._crit_edge85:                                    ; preds = %612
  %split86 = phi double [ %611, %612 ]
  br label %615

615:                                              ; preds = %._crit_edge85, %530
  %.9.lcssa = phi double [ %split86, %._crit_edge85 ], [ 0.000000e+00, %530 ]
  ...
  %639 = call double @llvm.fmuladd.f64(double %638, double %.9.lcssa, double %637)
  ...
  br i1 %667, label %.lr.ph90, label %704

.lr.ph90:                                         ; preds = %615
  br label %668

668:                                              ; preds = %.lr.ph90, %701
  %.1088 = phi double [ 0.000000e+00, %.lr.ph90 ], [ %700, %701 ]
  %.92087 = phi i32 [ 1, %.lr.ph90 ], [ %702, %701 ]
  %669 = sitofp i32 %.92087 to double
  ...
  %700 = call double @llvm.fmuladd.f64(double %686, double %699, double %.1088)
  br label %701

701:                                              ; preds = %668
  %702 = add nsw i32 %.92087, 1
  %703 = icmp sle i32 %702, %666
  br i1 %703, label %668, label %._crit_edge91, !llvm.loop !18

._crit_edge91:                                    ; preds = %701
  %split92 = phi double [ %700, %701 ]
  br label %704

704:                                              ; preds = %._crit_edge91, %615
  %.10.lcssa = phi double [ %split92, %._crit_edge91 ], [ 0.000000e+00, %615 ]
