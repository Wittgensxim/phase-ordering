...
122:                                              ; preds = %128, %65
  %.3276 = phi double [ %118, %65 ], [ %125, %128 ]
  %.2 = phi i32 [ 1, %65 ], [ %129, %128 ]
  %123 = icmp sle i32 %.2, %104
  br i1 %123, label %124, label %130

124:                                              ; preds = %122
  %125 = fneg double %.3276
...
158:                                              ; preds = %142
  %.1289.lcssa = phi double [ %.1289, %142 ]
  %.0287.lcssa = phi double [ %.0287, %142 ]
  %.2286.lcssa = phi double [ %.2286, %142 ]
...
210:                                              ; preds = %207
  ...
  %230 = call double @llvm.fmuladd.f64(double %213, double %229, double %.5278)
  br label %231
...
233:                                              ; preds = %207
  %.5278.lcssa = phi double [ %.5278, %207 ]
...
294:                                              ; preds = %291
  ...
  %309 = call double @llvm.fmuladd.f64(double %297, double %308, double %.6279)
...
314:                                              ; preds = %291
  %.6279.lcssa = phi double [ %.6279, %291 ]
...
385:                                              ; preds = %421, %314
  ...
  %387 = icmp sle i32 %.6, %386
  br i1 %387, label %388, label %423

388:                                              ; preds = %385
  %389 = sitofp i32 %.6 to double
...
423:                                              ; preds = %385
  %.7280.lcssa = phi double [ %.7280, %385 ]
...
491:                                              ; preds = %526, %423
  ...
  %493 = icmp sle i32 %.7, %492
  br i1 %493, label %494, label %528

494:                                              ; preds = %491
  %495 = sitofp i32 %.7 to double
  ...
  %525 = call double @llvm.fmuladd.f64(double %511, double %524, double %.8281)
  br label %526
...
528:                                              ; preds = %491
  %.8281.lcssa = phi double [ %.8281, %491 ]
...
613:                                              ; preds = %595
  %.9282.lcssa = phi double [ %.9282, %595 ]
...
664:                                              ; preds = %700, %613
  ...
  %666 = icmp sle i32 %.9, %665
  br i1 %666, label %667, label %702

667:                                              ; preds = %664
  %668 = sitofp i32 %.9 to double
