...
139:                                              ; preds = %146, %135
  ...
  %141 = phi double [ %147, %146 ], [ %.lcssa9, %135 ]
...
159:                                              ; preds = %139
  %.lcssa8 = phi double [ %142, %139 ]
  %.lcssa7 = phi double [ %143, %139 ]
  ...
  %177 = fdiv double %175, %.lcssa8
  %178 = fadd double %176, %177
  store double %178, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %179 = fmul double %.lcssa8, %.lcssa8
  %180 = fmul double %179, %.lcssa8
...
224:                                              ; preds = %197
  ...
  %253 = call double @llvm.fmuladd.f64(double %252, double %.lcssa6, double %250)
...
294:                                              ; preds = %271
  ...
  %321 = call double @llvm.fmuladd.f64(double %320, double %.lcssa4, double %319)
...
386:                                              ; preds = %349
  ...
  %426 = call double @llvm.fmuladd.f64(double %425, double %.lcssa3, double %423)
...
476:                                              ; preds = %440
  ...
  %516 = call double @llvm.fmuladd.f64(double %515, double %.lcssa2, double %513)
...
547:                                              ; preds = %528
  ...
  %570 = call double @llvm.fmuladd.f64(double %569, double %.lcssa1, double %567)
