...
10:                                               ; preds = %41, %0
  %.08 = phi double [ undef, %0 ], [ %18, %41 ]
  %.01 = phi double [ undef, %0 ], [ %.12, %41 ]
...
21:                                               ; preds = %24, %14
  %.011 = phi i32 [ 1, %14 ], [ %40, %24 ]
  %.04 = phi double [ 0.000000e+00, %14 ], [ %25, %24 ]
  %.12 = phi double [ 0.000000e+00, %14 ], [ %39, %24 ]
  %22 = sub nsw i32 %15, 1
...
45:                                               ; preds = %41, %10
  %.19 = phi double [ %18, %41 ], [ %.08, %10 ]
  %.2 = phi double [ %.12, %41 ], [ %.01, %10 ]
  %.1 = phi i32 [ %15, %41 ], [ %.0, %10 ]
...
61:                                               ; preds = %60, %53
  ...
  %87 = call double @llvm.fmuladd.f64(double %86, double %.2, double %85)
...
118:                                              ; preds = %120, %61
  %.213 = phi i32 [ 1, %61 ], [ %124, %120 ]
  %.3 = phi double [ %114, %61 ], [ %121, %120 ]
  %119 = icmp sle i32 %.213, %100
...
137:                                              ; preds = %139, %133
  %.314 = phi i32 [ 1, %133 ], [ %151, %139 ]
  %.210 = phi double [ 0.000000e+00, %133 ], [ %146, %139 ]
  %.07 = phi double [ 0.000000e+00, %133 ], [ %150, %139 ]
  %.15 = phi double [ 0.000000e+00, %133 ], [ %148, %139 ]
  %.03 = phi double [ %135, %133 ], [ %144, %139 ]
  %.4 = phi double [ %.3, %133 ], [ %140, %139 ]
  %138 = icmp sle i32 %.314, %100
...
139:                                              ; preds = %137
  ...
  %144 = fadd double %.03, %143
  %145 = fsub double %140, %144
  %146 = fadd double %.210, %145
  %147 = fneg double %140
  %148 = call double @llvm.fmuladd.f64(double %147, double %144, double %.15)
  %149 = fdiv double %140, %144
  %150 = fadd double %.07, %149
  %151 = add nsw i32 %.314, 1
...
152:                                              ; preds = %137
  ...
  %176 = fmul double %.15, %.15
  %177 = fmul double %176, %.15
...
201:                                              ; preds = %204, %152
  %.415 = phi i32 [ 1, %152 ], [ %225, %204 ]
  %.26 = phi double [ 0.000000e+00, %152 ], [ %206, %204 ]
  %.5 = phi double [ 0.000000e+00, %152 ], [ %224, %204 ]
  %202 = sub nsw i32 %165, 1
  %203 = icmp sle i32 %.415, %202
  br i1 %203, label %204, label %226

204:                                              ; preds = %201
  %205 = load double, ptr @one, align 8
  %206 = fadd double %.26, %205
  ...
  %224 = call double @llvm.fmuladd.f64(double %207, double %223, double %.5)
  %225 = add nsw i32 %.415, 1
...
226:                                              ; preds = %201
  ...
  %257 = call double @llvm.fmuladd.f64(double %256, double %.5, double %255)
...
284:                                              ; preds = %287, %226
  %.516 = phi i32 [ 1, %226 ], [ %305, %287 ]
  %.6 = phi double [ 0.000000e+00, %226 ], [ %304, %287 ]
  %285 = sub nsw i32 %165, 1
  %286 = icmp sle i32 %.516, %285
  br i1 %286, label %287, label %306

287:                                              ; preds = %284
  %288 = sitofp i32 %.516 to double
  ...
  %302 = call double @llvm.fmuladd.f64(double %290, double %301, double %.6)
  %303 = load double, ptr @one, align 8
  %304 = fadd double %302, %303
  %305 = add nsw i32 %.516, 1
...
306:                                              ; preds = %284
  ...
  %336 = call double @llvm.fmuladd.f64(double %335, double %.6, double %334)
...
377:                                              ; preds = %380, %306
  %.617 = phi i32 [ 1, %306 ], [ %413, %380 ]
  %.7 = phi double [ 0.000000e+00, %306 ], [ %412, %380 ]
  %378 = sub nsw i32 %165, 1
  %379 = icmp sle i32 %.617, %378
  br i1 %379, label %380, label %414

380:                                              ; preds = %377
  %381 = sitofp i32 %.617 to double
  ...
  %412 = fadd double %.7, %411
  %413 = add nsw i32 %.617, 1
...
414:                                              ; preds = %377
  ...
  %459 = call double @llvm.fmuladd.f64(double %458, double %.7, double %457)
...
482:                                              ; preds = %485, %414
  %.718 = phi i32 [ 1, %414 ], [ %517, %485 ]
  %.8 = phi double [ 0.000000e+00, %414 ], [ %516, %485 ]
  %483 = sub nsw i32 %165, 1
  %484 = icmp sle i32 %.718, %483
...
518:                                              ; preds = %482
  ...
  %563 = call double @llvm.fmuladd.f64(double %562, double %.8, double %561)
...
602:                                              ; preds = %585
  ...
  %626 = call double @llvm.fmuladd.f64(double %625, double %.9, double %624)
