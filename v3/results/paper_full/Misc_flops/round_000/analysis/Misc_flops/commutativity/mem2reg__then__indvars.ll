...
40:                                               ; preds = %24
  %41 = add nuw i32 %.011, 1
  br label %23, !llvm.loop !7

42:                                               ; preds = %23
  %.2.lcssa = phi double [ %.2, %23 ]
...
62:                                               ; preds = %61, %54
  ...
  %88 = call double @llvm.fmuladd.f64(double %87, double %.12, double %86)
  ...
  %smax25 = call i32 @llvm.smax.i32(i32 %101, i32 0)
  %119 = add nuw i32 %smax25, 1
  br label %120

120:                                              ; preds = %125, %62
  %.213 = phi i32 [ 1, %62 ], [ %126, %125 ]
  %.3 = phi double [ %115, %62 ], [ %122, %125 ]
  %exitcond26 = icmp ne i32 %.213, %119
  br i1 %exitcond26, label %121, label %127
...
125:                                              ; preds = %121
  %126 = add nuw i32 %.213, 1
  br label %120, !llvm.loop !11

127:                                              ; preds = %120
  %.3.lcssa = phi double [ %.3, %120 ]
...
135:                                              ; preds = %134, %127
  ...
  %smax27 = call i32 @llvm.smax.i32(i32 %101, i32 0)
  %139 = add nuw i32 %smax27, 1
  br label %140

140:                                              ; preds = %153, %135
  %.314 = phi i32 [ 1, %135 ], [ %154, %153 ]
  %.210 = phi double [ 0.000000e+00, %135 ], [ %148, %153 ]
  %.07 = phi double [ 0.000000e+00, %135 ], [ %152, %153 ]
  %.15 = phi double [ 0.000000e+00, %135 ], [ %150, %153 ]
  %.03 = phi double [ %137, %135 ], [ %146, %153 ]
  %.4 = phi double [ %.3.lcssa, %135 ], [ %142, %153 ]
  %exitcond28 = icmp ne i32 %.314, %139
  br i1 %exitcond28, label %141, label %155
...
141:                                              ; preds = %140
  ...
  %146 = fadd double %.03, %145
  %147 = fsub double %142, %146
  %148 = fadd double %.210, %147
  %149 = fneg double %142
  %150 = call double @llvm.fmuladd.f64(double %149, double %146, double %.15)
  %151 = fdiv double %142, %146
  %152 = fadd double %.07, %151
  br label %153

153:                                              ; preds = %141
  %154 = add nuw i32 %.314, 1
  br label %140, !llvm.loop !12

155:                                              ; preds = %140
  %.210.lcssa = phi double [ %.210, %140 ]
  %.07.lcssa = phi double [ %.07, %140 ]
  %.15.lcssa = phi double [ %.15, %140 ]
  ...
  %179 = fmul double %.15.lcssa, %.15.lcssa
  %180 = fmul double %179, %.15.lcssa
  ...
  %204 = add i32 %168, -1
  %smax29 = call i32 @llvm.smax.i32(i32 %204, i32 0)
  %205 = add nuw i32 %smax29, 1
  br label %206

206:                                              ; preds = %228, %155
  %.415 = phi i32 [ 1, %155 ], [ %229, %228 ]
  %.26 = phi double [ 0.000000e+00, %155 ], [ %209, %228 ]
  %.5 = phi double [ 0.000000e+00, %155 ], [ %227, %228 ]
  %exitcond30 = icmp ne i32 %.415, %205
  br i1 %exitcond30, label %207, label %230

207:                                              ; preds = %206
  %208 = load double, ptr @one, align 8
  %209 = fadd double %.26, %208
  ...
  %227 = call double @llvm.fmuladd.f64(double %210, double %226, double %.5)
  br label %228

228:                                              ; preds = %207
  %229 = add nuw i32 %.415, 1
  br label %206, !llvm.loop !13

230:                                              ; preds = %206
  %.5.lcssa = phi double [ %.5, %206 ]
  ...
  %261 = call double @llvm.fmuladd.f64(double %260, double %.5.lcssa, double %259)
...
288:                                              ; preds = %307, %230
  %.516 = phi i32 [ 1, %230 ], [ %308, %307 ]
  %.6 = phi double [ 0.000000e+00, %230 ], [ %306, %307 ]
  %exitcond31 = icmp ne i32 %.516, %205
  br i1 %exitcond31, label %289, label %309

289:                                              ; preds = %288
  %290 = sitofp i32 %.516 to double
  ...
  %304 = call double @llvm.fmuladd.f64(double %292, double %303, double %.6)
  %305 = load double, ptr @one, align 8
  %306 = fadd double %304, %305
  br label %307

307:                                              ; preds = %289
  %308 = add nuw i32 %.516, 1
  br label %288, !llvm.loop !14

309:                                              ; preds = %288
  %.6.lcssa = phi double [ %.6, %288 ]
  ...
  %339 = call double @llvm.fmuladd.f64(double %338, double %.6.lcssa, double %337)
...
380:                                              ; preds = %414, %309
  %.617 = phi i32 [ 1, %309 ], [ %415, %414 ]
  %.7 = phi double [ 0.000000e+00, %309 ], [ %413, %414 ]
  %exitcond32 = icmp ne i32 %.617, %205
  br i1 %exitcond32, label %381, label %416

381:                                              ; preds = %380
  %382 = sitofp i32 %.617 to double
  ...
  %413 = fadd double %.7, %412
  br label %414

414:                                              ; preds = %381
  %415 = add nuw i32 %.617, 1
  br label %380, !llvm.loop !15

416:                                              ; preds = %380
  %.7.lcssa = phi double [ %.7, %380 ]
  ...
  %461 = call double @llvm.fmuladd.f64(double %460, double %.7.lcssa, double %459)
...
484:                                              ; preds = %517, %416
  %.718 = phi i32 [ 1, %416 ], [ %518, %517 ]
  %.8 = phi double [ 0.000000e+00, %416 ], [ %516, %517 ]
  %exitcond33 = icmp ne i32 %.718, %205
  br i1 %exitcond33, label %485, label %519

485:                                              ; preds = %484
  %486 = sitofp i32 %.718 to double
  ...
  %516 = call double @llvm.fmuladd.f64(double %502, double %515, double %.8)
  br label %517

517:                                              ; preds = %485
  %518 = add nuw i32 %.718, 1
  br label %484, !llvm.loop !16

519:                                              ; preds = %484
  %.8.lcssa = phi double [ %.8, %484 ]
  ...
  %564 = call double @llvm.fmuladd.f64(double %563, double %.8.lcssa, double %562)
...
586:                                              ; preds = %600, %519
  %.819 = phi i32 [ 1, %519 ], [ %601, %600 ]
  %.9 = phi double [ 0.000000e+00, %519 ], [ %599, %600 ]
  %exitcond34 = icmp ne i32 %.819, %205
  br i1 %exitcond34, label %587, label %602

587:                                              ; preds = %586
  %588 = sitofp i32 %.819 to double
  %589 = fmul double %588, %584
  %590 = fmul double %589, %589
  %591 = fadd double %589, %581
  %592 = fdiv double %581, %591
  %593 = fsub double %.9, %592
...
600:                                              ; preds = %587
  %601 = add nuw i32 %.819, 1
  br label %586, !llvm.loop !17

602:                                              ; preds = %586
  %.9.lcssa = phi double [ %.9, %586 ]
  ...
  %626 = call double @llvm.fmuladd.f64(double %625, double %.9.lcssa, double %624)
  ...
  %653 = add i32 %634, -1
  %smax35 = call i32 @llvm.smax.i32(i32 %653, i32 0)
  %654 = add nuw i32 %smax35, 1
  br label %655

655:                                              ; preds = %689, %602
  %.920 = phi i32 [ 1, %602 ], [ %690, %689 ]
  %.10 = phi double [ 0.000000e+00, %602 ], [ %688, %689 ]
  %exitcond36 = icmp ne i32 %.920, %654
  br i1 %exitcond36, label %656, label %691

656:                                              ; preds = %655
  %657 = sitofp i32 %.920 to double
