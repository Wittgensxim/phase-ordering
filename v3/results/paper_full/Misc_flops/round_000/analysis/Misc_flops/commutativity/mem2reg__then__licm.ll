...
10:                                               ; preds = %47, %0
  ...
  %.01 = phi double [ undef, %0 ], [ %.2.lcssa, %47 ]
...
28:                                               ; preds = %40, %14
  ...
  %.04 = phi double [ 0.000000e+00, %14 ], [ %31, %40 ]
  %.2 = phi double [ 0.000000e+00, %14 ], [ %39, %40 ]
  %29 = icmp sle i32 %.011, %21
  br i1 %29, label %30, label %42

30:                                               ; preds = %28
  %31 = fadd double %.04, %19
...
46:                                               ; preds = %42
  %.lcssa24 = phi i32 [ %15, %42 ]
  %.lcssa = phi double [ %18, %42 ]
  %.2.lcssa.lcssa = phi double [ %.2.lcssa, %42 ]
  br label %48
...
.loopexit:                                        ; preds = %10
  %.08.lcssa = phi double [ %.08, %10 ]
  %.01.lcssa = phi double [ %.01, %10 ]
  %.0.lcssa = phi i32 [ %.0, %10 ]
  br label %48

48:                                               ; preds = %.loopexit, %46
  %.19 = phi double [ %.lcssa, %46 ], [ %.08.lcssa, %.loopexit ]
  %.12 = phi double [ %.2.lcssa.lcssa, %46 ], [ %.01.lcssa, %.loopexit ]
  %.1 = phi i32 [ %.lcssa24, %46 ], [ %.0.lcssa, %.loopexit ]
...
122:                                              ; preds = %128, %65
  ...
  %.3 = phi double [ %118, %65 ], [ %126, %128 ]
  %124 = icmp sle i32 %.213, %104
...
138:                                              ; preds = %137, %130
  ...
  %sa.promoted25 = load double, ptr @sa, align 8
  br label %143

143:                                              ; preds = %156, %138
  %144 = phi double [ %sa.promoted25, %138 ], [ %148, %156 ]
  ...
  %.4 = phi double [ %.3.lcssa, %138 ], [ %147, %156 ]
  %145 = icmp sle i32 %.314, %104
...
158:                                              ; preds = %143
  %.210.lcssa = phi double [ %.210, %143 ]
  %.07.lcssa = phi double [ %.07, %143 ]
  %.15.lcssa = phi double [ %.15, %143 ]
  ...
  %182 = fmul double %.15.lcssa, %.15.lcssa
  %183 = fmul double %182, %.15.lcssa
...
218:                                              ; preds = %231, %158
  ...
  %.26 = phi double [ 0.000000e+00, %158 ], [ %221, %231 ]
  %.5 = phi double [ 0.000000e+00, %158 ], [ %230, %231 ]
  %219 = icmp sle i32 %.415, %207
  br i1 %219, label %220, label %233

220:                                              ; preds = %218
  %221 = fadd double %.26, %208
  ...
  %230 = call double @llvm.fmuladd.f64(double %222, double %229, double %.5)
  br label %231
...
233:                                              ; preds = %218
  ...
  %264 = call double @llvm.fmuladd.f64(double %263, double %.5.lcssa, double %262)
...
299:                                              ; preds = %312, %233
  ...
  %300 = icmp sle i32 %.516, %291
  br i1 %300, label %301, label %314

301:                                              ; preds = %299
  %302 = sitofp i32 %.516 to double
  ...
  %310 = call double @llvm.fmuladd.f64(double %304, double %309, double %.6)
...
314:                                              ; preds = %299
  ...
  %344 = call double @llvm.fmuladd.f64(double %343, double %.6.lcssa, double %342)
...
400:                                              ; preds = %421, %314
  ...
  %401 = icmp sle i32 %.617, %385
  br i1 %401, label %402, label %423

402:                                              ; preds = %400
  %403 = sitofp i32 %.617 to double
...
423:                                              ; preds = %400
  ...
  %468 = call double @llvm.fmuladd.f64(double %467, double %.7.lcssa, double %466)
...
506:                                              ; preds = %526, %423
  ...
  %507 = icmp sle i32 %.718, %491
  br i1 %507, label %508, label %528

508:                                              ; preds = %506
  %509 = sitofp i32 %.718 to double
  ...
  %525 = call double @llvm.fmuladd.f64(double %518, double %524, double %.8)
  br label %526
...
528:                                              ; preds = %506
  ...
  %573 = call double @llvm.fmuladd.f64(double %572, double %.8.lcssa, double %571)
...
613:                                              ; preds = %596
  ...
  %637 = call double @llvm.fmuladd.f64(double %636, double %.9.lcssa, double %635)
...
679:                                              ; preds = %700, %613
  ...
  %680 = icmp sle i32 %.920, %664
  br i1 %680, label %681, label %702

681:                                              ; preds = %679
  %682 = sitofp i32 %.920 to double
