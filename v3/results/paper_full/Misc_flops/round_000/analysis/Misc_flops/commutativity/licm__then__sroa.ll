...
54:                                               ; preds = %.loopexit, %52
  %.0240 = phi double [ %.lcssa12, %52 ], [ %.lcssa11, %.loopexit ]
  %.0239 = phi double [ %.lcssa6.lcssa, %52 ], [ %.lcssa614.lcssa, %.loopexit ]
...
72:                                               ; preds = %71, %64
  ...
  %98 = call double @llvm.fmuladd.f64(double %97, double %.0239, double %96)
  %99 = fmul double %.0240, %98
...
152:                                              ; preds = %171, %147
  %.0241 = phi double [ 0.000000e+00, %147 ], [ %170, %171 ]
