...
13:                                               ; preds = %15, %7
  %.011 = phi i32 [ 1, %7 ], [ %30, %15 ]
  %.04 = phi double [ 0.000000e+00, %7 ], [ %16, %15 ]
  %.2 = phi double [ 0.000000e+00, %7 ], [ %29, %15 ]
  %.not.not = icmp slt i32 %.011, %8
...
37:                                               ; preds = %35, %3
  %.19 = phi double [ %11, %35 ], [ %.08, %3 ]
  %.12 = phi double [ %.2, %35 ], [ %.01, %3 ]
  %.1 = phi i32 [ %8, %35 ], [ %.0, %3 ]
...
39:                                               ; preds = %41, %37
  %.112 = phi i32 [ 1, %37 ], [ %42, %41 ]
  %.not.not23 = icmp slt i32 %.112, %.1
  br i1 %.not.not23, label %40, label %43

40:                                               ; preds = %39
  br label %41

41:                                               ; preds = %40
  %42 = add nuw nsw i32 %.112, 1
...
50:                                               ; preds = %49, %43
  ...
  %72 = call double @llvm.fmuladd.f64(double %71, double %.12, double %70)
...
98:                                               ; preds = %102, %50
  %.213 = phi i32 [ 1, %50 ], [ %104, %102 ]
  %.3 = phi double [ %94, %50 ], [ %103, %102 ]
  %.not = icmp sgt i32 %.213, %82
...
112:                                              ; preds = %111, %105
  %storemerge24 = phi double [ 0.000000e+00, %111 ], [ %109, %105 ]
...
116:                                              ; preds = %120, %112
  %.314 = phi i32 [ 1, %112 ], [ %129, %120 ]
  %.210 = phi double [ 0.000000e+00, %112 ], [ %128, %120 ]
  %.07 = phi double [ 0.000000e+00, %112 ], [ %125, %120 ]
  %.15 = phi double [ 0.000000e+00, %112 ], [ %126, %120 ]
  %.03 = phi double [ %114, %112 ], [ %122, %120 ]
  %.4 = phi double [ %.3, %112 ], [ %123, %120 ]
  %.not25 = icmp sgt i32 %.314, %82
  br i1 %.not25, label %130, label %117

117:                                              ; preds = %116
  %118 = load double, ptr @sa, align 8
  %119 = fsub double %118, %.4
...
171:                                              ; preds = %173, %130
  %.415 = phi i32 [ 1, %130 ], [ %194, %173 ]
  %.26 = phi double [ 0.000000e+00, %130 ], [ %175, %173 ]
  %.5 = phi double [ 0.000000e+00, %130 ], [ %193, %173 ]
  %.not26.not = icmp slt i32 %.415, %142
  br i1 %.not26.not, label %172, label %195
...
173:                                              ; preds = %172
  ...
  %193 = call double @llvm.fmuladd.f64(double %176, double %192, double %.5)
  %194 = add nuw nsw i32 %.415, 1
...
247:                                              ; preds = %249, %195
  %.516 = phi i32 [ 1, %195 ], [ %267, %249 ]
  %.6 = phi double [ 0.000000e+00, %195 ], [ %266, %249 ]
  %.not27.not = icmp slt i32 %.516, %142
  br i1 %.not27.not, label %248, label %268

248:                                              ; preds = %247
  br label %249

249:                                              ; preds = %248
  %250 = uitofp nneg i32 %.516 to double
  ...
  %264 = call double @llvm.fmuladd.f64(double %252, double %263, double %.6)
  %265 = load double, ptr @one, align 8
  %266 = fadd double %264, %265
  %267 = add nuw nsw i32 %.516, 1
...
333:                                              ; preds = %335, %268
  %.617 = phi i32 [ 1, %268 ], [ %368, %335 ]
  %.7 = phi double [ 0.000000e+00, %268 ], [ %367, %335 ]
  %.not28.not = icmp slt i32 %.617, %142
  br i1 %.not28.not, label %334, label %369

334:                                              ; preds = %333
  br label %335

335:                                              ; preds = %334
  %336 = uitofp nneg i32 %.617 to double
...
430:                                              ; preds = %432, %369
  %.718 = phi i32 [ 1, %369 ], [ %464, %432 ]
  %.8 = phi double [ 0.000000e+00, %369 ], [ %463, %432 ]
  %.not29.not = icmp slt i32 %.718, %142
  br i1 %.not29.not, label %431, label %465

431:                                              ; preds = %430
  br label %432

432:                                              ; preds = %431
  %433 = uitofp nneg i32 %.718 to double
...
524:                                              ; preds = %526, %465
  %.819 = phi i32 [ 1, %465 ], [ %539, %526 ]
  %.9 = phi double [ 0.000000e+00, %465 ], [ %538, %526 ]
  %.not30.not = icmp slt i32 %.819, %142
  br i1 %.not30.not, label %525, label %540

525:                                              ; preds = %524
  br label %526

526:                                              ; preds = %525
  %527 = uitofp nneg i32 %.819 to double
  %528 = fmul double %522, %527
  %529 = fadd double %528, %520
  %530 = fdiv double %520, %529
  %531 = fsub double %.9, %530
...
586:                                              ; preds = %588, %540
  %.920 = phi i32 [ 1, %540 ], [ %621, %588 ]
  %.10 = phi double [ 0.000000e+00, %540 ], [ %620, %588 ]
  %.not31.not = icmp slt i32 %.920, %569
  br i1 %.not31.not, label %587, label %622

587:                                              ; preds = %586
  br label %588

588:                                              ; preds = %587
  %589 = uitofp nneg i32 %.920 to double
