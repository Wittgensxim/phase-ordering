...
8:                                                ; preds = %45, %0
  %.0284 = phi double [ undef, %0 ], [ %16, %45 ]
  %.0273 = phi double [ undef, %0 ], [ %.2275, %45 ]
...
19:                                               ; preds = %38, %12
  %.0288 = phi double [ 0.000000e+00, %12 ], [ %23, %38 ]
  %.2275 = phi double [ 0.000000e+00, %12 ], [ %37, %38 ]
  %.0271 = phi i32 [ 1, %12 ], [ %39, %38 ]
  %20 = sub nsw i32 %13, 1
  %21 = icmp sle i32 %.0271, %20
  br i1 %21, label %22, label %40

22:                                               ; preds = %19
  %23 = fadd double %.0288, %17
  ...
  %37 = fadd double %.2275, %36
  br label %38

38:                                               ; preds = %22
  %39 = add nsw i32 %.0271, 1
...
46:                                               ; preds = %44, %8
  %.1285 = phi double [ %16, %44 ], [ %.0284, %8 ]
  %.1274 = phi double [ %.2275, %44 ], [ %.0273, %8 ]
...
49:                                               ; preds = %53, %46
  %.1272 = phi i32 [ 1, %46 ], [ %54, %53 ]
  %50 = sub nsw i32 %.1, 1
  %51 = icmp sle i32 %.1272, %50
...
63:                                               ; preds = %62, %55
  ...
  %89 = call double @llvm.fmuladd.f64(double %88, double %.1274, double %87)
  %90 = fmul double %.1285, %89
...
120:                                              ; preds = %126, %63
  %.3276 = phi double [ %116, %63 ], [ %123, %126 ]
  %.2 = phi i32 [ 1, %63 ], [ %127, %126 ]
  %121 = icmp sle i32 %.2, %102
  br i1 %121, label %122, label %128

122:                                              ; preds = %120
  %123 = fneg double %.3276
...
140:                                              ; preds = %154, %136
  %.1289 = phi double [ 0.000000e+00, %136 ], [ %151, %154 ]
  %.0287 = phi double [ 0.000000e+00, %136 ], [ %153, %154 ]
  %.2286 = phi double [ 0.000000e+00, %136 ], [ %149, %154 ]
  %.0283 = phi double [ %138, %136 ], [ %147, %154 ]
  %.4277 = phi double [ %.3276, %136 ], [ %143, %154 ]
  %.3 = phi i32 [ 1, %136 ], [ %155, %154 ]
  %141 = icmp sle i32 %.3, %102
  br i1 %141, label %142, label %156

142:                                              ; preds = %140
  %143 = fneg double %.4277
  %144 = load double, ptr @sa, align 8
  %145 = fadd double %144, %143
  store double %145, ptr @sa, align 8
  %146 = load double, ptr @two, align 8
  %147 = fadd double %.0283, %146
  %148 = fsub double %143, %147
  %149 = fadd double %.2286, %148
  %150 = fneg double %143
  %151 = call double @llvm.fmuladd.f64(double %150, double %147, double %.1289)
  %152 = fdiv double %143, %147
  %153 = fadd double %.0287, %152
  br label %154
...
156:                                              ; preds = %140
  ...
  %180 = fmul double %.1289, %.1289
  %181 = fmul double %180, %.1289
...
205:                                              ; preds = %229, %156
  %.2290 = phi double [ 0.000000e+00, %156 ], [ %210, %229 ]
  %.5278 = phi double [ 0.000000e+00, %156 ], [ %228, %229 ]
  %.4 = phi i32 [ 1, %156 ], [ %230, %229 ]
  %206 = sub nsw i32 %169, 1
  %207 = icmp sle i32 %.4, %206
  br i1 %207, label %208, label %231

208:                                              ; preds = %205
  %209 = load double, ptr @one, align 8
  %210 = fadd double %.2290, %209
  ...
  %228 = call double @llvm.fmuladd.f64(double %211, double %227, double %.5278)
  br label %229
...
231:                                              ; preds = %205
  ...
  %262 = call double @llvm.fmuladd.f64(double %261, double %.5278, double %260)
...
289:                                              ; preds = %310, %231
  %.6279 = phi double [ 0.000000e+00, %231 ], [ %309, %310 ]
  %.5 = phi i32 [ 1, %231 ], [ %311, %310 ]
  %290 = sub nsw i32 %169, 1
  %291 = icmp sle i32 %.5, %290
...
292:                                              ; preds = %289
  ...
  %307 = call double @llvm.fmuladd.f64(double %295, double %306, double %.6279)
...
312:                                              ; preds = %289
  ...
  %342 = call double @llvm.fmuladd.f64(double %341, double %.6279, double %340)
...
383:                                              ; preds = %419, %312
  %.7280 = phi double [ 0.000000e+00, %312 ], [ %418, %419 ]
  %.6 = phi i32 [ 1, %312 ], [ %420, %419 ]
  %384 = sub nsw i32 %169, 1
  %385 = icmp sle i32 %.6, %384
  br i1 %385, label %386, label %421

386:                                              ; preds = %383
  %387 = sitofp i32 %.6 to double
...
421:                                              ; preds = %383
  ...
  %466 = call double @llvm.fmuladd.f64(double %465, double %.7280, double %464)
...
489:                                              ; preds = %524, %421
  %.8281 = phi double [ 0.000000e+00, %421 ], [ %523, %524 ]
  %.7 = phi i32 [ 1, %421 ], [ %525, %524 ]
  %490 = sub nsw i32 %169, 1
  %491 = icmp sle i32 %.7, %490
  br i1 %491, label %492, label %526

492:                                              ; preds = %489
  %493 = sitofp i32 %.7 to double
  ...
  %523 = call double @llvm.fmuladd.f64(double %509, double %522, double %.8281)
  br label %524
...
526:                                              ; preds = %489
  ...
  %571 = call double @llvm.fmuladd.f64(double %570, double %.8281, double %569)
...
611:                                              ; preds = %593
  ...
  %635 = call double @llvm.fmuladd.f64(double %634, double %.9282, double %633)
...
662:                                              ; preds = %698, %611
  ...
  %.9 = phi i32 [ 1, %611 ], [ %699, %698 ]
  %663 = sub nsw i32 %643, 1
  %664 = icmp sle i32 %.9, %663
  br i1 %664, label %665, label %700

665:                                              ; preds = %662
  %666 = sitofp i32 %.9 to double
