...
8:                                                ; preds = %44, %0
  %.0120 = phi double [ undef, %0 ], [ %16, %44 ]
  %.0109 = phi double [ undef, %0 ], [ %.2111, %44 ]
...
19:                                               ; preds = %37, %12
  %.0124 = phi double [ 0.000000e+00, %12 ], [ %23, %37 ]
  %.2111 = phi double [ 0.000000e+00, %12 ], [ %36, %37 ]
  %.0107 = phi i32 [ 1, %12 ], [ %38, %37 ]
  %20 = sub nsw i32 %13, 1
  %21 = icmp sle i32 %.0107, %20
  br i1 %21, label %22, label %39

22:                                               ; preds = %19
  %23 = fadd double %.0124, %17
  ...
  %36 = fadd double %.2111, %35
  br label %37

37:                                               ; preds = %22
  %38 = add nsw i32 %.0107, 1
...
45:                                               ; preds = %43, %8
  %.1121 = phi double [ %16, %43 ], [ %.0120, %8 ]
  %.1110 = phi double [ %.2111, %43 ], [ %.0109, %8 ]
  %.1 = phi i32 [ %13, %43 ], [ %.0, %8 ]
...
47:                                               ; preds = %51, %45
  %.1108 = phi i32 [ 1, %45 ], [ %52, %51 ]
  %48 = sub nsw i32 %.1, 1
  %49 = icmp sle i32 %.1108, %48
...
60:                                               ; preds = %59, %53
  ...
  %85 = call double @llvm.fmuladd.f64(double %84, double %.1110, double %83)
  %86 = fmul double %.1121, %85
...
112:                                              ; preds = %118, %60
  %.3112 = phi double [ %108, %60 ], [ %115, %118 ]
  %.2 = phi i32 [ 1, %60 ], [ %119, %118 ]
  %113 = icmp sle i32 %.2, %95
  br i1 %113, label %114, label %120

114:                                              ; preds = %112
  %115 = fneg double %.3112
...
131:                                              ; preds = %145, %127
  %.1125 = phi double [ 0.000000e+00, %127 ], [ %142, %145 ]
  %.0123 = phi double [ 0.000000e+00, %127 ], [ %144, %145 ]
  %.2122 = phi double [ 0.000000e+00, %127 ], [ %140, %145 ]
  %.0119 = phi double [ %129, %127 ], [ %138, %145 ]
  %.4113 = phi double [ %.3112, %127 ], [ %134, %145 ]
  %.3 = phi i32 [ 1, %127 ], [ %146, %145 ]
  %132 = icmp sle i32 %.3, %95
  br i1 %132, label %133, label %147

133:                                              ; preds = %131
  %134 = fneg double %.4113
  %135 = load double, ptr @sa, align 8
  %136 = fadd double %135, %134
  store double %136, ptr @sa, align 8
  %137 = load double, ptr @two, align 8
  %138 = fadd double %.0119, %137
  %139 = fsub double %134, %138
  %140 = fadd double %.2122, %139
  %141 = fneg double %134
  %142 = call double @llvm.fmuladd.f64(double %141, double %138, double %.1125)
  %143 = fdiv double %134, %138
  %144 = fadd double %.0123, %143
  br label %145
...
191:                                              ; preds = %215, %147
  %.2126 = phi double [ 0.000000e+00, %147 ], [ %196, %215 ]
  %.5114 = phi double [ 0.000000e+00, %147 ], [ %214, %215 ]
  %.4 = phi i32 [ 1, %147 ], [ %216, %215 ]
  %192 = sub nsw i32 %159, 1
  %193 = icmp sle i32 %.4, %192
  br i1 %193, label %194, label %217

194:                                              ; preds = %191
  %195 = load double, ptr @one, align 8
  %196 = fadd double %.2126, %195
  ...
  %214 = call double @llvm.fmuladd.f64(double %197, double %213, double %.5114)
  br label %215
...
217:                                              ; preds = %191
  ...
  %248 = call double @llvm.fmuladd.f64(double %247, double %.5114, double %246)
...
272:                                              ; preds = %293, %217
  %.6115 = phi double [ 0.000000e+00, %217 ], [ %292, %293 ]
  %.5 = phi i32 [ 1, %217 ], [ %294, %293 ]
  %273 = sub nsw i32 %159, 1
  %274 = icmp sle i32 %.5, %273
  br i1 %274, label %275, label %295

275:                                              ; preds = %272
  %276 = sitofp i32 %.5 to double
  ...
  %290 = call double @llvm.fmuladd.f64(double %278, double %289, double %.6115)
...
295:                                              ; preds = %272
  ...
  %325 = call double @llvm.fmuladd.f64(double %324, double %.6115, double %323)
...
363:                                              ; preds = %399, %295
  %.7116 = phi double [ 0.000000e+00, %295 ], [ %398, %399 ]
  %.6 = phi i32 [ 1, %295 ], [ %400, %399 ]
  %364 = sub nsw i32 %159, 1
  %365 = icmp sle i32 %.6, %364
  br i1 %365, label %366, label %401

366:                                              ; preds = %363
  %367 = sitofp i32 %.6 to double
...
401:                                              ; preds = %363
  ...
  %445 = call double @llvm.fmuladd.f64(double %444, double %.7116, double %443)
...
465:                                              ; preds = %500, %401
  %.8117 = phi double [ 0.000000e+00, %401 ], [ %499, %500 ]
  %.7 = phi i32 [ 1, %401 ], [ %501, %500 ]
  %466 = sub nsw i32 %159, 1
  %467 = icmp sle i32 %.7, %466
  br i1 %467, label %468, label %502

468:                                              ; preds = %465
  %469 = sitofp i32 %.7 to double
  ...
  %499 = call double @llvm.fmuladd.f64(double %485, double %498, double %.8117)
  br label %500
...
502:                                              ; preds = %465
  ...
  %546 = call double @llvm.fmuladd.f64(double %545, double %.8117, double %544)
...
582:                                              ; preds = %564
  ...
  %604 = call double @llvm.fmuladd.f64(double %603, double %.9118, double %601)
...
629:                                              ; preds = %665, %582
  ...
  %.9 = phi i32 [ 1, %582 ], [ %666, %665 ]
  %630 = sub nsw i32 %611, 1
  %631 = icmp sle i32 %.9, %630
  br i1 %631, label %632, label %667

632:                                              ; preds = %629
  %633 = sitofp i32 %.9 to double
