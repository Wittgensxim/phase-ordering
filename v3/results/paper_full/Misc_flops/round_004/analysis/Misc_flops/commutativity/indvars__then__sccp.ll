...
96:                                               ; preds = %99, %54
  %97 = phi double [ %100, %99 ], [ %91, %54 ]
  %98 = phi i32 [ %103, %99 ], [ 1, %54 ]
  %exitcond18 = icmp eq i32 %98, %95
  br i1 %exitcond18, label %104, label %99
...
116:                                              ; preds = %123, %111
  %117 = phi double [ %133, %123 ], [ 0.000000e+00, %111 ]
  %118 = phi double [ %128, %123 ], [ %113, %111 ]
  %119 = phi double [ %124, %123 ], [ %.lcssa9, %111 ]
  %120 = phi double [ %131, %123 ], [ 0.000000e+00, %111 ]
  %121 = phi double [ %130, %123 ], [ 0.000000e+00, %111 ]
  %122 = phi i32 [ %134, %123 ], [ 1, %111 ]
  %exitcond20 = icmp eq i32 %122, %115
...
135:                                              ; preds = %116
  %.lcssa8 = phi double [ %117, %116 ]
  %.lcssa7 = phi double [ %120, %116 ]
  %.lcssa6 = phi double [ %121, %116 ]
