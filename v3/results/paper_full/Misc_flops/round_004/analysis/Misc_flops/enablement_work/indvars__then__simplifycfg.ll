...
89:                                               ; preds = %92, %.loopexit
  %90 = phi double [ %93, %92 ], [ %84, %.loopexit ]
  %91 = phi i32 [ %96, %92 ], [ 1, %.loopexit ]
  %exitcond18 = icmp eq i32 %91, %88
  br i1 %exitcond18, label %97, label %92
...
97:                                               ; preds = %89
  ...
  %106 = add nuw i32 %smax19, 1
  br label %107

107:                                              ; preds = %114, %97
  %108 = phi double [ %124, %114 ], [ 0.000000e+00, %97 ]
  %109 = phi double [ %119, %114 ], [ %104, %97 ]
  %110 = phi double [ %115, %114 ], [ %.lcssa9, %97 ]
  %111 = phi double [ %122, %114 ], [ 0.000000e+00, %97 ]
  %112 = phi double [ %121, %114 ], [ 0.000000e+00, %97 ]
  %113 = phi i32 [ %125, %114 ], [ 1, %97 ]
  %exitcond20 = icmp eq i32 %113, %106
  br i1 %exitcond20, label %126, label %114
...
114:                                              ; preds = %107
  ...
  %122 = call double @llvm.fmuladd.f64(double %110, double %119, double %111)
  %123 = fdiv double %110, %119
  %124 = fsub double %108, %123
  %125 = add nuw i32 %113, 1
  br label %107, !llvm.loop !11

126:                                              ; preds = %107
  %.lcssa8 = phi double [ %108, %107 ]
  %.lcssa7 = phi double [ %111, %107 ]
  %.lcssa6 = phi double [ %112, %107 ]
...
163:                                              ; preds = %167, %126
  %164 = phi double [ %169, %167 ], [ 0.000000e+00, %126 ]
  %165 = phi double [ %186, %167 ], [ 0.000000e+00, %126 ]
  %166 = phi i32 [ %187, %167 ], [ 1, %126 ]
  %exitcond22 = icmp ne i32 %166, %smax21
  br i1 %exitcond22, label %167, label %188
...
167:                                              ; preds = %163
  ...
  %174 = fneg double %173
  %175 = call double @llvm.fmuladd.f64(double %172, double %171, double %174)
  %176 = load double, ptr @A4, align 8
  %177 = call double @llvm.fmuladd.f64(double %175, double %171, double %176)
  %178 = load double, ptr @A3, align 8
  %179 = fneg double %178
  %180 = call double @llvm.fmuladd.f64(double %177, double %171, double %179)
  %181 = load double, ptr @A2, align 8
  %182 = call double @llvm.fmuladd.f64(double %180, double %171, double %181)
  %183 = load double, ptr @A1, align 8
  %184 = call double @llvm.fmuladd.f64(double %182, double %171, double %183)
  %185 = call double @llvm.fmuladd.f64(double %184, double %171, double %168)
  %186 = call double @llvm.fmuladd.f64(double %170, double %185, double %165)
  %187 = add nuw i32 %166, 1
  br label %163, !llvm.loop !12

188:                                              ; preds = %163
  %.lcssa5 = phi double [ %165, %163 ]
...
235:                                              ; preds = %238, %188
  %236 = phi double [ %255, %238 ], [ 0.000000e+00, %188 ]
  %237 = phi i32 [ %256, %238 ], [ 1, %188 ]
  %exitcond23 = icmp ne i32 %237, %smax21
  br i1 %exitcond23, label %238, label %257

238:                                              ; preds = %235
  %239 = uitofp nneg i32 %237 to double
  %240 = fmul double %233, %239
  %241 = fmul double %240, %240
  %242 = load double, ptr @B6, align 8
  %243 = load double, ptr @B5, align 8
  %244 = call double @llvm.fmuladd.f64(double %242, double %241, double %243)
  %245 = load double, ptr @B4, align 8
  %246 = call double @llvm.fmuladd.f64(double %241, double %244, double %245)
  %247 = load double, ptr @B3, align 8
  %248 = call double @llvm.fmuladd.f64(double %241, double %246, double %247)
  %249 = load double, ptr @B2, align 8
  %250 = call double @llvm.fmuladd.f64(double %241, double %248, double %249)
  %251 = load double, ptr @B1, align 8
  %252 = call double @llvm.fmuladd.f64(double %241, double %250, double %251)
  %253 = call double @llvm.fmuladd.f64(double %241, double %252, double %236)
  %254 = load double, ptr @one, align 8
  %255 = fadd double %253, %254
  %256 = add nuw i32 %237, 1
  br label %235, !llvm.loop !13

257:                                              ; preds = %235
  %.lcssa4 = phi double [ %236, %235 ]
...
312:                                              ; preds = %315, %257
  %313 = phi double [ %346, %315 ], [ 0.000000e+00, %257 ]
  %314 = phi i32 [ %347, %315 ], [ 1, %257 ]
  %exitcond24 = icmp ne i32 %314, %smax21
  br i1 %exitcond24, label %315, label %348
...
315:                                              ; preds = %312
  ...
  %346 = fadd double %313, %345
  %347 = add nuw i32 %314, 1
  br label %312, !llvm.loop !14

348:                                              ; preds = %312
  %.lcssa3 = phi double [ %313, %312 ]
...
402:                                              ; preds = %405, %348
  %403 = phi double [ %435, %405 ], [ 0.000000e+00, %348 ]
  %404 = phi i32 [ %436, %405 ], [ 1, %348 ]
  %exitcond25 = icmp ne i32 %404, %smax21
  br i1 %exitcond25, label %405, label %437
...
405:                                              ; preds = %402
  ...
  %435 = call double @llvm.fmuladd.f64(double %422, double %434, double %403)
  %436 = add nuw i32 %404, 1
  br label %402, !llvm.loop !15

437:                                              ; preds = %402
  %.lcssa2 = phi double [ %403, %402 ]
...
549:                                              ; preds = %552, %506
  %550 = phi double [ %583, %552 ], [ 0.000000e+00, %506 ]
  %551 = phi i32 [ %584, %552 ], [ 1, %506 ]
  %exitcond28 = icmp ne i32 %551, %smax27
  br i1 %exitcond28, label %552, label %585

552:                                              ; preds = %549
  %553 = uitofp nneg i32 %551 to double
  %554 = fmul double %547, %553
  %555 = fmul double %554, %554
  %556 = load double, ptr @B6, align 8
  %557 = load double, ptr @B5, align 8
  %558 = call double @llvm.fmuladd.f64(double %556, double %555, double %557)
  %559 = load double, ptr @B4, align 8
  %560 = call double @llvm.fmuladd.f64(double %555, double %558, double %559)
  %561 = load double, ptr @B3, align 8
  %562 = call double @llvm.fmuladd.f64(double %555, double %560, double %561)
  %563 = load double, ptr @B2, align 8
  %564 = call double @llvm.fmuladd.f64(double %555, double %562, double %563)
  %565 = load double, ptr @B1, align 8
  %566 = call double @llvm.fmuladd.f64(double %555, double %564, double %565)
  %567 = load double, ptr @one, align 8
  %568 = call double @llvm.fmuladd.f64(double %555, double %566, double %567)
  %569 = fmul double %568, %568
  %570 = fmul double %569, %554
  %571 = load double, ptr @A6, align 8
  %572 = load double, ptr @A5, align 8
  %573 = call double @llvm.fmuladd.f64(double %571, double %555, double %572)
  %574 = load double, ptr @A4, align 8
  %575 = call double @llvm.fmuladd.f64(double %573, double %555, double %574)
  %576 = load double, ptr @A3, align 8
  %577 = call double @llvm.fmuladd.f64(double %575, double %555, double %576)
  %578 = load double, ptr @A2, align 8
  %579 = call double @llvm.fmuladd.f64(double %577, double %555, double %578)
  %580 = load double, ptr @A1, align 8
  %581 = call double @llvm.fmuladd.f64(double %579, double %555, double %580)
  %582 = call double @llvm.fmuladd.f64(double %581, double %555, double %567)
  %583 = call double @llvm.fmuladd.f64(double %570, double %582, double %550)
  %584 = add nuw i32 %551, 1
  br label %549, !llvm.loop !17

585:                                              ; preds = %549
  %.lcssa = phi double [ %550, %549 ]
