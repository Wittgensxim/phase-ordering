...
21:                                               ; preds = %25, %10
  ...
  br i1 %exitcond.not, label %36, label %25
...
182:                                              ; preds = %186, %136
  ...
  %exitcond22.not = icmp eq i32 %185, %smax21
  br i1 %exitcond22.not, label %198, label %186
...
198:                                              ; preds = %182
  ...
  %227 = call double @llvm.fmuladd.f64(double %226, double %184, double %224)
...
252:                                              ; preds = %255, %198
  ...
  %exitcond23.not = icmp eq i32 %254, %smax21
  br i1 %exitcond23.not, label %267, label %255
...
267:                                              ; preds = %252
  ...
  %294 = call double @llvm.fmuladd.f64(double %293, double %253, double %292)
...
335:                                              ; preds = %338, %267
  ...
  %exitcond24.not = icmp eq i32 %337, %smax21
  br i1 %exitcond24.not, label %358, label %338
...
358:                                              ; preds = %335
  ...
  %398 = call double @llvm.fmuladd.f64(double %397, double %336, double %395)
...
425:                                              ; preds = %428, %358
  ...
  %exitcond25.not = icmp eq i32 %427, %smax21
  br i1 %exitcond25.not, label %447, label %428
...
447:                                              ; preds = %425
  ...
  %487 = call double @llvm.fmuladd.f64(double %486, double %426, double %484)
...
499:                                              ; preds = %502, %447
  ...
  %exitcond26.not = icmp eq i32 %501, %smax21
  br i1 %exitcond26.not, label %516, label %502
...
572:                                              ; preds = %575, %516
  ...
  %exitcond28.not = icmp eq i32 %574, %smax27
  br i1 %exitcond28.not, label %595, label %575
...
595:                                              ; preds = %572
  ...
  %636 = call double @llvm.fmuladd.f64(double %635, double %573, double %633)
