...
54:                                               ; preds = %53, %47
  ...
  %74 = call double @llvm.fmuladd.f64(double %73, double %43, double %72)
  %75 = fmul double %44, %74
...
96:                                               ; preds = %100, %54
  %97 = phi double [ %102, %100 ], [ %sa.promoted, %54 ]
  %98 = phi double [ %101, %100 ], [ %91, %54 ]
  %99 = phi i32 [ %103, %100 ], [ 1, %54 ]
  %exitcond18 = icmp eq i32 %99, %95
  br i1 %exitcond18, label %104, label %100

100:                                              ; preds = %96
  %101 = fneg double %98
  %102 = fsub double %97, %98
  store double %102, ptr @sa, align 8
  %103 = add nuw i32 %99, 1
  br label %96, !llvm.loop !10

104:                                              ; preds = %96
  %.lcssa9 = phi double [ %98, %96 ]
...
111:                                              ; preds = %110, %104
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %83, i32 0)
  %116 = add nuw i32 %smax19, 1
  br label %117

117:                                              ; preds = %125, %111
  %118 = phi double [ %127, %125 ], [ %sa.promoted18, %111 ]
  %119 = phi double [ %133, %125 ], [ 0.000000e+00, %111 ]
  %120 = phi double [ %128, %125 ], [ %113, %111 ]
  %121 = phi double [ %126, %125 ], [ %.lcssa9, %111 ]
  %122 = phi double [ %131, %125 ], [ 0.000000e+00, %111 ]
  %123 = phi double [ %130, %125 ], [ 0.000000e+00, %111 ]
  %124 = phi i32 [ %134, %125 ], [ 1, %111 ]
  %exitcond20 = icmp eq i32 %124, %116
