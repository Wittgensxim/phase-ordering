...
3:                                                ; preds = %41, %0
  %4 = phi double [ %.lcssa25, %41 ], [ undef, %0 ]
...
40:                                               ; preds = %36
  %.lcssa32 = phi double [ %14, %36 ]
  %.lcssa25.lcssa = phi double [ %.lcssa25, %36 ]
  br label %42
...
.loopexit:                                        ; preds = %3
  %.lcssa30 = phi double [ %4, %3 ]
  %.lcssa28 = phi double [ %5, %3 ]
  br label %42

42:                                               ; preds = %.loopexit, %40
  %43 = phi double [ %.lcssa25.lcssa, %40 ], [ %.lcssa30, %.loopexit ]
  %44 = phi double [ %.lcssa32, %40 ], [ %.lcssa28, %.loopexit ]
...
97:                                               ; preds = %100, %55
  ...
  %exitcond33 = icmp eq i32 %99, %96
  br i1 %exitcond33, label %105, label %100
...
112:                                              ; preds = %111, %105
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %84, i32 0)
  %116 = add nuw i32 %smax34, 1
  br label %117

117:                                              ; preds = %124, %112
  %118 = phi double [ %134, %124 ], [ 0.000000e+00, %112 ]
  %119 = phi double [ %129, %124 ], [ %114, %112 ]
  %120 = phi double [ %125, %124 ], [ %.lcssa24, %112 ]
  %121 = phi double [ %132, %124 ], [ 0.000000e+00, %112 ]
  %122 = phi double [ %131, %124 ], [ 0.000000e+00, %112 ]
  %123 = phi i32 [ %135, %124 ], [ 1, %112 ]
  %exitcond35 = icmp eq i32 %123, %116
  br i1 %exitcond35, label %136, label %124
...
124:                                              ; preds = %117
  ...
  %134 = fsub double %118, %133
  %135 = add nuw i32 %123, 1
  br label %117, !llvm.loop !12

136:                                              ; preds = %117
  %.lcssa23 = phi double [ %118, %117 ]
  %.lcssa22 = phi double [ %121, %117 ]
  %.lcssa21 = phi double [ %122, %117 ]
  ...
  %smax36 = call i32 @llvm.smax.i32(i32 %148, i32 1)
  br label %173
...
173:                                              ; preds = %177, %136
  ...
  %exitcond37 = icmp ne i32 %176, %smax36
  br i1 %exitcond37, label %177, label %198
...
177:                                              ; preds = %173
  ...
  %197 = add nuw i32 %176, 1
  br label %173, !llvm.loop !13

198:                                              ; preds = %173
  %.lcssa20 = phi double [ %175, %173 ]
  ...
  %227 = call double @llvm.fmuladd.f64(double %226, double %.lcssa20, double %224)
...
245:                                              ; preds = %248, %198
  ...
  %exitcond38 = icmp ne i32 %247, %smax36
  br i1 %exitcond38, label %248, label %267
...
267:                                              ; preds = %245
  ...
  %294 = call double @llvm.fmuladd.f64(double %293, double %.lcssa19, double %292)
...
322:                                              ; preds = %325, %267
  ...
  %exitcond39 = icmp ne i32 %324, %smax36
  br i1 %exitcond39, label %325, label %358
...
325:                                              ; preds = %322
  ...
  %357 = add nuw i32 %324, 1
  br label %322, !llvm.loop !15

358:                                              ; preds = %322
  %.lcssa18 = phi double [ %323, %322 ]
  ...
  %398 = call double @llvm.fmuladd.f64(double %397, double %.lcssa18, double %395)
...
412:                                              ; preds = %415, %358
  ...
  %exitcond40 = icmp ne i32 %414, %smax36
  br i1 %exitcond40, label %415, label %447
...
447:                                              ; preds = %412
  ...
  %487 = call double @llvm.fmuladd.f64(double %486, double %.lcssa17, double %484)
...
499:                                              ; preds = %502, %447
  ...
  %exitcond41 = icmp ne i32 %501, %smax36
  br i1 %exitcond41, label %502, label %516
...
516:                                              ; preds = %499
  ...
  %538 = call double @llvm.fmuladd.f64(double %537, double %.lcssa16, double %535)
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 %545, i32 1)
  br label %559

559:                                              ; preds = %562, %516
  %560 = phi double [ %593, %562 ], [ 0.000000e+00, %516 ]
  %561 = phi i32 [ %594, %562 ], [ 1, %516 ]
  %exitcond43 = icmp ne i32 %561, %smax42
  br i1 %exitcond43, label %562, label %595
