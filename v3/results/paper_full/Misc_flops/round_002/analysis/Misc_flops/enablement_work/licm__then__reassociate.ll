...
42:                                               ; preds = %.loopexit, %40
  ...
  %45 = phi i32 [ 512000000, %40 ], [ %.lcssa11, %.loopexit ]
...
119:                                              ; preds = %127, %114
  ...
  %123 = phi double [ %128, %127 ], [ %.lcssa9, %114 ]
...
137:                                              ; preds = %119
  %.lcssa8 = phi double [ %121, %119 ]
  %.lcssa7 = phi double [ %124, %119 ]
  %.lcssa6 = phi double [ %125, %119 ]
...
359:                                              ; preds = %336
  ...
  %399 = call double @llvm.fmuladd.f64(double %398, double %.lcssa3, double %396)
...
448:                                              ; preds = %426
  ...
  %488 = call double @llvm.fmuladd.f64(double %487, double %.lcssa2, double %485)
...
503:                                              ; preds = %500
  ...
  %507 = fadd double %497, %505
  %508 = fdiv double %497, %507
  %509 = fsub double %501, %508
  %510 = fadd double %497, %506
...
517:                                              ; preds = %500
  ...
  %527 = fneg double %497
  %528 = fadd double %497, %525
  %529 = fdiv double %497, %528
  %530 = fsub double %527, %529
  %531 = fadd double %497, %526
  ...
  %539 = call double @llvm.fmuladd.f64(double %538, double %.lcssa1, double %536)
