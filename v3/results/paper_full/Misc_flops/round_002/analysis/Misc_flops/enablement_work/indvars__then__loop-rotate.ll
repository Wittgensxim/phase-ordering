...
19:                                               ; preds = %12, %19
  %20 = phi i32 [ 1, %12 ], [ %37, %19 ]
  %21 = phi double [ 0.000000e+00, %12 ], [ %36, %19 ]
  %22 = phi double [ 0.000000e+00, %12 ], [ %23, %19 ]
  ...
  br i1 %exitcond, label %19, label %38, !llvm.loop !9

38:                                               ; preds = %19
  %.lcssa10 = phi double [ %36, %19 ]
...
97:                                               ; preds = %.lr.ph31, %97
  ...
  %99 = phi double [ %92, %.lr.ph31 ], [ %100, %97 ]
  %100 = fneg double %99
...
111:                                              ; preds = %110, %104
  ...
  %115 = add nuw i32 %smax19, 1
  %exitcond2033 = icmp eq i32 1, %115
  br i1 %exitcond2033, label %134, label %.lr.ph35

.lr.ph35:                                         ; preds = %111
  br label %116

116:                                              ; preds = %.lr.ph35, %116
  %117 = phi i32 [ 1, %.lr.ph35 ], [ %133, %116 ]
  %118 = phi double [ 0.000000e+00, %.lr.ph35 ], [ %129, %116 ]
  %119 = phi double [ 0.000000e+00, %.lr.ph35 ], [ %130, %116 ]
  %120 = phi double [ %.lcssa9, %.lr.ph35 ], [ %123, %116 ]
  %121 = phi double [ %113, %.lr.ph35 ], [ %127, %116 ]
  %122 = phi double [ 0.000000e+00, %.lr.ph35 ], [ %132, %116 ]
  %123 = fneg double %120
  ...
  %exitcond20 = icmp eq i32 %133, %115
  br i1 %exitcond20, label %._crit_edge36, label %116, !llvm.loop !12

._crit_edge36:                                    ; preds = %116
  %split37 = phi double [ %132, %116 ]
  %split38 = phi double [ %130, %116 ]
  %split39 = phi double [ %129, %116 ]
  br label %134
...
171:                                              ; preds = %.lr.ph42, %171
  ...
  %194 = add nuw i32 %172, 1
  %exitcond22 = icmp ne i32 %194, %smax21
  br i1 %exitcond22, label %171, label %._crit_edge43, !llvm.loop !13
...
242:                                              ; preds = %.lr.ph47, %242
  ...
  %262 = add nuw i32 %243, 1
  %exitcond23 = icmp ne i32 %262, %smax21
  br i1 %exitcond23, label %242, label %._crit_edge48, !llvm.loop !14
...
318:                                              ; preds = %.lr.ph52, %318
  ...
  %352 = add nuw i32 %319, 1
  %exitcond24 = icmp ne i32 %352, %smax21
  br i1 %exitcond24, label %318, label %._crit_edge53, !llvm.loop !15
...
407:                                              ; preds = %.lr.ph57, %407
  ...
  br i1 %exitcond25, label %407, label %._crit_edge58, !llvm.loop !16
...
552:                                              ; preds = %.lr.ph67, %552
  ...
  br i1 %exitcond28, label %552, label %._crit_edge68, !llvm.loop !18
