...
19:                                               ; preds = %21, %2
  ...
  br i1 %20, label %21, label %.preheader8
...
29:                                               ; preds = %.preheader8, %41
  %.010 = phi i64 [ %.111, %41 ], [ 0, %.preheader8 ]
  %.13 = phi i64 [ %42, %41 ], [ 0, %.preheader8 ]
  %30 = icmp ult i64 %.13, 256
  br i1 %30, label %34, label %.preheader7

.preheader7:                                      ; preds = %29
  %.010.lcssa = phi i64 [ %.010, %29 ]
  %31 = getelementptr inbounds [512 x i64], ptr %3, i64 0, i64 0
  %32 = getelementptr inbounds [256 x i64], ptr %4, i64 0, i64 0
  %33 = trunc i64 %.010.lcssa to i32
  br label %43

34:                                               ; preds = %29
  %35 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %.13
  %36 = load i64, ptr %35, align 8
  %37 = icmp ne i64 %36, 0
  br i1 %37, label %38, label %41

38:                                               ; preds = %34
  %39 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %.010
  store i64 %.13, ptr %39, align 8
  %40 = add i64 %.010, 1
  br label %41

41:                                               ; preds = %34, %38
  %.111 = phi i64 [ %40, %38 ], [ %.010, %34 ]
  %42 = add i64 %.13, 1
  br label %29, !llvm.loop !10

43:                                               ; preds = %.preheader7, %54
  %.24 = phi i64 [ %56, %54 ], [ %.010.lcssa, %.preheader7 ]
  %44 = icmp ugt i64 %.24, 0
  br i1 %44, label %54, label %.preheader6
...
.preheader6:                                      ; preds = %43
  ...
  %49 = getelementptr inbounds [256 x i64], ptr %4, i64 0, i64 0
...
54:                                               ; preds = %43
  ...
  call void @heap_adjust(ptr noundef %31, ptr noundef %32, i32 noundef %33, i32 noundef %55)
  %56 = add i64 %.24, -1
  br label %43, !llvm.loop !11

57:                                               ; preds = %.preheader6, %59
  %.212 = phi i64 [ %60, %59 ], [ %.010.lcssa, %.preheader6 ]
  %58 = icmp ugt i64 %.212, 1
  br i1 %58, label %59, label %82

59:                                               ; preds = %57
  %60 = add i64 %.212, -1
  %61 = load i64, ptr %45, align 16
  %62 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %60
  %63 = load i64, ptr %62, align 8
  store i64 %63, ptr %46, align 16
  %64 = trunc i64 %60 to i32
  call void @heap_adjust(ptr noundef %47, ptr noundef %48, i32 noundef %64, i32 noundef 1)
  %65 = load i64, ptr %49, align 16
  %66 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %65
  %67 = load i64, ptr %66, align 8
  %68 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %61
  ...
  %75 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %61
  store i32 %74, ptr %75, align 4
  %76 = sub i64 -256, %60
  %77 = trunc i64 %76 to i32
  %78 = load i64, ptr %50, align 16
  %79 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %78
  store i32 %77, ptr %79, align 4
  %80 = add i64 256, %60
  store i64 %80, ptr %51, align 16
  %81 = trunc i64 %60 to i32
  call void @heap_adjust(ptr noundef %52, ptr noundef %53, i32 noundef %81, i32 noundef 1)
  br label %57, !llvm.loop !12

82:                                               ; preds = %57
  %.212.lcssa = phi i64 [ %.212, %57 ]
  %83 = add i64 256, %.212.lcssa
...
108:                                              ; preds = %97
  %.043.lcssa = phi i64 [ %.043, %97 ]
  %.3.lcssa = phi i64 [ %.3, %97 ]
  ...
  %113 = icmp ugt i64 %.043.lcssa, %.045
  %spec.select = select i1 %113, i64 %.043.lcssa, i64 %.045
  %114 = icmp ugt i64 %.3.lcssa, %.039
  %.241 = select i1 %114, i64 %.3.lcssa, i64 %.039
  br label %115
...
117:                                              ; preds = %85
  %.045.lcssa = phi i64 [ %.045, %85 ]
  %.039.lcssa = phi i64 [ %.039, %85 ]
  %118 = icmp ugt i64 %.039.lcssa, 32
...
122:                                              ; preds = %117
  %123 = icmp eq i64 %.045.lcssa, 0
  br i1 %123, label %124, label %.preheader5

.preheader5:                                      ; preds = %122
  br label %127
...
127:                                              ; preds = %.preheader5, %172
  %.134 = phi ptr [ %173, %172 ], [ %0, %.preheader5 ]
  %.028 = phi i64 [ %.129.lcssa, %172 ], [ 0, %.preheader5 ]
  %.024 = phi i8 [ %.125.lcssa, %172 ], [ 0, %.preheader5 ]
  %.16 = phi i64 [ %174, %172 ], [ 0, %.preheader5 ]
  %.01 = phi i32 [ %.1.lcssa, %172 ], [ -1, %.preheader5 ]
...
172:                                              ; preds = %138
  %.129.lcssa = phi i64 [ %.129, %138 ]
  %.125.lcssa = phi i8 [ %.125, %138 ]
  %.1.lcssa = phi i32 [ %.1, %138 ]
  %173 = getelementptr inbounds nuw i8, ptr %.134, i32 1
  %174 = add i64 %.16, 1
  br label %127, !llvm.loop !16

175:                                              ; preds = %127
  %.028.lcssa = phi i64 [ %.028, %127 ]
  %.024.lcssa = phi i8 [ %.024, %127 ]
  %.01.lcssa = phi i32 [ %.01, %127 ]
  %176 = sub nsw i32 7, %.01.lcssa
  %177 = sext i8 %.024.lcssa to i32
  %178 = shl i32 %177, %176
  %179 = trunc i32 %178 to i8
  %180 = getelementptr inbounds nuw i8, ptr %11, i64 %.028.lcssa
  store i8 %179, ptr %180, align 1
  %181 = getelementptr inbounds [256 x i32], ptr %8, i64 0, i64 0
...
183:                                              ; preds = %220, %175
  ...
  br i1 %184, label %185, label %.preheader4

.preheader4:                                      ; preds = %183
  br label %222

185:                                              ; preds = %183
  %186 = trunc i64 %.27 to i8
...
206:                                              ; preds = %208, %195
  %.019 = phi i32 [ 0, %195 ], [ %spec.select1, %208 ]
  %.116 = phi i64 [ %201, %195 ], [ %216, %208 ]
  %.5 = phi i64 [ 0, %195 ], [ %217, %208 ]
  %207 = icmp ult i64 %.5, %204
...
208:                                              ; preds = %206
  ...
  %215 = add i32 %210, 1
  %spec.select1 = select i1 %214, i32 %215, i32 %210
  %216 = lshr i64 %.116, 1
  %217 = add i64 %.5, 1
  br label %206, !llvm.loop !17

218:                                              ; preds = %206
  %.019.lcssa = phi i32 [ %.019, %206 ]
  %219 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.27
  store i32 %.019.lcssa, ptr %219, align 4
  br label %220
...
222:                                              ; preds = %.preheader4, %.critedge
  %.6 = phi i64 [ %248, %.critedge ], [ 1, %.preheader4 ]
  %223 = icmp ult i64 %.6, 256
  br i1 %223, label %224, label %.preheader3
...
.critedge:                                        ; preds = %229, %231
  %.38.lcssa = phi i64 [ %.38, %229 ], [ %.38, %231 ]
...
249:                                              ; preds = %.preheader3, %253
  %.49 = phi i64 [ %254, %253 ], [ 0, %.preheader3 ]
...
255:                                              ; preds = %.preheader, %280
  %.235 = phi ptr [ %.336, %280 ], [ %0, %.preheader ]
  %.031 = phi ptr [ %.132, %280 ], [ %11, %.preheader ]
  %.221 = phi i32 [ %.423, %280 ], [ 0, %.preheader ]
  %.217 = phi i64 [ %.318, %280 ], [ 128, %.preheader ]
  %.313 = phi i64 [ %.414, %280 ], [ 0, %.preheader ]
  %.7 = phi i64 [ %.9, %280 ], [ %.49.lcssa, %.preheader ]
