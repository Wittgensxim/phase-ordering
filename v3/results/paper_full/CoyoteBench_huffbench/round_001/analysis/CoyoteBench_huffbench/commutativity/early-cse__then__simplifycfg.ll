...
208:                                              ; preds = %203
  ...
  %213 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %209
...
.critedge:                                        ; preds = %201, %203
  %217 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38
  store i32 %198, ptr %217, align 4
  %218 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38
  store i8 %200, ptr %218, align 1
  %219 = add i64 %.6, 1
  br label %194, !llvm.loop !20

220:                                              ; preds = %194, %224
  %.49 = phi i64 [ %225, %224 ], [ 0, %194 ]
...
226:                                              ; preds = %220, %249
  %.235 = phi ptr [ %.336, %249 ], [ %0, %220 ]
  %.031 = phi ptr [ %.132, %249 ], [ %11, %220 ]
  %.221 = phi i32 [ %.423, %249 ], [ 0, %220 ]
  %.217 = phi i64 [ %.318, %249 ], [ 128, %220 ]
  %.313 = phi i64 [ %.414, %249 ], [ 0, %220 ]
  %.7 = phi i64 [ %.9, %249 ], [ %.49, %220 ]
...
242:                                              ; preds = %236
  %243 = icmp eq i32 %spec.select2, %238
  br i1 %243, label %244, label %249

244:                                              ; preds = %242
  %245 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
