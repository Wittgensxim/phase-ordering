...
115:                                              ; preds = %161, %114
  ...
  %.028 = phi i64 [ 0, %114 ], [ %.129, %161 ]
  %.024 = phi i8 [ 0, %114 ], [ %.125, %161 ]
  %.16 = phi i64 [ 0, %114 ], [ %163, %161 ]
  %.01 = phi i32 [ -1, %114 ], [ %.1, %161 ]
...
230:                                              ; preds = %219
  %231 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38
  store i32 %209, ptr %231, align 4
  %232 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38
...
260:                                              ; preds = %254
  %261 = icmp eq i32 %.322, %256
  br i1 %261, label %262, label %267

262:                                              ; preds = %260
  %263 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
...
46:                                               ; preds = %._crit_edge, %41
  %.pre-phi = phi i64 [ %.pre, %._crit_edge ], [ %31, %41 ]
  %47 = sub nsw i32 %.01, 1
