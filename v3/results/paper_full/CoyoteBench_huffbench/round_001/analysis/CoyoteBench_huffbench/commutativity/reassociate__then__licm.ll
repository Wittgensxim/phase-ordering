...
46:                                               ; preds = %50, %42
  %.24 = phi i64 [ %.010.lcssa, %42 ], [ %51, %50 ]
  %47 = icmp ugt i64 %.24, 0
  br i1 %47, label %48, label %52

48:                                               ; preds = %46
  %49 = trunc i64 %.24 to i32
  call void @heap_adjust(ptr noundef %43, ptr noundef %44, i32 noundef %45, i32 noundef %49)
  br label %50
...
62:                                               ; preds = %64, %52
  %.212 = phi i64 [ %.010.lcssa, %52 ], [ %65, %64 ]
  %63 = icmp ugt i64 %.212, 1
  br i1 %63, label %64, label %87

64:                                               ; preds = %62
  %65 = add i64 %.212, -1
  %66 = load i64, ptr %53, align 16
  %67 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %65
  %68 = load i64, ptr %67, align 8
  store i64 %68, ptr %54, align 16
  %69 = trunc i64 %65 to i32
  call void @heap_adjust(ptr noundef %55, ptr noundef %56, i32 noundef %69, i32 noundef 1)
  %70 = load i64, ptr %57, align 16
  %71 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %70
  %72 = load i64, ptr %71, align 8
  %73 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %66
  ...
  %80 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %66
  store i32 %79, ptr %80, align 4
  %81 = sub i64 -256, %65
  %82 = trunc i64 %81 to i32
  %83 = load i64, ptr %58, align 16
  %84 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %83
  store i32 %82, ptr %84, align 4
  %85 = add i64 %65, 256
  store i64 %85, ptr %59, align 16
  %86 = trunc i64 %65 to i32
  call void @heap_adjust(ptr noundef %60, ptr noundef %61, i32 noundef %86, i32 noundef 1)
  br label %62, !llvm.loop !12

87:                                               ; preds = %62
  %.212.lcssa = phi i64 [ %.212, %62 ]
  %88 = add i64 %.212.lcssa, 256
...
115:                                              ; preds = %102
  %.043.lcssa = phi i64 [ %.043, %102 ]
  %.3.lcssa = phi i64 [ %.3, %102 ]
  %116 = trunc i64 %.043.lcssa to i32
  %117 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.042
  store i32 %116, ptr %117, align 4
  %118 = trunc i64 %.3.lcssa to i8
  %119 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.042
  store i8 %118, ptr %119, align 1
  %120 = icmp ugt i64 %.043.lcssa, %.045
...
122:                                              ; preds = %121, %115
  %.247 = phi i64 [ %.043.lcssa, %121 ], [ %.045, %115 ]
...
125:                                              ; preds = %124, %122
  %.241 = phi i64 [ %.3.lcssa, %124 ], [ %.039, %122 ]
  br label %126
...
129:                                              ; preds = %90
  %.045.lcssa = phi i64 [ %.045, %90 ]
  %.039.lcssa = phi i64 [ %.039, %90 ]
  %130 = icmp ugt i64 %.039.lcssa, 32
...
140:                                              ; preds = %191, %139
  ...
  %.028 = phi i64 [ 0, %139 ], [ %.129.lcssa, %191 ]
  %.024 = phi i8 [ 0, %139 ], [ %.125.lcssa, %191 ]
  %.16 = phi i64 [ 0, %139 ], [ %192, %191 ]
  %.01 = phi i32 [ -1, %139 ], [ %.1.lcssa, %191 ]
...
189:                                              ; preds = %151
  %.129.lcssa = phi i64 [ %.129, %151 ]
  %.125.lcssa = phi i8 [ %.125, %151 ]
  %.1.lcssa = phi i32 [ %.1, %151 ]
...
193:                                              ; preds = %140
  %.028.lcssa = phi i64 [ %.028, %140 ]
  %.024.lcssa = phi i8 [ %.024, %140 ]
  %.01.lcssa = phi i32 [ %.01, %140 ]
...
224:                                              ; preds = %237, %213
  %.019 = phi i32 [ 0, %213 ], [ %.120, %237 ]
  %.116 = phi i64 [ %219, %213 ], [ %236, %237 ]
  %.5 = phi i64 [ 0, %213 ], [ %238, %237 ]
  %225 = icmp ult i64 %.5, %222
...
239:                                              ; preds = %224
  %.019.lcssa = phi i32 [ %.019, %224 ]
  %240 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.27
...
261:                                              ; preds = %259
  ...
  %265 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38
  store i32 %264, ptr %265, align 4
  %266 = sub i64 %.38, 1
  %267 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %266
  %268 = load i8, ptr %267, align 1
  %269 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38
  store i8 %268, ptr %269, align 1
  %270 = add i64 %.38, -1
  br label %252, !llvm.loop !19

271:                                              ; preds = %259
  %.38.lcssa = phi i64 [ %.38, %259 ]
  %272 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38.lcssa
  store i32 %249, ptr %272, align 4
  %273 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38.lcssa
...
277:                                              ; preds = %282, %276
  %.49 = phi i64 [ 0, %276 ], [ %283, %282 ]
  %278 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.49
...
284:                                              ; preds = %277
  %.49.lcssa = phi i64 [ %.49, %277 ]
  br label %285

285:                                              ; preds = %318, %284
  %.235 = phi ptr [ %0, %284 ], [ %.336, %318 ]
  %.031 = phi ptr [ %11, %284 ], [ %.132, %318 ]
  %.221 = phi i32 [ 0, %284 ], [ %.423, %318 ]
  %.217 = phi i64 [ 128, %284 ], [ %.318, %318 ]
  %.313 = phi i64 [ 0, %284 ], [ %.414, %318 ]
  %.7 = phi i64 [ %.49.lcssa, %284 ], [ %.9, %318 ]
  %286 = icmp ult i64 %.313, %1
  br i1 %286, label %287, label %319

287:                                              ; preds = %285
  %288 = mul i32 %.221, 2
  %289 = add i32 %288, 1
  %290 = load i8, ptr %.031, align 1
...
303:                                              ; preds = %297
  %.8.lcssa = phi i64 [ %.8, %297 ]
  %304 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.8.lcssa
  %305 = load i32, ptr %304, align 4
  %306 = icmp eq i32 %.322, %305
  br i1 %306, label %307, label %312

307:                                              ; preds = %303
  %308 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8.lcssa
  %309 = load i8, ptr %308, align 1
  store i8 %309, ptr %.235, align 1
  %310 = getelementptr inbounds nuw i8, ptr %.235, i32 1
  %311 = add i64 %.313, 1
  br label %312

312:                                              ; preds = %307, %303
  %.336 = phi ptr [ %310, %307 ], [ %.235, %303 ]
  %.423 = phi i32 [ 0, %307 ], [ %.322, %303 ]
  %.414 = phi i64 [ %311, %307 ], [ %.313, %303 ]
  %.9 = phi i64 [ %.49.lcssa, %307 ], [ %.8.lcssa, %303 ]
  %313 = icmp ugt i64 %.217, 1
...
316:                                              ; preds = %312
  %317 = getelementptr inbounds nuw i8, ptr %.031, i32 1
  br label %318

318:                                              ; preds = %316, %314
  %.132 = phi ptr [ %.031, %314 ], [ %317, %316 ]
  %.318 = phi i64 [ %315, %314 ], [ 128, %316 ]
...
30:                                               ; preds = %17
  %31 = add nsw i32 %factor, 1
  br label %32

32:                                               ; preds = %30, %17, %15
  %.0 = phi i32 [ %31, %30 ], [ %factor, %17 ], [ %factor, %15 ]
