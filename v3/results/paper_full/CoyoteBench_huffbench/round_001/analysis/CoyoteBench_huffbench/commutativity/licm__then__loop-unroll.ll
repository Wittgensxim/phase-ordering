...
53:                                               ; preds = %31
  ...
  %56 = trunc i64 %.010.lcssa to i32
  br label %57

57:                                               ; preds = %61, %53
  %.24 = phi i64 [ %.010.lcssa, %53 ], [ %62, %61 ]
  %58 = icmp ugt i64 %.24, 0
  br i1 %58, label %59, label %63

59:                                               ; preds = %57
  %60 = trunc i64 %.24 to i32
  call void @heap_adjust(ptr noundef %54, ptr noundef %55, i32 noundef %56, i32 noundef %60)
  br label %61
...
73:                                               ; preds = %75, %63
  %.212 = phi i64 [ %.010.lcssa, %63 ], [ %76, %75 ]
  %74 = icmp ugt i64 %.212, 1
  br i1 %74, label %75, label %98

75:                                               ; preds = %73
  %76 = add i64 %.212, -1
  %77 = load i64, ptr %64, align 16
  %78 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %76
  %79 = load i64, ptr %78, align 8
  store i64 %79, ptr %65, align 16
  %80 = trunc i64 %76 to i32
  call void @heap_adjust(ptr noundef %66, ptr noundef %67, i32 noundef %80, i32 noundef 1)
  %81 = load i64, ptr %68, align 16
  ...
  %91 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %77
  store i32 %90, ptr %91, align 4
  %92 = sub i64 -256, %76
  %93 = trunc i64 %92 to i32
  %94 = load i64, ptr %69, align 16
  %95 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %94
  store i32 %93, ptr %95, align 4
  %96 = add i64 256, %76
  store i64 %96, ptr %70, align 16
  %97 = trunc i64 %76 to i32
  call void @heap_adjust(ptr noundef %71, ptr noundef %72, i32 noundef %97, i32 noundef 1)
  br label %73, !llvm.loop !12

98:                                               ; preds = %73
  %.212.lcssa = phi i64 [ %.212, %73 ]
...
204:                                              ; preds = %151
  ...
  %210 = getelementptr inbounds [256 x i32], ptr %8, i64 0, i64 0
  call void @llvm.memset.p0.i64(ptr align 16 %210, i8 0, i64 1024, i1 false)
  %211 = getelementptr inbounds [256 x i8], ptr %9, i64 0, i64 0
  br label %212
