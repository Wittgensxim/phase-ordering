...
3:                                                ; preds = %8, %1
  ...
  br i1 %exitcond.not, label %10, label %4
...
13:                                               ; preds = %20, %2
  ...
  br i1 %exitcond.not, label %23, label %14
...
24:                                               ; preds = %32, %23
  ...
  %exitcond7.not = icmp eq i64 %.13, 256
  br i1 %exitcond7.not, label %34, label %25
...
70:                                               ; preds = %100, %67
  ...
  %exitcond8.not = icmp eq i64 %.042, 256
  br i1 %exitcond8.not, label %102, label %71

71:                                               ; preds = %70
  %72 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.042
  %73 = load i64, ptr %72, align 8
  %.not17 = icmp eq i64 %73, 0
  br i1 %.not17, label %74, label %77
...
78:                                               ; preds = %84, %77
  ...
  %.not18 = icmp eq i32 %.037, 0
  br i1 %.not18, label %88, label %79
...
113:                                              ; preds = %157, %112
  ...
  %.028 = phi i64 [ 0, %112 ], [ %.129, %157 ]
  %.024 = phi i8 [ 0, %112 ], [ %.125, %157 ]
  %.16 = phi i64 [ 0, %112 ], [ %159, %157 ]
  %.01 = phi i32 [ -1, %112 ], [ %.1, %157 ]
  %exitcond9.not = icmp eq i64 %.16, %1
  br i1 %exitcond9.not, label %160, label %114
...
143:                                              ; preds = %140, %139
  ...
  %149 = and i64 %.015, %148
  %.not16 = icmp eq i64 %149, 0
  br i1 %.not16, label %152, label %150
...
166:                                              ; preds = %204, %160
  ...
  %exitcond10.not = icmp eq i64 %.27, 256
  br i1 %exitcond10.not, label %206, label %167
...
167:                                              ; preds = %166
  ...
  %175 = or i32 %171, %174
  %.not14 = icmp eq i32 %175, 0
  br i1 %.not14, label %203, label %176
...
188:                                              ; preds = %183
  ...
  %194 = and i64 %.116, %193
  %.not15 = icmp eq i64 %194, 0
  br i1 %.not15, label %197, label %195
...
207:                                              ; preds = %234, %206
  ...
  %exitcond11.not = icmp eq i64 %.6, 256
  br i1 %exitcond11.not, label %236, label %208
...
213:                                              ; preds = %221, %208
  ...
  br i1 %.not13, label %219, label %214
...
231:                                              ; preds = %219
  %232 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.38
...
247:                                              ; preds = %245
  ...
  %252 = and i64 %.217, %251
  %.not12 = icmp eq i64 %252, 0
  br i1 %.not12, label %255, label %253
...
17:                                               ; preds = %19, %15
  ...
  br i1 %exitcond1.not, label %21, label %18
