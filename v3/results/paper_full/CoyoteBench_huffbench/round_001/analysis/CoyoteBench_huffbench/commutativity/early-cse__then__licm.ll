...
45:                                               ; preds = %47, %44
  %.212 = phi i64 [ %.010.lcssa, %44 ], [ %48, %47 ]
...
102:                                              ; preds = %101, %95
  %.247 = phi i64 [ %.043.lcssa, %101 ], [ %.045, %95 ]
  %103 = icmp ugt i64 %.3.lcssa, %.039
...
105:                                              ; preds = %104, %102
  %.241 = phi i64 [ %.3.lcssa, %104 ], [ %.039, %102 ]
  br label %106
...
120:                                              ; preds = %171, %119
  ...
  %.028 = phi i64 [ 0, %119 ], [ %.129.lcssa, %171 ]
  %.024 = phi i8 [ 0, %119 ], [ %.125.lcssa, %171 ]
  %.16 = phi i64 [ 0, %119 ], [ %172, %171 ]
  %.01 = phi i32 [ -1, %119 ], [ %.1.lcssa, %171 ]
...
169:                                              ; preds = %131
  %.129.lcssa = phi i64 [ %.129, %131 ]
  %.125.lcssa = phi i8 [ %.125, %131 ]
  %.1.lcssa = phi i32 [ %.1, %131 ]
...
173:                                              ; preds = %120
  %.028.lcssa = phi i64 [ %.028, %120 ]
  %.024.lcssa = phi i8 [ %.024, %120 ]
  %.01.lcssa = phi i32 [ %.01, %120 ]
  %174 = sub nsw i32 7, %.01.lcssa
  %175 = sext i8 %.024.lcssa to i32
  %176 = shl i32 %175, %174
...
212:                                              ; preds = %197
  ...
  store i32 %.019.lcssa, ptr %213, align 4
  br label %214
...
243:                                              ; preds = %232
  %.38.lcssa = phi i64 [ %.38, %232 ]
  %244 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38.lcssa
  store i32 %222, ptr %244, align 4
  %245 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38.lcssa
...
275:                                              ; preds = %269
  %.8.lcssa = phi i64 [ %.8, %269 ]
  %.lcssa = phi i32 [ %271, %269 ]
  %276 = icmp eq i32 %.322, %.lcssa
