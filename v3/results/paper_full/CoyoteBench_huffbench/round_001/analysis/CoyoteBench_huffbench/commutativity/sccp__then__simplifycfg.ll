...
202:                                              ; preds = %207, %195
  %.019 = phi i32 [ 0, %195 ], [ %spec.select5, %207 ]
...
207:                                              ; preds = %202
  ...
  %215 = add i32 %209, 1
  %spec.select5 = select i1 %214, i32 %215, i32 %209
  %216 = lshr i64 %.116, 1
...
257:                                              ; preds = %255
  ...
  %264 = add i32 %259, 1
  %spec.select6 = select i1 %263, i32 %264, i32 %259
  br label %265
...
265:                                              ; preds = %269, %257
  ...
  %268 = icmp ult i32 %267, %spec.select6
...
271:                                              ; preds = %265
  ...
  %274 = icmp eq i32 %spec.select6, %273
...
280:                                              ; preds = %275, %271
  ...
  %.423 = phi i32 [ 0, %275 ], [ %spec.select6, %271 ]
