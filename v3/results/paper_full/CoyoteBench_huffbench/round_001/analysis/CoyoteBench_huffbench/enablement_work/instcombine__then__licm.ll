...
44:                                               ; preds = %46, %43
  %.212 = phi i64 [ %.010.lcssa, %43 ], [ %47, %46 ]
...
69:                                               ; preds = %44
  ...
  %70 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.212.lcssa
...
74:                                               ; preds = %72
  ...
  %.not6 = icmp eq i64 %76, 0
  br i1 %.not6, label %77, label %80
...
91:                                               ; preds = %81
  %.043.lcssa = phi i64 [ %.043, %81 ]
  %.3.lcssa = phi i64 [ %.3, %81 ]
...
116:                                              ; preds = %161, %115
  ...
  %.028 = phi i64 [ 0, %115 ], [ %.129.lcssa, %161 ]
  %.024 = phi i8 [ 0, %115 ], [ %.125.lcssa, %161 ]
  %.16 = phi i64 [ 0, %115 ], [ %163, %161 ]
  %.01 = phi i32 [ -1, %115 ], [ %.1.lcssa, %161 ]
...
147:                                              ; preds = %144, %143
  ...
  %153 = and i64 %.015, %152
  %.not5 = icmp eq i64 %153, 0
  br i1 %.not5, label %156, label %154
...
160:                                              ; preds = %127
  %.129.lcssa = phi i64 [ %.129, %127 ]
  %.125.lcssa = phi i8 [ %.125, %127 ]
  %.1.lcssa = phi i32 [ %.1, %127 ]
  br label %161
...
164:                                              ; preds = %116
  %.028.lcssa = phi i64 [ %.028, %116 ]
  %.024.lcssa = phi i8 [ %.024, %116 ]
  %.01.lcssa = phi i32 [ %.01, %116 ]
...
172:                                              ; preds = %170
  ...
  %180 = or i32 %176, %179
  %.not3 = icmp eq i32 %180, 0
  br i1 %.not3, label %208, label %181
...
181:                                              ; preds = %172
  ...
  %188 = getelementptr inbounds nuw i8, ptr %7, i64 %.27
...
194:                                              ; preds = %192
  ...
  %199 = and i64 %.116, %198
  %.not4 = icmp eq i64 %199, 0
  br i1 %.not4, label %202, label %200
...
253:                                              ; preds = %251
  ...
  %258 = and i64 %.217, %257
  %.not1 = icmp eq i64 %258, 0
  br i1 %.not1, label %261, label %259
