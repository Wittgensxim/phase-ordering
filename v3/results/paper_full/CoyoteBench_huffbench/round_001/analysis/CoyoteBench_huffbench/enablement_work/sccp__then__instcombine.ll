...
74:                                               ; preds = %72
  ...
  %.not10 = icmp eq i64 %76, 0
  br i1 %.not10, label %77, label %80
...
81:                                               ; preds = %87, %80
  ...
  %.not11 = icmp eq i32 %.037, 0
  br i1 %.not11, label %91, label %82
...
147:                                              ; preds = %144, %143
  ...
  %153 = and i64 %.015, %152
  %.not9 = icmp eq i64 %153, 0
  br i1 %.not9, label %156, label %154
...
172:                                              ; preds = %170
  ...
  br i1 %.not7, label %208, label %181
...
188:                                              ; preds = %203, %181
  ...
  %192 = icmp samesign ult i64 %.5, %191
...
193:                                              ; preds = %188
  ...
  %199 = and i64 %.116, %198
  %.not8 = icmp eq i64 %199, 0
  br i1 %.not8, label %202, label %200
...
219:                                              ; preds = %227, %214
  ...
  br i1 %.not6, label %225, label %220
...
253:                                              ; preds = %251
  ...
  %258 = and i64 %.217, %257
  %.not5 = icmp eq i64 %258, 0
  br i1 %.not5, label %261, label %259
