...
42:                                               ; preds = %39
  ...
  br i1 %43, label %.lr.ph14, label %52
...
47:                                               ; preds = %.lr.ph14, %49
  ...
  call void @heap_adjust(ptr noundef %44, ptr noundef %45, i32 noundef %46, i32 noundef %48)
  br label %49
...
52:                                               ; preds = %._crit_edge15, %42
  ...
  br i1 %53, label %.lr.ph18, label %87
...
63:                                               ; preds = %.lr.ph18, %63
  ...
  %64 = add i64 %.21216, -1
  %65 = load i64, ptr %54, align 16
  %66 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %64
  %67 = load i64, ptr %66, align 8
  store i64 %67, ptr %55, align 16
  %68 = trunc i64 %64 to i32
  call void @heap_adjust(ptr noundef %56, ptr noundef %57, i32 noundef %68, i32 noundef 1)
  %69 = load i64, ptr %58, align 16
  ...
  %82 = load i64, ptr %59, align 16
  %83 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %82
  store i32 %81, ptr %83, align 4
  %84 = add i64 256, %64
  store i64 %84, ptr %60, align 16
  %85 = trunc i64 %64 to i32
  call void @heap_adjust(ptr noundef %61, ptr noundef %62, i32 noundef %85, i32 noundef 1)
...
205:                                              ; preds = %197, %246
  %.062 = phi ptr [ %204, %197 ], [ %207, %246 ]
  %.2761 = phi i64 [ 0, %197 ], [ %247, %246 ]
...
215:                                              ; preds = %205
  ...
  br i1 %225, label %.lr.ph58, label %243

.lr.ph58:                                         ; preds = %215
  %226 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.2761
...
231:                                              ; preds = %.lr.ph58, %240
  %.556 = phi i64 [ 0, %.lr.ph58 ], [ %241, %240 ]
  %.11655 = phi i64 [ %221, %.lr.ph58 ], [ %239, %240 ]
  %.01954 = phi i32 [ 0, %.lr.ph58 ], [ %.120, %240 ]
  %232 = mul i32 %.01954, 2
  %233 = add i32 %232, 1
  %234 = and i64 %228, %.11655
...
238:                                              ; preds = %236, %231
  %.120 = phi i32 [ %237, %236 ], [ %233, %231 ]
  %239 = lshr i64 %.11655, 1
  br label %240

240:                                              ; preds = %238
  %241 = add i64 %.556, 1
  %242 = icmp ult i64 %241, %230
  br i1 %242, label %231, label %._crit_edge59, !llvm.loop !17

._crit_edge59:                                    ; preds = %240
  %split60 = phi i32 [ %.120, %240 ]
  br label %243

243:                                              ; preds = %._crit_edge59, %215
  %.019.lcssa = phi i32 [ %split60, %._crit_edge59 ], [ 0, %215 ]
  %244 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.2761
...
250:                                              ; preds = %249, %277
  %.663 = phi i64 [ 1, %249 ], [ %278, %277 ]
  %251 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.663
  %252 = load i32, ptr %251, align 4
  %253 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.663
  %254 = load i8, ptr %253, align 1
  br label %255

255:                                              ; preds = %264, %250
  %.38 = phi i64 [ %.663, %250 ], [ %273, %264 ]
...
280:                                              ; preds = %277
  ...
  br i1 %282, label %.lr.ph66, label %289

.lr.ph66:                                         ; preds = %280
  br label %283

283:                                              ; preds = %.lr.ph66, %284
  %.4964 = phi i64 [ 0, %.lr.ph66 ], [ %285, %284 ]
  br label %284
...
284:                                              ; preds = %283
  ...
  br i1 %288, label %283, label %._crit_edge67, !llvm.loop !21

._crit_edge67:                                    ; preds = %284
  %split68 = phi i64 [ %285, %284 ]
  br label %289

289:                                              ; preds = %._crit_edge67, %280
  %.49.lcssa = phi i64 [ %split68, %._crit_edge67 ], [ 0, %280 ]
  %290 = icmp ult i64 0, %1
  br i1 %290, label %.lr.ph76, label %323

.lr.ph76:                                         ; preds = %289
  br label %291

291:                                              ; preds = %.lr.ph76, %321
  %.774 = phi i64 [ %.49.lcssa, %.lr.ph76 ], [ %.9, %321 ]
  %.31373 = phi i64 [ 0, %.lr.ph76 ], [ %.414, %321 ]
  %.21772 = phi i64 [ 128, %.lr.ph76 ], [ %.318, %321 ]
  %.22171 = phi i32 [ 0, %.lr.ph76 ], [ %.423, %321 ]
  %.03170 = phi ptr [ %11, %.lr.ph76 ], [ %.132, %321 ]
  %.23569 = phi ptr [ %0, %.lr.ph76 ], [ %.336, %321 ]
  %292 = mul i32 %.22171, 2
  %293 = add i32 %292, 1
  %294 = load i8, ptr %.03170, align 1
  %295 = zext i8 %294 to i64
  %296 = and i64 %295, %.21772
...
310:                                              ; preds = %306
  ...
  store i8 %312, ptr %.23569, align 1
  %313 = getelementptr inbounds nuw i8, ptr %.23569, i32 1
  %314 = add i64 %.31373, 1
  br label %315

315:                                              ; preds = %310, %306
  %.336 = phi ptr [ %313, %310 ], [ %.23569, %306 ]
  %.423 = phi i32 [ 0, %310 ], [ %.322, %306 ]
  %.414 = phi i64 [ %314, %310 ], [ %.31373, %306 ]
  %.9 = phi i64 [ %.49.lcssa, %310 ], [ %.8.lcssa, %306 ]
  %316 = icmp ugt i64 %.21772, 1
  br i1 %316, label %317, label %319

317:                                              ; preds = %315
  %318 = lshr i64 %.21772, 1
  br label %321

319:                                              ; preds = %315
  %320 = getelementptr inbounds nuw i8, ptr %.03170, i32 1
  br label %321

321:                                              ; preds = %319, %317
  %.132 = phi ptr [ %.03170, %317 ], [ %320, %319 ]
  %.318 = phi i64 [ %318, %317 ], [ 128, %319 ]
  %322 = icmp ult i64 %.414, %1
  br i1 %322, label %291, label %._crit_edge77, !llvm.loop !23

._crit_edge77:                                    ; preds = %321
  br label %323

323:                                              ; preds = %._crit_edge77, %289
