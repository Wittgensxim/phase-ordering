...
78:                                               ; preds = %53
  %79 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.212
...
83:                                               ; preds = %81
  ...
  %.not12 = icmp eq i64 %85, 0
  br i1 %.not12, label %86, label %89
...
90:                                               ; preds = %96, %89
  ...
  br i1 %.not13, label %100, label %91
...
125:                                              ; preds = %170, %124
  ...
  %.028 = phi i64 [ 0, %124 ], [ %.129, %170 ]
  %.024 = phi i8 [ 0, %124 ], [ %.125, %170 ]
  %.16 = phi i64 [ 0, %124 ], [ %172, %170 ]
  %.01 = phi i32 [ -1, %124 ], [ %.1, %170 ]
...
156:                                              ; preds = %153, %152
  ...
  %162 = and i64 %.015, %161
  %.not11 = icmp eq i64 %162, 0
  br i1 %.not11, label %165, label %163
...
181:                                              ; preds = %179
  ...
  br i1 %.not9, label %217, label %190
...
228:                                              ; preds = %236, %223
  ...
  br i1 %.not8, label %234, label %229
...
246:                                              ; preds = %234
  %247 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.38
  store i32 %225, ptr %247, align 4
  %248 = getelementptr inbounds nuw i8, ptr %9, i64 %.38
...
277:                                              ; preds = %271
  %278 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.8
