...
._crit_edge:                                      ; preds = %125
  %.pre3 = load i8, ptr %.134, align 1
  %.pre4 = zext i8 %.pre3 to i64
  br label %137
...
137:                                              ; preds = %._crit_edge, %132
  %.pre-phi = phi i64 [ %.pre4, %._crit_edge ], [ %119, %132 ]
  %138 = phi i8 [ %117, %132 ], [ %.pre3, %._crit_edge ]
