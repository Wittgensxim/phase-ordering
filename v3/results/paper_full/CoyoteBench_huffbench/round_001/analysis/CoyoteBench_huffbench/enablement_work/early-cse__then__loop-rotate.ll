...
37:                                               ; preds = %.lr.ph14, %40
  %.2412 = phi i64 [ %.010.lcssa, %.lr.ph14 ], [ %41, %40 ]
...
45:                                               ; preds = %.lr.ph18, %45
  %.21216 = phi i64 [ %.010.lcssa, %.lr.ph18 ], [ %46, %45 ]
  %46 = add i64 %.21216, -1
...
66:                                               ; preds = %._crit_edge19, %43
  %.212.lcssa = phi i64 [ %split, %._crit_edge19 ], [ %.010.lcssa, %43 ]
...
._crit_edge26:                                    ; preds = %85
  %split27 = phi i64 [ %.144, %85 ]
  %split28 = phi i64 [ %90, %85 ]
  br label %92

92:                                               ; preds = %._crit_edge26, %76
  %.043.lcssa = phi i64 [ %split27, %._crit_edge26 ], [ 0, %76 ]
  %.3.lcssa = phi i64 [ %split28, %._crit_edge26 ], [ 0, %76 ]
...
117:                                              ; preds = %112
  %118 = icmp ult i64 0, %1
  br i1 %118, label %.lr.ph49, label %176

.lr.ph49:                                         ; preds = %117
  br label %119

119:                                              ; preds = %.lr.ph49, %173
  %.0147 = phi i32 [ -1, %.lr.ph49 ], [ %.1.lcssa, %173 ]
  %.1646 = phi i64 [ 0, %.lr.ph49 ], [ %174, %173 ]
  %.02445 = phi i8 [ 0, %.lr.ph49 ], [ %.125.lcssa, %173 ]
  %.02844 = phi i64 [ 0, %.lr.ph49 ], [ %.129.lcssa, %173 ]
  %.13443 = phi ptr [ %0, %.lr.ph49 ], [ %172, %173 ]
  %120 = load i8, ptr %.13443, align 1
  %121 = zext i8 %120 to i64
  %122 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %121
  %123 = load i8, ptr %122, align 1
  %124 = zext i8 %123 to i32
  %125 = sub nsw i32 %124, 1
  %126 = shl i32 1, %125
  %127 = sext i32 %126 to i64
  %128 = load i8, ptr %.13443, align 1
  %129 = zext i8 %128 to i64
  %130 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %129
  %131 = load i8, ptr %130, align 1
  %132 = zext i8 %131 to i64
  %133 = icmp ult i64 0, %132
  br i1 %133, label %.lr.ph38, label %171

.lr.ph38:                                         ; preds = %119
  br label %134

134:                                              ; preds = %.lr.ph38, %163
  %.136 = phi i32 [ %.0147, %.lr.ph38 ], [ %.2, %163 ]
  %.435 = phi i64 [ 0, %.lr.ph38 ], [ %164, %163 ]
  %.01534 = phi i64 [ %127, %.lr.ph38 ], [ %162, %163 ]
  %.12533 = phi i8 [ %.02445, %.lr.ph38 ], [ %.327, %163 ]
  %.12932 = phi i64 [ %.02844, %.lr.ph38 ], [ %.230, %163 ]
  %135 = icmp eq i32 %.136, 7
  br i1 %135, label %136, label %144

136:                                              ; preds = %134
  %137 = getelementptr inbounds nuw i8, ptr %11, i64 %.12932
  store i8 %.12533, ptr %137, align 1
  %138 = add i64 %.12932, 1
...
161:                                              ; preds = %157, %149
  ...
  %162 = lshr i64 %.01534, 1
  br label %163

163:                                              ; preds = %161
  %164 = add i64 %.435, 1
  %165 = load i8, ptr %.13443, align 1
  %166 = zext i8 %165 to i64
  %167 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %166
  %168 = load i8, ptr %167, align 1
  %169 = zext i8 %168 to i64
  %170 = icmp ult i64 %164, %169
  br i1 %170, label %134, label %._crit_edge39, !llvm.loop !15

._crit_edge39:                                    ; preds = %163
  %split40 = phi i64 [ %.230, %163 ]
  %split41 = phi i8 [ %.327, %163 ]
  %split42 = phi i32 [ %.2, %163 ]
  br label %171

171:                                              ; preds = %._crit_edge39, %119
  %.129.lcssa = phi i64 [ %split40, %._crit_edge39 ], [ %.02844, %119 ]
  %.125.lcssa = phi i8 [ %split41, %._crit_edge39 ], [ %.02445, %119 ]
  %.1.lcssa = phi i32 [ %split42, %._crit_edge39 ], [ %.0147, %119 ]
  %172 = getelementptr inbounds nuw i8, ptr %.13443, i32 1
  br label %173

173:                                              ; preds = %171
  %174 = add i64 %.1646, 1
  %175 = icmp ult i64 %174, %1
  br i1 %175, label %119, label %._crit_edge50, !llvm.loop !16

._crit_edge50:                                    ; preds = %173
  %split51 = phi i64 [ %.129.lcssa, %173 ]
  %split52 = phi i8 [ %.125.lcssa, %173 ]
  %split53 = phi i32 [ %.1.lcssa, %173 ]
  br label %176

176:                                              ; preds = %._crit_edge50, %117
  %.028.lcssa = phi i64 [ %split51, %._crit_edge50 ], [ 0, %117 ]
  %.024.lcssa = phi i8 [ %split52, %._crit_edge50 ], [ 0, %117 ]
  %.01.lcssa = phi i32 [ %split53, %._crit_edge50 ], [ -1, %117 ]
  %177 = sub nsw i32 7, %.01.lcssa
  %178 = sext i8 %.024.lcssa to i32
  %179 = shl i32 %178, %177
  %180 = trunc i32 %179 to i8
  %181 = getelementptr inbounds nuw i8, ptr %11, i64 %.028.lcssa
  store i8 %180, ptr %181, align 1
  call void @llvm.memset.p0.i64(ptr align 16 %8, i8 0, i64 1024, i1 false)
  br label %182

182:                                              ; preds = %176, %218
  %.062 = phi ptr [ %9, %176 ], [ %184, %218 ]
  %.2761 = phi i64 [ 0, %176 ], [ %219, %218 ]
  %183 = trunc i64 %.2761 to i8
  store i8 %183, ptr %.062, align 1
  %184 = getelementptr inbounds nuw i8, ptr %.062, i32 1
  %185 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.2761
  %186 = load i32, ptr %185, align 4
  %187 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.2761
...
192:                                              ; preds = %182
  ...
  br i1 %198, label %.lr.ph58, label %215

.lr.ph58:                                         ; preds = %192
  br label %199

199:                                              ; preds = %.lr.ph58, %210
  %.556 = phi i64 [ 0, %.lr.ph58 ], [ %211, %210 ]
  %.11655 = phi i64 [ %195, %.lr.ph58 ], [ %209, %210 ]
  %.01954 = phi i32 [ 0, %.lr.ph58 ], [ %.120, %210 ]
  %200 = mul i32 %.01954, 2
  %201 = add i32 %200, 1
...
208:                                              ; preds = %206, %199
  ...
  %209 = lshr i64 %.11655, 1
  br label %210

210:                                              ; preds = %208
  %211 = add i64 %.556, 1
  %212 = load i8, ptr %187, align 1
  %213 = zext i8 %212 to i64
  %214 = icmp ult i64 %211, %213
  br i1 %214, label %199, label %._crit_edge59, !llvm.loop !17

._crit_edge59:                                    ; preds = %210
  %split60 = phi i32 [ %.120, %210 ]
  br label %215

215:                                              ; preds = %._crit_edge59, %192
  %.019.lcssa = phi i32 [ %split60, %._crit_edge59 ], [ 0, %192 ]
  %216 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.2761
...
218:                                              ; preds = %217
  ...
  br i1 %220, label %182, label %221, !llvm.loop !18

221:                                              ; preds = %218
  br label %222

222:                                              ; preds = %221, %248
  %.663 = phi i64 [ 1, %221 ], [ %249, %248 ]
  %223 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.663
  %224 = load i32, ptr %223, align 4
  %225 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.663
  %226 = load i8, ptr %225, align 1
  br label %227

227:                                              ; preds = %236, %222
  %.38 = phi i64 [ %.663, %222 ], [ %244, %236 ]
  %228 = icmp ne i64 %.38, 0
...
236:                                              ; preds = %234
  ...
  %241 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %237
...
245:                                              ; preds = %234
  ...
  %246 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38.lcssa
  store i32 %224, ptr %246, align 4
  %247 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38.lcssa
  store i8 %226, ptr %247, align 1
  br label %248

248:                                              ; preds = %245
  %249 = add i64 %.663, 1
  %250 = icmp ult i64 %249, 256
  br i1 %250, label %222, label %251, !llvm.loop !20

251:                                              ; preds = %248
  %252 = load i32, ptr %8, align 4
  %253 = icmp eq i32 %252, 0
  br i1 %253, label %.lr.ph66, label %260

.lr.ph66:                                         ; preds = %251
  br label %254

254:                                              ; preds = %.lr.ph66, %255
  %.4964 = phi i64 [ 0, %.lr.ph66 ], [ %256, %255 ]
  br label %255
...
255:                                              ; preds = %254
  ...
  br i1 %259, label %254, label %._crit_edge67, !llvm.loop !21

._crit_edge67:                                    ; preds = %255
  %split68 = phi i64 [ %256, %255 ]
  br label %260

260:                                              ; preds = %._crit_edge67, %251
  %.49.lcssa = phi i64 [ %split68, %._crit_edge67 ], [ 0, %251 ]
  %261 = icmp ult i64 0, %1
  br i1 %261, label %.lr.ph76, label %292

.lr.ph76:                                         ; preds = %260
  br label %262

262:                                              ; preds = %.lr.ph76, %290
  %.774 = phi i64 [ %.49.lcssa, %.lr.ph76 ], [ %.9, %290 ]
  %.31373 = phi i64 [ 0, %.lr.ph76 ], [ %.414, %290 ]
  %.21772 = phi i64 [ 128, %.lr.ph76 ], [ %.318, %290 ]
  %.22171 = phi i32 [ 0, %.lr.ph76 ], [ %.423, %290 ]
  %.03170 = phi ptr [ %11, %.lr.ph76 ], [ %.132, %290 ]
  %.23569 = phi ptr [ %0, %.lr.ph76 ], [ %.336, %290 ]
  %263 = mul i32 %.22171, 2
  %264 = add i32 %263, 1
  %265 = load i8, ptr %.03170, align 1
  %266 = zext i8 %265 to i64
  %267 = and i64 %266, %.21772
...
271:                                              ; preds = %269, %262
  %.322 = phi i32 [ %270, %269 ], [ %264, %262 ]
  br label %272

272:                                              ; preds = %272, %271
  %.8 = phi i64 [ %.774, %271 ], [ %276, %272 ]
  %273 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.8
  %274 = load i32, ptr %273, align 4
  %275 = icmp ult i32 %274, %.322
  %276 = add i64 %.8, 1
  br i1 %275, label %272, label %277, !llvm.loop !22

277:                                              ; preds = %272
  %.8.lcssa = phi i64 [ %.8, %272 ]
  %.lcssa = phi i32 [ %274, %272 ]
  %278 = icmp eq i32 %.322, %.lcssa
  br i1 %278, label %279, label %284

279:                                              ; preds = %277
  %280 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8.lcssa
  %281 = load i8, ptr %280, align 1
  store i8 %281, ptr %.23569, align 1
  %282 = getelementptr inbounds nuw i8, ptr %.23569, i32 1
  %283 = add i64 %.31373, 1
  br label %284

284:                                              ; preds = %279, %277
  %.336 = phi ptr [ %282, %279 ], [ %.23569, %277 ]
  %.423 = phi i32 [ 0, %279 ], [ %.322, %277 ]
  %.414 = phi i64 [ %283, %279 ], [ %.31373, %277 ]
  %.9 = phi i64 [ %.49.lcssa, %279 ], [ %.8.lcssa, %277 ]
  %285 = icmp ugt i64 %.21772, 1
  br i1 %285, label %286, label %288

286:                                              ; preds = %284
  %287 = lshr i64 %.21772, 1
  br label %290

288:                                              ; preds = %284
  %289 = getelementptr inbounds nuw i8, ptr %.03170, i32 1
  br label %290

290:                                              ; preds = %288, %286
  %.132 = phi ptr [ %.03170, %286 ], [ %289, %288 ]
  %.318 = phi i64 [ %287, %286 ], [ 128, %288 ]
  %291 = icmp ult i64 %.414, %1
  br i1 %291, label %262, label %._crit_edge77, !llvm.loop !23

._crit_edge77:                                    ; preds = %290
  br label %292

292:                                              ; preds = %._crit_edge77, %260
