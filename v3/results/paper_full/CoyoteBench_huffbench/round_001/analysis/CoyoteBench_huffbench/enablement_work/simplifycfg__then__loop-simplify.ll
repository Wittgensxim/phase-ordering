...
29:                                               ; preds = %.preheader8, %38
  %.010 = phi i64 [ %.111, %38 ], [ 0, %.preheader8 ]
  %.13 = phi i64 [ %39, %38 ], [ 0, %.preheader8 ]
...
40:                                               ; preds = %.preheader7, %42
  %.24 = phi i64 [ %47, %42 ], [ %.010, %.preheader7 ]
  %41 = icmp ugt i64 %.24, 0
  br i1 %41, label %42, label %.preheader6
...
48:                                               ; preds = %.preheader6, %50
  %.212 = phi i64 [ %51, %50 ], [ %.010, %.preheader6 ]
...
127:                                              ; preds = %.preheader5, %172
  ...
  %.028 = phi i64 [ %.129, %172 ], [ 0, %.preheader5 ]
  %.024 = phi i8 [ %.125, %172 ], [ 0, %.preheader5 ]
  %.16 = phi i64 [ %174, %172 ], [ 0, %.preheader5 ]
  %.01 = phi i32 [ %.1, %172 ], [ -1, %.preheader5 ]
