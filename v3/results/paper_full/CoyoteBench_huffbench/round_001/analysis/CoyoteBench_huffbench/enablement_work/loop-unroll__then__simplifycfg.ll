...
29:                                               ; preds = %19, %46
  %.010 = phi i64 [ %.111.1, %46 ], [ 0, %19 ]
  %.13 = phi i64 [ %47, %46 ], [ 0, %19 ]
...
38:                                               ; preds = %31, %35
  ...
  %40 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %39
  %41 = load i64, ptr %40, align 8
  %42 = icmp ne i64 %41, 0
  br i1 %42, label %43, label %46

43:                                               ; preds = %38
  %44 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %.111
  store i64 %39, ptr %44, align 8
  %45 = add i64 %.111, 1
  br label %46

46:                                               ; preds = %38, %43
  %.111.1 = phi i64 [ %45, %43 ], [ %.111, %38 ]
  %47 = add nuw nsw i64 %.13, 2
...
57:                                               ; preds = %49, %59
  %.212 = phi i64 [ %60, %59 ], [ %.010.lcssa, %49 ]
...
136:                                              ; preds = %131, %181
  %.134 = phi ptr [ %182, %181 ], [ %0, %131 ]
  %.028 = phi i64 [ %.129.lcssa, %181 ], [ 0, %131 ]
  %.024 = phi i8 [ %.125.lcssa, %181 ], [ 0, %131 ]
  %.16 = phi i64 [ %183, %181 ], [ 0, %131 ]
  %.01 = phi i32 [ %.1.lcssa, %181 ], [ -1, %131 ]
...
211:                                              ; preds = %216, %204
  %.019 = phi i32 [ 0, %204 ], [ %spec.select7, %216 ]
...
216:                                              ; preds = %211
  ...
  %224 = add i32 %218, 1
  %spec.select7 = select i1 %223, i32 %224, i32 %218
  %225 = lshr i64 %.116, 1
  %226 = add i64 %.5, 1
...
231:                                              ; preds = %192, %.critedge
  %.6 = phi i64 [ %257, %.critedge ], [ 1, %192 ]
...
.critedge:                                        ; preds = %238, %240
  %.38.lcssa = phi i64 [ %.38, %240 ], [ %.38, %238 ]
...
265:                                              ; preds = %290, %264
  %.235 = phi ptr [ %0, %264 ], [ %.336, %290 ]
  %.031 = phi ptr [ %11, %264 ], [ %.132, %290 ]
  %.221 = phi i32 [ 0, %264 ], [ %.423, %290 ]
  %.217 = phi i64 [ 128, %264 ], [ %.318, %290 ]
  %.313 = phi i64 [ 0, %264 ], [ %.414, %290 ]
  %.7 = phi i64 [ %.49.lcssa, %264 ], [ %.9, %290 ]
...
267:                                              ; preds = %265
  ...
  %274 = add i32 %269, 1
  %spec.select8 = select i1 %273, i32 %274, i32 %269
  br label %275

275:                                              ; preds = %279, %267
  %.8 = phi i64 [ %.7, %267 ], [ %280, %279 ]
  %276 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.8
  %277 = load i32, ptr %276, align 4
  %278 = icmp ult i32 %277, %spec.select8
...
281:                                              ; preds = %275
  %.8.lcssa = phi i64 [ %.8, %275 ]
  %282 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.8.lcssa
  %283 = load i32, ptr %282, align 4
  %284 = icmp eq i32 %spec.select8, %283
  br i1 %284, label %285, label %290

285:                                              ; preds = %281
  %286 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8.lcssa
  %287 = load i8, ptr %286, align 1
  store i8 %287, ptr %.235, align 1
  %288 = getelementptr inbounds nuw i8, ptr %.235, i32 1
  %289 = add i64 %.313, 1
  br label %290

290:                                              ; preds = %285, %281
  %.336 = phi ptr [ %288, %285 ], [ %.235, %281 ]
  %.423 = phi i32 [ 0, %285 ], [ %spec.select8, %281 ]
  %.414 = phi i64 [ %289, %285 ], [ %.313, %281 ]
  %.9 = phi i64 [ %.49.lcssa, %285 ], [ %.8.lcssa, %281 ]
  %291 = icmp ugt i64 %.217, 1
  %292 = lshr i64 %.217, 1
  %293 = getelementptr inbounds nuw i8, ptr %.031, i32 1
  %.132 = select i1 %291, ptr %.031, ptr %293
  %.318 = select i1 %291, i64 %292, i64 128
