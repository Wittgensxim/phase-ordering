...
47:                                               ; preds = %52, %46
  %.24 = phi i64 [ %.010.lcssa, %46 ], [ %53, %52 ]
  %48 = icmp ugt i64 %.24, 0
  br i1 %48, label %49, label %54

49:                                               ; preds = %47
  %50 = trunc i64 %.010.lcssa to i32
...
55:                                               ; preds = %57, %54
  %.212 = phi i64 [ %.010.lcssa, %54 ], [ %58, %57 ]
...
77:                                               ; preds = %55
  %.212.lcssa = phi i64 [ %.212, %55 ]
  %78 = add i64 256, %.212.lcssa
...
105:                                              ; preds = %92
  %.043.lcssa = phi i64 [ %.043, %92 ]
  %.3.lcssa = phi i64 [ %.3, %92 ]
...
112:                                              ; preds = %111, %105
  %.247 = phi i64 [ %.043.lcssa, %111 ], [ %.045, %105 ]
  %113 = icmp ugt i64 %.3.lcssa, %.039
...
115:                                              ; preds = %114, %112
  %.241 = phi i64 [ %.3.lcssa, %114 ], [ %.039, %112 ]
  br label %116
...
119:                                              ; preds = %80
  %.045.lcssa = phi i64 [ %.045, %80 ]
  %.039.lcssa = phi i64 [ %.039, %80 ]
...
130:                                              ; preds = %181, %129
  ...
  %.028 = phi i64 [ 0, %129 ], [ %.129.lcssa, %181 ]
  %.024 = phi i8 [ 0, %129 ], [ %.125.lcssa, %181 ]
  %.16 = phi i64 [ 0, %129 ], [ %182, %181 ]
  %.01 = phi i32 [ -1, %129 ], [ %.1.lcssa, %181 ]
...
179:                                              ; preds = %141
  %.129.lcssa = phi i64 [ %.129, %141 ]
  %.125.lcssa = phi i8 [ %.125, %141 ]
  %.1.lcssa = phi i32 [ %.1, %141 ]
...
183:                                              ; preds = %130
  %.028.lcssa = phi i64 [ %.028, %130 ]
  %.024.lcssa = phi i8 [ %.024, %130 ]
  %.01.lcssa = phi i32 [ %.01, %130 ]
  %184 = sub nsw i32 7, %.01.lcssa
  %185 = sext i8 %.024.lcssa to i32
  %186 = shl i32 %185, %184
  %187 = trunc i32 %186 to i8
  %188 = getelementptr inbounds nuw i8, ptr %11, i64 %.028.lcssa
...
222:                                              ; preds = %205
  %.019.lcssa = phi i32 [ %.019, %205 ]
  %223 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.27
  store i32 %.019.lcssa, ptr %223, align 4
  br label %224
...
253:                                              ; preds = %242
  %.38.lcssa = phi i64 [ %.38, %242 ]
  %254 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38.lcssa
  store i32 %232, ptr %254, align 4
  %255 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38.lcssa
...
285:                                              ; preds = %279
  %.8.lcssa = phi i64 [ %.8, %279 ]
  %.lcssa = phi i32 [ %281, %279 ]
  %286 = icmp eq i32 %.322, %.lcssa
  br i1 %286, label %287, label %292

287:                                              ; preds = %285
  %288 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8.lcssa
...
292:                                              ; preds = %287, %285
  ...
  %.9 = phi i64 [ %.49.lcssa, %287 ], [ %.8.lcssa, %285 ]
