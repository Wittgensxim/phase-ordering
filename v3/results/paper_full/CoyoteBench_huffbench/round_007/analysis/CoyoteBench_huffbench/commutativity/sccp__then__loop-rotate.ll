...
define dso_local void @compdecomp(ptr noundef %0, i64 noundef %1) #0 {
  ...
  %exitcond.not16 = icmp eq i64 0, %1
  br i1 %exitcond.not16, label %.preheader6.preheader, label %.lr.ph
...
12:                                               ; preds = %.lr.ph, %12
  %.0218 = phi i64 [ 0, %.lr.ph ], [ %19, %12 ]
  %.03317 = phi ptr [ %0, %.lr.ph ], [ %18, %12 ]
  %13 = load i8, ptr %.03317, align 1
  %14 = zext i8 %13 to i64
  %15 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %14
  %16 = load i64, ptr %15, align 8
  %17 = add i64 %16, 1
  store i64 %17, ptr %15, align 8
  %18 = getelementptr inbounds nuw i8, ptr %.03317, i64 1
  %19 = add i64 %.0218, 1
...
.preheader5.preheader:                            ; preds = %.preheader6
  ...
  %.not22 = icmp eq i64 %.010.lcssa, 0
  br i1 %.not22, label %.preheader4.preheader, label %.lr.ph24

.lr.ph24:                                         ; preds = %.preheader5.preheader
  br label %.preheader5

20:                                               ; preds = %.preheader6.preheader, %.preheader6
  %.1321 = phi i64 [ 0, %.preheader6.preheader ], [ %26, %.preheader6 ]
  %.01020 = phi i64 [ 0, %.preheader6.preheader ], [ %.111, %.preheader6 ]
  %21 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.1321
  %22 = load i64, ptr %21, align 8
  %.not8 = icmp eq i64 %22, 0
  br i1 %.not8, label %.preheader6, label %23

23:                                               ; preds = %20
  %24 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.01020
  store i64 %.1321, ptr %24, align 8
  %25 = add i64 %.01020, 1
  br label %.preheader6

.preheader6:                                      ; preds = %23, %20
  %.111 = phi i64 [ %25, %23 ], [ %.01020, %20 ]
  %26 = add nuw nsw i64 %.1321, 1
...
.preheader4.preheader:                            ; preds = %.preheader5..preheader4.preheader_crit_edge, %.preheader5.preheader
  ...
  br i1 %27, label %.lr.ph26, label %50

.lr.ph26:                                         ; preds = %.preheader4.preheader
  br label %.preheader4

.preheader5:                                      ; preds = %.lr.ph24, %.preheader5
  %.2423 = phi i64 [ %.010.lcssa, %.lr.ph24 ], [ %30, %.preheader5 ]
  %28 = trunc i64 %.010.lcssa to i32
  %29 = trunc i64 %.2423 to i32
...
.preheader4:                                      ; preds = %.lr.ph26, %.preheader4
  %.21225 = phi i64 [ %.010.lcssa, %.lr.ph26 ], [ %31, %.preheader4 ]
  %31 = add i64 %.21225, -1
...
53:                                               ; preds = %50, %70
  %.03940 = phi i64 [ 0, %50 ], [ %.140, %70 ]
  %.04239 = phi i64 [ 0, %50 ], [ %71, %70 ]
  %.04538 = phi i64 [ 0, %50 ], [ %.146, %70 ]
  %54 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04239
  %55 = load i64, ptr %54, align 8
  %.not6 = icmp eq i64 %55, 0
  br i1 %.not6, label %56, label %.preheader9

.preheader9:                                      ; preds = %53
  %.037.in27 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.04239
  %.03728 = load i32, ptr %.037.in27, align 4
  %.not729 = icmp eq i32 %.03728, 0
  br i1 %.not729, label %65, label %.lr.ph34

.lr.ph34:                                         ; preds = %.preheader9
  br label %59

56:                                               ; preds = %53
  %57 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04239
  store i32 0, ptr %57, align 4
  %58 = getelementptr inbounds nuw i8, ptr %7, i64 %.04239
  store i8 0, ptr %58, align 1
  br label %70

59:                                               ; preds = %.lr.ph34, %59
  %.03733 = phi i32 [ %.03728, %.lr.ph34 ], [ %.037, %59 ]
  %.332 = phi i64 [ 0, %.lr.ph34 ], [ %64, %59 ]
  %.0531 = phi i64 [ 1, %.lr.ph34 ], [ %63, %59 ]
  %.04330 = phi i64 [ 0, %.lr.ph34 ], [ %.144, %59 ]
  %60 = icmp slt i32 %.03733, 0
  %61 = select i1 %60, i64 %.0531, i64 0
  %.144 = add i64 %.04330, %61
  %.138 = call i32 @llvm.abs.i32(i32 %.03733, i1 true)
  ...
  br i1 %.not7, label %._crit_edge35, label %59, !llvm.loop !13

._crit_edge35:                                    ; preds = %59
  %split36 = phi i64 [ %.144, %59 ]
  %split37 = phi i64 [ %64, %59 ]
  br label %65

65:                                               ; preds = %._crit_edge35, %.preheader9
  %.043.lcssa = phi i64 [ %split36, %._crit_edge35 ], [ 0, %.preheader9 ]
  %.3.lcssa = phi i64 [ %split37, %._crit_edge35 ], [ 0, %.preheader9 ]
  %66 = trunc i64 %.043.lcssa to i32
  %67 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04239
  store i32 %66, ptr %67, align 4
  %68 = trunc i64 %.3.lcssa to i8
  %69 = getelementptr inbounds nuw i8, ptr %7, i64 %.04239
...
70:                                               ; preds = %65, %56
  %.146 = phi i64 [ %spec.select, %65 ], [ %.04538, %56 ]
  %.140 = phi i64 [ %.241, %65 ], [ %.03940, %56 ]
  %71 = add nuw nsw i64 %.04239, 1
...
.preheader3.preheader:                            ; preds = %77
  %exitcond15.not52 = icmp eq i64 0, %1
  br i1 %exitcond15.not52, label %118, label %.lr.ph58

.lr.ph58:                                         ; preds = %.preheader3.preheader
  br label %82
...
82:                                               ; preds = %.lr.ph58, %.preheader3
  %.0157 = phi i32 [ -1, %.lr.ph58 ], [ %.1.lcssa, %.preheader3 ]
  %.1656 = phi i64 [ 0, %.lr.ph58 ], [ %117, %.preheader3 ]
  %.02455 = phi i8 [ 0, %.lr.ph58 ], [ %.125.lcssa, %.preheader3 ]
  %.02854 = phi i64 [ 0, %.lr.ph58 ], [ %.129.lcssa, %.preheader3 ]
  %.13453 = phi ptr [ %0, %.lr.ph58 ], [ %116, %.preheader3 ]
  %83 = load i8, ptr %.13453, align 1
  ...
  br i1 %92, label %.lr.ph47, label %.preheader3

.lr.ph47:                                         ; preds = %82
  br label %93

93:                                               ; preds = %.lr.ph47, %106
  %.145 = phi i32 [ %.0157, %.lr.ph47 ], [ %.2, %106 ]
  %.444 = phi i64 [ 0, %.lr.ph47 ], [ %113, %106 ]
  %.01543 = phi i64 [ %90, %.lr.ph47 ], [ %112, %106 ]
  %.12542 = phi i8 [ %.02455, %.lr.ph47 ], [ %.327, %106 ]
  %.12941 = phi i64 [ %.02854, %.lr.ph47 ], [ %.230, %106 ]
  %94 = phi i8 [ %83, %.lr.ph47 ], [ %.pre-phi.in, %106 ]
  %95 = icmp eq i32 %.145, 7
  br i1 %95, label %96, label %103

96:                                               ; preds = %93
  %97 = getelementptr inbounds nuw i8, ptr %11, i64 %.12941
  store i8 %.12542, ptr %97, align 1
  %98 = add i64 %.12941, 1
  %99 = icmp eq i64 %98, %1
  br i1 %99, label %100, label %._crit_edge

._crit_edge:                                      ; preds = %96
  %.pre1 = load i8, ptr %.13453, align 1
  br label %106
...
106:                                              ; preds = %103, %._crit_edge
  ...
  br i1 %115, label %93, label %._crit_edge48, !llvm.loop !15

._crit_edge48:                                    ; preds = %106
  %split49 = phi i64 [ %.230, %106 ]
  %split50 = phi i8 [ %.327, %106 ]
  %split51 = phi i32 [ %.2, %106 ]
  br label %.preheader3

.preheader3:                                      ; preds = %._crit_edge48, %82
  %.129.lcssa = phi i64 [ %split49, %._crit_edge48 ], [ %.02854, %82 ]
  %.125.lcssa = phi i8 [ %split50, %._crit_edge48 ], [ %.02455, %82 ]
  %.1.lcssa = phi i32 [ %split51, %._crit_edge48 ], [ %.0157, %82 ]
  %116 = getelementptr inbounds nuw i8, ptr %.13453, i64 1
  %117 = add i64 %.1656, 1
...
.preheader3._crit_edge:                           ; preds = %.preheader3
  %split59 = phi i64 [ %.129.lcssa, %.preheader3 ]
  %split60 = phi i8 [ %.125.lcssa, %.preheader3 ]
  %split61 = phi i32 [ %.1.lcssa, %.preheader3 ]
  br label %118

118:                                              ; preds = %.preheader3._crit_edge, %.preheader3.preheader
  %.028.lcssa = phi i64 [ %split59, %.preheader3._crit_edge ], [ 0, %.preheader3.preheader ]
  %.024.lcssa = phi i8 [ %split60, %.preheader3._crit_edge ], [ 0, %.preheader3.preheader ]
  %.01.lcssa = phi i32 [ %split61, %.preheader3._crit_edge ], [ -1, %.preheader3.preheader ]
...
124:                                              ; preds = %118, %148
  %.071 = phi ptr [ %9, %118 ], [ %126, %148 ]
  %.2770 = phi i64 [ 0, %118 ], [ %149, %148 ]
  %125 = trunc nuw i64 %.2770 to i8
  store i8 %125, ptr %.071, align 1
  %126 = getelementptr inbounds nuw i8, ptr %.071, i64 1
  %127 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2770
  %128 = load i32, ptr %127, align 4
  %129 = getelementptr inbounds nuw i8, ptr %7, i64 %.2770
...
133:                                              ; preds = %124
  ...
  %exitcond16.not62 = icmp eq i64 0, %137
  br i1 %exitcond16.not62, label %146, label %.lr.ph67

.lr.ph67:                                         ; preds = %133
  br label %138

138:                                              ; preds = %.lr.ph67, %138
  %.565 = phi i64 [ 0, %.lr.ph67 ], [ %145, %138 ]
  %.11664 = phi i64 [ %136, %.lr.ph67 ], [ %144, %138 ]
  %.01963 = phi i32 [ 0, %.lr.ph67 ], [ %spec.select1, %138 ]
  %139 = shl i32 %.01963, 1
  %140 = or disjoint i32 %139, 1
  %141 = zext i32 %128 to i64
  %142 = and i64 %.11664, %141
  %.not4 = icmp eq i64 %142, 0
  %143 = add i32 %139, 2
  %spec.select1 = select i1 %.not4, i32 %140, i32 %143
  %144 = lshr i64 %.11664, 1
  %145 = add nuw nsw i64 %.565, 1
  %exitcond16.not = icmp eq i64 %145, %137
  br i1 %exitcond16.not, label %._crit_edge68, label %138, !llvm.loop !17

._crit_edge68:                                    ; preds = %138
  %split69 = phi i32 [ %spec.select1, %138 ]
  br label %146

146:                                              ; preds = %._crit_edge68, %133
  %.019.lcssa = phi i32 [ %split69, %._crit_edge68 ], [ 0, %133 ]
  %147 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2770
  store i32 %.019.lcssa, ptr %147, align 4
  br label %148

148:                                              ; preds = %146, %124
  %149 = add nuw nsw i64 %.2770, 1
...
150:                                              ; preds = %.preheader2.preheader, %.critedge
  %.673 = phi i64 [ 1, %.preheader2.preheader ], [ %167, %.critedge ]
  %151 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.673
  %152 = load i32, ptr %151, align 4
  %153 = getelementptr inbounds nuw i8, ptr %9, i64 %.673
  %154 = load i8, ptr %153, align 1
  br label %155

155:                                              ; preds = %150, %160
  %.3872 = phi i64 [ %.673, %150 ], [ %156, %160 ]
  %156 = add nsw i64 %.3872, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %172, label %.lr.ph80, label %195

.lr.ph80:                                         ; preds = %.preheader.preheader
  br label %173

173:                                              ; preds = %.lr.ph80, %.preheader
  %.779 = phi i64 [ %.49.lcssa, %.lr.ph80 ], [ %.9, %.preheader ]
  %.31378 = phi i64 [ 0, %.lr.ph80 ], [ %.414, %.preheader ]
  %.21777 = phi i64 [ 128, %.lr.ph80 ], [ %.318, %.preheader ]
  %.22176 = phi i32 [ 0, %.lr.ph80 ], [ %.423, %.preheader ]
  %.03175 = phi ptr [ %11, %.lr.ph80 ], [ %.132, %.preheader ]
  %.23574 = phi ptr [ %0, %.lr.ph80 ], [ %.336, %.preheader ]
  %174 = shl i32 %.22176, 1
  %175 = or disjoint i32 %174, 1
  %176 = load i8, ptr %.03175, align 1
  %177 = zext i8 %176 to i64
  %178 = and i64 %.21777, %177
...
187:                                              ; preds = %185
  ...
  store i8 %189, ptr %.23574, align 1
  %190 = getelementptr inbounds nuw i8, ptr %.23574, i64 1
  %191 = add nuw i64 %.31378, 1
  br label %.preheader

.preheader:                                       ; preds = %187, %185
  %.336 = phi ptr [ %190, %187 ], [ %.23574, %185 ]
  %.423 = phi i32 [ 0, %187 ], [ %spec.select2, %185 ]
  %.414 = phi i64 [ %191, %187 ], [ %.31378, %185 ]
  %.9 = phi i64 [ %.49.lcssa, %187 ], [ %.8.lcssa, %185 ]
  %192 = icmp ult i64 %.21777, 2
  %193 = lshr i64 %.21777, 1
  %.132.idx = zext i1 %192 to i64
  %.132 = getelementptr inbounds nuw i8, ptr %.03175, i64 %.132.idx
