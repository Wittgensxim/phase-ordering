...
.lr.ph:                                           ; preds = %2, %.lr.ph
  %.0216 = phi i64 [ %18, %.lr.ph ], [ 0, %2 ]
  %.03315 = phi ptr [ %17, %.lr.ph ], [ %0, %2 ]
  %12 = load i8, ptr %.03315, align 1
  %13 = zext i8 %12 to i64
  %14 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %13
  %15 = load i64, ptr %14, align 8
  %16 = add i64 %15, 1
  store i64 %16, ptr %14, align 8
  %17 = getelementptr inbounds nuw i8, ptr %.03315, i64 1
  %18 = add i64 %.0216, 1
...
.preheader5.preheader:                            ; preds = %.preheader6
  ...
  br i1 %.not20, label %.preheader4.preheader, label %.preheader5

19:                                               ; preds = %.preheader6.preheader, %.preheader6
  %.1319 = phi i64 [ 0, %.preheader6.preheader ], [ %25, %.preheader6 ]
  %.01018 = phi i64 [ 0, %.preheader6.preheader ], [ %.111, %.preheader6 ]
  %20 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.1319
  %21 = load i64, ptr %20, align 8
  %.not8 = icmp eq i64 %21, 0
  br i1 %.not8, label %.preheader6, label %22

22:                                               ; preds = %19
  %23 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.01018
  store i64 %.1319, ptr %23, align 8
  %24 = add i64 %.01018, 1
  br label %.preheader6

.preheader6:                                      ; preds = %22, %19
  %.111 = phi i64 [ %24, %22 ], [ %.01018, %19 ]
  %25 = add nuw nsw i64 %.1319, 1
...
.preheader5:                                      ; preds = %.preheader5.preheader, %.preheader5
  %.2421 = phi i64 [ %29, %.preheader5 ], [ %.010.lcssa, %.preheader5.preheader ]
  %27 = trunc i64 %.010.lcssa to i32
  %28 = trunc i64 %.2421 to i32
...
.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  %.21223 = phi i64 [ %30, %.preheader4 ], [ %.010.lcssa, %.preheader4.preheader ]
  %30 = add i64 %.21223, -1
...
51:                                               ; preds = %.preheader4._crit_edge, %66
  %.03938 = phi i64 [ 0, %.preheader4._crit_edge ], [ %.140, %66 ]
  %.04237 = phi i64 [ 0, %.preheader4._crit_edge ], [ %67, %66 ]
  %.04536 = phi i64 [ 0, %.preheader4._crit_edge ], [ %.146, %66 ]
  %52 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04237
...
.preheader7:                                      ; preds = %51
  ...
  br i1 %.not727, label %._crit_edge33, label %.lr.ph32

54:                                               ; preds = %51
  %55 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04237
  store i32 0, ptr %55, align 4
  %56 = getelementptr inbounds nuw i8, ptr %7, i64 %.04237
  store i8 0, ptr %56, align 1
  br label %66

.lr.ph32:                                         ; preds = %.preheader7, %.lr.ph32
  %.03731 = phi i32 [ %.037, %.lr.ph32 ], [ %.03726, %.preheader7 ]
  %.330 = phi i64 [ %61, %.lr.ph32 ], [ 0, %.preheader7 ]
  %.0529 = phi i64 [ %60, %.lr.ph32 ], [ 1, %.preheader7 ]
  %.04328 = phi i64 [ %.144, %.lr.ph32 ], [ 0, %.preheader7 ]
  %57 = icmp slt i32 %.03731, 0
  %58 = select i1 %57, i64 %.0529, i64 0
  %.144 = add i64 %.04328, %58
...
._crit_edge33:                                    ; preds = %.lr.ph32, %.preheader7
  %.043.lcssa = phi i64 [ 0, %.preheader7 ], [ %.144, %.lr.ph32 ]
  %.3.lcssa = phi i64 [ 0, %.preheader7 ], [ %61, %.lr.ph32 ]
  %62 = trunc i64 %.043.lcssa to i32
  %63 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04237
  store i32 %62, ptr %63, align 4
  %64 = trunc i64 %.3.lcssa to i8
  %65 = getelementptr inbounds nuw i8, ptr %7, i64 %.04237
  store i8 %64, ptr %65, align 1
  %spec.select = call i64 @llvm.umax.i64(i64 %.043.lcssa, i64 %.04536)
  %.241 = call i64 @llvm.umax.i64(i64 %.3.lcssa, i64 %.03938)
  br label %66

66:                                               ; preds = %._crit_edge33, %54
  %.146 = phi i64 [ %spec.select, %._crit_edge33 ], [ %.04536, %54 ]
  %.140 = phi i64 [ %.241, %._crit_edge33 ], [ %.03938, %54 ]
  %67 = add nuw nsw i64 %.04237, 1
...
.preheader3.preheader:                            ; preds = %73
  ...
  br i1 %exitcond15.not50, label %.preheader3._crit_edge, label %.lr.ph56
...
.lr.ph56:                                         ; preds = %.preheader3.preheader, %.preheader3
  %.0155 = phi i32 [ %.1.lcssa, %.preheader3 ], [ -1, %.preheader3.preheader ]
  %.1654 = phi i64 [ %111, %.preheader3 ], [ 0, %.preheader3.preheader ]
  %.02453 = phi i8 [ %.125.lcssa, %.preheader3 ], [ 0, %.preheader3.preheader ]
  %.02852 = phi i64 [ %.129.lcssa, %.preheader3 ], [ 0, %.preheader3.preheader ]
  %.13451 = phi ptr [ %110, %.preheader3 ], [ %0, %.preheader3.preheader ]
  %78 = load i8, ptr %.13451, align 1
  ...
  br i1 %87, label %.lr.ph45, label %.preheader3

.lr.ph45:                                         ; preds = %.lr.ph56, %100
  %.143 = phi i32 [ %.2, %100 ], [ %.0155, %.lr.ph56 ]
  %.442 = phi i64 [ %107, %100 ], [ 0, %.lr.ph56 ]
  %.01541 = phi i64 [ %106, %100 ], [ %85, %.lr.ph56 ]
  %.12540 = phi i8 [ %.327, %100 ], [ %.02453, %.lr.ph56 ]
  %.12939 = phi i64 [ %.230, %100 ], [ %.02852, %.lr.ph56 ]
  %88 = phi i8 [ %.pre-phi.in, %100 ], [ %78, %.lr.ph56 ]
  %89 = icmp eq i32 %.143, 7
  br i1 %89, label %90, label %97

90:                                               ; preds = %.lr.ph45
  %91 = getelementptr inbounds nuw i8, ptr %11, i64 %.12939
  store i8 %.12540, ptr %91, align 1
  %92 = add i64 %.12939, 1
  %93 = icmp eq i64 %92, %1
...
100:                                              ; preds = %97, %._crit_edge
  ...
  br i1 %109, label %.lr.ph45, label %.preheader3, !llvm.loop !15

.preheader3:                                      ; preds = %100, %.lr.ph56
  %.129.lcssa = phi i64 [ %.02852, %.lr.ph56 ], [ %.230, %100 ]
  %.125.lcssa = phi i8 [ %.02453, %.lr.ph56 ], [ %.327, %100 ]
  %.1.lcssa = phi i32 [ %.0155, %.lr.ph56 ], [ %.2, %100 ]
  %110 = getelementptr inbounds nuw i8, ptr %.13451, i64 1
  %111 = add i64 %.1654, 1
  %exitcond15.not = icmp eq i64 %111, %1
  br i1 %exitcond15.not, label %.preheader3._crit_edge, label %.lr.ph56, !llvm.loop !16
...
117:                                              ; preds = %.preheader3._crit_edge, %139
  %.069 = phi ptr [ %9, %.preheader3._crit_edge ], [ %119, %139 ]
  %.2768 = phi i64 [ 0, %.preheader3._crit_edge ], [ %140, %139 ]
  %118 = trunc nuw i64 %.2768 to i8
  store i8 %118, ptr %.069, align 1
  %119 = getelementptr inbounds nuw i8, ptr %.069, i64 1
  %120 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2768
  %121 = load i32, ptr %120, align 4
  %122 = getelementptr inbounds nuw i8, ptr %7, i64 %.2768
...
126:                                              ; preds = %117
  ...
  %exitcond16.not60 = icmp eq i64 0, %130
  br i1 %exitcond16.not60, label %._crit_edge66, label %.lr.ph65

.lr.ph65:                                         ; preds = %126, %.lr.ph65
  %.563 = phi i64 [ %137, %.lr.ph65 ], [ 0, %126 ]
  %.11662 = phi i64 [ %136, %.lr.ph65 ], [ %129, %126 ]
  %.01961 = phi i32 [ %spec.select1, %.lr.ph65 ], [ 0, %126 ]
  %131 = shl i32 %.01961, 1
  %132 = or disjoint i32 %131, 1
  %133 = zext i32 %121 to i64
  %134 = and i64 %.11662, %133
  %.not4 = icmp eq i64 %134, 0
  %135 = add i32 %131, 2
  %spec.select1 = select i1 %.not4, i32 %132, i32 %135
  %136 = lshr i64 %.11662, 1
  %137 = add nuw nsw i64 %.563, 1
  %exitcond16.not = icmp eq i64 %137, %130
  br i1 %exitcond16.not, label %._crit_edge66, label %.lr.ph65, !llvm.loop !17

._crit_edge66:                                    ; preds = %.lr.ph65, %126
  %.019.lcssa = phi i32 [ 0, %126 ], [ %spec.select1, %.lr.ph65 ]
  %138 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2768
  store i32 %.019.lcssa, ptr %138, align 4
  br label %139

139:                                              ; preds = %._crit_edge66, %117
  %140 = add nuw nsw i64 %.2768, 1
...
.preheader2.preheader:                            ; preds = %139, %.critedge
  %.671 = phi i64 [ %157, %.critedge ], [ 1, %139 ]
  %141 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.671
  %142 = load i32, ptr %141, align 4
  %143 = getelementptr inbounds nuw i8, ptr %9, i64 %.671
  %144 = load i8, ptr %143, align 1
  br label %145

145:                                              ; preds = %.preheader2.preheader, %150
  %.3870 = phi i64 [ %.671, %.preheader2.preheader ], [ %146, %150 ]
  %146 = add nsw i64 %.3870, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %162, label %.lr.ph78, label %.preheader._crit_edge

.lr.ph78:                                         ; preds = %.preheader.preheader, %.preheader
  %.777 = phi i64 [ %.9, %.preheader ], [ %.49.lcssa, %.preheader.preheader ]
  %.31376 = phi i64 [ %.414, %.preheader ], [ 0, %.preheader.preheader ]
  %.21775 = phi i64 [ %.318, %.preheader ], [ 128, %.preheader.preheader ]
  %.22174 = phi i32 [ %.423, %.preheader ], [ 0, %.preheader.preheader ]
  %.03173 = phi ptr [ %.132, %.preheader ], [ %11, %.preheader.preheader ]
  %.23572 = phi ptr [ %.336, %.preheader ], [ %0, %.preheader.preheader ]
  %163 = shl i32 %.22174, 1
  %164 = or disjoint i32 %163, 1
  %165 = load i8, ptr %.03173, align 1
  %166 = zext i8 %165 to i64
  %167 = and i64 %.21775, %166
  %.not1 = icmp eq i64 %167, 0
  %168 = add i32 %163, 2
  %spec.select2 = select i1 %.not1, i32 %164, i32 %168
  br label %169

169:                                              ; preds = %169, %.lr.ph78
  %.8 = phi i64 [ %.777, %.lr.ph78 ], [ %173, %169 ]
...
176:                                              ; preds = %174
  ...
  store i8 %178, ptr %.23572, align 1
  %179 = getelementptr inbounds nuw i8, ptr %.23572, i64 1
  %180 = add nuw i64 %.31376, 1
  br label %.preheader

.preheader:                                       ; preds = %176, %174
  %.336 = phi ptr [ %179, %176 ], [ %.23572, %174 ]
  %.423 = phi i32 [ 0, %176 ], [ %spec.select2, %174 ]
  %.414 = phi i64 [ %180, %176 ], [ %.31376, %174 ]
  %.9 = phi i64 [ %.49.lcssa, %176 ], [ %.8.lcssa, %174 ]
  %181 = icmp ult i64 %.21775, 2
  %182 = lshr i64 %.21775, 1
  ...
  br i1 %183, label %.lr.ph78, label %.preheader._crit_edge, !llvm.loop !23
...
.loopexit:                                        ; preds = %6, %5, %2
  %.not1 = phi i1 [ true, %2 ], [ %exitcond.not, %5 ], [ %exitcond.not2, %6 ]
