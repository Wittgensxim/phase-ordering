...
21:                                               ; preds = %.preheader6.preheader, %.preheader6
  %.1319 = phi i64 [ 0, %.preheader6.preheader ], [ %27, %.preheader6 ]
  %.01018 = phi i64 [ 0, %.preheader6.preheader ], [ %.111, %.preheader6 ]
  %22 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.1319
  %23 = load i64, ptr %22, align 8
  %.not8 = icmp eq i64 %23, 0
  br i1 %.not8, label %.preheader6, label %24

24:                                               ; preds = %21
  %25 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.01018
  store i64 %.1319, ptr %25, align 8
  %26 = add i64 %.01018, 1
  br label %.preheader6

.preheader6:                                      ; preds = %24, %21
  %.111 = phi i64 [ %26, %24 ], [ %.01018, %21 ]
...
.preheader4.preheader:                            ; preds = %.preheader5..preheader4.preheader_crit_edge, %.preheader5.preheader
  ...
  br i1 %28, label %.lr.ph24, label %50
...
139:                                              ; preds = %.lr.ph65, %139
  %.563 = phi i64 [ 0, %.lr.ph65 ], [ %145, %139 ]
  %.11662 = phi i64 [ %136, %.lr.ph65 ], [ %144, %139 ]
  %.01961 = phi i32 [ 0, %.lr.ph65 ], [ %spec.select1, %139 ]
  %140 = shl i32 %.01961, 1
  %141 = or disjoint i32 %140, 1
  %142 = and i64 %.11662, %138
  ...
  br i1 %exitcond16.not, label %._crit_edge66, label %139, !llvm.loop !17

._crit_edge66:                                    ; preds = %139
  %split67 = phi i32 [ %spec.select1, %139 ]
  br label %146
