...
..preheader6.preheader_crit_edge.unr-lcssa:       ; preds = %22
  %.0216.unr = phi i64 [ %47, %22 ]
  %.03315.unr = phi ptr [ %46, %22 ]
...
.epil.preheader:                                  ; preds = %..preheader6.preheader_crit_edge.unr-lcssa, %.lr.ph
  %.0216.epil.init = phi i64 [ 0, %.lr.ph ], [ %.0216.unr, %..preheader6.preheader_crit_edge.unr-lcssa ]
  %.03315.epil.init = phi ptr [ %0, %.lr.ph ], [ %.03315.unr, %..preheader6.preheader_crit_edge.unr-lcssa ]
  %lcmp.mod79 = icmp ne i64 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod79)
  br label %14

14:                                               ; preds = %14, %.epil.preheader
  %.0216.epil = phi i64 [ %.0216.epil.init, %.epil.preheader ], [ %21, %14 ]
  %.03315.epil = phi ptr [ %.03315.epil.init, %.epil.preheader ], [ %20, %14 ]
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %14 ]
  %15 = load i8, ptr %.03315.epil, align 1
  %16 = zext i8 %15 to i64
  %17 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %16
  %18 = load i64, ptr %17, align 8
  %19 = add i64 %18, 1
  store i64 %19, ptr %17, align 8
  %20 = getelementptr inbounds nuw i8, ptr %.03315.epil, i64 1
  %21 = add i64 %.0216.epil, 1
...
22:                                               ; preds = %22, %.lr.ph.new
  %.0216 = phi i64 [ 0, %.lr.ph.new ], [ %47, %22 ]
  %.03315 = phi ptr [ %0, %.lr.ph.new ], [ %46, %22 ]
  %niter = phi i64 [ 0, %.lr.ph.new ], [ %niter.next.3, %22 ]
  %23 = load i8, ptr %.03315, align 1
  %24 = zext i8 %23 to i64
  %25 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %24
  %26 = load i64, ptr %25, align 8
  %27 = add i64 %26, 1
  store i64 %27, ptr %25, align 8
  %28 = getelementptr inbounds nuw i8, ptr %.03315, i64 1
...
48:                                               ; preds = %.preheader6.1, %.preheader6.preheader
  %.1319 = phi i64 [ 0, %.preheader6.preheader ], [ %60, %.preheader6.1 ]
  %.01018 = phi i64 [ 0, %.preheader6.preheader ], [ %.111.1, %.preheader6.1 ]
  %49 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.1319
  %50 = load i64, ptr %49, align 8
  %.not8 = icmp eq i64 %50, 0
  br i1 %.not8, label %.preheader6, label %51

51:                                               ; preds = %48
  %52 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.01018
  store i64 %.1319, ptr %52, align 8
  %53 = add i64 %.01018, 1
  br label %.preheader6

.preheader6:                                      ; preds = %51, %48
  %.111 = phi i64 [ %53, %51 ], [ %.01018, %48 ]
  %54 = add nuw nsw i64 %.1319, 1
...
.preheader4.preheader:                            ; preds = %.preheader5..preheader4.preheader_crit_edge, %.preheader5.preheader
  ...
  br i1 %61, label %.lr.ph24, label %84

.lr.ph24:                                         ; preds = %.preheader4.preheader
  br label %.preheader4

.preheader5:                                      ; preds = %.lr.ph22, %.preheader5
  %.2421 = phi i64 [ %.010.lcssa, %.lr.ph22 ], [ %64, %.preheader5 ]
  %62 = trunc i64 %.010.lcssa to i32
  %63 = trunc i64 %.2421 to i32
...
.preheader4:                                      ; preds = %.lr.ph24, %.preheader4
  %.21223 = phi i64 [ %.010.lcssa, %.lr.ph24 ], [ %65, %.preheader4 ]
  %65 = add i64 %.21223, -1
...
87:                                               ; preds = %84, %104
  %.03938 = phi i64 [ 0, %84 ], [ %.140, %104 ]
  %.04237 = phi i64 [ 0, %84 ], [ %105, %104 ]
  %.04536 = phi i64 [ 0, %84 ], [ %.146, %104 ]
  %88 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04237
...
.preheader7:                                      ; preds = %87
  ...
  br i1 %.not727, label %99, label %.lr.ph32

.lr.ph32:                                         ; preds = %.preheader7
  br label %93

90:                                               ; preds = %87
  %91 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04237
  store i32 0, ptr %91, align 4
  %92 = getelementptr inbounds nuw i8, ptr %7, i64 %.04237
  store i8 0, ptr %92, align 1
  br label %104

93:                                               ; preds = %.lr.ph32, %93
  %.03731 = phi i32 [ %.03726, %.lr.ph32 ], [ %.037, %93 ]
  %.330 = phi i64 [ 0, %.lr.ph32 ], [ %98, %93 ]
  %.0529 = phi i64 [ 1, %.lr.ph32 ], [ %97, %93 ]
  %.04328 = phi i64 [ 0, %.lr.ph32 ], [ %.144, %93 ]
  %94 = icmp slt i32 %.03731, 0
  %95 = select i1 %94, i64 %.0529, i64 0
  %.144 = add i64 %.04328, %95
  ...
  br i1 %.not7, label %._crit_edge33, label %93, !llvm.loop !15

._crit_edge33:                                    ; preds = %93
  %split34 = phi i64 [ %.144, %93 ]
  %split35 = phi i64 [ %98, %93 ]
  br label %99

99:                                               ; preds = %._crit_edge33, %.preheader7
  ...
  %101 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04237
  store i32 %100, ptr %101, align 4
  %102 = trunc i64 %.3.lcssa to i8
  %103 = getelementptr inbounds nuw i8, ptr %7, i64 %.04237
...
104:                                              ; preds = %99, %90
  %.146 = phi i64 [ %spec.select, %99 ], [ %.04536, %90 ]
  %.140 = phi i64 [ %.241, %99 ], [ %.03938, %90 ]
  %105 = add nuw nsw i64 %.04237, 1
...
.preheader3.preheader:                            ; preds = %111
  ...
  br i1 %exitcond15.not50, label %152, label %.lr.ph56
...
116:                                              ; preds = %.lr.ph56, %.preheader3
  %.0155 = phi i32 [ -1, %.lr.ph56 ], [ %.1.lcssa, %.preheader3 ]
  %.1654 = phi i64 [ 0, %.lr.ph56 ], [ %151, %.preheader3 ]
  %.02453 = phi i8 [ 0, %.lr.ph56 ], [ %.125.lcssa, %.preheader3 ]
  %.02852 = phi i64 [ 0, %.lr.ph56 ], [ %.129.lcssa, %.preheader3 ]
  %.13451 = phi ptr [ %0, %.lr.ph56 ], [ %150, %.preheader3 ]
  %117 = load i8, ptr %.13451, align 1
  ...
  br i1 %126, label %.lr.ph45, label %.preheader3

.lr.ph45:                                         ; preds = %116
  br label %127

127:                                              ; preds = %.lr.ph45, %140
  %.143 = phi i32 [ %.0155, %.lr.ph45 ], [ %.2, %140 ]
  %.442 = phi i64 [ 0, %.lr.ph45 ], [ %147, %140 ]
  %.01541 = phi i64 [ %124, %.lr.ph45 ], [ %146, %140 ]
  %.12540 = phi i8 [ %.02453, %.lr.ph45 ], [ %.327, %140 ]
  %.12939 = phi i64 [ %.02852, %.lr.ph45 ], [ %.230, %140 ]
  %128 = phi i8 [ %117, %.lr.ph45 ], [ %.pre-phi.in, %140 ]
  %129 = icmp eq i32 %.143, 7
  br i1 %129, label %130, label %137

130:                                              ; preds = %127
  %131 = getelementptr inbounds nuw i8, ptr %11, i64 %.12939
  store i8 %.12540, ptr %131, align 1
  %132 = add i64 %.12939, 1
...
140:                                              ; preds = %137, %._crit_edge
  ...
  br i1 %149, label %127, label %._crit_edge46, !llvm.loop !17

._crit_edge46:                                    ; preds = %140
  %split47 = phi i64 [ %.230, %140 ]
  %split48 = phi i8 [ %.327, %140 ]
  %split49 = phi i32 [ %.2, %140 ]
  br label %.preheader3

.preheader3:                                      ; preds = %._crit_edge46, %116
  %.129.lcssa = phi i64 [ %split47, %._crit_edge46 ], [ %.02852, %116 ]
  %.125.lcssa = phi i8 [ %split48, %._crit_edge46 ], [ %.02453, %116 ]
  %.1.lcssa = phi i32 [ %split49, %._crit_edge46 ], [ %.0155, %116 ]
  %150 = getelementptr inbounds nuw i8, ptr %.13451, i64 1
  %151 = add i64 %.1654, 1
...
158:                                              ; preds = %152, %195
  %.069 = phi ptr [ %9, %152 ], [ %160, %195 ]
  %.2768 = phi i64 [ 0, %152 ], [ %196, %195 ]
  %159 = trunc nuw i64 %.2768 to i8
  store i8 %159, ptr %.069, align 1
  %160 = getelementptr inbounds nuw i8, ptr %.069, i64 1
  %161 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2768
  %162 = load i32, ptr %161, align 4
  %163 = getelementptr inbounds nuw i8, ptr %7, i64 %.2768
...
167:                                              ; preds = %158
  ...
  %exitcond16.not60 = icmp eq i64 0, %171
  br i1 %exitcond16.not60, label %193, label %.lr.ph65

.lr.ph65:                                         ; preds = %167
  %172 = add nsw i64 %171, -1
  %xtraiter81 = and i64 %171, 1
  %173 = icmp ult i64 %172, 1
  br i1 %173, label %.epil.preheader80, label %.lr.ph65.new

.lr.ph65.new:                                     ; preds = %.lr.ph65
  %unroll_iter86 = sub i64 %171, %xtraiter81
  br label %174

174:                                              ; preds = %174, %.lr.ph65.new
  %.563 = phi i64 [ 0, %.lr.ph65.new ], [ %187, %174 ]
  %.11662 = phi i64 [ %170, %.lr.ph65.new ], [ %186, %174 ]
  %.01961 = phi i32 [ 0, %.lr.ph65.new ], [ %spec.select1.1, %174 ]
  %niter87 = phi i64 [ 0, %.lr.ph65.new ], [ %niter87.next.1, %174 ]
  %175 = shl i32 %.01961, 1
  %176 = or disjoint i32 %175, 1
  %177 = zext i32 %162 to i64
  %178 = and i64 %.11662, %177
  %.not4 = icmp eq i64 %178, 0
  %179 = add i32 %175, 2
  %spec.select1 = select i1 %.not4, i32 %176, i32 %179
  %180 = lshr i64 %.11662, 1
  ...
  %186 = lshr i64 %180, 1
  %187 = add nuw nsw i64 %.563, 2
  %niter87.next.1 = add i64 %niter87, 2
  %niter87.ncmp.1 = icmp eq i64 %niter87.next.1, %unroll_iter86
  br i1 %niter87.ncmp.1, label %._crit_edge66.unr-lcssa, label %174, !llvm.loop !19

._crit_edge66.unr-lcssa:                          ; preds = %174
  %split67.ph = phi i32 [ %spec.select1.1, %174 ]
  %.11662.unr = phi i64 [ %186, %174 ]
  %.01961.unr = phi i32 [ %spec.select1.1, %174 ]
  %lcmp.mod83 = icmp ne i64 %xtraiter81, 0
  br i1 %lcmp.mod83, label %.epil.preheader80, label %._crit_edge66

.epil.preheader80:                                ; preds = %._crit_edge66.unr-lcssa, %.lr.ph65
  %.11662.epil.init = phi i64 [ %170, %.lr.ph65 ], [ %.11662.unr, %._crit_edge66.unr-lcssa ]
  %.01961.epil.init = phi i32 [ 0, %.lr.ph65 ], [ %.01961.unr, %._crit_edge66.unr-lcssa ]
  %lcmp.mod85 = icmp ne i64 %xtraiter81, 0
  call void @llvm.assume(i1 %lcmp.mod85)
  br label %._crit_edge66.epilog-lcssa

._crit_edge66.epilog-lcssa:                       ; preds = %.epil.preheader80
  %188 = shl i32 %.01961.epil.init, 1
  %189 = or disjoint i32 %188, 1
  %190 = zext i32 %162 to i64
  %191 = and i64 %.11662.epil.init, %190
  %.not4.epil = icmp eq i64 %191, 0
  %192 = add i32 %188, 2
  %spec.select1.epil = select i1 %.not4.epil, i32 %189, i32 %192
  br label %._crit_edge66

._crit_edge66:                                    ; preds = %._crit_edge66.unr-lcssa, %._crit_edge66.epilog-lcssa
  %split67 = phi i32 [ %split67.ph, %._crit_edge66.unr-lcssa ], [ %spec.select1.epil, %._crit_edge66.epilog-lcssa ]
  br label %193

193:                                              ; preds = %._crit_edge66, %167
  %.019.lcssa = phi i32 [ %split67, %._crit_edge66 ], [ 0, %167 ]
  %194 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2768
  store i32 %.019.lcssa, ptr %194, align 4
  br label %195

195:                                              ; preds = %193, %158
  %196 = add nuw nsw i64 %.2768, 1
...
197:                                              ; preds = %.preheader2.preheader, %.critedge
  %.671 = phi i64 [ 1, %.preheader2.preheader ], [ %214, %.critedge ]
  %198 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.671
  %199 = load i32, ptr %198, align 4
  %200 = getelementptr inbounds nuw i8, ptr %9, i64 %.671
  %201 = load i8, ptr %200, align 1
  br label %202

202:                                              ; preds = %197, %207
  %.3870 = phi i64 [ %.671, %197 ], [ %203, %207 ]
  %203 = add nsw i64 %.3870, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %219, label %.lr.ph78, label %242

.lr.ph78:                                         ; preds = %.preheader.preheader
  br label %220

220:                                              ; preds = %.lr.ph78, %.preheader
  ...
  %223 = load i8, ptr %.03173, align 1
  %224 = zext i8 %223 to i64
  %225 = and i64 %.21775, %224
...
234:                                              ; preds = %232
  ...
  store i8 %236, ptr %.23572, align 1
  %237 = getelementptr inbounds nuw i8, ptr %.23572, i64 1
  %238 = add nuw i64 %.31376, 1
  br label %.preheader

.preheader:                                       ; preds = %234, %232
  %.336 = phi ptr [ %237, %234 ], [ %.23572, %232 ]
  %.423 = phi i32 [ 0, %234 ], [ %spec.select2, %232 ]
  %.414 = phi i64 [ %238, %234 ], [ %.31376, %232 ]
  %.9 = phi i64 [ %.49.lcssa, %234 ], [ %.8.lcssa, %232 ]
  %239 = icmp ult i64 %.21775, 2
  %240 = lshr i64 %.21775, 1
