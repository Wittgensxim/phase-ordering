...
130:                                              ; preds = %156, %124
  ...
  br i1 %exitcond17.not, label %.preheader2, label %131
...
.preheader2:                                      ; preds = %.critedge, %130
  %.6 = phi i64 [ %176, %.critedge ], [ 1, %130 ]
  %exitcond18.not = icmp eq i64 %.6, 256
  br i1 %exitcond18.not, label %.preheader1, label %158
...
.preheader1:                                      ; preds = %180, %.preheader2
...
.preheader:                                       ; preds = %203, %.preheader1
