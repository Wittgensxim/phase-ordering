...
12:                                               ; preds = %14, %2
  ...
  br i1 %13, label %14, label %.preheader20
...
22:                                               ; preds = %38, %.preheader20
  %.010 = phi i64 [ 0, %.preheader20 ], [ %.111.1, %38 ]
  %.13 = phi i64 [ 0, %.preheader20 ], [ %39, %38 ]
  %23 = icmp samesign ult i64 %.13, 256
  br i1 %23, label %24, label %.preheader19

.preheader19:                                     ; preds = %22
...
40:                                               ; preds = %.preheader19, %41
  %.24 = phi i64 [ %44, %41 ], [ %.010.lcssa, %.preheader19 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader18, label %41

.preheader18:                                     ; preds = %40
  br label %45
...
45:                                               ; preds = %.preheader18, %47
  %.212 = phi i64 [ %48, %47 ], [ %.010.lcssa, %.preheader18 ]
...
98:                                               ; preds = %93
  ...
  br i1 %99, label %100, label %.preheader11

.preheader11:                                     ; preds = %98
  br label %103
...
103:                                              ; preds = %.preheader11, %143
  %.134 = phi ptr [ %144, %143 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129.lcssa, %143 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125.lcssa, %143 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %145, %143 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1.lcssa, %143 ], [ -1, %.preheader11 ]
...
152:                                              ; preds = %182, %146
  ...
  br i1 %153, label %154, label %.preheader10

.preheader10:                                     ; preds = %152
  br label %184
...
184:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %205, %.critedge ], [ 1, %.preheader10 ]
  %185 = icmp samesign ult i64 %.6, 256
  br i1 %185, label %186, label %.preheader9

.preheader9:                                      ; preds = %184
  br label %206
...
.critedge:                                        ; preds = %192, %191
  %.38.lcssa = phi i64 [ %.38, %192 ], [ %.38, %191 ]
  %203 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.38.lcssa
  store i32 %188, ptr %203, align 4
  %204 = getelementptr inbounds nuw i8, ptr %9, i64 %.38.lcssa
  store i8 %190, ptr %204, align 1
  %205 = add nuw nsw i64 %.6, 1
  br label %184, !llvm.loop !20

206:                                              ; preds = %.preheader9, %210
  %.49 = phi i64 [ %211, %210 ], [ 0, %.preheader9 ]
...
212:                                              ; preds = %.preheader, %234
  ...
  %.7 = phi i64 [ %.9, %234 ], [ %.49.lcssa, %.preheader ]
...
214:                                              ; preds = %212
  ...
  %219 = and i64 %.217, %218
  %.not1 = icmp eq i64 %219, 0
  %220 = add i32 %215, 2
  %spec.select2 = select i1 %.not1, i32 %216, i32 %220
  br label %221
...
227:                                              ; preds = %221
  %.8.lcssa = phi i64 [ %.8, %221 ]
  %.lcssa = phi i32 [ %223, %221 ]
  %228 = icmp eq i32 %spec.select2, %.lcssa
  br i1 %228, label %229, label %234

229:                                              ; preds = %227
  %230 = getelementptr inbounds nuw i8, ptr %9, i64 %.8.lcssa
...
234:                                              ; preds = %229, %227
  ...
  %.9 = phi i64 [ %.49.lcssa, %229 ], [ %.8.lcssa, %227 ]
