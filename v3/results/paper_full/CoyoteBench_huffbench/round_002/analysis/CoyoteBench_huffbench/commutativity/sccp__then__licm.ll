...
22:                                               ; preds = %.preheader14, %32
  %.010 = phi i64 [ %.111, %32 ], [ 0, %.preheader14 ]
  %.13 = phi i64 [ %33, %32 ], [ 0, %.preheader14 ]
...
34:                                               ; preds = %.preheader13, %36
  %.24 = phi i64 [ %38, %36 ], [ %.010.lcssa, %.preheader13 ]
  %35 = icmp ugt i64 %.24, 0
  br i1 %35, label %36, label %.preheader12
...
39:                                               ; preds = %.preheader12, %41
  %.212 = phi i64 [ %42, %41 ], [ %.010.lcssa, %.preheader12 ]
...
61:                                               ; preds = %39
  ...
  %62 = add nuw nsw i64 256, %.212.lcssa
...
101:                                              ; preds = %96
  ...
  br i1 %102, label %103, label %.preheader11

.preheader11:                                     ; preds = %101
  br label %106
...
106:                                              ; preds = %.preheader11, %151
  %.134 = phi ptr [ %152, %151 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129.lcssa, %151 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125.lcssa, %151 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %153, %151 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1.lcssa, %151 ], [ -1, %.preheader11 ]
...
160:                                              ; preds = %192, %154
  ...
  br i1 %161, label %162, label %.preheader10

.preheader10:                                     ; preds = %160
  br label %194

162:                                              ; preds = %160
  %163 = trunc nuw i64 %.27 to i8
...
192:                                              ; preds = %190, %162
  %193 = add nuw nsw i64 %.27, 1
  br label %160, !llvm.loop !18

194:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %216, %.critedge ], [ 1, %.preheader10 ]
  %195 = icmp ult i64 %.6, 256
  br i1 %195, label %196, label %.preheader9

.preheader9:                                      ; preds = %194
  br label %217
...
.critedge:                                        ; preds = %203, %201
  ...
  %216 = add nuw nsw i64 %.6, 1
  br label %194, !llvm.loop !20

217:                                              ; preds = %.preheader9, %221
  %.49 = phi i64 [ %222, %221 ], [ 0, %.preheader9 ]
