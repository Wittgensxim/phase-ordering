...
33:                                               ; preds = %.preheader7, %35
  %.24 = phi i64 [ %38, %35 ], [ %.010, %.preheader7 ]
  %34 = icmp ugt i64 %.24, 0
  br i1 %34, label %35, label %.preheader6
...
39:                                               ; preds = %.preheader6, %41
  %.212 = phi i64 [ %42, %41 ], [ %.010, %.preheader6 ]
...
105:                                              ; preds = %.preheader5, %149
  %.134 = phi ptr [ %150, %149 ], [ %0, %.preheader5 ]
  %.028 = phi i64 [ %.129, %149 ], [ 0, %.preheader5 ]
  %.024 = phi i8 [ %.125, %149 ], [ 0, %.preheader5 ]
  %.16 = phi i64 [ %151, %149 ], [ 0, %.preheader5 ]
  %.01 = phi i32 [ %.1, %149 ], [ -1, %.preheader5 ]
...
158:                                              ; preds = %188, %152
  ...
  br i1 %159, label %160, label %.preheader4

.preheader4:                                      ; preds = %158
  br label %190
...
190:                                              ; preds = %.preheader4, %.critedge
  %.6 = phi i64 [ %212, %.critedge ], [ 1, %.preheader4 ]
  %191 = icmp ult i64 %.6, 256
  br i1 %191, label %192, label %.preheader3
...
213:                                              ; preds = %.preheader3, %217
  %.49 = phi i64 [ %218, %217 ], [ 0, %.preheader3 ]
