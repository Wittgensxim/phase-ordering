...
103:                                              ; preds = %.preheader3, %147
  ...
  %.028 = phi i64 [ %.129, %147 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125, %147 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %149, %147 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1, %147 ], [ -1, %.preheader3 ]
...
233:                                              ; preds = %227
  %234 = icmp eq i32 %spec.select2, %229
  br i1 %234, label %235, label %240

235:                                              ; preds = %233
  %236 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
