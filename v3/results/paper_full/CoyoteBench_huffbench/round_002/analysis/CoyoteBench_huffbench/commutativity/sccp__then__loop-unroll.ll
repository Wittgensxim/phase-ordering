...
22:                                               ; preds = %40, %.preheader20
  %.010 = phi i64 [ 0, %.preheader20 ], [ %.111.1, %40 ]
  %.13 = phi i64 [ 0, %.preheader20 ], [ %41, %40 ]
...
42:                                               ; preds = %.preheader19, %44
  %.24 = phi i64 [ %47, %44 ], [ %.010.lcssa, %.preheader19 ]
  %43 = icmp ugt i64 %.24, 0
  br i1 %43, label %44, label %.preheader18

.preheader18:                                     ; preds = %42
  br label %48
...
48:                                               ; preds = %.preheader18, %50
  %.212 = phi i64 [ %51, %50 ], [ %.010.lcssa, %.preheader18 ]
...
70:                                               ; preds = %48
  ...
  %71 = add nuw nsw i64 256, %.212.lcssa
...
110:                                              ; preds = %105
  ...
  br i1 %111, label %112, label %.preheader11

.preheader11:                                     ; preds = %110
  br label %115
...
115:                                              ; preds = %.preheader11, %160
  %.134 = phi ptr [ %161, %160 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129.lcssa, %160 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125.lcssa, %160 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %162, %160 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1.lcssa, %160 ], [ -1, %.preheader11 ]
...
169:                                              ; preds = %201, %163
  ...
  br i1 %170, label %171, label %.preheader10

.preheader10:                                     ; preds = %169
  br label %203

171:                                              ; preds = %169
  %172 = trunc nuw i64 %.27 to i8
...
189:                                              ; preds = %185
  ...
  %197 = lshr i64 %.116, 1
  %198 = add nuw nsw i64 %.5, 1
  br label %185, !llvm.loop !17

199:                                              ; preds = %185
  %.019.lcssa = phi i32 [ %.019, %185 ]
...
203:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %225, %.critedge ], [ 1, %.preheader10 ]
  %204 = icmp ult i64 %.6, 256
  br i1 %204, label %205, label %.preheader9

.preheader9:                                      ; preds = %203
  br label %226
...
.critedge:                                        ; preds = %212, %210
  ...
  %225 = add nuw nsw i64 %.6, 1
  br label %203, !llvm.loop !20

226:                                              ; preds = %.preheader9, %230
  %.49 = phi i64 [ %231, %230 ], [ 0, %.preheader9 ]
