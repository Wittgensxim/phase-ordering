...
184:                                              ; preds = %.lr.ph58, %184
  %.556 = phi i64 [ 0, %.lr.ph58 ], [ %191, %184 ]
  %.11655 = phi i64 [ %176, %.lr.ph58 ], [ %190, %184 ]
  %.01954 = phi i32 [ 0, %.lr.ph58 ], [ %spec.select1, %184 ]
  %185 = mul i32 %.01954, 2
  %186 = add i32 %185, 1
  %187 = and i64 %181, %.11655
  %188 = icmp ne i64 %187, 0
  %189 = add i32 %186, 1
  %spec.select1 = select i1 %188, i32 %189, i32 %186
  %190 = lshr i64 %.11655, 1
  %191 = add i64 %.556, 1
  %192 = icmp ult i64 %191, %183
  br i1 %192, label %184, label %._crit_edge59, !llvm.loop !17

._crit_edge59:                                    ; preds = %184
  %split60 = phi i32 [ %spec.select1, %184 ]
  br label %193
