...
34:                                               ; preds = %.preheader5, %36
  %.24 = phi i64 [ %38, %36 ], [ %.010.lcssa, %.preheader5 ]
...
39:                                               ; preds = %.preheader4, %41
  %.212 = phi i64 [ %42, %41 ], [ %.010.lcssa, %.preheader4 ]
...
87:                                               ; preds = %76
  ...
  %92 = icmp ugt i64 %.043.lcssa, %.045
  %spec.select = select i1 %92, i64 %.043.lcssa, i64 %.045
  %93 = icmp ugt i64 %.3.lcssa, %.039
  %.241 = select i1 %93, i64 %.3.lcssa, i64 %.039
  br label %94
...
106:                                              ; preds = %.preheader3, %151
  ...
  %.028 = phi i64 [ %.129.lcssa, %151 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125.lcssa, %151 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %153, %151 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1.lcssa, %151 ], [ -1, %.preheader3 ]
...
151:                                              ; preds = %117
  %.129.lcssa = phi i64 [ %.129, %117 ]
  %.125.lcssa = phi i8 [ %.125, %117 ]
  %.1.lcssa = phi i32 [ %.1, %117 ]
  %152 = getelementptr inbounds nuw i8, ptr %.134, i32 1
  %153 = add i64 %.16, 1
  br label %106, !llvm.loop !16

154:                                              ; preds = %106
  %.028.lcssa = phi i64 [ %.028, %106 ]
  %.024.lcssa = phi i8 [ %.024, %106 ]
  %.01.lcssa = phi i32 [ %.01, %106 ]
  %155 = sub nsw i32 7, %.01.lcssa
  %156 = sext i8 %.024.lcssa to i32
  %157 = shl i32 %156, %155
  %158 = trunc i32 %157 to i8
  %159 = getelementptr inbounds nuw i8, ptr %11, i64 %.028.lcssa
...
190:                                              ; preds = %178
  %.019.lcssa = phi i32 [ %.019, %178 ]
  %191 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.27
  store i32 %.019.lcssa, ptr %191, align 4
  br label %192
...
194:                                              ; preds = %.preheader2, %.critedge
  %.6 = phi i64 [ %216, %.critedge ], [ 1, %.preheader2 ]
  %195 = icmp ult i64 %.6, 256
  br i1 %195, label %196, label %.preheader1

.preheader1:                                      ; preds = %194
  br label %217
...
.critedge:                                        ; preds = %203, %201
  %.38.lcssa = phi i64 [ %.38, %203 ], [ %.38, %201 ]
...
217:                                              ; preds = %.preheader1, %221
  %.49 = phi i64 [ %222, %221 ], [ 0, %.preheader1 ]
  %218 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.49
  %219 = load i32, ptr %218, align 4
  %220 = icmp eq i32 %219, 0
  br i1 %220, label %221, label %.preheader

.preheader:                                       ; preds = %217
  %.49.lcssa = phi i64 [ %.49, %217 ]
  br label %223
...
223:                                              ; preds = %.preheader, %246
  %.235 = phi ptr [ %.336, %246 ], [ %0, %.preheader ]
  %.031 = phi ptr [ %.132, %246 ], [ %11, %.preheader ]
  %.221 = phi i32 [ %.423, %246 ], [ 0, %.preheader ]
  %.217 = phi i64 [ %.318, %246 ], [ 128, %.preheader ]
  %.313 = phi i64 [ %.414, %246 ], [ 0, %.preheader ]
  %.7 = phi i64 [ %.9, %246 ], [ %.49.lcssa, %.preheader ]
...
17:                                               ; preds = %15
  ...
  %30 = add nsw i32 %factor, 1
  %spec.select = select i1 %29, i32 %30, i32 %factor
  br label %31

31:                                               ; preds = %17, %15
  %.0 = phi i32 [ %factor, %15 ], [ %spec.select, %17 ]
...
44:                                               ; preds = %31, %13
  %.01.lcssa = phi i32 [ %.01, %31 ], [ %.01, %13 ]
  %45 = sext i32 %9 to i64
  %46 = sub nsw i32 %.01.lcssa, 1
