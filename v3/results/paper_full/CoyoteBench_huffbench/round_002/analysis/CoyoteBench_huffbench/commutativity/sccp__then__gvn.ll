...
137:                                              ; preds = %._crit_edge, %132
  %.pre-phi = phi i64 [ %.pre10, %._crit_edge ], [ %119, %132 ]
  %138 = phi i8 [ %117, %132 ], [ %.pre9, %._crit_edge ]
