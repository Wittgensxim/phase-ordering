...
21:                                               ; preds = %.preheader14, %29
  %.010 = phi i64 [ %.111, %29 ], [ 0, %.preheader14 ]
  %.13 = phi i64 [ %30, %29 ], [ 0, %.preheader14 ]
...
31:                                               ; preds = %.preheader13, %33
  %.24 = phi i64 [ %36, %33 ], [ %.010.lcssa, %.preheader13 ]
  %32 = icmp ugt i64 %.24, 0
  br i1 %32, label %33, label %.preheader12

.preheader12:                                     ; preds = %31
  br label %37
...
59:                                               ; preds = %37
  ...
  %60 = add nuw nsw i64 256, %.212.lcssa
...
62:                                               ; preds = %91, %59
  ...
  br i1 %exitcond22, label %63, label %93
...
103:                                              ; preds = %.preheader11, %147
  %.134 = phi ptr [ %148, %147 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129.lcssa, %147 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125.lcssa, %147 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %149, %147 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1.lcssa, %147 ], [ -1, %.preheader11 ]
  %exitcond23 = icmp ne i64 %.16, %1
  br i1 %exitcond23, label %104, label %150
...
156:                                              ; preds = %187, %150
  ...
  br i1 %exitcond24, label %157, label %.preheader10
...
189:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %210, %.critedge ], [ 1, %.preheader10 ]
  %exitcond25 = icmp ne i64 %.6, 256
  br i1 %exitcond25, label %190, label %.preheader9
...
211:                                              ; preds = %.preheader9, %215
  %.49 = phi i64 [ %216, %215 ], [ 0, %.preheader9 ]
