...
22:                                               ; preds = %40, %.preheader6
  %.010 = phi i64 [ 0, %.preheader6 ], [ %.111.1, %40 ]
  %.13 = phi i64 [ 0, %.preheader6 ], [ %41, %40 ]
...
42:                                               ; preds = %.preheader5, %44
  %.24 = phi i64 [ %47, %44 ], [ %.010.lcssa, %.preheader5 ]
  %43 = icmp ugt i64 %.24, 0
  br i1 %43, label %44, label %.preheader4
...
48:                                               ; preds = %.preheader4, %50
  %.212 = phi i64 [ %51, %50 ], [ %.010.lcssa, %.preheader4 ]
