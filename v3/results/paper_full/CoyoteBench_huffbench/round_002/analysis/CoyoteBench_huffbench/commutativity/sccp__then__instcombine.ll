...
71:                                               ; preds = %72, %70
  ...
  %.not15 = icmp eq i32 %.037, 0
  br i1 %.not15, label %78, label %72
...
95:                                               ; preds = %135, %90
  %.134 = phi ptr [ %136, %135 ], [ %0, %90 ]
  %.028 = phi i64 [ %.129, %135 ], [ 0, %90 ]
  %.024 = phi i8 [ %.125, %135 ], [ 0, %90 ]
  %.16 = phi i64 [ %137, %135 ], [ 0, %90 ]
  %.01 = phi i32 [ %.1, %135 ], [ -1, %90 ]
...
125:                                              ; preds = %122, %115
  ...
  %131 = and i64 %.015, %130
  %.not13 = icmp ne i64 %131, 0
  %132 = zext i1 %.not13 to i8
...
138:                                              ; preds = %95
  %139 = sub nsw i32 7, %.01
  %140 = zext i8 %.024 to i32
  %141 = shl i32 %140, %139
  %142 = trunc i32 %141 to i8
  %143 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
146:                                              ; preds = %144
  ...
  br i1 %.not11, label %174, label %155
...
159:                                              ; preds = %163, %155
  ...
  %162 = icmp samesign ult i64 %.5, %161
...
163:                                              ; preds = %159
  ...
  %168 = and i64 %.116, %167
  %.not12 = icmp eq i64 %168, 0
  %169 = add i32 %164, 2
  %spec.select1 = select i1 %.not12, i32 %165, i32 %169
  %170 = lshr i64 %.116, 1
  %171 = add nuw nsw i64 %.5, 1
...
176:                                              ; preds = %.critedge, %144
  %.6 = phi i64 [ %197, %.critedge ], [ 1, %144 ]
...
183:                                              ; preds = %189, %178
  ...
  br i1 %.not10, label %.critedge, label %184
...
.critedge:                                        ; preds = %184, %183
  %195 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.38
...
204:                                              ; preds = %226, %198
  %.235 = phi ptr [ %.336, %226 ], [ %0, %198 ]
  %.031 = phi ptr [ %.132, %226 ], [ %11, %198 ]
  %.221 = phi i32 [ %.423, %226 ], [ 0, %198 ]
  %.217 = phi i64 [ %.318, %226 ], [ 128, %198 ]
  %.313 = phi i64 [ %.414, %226 ], [ 0, %198 ]
  %.7 = phi i64 [ %.9, %226 ], [ %.49, %198 ]
...
206:                                              ; preds = %204
  ...
  %211 = and i64 %.217, %210
  %.not9 = icmp eq i64 %211, 0
  %212 = add i32 %207, 2
  %spec.select2 = select i1 %.not9, i32 %208, i32 %212
  br label %213
...
219:                                              ; preds = %213
  %220 = icmp eq i32 %spec.select2, %215
