...
125:                                              ; preds = %122, %115
  ...
  %131 = and i64 %.015, %130
  %.not17 = icmp ne i64 %131, 0
  %132 = zext i1 %.not17 to i8
...
146:                                              ; preds = %144
  ...
  %154 = or i32 %150, %153
  %.not15 = icmp eq i32 %154, 0
  br i1 %.not15, label %174, label %155
...
163:                                              ; preds = %161
  ...
  %168 = and i64 %.116, %167
  %.not16 = icmp eq i64 %168, 0
  %169 = add i32 %164, 2
  %spec.select1 = select i1 %.not16, i32 %165, i32 %169
  %170 = lshr i64 %.116, 1
  %171 = add i64 %.5, 1
...
183:                                              ; preds = %189, %178
  ...
  br i1 %.not14, label %.critedge, label %184
...
206:                                              ; preds = %204
  ...
  %211 = and i64 %.217, %210
  %.not13 = icmp eq i64 %211, 0
  %212 = add i32 %207, 2
  %spec.select2 = select i1 %.not13, i32 %208, i32 %212
  br label %213
