...
94:                                               ; preds = %130, %89
  %.134 = phi ptr [ %131, %130 ], [ %0, %89 ]
  %.028 = phi i64 [ %.129, %130 ], [ 0, %89 ]
  %.024 = phi i8 [ %.125, %130 ], [ 0, %89 ]
  %.16 = phi i64 [ %132, %130 ], [ 0, %89 ]
  %.01 = phi i32 [ %.1, %130 ], [ -1, %89 ]
...
122:                                              ; preds = %._crit_edge, %119
  ...
  %126 = and i64 %.015, %125
  %.not7 = icmp ne i64 %126, 0
  %127 = zext i1 %.not7 to i8
...
141:                                              ; preds = %139
  ...
  %149 = or i32 %145, %148
  %.not5 = icmp eq i32 %149, 0
  br i1 %.not5, label %167, label %150
...
157:                                              ; preds = %154
  ...
  %162 = add i32 %158, 2
  %spec.select1 = select i1 %.not6, i32 %159, i32 %162
  %163 = lshr i64 %.116, 1
  %164 = add i64 %.5, 1
...
176:                                              ; preds = %182, %171
  %.38 = phi i64 [ %.6, %171 ], [ %187, %182 ]
  %.not4 = icmp eq i64 %.38, 0
  br i1 %.not4, label %.critedge, label %177
...
.critedge:                                        ; preds = %177, %176
  ...
  store i8 %175, ptr %189, align 1
  %190 = add nuw nsw i64 %.6, 1
  br label %169, !llvm.loop !20

191:                                              ; preds = %195, %169
  %.49 = phi i64 [ %196, %195 ], [ 0, %169 ]
...
197:                                              ; preds = %219, %191
  %.235 = phi ptr [ %.336, %219 ], [ %0, %191 ]
  %.031 = phi ptr [ %.132, %219 ], [ %11, %191 ]
  %.221 = phi i32 [ %.423, %219 ], [ 0, %191 ]
  %.217 = phi i64 [ %.318, %219 ], [ 128, %191 ]
  %.313 = phi i64 [ %.414, %219 ], [ 0, %191 ]
  %.7 = phi i64 [ %.9, %219 ], [ %.49, %191 ]
...
199:                                              ; preds = %197
  ...
  %204 = and i64 %.217, %203
  %.not3 = icmp eq i64 %204, 0
  %205 = add i32 %200, 2
  %spec.select2 = select i1 %.not3, i32 %201, i32 %205
  br label %206
...
43:                                               ; preds = %split, %._crit_edge
  %.pre-phi = phi i64 [ %29, %split ], [ %.pre, %._crit_edge ]
  %44 = sext i32 %.01 to i64
  %45 = getelementptr [8 x i8], ptr %1, i64 %44
  %46 = getelementptr i8, ptr %45, i64 -8
  store i64 %.pre-phi, ptr %46, align 8
  ret void
}
