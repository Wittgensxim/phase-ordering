...
22:                                               ; preds = %40, %.preheader12
  %.010 = phi i64 [ 0, %.preheader12 ], [ %.111.1, %40 ]
  %.13 = phi i64 [ 0, %.preheader12 ], [ %41, %40 ]
...
42:                                               ; preds = %.preheader11, %44
  %.24 = phi i64 [ %47, %44 ], [ %.010, %.preheader11 ]
  %43 = icmp ugt i64 %.24, 0
  br i1 %43, label %44, label %.preheader10
...
48:                                               ; preds = %.preheader10, %50
  %.212 = phi i64 [ %51, %50 ], [ %.010, %.preheader10 ]
...
96:                                               ; preds = %85
  ...
  %101 = icmp ugt i64 %.043, %.045
  %spec.select = select i1 %101, i64 %.043, i64 %.045
  %102 = icmp ugt i64 %.3, %.039
  %.241 = select i1 %102, i64 %.3, i64 %.039
  br label %103
...
115:                                              ; preds = %.preheader3, %160
  ...
  %.028 = phi i64 [ %.129, %160 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125, %160 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %162, %160 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1, %160 ], [ -1, %.preheader3 ]
...
163:                                              ; preds = %115
  %164 = sub nsw i32 7, %.01
  %165 = sext i8 %.024 to i32
  %166 = shl i32 %165, %164
  %167 = trunc i32 %166 to i8
  %168 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
.critedge:                                        ; preds = %212, %210
  %223 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38
  store i32 %207, ptr %223, align 4
  %224 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38
...
248:                                              ; preds = %242
  %249 = icmp eq i32 %spec.select2, %244
  br i1 %249, label %250, label %255

250:                                              ; preds = %248
  %251 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
