...
178:                                              ; preds = %.preheader10, %.critedge
  %.676 = phi i64 [ 1, %.preheader10 ], [ %196, %.critedge ]
...
.critedge:                                        ; preds = %183, %188
  ...
  %196 = add nuw nsw i64 %.676, 1
  %197 = icmp samesign ult i64 %196, 256
  br i1 %197, label %178, label %.preheader9, !llvm.loop !20

198:                                              ; preds = %198, %.preheader9
  %.49 = phi i64 [ %202, %198 ], [ 0, %.preheader9 ]
  %199 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.49
  %200 = load i32, ptr %199, align 4
  %201 = icmp eq i32 %200, 0
  %202 = add i64 %.49, 1
  br i1 %201, label %198, label %.preheader, !llvm.loop !21

.preheader:                                       ; preds = %198
  %.49.lcssa = phi i64 [ %.49, %198 ]
  %203 = icmp ult i64 0, %1
  br i1 %203, label %.lr.ph83, label %227

.lr.ph83:                                         ; preds = %.preheader
  br label %204

204:                                              ; preds = %.lr.ph83, %223
  %.782 = phi i64 [ %.49.lcssa, %.lr.ph83 ], [ %.9, %223 ]
  %.31381 = phi i64 [ 0, %.lr.ph83 ], [ %.414, %223 ]
  %.21780 = phi i64 [ 128, %.lr.ph83 ], [ %.318, %223 ]
  %.22179 = phi i32 [ 0, %.lr.ph83 ], [ %.423, %223 ]
  %.03178 = phi ptr [ %11, %.lr.ph83 ], [ %.132, %223 ]
  %.23577 = phi ptr [ %0, %.lr.ph83 ], [ %.336, %223 ]
  %205 = shl i32 %.22179, 1
  %206 = or disjoint i32 %205, 1
  %207 = load i8, ptr %.03178, align 1
  %208 = zext i8 %207 to i64
  %209 = and i64 %.21780, %208
...
211:                                              ; preds = %211, %204
  %.8 = phi i64 [ %.782, %204 ], [ %215, %211 ]
  %212 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.8
  %213 = load i32, ptr %212, align 4
  %214 = icmp ult i32 %213, %spec.select2
  %215 = add i64 %.8, 1
  br i1 %214, label %211, label %216, !llvm.loop !22

216:                                              ; preds = %211
  %.8.lcssa = phi i64 [ %.8, %211 ]
  %.lcssa = phi i32 [ %213, %211 ]
  %217 = icmp eq i32 %spec.select2, %.lcssa
  br i1 %217, label %218, label %223

218:                                              ; preds = %216
  %219 = getelementptr inbounds nuw i8, ptr %9, i64 %.8.lcssa
  %220 = load i8, ptr %219, align 1
  store i8 %220, ptr %.23577, align 1
  %221 = getelementptr inbounds nuw i8, ptr %.23577, i64 1
  %222 = add i64 %.31381, 1
  br label %223

223:                                              ; preds = %218, %216
  %.336 = phi ptr [ %221, %218 ], [ %.23577, %216 ]
  %.423 = phi i32 [ 0, %218 ], [ %spec.select2, %216 ]
  %.414 = phi i64 [ %222, %218 ], [ %.31381, %216 ]
  %.9 = phi i64 [ %.49.lcssa, %218 ], [ %.8.lcssa, %216 ]
  %224 = icmp ult i64 %.21780, 2
  %225 = lshr i64 %.21780, 1
  %.132.idx = zext i1 %224 to i64
  %.132 = getelementptr inbounds nuw i8, ptr %.03178, i64 %.132.idx
  %.318 = select i1 %224, i64 128, i64 %225
  %226 = icmp ult i64 %.414, %1
  br i1 %226, label %204, label %._crit_edge84, !llvm.loop !23

._crit_edge84:                                    ; preds = %223
  br label %227

227:                                              ; preds = %._crit_edge84, %.preheader
...
define internal void @heap_adjust(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %9 = sdiv i32 %2, 2
  %.not2 = icmp sgt i32 %3, %9
  br i1 %.not2, label %42, label %.lr.ph

.lr.ph:                                           ; preds = %4
  br label %10

10:                                               ; preds = %.lr.ph, %38
  %.013 = phi i32 [ %3, %.lr.ph ], [ %.0, %38 ]
...
38:                                               ; preds = %27
  ...
  br i1 %.not, label %._crit_edge4, label %10, !llvm.loop !24

._crit_edge:                                      ; preds = %27
  %split = phi i32 [ %.013, %27 ]
  br label %42
...
42:                                               ; preds = %._crit_edge4, %._crit_edge, %4
