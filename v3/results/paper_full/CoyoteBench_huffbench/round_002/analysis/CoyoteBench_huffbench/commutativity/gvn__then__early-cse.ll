...
105:                                              ; preds = %148, %100
  %.134 = phi ptr [ %149, %148 ], [ %0, %100 ]
  %.028 = phi i64 [ %.129, %148 ], [ 0, %100 ]
  %.024 = phi i8 [ %.125, %148 ], [ 0, %100 ]
  %.16 = phi i64 [ %150, %148 ], [ 0, %100 ]
  %.01 = phi i32 [ %.1, %148 ], [ -1, %100 ]
...
151:                                              ; preds = %105
  %152 = sub nsw i32 7, %.01
  %153 = sext i8 %.024 to i32
  %154 = shl i32 %153, %152
  %155 = trunc i32 %154 to i8
  %156 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
173:                                              ; preds = %176, %169
  %.019 = phi i32 [ 0, %169 ], [ %spec.select1, %176 ]
  %.116 = phi i64 [ %172, %169 ], [ %183, %176 ]
  %.5 = phi i64 [ 0, %169 ], [ %184, %176 ]
...
176:                                              ; preds = %173
  ...
  %182 = add i32 %178, 1
  %spec.select1 = select i1 %181, i32 %182, i32 %178
  %183 = lshr i64 %.116, 1
  %184 = add i64 %.5, 1
...
189:                                              ; preds = %.critedge, %157
  %.6 = phi i64 [ %211, %.critedge ], [ 1, %157 ]
...
218:                                              ; preds = %241, %212
  %.235 = phi ptr [ %.336, %241 ], [ %0, %212 ]
  %.031 = phi ptr [ %.132, %241 ], [ %11, %212 ]
  %.221 = phi i32 [ %.423, %241 ], [ 0, %212 ]
  %.217 = phi i64 [ %.318, %241 ], [ 128, %212 ]
  %.313 = phi i64 [ %.414, %241 ], [ 0, %212 ]
  %.7 = phi i64 [ %.9, %241 ], [ %.49, %212 ]
...
234:                                              ; preds = %228
  %235 = icmp eq i32 %spec.select2, %230
  br i1 %235, label %236, label %241

236:                                              ; preds = %234
  %237 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
