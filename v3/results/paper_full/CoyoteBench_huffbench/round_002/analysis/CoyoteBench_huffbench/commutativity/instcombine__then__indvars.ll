...
12:                                               ; preds = %13, %2
  ...
  br i1 %exitcond, label %13, label %.preheader14
...
21:                                               ; preds = %.preheader14, %28
  %.010 = phi i64 [ %.111, %28 ], [ 0, %.preheader14 ]
  %.13 = phi i64 [ %29, %28 ], [ 0, %.preheader14 ]
  %exitcond21 = icmp ne i64 %.13, 256
  br i1 %exitcond21, label %22, label %.preheader13

.preheader13:                                     ; preds = %21
...
30:                                               ; preds = %.preheader13, %31
  %.24 = phi i64 [ %34, %31 ], [ %.010.lcssa, %.preheader13 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader12, label %31
...
35:                                               ; preds = %.preheader12, %37
  %.212 = phi i64 [ %38, %37 ], [ %.010.lcssa, %.preheader12 ]
...
60:                                               ; preds = %80, %57
  ...
  %exitcond22 = icmp ne i64 %.042, 256
  br i1 %exitcond22, label %61, label %82
...
87:                                               ; preds = %82
  ...
  br i1 %88, label %89, label %.preheader11

.preheader11:                                     ; preds = %87
  br label %92
...
92:                                               ; preds = %.preheader11, %131
  %.134 = phi ptr [ %132, %131 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129.lcssa, %131 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125.lcssa, %131 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %133, %131 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1.lcssa, %131 ], [ -1, %.preheader11 ]
  %exitcond23 = icmp ne i64 %.16, %1
  br i1 %exitcond23, label %93, label %134
...
140:                                              ; preds = %169, %134
  ...
  %exitcond24 = icmp ne i64 %.27, 256
  br i1 %exitcond24, label %141, label %.preheader10

.preheader10:                                     ; preds = %140
  br label %171
...
171:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %191, %.critedge ], [ 1, %.preheader10 ]
  %exitcond25 = icmp ne i64 %.6, 256
  br i1 %exitcond25, label %172, label %.preheader9
...
192:                                              ; preds = %.preheader9, %196
  %.49 = phi i64 [ %197, %196 ], [ 0, %.preheader9 ]
