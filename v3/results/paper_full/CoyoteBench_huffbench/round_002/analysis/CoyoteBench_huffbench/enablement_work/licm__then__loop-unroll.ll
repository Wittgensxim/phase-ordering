...
22:                                               ; preds = %41, %.preheader6
  %.010 = phi i64 [ 0, %.preheader6 ], [ %.111.1, %41 ]
  %.13 = phi i64 [ 0, %.preheader6 ], [ %42, %41 ]
...
43:                                               ; preds = %.preheader5, %45
  %.24 = phi i64 [ %47, %45 ], [ %.010.lcssa, %.preheader5 ]
  %44 = icmp ugt i64 %.24, 0
  br i1 %44, label %45, label %.preheader4
