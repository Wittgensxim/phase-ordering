...
.critedge:                                        ; preds = %..critedge_crit_edge67, %..critedge_crit_edge, %198
  %.38.lcssa = phi i64 [ %split66, %..critedge_crit_edge ], [ %split68, %..critedge_crit_edge67 ], [ %.669, %198 ]
...
12:                                               ; preds = %.lr.ph, %39
  %.011 = phi i32 [ %3, %.lr.ph ], [ %.0, %39 ]
  %factor = mul i32 %.011, 2
...
14:                                               ; preds = %12
  ...
  %27 = add nsw i32 %factor, 1
  %spec.select = select i1 %26, i32 %27, i32 %factor
  br label %28

28:                                               ; preds = %14, %12
  %.0 = phi i32 [ %factor, %12 ], [ %spec.select, %14 ]
...
39:                                               ; preds = %28
  ...
  br i1 %43, label %12, label %._crit_edge2, !llvm.loop !24

._crit_edge:                                      ; preds = %28
  %split = phi i32 [ %.011, %28 ]
  br label %44
...
44:                                               ; preds = %._crit_edge2, %._crit_edge, %4
