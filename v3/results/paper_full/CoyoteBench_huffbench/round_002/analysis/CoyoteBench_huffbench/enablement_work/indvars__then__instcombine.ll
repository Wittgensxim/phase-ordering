...
57:                                               ; preds = %35
  %58 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.212
...
92:                                               ; preds = %.preheader3, %131
  ...
  %.028 = phi i64 [ %.129, %131 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125, %131 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %133, %131 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1, %131 ], [ -1, %.preheader3 ]
  %exitcond15.not = icmp eq i64 %.16, %1
  br i1 %exitcond15.not, label %134, label %93
...
121:                                              ; preds = %118, %111
  ...
  %127 = and i64 %.015, %126
  %.not22 = icmp ne i64 %127, 0
  %128 = zext i1 %.not22 to i8
...
134:                                              ; preds = %92
  %135 = sub nsw i32 7, %.01
  %136 = zext i8 %.024 to i32
  %137 = shl i32 %136, %135
  %138 = trunc i32 %137 to i8
  %139 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
140:                                              ; preds = %169, %134
  ...
  %exitcond16.not = icmp eq i64 %.27, 256
  br i1 %exitcond16.not, label %.preheader2, label %141

.preheader2:                                      ; preds = %140
  br label %171

141:                                              ; preds = %140
  %142 = trunc i64 %.27 to i8
  ...
  %149 = or i32 %145, %148
  %.not20 = icmp eq i32 %149, 0
  br i1 %.not20, label %169, label %150
...
158:                                              ; preds = %154
  ...
  %163 = and i64 %.116, %162
  %.not21 = icmp eq i64 %163, 0
  %164 = add i32 %159, 2
  %spec.select1 = select i1 %.not21, i32 %160, i32 %164
  %165 = lshr i64 %.116, 1
...
171:                                              ; preds = %.preheader2, %.critedge
  ...
  %exitcond17.not = icmp eq i64 %.6, 256
  br i1 %exitcond17.not, label %.preheader1, label %172
...
177:                                              ; preds = %183, %172
  ...
  br i1 %.not19, label %.critedge, label %178
...
200:                                              ; preds = %198
  ...
  %205 = and i64 %.217, %204
  %.not18 = icmp eq i64 %205, 0
  %206 = add i32 %201, 2
  %spec.select2 = select i1 %.not18, i32 %202, i32 %206
  br label %207
