...
100:                                              ; preds = %95
  ...
  br i1 %101, label %102, label %.preheader3

.preheader3:                                      ; preds = %100
  br label %105
...
105:                                              ; preds = %.preheader3, %149
  %.134 = phi ptr [ %150, %149 ], [ %0, %.preheader3 ]
  %.028 = phi i64 [ %.129, %149 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125, %149 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %151, %149 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1, %149 ], [ -1, %.preheader3 ]
...
137:                                              ; preds = %._crit_edge, %132
  %.pre-phi = phi i64 [ %.pre14, %._crit_edge ], [ %119, %132 ]
  %138 = phi i8 [ %117, %132 ], [ %.pre13, %._crit_edge ]
...
158:                                              ; preds = %188, %152
  ...
  br i1 %159, label %160, label %.preheader2
...
213:                                              ; preds = %.preheader1, %217
  %.49 = phi i64 [ %218, %217 ], [ 0, %.preheader1 ]
...
219:                                              ; preds = %.preheader, %242
  %.235 = phi ptr [ %.336, %242 ], [ %0, %.preheader ]
  %.031 = phi ptr [ %.132, %242 ], [ %11, %.preheader ]
  %.221 = phi i32 [ %.423, %242 ], [ 0, %.preheader ]
  %.217 = phi i64 [ %.318, %242 ], [ 128, %.preheader ]
  %.313 = phi i64 [ %.414, %242 ], [ 0, %.preheader ]
  %.7 = phi i64 [ %.9, %242 ], [ %.49, %.preheader ]
