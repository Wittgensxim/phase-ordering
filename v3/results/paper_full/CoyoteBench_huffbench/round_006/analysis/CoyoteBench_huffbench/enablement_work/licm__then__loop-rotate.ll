...
21:                                               ; preds = %.preheader6, %27
  %.1312 = phi i64 [ 0, %.preheader6 ], [ %28, %27 ]
  %.01011 = phi i64 [ 0, %.preheader6 ], [ %.111, %27 ]
...
27:                                               ; preds = %24, %21
  ...
  %28 = add nuw nsw i64 %.1312, 1
  %exitcond13.not = icmp eq i64 %28, 256
  br i1 %exitcond13.not, label %.preheader5, label %21, !llvm.loop !10
...
.preheader4:                                      ; preds = %..preheader4_crit_edge, %.preheader5
  ...
  br i1 %29, label %.lr.ph17, label %53

.lr.ph17:                                         ; preds = %.preheader4
  br label %33

30:                                               ; preds = %.lr.ph15, %30
  %.2414 = phi i64 [ %.010.lcssa, %.lr.ph15 ], [ %32, %30 ]
  %31 = trunc i64 %.2414 to i32
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %20, i32 noundef %31)
  %32 = add i64 %.2414, -1
  %.not = icmp eq i64 %32, 0
  br i1 %.not, label %..preheader4_crit_edge, label %30, !llvm.loop !11

33:                                               ; preds = %.lr.ph17, %33
  %.21216 = phi i64 [ %.010.lcssa, %.lr.ph17 ], [ %34, %33 ]
  %34 = add i64 %.21216, -1
...
._crit_edge28:                                    ; preds = %63
  %split29 = phi i64 [ %.144, %63 ]
  %split30 = phi i64 [ %68, %63 ]
  br label %69

69:                                               ; preds = %._crit_edge28, %62
  %.043.lcssa = phi i64 [ %split29, %._crit_edge28 ], [ 0, %62 ]
  %.3.lcssa = phi i64 [ %split30, %._crit_edge28 ], [ 0, %62 ]
...
.preheader3:                                      ; preds = %81
  ...
  br i1 %exitcond15.not46, label %123, label %.lr.ph52
...
._crit_edge42:                                    ; preds = %110
  %split43 = phi i64 [ %.230, %110 ]
  %split44 = phi i8 [ %.327, %110 ]
  %split45 = phi i32 [ %.2, %110 ]
  br label %120

120:                                              ; preds = %._crit_edge42, %86
  %.129.lcssa = phi i64 [ %split43, %._crit_edge42 ], [ %.02848, %86 ]
  %.125.lcssa = phi i8 [ %split44, %._crit_edge42 ], [ %.02449, %86 ]
  %.1.lcssa = phi i32 [ %split45, %._crit_edge42 ], [ %.0151, %86 ]
...
._crit_edge53:                                    ; preds = %120
  %split54 = phi i64 [ %.129.lcssa, %120 ]
  %split55 = phi i8 [ %.125.lcssa, %120 ]
  %split56 = phi i32 [ %.1.lcssa, %120 ]
  br label %123
...
138:                                              ; preds = %129
  ...
  %exitcond16.not57 = icmp eq i64 0, %142
  br i1 %exitcond16.not57, label %151, label %.lr.ph62

.lr.ph62:                                         ; preds = %138
  br label %144

144:                                              ; preds = %.lr.ph62, %144
  %.560 = phi i64 [ 0, %.lr.ph62 ], [ %150, %144 ]
  %.11659 = phi i64 [ %141, %.lr.ph62 ], [ %149, %144 ]
  %.01958 = phi i32 [ 0, %.lr.ph62 ], [ %spec.select1, %144 ]
  %145 = shl i32 %.01958, 1
  %146 = or disjoint i32 %145, 1
  %147 = and i64 %.11659, %143
  %.not4 = icmp eq i64 %147, 0
  %148 = add i32 %145, 2
  %spec.select1 = select i1 %.not4, i32 %146, i32 %148
  %149 = lshr i64 %.11659, 1
  %150 = add nuw nsw i64 %.560, 1
  %exitcond16.not = icmp eq i64 %150, %142
  br i1 %exitcond16.not, label %._crit_edge63, label %144, !llvm.loop !17

._crit_edge63:                                    ; preds = %144
  %split64 = phi i32 [ %spec.select1, %144 ]
  br label %151

151:                                              ; preds = %._crit_edge63, %138
  %.019.lcssa = phi i32 [ %split64, %._crit_edge63 ], [ 0, %138 ]
...
179:                                              ; preds = %.lr.ph75, %198
  %.774 = phi i64 [ %.49.lcssa, %.lr.ph75 ], [ %.9, %198 ]
...
37:                                               ; preds = %28
  ...
  br i1 %.not, label %.._crit_edge_crit_edge, label %13, !llvm.loop !24

split:                                            ; preds = %28
  %.01.lcssa1 = phi i32 [ %.014, %28 ]
  br label %41
