...
define dso_local void @compdecomp(ptr noundef %0, i64 noundef %1) #0 {
  ...
  br i1 %exitcond.not14, label %.preheader6, label %.lr.ph
...
.preheader5:                                      ; preds = %26
  ...
  br i1 %.not20, label %.preheader4, label %.lr.ph22

.lr.ph22:                                         ; preds = %.preheader5
  br label %29

20:                                               ; preds = %.preheader6, %26
  %.1319 = phi i64 [ 0, %.preheader6 ], [ %27, %26 ]
  %.01018 = phi i64 [ 0, %.preheader6 ], [ %.111, %26 ]
...
.preheader4:                                      ; preds = %..preheader4_crit_edge, %.preheader5
  ...
  br i1 %28, label %.lr.ph24, label %53

.lr.ph24:                                         ; preds = %.preheader4
  br label %33

29:                                               ; preds = %.lr.ph22, %29
  %.2421 = phi i64 [ %.010.lcssa, %.lr.ph22 ], [ %32, %29 ]
  %30 = trunc i64 %.010.lcssa to i32
  %31 = trunc i64 %.2421 to i32
...
33:                                               ; preds = %.lr.ph24, %33
  %.21223 = phi i64 [ %.010.lcssa, %.lr.ph24 ], [ %34, %33 ]
  %34 = add i64 %.21223, -1
  ...
  br i1 %52, label %33, label %._crit_edge25, !llvm.loop !12

._crit_edge25:                                    ; preds = %33
  %split = phi i64 [ %34, %33 ]
  br label %53

53:                                               ; preds = %._crit_edge25, %.preheader4
  %.212.lcssa = phi i64 [ %split, %._crit_edge25 ], [ %.010.lcssa, %.preheader4 ]
...
56:                                               ; preds = %53, %74
  %.03940 = phi i64 [ 0, %53 ], [ %.140, %74 ]
  %.04239 = phi i64 [ 0, %53 ], [ %75, %74 ]
  %.04538 = phi i64 [ 0, %53 ], [ %.146, %74 ]
  %57 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04239
  %58 = load i64, ptr %57, align 8
  %.not6 = icmp eq i64 %58, 0
  br i1 %.not6, label %59, label %62

59:                                               ; preds = %56
  %60 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04239
  store i32 0, ptr %60, align 4
  %61 = getelementptr inbounds nuw i8, ptr %7, i64 %.04239
...
62:                                               ; preds = %56
  ...
  br i1 %.not728, label %69, label %.lr.ph34

.lr.ph34:                                         ; preds = %62
  br label %63

63:                                               ; preds = %.lr.ph34, %63
  %.03732 = phi i32 [ %.03727, %.lr.ph34 ], [ %.037, %63 ]
  %.331 = phi i64 [ 0, %.lr.ph34 ], [ %68, %63 ]
  %.0530 = phi i64 [ 1, %.lr.ph34 ], [ %67, %63 ]
  %.04329 = phi i64 [ 0, %.lr.ph34 ], [ %.144, %63 ]
  %64 = icmp slt i32 %.03732, 0
  %65 = select i1 %64, i64 %.0530, i64 0
  %.144 = add i64 %.04329, %65
  ...
  br i1 %.not7, label %._crit_edge35, label %63, !llvm.loop !13

._crit_edge35:                                    ; preds = %63
  %split36 = phi i64 [ %.144, %63 ]
  %split37 = phi i64 [ %68, %63 ]
  br label %69

69:                                               ; preds = %._crit_edge35, %62
  %.043.lcssa = phi i64 [ %split36, %._crit_edge35 ], [ 0, %62 ]
  %.3.lcssa = phi i64 [ %split37, %._crit_edge35 ], [ 0, %62 ]
  %70 = trunc i64 %.043.lcssa to i32
  %71 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04239
  store i32 %70, ptr %71, align 4
  %72 = trunc i64 %.3.lcssa to i8
  %73 = getelementptr inbounds nuw i8, ptr %7, i64 %.04239
...
74:                                               ; preds = %69, %59
  %.146 = phi i64 [ %spec.select, %69 ], [ %.04538, %59 ]
  %.140 = phi i64 [ %.241, %69 ], [ %.03940, %59 ]
  %75 = add nuw nsw i64 %.04239, 1
...
.preheader3:                                      ; preds = %81
  ...
  br i1 %exitcond15.not52, label %123, label %.lr.ph58

.lr.ph58:                                         ; preds = %.preheader3
  br label %86
...
86:                                               ; preds = %.lr.ph58, %120
  %.0157 = phi i32 [ -1, %.lr.ph58 ], [ %.1.lcssa, %120 ]
  %.1656 = phi i64 [ 0, %.lr.ph58 ], [ %122, %120 ]
  %.02455 = phi i8 [ 0, %.lr.ph58 ], [ %.125.lcssa, %120 ]
  %.02854 = phi i64 [ 0, %.lr.ph58 ], [ %.129.lcssa, %120 ]
  %.13453 = phi ptr [ %0, %.lr.ph58 ], [ %121, %120 ]
  %87 = load i8, ptr %.13453, align 1
  ...
  br i1 %96, label %.lr.ph47, label %120

.lr.ph47:                                         ; preds = %86
  br label %97

97:                                               ; preds = %.lr.ph47, %110
  %.145 = phi i32 [ %.0157, %.lr.ph47 ], [ %.2, %110 ]
  %.444 = phi i64 [ 0, %.lr.ph47 ], [ %117, %110 ]
  %.01543 = phi i64 [ %94, %.lr.ph47 ], [ %116, %110 ]
  %.12542 = phi i8 [ %.02455, %.lr.ph47 ], [ %.327, %110 ]
  %.12941 = phi i64 [ %.02854, %.lr.ph47 ], [ %.230, %110 ]
  %98 = phi i8 [ %87, %.lr.ph47 ], [ %.pre-phi.in, %110 ]
  %99 = icmp eq i32 %.145, 7
  br i1 %99, label %100, label %107

100:                                              ; preds = %97
  %101 = getelementptr inbounds nuw i8, ptr %11, i64 %.12941
  store i8 %.12542, ptr %101, align 1
  %102 = add i64 %.12941, 1
...
110:                                              ; preds = %107, %._crit_edge
  ...
  br i1 %119, label %97, label %._crit_edge48, !llvm.loop !15

._crit_edge48:                                    ; preds = %110
  %split49 = phi i64 [ %.230, %110 ]
  %split50 = phi i8 [ %.327, %110 ]
  %split51 = phi i32 [ %.2, %110 ]
  br label %120

120:                                              ; preds = %._crit_edge48, %86
  %.129.lcssa = phi i64 [ %split49, %._crit_edge48 ], [ %.02854, %86 ]
  %.125.lcssa = phi i8 [ %split50, %._crit_edge48 ], [ %.02455, %86 ]
  %.1.lcssa = phi i32 [ %split51, %._crit_edge48 ], [ %.0157, %86 ]
  %121 = getelementptr inbounds nuw i8, ptr %.13453, i64 1
  %122 = add i64 %.1656, 1
  %exitcond15.not = icmp eq i64 %122, %1
  br i1 %exitcond15.not, label %._crit_edge59, label %86, !llvm.loop !16

._crit_edge59:                                    ; preds = %120
  %split60 = phi i64 [ %.129.lcssa, %120 ]
  %split61 = phi i8 [ %.125.lcssa, %120 ]
  %split62 = phi i32 [ %.1.lcssa, %120 ]
  br label %123

123:                                              ; preds = %._crit_edge59, %.preheader3
  %.028.lcssa = phi i64 [ %split60, %._crit_edge59 ], [ 0, %.preheader3 ]
  %.024.lcssa = phi i8 [ %split61, %._crit_edge59 ], [ 0, %.preheader3 ]
  %.01.lcssa = phi i32 [ %split62, %._crit_edge59 ], [ -1, %.preheader3 ]
...
129:                                              ; preds = %123, %153
  %.072 = phi ptr [ %9, %123 ], [ %131, %153 ]
  %.2771 = phi i64 [ 0, %123 ], [ %154, %153 ]
  %130 = trunc nuw i64 %.2771 to i8
  store i8 %130, ptr %.072, align 1
  %131 = getelementptr inbounds nuw i8, ptr %.072, i64 1
  %132 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2771
  %133 = load i32, ptr %132, align 4
  %134 = getelementptr inbounds nuw i8, ptr %7, i64 %.2771
...
138:                                              ; preds = %129
  ...
  %exitcond16.not63 = icmp eq i64 0, %142
  br i1 %exitcond16.not63, label %151, label %.lr.ph68

.lr.ph68:                                         ; preds = %138
  br label %143

143:                                              ; preds = %.lr.ph68, %143
  %.566 = phi i64 [ 0, %.lr.ph68 ], [ %150, %143 ]
  %.11665 = phi i64 [ %141, %.lr.ph68 ], [ %149, %143 ]
  %.01964 = phi i32 [ 0, %.lr.ph68 ], [ %spec.select1, %143 ]
  %144 = shl i32 %.01964, 1
  %145 = or disjoint i32 %144, 1
  %146 = zext i32 %133 to i64
  %147 = and i64 %.11665, %146
  %.not4 = icmp eq i64 %147, 0
  %148 = add i32 %144, 2
  %spec.select1 = select i1 %.not4, i32 %145, i32 %148
  %149 = lshr i64 %.11665, 1
  %150 = add nuw nsw i64 %.566, 1
  %exitcond16.not = icmp eq i64 %150, %142
  br i1 %exitcond16.not, label %._crit_edge69, label %143, !llvm.loop !17

._crit_edge69:                                    ; preds = %143
  %split70 = phi i32 [ %spec.select1, %143 ]
  br label %151

151:                                              ; preds = %._crit_edge69, %138
  %.019.lcssa = phi i32 [ %split70, %._crit_edge69 ], [ 0, %138 ]
  %152 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2771
  store i32 %.019.lcssa, ptr %152, align 4
  br label %153

153:                                              ; preds = %151, %129
  %154 = add nuw nsw i64 %.2771, 1
  %exitcond17.not = icmp eq i64 %154, 256
  br i1 %exitcond17.not, label %.preheader2, label %129, !llvm.loop !18

.preheader1:                                      ; preds = %.critedge
  br label %173

155:                                              ; preds = %.preheader2, %.critedge
  %.674 = phi i64 [ 1, %.preheader2 ], [ %172, %.critedge ]
  %156 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.674
  %157 = load i32, ptr %156, align 4
  %158 = getelementptr inbounds nuw i8, ptr %9, i64 %.674
  %159 = load i8, ptr %158, align 1
  br label %160

160:                                              ; preds = %155, %165
  %.3873 = phi i64 [ %.674, %155 ], [ %161, %165 ]
  %161 = add nsw i64 %.3873, -1
...
.critedge:                                        ; preds = %160, %165
  ...
  %172 = add nuw nsw i64 %.674, 1
  %exitcond18.not = icmp eq i64 %172, 256
  br i1 %exitcond18.not, label %.preheader1, label %155, !llvm.loop !20
...
.preheader:                                       ; preds = %173
  ...
  br i1 %178, label %.lr.ph81, label %202

.lr.ph81:                                         ; preds = %.preheader
  br label %179

179:                                              ; preds = %.lr.ph81, %198
  %.780 = phi i64 [ %.49.lcssa, %.lr.ph81 ], [ %.9, %198 ]
  %.31379 = phi i64 [ 0, %.lr.ph81 ], [ %.414, %198 ]
  %.21778 = phi i64 [ 128, %.lr.ph81 ], [ %.318, %198 ]
  %.22177 = phi i32 [ 0, %.lr.ph81 ], [ %.423, %198 ]
  %.03176 = phi ptr [ %11, %.lr.ph81 ], [ %.132, %198 ]
  %.23575 = phi ptr [ %0, %.lr.ph81 ], [ %.336, %198 ]
  %180 = shl i32 %.22177, 1
  %181 = or disjoint i32 %180, 1
  %182 = load i8, ptr %.03176, align 1
  %183 = zext i8 %182 to i64
  %184 = and i64 %.21778, %183
...
193:                                              ; preds = %191
  ...
  store i8 %195, ptr %.23575, align 1
  %196 = getelementptr inbounds nuw i8, ptr %.23575, i64 1
  %197 = add nuw i64 %.31379, 1
  br label %198

198:                                              ; preds = %193, %191
  %.336 = phi ptr [ %196, %193 ], [ %.23575, %191 ]
  %.423 = phi i32 [ 0, %193 ], [ %spec.select2, %191 ]
  %.414 = phi i64 [ %197, %193 ], [ %.31379, %191 ]
  %.9 = phi i64 [ %.49.lcssa, %193 ], [ %.8.lcssa, %191 ]
  %199 = icmp ult i64 %.21778, 2
  %200 = lshr i64 %.21778, 1
  %.132.idx = zext i1 %199 to i64
  %.132 = getelementptr inbounds nuw i8, ptr %.03176, i64 %.132.idx
  %.318 = select i1 %199, i64 128, i64 %200
  %201 = icmp ult i64 %.414, %1
  br i1 %201, label %179, label %._crit_edge82, !llvm.loop !23

._crit_edge82:                                    ; preds = %198
  br label %202

202:                                              ; preds = %._crit_edge82, %.preheader
