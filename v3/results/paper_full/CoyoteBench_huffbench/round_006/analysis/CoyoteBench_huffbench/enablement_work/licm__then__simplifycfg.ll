...
30:                                               ; preds = %31, %.preheader5
  %.24 = phi i64 [ %33, %31 ], [ %.010.lcssa, %.preheader5 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4, label %31

31:                                               ; preds = %30
  %32 = trunc i64 %.24 to i32
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %21, i32 noundef %32)
  %33 = add i64 %.24, -1
  br label %30, !llvm.loop !11

.preheader4:                                      ; preds = %30, %35
  %.212 = phi i64 [ %36, %35 ], [ %.010.lcssa, %30 ]
...
57:                                               ; preds = %76, %54
  ...
  br i1 %exitcond14.not, label %78, label %58
...
.preheader3:                                      ; preds = %83, %122
  ...
  br i1 %exitcond15.not, label %125, label %88
...
131:                                              ; preds = %157, %125
  ...
  br i1 %exitcond17.not, label %.preheader2, label %132
...
147:                                              ; preds = %148, %141
  %.019 = phi i32 [ 0, %141 ], [ %spec.select1, %148 ]
  %.116 = phi i64 [ %144, %141 ], [ %153, %148 ]
  %.5 = phi i64 [ 0, %141 ], [ %154, %148 ]
  %exitcond16.not = icmp eq i64 %.5, %145
  br i1 %exitcond16.not, label %155, label %148
...
148:                                              ; preds = %147
  ...
  %152 = add i32 %149, 2
  %spec.select1 = select i1 %.not4, i32 %150, i32 %152
  %153 = lshr i64 %.116, 1
  %154 = add nuw nsw i64 %.5, 1
  br label %147, !llvm.loop !17

155:                                              ; preds = %147
  %.019.lcssa = phi i32 [ %.019, %147 ]
...
.preheader2:                                      ; preds = %131, %.critedge
  ...
  br i1 %exitcond18.not, label %.preheader1, label %159
