...
29:                                               ; preds = %.lr.ph15, %29
  %.2414 = phi i64 [ %.010.lcssa, %.lr.ph15 ], [ %32, %29 ]
...
53:                                               ; preds = %._crit_edge18, %.preheader4
  %.212.lcssa = phi i64 [ 1, %._crit_edge18 ], [ %.010.lcssa, %.preheader4 ]
...
143:                                              ; preds = %.lr.ph62, %143
  ...
  br i1 %exitcond16.not, label %._crit_edge63, label %143, !llvm.loop !17

._crit_edge63:                                    ; preds = %143
  %split64 = phi i32 [ %spec.select1, %143 ]
  br label %151
