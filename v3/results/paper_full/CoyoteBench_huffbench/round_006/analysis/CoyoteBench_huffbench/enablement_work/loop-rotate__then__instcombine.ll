...
.preheader3:                                      ; preds = %81
  %exitcond15.not46 = icmp eq i64 %1, 0
  br i1 %exitcond15.not46, label %125, label %.lr.ph52
...
137:                                              ; preds = %128
  ...
  %exitcond16.not57 = icmp eq i8 %134, 0
  br i1 %exitcond16.not57, label %150, label %.lr.ph62
