...
21:                                               ; preds = %37, %.preheader6
  %.010 = phi i64 [ 0, %.preheader6 ], [ %.111.1, %37 ]
  %.13 = phi i64 [ 0, %.preheader6 ], [ %38, %37 ]
  %exitcond13.not = icmp eq i64 %.13, 256
  br i1 %exitcond13.not, label %.preheader5, label %23
...
39:                                               ; preds = %40, %.preheader5
  %.24 = phi i64 [ %42, %40 ], [ %.010.lcssa, %.preheader5 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4, label %40
...
40:                                               ; preds = %39
  ...
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %22, i32 noundef %41)
  %42 = add i64 %.24, -1
  br label %39, !llvm.loop !11

43:                                               ; preds = %45, %.preheader4
...
45:                                               ; preds = %43
  ...
  %62 = sub i32 -255, %61
  %63 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %51
...
67:                                               ; preds = %87, %64
  ...
  br i1 %exitcond14.not, label %89, label %68
...
99:                                               ; preds = %134, %.preheader3
  %.134 = phi ptr [ %135, %134 ], [ %0, %.preheader3 ]
  %.028 = phi i64 [ %.129.lcssa, %134 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125.lcssa, %134 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %136, %134 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1.lcssa, %134 ], [ -1, %.preheader3 ]
  %exitcond15.not = icmp eq i64 %.16, %1
  br i1 %exitcond15.not, label %137, label %100
...
109:                                              ; preds = %126, %100
  %110 = phi i8 [ %101, %100 ], [ %.pre-phi.in, %126 ]
  %111 = phi i8 [ %104, %100 ], [ %.pre, %126 ]
  %.129 = phi i64 [ %.028, %100 ], [ %.230, %126 ]
  %.125 = phi i8 [ %.024, %100 ], [ %.327, %126 ]
  %.015 = phi i64 [ %108, %100 ], [ %132, %126 ]
  %.4 = phi i64 [ 0, %100 ], [ %133, %126 ]
  %.1 = phi i32 [ %.01, %100 ], [ %.2, %126 ]
  %112 = zext i8 %111 to i64
  %113 = icmp samesign ult i64 %.4, %112
...
116:                                              ; preds = %114
  %117 = getelementptr inbounds nuw i8, ptr %11, i64 %.129
...
120:                                              ; preds = %116
  %121 = call ptr @__acrt_iob_func(i32 noundef 2) #10
  %122 = call i64 @fwrite(ptr nonnull @.str.3, i64 22, i64 1, ptr %121)
  call void @exit(i32 noundef 1) #11
  unreachable
...
126:                                              ; preds = %123, %._crit_edge
  %.pre-phi.in = phi i8 [ %.pre1, %._crit_edge ], [ %110, %123 ]
  %.230 = phi i64 [ %118, %._crit_edge ], [ %.129, %123 ]
  %.226 = phi i8 [ 0, %._crit_edge ], [ %125, %123 ]
  %.2 = phi i32 [ 0, %._crit_edge ], [ %124, %123 ]
  %.pre-phi = zext i8 %.pre-phi.in to i64
  %127 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.pre-phi
...
137:                                              ; preds = %99
  %.028.lcssa = phi i64 [ %.028, %99 ]
  %.024.lcssa = phi i8 [ %.024, %99 ]
  %.01.lcssa = phi i32 [ %.01, %99 ]
...
143:                                              ; preds = %169, %137
  %.27 = phi i64 [ 0, %137 ], [ %170, %169 ]
  %.0 = phi ptr [ %9, %137 ], [ %146, %169 ]
  %exitcond17.not = icmp eq i64 %.27, 256
  br i1 %exitcond17.not, label %.preheader2, label %144

.preheader2:                                      ; preds = %143
  br label %171
...
144:                                              ; preds = %143
  ...
  br i1 %.not3, label %169, label %153
...
159:                                              ; preds = %160, %153
  ...
  %.116 = phi i64 [ %156, %153 ], [ %165, %160 ]
  %.5 = phi i64 [ 0, %153 ], [ %166, %160 ]
  %exitcond16.not = icmp eq i64 %.5, %157
  br i1 %exitcond16.not, label %167, label %160
...
160:                                              ; preds = %159
  ...
  %164 = add i32 %161, 2
  %spec.select1 = select i1 %.not4, i32 %162, i32 %164
  %165 = lshr i64 %.116, 1
  %166 = add nuw nsw i64 %.5, 1
  br label %159, !llvm.loop !17

167:                                              ; preds = %159
  %.019.lcssa = phi i32 [ %.019, %159 ]
...
171:                                              ; preds = %.critedge, %.preheader2
  %.6 = phi i64 [ %190, %.critedge ], [ 1, %.preheader2 ]
  %exitcond18.not = icmp eq i64 %.6, 256
  br i1 %exitcond18.not, label %.preheader1, label %172
...
17:                                               ; preds = %14
  ...
  %spec.select = or disjoint i32 %15, %28
  br label %29
