...
38:                                               ; preds = %39, %.preheader5
  %.24 = phi i64 [ %42, %39 ], [ %.010, %.preheader5 ]
...
43:                                               ; preds = %45, %.preheader4
  %.212 = phi i64 [ %46, %45 ], [ %.010, %.preheader4 ]
...
64:                                               ; preds = %43
  %65 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.212
...
99:                                               ; preds = %134, %.preheader3
  ...
  %.028 = phi i64 [ %.129, %134 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125, %134 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %136, %134 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1, %134 ], [ -1, %.preheader3 ]
...
158:                                              ; preds = %159, %153
  %.019 = phi i32 [ 0, %153 ], [ %spec.select1, %159 ]
  %.116 = phi i64 [ %156, %153 ], [ %165, %159 ]
  %.5 = phi i64 [ 0, %153 ], [ %166, %159 ]
  %exitcond16.not = icmp eq i64 %.5, %157
  br i1 %exitcond16.not, label %167, label %159
...
212:                                              ; preds = %206
  %213 = icmp eq i32 %spec.select2, %208
...
42:                                               ; preds = %split, %._crit_edge
  %.012 = phi i32 [ %.01, %split ], [ %.01, %._crit_edge ]
...
11:                                               ; preds = %.loopexit, %2
  %.not1 = phi i1 [ true, %2 ], [ %exitcond.not, %.loopexit ]
