...
.preheader6:                                      ; preds = %.preheader6.preheader, %28
  %.010 = phi i64 [ %.111, %28 ], [ 0, %.preheader6.preheader ]
  %.13 = phi i64 [ %29, %28 ], [ 0, %.preheader6.preheader ]
  %exitcond13.not = icmp eq i64 %.13, 256
  br i1 %exitcond13.not, label %.preheader5.preheader, label %22

.preheader5.preheader:                            ; preds = %.preheader6
  %21 = trunc i64 %.010 to i32
  br label %.preheader5
...
.preheader5:                                      ; preds = %.preheader5.preheader, %30
  %.24 = phi i64 [ %32, %30 ], [ %.010, %.preheader5.preheader ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4.preheader, label %30
...
30:                                               ; preds = %.preheader5
  ...
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %21, i32 noundef %31)
  %32 = add i64 %.24, -1
  br label %.preheader5, !llvm.loop !11

.preheader4:                                      ; preds = %.preheader4.preheader, %34
  %.212 = phi i64 [ %35, %34 ], [ %.010, %.preheader4.preheader ]
...
.preheader7:                                      ; preds = %.preheader7.preheader, %63
...
.preheader3:                                      ; preds = %.preheader3.preheader, %120
  %.134 = phi ptr [ %121, %120 ], [ %0, %.preheader3.preheader ]
  %.028 = phi i64 [ %.129, %120 ], [ 0, %.preheader3.preheader ]
  %.024 = phi i8 [ %.125, %120 ], [ 0, %.preheader3.preheader ]
  %.16 = phi i64 [ %122, %120 ], [ 0, %.preheader3.preheader ]
  %.01 = phi i32 [ %.1, %120 ], [ -1, %.preheader3.preheader ]
...
145:                                              ; preds = %146, %139
  %.019 = phi i32 [ 0, %139 ], [ %spec.select1, %146 ]
  %.116 = phi i64 [ %142, %139 ], [ %151, %146 ]
  %.5 = phi i64 [ 0, %139 ], [ %152, %146 ]
  %exitcond16.not = icmp eq i64 %.5, %143
  br i1 %exitcond16.not, label %153, label %146
...
146:                                              ; preds = %145
  ...
  %150 = add i32 %147, 2
  %spec.select1 = select i1 %.not4, i32 %148, i32 %150
  %151 = lshr i64 %.116, 1
...
.preheader1:                                      ; preds = %.preheader1.preheader, %179
...
.preheader:                                       ; preds = %.preheader.preheader, %202
  ...
  %.7 = phi i64 [ %.9, %202 ], [ %.49, %.preheader.preheader ]
...
.loopexit.loopexit:                               ; preds = %5, %6
  %exitcond.not.lcssa = phi i1 [ %exitcond.not, %5 ], [ false, %6 ]
  br label %.loopexit
