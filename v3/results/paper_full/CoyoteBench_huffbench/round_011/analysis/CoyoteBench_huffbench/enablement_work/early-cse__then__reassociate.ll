...
.preheader5:                                      ; preds = %29, %.preheader6
  %.24 = phi i64 [ %32, %29 ], [ %.010, %.preheader6 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4, label %29

29:                                               ; preds = %.preheader5
  %30 = trunc i64 %.010 to i32
...
.preheader4:                                      ; preds = %34, %.preheader5
  %.212 = phi i64 [ %35, %34 ], [ %.010, %.preheader5 ]
...
53:                                               ; preds = %.preheader4
  %54 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.212
...
.preheader7:                                      ; preds = %63, %57
  %.043 = phi i64 [ %.144, %63 ], [ 0, %57 ]
  %.042.pn = phi i64 [ %66, %63 ], [ %.042, %57 ]
  %.05 = phi i64 [ %67, %63 ], [ 1, %57 ]
  %.3 = phi i64 [ %68, %63 ], [ 0, %57 ]
...
.preheader3:                                      ; preds = %120, %81
  %.134 = phi ptr [ %121, %120 ], [ %0, %81 ]
  %.028 = phi i64 [ %.129, %120 ], [ 0, %81 ]
  %.024 = phi i8 [ %.125, %120 ], [ 0, %81 ]
  %.16 = phi i64 [ %122, %120 ], [ 0, %81 ]
  %.01 = phi i32 [ %.1, %120 ], [ -1, %81 ]
...
123:                                              ; preds = %.preheader3
  %124 = sub nsw i32 7, %.01
  %125 = zext i8 %.024 to i32
  %126 = shl i32 %125, %124
  %127 = trunc i32 %126 to i8
  %128 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
129:                                              ; preds = %155, %123
  ...
  br i1 %exitcond17.not, label %.preheader2, label %130
...
.preheader2:                                      ; preds = %.critedge, %129
  %.6 = phi i64 [ %175, %.critedge ], [ 1, %129 ]
  %exitcond18.not = icmp eq i64 %.6, 256
  br i1 %exitcond18.not, label %.preheader1, label %157
...
.preheader1:                                      ; preds = %179, %.preheader2
  %.49 = phi i64 [ %180, %179 ], [ 0, %.preheader2 ]
...
.preheader:                                       ; preds = %202, %.preheader1
  %.235 = phi ptr [ %.336, %202 ], [ %0, %.preheader1 ]
  %.031 = phi ptr [ %.132, %202 ], [ %11, %.preheader1 ]
  %.221 = phi i32 [ %.423, %202 ], [ 0, %.preheader1 ]
  %.217 = phi i64 [ %.318, %202 ], [ 128, %.preheader1 ]
  %.313 = phi i64 [ %.414, %202 ], [ 0, %.preheader1 ]
  %.7 = phi i64 [ %.9, %202 ], [ %.49, %.preheader1 ]
...
195:                                              ; preds = %189
  %196 = icmp eq i32 %spec.select2, %191
...
.loopexit:                                        ; preds = %6, %5, %2
  %.not1 = phi i1 [ true, %2 ], [ false, %6 ], [ %exitcond.not, %5 ]
