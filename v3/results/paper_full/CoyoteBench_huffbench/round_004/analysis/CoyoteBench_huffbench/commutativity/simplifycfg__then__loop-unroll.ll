...
71:                                               ; preds = %69
  ...
  br i1 %.not6, label %74, label %.preheader10

.preheader10:                                     ; preds = %71
  br label %77
...
77:                                               ; preds = %.preheader10, %78
  %.043 = phi i64 [ %.144, %78 ], [ 0, %.preheader10 ]
  %.042.pn = phi i64 [ %81, %78 ], [ %.042, %.preheader10 ]
  %.05 = phi i64 [ %82, %78 ], [ 1, %.preheader10 ]
  %.3 = phi i64 [ %83, %78 ], [ 0, %.preheader10 ]
...
89:                                               ; preds = %84, %74
  %.146 = phi i64 [ %spec.select, %84 ], [ %.045, %74 ]
  %.140 = phi i64 [ %.241, %84 ], [ %.039, %74 ]
...
101:                                              ; preds = %.preheader3, %137
  ...
  %.028 = phi i64 [ %.129.lcssa, %137 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125.lcssa, %137 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %139, %137 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1.lcssa, %137 ], [ -1, %.preheader3 ]
...
140:                                              ; preds = %101
  ...
  %141 = sub nsw i32 7, %.01.lcssa
  %142 = zext i8 %.024.lcssa to i32
  %143 = shl i32 %142, %141
...
203:                                              ; preds = %.preheader, %225
  ...
  %.7 = phi i64 [ %.9, %225 ], [ %.49.lcssa, %.preheader ]
...
218:                                              ; preds = %212
  %.8.lcssa = phi i64 [ %.8, %212 ]
  %.lcssa = phi i32 [ %214, %212 ]
  %219 = icmp eq i32 %spec.select2, %.lcssa
  br i1 %219, label %220, label %225

220:                                              ; preds = %218
  %221 = getelementptr inbounds nuw i8, ptr %9, i64 %.8.lcssa
...
225:                                              ; preds = %220, %218
  ...
  %.9 = phi i64 [ %.49.lcssa, %220 ], [ %.8.lcssa, %218 ]
