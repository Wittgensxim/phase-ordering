...
59:                                               ; preds = %79, %56
  ...
  br i1 %exitcond22, label %60, label %81
...
86:                                               ; preds = %81
  ...
  br i1 %87, label %88, label %.preheader11
...
91:                                               ; preds = %.preheader11, %126
  %.134 = phi ptr [ %127, %126 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129.lcssa, %126 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125.lcssa, %126 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %128, %126 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1.lcssa, %126 ], [ -1, %.preheader11 ]
  %exitcond23 = icmp ne i64 %.16, %1
  br i1 %exitcond23, label %92, label %129
...
135:                                              ; preds = %161, %129
  ...
  %exitcond25 = icmp ne i64 %.27, 256
  br i1 %exitcond25, label %136, label %.preheader10

.preheader10:                                     ; preds = %135
  br label %163
...
150:                                              ; preds = %151, %145
  ...
  %exitcond24 = icmp ne i64 %.5, %149
  br i1 %exitcond24, label %151, label %159
...
163:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %182, %.critedge ], [ 1, %.preheader10 ]
  %exitcond26 = icmp ne i64 %.6, 256
  br i1 %exitcond26, label %164, label %.preheader9

.preheader9:                                      ; preds = %163
  br label %183
...
183:                                              ; preds = %.preheader9, %187
  %.49 = phi i64 [ %188, %187 ], [ 0, %.preheader9 ]
