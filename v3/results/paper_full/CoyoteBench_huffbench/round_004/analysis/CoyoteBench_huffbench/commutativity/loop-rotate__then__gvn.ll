...
22:                                               ; preds = %.preheader6, %28
  %.1317 = phi i64 [ 0, %.preheader6 ], [ %29, %28 ]
  %.01016 = phi i64 [ 0, %.preheader6 ], [ %.111, %28 ]
...
.preheader4:                                      ; preds = %..preheader4_crit_edge, %.preheader5
  ...
  br i1 %31, label %.lr.ph22, label %56

.lr.ph22:                                         ; preds = %.preheader4
  br label %36

32:                                               ; preds = %.lr.ph20, %32
  %.2419 = phi i64 [ %.111, %.lr.ph20 ], [ %35, %32 ]
...
36:                                               ; preds = %.lr.ph22, %36
  %.21221 = phi i64 [ %.111, %.lr.ph22 ], [ %37, %36 ]
  %37 = add i64 %.21221, -1
...
56:                                               ; preds = %._crit_edge23, %.preheader4
  %.212.lcssa = phi i64 [ %37, %._crit_edge23 ], [ %.111, %.preheader4 ]
...
72:                                               ; preds = %._crit_edge33, %65
  %.043.lcssa = phi i64 [ %.144, %._crit_edge33 ], [ 0, %65 ]
  %.3.lcssa = phi i64 [ %71, %._crit_edge33 ], [ 0, %65 ]
...
.preheader3:                                      ; preds = %85
  br i1 %12, label %.lr.ph55, label %128
...
124:                                              ; preds = %._crit_edge46, %90
  %.129.lcssa = phi i64 [ %.230, %._crit_edge46 ], [ %.02851, %90 ]
  %.125.lcssa = phi i8 [ %.327, %._crit_edge46 ], [ %.02452, %90 ]
  %.1.lcssa = phi i32 [ %.2, %._crit_edge46 ], [ %.0154, %90 ]
...
128:                                              ; preds = %._crit_edge56, %.preheader3
  ...
  %.024.lcssa = phi i8 [ %.125.lcssa, %._crit_edge56 ], [ 0, %.preheader3 ]
  %.01.lcssa = phi i32 [ %.1.lcssa, %._crit_edge56 ], [ -1, %.preheader3 ]
...
158:                                              ; preds = %._crit_edge65, %143
  %.019.lcssa = phi i32 [ %spec.select1, %._crit_edge65 ], [ 0, %143 ]
...
.critedge:                                        ; preds = %168, %173
  %.38.lcssa = phi i64 [ %.3869, %168 ], [ 0, %173 ]
...
.preheader:                                       ; preds = %182
  br i1 %12, label %.lr.ph77, label %210

.lr.ph77:                                         ; preds = %.preheader
  br label %187

187:                                              ; preds = %.lr.ph77, %206
  %.776 = phi i64 [ %.49, %.lr.ph77 ], [ %.9, %206 ]
  %.31375 = phi i64 [ 0, %.lr.ph77 ], [ %.414, %206 ]
  %.21774 = phi i64 [ 128, %.lr.ph77 ], [ %.318, %206 ]
  %.22173 = phi i32 [ 0, %.lr.ph77 ], [ %.423, %206 ]
  %.03172 = phi ptr [ %11, %.lr.ph77 ], [ %.132, %206 ]
  %.23571 = phi ptr [ %0, %.lr.ph77 ], [ %.336, %206 ]
  %188 = shl i32 %.22173, 1
  %189 = or disjoint i32 %188, 1
  %190 = load i8, ptr %.03172, align 1
  %191 = zext i8 %190 to i64
  %192 = and i64 %.21774, %191
...
199:                                              ; preds = %194
  %200 = icmp eq i32 %spec.select2, %196
  br i1 %200, label %201, label %206

201:                                              ; preds = %199
  %202 = getelementptr inbounds nuw i8, ptr %9, i64 %.8
  %203 = load i8, ptr %202, align 1
  store i8 %203, ptr %.23571, align 1
  %204 = getelementptr inbounds nuw i8, ptr %.23571, i64 1
  %205 = add i64 %.31375, 1
  br label %206

206:                                              ; preds = %201, %199
  %.336 = phi ptr [ %204, %201 ], [ %.23571, %199 ]
  %.423 = phi i32 [ 0, %201 ], [ %spec.select2, %199 ]
  %.414 = phi i64 [ %205, %201 ], [ %.31375, %199 ]
  %.9 = phi i64 [ %.49, %201 ], [ %.8, %199 ]
  %207 = icmp ult i64 %.21774, 2
  %208 = lshr i64 %.21774, 1
  ...
  br i1 %209, label %187, label %._crit_edge78, !llvm.loop !23

._crit_edge78:                                    ; preds = %206
  br label %210

210:                                              ; preds = %._crit_edge78, %.preheader
...
define internal void @heap_adjust(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  br i1 %.not3, label %.._crit_edge_crit_edge7, label %.lr.ph

.._crit_edge_crit_edge7:                          ; preds = %4
  %.pre8 = shl i64 %8, 32
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge7, %.._crit_edge_crit_edge
  %.pre.pre-phi = phi i64 [ %.pre8, %.._crit_edge_crit_edge7 ], [ %sext, %.._crit_edge_crit_edge ]
  %.01.lcssa = phi i32 [ %.0, %.._crit_edge_crit_edge ], [ %3, %.._crit_edge_crit_edge7 ]
  br label %40
...
40:                                               ; preds = %split, %._crit_edge
  ...
  %sext1.pre-phi = phi i64 [ %sext, %split ], [ %.pre.pre-phi, %._crit_edge ]
