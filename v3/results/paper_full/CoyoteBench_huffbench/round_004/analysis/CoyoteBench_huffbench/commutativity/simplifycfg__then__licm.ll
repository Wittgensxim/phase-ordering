...
76:                                               ; preds = %69
  %.043.lcssa = phi i64 [ %.043, %69 ]
  %.3.lcssa = phi i64 [ %.3, %69 ]
...
93:                                               ; preds = %.preheader3, %129
  ...
  %.028 = phi i64 [ %.129.lcssa, %129 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125.lcssa, %129 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %131, %129 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1.lcssa, %129 ], [ -1, %.preheader3 ]
...
132:                                              ; preds = %93
  %.028.lcssa = phi i64 [ %.028, %93 ]
  %.024.lcssa = phi i8 [ %.024, %93 ]
  %.01.lcssa = phi i32 [ %.01, %93 ]
...
155:                                              ; preds = %157, %149
  ...
  %.116 = phi i64 [ %152, %149 ], [ %162, %157 ]
  %.5 = phi i64 [ 0, %149 ], [ %163, %157 ]
  %156 = icmp ult i64 %.5, %153
...
157:                                              ; preds = %155
  ...
  %161 = add i32 %158, 2
  %spec.select1 = select i1 %.not4, i32 %159, i32 %161
  %162 = lshr i64 %.116, 1
  %163 = add i64 %.5, 1
  br label %155, !llvm.loop !17

164:                                              ; preds = %155
  %.019.lcssa = phi i32 [ %.019, %155 ]
  %165 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.27
  store i32 %.019.lcssa, ptr %165, align 4
  br label %166
...
.critedge:                                        ; preds = %176, %175
  %.38.lcssa = phi i64 [ %.38, %176 ], [ %.38, %175 ]
...
195:                                              ; preds = %.preheader, %217
  ...
  %.7 = phi i64 [ %.9, %217 ], [ %.49.lcssa, %.preheader ]
...
210:                                              ; preds = %204
  ...
  %211 = icmp eq i32 %spec.select2, %.lcssa
  br i1 %211, label %212, label %217

212:                                              ; preds = %210
  %213 = getelementptr inbounds nuw i8, ptr %9, i64 %.8.lcssa
...
217:                                              ; preds = %212, %210
  ...
  %.9 = phi i64 [ %.49.lcssa, %212 ], [ %.8.lcssa, %210 ]
