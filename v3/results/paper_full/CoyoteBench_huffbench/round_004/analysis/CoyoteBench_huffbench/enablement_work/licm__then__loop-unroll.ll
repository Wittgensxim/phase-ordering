...
22:                                               ; preds = %39, %.preheader6
  %.010 = phi i64 [ 0, %.preheader6 ], [ %.111.1, %39 ]
  %.13 = phi i64 [ 0, %.preheader6 ], [ %40, %39 ]
...
33:                                               ; preds = %31
  %34 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %32
  %35 = load i64, ptr %34, align 8
  %.not8.1 = icmp eq i64 %35, 0
  br i1 %.not8.1, label %39, label %36

36:                                               ; preds = %33
  %37 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.111
  store i64 %32, ptr %37, align 8
  %38 = add i64 %.111, 1
  br label %39

39:                                               ; preds = %36, %33
  %.111.1 = phi i64 [ %38, %36 ], [ %.111, %33 ]
  %40 = add nuw nsw i64 %.13, 2
  br label %22, !llvm.loop !10

41:                                               ; preds = %.preheader5, %42
  %.24 = phi i64 [ %44, %42 ], [ %.010.lcssa, %.preheader5 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4, label %42
...
42:                                               ; preds = %41
  ...
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %24, i32 noundef %43)
  %44 = add i64 %.24, -1
...
164:                                              ; preds = %166, %158
  ...
  %.116 = phi i64 [ %161, %158 ], [ %171, %166 ]
  %.5 = phi i64 [ 0, %158 ], [ %172, %166 ]
  %165 = icmp ult i64 %.5, %162
...
166:                                              ; preds = %164
  ...
  %170 = add i32 %167, 2
  %spec.select1 = select i1 %.not4, i32 %168, i32 %170
  %171 = lshr i64 %.116, 1
  %172 = add i64 %.5, 1
  br label %164, !llvm.loop !17

173:                                              ; preds = %164
  %.019.lcssa = phi i32 [ %.019, %164 ]
