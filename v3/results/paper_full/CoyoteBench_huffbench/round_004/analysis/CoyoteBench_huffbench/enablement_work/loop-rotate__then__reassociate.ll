...
115:                                              ; preds = %112, %._crit_edge
  ...
  %119 = and i64 %118, %.01541
  %.not5 = icmp ne i64 %119, 0
  %120 = zext i1 %.not5 to i8
  %.327 = or disjoint i8 %120, %.226
...
150:                                              ; preds = %.lr.ph64, %150
  %.562 = phi i64 [ 0, %.lr.ph64 ], [ %157, %150 ]
  %.11661 = phi i64 [ %147, %.lr.ph64 ], [ %156, %150 ]
  %.01960 = phi i32 [ 0, %.lr.ph64 ], [ %spec.select1, %150 ]
  %151 = shl i32 %.01960, 1
  %152 = or disjoint i32 %151, 1
  %153 = zext i32 %139 to i64
  %154 = and i64 %.11661, %153
  ...
  br i1 %158, label %150, label %._crit_edge65, !llvm.loop !17

._crit_edge65:                                    ; preds = %150
  %split66 = phi i32 [ %spec.select1, %150 ]
  br label %159
...
13:                                               ; preds = %10
  ...
  %spec.select = or disjoint i32 %24, %11
  br label %25
