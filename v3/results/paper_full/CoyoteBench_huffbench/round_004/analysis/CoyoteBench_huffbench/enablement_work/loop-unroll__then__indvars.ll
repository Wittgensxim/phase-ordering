...
68:                                               ; preds = %88, %65
  ...
  br i1 %exitcond13, label %69, label %90
...
100:                                              ; preds = %.preheader3, %135
  %.134 = phi ptr [ %136, %135 ], [ %0, %.preheader3 ]
  %.028 = phi i64 [ %.129.lcssa, %135 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125.lcssa, %135 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %137, %135 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1.lcssa, %135 ], [ -1, %.preheader3 ]
  %exitcond14 = icmp ne i64 %.16, %1
  br i1 %exitcond14, label %101, label %138
...
110:                                              ; preds = %127, %101
  %111 = phi i8 [ %102, %101 ], [ %.pre-phi.in, %127 ]
  %112 = phi i8 [ %105, %101 ], [ %.pre, %127 ]
  %.129 = phi i64 [ %.028, %101 ], [ %.230, %127 ]
  %.125 = phi i8 [ %.024, %101 ], [ %.327, %127 ]
  %.015 = phi i64 [ %109, %101 ], [ %133, %127 ]
  %.4 = phi i64 [ 0, %101 ], [ %134, %127 ]
  %.1 = phi i32 [ %.01, %101 ], [ %.2, %127 ]
  %113 = zext i8 %112 to i64
  %114 = icmp samesign ult i64 %.4, %113
...
117:                                              ; preds = %115
  %118 = getelementptr inbounds nuw i8, ptr %11, i64 %.129
...
127:                                              ; preds = %124, %._crit_edge
  %.pre-phi.in = phi i8 [ %.pre1, %._crit_edge ], [ %111, %124 ]
  %.230 = phi i64 [ %119, %._crit_edge ], [ %.129, %124 ]
  %.226 = phi i8 [ 0, %._crit_edge ], [ %126, %124 ]
  %.2 = phi i32 [ 0, %._crit_edge ], [ %125, %124 ]
  %.pre-phi = zext i8 %.pre-phi.in to i64
  %128 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.pre-phi
...
144:                                              ; preds = %170, %138
  %.27 = phi i64 [ 0, %138 ], [ %171, %170 ]
  %.0 = phi ptr [ %9, %138 ], [ %147, %170 ]
  %exitcond16 = icmp ne i64 %.27, 256
  br i1 %exitcond16, label %145, label %.preheader2

.preheader2:                                      ; preds = %144
  br label %172
...
145:                                              ; preds = %144
  ...
  br i1 %.not3, label %170, label %154
...
159:                                              ; preds = %160, %154
  %.019 = phi i32 [ 0, %154 ], [ %spec.select1, %160 ]
  %.116 = phi i64 [ %157, %154 ], [ %166, %160 ]
  %.5 = phi i64 [ 0, %154 ], [ %167, %160 ]
  %exitcond15 = icmp ne i64 %.5, %158
  br i1 %exitcond15, label %160, label %168
...
172:                                              ; preds = %.preheader2, %.critedge
  %.6 = phi i64 [ %191, %.critedge ], [ 1, %.preheader2 ]
  %exitcond17 = icmp ne i64 %.6, 256
  br i1 %exitcond17, label %173, label %.preheader1

.preheader1:                                      ; preds = %172
  br label %192
...
192:                                              ; preds = %.preheader1, %196
  %.49 = phi i64 [ %197, %196 ], [ 0, %.preheader1 ]
...
198:                                              ; preds = %.preheader, %220
  %.235 = phi ptr [ %.336, %220 ], [ %0, %.preheader ]
  %.031 = phi ptr [ %.132, %220 ], [ %11, %.preheader ]
  %.221 = phi i32 [ %.423, %220 ], [ 0, %.preheader ]
  %.217 = phi i64 [ %.318, %220 ], [ 128, %.preheader ]
  %.313 = phi i64 [ %.414, %220 ], [ 0, %.preheader ]
  %.7 = phi i64 [ %.9, %220 ], [ %.49.lcssa, %.preheader ]
...
213:                                              ; preds = %207
  %.8.lcssa = phi i64 [ %.8, %207 ]
  %.lcssa = phi i32 [ %209, %207 ]
...
42:                                               ; preds = %split, %._crit_edge
  ...
  %43 = ashr exact i64 %sext1.pre-phi, 32
