...
97:                                               ; preds = %92
  ...
  br i1 %98, label %99, label %.preheader11
...
102:                                              ; preds = %.preheader11, %138
  %.134 = phi ptr [ %139, %138 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129.lcssa, %138 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125.lcssa, %138 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %140, %138 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1.lcssa, %138 ], [ -1, %.preheader11 ]
...
147:                                              ; preds = %175, %141
  ...
  br i1 %148, label %149, label %.preheader10
...
177:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %197, %.critedge ], [ 1, %.preheader10 ]
  %178 = icmp samesign ult i64 %.6, 256
  br i1 %178, label %179, label %.preheader9

.preheader9:                                      ; preds = %177
  br label %198
