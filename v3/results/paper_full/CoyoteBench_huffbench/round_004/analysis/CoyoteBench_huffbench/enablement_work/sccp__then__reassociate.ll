...
196:                                              ; preds = %218, %190
  %.235 = phi ptr [ %.336, %218 ], [ %0, %190 ]
  %.031 = phi ptr [ %.132, %218 ], [ %11, %190 ]
  %.221 = phi i32 [ %.423, %218 ], [ 0, %190 ]
  %.217 = phi i64 [ %.318, %218 ], [ 128, %190 ]
  %.313 = phi i64 [ %.414, %218 ], [ 0, %190 ]
  %.7 = phi i64 [ %.9, %218 ], [ %.49, %190 ]
