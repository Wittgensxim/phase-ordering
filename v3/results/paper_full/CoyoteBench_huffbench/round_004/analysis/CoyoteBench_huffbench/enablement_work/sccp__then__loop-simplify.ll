...
22:                                               ; preds = %.preheader14, %30
  %.010 = phi i64 [ %.111, %30 ], [ 0, %.preheader14 ]
  %.13 = phi i64 [ %31, %30 ], [ 0, %.preheader14 ]
...
32:                                               ; preds = %.preheader13, %33
  %.24 = phi i64 [ %36, %33 ], [ %.010, %.preheader13 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader12, label %33
...
37:                                               ; preds = %.preheader12, %39
  %.212 = phi i64 [ %40, %39 ], [ %.010, %.preheader12 ]
...
89:                                               ; preds = %84
  ...
  br i1 %90, label %91, label %.preheader11

.preheader11:                                     ; preds = %89
  br label %94
...
94:                                               ; preds = %.preheader11, %130
  %.134 = phi ptr [ %131, %130 ], [ %0, %.preheader11 ]
  %.028 = phi i64 [ %.129, %130 ], [ 0, %.preheader11 ]
  %.024 = phi i8 [ %.125, %130 ], [ 0, %.preheader11 ]
  %.16 = phi i64 [ %132, %130 ], [ 0, %.preheader11 ]
  %.01 = phi i32 [ %.1, %130 ], [ -1, %.preheader11 ]
...
139:                                              ; preds = %167, %133
  ...
  br i1 %140, label %141, label %.preheader10

.preheader10:                                     ; preds = %139
  br label %169
...
154:                                              ; preds = %157, %150
  %.019 = phi i32 [ 0, %150 ], [ %spec.select1, %157 ]
  %.116 = phi i64 [ %153, %150 ], [ %163, %157 ]
  %.5 = phi i64 [ 0, %150 ], [ %164, %157 ]
  %155 = zext i8 %147 to i64
  %156 = icmp ult i64 %.5, %155
...
157:                                              ; preds = %154
  ...
  %162 = add i32 %158, 2
  %spec.select1 = select i1 %.not4, i32 %159, i32 %162
  %163 = lshr i64 %.116, 1
  %164 = add nuw nsw i64 %.5, 1
  br label %154, !llvm.loop !17

165:                                              ; preds = %154
  %166 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.27
  store i32 %.019, ptr %166, align 4
  br label %167
...
169:                                              ; preds = %.preheader10, %.critedge
  %.6 = phi i64 [ %189, %.critedge ], [ 1, %.preheader10 ]
  %170 = icmp samesign ult i64 %.6, 256
  br i1 %170, label %171, label %.preheader9

.preheader9:                                      ; preds = %169
  br label %190
...
.critedge:                                        ; preds = %177, %176
  %187 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.38
...
190:                                              ; preds = %.preheader9, %194
  %.49 = phi i64 [ %195, %194 ], [ 0, %.preheader9 ]
