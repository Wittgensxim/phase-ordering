...
93:                                               ; preds = %129, %88
  %.134 = phi ptr [ %130, %129 ], [ %0, %88 ]
  %.028 = phi i64 [ %.129, %129 ], [ 0, %88 ]
  %.024 = phi i8 [ %.125, %129 ], [ 0, %88 ]
  %.16 = phi i64 [ %131, %129 ], [ 0, %88 ]
  %.01 = phi i32 [ %.1, %129 ], [ -1, %88 ]
...
168:                                              ; preds = %.critedge, %138
  %.6 = phi i64 [ %188, %.critedge ], [ 1, %138 ]
...
195:                                              ; preds = %217, %189
  %.235 = phi ptr [ %.336, %217 ], [ %0, %189 ]
  %.031 = phi ptr [ %.132, %217 ], [ %11, %189 ]
  %.221 = phi i32 [ %.423, %217 ], [ 0, %189 ]
  %.217 = phi i64 [ %.318, %217 ], [ 128, %189 ]
  %.313 = phi i64 [ %.414, %217 ], [ 0, %189 ]
  %.7 = phi i64 [ %.9, %217 ], [ %.49, %189 ]
