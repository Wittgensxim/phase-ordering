...
102:                                              ; preds = %.preheader3, %138
  ...
  %.028 = phi i64 [ %.129, %138 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125, %138 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %140, %138 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1, %138 ], [ -1, %.preheader3 ]
...
141:                                              ; preds = %102
  %142 = sub nsw i32 7, %.01
  %143 = zext i8 %.024 to i32
  %144 = shl i32 %143, %142
  %145 = trunc i32 %144 to i8
  %146 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
