...
124:                                              ; preds = %._crit_edge, %121
  %.pre-phi = phi i64 [ %.pre14, %._crit_edge ], [ %108, %121 ]
  %125 = phi i8 [ %106, %121 ], [ %.pre13, %._crit_edge ]
...
172:                                              ; preds = %.preheader2, %.critedge
  %.6 = phi i64 [ %192, %.critedge ], [ 1, %.preheader2 ]
  %173 = icmp samesign ult i64 %.6, 256
  br i1 %173, label %174, label %.preheader1
...
.critedge:                                        ; preds = %180, %179
  %.38.lcssa = phi i64 [ %.38, %180 ], [ 0, %179 ]
  %190 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.38.lcssa
  store i32 %176, ptr %190, align 4
  %191 = getelementptr inbounds nuw i8, ptr %9, i64 %.38.lcssa
  store i8 %178, ptr %191, align 1
  %192 = add nuw nsw i64 %.6, 1
  br label %172, !llvm.loop !20

193:                                              ; preds = %.preheader1, %197
  %.49 = phi i64 [ %198, %197 ], [ 0, %.preheader1 ]
