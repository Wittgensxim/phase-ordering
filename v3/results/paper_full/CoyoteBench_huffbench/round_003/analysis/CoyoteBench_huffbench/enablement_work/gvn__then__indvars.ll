...
21:                                               ; preds = %.preheader8, %28
  %.010 = phi i64 [ %.111, %28 ], [ 0, %.preheader8 ]
  %.13 = phi i64 [ %29, %28 ], [ 0, %.preheader8 ]
...
30:                                               ; preds = %.preheader7, %31
  %.24 = phi i64 [ %34, %31 ], [ %.010.lcssa, %.preheader7 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader6, label %31
...
35:                                               ; preds = %.preheader6, %37
  %.212 = phi i64 [ %38, %37 ], [ %.010.lcssa, %.preheader6 ]
...
59:                                               ; preds = %79, %56
  ...
  br i1 %exitcond16, label %60, label %81
...
86:                                               ; preds = %81
  ...
  br i1 %87, label %88, label %.preheader5
...
91:                                               ; preds = %.preheader5, %129
  %.134 = phi ptr [ %130, %129 ], [ %0, %.preheader5 ]
  %.028 = phi i64 [ %.129.lcssa, %129 ], [ 0, %.preheader5 ]
  %.024 = phi i8 [ %.125.lcssa, %129 ], [ 0, %.preheader5 ]
  %.16 = phi i64 [ %131, %129 ], [ 0, %.preheader5 ]
  %.01 = phi i32 [ %.1.lcssa, %129 ], [ -1, %.preheader5 ]
  %exitcond17 = icmp ne i64 %.16, %1
  br i1 %exitcond17, label %92, label %132
...
120:                                              ; preds = %._crit_edge, %117
  %.pre-phi = phi i64 [ %.pre2, %._crit_edge ], [ %104, %117 ]
  %121 = phi i8 [ %102, %117 ], [ %.pre1, %._crit_edge ]
...
138:                                              ; preds = %164, %132
  ...
  br i1 %exitcond19, label %139, label %.preheader4

.preheader4:                                      ; preds = %138
  br label %166
...
153:                                              ; preds = %154, %148
  ...
  %exitcond18 = icmp ne i64 %.5, %152
  br i1 %exitcond18, label %154, label %162
...
166:                                              ; preds = %.preheader4, %.critedge
  %.6 = phi i64 [ %185, %.critedge ], [ 1, %.preheader4 ]
  %exitcond20 = icmp ne i64 %.6, 256
  br i1 %exitcond20, label %167, label %.preheader3

.preheader3:                                      ; preds = %166
  br label %186
...
186:                                              ; preds = %.preheader3, %190
  %.49 = phi i64 [ %191, %190 ], [ 0, %.preheader3 ]
...
192:                                              ; preds = %.preheader, %214
  %.235 = phi ptr [ %.336, %214 ], [ %0, %.preheader ]
  %.031 = phi ptr [ %.132, %214 ], [ %11, %.preheader ]
  %.221 = phi i32 [ %.423, %214 ], [ 0, %.preheader ]
  %.217 = phi i64 [ %.318, %214 ], [ 128, %.preheader ]
  %.313 = phi i64 [ %.414, %214 ], [ 0, %.preheader ]
  %.7 = phi i64 [ %.9, %214 ], [ %.49.lcssa, %.preheader ]
  %193 = icmp ult i64 %.313, %1
  br i1 %193, label %194, label %217

194:                                              ; preds = %192
  %195 = shl i32 %.221, 1
  %196 = or disjoint i32 %195, 1
  %197 = load i8, ptr %.031, align 1
...
207:                                              ; preds = %201
  %.8.lcssa = phi i64 [ %.8, %201 ]
  %.lcssa = phi i32 [ %203, %201 ]
...
209:                                              ; preds = %207
  ...
  store i8 %211, ptr %.235, align 1
  %212 = getelementptr inbounds nuw i8, ptr %.235, i64 1
  %213 = add nuw i64 %.313, 1
  br label %214

214:                                              ; preds = %209, %207
  %.336 = phi ptr [ %212, %209 ], [ %.235, %207 ]
  %.423 = phi i32 [ 0, %209 ], [ %spec.select2, %207 ]
  %.414 = phi i64 [ %213, %209 ], [ %.313, %207 ]
  %.9 = phi i64 [ %.49.lcssa, %209 ], [ %.8.lcssa, %207 ]
  %215 = icmp ult i64 %.217, 2
  %216 = lshr i64 %.217, 1
