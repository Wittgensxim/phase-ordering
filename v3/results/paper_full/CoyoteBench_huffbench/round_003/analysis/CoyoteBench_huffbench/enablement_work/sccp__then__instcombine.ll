...
203:                                              ; preds = %225, %197
  %.235 = phi ptr [ %.336, %225 ], [ %0, %197 ]
  %.031 = phi ptr [ %.132, %225 ], [ %11, %197 ]
  %.221 = phi i32 [ %.423, %225 ], [ 0, %197 ]
  %.217 = phi i64 [ %.318, %225 ], [ 128, %197 ]
  %.313 = phi i64 [ %.414, %225 ], [ 0, %197 ]
  %.7 = phi i64 [ %.9, %225 ], [ %.49, %197 ]
