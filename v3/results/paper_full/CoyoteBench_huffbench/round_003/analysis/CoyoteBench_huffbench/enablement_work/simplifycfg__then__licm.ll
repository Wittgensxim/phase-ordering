...
22:                                               ; preds = %.preheader7, %31
  %.010 = phi i64 [ %.111, %31 ], [ 0, %.preheader7 ]
  %.13 = phi i64 [ %32, %31 ], [ 0, %.preheader7 ]
  %23 = icmp samesign ult i64 %.13, 256
  br i1 %23, label %25, label %.preheader6
...
33:                                               ; preds = %.preheader6, %34
  %.24 = phi i64 [ %36, %34 ], [ %.010.lcssa, %.preheader6 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader5, label %34
...
37:                                               ; preds = %.preheader5, %39
  %.212 = phi i64 [ %40, %39 ], [ %.010.lcssa, %.preheader5 ]
...
64:                                               ; preds = %62
  ...
  br i1 %.not6, label %67, label %.preheader4
...
70:                                               ; preds = %.preheader4, %71
  %.043 = phi i64 [ %.144, %71 ], [ 0, %.preheader4 ]
  %.042.pn = phi i64 [ %74, %71 ], [ %.042, %.preheader4 ]
  %.05 = phi i64 [ %75, %71 ], [ 1, %.preheader4 ]
  %.3 = phi i64 [ %76, %71 ], [ 0, %.preheader4 ]
...
143:                                              ; preds = %173, %137
  ...
  br i1 %144, label %145, label %.preheader2
...
175:                                              ; preds = %.preheader2, %.critedge
  %.6 = phi i64 [ %195, %.critedge ], [ 1, %.preheader2 ]
  %176 = icmp samesign ult i64 %.6, 256
  br i1 %176, label %177, label %.preheader1

.preheader1:                                      ; preds = %175
  br label %196
...
.critedge:                                        ; preds = %183, %182
  %.38.lcssa = phi i64 [ %.38, %183 ], [ %.38, %182 ]
...
196:                                              ; preds = %.preheader1, %200
  %.49 = phi i64 [ %201, %200 ], [ 0, %.preheader1 ]
...
202:                                              ; preds = %.preheader, %224
  %.235 = phi ptr [ %.336, %224 ], [ %0, %.preheader ]
  %.031 = phi ptr [ %.132, %224 ], [ %11, %.preheader ]
  %.221 = phi i32 [ %.423, %224 ], [ 0, %.preheader ]
  %.217 = phi i64 [ %.318, %224 ], [ 128, %.preheader ]
  %.313 = phi i64 [ %.414, %224 ], [ 0, %.preheader ]
  %.7 = phi i64 [ %.9, %224 ], [ %.49.lcssa, %.preheader ]
...
217:                                              ; preds = %211
  ...
  %218 = icmp eq i32 %spec.select2, %.lcssa
  br i1 %218, label %219, label %224

219:                                              ; preds = %217
  %220 = getelementptr inbounds nuw i8, ptr %9, i64 %.8.lcssa
...
224:                                              ; preds = %219, %217
  ...
  %.9 = phi i64 [ %.49.lcssa, %219 ], [ %.8.lcssa, %217 ]
