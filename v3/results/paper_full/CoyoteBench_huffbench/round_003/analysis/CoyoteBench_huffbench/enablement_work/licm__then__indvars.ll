...
140:                                              ; preds = %168, %134
  %.27 = phi i64 [ 0, %134 ], [ %169, %168 ]
  %.0 = phi ptr [ %9, %134 ], [ %143, %168 ]
  %exitcond17 = icmp ne i64 %.27, 256
  br i1 %exitcond17, label %141, label %.preheader2
...
141:                                              ; preds = %140
  ...
  br i1 %.not3, label %168, label %150
...
156:                                              ; preds = %157, %150
  ...
  %.116 = phi i64 [ %153, %150 ], [ %164, %157 ]
  %.5 = phi i64 [ 0, %150 ], [ %165, %157 ]
  %exitcond16 = icmp ne i64 %.5, %155
  br i1 %exitcond16, label %157, label %166
