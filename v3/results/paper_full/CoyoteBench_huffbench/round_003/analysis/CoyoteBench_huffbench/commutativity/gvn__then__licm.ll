...
22:                                               ; preds = %.preheader8, %31
  %.010 = phi i64 [ %.111, %31 ], [ 0, %.preheader8 ]
  %.13 = phi i64 [ %32, %31 ], [ 0, %.preheader8 ]
...
33:                                               ; preds = %.preheader7, %34
  %.24 = phi i64 [ %36, %34 ], [ %.010.lcssa, %.preheader7 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader6, label %34
...
94:                                               ; preds = %.preheader5, %132
  %.134 = phi ptr [ %133, %132 ], [ %0, %.preheader5 ]
  %.028 = phi i64 [ %.129.lcssa, %132 ], [ 0, %.preheader5 ]
  %.024 = phi i8 [ %.125.lcssa, %132 ], [ 0, %.preheader5 ]
  %.16 = phi i64 [ %134, %132 ], [ 0, %.preheader5 ]
  %.01 = phi i32 [ %.1.lcssa, %132 ], [ -1, %.preheader5 ]
...
141:                                              ; preds = %169, %135
  ...
  br i1 %142, label %143, label %.preheader4

.preheader4:                                      ; preds = %141
  br label %171
...
158:                                              ; preds = %160, %152
  %.019 = phi i32 [ 0, %152 ], [ %spec.select1, %160 ]
  %.116 = phi i64 [ %155, %152 ], [ %165, %160 ]
  %.5 = phi i64 [ 0, %152 ], [ %166, %160 ]
  %159 = icmp ult i64 %.5, %156
...
171:                                              ; preds = %.preheader4, %.critedge
  %.6 = phi i64 [ %191, %.critedge ], [ 1, %.preheader4 ]
  %172 = icmp samesign ult i64 %.6, 256
  br i1 %172, label %173, label %.preheader3
...
192:                                              ; preds = %.preheader3, %196
  %.49 = phi i64 [ %197, %196 ], [ 0, %.preheader3 ]
