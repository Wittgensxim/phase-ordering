...
.preheader2:                                      ; preds = %173
  br label %176

145:                                              ; preds = %139, %173
  %.067 = phi ptr [ %9, %139 ], [ %147, %173 ]
  %.2766 = phi i64 [ 0, %139 ], [ %174, %173 ]
...
154:                                              ; preds = %145
  ...
  br i1 %160, label %.lr.ph63, label %171

.lr.ph63:                                         ; preds = %154
  br label %161

161:                                              ; preds = %.lr.ph63, %161
  %.561 = phi i64 [ 0, %.lr.ph63 ], [ %169, %161 ]
  %.11660 = phi i64 [ %157, %.lr.ph63 ], [ %168, %161 ]
  %.01959 = phi i32 [ 0, %.lr.ph63 ], [ %spec.select1, %161 ]
  %162 = shl i32 %.01959, 1
  %163 = or disjoint i32 %162, 1
  %164 = load i32, ptr %148, align 4
  %165 = zext i32 %164 to i64
  %166 = and i64 %.11660, %165
  %.not4 = icmp eq i64 %166, 0
  %167 = add i32 %162, 2
  %spec.select1 = select i1 %.not4, i32 %163, i32 %167
  %168 = lshr i64 %.11660, 1
  %169 = add i64 %.561, 1
  %170 = icmp ult i64 %169, %159
  br i1 %170, label %161, label %._crit_edge64, !llvm.loop !17

._crit_edge64:                                    ; preds = %161
  %split65 = phi i32 [ %spec.select1, %161 ]
  br label %171

171:                                              ; preds = %._crit_edge64, %154
  %.019.lcssa = phi i32 [ %split65, %._crit_edge64 ], [ 0, %154 ]
  %172 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2766
  store i32 %.019.lcssa, ptr %172, align 4
  br label %173

173:                                              ; preds = %171, %145
  %174 = add nuw nsw i64 %.2766, 1
  %175 = icmp samesign ult i64 %174, 256
  br i1 %175, label %145, label %.preheader2, !llvm.loop !18

.preheader1:                                      ; preds = %.critedge
  br label %195

176:                                              ; preds = %.preheader2, %.critedge
  %.669 = phi i64 [ 1, %.preheader2 ], [ %193, %.critedge ]
  %177 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.669
  %178 = load i32, ptr %177, align 4
  %179 = getelementptr inbounds nuw i8, ptr %9, i64 %.669
  %180 = load i8, ptr %179, align 1
  br label %181

181:                                              ; preds = %176, %186
  %.3868 = phi i64 [ %.669, %176 ], [ %182, %186 ]
  %182 = add i64 %.3868, -1
  %183 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %182
  %184 = load i32, ptr %183, align 4
  %185 = icmp ugt i32 %184, %178
  br i1 %185, label %186, label %.critedge

186:                                              ; preds = %181
  %187 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.3868
  store i32 %184, ptr %187, align 4
  %188 = getelementptr inbounds nuw i8, ptr %9, i64 %182
  %189 = load i8, ptr %188, align 1
  %190 = getelementptr inbounds nuw i8, ptr %9, i64 %.3868
  store i8 %189, ptr %190, align 1
  %.not2 = icmp eq i64 %182, 0
  br i1 %.not2, label %.critedge, label %181, !llvm.loop !19

.critedge:                                        ; preds = %181, %186
  %.38.lcssa = phi i64 [ %.3868, %181 ], [ %182, %186 ]
  %191 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.38.lcssa
  store i32 %178, ptr %191, align 4
  %192 = getelementptr inbounds nuw i8, ptr %9, i64 %.38.lcssa
  store i8 %180, ptr %192, align 1
  %193 = add nuw nsw i64 %.669, 1
  %194 = icmp samesign ult i64 %193, 256
  br i1 %194, label %176, label %.preheader1, !llvm.loop !20

195:                                              ; preds = %195, %.preheader1
  %.49 = phi i64 [ %199, %195 ], [ 0, %.preheader1 ]
  %196 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.49
  %197 = load i32, ptr %196, align 4
  %198 = icmp eq i32 %197, 0
  %199 = add i64 %.49, 1
  br i1 %198, label %195, label %.preheader, !llvm.loop !21

.preheader:                                       ; preds = %195
  %.49.lcssa = phi i64 [ %.49, %195 ]
  %200 = icmp ult i64 0, %1
  br i1 %200, label %.lr.ph76, label %224

.lr.ph76:                                         ; preds = %.preheader
  br label %201

201:                                              ; preds = %.lr.ph76, %220
  %.775 = phi i64 [ %.49.lcssa, %.lr.ph76 ], [ %.9, %220 ]
  %.31374 = phi i64 [ 0, %.lr.ph76 ], [ %.414, %220 ]
  %.21773 = phi i64 [ 128, %.lr.ph76 ], [ %.318, %220 ]
  %.22172 = phi i32 [ 0, %.lr.ph76 ], [ %.423, %220 ]
  %.03171 = phi ptr [ %11, %.lr.ph76 ], [ %.132, %220 ]
  %.23570 = phi ptr [ %0, %.lr.ph76 ], [ %.336, %220 ]
  %202 = shl i32 %.22172, 1
  %203 = or disjoint i32 %202, 1
  %204 = load i8, ptr %.03171, align 1
  %205 = zext i8 %204 to i64
  %206 = and i64 %.21773, %205
...
208:                                              ; preds = %208, %201
  %.8 = phi i64 [ %.775, %201 ], [ %212, %208 ]
  %209 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.8
  %210 = load i32, ptr %209, align 4
  %211 = icmp ult i32 %210, %spec.select2
  %212 = add i64 %.8, 1
  br i1 %211, label %208, label %213, !llvm.loop !22

213:                                              ; preds = %208
  %.8.lcssa = phi i64 [ %.8, %208 ]
  %.lcssa = phi i32 [ %210, %208 ]
  %214 = icmp eq i32 %spec.select2, %.lcssa
  br i1 %214, label %215, label %220

215:                                              ; preds = %213
  %216 = getelementptr inbounds nuw i8, ptr %9, i64 %.8.lcssa
  %217 = load i8, ptr %216, align 1
  store i8 %217, ptr %.23570, align 1
  %218 = getelementptr inbounds nuw i8, ptr %.23570, i64 1
  %219 = add i64 %.31374, 1
  br label %220

220:                                              ; preds = %215, %213
  %.336 = phi ptr [ %218, %215 ], [ %.23570, %213 ]
  %.423 = phi i32 [ 0, %215 ], [ %spec.select2, %213 ]
  %.414 = phi i64 [ %219, %215 ], [ %.31374, %213 ]
  %.9 = phi i64 [ %.49.lcssa, %215 ], [ %.8.lcssa, %213 ]
  %221 = icmp ult i64 %.21773, 2
  %222 = lshr i64 %.21773, 1
  %.132.idx = zext i1 %221 to i64
  %.132 = getelementptr inbounds nuw i8, ptr %.03171, i64 %.132.idx
  %.318 = select i1 %221, i64 128, i64 %222
  %223 = icmp ult i64 %.414, %1
  br i1 %223, label %201, label %._crit_edge77, !llvm.loop !23

._crit_edge77:                                    ; preds = %220
  br label %224

224:                                              ; preds = %._crit_edge77, %.preheader
