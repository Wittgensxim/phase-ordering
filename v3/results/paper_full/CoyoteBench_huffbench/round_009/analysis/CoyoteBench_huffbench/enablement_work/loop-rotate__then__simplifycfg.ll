...
51:                                               ; preds = %.preheader4._crit_edge, %66
  %.03930 = phi i64 [ 0, %.preheader4._crit_edge ], [ %.140, %66 ]
  %.04229 = phi i64 [ 0, %.preheader4._crit_edge ], [ %67, %66 ]
  %.04528 = phi i64 [ 0, %.preheader4._crit_edge ], [ %.146, %66 ]
  %52 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04229
  %53 = load i64, ptr %52, align 8
  %.not6 = icmp eq i64 %53, 0
  br i1 %.not6, label %54, label %.preheader7.preheader

.preheader7.preheader:                            ; preds = %51
  %.037.in18 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.04229
  %.03719 = load i32, ptr %.037.in18, align 4
  %.not720 = icmp eq i32 %.03719, 0
  br i1 %.not720, label %.preheader7._crit_edge, label %.preheader7

54:                                               ; preds = %51
  %55 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04229
  store i32 0, ptr %55, align 4
  %56 = getelementptr inbounds nuw i8, ptr %7, i64 %.04229
  store i8 0, ptr %56, align 1
  br label %66

.preheader7:                                      ; preds = %.preheader7.preheader, %.preheader7
  %.03724 = phi i32 [ %.037, %.preheader7 ], [ %.03719, %.preheader7.preheader ]
  %.323 = phi i64 [ %61, %.preheader7 ], [ 0, %.preheader7.preheader ]
  %.0522 = phi i64 [ %60, %.preheader7 ], [ 1, %.preheader7.preheader ]
  %.04321 = phi i64 [ %.144, %.preheader7 ], [ 0, %.preheader7.preheader ]
...
.preheader7._crit_edge:                           ; preds = %.preheader7, %.preheader7.preheader
  %.043.lcssa = phi i64 [ 0, %.preheader7.preheader ], [ %.144, %.preheader7 ]
  %.3.lcssa = phi i64 [ 0, %.preheader7.preheader ], [ %61, %.preheader7 ]
  %62 = trunc i64 %.043.lcssa to i32
  %63 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04229
...
66:                                               ; preds = %.preheader7._crit_edge, %54
  %.146 = phi i64 [ %spec.select, %.preheader7._crit_edge ], [ %.04528, %54 ]
  %.140 = phi i64 [ %.241, %.preheader7._crit_edge ], [ %.03930, %54 ]
  %67 = add nuw nsw i64 %.04229, 1
...
.preheader3.preheader:                            ; preds = %73
  ...
  br i1 %exitcond15.not42, label %.preheader3._crit_edge, label %.lr.ph48
...
.lr.ph48:                                         ; preds = %.preheader3.preheader, %.preheader3
  %.0147 = phi i32 [ %.1.lcssa, %.preheader3 ], [ -1, %.preheader3.preheader ]
  %.1646 = phi i64 [ %111, %.preheader3 ], [ 0, %.preheader3.preheader ]
  %.02445 = phi i8 [ %.125.lcssa, %.preheader3 ], [ 0, %.preheader3.preheader ]
  %.02844 = phi i64 [ %.129.lcssa, %.preheader3 ], [ 0, %.preheader3.preheader ]
  %.13443 = phi ptr [ %110, %.preheader3 ], [ %0, %.preheader3.preheader ]
  %78 = load i8, ptr %.13443, align 1
  ...
  br i1 %87, label %.lr.ph37, label %.preheader3

.lr.ph37:                                         ; preds = %.lr.ph48, %100
  %.135 = phi i32 [ %.2, %100 ], [ %.0147, %.lr.ph48 ]
  %.434 = phi i64 [ %107, %100 ], [ 0, %.lr.ph48 ]
  %.01533 = phi i64 [ %106, %100 ], [ %85, %.lr.ph48 ]
  %.12532 = phi i8 [ %.327, %100 ], [ %.02445, %.lr.ph48 ]
  %.12931 = phi i64 [ %.230, %100 ], [ %.02844, %.lr.ph48 ]
  %88 = phi i8 [ %.pre-phi.in, %100 ], [ %78, %.lr.ph48 ]
  %89 = icmp eq i32 %.135, 7
  br i1 %89, label %90, label %97

90:                                               ; preds = %.lr.ph37
  %91 = getelementptr inbounds nuw i8, ptr %11, i64 %.12931
  store i8 %.12532, ptr %91, align 1
  %92 = add i64 %.12931, 1
  %93 = icmp eq i64 %92, %1
...
100:                                              ; preds = %97, %._crit_edge
  ...
  br i1 %109, label %.lr.ph37, label %.preheader3, !llvm.loop !15

.preheader3:                                      ; preds = %100, %.lr.ph48
  %.129.lcssa = phi i64 [ %.02844, %.lr.ph48 ], [ %.230, %100 ]
  %.125.lcssa = phi i8 [ %.02445, %.lr.ph48 ], [ %.327, %100 ]
  %.1.lcssa = phi i32 [ %.0147, %.lr.ph48 ], [ %.2, %100 ]
  %110 = getelementptr inbounds nuw i8, ptr %.13443, i64 1
  %111 = add i64 %.1646, 1
  %exitcond15.not = icmp eq i64 %111, %1
  br i1 %exitcond15.not, label %.preheader3._crit_edge, label %.lr.ph48, !llvm.loop !16
...
117:                                              ; preds = %.preheader3._crit_edge, %139
  %.061 = phi ptr [ %9, %.preheader3._crit_edge ], [ %119, %139 ]
  %.2760 = phi i64 [ 0, %.preheader3._crit_edge ], [ %140, %139 ]
  %118 = trunc nuw i64 %.2760 to i8
  store i8 %118, ptr %.061, align 1
  %119 = getelementptr inbounds nuw i8, ptr %.061, i64 1
  %120 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2760
  %121 = load i32, ptr %120, align 4
  %122 = getelementptr inbounds nuw i8, ptr %7, i64 %.2760
...
126:                                              ; preds = %117
  ...
  %exitcond16.not52 = icmp eq i64 0, %130
  br i1 %exitcond16.not52, label %._crit_edge58, label %.lr.ph57

.lr.ph57:                                         ; preds = %126, %.lr.ph57
  %.555 = phi i64 [ %137, %.lr.ph57 ], [ 0, %126 ]
  %.11654 = phi i64 [ %136, %.lr.ph57 ], [ %129, %126 ]
  %.01953 = phi i32 [ %spec.select1, %.lr.ph57 ], [ 0, %126 ]
  %131 = shl i32 %.01953, 1
  %132 = or disjoint i32 %131, 1
  %133 = zext i32 %121 to i64
  %134 = and i64 %.11654, %133
  %.not4 = icmp eq i64 %134, 0
  %135 = add i32 %131, 2
  %spec.select1 = select i1 %.not4, i32 %132, i32 %135
  %136 = lshr i64 %.11654, 1
  %137 = add nuw nsw i64 %.555, 1
  %exitcond16.not = icmp eq i64 %137, %130
  br i1 %exitcond16.not, label %._crit_edge58, label %.lr.ph57, !llvm.loop !17

._crit_edge58:                                    ; preds = %.lr.ph57, %126
  %.019.lcssa = phi i32 [ 0, %126 ], [ %spec.select1, %.lr.ph57 ]
  %138 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2760
  store i32 %.019.lcssa, ptr %138, align 4
  br label %139

139:                                              ; preds = %._crit_edge58, %117
  %140 = add nuw nsw i64 %.2760, 1
...
.preheader2.preheader:                            ; preds = %139, %.critedge
  %.663 = phi i64 [ %157, %.critedge ], [ 1, %139 ]
  %141 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.663
  %142 = load i32, ptr %141, align 4
  %143 = getelementptr inbounds nuw i8, ptr %9, i64 %.663
  %144 = load i8, ptr %143, align 1
  br label %145

145:                                              ; preds = %.preheader2.preheader, %150
  %.3862 = phi i64 [ %.663, %.preheader2.preheader ], [ %146, %150 ]
  %146 = add nsw i64 %.3862, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %162, label %.lr.ph70, label %.preheader._crit_edge

.lr.ph70:                                         ; preds = %.preheader.preheader, %.preheader
  %.769 = phi i64 [ %.9, %.preheader ], [ %.49.lcssa, %.preheader.preheader ]
  %.31368 = phi i64 [ %.414, %.preheader ], [ 0, %.preheader.preheader ]
  %.21767 = phi i64 [ %.318, %.preheader ], [ 128, %.preheader.preheader ]
  %.22166 = phi i32 [ %.423, %.preheader ], [ 0, %.preheader.preheader ]
  %.03165 = phi ptr [ %.132, %.preheader ], [ %11, %.preheader.preheader ]
  %.23564 = phi ptr [ %.336, %.preheader ], [ %0, %.preheader.preheader ]
  %163 = shl i32 %.22166, 1
  %164 = or disjoint i32 %163, 1
  %165 = load i8, ptr %.03165, align 1
  %166 = zext i8 %165 to i64
  %167 = and i64 %.21767, %166
  %.not1 = icmp eq i64 %167, 0
  %168 = add i32 %163, 2
  %spec.select2 = select i1 %.not1, i32 %164, i32 %168
  br label %169

169:                                              ; preds = %169, %.lr.ph70
  %.8 = phi i64 [ %.769, %.lr.ph70 ], [ %173, %169 ]
...
176:                                              ; preds = %174
  ...
  store i8 %178, ptr %.23564, align 1
  %179 = getelementptr inbounds nuw i8, ptr %.23564, i64 1
  %180 = add nuw i64 %.31368, 1
  br label %.preheader

.preheader:                                       ; preds = %176, %174
  %.336 = phi ptr [ %179, %176 ], [ %.23564, %174 ]
  %.423 = phi i32 [ 0, %176 ], [ %spec.select2, %174 ]
  %.414 = phi i64 [ %180, %176 ], [ %.31368, %174 ]
  %.9 = phi i64 [ %.49.lcssa, %176 ], [ %.8.lcssa, %174 ]
  %181 = icmp ult i64 %.21767, 2
  %182 = lshr i64 %.21767, 1
  ...
  br i1 %183, label %.lr.ph70, label %.preheader._crit_edge, !llvm.loop !23
