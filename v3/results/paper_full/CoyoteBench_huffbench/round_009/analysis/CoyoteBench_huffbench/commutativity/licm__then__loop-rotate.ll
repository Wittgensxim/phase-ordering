...
138:                                              ; preds = %.lr.ph57, %138
  %.555 = phi i64 [ 0, %.lr.ph57 ], [ %144, %138 ]
  %.11654 = phi i64 [ %135, %.lr.ph57 ], [ %143, %138 ]
  %.01953 = phi i32 [ 0, %.lr.ph57 ], [ %spec.select1, %138 ]
  %139 = shl i32 %.01953, 1
  %140 = or disjoint i32 %139, 1
  %141 = and i64 %.11654, %137
  %.not4 = icmp eq i64 %141, 0
  %142 = add i32 %139, 2
  %spec.select1 = select i1 %.not4, i32 %140, i32 %142
  %143 = lshr i64 %.11654, 1
  %144 = add nuw nsw i64 %.555, 1
  %exitcond16.not = icmp eq i64 %144, %136
  br i1 %exitcond16.not, label %._crit_edge58, label %138, !llvm.loop !17

._crit_edge58:                                    ; preds = %138
  %split59 = phi i32 [ %spec.select1, %138 ]
  br label %145
