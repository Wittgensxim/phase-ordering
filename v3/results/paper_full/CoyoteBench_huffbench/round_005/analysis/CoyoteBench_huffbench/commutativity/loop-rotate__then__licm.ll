...
.preheader3:                                      ; preds = %81
  %exitcond1546 = icmp ne i64 0, %1
  br i1 %exitcond1546, label %.lr.ph52, label %123
...
144:                                              ; preds = %.lr.ph62, %144
  ...
  br i1 %exitcond16, label %144, label %._crit_edge63, !llvm.loop !17
