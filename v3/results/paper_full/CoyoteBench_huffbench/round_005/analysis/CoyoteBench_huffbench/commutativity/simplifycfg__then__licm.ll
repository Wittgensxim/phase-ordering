...
12:                                               ; preds = %13, %2
  ...
  br i1 %exitcond, label %13, label %.preheader6.preheader
...
.preheader6:                                      ; preds = %.preheader6.preheader, %28
  ...
  br i1 %exitcond13, label %22, label %.preheader5.preheader
...
130:                                              ; preds = %156, %124
  ...
  br i1 %exitcond17, label %131, label %.preheader2.preheader
...
146:                                              ; preds = %147, %140
  ...
  br i1 %exitcond16, label %147, label %154
...
.preheader2:                                      ; preds = %.preheader2.preheader, %.critedge
  ...
  br i1 %exitcond18, label %158, label %.preheader1.preheader
...
5:                                                ; preds = %9, %.preheader
  ...
  br i1 %exitcond, label %6, label %.loopexit.loopexit
