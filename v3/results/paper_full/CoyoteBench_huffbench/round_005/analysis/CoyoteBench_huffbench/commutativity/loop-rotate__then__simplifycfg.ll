...
.lr.ph:                                           ; preds = %2, %.lr.ph
  ...
  %18 = add i64 %.029, 1
  %exitcond = icmp ne i64 %18, %1
  br i1 %exitcond, label %.lr.ph, label %.preheader6, !llvm.loop !9
...
25:                                               ; preds = %22, %19
  ...
  br i1 %exitcond13, label %19, label %.preheader5, !llvm.loop !10
...
68:                                               ; preds = %._crit_edge28, %55
  ...
  %exitcond14 = icmp ne i64 %69, 256
  br i1 %exitcond14, label %52, label %70, !llvm.loop !14
...
.preheader3:                                      ; preds = %75
  ...
  br i1 %exitcond1546, label %.lr.ph52, label %._crit_edge53
...
._crit_edge42:                                    ; preds = %102, %.lr.ph52
  ...
  %113 = add i64 %.1650, 1
  %exitcond15 = icmp ne i64 %113, %1
  br i1 %exitcond15, label %.lr.ph52, label %._crit_edge53, !llvm.loop !16
...
128:                                              ; preds = %119
  ...
  %exitcond1657 = icmp ne i64 0, %132
  br i1 %exitcond1657, label %.lr.ph62, label %._crit_edge63
...
.lr.ph62:                                         ; preds = %128, %.lr.ph62
  ...
  %exitcond16 = icmp ne i64 %139, %132
  br i1 %exitcond16, label %.lr.ph62, label %._crit_edge63, !llvm.loop !17
...
141:                                              ; preds = %._crit_edge63, %119
  ...
  %exitcond17 = icmp ne i64 %142, 256
  br i1 %exitcond17, label %119, label %.preheader2, !llvm.loop !18
...
.critedge:                                        ; preds = %147, %152
  ...
  %exitcond18 = icmp ne i64 %159, 256
  br i1 %exitcond18, label %.preheader2, label %.preheader1, !llvm.loop !20
