...
define dso_local void @compdecomp(ptr noundef %0, i64 noundef %1) #0 {
  ...
  br i1 %exitcond19, label %.lr.ph, label %.preheader6
...
.preheader5:                                      ; preds = %26
  ...
  br i1 %.not25, label %.preheader4, label %.lr.ph27

.lr.ph27:                                         ; preds = %.preheader5
  br label %29

20:                                               ; preds = %.preheader6, %26
  %.1324 = phi i64 [ 0, %.preheader6 ], [ %27, %26 ]
  %.01023 = phi i64 [ 0, %.preheader6 ], [ %.111, %26 ]
...
.preheader4:                                      ; preds = %..preheader4_crit_edge, %.preheader5
  ...
  br i1 %28, label %.lr.ph29, label %53

.lr.ph29:                                         ; preds = %.preheader4
  br label %33

29:                                               ; preds = %.lr.ph27, %29
  %.2426 = phi i64 [ %.010.lcssa, %.lr.ph27 ], [ %32, %29 ]
  %30 = trunc i64 %.010.lcssa to i32
  %31 = trunc i64 %.2426 to i32
...
33:                                               ; preds = %.lr.ph29, %33
  %.21228 = phi i64 [ %.010.lcssa, %.lr.ph29 ], [ %34, %33 ]
  %34 = add i64 %.21228, -1
  ...
  br i1 %52, label %33, label %._crit_edge30, !llvm.loop !12

._crit_edge30:                                    ; preds = %33
  %split = phi i64 [ %34, %33 ]
  br label %53

53:                                               ; preds = %._crit_edge30, %.preheader4
  %.212.lcssa = phi i64 [ %split, %._crit_edge30 ], [ %.010.lcssa, %.preheader4 ]
...
56:                                               ; preds = %53, %74
  %.03946 = phi i64 [ 0, %53 ], [ %.140, %74 ]
  %.04245 = phi i64 [ 0, %53 ], [ %75, %74 ]
  %.04544 = phi i64 [ 0, %53 ], [ %.146, %74 ]
  %57 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04245
  %58 = load i64, ptr %57, align 8
  %.not6 = icmp eq i64 %58, 0
  br i1 %.not6, label %59, label %62

59:                                               ; preds = %56
  %60 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04245
  store i32 0, ptr %60, align 4
  %61 = getelementptr inbounds nuw i8, ptr %7, i64 %.04245
  store i8 0, ptr %61, align 1
  br label %74

62:                                               ; preds = %56
  %.037.in31 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.04245
  %.03732 = load i32, ptr %.037.in31, align 4
  %.not733 = icmp eq i32 %.03732, 0
  br i1 %.not733, label %69, label %.lr.ph40

.lr.ph40:                                         ; preds = %62
  br label %63

63:                                               ; preds = %.lr.ph40, %63
  %.03738 = phi i32 [ %.03732, %.lr.ph40 ], [ %.037, %63 ]
  %.337 = phi i64 [ 0, %.lr.ph40 ], [ %68, %63 ]
  %.0535 = phi i64 [ 1, %.lr.ph40 ], [ %67, %63 ]
  %.04334 = phi i64 [ 0, %.lr.ph40 ], [ %.144, %63 ]
  %64 = icmp slt i32 %.03738, 0
  %65 = select i1 %64, i64 %.0535, i64 0
  %.144 = add i64 %.04334, %65
  ...
  br i1 %.not7, label %._crit_edge41, label %63, !llvm.loop !13

._crit_edge41:                                    ; preds = %63
  %split42 = phi i64 [ %.144, %63 ]
  %split43 = phi i64 [ %68, %63 ]
  br label %69

69:                                               ; preds = %._crit_edge41, %62
  %.043.lcssa = phi i64 [ %split42, %._crit_edge41 ], [ 0, %62 ]
  %.3.lcssa = phi i64 [ %split43, %._crit_edge41 ], [ 0, %62 ]
  %70 = trunc i64 %.043.lcssa to i32
  %71 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04245
  store i32 %70, ptr %71, align 4
  %72 = trunc i64 %.3.lcssa to i8
  %73 = getelementptr inbounds nuw i8, ptr %7, i64 %.04245
...
74:                                               ; preds = %69, %59
  %.146 = phi i64 [ %spec.select, %69 ], [ %.04544, %59 ]
  %.140 = phi i64 [ %.241, %69 ], [ %.03946, %59 ]
  %75 = add nuw nsw i64 %.04245, 1
  %exitcond14 = icmp ne i64 %75, 256
  br i1 %exitcond14, label %56, label %76, !llvm.loop !14

76:                                               ; preds = %74
  %.045.lcssa = phi i64 [ %.146, %74 ]
  %.039.lcssa = phi i64 [ %.140, %74 ]
...
.preheader3:                                      ; preds = %81
  %exitcond1558 = icmp ne i64 0, %1
  br i1 %exitcond1558, label %.lr.ph64, label %123

.lr.ph64:                                         ; preds = %.preheader3
  br label %86
...
86:                                               ; preds = %.lr.ph64, %120
  %.0163 = phi i32 [ -1, %.lr.ph64 ], [ %.1.lcssa, %120 ]
  %.1662 = phi i64 [ 0, %.lr.ph64 ], [ %122, %120 ]
  %.02461 = phi i8 [ 0, %.lr.ph64 ], [ %.125.lcssa, %120 ]
  %.02860 = phi i64 [ 0, %.lr.ph64 ], [ %.129.lcssa, %120 ]
  %.13459 = phi ptr [ %0, %.lr.ph64 ], [ %121, %120 ]
  %87 = load i8, ptr %.13459, align 1
  ...
  br i1 %96, label %.lr.ph53, label %120

.lr.ph53:                                         ; preds = %86
  br label %97

97:                                               ; preds = %.lr.ph53, %110
  %.151 = phi i32 [ %.0163, %.lr.ph53 ], [ %.2, %110 ]
  %.450 = phi i64 [ 0, %.lr.ph53 ], [ %117, %110 ]
  %.01549 = phi i64 [ %94, %.lr.ph53 ], [ %116, %110 ]
  %.12548 = phi i8 [ %.02461, %.lr.ph53 ], [ %.327, %110 ]
  %.12947 = phi i64 [ %.02860, %.lr.ph53 ], [ %.230, %110 ]
  %98 = phi i8 [ %87, %.lr.ph53 ], [ %.pre-phi.in, %110 ]
  %99 = icmp eq i32 %.151, 7
  br i1 %99, label %100, label %107

100:                                              ; preds = %97
  %101 = getelementptr inbounds nuw i8, ptr %11, i64 %.12947
  store i8 %.12548, ptr %101, align 1
  %102 = add i64 %.12947, 1
  %103 = icmp eq i64 %102, %1
  br i1 %103, label %104, label %._crit_edge

._crit_edge:                                      ; preds = %100
  %.pre1 = load i8, ptr %.13459, align 1
  br label %110
...
110:                                              ; preds = %107, %._crit_edge
  ...
  %.230 = phi i64 [ %102, %._crit_edge ], [ %.12947, %107 ]
  ...
  br i1 %119, label %97, label %._crit_edge54, !llvm.loop !15

._crit_edge54:                                    ; preds = %110
  %split55 = phi i64 [ %.230, %110 ]
  %split56 = phi i8 [ %.327, %110 ]
  %split57 = phi i32 [ %.2, %110 ]
  br label %120

120:                                              ; preds = %._crit_edge54, %86
  %.129.lcssa = phi i64 [ %split55, %._crit_edge54 ], [ %.02860, %86 ]
  %.125.lcssa = phi i8 [ %split56, %._crit_edge54 ], [ %.02461, %86 ]
  %.1.lcssa = phi i32 [ %split57, %._crit_edge54 ], [ %.0163, %86 ]
  %121 = getelementptr inbounds nuw i8, ptr %.13459, i64 1
  %122 = add i64 %.1662, 1
  %exitcond15 = icmp ne i64 %122, %1
  br i1 %exitcond15, label %86, label %._crit_edge65, !llvm.loop !16

._crit_edge65:                                    ; preds = %120
  %split66 = phi i64 [ %.129.lcssa, %120 ]
  %split67 = phi i8 [ %.125.lcssa, %120 ]
  %split68 = phi i32 [ %.1.lcssa, %120 ]
  br label %123

123:                                              ; preds = %._crit_edge65, %.preheader3
  %.028.lcssa = phi i64 [ %split66, %._crit_edge65 ], [ 0, %.preheader3 ]
  %.024.lcssa = phi i8 [ %split67, %._crit_edge65 ], [ 0, %.preheader3 ]
  %.01.lcssa = phi i32 [ %split68, %._crit_edge65 ], [ -1, %.preheader3 ]
...
129:                                              ; preds = %123, %153
  %.078 = phi ptr [ %9, %123 ], [ %131, %153 ]
  %.2777 = phi i64 [ 0, %123 ], [ %154, %153 ]
  %130 = trunc nuw i64 %.2777 to i8
  store i8 %130, ptr %.078, align 1
  %131 = getelementptr inbounds nuw i8, ptr %.078, i64 1
  %132 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2777
  %133 = load i32, ptr %132, align 4
  %134 = getelementptr inbounds nuw i8, ptr %7, i64 %.2777
...
138:                                              ; preds = %129
  ...
  %exitcond1669 = icmp ne i64 0, %142
  br i1 %exitcond1669, label %.lr.ph74, label %151

.lr.ph74:                                         ; preds = %138
  br label %143

143:                                              ; preds = %.lr.ph74, %143
  %.572 = phi i64 [ 0, %.lr.ph74 ], [ %150, %143 ]
  %.11671 = phi i64 [ %141, %.lr.ph74 ], [ %149, %143 ]
  %.01970 = phi i32 [ 0, %.lr.ph74 ], [ %spec.select1, %143 ]
  %144 = shl i32 %.01970, 1
  %145 = or disjoint i32 %144, 1
  %146 = zext i32 %133 to i64
  %147 = and i64 %.11671, %146
  %.not4 = icmp eq i64 %147, 0
  %148 = add i32 %144, 2
  %spec.select1 = select i1 %.not4, i32 %145, i32 %148
  %149 = lshr i64 %.11671, 1
  %150 = add nuw nsw i64 %.572, 1
  %exitcond16 = icmp ne i64 %150, %142
  br i1 %exitcond16, label %143, label %._crit_edge75, !llvm.loop !17

._crit_edge75:                                    ; preds = %143
  %split76 = phi i32 [ %spec.select1, %143 ]
  br label %151

151:                                              ; preds = %._crit_edge75, %138
  %.019.lcssa = phi i32 [ %split76, %._crit_edge75 ], [ 0, %138 ]
  %152 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2777
  store i32 %.019.lcssa, ptr %152, align 4
  br label %153

153:                                              ; preds = %151, %129
  %154 = add nuw nsw i64 %.2777, 1
...
155:                                              ; preds = %.preheader2, %.critedge
  %.680 = phi i64 [ 1, %.preheader2 ], [ %172, %.critedge ]
  %156 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.680
  %157 = load i32, ptr %156, align 4
  %158 = getelementptr inbounds nuw i8, ptr %9, i64 %.680
  %159 = load i8, ptr %158, align 1
  br label %160

160:                                              ; preds = %155, %165
  %.3879 = phi i64 [ %.680, %155 ], [ %161, %165 ]
  %161 = add nsw i64 %.3879, -1
...
.preheader:                                       ; preds = %173
  %.49.lcssa = phi i64 [ %.49, %173 ]
  %178 = icmp ult i64 0, %1
  br i1 %178, label %.lr.ph87, label %202

.lr.ph87:                                         ; preds = %.preheader
  br label %179

179:                                              ; preds = %.lr.ph87, %198
  %.786 = phi i64 [ %.49.lcssa, %.lr.ph87 ], [ %.9, %198 ]
  %.31385 = phi i64 [ 0, %.lr.ph87 ], [ %.414, %198 ]
  %.21784 = phi i64 [ 128, %.lr.ph87 ], [ %.318, %198 ]
  %.22183 = phi i32 [ 0, %.lr.ph87 ], [ %.423, %198 ]
  %.03182 = phi ptr [ %11, %.lr.ph87 ], [ %.132, %198 ]
  %.23581 = phi ptr [ %0, %.lr.ph87 ], [ %.336, %198 ]
  %180 = shl i32 %.22183, 1
  %181 = or disjoint i32 %180, 1
  %182 = load i8, ptr %.03182, align 1
  %183 = zext i8 %182 to i64
  %184 = and i64 %.21784, %183
...
191:                                              ; preds = %186
  %.8.lcssa = phi i64 [ %.8, %186 ]
  %.lcssa = phi i32 [ %188, %186 ]
  %192 = icmp eq i32 %spec.select2, %.lcssa
  br i1 %192, label %193, label %198

193:                                              ; preds = %191
  %194 = getelementptr inbounds nuw i8, ptr %9, i64 %.8.lcssa
  %195 = load i8, ptr %194, align 1
  store i8 %195, ptr %.23581, align 1
  %196 = getelementptr inbounds nuw i8, ptr %.23581, i64 1
  %197 = add nuw i64 %.31385, 1
  br label %198

198:                                              ; preds = %193, %191
  %.336 = phi ptr [ %196, %193 ], [ %.23581, %191 ]
  %.423 = phi i32 [ 0, %193 ], [ %spec.select2, %191 ]
  %.414 = phi i64 [ %197, %193 ], [ %.31385, %191 ]
  %.9 = phi i64 [ %.49.lcssa, %193 ], [ %.8.lcssa, %191 ]
  %199 = icmp ult i64 %.21784, 2
  %200 = lshr i64 %.21784, 1
  %.132.idx = zext i1 %199 to i64
  %.132 = getelementptr inbounds nuw i8, ptr %.03182, i64 %.132.idx
  %.318 = select i1 %199, i64 128, i64 %200
  %201 = icmp ult i64 %.414, %1
  br i1 %201, label %179, label %._crit_edge88, !llvm.loop !23

._crit_edge88:                                    ; preds = %198
  br label %202

202:                                              ; preds = %._crit_edge88, %.preheader
...
11:                                               ; preds = %.lr.ph, %37
  %.016 = phi i32 [ %3, %.lr.ph ], [ %.0, %37 ]
  %12 = shl nsw i32 %.016, 1
