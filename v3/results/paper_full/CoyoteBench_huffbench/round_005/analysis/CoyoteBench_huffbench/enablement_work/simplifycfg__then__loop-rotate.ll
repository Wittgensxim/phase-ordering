...
define dso_local void @compdecomp(ptr noundef %0, i64 noundef %1) #0 {
  ...
  %exitcond19 = icmp ne i64 0, %1
  br i1 %exitcond19, label %.lr.ph, label %.preheader6.preheader
...
12:                                               ; preds = %.lr.ph, %12
  %.0221 = phi i64 [ 0, %.lr.ph ], [ %19, %12 ]
  %.03320 = phi ptr [ %0, %.lr.ph ], [ %18, %12 ]
  %13 = load i8, ptr %.03320, align 1
  %14 = zext i8 %13 to i64
  %15 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %14
  %16 = load i64, ptr %15, align 8
  %17 = add i64 %16, 1
  store i64 %17, ptr %15, align 8
  %18 = getelementptr inbounds nuw i8, ptr %.03320, i64 1
  %19 = add i64 %.0221, 1
  %exitcond = icmp ne i64 %19, %1
  br i1 %exitcond, label %12, label %..preheader6.preheader_crit_edge, !llvm.loop !9

.preheader5.preheader:                            ; preds = %.preheader6
  %.010.lcssa = phi i64 [ %.111, %.preheader6 ]
  %.not25 = icmp eq i64 %.010.lcssa, 0
  br i1 %.not25, label %.preheader4.preheader, label %.lr.ph27

.lr.ph27:                                         ; preds = %.preheader5.preheader
  br label %.preheader5

20:                                               ; preds = %.preheader6.preheader, %.preheader6
  %.1324 = phi i64 [ 0, %.preheader6.preheader ], [ %26, %.preheader6 ]
  %.01023 = phi i64 [ 0, %.preheader6.preheader ], [ %.111, %.preheader6 ]
  %21 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.1324
  %22 = load i64, ptr %21, align 8
  %.not8 = icmp eq i64 %22, 0
  br i1 %.not8, label %.preheader6, label %23

23:                                               ; preds = %20
  %24 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.01023
  store i64 %.1324, ptr %24, align 8
  %25 = add i64 %.01023, 1
  br label %.preheader6

.preheader6:                                      ; preds = %23, %20
  %.111 = phi i64 [ %25, %23 ], [ %.01023, %20 ]
  %26 = add nuw nsw i64 %.1324, 1
  %exitcond13 = icmp ne i64 %26, 256
  br i1 %exitcond13, label %20, label %.preheader5.preheader, !llvm.loop !10
...
.preheader4.preheader:                            ; preds = %.preheader5..preheader4.preheader_crit_edge, %.preheader5.preheader
  ...
  br i1 %27, label %.lr.ph29, label %50

.lr.ph29:                                         ; preds = %.preheader4.preheader
  br label %.preheader4

.preheader5:                                      ; preds = %.lr.ph27, %.preheader5
  %.2426 = phi i64 [ %.010.lcssa, %.lr.ph27 ], [ %30, %.preheader5 ]
  %28 = trunc i64 %.010.lcssa to i32
  %29 = trunc i64 %.2426 to i32
...
.preheader4:                                      ; preds = %.lr.ph29, %.preheader4
  %.21228 = phi i64 [ %.010.lcssa, %.lr.ph29 ], [ %31, %.preheader4 ]
  %31 = add i64 %.21228, -1
...
53:                                               ; preds = %50, %70
  %.03943 = phi i64 [ 0, %50 ], [ %.140, %70 ]
  %.04242 = phi i64 [ 0, %50 ], [ %71, %70 ]
  %.04541 = phi i64 [ 0, %50 ], [ %.146, %70 ]
  %54 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04242
  %55 = load i64, ptr %54, align 8
  %.not6 = icmp eq i64 %55, 0
  br i1 %.not6, label %56, label %.preheader7

.preheader7:                                      ; preds = %53
  %.037.in30 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.04242
  %.03731 = load i32, ptr %.037.in30, align 4
  %.not732 = icmp eq i32 %.03731, 0
  br i1 %.not732, label %65, label %.lr.ph37

.lr.ph37:                                         ; preds = %.preheader7
  br label %59

56:                                               ; preds = %53
  %57 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04242
  store i32 0, ptr %57, align 4
  %58 = getelementptr inbounds nuw i8, ptr %7, i64 %.04242
  store i8 0, ptr %58, align 1
  br label %70

59:                                               ; preds = %.lr.ph37, %59
  %.03736 = phi i32 [ %.03731, %.lr.ph37 ], [ %.037, %59 ]
  %.335 = phi i64 [ 0, %.lr.ph37 ], [ %64, %59 ]
  %.0534 = phi i64 [ 1, %.lr.ph37 ], [ %63, %59 ]
  %.04333 = phi i64 [ 0, %.lr.ph37 ], [ %.144, %59 ]
  %60 = icmp slt i32 %.03736, 0
  %61 = select i1 %60, i64 %.0534, i64 0
  %.144 = add i64 %.04333, %61
  ...
  br i1 %.not7, label %._crit_edge38, label %59, !llvm.loop !13

._crit_edge38:                                    ; preds = %59
  %split39 = phi i64 [ %.144, %59 ]
  %split40 = phi i64 [ %64, %59 ]
  br label %65

65:                                               ; preds = %._crit_edge38, %.preheader7
  %.043.lcssa = phi i64 [ %split39, %._crit_edge38 ], [ 0, %.preheader7 ]
  %.3.lcssa = phi i64 [ %split40, %._crit_edge38 ], [ 0, %.preheader7 ]
  %66 = trunc i64 %.043.lcssa to i32
  %67 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04242
  store i32 %66, ptr %67, align 4
  %68 = trunc i64 %.3.lcssa to i8
  %69 = getelementptr inbounds nuw i8, ptr %7, i64 %.04242
  store i8 %68, ptr %69, align 1
  %spec.select = call i64 @llvm.umax.i64(i64 %.043.lcssa, i64 %.04541)
  %.241 = call i64 @llvm.umax.i64(i64 %.3.lcssa, i64 %.03943)
  br label %70

70:                                               ; preds = %65, %56
  %.146 = phi i64 [ %spec.select, %65 ], [ %.04541, %56 ]
  %.140 = phi i64 [ %.241, %65 ], [ %.03943, %56 ]
  %71 = add nuw nsw i64 %.04242, 1
  %exitcond14 = icmp ne i64 %71, 256
  br i1 %exitcond14, label %53, label %72, !llvm.loop !14
...
.preheader3.preheader:                            ; preds = %77
  %exitcond1555 = icmp ne i64 0, %1
  br i1 %exitcond1555, label %.lr.ph61, label %118

.lr.ph61:                                         ; preds = %.preheader3.preheader
  br label %82
...
82:                                               ; preds = %.lr.ph61, %.preheader3
  %.0160 = phi i32 [ -1, %.lr.ph61 ], [ %.1.lcssa, %.preheader3 ]
  %.1659 = phi i64 [ 0, %.lr.ph61 ], [ %117, %.preheader3 ]
  %.02458 = phi i8 [ 0, %.lr.ph61 ], [ %.125.lcssa, %.preheader3 ]
  %.02857 = phi i64 [ 0, %.lr.ph61 ], [ %.129.lcssa, %.preheader3 ]
  %.13456 = phi ptr [ %0, %.lr.ph61 ], [ %116, %.preheader3 ]
  %83 = load i8, ptr %.13456, align 1
  ...
  br i1 %92, label %.lr.ph50, label %.preheader3

.lr.ph50:                                         ; preds = %82
  br label %93

93:                                               ; preds = %.lr.ph50, %106
  %.148 = phi i32 [ %.0160, %.lr.ph50 ], [ %.2, %106 ]
  %.447 = phi i64 [ 0, %.lr.ph50 ], [ %113, %106 ]
  %.01546 = phi i64 [ %90, %.lr.ph50 ], [ %112, %106 ]
  %.12545 = phi i8 [ %.02458, %.lr.ph50 ], [ %.327, %106 ]
  %.12944 = phi i64 [ %.02857, %.lr.ph50 ], [ %.230, %106 ]
  %94 = phi i8 [ %83, %.lr.ph50 ], [ %.pre-phi.in, %106 ]
  %95 = icmp eq i32 %.148, 7
  br i1 %95, label %96, label %103

96:                                               ; preds = %93
  %97 = getelementptr inbounds nuw i8, ptr %11, i64 %.12944
  store i8 %.12545, ptr %97, align 1
  %98 = add i64 %.12944, 1
  %99 = icmp eq i64 %98, %1
  br i1 %99, label %100, label %._crit_edge

._crit_edge:                                      ; preds = %96
  %.pre1 = load i8, ptr %.13456, align 1
  br label %106
...
106:                                              ; preds = %103, %._crit_edge
  ...
  %110 = and i64 %.01546, %109
  %.not5 = icmp ne i64 %110, 0
  %111 = zext i1 %.not5 to i8
  %.327 = or disjoint i8 %.226, %111
  %112 = lshr i64 %.01546, 1
  %113 = add nuw nsw i64 %.447, 1
  ...
  br i1 %115, label %93, label %._crit_edge51, !llvm.loop !15

._crit_edge51:                                    ; preds = %106
  %split52 = phi i64 [ %.230, %106 ]
  %split53 = phi i8 [ %.327, %106 ]
  %split54 = phi i32 [ %.2, %106 ]
  br label %.preheader3

.preheader3:                                      ; preds = %._crit_edge51, %82
  %.129.lcssa = phi i64 [ %split52, %._crit_edge51 ], [ %.02857, %82 ]
  %.125.lcssa = phi i8 [ %split53, %._crit_edge51 ], [ %.02458, %82 ]
  %.1.lcssa = phi i32 [ %split54, %._crit_edge51 ], [ %.0160, %82 ]
  %116 = getelementptr inbounds nuw i8, ptr %.13456, i64 1
  %117 = add i64 %.1659, 1
  %exitcond15 = icmp ne i64 %117, %1
  br i1 %exitcond15, label %82, label %.preheader3._crit_edge, !llvm.loop !16

.preheader3._crit_edge:                           ; preds = %.preheader3
  %split62 = phi i64 [ %.129.lcssa, %.preheader3 ]
  %split63 = phi i8 [ %.125.lcssa, %.preheader3 ]
  %split64 = phi i32 [ %.1.lcssa, %.preheader3 ]
  br label %118

118:                                              ; preds = %.preheader3._crit_edge, %.preheader3.preheader
  %.028.lcssa = phi i64 [ %split62, %.preheader3._crit_edge ], [ 0, %.preheader3.preheader ]
  %.024.lcssa = phi i8 [ %split63, %.preheader3._crit_edge ], [ 0, %.preheader3.preheader ]
  %.01.lcssa = phi i32 [ %split64, %.preheader3._crit_edge ], [ -1, %.preheader3.preheader ]
...
124:                                              ; preds = %118, %148
  %.074 = phi ptr [ %9, %118 ], [ %126, %148 ]
  %.2773 = phi i64 [ 0, %118 ], [ %149, %148 ]
  %125 = trunc nuw i64 %.2773 to i8
  store i8 %125, ptr %.074, align 1
  %126 = getelementptr inbounds nuw i8, ptr %.074, i64 1
  %127 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2773
  %128 = load i32, ptr %127, align 4
  %129 = getelementptr inbounds nuw i8, ptr %7, i64 %.2773
...
133:                                              ; preds = %124
  ...
  %exitcond1665 = icmp ne i64 0, %137
  br i1 %exitcond1665, label %.lr.ph70, label %146

.lr.ph70:                                         ; preds = %133
  br label %138

138:                                              ; preds = %.lr.ph70, %138
  %.568 = phi i64 [ 0, %.lr.ph70 ], [ %145, %138 ]
  %.11667 = phi i64 [ %136, %.lr.ph70 ], [ %144, %138 ]
  %.01966 = phi i32 [ 0, %.lr.ph70 ], [ %spec.select1, %138 ]
  %139 = shl i32 %.01966, 1
  %140 = or disjoint i32 %139, 1
  %141 = zext i32 %128 to i64
  %142 = and i64 %.11667, %141
  %.not4 = icmp eq i64 %142, 0
  %143 = add i32 %139, 2
  %spec.select1 = select i1 %.not4, i32 %140, i32 %143
  %144 = lshr i64 %.11667, 1
  %145 = add nuw nsw i64 %.568, 1
  %exitcond16 = icmp ne i64 %145, %137
  br i1 %exitcond16, label %138, label %._crit_edge71, !llvm.loop !17

._crit_edge71:                                    ; preds = %138
  %split72 = phi i32 [ %spec.select1, %138 ]
  br label %146

146:                                              ; preds = %._crit_edge71, %133
  %.019.lcssa = phi i32 [ %split72, %._crit_edge71 ], [ 0, %133 ]
  %147 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2773
  store i32 %.019.lcssa, ptr %147, align 4
  br label %148

148:                                              ; preds = %146, %124
  %149 = add nuw nsw i64 %.2773, 1
  %exitcond17 = icmp ne i64 %149, 256
  br i1 %exitcond17, label %124, label %.preheader2.preheader, !llvm.loop !18

.preheader1.preheader:                            ; preds = %.critedge
  br label %.preheader1

150:                                              ; preds = %.preheader2.preheader, %.critedge
  %.676 = phi i64 [ 1, %.preheader2.preheader ], [ %167, %.critedge ]
  %151 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.676
  %152 = load i32, ptr %151, align 4
  %153 = getelementptr inbounds nuw i8, ptr %9, i64 %.676
  %154 = load i8, ptr %153, align 1
  br label %155

155:                                              ; preds = %150, %160
  %.3875 = phi i64 [ %.676, %150 ], [ %156, %160 ]
  %156 = add nsw i64 %.3875, -1
...
.critedge:                                        ; preds = %155, %160
  ...
  %167 = add nuw nsw i64 %.676, 1
  %exitcond18 = icmp ne i64 %167, 256
  br i1 %exitcond18, label %150, label %.preheader1.preheader, !llvm.loop !20
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %172, label %.lr.ph83, label %195

.lr.ph83:                                         ; preds = %.preheader.preheader
  br label %173

173:                                              ; preds = %.lr.ph83, %.preheader
  %.782 = phi i64 [ %.49.lcssa, %.lr.ph83 ], [ %.9, %.preheader ]
  %.31381 = phi i64 [ 0, %.lr.ph83 ], [ %.414, %.preheader ]
  %.21780 = phi i64 [ 128, %.lr.ph83 ], [ %.318, %.preheader ]
  %.22179 = phi i32 [ 0, %.lr.ph83 ], [ %.423, %.preheader ]
  %.03178 = phi ptr [ %11, %.lr.ph83 ], [ %.132, %.preheader ]
  %.23577 = phi ptr [ %0, %.lr.ph83 ], [ %.336, %.preheader ]
  %174 = shl i32 %.22179, 1
  %175 = or disjoint i32 %174, 1
  %176 = load i8, ptr %.03178, align 1
  %177 = zext i8 %176 to i64
  %178 = and i64 %.21780, %177
...
187:                                              ; preds = %185
  ...
  store i8 %189, ptr %.23577, align 1
  %190 = getelementptr inbounds nuw i8, ptr %.23577, i64 1
  %191 = add nuw i64 %.31381, 1
  br label %.preheader

.preheader:                                       ; preds = %187, %185
  %.336 = phi ptr [ %190, %187 ], [ %.23577, %185 ]
  %.423 = phi i32 [ 0, %187 ], [ %spec.select2, %185 ]
  %.414 = phi i64 [ %191, %187 ], [ %.31381, %185 ]
  %.9 = phi i64 [ %.49.lcssa, %187 ], [ %.8.lcssa, %185 ]
  %192 = icmp ult i64 %.21780, 2
  %193 = lshr i64 %.21780, 1
...
5:                                                ; preds = %6
  ...
  br i1 %exitcond, label %6, label %.loopexit.loopexit, !llvm.loop !25
...
11:                                               ; preds = %.loopexit, %11
  ...
  br i1 %exitcond1, label %11, label %13, !llvm.loop !26
