...
.preheader5:                                      ; preds = %.preheader6, %29
...
.preheader4:                                      ; preds = %.preheader5, %34
...
56:                                               ; preds = %75, %53
  ...
  br i1 %exitcond14, label %57, label %77
...
63:                                               ; preds = %57, %64
  %.043 = phi i64 [ %.144, %64 ], [ 0, %57 ]
  %.042.pn = phi i64 [ %67, %64 ], [ %.042, %57 ]
  %.05 = phi i64 [ %68, %64 ], [ 1, %57 ]
  %.3 = phi i64 [ %69, %64 ], [ 0, %57 ]
...
.preheader3:                                      ; preds = %82, %121
  %.134 = phi ptr [ %122, %121 ], [ %0, %82 ]
  %.028 = phi i64 [ %.129, %121 ], [ 0, %82 ]
  %.024 = phi i8 [ %.125, %121 ], [ 0, %82 ]
  %.16 = phi i64 [ %123, %121 ], [ 0, %82 ]
  %.01 = phi i32 [ %.1, %121 ], [ -1, %82 ]
  %exitcond15 = icmp ne i64 %.16, %1
  br i1 %exitcond15, label %87, label %124
...
124:                                              ; preds = %.preheader3
  %125 = sub nsw i32 7, %.01
  %126 = zext i8 %.024 to i32
  %127 = shl i32 %126, %125
  %128 = trunc i32 %127 to i8
  %129 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
130:                                              ; preds = %156, %124
  ...
  br i1 %exitcond17, label %131, label %.preheader2
...
145:                                              ; preds = %146, %140
  ...
  %exitcond16 = icmp ne i64 %.5, %144
  br i1 %exitcond16, label %146, label %154
...
.preheader2:                                      ; preds = %130, %.critedge
  %.6 = phi i64 [ %176, %.critedge ], [ 1, %130 ]
  %exitcond18 = icmp ne i64 %.6, 256
  br i1 %exitcond18, label %158, label %.preheader1
...
.preheader1:                                      ; preds = %.preheader2, %180
  %.49 = phi i64 [ %181, %180 ], [ 0, %.preheader2 ]
...
.preheader:                                       ; preds = %.preheader1, %203
  %.235 = phi ptr [ %.336, %203 ], [ %0, %.preheader1 ]
  %.031 = phi ptr [ %.132, %203 ], [ %11, %.preheader1 ]
  %.221 = phi i32 [ %.423, %203 ], [ 0, %.preheader1 ]
  %.217 = phi i64 [ %.318, %203 ], [ 128, %.preheader1 ]
  %.313 = phi i64 [ %.414, %203 ], [ 0, %.preheader1 ]
  %.7 = phi i64 [ %.9, %203 ], [ %.49, %.preheader1 ]
...
196:                                              ; preds = %190
  %197 = icmp eq i32 %spec.select2, %192
