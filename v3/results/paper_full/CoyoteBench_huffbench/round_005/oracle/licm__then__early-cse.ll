...
31:                                               ; preds = %32, %.preheader5
  %.24 = phi i64 [ %34, %32 ], [ %.010, %.preheader5 ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4, label %32
...
32:                                               ; preds = %31
  ...
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %22, i32 noundef %33)
  %34 = add i64 %.24, -1
...
91:                                               ; preds = %126, %.preheader3
  ...
  %.028 = phi i64 [ %.129, %126 ], [ 0, %.preheader3 ]
  %.024 = phi i8 [ %.125, %126 ], [ 0, %.preheader3 ]
  %.16 = phi i64 [ %128, %126 ], [ 0, %.preheader3 ]
  %.01 = phi i32 [ %.1, %126 ], [ -1, %.preheader3 ]
  %exitcond15 = icmp ne i64 %.16, %1
  br i1 %exitcond15, label %92, label %129
...
135:                                              ; preds = %161, %129
  ...
  br i1 %exitcond17, label %136, label %.preheader2
...
151:                                              ; preds = %152, %145
  ...
  %.116 = phi i64 [ %148, %145 ], [ %157, %152 ]
  %.5 = phi i64 [ 0, %145 ], [ %158, %152 ]
  %exitcond16 = icmp ne i64 %.5, %149
  br i1 %exitcond16, label %152, label %159
...
152:                                              ; preds = %151
  ...
  %156 = add i32 %153, 2
  %spec.select1 = select i1 %.not4, i32 %154, i32 %156
  %157 = lshr i64 %.116, 1
...
163:                                              ; preds = %.critedge, %.preheader2
  ...
  br i1 %exitcond18, label %164, label %.preheader1
...
204:                                              ; preds = %198
  %205 = icmp eq i32 %spec.select2, %200
