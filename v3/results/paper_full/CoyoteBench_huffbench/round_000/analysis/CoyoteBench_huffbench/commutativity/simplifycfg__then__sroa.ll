...
19:                                               ; preds = %21, %2
  %.0171 = phi ptr [ %0, %2 ], [ %27, %21 ]
  %.0162 = phi i64 [ 0, %2 ], [ %28, %21 ]
  %20 = icmp ult i64 %.0162, %1
  br i1 %20, label %21, label %29

21:                                               ; preds = %19
  %22 = load i8, ptr %.0171, align 1
  %23 = zext i8 %22 to i64
  %24 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %23
  %25 = load i64, ptr %24, align 8
  %26 = add i64 %25, 1
  store i64 %26, ptr %24, align 8
  %27 = getelementptr inbounds nuw i8, ptr %.0171, i32 1
  %28 = add i64 %.0162, 1
...
30:                                               ; preds = %39, %29
  %.0177 = phi i64 [ 0, %29 ], [ %.1178, %39 ]
  %.1163 = phi i64 [ 0, %29 ], [ %40, %39 ]
  %31 = icmp ult i64 %.1163, 256
  br i1 %31, label %32, label %41

32:                                               ; preds = %30
  %33 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %.1163
  %34 = load i64, ptr %33, align 8
  %35 = icmp ne i64 %34, 0
  br i1 %35, label %36, label %39

36:                                               ; preds = %32
  %37 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %.0177
  store i64 %.1163, ptr %37, align 8
  %38 = add i64 %.0177, 1
  br label %39

39:                                               ; preds = %32, %36
  %.1178 = phi i64 [ %38, %36 ], [ %.0177, %32 ]
  %40 = add i64 %.1163, 1
...
87:                                               ; preds = %122, %84
  %.0161 = phi i64 [ 0, %84 ], [ %123, %122 ]
  %.0156 = phi i64 [ 0, %84 ], [ %.2158, %122 ]
  %.0154 = phi i64 [ 0, %84 ], [ %.1155, %122 ]
  %88 = icmp ult i64 %.0161, 256
  br i1 %88, label %89, label %124

89:                                               ; preds = %87
  %90 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %.0161
  %91 = load i64, ptr %90, align 8
  %92 = icmp ne i64 %91, 0
  br i1 %92, label %96, label %93

93:                                               ; preds = %89
  %94 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.0161
  store i32 0, ptr %94, align 4
  %95 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.0161
  store i8 0, ptr %95, align 1
  br label %122

96:                                               ; preds = %89
  %97 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %.0161
  %98 = load i32, ptr %97, align 4
  br label %99

99:                                               ; preds = %106, %96
  %.0166 = phi i64 [ 1, %96 ], [ %110, %106 ]
  %.3165 = phi i64 [ 0, %96 ], [ %111, %106 ]
  %.0159 = phi i64 [ 0, %96 ], [ %.1160, %106 ]
  %.0152 = phi i32 [ %98, %96 ], [ %109, %106 ]
  %100 = icmp ne i32 %.0152, 0
  br i1 %100, label %101, label %112

101:                                              ; preds = %99
  %102 = icmp slt i32 %.0152, 0
  br i1 %102, label %103, label %106

103:                                              ; preds = %101
  %104 = add i64 %.0159, %.0166
  %105 = sub nsw i32 0, %.0152
  br label %106

106:                                              ; preds = %103, %101
  %.1160 = phi i64 [ %104, %103 ], [ %.0159, %101 ]
  %.1153 = phi i32 [ %105, %103 ], [ %.0152, %101 ]
...
112:                                              ; preds = %99
  %113 = trunc i64 %.0159 to i32
  %114 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.0161
  store i32 %113, ptr %114, align 4
  %115 = trunc i64 %.3165 to i8
  %116 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.0161
  store i8 %115, ptr %116, align 1
  %117 = icmp ugt i64 %.0159, %.0156
...
119:                                              ; preds = %118, %112
  %.1157 = phi i64 [ %.0159, %118 ], [ %.0156, %112 ]
  %120 = icmp ugt i64 %.3165, %.0154
...
122:                                              ; preds = %93, %121, %119
  %.2158 = phi i64 [ %.1157, %121 ], [ %.1157, %119 ], [ %.0156, %93 ]
  %.1155 = phi i64 [ %.3165, %121 ], [ %.0154, %119 ], [ %.0154, %93 ]
  %123 = add i64 %.0161, 1
  br label %87, !llvm.loop !14

124:                                              ; preds = %87
  %125 = icmp ugt i64 %.0154, 32
...
135:                                              ; preds = %183, %134
  %.1172 = phi ptr [ %0, %134 ], [ %184, %183 ]
  %.1167 = phi i64 [ 0, %134 ], [ %185, %183 ]
  %.0149 = phi i64 [ 0, %134 ], [ %.1150, %183 ]
  %.0146 = phi i8 [ 0, %134 ], [ %.1147, %183 ]
  %.0145 = phi i32 [ -1, %134 ], [ %.1, %183 ]
  %136 = icmp ult i64 %.1167, %1
  br i1 %136, label %137, label %186

137:                                              ; preds = %135
  %138 = load i8, ptr %.1172, align 1
...
146:                                              ; preds = %180, %137
  %.0182 = phi i64 [ %145, %137 ], [ %181, %180 ]
  %.4 = phi i64 [ 0, %137 ], [ %182, %180 ]
  %.1150 = phi i64 [ %.0149, %137 ], [ %.2151, %180 ]
  %.1147 = phi i8 [ %.0146, %137 ], [ %.3, %180 ]
  %.1 = phi i32 [ %.0145, %137 ], [ %.2, %180 ]
  %147 = load i8, ptr %.1172, align 1
...
155:                                              ; preds = %153
  %156 = getelementptr inbounds nuw i8, ptr %11, i64 %.1150
  store i8 %.1147, ptr %156, align 1
  %157 = add i64 %.1150, 1
...
163:                                              ; preds = %153
  %164 = add nsw i32 %.1, 1
  %165 = sext i8 %.1147 to i32
  %166 = shl i32 %165, 1
  %167 = trunc i32 %166 to i8
  br label %168

168:                                              ; preds = %163, %162
  %.2151 = phi i64 [ %157, %162 ], [ %.1150, %163 ]
  %.2148 = phi i8 [ 0, %162 ], [ %167, %163 ]
  %.2 = phi i32 [ 0, %162 ], [ %164, %163 ]
  %169 = load i8, ptr %.1172, align 1
  %170 = zext i8 %169 to i64
  %171 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %170
  %172 = load i32, ptr %171, align 4
  %173 = zext i32 %172 to i64
  %174 = and i64 %173, %.0182
  %175 = icmp ne i64 %174, 0
  br i1 %175, label %176, label %180

176:                                              ; preds = %168
  %177 = sext i8 %.2148 to i32
  %178 = or i32 %177, 1
  %179 = trunc i32 %178 to i8
  br label %180

180:                                              ; preds = %176, %168
  %.3 = phi i8 [ %179, %176 ], [ %.2148, %168 ]
  %181 = lshr i64 %.0182, 1
  %182 = add i64 %.4, 1
  br label %146, !llvm.loop !15

183:                                              ; preds = %146
  %184 = getelementptr inbounds nuw i8, ptr %.1172, i32 1
  %185 = add i64 %.1167, 1
  br label %135, !llvm.loop !16

186:                                              ; preds = %135
  %187 = sub nsw i32 7, %.0145
  %188 = sext i8 %.0146 to i32
  %189 = shl i32 %188, %187
  %190 = trunc i32 %189 to i8
  %191 = getelementptr inbounds nuw i8, ptr %11, i64 %.0149
...
195:                                              ; preds = %234, %186
  %.2168 = phi i64 [ 0, %186 ], [ %235, %234 ]
  %.0 = phi ptr [ %194, %186 ], [ %199, %234 ]
  %196 = icmp ult i64 %.2168, 256
  br i1 %196, label %197, label %236

197:                                              ; preds = %195
  %198 = trunc i64 %.2168 to i8
  store i8 %198, ptr %.0, align 1
  %199 = getelementptr inbounds nuw i8, ptr %.0, i32 1
  %200 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.2168
  %201 = load i32, ptr %200, align 4
  %202 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.2168
...
207:                                              ; preds = %197
  %208 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.2168
...
214:                                              ; preds = %229, %207
  %.0186 = phi i32 [ 0, %207 ], [ %.1187, %229 ]
  %.1183 = phi i64 [ %213, %207 ], [ %230, %229 ]
  %.5 = phi i64 [ 0, %207 ], [ %231, %229 ]
  %215 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.2168
...
219:                                              ; preds = %214
  %220 = mul i32 %.0186, 2
  %221 = add i32 %220, 1
  %222 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.2168
  %223 = load i32, ptr %222, align 4
  %224 = zext i32 %223 to i64
  %225 = and i64 %224, %.1183
...
229:                                              ; preds = %227, %219
  %.1187 = phi i32 [ %228, %227 ], [ %221, %219 ]
  %230 = lshr i64 %.1183, 1
  %231 = add i64 %.5, 1
  br label %214, !llvm.loop !17

232:                                              ; preds = %214
  %233 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.2168
  store i32 %.0186, ptr %233, align 4
  br label %234
...
244:                                              ; preds = %251, %239
  %.3169 = phi i64 [ %.6, %239 ], [ %260, %251 ]
  %245 = icmp ne i64 %.3169, 0
...
251:                                              ; preds = %246
  ...
  %255 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.3169
  store i32 %254, ptr %255, align 4
  %256 = sub i64 %.3169, 1
  %257 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %256
  %258 = load i8, ptr %257, align 1
  %259 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.3169
  store i8 %258, ptr %259, align 1
  %260 = add i64 %.3169, -1
  br label %244, !llvm.loop !19

.critedge:                                        ; preds = %244, %246
  %261 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.3169
  store i32 %241, ptr %261, align 4
  %262 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.3169
...
265:                                              ; preds = %269, %264
  %.4170 = phi i64 [ 0, %264 ], [ %270, %269 ]
  %266 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.4170
...
272:                                              ; preds = %305, %271
  %.2188 = phi i32 [ 0, %271 ], [ %.4190, %305 ]
  %.2184 = phi i64 [ 128, %271 ], [ %.3185, %305 ]
  %.3180 = phi i64 [ 0, %271 ], [ %.4181, %305 ]
  %.0175 = phi ptr [ %11, %271 ], [ %.1176, %305 ]
  %.2173 = phi ptr [ %0, %271 ], [ %.3174, %305 ]
  %.7 = phi i64 [ %.4170, %271 ], [ %.9, %305 ]
  %273 = icmp ult i64 %.3180, %1
  br i1 %273, label %274, label %306

274:                                              ; preds = %272
  %275 = mul i32 %.2188, 2
  %276 = add i32 %275, 1
  %277 = load i8, ptr %.0175, align 1
  %278 = zext i8 %277 to i64
  %279 = and i64 %278, %.2184
...
290:                                              ; preds = %284
  ...
  %293 = icmp eq i32 %.3189, %292
  br i1 %293, label %294, label %299

294:                                              ; preds = %290
  %295 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
  %296 = load i8, ptr %295, align 1
  store i8 %296, ptr %.2173, align 1
  %297 = getelementptr inbounds nuw i8, ptr %.2173, i32 1
  %298 = add i64 %.3180, 1
  br label %299

299:                                              ; preds = %294, %290
  %.4190 = phi i32 [ 0, %294 ], [ %.3189, %290 ]
  %.4181 = phi i64 [ %298, %294 ], [ %.3180, %290 ]
  %.3174 = phi ptr [ %297, %294 ], [ %.2173, %290 ]
  %.9 = phi i64 [ %.4170, %294 ], [ %.8, %290 ]
  %300 = icmp ugt i64 %.2184, 1
...
303:                                              ; preds = %299
  %304 = getelementptr inbounds nuw i8, ptr %.0175, i32 1
  br label %305

305:                                              ; preds = %303, %301
  %.3185 = phi i64 [ %302, %301 ], [ 128, %303 ]
  %.1176 = phi ptr [ %.0175, %301 ], [ %304, %303 ]
