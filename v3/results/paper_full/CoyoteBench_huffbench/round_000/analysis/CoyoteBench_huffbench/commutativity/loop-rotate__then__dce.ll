...
102:                                              ; preds = %.lr.ph8, %102
  ...
  %110 = getelementptr inbounds [256 x i64], ptr %16, i64 0, i64 0
  store i64 %109, ptr %110, align 16
  %111 = getelementptr inbounds [512 x i64], ptr %15, i64 0, i64 0
  ...
  %115 = getelementptr inbounds [256 x i64], ptr %16, i64 0, i64 0
  ...
  %138 = add i64 256, %137
  %139 = getelementptr inbounds [256 x i64], ptr %16, i64 0, i64 0
  store i64 %138, ptr %139, align 16
  %140 = getelementptr inbounds [512 x i64], ptr %15, i64 0, i64 0
  %141 = getelementptr inbounds [256 x i64], ptr %16, i64 0, i64 0
...
312:                                              ; preds = %._crit_edge21, %228
  ...
  %325 = getelementptr inbounds [256 x i32], ptr %29, i64 0, i64 0
  call void @llvm.memset.p0.i64(ptr align 16 %325, i8 0, i64 1024, i1 false)
  %326 = getelementptr inbounds [256 x i8], ptr %30, i64 0, i64 0
