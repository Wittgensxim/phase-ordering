...
119:                                              ; preds = %84
  %.lcssa6 = phi i64 [ %85, %84 ]
  %120 = add i64 256, %.lcssa6
...
260:                                              ; preds = %208
  %.lcssa4 = phi ptr [ %210, %208 ]
  %261 = getelementptr inbounds nuw i8, ptr %.lcssa4, i32 1
...
327:                                              ; preds = %301
  %.lcssa3 = phi i64 [ %303, %301 ]
  %328 = load i32, ptr %9, align 4
  %329 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %.lcssa3
...
417:                                              ; preds = %409
  %.lcssa2 = phi i64 [ %410, %409 ]
  %.lcssa1 = phi i32 [ %412, %409 ]
  %.lcssa = phi i32 [ %413, %409 ]
  %418 = icmp eq i32 %.lcssa, %.lcssa1
  br i1 %418, label %419, label %428

419:                                              ; preds = %417
  %420 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %.lcssa2
