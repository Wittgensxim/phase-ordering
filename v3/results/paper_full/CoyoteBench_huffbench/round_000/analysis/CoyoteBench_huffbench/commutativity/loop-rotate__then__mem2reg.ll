...
5:                                                ; preds = %.lr.ph, %10
  %.01 = phi ptr [ %2, %.lr.ph ], [ %9, %10 ]
  %.0 = phi i32 [ 0, %.lr.ph ], [ %11, %10 ]
  %6 = call i64 @random4()
  %7 = getelementptr inbounds nuw i8, ptr @.str, i64 %6
  %8 = load i8, ptr %7, align 1
  store i8 %8, ptr %.01, align 1
  %9 = getelementptr inbounds nuw i8, ptr %.01, i32 1
  br label %10
...
20:                                               ; preds = %.lr.ph, %27
  %.082 = phi ptr [ %0, %.lr.ph ], [ %26, %27 ]
  %.041 = phi i64 [ 0, %.lr.ph ], [ %28, %27 ]
  %21 = load i8, ptr %.082, align 1
  %22 = zext i8 %21 to i64
  %23 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %22
  %24 = load i64, ptr %23, align 8
  %25 = add i64 %24, 1
  store i64 %25, ptr %23, align 8
  %26 = getelementptr inbounds nuw i8, ptr %.082, i32 1
  br label %27
...
32:                                               ; preds = %.lr.ph2, %40
  %.052 = phi i64 [ 0, %.lr.ph2 ], [ %.254, %40 ]
  %.142 = phi i64 [ 0, %.lr.ph2 ], [ %41, %40 ]
  %33 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %.142
  %34 = load i64, ptr %33, align 8
  %35 = icmp ne i64 %34, 0
  br i1 %35, label %36, label %39

36:                                               ; preds = %32
  %37 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %.052
  store i64 %.142, ptr %37, align 8
  %38 = add i64 %.052, 1
  br label %39

39:                                               ; preds = %36, %32
  %.254 = phi i64 [ %38, %36 ], [ %.052, %32 ]
  br label %40
...
43:                                               ; preds = %._crit_edge3, %30
  %.153 = phi i64 [ %.254, %._crit_edge3 ], [ 0, %30 ]
  %44 = icmp ugt i64 %.153, 0
...
88:                                               ; preds = %._crit_edge9, %53
  %.456 = phi i64 [ %56, %._crit_edge9 ], [ %.153, %53 ]
  %89 = add i64 256, %.456
...
92:                                               ; preds = %.lr.ph14, %127
  %.096 = phi i64 [ 0, %.lr.ph14 ], [ %.298, %127 ]
  %.092 = phi i64 [ 0, %.lr.ph14 ], [ %128, %127 ]
  %.088 = phi i64 [ 0, %.lr.ph14 ], [ %.290, %127 ]
  %93 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %.092
  %94 = load i64, ptr %93, align 8
  %95 = icmp ne i64 %94, 0
  br i1 %95, label %99, label %96

96:                                               ; preds = %92
  %97 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.092
  store i32 0, ptr %97, align 4
  %98 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.092
  store i8 0, ptr %98, align 1
  br label %126

99:                                               ; preds = %92
  %100 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %.092
...
103:                                              ; preds = %.lr.ph11, %108
  %.093 = phi i64 [ 0, %.lr.ph11 ], [ %.295, %108 ]
  %.086 = phi i32 [ %101, %.lr.ph11 ], [ %111, %108 ]
  %.046 = phi i64 [ 1, %.lr.ph11 ], [ %112, %108 ]
  %.344 = phi i64 [ 0, %.lr.ph11 ], [ %113, %108 ]
  %104 = icmp slt i32 %.086, 0
  br i1 %104, label %105, label %108

105:                                              ; preds = %103
  %106 = add i64 %.093, %.046
  %107 = sub nsw i32 0, %.086
  br label %108

108:                                              ; preds = %105, %103
  %.295 = phi i64 [ %106, %105 ], [ %.093, %103 ]
  %.187 = phi i32 [ %107, %105 ], [ %.086, %103 ]
  %109 = sext i32 %.187 to i64
...
115:                                              ; preds = %._crit_edge12, %99
  %.194 = phi i64 [ %.295, %._crit_edge12 ], [ 0, %99 ]
  %.445 = phi i64 [ %113, %._crit_edge12 ], [ 0, %99 ]
  %116 = trunc i64 %.194 to i32
  %117 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.092
  store i32 %116, ptr %117, align 4
  %118 = trunc i64 %.445 to i8
  %119 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.092
  store i8 %118, ptr %119, align 1
  %120 = icmp ugt i64 %.194, %.096
...
122:                                              ; preds = %121, %115
  %.399 = phi i64 [ %.194, %121 ], [ %.096, %115 ]
  %123 = icmp ugt i64 %.445, %.088
...
125:                                              ; preds = %124, %122
  %.391 = phi i64 [ %.445, %124 ], [ %.088, %122 ]
  br label %126

126:                                              ; preds = %125, %96
  %.298 = phi i64 [ %.399, %125 ], [ %.096, %96 ]
  %.290 = phi i64 [ %.391, %125 ], [ %.088, %96 ]
  br label %127
...
130:                                              ; preds = %._crit_edge15, %88
  %.197 = phi i64 [ %.298, %._crit_edge15 ], [ 0, %88 ]
  %.189 = phi i64 [ %.290, %._crit_edge15 ], [ 0, %88 ]
  %131 = icmp ugt i64 %.189, 32
...
142:                                              ; preds = %.lr.ph20, %196
  %.183 = phi ptr [ %0, %.lr.ph20 ], [ %195, %196 ]
  %.075 = phi i64 [ 0, %.lr.ph20 ], [ %.378, %196 ]
  %.069 = phi i8 [ 0, %.lr.ph20 ], [ %.372, %196 ]
  %.147 = phi i64 [ 0, %.lr.ph20 ], [ %197, %196 ]
  %.040 = phi i32 [ -1, %.lr.ph20 ], [ %.3, %196 ]
  %143 = load i8, ptr %.183, align 1
...
157:                                              ; preds = %.lr.ph17, %186
  %.277 = phi i64 [ %.075, %.lr.ph17 ], [ %.479, %186 ]
  %.271 = phi i8 [ %.069, %.lr.ph17 ], [ %.574, %186 ]
  %.059 = phi i64 [ %150, %.lr.ph17 ], [ %185, %186 ]
  %.5 = phi i64 [ 0, %.lr.ph17 ], [ %187, %186 ]
  %.2 = phi i32 [ %.040, %.lr.ph17 ], [ %.4, %186 ]
  %158 = icmp eq i32 %.2, 7
  br i1 %158, label %159, label %167

159:                                              ; preds = %157
  %160 = getelementptr inbounds nuw i8, ptr %11, i64 %.277
  store i8 %.271, ptr %160, align 1
  %161 = add i64 %.277, 1
...
167:                                              ; preds = %157
  %168 = add nsw i32 %.2, 1
  %169 = sext i8 %.271 to i32
  %170 = shl i32 %169, 1
  %171 = trunc i32 %170 to i8
  br label %172

172:                                              ; preds = %167, %166
  %.479 = phi i64 [ %161, %166 ], [ %.277, %167 ]
  %.473 = phi i8 [ 0, %166 ], [ %171, %167 ]
  %.4 = phi i32 [ 0, %166 ], [ %168, %167 ]
  %173 = load i8, ptr %.183, align 1
...
180:                                              ; preds = %172
  %181 = sext i8 %.473 to i32
  %182 = or i32 %181, 1
  %183 = trunc i32 %182 to i8
  br label %184

184:                                              ; preds = %180, %172
  %.574 = phi i8 [ %183, %180 ], [ %.473, %172 ]
  %185 = lshr i64 %.059, 1
  br label %186
...
194:                                              ; preds = %._crit_edge18, %142
  %.378 = phi i64 [ %.479, %._crit_edge18 ], [ %.075, %142 ]
  %.372 = phi i8 [ %.574, %._crit_edge18 ], [ %.069, %142 ]
  %.3 = phi i32 [ %.4, %._crit_edge18 ], [ %.040, %142 ]
  %195 = getelementptr inbounds nuw i8, ptr %.183, i32 1
  br label %196
...
199:                                              ; preds = %._crit_edge21, %140
  %.176 = phi i64 [ %.378, %._crit_edge21 ], [ 0, %140 ]
  %.170 = phi i8 [ %.372, %._crit_edge21 ], [ 0, %140 ]
  %.1 = phi i32 [ %.3, %._crit_edge21 ], [ -1, %140 ]
  %200 = sub nsw i32 7, %.1
  %201 = sext i8 %.170 to i32
  %202 = shl i32 %201, %200
  %203 = trunc i32 %202 to i8
  %204 = getelementptr inbounds nuw i8, ptr %11, i64 %.176
...
209:                                              ; preds = %.lr.ph26, %251
  %.248 = phi i64 [ 0, %.lr.ph26 ], [ %252, %251 ]
  %.0 = phi ptr [ %207, %.lr.ph26 ], [ %211, %251 ]
  %210 = trunc i64 %.248 to i8
  store i8 %210, ptr %.0, align 1
  %211 = getelementptr inbounds nuw i8, ptr %.0, i32 1
  %212 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.248
  %213 = load i32, ptr %212, align 4
  %214 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.248
...
219:                                              ; preds = %209
  %220 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.248
  %221 = load i8, ptr %220, align 1
  %222 = zext i8 %221 to i32
  %223 = sub nsw i32 %222, 1
  %224 = shl i32 1, %223
  %225 = sext i32 %224 to i64
  %226 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.248
...
230:                                              ; preds = %.lr.ph23, %242
  %.063 = phi i32 [ 0, %.lr.ph23 ], [ %.265, %242 ]
  %.160 = phi i64 [ %225, %.lr.ph23 ], [ %241, %242 ]
  %.6 = phi i64 [ 0, %.lr.ph23 ], [ %243, %242 ]
  %231 = mul i32 %.063, 2
  %232 = add i32 %231, 1
  %233 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.248
...
240:                                              ; preds = %238, %230
  %.265 = phi i32 [ %239, %238 ], [ %232, %230 ]
  %241 = lshr i64 %.160, 1
  br label %242

242:                                              ; preds = %240
  %243 = add i64 %.6, 1
  %244 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.248
...
248:                                              ; preds = %._crit_edge24, %219
  %.164 = phi i32 [ %.265, %._crit_edge24 ], [ 0, %219 ]
  %249 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.248
  store i32 %.164, ptr %249, align 4
  br label %250
...
261:                                              ; preds = %270, %256
  %.349 = phi i64 [ %.7, %256 ], [ %279, %270 ]
  %262 = icmp ne i64 %.349, 0
...
270:                                              ; preds = %268
  ...
  %274 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.349
  store i32 %273, ptr %274, align 4
  %275 = sub i64 %.349, 1
  %276 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %275
  %277 = load i8, ptr %276, align 1
  %278 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.349
  store i8 %277, ptr %278, align 1
  %279 = add i64 %.349, -1
  br label %261, !llvm.loop !19

280:                                              ; preds = %268
  %281 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.349
  store i32 %258, ptr %281, align 4
  %282 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.349
...
296:                                              ; preds = %._crit_edge33, %286
  %.551 = phi i64 [ %292, %._crit_edge33 ], [ 0, %286 ]
...
298:                                              ; preds = %.lr.ph38, %331
  %.284 = phi ptr [ %0, %.lr.ph38 ], [ %.385, %331 ]
  %.080 = phi ptr [ %11, %.lr.ph38 ], [ %.181, %331 ]
  %.366 = phi i32 [ 0, %.lr.ph38 ], [ %.568, %331 ]
  %.261 = phi i64 [ 128, %.lr.ph38 ], [ %.362, %331 ]
  %.557 = phi i64 [ 0, %.lr.ph38 ], [ %.658, %331 ]
  %.8 = phi i64 [ %.551, %.lr.ph38 ], [ %.11, %331 ]
  %299 = mul i32 %.366, 2
  %300 = add i32 %299, 1
  %301 = load i8, ptr %.080, align 1
...
320:                                              ; preds = %316
  ...
  %323 = getelementptr inbounds nuw i8, ptr %.284, i32 1
  %324 = add i64 %.557, 1
  br label %325

325:                                              ; preds = %320, %316
  %.385 = phi ptr [ %323, %320 ], [ %.284, %316 ]
  %.568 = phi i32 [ 0, %320 ], [ %.467, %316 ]
  %.658 = phi i64 [ %324, %320 ], [ %.557, %316 ]
  %.11 = phi i64 [ %.551, %320 ], [ %.10, %316 ]
  %326 = icmp ugt i64 %.261, 1
...
329:                                              ; preds = %325
  %330 = getelementptr inbounds nuw i8, ptr %.080, i32 1
  br label %331

331:                                              ; preds = %329, %327
  %.181 = phi ptr [ %.080, %327 ], [ %330, %329 ]
  %.362 = phi i64 [ %328, %327 ], [ 128, %329 ]
  %332 = icmp ult i64 %.658, %1
...
12:                                               ; preds = %.lr.ph, %42
  %.01 = phi i32 [ %3, %.lr.ph ], [ %.0, %42 ]
  %13 = add nsw i32 %.01, %.01
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %4
  %.2 = phi i32 [ %.0, %..loopexit_crit_edge ], [ %3, %4 ]
  br label %52

52:                                               ; preds = %.loopexit, %41
  %.1 = phi i32 [ %.01, %41 ], [ %.2, %.loopexit ]
