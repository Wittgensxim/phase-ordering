...
12:                                               ; preds = %21, %2
  %.0172 = phi ptr [ %0, %2 ], [ %20, %21 ]
  %.0163 = phi i64 [ 0, %2 ], [ %22, %21 ]
...
24:                                               ; preds = %34, %23
  %.0178 = phi i64 [ 0, %23 ], [ %.1179, %34 ]
  %.1164 = phi i64 [ 0, %23 ], [ %35, %34 ]
  %25 = icmp ult i64 %.1164, 256
  br i1 %25, label %26, label %36

26:                                               ; preds = %24
  %27 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %.1164
  %28 = load i64, ptr %27, align 8
  %29 = icmp ne i64 %28, 0
  br i1 %29, label %30, label %33

30:                                               ; preds = %26
  %31 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 %.0178
  store i64 %.1164, ptr %31, align 8
  %32 = add i64 %.0178, 1
  br label %33

33:                                               ; preds = %30, %26
  %.1179 = phi i64 [ %32, %30 ], [ %.0178, %26 ]
  br label %34
...
37:                                               ; preds = %42, %36
  %.2165 = phi i64 [ %.0178, %36 ], [ %43, %42 ]
  %38 = icmp ugt i64 %.2165, 0
  br i1 %38, label %39, label %44

39:                                               ; preds = %37
  %40 = trunc i64 %.0178 to i32
  %41 = trunc i64 %.2165 to i32
...
45:                                               ; preds = %47, %44
  %.2180 = phi i64 [ %.0178, %44 ], [ %48, %47 ]
  %46 = icmp ugt i64 %.2180, 1
...
70:                                               ; preds = %107, %67
  %.0162 = phi i64 [ 0, %67 ], [ %108, %107 ]
  %.0157 = phi i64 [ 0, %67 ], [ %.1158, %107 ]
  %.0154 = phi i64 [ 0, %67 ], [ %.1155, %107 ]
  %71 = icmp ult i64 %.0162, 256
  br i1 %71, label %72, label %109

72:                                               ; preds = %70
  %73 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 %.0162
  %74 = load i64, ptr %73, align 8
  %75 = icmp ne i64 %74, 0
  br i1 %75, label %79, label %76

76:                                               ; preds = %72
  %77 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.0162
  store i32 0, ptr %77, align 4
  %78 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.0162
  store i8 0, ptr %78, align 1
  br label %106

79:                                               ; preds = %72
  %80 = getelementptr inbounds nuw [512 x i32], ptr %5, i64 0, i64 %.0162
  %81 = load i32, ptr %80, align 4
  br label %82

82:                                               ; preds = %89, %79
  %.0167 = phi i64 [ 1, %79 ], [ %93, %89 ]
  %.3166 = phi i64 [ 0, %79 ], [ %94, %89 ]
  %.0160 = phi i64 [ 0, %79 ], [ %.1161, %89 ]
  %.0152 = phi i32 [ %81, %79 ], [ %92, %89 ]
  %83 = icmp ne i32 %.0152, 0
...
86:                                               ; preds = %84
  %87 = add i64 %.0160, %.0167
  %88 = sub nsw i32 0, %.0152
  br label %89

89:                                               ; preds = %86, %84
  %.1161 = phi i64 [ %87, %86 ], [ %.0160, %84 ]
  %.1153 = phi i32 [ %88, %86 ], [ %.0152, %84 ]
  %90 = sext i32 %.1153 to i64
...
102:                                              ; preds = %101, %95
  %.2159 = phi i64 [ %.0160, %101 ], [ %.0157, %95 ]
  %103 = icmp ugt i64 %.3166, %.0154
...
105:                                              ; preds = %104, %102
  %.2156 = phi i64 [ %.3166, %104 ], [ %.0154, %102 ]
  br label %106

106:                                              ; preds = %105, %76
  %.1158 = phi i64 [ %.2159, %105 ], [ %.0157, %76 ]
  %.1155 = phi i64 [ %.2156, %105 ], [ %.0154, %76 ]
  br label %107
...
120:                                              ; preds = %171, %119
  %.1173 = phi ptr [ %0, %119 ], [ %170, %171 ]
  %.1168 = phi i64 [ 0, %119 ], [ %172, %171 ]
  %.0149 = phi i64 [ 0, %119 ], [ %.1150, %171 ]
  %.0146 = phi i8 [ 0, %119 ], [ %.1147, %171 ]
  %.0145 = phi i32 [ -1, %119 ], [ %.1, %171 ]
  %121 = icmp ult i64 %.1168, %1
  br i1 %121, label %122, label %173

122:                                              ; preds = %120
  %123 = load i8, ptr %.1173, align 1
...
131:                                              ; preds = %167, %122
  %.0183 = phi i64 [ %130, %122 ], [ %166, %167 ]
  %.4 = phi i64 [ 0, %122 ], [ %168, %167 ]
  %.1150 = phi i64 [ %.0149, %122 ], [ %.2151, %167 ]
  %.1147 = phi i8 [ %.0146, %122 ], [ %.3, %167 ]
  %.1 = phi i32 [ %.0145, %122 ], [ %.2, %167 ]
  %132 = load i8, ptr %.1173, align 1
...
140:                                              ; preds = %138
  %141 = getelementptr inbounds nuw i8, ptr %11, i64 %.1150
  store i8 %.1147, ptr %141, align 1
  %142 = add i64 %.1150, 1
...
148:                                              ; preds = %138
  %149 = add nsw i32 %.1, 1
  %150 = sext i8 %.1147 to i32
  %151 = shl i32 %150, 1
  %152 = trunc i32 %151 to i8
  br label %153

153:                                              ; preds = %148, %147
  %.2151 = phi i64 [ %142, %147 ], [ %.1150, %148 ]
  %.2148 = phi i8 [ 0, %147 ], [ %152, %148 ]
  ...
  %159 = and i64 %158, %.0183
  %160 = icmp ne i64 %159, 0
  br i1 %160, label %161, label %165

161:                                              ; preds = %153
  %162 = sext i8 %.2148 to i32
  %163 = or i32 %162, 1
  %164 = trunc i32 %163 to i8
  br label %165

165:                                              ; preds = %161, %153
  %.3 = phi i8 [ %164, %161 ], [ %.2148, %153 ]
  %166 = lshr i64 %.0183, 1
  br label %167
...
169:                                              ; preds = %131
  %170 = getelementptr inbounds nuw i8, ptr %.1173, i32 1
  br label %171
...
173:                                              ; preds = %120
  %174 = sub nsw i32 7, %.0145
  %175 = sext i8 %.0146 to i32
  %176 = shl i32 %175, %174
  %177 = trunc i32 %176 to i8
  %178 = getelementptr inbounds nuw i8, ptr %11, i64 %.0149
  store i8 %177, ptr %178, align 1
  call void @llvm.memset.p0.i64(ptr align 16 %8, i8 0, i64 1024, i1 false)
  br label %179

179:                                              ; preds = %215, %173
  %.2169 = phi i64 [ 0, %173 ], [ %216, %215 ]
  %.0 = phi ptr [ %9, %173 ], [ %183, %215 ]
  %180 = icmp ult i64 %.2169, 256
  br i1 %180, label %181, label %217

181:                                              ; preds = %179
  %182 = trunc i64 %.2169 to i8
  store i8 %182, ptr %.0, align 1
  %183 = getelementptr inbounds nuw i8, ptr %.0, i32 1
  %184 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.2169
  %185 = load i32, ptr %184, align 4
  %186 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.2169
...
195:                                              ; preds = %210, %191
  %.0187 = phi i32 [ 0, %191 ], [ %.1188, %210 ]
  %.1184 = phi i64 [ %194, %191 ], [ %209, %210 ]
...
212:                                              ; preds = %195
  %213 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.2169
  store i32 %.0187, ptr %213, align 4
  br label %214
...
225:                                              ; preds = %234, %220
  %.3170 = phi i64 [ %.6, %220 ], [ %242, %234 ]
  %226 = icmp ne i64 %.3170, 0
...
234:                                              ; preds = %232
  ...
  %238 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.3170
  store i32 %237, ptr %238, align 4
  %239 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %235
  %240 = load i8, ptr %239, align 1
  %241 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.3170
  store i8 %240, ptr %241, align 1
  %242 = add i64 %.3170, -1
  br label %225, !llvm.loop !19

243:                                              ; preds = %232
  %244 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.3170
...
249:                                              ; preds = %254, %248
  %.4171 = phi i64 [ 0, %248 ], [ %255, %254 ]
  %250 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.4171
...
257:                                              ; preds = %288, %256
  %.2189 = phi i32 [ 0, %256 ], [ %.4191, %288 ]
  %.2185 = phi i64 [ 128, %256 ], [ %.3186, %288 ]
  %.3181 = phi i64 [ 0, %256 ], [ %.4182, %288 ]
  %.0176 = phi ptr [ %11, %256 ], [ %.1177, %288 ]
  %.2174 = phi ptr [ %0, %256 ], [ %.3175, %288 ]
  %.7 = phi i64 [ %.4171, %256 ], [ %.9, %288 ]
  %258 = icmp ult i64 %.3181, %1
  br i1 %258, label %259, label %289

259:                                              ; preds = %257
  %260 = mul i32 %.2189, 2
  %261 = add i32 %260, 1
  %262 = load i8, ptr %.0176, align 1
  %263 = zext i8 %262 to i64
  %264 = and i64 %263, %.2185
...
275:                                              ; preds = %269
  %276 = icmp eq i32 %.3190, %271
  br i1 %276, label %277, label %282

277:                                              ; preds = %275
  %278 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
  %279 = load i8, ptr %278, align 1
  store i8 %279, ptr %.2174, align 1
  %280 = getelementptr inbounds nuw i8, ptr %.2174, i32 1
  %281 = add i64 %.3181, 1
  br label %282

282:                                              ; preds = %277, %275
  %.4191 = phi i32 [ 0, %277 ], [ %.3190, %275 ]
  %.4182 = phi i64 [ %281, %277 ], [ %.3181, %275 ]
  %.3175 = phi ptr [ %280, %277 ], [ %.2174, %275 ]
  %.9 = phi i64 [ %.4171, %277 ], [ %.8, %275 ]
  %283 = icmp ugt i64 %.2185, 1
...
286:                                              ; preds = %282
  %287 = getelementptr inbounds nuw i8, ptr %.0176, i32 1
  br label %288

288:                                              ; preds = %286, %284
  %.3186 = phi i64 [ %285, %284 ], [ 128, %286 ]
  %.1177 = phi ptr [ %.0176, %284 ], [ %287, %286 ]
