...
43:                                               ; preds = %31
  ...
  %46 = trunc i64 %.0178.lcssa to i32
  br label %47

47:                                               ; preds = %51, %43
  %.2165 = phi i64 [ %.0178.lcssa, %43 ], [ %52, %51 ]
  %48 = icmp ugt i64 %.2165, 0
...
63:                                               ; preds = %65, %53
  %.2180 = phi i64 [ %.0178.lcssa, %53 ], [ %66, %65 ]
  %64 = icmp ugt i64 %.2180, 1
...
88:                                               ; preds = %63
  %.2180.lcssa = phi i64 [ %.2180, %63 ]
  %89 = add i64 256, %.2180.lcssa
...
116:                                              ; preds = %103
  %.3166.lcssa = phi i64 [ %.3166, %103 ]
  %.0160.lcssa = phi i64 [ %.0160, %103 ]
  %117 = trunc i64 %.0160.lcssa to i32
  %118 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.0162
  store i32 %117, ptr %118, align 4
  %119 = trunc i64 %.3166.lcssa to i8
  %120 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.0162
  store i8 %119, ptr %120, align 1
  %121 = icmp ugt i64 %.0160.lcssa, %.0157
...
123:                                              ; preds = %122, %116
  %.2159 = phi i64 [ %.0160.lcssa, %122 ], [ %.0157, %116 ]
  %124 = icmp ugt i64 %.3166.lcssa, %.0154
...
126:                                              ; preds = %125, %123
  %.2156 = phi i64 [ %.3166.lcssa, %125 ], [ %.0154, %123 ]
  br label %127
...
130:                                              ; preds = %91
  %.0157.lcssa = phi i64 [ %.0157, %91 ]
  %.0154.lcssa = phi i64 [ %.0154, %91 ]
  %131 = icmp ugt i64 %.0154.lcssa, 32
...
141:                                              ; preds = %192, %140
  ...
  %.0149 = phi i64 [ 0, %140 ], [ %.1150.lcssa, %192 ]
  %.0146 = phi i8 [ 0, %140 ], [ %.1147.lcssa, %192 ]
  %.0145 = phi i32 [ -1, %140 ], [ %.1.lcssa, %192 ]
...
190:                                              ; preds = %152
  %.1150.lcssa = phi i64 [ %.1150, %152 ]
  %.1147.lcssa = phi i8 [ %.1147, %152 ]
...
194:                                              ; preds = %141
  %.0149.lcssa = phi i64 [ %.0149, %141 ]
  %.0146.lcssa = phi i8 [ %.0146, %141 ]
  %.0145.lcssa = phi i32 [ %.0145, %141 ]
  %195 = sub nsw i32 7, %.0145.lcssa
  %196 = sext i8 %.0146.lcssa to i32
  %197 = shl i32 %196, %195
  %198 = trunc i32 %197 to i8
  %199 = getelementptr inbounds nuw i8, ptr %11, i64 %.0149.lcssa
  store i8 %198, ptr %199, align 1
  %200 = add i64 %.0149.lcssa, 1
...
215:                                              ; preds = %205
  ...
  %225 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.2169
  br label %226
...
241:                                              ; preds = %226
  %.0187.lcssa = phi i32 [ %.0187, %226 ]
  %242 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.2169
  store i32 %.0187.lcssa, ptr %242, align 4
  br label %243
...
273:                                              ; preds = %261
  %.3170.lcssa = phi i64 [ %.3170, %261 ]
  %274 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.3170.lcssa
  store i32 %251, ptr %274, align 4
  %275 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.3170.lcssa
...
287:                                              ; preds = %320, %286
  ...
  %.7 = phi i64 [ %.4171.lcssa, %286 ], [ %.9, %320 ]
...
314:                                              ; preds = %309, %305
  ...
  %.9 = phi i64 [ %.4171.lcssa, %309 ], [ %.8.lcssa, %305 ]
