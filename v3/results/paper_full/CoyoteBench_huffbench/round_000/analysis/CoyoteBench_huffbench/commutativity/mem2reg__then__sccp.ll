...
46:                                               ; preds = %44
  %47 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 0
  %48 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 0
...
56:                                               ; preds = %54
  ...
  %63 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 0
  ...
  %66 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 0
  ...
  %85 = getelementptr inbounds nuw [512 x i64], ptr %3, i64 0, i64 0
  %86 = getelementptr inbounds nuw [256 x i64], ptr %4, i64 0, i64 0
  %87 = trunc i64 %57 to i32
  call void @heap_adjust(ptr noundef %85, ptr noundef %86, i32 noundef %87, i32 noundef 1)
  br label %54, !llvm.loop !12

88:                                               ; preds = %54
  %89 = add nuw nsw i64 256, %.212
...
123:                                              ; preds = %122, %116
  %.247 = phi i64 [ %.043, %122 ], [ %.045, %116 ]
  %124 = icmp ugt i64 %.3, %.039
...
141:                                              ; preds = %192, %140
  ...
  %.028 = phi i64 [ 0, %140 ], [ %.129, %192 ]
  %.024 = phi i8 [ 0, %140 ], [ %.125, %192 ]
  %.16 = phi i64 [ 0, %140 ], [ %193, %192 ]
  %.01 = phi i32 [ -1, %140 ], [ %.1, %192 ]
...
194:                                              ; preds = %141
  %195 = sub nsw i32 7, %.01
  %196 = sext i8 %.024 to i32
  %197 = shl i32 %196, %195
  %198 = trunc i32 %197 to i8
  %199 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
  store i8 %198, ptr %199, align 1
  %200 = add i64 %.028, 1
  %201 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 0
  call void @llvm.memset.p0.i64(ptr align 16 %201, i8 0, i64 1024, i1 false)
  %202 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 0
  br label %203

203:                                              ; preds = %244, %194
  %.27 = phi i64 [ 0, %194 ], [ %245, %244 ]
  %.0 = phi ptr [ %202, %194 ], [ %207, %244 ]
  %204 = icmp ult i64 %.27, 256
  br i1 %204, label %205, label %246

205:                                              ; preds = %203
  %206 = trunc nuw i64 %.27 to i8
  store i8 %206, ptr %.0, align 1
  %207 = getelementptr inbounds nuw i8, ptr %.0, i32 1
  %208 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.27
...
222:                                              ; preds = %239, %215
  %.019 = phi i32 [ 0, %215 ], [ %.120, %239 ]
  %.116 = phi i64 [ %221, %215 ], [ %238, %239 ]
  %.5 = phi i64 [ 0, %215 ], [ %240, %239 ]
  %223 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.27
...
227:                                              ; preds = %222
  %228 = mul i32 %.019, 2
  %229 = add i32 %228, 1
  %230 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.27
...
239:                                              ; preds = %237
  %240 = add nuw nsw i64 %.5, 1
  br label %222, !llvm.loop !17

241:                                              ; preds = %222
  %242 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.27
  store i32 %.019, ptr %242, align 4
  br label %243
...
254:                                              ; preds = %263, %249
  %.38 = phi i64 [ %.6, %249 ], [ %272, %263 ]
  %255 = icmp ne i64 %.38, 0
  br i1 %255, label %256, label %261

256:                                              ; preds = %254
  %257 = sub nuw i64 %.38, 1
...
273:                                              ; preds = %261
  %274 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38
...
279:                                              ; preds = %284, %278
  %.49 = phi i64 [ 0, %278 ], [ %285, %284 ]
  %280 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.49
...
287:                                              ; preds = %320, %286
  %.235 = phi ptr [ %0, %286 ], [ %.336, %320 ]
  %.031 = phi ptr [ %11, %286 ], [ %.132, %320 ]
  %.221 = phi i32 [ 0, %286 ], [ %.423, %320 ]
  %.217 = phi i64 [ 128, %286 ], [ %.318, %320 ]
  %.313 = phi i64 [ 0, %286 ], [ %.414, %320 ]
  %.7 = phi i64 [ %.49, %286 ], [ %.9, %320 ]
  %288 = icmp ult i64 %.313, %1
  br i1 %288, label %289, label %321

289:                                              ; preds = %287
  %290 = mul i32 %.221, 2
  %291 = add i32 %290, 1
  %292 = load i8, ptr %.031, align 1
...
309:                                              ; preds = %305
  ...
  store i8 %311, ptr %.235, align 1
  %312 = getelementptr inbounds nuw i8, ptr %.235, i32 1
  %313 = add i64 %.313, 1
  br label %314

314:                                              ; preds = %309, %305
  %.336 = phi ptr [ %312, %309 ], [ %.235, %305 ]
  %.423 = phi i32 [ 0, %309 ], [ %.322, %305 ]
  %.414 = phi i64 [ %313, %309 ], [ %.313, %305 ]
  %.9 = phi i64 [ %.49, %309 ], [ %.8, %305 ]
  %315 = icmp ugt i64 %.217, 1
...
318:                                              ; preds = %314
  %319 = getelementptr inbounds nuw i8, ptr %.031, i32 1
  br label %320

320:                                              ; preds = %318, %316
  %.132 = phi ptr [ %.031, %316 ], [ %319, %318 ]
