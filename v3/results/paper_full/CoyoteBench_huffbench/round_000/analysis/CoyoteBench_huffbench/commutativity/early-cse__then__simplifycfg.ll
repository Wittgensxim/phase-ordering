...
153:                                              ; preds = %133
  ...
  %spec.store.select = select i1 %164, i64 %162, i64 %163
  store i64 %spec.store.select, ptr %23, align 8
  %165 = load i64, ptr %5, align 8
  %166 = load i64, ptr %24, align 8
  %167 = icmp ugt i64 %165, %166
  %spec.store.select1 = select i1 %167, i64 %165, i64 %166
  store i64 %spec.store.select1, ptr %24, align 8
  br label %168
...
174:                                              ; preds = %171
  ...
  %176 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %175, ptr noundef @.str.1) #7
...
181:                                              ; preds = %177
  %182 = call ptr @__acrt_iob_func(i32 noundef 2)
  %183 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %182, ptr noundef @.str.2) #7
  call void @exit(i32 noundef 1) #8
  unreachable
...
199:                                              ; preds = %245, %189
  ...
  %204 = getelementptr inbounds nuw [256 x i8], ptr %19, i64 0, i64 %203
...
250:                                              ; preds = %199
  %251 = getelementptr inbounds nuw i8, ptr %201, i32 1
...
269:                                              ; preds = %266
  ...
  %275 = getelementptr inbounds nuw [256 x i32], ptr %18, i64 0, i64 %274
  %276 = load i32, ptr %275, align 4
  %277 = getelementptr inbounds nuw [256 x i8], ptr %19, i64 0, i64 %274
...
282:                                              ; preds = %269
  ...
  %284 = getelementptr inbounds nuw [256 x i8], ptr %19, i64 0, i64 %283
...
290:                                              ; preds = %310, %282
  ...
  %293 = getelementptr inbounds nuw [256 x i8], ptr %19, i64 0, i64 %292
...
297:                                              ; preds = %290
  ...
  %302 = getelementptr inbounds nuw [256 x i32], ptr %18, i64 0, i64 %301
...
315:                                              ; preds = %290
  ...
  %317 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %292
...
325:                                              ; preds = %322
  ...
  %329 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %328
...
341:                                              ; preds = %335
  ...
  %346 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %342
  store i32 %345, ptr %346, align 4
  %347 = load i64, ptr %6, align 8
  %348 = sub i64 %347, 1
  %349 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %348
...
.critedge:                                        ; preds = %332, %335
  %354 = load i32, ptr %10, align 4
  %355 = load i64, ptr %6, align 8
  %356 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %355
  store i32 %354, ptr %356, align 4
  %357 = load i8, ptr %11, align 1
  %358 = load i64, ptr %6, align 8
  %359 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %358
...
363:                                              ; preds = %368, %362
  ...
  %365 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %364
...
391:                                              ; preds = %397, %390
  ...
  %393 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %392
...
397:                                              ; preds = %391
  %398 = add i64 %392, 1
  store i64 %398, ptr %5, align 8
  br label %391, !llvm.loop !22

399:                                              ; preds = %391
  %400 = icmp eq i32 %395, %394
  br i1 %400, label %401, label %410

401:                                              ; preds = %399
  %402 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %392
...
419:                                              ; preds = %374
  ...
  call void @free(ptr noundef %420)
  ret void
}
