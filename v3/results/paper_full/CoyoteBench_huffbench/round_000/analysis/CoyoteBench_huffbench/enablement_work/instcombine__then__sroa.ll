...
30:                                               ; preds = %27
  %31 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.0151
  store i64 %storemerge1, ptr %31, align 8
  %32 = add i64 %.0151, 1
  br label %33

33:                                               ; preds = %30, %27
  %.1152 = phi i64 [ %.0151, %27 ], [ %32, %30 ]
  br label %34
...
37:                                               ; preds = %41, %36
  %storemerge2 = phi i64 [ %.0151, %36 ], [ %42, %41 ]
  %.not = icmp eq i64 %storemerge2, 0
  br i1 %.not, label %43, label %38

38:                                               ; preds = %37
  %39 = trunc i64 %.0151 to i32
...
44:                                               ; preds = %46, %43
  %.2153 = phi i64 [ %.0151, %43 ], [ %47, %46 ]
  %45 = icmp ugt i64 %.2153, 1
...
69:                                               ; preds = %44
  %70 = getelementptr [4 x i8], ptr %5, i64 %.2153
  %71 = getelementptr i8, ptr %70, i64 1024
  store i32 0, ptr %71, align 4
  br label %72

72:                                               ; preds = %107, %69
  %.0142 = phi i64 [ 0, %69 ], [ %.1143, %107 ]
  %.0139 = phi i64 [ 0, %69 ], [ %.1140, %107 ]
...
83:                                               ; preds = %89, %80
  %.0150 = phi i64 [ 1, %80 ], [ %93, %89 ]
  %.0147 = phi i64 [ 0, %80 ], [ %94, %89 ]
  %.0145 = phi i64 [ 0, %80 ], [ %.1146, %89 ]
  %.0137 = phi i32 [ %82, %80 ], [ %92, %89 ]
  %.not18 = icmp eq i32 %.0137, 0
  br i1 %.not18, label %95, label %84

84:                                               ; preds = %83
  %85 = icmp slt i32 %.0137, 0
  br i1 %85, label %86, label %89

86:                                               ; preds = %84
  %87 = add i64 %.0145, %.0150
  %88 = sub nsw i32 0, %.0137
  br label %89

89:                                               ; preds = %86, %84
  %.1146 = phi i64 [ %87, %86 ], [ %.0145, %84 ]
  %.1138 = phi i32 [ %88, %86 ], [ %.0137, %84 ]
  %90 = sext i32 %.1138 to i64
...
102:                                              ; preds = %101, %95
  %.2144 = phi i64 [ %.0145, %101 ], [ %.0142, %95 ]
  %103 = icmp ugt i64 %.0147, %.0139
...
105:                                              ; preds = %104, %102
  %.2141 = phi i64 [ %.0147, %104 ], [ %.0139, %102 ]
  br label %106

106:                                              ; preds = %105, %77
  %.1143 = phi i64 [ %.0142, %77 ], [ %.2144, %105 ]
  %.1140 = phi i64 [ %.0139, %77 ], [ %.2141, %105 ]
  br label %107
...
120:                                              ; preds = %166, %119
  %.1156 = phi ptr [ %0, %119 ], [ %165, %166 ]
  %.0134 = phi i64 [ 0, %119 ], [ %.1135, %166 ]
  %.0131 = phi i8 [ 0, %119 ], [ %.1132, %166 ]
  %.0130 = phi i32 [ -1, %119 ], [ %.1, %166 ]
  %storemerge4 = phi i64 [ 0, %119 ], [ %167, %166 ]
  %121 = icmp ult i64 %storemerge4, %1
  br i1 %121, label %122, label %168

122:                                              ; preds = %120
  %123 = load i8, ptr %.1156, align 1
...
131:                                              ; preds = %162, %122
  %.0161 = phi i64 [ %130, %122 ], [ %161, %162 ]
  %.1135 = phi i64 [ %.0134, %122 ], [ %.2136, %162 ]
  %.1132 = phi i8 [ %.0131, %122 ], [ %.2133, %162 ]
  %.1 = phi i32 [ %.0130, %122 ], [ %.2, %162 ]
  %storemerge14 = phi i64 [ 0, %122 ], [ %163, %162 ]
  %132 = load i8, ptr %.1156, align 1
...
140:                                              ; preds = %138
  %141 = getelementptr inbounds nuw i8, ptr %11, i64 %.1135
  store i8 %.1132, ptr %141, align 1
  %142 = add i64 %.1135, 1
...
160:                                              ; preds = %158, %151
  %.2133 = phi i8 [ %storemerge15, %151 ], [ %159, %158 ]
  %161 = lshr i64 %.0161, 1
  br label %162
...
164:                                              ; preds = %131
  %165 = getelementptr inbounds nuw i8, ptr %.1156, i64 1
  br label %166
...
168:                                              ; preds = %120
  %169 = sub nsw i32 7, %.0130
  %170 = zext i8 %.0131 to i32
  %171 = shl i32 %170, %169
  %172 = trunc i32 %171 to i8
  %173 = getelementptr inbounds nuw i8, ptr %11, i64 %.0134
...
193:                                              ; preds = %209, %186
  %.0165 = phi i32 [ 0, %186 ], [ %.1166, %209 ]
  %.1162 = phi i64 [ %192, %186 ], [ %208, %209 ]
...
211:                                              ; preds = %193
  ...
  store i32 %.0165, ptr %212, align 4
  br label %213
...
256:                                              ; preds = %288, %255
  %.2167 = phi i32 [ 0, %255 ], [ %.4169, %288 ]
  %.2163 = phi i64 [ 128, %255 ], [ %.3164, %288 ]
  %.0159 = phi ptr [ %11, %255 ], [ %.1160, %288 ]
  %.2157 = phi ptr [ %0, %255 ], [ %.3158, %288 ]
  %.3154 = phi i64 [ 0, %255 ], [ %.4, %288 ]
  %.1148 = phi i64 [ %storemerge7, %255 ], [ %.3, %288 ]
  %257 = icmp ult i64 %.3154, %1
  br i1 %257, label %258, label %289

258:                                              ; preds = %256
  %259 = shl i32 %.2167, 1
  %260 = or disjoint i32 %259, 1
  %261 = load i8, ptr %.0159, align 1
  %262 = zext i8 %261 to i64
  %263 = and i64 %.2163, %262
...
266:                                              ; preds = %264, %258
  %.3168 = phi i32 [ %260, %258 ], [ %265, %264 ]
  br label %267

267:                                              ; preds = %271, %266
  %.2149 = phi i64 [ %.1148, %266 ], [ %272, %271 ]
  %268 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2149
  %269 = load i32, ptr %268, align 4
  %270 = icmp ult i32 %269, %.3168
...
273:                                              ; preds = %267
  %274 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2149
  %275 = load i32, ptr %274, align 4
  %276 = icmp eq i32 %.3168, %275
  br i1 %276, label %277, label %282

277:                                              ; preds = %273
  %278 = getelementptr inbounds nuw i8, ptr %9, i64 %.2149
  %279 = load i8, ptr %278, align 1
  store i8 %279, ptr %.2157, align 1
  %280 = getelementptr inbounds nuw i8, ptr %.2157, i64 1
  %281 = add i64 %.3154, 1
  br label %282

282:                                              ; preds = %277, %273
  %.4169 = phi i32 [ 0, %277 ], [ %.3168, %273 ]
  %.3158 = phi ptr [ %280, %277 ], [ %.2157, %273 ]
  %.4 = phi i64 [ %281, %277 ], [ %.3154, %273 ]
  %.3 = phi i64 [ %storemerge7, %277 ], [ %.2149, %273 ]
  %283 = icmp ugt i64 %.2163, 1
...
286:                                              ; preds = %282
  %287 = getelementptr inbounds nuw i8, ptr %.0159, i64 1
  br label %288

288:                                              ; preds = %286, %284
  %.3164 = phi i64 [ %285, %284 ], [ 128, %286 ]
  %.1160 = phi ptr [ %.0159, %284 ], [ %287, %286 ]
