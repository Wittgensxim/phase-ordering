...
277:                                              ; preds = %.critedge, %276
  %278 = phi i64 [ %301, %.critedge ], [ 1, %276 ]
...
293:                                              ; preds = %288
  %294 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %286
  store i32 %291, ptr %294, align 4
  %295 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %289
  %296 = load i8, ptr %295, align 1
  %297 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %286
...
.critedge:                                        ; preds = %285, %288
  %299 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %286
...
303:                                              ; preds = %308, %302
  %304 = phi i64 [ %309, %308 ], [ 0, %302 ]
  %305 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %304
...
313:                                              ; preds = %360, %310
  %314 = phi ptr [ %351, %360 ], [ %312, %310 ]
  %315 = phi i64 [ %352, %360 ], [ %304, %310 ]
  %316 = phi i64 [ %361, %360 ], [ 128, %310 ]
  %317 = phi ptr [ %362, %360 ], [ %311, %310 ]
  %318 = phi i32 [ %353, %360 ], [ 0, %310 ]
  %319 = phi i64 [ %354, %360 ], [ 0, %310 ]
  %320 = icmp ult i64 %319, %.pre
...
330:                                              ; preds = %328, %321
  %331 = phi i32 [ %329, %328 ], [ %323, %321 ]
  br label %332

332:                                              ; preds = %337, %330
  %333 = phi i64 [ %338, %337 ], [ %315, %330 ]
  %334 = getelementptr inbounds nuw [256 x i32], ptr %29, i64 0, i64 %333
...
339:                                              ; preds = %332
  %340 = icmp eq i32 %331, %335
  br i1 %340, label %341, label %349

341:                                              ; preds = %339
  %342 = getelementptr inbounds nuw [256 x i8], ptr %30, i64 0, i64 %333
  %343 = load i8, ptr %342, align 1
  store i8 %343, ptr %314, align 1
...
349:                                              ; preds = %341, %339
  %350 = phi i64 [ %.pre1, %341 ], [ %316, %339 ]
  %351 = phi ptr [ %345, %341 ], [ %314, %339 ]
  %352 = phi i64 [ %348, %341 ], [ %333, %339 ]
  %353 = phi i32 [ 0, %341 ], [ %331, %339 ]
  %354 = phi i64 [ %347, %341 ], [ %319, %339 ]
...
358:                                              ; preds = %349
  store i64 128, ptr %8, align 8
  %359 = getelementptr inbounds nuw i8, ptr %317, i32 1
  store ptr %359, ptr %12, align 8
  br label %360

360:                                              ; preds = %358, %356
  %361 = phi i64 [ 128, %358 ], [ %357, %356 ]
  %362 = phi ptr [ %359, %358 ], [ %317, %356 ]
  br label %313, !llvm.loop !23

363:                                              ; preds = %313
  call void @free(ptr noundef %311)
  ret void
}
...
54:                                               ; preds = %split, %._crit_edge
  %.pre-phi = phi i64 [ %40, %split ], [ %.pre, %._crit_edge ]
  %55 = sub nsw i32 %17, 1
