...
142:                                              ; preds = %135
  %.pre48 = load i8, ptr %.134, align 1
  %.pre49 = zext i8 %.pre48 to i64
  br label %148
...
148:                                              ; preds = %143, %142
  %.pre-phi = phi i64 [ %129, %143 ], [ %.pre49, %142 ]
  %149 = phi i8 [ %.pre48, %142 ], [ %127, %143 ]
...
172:                                              ; preds = %204, %165
  %.27 = phi i64 [ 0, %165 ], [ %205, %204 ]
  %.0 = phi ptr [ %9, %165 ], [ %176, %204 ]
  %173 = icmp ult i64 %.27, 256
  br i1 %173, label %174, label %206

174:                                              ; preds = %172
  %175 = trunc i64 %.27 to i8
  store i8 %175, ptr %.0, align 1
  %176 = getelementptr inbounds nuw i8, ptr %.0, i32 1
  %177 = getelementptr inbounds nuw [256 x i32], ptr %6, i64 0, i64 %.27
  %178 = load i32, ptr %177, align 4
  %179 = getelementptr inbounds nuw [256 x i8], ptr %7, i64 0, i64 %.27
...
188:                                              ; preds = %199, %184
  %.019 = phi i32 [ 0, %184 ], [ %.120, %199 ]
  %.116 = phi i64 [ %187, %184 ], [ %200, %199 ]
...
199:                                              ; preds = %197, %191
  %.120 = phi i32 [ %198, %197 ], [ %193, %191 ]
  %200 = lshr i64 %.116, 1
  %201 = add i64 %.5, 1
  br label %188, !llvm.loop !17

202:                                              ; preds = %188
  %203 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.27
  store i32 %.019, ptr %203, align 4
  br label %204
...
214:                                              ; preds = %223, %209
  %.38 = phi i64 [ %.6, %209 ], [ %231, %223 ]
  %215 = icmp ne i64 %.38, 0
...
223:                                              ; preds = %221
  ...
  %227 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38
  store i32 %226, ptr %227, align 4
  %228 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %224
  %229 = load i8, ptr %228, align 1
  %230 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38
  store i8 %229, ptr %230, align 1
  %231 = add i64 %.38, -1
  br label %214, !llvm.loop !19

232:                                              ; preds = %221
  %233 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.38
  store i32 %211, ptr %233, align 4
  %234 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.38
...
237:                                              ; preds = %241, %236
  %.49 = phi i64 [ 0, %236 ], [ %242, %241 ]
  %238 = getelementptr inbounds nuw [256 x i32], ptr %8, i64 0, i64 %.49
...
244:                                              ; preds = %275, %243
  %.235 = phi ptr [ %0, %243 ], [ %.336, %275 ]
  %.031 = phi ptr [ %11, %243 ], [ %.132, %275 ]
  %.221 = phi i32 [ 0, %243 ], [ %.423, %275 ]
  %.217 = phi i64 [ 128, %243 ], [ %.318, %275 ]
  %.313 = phi i64 [ 0, %243 ], [ %.414, %275 ]
  %.7 = phi i64 [ %.49, %243 ], [ %.9, %275 ]
  %245 = icmp ult i64 %.313, %1
  br i1 %245, label %246, label %276

246:                                              ; preds = %244
  %247 = mul i32 %.221, 2
  %248 = add i32 %247, 1
  %249 = load i8, ptr %.031, align 1
...
262:                                              ; preds = %256
  %263 = icmp eq i32 %.322, %258
  br i1 %263, label %264, label %269

264:                                              ; preds = %262
  %265 = getelementptr inbounds nuw [256 x i8], ptr %9, i64 0, i64 %.8
  %266 = load i8, ptr %265, align 1
  store i8 %266, ptr %.235, align 1
  %267 = getelementptr inbounds nuw i8, ptr %.235, i32 1
  %268 = add i64 %.313, 1
  br label %269

269:                                              ; preds = %264, %262
  %.336 = phi ptr [ %267, %264 ], [ %.235, %262 ]
  %.423 = phi i32 [ 0, %264 ], [ %.322, %262 ]
  %.414 = phi i64 [ %268, %264 ], [ %.313, %262 ]
  %.9 = phi i64 [ %.49, %264 ], [ %.8, %262 ]
  %270 = icmp ugt i64 %.217, 1
...
273:                                              ; preds = %269
  %274 = getelementptr inbounds nuw i8, ptr %.031, i32 1
  br label %275

275:                                              ; preds = %273, %271
  %.132 = phi ptr [ %.031, %271 ], [ %274, %273 ]
  %.318 = phi i64 [ %272, %271 ], [ 128, %273 ]
