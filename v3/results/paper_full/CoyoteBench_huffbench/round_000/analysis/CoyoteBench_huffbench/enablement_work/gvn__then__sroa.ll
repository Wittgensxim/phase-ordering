...
297:                                              ; preds = %341, %296
  %.018 = phi i64 [ 128, %296 ], [ %.119, %341 ]
  %.016 = phi i64 [ 0, %296 ], [ %.117, %341 ]
  %.014 = phi ptr [ %0, %296 ], [ %.115, %341 ]
...
325:                                              ; preds = %323
  ...
  %328 = getelementptr inbounds nuw i8, ptr %.014, i32 1
  %329 = add i64 %.016, 1
  br label %330

330:                                              ; preds = %325, %323
  %.117 = phi i64 [ %329, %325 ], [ %.016, %323 ]
  %.115 = phi ptr [ %328, %325 ], [ %.014, %323 ]
  %331 = phi i64 [ %.018, %325 ], [ %300, %323 ]
  %332 = phi ptr [ %328, %325 ], [ %298, %323 ]
  %333 = phi i64 [ %.013, %325 ], [ %317, %323 ]
