...
.preheader6:                                      ; preds = %33, %.preheader6.preheader
  %.010 = phi i64 [ 0, %.preheader6.preheader ], [ %.111.1, %33 ]
  %.13 = phi i64 [ 0, %.preheader6.preheader ], [ %34, %33 ]
...
.preheader5:                                      ; preds = %35, %.preheader5.preheader
  %.24 = phi i64 [ %38, %35 ], [ %.010, %.preheader5.preheader ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4.preheader, label %35
...
.preheader4:                                      ; preds = %40, %.preheader4.preheader
  %.212 = phi i64 [ %41, %40 ], [ %.010, %.preheader4.preheader ]
...
63:                                               ; preds = %62
  ...
  br i1 %.not6, label %66, label %.preheader7.preheader

.preheader7.preheader:                            ; preds = %63
  br label %.preheader7
...
.preheader7:                                      ; preds = %69, %.preheader7.preheader
  %.043 = phi i64 [ %.144, %69 ], [ 0, %.preheader7.preheader ]
  %.042.pn = phi i64 [ %72, %69 ], [ %.042, %.preheader7.preheader ]
  %.05 = phi i64 [ %73, %69 ], [ 1, %.preheader7.preheader ]
  %.3 = phi i64 [ %74, %69 ], [ 0, %.preheader7.preheader ]
...
87:                                               ; preds = %82
  %88 = icmp eq i64 %.045, 0
  br i1 %88, label %89, label %.preheader3.preheader
...
.preheader3:                                      ; preds = %126, %.preheader3.preheader
  %.134 = phi ptr [ %127, %126 ], [ %0, %.preheader3.preheader ]
  %.028 = phi i64 [ %.129, %126 ], [ 0, %.preheader3.preheader ]
  %.024 = phi i8 [ %.125, %126 ], [ 0, %.preheader3.preheader ]
  %.16 = phi i64 [ %128, %126 ], [ 0, %.preheader3.preheader ]
  %.01 = phi i32 [ %.1, %126 ], [ -1, %.preheader3.preheader ]
...
129:                                              ; preds = %.preheader3
  %130 = sub nsw i32 7, %.01
  %131 = zext i8 %.024 to i32
  %132 = shl i32 %131, %130
  %133 = trunc i32 %132 to i8
  %134 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
135:                                              ; preds = %161, %129
  ...
  br i1 %exitcond17.not, label %.preheader2.preheader, label %136

.preheader2.preheader:                            ; preds = %135
  br label %.preheader2
...
.preheader2:                                      ; preds = %.critedge, %.preheader2.preheader
  %.6 = phi i64 [ %181, %.critedge ], [ 1, %.preheader2.preheader ]
  %exitcond18.not = icmp eq i64 %.6, 256
  br i1 %exitcond18.not, label %.preheader1.preheader, label %163
...
.preheader1:                                      ; preds = %185, %.preheader1.preheader
  %.49 = phi i64 [ %186, %185 ], [ 0, %.preheader1.preheader ]
...
.preheader:                                       ; preds = %208, %.preheader.preheader
  ...
  %.7 = phi i64 [ %.9, %208 ], [ %.49, %.preheader.preheader ]
...
201:                                              ; preds = %195
  %202 = icmp eq i32 %spec.select2, %197
