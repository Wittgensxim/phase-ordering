...
53:                                               ; preds = %50, %69
  %.03937 = phi i64 [ 0, %50 ], [ %.140, %69 ]
  %.04236 = phi i64 [ 0, %50 ], [ %70, %69 ]
  %.04535 = phi i64 [ 0, %50 ], [ %.146, %69 ]
  %54 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04236
  %55 = load i64, ptr %54, align 8
  %.not6 = icmp eq i64 %55, 0
  br i1 %.not6, label %56, label %.preheader7.preheader

.preheader7.preheader:                            ; preds = %53
  %.037.in25 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.04236
  %.03726 = load i32, ptr %.037.in25, align 4
  %.not727 = icmp eq i32 %.03726, 0
  br i1 %.not727, label %64, label %.lr.ph32

.lr.ph32:                                         ; preds = %.preheader7.preheader
  br label %.preheader7

56:                                               ; preds = %53
  %57 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04236
  store i32 0, ptr %57, align 4
  %58 = getelementptr inbounds nuw i8, ptr %7, i64 %.04236
  store i8 0, ptr %58, align 1
  br label %69

.preheader7:                                      ; preds = %.lr.ph32, %.preheader7
  %.03731 = phi i32 [ %.03726, %.lr.ph32 ], [ %.037, %.preheader7 ]
  %.330 = phi i64 [ 0, %.lr.ph32 ], [ %63, %.preheader7 ]
  %.0529 = phi i64 [ 1, %.lr.ph32 ], [ %62, %.preheader7 ]
  %.04328 = phi i64 [ 0, %.lr.ph32 ], [ %.144, %.preheader7 ]
  %59 = icmp slt i32 %.03731, 0
  %60 = select i1 %59, i64 %.0529, i64 0
  %.144 = add i64 %.04328, %60
...
.preheader7._crit_edge:                           ; preds = %.preheader7
  %split33 = phi i64 [ %.144, %.preheader7 ]
  %split34 = phi i64 [ %63, %.preheader7 ]
  br label %64

64:                                               ; preds = %.preheader7._crit_edge, %.preheader7.preheader
  %.043.lcssa = phi i64 [ %split33, %.preheader7._crit_edge ], [ 0, %.preheader7.preheader ]
  %.3.lcssa = phi i64 [ %split34, %.preheader7._crit_edge ], [ 0, %.preheader7.preheader ]
  %65 = trunc i64 %.043.lcssa to i32
  %66 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04236
  store i32 %65, ptr %66, align 4
  %67 = trunc i64 %.3.lcssa to i8
  %68 = getelementptr inbounds nuw i8, ptr %7, i64 %.04236
...
69:                                               ; preds = %64, %56
  %.146 = phi i64 [ %spec.select, %64 ], [ %.04535, %56 ]
  %.140 = phi i64 [ %.241, %64 ], [ %.03937, %56 ]
  %70 = add nuw nsw i64 %.04236, 1
...
.preheader3.preheader:                            ; preds = %76
  %exitcond15.not49 = icmp eq i64 0, %1
  br i1 %exitcond15.not49, label %117, label %.lr.ph55

.lr.ph55:                                         ; preds = %.preheader3.preheader
  br label %81
...
81:                                               ; preds = %.lr.ph55, %.preheader3
  %.0154 = phi i32 [ -1, %.lr.ph55 ], [ %.1.lcssa, %.preheader3 ]
  %.1653 = phi i64 [ 0, %.lr.ph55 ], [ %116, %.preheader3 ]
  %.02452 = phi i8 [ 0, %.lr.ph55 ], [ %.125.lcssa, %.preheader3 ]
  %.02851 = phi i64 [ 0, %.lr.ph55 ], [ %.129.lcssa, %.preheader3 ]
  %.13450 = phi ptr [ %0, %.lr.ph55 ], [ %115, %.preheader3 ]
  %82 = load i8, ptr %.13450, align 1
  ...
  br i1 %91, label %.lr.ph44, label %.preheader3

.lr.ph44:                                         ; preds = %81
  br label %92

92:                                               ; preds = %.lr.ph44, %105
  %.142 = phi i32 [ %.0154, %.lr.ph44 ], [ %.2, %105 ]
  %.441 = phi i64 [ 0, %.lr.ph44 ], [ %112, %105 ]
  %.01540 = phi i64 [ %89, %.lr.ph44 ], [ %111, %105 ]
  %.12539 = phi i8 [ %.02452, %.lr.ph44 ], [ %.327, %105 ]
  %.12938 = phi i64 [ %.02851, %.lr.ph44 ], [ %.230, %105 ]
  %93 = phi i8 [ %82, %.lr.ph44 ], [ %.pre-phi.in, %105 ]
  %94 = icmp eq i32 %.142, 7
  br i1 %94, label %95, label %102

95:                                               ; preds = %92
  %96 = getelementptr inbounds nuw i8, ptr %11, i64 %.12938
  store i8 %.12539, ptr %96, align 1
  %97 = add i64 %.12938, 1
  %98 = icmp eq i64 %97, %1
...
105:                                              ; preds = %102, %._crit_edge
  ...
  br i1 %114, label %92, label %._crit_edge45, !llvm.loop !15

._crit_edge45:                                    ; preds = %105
  %split46 = phi i64 [ %.230, %105 ]
  %split47 = phi i8 [ %.327, %105 ]
  %split48 = phi i32 [ %.2, %105 ]
  br label %.preheader3

.preheader3:                                      ; preds = %._crit_edge45, %81
  %.129.lcssa = phi i64 [ %split46, %._crit_edge45 ], [ %.02851, %81 ]
  %.125.lcssa = phi i8 [ %split47, %._crit_edge45 ], [ %.02452, %81 ]
  %.1.lcssa = phi i32 [ %split48, %._crit_edge45 ], [ %.0154, %81 ]
  %115 = getelementptr inbounds nuw i8, ptr %.13450, i64 1
  %116 = add i64 %.1653, 1
...
.preheader3._crit_edge:                           ; preds = %.preheader3
  %split56 = phi i64 [ %.129.lcssa, %.preheader3 ]
  %split57 = phi i8 [ %.125.lcssa, %.preheader3 ]
  %split58 = phi i32 [ %.1.lcssa, %.preheader3 ]
  br label %117

117:                                              ; preds = %.preheader3._crit_edge, %.preheader3.preheader
  %.028.lcssa = phi i64 [ %split56, %.preheader3._crit_edge ], [ 0, %.preheader3.preheader ]
  %.024.lcssa = phi i8 [ %split57, %.preheader3._crit_edge ], [ 0, %.preheader3.preheader ]
  %.01.lcssa = phi i32 [ %split58, %.preheader3._crit_edge ], [ -1, %.preheader3.preheader ]
...
123:                                              ; preds = %117, %147
  %.068 = phi ptr [ %9, %117 ], [ %125, %147 ]
  %.2767 = phi i64 [ 0, %117 ], [ %148, %147 ]
  %124 = trunc nuw i64 %.2767 to i8
  store i8 %124, ptr %.068, align 1
  %125 = getelementptr inbounds nuw i8, ptr %.068, i64 1
  %126 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2767
  %127 = load i32, ptr %126, align 4
  %128 = getelementptr inbounds nuw i8, ptr %7, i64 %.2767
...
132:                                              ; preds = %123
  ...
  %exitcond16.not59 = icmp eq i64 0, %136
  br i1 %exitcond16.not59, label %145, label %.lr.ph64

.lr.ph64:                                         ; preds = %132
  br label %137

137:                                              ; preds = %.lr.ph64, %137
  %.562 = phi i64 [ 0, %.lr.ph64 ], [ %144, %137 ]
  %.11661 = phi i64 [ %135, %.lr.ph64 ], [ %143, %137 ]
  %.01960 = phi i32 [ 0, %.lr.ph64 ], [ %spec.select1, %137 ]
  %138 = shl i32 %.01960, 1
  %139 = or disjoint i32 %138, 1
  %140 = zext i32 %127 to i64
  %141 = and i64 %.11661, %140
  %.not4 = icmp eq i64 %141, 0
  %142 = add i32 %138, 2
  %spec.select1 = select i1 %.not4, i32 %139, i32 %142
  %143 = lshr i64 %.11661, 1
  %144 = add nuw nsw i64 %.562, 1
  %exitcond16.not = icmp eq i64 %144, %136
  br i1 %exitcond16.not, label %._crit_edge65, label %137, !llvm.loop !17

._crit_edge65:                                    ; preds = %137
  %split66 = phi i32 [ %spec.select1, %137 ]
  br label %145

145:                                              ; preds = %._crit_edge65, %132
  %.019.lcssa = phi i32 [ %split66, %._crit_edge65 ], [ 0, %132 ]
  %146 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2767
  store i32 %.019.lcssa, ptr %146, align 4
  br label %147

147:                                              ; preds = %145, %123
  %148 = add nuw nsw i64 %.2767, 1
...
149:                                              ; preds = %.preheader2.preheader, %.critedge
  %.670 = phi i64 [ 1, %.preheader2.preheader ], [ %166, %.critedge ]
  %150 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.670
  %151 = load i32, ptr %150, align 4
  %152 = getelementptr inbounds nuw i8, ptr %9, i64 %.670
  %153 = load i8, ptr %152, align 1
  br label %154

154:                                              ; preds = %149, %159
  %.3869 = phi i64 [ %.670, %149 ], [ %155, %159 ]
  %155 = add nsw i64 %.3869, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %171, label %.lr.ph77, label %194

.lr.ph77:                                         ; preds = %.preheader.preheader
  br label %172

172:                                              ; preds = %.lr.ph77, %.preheader
  %.776 = phi i64 [ %.49.lcssa, %.lr.ph77 ], [ %.9, %.preheader ]
  %.31375 = phi i64 [ 0, %.lr.ph77 ], [ %.414, %.preheader ]
  %.21774 = phi i64 [ 128, %.lr.ph77 ], [ %.318, %.preheader ]
  %.22173 = phi i32 [ 0, %.lr.ph77 ], [ %.423, %.preheader ]
  %.03172 = phi ptr [ %11, %.lr.ph77 ], [ %.132, %.preheader ]
  %.23571 = phi ptr [ %0, %.lr.ph77 ], [ %.336, %.preheader ]
  %173 = shl i32 %.22173, 1
  %174 = or disjoint i32 %173, 1
  %175 = load i8, ptr %.03172, align 1
  %176 = zext i8 %175 to i64
  %177 = and i64 %.21774, %176
...
186:                                              ; preds = %184
  ...
  store i8 %188, ptr %.23571, align 1
  %189 = getelementptr inbounds nuw i8, ptr %.23571, i64 1
  %190 = add nuw i64 %.31375, 1
  br label %.preheader

.preheader:                                       ; preds = %186, %184
  %.336 = phi ptr [ %189, %186 ], [ %.23571, %184 ]
  %.423 = phi i32 [ 0, %186 ], [ %spec.select2, %184 ]
  %.414 = phi i64 [ %190, %186 ], [ %.31375, %184 ]
  %.9 = phi i64 [ %.49.lcssa, %186 ], [ %.8.lcssa, %184 ]
  %191 = icmp ult i64 %.21774, 2
  %192 = lshr i64 %.21774, 1
