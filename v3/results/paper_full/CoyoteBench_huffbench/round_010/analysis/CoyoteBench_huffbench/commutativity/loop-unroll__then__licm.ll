...
.preheader7:                                      ; preds = %70, %.preheader7.preheader
...
152:                                              ; preds = %153, %146
  %.019 = phi i32 [ 0, %146 ], [ %spec.select1, %153 ]
  %.116 = phi i64 [ %149, %146 ], [ %158, %153 ]
  %.5 = phi i64 [ 0, %146 ], [ %159, %153 ]
  %exitcond16.not = icmp eq i64 %.5, %150
  br i1 %exitcond16.not, label %160, label %153
...
153:                                              ; preds = %152
  ...
  %157 = add i32 %154, 2
  %spec.select1 = select i1 %.not4, i32 %155, i32 %157
  %158 = lshr i64 %.116, 1
