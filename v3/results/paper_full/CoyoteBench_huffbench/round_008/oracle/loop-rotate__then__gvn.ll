...
65:                                               ; preds = %._crit_edge26, %.preheader7
  %.043.lcssa = phi i64 [ %.144, %._crit_edge26 ], [ 0, %.preheader7 ]
  %.3.lcssa = phi i64 [ %64, %._crit_edge26 ], [ 0, %.preheader7 ]
...
.preheader3.preheader:                            ; preds = %77
  br i1 %exitcond.not7, label %118, label %.lr.ph49
...
.preheader3:                                      ; preds = %._crit_edge39, %82
  %.129.lcssa = phi i64 [ %.230, %._crit_edge39 ], [ %.02845, %82 ]
  %.125.lcssa = phi i8 [ %.327, %._crit_edge39 ], [ %.02446, %82 ]
  %.1.lcssa = phi i32 [ %.2, %._crit_edge39 ], [ %.0148, %82 ]
...
118:                                              ; preds = %.preheader3._crit_edge, %.preheader3.preheader
  ...
  %.024.lcssa = phi i8 [ %.125.lcssa, %.preheader3._crit_edge ], [ 0, %.preheader3.preheader ]
  %.01.lcssa = phi i32 [ %.1.lcssa, %.preheader3._crit_edge ], [ -1, %.preheader3.preheader ]
...
138:                                              ; preds = %.lr.ph58, %138
  %.556 = phi i64 [ 0, %.lr.ph58 ], [ %145, %138 ]
  %.11655 = phi i64 [ %136, %.lr.ph58 ], [ %144, %138 ]
  %.01954 = phi i32 [ 0, %.lr.ph58 ], [ %spec.select1, %138 ]
  %139 = shl i32 %.01954, 1
  %140 = or disjoint i32 %139, 1
  %141 = zext i32 %128 to i64
  %142 = and i64 %.11655, %141
  ...
  br i1 %exitcond16.not, label %._crit_edge59, label %138, !llvm.loop !17

._crit_edge59:                                    ; preds = %138
  br label %146

146:                                              ; preds = %._crit_edge59, %133
  %.019.lcssa = phi i32 [ %spec.select1, %._crit_edge59 ], [ 0, %133 ]
...
173:                                              ; preds = %.lr.ph71, %.preheader
  %.770 = phi i64 [ %.49, %.lr.ph71 ], [ %.9, %.preheader ]
...
185:                                              ; preds = %180
  %186 = icmp eq i32 %spec.select2, %182
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge4, %.._crit_edge_crit_edge, %4
  %.pre-phi = phi i64 [ %30, %.._crit_edge_crit_edge4 ], [ %.pre, %.._crit_edge_crit_edge ], [ %5, %4 ]
  %.01.lcssa = phi i32 [ %.012, %.._crit_edge_crit_edge ], [ %.0, %.._crit_edge_crit_edge4 ], [ %3, %4 ]
  %41 = ashr exact i64 %9, 32
  %42 = getelementptr [8 x i8], ptr %1, i64 %.pre-phi
...
.loopexit.loopexit:                               ; preds = %6, %5
  %exitcond.not.lcssa = phi i1 [ false, %6 ], [ true, %5 ]
  br label %.loopexit
