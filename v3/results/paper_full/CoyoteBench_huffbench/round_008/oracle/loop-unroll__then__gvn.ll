...
62:                                               ; preds = %81, %59
  %.045 = phi i64 [ 0, %59 ], [ %.146, %81 ]
  %.042 = phi i64 [ 0, %59 ], [ %82, %81 ]
  %.039 = phi i64 [ 0, %59 ], [ %.140, %81 ]
  %exitcond14.not = icmp eq i64 %.042, 256
  br i1 %exitcond14.not, label %83, label %63
...
69:                                               ; preds = %70, %.preheader7
  %.043 = phi i64 [ %.144, %70 ], [ 0, %.preheader7 ]
  %.042.pn = phi i64 [ %73, %70 ], [ %.042, %.preheader7 ]
  %.05 = phi i64 [ %74, %70 ], [ 1, %.preheader7 ]
  %.3 = phi i64 [ %75, %70 ], [ 0, %.preheader7 ]
...
.preheader3:                                      ; preds = %127, %.preheader3.preheader
  %.134 = phi ptr [ %128, %127 ], [ %0, %.preheader3.preheader ]
  %.028 = phi i64 [ %.129, %127 ], [ 0, %.preheader3.preheader ]
  %.024 = phi i8 [ %.125, %127 ], [ 0, %.preheader3.preheader ]
  %.16 = phi i64 [ %129, %127 ], [ 0, %.preheader3.preheader ]
  %.01 = phi i32 [ %.1, %127 ], [ -1, %.preheader3.preheader ]
...
130:                                              ; preds = %.preheader3
  %131 = sub nsw i32 7, %.01
  %132 = zext i8 %.024 to i32
  %133 = shl i32 %132, %131
  %134 = trunc i32 %133 to i8
  %135 = getelementptr inbounds nuw i8, ptr %11, i64 %.028
...
.preheader:                                       ; preds = %209, %.preheader.preheader
  ...
  %.7 = phi i64 [ %.9, %209 ], [ %.49, %.preheader.preheader ]
...
202:                                              ; preds = %196
  %203 = icmp eq i32 %spec.select2, %198
