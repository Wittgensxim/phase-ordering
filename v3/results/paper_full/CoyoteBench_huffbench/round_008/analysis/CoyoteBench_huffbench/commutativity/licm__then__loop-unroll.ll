...
.preheader6:                                      ; preds = %35, %.preheader6.preheader
  %.010 = phi i64 [ 0, %.preheader6.preheader ], [ %.111.1, %35 ]
  %.13 = phi i64 [ 0, %.preheader6.preheader ], [ %36, %35 ]
...
22:                                               ; preds = %.preheader6
  ...
  br i1 %.not8, label %.preheader6.1, label %25
...
.preheader6.1:                                    ; preds = %25, %22
  %.111 = phi i64 [ %27, %25 ], [ %.010, %22 ]
  %28 = add nuw nsw i64 %.13, 1
  br label %29

29:                                               ; preds = %.preheader6.1
...
35:                                               ; preds = %32, %29
  %.111.1 = phi i64 [ %34, %32 ], [ %.111, %29 ]
  %36 = add nuw nsw i64 %.13, 2
  br label %.preheader6, !llvm.loop !10

.preheader5:                                      ; preds = %37, %.preheader5.preheader
  %.24 = phi i64 [ %39, %37 ], [ %.010.lcssa, %.preheader5.preheader ]
  %.not = icmp eq i64 %.24, 0
  br i1 %.not, label %.preheader4.preheader, label %37
...
37:                                               ; preds = %.preheader5
  ...
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %21, i32 noundef %38)
  %39 = add i64 %.24, -1
  br label %.preheader5, !llvm.loop !11

.preheader4:                                      ; preds = %41, %.preheader4.preheader
...
.preheader3:                                      ; preds = %128, %.preheader3.preheader
  %.134 = phi ptr [ %129, %128 ], [ %0, %.preheader3.preheader ]
  %.028 = phi i64 [ %.129.lcssa, %128 ], [ 0, %.preheader3.preheader ]
  %.024 = phi i8 [ %.125.lcssa, %128 ], [ 0, %.preheader3.preheader ]
  %.16 = phi i64 [ %130, %128 ], [ 0, %.preheader3.preheader ]
  %.01 = phi i32 [ %.1.lcssa, %128 ], [ -1, %.preheader3.preheader ]
...
128:                                              ; preds = %103
  %.129.lcssa = phi i64 [ %.129, %103 ]
  %.125.lcssa = phi i8 [ %.125, %103 ]
  %.1.lcssa = phi i32 [ %.1, %103 ]
...
153:                                              ; preds = %154, %147
  %.019 = phi i32 [ 0, %147 ], [ %spec.select1, %154 ]
  %.116 = phi i64 [ %150, %147 ], [ %159, %154 ]
  %.5 = phi i64 [ 0, %147 ], [ %160, %154 ]
  %exitcond16.not = icmp eq i64 %.5, %151
  br i1 %exitcond16.not, label %161, label %154
...
.preheader:                                       ; preds = %210, %.preheader.preheader
  ...
  %.7 = phi i64 [ %.9, %210 ], [ %.49.lcssa, %.preheader.preheader ]
