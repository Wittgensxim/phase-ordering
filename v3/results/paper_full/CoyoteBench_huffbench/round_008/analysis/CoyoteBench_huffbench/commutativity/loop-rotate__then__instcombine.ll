...
.preheader3.preheader:                            ; preds = %77
  %exitcond15.not43 = icmp eq i64 %1, 0
  br i1 %exitcond15.not43, label %120, label %.lr.ph49
...
91:                                               ; preds = %.lr.ph38, %104
  %.136 = phi i32 [ %.0148, %.lr.ph38 ], [ %.2, %104 ]
  %.435 = phi i64 [ 0, %.lr.ph38 ], [ %111, %104 ]
  %.01534 = phi i64 [ %90, %.lr.ph38 ], [ %110, %104 ]
  %.12533 = phi i8 [ %.02446, %.lr.ph38 ], [ %.327, %104 ]
  %.12932 = phi i64 [ %.02845, %.lr.ph38 ], [ %.230, %104 ]
  %92 = phi i8 [ %83, %.lr.ph38 ], [ %.pre-phi.in, %104 ]
  %93 = icmp eq i32 %.136, 7
  br i1 %93, label %94, label %101

94:                                               ; preds = %91
  %95 = getelementptr inbounds nuw i8, ptr %11, i64 %.12932
  store i8 %.12533, ptr %95, align 1
  %96 = add i64 %.12932, 1
  %97 = icmp eq i64 %96, %1
...
104:                                              ; preds = %101, %._crit_edge
  ...
  br i1 %113, label %91, label %._crit_edge39, !llvm.loop !15
...
.preheader3:                                      ; preds = %._crit_edge39, %82
  ...
  %114 = getelementptr inbounds nuw i8, ptr %.13444, i64 1
  %115 = add i64 %.1647, 1
...
123:                                              ; preds = %120, %147
  %.062 = phi ptr [ %9, %120 ], [ %125, %147 ]
  %.2761 = phi i64 [ 0, %120 ], [ %148, %147 ]
  %124 = trunc nuw i64 %.2761 to i8
  store i8 %124, ptr %.062, align 1
  %125 = getelementptr inbounds nuw i8, ptr %.062, i64 1
  %126 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2761
  %127 = load i32, ptr %126, align 4
  %128 = getelementptr inbounds nuw i8, ptr %7, i64 %.2761
...
132:                                              ; preds = %123
  ...
  %exitcond16.not53 = icmp eq i8 %129, 0
  br i1 %exitcond16.not53, label %145, label %.lr.ph58
...
137:                                              ; preds = %.lr.ph58, %137
  %.556 = phi i64 [ 0, %.lr.ph58 ], [ %144, %137 ]
  %.11655 = phi i64 [ %136, %.lr.ph58 ], [ %143, %137 ]
  %.01954 = phi i32 [ 0, %.lr.ph58 ], [ %spec.select1, %137 ]
  %138 = shl i32 %.01954, 1
  %139 = or disjoint i32 %138, 1
  %140 = zext i32 %127 to i64
  %141 = and i64 %.11655, %140
  %.not4 = icmp eq i64 %141, 0
  %142 = add i32 %138, 2
  %spec.select1 = select i1 %.not4, i32 %139, i32 %142
  %143 = lshr i64 %.11655, 1
  %144 = add nuw nsw i64 %.556, 1
  %exitcond16.not = icmp eq i64 %144, %133
  br i1 %exitcond16.not, label %._crit_edge59, label %137, !llvm.loop !17

._crit_edge59:                                    ; preds = %137
  br label %145

145:                                              ; preds = %._crit_edge59, %132
  %.019.lcssa = phi i32 [ %spec.select1, %._crit_edge59 ], [ 0, %132 ]
  %146 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2761
  store i32 %.019.lcssa, ptr %146, align 4
  br label %147

147:                                              ; preds = %145, %123
  %148 = add nuw nsw i64 %.2761, 1
...
149:                                              ; preds = %.preheader2.preheader, %.critedge
  %.664 = phi i64 [ 1, %.preheader2.preheader ], [ %166, %.critedge ]
  %150 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.664
  %151 = load i32, ptr %150, align 4
  %152 = getelementptr inbounds nuw i8, ptr %9, i64 %.664
  %153 = load i8, ptr %152, align 1
  br label %154

154:                                              ; preds = %149, %159
  %.3863 = phi i64 [ %.664, %149 ], [ %155, %159 ]
  %155 = add nsw i64 %.3863, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %.not73, label %193, label %.lr.ph71

.lr.ph71:                                         ; preds = %.preheader.preheader
  br label %171

171:                                              ; preds = %.lr.ph71, %.preheader
  ...
  %174 = load i8, ptr %.03166, align 1
  %175 = zext i8 %174 to i64
  %176 = and i64 %.21768, %175
...
185:                                              ; preds = %183
  ...
  store i8 %187, ptr %.23565, align 1
  %188 = getelementptr inbounds nuw i8, ptr %.23565, i64 1
  %189 = add nuw i64 %.31369, 1
  br label %.preheader

.preheader:                                       ; preds = %185, %183
  %.336 = phi ptr [ %188, %185 ], [ %.23565, %183 ]
  %.423 = phi i32 [ 0, %185 ], [ %spec.select2, %183 ]
  %.414 = phi i64 [ %189, %185 ], [ %.31369, %183 ]
  %.9 = phi i64 [ %.49, %185 ], [ %.8, %183 ]
  %190 = icmp ult i64 %.21768, 2
  %191 = lshr i64 %.21768, 1
