...
60:                                               ; preds = %57, %77
  %.03931 = phi i64 [ 0, %57 ], [ %.140, %77 ]
  %.04230 = phi i64 [ 0, %57 ], [ %78, %77 ]
  %.04529 = phi i64 [ 0, %57 ], [ %.146, %77 ]
  %61 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04230
...
.preheader7:                                      ; preds = %60
  ...
  br i1 %.not720, label %72, label %.lr.ph25

.lr.ph25:                                         ; preds = %.preheader7
  br label %66

63:                                               ; preds = %60
  %64 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04230
...
66:                                               ; preds = %.lr.ph25, %66
  %.03724 = phi i32 [ %.03719, %.lr.ph25 ], [ %.037, %66 ]
  %.323 = phi i64 [ 0, %.lr.ph25 ], [ %71, %66 ]
  %.0522 = phi i64 [ 1, %.lr.ph25 ], [ %70, %66 ]
  %.04321 = phi i64 [ 0, %.lr.ph25 ], [ %.144, %66 ]
  %67 = icmp slt i32 %.03724, 0
  %68 = select i1 %67, i64 %.0522, i64 0
  %.144 = add i64 %.04321, %68
  ...
  br i1 %.not7, label %._crit_edge26, label %66, !llvm.loop !13

._crit_edge26:                                    ; preds = %66
  %split27 = phi i64 [ %.144, %66 ]
  %split28 = phi i64 [ %71, %66 ]
  br label %72

72:                                               ; preds = %._crit_edge26, %.preheader7
  ...
  %74 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04230
  store i32 %73, ptr %74, align 4
  %75 = trunc i64 %.3.lcssa to i8
  %76 = getelementptr inbounds nuw i8, ptr %7, i64 %.04230
...
77:                                               ; preds = %72, %63
  %.146 = phi i64 [ %spec.select, %72 ], [ %.04529, %63 ]
  %.140 = phi i64 [ %.241, %72 ], [ %.03931, %63 ]
  %78 = add nuw nsw i64 %.04230, 1
...
.preheader3.preheader:                            ; preds = %84
  ...
  br i1 %exitcond15.not43, label %125, label %.lr.ph49
...
89:                                               ; preds = %.lr.ph49, %.preheader3
  %.0148 = phi i32 [ -1, %.lr.ph49 ], [ %.1.lcssa, %.preheader3 ]
  %.1647 = phi i64 [ 0, %.lr.ph49 ], [ %124, %.preheader3 ]
  %.02446 = phi i8 [ 0, %.lr.ph49 ], [ %.125.lcssa, %.preheader3 ]
  %.02845 = phi i64 [ 0, %.lr.ph49 ], [ %.129.lcssa, %.preheader3 ]
  %.13444 = phi ptr [ %0, %.lr.ph49 ], [ %123, %.preheader3 ]
  %90 = load i8, ptr %.13444, align 1
  ...
  br i1 %99, label %.lr.ph38, label %.preheader3

.lr.ph38:                                         ; preds = %89
  br label %100

100:                                              ; preds = %.lr.ph38, %113
  %.136 = phi i32 [ %.0148, %.lr.ph38 ], [ %.2, %113 ]
  %.435 = phi i64 [ 0, %.lr.ph38 ], [ %120, %113 ]
  %.01534 = phi i64 [ %97, %.lr.ph38 ], [ %119, %113 ]
  %.12533 = phi i8 [ %.02446, %.lr.ph38 ], [ %.327, %113 ]
  %.12932 = phi i64 [ %.02845, %.lr.ph38 ], [ %.230, %113 ]
  %101 = phi i8 [ %90, %.lr.ph38 ], [ %.pre-phi.in, %113 ]
  %102 = icmp eq i32 %.136, 7
  br i1 %102, label %103, label %110

103:                                              ; preds = %100
  %104 = getelementptr inbounds nuw i8, ptr %11, i64 %.12932
  store i8 %.12533, ptr %104, align 1
  %105 = add i64 %.12932, 1
...
113:                                              ; preds = %110, %._crit_edge
  ...
  br i1 %122, label %100, label %._crit_edge39, !llvm.loop !15

._crit_edge39:                                    ; preds = %113
  %split40 = phi i64 [ %.230, %113 ]
  %split41 = phi i8 [ %.327, %113 ]
  %split42 = phi i32 [ %.2, %113 ]
  br label %.preheader3

.preheader3:                                      ; preds = %._crit_edge39, %89
  %.129.lcssa = phi i64 [ %split40, %._crit_edge39 ], [ %.02845, %89 ]
  %.125.lcssa = phi i8 [ %split41, %._crit_edge39 ], [ %.02446, %89 ]
  %.1.lcssa = phi i32 [ %split42, %._crit_edge39 ], [ %.0148, %89 ]
  %123 = getelementptr inbounds nuw i8, ptr %.13444, i64 1
  %124 = add i64 %.1647, 1
...
131:                                              ; preds = %125, %155
  %.062 = phi ptr [ %9, %125 ], [ %133, %155 ]
  %.2761 = phi i64 [ 0, %125 ], [ %156, %155 ]
  %132 = trunc nuw i64 %.2761 to i8
  store i8 %132, ptr %.062, align 1
  %133 = getelementptr inbounds nuw i8, ptr %.062, i64 1
  %134 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2761
  %135 = load i32, ptr %134, align 4
  %136 = getelementptr inbounds nuw i8, ptr %7, i64 %.2761
...
140:                                              ; preds = %131
  ...
  %exitcond16.not53 = icmp eq i64 0, %144
  br i1 %exitcond16.not53, label %153, label %.lr.ph58

.lr.ph58:                                         ; preds = %140
  br label %145

145:                                              ; preds = %.lr.ph58, %145
  %.556 = phi i64 [ 0, %.lr.ph58 ], [ %152, %145 ]
  %.11655 = phi i64 [ %143, %.lr.ph58 ], [ %151, %145 ]
  %.01954 = phi i32 [ 0, %.lr.ph58 ], [ %spec.select1, %145 ]
  %146 = shl i32 %.01954, 1
  %147 = or disjoint i32 %146, 1
  %148 = zext i32 %135 to i64
  %149 = and i64 %.11655, %148
  %.not4 = icmp eq i64 %149, 0
  %150 = add i32 %146, 2
  %spec.select1 = select i1 %.not4, i32 %147, i32 %150
  %151 = lshr i64 %.11655, 1
  %152 = add nuw nsw i64 %.556, 1
  %exitcond16.not = icmp eq i64 %152, %144
  br i1 %exitcond16.not, label %._crit_edge59, label %145, !llvm.loop !17

._crit_edge59:                                    ; preds = %145
  %split60 = phi i32 [ %spec.select1, %145 ]
  br label %153

153:                                              ; preds = %._crit_edge59, %140
  %.019.lcssa = phi i32 [ %split60, %._crit_edge59 ], [ 0, %140 ]
  %154 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2761
  store i32 %.019.lcssa, ptr %154, align 4
  br label %155

155:                                              ; preds = %153, %131
  %156 = add nuw nsw i64 %.2761, 1
...
157:                                              ; preds = %.preheader2.preheader, %.critedge
  %.664 = phi i64 [ 1, %.preheader2.preheader ], [ %174, %.critedge ]
  %158 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.664
  %159 = load i32, ptr %158, align 4
  %160 = getelementptr inbounds nuw i8, ptr %9, i64 %.664
  %161 = load i8, ptr %160, align 1
  br label %162

162:                                              ; preds = %157, %167
  %.3863 = phi i64 [ %.664, %157 ], [ %163, %167 ]
  %163 = add nsw i64 %.3863, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %179, label %.lr.ph71, label %202

.lr.ph71:                                         ; preds = %.preheader.preheader
  br label %180

180:                                              ; preds = %.lr.ph71, %.preheader
  ...
  %183 = load i8, ptr %.03166, align 1
  %184 = zext i8 %183 to i64
  %185 = and i64 %.21768, %184
...
194:                                              ; preds = %192
  ...
  store i8 %196, ptr %.23565, align 1
  %197 = getelementptr inbounds nuw i8, ptr %.23565, i64 1
  %198 = add nuw i64 %.31369, 1
  br label %.preheader

.preheader:                                       ; preds = %194, %192
  %.336 = phi ptr [ %197, %194 ], [ %.23565, %192 ]
  %.423 = phi i32 [ 0, %194 ], [ %spec.select2, %192 ]
  %.414 = phi i64 [ %198, %194 ], [ %.31369, %192 ]
  %.9 = phi i64 [ %.49.lcssa, %194 ], [ %.8.lcssa, %192 ]
  %199 = icmp ult i64 %.21768, 2
  %200 = lshr i64 %.21768, 1
