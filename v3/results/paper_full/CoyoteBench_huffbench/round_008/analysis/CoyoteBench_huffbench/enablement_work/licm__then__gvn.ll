...
.preheader6:                                      ; preds = %28, %.preheader6.preheader
...
.preheader3:                                      ; preds = %121, %.preheader3.preheader
  ...
  %.028 = phi i64 [ %.129, %121 ], [ 0, %.preheader3.preheader ]
  %.024 = phi i8 [ %.125, %121 ], [ 0, %.preheader3.preheader ]
  %.16 = phi i64 [ %123, %121 ], [ 0, %.preheader3.preheader ]
  %.01 = phi i32 [ %.1, %121 ], [ -1, %.preheader3.preheader ]
...
146:                                              ; preds = %147, %140
  %.019 = phi i32 [ 0, %140 ], [ %spec.select1, %147 ]
  %.116 = phi i64 [ %143, %140 ], [ %152, %147 ]
  %.5 = phi i64 [ 0, %140 ], [ %153, %147 ]
  %exitcond16.not = icmp eq i64 %.5, %144
  br i1 %exitcond16.not, label %154, label %147
...
147:                                              ; preds = %146
  ...
  %151 = add i32 %148, 2
  %spec.select1 = select i1 %.not4, i32 %149, i32 %151
  %152 = lshr i64 %.116, 1
...
.preheader1:                                      ; preds = %180, %.preheader1.preheader
...
.preheader:                                       ; preds = %203, %.preheader.preheader
  ...
  %.7 = phi i64 [ %.9, %203 ], [ %.49, %.preheader.preheader ]
