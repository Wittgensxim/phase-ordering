...
21:                                               ; preds = %.preheader6.preheader, %.preheader6
  %.1312 = phi i64 [ 0, %.preheader6.preheader ], [ %27, %.preheader6 ]
  %.01011 = phi i64 [ 0, %.preheader6.preheader ], [ %.111, %.preheader6 ]
  %22 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.1312
  %23 = load i64, ptr %22, align 8
  %.not8 = icmp eq i64 %23, 0
  br i1 %.not8, label %.preheader6, label %24

24:                                               ; preds = %21
  %25 = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %.01011
  store i64 %.1312, ptr %25, align 8
  %26 = add i64 %.01011, 1
  br label %.preheader6

.preheader6:                                      ; preds = %24, %21
  %.111 = phi i64 [ %26, %24 ], [ %.01011, %21 ]
  %27 = add nuw nsw i64 %.1312, 1
  %exitcond13.not = icmp eq i64 %27, 256
  br i1 %exitcond13.not, label %.preheader5.preheader, label %21, !llvm.loop !10
...
.preheader4.preheader:                            ; preds = %.preheader5..preheader4.preheader_crit_edge, %.preheader5.preheader
  ...
  br i1 %28, label %.lr.ph17, label %50
...
.preheader5:                                      ; preds = %.lr.ph15, %.preheader5
  ...
  call void @heap_adjust(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef %20, i32 noundef %29)
  %30 = add i64 %.2414, -1
...
53:                                               ; preds = %50, %70
  %.03931 = phi i64 [ 0, %50 ], [ %.140, %70 ]
  %.04230 = phi i64 [ 0, %50 ], [ %71, %70 ]
  %.04529 = phi i64 [ 0, %50 ], [ %.146, %70 ]
  %54 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.04230
...
.preheader7:                                      ; preds = %53
  ...
  br i1 %.not720, label %65, label %.lr.ph25

.lr.ph25:                                         ; preds = %.preheader7
  br label %59

56:                                               ; preds = %53
  %57 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04230
  store i32 0, ptr %57, align 4
  %58 = getelementptr inbounds nuw i8, ptr %7, i64 %.04230
  store i8 0, ptr %58, align 1
  br label %70

59:                                               ; preds = %.lr.ph25, %59
  %.03724 = phi i32 [ %.03719, %.lr.ph25 ], [ %.037, %59 ]
  %.323 = phi i64 [ 0, %.lr.ph25 ], [ %64, %59 ]
  %.0522 = phi i64 [ 1, %.lr.ph25 ], [ %63, %59 ]
  %.04321 = phi i64 [ 0, %.lr.ph25 ], [ %.144, %59 ]
  %60 = icmp slt i32 %.03724, 0
  %61 = select i1 %60, i64 %.0522, i64 0
  %.144 = add i64 %.04321, %61
  ...
  br i1 %.not7, label %._crit_edge26, label %59, !llvm.loop !13

._crit_edge26:                                    ; preds = %59
  %split27 = phi i64 [ %.144, %59 ]
  %split28 = phi i64 [ %64, %59 ]
  br label %65

65:                                               ; preds = %._crit_edge26, %.preheader7
  ...
  %67 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.04230
  store i32 %66, ptr %67, align 4
  %68 = trunc i64 %.3.lcssa to i8
  %69 = getelementptr inbounds nuw i8, ptr %7, i64 %.04230
...
70:                                               ; preds = %65, %56
  %.146 = phi i64 [ %spec.select, %65 ], [ %.04529, %56 ]
  %.140 = phi i64 [ %.241, %65 ], [ %.03931, %56 ]
  %71 = add nuw nsw i64 %.04230, 1
...
.preheader3.preheader:                            ; preds = %77
  ...
  br i1 %exitcond15.not43, label %118, label %.lr.ph49
...
82:                                               ; preds = %.lr.ph49, %.preheader3
  %.0148 = phi i32 [ -1, %.lr.ph49 ], [ %.1.lcssa, %.preheader3 ]
  %.1647 = phi i64 [ 0, %.lr.ph49 ], [ %117, %.preheader3 ]
  %.02446 = phi i8 [ 0, %.lr.ph49 ], [ %.125.lcssa, %.preheader3 ]
  %.02845 = phi i64 [ 0, %.lr.ph49 ], [ %.129.lcssa, %.preheader3 ]
  %.13444 = phi ptr [ %0, %.lr.ph49 ], [ %116, %.preheader3 ]
  %83 = load i8, ptr %.13444, align 1
  ...
  br i1 %92, label %.lr.ph38, label %.preheader3

.lr.ph38:                                         ; preds = %82
  br label %93

93:                                               ; preds = %.lr.ph38, %106
  %.136 = phi i32 [ %.0148, %.lr.ph38 ], [ %.2, %106 ]
  %.435 = phi i64 [ 0, %.lr.ph38 ], [ %113, %106 ]
  %.01534 = phi i64 [ %90, %.lr.ph38 ], [ %112, %106 ]
  %.12533 = phi i8 [ %.02446, %.lr.ph38 ], [ %.327, %106 ]
  %.12932 = phi i64 [ %.02845, %.lr.ph38 ], [ %.230, %106 ]
  %94 = phi i8 [ %83, %.lr.ph38 ], [ %.pre-phi.in, %106 ]
  %95 = icmp eq i32 %.136, 7
  br i1 %95, label %96, label %103

96:                                               ; preds = %93
  %97 = getelementptr inbounds nuw i8, ptr %11, i64 %.12932
  store i8 %.12533, ptr %97, align 1
  %98 = add i64 %.12932, 1
  %99 = icmp eq i64 %98, %1
...
106:                                              ; preds = %103, %._crit_edge
  ...
  br i1 %115, label %93, label %._crit_edge39, !llvm.loop !15

._crit_edge39:                                    ; preds = %106
  %split40 = phi i64 [ %.230, %106 ]
  %split41 = phi i8 [ %.327, %106 ]
  %split42 = phi i32 [ %.2, %106 ]
  br label %.preheader3

.preheader3:                                      ; preds = %._crit_edge39, %82
  %.129.lcssa = phi i64 [ %split40, %._crit_edge39 ], [ %.02845, %82 ]
  %.125.lcssa = phi i8 [ %split41, %._crit_edge39 ], [ %.02446, %82 ]
  %.1.lcssa = phi i32 [ %split42, %._crit_edge39 ], [ %.0148, %82 ]
  %116 = getelementptr inbounds nuw i8, ptr %.13444, i64 1
  %117 = add i64 %.1647, 1
...
124:                                              ; preds = %118, %148
  %.062 = phi ptr [ %9, %118 ], [ %126, %148 ]
  %.2761 = phi i64 [ 0, %118 ], [ %149, %148 ]
  %125 = trunc nuw i64 %.2761 to i8
  store i8 %125, ptr %.062, align 1
  %126 = getelementptr inbounds nuw i8, ptr %.062, i64 1
  %127 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %.2761
  %128 = load i32, ptr %127, align 4
  %129 = getelementptr inbounds nuw i8, ptr %7, i64 %.2761
...
133:                                              ; preds = %124
  ...
  %exitcond16.not53 = icmp eq i64 0, %137
  br i1 %exitcond16.not53, label %146, label %.lr.ph58

.lr.ph58:                                         ; preds = %133
  br label %139

139:                                              ; preds = %.lr.ph58, %139
  %.556 = phi i64 [ 0, %.lr.ph58 ], [ %145, %139 ]
  %.11655 = phi i64 [ %136, %.lr.ph58 ], [ %144, %139 ]
  %.01954 = phi i32 [ 0, %.lr.ph58 ], [ %spec.select1, %139 ]
  %140 = shl i32 %.01954, 1
  %141 = or disjoint i32 %140, 1
  %142 = and i64 %.11655, %138
  %.not4 = icmp eq i64 %142, 0
  %143 = add i32 %140, 2
  %spec.select1 = select i1 %.not4, i32 %141, i32 %143
  %144 = lshr i64 %.11655, 1
  %145 = add nuw nsw i64 %.556, 1
  %exitcond16.not = icmp eq i64 %145, %137
  br i1 %exitcond16.not, label %._crit_edge59, label %139, !llvm.loop !17

._crit_edge59:                                    ; preds = %139
  %split60 = phi i32 [ %spec.select1, %139 ]
  br label %146

146:                                              ; preds = %._crit_edge59, %133
  %.019.lcssa = phi i32 [ %split60, %._crit_edge59 ], [ 0, %133 ]
  %147 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.2761
  store i32 %.019.lcssa, ptr %147, align 4
  br label %148

148:                                              ; preds = %146, %124
  %149 = add nuw nsw i64 %.2761, 1
...
150:                                              ; preds = %.preheader2.preheader, %.critedge
  %.664 = phi i64 [ 1, %.preheader2.preheader ], [ %167, %.critedge ]
  %151 = getelementptr inbounds nuw [4 x i8], ptr %8, i64 %.664
  %152 = load i32, ptr %151, align 4
  %153 = getelementptr inbounds nuw i8, ptr %9, i64 %.664
  %154 = load i8, ptr %153, align 1
  br label %155

155:                                              ; preds = %150, %160
  %.3863 = phi i64 [ %.664, %150 ], [ %156, %160 ]
  %156 = add nsw i64 %.3863, -1
...
.preheader.preheader:                             ; preds = %.preheader1
  ...
  br i1 %172, label %.lr.ph71, label %195

.lr.ph71:                                         ; preds = %.preheader.preheader
  br label %173

173:                                              ; preds = %.lr.ph71, %.preheader
  ...
  %176 = load i8, ptr %.03166, align 1
  %177 = zext i8 %176 to i64
  %178 = and i64 %.21768, %177
...
187:                                              ; preds = %185
  ...
  store i8 %189, ptr %.23565, align 1
  %190 = getelementptr inbounds nuw i8, ptr %.23565, i64 1
  %191 = add nuw i64 %.31369, 1
  br label %.preheader

.preheader:                                       ; preds = %187, %185
  %.336 = phi ptr [ %190, %187 ], [ %.23565, %185 ]
  %.423 = phi i32 [ 0, %187 ], [ %spec.select2, %185 ]
  %.414 = phi i64 [ %191, %187 ], [ %.31369, %185 ]
  %.9 = phi i64 [ %.49.lcssa, %187 ], [ %.8.lcssa, %185 ]
  %192 = icmp ult i64 %.21768, 2
  %193 = lshr i64 %.21768, 1
...
37:                                               ; preds = %28
  ...
  br i1 %.not, label %.._crit_edge_crit_edge4, label %13, !llvm.loop !24

.._crit_edge_crit_edge:                           ; preds = %28
  %split = phi i32 [ %.012, %28 ]
  br label %._crit_edge
