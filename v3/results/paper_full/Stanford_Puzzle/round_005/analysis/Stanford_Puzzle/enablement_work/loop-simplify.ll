...
75:                                               ; preds = %84, %74
  %76 = phi i1 [ true, %74 ], [ false, %84 ]
  %77 = phi i32 [ 0, %74 ], [ 1, %84 ]
  br label %78

78:                                               ; preds = %78, %75
  %79 = phi i1 [ true, %75 ], [ false, %78 ]
  %80 = phi i32 [ 0, %75 ], [ 8, %78 ]
  %81 = or disjoint i32 %77, %80
  %82 = zext nneg i32 %81 to i64
  %83 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 18432), i64 %82
  store i32 1, ptr %83, align 4
  br i1 %79, label %78, label %84, !llvm.loop !34

84:                                               ; preds = %78
  br i1 %76, label %75, label %85, !llvm.loop !35
...
86:                                               ; preds = %92, %85
  %87 = phi i1 [ true, %85 ], [ false, %92 ]
  %88 = phi i64 [ 0, %85 ], [ 1, %92 ]
  br label %89

89:                                               ; preds = %89, %86
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %89 ], [ 0, %86 ]
  %.idx84 = shl nuw nsw i64 %indvars.iv63, 8
  %90 = getelementptr inbounds nuw i8, ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %.idx84
  %91 = getelementptr inbounds nuw [4 x i8], ptr %90, i64 %88
  store i32 1, ptr %91, align 4
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %exitcond66.not = icmp eq i64 %indvars.iv.next64, 2
  br i1 %exitcond66.not, label %92, label %89, !llvm.loop !36

92:                                               ; preds = %89
  br i1 %87, label %86, label %93, !llvm.loop !37
...
94:                                               ; preds = %100, %93
  %95 = phi i1 [ true, %93 ], [ false, %100 ]
  %96 = phi i64 [ 0, %93 ], [ 8, %100 ]
  br label %97

97:                                               ; preds = %97, %94
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %97 ], [ 0, %94 ]
  %.idx85 = shl nuw nsw i64 %indvars.iv67, 8
  %98 = getelementptr inbounds nuw i8, ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %.idx85
  %99 = getelementptr inbounds nuw [4 x i8], ptr %98, i64 %96
  store i32 1, ptr %99, align 4
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond70.not = icmp eq i64 %indvars.iv.next68, 2
  br i1 %exitcond70.not, label %100, label %97, !llvm.loop !38

100:                                              ; preds = %97
  br i1 %95, label %94, label %101, !llvm.loop !39
...
102:                                              ; preds = %113, %101
  %103 = phi i1 [ true, %101 ], [ false, %113 ]
  %104 = phi i64 [ 0, %101 ], [ 1, %113 ]
  br label %105

105:                                              ; preds = %112, %102
  %106 = phi i1 [ true, %102 ], [ false, %112 ]
  %107 = phi i64 [ 0, %102 ], [ 8, %112 ]
  br label %108

108:                                              ; preds = %108, %105
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %108 ], [ 0, %105 ]
  %.idx86 = shl nuw nsw i64 %indvars.iv71, 8
  %109 = getelementptr inbounds nuw i8, ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %.idx86
  %110 = getelementptr inbounds nuw [4 x i8], ptr %109, i64 %107
  %111 = getelementptr inbounds nuw [4 x i8], ptr %110, i64 %104
  store i32 1, ptr %111, align 4
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond74.not = icmp eq i64 %indvars.iv.next72, 2
  br i1 %exitcond74.not, label %112, label %108, !llvm.loop !40

112:                                              ; preds = %108
  br i1 %106, label %105, label %113, !llvm.loop !41

113:                                              ; preds = %112
  br i1 %103, label %102, label %114, !llvm.loop !42
...
119:                                              ; preds = %118, %116
  %120 = phi i32 [ %.pre, %118 ], [ %117, %116 ]
  %121 = call i32 @Trial(i32 noundef %120)
  %.not1 = icmp eq i32 %121, 0
  br i1 %.not1, label %122, label %123
...
123:                                              ; preds = %119
  ...
  %.not3 = icmp eq i32 %124, 2005
  br i1 %.not3, label %126, label %125
...
127:                                              ; preds = %126, %122
  ...
  %129 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %128) #3
  %130 = load i32, ptr @kount, align 4
  %131 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %130) #3
  ret void
}
