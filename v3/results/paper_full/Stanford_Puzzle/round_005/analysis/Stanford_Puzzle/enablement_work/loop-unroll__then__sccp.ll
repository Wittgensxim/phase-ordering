...
define dso_local range(i32 -2147483648, 512) i32 @Place(i32 noundef %0, i32 noundef %1) #0 {
  ...
  br i1 %.not4, label %29, label %.lr.ph
...
.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter = sub nuw nsw i64 %wide.trip.count, %xtraiter
  br label %7
...
22:                                               ; preds = %.epil.preheader
  ...
  br i1 %.not3.epil, label %._crit_edge.epilog-lcssa, label %26
...
._crit_edge.epilog-lcssa:                         ; preds = %26, %22
  br label %._crit_edge
...
29:                                               ; preds = %._crit_edge, %2
  %30 = getelementptr inbounds [4 x i8], ptr @class, i64 %.phi.trans.insert
  ...
  %36 = icmp slt i32 %1, 512
  br i1 %36, label %.lr.ph6, label %45
...
38:                                               ; preds = %43, %.lr.ph6
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %43 ], [ %37, %.lr.ph6 ]
  %39 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv3
  %40 = load i32, ptr %39, align 4
  %.not2 = icmp eq i32 %40, 0
  br i1 %.not2, label %41, label %43

41:                                               ; preds = %38
  %indvars.iv3.lcssa = phi i64 [ %indvars.iv3, %38 ]
  %42 = trunc nsw i64 %indvars.iv3.lcssa to i32
  br label %46

43:                                               ; preds = %38
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, 1
  %44 = and i64 %indvars.iv.next4, 4294967295
  %exitcond6.not = icmp eq i64 %44, 512
  br i1 %exitcond6.not, label %._crit_edge7, label %38, !llvm.loop !10

._crit_edge7:                                     ; preds = %43
  br label %45

45:                                               ; preds = %._crit_edge7, %29
  br label %46

46:                                               ; preds = %45, %41
  %47 = phi i32 [ 0, %45 ], [ %42, %41 ]
  ret i32 %47
}
...
22:                                               ; preds = %.epil.preheader
  ...
  br i1 %.not2.epil, label %._crit_edge.epilog-lcssa, label %26
...
83:                                               ; preds = %83, %82
  %indvars.iv14 = phi i64 [ 0, %82 ], [ %indvars.iv.next15.3, %83 ]
  %84 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv18
  %85 = getelementptr inbounds nuw [4 x i8], ptr %84, i64 %indvars.iv14
  store i32 0, ptr %85, align 4
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %86 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv18
  %87 = getelementptr inbounds nuw [4 x i8], ptr %86, i64 %indvars.iv.next15
  store i32 0, ptr %87, align 4
  %indvars.iv.next15.1 = add nuw nsw i64 %indvars.iv14, 2
  %88 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv18
  %89 = getelementptr inbounds nuw [4 x i8], ptr %88, i64 %indvars.iv.next15.1
  store i32 0, ptr %89, align 4
  %indvars.iv.next15.2 = add nuw nsw i64 %indvars.iv14, 3
  %90 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv18
  %91 = getelementptr inbounds nuw [4 x i8], ptr %90, i64 %indvars.iv.next15.2
  store i32 0, ptr %91, align 4
  %indvars.iv.next15.3 = add nuw nsw i64 %indvars.iv14, 4
  %exitcond17.not.3 = icmp eq i64 %indvars.iv.next15.3, 512
  br i1 %exitcond17.not.3, label %92, label %83, !llvm.loop !15
