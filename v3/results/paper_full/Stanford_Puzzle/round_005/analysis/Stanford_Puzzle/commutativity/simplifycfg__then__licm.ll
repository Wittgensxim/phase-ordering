...
22:                                               ; preds = %19
  %indvars.iv3.lcssa = phi i64 [ %indvars.iv3, %19 ]
  %23 = trunc nsw i64 %indvars.iv3.lcssa to i32
...
24:                                               ; preds = %19
  ...
  br i1 %exitcond6.not, label %._crit_edge7.loopexit, label %19, !llvm.loop !10

._crit_edge7.loopexit:                            ; preds = %24
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7.loopexit, %._crit_edge, %22
  %26 = phi i32 [ %23, %22 ], [ 0, %._crit_edge ], [ 0, %._crit_edge7.loopexit ]
  ret i32 %26
}
...
10:                                               ; preds = %9, %6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge.loopexit, label %6, !llvm.loop !11
...
1:                                                ; preds = %1, %0
  ...
  br i1 %exitcond.not, label %.preheader2, label %1, !llvm.loop !13

.preheader2:                                      ; preds = %1
  br label %3

3:                                                ; preds = %.preheader2, %8
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %8 ], [ 1, %.preheader2 ]
...
8:                                                ; preds = %7
  ...
  br i1 %exitcond13.not, label %.preheader1, label %3, !llvm.loop !16

.preheader1:                                      ; preds = %8
  br label %9

9:                                                ; preds = %.preheader1, %13
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %13 ], [ 0, %.preheader1 ]
...
13:                                               ; preds = %11
  ...
  br i1 %exitcond21.not, label %.preheader, label %9, !llvm.loop !18

.preheader:                                       ; preds = %13
  br label %14

14:                                               ; preds = %.preheader, %22
  %15 = phi i32 [ %23, %22 ], [ 0, %.preheader ]
  br label %16
...
25:                                               ; preds = %29, %24
  ...
  %invariant.gep3 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 2048), i64 %27
  br label %28

28:                                               ; preds = %28, %25
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %28 ], [ 0, %25 ]
  %.idx76 = shl nuw nsw i64 %indvars.iv23, 8
  %gep4 = getelementptr inbounds i8, ptr %invariant.gep3, i64 %.idx76
...
31:                                               ; preds = %33, %30
  ...
  %invariant.gep5 = getelementptr inbounds i8, ptr getelementptr inbounds nuw (i8, ptr @p, i64 4096), i64 %.idx78
  br label %32

32:                                               ; preds = %32, %31
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %32 ], [ 0, %31 ]
  %.idx77 = shl nuw nsw i64 %indvars.iv27, 8
  %gep6 = getelementptr inbounds i8, ptr %invariant.gep5, i64 %.idx77
...
35:                                               ; preds = %39, %34
  ...
  %invariant.gep7 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 6144), i64 %37
  br label %38

38:                                               ; preds = %38, %35
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %38 ], [ 0, %35 ]
  %.idx79 = shl nuw nsw i64 %indvars.iv35, 5
  %gep8 = getelementptr inbounds i8, ptr %invariant.gep7, i64 %.idx79
...
47:                                               ; preds = %51, %46
  ...
  %invariant.gep9 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 10240), i64 %49
  br label %50

50:                                               ; preds = %50, %47
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %50 ], [ 0, %47 ]
  %.idx81 = shl nuw nsw i64 %indvars.iv47, 8
  %gep10 = getelementptr inbounds i8, ptr %invariant.gep9, i64 %.idx81
...
73:                                               ; preds = %77, %72
  ...
  %invariant.gep11 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %75
  br label %76

76:                                               ; preds = %76, %73
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %76 ], [ 0, %73 ]
  %.idx84 = shl nuw nsw i64 %indvars.iv63, 8
  %gep12 = getelementptr inbounds i8, ptr %invariant.gep11, i64 %.idx84
...
79:                                               ; preds = %83, %78
  ...
  %invariant.gep13 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %81
  br label %82

82:                                               ; preds = %82, %79
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %82 ], [ 0, %79 ]
  %.idx85 = shl nuw nsw i64 %indvars.iv67, 8
  %gep14 = getelementptr inbounds i8, ptr %invariant.gep13, i64 %.idx85
  store i32 1, ptr %gep14, align 4
...
85:                                               ; preds = %93, %84
  ...
  %invariant.gep19 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %87
  br label %88

88:                                               ; preds = %92, %85
  %89 = phi i1 [ true, %85 ], [ false, %92 ]
  %90 = phi i64 [ 0, %85 ], [ 8, %92 ]
  %gep20 = getelementptr inbounds [4 x i8], ptr %invariant.gep19, i64 %90
  br label %91

91:                                               ; preds = %91, %88
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %91 ], [ 0, %88 ]
  %.idx86 = shl nuw nsw i64 %indvars.iv71, 8
  %gep18 = getelementptr inbounds i8, ptr %gep20, i64 %.idx86
  store i32 1, ptr %gep18, align 4
