...
._crit_edge.unr-lcssa:                            ; preds = %25
  %27 = and i32 %.pre, 1
  %lcmp.mod.not.not = icmp eq i32 %27, 0
  br i1 %lcmp.mod.not.not, label %.epil.preheader, label %._crit_edge

.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  %.epil.init = phi i32 [ 0, %.lr.ph ], [ %26, %._crit_edge.unr-lcssa ]
  %lcmp.mod2 = trunc i32 %3 to i1
  call void @llvm.assume(i1 %lcmp.mod2)
  br label %28

28:                                               ; preds = %.epil.preheader
  %29 = getelementptr inbounds [2048 x i8], ptr @p, i64 %.phi.trans.insert
  %30 = zext nneg i32 %.epil.init to i64
  %31 = getelementptr inbounds nuw [4 x i8], ptr %29, i64 %30
  %32 = load i32, ptr %31, align 4
  %.not3.epil = icmp eq i32 %32, 0
  br i1 %.not3.epil, label %._crit_edge.epilog-lcssa, label %33

33:                                               ; preds = %28
  %34 = add nsw i32 %1, %.epil.init
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %35
  store i32 1, ptr %36, align 4
  br label %._crit_edge.epilog-lcssa

._crit_edge.epilog-lcssa:                         ; preds = %33, %28
  br label %._crit_edge
...
37:                                               ; preds = %._crit_edge, %2
  %38 = getelementptr inbounds [4 x i8], ptr @class, i64 %.phi.trans.insert
  %39 = load i32, ptr %38, align 4
  %40 = sext i32 %39 to i64
  %41 = getelementptr inbounds [4 x i8], ptr @piececount, i64 %40
  %42 = load i32, ptr %41, align 4
  %43 = add nsw i32 %42, -1
  store i32 %43, ptr %41, align 4
  %44 = icmp slt i32 %1, 512
  br i1 %44, label %.lr.ph6, label %54

.lr.ph6:                                          ; preds = %37
  br label %45

45:                                               ; preds = %51, %.lr.ph6
  %46 = phi i32 [ %1, %.lr.ph6 ], [ %52, %51 ]
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %47
  %49 = load i32, ptr %48, align 4
  %.not2 = icmp eq i32 %49, 0
  br i1 %.not2, label %50, label %51
...
51:                                               ; preds = %45
  %52 = add nsw i32 %46, 1
  %53 = icmp slt i32 %46, 511
  br i1 %53, label %45, label %._crit_edge7, !llvm.loop !10
...
28:                                               ; preds = %.epil.preheader
  ...
  %31 = getelementptr inbounds nuw [4 x i8], ptr %29, i64 %30
  %32 = load i32, ptr %31, align 4
  %.not2.epil = icmp eq i32 %32, 0
  br i1 %.not2.epil, label %._crit_edge.epilog-lcssa, label %33
...
1:                                                ; preds = %1, %0
  ...
  %15 = icmp samesign ult i32 %2, 508
...
20:                                               ; preds = %19
  ...
  %35 = getelementptr inbounds nuw i8, ptr %34, i64 1312
...
36:                                               ; preds = %20
  ...
  %48 = getelementptr inbounds nuw i8, ptr %47, i64 1088
...
52:                                               ; preds = %36
  ...
  %64 = getelementptr inbounds nuw i8, ptr %63, i64 1120
  store i32 0, ptr %64, align 4
  %65 = zext nneg i32 %18 to i64
  %66 = getelementptr inbounds nuw [4 x i8], ptr @puzzl, i64 %65
  %67 = getelementptr inbounds nuw i8, ptr %66, i64 1376
...
68:                                               ; preds = %52
  ...
  %77 = getelementptr inbounds nuw i8, ptr %76, i64 896
  ...
  %83 = getelementptr inbounds nuw i8, ptr %82, i64 1408
...
84:                                               ; preds = %68
  ...
  %93 = getelementptr inbounds nuw i8, ptr %92, i64 928
  store i32 0, ptr %93, align 4
  %94 = zext nneg i32 %18 to i64
  %95 = getelementptr inbounds nuw [4 x i8], ptr @puzzl, i64 %94
  %96 = getelementptr inbounds nuw i8, ptr %95, i64 1184
  store i32 0, ptr %96, align 4
  %97 = zext nneg i32 %18 to i64
  %98 = getelementptr inbounds nuw [4 x i8], ptr @puzzl, i64 %97
  %99 = getelementptr inbounds nuw i8, ptr %98, i64 1440
...
105:                                              ; preds = %105, %103
  ...
  %112 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %111
  ...
  %122 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %121
  ...
  %127 = icmp samesign ult i32 %106, 508
...
174:                                              ; preds = %173
  ...
  %175 = call i32 @Fit(i32 noundef 0, i32 noundef 73)
  %.not = icmp eq i32 %175, 0
  br i1 %.not, label %178, label %176

176:                                              ; preds = %174
  %177 = call i32 @Place(i32 noundef 0, i32 noundef 73)
  store i32 %177, ptr @n, align 4
  br label %179
...
179:                                              ; preds = %178, %176
  %180 = phi i32 [ %.pre, %178 ], [ %177, %176 ]
  %181 = call i32 @Trial(i32 noundef %180)
  %.not1 = icmp eq i32 %181, 0
  br i1 %.not1, label %182, label %183
...
183:                                              ; preds = %179
  %184 = load i32, ptr @kount, align 4
  %.not3 = icmp eq i32 %184, 2005
  br i1 %.not3, label %186, label %185
...
187:                                              ; preds = %186, %182
  ...
  %189 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %188) #4
  %190 = load i32, ptr @kount, align 4
  %191 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %190) #4
  ret void
}
