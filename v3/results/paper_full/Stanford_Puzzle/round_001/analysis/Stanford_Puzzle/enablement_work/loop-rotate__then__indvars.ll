...
22:                                               ; preds = %.lr.ph6, %27
  %indvars.iv9 = phi i64 [ %21, %.lr.ph6 ], [ %indvars.iv.next10, %27 ]
  %23 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv9
  %24 = load i32, ptr %23, align 4
  %.not2 = icmp eq i32 %24, 0
  br i1 %.not2, label %25, label %27

25:                                               ; preds = %22
  %.lcssa1.wide = phi i64 [ %indvars.iv9, %22 ]
...
27:                                               ; preds = %22
  ...
  %exitcond12 = icmp ne i32 %lftr.wideiv, 512
  br i1 %exitcond12, label %22, label %._crit_edge7, !llvm.loop !10
...
4:                                                ; preds = %3, %13
  %indvars.iv10 = phi i64 [ 1, %3 ], [ %indvars.iv.next11, %13 ]
  br label %5

5:                                                ; preds = %4, %12
  %indvars.iv6 = phi i64 [ 1, %4 ], [ %indvars.iv.next7, %12 ]
  br label %6

6:                                                ; preds = %5, %6
  %indvars.iv2 = phi i64 [ 1, %5 ], [ %indvars.iv.next3, %6 ]
...
15:                                               ; preds = %14, %19
  %indvars.iv18 = phi i64 [ 0, %14 ], [ %indvars.iv.next19, %19 ]
  br label %16

16:                                               ; preds = %15, %16
  %indvars.iv14 = phi i64 [ 0, %15 ], [ %indvars.iv.next15, %16 ]
...
21:                                               ; preds = %20, %28
  %indvars.iv26 = phi i64 [ 0, %20 ], [ %indvars.iv.next27, %28 ]
  br label %22

22:                                               ; preds = %21, %27
  %indvars.iv22 = phi i64 [ 0, %21 ], [ %indvars.iv.next23, %27 ]
  br label %23

23:                                               ; preds = %22, %23
  %24 = shl nuw nsw i64 %indvars.iv22, 3
  %25 = or disjoint i64 %indvars.iv26, %24
...
30:                                               ; preds = %29, %37
  %indvars.iv34 = phi i64 [ 0, %29 ], [ %indvars.iv.next35, %37 ]
  br label %31
...
32:                                               ; preds = %31, %32
  %indvars.iv30 = phi i64 [ 0, %31 ], [ %indvars.iv.next31, %32 ]
  %33 = shl nuw nsw i64 %indvars.iv30, 6
  %34 = or disjoint i64 %indvars.iv34, %33
...
41:                                               ; preds = %40, %41
  %indvars.iv38 = phi i64 [ 0, %40 ], [ %indvars.iv.next39, %41 ]
...
49:                                               ; preds = %48, %56
  %indvars.iv50 = phi i64 [ 0, %48 ], [ %indvars.iv.next51, %56 ]
  br label %50

50:                                               ; preds = %49, %55
  %indvars.iv46 = phi i64 [ 0, %49 ], [ %indvars.iv.next47, %55 ]
  br label %51

51:                                               ; preds = %50, %51
  %52 = shl nuw nsw i64 %indvars.iv46, 3
  %53 = or disjoint i64 %indvars.iv50, %52
...
58:                                               ; preds = %57, %65
  %indvars.iv58 = phi i64 [ 0, %57 ], [ %indvars.iv.next59, %65 ]
  br label %59
...
60:                                               ; preds = %59, %60
  %indvars.iv54 = phi i64 [ 0, %59 ], [ %indvars.iv.next55, %60 ]
  %61 = shl nuw nsw i64 %indvars.iv54, 6
  %62 = or disjoint i64 %indvars.iv58, %61
...
68:                                               ; preds = %67, %74
  %indvars.iv66 = phi i64 [ 0, %67 ], [ %indvars.iv.next67, %74 ]
  br label %69

69:                                               ; preds = %68, %69
  %indvars.iv62 = phi i64 [ 0, %68 ], [ %indvars.iv.next63, %69 ]
...
77:                                               ; preds = %76, %82
  %indvars.iv70 = phi i64 [ 0, %76 ], [ %indvars.iv.next71, %82 ]
  br label %78
...
85:                                               ; preds = %84, %89
  %indvars.iv74 = phi i64 [ 0, %84 ], [ %indvars.iv.next75, %89 ]
  br label %86
...
94:                                               ; preds = %93, %94
  %indvars.iv78 = phi i64 [ 0, %93 ], [ %indvars.iv.next79, %94 ]
...
100:                                              ; preds = %99, %107
  %indvars.iv86 = phi i64 [ 0, %99 ], [ %indvars.iv.next87, %107 ]
  br label %101

101:                                              ; preds = %100, %106
  %indvars.iv82 = phi i64 [ 0, %100 ], [ %indvars.iv.next83, %106 ]
  br label %102

102:                                              ; preds = %101, %102
  %103 = shl nuw nsw i64 %indvars.iv82, 3
  %104 = or disjoint i64 %indvars.iv86, %103
...
109:                                              ; preds = %108, %116
  %indvars.iv94 = phi i64 [ 0, %108 ], [ %indvars.iv.next95, %116 ]
  br label %110
...
111:                                              ; preds = %110, %111
  %indvars.iv90 = phi i64 [ 0, %110 ], [ %indvars.iv.next91, %111 ]
  %112 = shl nuw nsw i64 %indvars.iv90, 6
  %113 = or disjoint i64 %indvars.iv94, %112
...
119:                                              ; preds = %118, %125
  %indvars.iv102 = phi i64 [ 0, %118 ], [ %indvars.iv.next103, %125 ]
  br label %120

120:                                              ; preds = %119, %120
  %indvars.iv98 = phi i64 [ 0, %119 ], [ %indvars.iv.next99, %120 ]
...
128:                                              ; preds = %127, %137
  %indvars.iv114 = phi i64 [ 0, %127 ], [ %indvars.iv.next115, %137 ]
  br label %129

129:                                              ; preds = %128, %136
  %indvars.iv110 = phi i64 [ 0, %128 ], [ %indvars.iv.next111, %136 ]
  br label %130

130:                                              ; preds = %129, %130
  %indvars.iv106 = phi i64 [ 0, %129 ], [ %indvars.iv.next107, %130 ]
  %131 = shl nuw nsw i64 %indvars.iv106, 6
  %132 = shl nuw nsw i64 %indvars.iv110, 3
  %133 = or disjoint i64 %131, %132
  %134 = or disjoint i64 %indvars.iv114, %133
