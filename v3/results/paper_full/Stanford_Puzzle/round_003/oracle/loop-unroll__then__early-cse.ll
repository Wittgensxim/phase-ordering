...
168:                                              ; preds = %167
  ...
  %169 = call i32 @Fit(i32 noundef 0, i32 noundef 73)
  %.not = icmp eq i32 %169, 0
  br i1 %.not, label %172, label %170

170:                                              ; preds = %168
  %171 = call i32 @Place(i32 noundef 0, i32 noundef 73)
  store i32 %171, ptr @n, align 4
  br label %173
...
173:                                              ; preds = %172, %170
  %174 = phi i32 [ %.pre, %172 ], [ %171, %170 ]
  %175 = call i32 @Trial(i32 noundef %174)
  %.not1 = icmp eq i32 %175, 0
  br i1 %.not1, label %176, label %177
...
177:                                              ; preds = %173
  %178 = load i32, ptr @kount, align 4
  %.not3 = icmp eq i32 %178, 2005
  br i1 %.not3, label %180, label %179
...
181:                                              ; preds = %180, %176
  ...
  %183 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %182) #4
