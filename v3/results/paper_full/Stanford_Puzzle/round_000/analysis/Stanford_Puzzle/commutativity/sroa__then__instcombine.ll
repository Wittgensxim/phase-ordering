...
4:                                                ; preds = %25, %1
  %.012 = phi i32 [ 0, %1 ], [ %26, %25 ]
  %5 = icmp samesign ult i32 %.012, 13
  br i1 %5, label %6, label %27

6:                                                ; preds = %4
  %7 = zext nneg i32 %.012 to i64
...
13:                                               ; preds = %6
  %14 = call i32 @Fit(i32 noundef %.012, i32 noundef %0)
  %.not13 = icmp eq i32 %14, 0
  br i1 %.not13, label %23, label %15
...
9:                                                ; preds = %30, %8
  ...
  %10 = icmp samesign ult i32 %.0153, 6
...
12:                                               ; preds = %27, %11
  ...
  %13 = icmp samesign ult i32 %.0139, 6
...
15:                                               ; preds = %24, %14
  ...
  %16 = icmp samesign ult i32 %.0137, 6
  br i1 %16, label %17, label %26

17:                                               ; preds = %15
  %18 = shl nuw nsw i32 %.0137, 6
  %19 = shl nuw nsw i32 %.0139, 3
  %20 = or disjoint i32 %18, %19
  %21 = or disjoint i32 %.0153, %20
...
33:                                               ; preds = %46, %32
  ...
  %34 = icmp samesign ult i32 %.1154, 13
...
49:                                               ; preds = %66, %48
  %.2155 = phi i32 [ 0, %48 ], [ %67, %66 ]
  %50 = icmp samesign ult i32 %.2155, 4
...
52:                                               ; preds = %63, %51
  %.1140 = phi i32 [ 0, %51 ], [ %64, %63 ]
  %53 = icmp samesign ult i32 %.1140, 2
...
55:                                               ; preds = %61, %54
  %.1138 = phi i1 [ true, %54 ], [ false, %61 ]
  br i1 %.1138, label %56, label %62

56:                                               ; preds = %55
  %57 = shl nuw nsw i32 %.1140, 3
  %58 = or disjoint i32 %.2155, %57
...
69:                                               ; preds = %87, %68
  %.3156 = phi i32 [ 0, %68 ], [ %88, %87 ]
  %70 = icmp samesign ult i32 %.3156, 2
...
93:                                               ; preds = %107, %92
  %.3142 = phi i32 [ 0, %92 ], [ %108, %107 ]
  %94 = icmp samesign ult i32 %.3142, 4
...
112:                                              ; preds = %129, %111
  %.5158 = phi i32 [ 0, %111 ], [ %130, %129 ]
  %113 = icmp samesign ult i32 %.5158, 2
...
115:                                              ; preds = %126, %114
  %.4143 = phi i32 [ 0, %114 ], [ %127, %126 ]
  %116 = icmp samesign ult i32 %.4143, 4
...
119:                                              ; preds = %118
  %120 = shl nuw nsw i32 %.4143, 3
  %121 = or disjoint i32 %.5158, %120
...
132:                                              ; preds = %150, %131
  %.6159 = phi i32 [ 0, %131 ], [ %151, %150 ]
  %133 = icmp samesign ult i32 %.6159, 4
...
156:                                              ; preds = %170, %155
  %.6145 = phi i32 [ 0, %155 ], [ %171, %170 ]
  %157 = icmp samesign ult i32 %.6145, 2
...
175:                                              ; preds = %189, %174
  %.8161 = phi i32 [ 0, %174 ], [ %190, %189 ]
  %176 = icmp samesign ult i32 %.8161, 3
...
195:                                              ; preds = %205, %194
  %.8147 = phi i32 [ 0, %194 ], [ %206, %205 ]
  %196 = icmp samesign ult i32 %.8147, 3
...
229:                                              ; preds = %246, %228
  %.11164 = phi i32 [ 0, %228 ], [ %247, %246 ]
  %230 = icmp samesign ult i32 %.11164, 2
...
232:                                              ; preds = %243, %231
  %.10149 = phi i32 [ 0, %231 ], [ %244, %243 ]
  %233 = icmp samesign ult i32 %.10149, 2
...
236:                                              ; preds = %235
  %237 = shl nuw nsw i32 %.10149, 3
  %238 = or disjoint i32 %.11164, %237
...
249:                                              ; preds = %267, %248
  %.12165 = phi i32 [ 0, %248 ], [ %268, %267 ]
  %250 = icmp samesign ult i32 %.12165, 2
...
273:                                              ; preds = %287, %272
  %.12151 = phi i32 [ 0, %272 ], [ %288, %287 ]
  %274 = icmp samesign ult i32 %.12151, 2
...
295:                                              ; preds = %310, %294
  %.13152 = phi i32 [ 0, %294 ], [ %311, %310 ]
  %296 = icmp samesign ult i32 %.13152, 2
...
320:                                              ; preds = %319, %317
  ...
  br i1 %.not167, label %323, label %324

323:                                              ; preds = %320
  %puts168 = call i32 @puts(ptr nonnull dereferenceable(1) @str.1)
  br label %328

324:                                              ; preds = %320
  %325 = load i32, ptr @kount, align 4
  %.not169 = icmp eq i32 %325, 2005
  br i1 %.not169, label %327, label %326
