...
34:                                               ; preds = %42, %21
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %42 ], [ %3, %21 ]
  %exitcond = icmp ne i64 %indvars.iv4, %wide.trip.count
  br i1 %exitcond, label %35, label %43

35:                                               ; preds = %34
  %36 = getelementptr inbounds [512 x i32], ptr @puzzl, i64 0, i64 %indvars.iv4
  %37 = load i32, ptr %36, align 4
  %38 = icmp ne i32 %37, 0
  br i1 %38, label %41, label %39

39:                                               ; preds = %35
  %.1.lcssa2.wide = phi i64 [ %indvars.iv4, %35 ]
  %40 = trunc nsw i64 %.1.lcssa2.wide to i32
  br label %44
