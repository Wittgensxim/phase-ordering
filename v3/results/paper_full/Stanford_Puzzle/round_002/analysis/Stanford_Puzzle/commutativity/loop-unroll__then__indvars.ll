...
170:                                              ; preds = %169
  ...
  %171 = call i32 @Fit(i32 noundef 0, i32 noundef 73)
  %.not = icmp eq i32 %171, 0
  br i1 %.not, label %174, label %172

172:                                              ; preds = %170
  %173 = call i32 @Place(i32 noundef 0, i32 noundef 73)
  store i32 %173, ptr @n, align 4
  br label %175
...
175:                                              ; preds = %174, %172
  %176 = phi i32 [ %.pre, %174 ], [ %173, %172 ]
  %177 = call i32 @Trial(i32 noundef %176)
  %.not1 = icmp eq i32 %177, 0
  br i1 %.not1, label %178, label %179
...
179:                                              ; preds = %175
  ...
  %.not3 = icmp eq i32 %180, 2005
  br i1 %.not3, label %182, label %181
