...
49:                                               ; preds = %._crit_edge, %43
  br i1 false, label %._crit_edge, label %50, !llvm.loop !19
...
68:                                               ; preds = %60
  br i1 false, label %._crit_edge1, label %69, !llvm.loop !23
...
88:                                               ; preds = %85
  br i1 false, label %._crit_edge2, label %89, !llvm.loop !27
...
98:                                               ; preds = %._crit_edge3, %92
  br i1 false, label %._crit_edge3, label %99, !llvm.loop !28
...
117:                                              ; preds = %109
  br i1 false, label %._crit_edge4, label %118, !llvm.loop !32
...
137:                                              ; preds = %134
  br i1 false, label %._crit_edge5, label %138, !llvm.loop !36

._crit_edge5:                                     ; preds = %137
...
143:                                              ; preds = %._crit_edge7, %139
  br label %144

144:                                              ; preds = %._crit_edge6, %143
  br i1 false, label %._crit_edge6, label %145, !llvm.loop !37

._crit_edge6:                                     ; preds = %144
  br label %144, !llvm.loop !37

145:                                              ; preds = %144
  br i1 false, label %._crit_edge7, label %146, !llvm.loop !38

._crit_edge7:                                     ; preds = %145
...
156:                                              ; preds = %._crit_edge8, %151
  br i1 false, label %._crit_edge8, label %157, !llvm.loop !40

._crit_edge8:                                     ; preds = %156
...
160:                                              ; preds = %157
  br i1 false, label %._crit_edge9, label %161, !llvm.loop !42
...
162:                                              ; preds = %._crit_edge11, %161
  br label %163

163:                                              ; preds = %._crit_edge10, %162
  br label %164
...
171:                                              ; preds = %164
  br i1 false, label %._crit_edge10, label %172, !llvm.loop !44

._crit_edge10:                                    ; preds = %171
  br label %163, !llvm.loop !44

172:                                              ; preds = %171
  br i1 false, label %._crit_edge11, label %173, !llvm.loop !45

._crit_edge11:                                    ; preds = %172
...
182:                                              ; preds = %._crit_edge12, %176
  br i1 false, label %._crit_edge12, label %183, !llvm.loop !46

._crit_edge12:                                    ; preds = %182
...
201:                                              ; preds = %193
  br i1 false, label %._crit_edge13, label %202, !llvm.loop !50

._crit_edge13:                                    ; preds = %201
  br label %192, !llvm.loop !50
...
221:                                              ; preds = %218
  br i1 false, label %._crit_edge14, label %222, !llvm.loop !54

._crit_edge14:                                    ; preds = %221
  br label %206, !llvm.loop !54
...
225:                                              ; preds = %235, %223
  ...
  %invariant.op15 = or disjoint i32 %227, %224
  br label %228

228:                                              ; preds = %228, %225
  %229 = phi i32 [ 0, %225 ], [ %233, %228 ]
  %230 = shl nuw nsw i32 %229, 6
  %.reass16 = or disjoint i32 %230, %invariant.op15
  %231 = zext nneg i32 %.reass16 to i64
