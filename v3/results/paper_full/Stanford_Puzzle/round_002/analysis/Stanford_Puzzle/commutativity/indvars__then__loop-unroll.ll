...
162:                                              ; preds = %161
  ...
  %163 = call i32 @Fit(i32 noundef 0, i32 noundef 73)
  %.not = icmp eq i32 %163, 0
  br i1 %.not, label %166, label %164

164:                                              ; preds = %162
  %165 = call i32 @Place(i32 noundef 0, i32 noundef 73)
  store i32 %165, ptr @n, align 4
  br label %167
...
167:                                              ; preds = %166, %164
  %168 = phi i32 [ %.pre, %166 ], [ %165, %164 ]
  %169 = call i32 @Trial(i32 noundef %168)
  %.not1 = icmp eq i32 %169, 0
  br i1 %.not1, label %170, label %171
...
171:                                              ; preds = %167
  %172 = load i32, ptr @kount, align 4
  %.not3 = icmp eq i32 %172, 2005
...
175:                                              ; preds = %174, %170
  ...
  %177 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %176) #4
