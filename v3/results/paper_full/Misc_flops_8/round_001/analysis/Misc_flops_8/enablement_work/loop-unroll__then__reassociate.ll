...
5:                                                ; preds = %9, %0
  %6 = phi double [ %40, %9 ], [ 0.000000e+00, %0 ]
  %7 = phi i32 [ %41, %9 ], [ 1, %0 ]
  %8 = icmp samesign ult i32 %7, 156250000
...
9:                                                ; preds = %5
  ...
  %25 = call double @llvm.fmuladd.f64(double %12, double %23, double %24)
  %26 = fmul double %25, %25
  %27 = fmul double %11, %26
  %28 = load double, ptr @A6, align 8
  %29 = load double, ptr @A5, align 8
  %30 = call double @llvm.fmuladd.f64(double %28, double %12, double %29)
  %31 = load double, ptr @A4, align 8
  %32 = call double @llvm.fmuladd.f64(double %30, double %12, double %31)
  %33 = load double, ptr @A3, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %12, double %33)
  %35 = load double, ptr @A2, align 8
  %36 = call double @llvm.fmuladd.f64(double %34, double %12, double %35)
  %37 = load double, ptr @A1, align 8
  %38 = call double @llvm.fmuladd.f64(double %36, double %12, double %37)
  %39 = call double @llvm.fmuladd.f64(double %38, double %12, double %24)
  %40 = call double @llvm.fmuladd.f64(double %27, double %39, double %6)
