...
5:                                                ; preds = %8, %0
  %6 = phi double [ %39, %8 ], [ 0.000000e+00, %0 ]
  %7 = phi i32 [ %40, %8 ], [ 1, %0 ]
  %exitcond.not = icmp eq i32 %7, 156250000
  br i1 %exitcond.not, label %41, label %8
...
8:                                                ; preds = %5
  ...
  %17 = load double, ptr @B3, align 8
  %18 = call double @llvm.fmuladd.f64(double %11, double %16, double %17)
  %19 = load double, ptr @B2, align 8
  %20 = call double @llvm.fmuladd.f64(double %11, double %18, double %19)
  %21 = load double, ptr @B1, align 8
  %22 = call double @llvm.fmuladd.f64(double %11, double %20, double %21)
  %23 = load double, ptr @one, align 8
  %24 = call double @llvm.fmuladd.f64(double %11, double %22, double %23)
  %25 = fmul double %24, %24
  %26 = fmul double %25, %10
  %27 = load double, ptr @A6, align 8
  %28 = load double, ptr @A5, align 8
  %29 = call double @llvm.fmuladd.f64(double %27, double %11, double %28)
  %30 = load double, ptr @A4, align 8
  %31 = call double @llvm.fmuladd.f64(double %29, double %11, double %30)
  %32 = load double, ptr @A3, align 8
  %33 = call double @llvm.fmuladd.f64(double %31, double %11, double %32)
  %34 = load double, ptr @A2, align 8
  %35 = call double @llvm.fmuladd.f64(double %33, double %11, double %34)
  %36 = load double, ptr @A1, align 8
  %37 = call double @llvm.fmuladd.f64(double %35, double %11, double %36)
  %38 = call double @llvm.fmuladd.f64(double %37, double %11, double %23)
