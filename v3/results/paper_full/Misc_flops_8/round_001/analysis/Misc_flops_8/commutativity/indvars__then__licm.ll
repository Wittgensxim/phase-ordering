...
18:                                               ; preds = %21, %0
  %19 = phi double [ %39, %21 ], [ 0.000000e+00, %0 ]
  %20 = phi i32 [ %40, %21 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %20, 156250000
  br i1 %exitcond, label %21, label %41

21:                                               ; preds = %18
  %22 = uitofp nneg i32 %20 to double
  %23 = fmul double %4, %22
  %24 = fmul double %23, %23
  %25 = call double @llvm.fmuladd.f64(double %5, double %24, double %6)
  %26 = call double @llvm.fmuladd.f64(double %24, double %25, double %7)
  %27 = call double @llvm.fmuladd.f64(double %24, double %26, double %8)
  %28 = call double @llvm.fmuladd.f64(double %24, double %27, double %9)
  %29 = call double @llvm.fmuladd.f64(double %24, double %28, double %10)
  %30 = call double @llvm.fmuladd.f64(double %24, double %29, double %11)
  %31 = fmul double %30, %30
  %32 = fmul double %31, %23
  %33 = call double @llvm.fmuladd.f64(double %12, double %24, double %13)
  %34 = call double @llvm.fmuladd.f64(double %33, double %24, double %14)
  %35 = call double @llvm.fmuladd.f64(double %34, double %24, double %15)
  %36 = call double @llvm.fmuladd.f64(double %35, double %24, double %16)
  %37 = call double @llvm.fmuladd.f64(double %36, double %24, double %17)
  %38 = call double @llvm.fmuladd.f64(double %37, double %24, double %11)
  %39 = call double @llvm.fmuladd.f64(double %32, double %38, double %19)
...
41:                                               ; preds = %18
  ...
  %76 = fadd double %75, f0xBFD2AAAAAAAAAAAB
