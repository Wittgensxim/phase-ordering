...
5:                                                ; preds = %0, %5
  ...
  %11 = call double @llvm.fmuladd.f64(double %9, double %8, double %10)
  %12 = load double, ptr @B4, align 8
  %13 = call double @llvm.fmuladd.f64(double %8, double %11, double %12)
  %14 = load double, ptr @B3, align 8
  %15 = call double @llvm.fmuladd.f64(double %8, double %13, double %14)
  %16 = load double, ptr @B2, align 8
  %17 = call double @llvm.fmuladd.f64(double %8, double %15, double %16)
  %18 = load double, ptr @B1, align 8
  %19 = call double @llvm.fmuladd.f64(double %8, double %17, double %18)
  %20 = load double, ptr @one, align 8
  %21 = call double @llvm.fmuladd.f64(double %8, double %19, double %20)
  %22 = fmul double %21, %21
  %23 = fmul double %22, %7
  %24 = load double, ptr @A6, align 8
  %25 = load double, ptr @A5, align 8
  %26 = call double @llvm.fmuladd.f64(double %24, double %8, double %25)
  %27 = load double, ptr @A4, align 8
  %28 = call double @llvm.fmuladd.f64(double %26, double %8, double %27)
  %29 = load double, ptr @A3, align 8
  %30 = call double @llvm.fmuladd.f64(double %28, double %8, double %29)
  %31 = load double, ptr @A2, align 8
  %32 = call double @llvm.fmuladd.f64(double %30, double %8, double %31)
  %33 = load double, ptr @A1, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %8, double %33)
  %35 = call double @llvm.fmuladd.f64(double %34, double %8, double %20)
  %36 = call double @llvm.fmuladd.f64(double %23, double %35, double %.014)
...
39:                                               ; preds = %5
  ...
  %71 = call double @llvm.fmuladd.f64(double %70, double %.01.lcssa, double %69)
  %72 = fmul double %4, %71
  %73 = fdiv double %72, %70
  store double %73, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %74 = fadd double %73, f0xBFD2AAAAAAAAAAAB
