...
26:                                               ; preds = %.lr.ph, %64
  ...
  %54 = call double @llvm.fmuladd.f64(double %52, double %50, double %53)
  %55 = load double, ptr @A3, align 8
  %56 = call double @llvm.fmuladd.f64(double %54, double %50, double %55)
  %57 = load double, ptr @A2, align 8
  %58 = call double @llvm.fmuladd.f64(double %56, double %50, double %57)
  %59 = load double, ptr @A1, align 8
  %60 = call double @llvm.fmuladd.f64(double %58, double %50, double %59)
  %61 = load double, ptr @one, align 8
  %62 = call double @llvm.fmuladd.f64(double %60, double %50, double %61)
  %63 = call double @llvm.fmuladd.f64(double %48, double %62, double %45)
...
70:                                               ; preds = %._crit_edge, %0
  ...
  %114 = fsub double %113, f0x3FD2AAAAAAAAAAAB
