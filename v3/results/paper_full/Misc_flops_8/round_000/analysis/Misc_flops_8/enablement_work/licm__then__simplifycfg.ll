...
42:                                               ; preds = %49, %0
  %43 = phi double [ %67, %49 ], [ %.promoted7, %0 ]
  %44 = phi double [ %58, %49 ], [ %.promoted5, %0 ]
  %45 = phi double [ %52, %49 ], [ %.promoted3, %0 ]
  %46 = phi double [ %51, %49 ], [ %.promoted1, %0 ]
  %47 = phi i32 [ %68, %49 ], [ %.promoted, %0 ]
...
49:                                               ; preds = %42
  ...
  %54 = call double @llvm.fmuladd.f64(double %52, double %53, double %30)
  %55 = call double @llvm.fmuladd.f64(double %52, double %54, double %31)
  %56 = call double @llvm.fmuladd.f64(double %52, double %55, double %32)
  %57 = call double @llvm.fmuladd.f64(double %52, double %56, double %33)
  %58 = call double @llvm.fmuladd.f64(double %52, double %57, double %34)
  %59 = fmul double %58, %58
  %60 = fmul double %59, %51
  %61 = call double @llvm.fmuladd.f64(double %35, double %52, double %36)
  %62 = call double @llvm.fmuladd.f64(double %61, double %52, double %37)
  %63 = call double @llvm.fmuladd.f64(double %62, double %52, double %38)
  %64 = call double @llvm.fmuladd.f64(double %63, double %52, double %39)
  %65 = call double @llvm.fmuladd.f64(double %64, double %52, double %40)
  %66 = call double @llvm.fmuladd.f64(double %65, double %52, double %41)
  %67 = call double @llvm.fmuladd.f64(double %60, double %66, double %43)
  %68 = add nsw i32 %47, 1
