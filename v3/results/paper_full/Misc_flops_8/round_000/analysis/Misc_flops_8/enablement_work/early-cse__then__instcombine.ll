...
15:                                               ; preds = %54, %0
  ...
  br i1 %.not.not, label %17, label %57
...
17:                                               ; preds = %15
  ...
  %44 = call double @llvm.fmuladd.f64(double %42, double %40, double %43)
  %45 = load double, ptr @A3, align 8
  %46 = call double @llvm.fmuladd.f64(double %44, double %40, double %45)
  %47 = load double, ptr @A2, align 8
  %48 = call double @llvm.fmuladd.f64(double %46, double %40, double %47)
  %49 = load double, ptr @A1, align 8
  %50 = call double @llvm.fmuladd.f64(double %48, double %40, double %49)
  %51 = load double, ptr @one, align 8
  %52 = call double @llvm.fmuladd.f64(double %50, double %40, double %51)
  %53 = call double @llvm.fmuladd.f64(double %38, double %52, double %35)
...
57:                                               ; preds = %15
  ...
  %70 = call double @llvm.fmuladd.f64(double %68, double %61, double %69)
  %71 = load double, ptr @A1, align 8
  %72 = call double @llvm.fmuladd.f64(double %70, double %61, double %71)
  %73 = load double, ptr @one, align 8
  %74 = call double @llvm.fmuladd.f64(double %72, double %61, double %73)
