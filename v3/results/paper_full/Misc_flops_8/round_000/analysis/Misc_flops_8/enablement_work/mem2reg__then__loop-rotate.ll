...
13:                                               ; preds = %0, %46
  %.03 = phi i32 [ 1, %0 ], [ %47, %46 ]
  %.012 = phi double [ 0.000000e+00, %0 ], [ %45, %46 ]
  %14 = sitofp i32 %.03 to double
  ...
  %45 = call double @llvm.fmuladd.f64(double %31, double %44, double %.012)
  br label %46
...
49:                                               ; preds = %46
  ...
  %88 = call double @llvm.fmuladd.f64(double %87, double %.01.lcssa, double %86)
