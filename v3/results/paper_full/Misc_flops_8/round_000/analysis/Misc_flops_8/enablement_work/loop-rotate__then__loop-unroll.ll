...
29:                                               ; preds = %.lr.ph, %82
  ...
  %51 = call double @llvm.fmuladd.f64(double %39, double %49, double %50)
  %52 = load double, ptr @B1, align 8
  %53 = call double @llvm.fmuladd.f64(double %38, double %51, double %52)
  %54 = load double, ptr @one, align 8
  %55 = call double @llvm.fmuladd.f64(double %37, double %53, double %54)
  ...
  %81 = call double @llvm.fmuladd.f64(double %61, double %80, double %56)
...
82:                                               ; preds = %29
  ...
  br i1 %88, label %29, label %._crit_edge, !llvm.loop !7
...
89:                                               ; preds = %._crit_edge, %0
  ...
  %91 = load double, ptr @three, align 8
  ...
  %122 = load double, ptr @B6, align 8
  %123 = load double, ptr %5, align 8
  %124 = load double, ptr @B5, align 8
  %125 = call double @llvm.fmuladd.f64(double %122, double %123, double %124)
  %126 = load double, ptr @B4, align 8
  %127 = call double @llvm.fmuladd.f64(double %121, double %125, double %126)
  %128 = load double, ptr @B3, align 8
  %129 = call double @llvm.fmuladd.f64(double %120, double %127, double %128)
  %130 = load double, ptr @B2, align 8
  %131 = call double @llvm.fmuladd.f64(double %119, double %129, double %130)
  %132 = load double, ptr @B1, align 8
  %133 = call double @llvm.fmuladd.f64(double %118, double %131, double %132)
  %134 = load double, ptr @one, align 8
  %135 = call double @llvm.fmuladd.f64(double %117, double %133, double %134)
  store double %135, ptr @sb, align 8
  %136 = load double, ptr @sa, align 8
  %137 = load double, ptr @sb, align 8
  %138 = fmul double %136, %137
  %139 = load double, ptr @sb, align 8
  %140 = fmul double %138, %139
  store double %140, ptr @sa, align 8
  ...
  %147 = load double, ptr @two, align 8
  %148 = fdiv double %146, %147
  store double %148, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %149 = load double, ptr @sa, align 8
  %150 = load double, ptr @sb, align 8
  %151 = fsub double %149, %150
  store double %151, ptr @sc, align 8
  %152 = load double, ptr @sc, align 8
  %153 = fmul double %152, 1.000000e-30
  %154 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %153, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
