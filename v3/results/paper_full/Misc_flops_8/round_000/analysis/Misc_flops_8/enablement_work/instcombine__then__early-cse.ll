...
15:                                               ; preds = %52, %0
  %storemerge = phi i32 [ 1, %0 ], [ %54, %52 ]
  store i32 %storemerge, ptr %6, align 4
  %16 = load i32, ptr %7, align 4
  %.not.not = icmp slt i32 %storemerge, %16
  br i1 %.not.not, label %17, label %55

17:                                               ; preds = %15
  %18 = sitofp i32 %storemerge to double
  ...
  %34 = call double @llvm.fmuladd.f64(double %21, double %32, double %33)
  ...
  %41 = call double @llvm.fmuladd.f64(double %39, double %21, double %40)
  %42 = load double, ptr @A4, align 8
  %43 = call double @llvm.fmuladd.f64(double %41, double %21, double %42)
  %44 = load double, ptr @A3, align 8
  %45 = call double @llvm.fmuladd.f64(double %43, double %21, double %44)
  %46 = load double, ptr @A2, align 8
  %47 = call double @llvm.fmuladd.f64(double %45, double %21, double %46)
  %48 = load double, ptr @A1, align 8
  %49 = call double @llvm.fmuladd.f64(double %47, double %21, double %48)
  %50 = call double @llvm.fmuladd.f64(double %49, double %21, double %33)
  %51 = call double @llvm.fmuladd.f64(double %38, double %50, double %35)
...
55:                                               ; preds = %15
  ...
  %94 = call double @llvm.fmuladd.f64(double %92, double %93, double %90)
  %95 = fmul double %91, %94
  %96 = fdiv double %95, %92
  store double %96, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %97 = fadd double %96, f0xBFD2AAAAAAAAAAAB
  store double %97, ptr @sc, align 8
  %98 = fmul double %97, 1.000000e-30
  %99 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %98, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
