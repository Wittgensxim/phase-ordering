...
81:                                               ; preds = %28
  ...
  br i1 %87, label %28, label %._crit_edge, !llvm.loop !7
...
88:                                               ; preds = %._crit_edge, %0
  ...
  %138 = load double, ptr @sb, align 8
  ...
  %153 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %152, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
