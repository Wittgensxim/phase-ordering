...
41:                                               ; preds = %66, %0
  ...
  %43 = phi double [ %56, %66 ], [ %.promoted5, %0 ]
...
47:                                               ; preds = %41
  ...
  %52 = call double @llvm.fmuladd.f64(double %50, double %51, double %29)
  %53 = call double @llvm.fmuladd.f64(double %50, double %52, double %30)
  %54 = call double @llvm.fmuladd.f64(double %50, double %53, double %31)
  %55 = call double @llvm.fmuladd.f64(double %50, double %54, double %32)
  %56 = call double @llvm.fmuladd.f64(double %50, double %55, double %33)
  %57 = fmul double %56, %56
  %58 = fmul double %57, %49
  %59 = call double @llvm.fmuladd.f64(double %34, double %50, double %35)
  %60 = call double @llvm.fmuladd.f64(double %59, double %50, double %36)
  %61 = call double @llvm.fmuladd.f64(double %60, double %50, double %37)
  %62 = call double @llvm.fmuladd.f64(double %61, double %50, double %38)
  %63 = call double @llvm.fmuladd.f64(double %62, double %50, double %39)
  %64 = call double @llvm.fmuladd.f64(double %63, double %50, double %40)
