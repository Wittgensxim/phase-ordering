...
41:                                               ; preds = %67, %0
  %42 = phi double [ %66, %67 ], [ %.promoted7, %0 ]
  %43 = phi double [ %57, %67 ], [ %.promoted5, %0 ]
  %44 = phi double [ %51, %67 ], [ %.promoted3, %0 ]
  %45 = phi double [ %50, %67 ], [ %.promoted1, %0 ]
  %46 = phi i32 [ %68, %67 ], [ %.promoted, %0 ]
...
48:                                               ; preds = %41
  ...
  %52 = call double @llvm.fmuladd.f64(double %27, double %51, double %28)
  %53 = call double @llvm.fmuladd.f64(double %51, double %52, double %29)
  %54 = call double @llvm.fmuladd.f64(double %51, double %53, double %30)
  %55 = call double @llvm.fmuladd.f64(double %51, double %54, double %31)
  %56 = call double @llvm.fmuladd.f64(double %51, double %55, double %32)
  %57 = call double @llvm.fmuladd.f64(double %51, double %56, double %33)
  %58 = fmul double %57, %57
  %59 = fmul double %58, %50
  %60 = call double @llvm.fmuladd.f64(double %34, double %51, double %35)
  %61 = call double @llvm.fmuladd.f64(double %60, double %51, double %36)
  %62 = call double @llvm.fmuladd.f64(double %61, double %51, double %37)
  %63 = call double @llvm.fmuladd.f64(double %62, double %51, double %38)
  %64 = call double @llvm.fmuladd.f64(double %63, double %51, double %39)
  %65 = call double @llvm.fmuladd.f64(double %64, double %51, double %40)
  %66 = call double @llvm.fmuladd.f64(double %59, double %65, double %42)
  br label %67
...
69:                                               ; preds = %41
  ...
  %102 = load double, ptr @B6, align 8
  %103 = load double, ptr %5, align 8
  %104 = load double, ptr @B5, align 8
  %105 = call double @llvm.fmuladd.f64(double %102, double %103, double %104)
  %106 = load double, ptr @B4, align 8
  %107 = call double @llvm.fmuladd.f64(double %101, double %105, double %106)
  %108 = load double, ptr @B3, align 8
  %109 = call double @llvm.fmuladd.f64(double %100, double %107, double %108)
  %110 = load double, ptr @B2, align 8
  %111 = call double @llvm.fmuladd.f64(double %99, double %109, double %110)
  %112 = load double, ptr @B1, align 8
  %113 = call double @llvm.fmuladd.f64(double %98, double %111, double %112)
  %114 = load double, ptr @one, align 8
  %115 = call double @llvm.fmuladd.f64(double %97, double %113, double %114)
  store double %115, ptr @sb, align 8
