...
9:                                                ; preds = %11, %0
  %.041 = phi i32 [ 1, %0 ], [ %43, %11 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %42, %11 ]
  %10 = icmp sle i32 %.041, 156249999
  br i1 %10, label %11, label %44

11:                                               ; preds = %9
  %12 = sitofp i32 %.041 to double
  %13 = fmul double %12, %8
  ...
  %27 = call double @llvm.fmuladd.f64(double %14, double %25, double %26)
  %28 = fmul double %27, %27
  %29 = fmul double %28, %13
  %30 = load double, ptr @A6, align 8
  %31 = load double, ptr @A5, align 8
  %32 = call double @llvm.fmuladd.f64(double %30, double %14, double %31)
  %33 = load double, ptr @A4, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %14, double %33)
  %35 = load double, ptr @A3, align 8
  %36 = call double @llvm.fmuladd.f64(double %34, double %14, double %35)
  %37 = load double, ptr @A2, align 8
  %38 = call double @llvm.fmuladd.f64(double %36, double %14, double %37)
  %39 = load double, ptr @A1, align 8
  %40 = call double @llvm.fmuladd.f64(double %38, double %14, double %39)
  %41 = call double @llvm.fmuladd.f64(double %40, double %14, double %26)
...
44:                                               ; preds = %9
  ...
  %76 = call double @llvm.fmuladd.f64(double %75, double %.0, double %74)
  %77 = fmul double %8, %76
  %78 = fdiv double %77, %75
  store double %78, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %79 = fsub double %78, f0x3FD2AAAAAAAAAAAB
