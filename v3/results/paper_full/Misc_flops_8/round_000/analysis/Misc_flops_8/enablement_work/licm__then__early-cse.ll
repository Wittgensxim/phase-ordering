...
39:                                               ; preds = %65, %0
  ...
  %41 = phi double [ %55, %65 ], [ %.promoted5, %0 ]
...
46:                                               ; preds = %39
  ...
  %51 = call double @llvm.fmuladd.f64(double %49, double %50, double %28)
  %52 = call double @llvm.fmuladd.f64(double %49, double %51, double %29)
  %53 = call double @llvm.fmuladd.f64(double %49, double %52, double %30)
  %54 = call double @llvm.fmuladd.f64(double %49, double %53, double %31)
  %55 = call double @llvm.fmuladd.f64(double %49, double %54, double %32)
  %56 = fmul double %55, %55
  %57 = fmul double %56, %48
  %58 = call double @llvm.fmuladd.f64(double %33, double %49, double %34)
  %59 = call double @llvm.fmuladd.f64(double %58, double %49, double %35)
  %60 = call double @llvm.fmuladd.f64(double %59, double %49, double %36)
  %61 = call double @llvm.fmuladd.f64(double %60, double %49, double %37)
  %62 = call double @llvm.fmuladd.f64(double %61, double %49, double %38)
  %63 = call double @llvm.fmuladd.f64(double %62, double %49, double %32)
  %64 = call double @llvm.fmuladd.f64(double %57, double %63, double %40)
  br label %65
...
67:                                               ; preds = %39
  ...
  %111 = fsub double %110, f0x3FD2AAAAAAAAAAAB
