...
20:                                               ; preds = %0, %20
  ...
  %30 = call double @llvm.fmuladd.f64(double %25, double %28, double %29)
  %31 = load double, ptr @B3, align 8
  %32 = call double @llvm.fmuladd.f64(double %25, double %30, double %31)
  %33 = load double, ptr @B2, align 8
  %34 = call double @llvm.fmuladd.f64(double %25, double %32, double %33)
  %35 = load double, ptr @B1, align 8
  %36 = call double @llvm.fmuladd.f64(double %25, double %34, double %35)
  %37 = load double, ptr @one, align 8
  %38 = call double @llvm.fmuladd.f64(double %25, double %36, double %37)
  ...
  %49 = call double @llvm.fmuladd.f64(double %47, double %25, double %48)
  %50 = load double, ptr @A1, align 8
  %51 = call double @llvm.fmuladd.f64(double %49, double %25, double %50)
  %52 = call double @llvm.fmuladd.f64(double %51, double %25, double %37)
  %53 = call double @llvm.fmuladd.f64(double %40, double %52, double %22)
...
56:                                               ; preds = %20
  ...
  %88 = call double @llvm.fmuladd.f64(double %87, double %.lcssa, double %86)
  %89 = fmul double %19, %88
  %90 = fdiv double %89, %87
  store double %90, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %91 = fsub double %90, f0x3FD2AAAAAAAAAAAB
