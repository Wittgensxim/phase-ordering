...
8:                                                ; preds = %7
  ...
  %39 = call double @llvm.fmuladd.f64(double %37, double %11, double %38)
  %40 = call double @llvm.fmuladd.f64(double %26, double %39, double %.0)
  br label %41
...
43:                                               ; preds = %7
  ...
  %79 = call double @llvm.fmuladd.f64(double %78, double %.0, double %77)
  %80 = fmul double %6, %79
  %81 = fdiv double %80, %78
  store double %81, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %82 = fadd double %81, f0xBFD2AAAAAAAAAAAB
  store double %82, ptr @sc, align 8
  %83 = fmul double %82, 1.000000e-30
  %84 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %83, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
