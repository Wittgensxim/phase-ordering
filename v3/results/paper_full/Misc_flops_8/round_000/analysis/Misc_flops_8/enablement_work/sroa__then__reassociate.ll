...
define dso_local i32 @main() #0 {
  ...
  %8 = sitofp i32 156250000 to double
  %9 = fmul double %8, %7
  %10 = fdiv double %6, %9
  br label %11

11:                                               ; preds = %47, %0
  %.041 = phi i32 [ 1, %0 ], [ %48, %47 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %46, %47 ]
  %12 = sub nsw i32 156250000, 1
  %13 = icmp sle i32 %.041, %12
  br i1 %13, label %14, label %49

14:                                               ; preds = %11
  %15 = sitofp i32 %.041 to double
  %16 = fmul double %10, %15
  %17 = fmul double %16, %16
  %18 = load double, ptr @B6, align 8
  %19 = load double, ptr @B5, align 8
  %20 = call double @llvm.fmuladd.f64(double %18, double %17, double %19)
  %21 = load double, ptr @B4, align 8
  ...
  %27 = load double, ptr @B1, align 8
  %28 = call double @llvm.fmuladd.f64(double %17, double %26, double %27)
  %29 = load double, ptr @one, align 8
  %30 = call double @llvm.fmuladd.f64(double %17, double %28, double %29)
  %31 = fmul double %30, %30
  %32 = fmul double %16, %31
  %33 = load double, ptr @A6, align 8
  %34 = load double, ptr @A5, align 8
  %35 = call double @llvm.fmuladd.f64(double %33, double %17, double %34)
  %36 = load double, ptr @A4, align 8
  %37 = call double @llvm.fmuladd.f64(double %35, double %17, double %36)
  %38 = load double, ptr @A3, align 8
  %39 = call double @llvm.fmuladd.f64(double %37, double %17, double %38)
  %40 = load double, ptr @A2, align 8
  %41 = call double @llvm.fmuladd.f64(double %39, double %17, double %40)
  %42 = load double, ptr @A1, align 8
  %43 = call double @llvm.fmuladd.f64(double %41, double %17, double %42)
  %44 = load double, ptr @one, align 8
  %45 = call double @llvm.fmuladd.f64(double %43, double %17, double %44)
  %46 = call double @llvm.fmuladd.f64(double %32, double %45, double %.0)
  br label %47
...
49:                                               ; preds = %11
  ...
  %88 = call double @llvm.fmuladd.f64(double %87, double %.0, double %86)
