...
13:                                               ; preds = %0, %46
  %.043 = phi double [ 0.000000e+00, %0 ], [ %45, %46 ]
  %.04142 = phi i32 [ 1, %0 ], [ %47, %46 ]
  %14 = sitofp i32 %.04142 to double
  ...
  %44 = call double @llvm.fmuladd.f64(double %42, double %16, double %43)
  %45 = call double @llvm.fmuladd.f64(double %31, double %44, double %.043)
  br label %46

46:                                               ; preds = %13
  %47 = add nsw i32 %.04142, 1
  %48 = icmp sle i32 %47, %12
  br i1 %48, label %13, label %49, !llvm.loop !7

49:                                               ; preds = %46
  %.0.lcssa = phi double [ %45, %46 ]
  ...
  %88 = call double @llvm.fmuladd.f64(double %87, double %.0.lcssa, double %86)
