...
24:                                               ; preds = %20
  ...
  %36 = call double @llvm.fmuladd.f64(double %27, double %34, double %35)
  ...
  %45 = call double @llvm.fmuladd.f64(double %43, double %27, double %44)
  %46 = load double, ptr @A4, align 8
  %47 = call double @llvm.fmuladd.f64(double %45, double %27, double %46)
  %48 = load double, ptr @A3, align 8
  %49 = call double @llvm.fmuladd.f64(double %47, double %27, double %48)
  %50 = load double, ptr @A2, align 8
  %51 = call double @llvm.fmuladd.f64(double %49, double %27, double %50)
  %52 = load double, ptr @A1, align 8
  %53 = call double @llvm.fmuladd.f64(double %51, double %27, double %52)
  %54 = call double @llvm.fmuladd.f64(double %53, double %27, double %39)
  %55 = call double @llvm.fmuladd.f64(double %42, double %54, double %21)
...
57:                                               ; preds = %20
  ...
  %89 = call double @llvm.fmuladd.f64(double %88, double %.lcssa, double %87)
  %90 = fmul double %19, %89
  %91 = fdiv double %90, %88
  store double %91, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %92 = fsub double %91, f0x3FD2AAAAAAAAAAAB
