...
14:                                               ; preds = %.lr.ph, %47
  %.043 = phi i32 [ 1, %.lr.ph ], [ %48, %47 ]
  %.0 = phi double [ 0.000000e+00, %.lr.ph ], [ %46, %47 ]
  %15 = sitofp i32 %.043 to double
...
51:                                               ; preds = %._crit_edge, %0
  ...
  %90 = call double @llvm.fmuladd.f64(double %89, double %.1, double %88)
  %91 = fmul double %11, %90
