...
27:                                               ; preds = %53, %0
  %28 = phi double [ %52, %53 ], [ 0.000000e+00, %0 ]
  %29 = phi double [ %43, %53 ], [ 0.000000e+00, %0 ]
  %30 = phi double [ %37, %53 ], [ undef, %0 ]
  %31 = phi double [ %36, %53 ], [ undef, %0 ]
  %32 = phi i32 [ %54, %53 ], [ 1, %0 ]
  %33 = icmp sle i32 %32, %12
  br i1 %33, label %34, label %55

34:                                               ; preds = %27
  %35 = sitofp i32 %32 to double
  %36 = fmul double %35, %11
  %37 = fmul double %36, %36
  %38 = call double @llvm.fmuladd.f64(double %13, double %37, double %14)
  %39 = call double @llvm.fmuladd.f64(double %37, double %38, double %15)
  %40 = call double @llvm.fmuladd.f64(double %37, double %39, double %16)
  %41 = call double @llvm.fmuladd.f64(double %37, double %40, double %17)
  %42 = call double @llvm.fmuladd.f64(double %37, double %41, double %18)
  %43 = call double @llvm.fmuladd.f64(double %37, double %42, double %19)
  %44 = fmul double %43, %43
  %45 = fmul double %44, %36
  %46 = call double @llvm.fmuladd.f64(double %20, double %37, double %21)
  %47 = call double @llvm.fmuladd.f64(double %46, double %37, double %22)
  %48 = call double @llvm.fmuladd.f64(double %47, double %37, double %23)
  %49 = call double @llvm.fmuladd.f64(double %48, double %37, double %24)
  %50 = call double @llvm.fmuladd.f64(double %49, double %37, double %25)
  %51 = call double @llvm.fmuladd.f64(double %50, double %37, double %26)
  %52 = call double @llvm.fmuladd.f64(double %45, double %51, double %28)
  br label %53
...
55:                                               ; preds = %27
  %.lcssa8 = phi double [ %28, %27 ]
  %.lcssa6 = phi double [ %29, %27 ]
  %.lcssa4 = phi double [ %30, %27 ]
  %.lcssa2 = phi double [ %31, %27 ]
  %.lcssa = phi i32 [ %32, %27 ]
  ...
  %86 = call double @llvm.fmuladd.f64(double %59, double %84, double %85)
  ...
  %94 = call double @llvm.fmuladd.f64(double %93, double %.lcssa8, double %92)
