...
define dso_local i32 @main() #0 {
  ...
  %26 = load double, ptr @A4, align 8
  %27 = load double, ptr @A3, align 8
  %28 = load double, ptr @A2, align 8
  %29 = load double, ptr @A1, align 8
...
31:                                               ; preds = %54, %0
  %32 = phi double [ %.promoted5, %0 ], [ %53, %54 ]
  %33 = phi double [ %.promoted3, %0 ], [ %38, %54 ]
  %34 = phi double [ %.promoted, %0 ], [ %37, %54 ]
  %storemerge = phi i32 [ 1, %0 ], [ %55, %54 ]
  %.not.not = icmp slt i32 %storemerge, %15
  br i1 %.not.not, label %35, label %56

35:                                               ; preds = %31
  %36 = sitofp i32 %storemerge to double
  %37 = fmul double %16, %36
  %38 = fmul double %37, %37
  %39 = call double @llvm.fmuladd.f64(double %17, double %38, double %18)
  %40 = call double @llvm.fmuladd.f64(double %38, double %39, double %19)
  %41 = call double @llvm.fmuladd.f64(double %38, double %40, double %20)
  %42 = call double @llvm.fmuladd.f64(double %38, double %41, double %21)
  %43 = call double @llvm.fmuladd.f64(double %38, double %42, double %22)
  %44 = call double @llvm.fmuladd.f64(double %38, double %43, double %23)
  %45 = fmul double %44, %44
  %46 = fmul double %45, %37
  %47 = call double @llvm.fmuladd.f64(double %24, double %38, double %25)
  %48 = call double @llvm.fmuladd.f64(double %47, double %38, double %26)
  %49 = call double @llvm.fmuladd.f64(double %48, double %38, double %27)
  %50 = call double @llvm.fmuladd.f64(double %49, double %38, double %28)
  %51 = call double @llvm.fmuladd.f64(double %50, double %38, double %29)
  %52 = call double @llvm.fmuladd.f64(double %51, double %38, double %30)
  %53 = call double @llvm.fmuladd.f64(double %46, double %52, double %32)
  br label %54

54:                                               ; preds = %35
  %55 = add nsw i32 %storemerge, 1
  br label %31, !llvm.loop !7

56:                                               ; preds = %31
  %.lcssa6 = phi double [ %32, %31 ]
  %.lcssa4 = phi double [ %33, %31 ]
  %.lcssa = phi double [ %34, %31 ]
  ...
  %89 = call double @llvm.fmuladd.f64(double %76, double %87, double %88)
  ...
  %99 = fadd double %98, f0xBFD2AAAAAAAAAAAB
