...
define dso_local i32 @main() #0 {
  ...
  br i1 %.not.not3, label %.lr.ph, label %59
...
16:                                               ; preds = %.lr.ph, %55
  ...
  %51 = call double @llvm.fmuladd.f64(double %49, double %47, double %50)
  %52 = load double, ptr @one, align 8
  %53 = call double @llvm.fmuladd.f64(double %51, double %47, double %52)
  %54 = call double @llvm.fmuladd.f64(double %38, double %53, double %35)
