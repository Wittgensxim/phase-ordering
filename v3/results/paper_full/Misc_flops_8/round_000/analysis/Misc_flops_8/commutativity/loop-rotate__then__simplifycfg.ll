...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  %80 = call double @llvm.fmuladd.f64(double %60, double %79, double %55)
...
._crit_edge:                                      ; preds = %.lr.ph, %0
  ...
  %88 = load double, ptr @three, align 8
