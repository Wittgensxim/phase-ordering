...
61:                                               ; preds = %._crit_edge, %0
  ...
  %82 = load double, ptr @B6, align 8
  %83 = load double, ptr @B5, align 8
  %84 = call double @llvm.fmuladd.f64(double %82, double %81, double %83)
  %85 = load double, ptr @B4, align 8
  %86 = call double @llvm.fmuladd.f64(double %81, double %84, double %85)
  %87 = load double, ptr @B3, align 8
  %88 = call double @llvm.fmuladd.f64(double %81, double %86, double %87)
  %89 = load double, ptr @B2, align 8
  %90 = call double @llvm.fmuladd.f64(double %81, double %88, double %89)
  %91 = load double, ptr @B1, align 8
  %92 = call double @llvm.fmuladd.f64(double %81, double %90, double %91)
  %93 = load double, ptr @one, align 8
  %94 = call double @llvm.fmuladd.f64(double %81, double %92, double %93)
  ...
  %101 = call double @llvm.fmuladd.f64(double %99, double %100, double %97)
  %102 = fmul double %98, %101
  %103 = fdiv double %102, %99
  store double %103, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %104 = fadd double %103, f0xBFD2AAAAAAAAAAAB
  store double %104, ptr @sc, align 8
  %105 = fmul double %104, 1.000000e-30
  %106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %105, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
