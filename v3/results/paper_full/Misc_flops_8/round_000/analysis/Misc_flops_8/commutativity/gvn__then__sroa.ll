...
9:                                                ; preds = %13, %0
  %10 = phi double [ %44, %13 ], [ 0.000000e+00, %0 ]
  %11 = phi i32 [ %45, %13 ], [ 1, %0 ]
  %12 = icmp sle i32 %11, 156249999
...
13:                                               ; preds = %9
  ...
  %29 = call double @llvm.fmuladd.f64(double %16, double %27, double %28)
  %30 = fmul double %29, %29
  %31 = fmul double %30, %15
  %32 = load double, ptr @A6, align 8
  %33 = load double, ptr @A5, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %16, double %33)
  %35 = load double, ptr @A4, align 8
  %36 = call double @llvm.fmuladd.f64(double %34, double %16, double %35)
  %37 = load double, ptr @A3, align 8
  %38 = call double @llvm.fmuladd.f64(double %36, double %16, double %37)
  %39 = load double, ptr @A2, align 8
  %40 = call double @llvm.fmuladd.f64(double %38, double %16, double %39)
  %41 = load double, ptr @A1, align 8
  %42 = call double @llvm.fmuladd.f64(double %40, double %16, double %41)
  %43 = call double @llvm.fmuladd.f64(double %42, double %16, double %28)
  %44 = call double @llvm.fmuladd.f64(double %31, double %43, double %10)
  %45 = add nsw i32 %11, 1
...
46:                                               ; preds = %9
  ...
  %53 = call double @llvm.fmuladd.f64(double %51, double %48, double %52)
  %54 = load double, ptr @A3, align 8
  %55 = call double @llvm.fmuladd.f64(double %53, double %48, double %54)
  %56 = load double, ptr @A2, align 8
  %57 = call double @llvm.fmuladd.f64(double %55, double %48, double %56)
  %58 = load double, ptr @A1, align 8
  ...
  %65 = call double @llvm.fmuladd.f64(double %63, double %48, double %64)
  %66 = load double, ptr @B4, align 8
  %67 = call double @llvm.fmuladd.f64(double %48, double %65, double %66)
  %68 = load double, ptr @B3, align 8
  %69 = call double @llvm.fmuladd.f64(double %48, double %67, double %68)
  %70 = load double, ptr @B2, align 8
  %71 = call double @llvm.fmuladd.f64(double %48, double %69, double %70)
  %72 = load double, ptr @B1, align 8
  %73 = call double @llvm.fmuladd.f64(double %48, double %71, double %72)
  %74 = call double @llvm.fmuladd.f64(double %48, double %73, double %60)
  ...
  %78 = call double @llvm.fmuladd.f64(double %77, double %10, double %76)
  %79 = fmul double %8, %78
  %80 = fdiv double %79, %77
  store double %80, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %81 = fsub double %80, f0x3FD2AAAAAAAAAAAB
  store double %81, ptr @sc, align 8
  %82 = fmul double %81, 1.000000e-30
  %83 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %82, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
