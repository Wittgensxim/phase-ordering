...
define dso_local i32 @main() #0 {
  ...
  br i1 %26, label %.lr.ph, label %72

.lr.ph:                                           ; preds = %0
  br label %27

27:                                               ; preds = %.lr.ph, %65
  %28 = phi i32 [ %23, %.lr.ph ], [ %68, %65 ]
  ...
  %35 = call double @llvm.fmuladd.f64(double %33, double %32, double %34)
  %36 = load double, ptr @B4, align 8
  %37 = call double @llvm.fmuladd.f64(double %32, double %35, double %36)
  %38 = load double, ptr @B3, align 8
  %39 = call double @llvm.fmuladd.f64(double %32, double %37, double %38)
  %40 = load double, ptr @B2, align 8
  %41 = call double @llvm.fmuladd.f64(double %32, double %39, double %40)
  %42 = load double, ptr @B1, align 8
  %43 = call double @llvm.fmuladd.f64(double %32, double %41, double %42)
  %44 = load double, ptr @one, align 8
  %45 = call double @llvm.fmuladd.f64(double %32, double %43, double %44)
  store double %45, ptr %4, align 8
  %46 = load double, ptr %2, align 8
  %47 = fmul double %45, %45
  %48 = load double, ptr %3, align 8
  %49 = fmul double %47, %48
  %50 = load double, ptr @A6, align 8
  ...
  %55 = call double @llvm.fmuladd.f64(double %53, double %51, double %54)
  %56 = load double, ptr @A3, align 8
  %57 = call double @llvm.fmuladd.f64(double %55, double %51, double %56)
  %58 = load double, ptr @A2, align 8
  %59 = call double @llvm.fmuladd.f64(double %57, double %51, double %58)
  %60 = load double, ptr @A1, align 8
  %61 = call double @llvm.fmuladd.f64(double %59, double %51, double %60)
  %62 = load double, ptr @one, align 8
  %63 = call double @llvm.fmuladd.f64(double %61, double %51, double %62)
  %64 = call double @llvm.fmuladd.f64(double %49, double %63, double %46)
...
65:                                               ; preds = %27
  ...
  br i1 %71, label %27, label %._crit_edge, !llvm.loop !7
...
72:                                               ; preds = %._crit_edge, %0
  ...
  %74 = load double, ptr @three, align 8
  ...
  %79 = load double, ptr @A5, align 8
  %80 = call double @llvm.fmuladd.f64(double %78, double %76, double %79)
  %81 = load double, ptr @A4, align 8
  %82 = call double @llvm.fmuladd.f64(double %80, double %76, double %81)
  %83 = load double, ptr @A3, align 8
  %84 = call double @llvm.fmuladd.f64(double %82, double %76, double %83)
  %85 = load double, ptr @A2, align 8
  %86 = call double @llvm.fmuladd.f64(double %84, double %76, double %85)
  %87 = load double, ptr @A1, align 8
  %88 = call double @llvm.fmuladd.f64(double %86, double %76, double %87)
  %89 = load double, ptr @one, align 8
  %90 = call double @llvm.fmuladd.f64(double %88, double %76, double %89)
  %91 = fmul double %77, %90
  store double %91, ptr @sa, align 8
  %92 = load double, ptr %5, align 8
  %93 = load double, ptr @B6, align 8
  %94 = load double, ptr @B5, align 8
  %95 = call double @llvm.fmuladd.f64(double %93, double %92, double %94)
  %96 = load double, ptr @B4, align 8
  %97 = call double @llvm.fmuladd.f64(double %92, double %95, double %96)
  %98 = load double, ptr @B3, align 8
  %99 = call double @llvm.fmuladd.f64(double %92, double %97, double %98)
  %100 = load double, ptr @B2, align 8
  %101 = call double @llvm.fmuladd.f64(double %92, double %99, double %100)
  %102 = load double, ptr @B1, align 8
  %103 = call double @llvm.fmuladd.f64(double %92, double %101, double %102)
  %104 = load double, ptr @one, align 8
  %105 = call double @llvm.fmuladd.f64(double %92, double %103, double %104)
  ...
  %112 = call double @llvm.fmuladd.f64(double %110, double %111, double %108)
  %113 = fmul double %109, %112
  %114 = fdiv double %113, %110
  store double %114, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %115 = load double, ptr @sa, align 8
  %116 = fsub double %115, f0x3FD2AAAAAAAAAAAB
  store double %116, ptr @sc, align 8
  %117 = fmul double %116, 1.000000e-30
  %118 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %117, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
