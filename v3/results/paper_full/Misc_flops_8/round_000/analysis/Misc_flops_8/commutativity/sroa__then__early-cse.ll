...
10:                                               ; preds = %44, %0
  %.041 = phi i32 [ 1, %0 ], [ %45, %44 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %43, %44 ]
  %11 = icmp sle i32 %.041, 156249999
  br i1 %11, label %12, label %46

12:                                               ; preds = %10
  %13 = sitofp i32 %.041 to double
  %14 = fmul double %13, %9
  ...
  %28 = call double @llvm.fmuladd.f64(double %15, double %26, double %27)
  %29 = fmul double %28, %28
  %30 = fmul double %29, %14
  %31 = load double, ptr @A6, align 8
  %32 = load double, ptr @A5, align 8
  %33 = call double @llvm.fmuladd.f64(double %31, double %15, double %32)
  %34 = load double, ptr @A4, align 8
  %35 = call double @llvm.fmuladd.f64(double %33, double %15, double %34)
  %36 = load double, ptr @A3, align 8
  %37 = call double @llvm.fmuladd.f64(double %35, double %15, double %36)
  %38 = load double, ptr @A2, align 8
  %39 = call double @llvm.fmuladd.f64(double %37, double %15, double %38)
  %40 = load double, ptr @A1, align 8
  %41 = call double @llvm.fmuladd.f64(double %39, double %15, double %40)
  %42 = call double @llvm.fmuladd.f64(double %41, double %15, double %27)
  %43 = call double @llvm.fmuladd.f64(double %30, double %42, double %.0)
  br label %44
...
46:                                               ; preds = %10
  ...
  %81 = load double, ptr @two, align 8
  %82 = call double @llvm.fmuladd.f64(double %81, double %.0, double %80)
  %83 = fmul double %9, %82
  %84 = fdiv double %83, %81
  store double %84, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %85 = load double, ptr @sa, align 8
  %86 = fsub double %85, f0x3FD2AAAAAAAAAAAB
