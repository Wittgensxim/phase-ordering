...
define dso_local i32 @main() #0 {
  ...
  %30 = load double, ptr @B4, align 8
  %31 = load double, ptr @B3, align 8
  %32 = load double, ptr @B2, align 8
  %33 = load double, ptr @B1, align 8
...
43:                                               ; preds = %.lr.ph, %64
  ...
  %50 = call double @llvm.fmuladd.f64(double %48, double %49, double %30)
  %51 = call double @llvm.fmuladd.f64(double %48, double %50, double %31)
  %52 = call double @llvm.fmuladd.f64(double %48, double %51, double %32)
  %53 = call double @llvm.fmuladd.f64(double %48, double %52, double %33)
  %54 = call double @llvm.fmuladd.f64(double %48, double %53, double %34)
  %55 = fmul double %54, %54
  %56 = fmul double %55, %47
  %57 = call double @llvm.fmuladd.f64(double %35, double %48, double %36)
  %58 = call double @llvm.fmuladd.f64(double %57, double %48, double %37)
  %59 = call double @llvm.fmuladd.f64(double %58, double %48, double %38)
  %60 = call double @llvm.fmuladd.f64(double %59, double %48, double %39)
  %61 = call double @llvm.fmuladd.f64(double %60, double %48, double %40)
  %62 = call double @llvm.fmuladd.f64(double %61, double %48, double %41)
  %63 = call double @llvm.fmuladd.f64(double %56, double %62, double %45)
  br label %64
