...
define dso_local i32 @main() #0 {
  ...
  %puts43 = call i32 @puts(ptr nonnull dereferenceable(1) @str.2)
...
5:                                                ; preds = %8, %0
  %.041 = phi i32 [ 1, %0 ], [ %41, %8 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %40, %8 ]
  %6 = icmp samesign ult i32 %.041, 156250000
...
8:                                                ; preds = %7
  %9 = uitofp nneg i32 %.041 to double
  %10 = fmul double %4, %9
...
42:                                               ; preds = %5
  ...
  %81 = fadd double %80, f0xBFD2AAAAAAAAAAAB
