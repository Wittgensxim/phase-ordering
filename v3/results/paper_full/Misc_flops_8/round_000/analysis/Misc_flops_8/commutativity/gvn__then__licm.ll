...
42:                                               ; preds = %33
  ...
  %47 = call double @llvm.fmuladd.f64(double %45, double %46, double %22)
  %48 = call double @llvm.fmuladd.f64(double %45, double %47, double %23)
  %49 = call double @llvm.fmuladd.f64(double %45, double %48, double %24)
  %50 = call double @llvm.fmuladd.f64(double %45, double %49, double %25)
  %51 = call double @llvm.fmuladd.f64(double %45, double %50, double %26)
  %52 = fmul double %51, %51
  %53 = fmul double %52, %44
  %54 = call double @llvm.fmuladd.f64(double %27, double %45, double %28)
  %55 = call double @llvm.fmuladd.f64(double %54, double %45, double %29)
  %56 = call double @llvm.fmuladd.f64(double %55, double %45, double %30)
  %57 = call double @llvm.fmuladd.f64(double %56, double %45, double %31)
  %58 = call double @llvm.fmuladd.f64(double %57, double %45, double %32)
  %59 = call double @llvm.fmuladd.f64(double %58, double %45, double %26)
  %60 = call double @llvm.fmuladd.f64(double %53, double %59, double %39)
  %61 = add nsw i32 %40, 1
...
62:                                               ; preds = %33
  ...
  %94 = call double @llvm.fmuladd.f64(double %93, double %.lcssa, double %92)
  %95 = fmul double %19, %94
  %96 = fdiv double %95, %93
  store double %96, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %97 = fsub double %96, f0x3FD2AAAAAAAAAAAB
