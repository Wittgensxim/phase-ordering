...
31:                                               ; preds = %38, %0
  ...
  %33 = phi double [ %47, %38 ], [ %.promoted5, %0 ]
...
38:                                               ; preds = %37
  ...
  %43 = call double @llvm.fmuladd.f64(double %41, double %42, double %19)
  %44 = call double @llvm.fmuladd.f64(double %41, double %43, double %20)
  %45 = call double @llvm.fmuladd.f64(double %41, double %44, double %21)
  %46 = call double @llvm.fmuladd.f64(double %41, double %45, double %22)
  %47 = call double @llvm.fmuladd.f64(double %41, double %46, double %23)
  %48 = fmul double %47, %47
  %49 = fmul double %48, %40
  %50 = call double @llvm.fmuladd.f64(double %24, double %41, double %25)
  %51 = call double @llvm.fmuladd.f64(double %50, double %41, double %26)
  %52 = call double @llvm.fmuladd.f64(double %51, double %41, double %27)
  %53 = call double @llvm.fmuladd.f64(double %52, double %41, double %28)
  %54 = call double @llvm.fmuladd.f64(double %53, double %41, double %29)
  %55 = call double @llvm.fmuladd.f64(double %54, double %41, double %30)
  %56 = call double @llvm.fmuladd.f64(double %49, double %55, double %32)
  %57 = add nsw i32 %36, 1
...
58:                                               ; preds = %31
  ...
  %98 = call double @llvm.fmuladd.f64(double %96, double %97, double %94)
  %99 = fmul double %95, %98
  %100 = fdiv double %99, %96
  store double %100, ptr @sa, align 8
  store double f0x3FD2AAAAAAAAAAAB, ptr @sb, align 8
  %101 = fadd double %100, f0xBFD2AAAAAAAAAAAB
  store double %101, ptr @sc, align 8
  %102 = fmul double %101, 1.000000e-30
  %103 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %102, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
