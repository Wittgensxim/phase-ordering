...
46:                                               ; preds = %.lr.ph, %67
  ...
  %53 = call double @llvm.fmuladd.f64(double %51, double %52, double %32)
  %54 = call double @llvm.fmuladd.f64(double %51, double %53, double %33)
  %55 = call double @llvm.fmuladd.f64(double %51, double %54, double %34)
  %56 = call double @llvm.fmuladd.f64(double %51, double %55, double %35)
  %57 = call double @llvm.fmuladd.f64(double %51, double %56, double %36)
  %58 = fmul double %57, %57
  %59 = fmul double %58, %50
  %60 = call double @llvm.fmuladd.f64(double %37, double %51, double %38)
  %61 = call double @llvm.fmuladd.f64(double %60, double %51, double %39)
  %62 = call double @llvm.fmuladd.f64(double %61, double %51, double %40)
  %63 = call double @llvm.fmuladd.f64(double %62, double %51, double %41)
  %64 = call double @llvm.fmuladd.f64(double %63, double %51, double %42)
  %65 = call double @llvm.fmuladd.f64(double %64, double %51, double %43)
  %66 = call double @llvm.fmuladd.f64(double %59, double %65, double %47)
  br label %67
...
70:                                               ; preds = %._crit_edge, %0
  ...
  %135 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %134, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
