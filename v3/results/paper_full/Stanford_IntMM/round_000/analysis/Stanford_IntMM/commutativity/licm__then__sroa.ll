...
2:                                                ; preds = %23, %1
  %.lcssa27 = phi i32 [ %.lcssa2, %23 ], [ undef, %1 ]
  %.lcssa6 = phi i32 [ %.lcssa, %23 ], [ undef, %1 ]
  %3 = phi i32 [ %24, %23 ], [ 1, %1 ]
  %4 = icmp sle i32 %3, 40
...
5:                                                ; preds = %2
  %6 = sext i32 %3 to i64
  %7 = getelementptr inbounds [41 x i32], ptr %0, i64 %6
  br label %8

8:                                                ; preds = %20, %5
  %9 = phi i32 [ %13, %20 ], [ %.lcssa27, %5 ]
...
12:                                               ; preds = %8
  ...
  %19 = getelementptr inbounds [41 x i32], ptr %7, i64 0, i64 %18
...
12:                                               ; preds = %9
  ...
  %15 = getelementptr inbounds [41 x i32], ptr %7, i64 0, i64 %14
  %16 = load i32, ptr %15, align 4
  %17 = sext i32 %10 to i64
  %gep = getelementptr [41 x i32], ptr %invariant.gep, i64 %17
...
11:                                               ; preds = %8
  ...
  %13 = getelementptr inbounds [41 x i32], ptr %7, i64 0, i64 %12
  call void @Innerproduct(ptr noundef %13, ptr noundef @ima, ptr noundef @imb, i32 noundef %3, i32 noundef %9)
  br label %14
...
19:                                               ; preds = %2
  ...
  %22 = getelementptr inbounds [41 x [41 x i32]], ptr @imr, i64 0, i64 %21
  %23 = add nsw i32 %0, 1
