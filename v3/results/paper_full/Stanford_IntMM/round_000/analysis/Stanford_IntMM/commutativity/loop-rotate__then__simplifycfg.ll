...
.lr.ph:                                           ; preds = %.lr.ph2, %.lr.ph
  ...
  %20 = getelementptr inbounds [41 x i32], ptr %17, i64 %19
...
._crit_edge:                                      ; preds = %.lr.ph2, %.lr.ph
  ...
  br i1 %31, label %.lr.ph2, label %._crit_edge3, !llvm.loop !9
...
.lr.ph:                                           ; preds = %5, %.lr.ph
  ...
  %28 = getelementptr inbounds [41 x i32], ptr %25, i64 %27
  %29 = load i32, ptr %10, align 4
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds [41 x i32], ptr %28, i64 0, i64 %30
  %32 = load i32, ptr %31, align 4
  %33 = mul nsw i32 %24, %32
...
.lr.ph:                                           ; preds = %.lr.ph2, %.lr.ph
  ...
  %14 = getelementptr inbounds [41 x i32], ptr %11, i64 0, i64 %13
  %15 = load i32, ptr %3, align 4
  %16 = load i32, ptr %4, align 4
  call void @Innerproduct(ptr noundef %14, ptr noundef @ima, ptr noundef @imb, i32 noundef %15, i32 noundef %16)
...
._crit_edge3:                                     ; preds = %._crit_edge, %1
  ...
  %26 = add nsw i32 %25, 1
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [41 x [41 x i32]], ptr @imr, i64 0, i64 %27
  %29 = load i32, ptr %2, align 4
  %30 = add nsw i32 %29, 1
  %31 = sext i32 %30 to i64
  %32 = getelementptr inbounds [41 x i32], ptr %28, i64 0, i64 %31
