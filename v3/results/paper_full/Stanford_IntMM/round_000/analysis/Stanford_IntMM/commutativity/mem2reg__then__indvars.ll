...
2:                                                ; preds = %15, %1
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %15 ], [ 1, %1 ]
  %exitcond6 = icmp ne i64 %indvars.iv3, 41
  br i1 %exitcond6, label %3, label %16
...
5:                                                ; preds = %4
  ...
  %9 = sub nsw i32 %6, %8
  %10 = sub nsw i32 %9, 60
  %11 = getelementptr inbounds [41 x i32], ptr %0, i64 %indvars.iv3
...
5:                                                ; preds = %4
  %6 = getelementptr inbounds [41 x [41 x i32]], ptr @imr, i64 0, i64 %indvars.iv3
