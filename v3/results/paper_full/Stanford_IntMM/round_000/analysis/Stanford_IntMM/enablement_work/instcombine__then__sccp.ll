...
10:                                               ; preds = %8
  ...
  call void @Innerproduct(ptr noundef nonnull %16, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %11, i32 noundef %14)
  br label %17
...
24:                                               ; preds = %5
  ...
  %27 = getelementptr [164 x i8], ptr @imr, i64 %26
  %28 = sext i32 %25 to i64
  %29 = getelementptr [4 x i8], ptr %27, i64 %28
  %30 = getelementptr i8, ptr %29, i64 168
  %31 = load i32, ptr %30, align 4
  %32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %31) #2
  ret void
}
