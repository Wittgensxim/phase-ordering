...
13:                                               ; preds = %18, %10
  %14 = phi i32 [ %26, %18 ], [ 1, %10 ]
  %15 = phi i32 [ %19, %18 ], [ %.lcssa6, %10 ]
  %16 = phi i32 [ %26, %18 ], [ 1, %10 ]
...
18:                                               ; preds = %13
  ...
  %25 = getelementptr inbounds [41 x i32], ptr %12, i64 0, i64 %24
...
15:                                               ; preds = %20, %5
  %16 = phi i32 [ %27, %20 ], [ poison, %5 ]
  %17 = phi i32 [ %26, %20 ], [ 0, %5 ]
  %18 = phi i32 [ %27, %20 ], [ 1, %5 ]
...
20:                                               ; preds = %15
  ...
  %gep = getelementptr [41 x i32], ptr %invariant.gep, i64 %21
...
16:                                               ; preds = %12
  ...
  %18 = getelementptr inbounds [41 x i32], ptr %11, i64 0, i64 %17
  call void @Innerproduct(ptr noundef %18, ptr noundef @ima, ptr noundef @imb, i32 noundef %7, i32 noundef %14)
  %19 = add nsw i32 %14, 1
...
22:                                               ; preds = %5
  ...
  %26 = getelementptr inbounds [41 x i32], ptr %25, i64 0, i64 %24
