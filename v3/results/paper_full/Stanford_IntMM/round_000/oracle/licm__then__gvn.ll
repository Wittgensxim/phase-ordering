...
6:                                                ; preds = %25, %1
  %.lcssa27 = phi i32 [ %13, %25 ], [ undef, %1 ]
  %.lcssa6 = phi i32 [ %14, %25 ], [ undef, %1 ]
  %7 = phi i32 [ %26, %25 ], [ 1, %1 ]
  %8 = icmp sle i32 %7, 40
...
9:                                                ; preds = %6
  ...
  %11 = getelementptr inbounds [41 x i32], ptr %0, i64 %10
  br label %12

12:                                               ; preds = %16, %9
  %13 = phi i32 [ %17, %16 ], [ %.lcssa27, %9 ]
  %14 = phi i32 [ %24, %16 ], [ 1, %9 ]
...
16:                                               ; preds = %12
  ...
  %23 = getelementptr inbounds [41 x i32], ptr %11, i64 0, i64 %22
...
define dso_local void @Innerproduct(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %4) #0 {
  ...
  %13 = getelementptr inbounds [41 x i32], ptr %1, i64 %12
  %14 = sext i32 %4 to i64
  %invariant.gep = getelementptr [41 x i32], ptr %2, i64 0, i64 %14
  br label %15

15:                                               ; preds = %19, %5
  %16 = phi i32 [ %25, %19 ], [ 0, %5 ]
  %17 = phi i32 [ %26, %19 ], [ 1, %5 ]
  %18 = icmp sle i32 %17, 40
  br i1 %18, label %19, label %27

19:                                               ; preds = %15
  %20 = sext i32 %17 to i64
  %21 = getelementptr inbounds [41 x i32], ptr %13, i64 0, i64 %20
  %22 = load i32, ptr %21, align 4
  %gep = getelementptr [41 x i32], ptr %invariant.gep, i64 %20
