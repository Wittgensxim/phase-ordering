; ModuleID = 'results\paper_full\Stanford_IntMM\round_001\output.ll'
...
3:                                                ; preds = %3, %2
  ...
  %5 = srem i32 %.fr, 120
  %6 = add nsw i32 %5, -60
  %7 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %indvars.iv27
  %8 = getelementptr inbounds nuw [4 x i8], ptr %7, i64 %indvars.iv6
...
9:                                                ; preds = %3
  ...
  %exitcond5.not = icmp eq i64 %indvars.iv.next3, 41
  br i1 %exitcond5.not, label %10, label %2, !llvm.loop !9
...
6:                                                ; preds = %6, %5
  ...
  %10 = getelementptr inbounds nuw [4 x i8], ptr %9, i64 %indvars.iv2
  %11 = load i32, ptr %10, align 4
  %12 = getelementptr inbounds nuw [164 x i8], ptr %2, i64 %indvars.iv2
  ...
  %19 = getelementptr inbounds [164 x i8], ptr %1, i64 %18
  %20 = getelementptr inbounds nuw [4 x i8], ptr %19, i64 %indvars.iv.next
  %21 = load i32, ptr %20, align 4
  %22 = getelementptr inbounds nuw [164 x i8], ptr %2, i64 %indvars.iv.next
  ...
  %exitcond.1.not = icmp eq i64 %indvars.iv.next.1, 41
  br i1 %exitcond.1.not, label %28, label %6, !llvm.loop !10
...
3:                                                ; preds = %3, %2
  %indvars.iv6 = phi i64 [ 1, %2 ], [ %indvars.iv.next, %3 ]
  %4 = getelementptr inbounds nuw [164 x i8], ptr @imr, i64 %indvars.iv27
  %5 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %indvars.iv6
  %6 = trunc nuw nsw i64 %indvars.iv6 to i32
  %7 = trunc nuw nsw i64 %indvars.iv27 to i32
  call void @Innerproduct(ptr noundef nonnull %5, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %7, i32 noundef %6)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv6, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 41
...
8:                                                ; preds = %3
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond5.not = icmp eq i64 %indvars.iv.next3, 41
  br i1 %exitcond5.not, label %9, label %2, !llvm.loop !12
