...
2:                                                ; preds = %10, %1
  ...
  br i1 %exitcond5, label %.preheader, label %11
...
4:                                                ; preds = %3
  ...
  %6 = srem i32 %.fr, 120
  %7 = add nsw i32 %6, -60
  %8 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %indvars.iv2
...
6:                                                ; preds = %8, %5
  ...
  %7 = phi i32 [ %18, %8 ], [ 0, %5 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
  br i1 %exitcond, label %8, label %19
...
2:                                                ; preds = %9, %1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %9 ], [ 1, %1 ]
  %exitcond5 = icmp ne i64 %indvars.iv2, 41
  br i1 %exitcond5, label %.preheader, label %10
...
4:                                                ; preds = %3
  %5 = getelementptr inbounds nuw [164 x i8], ptr @imr, i64 %indvars.iv2
  %6 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %indvars.iv
  %7 = trunc nuw nsw i64 %indvars.iv to i32
  %8 = trunc nuw nsw i64 %indvars.iv2 to i32
  call void @Innerproduct(ptr noundef nonnull %6, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %8, i32 noundef %7)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
10:                                               ; preds = %2
  ...
  %16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %15) #2
  ret void
}
