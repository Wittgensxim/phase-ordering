...
define dso_local void @Innerproduct(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %4) #0 {
  ...
  %invariant.gep1 = getelementptr [4 x i8], ptr %2, i64 %11
  br label %12

12:                                               ; preds = %24, %5
  %13 = phi i32 [ 0, %5 ], [ %30, %24 ]
  %14 = phi i32 [ 1, %5 ], [ %31, %24 ]
...
16:                                               ; preds = %12
  ...
  %gep = getelementptr [164 x i8], ptr %invariant.gep, i64 %17
...
24:                                               ; preds = %16
  ...
  %gep2 = getelementptr [164 x i8], ptr %invariant.gep1, i64 %25
  %28 = load i32, ptr %gep2, align 4
...
11:                                               ; preds = %8
  ...
  call void @Innerproduct(ptr noundef nonnull %13, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %3, i32 noundef %9)
...
17:                                               ; preds = %2
  ...
  %20 = getelementptr inbounds [164 x i8], ptr @imr, i64 %19
  %21 = getelementptr inbounds [4 x i8], ptr %20, i64 %19
  %22 = load i32, ptr %21, align 4
  %23 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %22) #2
  ret void
}
