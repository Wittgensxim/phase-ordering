...
2:                                                ; preds = %11, %1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %11 ], [ 1, %1 ]
  %exitcond5 = icmp ne i64 %indvars.iv2, 41
  br i1 %exitcond5, label %3, label %12
...
5:                                                ; preds = %4
  ...
  %7 = srem i32 %.fr, 120
  %8 = add nsw i32 %7, -60
  %9 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %indvars.iv2
...
6:                                                ; preds = %19, %5
  %indvars.iv = phi i64 [ 1, %5 ], [ %indvars.iv.next.1, %19 ]
  %7 = phi i32 [ 0, %5 ], [ %29, %19 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
  br i1 %exitcond, label %8, label %30

8:                                                ; preds = %6
  %9 = sext i32 %3 to i64
  %10 = getelementptr inbounds [164 x i8], ptr %1, i64 %9
  %11 = getelementptr inbounds nuw [4 x i8], ptr %10, i64 %indvars.iv
  %12 = load i32, ptr %11, align 4
  %13 = getelementptr inbounds nuw [164 x i8], ptr %2, i64 %indvars.iv
...
19:                                               ; preds = %8
  ...
  %21 = getelementptr inbounds [164 x i8], ptr %1, i64 %20
  %22 = getelementptr inbounds nuw [4 x i8], ptr %21, i64 %indvars.iv.next
  %23 = load i32, ptr %22, align 4
  %24 = getelementptr inbounds nuw [164 x i8], ptr %2, i64 %indvars.iv.next
...
2:                                                ; preds = %10, %1
  ...
  %exitcond5 = icmp ne i64 %indvars.iv2, 41
  br i1 %exitcond5, label %3, label %11
...
5:                                                ; preds = %4
  %6 = getelementptr inbounds nuw [164 x i8], ptr @imr, i64 %indvars.iv2
  %7 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv
  %8 = trunc nuw nsw i64 %indvars.iv to i32
  %9 = trunc nuw nsw i64 %indvars.iv2 to i32
  call void @Innerproduct(ptr noundef nonnull %7, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %9, i32 noundef %8)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
11:                                               ; preds = %2
  ...
  %16 = load i32, ptr %15, align 4
  %17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %16) #2
  ret void
}
...
12:                                               ; preds = %11
  call void @Intmm(i32 noundef 10)
  unreachable
