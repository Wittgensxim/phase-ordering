...
2:                                                ; preds = %1, %15
  ...
  %5 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %4
  br label %6
...
6:                                                ; preds = %2, %6
  ...
  br i1 %14, label %6, label %15, !llvm.loop !7
...
9:                                                ; preds = %5, %9
  ...
  %gep = getelementptr [164 x i8], ptr %invariant.gep, i64 %12
  ...
  br i1 %19, label %9, label %20, !llvm.loop !10
...
2:                                                ; preds = %1, %12
  %3 = phi i32 [ 1, %1 ], [ %13, %12 ]
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr inbounds nuw [164 x i8], ptr @imr, i64 %4
  br label %6
...
6:                                                ; preds = %2, %6
  ...
  call void @Innerproduct(ptr noundef nonnull %9, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %3, i32 noundef %7)
