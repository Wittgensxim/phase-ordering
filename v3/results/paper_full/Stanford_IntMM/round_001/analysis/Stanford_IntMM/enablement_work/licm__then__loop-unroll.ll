...
9:                                                ; preds = %21, %5
  %10 = phi i32 [ 0, %5 ], [ %27, %21 ]
  %11 = phi i32 [ 1, %5 ], [ %28, %21 ]
...
13:                                               ; preds = %9
  ...
  %gep = getelementptr [164 x i8], ptr %invariant.gep, i64 %14
...
21:                                               ; preds = %13
  ...
  %gep.1 = getelementptr [164 x i8], ptr %invariant.gep, i64 %22
  %25 = load i32, ptr %gep.1, align 4
