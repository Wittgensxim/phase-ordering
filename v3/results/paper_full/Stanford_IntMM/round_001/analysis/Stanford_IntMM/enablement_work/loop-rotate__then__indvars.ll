...
2:                                                ; preds = %1, %9
  %indvars.iv2 = phi i64 [ 1, %1 ], [ %indvars.iv.next3, %9 ]
  br label %3
...
3:                                                ; preds = %2, %3
  ...
  %5 = srem i32 %.fr, 120
  %6 = add nsw i32 %5, -60
  %7 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %indvars.iv2
...
2:                                                ; preds = %1, %8
  %indvars.iv2 = phi i64 [ 1, %1 ], [ %indvars.iv.next3, %8 ]
  br label %3
...
3:                                                ; preds = %2, %3
  ...
  %7 = trunc nuw nsw i64 %indvars.iv2 to i32
