...
.preheader:                                       ; preds = %2
  ...
  %6 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %5
  br label %7

7:                                                ; preds = %.preheader, %10
  %8 = phi i32 [ %16, %10 ], [ 1, %.preheader ]
...
10:                                               ; preds = %7
  ...
  call void @Innerproduct(ptr noundef nonnull %12, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %3, i32 noundef %8)
