...
2:                                                ; preds = %11, %1
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %11 ], [ 1, %1 ]
  %exitcond6 = icmp ne i64 %indvars.iv3, 41
  br i1 %exitcond6, label %3, label %12
...
5:                                                ; preds = %4
  ...
  %7 = srem i32 %.fr, 120
  %8 = add nsw i32 %7, -60
  %9 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %indvars.iv3
...
2:                                                ; preds = %10, %1
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %10 ], [ 1, %1 ]
  %exitcond6 = icmp ne i64 %indvars.iv3, 41
  br i1 %exitcond6, label %3, label %11
...
5:                                                ; preds = %4
  %6 = getelementptr inbounds nuw [164 x i8], ptr @imr, i64 %indvars.iv3
