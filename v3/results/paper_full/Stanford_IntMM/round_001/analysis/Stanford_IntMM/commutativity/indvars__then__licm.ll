...
3:                                                ; preds = %2
  %4 = getelementptr inbounds nuw [164 x i8], ptr %0, i64 %indvars.iv2
  br label %5

5:                                                ; preds = %6, %3
  %indvars.iv = phi i64 [ %indvars.iv.next, %6 ], [ 1, %3 ]
...
9:                                                ; preds = %11, %5
  %indvars.iv = phi i64 [ %indvars.iv.next, %11 ], [ 1, %5 ]
  %10 = phi i32 [ %16, %11 ], [ 0, %5 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
...
11:                                               ; preds = %9
  ...
  %gep = getelementptr [164 x i8], ptr %invariant.gep, i64 %indvars.iv
...
3:                                                ; preds = %2
  %4 = getelementptr inbounds nuw [164 x i8], ptr @imr, i64 %indvars.iv2
  %5 = trunc nuw nsw i64 %indvars.iv2 to i32
  br label %6

6:                                                ; preds = %7, %3
  %indvars.iv = phi i64 [ %indvars.iv.next, %7 ], [ 1, %3 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
...
7:                                                ; preds = %6
  ...
  call void @Innerproduct(ptr noundef nonnull %8, ptr noundef nonnull @ima, ptr noundef nonnull @imb, i32 noundef %5, i32 noundef %9)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
