...
23:                                               ; preds = %._crit_edge, %0
  ...
  %28 = call ptr @malloc(i64 noundef 56) #5
  ...
  store double 4.000000e+01, ptr %37, align 8
  ...
  %41 = call ptr @strcpy(ptr noundef %40, ptr noundef @.str.1) #6
  %42 = getelementptr inbounds [31 x i8], ptr %8, i64 0, i64 0
  %43 = call ptr @strcpy(ptr noundef %42, ptr noundef @.str.2) #6
...
47:                                               ; preds = %.lr.ph8, %116
  ...
  %50 = getelementptr inbounds [31 x i8], ptr %9, i64 0, i64 0
  %51 = call ptr @strcpy(ptr noundef %50, ptr noundef @.str.3) #6
  store i32 10000, ptr %7, align 4
  %52 = getelementptr inbounds [31 x i8], ptr %8, i64 0, i64 0
  %53 = getelementptr inbounds [31 x i8], ptr %9, i64 0, i64 0
...
74:                                               ; preds = %._crit_edge3, %47
  ...
  %77 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %75, double noundef %76)
...
102:                                              ; preds = %._crit_edge6, %74
  ...
  %113 = fneg double %112
  %114 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %111, double %113)
...
44:                                               ; preds = %.lr.ph, %55
  ...
  %50 = getelementptr inbounds [51 x double], ptr %46, i64 %49
  %51 = load double, ptr %11, align 8
  %52 = fptosi double %51 to i32
  %53 = sext i32 %52 to i64
  %54 = getelementptr inbounds [51 x double], ptr %50, i64 0, i64 %53
...
55:                                               ; preds = %44
  ...
  br i1 %61, label %44, label %._crit_edge, !llvm.loop !12
...
62:                                               ; preds = %._crit_edge, %4
  ...
  %67 = getelementptr inbounds [51 x double], ptr %63, i64 %66
  %68 = load double, ptr %10, align 8
  %69 = fptosi double %68 to i32
  %70 = sub nsw i32 %69, 1
  %71 = sext i32 %70 to i64
  %72 = getelementptr inbounds [51 x double], ptr %67, i64 0, i64 %71
  ...
  %86 = getelementptr inbounds [51 x double], ptr %81, i64 %85
  %87 = load double, ptr %10, align 8
  %88 = fptosi double %87 to i32
  %89 = sext i32 %88 to i64
  %90 = getelementptr inbounds [51 x double], ptr %86, i64 0, i64 %89
  store double %80, ptr %90, align 8
...
31:                                               ; preds = %28, %10
  ...
  br i1 %33, label %10, label %._crit_edge, !llvm.loop !13
