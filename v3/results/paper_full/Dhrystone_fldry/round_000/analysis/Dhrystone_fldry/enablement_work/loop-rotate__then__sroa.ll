...
67:                                               ; preds = %.lr.ph5, %75
  %.026 = phi i8 [ 65, %.lr.ph5 ], [ %76, %75 ]
  %68 = load i32, ptr %3, align 4
  %69 = sext i8 %.026 to i32
...
4:                                                ; preds = %.lr.ph, %20
  %.013 = phi double [ 1.000000e+00, %.lr.ph ], [ %.2, %20 ]
  %5 = fptosi double %.013 to i32
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds i8, ptr %0, i64 %6
  %8 = load i8, ptr %7, align 1
  %9 = sext i8 %8 to i32
  %10 = fptosi double %.013 to i32
  %11 = add nsw i32 %10, 1
...
18:                                               ; preds = %4
  %19 = fadd double %.013, 1.000000e+00
  br label %20

20:                                               ; preds = %18, %4
  %.2 = phi double [ %19, %18 ], [ %.013, %4 ]
