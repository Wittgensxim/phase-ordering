...
21:                                               ; preds = %._crit_edge, %0
  ...
  %40 = getelementptr inbounds [31 x i8], ptr %7, i64 0, i64 0
  ...
  br i1 %44, label %.lr.ph8, label %119
...
45:                                               ; preds = %.lr.ph8, %114
  ...
  br i1 %58, label %.lr.ph2, label %72
...
59:                                               ; preds = %.lr.ph2, %59
  ...
  %66 = call i32 @Proc7(double noundef %64, double noundef %65, ptr noundef %4)
  ...
  br i1 %71, label %59, label %._crit_edge3, !llvm.loop !9

._crit_edge3:                                     ; preds = %59
  br label %72

72:                                               ; preds = %._crit_edge3, %45
...
89:                                               ; preds = %83
  %90 = call i32 @Proc6(i32 noundef 0, ptr noundef %6)
  br label %91
...
92:                                               ; preds = %91
  ...
  br i1 %99, label %83, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %92
  br label %100

100:                                              ; preds = %._crit_edge6, %72
  ...
  %111 = fneg double %110
  %112 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %109, double %111)
...
114:                                              ; preds = %100
  ...
  %118 = icmp ult i32 %117, 100000000
  br i1 %118, label %45, label %._crit_edge9, !llvm.loop !11

._crit_edge9:                                     ; preds = %114
  br label %119

119:                                              ; preds = %._crit_edge9, %21
