...
11:                                               ; preds = %7
  ...
  %23 = call ptr @strcpy(ptr noundef %4, ptr noundef @.str.2) #6
  store double 1.000000e+01, ptr getelementptr inbounds nuw (i8, ptr @Array2Glob, i64 3320), align 8
  %24 = call i32 @clock()
  br label %25

25:                                               ; preds = %61, %11
  %.1 = phi i32 [ 0, %11 ], [ %69, %61 ]
...
38:                                               ; preds = %35
  ...
  %40 = call i32 @Proc7(double noundef %36, double noundef 3.000000e+00, ptr noundef %2)
...
43:                                               ; preds = %35
  ...
  %45 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %36, double noundef %44)
  %46 = load ptr, ptr @PtrGlb, align 8
  %47 = call i32 @Proc1(ptr noundef %46)
  br label %48

48:                                               ; preds = %59, %43
  %.013 = phi i8 [ 65, %43 ], [ %60, %59 ]
...
61:                                               ; preds = %48
  ...
  %66 = fneg double %62
  %67 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %65, double %66)
...
3:                                                ; preds = %20, %2
  %.012 = phi double [ 1.000000e+00, %2 ], [ %.1, %20 ]
  %4 = fcmp ole double %.012, 1.000000e+00
...
18:                                               ; preds = %5
  %19 = fadd double %.012, 1.000000e+00
  br label %20

20:                                               ; preds = %18, %5
  %.1 = phi double [ %19, %18 ], [ %.012, %5 ]
...
31:                                               ; preds = %28
  %32 = fadd double %.012, 7.000000e+00
  br label %34
