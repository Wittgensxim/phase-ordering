...
23:                                               ; preds = %61, %12
  %.1 = phi i32 [ 0, %12 ], [ %62, %61 ]
  %24 = icmp samesign ult i32 %.1, 100000000
...
39:                                               ; preds = %30
  ...
  %42 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %40, double noundef %41)
  %43 = load ptr, ptr @PtrGlb, align 8
  %44 = call i32 @Proc1(ptr noundef %43)
  br label %45

45:                                               ; preds = %55, %39
  %.013 = phi i8 [ 65, %39 ], [ %56, %55 ]
  %46 = load i8, ptr @Char2Glob, align 1
  %.not14 = icmp sgt i8 %.013, %46
  br i1 %.not14, label %57, label %47

47:                                               ; preds = %45
  %48 = load i32, ptr %3, align 4
  %49 = sext i8 %.013 to i32
  %50 = call i32 @Func1(i32 noundef %49, i32 noundef 67)
...
23:                                               ; preds = %22
  br i1 poison, label %24, label %25
