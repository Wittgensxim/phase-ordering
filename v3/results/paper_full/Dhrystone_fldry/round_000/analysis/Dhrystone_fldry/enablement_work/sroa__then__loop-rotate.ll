...
32:                                               ; preds = %11, %90
  %.119 = phi i32 [ 0, %11 ], [ %91, %90 ]
  %33 = call i32 @Proc5()
  %34 = call i32 @Proc4()
  store double 2.000000e+00, ptr %1, align 8
  %35 = getelementptr inbounds [31 x i8], ptr %5, i64 0, i64 0
  %36 = call ptr @strcpy(ptr noundef %35, ptr noundef @.str.3) #6
  store i32 10000, ptr %3, align 4
  %37 = getelementptr inbounds [31 x i8], ptr %4, i64 0, i64 0
  %38 = getelementptr inbounds [31 x i8], ptr %5, i64 0, i64 0
  %39 = call i32 @Func2(ptr noundef %37, ptr noundef %38)
  %40 = icmp ne i32 %39, 0
  %41 = xor i1 %40, true
...
45:                                               ; preds = %.lr.ph, %45
  ...
  %47 = fneg double 3.000000e+00
  %48 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %46, double %47)
  store double %48, ptr %2, align 8
  %49 = load double, ptr %1, align 8
  %50 = call i32 @Proc7(double noundef %49, double noundef 3.000000e+00, ptr noundef %2)
  %51 = load double, ptr %1, align 8
  %52 = fadd double %51, 1.000000e+00
  store double %52, ptr %1, align 8
  %53 = load double, ptr %1, align 8
  %54 = fcmp olt double %53, 3.000000e+00
  br i1 %54, label %45, label %._crit_edge, !llvm.loop !9
...
55:                                               ; preds = %._crit_edge, %32
  ...
  br i1 %63, label %.lr.ph17, label %78

.lr.ph17:                                         ; preds = %55
  br label %64

64:                                               ; preds = %.lr.ph17, %72
  %.01315 = phi i8 [ 65, %.lr.ph17 ], [ %73, %72 ]
  %65 = load i32, ptr %3, align 4
  %66 = sext i8 %.01315 to i32
...
72:                                               ; preds = %71
  ...
  br i1 %77, label %64, label %._crit_edge18, !llvm.loop !10

._crit_edge18:                                    ; preds = %72
  br label %78

78:                                               ; preds = %._crit_edge18, %55
  ...
  %87 = fneg double %86
  %88 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %85, double %87)
  %89 = call i32 @Proc2(ptr noundef %1)
  br label %90

90:                                               ; preds = %78
  %91 = add i32 %.119, 1
  %92 = icmp ult i32 %91, 100000000
  br i1 %92, label %32, label %93, !llvm.loop !11
...
30:                                               ; preds = %23
  %31 = fadd double %.027, 1.000000e+00
...
3:                                                ; preds = %2, %19
  %.01213 = phi double [ 1.000000e+00, %2 ], [ %.1, %19 ]
  %4 = fptosi double %.01213 to i32
  %5 = sext i32 %4 to i64
  %6 = getelementptr inbounds i8, ptr %0, i64 %5
  %7 = load i8, ptr %6, align 1
  %8 = sext i8 %7 to i32
  %9 = fptosi double %.01213 to i32
  %10 = add nsw i32 %9, 1
...
17:                                               ; preds = %3
  %18 = fadd double %.01213, 1.000000e+00
  br label %19

19:                                               ; preds = %17, %3
  %.1 = phi double [ %18, %17 ], [ %.01213, %3 ]
  %20 = fcmp ole double %.1, 1.000000e+00
  br i1 %20, label %3, label %21, !llvm.loop !13

21:                                               ; preds = %19
  %.012.lcssa = phi double [ %.1, %19 ]
...
28:                                               ; preds = %27, %24, %21
  %.2 = phi double [ 7.000000e+00, %27 ], [ %.012.lcssa, %24 ], [ %.012.lcssa, %21 ]
  %29 = sext i8 65 to i32
...
32:                                               ; preds = %28
  %33 = call i32 @strcmp(ptr noundef %0, ptr noundef %1) #6
  %34 = icmp sgt i32 %33, 0
  br i1 %34, label %35, label %37

35:                                               ; preds = %32
  %36 = fadd double %.2, 7.000000e+00
  br label %38
