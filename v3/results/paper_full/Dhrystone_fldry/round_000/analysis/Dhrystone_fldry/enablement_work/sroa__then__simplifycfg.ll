...
3:                                                ; preds = %5, %2
  %.012 = phi double [ 1.000000e+00, %2 ], [ %.1, %5 ]
...
5:                                                ; preds = %3
  ...
  %.1 = select i1 %18, double %19, double %.012
...
20:                                               ; preds = %3
  ...
  %.2 = select i1 %or.cond, double 7.000000e+00, double %.012
  %25 = sext i8 65 to i32
  %26 = icmp eq i32 %25, 88
  br i1 %26, label %30, label %27

27:                                               ; preds = %20
  %28 = call i32 @strcmp(ptr noundef %0, ptr noundef %1) #6
  %29 = icmp sgt i32 %28, 0
  %spec.select = select i1 %29, i32 1, i32 0
  br label %30

30:                                               ; preds = %27, %20
  %.0 = phi i32 [ 1, %20 ], [ %spec.select, %27 ]
  ret i32 %.0
}
