...
46:                                               ; preds = %102, %21
  %.lcssa28 = phi i8 [ %.lcssa2, %102 ], [ %.promoted7, %21 ]
  %47 = phi double [ %100, %102 ], [ %.promoted5, %21 ]
  %48 = phi i32 [ %103, %102 ], [ %.promoted3, %21 ]
...
61:                                               ; preds = %58
  ...
  %63 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %62, double -3.000000e+00)
...
90:                                               ; preds = %74
  ...
  %99 = fneg double %98
  %100 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %97, double %99)
  %101 = call i32 @Proc2(ptr noundef %2)
  br label %102
