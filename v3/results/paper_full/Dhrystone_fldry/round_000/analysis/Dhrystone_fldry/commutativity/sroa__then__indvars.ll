...
30:                                               ; preds = %86, %10
  %.1 = phi i32 [ 0, %10 ], [ %87, %86 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %31, label %88
...
59:                                               ; preds = %72, %53
  %.013 = phi i8 [ 65, %53 ], [ %73, %72 ]
  %60 = sext i8 %.013 to i32
...
74:                                               ; preds = %59
  ...
  %83 = fneg double %82
  %84 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %81, double %83)
...
29:                                               ; preds = %28, %25, %22
  %.2 = phi double [ 7.000000e+00, %28 ], [ %.012.lcssa, %25 ], [ %.012.lcssa, %22 ]
