...
54:                                               ; preds = %66, %49
  %.09 = phi i8 [ 65, %49 ], [ %67, %66 ]
  %55 = sext i8 %.09 to i32
...
3:                                                ; preds = %20, %2
  %.09 = phi double [ 1.000000e+00, %2 ], [ %.1, %20 ]
  %4 = fcmp ole double %.09, 1.000000e+00
  br i1 %4, label %5, label %21

5:                                                ; preds = %3
  %6 = fptosi double %.09 to i32
  %7 = sext i32 %6 to i64
...
18:                                               ; preds = %5
  %19 = fadd double %.09, 1.000000e+00
  br label %20

20:                                               ; preds = %18, %5
  %.1 = phi double [ %19, %18 ], [ %.09, %5 ]
...
27:                                               ; preds = %26, %24, %21
  %.2 = phi double [ 7.000000e+00, %26 ], [ %.09, %24 ], [ %.09, %21 ]
