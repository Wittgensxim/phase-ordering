...
3:                                                ; preds = %21, %2
  %.03 = phi double [ 1.000000e+00, %2 ], [ %.1, %21 ]
  %4 = fcmp ole double %.03, 1.000000e+00
  br i1 %4, label %5, label %22

5:                                                ; preds = %3
  %6 = fptosi double %.03 to i32
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds i8, ptr %0, i64 %7
  %9 = load i8, ptr %8, align 1
  %10 = sext i8 %9 to i32
  %11 = fptosi double %.03 to i32
  %12 = add nsw i32 %11, 1
...
19:                                               ; preds = %5
  %20 = fadd double %.03, 1.000000e+00
  br label %21

21:                                               ; preds = %19, %5
  %.1 = phi double [ %20, %19 ], [ %.03, %5 ]
...
28:                                               ; preds = %27, %22
  %.2 = phi double [ 7.000000e+00, %27 ], [ %.03, %22 ]
