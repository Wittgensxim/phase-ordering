...
7:                                                ; preds = %10, %0
  ...
  %8 = icmp ult i32 %storemerge, 100000000
...
12:                                               ; preds = %7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %21, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #6
...
23:                                               ; preds = %66, %12
  %storemerge1 = phi i32 [ 0, %12 ], [ %67, %66 ]
...
33:                                               ; preds = %30
  ...
  %35 = fneg double 3.000000e+00
  %36 = call double @llvm.fmuladd.f64(double %34, double 5.000000e+00, double %35)
  store double %36, ptr %2, align 8
  %37 = call i32 @Proc7(double noundef %34, double noundef 3.000000e+00, ptr noundef nonnull %2)
...
40:                                               ; preds = %30
  ...
  %43 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %41, double noundef %42)
  %44 = load ptr, ptr @PtrGlb, align 8
  %45 = call i32 @Proc1(ptr noundef %44)
  br label %46

46:                                               ; preds = %56, %40
  %storemerge2 = phi i8 [ 65, %40 ], [ %57, %56 ]
...
48:                                               ; preds = %46
  ...
  %51 = call i32 @Func1(i32 noundef %50, i32 noundef 67)
  %52 = icmp eq i32 %49, %51
  br i1 %52, label %53, label %55

53:                                               ; preds = %48
  %54 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %3)
  br label %55
...
21:                                               ; preds = %31, %4
  %storemerge = phi double [ %5, %4 ], [ %32, %31 ]
  %22 = fadd double %5, 1.000000e+00
  %23 = fcmp ugt double %storemerge, %22
...
24:                                               ; preds = %21
  ...
  %28 = fptosi double %storemerge to i32
...
3:                                                ; preds = %21, %2
  %.012 = phi double [ 1.000000e+00, %2 ], [ %.1, %21 ]
  %4 = fcmp ugt double %.012, 1.000000e+00
  br i1 %4, label %22, label %5

5:                                                ; preds = %3
  %6 = fptosi double %.012 to i32
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds i8, ptr %0, i64 %7
  %9 = load i8, ptr %8, align 1
  %10 = sext i8 %9 to i32
  %11 = fptosi double %.012 to i32
...
19:                                               ; preds = %5
  %20 = fadd double %.012, 1.000000e+00
  br label %21

21:                                               ; preds = %19, %5
  %.1 = phi double [ %20, %19 ], [ %.012, %5 ]
  br label %3, !llvm.loop !13

22:                                               ; preds = %3
  %23 = icmp sgt i8 65, 86
  br i1 %23, label %24, label %27

24:                                               ; preds = %22
  %25 = icmp slt i8 65, 91
...
27:                                               ; preds = %26, %24, %22
  %.2 = phi double [ 7.000000e+00, %26 ], [ %.012, %24 ], [ %.012, %22 ]
  %28 = icmp eq i8 65, 88
...
30:                                               ; preds = %27
  %31 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #6
  %32 = icmp sgt i32 %31, 0
  br i1 %32, label %33, label %35

33:                                               ; preds = %30
  %34 = fadd double %.2, 7.000000e+00
  br label %36
