...
49:                                               ; preds = %46
  ...
  %51 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %50, double -3.000000e+00)
...
77:                                               ; preds = %62
  ...
  %86 = fneg double %85
  %87 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %84, double %86)
  %88 = call i32 @Proc2(ptr noundef %1)
  br label %89

89:                                               ; preds = %77
  %90 = add nuw nsw i32 %.1, 1
...
27:                                               ; preds = %24
  %28 = fadd double %.012, 7.000000e+00
  br label %30
