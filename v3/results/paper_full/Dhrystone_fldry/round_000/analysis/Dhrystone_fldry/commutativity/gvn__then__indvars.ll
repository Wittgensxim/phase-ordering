...
33:                                               ; preds = %70, %19
  %34 = phi i32 [ %78, %70 ], [ 0, %19 ]
  %exitcond1 = icmp ne i32 %34, 100000000
  br i1 %exitcond1, label %35, label %79
...
35:                                               ; preds = %33
  ...
  %38 = call ptr @strcpy(ptr noundef %9, ptr noundef @.str.3) #6
...
43:                                               ; preds = %46, %35
  %44 = phi double [ %50, %46 ], [ %.pre, %35 ]
  %45 = fcmp olt double %44, 3.000000e+00
  br i1 %45, label %46, label %51

46:                                               ; preds = %43
  %47 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %44, double -3.000000e+00)
  store double %47, ptr %4, align 8
  %48 = call i32 @Proc7(double noundef %44, double noundef 3.000000e+00, ptr noundef %4)
...
51:                                               ; preds = %43
  %.lcssa = phi double [ %44, %43 ]
  %52 = load double, ptr %4, align 8
  %53 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %.lcssa, double noundef %52)
...
70:                                               ; preds = %56
  ...
  %75 = fneg double %71
  %76 = call double @llvm.fmuladd.f64(double 7.000000e+00, double %74, double %75)
