...
21:                                               ; preds = %15
  ...
  store i32 0, ptr %10, align 4
  %43 = getelementptr inbounds nuw [31 x i8], ptr %9, i64 0, i64 0
  %44 = getelementptr inbounds nuw [31 x i8], ptr %8, i64 0, i64 0
  %45 = getelementptr inbounds nuw [31 x i8], ptr %9, i64 0, i64 0
...
46:                                               ; preds = %103, %21
  %.lcssa28 = phi i8 [ %.lcssa2, %103 ], [ %.promoted7, %21 ]
  %47 = phi double [ %101, %103 ], [ %.promoted5, %21 ]
  %48 = phi i32 [ %104, %103 ], [ %.promoted3, %21 ]
...
50:                                               ; preds = %46
  ...
  %53 = call ptr @strcpy(ptr noundef %43, ptr noundef @.str.3) #6
  store i32 10000, ptr %7, align 4
  %54 = call i32 @Func2(ptr noundef %44, ptr noundef %45)
  %55 = icmp ne i32 %54, 0
  %56 = xor i1 %55, true
  %57 = zext i1 %56 to i32
  store i32 %57, ptr @BoolGlob, align 4
  %58 = fneg double 3.000000e+00
  br label %59
...
62:                                               ; preds = %59
  ...
  %64 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %63, double %58)
  store double %64, ptr %4, align 8
  %65 = load double, ptr %2, align 8
  %66 = call i32 @Proc7(double noundef %65, double noundef 3.000000e+00, ptr noundef %4)
...
69:                                               ; preds = %59
  ...
  %72 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %70, double noundef %71)
  %73 = load ptr, ptr @PtrGlb, align 8
  %74 = call i32 @Proc1(ptr noundef %73)
  br label %75

75:                                               ; preds = %89, %69
  %76 = phi i8 [ %90, %89 ], [ 65, %69 ]
...
105:                                              ; preds = %46
  %.lcssa28.lcssa = phi i8 [ %.lcssa28, %46 ]
  %.lcssa6 = phi double [ %47, %46 ]
  %.lcssa4 = phi i32 [ %48, %46 ]
