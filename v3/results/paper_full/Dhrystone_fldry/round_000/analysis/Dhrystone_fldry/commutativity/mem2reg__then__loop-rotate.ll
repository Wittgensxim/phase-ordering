...
64:                                               ; preds = %.lr.ph5, %72
  %.013 = phi i8 [ 65, %.lr.ph5 ], [ %73, %72 ]
  %65 = load i32, ptr %3, align 4
  %66 = sext i8 %.013 to i32
...
72:                                               ; preds = %71
  ...
  br i1 %77, label %64, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %72
  br label %78

78:                                               ; preds = %._crit_edge6, %55
...
3:                                                ; preds = %2, %19
  %.012 = phi double [ 1.000000e+00, %2 ], [ %.1, %19 ]
  %4 = fptosi double %.012 to i32
  %5 = sext i32 %4 to i64
  %6 = getelementptr inbounds i8, ptr %0, i64 %5
  %7 = load i8, ptr %6, align 1
  %8 = sext i8 %7 to i32
  %9 = fptosi double %.012 to i32
  %10 = add nsw i32 %9, 1
...
17:                                               ; preds = %3
  %18 = fadd double %.012, 1.000000e+00
  br label %19

19:                                               ; preds = %17, %3
  %.1 = phi double [ %18, %17 ], [ %.012, %3 ]
  %20 = fcmp ole double %.1, 1.000000e+00
  br i1 %20, label %3, label %21, !llvm.loop !13

21:                                               ; preds = %19
  %.01.lcssa = phi double [ %.1, %19 ]
...
28:                                               ; preds = %27, %24, %21
  %.2 = phi double [ 7.000000e+00, %27 ], [ %.01.lcssa, %24 ], [ %.01.lcssa, %21 ]
