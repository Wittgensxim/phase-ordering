...
19:                                               ; preds = %13
  ...
  %.promoted6 = load double, ptr %3, align 8
  %.promoted8 = load i8, ptr %5, align 1
  br label %37

37:                                               ; preds = %90, %19
  %.lcssa39 = phi i8 [ %.lcssa3, %90 ], [ %.promoted8, %19 ]
  %38 = phi double [ %88, %90 ], [ %.promoted6, %19 ]
  %39 = phi i32 [ %91, %90 ], [ %.promoted4, %19 ]
...
53:                                               ; preds = %50
  %54 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %51, double %49)
  store double %54, ptr %4, align 8
  %55 = load double, ptr %2, align 8
  %56 = call i32 @Proc7(double noundef %55, double noundef 3.000000e+00, ptr noundef %4)
...
59:                                               ; preds = %50
  ...
  %61 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %.lcssa, double noundef %60)
...
79:                                               ; preds = %64
  ...
  %89 = call i32 @Proc2(ptr noundef %2)
  br label %90
...
92:                                               ; preds = %37
  %.lcssa39.lcssa = phi i8 [ %.lcssa39, %37 ]
  %.lcssa7 = phi double [ %38, %37 ]
  %.lcssa5 = phi i32 [ %39, %37 ]
  store i32 %.lcssa5, ptr %9, align 4
  store double %.lcssa7, ptr %3, align 8
...
12:                                               ; preds = %24, %1
  ...
  %14 = phi double [ %21, %24 ], [ %.promoted, %1 ]
...
41:                                               ; preds = %48, %4
  %42 = phi double [ %49, %48 ], [ %.promoted, %4 ]
...
50:                                               ; preds = %41
  %.lcssa1 = phi double [ %42, %41 ]
  %.lcssa = phi double [ %35, %41 ]
  store double %.lcssa1, ptr %11, align 8
  %51 = load ptr, ptr %7, align 8
  %52 = fptosi double %.lcssa to i32
...
10:                                               ; preds = %29, %2
  ...
  %12 = phi double [ %31, %29 ], [ %.promoted, %2 ]
