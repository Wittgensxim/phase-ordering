...
26:                                               ; preds = %7
  ...
  %40 = call ptr @strcpy(ptr noundef %4, ptr noundef @.str.2) #6
  store double 1.000000e+01, ptr getelementptr inbounds nuw (i8, ptr @Array2Glob, i64 3320), align 8
  %41 = call i32 @clock()
  br label %42

42:                                               ; preds = %84, %26
  %.1 = phi i32 [ 0, %26 ], [ %85, %84 ]
...
44:                                               ; preds = %42
  ...
  %47 = call ptr @strcpy(ptr noundef %5, ptr noundef @.str.3) #6
...
55:                                               ; preds = %52
  %56 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %53, double -3.000000e+00)
  store double %56, ptr %2, align 8
  %57 = load double, ptr %1, align 8
  %58 = call i32 @Proc7(double noundef %57, double noundef 3.000000e+00, ptr noundef %2)
...
61:                                               ; preds = %52
  ...
  %63 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %.lcssa, double noundef %62)
  %64 = load ptr, ptr @PtrGlb, align 8
  %65 = call i32 @Proc1(ptr noundef %64)
  br label %66

66:                                               ; preds = %78, %61
  %.01 = phi i8 [ 65, %61 ], [ %79, %78 ]
  %67 = sext i8 %.01 to i32
...
80:                                               ; preds = %66
  ...
  %83 = call i32 @Proc2(ptr noundef %1)
  br label %84
