...
12:                                               ; preds = %7
  ...
  %27 = getelementptr inbounds nuw [31 x i8], ptr %26, i64 0, i64 0
  %28 = call ptr @strcpy(ptr noundef %27, ptr noundef @.str.1) #6
  %29 = getelementptr inbounds nuw [31 x i8], ptr %4, i64 0, i64 0
  ...
  %33 = getelementptr inbounds nuw [31 x i8], ptr %4, i64 0, i64 0
  %34 = getelementptr inbounds nuw [31 x i8], ptr %5, i64 0, i64 0
  br label %35

35:                                               ; preds = %80, %12
  %.1 = phi i32 [ 0, %12 ], [ %81, %80 ]
  %36 = icmp ult i32 %.1, 100000000
...
37:                                               ; preds = %35
  ...
  %40 = call ptr @strcpy(ptr noundef %32, ptr noundef @.str.3) #6
  store i32 10000, ptr %3, align 4
  %41 = call i32 @Func2(ptr noundef %33, ptr noundef %34)
  %42 = icmp ne i32 %41, 0
  %43 = xor i1 %42, true
...
48:                                               ; preds = %45
  ...
  %50 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %49, double -3.000000e+00)
