...
59:                                               ; preds = %56
  ...
  %61 = fneg double 3.000000e+00
  %62 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %60, double %61)
  store double %62, ptr %2, align 8
  %63 = load double, ptr %1, align 8
  %64 = call i32 @Proc7(double noundef %63, double noundef 3.000000e+00, ptr noundef %2)
...
88:                                               ; preds = %73
  ...
  %90 = fmul double 3.000000e+00, %89
