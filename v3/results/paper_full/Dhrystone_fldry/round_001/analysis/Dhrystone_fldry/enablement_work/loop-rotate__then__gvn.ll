...
33:                                               ; preds = %.lr.ph, %33
  %34 = phi double [ %31, %.lr.ph ], [ %38, %33 ]
  %35 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %34, double -3.000000e+00)
  store double %35, ptr %2, align 8
  %36 = call i32 @Proc7(double noundef %34, double noundef 3.000000e+00, ptr noundef %2)
...
40:                                               ; preds = %._crit_edge, %23
  %41 = phi double [ %38, %._crit_edge ], [ %31, %23 ]
  %42 = load double, ptr %2, align 8
  %43 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %41, double noundef %42)
  %44 = load ptr, ptr @PtrGlb, align 8
  %45 = call i32 @Proc1(ptr noundef %44)
  %46 = load i8, ptr @Char2Glob, align 1
  %47 = sext i8 %46 to i32
  %48 = icmp sle i32 65, %47
  br i1 %48, label %.lr.ph5, label %62

.lr.ph5:                                          ; preds = %40
  br label %49

49:                                               ; preds = %.lr.ph5, %56
  %.013 = phi i8 [ 65, %.lr.ph5 ], [ %57, %56 ]
  %50 = load i32, ptr %3, align 4
  %51 = sext i8 %.013 to i32
...
56:                                               ; preds = %54, %49
  ...
  br i1 %61, label %49, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %56
  br label %62

62:                                               ; preds = %._crit_edge6, %40
