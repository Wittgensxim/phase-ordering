...
26:                                               ; preds = %7
  ...
  store double 4.000000e+01, ptr %38, align 8
  ...
  %42 = call ptr @strcpy(ptr noundef %41, ptr noundef @.str.1) #6
  %43 = getelementptr inbounds nuw [31 x i8], ptr %4, i64 0, i64 0
  %44 = call ptr @strcpy(ptr noundef %43, ptr noundef @.str.2) #6
  store double 1.000000e+01, ptr getelementptr inbounds nuw (i8, ptr @Array2Glob, i64 3320), align 8
  %45 = call i32 @clock()
  br label %46

46:                                               ; preds = %94, %26
  %.1 = phi i32 [ 0, %26 ], [ %95, %94 ]
...
48:                                               ; preds = %46
  ...
  %52 = call ptr @strcpy(ptr noundef %51, ptr noundef @.str.3) #6
...
62:                                               ; preds = %59
  ...
  %64 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %63, double -3.000000e+00)
  store double %64, ptr %2, align 8
  %65 = load double, ptr %1, align 8
  %66 = call i32 @Proc7(double noundef %65, double noundef 3.000000e+00, ptr noundef %2)
...
75:                                               ; preds = %88, %69
  %.01 = phi i8 [ 65, %69 ], [ %89, %88 ]
  %76 = sext i8 %.01 to i32
...
80:                                               ; preds = %75
  ...
  %82 = sext i8 %.01 to i32
  %83 = call i32 @Func1(i32 noundef %82, i32 noundef 67)
  %84 = icmp eq i32 %81, %83
  br i1 %84, label %85, label %87

85:                                               ; preds = %80
  %86 = call i32 @Proc6(i32 noundef 0, ptr noundef %3)
  br label %87
...
24:                                               ; preds = %23
  %25 = call i32 @strcmp(ptr noundef %0, ptr noundef %1) #6
