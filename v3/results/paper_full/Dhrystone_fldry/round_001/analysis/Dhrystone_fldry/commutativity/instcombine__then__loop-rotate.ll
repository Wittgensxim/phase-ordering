...
37:                                               ; preds = %._crit_edge, %22
  ...
  %40 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %38, double noundef %39)
  %41 = load ptr, ptr @PtrGlb, align 8
  %42 = call i32 @Proc1(ptr noundef %41)
  %43 = load i8, ptr @Char2Glob, align 1
  %.not13 = icmp sgt i8 65, %43
  br i1 %.not13, label %55, label %.lr.ph6

.lr.ph6:                                          ; preds = %37
  br label %44

44:                                               ; preds = %.lr.ph6, %52
  %.014 = phi i8 [ 65, %.lr.ph6 ], [ %53, %52 ]
  %45 = load i32, ptr %3, align 4
  %46 = sext i8 %.014 to i32
...
52:                                               ; preds = %51
  ...
  br i1 %.not1, label %._crit_edge7, label %44, !llvm.loop !10

._crit_edge7:                                     ; preds = %52
  br label %55

55:                                               ; preds = %._crit_edge7, %37
