...
8:                                                ; preds = %7
  %9 = call i32 @clock()
  %10 = call ptr @malloc(i64 noundef 56) #5
  ...
  %23 = getelementptr inbounds nuw [31 x i8], ptr %22, i64 0, i64 0
  %24 = call ptr @strcpy(ptr noundef %23, ptr noundef @.str.1) #6
  %25 = getelementptr inbounds nuw [31 x i8], ptr %4, i64 0, i64 0
  %26 = call ptr @strcpy(ptr noundef %25, ptr noundef @.str.2) #6
...
28:                                               ; preds = %75, %8
  ...
  br i1 %exitcond, label %29, label %77

29:                                               ; preds = %28
  %30 = call i32 @Proc5()
  %31 = call i32 @Proc4()
  store double 2.000000e+00, ptr %1, align 8
  %32 = getelementptr inbounds nuw [31 x i8], ptr %5, i64 0, i64 0
  %33 = call ptr @strcpy(ptr noundef %32, ptr noundef @.str.3) #6
  store i32 10000, ptr %3, align 4
  %34 = getelementptr inbounds nuw [31 x i8], ptr %4, i64 0, i64 0
  %35 = getelementptr inbounds nuw [31 x i8], ptr %5, i64 0, i64 0
...
50:                                               ; preds = %40
  ...
  %53 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %51, double noundef %52)
  %54 = load ptr, ptr @PtrGlb, align 8
  %55 = call i32 @Proc1(ptr noundef %54)
  br label %56

56:                                               ; preds = %69, %50
  %.01 = phi i8 [ 65, %50 ], [ %70, %69 ]
