...
53:                                               ; preds = %.lr.ph, %53
  ...
  br i1 %62, label %53, label %._crit_edge, !llvm.loop !9
...
63:                                               ; preds = %._crit_edge, %40
  ...
  %66 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %64, double noundef %65)
  %67 = load ptr, ptr @PtrGlb, align 8
  %68 = call i32 @Proc1(ptr noundef %67)
  %69 = load i8, ptr @Char2Glob, align 1
  %70 = sext i8 %69 to i32
  %71 = icmp sle i32 65, %70
  br i1 %71, label %.lr.ph5, label %86

.lr.ph5:                                          ; preds = %63
  br label %72

72:                                               ; preds = %.lr.ph5, %80
  %.013 = phi i8 [ 65, %.lr.ph5 ], [ %81, %80 ]
  %73 = load i32, ptr %3, align 4
  %74 = sext i8 %.013 to i32
...
80:                                               ; preds = %79
  ...
  br i1 %85, label %72, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %80
  br label %86

86:                                               ; preds = %._crit_edge6, %63
...
90:                                               ; preds = %86
  ...
  br i1 %92, label %40, label %93, !llvm.loop !11
