...
10:                                               ; preds = %7
  ...
  %25 = getelementptr inbounds nuw [31 x i8], ptr %24, i64 0, i64 0
  %26 = call ptr @strcpy(ptr noundef %25, ptr noundef @.str.1) #6
  %27 = getelementptr inbounds nuw [31 x i8], ptr %4, i64 0, i64 0
...
30:                                               ; preds = %77, %10
  %.1 = phi i32 [ 0, %10 ], [ %78, %77 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %31, label %79
...
45:                                               ; preds = %42
  ...
  %47 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %46, double -3.000000e+00)
...
52:                                               ; preds = %42
  ...
  %55 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, double noundef %53, double noundef %54)
  %56 = load ptr, ptr @PtrGlb, align 8
  %57 = call i32 @Proc1(ptr noundef %56)
  br label %58

58:                                               ; preds = %71, %52
  %.01 = phi i8 [ 65, %52 ], [ %72, %71 ]
