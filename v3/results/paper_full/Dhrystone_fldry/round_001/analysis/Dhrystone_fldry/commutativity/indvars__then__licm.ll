...
10:                                               ; preds = %7
  ...
  %33 = fneg double 3.000000e+00
  br label %34

34:                                               ; preds = %78, %10
  %.1 = phi i32 [ 0, %10 ], [ %79, %78 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %35, label %80

35:                                               ; preds = %34
  %36 = call i32 @Proc5()
  %37 = call i32 @Proc4()
  store double 2.000000e+00, ptr %1, align 8
  %38 = call ptr @strcpy(ptr noundef %30, ptr noundef @.str.3) #6
  store i32 10000, ptr %3, align 4
  %39 = call i32 @Func2(ptr noundef %31, ptr noundef %32)
  %40 = icmp ne i32 %39, 0
  %41 = xor i1 %40, true
...
46:                                               ; preds = %43
  ...
  %48 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %47, double %33)
