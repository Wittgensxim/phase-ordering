...
11:                                               ; preds = %8
  ...
  %30 = call i32 @clock()
  %31 = getelementptr inbounds [31 x i8], ptr %5, i64 0, i64 0
...
35:                                               ; preds = %11, %81
  ...
  %38 = call ptr @strcpy(ptr noundef %31, ptr noundef @.str.3) #6
  store i32 10000, ptr %3, align 4
  %39 = call i32 @Func2(ptr noundef %32, ptr noundef %33)
  %40 = icmp ne i32 %39, 0
  %41 = xor i1 %40, true
...
45:                                               ; preds = %.lr.ph, %45
  ...
  %47 = call double @llvm.fmuladd.f64(double 5.000000e+00, double %46, double %34)
  ...
  br i1 %53, label %45, label %._crit_edge, !llvm.loop !9
...
81:                                               ; preds = %77
  ...
  br i1 %83, label %35, label %84, !llvm.loop !11
...
26:                                               ; preds = %.lr.ph, %30
  ...
  %29 = getelementptr inbounds [51 x double], ptr %24, i64 0, i64 %28
...
30:                                               ; preds = %26
  ...
  br i1 %32, label %26, label %._crit_edge, !llvm.loop !12
