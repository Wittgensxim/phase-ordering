...
37:                                               ; preds = %._crit_edge, %22
  ...
  %.not15 = icmp sgt i8 65, %42
  br i1 %.not15, label %54, label %.lr.ph8

.lr.ph8:                                          ; preds = %37
  br label %43

43:                                               ; preds = %.lr.ph8, %51
  %.016 = phi i8 [ 65, %.lr.ph8 ], [ %52, %51 ]
  %44 = load i32, ptr %3, align 4
  %45 = sext i8 %.016 to i32
...
51:                                               ; preds = %50
  ...
  br i1 %.not1, label %._crit_edge9, label %43, !llvm.loop !10

._crit_edge9:                                     ; preds = %51
  br label %54

54:                                               ; preds = %._crit_edge9, %37
