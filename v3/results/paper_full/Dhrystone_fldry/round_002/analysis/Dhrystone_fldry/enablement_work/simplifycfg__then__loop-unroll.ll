...
18:                                               ; preds = %7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %27, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #6
...
29:                                               ; preds = %60, %18
  ...
  %30 = icmp samesign ult i32 %.1, 100000000
...
39:                                               ; preds = %36
  %40 = call double @llvm.fmuladd.f64(double %37, double 5.000000e+00, double -3.000000e+00)
  store double %40, ptr %2, align 8
  %41 = call i32 @Proc7(double noundef %37, double noundef 3.000000e+00, ptr noundef nonnull %2)
...
44:                                               ; preds = %36
  %.lcssa = phi double [ %37, %36 ]
  %45 = load double, ptr %2, align 8
  %46 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %45)
