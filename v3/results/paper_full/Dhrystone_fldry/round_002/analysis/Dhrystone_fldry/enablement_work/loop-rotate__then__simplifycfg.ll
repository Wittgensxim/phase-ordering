...
21:                                               ; preds = %10, %._crit_edge7
  %.18 = phi i32 [ 0, %10 ], [ %52, %._crit_edge7 ]
  %22 = call i32 @Proc5()
  %23 = call i32 @Proc4()
...
._crit_edge:                                      ; preds = %.lr.ph, %21
  %.lcssa = phi double [ %26, %21 ], [ %33, %.lr.ph ]
  ...
  br i1 %.not13, label %._crit_edge7, label %.lr.ph6

.lr.ph6:                                          ; preds = %._crit_edge, %46
  %.014 = phi i8 [ %47, %46 ], [ 65, %._crit_edge ]
  %40 = load i32, ptr %3, align 4
  %41 = sext i8 %.014 to i32
...
46:                                               ; preds = %.lr.ph6, %44
  ...
  br i1 %.not1, label %._crit_edge7, label %.lr.ph6, !llvm.loop !10

._crit_edge7:                                     ; preds = %46, %._crit_edge
  ...
  %53 = icmp samesign ult i32 %52, 100000000
  br i1 %53, label %21, label %54, !llvm.loop !11
