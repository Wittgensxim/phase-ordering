...
28:                                               ; preds = %.lr.ph, %28
  %29 = phi double [ %26, %.lr.ph ], [ %34, %28 ]
  %30 = call double @llvm.fmuladd.f64(double %29, double 5.000000e+00, double -3.000000e+00)
  store double %30, ptr %2, align 8
  %31 = call i32 @Proc7(double noundef %29, double noundef 3.000000e+00, ptr noundef nonnull %2)
...
._crit_edge:                                      ; preds = %28
  %split = phi double [ %34, %28 ]
  br label %36

36:                                               ; preds = %._crit_edge, %21
  %.lcssa = phi double [ %split, %._crit_edge ], [ %26, %21 ]
  %37 = load double, ptr %2, align 8
  %38 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %37)
  %39 = load ptr, ptr @PtrGlb, align 8
  %40 = call i32 @Proc1(ptr noundef %39)
  %41 = load i8, ptr @Char2Glob, align 1
  %.not11 = icmp sgt i8 65, %41
  br i1 %.not11, label %52, label %.lr.ph4

.lr.ph4:                                          ; preds = %36
  br label %42

42:                                               ; preds = %.lr.ph4, %49
  %.012 = phi i8 [ 65, %.lr.ph4 ], [ %50, %49 ]
  %43 = load i32, ptr %3, align 4
  %44 = sext i8 %.012 to i32
...
49:                                               ; preds = %42, %47
  ...
  br i1 %.not1, label %._crit_edge5, label %42, !llvm.loop !10

._crit_edge5:                                     ; preds = %49
  br label %52

52:                                               ; preds = %._crit_edge5, %36
  ...
  %57 = icmp samesign ult i32 %56, 100000000
