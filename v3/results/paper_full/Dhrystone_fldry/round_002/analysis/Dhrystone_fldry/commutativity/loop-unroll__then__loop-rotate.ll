...
25:                                               ; preds = %22
  %26 = call i32 @clock() #6
  %27 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %34, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #6
...
43:                                               ; preds = %.lr.ph, %43
  %44 = phi double [ %41, %.lr.ph ], [ %49, %43 ]
  %45 = call double @llvm.fmuladd.f64(double %44, double 5.000000e+00, double -3.000000e+00)
  store double %45, ptr %2, align 8
  %46 = call i32 @Proc7(double noundef %44, double noundef 3.000000e+00, ptr noundef nonnull %2)
...
._crit_edge:                                      ; preds = %43
  %split = phi double [ %49, %43 ]
  br label %51

51:                                               ; preds = %._crit_edge, %36
  %.lcssa = phi double [ %split, %._crit_edge ], [ %41, %36 ]
  %52 = load double, ptr %2, align 8
  %53 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %52)
  %54 = load ptr, ptr @PtrGlb, align 8
  %55 = call i32 @Proc1(ptr noundef %54)
  %56 = load i8, ptr @Char2Glob, align 1
  %.not13 = icmp sgt i8 65, %56
  br i1 %.not13, label %68, label %.lr.ph6

.lr.ph6:                                          ; preds = %51
  br label %57

57:                                               ; preds = %.lr.ph6, %65
  %.014 = phi i8 [ 65, %.lr.ph6 ], [ %66, %65 ]
  %58 = load i32, ptr %3, align 4
  %59 = sext i8 %.014 to i32
  %60 = call i32 @Func1(i32 noundef %59, i32 noundef 67)
  %61 = icmp eq i32 %58, %60
  br i1 %61, label %62, label %64

62:                                               ; preds = %57
  %63 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %3)
  br label %64
...
65:                                               ; preds = %64
  ...
  %.not1 = icmp sgt i8 %66, %67
  br i1 %.not1, label %._crit_edge7, label %57, !llvm.loop !10

._crit_edge7:                                     ; preds = %65
  br label %68

68:                                               ; preds = %._crit_edge7, %51
...
72:                                               ; preds = %68
  ...
  %74 = icmp samesign ult i32 %73, 100000000
  br i1 %74, label %36, label %75, !llvm.loop !11
