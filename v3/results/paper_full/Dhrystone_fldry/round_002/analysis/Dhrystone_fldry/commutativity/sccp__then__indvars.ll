...
21:                                               ; preds = %56, %10
  %.1 = phi i32 [ 0, %10 ], [ %57, %56 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %22, label %58
...
30:                                               ; preds = %27
  %31 = call double @llvm.fmuladd.f64(double %28, double 5.000000e+00, double -3.000000e+00)
  store double %31, ptr %2, align 8
  %32 = call i32 @Proc7(double noundef %28, double noundef 3.000000e+00, ptr noundef nonnull %2)
...
40:                                               ; preds = %50, %35
  %.01 = phi i8 [ 65, %35 ], [ %51, %50 ]
  %41 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %.01, %41
  br i1 %.not1, label %52, label %42

42:                                               ; preds = %40
  %43 = load i32, ptr %3, align 4
  %44 = sext i8 %.01 to i32
