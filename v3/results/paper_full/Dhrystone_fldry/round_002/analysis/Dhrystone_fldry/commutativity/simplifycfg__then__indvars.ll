...
20:                                               ; preds = %50, %9
  ...
  br i1 %exitcond, label %21, label %55
...
29:                                               ; preds = %26
  %30 = call double @llvm.fmuladd.f64(double %27, double 5.000000e+00, double -3.000000e+00)
  store double %30, ptr %2, align 8
  %31 = call i32 @Proc7(double noundef %27, double noundef 3.000000e+00, ptr noundef nonnull %2)
