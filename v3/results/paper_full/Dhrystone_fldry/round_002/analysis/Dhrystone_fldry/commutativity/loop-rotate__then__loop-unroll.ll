...
20:                                               ; preds = %17
  %21 = call i32 @clock() #6
  %22 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #7
  store ptr %22, ptr @PtrGlbNext, align 8
  %23 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %29, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #6
...
38:                                               ; preds = %.lr.ph, %38
  %39 = phi double [ %36, %.lr.ph ], [ %44, %38 ]
  %40 = call double @llvm.fmuladd.f64(double %39, double 5.000000e+00, double -3.000000e+00)
  store double %40, ptr %2, align 8
  %41 = call i32 @Proc7(double noundef %39, double noundef 3.000000e+00, ptr noundef nonnull %2)
  %42 = load double, ptr %1, align 8
  %43 = fadd double %42, 1.000000e+00
  store double %43, ptr %1, align 8
  %44 = load double, ptr %1, align 8
  %45 = fcmp olt double %44, 3.000000e+00
  br i1 %45, label %38, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %38
  %split = phi double [ %44, %38 ]
  br label %46

46:                                               ; preds = %._crit_edge, %31
  %.lcssa = phi double [ %split, %._crit_edge ], [ %36, %31 ]
  %47 = load double, ptr %2, align 8
  %48 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %47)
  %49 = load ptr, ptr @PtrGlb, align 8
  %50 = call i32 @Proc1(ptr noundef %49)
  %51 = load i8, ptr @Char2Glob, align 1
  %.not13 = icmp sgt i8 65, %51
  br i1 %.not13, label %63, label %.lr.ph6

.lr.ph6:                                          ; preds = %46
  br label %52

52:                                               ; preds = %.lr.ph6, %60
  %.014 = phi i8 [ 65, %.lr.ph6 ], [ %61, %60 ]
...
57:                                               ; preds = %52
  %58 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %3)
  br label %59
...
60:                                               ; preds = %59
  ...
  %.not1 = icmp sgt i8 %61, %62
  br i1 %.not1, label %._crit_edge7, label %52, !llvm.loop !10

._crit_edge7:                                     ; preds = %60
  br label %63

63:                                               ; preds = %._crit_edge7, %46
...
67:                                               ; preds = %63
  ...
  %69 = icmp samesign ult i32 %68, 100000000
