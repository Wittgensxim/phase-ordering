...
24:                                               ; preds = %7
  %25 = call i32 @clock() #6
  %26 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %33, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #6
...
35:                                               ; preds = %70, %24
  %.1 = phi i32 [ 0, %24 ], [ %71, %70 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %36, label %72
...
44:                                               ; preds = %41
  %45 = call double @llvm.fmuladd.f64(double %42, double 5.000000e+00, double -3.000000e+00)
  store double %45, ptr %2, align 8
  %46 = call i32 @Proc7(double noundef %42, double noundef 3.000000e+00, ptr noundef nonnull %2)
...
49:                                               ; preds = %41
  %.lcssa = phi double [ %42, %41 ]
  %50 = load double, ptr %2, align 8
  %51 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %50)
  %52 = load ptr, ptr @PtrGlb, align 8
  %53 = call i32 @Proc1(ptr noundef %52)
  br label %54

54:                                               ; preds = %64, %49
  %.01 = phi i8 [ 65, %49 ], [ %65, %64 ]
  %55 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %.01, %55
  br i1 %.not1, label %66, label %56

56:                                               ; preds = %54
  %57 = load i32, ptr %3, align 4
  %58 = sext i8 %.01 to i32
  %59 = call i32 @Func1(i32 noundef %58, i32 noundef 67)
  %60 = icmp eq i32 %57, %59
  br i1 %60, label %61, label %63

61:                                               ; preds = %56
  %62 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %3)
  br label %63
