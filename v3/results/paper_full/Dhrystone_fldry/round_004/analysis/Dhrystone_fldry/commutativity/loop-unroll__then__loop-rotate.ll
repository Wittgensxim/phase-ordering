...
19:                                               ; preds = %9, %48
  ...
  %24 = fcmp olt double %.pre, 3.000000e+00
...
25:                                               ; preds = %.lr.ph, %25
  ...
  br i1 %31, label %25, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %25
  %split = phi double [ %30, %25 ]
  br label %32

32:                                               ; preds = %._crit_edge, %19
  %.lcssa = phi double [ %split, %._crit_edge ], [ %.pre, %19 ]
  %33 = load double, ptr %2, align 8
  %34 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %33)
...
48:                                               ; preds = %._crit_edge5, %32
  ...
  br i1 %exitcond.not, label %53, label %19, !llvm.loop !10
