...
7:                                                ; preds = %0
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %15, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #7
...
17:                                               ; preds = %7, %46
  ...
  %22 = fcmp olt double %.pre, 3.000000e+00
...
23:                                               ; preds = %.lr.ph, %23
  %24 = phi double [ %.pre, %.lr.ph ], [ %28, %23 ]
  %25 = call double @llvm.fmuladd.f64(double %24, double 5.000000e+00, double -3.000000e+00)
  store double %25, ptr %2, align 8
  %26 = call i32 @Proc7(double noundef %24, double noundef 3.000000e+00, ptr noundef nonnull %2)
  %27 = load double, ptr %1, align 8
  %28 = fadd double %27, 1.000000e+00
  store double %28, ptr %1, align 8
  %29 = fcmp olt double %28, 3.000000e+00
  br i1 %29, label %23, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %23
  %split = phi double [ %28, %23 ]
  br label %30

30:                                               ; preds = %._crit_edge, %17
  %.lcssa = phi double [ %split, %._crit_edge ], [ %.pre, %17 ]
  %31 = load double, ptr %2, align 8
  %32 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %31)
...
46:                                               ; preds = %._crit_edge5, %30
  ...
  br i1 %exitcond.not, label %51, label %17, !llvm.loop !10
