...
24:                                               ; preds = %.lr.ph, %24
  ...
  br i1 %30, label %24, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %24
  %split = phi double [ %29, %24 ]
  br label %31

31:                                               ; preds = %._crit_edge, %18
  %.lcssa = phi double [ %split, %._crit_edge ], [ %.pre, %18 ]
  ...
  %.not12 = icmp sgt i8 65, %36
  br i1 %.not12, label %47, label %.lr.ph5

.lr.ph5:                                          ; preds = %31
  br label %37

37:                                               ; preds = %.lr.ph5, %44
  %.013 = phi i8 [ 65, %.lr.ph5 ], [ %45, %44 ]
  %38 = load i32, ptr %3, align 4
  %39 = sext i8 %.013 to i32
...
44:                                               ; preds = %42, %37
  ...
  br i1 %.not1, label %._crit_edge6, label %37, !llvm.loop !9

._crit_edge6:                                     ; preds = %44
  br label %47

47:                                               ; preds = %._crit_edge6, %31
  ...
  br i1 %exitcond.not, label %52, label %18, !llvm.loop !10
