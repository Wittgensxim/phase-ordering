; ModuleID = 'results\paper_full\Dhrystone_fldry\round_008\output.ll'
...
.lr.ph:                                           ; preds = %16, %.lr.ph
  %22 = phi double [ %26, %.lr.ph ], [ %.pre, %16 ]
  %23 = call double @llvm.fmuladd.f64(double %22, double 5.000000e+00, double -3.000000e+00)
  store double %23, ptr %2, align 8
  %24 = call i32 @Proc7(double noundef %22, double noundef 3.000000e+00, ptr noundef nonnull %2)
...
._crit_edge:                                      ; preds = %.lr.ph, %16
  %.lcssa = phi double [ %.pre, %16 ], [ %26, %.lr.ph ]
  %28 = load double, ptr %2, align 8
  %29 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %28)
  %30 = load ptr, ptr @PtrGlb, align 8
  %31 = call i32 @Proc1(ptr noundef %30)
  %32 = load i8, ptr @Char2Glob, align 1
  %.not11 = icmp sgt i8 65, %32
  br i1 %.not11, label %._crit_edge5, label %.lr.ph4

.lr.ph4:                                          ; preds = %._crit_edge, %39
  %.012 = phi i8 [ %40, %39 ], [ 65, %._crit_edge ]
  %33 = load i32, ptr %3, align 4
  %34 = sext i8 %.012 to i32
  %35 = call i32 @Func1(i32 noundef %34, i32 noundef 67)
  %36 = icmp eq i32 %33, %35
  br i1 %36, label %37, label %39

37:                                               ; preds = %.lr.ph4
  %38 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %3)
  br label %39

39:                                               ; preds = %37, %.lr.ph4
  %40 = add i8 %.012, 1
  %41 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %40, %41
  br i1 %.not1, label %._crit_edge5, label %.lr.ph4, !llvm.loop !9

._crit_edge5:                                     ; preds = %39, %._crit_edge
  %42 = load double, ptr %1, align 8
  %43 = fmul double %42, 3.000000e+00
  store double %43, ptr %2, align 8
  %44 = call i32 @Proc2(ptr noundef nonnull %1)
  %45 = add nuw nsw i32 %.16, 1
  %exitcond.not = icmp eq i32 %45, 100000000
  br i1 %exitcond.not, label %46, label %16, !llvm.loop !10

46:                                               ; preds = %._crit_edge5
  ret i32 undef
}
...
._crit_edge:                                      ; preds = %.lr.ph, %4
  %19 = getelementptr [8 x i8], ptr %12, i64 %7
  %20 = getelementptr i8, ptr %19, i64 -8
  %21 = load double, ptr %20, align 8
  %22 = fadd double %21, 1.000000e+00
  store double %22, ptr %20, align 8
  %23 = load double, ptr %8, align 8
  %24 = getelementptr i8, ptr %12, i64 8160
  %25 = getelementptr inbounds [8 x i8], ptr %24, i64 %7
