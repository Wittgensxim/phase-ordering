...
33:                                               ; preds = %._crit_edge, %20
  ...
  %.not14 = icmp sgt i8 65, %38
  br i1 %.not14, label %49, label %.lr.ph7

.lr.ph7:                                          ; preds = %33
  br label %39

39:                                               ; preds = %.lr.ph7, %46
  %.015 = phi i8 [ 65, %.lr.ph7 ], [ %47, %46 ]
...
46:                                               ; preds = %44, %39
  ...
  br i1 %.not1, label %._crit_edge8, label %39, !llvm.loop !10

._crit_edge8:                                     ; preds = %46
  br label %49

49:                                               ; preds = %._crit_edge8, %33
