...
21:                                               ; preds = %11, %50
  ...
  %26 = fcmp olt double %.pre, 3.000000e+00
...
._crit_edge:                                      ; preds = %27
  %split = phi double [ %32, %27 ]
  br label %34

34:                                               ; preds = %._crit_edge, %21
  %.lcssa = phi double [ %split, %._crit_edge ], [ %.pre, %21 ]
...
50:                                               ; preds = %._crit_edge5, %34
  ...
  br i1 %55, label %21, label %56, !llvm.loop !11
