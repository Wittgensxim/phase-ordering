...
16:                                               ; preds = %7
  %17 = call i32 @clock() #7
  %18 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %24, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #7
...
26:                                               ; preds = %56, %16
  %.1 = phi i32 [ 0, %16 ], [ %60, %56 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %27, label %61
...
32:                                               ; preds = %35, %27
  %33 = phi double [ %39, %35 ], [ %.pre, %27 ]
  %34 = fcmp olt double %33, 3.000000e+00
  br i1 %34, label %35, label %40

35:                                               ; preds = %32
  %36 = call double @llvm.fmuladd.f64(double %33, double 5.000000e+00, double -3.000000e+00)
  store double %36, ptr %2, align 8
  %37 = call i32 @Proc7(double noundef %33, double noundef 3.000000e+00, ptr noundef nonnull %2)
