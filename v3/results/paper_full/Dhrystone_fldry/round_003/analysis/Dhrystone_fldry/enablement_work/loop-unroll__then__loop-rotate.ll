...
17:                                               ; preds = %14
  %18 = call i32 @clock() #7
  %19 = call dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %25, ptr noundef nonnull align 1 dereferenceable(31) @.str.1, i64 31, i1 false) #7
...
27:                                               ; preds = %17, %56
  ...
  %30 = call i32 @Func2(ptr noundef nonnull %4, ptr noundef nonnull %5)
  %.not = icmp eq i32 %30, 0
  %31 = zext i1 %.not to i32
  store i32 %31, ptr @BoolGlob, align 4
  %.pre = load double, ptr %1, align 8
  %32 = fcmp olt double %.pre, 3.000000e+00
...
33:                                               ; preds = %.lr.ph, %33
  %34 = phi double [ %.pre, %.lr.ph ], [ %38, %33 ]
  %35 = call double @llvm.fmuladd.f64(double %34, double 5.000000e+00, double -3.000000e+00)
  store double %35, ptr %2, align 8
  %36 = call i32 @Proc7(double noundef %34, double noundef 3.000000e+00, ptr noundef nonnull %2)
  %37 = load double, ptr %1, align 8
  %38 = fadd double %37, 1.000000e+00
  store double %38, ptr %1, align 8
  %39 = fcmp olt double %38, 3.000000e+00
  br i1 %39, label %33, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %33
  %split = phi double [ %38, %33 ]
  br label %40

40:                                               ; preds = %._crit_edge, %27
  %.lcssa = phi double [ %split, %._crit_edge ], [ %.pre, %27 ]
  %41 = load double, ptr %2, align 8
  %42 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, double noundef %.lcssa, double noundef %41)
  %43 = load ptr, ptr @PtrGlb, align 8
  %44 = call i32 @Proc1(ptr noundef %43)
  %45 = load i8, ptr @Char2Glob, align 1
  %.not13 = icmp sgt i8 65, %45
  br i1 %.not13, label %56, label %.lr.ph6

.lr.ph6:                                          ; preds = %40
  br label %46

46:                                               ; preds = %.lr.ph6, %53
  %.014 = phi i8 [ 65, %.lr.ph6 ], [ %54, %53 ]
  %47 = load i32, ptr %3, align 4
  %48 = sext i8 %.014 to i32
...
53:                                               ; preds = %51, %46
  ...
  %.not1 = icmp sgt i8 %54, %55
  br i1 %.not1, label %._crit_edge7, label %46, !llvm.loop !10

._crit_edge7:                                     ; preds = %53
  br label %56

56:                                               ; preds = %._crit_edge7, %40
  ...
  br i1 %61, label %27, label %62, !llvm.loop !11
