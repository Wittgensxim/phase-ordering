...
9:                                                ; preds = %13, %2
  %10 = phi i32 [ %14, %13 ], [ %.promoted, %2 ]
  %11 = icmp sge i32 %10, 1
  br i1 %11, label %12, label %15

12:                                               ; preds = %9
  call void @Push(i32 noundef %10, i32 noundef %8)
  br label %13
...
define dso_local void @Towers() #0 {
  ...
  %smax = call i32 @llvm.smax.i32(i32 %.promoted, i32 19)
  %wide.trip.count = sext i32 %smax to i64
  br label %3

3:                                                ; preds = %9, %0
  %indvars.iv = phi i64 [ %indvars.iv.next, %9 ], [ %2, %0 ]
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %4, label %10

4:                                                ; preds = %3
  %5 = sub nsw i64 %indvars.iv, 1
  %6 = getelementptr inbounds [19 x %struct.element], ptr @cellspace, i64 0, i64 %indvars.iv
