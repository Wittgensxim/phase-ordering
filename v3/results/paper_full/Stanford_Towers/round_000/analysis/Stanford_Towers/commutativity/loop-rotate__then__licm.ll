...
11:                                               ; preds = %.lr.ph, %13
  %12 = phi i32 [ %.promoted, %.lr.ph ], [ %14, %13 ]
  call void @Push(i32 noundef %12, i32 noundef %10)
  br label %13
...
4:                                                ; preds = %.lr.ph, %10
  %5 = phi i32 [ %.promoted, %.lr.ph ], [ %11, %10 ]
  %6 = sub nsw i32 %5, 1
  %7 = sext i32 %5 to i64
  %8 = getelementptr inbounds [19 x %struct.element], ptr @cellspace, i64 0, i64 %7
  %9 = getelementptr inbounds nuw %struct.element, ptr %8, i32 0, i32 1
...
10:                                               ; preds = %4
  ...
  br i1 %12, label %4, label %._crit_edge, !llvm.loop !9
