...
17:                                               ; preds = %14
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %25, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #6
...
33:                                               ; preds = %.lr.ph, %33
  %34 = phi i32 [ %.pre, %.lr.ph ], [ %39, %33 ]
  %35 = mul nsw i32 %34, 5
  %36 = add nsw i32 %35, -3
  store i32 %36, ptr %2, align 4
  %37 = call i32 @Proc7(i32 noundef %34, i32 noundef 3, ptr noundef nonnull %2)
...
41:                                               ; preds = %._crit_edge, %27
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %27 ]
  ...
  %.not13 = icmp sgt i8 65, %46
  br i1 %.not13, label %57, label %.lr.ph6

.lr.ph6:                                          ; preds = %41
  br label %47

47:                                               ; preds = %.lr.ph6, %54
  %.014 = phi i8 [ 65, %.lr.ph6 ], [ %55, %54 ]
  %48 = load i32, ptr %3, align 4
  %49 = sext i8 %.014 to i32
...
54:                                               ; preds = %52, %47
  ...
  %.not1 = icmp sgt i8 %55, %56
  br i1 %.not1, label %._crit_edge7, label %47, !llvm.loop !10

._crit_edge7:                                     ; preds = %54
  br label %57

57:                                               ; preds = %._crit_edge7, %41
  %58 = load i32, ptr %1, align 4
  %59 = mul nsw i32 %58, 3
  store i32 %59, ptr %2, align 4
  %60 = call i32 @Proc2(ptr noundef nonnull %1)
  %61 = add nuw nsw i32 %.18, 1
  %62 = icmp samesign ult i32 %61, 100000000
