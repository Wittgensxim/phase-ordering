...
16:                                               ; preds = %7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %24, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #6
...
26:                                               ; preds = %57, %16
  %.1 = phi i32 [ 0, %16 ], [ %61, %57 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %27, label %62
...
35:                                               ; preds = %32
  ...
  %38 = call i32 @Proc7(i32 noundef %33, i32 noundef 3, ptr noundef nonnull %2)
...
46:                                               ; preds = %55, %41
  %.01 = phi i8 [ 65, %41 ], [ %56, %55 ]
  %47 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %.01, %47
