...
7:                                                ; preds = %7, %0
  %.0 = phi i32 [ 0, %0 ], [ %10, %7 ]
  %8 = add nuw nsw i32 %.0, 16
  %9 = icmp samesign ult i32 %8, 100000000
  %10 = add nuw nsw i32 %.0, 17
  br i1 %9, label %7, label %11, !llvm.loop !7
...
11:                                               ; preds = %7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %19, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #6
...
35:                                               ; preds = %._crit_edge, %21
  ...
  %.not11 = icmp sgt i8 65, %40
  br i1 %.not11, label %51, label %.lr.ph4

.lr.ph4:                                          ; preds = %35
  br label %41

41:                                               ; preds = %.lr.ph4, %48
  %.012 = phi i8 [ 65, %.lr.ph4 ], [ %49, %48 ]
...
48:                                               ; preds = %46, %41
  ...
  br i1 %.not1, label %._crit_edge5, label %41, !llvm.loop !10

._crit_edge5:                                     ; preds = %48
  br label %51

51:                                               ; preds = %._crit_edge5, %35
...
21:                                               ; preds = %17, %12
  ...
  %23 = getelementptr [4 x i8], ptr %22, i64 %8
  %24 = getelementptr i8, ptr %23, i64 16
  %25 = load i32, ptr %24, align 4
  %26 = add nsw i32 %25, 1
  store i32 %26, ptr %24, align 4
  %27 = load i32, ptr %7, align 4
  %28 = getelementptr [204 x i8], ptr %1, i64 %8
