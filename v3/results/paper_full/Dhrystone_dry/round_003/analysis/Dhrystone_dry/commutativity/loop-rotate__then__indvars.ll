...
16:                                               ; preds = %4, %16
  %indvars.iv = phi i64 [ %14, %4 ], [ %indvars.iv.next, %16 ]
  %17 = getelementptr inbounds [204 x i8], ptr %1, i64 %6
  %18 = getelementptr inbounds [4 x i8], ptr %17, i64 %indvars.iv
  store i32 %5, ptr %18, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %.not = icmp sgt i64 %indvars.iv.next, %15
  br i1 %.not, label %19, label %16, !llvm.loop !12
...
3:                                                ; preds = %2, %3
  ...
  %spec.select = select i1 %13, i32 %14, i32 %.011
  %15 = icmp slt i32 %spec.select, 2
