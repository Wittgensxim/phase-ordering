...
34:                                               ; preds = %._crit_edge, %20
  ...
  %.not14 = icmp sgt i8 65, %39
  br i1 %.not14, label %50, label %.lr.ph7

.lr.ph7:                                          ; preds = %34
  br label %40

40:                                               ; preds = %.lr.ph7, %47
  %.015 = phi i8 [ 65, %.lr.ph7 ], [ %48, %47 ]
...
47:                                               ; preds = %45, %40
  ...
  br i1 %.not1, label %._crit_edge8, label %40, !llvm.loop !10
...
3:                                                ; preds = %2, %3
  ...
  %13 = icmp slt i32 %spec.select, 2
  br i1 %13, label %3, label %14, !llvm.loop !13

14:                                               ; preds = %3
  %15 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #6
  %16 = icmp sgt i32 %15, 0
  %. = select i1 %16, i32 1, i32 0
  ret i32 %.
}
