...
26:                                               ; preds = %68, %10
  %.1 = phi i32 [ 0, %10 ], [ %69, %68 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %27, label %70
...
45:                                               ; preds = %35
  ...
  %47 = call i32 @Proc8(ptr noundef @Array1Glob, ptr noundef @Array2Glob, i32 noundef %36, i32 noundef %46)
  %48 = load ptr, ptr @PtrGlb, align 8
  %49 = call i32 @Proc1(ptr noundef %48)
  br label %50

50:                                               ; preds = %62, %45
  %.01 = phi i8 [ 65, %45 ], [ %63, %62 ]
  %51 = sext i8 %.01 to i32
...
16:                                               ; preds = %21, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %21 ], [ %15, %4 ]
  %17 = icmp sle i64 %indvars.iv, %9
  br i1 %17, label %18, label %22

18:                                               ; preds = %16
  %19 = getelementptr inbounds [51 x i32], ptr %1, i64 %6
  %20 = getelementptr inbounds [51 x i32], ptr %19, i64 0, i64 %indvars.iv
