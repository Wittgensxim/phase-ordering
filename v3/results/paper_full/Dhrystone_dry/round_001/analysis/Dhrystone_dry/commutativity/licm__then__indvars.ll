...
33:                                               ; preds = %78, %10
  ...
  br i1 %exitcond, label %34, label %80

34:                                               ; preds = %33
  %35 = call i32 @Proc5()
  %36 = call i32 @Proc4()
  store i32 2, ptr %1, align 4
  %37 = call ptr @strcpy(ptr noundef %30, ptr noundef @.str.2) #5
  store i32 10000, ptr %3, align 4
  %38 = call i32 @Func2(ptr noundef %31, ptr noundef %32)
  %39 = icmp ne i32 %38, 0
  %40 = xor i1 %39, true
...
23:                                               ; preds = %27, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %27 ], [ %21, %4 ]
  %24 = icmp sle i64 %indvars.iv, %22
  br i1 %24, label %25, label %28

25:                                               ; preds = %23
  %26 = getelementptr inbounds [51 x i32], ptr %19, i64 0, i64 %indvars.iv
