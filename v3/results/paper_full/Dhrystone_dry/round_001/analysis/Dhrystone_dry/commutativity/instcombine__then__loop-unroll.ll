...
47:                                               ; preds = %44
  ...
  %51 = call i32 @Proc7(i32 noundef %48, i32 noundef 3, ptr noundef nonnull %2)
...
54:                                               ; preds = %44
  ...
  %57 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %55, i32 noundef %56)
  %58 = load ptr, ptr @PtrGlb, align 8
  %59 = call i32 @Proc1(ptr noundef %58)
  br label %60

60:                                               ; preds = %70, %54
  %.01 = phi i8 [ 65, %54 ], [ %71, %70 ]
  %61 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %.01, %61
  br i1 %.not1, label %72, label %62
...
67:                                               ; preds = %62
  %68 = call i32 @Proc6(i32 noundef 0, ptr noundef nonnull %3)
  br label %69
...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %16 = getelementptr i8, ptr %15, i64 140
...
38:                                               ; preds = %30
  ...
  %51 = getelementptr i8, ptr %50, i64 5100
