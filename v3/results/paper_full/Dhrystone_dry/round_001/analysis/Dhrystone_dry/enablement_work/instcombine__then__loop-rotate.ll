...
38:                                               ; preds = %._crit_edge, %22
  ...
  %41 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %39, i32 noundef %40)
  %42 = load ptr, ptr @PtrGlb, align 8
  %43 = call i32 @Proc1(ptr noundef %42)
  %44 = load i8, ptr @Char2Glob, align 1
  %.not13 = icmp sgt i8 65, %44
...
53:                                               ; preds = %52
  ...
  br i1 %.not1, label %._crit_edge7, label %45, !llvm.loop !10

._crit_edge7:                                     ; preds = %53
  br label %56

56:                                               ; preds = %._crit_edge7, %38
