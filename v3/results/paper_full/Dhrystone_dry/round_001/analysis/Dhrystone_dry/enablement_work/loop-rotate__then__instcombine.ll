...
37:                                               ; preds = %._crit_edge, %22
  ...
  %40 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %38, i32 noundef %39)
  %41 = load ptr, ptr @PtrGlb, align 8
  %42 = call i32 @Proc1(ptr noundef %41)
  %43 = load i8, ptr @Char2Glob, align 1
  %44 = icmp sgt i8 %43, 64
  br i1 %44, label %.lr.ph5, label %56

.lr.ph5:                                          ; preds = %37
  br label %45

45:                                               ; preds = %.lr.ph5, %53
  %.013 = phi i8 [ 65, %.lr.ph5 ], [ %54, %53 ]
  %46 = load i32, ptr %3, align 4
  %47 = sext i8 %.013 to i32
...
53:                                               ; preds = %52
  ...
  %.not8 = icmp sgt i8 %54, %55
  br i1 %.not8, label %._crit_edge6, label %45, !llvm.loop !10
...
60:                                               ; preds = %56
  ...
  %62 = icmp samesign ult i32 %.17, 99999999
