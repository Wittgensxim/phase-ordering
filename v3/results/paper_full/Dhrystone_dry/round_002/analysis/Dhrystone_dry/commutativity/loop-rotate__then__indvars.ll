...
20:                                               ; preds = %9, %57
  ...
  br i1 %26, label %.lr.ph, label %36

.lr.ph:                                           ; preds = %20
  br label %27

27:                                               ; preds = %.lr.ph, %27
  %28 = phi i32 [ %25, %.lr.ph ], [ %34, %27 ]
  %29 = mul nsw i32 %28, 5
  %30 = add nsw i32 %29, -3
  ...
  br i1 %35, label %27, label %._crit_edge, !llvm.loop !9
...
36:                                               ; preds = %._crit_edge, %20
  ...
  %.not13 = icmp sgt i8 65, %41
  br i1 %.not13, label %53, label %.lr.ph6

.lr.ph6:                                          ; preds = %36
  br label %42

42:                                               ; preds = %.lr.ph6, %50
  %.014 = phi i8 [ 65, %.lr.ph6 ], [ %51, %50 ]
  %43 = load i32, ptr %3, align 4
  %44 = sext i8 %.014 to i32
...
50:                                               ; preds = %49
  ...
  br i1 %.not1, label %._crit_edge7, label %42, !llvm.loop !10
...
16:                                               ; preds = %4, %19
  %indvars.iv = phi i64 [ %14, %4 ], [ %indvars.iv.next, %19 ]
...
19:                                               ; preds = %16
  ...
  br i1 %.not, label %20, label %16, !llvm.loop !12

20:                                               ; preds = %19
  %21 = getelementptr inbounds [204 x i8], ptr %1, i64 %6
  %22 = getelementptr [4 x i8], ptr %21, i64 %8
  %23 = getelementptr i8, ptr %22, i64 16
  %24 = load i32, ptr %23, align 4
  %25 = add nsw i32 %24, 1
  store i32 %25, ptr %23, align 4
  %26 = load i32, ptr %7, align 4
  %27 = getelementptr [204 x i8], ptr %1, i64 %8
