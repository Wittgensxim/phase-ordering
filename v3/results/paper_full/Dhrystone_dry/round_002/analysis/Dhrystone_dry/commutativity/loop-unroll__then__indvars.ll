...
35:                                               ; preds = %71, %24
  %.1 = phi i32 [ 0, %24 ], [ %72, %71 ]
  %exitcond = icmp ne i32 %.1, 100000000
  br i1 %exitcond, label %36, label %73
...
44:                                               ; preds = %41
  ...
  %47 = call i32 @Proc7(i32 noundef %42, i32 noundef 3, ptr noundef nonnull %2)
...
50:                                               ; preds = %41
  ...
  %52 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %.lcssa, i32 noundef %51)
  %53 = load ptr, ptr @PtrGlb, align 8
  %54 = call i32 @Proc1(ptr noundef %53)
  br label %55

55:                                               ; preds = %65, %50
  %.01 = phi i8 [ 65, %50 ], [ %66, %65 ]
  %56 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %.01, %56
  br i1 %.not1, label %67, label %57
