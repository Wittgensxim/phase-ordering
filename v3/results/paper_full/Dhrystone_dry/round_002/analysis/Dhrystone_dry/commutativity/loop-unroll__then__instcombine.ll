...
47:                                               ; preds = %44
  ...
  %50 = call i32 @Proc7(i32 noundef %45, i32 noundef 3, ptr noundef nonnull %2)
...
53:                                               ; preds = %44
  ...
  %55 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %45, i32 noundef %54)
  %56 = load ptr, ptr @PtrGlb, align 8
  %57 = call i32 @Proc1(ptr noundef %56)
  br label %58

58:                                               ; preds = %68, %53
  %.01 = phi i8 [ 65, %53 ], [ %69, %68 ]
  %59 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %.01, %59
  br i1 %.not1, label %70, label %60
...
26:                                               ; preds = %23
  ...
  %28 = getelementptr [4 x i8], ptr %27, i64 %8
  %29 = getelementptr i8, ptr %28, i64 16
  %30 = load i32, ptr %29, align 4
  %31 = add nsw i32 %30, 1
  store i32 %31, ptr %29, align 4
  %32 = load i32, ptr %7, align 4
  %33 = getelementptr [204 x i8], ptr %1, i64 %8
  %34 = getelementptr i8, ptr %33, i64 5100
