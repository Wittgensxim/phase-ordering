...
37:                                               ; preds = %._crit_edge, %21
  ...
  %.not11 = icmp sgt i8 65, %42
  br i1 %.not11, label %53, label %.lr.ph4

.lr.ph4:                                          ; preds = %37
  br label %43

43:                                               ; preds = %.lr.ph4, %50
  %.012 = phi i8 [ 65, %.lr.ph4 ], [ %51, %50 ]
  %44 = load i32, ptr %3, align 4
  %45 = sext i8 %.012 to i32
...
50:                                               ; preds = %43, %48
  ...
  br i1 %.not1, label %._crit_edge5, label %43, !llvm.loop !10
