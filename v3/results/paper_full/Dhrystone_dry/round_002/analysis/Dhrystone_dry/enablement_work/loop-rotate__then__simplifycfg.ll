...
21:                                               ; preds = %10, %._crit_edge7
  %.18 = phi i32 [ 0, %10 ], [ %53, %._crit_edge7 ]
  %22 = call i32 @Proc5()
  %23 = call i32 @Proc4()
...
.lr.ph6:                                          ; preds = %._crit_edge, %47
  %.014 = phi i8 [ %48, %47 ], [ 65, %._crit_edge ]
...
._crit_edge7:                                     ; preds = %47, %._crit_edge
  ...
  br i1 %54, label %21, label %55, !llvm.loop !11

55:                                               ; preds = %._crit_edge7
  ret i32 undef
}
