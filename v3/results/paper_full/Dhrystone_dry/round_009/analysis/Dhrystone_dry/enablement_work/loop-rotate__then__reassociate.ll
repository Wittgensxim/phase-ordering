...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  br i1 %exitcond1, label %17, label %.lr.ph

.lr.ph:                                           ; preds = %4
  br label %15

15:                                               ; preds = %.lr.ph, %15
  %indvars.iv2 = phi i64 [ %12, %.lr.ph ], [ %indvars.iv.next, %15 ]
  %16 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv2
...
17:                                               ; preds = %._crit_edge, %4
  %18 = getelementptr [4 x i8], ptr %14, i64 %8
  %19 = getelementptr i8, ptr %18, i64 16
  %20 = load i32, ptr %19, align 4
  %21 = add nsw i32 %20, 1
  store i32 %21, ptr %19, align 4
  %22 = load i32, ptr %7, align 4
  %23 = getelementptr [204 x i8], ptr %1, i64 %8
  %24 = getelementptr i8, ptr %23, i64 5100
