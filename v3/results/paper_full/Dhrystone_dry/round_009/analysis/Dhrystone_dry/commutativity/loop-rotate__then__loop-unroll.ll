; ModuleID = 'results\paper_full\Dhrystone_dry\round_008\output.ll'
...
19:                                               ; preds = %19, %.prol.preheader
  %indvars.iv2.prol = phi i64 [ %12, %.prol.preheader ], [ %indvars.iv.next.prol, %19 ]
  %prol.iter = phi i64 [ 0, %.prol.preheader ], [ %prol.iter.next, %19 ]
  %20 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv2.prol
...
22:                                               ; preds = %22, %.lr.ph.new
  %indvars.iv2 = phi i64 [ %indvars.iv2.unr, %.lr.ph.new ], [ %indvars.iv.next.7, %22 ]
  %23 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv2
  store i32 %5, ptr %23, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv2, 1
  %24 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv.next
  store i32 %5, ptr %24, align 4
  %indvars.iv.next.1 = add nsw i64 %indvars.iv2, 2
  %25 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv.next.1
  store i32 %5, ptr %25, align 4
  %indvars.iv.next.2 = add nsw i64 %indvars.iv2, 3
  %26 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv.next.2
  store i32 %5, ptr %26, align 4
  %indvars.iv.next.3 = add nsw i64 %indvars.iv2, 4
  %27 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv.next.3
  store i32 %5, ptr %27, align 4
  %indvars.iv.next.4 = add nsw i64 %indvars.iv2, 5
  %28 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv.next.4
  store i32 %5, ptr %28, align 4
  %indvars.iv.next.5 = add nsw i64 %indvars.iv2, 6
  %29 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv.next.5
  store i32 %5, ptr %29, align 4
  %indvars.iv.next.6 = add nsw i64 %indvars.iv2, 7
  %30 = getelementptr inbounds [4 x i8], ptr %14, i64 %indvars.iv.next.6
  store i32 %5, ptr %30, align 4
  %indvars.iv.next.7 = add nsw i64 %indvars.iv2, 8
  %exitcond.7 = icmp eq i64 %indvars.iv.next.7, %wide.trip.count
  br i1 %exitcond.7, label %._crit_edge.unr-lcssa, label %22, !llvm.loop !14
...
31:                                               ; preds = %._crit_edge, %4
  %32 = getelementptr [4 x i8], ptr %14, i64 %8
...
5:                                                ; preds = %2, %5
  ...
  %9 = sext i8 %8 to i32
  %10 = call i32 @Func1(i32 noundef %7, i32 noundef %9)
  %11 = icmp eq i32 %10, 0
  %spec.select = select i1 %11, i32 2, i32 1
  %12 = icmp samesign ult i32 %spec.select, 2
  br i1 %12, label %5, label %13, !llvm.loop !15
