...
31:                                               ; preds = %22
  ...
  %33 = call i32 @Proc8(ptr noundef nonnull @Array1Glob, ptr noundef nonnull @Array2Glob, i32 noundef %23, i32 noundef %32)
...
15:                                               ; preds = %16, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %16 ], [ %12, %4 ]
  %exitcond = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %18, label %16
