...
define dso_local i32 @Proc8(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  br i1 %exitcond1, label %18, label %.lr.ph

.lr.ph:                                           ; preds = %4
  br label %15

15:                                               ; preds = %.lr.ph, %15
  %indvars.iv2 = phi i64 [ %13, %.lr.ph ], [ %indvars.iv.next, %15 ]
  %16 = getelementptr inbounds [204 x i8], ptr %1, i64 %6
  %17 = getelementptr inbounds [4 x i8], ptr %16, i64 %indvars.iv2
  store i32 %5, ptr %17, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv2, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge, label %15, !llvm.loop !13
...
3:                                                ; preds = %2, %3
  ...
  %spec.select = add nuw nsw i32 %14, %.011
