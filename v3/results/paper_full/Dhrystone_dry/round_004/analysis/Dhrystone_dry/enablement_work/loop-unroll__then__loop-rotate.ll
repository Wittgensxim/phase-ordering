...
25:                                               ; preds = %.lr.ph, %25
  ...
  br i1 %32, label %25, label %._crit_edge, !llvm.loop !7
...
33:                                               ; preds = %._crit_edge, %19
  %.lcssa = phi i32 [ %split, %._crit_edge ], [ %.pre, %19 ]
  ...
  %.not11 = icmp sgt i8 65, %38
  br i1 %.not11, label %49, label %.lr.ph4

.lr.ph4:                                          ; preds = %33
  br label %39

39:                                               ; preds = %.lr.ph4, %46
  %.012 = phi i8 [ 65, %.lr.ph4 ], [ %47, %46 ]
...
46:                                               ; preds = %44, %39
  ...
  %.not1 = icmp sgt i8 %47, %48
  br i1 %.not1, label %._crit_edge5, label %39, !llvm.loop !9

._crit_edge5:                                     ; preds = %46
  br label %49

49:                                               ; preds = %._crit_edge5, %33
  %50 = load i32, ptr %1, align 4
  %51 = mul nsw i32 %50, 3
  store i32 %51, ptr %2, align 4
  %52 = call i32 @Proc2(ptr noundef nonnull %1)
  %53 = add nuw nsw i32 %.16, 1
  %exitcond.not = icmp eq i32 %53, 100000000
  br i1 %exitcond.not, label %54, label %19, !llvm.loop !10
