...
7:                                                ; preds = %._crit_edge7, %0
  br i1 false, label %._crit_edge7, label %8, !llvm.loop !7
...
32:                                               ; preds = %._crit_edge, %18
  %.lcssa = phi i32 [ %30, %._crit_edge ], [ %.pre, %18 ]
...
48:                                               ; preds = %._crit_edge5, %32
  ...
  %exitcond.not = icmp eq i32 %52, 100000000
  br i1 %exitcond.not, label %53, label %18, !llvm.loop !11
...
14:                                               ; preds = %.lr.ph, %14
  %indvars.iv2 = phi i64 [ %12, %.lr.ph ], [ %indvars.iv.next, %14 ]
  %15 = getelementptr inbounds [204 x i8], ptr %1, i64 %6
  %16 = getelementptr inbounds [4 x i8], ptr %15, i64 %indvars.iv2
  store i32 %5, ptr %16, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv2, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge, label %14, !llvm.loop !13
...
17:                                               ; preds = %._crit_edge, %4
  ...
  %19 = getelementptr [4 x i8], ptr %18, i64 %8
