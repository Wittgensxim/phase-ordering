...
16:                                               ; preds = %.lr.ph, %16
  %indvars.iv2 = phi i64 [ %13, %.lr.ph ], [ %indvars.iv.next, %16 ]
  %17 = getelementptr inbounds [4 x i8], ptr %15, i64 %indvars.iv2
  store i32 %5, ptr %17, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv2, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge, label %16, !llvm.loop !13
