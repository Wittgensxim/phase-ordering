...
67:                                               ; preds = %72, %3
  %68 = phi double [ %103, %72 ], [ %29, %3 ]
  %69 = phi double [ %92, %72 ], [ %19, %3 ]
  %70 = phi i32 [ %104, %72 ], [ 0, %3 ]
  %71 = icmp samesign ult i32 %70, 8
  br i1 %71, label %72, label %105

72:                                               ; preds = %67
  %73 = getelementptr inbounds [72 x i8], ptr @kp, i64 %11
  %74 = zext nneg i32 %70 to i64
  %75 = getelementptr inbounds nuw [8 x i8], ptr %73, i64 %74
  %76 = load double, ptr %75, align 8
  %77 = fmul double %76, %66
  %78 = getelementptr inbounds [80 x i8], ptr @kq, i64 %11
  %79 = getelementptr inbounds nuw [8 x i8], ptr %78, i64 %74
  %80 = load double, ptr %79, align 8
  %81 = fmul double %80, %66
  %82 = getelementptr inbounds [72 x i8], ptr @ca, i64 %11
  %83 = getelementptr inbounds nuw [8 x i8], ptr %82, i64 %74
  %84 = load double, ptr %83, align 8
  %85 = call double @cos(double noundef %77) #4
  %86 = getelementptr inbounds [72 x i8], ptr @sa, i64 %11
  %87 = getelementptr inbounds nuw [8 x i8], ptr %86, i64 %74
  %88 = load double, ptr %87, align 8
  %89 = call double @sin(double noundef %77) #4
  %90 = fmul double %88, %89
  %91 = call double @llvm.fmuladd.f64(double %84, double %85, double %90)
  %92 = call double @llvm.fmuladd.f64(double %91, double f0x3E7AD7F29ABCAF48, double %69)
  %93 = getelementptr inbounds [80 x i8], ptr @cl, i64 %11
  %94 = getelementptr inbounds nuw [8 x i8], ptr %93, i64 %74
  %95 = load double, ptr %94, align 8
  %96 = call double @cos(double noundef %81) #4
  %97 = getelementptr inbounds [80 x i8], ptr @sl, i64 %11
  ...
  %103 = call double @llvm.fmuladd.f64(double %102, double f0x3E7AD7F29ABCAF48, double %68)
...
118:                                              ; preds = %122, %105
  %119 = phi double [ %139, %122 ], [ %68, %105 ]
  %120 = phi i32 [ %140, %122 ], [ 8, %105 ]
  %121 = icmp samesign ult i32 %120, 10
  br i1 %121, label %122, label %141

122:                                              ; preds = %118
  %123 = getelementptr inbounds [80 x i8], ptr @kq, i64 %11
  %124 = zext nneg i32 %120 to i64
  %125 = getelementptr inbounds nuw [8 x i8], ptr %123, i64 %124
  %126 = load double, ptr %125, align 8
  %127 = fmul double %126, %66
  %128 = getelementptr inbounds [80 x i8], ptr @cl, i64 %11
  %129 = getelementptr inbounds nuw [8 x i8], ptr %128, i64 %124
  %130 = load double, ptr %129, align 8
  %131 = call double @cos(double noundef %127) #4
  %132 = getelementptr inbounds [80 x i8], ptr @sl, i64 %11
  %133 = getelementptr inbounds nuw [8 x i8], ptr %132, i64 %124
  %134 = load double, ptr %133, align 8
  %135 = call double @sin(double noundef %127) #4
  %136 = fmul double %134, %135
  %137 = call double @llvm.fmuladd.f64(double %130, double %131, double %136)
  %138 = fmul double %10, %137
  %139 = call double @llvm.fmuladd.f64(double %138, double f0x3E7AD7F29ABCAF48, double %119)
  %140 = add nuw nsw i32 %120, 1
  br label %118, !llvm.loop !9

141:                                              ; preds = %118
  %142 = call double @fmod(double noundef %119, double noundef f0x401921FB54442D18) #4
...
146:                                              ; preds = %146, %141
  %147 = phi i32 [ 0, %141 ], [ %157, %146 ]
  %148 = phi double [ %145, %141 ], [ %156, %146 ]
  ...
  %158 = icmp samesign ugt i32 %147, 8
  %159 = call double @llvm.fabs.f64(double %155)
  %160 = fcmp olt double %159, f0x3D719799812DEA11
  %or.cond = select i1 %158, i1 true, i1 %160
  br i1 %or.cond, label %161, label %146

161:                                              ; preds = %146
  %162 = fmul double %116, %117
  %163 = call double @llvm.fmuladd.f64(double %112, double %113, double %162)
  %164 = fmul double %10, %163
  %165 = call double @llvm.fmuladd.f64(double %164, double f0x3E7AD7F29ABCAF48, double %69)
  ...
  %170 = fmul double %156, 5.000000e-01
  ...
  %180 = call double @cos(double noundef %156) #4
  %181 = call double @llvm.fmuladd.f64(double %153, double %180, double 1.000000e+00)
  ...
  %205 = call double @llvm.fmuladd.f64(double %153, double %37, double 1.000000e+00)
