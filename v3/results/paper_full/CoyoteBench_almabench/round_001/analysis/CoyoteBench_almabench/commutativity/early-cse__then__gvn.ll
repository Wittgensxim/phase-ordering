...
146:                                              ; preds = %253, %141
  %147 = phi i32 [ %157, %253 ], [ 0, %141 ]
  %148 = phi double [ %156, %253 ], [ %145, %141 ]
...
162:                                              ; preds = %159, %146
  ...
  %166 = call double @llvm.fmuladd.f64(double %165, double f0x3E7AD7F29ABCAF48, double %69)
  ...
  %171 = fmul double %156, 5.000000e-01
  ...
  %181 = call double @cos(double noundef %156) #4
  %182 = call double @llvm.fmuladd.f64(double %153, double %181, double 1.000000e+00)
  ...
  %206 = call double @llvm.fmuladd.f64(double %153, double %37, double 1.000000e+00)
