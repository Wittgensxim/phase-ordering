...
65:                                               ; preds = %3, %65
  %66 = phi double [ %19, %3 ], [ %86, %65 ]
  %67 = phi double [ %29, %3 ], [ %97, %65 ]
  %indvars.iv11 = phi i64 [ 0, %3 ], [ %indvars.iv.next, %65 ]
  %68 = getelementptr inbounds [72 x i8], ptr @kp, i64 %11
  %69 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 %indvars.iv11
  %70 = load double, ptr %69, align 8
  %71 = fmul double %70, %64
  %72 = getelementptr inbounds [80 x i8], ptr @kq, i64 %11
  %73 = getelementptr inbounds nuw [8 x i8], ptr %72, i64 %indvars.iv11
  %74 = load double, ptr %73, align 8
  %75 = fmul double %74, %64
  %76 = getelementptr inbounds [72 x i8], ptr @ca, i64 %11
  %77 = getelementptr inbounds nuw [8 x i8], ptr %76, i64 %indvars.iv11
  %78 = load double, ptr %77, align 8
  %79 = call double @cos(double noundef %71) #4
  %80 = getelementptr inbounds [72 x i8], ptr @sa, i64 %11
  %81 = getelementptr inbounds nuw [8 x i8], ptr %80, i64 %indvars.iv11
  ...
  %87 = getelementptr inbounds [80 x i8], ptr @cl, i64 %11
  %88 = getelementptr inbounds nuw [8 x i8], ptr %87, i64 %indvars.iv11
  %89 = load double, ptr %88, align 8
  %90 = call double @cos(double noundef %75) #4
  %91 = getelementptr inbounds [80 x i8], ptr @sl, i64 %11
  %92 = getelementptr inbounds nuw [8 x i8], ptr %91, i64 %indvars.iv11
  %93 = load double, ptr %92, align 8
  %94 = call double @sin(double noundef %75) #4
  %95 = fmul double %93, %94
  %96 = call double @llvm.fmuladd.f64(double %89, double %90, double %95)
  %97 = call double @llvm.fmuladd.f64(double %96, double f0x3E7AD7F29ABCAF48, double %67)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv11, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 8
  br i1 %exitcond, label %65, label %98, !llvm.loop !7

98:                                               ; preds = %65
  %.lcssa4 = phi double [ %97, %65 ]
  %.lcssa3 = phi double [ %86, %65 ]
  %99 = getelementptr inbounds [72 x i8], ptr @kp, i64 %11
  %100 = getelementptr inbounds nuw i8, ptr %99, i64 64
  %101 = load double, ptr %100, align 8
  %102 = fmul double %101, %64
  %103 = getelementptr inbounds [72 x i8], ptr @ca, i64 %11
  %104 = getelementptr inbounds nuw i8, ptr %103, i64 64
  %105 = load double, ptr %104, align 8
  %106 = call double @cos(double noundef %102) #4
  %107 = getelementptr inbounds [72 x i8], ptr @sa, i64 %11
...
111:                                              ; preds = %98, %111
  %112 = phi double [ %.lcssa4, %98 ], [ %128, %111 ]
  %indvars.iv612 = phi i64 [ 8, %98 ], [ %indvars.iv.next7, %111 ]
  %113 = getelementptr inbounds [80 x i8], ptr @kq, i64 %11
  %114 = getelementptr inbounds nuw [8 x i8], ptr %113, i64 %indvars.iv612
  %115 = load double, ptr %114, align 8
  %116 = fmul double %115, %64
  %117 = getelementptr inbounds [80 x i8], ptr @cl, i64 %11
  %118 = getelementptr inbounds nuw [8 x i8], ptr %117, i64 %indvars.iv612
  %119 = load double, ptr %118, align 8
  %120 = call double @cos(double noundef %116) #4
  %121 = getelementptr inbounds [80 x i8], ptr @sl, i64 %11
  %122 = getelementptr inbounds nuw [8 x i8], ptr %121, i64 %indvars.iv612
  %123 = load double, ptr %122, align 8
  %124 = call double @sin(double noundef %116) #4
  %125 = fmul double %123, %124
  %126 = call double @llvm.fmuladd.f64(double %119, double %120, double %125)
  %127 = fmul double %10, %126
  %128 = call double @llvm.fmuladd.f64(double %127, double f0x3E7AD7F29ABCAF48, double %112)
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv612, 1
  %exitcond9 = icmp ne i64 %indvars.iv.next7, 10
  br i1 %exitcond9, label %111, label %129, !llvm.loop !9

129:                                              ; preds = %111
  %.lcssa2 = phi double [ %128, %111 ]
  %130 = call double @llvm.fmuladd.f64(double %35, double %10, double %33)
  %131 = call double @llvm.fmuladd.f64(double %130, double %10, double %31)
  %132 = call double @fmod(double noundef %.lcssa2, double noundef f0x401921FB54442D18) #4
  %133 = fsub double %132, %46
  %134 = call double @sin(double noundef %133) #4
  %135 = call double @llvm.fmuladd.f64(double %131, double %134, double %133)
  %136 = fsub double %133, %135
  %137 = call double @sin(double noundef %135) #4
  %138 = call double @llvm.fmuladd.f64(double %131, double %137, double %136)
  %139 = call double @cos(double noundef %135) #4
  %140 = fneg double %131
  %141 = call double @llvm.fmuladd.f64(double %140, double %139, double 1.000000e+00)
...
144:                                              ; preds = %155
  %145 = phi i32 [ %156, %155 ]
  %146 = phi double [ %157, %155 ]
  %147 = fsub double %133, %146
  %148 = call double @sin(double noundef %146) #4
  %149 = call double @llvm.fmuladd.f64(double %131, double %148, double %147)
  %150 = call double @cos(double noundef %146) #4
  %151 = call double @llvm.fmuladd.f64(double %140, double %150, double 1.000000e+00)
  %152 = fdiv double %149, %151
  %153 = fadd double %146, %152
  %154 = add nuw nsw i32 %145, 1
  %exitcond10 = icmp eq i32 %145, 9
  br i1 %exitcond10, label %161, label %155

155:                                              ; preds = %129, %144
  %156 = phi i32 [ 1, %129 ], [ %154, %144 ]
  %157 = phi double [ %143, %129 ], [ %153, %144 ]
  %158 = phi double [ %142, %129 ], [ %152, %144 ]
  %159 = call double @llvm.fabs.f64(double %158)
  %160 = fcmp olt double %159, f0x3D719799812DEA11
  br i1 %160, label %161, label %144

161:                                              ; preds = %155, %144
  %.lcssa1 = phi double [ %140, %155 ], [ %140, %144 ]
  %.lcssa = phi double [ %157, %155 ], [ %153, %144 ]
  %162 = fmul double %109, %110
  %163 = call double @llvm.fmuladd.f64(double %105, double %106, double %162)
  %164 = fmul double %10, %163
  %165 = call double @llvm.fmuladd.f64(double %164, double f0x3E7AD7F29ABCAF48, double %.lcssa3)
  %166 = call double @llvm.fmuladd.f64(double %52, double %10, double %50)
  %167 = fmul double %166, %10
  %168 = call double @llvm.fmuladd.f64(double %48, double 3.600000e+03, double %167)
  %169 = fmul double %168, f0x3ED455A5B2FF8F9D
  %170 = fmul double %.lcssa, 5.000000e-01
  %171 = fadd double %131, 1.000000e+00
  %172 = fsub double 1.000000e+00, %131
  ...
  %181 = call double @llvm.fmuladd.f64(double %.lcssa1, double %180, double 1.000000e+00)
  ...
  %194 = call double @cos(double noundef %63) #4
  %195 = fmul double %193, %194
  %196 = call double @sin(double noundef %63) #4
  %197 = fmul double %193, %196
  %198 = fadd double %179, %46
  ...
  %205 = call double @llvm.fmuladd.f64(double %.lcssa1, double %131, double 1.000000e+00)
  %206 = call double @sqrt(double noundef %205) #4
  %207 = fdiv double %165, %206
  %208 = call double @cos(double noundef %192) #4
  %209 = call double @sin(double noundef %46) #4
  %210 = call double @llvm.fmuladd.f64(double %131, double %209, double %199)
  %211 = fmul double %210, %207
  %212 = call double @cos(double noundef %46) #4
  %213 = call double @llvm.fmuladd.f64(double %131, double %212, double %200)
  ...
  %247 = fmul double %244, f0xBFD9752E50F4B399
  %248 = call double @llvm.fmuladd.f64(double %239, double f0x3FED5C0357681EF3, double %247)
  %249 = getelementptr inbounds nuw i8, ptr %245, i64 32
  store double %248, ptr %249, align 8
  %250 = fmul double %244, f0x3FED5C0357681EF3
  %251 = call double @llvm.fmuladd.f64(double %239, double f0x3FD9752E50F4B399, double %250)
...
8:                                                ; preds = %10
  ...
  br i1 %exitcond, label %10, label %.loopexit, !llvm.loop !10
...
26:                                               ; preds = %22, %26
  %indvars.iv9 = phi i64 [ 0, %22 ], [ %indvars.iv.next, %26 ]
  %27 = trunc nuw nsw i64 %indvars.iv9 to i32
  call void @planetpv(ptr noundef nonnull %3, i32 noundef %27, ptr noundef nonnull %4)
  %28 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %indvars.iv9
  call void @radecdist(ptr noundef nonnull %4, ptr noundef nonnull %28)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv9, 1
  %exitcond2 = icmp ne i64 %indvars.iv.next, 8
  br i1 %exitcond2, label %26, label %29, !llvm.loop !11

29:                                               ; preds = %26
  %30 = add nuw nsw i32 %23, 1
  %exitcond3 = icmp ne i32 %30, 36525
  br i1 %exitcond3, label %22, label %31, !llvm.loop !12

31:                                               ; preds = %29
  %32 = add nuw nsw i32 %20, 1
  %exitcond4 = icmp ne i32 %32, 20
  br i1 %exitcond4, label %19, label %33, !llvm.loop !13

33:                                               ; preds = %31
  br label %34

34:                                               ; preds = %33, %34
  %indvars.iv510 = phi i64 [ 0, %33 ], [ %indvars.iv.next6, %34 ]
  %35 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %indvars.iv510
  ...
  br i1 %exitcond8, label %34, label %42, !llvm.loop !14
