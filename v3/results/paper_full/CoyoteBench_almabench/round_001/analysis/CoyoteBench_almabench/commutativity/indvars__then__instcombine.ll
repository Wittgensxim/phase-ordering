...
65:                                               ; preds = %68, %3
  ...
  br i1 %exitcond.not, label %99, label %68
...
112:                                              ; preds = %114, %99
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %114 ], [ 8, %99 ]
  %113 = phi double [ %130, %114 ], [ %66, %99 ]
  %exitcond9.not = icmp eq i64 %indvars.iv6, 10
  br i1 %exitcond9.not, label %131, label %114

114:                                              ; preds = %112
  %115 = getelementptr inbounds [80 x i8], ptr @kq, i64 %11
  %116 = getelementptr inbounds nuw [8 x i8], ptr %115, i64 %indvars.iv6
  %117 = load double, ptr %116, align 8
  %118 = fmul double %117, %64
  %119 = getelementptr inbounds [80 x i8], ptr @cl, i64 %11
  %120 = getelementptr inbounds nuw [8 x i8], ptr %119, i64 %indvars.iv6
  %121 = load double, ptr %120, align 8
  %122 = call double @cos(double noundef %118) #4
  %123 = getelementptr inbounds [80 x i8], ptr @sl, i64 %11
  %124 = getelementptr inbounds nuw [8 x i8], ptr %123, i64 %indvars.iv6
...
131:                                              ; preds = %112
  ...
  %134 = call double @fmod(double noundef %113, double noundef f0x401921FB54442D18) #4
...
153:                                              ; preds = %150, %138
  ...
  %157 = call double @llvm.fmuladd.f64(double %156, double f0x3E7AD7F29ABCAF48, double %67)
  ...
  %162 = fmul double %148, 5.000000e-01
  ...
  %172 = call double @cos(double noundef %148) #4
  %173 = call double @llvm.fmuladd.f64(double %145, double %172, double 1.000000e+00)
  ...
  %197 = call double @llvm.fmuladd.f64(double %145, double %133, double 1.000000e+00)
...
19:                                               ; preds = %34, %18
  ...
  %exitcond4.not = icmp eq i32 %20, 20
  br i1 %exitcond4.not, label %36, label %21
...
23:                                               ; preds = %32, %21
  ...
  br i1 %exitcond3.not, label %34, label %25
...
28:                                               ; preds = %29, %25
  ...
  br i1 %exitcond2.not, label %32, label %29
...
37:                                               ; preds = %38, %36
  ...
  br i1 %exitcond8.not, label %46, label %38
