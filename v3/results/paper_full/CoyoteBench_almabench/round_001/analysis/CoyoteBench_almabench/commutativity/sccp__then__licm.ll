...
162:                                              ; preds = %159, %147
  %.lcssa2 = phi double [ %146, %159 ], [ %146, %147 ]
  ...
  %166 = call double @llvm.fmuladd.f64(double %165, double f0x3E7AD7F29ABCAF48, double %.lcssa4)
  ...
  %182 = call double @llvm.fmuladd.f64(double %.lcssa2, double %181, double 1.000000e+00)
  ...
  %206 = call double @llvm.fmuladd.f64(double %.lcssa2, double %37, double 1.000000e+00)
