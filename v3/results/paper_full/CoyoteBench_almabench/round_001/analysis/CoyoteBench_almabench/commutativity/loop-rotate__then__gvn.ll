...
104:                                              ; preds = %67
  %105 = getelementptr inbounds nuw i8, ptr %71, i64 64
...
114:                                              ; preds = %104, %114
  ...
  %116 = phi double [ %101, %104 ], [ %130, %114 ]
  %117 = zext nneg i32 %115 to i64
  %118 = getelementptr inbounds nuw [8 x i8], ptr %76, i64 %117
  %119 = load double, ptr %118, align 8
  %120 = fmul double %119, %66
  %121 = getelementptr inbounds nuw [8 x i8], ptr %91, i64 %117
  %122 = load double, ptr %121, align 8
  %123 = call double @cos(double noundef %120) #4
  %124 = getelementptr inbounds nuw [8 x i8], ptr %95, i64 %117
...
133:                                              ; preds = %114
  %134 = call double @fmod(double noundef %130, double noundef f0x401921FB54442D18) #4
  ...
  %140 = call double @llvm.fmuladd.f64(double %37, double %139, double %138)
  %141 = call double @cos(double noundef %137) #4
  %142 = fneg double %37
  %143 = call double @llvm.fmuladd.f64(double %142, double %141, double 1.000000e+00)
  %144 = fdiv double %140, %143
  %145 = fadd double %137, %144
  br label %156

146:                                              ; preds = %156
  %147 = fsub double %135, %158
  %148 = call double @sin(double noundef %158) #4
  %149 = call double @llvm.fmuladd.f64(double %37, double %148, double %147)
  %150 = call double @cos(double noundef %158) #4
  %151 = call double @llvm.fmuladd.f64(double %142, double %150, double 1.000000e+00)
  %152 = fdiv double %149, %151
  %153 = fadd double %158, %152
  %154 = add nuw nsw i32 %157, 1
  %155 = icmp samesign ugt i32 %157, 8
  br i1 %155, label %162, label %156

156:                                              ; preds = %133, %146
  %157 = phi i32 [ 1, %133 ], [ %154, %146 ]
  %158 = phi double [ %145, %133 ], [ %153, %146 ]
  %159 = phi double [ %144, %133 ], [ %152, %146 ]
  %160 = call double @llvm.fabs.f64(double %159)
  %161 = fcmp olt double %160, f0x3D719799812DEA11
  br i1 %161, label %162, label %146

162:                                              ; preds = %156, %146
  %.lcssa = phi double [ %158, %156 ], [ %153, %146 ]
  %163 = fmul double %112, %113
  %164 = call double @llvm.fmuladd.f64(double %109, double %110, double %163)
  %165 = fmul double %10, %164
  %166 = call double @llvm.fmuladd.f64(double %165, double f0x3E7AD7F29ABCAF48, double %90)
  ...
  %182 = call double @llvm.fmuladd.f64(double %142, double %181, double 1.000000e+00)
  ...
  %206 = call double @llvm.fmuladd.f64(double %142, double %37, double 1.000000e+00)
...
32:                                               ; preds = %26
  ...
  %34 = icmp samesign ult i32 %33, 36525
  br i1 %34, label %22, label %35, !llvm.loop !12

35:                                               ; preds = %32
  %36 = add nuw nsw i32 %20, 1
  %37 = icmp samesign ult i32 %36, 20
