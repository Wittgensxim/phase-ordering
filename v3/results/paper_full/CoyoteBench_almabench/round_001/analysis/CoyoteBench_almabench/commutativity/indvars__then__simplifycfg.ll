...
138:                                              ; preds = %138, %131
  ...
  %or.cond = select i1 %exitcond10, i1 true, i1 %151
  br i1 %or.cond, label %152, label %138

152:                                              ; preds = %138
  %153 = fmul double %110, %111
  %154 = call double @llvm.fmuladd.f64(double %106, double %107, double %153)
  %155 = fmul double %10, %154
  %156 = call double @llvm.fmuladd.f64(double %155, double f0x3E7AD7F29ABCAF48, double %.lcssa3)
  %157 = call double @llvm.fmuladd.f64(double %52, double %10, double %50)
  %158 = fmul double %157, %10
  %159 = call double @llvm.fmuladd.f64(double %48, double 3.600000e+03, double %158)
  %160 = fmul double %159, f0x3ED455A5B2FF8F9D
  %161 = fmul double %148, 5.000000e-01
  %162 = fadd double %133, 1.000000e+00
  %163 = fsub double 1.000000e+00, %133
  ...
  %171 = call double @cos(double noundef %148) #4
  %172 = call double @llvm.fmuladd.f64(double %145, double %171, double 1.000000e+00)
  %173 = fmul double %156, %172
  %174 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  ...
  %185 = call double @cos(double noundef %63) #4
  %186 = fmul double %184, %185
  %187 = call double @sin(double noundef %63) #4
  %188 = fmul double %184, %187
  %189 = fadd double %170, %46
  ...
  %196 = call double @llvm.fmuladd.f64(double %145, double %133, double 1.000000e+00)
  %197 = call double @sqrt(double noundef %196) #4
  %198 = fdiv double %156, %197
  %199 = call double @cos(double noundef %183) #4
  %200 = call double @sin(double noundef %46) #4
  %201 = call double @llvm.fmuladd.f64(double %133, double %200, double %190)
  %202 = fmul double %201, %198
  %203 = call double @cos(double noundef %46) #4
  %204 = call double @llvm.fmuladd.f64(double %133, double %203, double %191)
  ...
  %238 = fmul double %235, f0xBFD9752E50F4B399
  %239 = call double @llvm.fmuladd.f64(double %230, double f0x3FED5C0357681EF3, double %238)
  %240 = getelementptr inbounds nuw i8, ptr %236, i64 32
  store double %239, ptr %240, align 8
  %241 = fmul double %235, f0x3FED5C0357681EF3
  %242 = call double @llvm.fmuladd.f64(double %230, double f0x3FD9752E50F4B399, double %241)
...
15:                                               ; preds = %30, %.loopexit
  %16 = phi i32 [ %31, %30 ], [ 0, %.loopexit ]
  %exitcond4 = icmp ne i32 %16, 20
  br i1 %exitcond4, label %17, label %32
...
19:                                               ; preds = %28, %17
  %20 = phi i32 [ %29, %28 ], [ 0, %17 ]
  %exitcond3 = icmp ne i32 %20, 36525
  br i1 %exitcond3, label %21, label %30
...
24:                                               ; preds = %25, %21
  ...
  br i1 %exitcond2, label %25, label %28
...
32:                                               ; preds = %15, %33
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %33 ], [ 0, %15 ]
  %exitcond8 = icmp ne i64 %indvars.iv5, 8
  br i1 %exitcond8, label %33, label %41
