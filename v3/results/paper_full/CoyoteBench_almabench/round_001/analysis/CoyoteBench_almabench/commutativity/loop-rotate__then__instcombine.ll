...
67:                                               ; preds = %3, %67
  ...
  %103 = icmp samesign ult i32 %68, 7
...
117:                                              ; preds = %104, %117
  ...
  %119 = phi double [ %101, %104 ], [ %136, %117 ]
  ...
  %138 = icmp samesign ult i32 %118, 9
  br i1 %138, label %117, label %139, !llvm.loop !9

139:                                              ; preds = %117
  %140 = call double @fmod(double noundef %136, double noundef f0x401921FB54442D18) #4
...
152:                                              ; preds = %162
  %153 = fsub double %141, %164
  %154 = call double @sin(double noundef %164) #4
  %155 = call double @llvm.fmuladd.f64(double %37, double %154, double %153)
  %156 = call double @cos(double noundef %164) #4
  %157 = call double @llvm.fmuladd.f64(double %148, double %156, double 1.000000e+00)
  %158 = fdiv double %155, %157
  %159 = fadd double %164, %158
  %160 = add nuw nsw i32 %163, 1
  %161 = icmp samesign ugt i32 %163, 8
  br i1 %161, label %168, label %162

162:                                              ; preds = %139, %152
  %163 = phi i32 [ 1, %139 ], [ %160, %152 ]
  %164 = phi double [ %151, %139 ], [ %159, %152 ]
  %165 = phi double [ %150, %139 ], [ %158, %152 ]
  %166 = call double @llvm.fabs.f64(double %165)
  %167 = fcmp olt double %166, f0x3D719799812DEA11
  br i1 %167, label %168, label %152

168:                                              ; preds = %162, %152
  %.lcssa = phi double [ %164, %162 ], [ %159, %152 ]
  %169 = fmul double %115, %116
  %170 = call double @llvm.fmuladd.f64(double %111, double %112, double %169)
  %171 = fmul double %10, %170
  %172 = call double @llvm.fmuladd.f64(double %171, double f0x3E7AD7F29ABCAF48, double %90)
  %173 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %174 = fmul double %173, %10
  %175 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %174)
  %176 = fmul double %175, f0x3ED455A5B2FF8F9D
  %177 = fmul double %.lcssa, 5.000000e-01
  %178 = fadd double %37, 1.000000e+00
  %179 = fsub double 1.000000e+00, %37
  %180 = fdiv double %178, %179
  %181 = call double @sqrt(double noundef %180) #4
  %182 = call double @sin(double noundef %177) #4
  %183 = fmul double %181, %182
  %184 = call double @cos(double noundef %177) #4
  %185 = call double @atan2(double noundef %183, double noundef %184) #4
  %186 = fmul double %185, 2.000000e+00
  %187 = call double @cos(double noundef %.lcssa) #4
  %188 = call double @llvm.fmuladd.f64(double %148, double %187, double 1.000000e+00)
  %189 = fmul double %172, %188
  %190 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  %191 = load double, ptr %190, align 8
  %192 = fdiv double 1.000000e+00, %191
  %193 = fadd double %192, 1.000000e+00
  %194 = fmul double %172, %172
  %195 = fmul double %194, %172
  %196 = fdiv double %193, %195
  %197 = call double @sqrt(double noundef %196) #4
  %198 = fmul double %197, f0x3F919D6D51A6B69A
  %199 = fmul double %176, 5.000000e-01
  %200 = call double @sin(double noundef %199) #4
  %201 = call double @cos(double noundef %65) #4
  %202 = fmul double %200, %201
  %203 = call double @sin(double noundef %65) #4
  %204 = fmul double %200, %203
  %205 = fadd double %186, %48
  %206 = call double @sin(double noundef %205) #4
  %207 = call double @cos(double noundef %205) #4
  %208 = fneg double %206
  %209 = fmul double %202, %208
  %210 = call double @llvm.fmuladd.f64(double %204, double %207, double %209)
  %211 = fmul double %210, 2.000000e+00
  %212 = call double @llvm.fmuladd.f64(double %148, double %37, double 1.000000e+00)
  %213 = call double @sqrt(double noundef %212) #4
  %214 = fdiv double %172, %213
  %215 = call double @cos(double noundef %199) #4
  %216 = call double @sin(double noundef %48) #4
  %217 = call double @llvm.fmuladd.f64(double %37, double %216, double %206)
  %218 = fmul double %217, %214
  %219 = call double @cos(double noundef %48) #4
  %220 = call double @llvm.fmuladd.f64(double %37, double %219, double %207)
  %221 = fmul double %220, %214
  %222 = fmul double %204, 2.000000e+00
  %223 = fmul double %222, %202
  %224 = fneg double %211
  %225 = call double @llvm.fmuladd.f64(double %224, double %204, double %207)
  %226 = fmul double %189, %225
  %227 = call double @llvm.fmuladd.f64(double %211, double %202, double %206)
  %228 = fmul double %189, %227
  %229 = fmul double %215, %224
  %230 = fmul double %189, %229
  store double %226, ptr %2, align 8
  %231 = fmul double %230, f0xBFD9752E50F4B399
  %232 = call double @llvm.fmuladd.f64(double %228, double f0x3FED5C0357681EF3, double %231)
  %233 = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double %232, ptr %233, align 8
  %234 = fmul double %230, f0x3FED5C0357681EF3
  %235 = call double @llvm.fmuladd.f64(double %228, double f0x3FD9752E50F4B399, double %234)
  %236 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store double %235, ptr %236, align 8
  %237 = call double @llvm.fmuladd.f64(double %222, double %204, double -1.000000e+00)
  %238 = fmul double %223, %221
  %239 = call double @llvm.fmuladd.f64(double %237, double %218, double %238)
  %240 = fmul double %198, %239
  %241 = fmul double %202, -2.000000e+00
  %242 = call double @llvm.fmuladd.f64(double %241, double %202, double 1.000000e+00)
  %243 = fneg double %218
  %244 = fmul double %223, %243
  %245 = call double @llvm.fmuladd.f64(double %242, double %221, double %244)
  %246 = fmul double %198, %245
  %247 = fmul double %215, 2.000000e+00
  %248 = fmul double %202, %221
  %249 = call double @llvm.fmuladd.f64(double %204, double %218, double %248)
  %250 = fmul double %247, %249
  %251 = fmul double %198, %250
  %252 = load ptr, ptr %4, align 8
  %253 = getelementptr inbounds nuw i8, ptr %252, i64 24
  store double %240, ptr %253, align 8
  %254 = fmul double %251, f0xBFD9752E50F4B399
  %255 = call double @llvm.fmuladd.f64(double %246, double f0x3FED5C0357681EF3, double %254)
  %256 = getelementptr inbounds nuw i8, ptr %252, i64 32
  store double %255, ptr %256, align 8
  %257 = fmul double %251, f0x3FED5C0357681EF3
  %258 = call double @llvm.fmuladd.f64(double %246, double f0x3FD9752E50F4B399, double %257)
...
26:                                               ; preds = %22, %26
  ...
  %29 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %28
  call void @radecdist(ptr noundef nonnull %4, ptr noundef nonnull %29)
  %30 = add nuw nsw i32 %27, 1
  %31 = icmp samesign ult i32 %27, 7
  br i1 %31, label %26, label %32, !llvm.loop !11

32:                                               ; preds = %26
  %33 = add nuw nsw i32 %23, 1
  %34 = icmp samesign ult i32 %23, 36524
  br i1 %34, label %22, label %35, !llvm.loop !12

35:                                               ; preds = %32
  %36 = add nuw nsw i32 %20, 1
  %37 = icmp samesign ult i32 %20, 19
  br i1 %37, label %19, label %38, !llvm.loop !13

38:                                               ; preds = %35
  br label %39

39:                                               ; preds = %38, %39
  %40 = phi i32 [ 0, %38 ], [ %49, %39 ]
  ...
  %50 = icmp samesign ult i32 %40, 7
  br i1 %50, label %39, label %51, !llvm.loop !14

51:                                               ; preds = %39
  %52 = call ptr @__acrt_iob_func(i32 noundef 1) #4
  %53 = call i32 @fflush(ptr noundef %52) #4
  ret i32 0
}
