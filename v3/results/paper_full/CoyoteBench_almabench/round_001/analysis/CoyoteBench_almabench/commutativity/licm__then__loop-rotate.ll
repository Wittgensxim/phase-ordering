...
104:                                              ; preds = %73
  ...
  %117 = getelementptr inbounds [80 x i8], ptr @kq, i64 %11
  %118 = getelementptr inbounds [80 x i8], ptr @cl, i64 %11
  %119 = getelementptr inbounds [80 x i8], ptr @sl, i64 %11
  br label %120

120:                                              ; preds = %104, %120
  %121 = phi i32 [ 8, %104 ], [ %137, %120 ]
  %122 = phi double [ %.lcssa4, %104 ], [ %136, %120 ]
  %123 = zext nneg i32 %121 to i64
  %124 = getelementptr inbounds nuw [8 x i8], ptr %117, i64 %123
  %125 = load double, ptr %124, align 8
  %126 = fmul double %125, %66
  %127 = getelementptr inbounds nuw [8 x i8], ptr %118, i64 %123
  %128 = load double, ptr %127, align 8
  %129 = call double @cos(double noundef %126) #4
  %130 = getelementptr inbounds nuw [8 x i8], ptr %119, i64 %123
  ...
  br i1 %138, label %120, label %139, !llvm.loop !9

139:                                              ; preds = %120
  %.lcssa2 = phi double [ %136, %120 ]
  ...
  %144 = fneg double %37
  %145 = fsub double %141, %143
  %146 = call double @sin(double noundef %143) #4
  %147 = call double @llvm.fmuladd.f64(double %37, double %146, double %145)
  %148 = call double @cos(double noundef %143) #4
  %149 = call double @llvm.fmuladd.f64(double %144, double %148, double 1.000000e+00)
...
152:                                              ; preds = %164
  ...
  %159 = call double @llvm.fmuladd.f64(double %144, double %158, double 1.000000e+00)
...
170:                                              ; preds = %164, %152
  %.lcssa1 = phi double [ %144, %164 ], [ %144, %152 ]
