...
170:                                              ; preds = %164, %152
  %.lcssa2 = phi double [ %148, %164 ], [ %148, %152 ]
  ...
  %174 = call double @llvm.fmuladd.f64(double %173, double f0x3E7AD7F29ABCAF48, double %.lcssa4)
  ...
  %190 = call double @llvm.fmuladd.f64(double %.lcssa2, double %189, double 1.000000e+00)
  ...
  %214 = call double @llvm.fmuladd.f64(double %.lcssa2, double %37, double 1.000000e+00)
