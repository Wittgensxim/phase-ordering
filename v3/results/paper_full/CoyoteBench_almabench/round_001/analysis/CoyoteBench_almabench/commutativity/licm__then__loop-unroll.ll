...
122:                                              ; preds = %121
  %123 = getelementptr inbounds nuw [8 x i8], ptr %118, i64 8
  %124 = load double, ptr %123, align 8
  %125 = fmul double %124, %66
  %126 = getelementptr inbounds nuw [8 x i8], ptr %119, i64 8
  %127 = load double, ptr %126, align 8
  %128 = call double @cos(double noundef %125) #4
  %129 = getelementptr inbounds nuw [8 x i8], ptr %120, i64 8
  %130 = load double, ptr %129, align 8
  %131 = call double @sin(double noundef %125) #4
  %132 = fmul double %130, %131
  %133 = call double @llvm.fmuladd.f64(double %127, double %128, double %132)
  %134 = fmul double %10, %133
  %135 = call double @llvm.fmuladd.f64(double %134, double f0x3E7AD7F29ABCAF48, double %.lcssa4)
  br label %136

136:                                              ; preds = %122
  %137 = getelementptr inbounds nuw [8 x i8], ptr %118, i64 9
  %138 = load double, ptr %137, align 8
  %139 = fmul double %138, %66
  %140 = getelementptr inbounds nuw [8 x i8], ptr %119, i64 9
  %141 = load double, ptr %140, align 8
  %142 = call double @cos(double noundef %139) #4
  %143 = getelementptr inbounds nuw [8 x i8], ptr %120, i64 9
  %144 = load double, ptr %143, align 8
  %145 = call double @sin(double noundef %139) #4
  %146 = fmul double %144, %145
  %147 = call double @llvm.fmuladd.f64(double %141, double %142, double %146)
  %148 = fmul double %10, %147
  %149 = call double @llvm.fmuladd.f64(double %148, double f0x3E7AD7F29ABCAF48, double %135)
  br i1 false, label %150, label %156

150:                                              ; preds = %136
  %151 = getelementptr inbounds nuw [8 x i8], ptr %118, i64 10
  %152 = load double, ptr %151, align 8
  %153 = fmul double %152, %66
  %154 = call double @cos(double noundef %153) #4
  %155 = call double @sin(double noundef %153) #4
  unreachable

156:                                              ; preds = %136
  %.lcssa2 = phi double [ %149, %136 ]
  %157 = call double @fmod(double noundef %.lcssa2, double noundef f0x401921FB54442D18) #4
  %158 = fsub double %157, %48
  %159 = call double @sin(double noundef %158) #4
  %160 = call double @llvm.fmuladd.f64(double %37, double %159, double %158)
  %161 = fneg double %37
  br label %162

162:                                              ; preds = %156
  %163 = fsub double %158, %160
  %164 = call double @sin(double noundef %160) #4
  %165 = call double @llvm.fmuladd.f64(double %37, double %164, double %163)
  %166 = call double @cos(double noundef %160) #4
  %167 = call double @llvm.fmuladd.f64(double %161, double %166, double 1.000000e+00)
  %168 = fdiv double %165, %167
  %169 = fadd double %160, %168
  br label %170

170:                                              ; preds = %162
  %171 = call double @llvm.fabs.f64(double %168)
  %172 = fcmp olt double %171, f0x3D719799812DEA11
  br i1 %172, label %173, label %265

173:                                              ; preds = %361, %353, %350, %339, %328, %317, %306, %295, %284, %273, %170
  %.lcssa1 = phi double [ %161, %170 ], [ %161, %361 ], [ %161, %353 ], [ %161, %273 ], [ %161, %350 ], [ %161, %284 ], [ %161, %317 ], [ %161, %295 ], [ %161, %339 ], [ %161, %306 ], [ %161, %328 ]
  %.lcssa = phi double [ %169, %170 ], [ %360, %361 ], [ %360, %353 ], [ %272, %273 ], [ %349, %350 ], [ %283, %284 ], [ %316, %317 ], [ %294, %295 ], [ %338, %339 ], [ %305, %306 ], [ %327, %328 ]
  %174 = fmul double %116, %117
  %175 = call double @llvm.fmuladd.f64(double %112, double %113, double %174)
  %176 = fmul double %10, %175
  %177 = call double @llvm.fmuladd.f64(double %176, double f0x3E7AD7F29ABCAF48, double %.lcssa3)
  %178 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %179 = fmul double %178, %10
  %180 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %179)
  %181 = fmul double %180, f0x3ED455A5B2FF8F9D
  %182 = fmul double %.lcssa, 5.000000e-01
  %183 = fadd double %37, 1.000000e+00
  %184 = fsub double 1.000000e+00, %37
  %185 = fdiv double %183, %184
  %186 = call double @sqrt(double noundef %185) #4
  %187 = call double @sin(double noundef %182) #4
  %188 = fmul double %186, %187
  %189 = call double @cos(double noundef %182) #4
  %190 = call double @atan2(double noundef %188, double noundef %189) #4
  %191 = fmul double %190, 2.000000e+00
  %192 = call double @cos(double noundef %.lcssa) #4
  %193 = call double @llvm.fmuladd.f64(double %.lcssa1, double %192, double 1.000000e+00)
  %194 = fmul double %177, %193
  %195 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  ...
  %203 = fmul double %202, f0x3F919D6D51A6B69A
  %204 = fmul double %181, 5.000000e-01
  %205 = call double @sin(double noundef %204) #4
  %206 = call double @cos(double noundef %65) #4
  %207 = fmul double %205, %206
  %208 = call double @sin(double noundef %65) #4
  %209 = fmul double %205, %208
  %210 = fadd double %191, %48
  %211 = call double @sin(double noundef %210) #4
  %212 = call double @cos(double noundef %210) #4
  %213 = fneg double %211
  %214 = fmul double %207, %213
  %215 = call double @llvm.fmuladd.f64(double %209, double %212, double %214)
  %216 = fmul double %215, 2.000000e+00
  %217 = call double @llvm.fmuladd.f64(double %.lcssa1, double %37, double 1.000000e+00)
  %218 = call double @sqrt(double noundef %217) #4
  %219 = fdiv double %177, %218
  %220 = call double @cos(double noundef %204) #4
  %221 = call double @sin(double noundef %48) #4
  %222 = call double @llvm.fmuladd.f64(double %37, double %221, double %211)
  %223 = fmul double %222, %219
  %224 = call double @cos(double noundef %48) #4
  %225 = call double @llvm.fmuladd.f64(double %37, double %224, double %212)
  %226 = fmul double %225, %219
  %227 = fmul double %209, 2.000000e+00
  %228 = fmul double %227, %207
  %229 = fneg double %216
  %230 = call double @llvm.fmuladd.f64(double %229, double %209, double %212)
  %231 = fmul double %194, %230
  %232 = call double @llvm.fmuladd.f64(double %216, double %207, double %211)
  %233 = fmul double %194, %232
  %234 = fmul double %220, %229
  %235 = fmul double %194, %234
  store double %231, ptr %2, align 8
  %236 = fmul double %235, f0xBFD9752E50F4B399
  %237 = call double @llvm.fmuladd.f64(double %233, double f0x3FED5C0357681EF3, double %236)
  %238 = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double %237, ptr %238, align 8
  %239 = fmul double %235, f0x3FED5C0357681EF3
  %240 = call double @llvm.fmuladd.f64(double %233, double f0x3FD9752E50F4B399, double %239)
  %241 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store double %240, ptr %241, align 8
  %242 = call double @llvm.fmuladd.f64(double %227, double %209, double -1.000000e+00)
  %243 = fmul double %228, %226
  %244 = call double @llvm.fmuladd.f64(double %242, double %223, double %243)
  %245 = fmul double %203, %244
  %246 = fmul double %207, -2.000000e+00
  %247 = call double @llvm.fmuladd.f64(double %246, double %207, double 1.000000e+00)
  %248 = fneg double %223
  %249 = fmul double %228, %248
  %250 = call double @llvm.fmuladd.f64(double %247, double %226, double %249)
  %251 = fmul double %203, %250
  %252 = fmul double %220, 2.000000e+00
  %253 = fmul double %207, %226
  %254 = call double @llvm.fmuladd.f64(double %209, double %223, double %253)
  %255 = fmul double %252, %254
  %256 = fmul double %203, %255
  %257 = load ptr, ptr %4, align 8
  %258 = getelementptr inbounds nuw i8, ptr %257, i64 24
  store double %245, ptr %258, align 8
  %259 = fmul double %256, f0xBFD9752E50F4B399
  %260 = call double @llvm.fmuladd.f64(double %251, double f0x3FED5C0357681EF3, double %259)
  %261 = getelementptr inbounds nuw i8, ptr %257, i64 32
  store double %260, ptr %261, align 8
  %262 = fmul double %256, f0x3FED5C0357681EF3
  %263 = call double @llvm.fmuladd.f64(double %251, double f0x3FD9752E50F4B399, double %262)
  %264 = getelementptr inbounds nuw i8, ptr %257, i64 40
  store double %263, ptr %264, align 8
  ret void

265:                                              ; preds = %170
  %266 = fsub double %158, %169
  %267 = call double @sin(double noundef %169) #4
  %268 = call double @llvm.fmuladd.f64(double %37, double %267, double %266)
  %269 = call double @cos(double noundef %169) #4
  %270 = call double @llvm.fmuladd.f64(double %161, double %269, double 1.000000e+00)
  %271 = fdiv double %268, %270
  %272 = fadd double %169, %271
  br label %273

273:                                              ; preds = %265
  %274 = call double @llvm.fabs.f64(double %271)
  %275 = fcmp olt double %274, f0x3D719799812DEA11
  br i1 %275, label %173, label %276

276:                                              ; preds = %273
  %277 = fsub double %158, %272
  %278 = call double @sin(double noundef %272) #4
  %279 = call double @llvm.fmuladd.f64(double %37, double %278, double %277)
  %280 = call double @cos(double noundef %272) #4
  %281 = call double @llvm.fmuladd.f64(double %161, double %280, double 1.000000e+00)
...
284:                                              ; preds = %276
  ...
  br i1 %286, label %173, label %287

287:                                              ; preds = %284
  %288 = fsub double %158, %283
  %289 = call double @sin(double noundef %283) #4
  %290 = call double @llvm.fmuladd.f64(double %37, double %289, double %288)
  %291 = call double @cos(double noundef %283) #4
  %292 = call double @llvm.fmuladd.f64(double %161, double %291, double 1.000000e+00)
...
295:                                              ; preds = %287
  ...
  br i1 %297, label %173, label %298

298:                                              ; preds = %295
  %299 = fsub double %158, %294
  %300 = call double @sin(double noundef %294) #4
  %301 = call double @llvm.fmuladd.f64(double %37, double %300, double %299)
  %302 = call double @cos(double noundef %294) #4
  %303 = call double @llvm.fmuladd.f64(double %161, double %302, double 1.000000e+00)
...
309:                                              ; preds = %306
  %310 = fsub double %158, %305
  %311 = call double @sin(double noundef %305) #4
  %312 = call double @llvm.fmuladd.f64(double %37, double %311, double %310)
  %313 = call double @cos(double noundef %305) #4
  %314 = call double @llvm.fmuladd.f64(double %161, double %313, double 1.000000e+00)
...
317:                                              ; preds = %309
  ...
  br i1 %319, label %173, label %320

320:                                              ; preds = %317
  %321 = fsub double %158, %316
  %322 = call double @sin(double noundef %316) #4
  %323 = call double @llvm.fmuladd.f64(double %37, double %322, double %321)
  %324 = call double @cos(double noundef %316) #4
  %325 = call double @llvm.fmuladd.f64(double %161, double %324, double 1.000000e+00)
...
328:                                              ; preds = %320
  ...
  br i1 %330, label %173, label %331

331:                                              ; preds = %328
  %332 = fsub double %158, %327
  %333 = call double @sin(double noundef %327) #4
  %334 = call double @llvm.fmuladd.f64(double %37, double %333, double %332)
  %335 = call double @cos(double noundef %327) #4
  %336 = call double @llvm.fmuladd.f64(double %161, double %335, double 1.000000e+00)
...
339:                                              ; preds = %331
  ...
  br i1 %341, label %173, label %342

342:                                              ; preds = %339
  %343 = fsub double %158, %338
  %344 = call double @sin(double noundef %338) #4
  %345 = call double @llvm.fmuladd.f64(double %37, double %344, double %343)
  %346 = call double @cos(double noundef %338) #4
  %347 = call double @llvm.fmuladd.f64(double %161, double %346, double 1.000000e+00)
...
350:                                              ; preds = %342
  ...
  br i1 %352, label %173, label %353

353:                                              ; preds = %350
  %354 = fsub double %158, %349
  %355 = call double @sin(double noundef %349) #4
  %356 = call double @llvm.fmuladd.f64(double %37, double %355, double %354)
  %357 = call double @cos(double noundef %349) #4
  %358 = call double @llvm.fmuladd.f64(double %161, double %357, double 1.000000e+00)
  %359 = fdiv double %356, %358
  %360 = fadd double %349, %359
  br i1 true, label %173, label %361

361:                                              ; preds = %353
  %362 = call double @llvm.fabs.f64(double %359)
  %363 = fcmp olt double %362, f0x3D719799812DEA11
  br i1 %363, label %173, label %364
