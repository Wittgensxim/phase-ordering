...
383:                                              ; preds = %383, %378
  %384 = phi i32 [ 0, %378 ], [ %394, %383 ]
  %385 = phi double [ %382, %378 ], [ %393, %383 ]
  %386 = fsub double %380, %385
  %387 = call double @sin(double noundef %385) #4
  %388 = call double @llvm.fmuladd.f64(double %37, double %387, double %386)
  %389 = call double @cos(double noundef %385) #4
  %390 = fneg double %37
  ...
  %395 = icmp samesign ugt i32 %384, 8
  %396 = call double @llvm.fabs.f64(double %392)
  %397 = fcmp olt double %396, f0x3D719799812DEA11
  %or.cond = select i1 %395, i1 true, i1 %397
  br i1 %or.cond, label %398, label %383

398:                                              ; preds = %383
  %.lcssa2 = phi double [ %390, %383 ]
  %.lcssa = phi double [ %393, %383 ]
  %399 = fmul double %334, %335
  %400 = call double @llvm.fmuladd.f64(double %330, double %331, double %399)
  %401 = fmul double %10, %400
  %402 = call double @llvm.fmuladd.f64(double %401, double f0x3E7AD7F29ABCAF48, double %.lcssa4)
  %403 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %404 = fmul double %403, %10
  %405 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %404)
  %406 = fmul double %405, f0x3ED455A5B2FF8F9D
  %407 = fmul double %.lcssa, 5.000000e-01
  %408 = fadd double %37, 1.000000e+00
  %409 = fsub double 1.000000e+00, %37
  %410 = fdiv double %408, %409
  %411 = call double @sqrt(double noundef %410) #4
  %412 = call double @sin(double noundef %407) #4
  %413 = fmul double %411, %412
  %414 = call double @cos(double noundef %407) #4
  %415 = call double @atan2(double noundef %413, double noundef %414) #4
  %416 = fmul double %415, 2.000000e+00
  %417 = call double @cos(double noundef %.lcssa) #4
  %418 = call double @llvm.fmuladd.f64(double %.lcssa2, double %417, double 1.000000e+00)
  %419 = fmul double %402, %418
  %420 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  %421 = load double, ptr %420, align 8
  %422 = fdiv double 1.000000e+00, %421
  %423 = fadd double %422, 1.000000e+00
  %424 = fmul double %402, %402
  %425 = fmul double %424, %402
  %426 = fdiv double %423, %425
  %427 = call double @sqrt(double noundef %426) #4
  %428 = fmul double %427, f0x3F919D6D51A6B69A
  %429 = fmul double %406, 5.000000e-01
  %430 = call double @sin(double noundef %429) #4
  %431 = call double @cos(double noundef %65) #4
  %432 = fmul double %430, %431
  %433 = call double @sin(double noundef %65) #4
  %434 = fmul double %430, %433
  %435 = fadd double %416, %48
  %436 = call double @sin(double noundef %435) #4
  %437 = call double @cos(double noundef %435) #4
  %438 = fneg double %436
  %439 = fmul double %432, %438
  %440 = call double @llvm.fmuladd.f64(double %434, double %437, double %439)
  %441 = fmul double %440, 2.000000e+00
  %442 = call double @llvm.fmuladd.f64(double %.lcssa2, double %37, double 1.000000e+00)
  %443 = call double @sqrt(double noundef %442) #4
  %444 = fdiv double %402, %443
  %445 = call double @cos(double noundef %429) #4
  %446 = call double @sin(double noundef %48) #4
  %447 = call double @llvm.fmuladd.f64(double %37, double %446, double %436)
  %448 = fmul double %447, %444
  %449 = call double @cos(double noundef %48) #4
  %450 = call double @llvm.fmuladd.f64(double %37, double %449, double %437)
  %451 = fmul double %450, %444
  %452 = fmul double %434, 2.000000e+00
  %453 = fmul double %452, %432
  %454 = fneg double %441
  %455 = call double @llvm.fmuladd.f64(double %454, double %434, double %437)
  %456 = fmul double %419, %455
  %457 = call double @llvm.fmuladd.f64(double %441, double %432, double %436)
  %458 = fmul double %419, %457
  %459 = fmul double %445, %454
  %460 = fmul double %419, %459
  store double %456, ptr %2, align 8
  %461 = fmul double %460, f0xBFD9752E50F4B399
  %462 = call double @llvm.fmuladd.f64(double %458, double f0x3FED5C0357681EF3, double %461)
  %463 = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double %462, ptr %463, align 8
  %464 = fmul double %460, f0x3FED5C0357681EF3
  %465 = call double @llvm.fmuladd.f64(double %458, double f0x3FD9752E50F4B399, double %464)
  %466 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store double %465, ptr %466, align 8
  %467 = call double @llvm.fmuladd.f64(double %452, double %434, double -1.000000e+00)
  %468 = fmul double %453, %451
  %469 = call double @llvm.fmuladd.f64(double %467, double %448, double %468)
  %470 = fmul double %428, %469
  %471 = fmul double %432, -2.000000e+00
  %472 = call double @llvm.fmuladd.f64(double %471, double %432, double 1.000000e+00)
  %473 = fneg double %448
  %474 = fmul double %453, %473
  %475 = call double @llvm.fmuladd.f64(double %472, double %451, double %474)
  %476 = fmul double %428, %475
  %477 = fmul double %445, 2.000000e+00
  %478 = fmul double %432, %451
  %479 = call double @llvm.fmuladd.f64(double %434, double %448, double %478)
  %480 = fmul double %477, %479
  %481 = fmul double %428, %480
  %482 = load ptr, ptr %4, align 8
  %483 = getelementptr inbounds nuw i8, ptr %482, i64 24
  store double %470, ptr %483, align 8
  %484 = fmul double %481, f0xBFD9752E50F4B399
  %485 = call double @llvm.fmuladd.f64(double %476, double f0x3FED5C0357681EF3, double %484)
  %486 = getelementptr inbounds nuw i8, ptr %482, i64 32
  store double %485, ptr %486, align 8
  %487 = fmul double %481, f0x3FED5C0357681EF3
  %488 = call double @llvm.fmuladd.f64(double %476, double f0x3FD9752E50F4B399, double %487)
...
106:                                              ; preds = %98
  ...
  br i1 false, label %114, label %122
