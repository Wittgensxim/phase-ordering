...
104:                                              ; preds = %67
  %.lcssa5 = phi double [ %101, %67 ]
  %.lcssa4 = phi double [ %90, %67 ]
...
117:                                              ; preds = %104, %117
  ...
  %119 = phi double [ %.lcssa5, %104 ], [ %136, %117 ]
...
139:                                              ; preds = %117
  %.lcssa3 = phi double [ %136, %117 ]
  %140 = call double @fmod(double noundef %.lcssa3, double noundef f0x401921FB54442D18) #4
...
144:                                              ; preds = %144, %139
  %145 = phi i32 [ 0, %139 ], [ %155, %144 ]
  %146 = phi double [ %143, %139 ], [ %154, %144 ]
  %147 = fsub double %141, %146
  %148 = call double @sin(double noundef %146) #4
  %149 = call double @llvm.fmuladd.f64(double %37, double %148, double %147)
  %150 = call double @cos(double noundef %146) #4
  %151 = fneg double %37
  %152 = call double @llvm.fmuladd.f64(double %151, double %150, double 1.000000e+00)
  %153 = fdiv double %149, %152
  %154 = fadd double %146, %153
  %155 = add nuw nsw i32 %145, 1
  %156 = icmp samesign ugt i32 %145, 8
  %157 = call double @llvm.fabs.f64(double %153)
  %158 = fcmp olt double %157, f0x3D719799812DEA11
  %or.cond = select i1 %156, i1 true, i1 %158
  br i1 %or.cond, label %159, label %144

159:                                              ; preds = %144
  %.lcssa2 = phi double [ %151, %144 ]
  %.lcssa = phi double [ %154, %144 ]
  %160 = fmul double %115, %116
  %161 = call double @llvm.fmuladd.f64(double %111, double %112, double %160)
  %162 = fmul double %10, %161
  %163 = call double @llvm.fmuladd.f64(double %162, double f0x3E7AD7F29ABCAF48, double %.lcssa4)
  %164 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %165 = fmul double %164, %10
  %166 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %165)
  %167 = fmul double %166, f0x3ED455A5B2FF8F9D
  %168 = fmul double %.lcssa, 5.000000e-01
  %169 = fadd double %37, 1.000000e+00
  %170 = fsub double 1.000000e+00, %37
  %171 = fdiv double %169, %170
  %172 = call double @sqrt(double noundef %171) #4
  %173 = call double @sin(double noundef %168) #4
  %174 = fmul double %172, %173
  %175 = call double @cos(double noundef %168) #4
  %176 = call double @atan2(double noundef %174, double noundef %175) #4
  %177 = fmul double %176, 2.000000e+00
  %178 = call double @cos(double noundef %.lcssa) #4
  %179 = call double @llvm.fmuladd.f64(double %.lcssa2, double %178, double 1.000000e+00)
  %180 = fmul double %163, %179
  %181 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  %182 = load double, ptr %181, align 8
  %183 = fdiv double 1.000000e+00, %182
  %184 = fadd double %183, 1.000000e+00
  %185 = fmul double %163, %163
  %186 = fmul double %185, %163
  %187 = fdiv double %184, %186
  %188 = call double @sqrt(double noundef %187) #4
  %189 = fmul double %188, f0x3F919D6D51A6B69A
  %190 = fmul double %167, 5.000000e-01
  %191 = call double @sin(double noundef %190) #4
  %192 = call double @cos(double noundef %65) #4
  %193 = fmul double %191, %192
  %194 = call double @sin(double noundef %65) #4
  %195 = fmul double %191, %194
  %196 = fadd double %177, %48
  %197 = call double @sin(double noundef %196) #4
  %198 = call double @cos(double noundef %196) #4
  %199 = fneg double %197
  %200 = fmul double %193, %199
  %201 = call double @llvm.fmuladd.f64(double %195, double %198, double %200)
  %202 = fmul double %201, 2.000000e+00
  %203 = call double @llvm.fmuladd.f64(double %.lcssa2, double %37, double 1.000000e+00)
  %204 = call double @sqrt(double noundef %203) #4
  %205 = fdiv double %163, %204
  %206 = call double @cos(double noundef %190) #4
  %207 = call double @sin(double noundef %48) #4
  %208 = call double @llvm.fmuladd.f64(double %37, double %207, double %197)
  %209 = fmul double %208, %205
  %210 = call double @cos(double noundef %48) #4
  %211 = call double @llvm.fmuladd.f64(double %37, double %210, double %198)
  %212 = fmul double %211, %205
  %213 = fmul double %195, 2.000000e+00
  %214 = fmul double %213, %193
  %215 = fneg double %202
  %216 = call double @llvm.fmuladd.f64(double %215, double %195, double %198)
  %217 = fmul double %180, %216
  %218 = call double @llvm.fmuladd.f64(double %202, double %193, double %197)
  %219 = fmul double %180, %218
  %220 = fmul double %206, %215
  %221 = fmul double %180, %220
  store double %217, ptr %2, align 8
  %222 = fmul double %221, f0xBFD9752E50F4B399
  %223 = call double @llvm.fmuladd.f64(double %219, double f0x3FED5C0357681EF3, double %222)
  %224 = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double %223, ptr %224, align 8
  %225 = fmul double %221, f0x3FED5C0357681EF3
  %226 = call double @llvm.fmuladd.f64(double %219, double f0x3FD9752E50F4B399, double %225)
  %227 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store double %226, ptr %227, align 8
  %228 = call double @llvm.fmuladd.f64(double %213, double %195, double -1.000000e+00)
  %229 = fmul double %214, %212
  %230 = call double @llvm.fmuladd.f64(double %228, double %209, double %229)
  %231 = fmul double %189, %230
  %232 = fmul double %193, -2.000000e+00
  %233 = call double @llvm.fmuladd.f64(double %232, double %193, double 1.000000e+00)
  %234 = fneg double %209
  %235 = fmul double %214, %234
  %236 = call double @llvm.fmuladd.f64(double %233, double %212, double %235)
  %237 = fmul double %189, %236
  %238 = fmul double %206, 2.000000e+00
  %239 = fmul double %193, %212
  %240 = call double @llvm.fmuladd.f64(double %195, double %209, double %239)
  %241 = fmul double %238, %240
  %242 = fmul double %189, %241
  %243 = load ptr, ptr %4, align 8
  %244 = getelementptr inbounds nuw i8, ptr %243, i64 24
  store double %231, ptr %244, align 8
  %245 = fmul double %242, f0xBFD9752E50F4B399
  %246 = call double @llvm.fmuladd.f64(double %237, double f0x3FED5C0357681EF3, double %245)
  %247 = getelementptr inbounds nuw i8, ptr %243, i64 32
  store double %246, ptr %247, align 8
  %248 = fmul double %242, f0x3FED5C0357681EF3
  %249 = call double @llvm.fmuladd.f64(double %237, double f0x3FD9752E50F4B399, double %248)
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  %6 = icmp sgt i32 %0, 1
  br i1 %6, label %.preheader1, label %16
...
11:                                               ; preds = %.preheader1, %8
  %12 = phi i32 [ 1, %.preheader1 ], [ %9, %8 ]
...
20:                                               ; preds = %17, %30
  ...
  %22 = load double, ptr %3, align 16
  %23 = fadd double %22, 1.000000e+00
  store double %23, ptr %3, align 16
  br label %24

24:                                               ; preds = %20, %24
  %25 = phi i32 [ 0, %20 ], [ %28, %24 ]
  call void @planetpv(ptr noundef nonnull %3, i32 noundef %25, ptr noundef nonnull %4)
  %26 = zext nneg i32 %25 to i64
  %27 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %26
  call void @radecdist(ptr noundef nonnull %4, ptr noundef nonnull %27)
  %28 = add nuw nsw i32 %25, 1
  %29 = icmp samesign ult i32 %28, 8
  br i1 %29, label %24, label %30, !llvm.loop !11

30:                                               ; preds = %24
  %31 = add nuw nsw i32 %21, 1
  %32 = icmp samesign ult i32 %31, 36525
  br i1 %32, label %20, label %33, !llvm.loop !12

33:                                               ; preds = %30
  %34 = add nuw nsw i32 %18, 1
  %35 = icmp samesign ult i32 %34, 20
  br i1 %35, label %17, label %.preheader, !llvm.loop !13

36:                                               ; preds = %.preheader, %36
  %37 = phi i32 [ 0, %.preheader ], [ %46, %36 ]
  %38 = zext nneg i32 %37 to i64
  %39 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %38
  ...
  br i1 %47, label %36, label %48, !llvm.loop !14

48:                                               ; preds = %36
  %49 = call ptr @__acrt_iob_func(i32 noundef 1) #4
  %50 = call i32 @fflush(ptr noundef %49) #4
  ret i32 0
}
