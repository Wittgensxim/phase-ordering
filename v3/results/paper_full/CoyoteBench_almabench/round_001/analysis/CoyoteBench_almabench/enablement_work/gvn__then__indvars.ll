...
138:                                              ; preds = %244, %131
  %139 = phi i32 [ %149, %244 ], [ 0, %131 ]
  %140 = phi double [ %148, %244 ], [ %137, %131 ]
...
153:                                              ; preds = %150, %138
  ...
  store double %225, ptr %237, align 8
  %238 = fmul double %236, f0xBFD9752E50F4B399
  %239 = call double @llvm.fmuladd.f64(double %231, double f0x3FED5C0357681EF3, double %238)
  %240 = getelementptr inbounds nuw i8, ptr %2, i64 32
  store double %239, ptr %240, align 8
  %241 = fmul double %236, f0x3FED5C0357681EF3
  %242 = call double @llvm.fmuladd.f64(double %231, double f0x3FD9752E50F4B399, double %241)
