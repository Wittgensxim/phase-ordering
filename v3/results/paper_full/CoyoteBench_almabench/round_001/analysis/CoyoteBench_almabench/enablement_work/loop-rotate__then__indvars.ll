...
65:                                               ; preds = %3, %65
  %indvars.iv = phi i64 [ 0, %3 ], [ %indvars.iv.next, %65 ]
...
144:                                              ; preds = %154
  %145 = phi double [ %156, %154 ]
  %146 = fsub double %133, %145
  %147 = call double @sin(double noundef %145) #4
  %148 = call double @llvm.fmuladd.f64(double %131, double %147, double %146)
  %149 = call double @cos(double noundef %145) #4
  %150 = call double @llvm.fmuladd.f64(double %140, double %149, double 1.000000e+00)
  %151 = fdiv double %148, %150
  %152 = fadd double %145, %151
  %153 = add nuw nsw i32 %155, 1
  %exitcond10 = icmp eq i32 %153, 10
  br i1 %exitcond10, label %160, label %154

154:                                              ; preds = %129, %144
  %155 = phi i32 [ 1, %129 ], [ %153, %144 ]
  %156 = phi double [ %143, %129 ], [ %152, %144 ]
  %157 = phi double [ %142, %129 ], [ %151, %144 ]
  %158 = call double @llvm.fabs.f64(double %157)
  %159 = fcmp olt double %158, f0x3D719799812DEA11
  br i1 %159, label %160, label %144

160:                                              ; preds = %154, %144
  %.lcssa1 = phi double [ %140, %154 ], [ %140, %144 ]
  %.lcssa = phi double [ %156, %154 ], [ %152, %144 ]
  %161 = fmul double %109, %110
  %162 = call double @llvm.fmuladd.f64(double %105, double %106, double %161)
  %163 = fmul double %10, %162
  %164 = call double @llvm.fmuladd.f64(double %163, double f0x3E7AD7F29ABCAF48, double %.lcssa3)
  %165 = call double @llvm.fmuladd.f64(double %52, double %10, double %50)
  %166 = fmul double %165, %10
  %167 = call double @llvm.fmuladd.f64(double %48, double 3.600000e+03, double %166)
  %168 = fmul double %167, f0x3ED455A5B2FF8F9D
  %169 = fmul double %.lcssa, 5.000000e-01
  %170 = fadd double %131, 1.000000e+00
  %171 = fsub double 1.000000e+00, %131
  ...
  %179 = call double @cos(double noundef %.lcssa) #4
  %180 = call double @llvm.fmuladd.f64(double %.lcssa1, double %179, double 1.000000e+00)
  %181 = fmul double %164, %180
  %182 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  ...
  %193 = call double @cos(double noundef %63) #4
  %194 = fmul double %192, %193
  %195 = call double @sin(double noundef %63) #4
  %196 = fmul double %192, %195
  %197 = fadd double %178, %46
  ...
  %204 = call double @llvm.fmuladd.f64(double %.lcssa1, double %131, double 1.000000e+00)
  %205 = call double @sqrt(double noundef %204) #4
  %206 = fdiv double %164, %205
  %207 = call double @cos(double noundef %191) #4
  %208 = call double @sin(double noundef %46) #4
  %209 = call double @llvm.fmuladd.f64(double %131, double %208, double %198)
  %210 = fmul double %209, %206
  %211 = call double @cos(double noundef %46) #4
  %212 = call double @llvm.fmuladd.f64(double %131, double %211, double %199)
  ...
  store double %232, ptr %245, align 8
  %246 = fmul double %243, f0xBFD9752E50F4B399
...
8:                                                ; preds = %9
  %exitcond = icmp ne i32 %14, %0
  br i1 %exitcond, label %9, label %.loopexit, !llvm.loop !10
...
25:                                               ; preds = %21, %25
  %indvars.iv = phi i64 [ 0, %21 ], [ %indvars.iv.next, %25 ]
  %26 = trunc nuw nsw i64 %indvars.iv to i32
  call void @planetpv(ptr noundef nonnull %3, i32 noundef %26, ptr noundef nonnull %4)
  %27 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %indvars.iv
  call void @radecdist(ptr noundef nonnull %4, ptr noundef nonnull %27)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond2 = icmp ne i64 %indvars.iv.next, 8
  br i1 %exitcond2, label %25, label %28, !llvm.loop !11

28:                                               ; preds = %25
  %29 = add nuw nsw i32 %22, 1
  %exitcond3 = icmp ne i32 %29, 36525
  br i1 %exitcond3, label %21, label %30, !llvm.loop !12

30:                                               ; preds = %28
  %31 = add nuw nsw i32 %19, 1
  %exitcond4 = icmp ne i32 %31, 20
  br i1 %exitcond4, label %18, label %32, !llvm.loop !13

32:                                               ; preds = %30
  br label %33

33:                                               ; preds = %32, %33
  %indvars.iv5 = phi i64 [ 0, %32 ], [ %indvars.iv.next6, %33 ]
  %34 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %indvars.iv5
  %35 = load double, ptr %34, align 8
  %36 = getelementptr inbounds nuw i8, ptr %34, i64 8
  %37 = load double, ptr %36, align 8
  %38 = getelementptr inbounds nuw i8, ptr %34, i64 16
  %39 = load double, ptr %38, align 8
  %40 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %35, double noundef %37, double noundef %39) #4
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %exitcond8 = icmp ne i64 %indvars.iv.next6, 8
  br i1 %exitcond8, label %33, label %41, !llvm.loop !14

41:                                               ; preds = %33
  %42 = call ptr @__acrt_iob_func(i32 noundef 1) #4
  %43 = call i32 @fflush(ptr noundef %42) #4
  ret i32 0
}
