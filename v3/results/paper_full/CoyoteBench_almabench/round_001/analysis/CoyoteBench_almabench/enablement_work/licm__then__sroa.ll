...
104:                                              ; preds = %72
  %.lcssa4 = phi double [ %73, %72 ]
  %.lcssa3 = phi double [ %74, %72 ]
  ...
  %117 = getelementptr inbounds [80 x i8], ptr @kq, i64 %10
  %118 = getelementptr inbounds [80 x i8], ptr @cl, i64 %10
  %119 = getelementptr inbounds [80 x i8], ptr @sl, i64 %10
  br label %120

120:                                              ; preds = %124, %104
  %121 = phi double [ %138, %124 ], [ %.lcssa4, %104 ]
  %122 = phi i32 [ %139, %124 ], [ 8, %104 ]
...
124:                                              ; preds = %120
  ...
  %129 = getelementptr inbounds nuw [8 x i8], ptr %118, i64 %125
  %130 = load double, ptr %129, align 8
  %131 = call double @cos(double noundef %128) #4
  %132 = getelementptr inbounds nuw [8 x i8], ptr %119, i64 %125
  ...
  %138 = call double @llvm.fmuladd.f64(double %137, double f0x3E7AD7F29ABCAF48, double %121)
  %139 = add nuw nsw i32 %122, 1
  br label %120, !llvm.loop !9

140:                                              ; preds = %120
  %.lcssa2 = phi double [ %121, %120 ]
  %141 = call double @fmod(double noundef %.lcssa2, double noundef f0x401921FB54442D18) #4
...
146:                                              ; preds = %252, %140
  %147 = phi i32 [ %156, %252 ], [ 0, %140 ]
  %148 = phi double [ %155, %252 ], [ %144, %140 ]
  ...
  %153 = call double @llvm.fmuladd.f64(double %145, double %152, double 1.000000e+00)
...
161:                                              ; preds = %158, %146
  %.lcssa1 = phi double [ %145, %158 ], [ %145, %146 ]
  %.lcssa = phi double [ %155, %158 ], [ %155, %146 ]
  ...
  %205 = call double @llvm.fmuladd.f64(double %.lcssa1, double %36, double 1.000000e+00)
