...
337:                                              ; preds = %336
  ...
  %353 = call double @llvm.fmuladd.f64(double %352, double f0x3E7AD7F29ABCAF48, double %.lcssa4)
  br label %354
...
395:                                              ; preds = %591, %582, %579, %567, %555, %543, %531, %519, %507, %495, %392
  %.lcssa1 = phi double [ %388, %392 ], [ %587, %591 ], [ %587, %582 ], [ %491, %495 ], [ %575, %579 ], [ %503, %507 ], [ %539, %543 ], [ %515, %519 ], [ %563, %567 ], [ %527, %531 ], [ %551, %555 ]
  %.lcssa = phi double [ %391, %392 ], [ %590, %591 ], [ %590, %582 ], [ %494, %495 ], [ %578, %579 ], [ %506, %507 ], [ %542, %543 ], [ %518, %519 ], [ %566, %567 ], [ %530, %531 ], [ %554, %555 ]
  ...
  %439 = call double @llvm.fmuladd.f64(double %.lcssa1, double %37, double 1.000000e+00)
  ...
  store double %467, ptr %479, align 8
  %480 = fmul double %478, f0xBFD9752E50F4B399
  %481 = call double @llvm.fmuladd.f64(double %473, double f0x3FED5C0357681EF3, double %480)
  %482 = getelementptr inbounds nuw i8, ptr %2, i64 32
  store double %481, ptr %482, align 8
  %483 = fmul double %478, f0x3FED5C0357681EF3
  %484 = call double @llvm.fmuladd.f64(double %473, double f0x3FD9752E50F4B399, double %483)
  %485 = getelementptr inbounds nuw i8, ptr %2, i64 40
  store double %484, ptr %485, align 8
  ret void

486:                                              ; preds = %392
  %487 = fsub double %380, %391
  %488 = call double @sin(double noundef %391) #4
  %489 = call double @llvm.fmuladd.f64(double %37, double %488, double %487)
  %490 = call double @cos(double noundef %391) #4
  %491 = fneg double %37
  %492 = call double @llvm.fmuladd.f64(double %491, double %490, double 1.000000e+00)
  %493 = fdiv double %489, %492
  %494 = fadd double %391, %493
  br label %495

495:                                              ; preds = %486
  %496 = call double @llvm.fabs.f64(double %493)
  %497 = fcmp olt double %496, f0x3D719799812DEA11
  br i1 %497, label %395, label %498

498:                                              ; preds = %495
  %499 = fsub double %380, %494
  %500 = call double @sin(double noundef %494) #4
  %501 = call double @llvm.fmuladd.f64(double %37, double %500, double %499)
  %502 = call double @cos(double noundef %494) #4
  %503 = fneg double %37
...
507:                                              ; preds = %498
  ...
  br i1 %509, label %395, label %510

510:                                              ; preds = %507
  %511 = fsub double %380, %506
  ...
  %515 = fneg double %37
  %516 = call double @llvm.fmuladd.f64(double %515, double %514, double 1.000000e+00)
  %517 = fdiv double %513, %516
  %518 = fadd double %506, %517
  br label %519

519:                                              ; preds = %510
  %520 = call double @llvm.fabs.f64(double %517)
  %521 = fcmp olt double %520, f0x3D719799812DEA11
  br i1 %521, label %395, label %522

522:                                              ; preds = %519
  %523 = fsub double %380, %518
  %524 = call double @sin(double noundef %518) #4
  %525 = call double @llvm.fmuladd.f64(double %37, double %524, double %523)
  %526 = call double @cos(double noundef %518) #4
  %527 = fneg double %37
  %528 = call double @llvm.fmuladd.f64(double %527, double %526, double 1.000000e+00)
  %529 = fdiv double %525, %528
  %530 = fadd double %518, %529
  br label %531

531:                                              ; preds = %522
  %532 = call double @llvm.fabs.f64(double %529)
  %533 = fcmp olt double %532, f0x3D719799812DEA11
  br i1 %533, label %395, label %534

534:                                              ; preds = %531
  %535 = fsub double %380, %530
  %536 = call double @sin(double noundef %530) #4
  %537 = call double @llvm.fmuladd.f64(double %37, double %536, double %535)
  %538 = call double @cos(double noundef %530) #4
  %539 = fneg double %37
  %540 = call double @llvm.fmuladd.f64(double %539, double %538, double 1.000000e+00)
  %541 = fdiv double %537, %540
  %542 = fadd double %530, %541
  br label %543

543:                                              ; preds = %534
  %544 = call double @llvm.fabs.f64(double %541)
  %545 = fcmp olt double %544, f0x3D719799812DEA11
  br i1 %545, label %395, label %546

546:                                              ; preds = %543
  %547 = fsub double %380, %542
  %548 = call double @sin(double noundef %542) #4
  %549 = call double @llvm.fmuladd.f64(double %37, double %548, double %547)
  %550 = call double @cos(double noundef %542) #4
  %551 = fneg double %37
  %552 = call double @llvm.fmuladd.f64(double %551, double %550, double 1.000000e+00)
  %553 = fdiv double %549, %552
  %554 = fadd double %542, %553
  br label %555

555:                                              ; preds = %546
  %556 = call double @llvm.fabs.f64(double %553)
  %557 = fcmp olt double %556, f0x3D719799812DEA11
  br i1 %557, label %395, label %558

558:                                              ; preds = %555
  %559 = fsub double %380, %554
  %560 = call double @sin(double noundef %554) #4
  %561 = call double @llvm.fmuladd.f64(double %37, double %560, double %559)
  %562 = call double @cos(double noundef %554) #4
  %563 = fneg double %37
  %564 = call double @llvm.fmuladd.f64(double %563, double %562, double 1.000000e+00)
  %565 = fdiv double %561, %564
  %566 = fadd double %554, %565
  br label %567

567:                                              ; preds = %558
  %568 = call double @llvm.fabs.f64(double %565)
  %569 = fcmp olt double %568, f0x3D719799812DEA11
  br i1 %569, label %395, label %570

570:                                              ; preds = %567
  %571 = fsub double %380, %566
  %572 = call double @sin(double noundef %566) #4
  %573 = call double @llvm.fmuladd.f64(double %37, double %572, double %571)
  %574 = call double @cos(double noundef %566) #4
  %575 = fneg double %37
  %576 = call double @llvm.fmuladd.f64(double %575, double %574, double 1.000000e+00)
  %577 = fdiv double %573, %576
  %578 = fadd double %566, %577
  br label %579

579:                                              ; preds = %570
  %580 = call double @llvm.fabs.f64(double %577)
  %581 = fcmp olt double %580, f0x3D719799812DEA11
  br i1 %581, label %395, label %582

582:                                              ; preds = %579
  %583 = fsub double %380, %578
  %584 = call double @sin(double noundef %578) #4
  %585 = call double @llvm.fmuladd.f64(double %37, double %584, double %583)
  %586 = call double @cos(double noundef %578) #4
  %587 = fneg double %37
  %588 = call double @llvm.fmuladd.f64(double %587, double %586, double 1.000000e+00)
  %589 = fdiv double %585, %588
  %590 = fadd double %578, %589
  br i1 true, label %395, label %591

591:                                              ; preds = %582
  %592 = call double @llvm.fabs.f64(double %589)
  %593 = fcmp olt double %592, f0x3D719799812DEA11
  br i1 %593, label %395, label %594
