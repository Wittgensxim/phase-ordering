...
115:                                              ; preds = %119, %105
  %116 = phi double [ %133, %119 ], [ %74, %105 ]
  %117 = phi i32 [ %134, %119 ], [ 8, %105 ]
  %118 = icmp samesign ult i32 %117, 10
  br i1 %118, label %119, label %135

119:                                              ; preds = %115
  %120 = zext nneg i32 %117 to i64
  %121 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 %120
  %122 = load double, ptr %121, align 8
  %123 = fmul double %122, %66
  %124 = getelementptr inbounds nuw [8 x i8], ptr %71, i64 %120
  %125 = load double, ptr %124, align 8
  %126 = call double @cos(double noundef %123) #4
  %127 = getelementptr inbounds nuw [8 x i8], ptr %72, i64 %120
  %128 = load double, ptr %127, align 8
  %129 = call double @sin(double noundef %123) #4
  %130 = fmul double %128, %129
  %131 = call double @llvm.fmuladd.f64(double %125, double %126, double %130)
  %132 = fmul double %10, %131
  %133 = call double @llvm.fmuladd.f64(double %132, double f0x3E7AD7F29ABCAF48, double %116)
  %134 = add nuw nsw i32 %117, 1
  br label %115, !llvm.loop !9

135:                                              ; preds = %115
  %136 = call double @fmod(double noundef %116, double noundef f0x401921FB54442D18) #4
  %137 = fsub double %136, %48
  %138 = call double @sin(double noundef %137) #4
  %139 = call double @llvm.fmuladd.f64(double %37, double %138, double %137)
  %140 = fneg double %37
  br label %141

141:                                              ; preds = %248, %135
  %142 = phi i32 [ %151, %248 ], [ 0, %135 ]
  %143 = phi double [ %150, %248 ], [ %139, %135 ]
  ...
  %148 = call double @llvm.fmuladd.f64(double %140, double %147, double 1.000000e+00)
  %149 = fdiv double %146, %148
  %150 = fadd double %143, %149
  %151 = add nuw nsw i32 %142, 1
  %152 = icmp samesign ugt i32 %142, 8
...
156:                                              ; preds = %153, %141
  %157 = fmul double %113, %114
  %158 = call double @llvm.fmuladd.f64(double %110, double %111, double %157)
  %159 = fmul double %10, %158
  %160 = call double @llvm.fmuladd.f64(double %159, double f0x3E7AD7F29ABCAF48, double %75)
  %161 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %162 = fmul double %161, %10
  %163 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %162)
  %164 = fmul double %163, f0x3ED455A5B2FF8F9D
  %165 = fmul double %150, 5.000000e-01
  %166 = fadd double %37, 1.000000e+00
  %167 = fsub double 1.000000e+00, %37
  ...
  %175 = call double @cos(double noundef %150) #4
  %176 = call double @llvm.fmuladd.f64(double %140, double %175, double 1.000000e+00)
  %177 = fmul double %160, %176
  %178 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  ...
  %189 = call double @cos(double noundef %65) #4
  %190 = fmul double %188, %189
  %191 = call double @sin(double noundef %65) #4
  %192 = fmul double %188, %191
  %193 = fadd double %174, %48
  ...
  %200 = call double @llvm.fmuladd.f64(double %140, double %37, double 1.000000e+00)
  %201 = call double @sqrt(double noundef %200) #4
  %202 = fdiv double %160, %201
  %203 = call double @cos(double noundef %187) #4
  %204 = call double @sin(double noundef %48) #4
  %205 = call double @llvm.fmuladd.f64(double %37, double %204, double %194)
  %206 = fmul double %205, %202
  %207 = call double @cos(double noundef %48) #4
  %208 = call double @llvm.fmuladd.f64(double %37, double %207, double %195)
  ...
  store double %228, ptr %241, align 8
  %242 = fmul double %239, f0xBFD9752E50F4B399
  ...
  %247 = getelementptr inbounds nuw i8, ptr %240, i64 40
