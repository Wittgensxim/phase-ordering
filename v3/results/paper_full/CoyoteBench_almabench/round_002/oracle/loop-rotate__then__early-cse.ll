...
146:                                              ; preds = %156
  ...
  %151 = call double @llvm.fmuladd.f64(double %138, double %150, double 1.000000e+00)
...
162:                                              ; preds = %156, %146
  ...
  %166 = call double @llvm.fmuladd.f64(double %165, double f0x3E7AD7F29ABCAF48, double %92)
  ...
  %182 = call double @llvm.fmuladd.f64(double %138, double %181, double 1.000000e+00)
  ...
  %206 = call double @llvm.fmuladd.f64(double %138, double %37, double 1.000000e+00)
