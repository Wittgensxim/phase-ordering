...
116:                                              ; preds = %115
  ...
  %129 = call double @llvm.fmuladd.f64(double %128, double f0x3E7AD7F29ABCAF48, double %74)
  br label %130
...
150:                                              ; preds = %130
  %151 = call double @fmod(double noundef %143, double noundef f0x401921FB54442D18) #4
...
167:                                              ; preds = %354, %346, %343, %332, %321, %310, %299, %288, %277, %266, %164
  ...
  %171 = call double @llvm.fmuladd.f64(double %170, double f0x3E7AD7F29ABCAF48, double %75)
