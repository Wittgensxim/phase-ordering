...
71:                                               ; preds = %3, %71
  %indvars.iv = phi i64 [ 0, %3 ], [ %indvars.iv.next, %71 ]
  %72 = phi double [ %19, %3 ], [ %88, %71 ]
  %73 = phi double [ %29, %3 ], [ %97, %71 ]
  %74 = getelementptr inbounds nuw [8 x i8], ptr %65, i64 %indvars.iv
  %75 = load double, ptr %74, align 8
  %76 = fmul double %75, %64
  %77 = getelementptr inbounds nuw [8 x i8], ptr %66, i64 %indvars.iv
  ...
  %83 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 %indvars.iv
  ...
  %92 = getelementptr inbounds nuw [8 x i8], ptr %70, i64 %indvars.iv
...
108:                                              ; preds = %98, %108
  %indvars.iv5 = phi i64 [ 8, %98 ], [ %indvars.iv.next6, %108 ]
  %109 = phi double [ %.lcssa3, %98 ], [ %122, %108 ]
  %110 = getelementptr inbounds nuw [8 x i8], ptr %66, i64 %indvars.iv5
  %111 = load double, ptr %110, align 8
  %112 = fmul double %111, %64
  %113 = getelementptr inbounds nuw [8 x i8], ptr %69, i64 %indvars.iv5
  %114 = load double, ptr %113, align 8
  %115 = call double @cos(double noundef %112) #4
  %116 = getelementptr inbounds nuw [8 x i8], ptr %70, i64 %indvars.iv5
...
138:                                              ; preds = %148
  ...
  %142 = call double @llvm.fmuladd.f64(double %125, double %141, double %140)
  %143 = call double @cos(double noundef %139) #4
  %144 = call double @llvm.fmuladd.f64(double %130, double %143, double 1.000000e+00)
  %145 = fdiv double %142, %144
  %146 = fadd double %139, %145
  %147 = add nuw nsw i32 %149, 1
  %exitcond9 = icmp eq i32 %147, 10
  br i1 %exitcond9, label %154, label %148

148:                                              ; preds = %123, %138
  %149 = phi i32 [ 1, %123 ], [ %147, %138 ]
  %150 = phi double [ %137, %123 ], [ %146, %138 ]
  %151 = phi double [ %136, %123 ], [ %145, %138 ]
  %152 = call double @llvm.fabs.f64(double %151)
  %153 = fcmp olt double %152, f0x3D719799812DEA11
  br i1 %153, label %154, label %138

154:                                              ; preds = %148, %138
  %.lcssa = phi double [ %150, %148 ], [ %146, %138 ]
  %155 = fmul double %106, %107
  %156 = call double @llvm.fmuladd.f64(double %103, double %104, double %155)
  %157 = fmul double %10, %156
  %158 = call double @llvm.fmuladd.f64(double %157, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %159 = call double @llvm.fmuladd.f64(double %52, double %10, double %50)
  %160 = fmul double %159, %10
  %161 = call double @llvm.fmuladd.f64(double %48, double 3.600000e+03, double %160)
  %162 = fmul double %161, f0x3ED455A5B2FF8F9D
  %163 = fmul double %.lcssa, 5.000000e-01
  %164 = fadd double %125, 1.000000e+00
  %165 = fsub double 1.000000e+00, %125
  ...
  %174 = call double @llvm.fmuladd.f64(double %130, double %173, double 1.000000e+00)
  %175 = fmul double %158, %174
  %176 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  ...
  %187 = call double @cos(double noundef %63) #4
  %188 = fmul double %186, %187
  %189 = call double @sin(double noundef %63) #4
  %190 = fmul double %186, %189
  %191 = fadd double %172, %46
  ...
  %198 = call double @llvm.fmuladd.f64(double %130, double %125, double 1.000000e+00)
  %199 = call double @sqrt(double noundef %198) #4
  %200 = fdiv double %158, %199
  %201 = call double @cos(double noundef %185) #4
  %202 = call double @sin(double noundef %46) #4
  %203 = call double @llvm.fmuladd.f64(double %125, double %202, double %192)
  %204 = fmul double %203, %200
  %205 = call double @cos(double noundef %46) #4
  %206 = call double @llvm.fmuladd.f64(double %125, double %205, double %193)
...
30:                                               ; preds = %28
  ...
  br i1 %exitcond4, label %19, label %32, !llvm.loop !13
