...
72:                                               ; preds = %3, %72
  ...
  %102 = icmp samesign ult i32 %73, 7
...
113:                                              ; preds = %103, %113
  ...
  %115 = phi double [ %100, %103 ], [ %129, %113 ]
  ...
  %131 = icmp samesign ult i32 %114, 9
  br i1 %131, label %113, label %132, !llvm.loop !9

132:                                              ; preds = %113
  %133 = call double @fmod(double noundef %129, double noundef f0x401921FB54442D18) #4
...
145:                                              ; preds = %155
  %146 = fsub double %134, %157
  %147 = call double @sin(double noundef %157) #4
  %148 = call double @llvm.fmuladd.f64(double %36, double %147, double %146)
  %149 = call double @cos(double noundef %157) #4
  %150 = call double @llvm.fmuladd.f64(double %137, double %149, double 1.000000e+00)
  %151 = fdiv double %148, %150
  %152 = fadd double %157, %151
  %153 = add nuw nsw i32 %156, 1
  %154 = icmp samesign ugt i32 %156, 8
  br i1 %154, label %161, label %155

155:                                              ; preds = %132, %145
  %156 = phi i32 [ 1, %132 ], [ %153, %145 ]
  %157 = phi double [ %144, %132 ], [ %152, %145 ]
  %158 = phi double [ %143, %132 ], [ %151, %145 ]
  %159 = call double @llvm.fabs.f64(double %158)
  %160 = fcmp olt double %159, f0x3D719799812DEA11
  br i1 %160, label %161, label %145

161:                                              ; preds = %155, %145
  %.lcssa = phi double [ %157, %155 ], [ %152, %145 ]
  %162 = fmul double %111, %112
  %163 = call double @llvm.fmuladd.f64(double %108, double %109, double %162)
  %164 = fmul double %9, %163
  %165 = call double @llvm.fmuladd.f64(double %164, double f0x3E7AD7F29ABCAF48, double %91)
  ...
  %181 = call double @llvm.fmuladd.f64(double %137, double %180, double 1.000000e+00)
  ...
  %205 = call double @llvm.fmuladd.f64(double %137, double %36, double 1.000000e+00)
...
35:                                               ; preds = %32
  ...
  %37 = icmp samesign ult i32 %21, 19
