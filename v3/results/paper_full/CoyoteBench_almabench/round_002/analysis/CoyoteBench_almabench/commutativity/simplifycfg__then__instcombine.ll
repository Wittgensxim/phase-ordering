...
140:                                              ; preds = %140, %134
  %141 = phi i32 [ 0, %134 ], [ %150, %140 ]
  %142 = phi double [ %138, %134 ], [ %149, %140 ]
  ...
  %152 = call double @llvm.fabs.f64(double %148)
  %153 = fcmp olt double %152, f0x3D719799812DEA11
  %or.cond = select i1 %151, i1 true, i1 %153
  br i1 %or.cond, label %154, label %140

154:                                              ; preds = %140
  %155 = fmul double %112, %113
  %156 = call double @llvm.fmuladd.f64(double %109, double %110, double %155)
  %157 = fmul double %9, %156
  %158 = call double @llvm.fmuladd.f64(double %157, double f0x3E7AD7F29ABCAF48, double %74)
  %159 = call double @llvm.fmuladd.f64(double %53, double %9, double %51)
  %160 = fmul double %159, %9
  %161 = call double @llvm.fmuladd.f64(double %49, double 3.600000e+03, double %160)
  %162 = fmul double %161, f0x3ED455A5B2FF8F9D
  %163 = fmul double %149, 5.000000e-01
  %164 = fadd double %36, 1.000000e+00
  ...
  %173 = call double @cos(double noundef %149) #4
  %174 = call double @llvm.fmuladd.f64(double %139, double %173, double 1.000000e+00)
  ...
  %187 = call double @cos(double noundef %64) #4
  %188 = fmul double %186, %187
  %189 = call double @sin(double noundef %64) #4
  ...
  %198 = call double @llvm.fmuladd.f64(double %139, double %36, double 1.000000e+00)
