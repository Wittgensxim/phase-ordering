...
116:                                              ; preds = %115
  ...
  %129 = call double @llvm.fmuladd.f64(double %128, double f0x3E7AD7F29ABCAF48, double %.lcssa4)
  br label %130
...
144:                                              ; preds = %130
  ...
  %147 = fmul double %146, %66
  %148 = call double @cos(double noundef %147) #4
  %149 = call double @sin(double noundef %147) #4
  unreachable

150:                                              ; preds = %130
  %.lcssa2 = phi double [ %143, %130 ]
  %151 = call double @fmod(double noundef %.lcssa2, double noundef f0x401921FB54442D18) #4
...
156:                                              ; preds = %156, %150
  %157 = phi i32 [ 0, %150 ], [ %166, %156 ]
  %158 = phi double [ %154, %150 ], [ %165, %156 ]
  %159 = fsub double %152, %158
  %160 = call double @sin(double noundef %158) #4
  %161 = call double @llvm.fmuladd.f64(double %37, double %160, double %159)
  %162 = call double @cos(double noundef %158) #4
  %163 = call double @llvm.fmuladd.f64(double %155, double %162, double 1.000000e+00)
  %164 = fdiv double %161, %163
  %165 = fadd double %158, %164
  %166 = add nuw nsw i32 %157, 1
  %167 = icmp samesign ugt i32 %157, 8
  %168 = call double @llvm.fabs.f64(double %164)
  %169 = fcmp olt double %168, f0x3D719799812DEA11
  %or.cond = select i1 %167, i1 true, i1 %169
  br i1 %or.cond, label %170, label %156

170:                                              ; preds = %156
  %.lcssa = phi double [ %165, %156 ]
  %171 = fmul double %113, %114
  %172 = call double @llvm.fmuladd.f64(double %110, double %111, double %171)
  ...
  %190 = call double @llvm.fmuladd.f64(double %155, double %189, double 1.000000e+00)
  ...
  %214 = call double @llvm.fmuladd.f64(double %155, double %37, double 1.000000e+00)
  ...
  store double %242, ptr %254, align 8
  %255 = fmul double %253, f0xBFD9752E50F4B399
  %256 = call double @llvm.fmuladd.f64(double %248, double f0x3FED5C0357681EF3, double %255)
  %257 = getelementptr inbounds nuw i8, ptr %2, i64 32
  store double %256, ptr %257, align 8
  %258 = fmul double %253, f0x3FED5C0357681EF3
  %259 = call double @llvm.fmuladd.f64(double %248, double f0x3FD9752E50F4B399, double %258)
...
18:                                               ; preds = %48, %.loopexit
  %19 = phi i32 [ %49, %48 ], [ 0, %.loopexit ]
