...
114:                                              ; preds = %118, %104
  %115 = phi double [ %132, %118 ], [ %.lcssa3, %104 ]
...
134:                                              ; preds = %114
  %.lcssa1 = phi double [ %115, %114 ]
  %135 = call double @fmod(double noundef %.lcssa1, double noundef f0x401921FB54442D18) #4
...
155:                                              ; preds = %152, %140
  %.lcssa = phi double [ %149, %152 ], [ %149, %140 ]
