...
104:                                              ; preds = %72
  %.lcssa3 = phi double [ %73, %72 ]
  %.lcssa2 = phi double [ %74, %72 ]
...
115:                                              ; preds = %114
  %116 = getelementptr inbounds nuw [8 x i8], ptr %67, i64 8
  ...
  %122 = getelementptr inbounds nuw [8 x i8], ptr %71, i64 8
...
129:                                              ; preds = %115
  %130 = getelementptr inbounds nuw [8 x i8], ptr %67, i64 9
  ...
  %136 = getelementptr inbounds nuw [8 x i8], ptr %71, i64 9
...
143:                                              ; preds = %129
  %144 = getelementptr inbounds nuw [8 x i8], ptr %67, i64 10
  %145 = load double, ptr %144, align 8
  %146 = fmul double %145, %65
...
166:                                              ; preds = %353, %345, %342, %331, %320, %309, %298, %287, %276, %265, %163
  ...
  %169 = fmul double %9, %168
  %170 = call double @llvm.fmuladd.f64(double %169, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %171 = call double @llvm.fmuladd.f64(double %53, double %9, double %51)
  %172 = fmul double %171, %9
  %173 = call double @llvm.fmuladd.f64(double %49, double 3.600000e+03, double %172)
  %174 = fmul double %173, f0x3ED455A5B2FF8F9D
  %175 = fmul double %.lcssa, 5.000000e-01
  %176 = fadd double %36, 1.000000e+00
  %177 = fsub double 1.000000e+00, %36
  ...
  %188 = getelementptr inbounds [8 x i8], ptr @amas, i64 %10
  ...
  %199 = call double @cos(double noundef %64) #4
  %200 = fmul double %198, %199
  %201 = call double @sin(double noundef %64) #4
  %202 = fmul double %198, %201
  %203 = fadd double %184, %47
  ...
  %210 = call double @llvm.fmuladd.f64(double %154, double %36, double 1.000000e+00)
  %211 = call double @sqrt(double noundef %210) #4
  %212 = fdiv double %170, %211
  %213 = call double @cos(double noundef %197) #4
  %214 = call double @sin(double noundef %47) #4
  %215 = call double @llvm.fmuladd.f64(double %36, double %214, double %204)
  %216 = fmul double %215, %212
  %217 = call double @cos(double noundef %47) #4
  %218 = call double @llvm.fmuladd.f64(double %36, double %217, double %205)
...
257:                                              ; preds = %163
  ...
  %260 = call double @llvm.fmuladd.f64(double %36, double %259, double %258)
...
268:                                              ; preds = %265
  ...
  %271 = call double @llvm.fmuladd.f64(double %36, double %270, double %269)
...
279:                                              ; preds = %276
  ...
  %282 = call double @llvm.fmuladd.f64(double %36, double %281, double %280)
...
290:                                              ; preds = %287
  ...
  %293 = call double @llvm.fmuladd.f64(double %36, double %292, double %291)
...
301:                                              ; preds = %298
  ...
  %304 = call double @llvm.fmuladd.f64(double %36, double %303, double %302)
...
312:                                              ; preds = %309
  ...
  %315 = call double @llvm.fmuladd.f64(double %36, double %314, double %313)
...
323:                                              ; preds = %320
  ...
  %326 = call double @llvm.fmuladd.f64(double %36, double %325, double %324)
...
334:                                              ; preds = %331
  ...
  %337 = call double @llvm.fmuladd.f64(double %36, double %336, double %335)
...
345:                                              ; preds = %342
  ...
  %348 = call double @llvm.fmuladd.f64(double %36, double %347, double %346)
