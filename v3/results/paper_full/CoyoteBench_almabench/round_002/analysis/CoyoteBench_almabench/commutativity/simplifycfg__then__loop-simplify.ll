...
141:                                              ; preds = %141, %135
  %142 = phi i32 [ 0, %135 ], [ %151, %141 ]
  %143 = phi double [ %139, %135 ], [ %150, %141 ]
  ...
  %153 = call double @llvm.fabs.f64(double %149)
  %154 = fcmp olt double %153, f0x3D719799812DEA11
  %or.cond = select i1 %152, i1 true, i1 %154
  br i1 %or.cond, label %155, label %141

155:                                              ; preds = %141
  %156 = fmul double %113, %114
  %157 = call double @llvm.fmuladd.f64(double %110, double %111, double %156)
  %158 = fmul double %10, %157
  %159 = call double @llvm.fmuladd.f64(double %158, double f0x3E7AD7F29ABCAF48, double %75)
  ...
  %164 = fmul double %150, 5.000000e-01
  ...
  %174 = call double @cos(double noundef %150) #4
  %175 = call double @llvm.fmuladd.f64(double %140, double %174, double 1.000000e+00)
  ...
  %199 = call double @llvm.fmuladd.f64(double %140, double %37, double 1.000000e+00)
...
12:                                               ; preds = %9
  ...
  br i1 %.not, label %.loopexit.loopexit, label %15
...
18:                                               ; preds = %37, %.loopexit
  %19 = phi i32 [ %38, %37 ], [ 0, %.loopexit ]
