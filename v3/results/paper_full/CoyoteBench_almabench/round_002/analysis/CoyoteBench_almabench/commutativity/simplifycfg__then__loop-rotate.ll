...
104:                                              ; preds = %73
  %.lcssa4 = phi double [ %101, %73 ]
  %.lcssa3 = phi double [ %92, %73 ]
...
114:                                              ; preds = %104, %114
  ...
  %116 = phi double [ %.lcssa4, %104 ], [ %130, %114 ]
...
139:                                              ; preds = %139, %133
  %140 = phi i32 [ 0, %133 ], [ %149, %139 ]
  %141 = phi double [ %137, %133 ], [ %148, %139 ]
  ...
  %150 = icmp samesign ugt i32 %140, 8
  %151 = call double @llvm.fabs.f64(double %147)
  %152 = fcmp olt double %151, f0x3D719799812DEA11
  %or.cond = select i1 %150, i1 true, i1 %152
  br i1 %or.cond, label %153, label %139

153:                                              ; preds = %139
  %.lcssa = phi double [ %148, %139 ]
  %154 = fmul double %112, %113
  %155 = call double @llvm.fmuladd.f64(double %109, double %110, double %154)
  %156 = fmul double %10, %155
  %157 = call double @llvm.fmuladd.f64(double %156, double f0x3E7AD7F29ABCAF48, double %.lcssa3)
  %158 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %159 = fmul double %158, %10
  %160 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %159)
  %161 = fmul double %160, f0x3ED455A5B2FF8F9D
  %162 = fmul double %.lcssa, 5.000000e-01
  %163 = fadd double %37, 1.000000e+00
  %164 = fsub double 1.000000e+00, %37
  ...
  %173 = call double @llvm.fmuladd.f64(double %138, double %172, double 1.000000e+00)
  ...
  %186 = call double @cos(double noundef %65) #4
  %187 = fmul double %185, %186
  %188 = call double @sin(double noundef %65) #4
  %189 = fmul double %185, %188
  %190 = fadd double %171, %48
  ...
  %197 = call double @llvm.fmuladd.f64(double %138, double %37, double 1.000000e+00)
  %198 = call double @sqrt(double noundef %197) #4
  %199 = fdiv double %157, %198
  %200 = call double @cos(double noundef %184) #4
  %201 = call double @sin(double noundef %48) #4
  %202 = call double @llvm.fmuladd.f64(double %37, double %201, double %191)
  %203 = fmul double %202, %199
  %204 = call double @cos(double noundef %48) #4
  %205 = call double @llvm.fmuladd.f64(double %37, double %204, double %192)
...
9:                                                ; preds = %12
  ...
  br i1 %11, label %12, label %.loopexit.loopexit, !llvm.loop !10
...
18:                                               ; preds = %.loopexit, %33
  %19 = phi i32 [ 0, %.loopexit ], [ %34, %33 ]
...
33:                                               ; preds = %30
  ...
  br i1 %35, label %18, label %.preheader, !llvm.loop !13
