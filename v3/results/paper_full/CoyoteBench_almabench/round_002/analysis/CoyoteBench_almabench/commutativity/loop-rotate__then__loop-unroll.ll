...
114:                                              ; preds = %104
  %115 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 8
  %116 = load double, ptr %115, align 8
  %117 = fmul double %116, %66
  %118 = getelementptr inbounds nuw [8 x i8], ptr %71, i64 8
  %119 = load double, ptr %118, align 8
  %120 = call double @cos(double noundef %117) #4
  %121 = getelementptr inbounds nuw [8 x i8], ptr %72, i64 8
  %122 = load double, ptr %121, align 8
  %123 = call double @sin(double noundef %117) #4
  %124 = fmul double %122, %123
  %125 = call double @llvm.fmuladd.f64(double %119, double %120, double %124)
  %126 = fmul double %10, %125
  %127 = call double @llvm.fmuladd.f64(double %126, double f0x3E7AD7F29ABCAF48, double %.lcssa3)
  %128 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 9
  %129 = load double, ptr %128, align 8
  %130 = fmul double %129, %66
  %131 = getelementptr inbounds nuw [8 x i8], ptr %71, i64 9
  %132 = load double, ptr %131, align 8
  %133 = call double @cos(double noundef %130) #4
  %134 = getelementptr inbounds nuw [8 x i8], ptr %72, i64 9
  %135 = load double, ptr %134, align 8
  %136 = call double @sin(double noundef %130) #4
  %137 = fmul double %135, %136
  %138 = call double @llvm.fmuladd.f64(double %132, double %133, double %137)
  %139 = fmul double %10, %138
  %140 = call double @llvm.fmuladd.f64(double %139, double f0x3E7AD7F29ABCAF48, double %127)
  %141 = call double @fmod(double noundef %140, double noundef f0x401921FB54442D18) #4
  %142 = fsub double %141, %48
  %143 = call double @sin(double noundef %142) #4
  %144 = call double @llvm.fmuladd.f64(double %37, double %143, double %142)
  %145 = fneg double %37
  %146 = fsub double %142, %144
  %147 = call double @sin(double noundef %144) #4
...
153:                                              ; preds = %241
  %154 = fsub double %142, %152
  %155 = call double @sin(double noundef %152) #4
  %156 = call double @llvm.fmuladd.f64(double %37, double %155, double %154)
  %157 = call double @cos(double noundef %152) #4
  %158 = call double @llvm.fmuladd.f64(double %145, double %157, double 1.000000e+00)
  %159 = fdiv double %156, %158
  %160 = fadd double %152, %159
  %161 = call double @llvm.fabs.f64(double %159)
  %162 = fcmp olt double %161, f0x3D719799812DEA11
  br i1 %162, label %244, label %163

163:                                              ; preds = %153
  %164 = fsub double %142, %160
  %165 = call double @sin(double noundef %160) #4
  %166 = call double @llvm.fmuladd.f64(double %37, double %165, double %164)
  %167 = call double @cos(double noundef %160) #4
  %168 = call double @llvm.fmuladd.f64(double %145, double %167, double 1.000000e+00)
...
173:                                              ; preds = %163
  %174 = fsub double %142, %170
  %175 = call double @sin(double noundef %170) #4
  %176 = call double @llvm.fmuladd.f64(double %37, double %175, double %174)
  %177 = call double @cos(double noundef %170) #4
  %178 = call double @llvm.fmuladd.f64(double %145, double %177, double 1.000000e+00)
  %179 = fdiv double %176, %178
  %180 = fadd double %170, %179
  %181 = call double @llvm.fabs.f64(double %179)
  %182 = fcmp olt double %181, f0x3D719799812DEA11
  br i1 %182, label %244, label %183

183:                                              ; preds = %173
  %184 = fsub double %142, %180
  %185 = call double @sin(double noundef %180) #4
  %186 = call double @llvm.fmuladd.f64(double %37, double %185, double %184)
  %187 = call double @cos(double noundef %180) #4
  %188 = call double @llvm.fmuladd.f64(double %145, double %187, double 1.000000e+00)
  %189 = fdiv double %186, %188
  %190 = fadd double %180, %189
  %191 = call double @llvm.fabs.f64(double %189)
  %192 = fcmp olt double %191, f0x3D719799812DEA11
  br i1 %192, label %244, label %193

193:                                              ; preds = %183
  %194 = fsub double %142, %190
  %195 = call double @sin(double noundef %190) #4
  %196 = call double @llvm.fmuladd.f64(double %37, double %195, double %194)
  %197 = call double @cos(double noundef %190) #4
  %198 = call double @llvm.fmuladd.f64(double %145, double %197, double 1.000000e+00)
  %199 = fdiv double %196, %198
  %200 = fadd double %190, %199
  %201 = call double @llvm.fabs.f64(double %199)
  %202 = fcmp olt double %201, f0x3D719799812DEA11
  br i1 %202, label %244, label %203

203:                                              ; preds = %193
  %204 = fsub double %142, %200
  %205 = call double @sin(double noundef %200) #4
  %206 = call double @llvm.fmuladd.f64(double %37, double %205, double %204)
  %207 = call double @cos(double noundef %200) #4
  %208 = call double @llvm.fmuladd.f64(double %145, double %207, double 1.000000e+00)
  %209 = fdiv double %206, %208
  %210 = fadd double %200, %209
  %211 = call double @llvm.fabs.f64(double %209)
  %212 = fcmp olt double %211, f0x3D719799812DEA11
  br i1 %212, label %244, label %213

213:                                              ; preds = %203
  %214 = fsub double %142, %210
  %215 = call double @sin(double noundef %210) #4
  %216 = call double @llvm.fmuladd.f64(double %37, double %215, double %214)
  %217 = call double @cos(double noundef %210) #4
  %218 = call double @llvm.fmuladd.f64(double %145, double %217, double 1.000000e+00)
  %219 = fdiv double %216, %218
  %220 = fadd double %210, %219
  %221 = call double @llvm.fabs.f64(double %219)
  %222 = fcmp olt double %221, f0x3D719799812DEA11
  br i1 %222, label %244, label %223

223:                                              ; preds = %213
  %224 = fsub double %142, %220
  %225 = call double @sin(double noundef %220) #4
  %226 = call double @llvm.fmuladd.f64(double %37, double %225, double %224)
  %227 = call double @cos(double noundef %220) #4
  %228 = call double @llvm.fmuladd.f64(double %145, double %227, double 1.000000e+00)
  %229 = fdiv double %226, %228
  %230 = fadd double %220, %229
  %231 = call double @llvm.fabs.f64(double %229)
  %232 = fcmp olt double %231, f0x3D719799812DEA11
  br i1 %232, label %244, label %233

233:                                              ; preds = %223
  %234 = fsub double %142, %230
  %235 = call double @sin(double noundef %230) #4
  %236 = call double @llvm.fmuladd.f64(double %37, double %235, double %234)
  %237 = call double @cos(double noundef %230) #4
  %238 = call double @llvm.fmuladd.f64(double %145, double %237, double 1.000000e+00)
  %239 = fdiv double %236, %238
  %240 = fadd double %230, %239
  br label %244

241:                                              ; preds = %114
  %242 = call double @llvm.fabs.f64(double %151)
  %243 = fcmp olt double %242, f0x3D719799812DEA11
  br i1 %243, label %244, label %153

244:                                              ; preds = %233, %223, %213, %203, %193, %183, %173, %163, %153, %241
  %.lcssa = phi double [ %152, %241 ], [ %240, %233 ], [ %160, %153 ], [ %230, %223 ], [ %170, %163 ], [ %200, %193 ], [ %180, %173 ], [ %220, %213 ], [ %190, %183 ], [ %210, %203 ]
  %245 = fmul double %112, %113
  %246 = call double @llvm.fmuladd.f64(double %109, double %110, double %245)
  %247 = fmul double %10, %246
  %248 = call double @llvm.fmuladd.f64(double %247, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %249 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %250 = fmul double %249, %10
  %251 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %250)
  %252 = fmul double %251, f0x3ED455A5B2FF8F9D
  %253 = fmul double %.lcssa, 5.000000e-01
  %254 = fadd double %37, 1.000000e+00
  %255 = fsub double 1.000000e+00, %37
  %256 = fdiv double %254, %255
  %257 = call double @sqrt(double noundef %256) #4
  %258 = call double @sin(double noundef %253) #4
  %259 = fmul double %257, %258
  %260 = call double @cos(double noundef %253) #4
  %261 = call double @atan2(double noundef %259, double noundef %260) #4
  %262 = fmul double %261, 2.000000e+00
  %263 = call double @cos(double noundef %.lcssa) #4
  %264 = call double @llvm.fmuladd.f64(double %145, double %263, double 1.000000e+00)
  %265 = fmul double %248, %264
  %266 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  %267 = load double, ptr %266, align 8
  %268 = fdiv double 1.000000e+00, %267
  %269 = fadd double %268, 1.000000e+00
  %270 = fmul double %248, %248
  %271 = fmul double %270, %248
  %272 = fdiv double %269, %271
  %273 = call double @sqrt(double noundef %272) #4
  %274 = fmul double %273, f0x3F919D6D51A6B69A
  %275 = fmul double %252, 5.000000e-01
  %276 = call double @sin(double noundef %275) #4
  %277 = call double @cos(double noundef %65) #4
  %278 = fmul double %276, %277
  %279 = call double @sin(double noundef %65) #4
  %280 = fmul double %276, %279
  %281 = fadd double %262, %48
  %282 = call double @sin(double noundef %281) #4
  %283 = call double @cos(double noundef %281) #4
  %284 = fneg double %282
  %285 = fmul double %278, %284
  %286 = call double @llvm.fmuladd.f64(double %280, double %283, double %285)
  %287 = fmul double %286, 2.000000e+00
  %288 = call double @llvm.fmuladd.f64(double %145, double %37, double 1.000000e+00)
  %289 = call double @sqrt(double noundef %288) #4
  %290 = fdiv double %248, %289
  %291 = call double @cos(double noundef %275) #4
  %292 = call double @sin(double noundef %48) #4
  %293 = call double @llvm.fmuladd.f64(double %37, double %292, double %282)
  %294 = fmul double %293, %290
  %295 = call double @cos(double noundef %48) #4
  %296 = call double @llvm.fmuladd.f64(double %37, double %295, double %283)
  %297 = fmul double %296, %290
  %298 = fmul double %280, 2.000000e+00
  %299 = fmul double %298, %278
  %300 = fneg double %287
  %301 = call double @llvm.fmuladd.f64(double %300, double %280, double %283)
  %302 = fmul double %265, %301
  %303 = call double @llvm.fmuladd.f64(double %287, double %278, double %282)
  %304 = fmul double %265, %303
  %305 = fmul double %291, %300
  %306 = fmul double %265, %305
  store double %302, ptr %2, align 8
  %307 = fmul double %306, f0xBFD9752E50F4B399
  %308 = call double @llvm.fmuladd.f64(double %304, double f0x3FED5C0357681EF3, double %307)
  %309 = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double %308, ptr %309, align 8
  %310 = fmul double %306, f0x3FED5C0357681EF3
  %311 = call double @llvm.fmuladd.f64(double %304, double f0x3FD9752E50F4B399, double %310)
  %312 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store double %311, ptr %312, align 8
  %313 = call double @llvm.fmuladd.f64(double %298, double %280, double -1.000000e+00)
  %314 = fmul double %299, %297
  %315 = call double @llvm.fmuladd.f64(double %313, double %294, double %314)
  %316 = fmul double %274, %315
  %317 = fmul double %278, -2.000000e+00
  %318 = call double @llvm.fmuladd.f64(double %317, double %278, double 1.000000e+00)
  %319 = fneg double %294
  %320 = fmul double %299, %319
  %321 = call double @llvm.fmuladd.f64(double %318, double %297, double %320)
  %322 = fmul double %274, %321
  %323 = fmul double %291, 2.000000e+00
  %324 = fmul double %278, %297
  %325 = call double @llvm.fmuladd.f64(double %280, double %294, double %324)
  %326 = fmul double %323, %325
  %327 = fmul double %274, %326
  %328 = getelementptr inbounds nuw i8, ptr %2, i64 24
  store double %316, ptr %328, align 8
  %329 = fmul double %327, f0xBFD9752E50F4B399
  %330 = call double @llvm.fmuladd.f64(double %322, double f0x3FED5C0357681EF3, double %329)
  %331 = getelementptr inbounds nuw i8, ptr %2, i64 32
  store double %330, ptr %331, align 8
  %332 = fmul double %327, f0x3FED5C0357681EF3
  %333 = call double @llvm.fmuladd.f64(double %322, double f0x3FD9752E50F4B399, double %332)
  %334 = getelementptr inbounds nuw i8, ptr %2, i64 40
