...
71:                                               ; preds = %3, %71
  %72 = phi double [ %19, %3 ], [ %88, %71 ]
  %73 = phi double [ %29, %3 ], [ %97, %71 ]
  %indvars.iv10 = phi i64 [ 0, %3 ], [ %indvars.iv.next, %71 ]
  %74 = getelementptr inbounds nuw [8 x i8], ptr %65, i64 %indvars.iv10
  %75 = load double, ptr %74, align 8
  %76 = fmul double %75, %64
  %77 = getelementptr inbounds nuw [8 x i8], ptr %66, i64 %indvars.iv10
  %78 = load double, ptr %77, align 8
  %79 = fmul double %78, %64
  %80 = getelementptr inbounds nuw [8 x i8], ptr %67, i64 %indvars.iv10
  %81 = load double, ptr %80, align 8
  %82 = call double @cos(double noundef %76) #4
  %83 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 %indvars.iv10
  ...
  %89 = getelementptr inbounds nuw [8 x i8], ptr %69, i64 %indvars.iv10
  %90 = load double, ptr %89, align 8
  %91 = call double @cos(double noundef %79) #4
  %92 = getelementptr inbounds nuw [8 x i8], ptr %70, i64 %indvars.iv10
  %93 = load double, ptr %92, align 8
  %94 = call double @sin(double noundef %79) #4
  %95 = fmul double %93, %94
  %96 = call double @llvm.fmuladd.f64(double %90, double %91, double %95)
  %97 = call double @llvm.fmuladd.f64(double %96, double f0x3E7AD7F29ABCAF48, double %73)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv10, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 8
  br i1 %exitcond, label %71, label %98, !llvm.loop !7

98:                                               ; preds = %71
  %.lcssa3 = phi double [ %97, %71 ]
  %.lcssa2 = phi double [ %88, %71 ]
  %99 = getelementptr inbounds nuw i8, ptr %65, i64 64
  %100 = load double, ptr %99, align 8
  %101 = fmul double %100, %64
  %102 = getelementptr inbounds nuw i8, ptr %67, i64 64
  %103 = load double, ptr %102, align 8
  %104 = call double @cos(double noundef %101) #4
  %105 = getelementptr inbounds nuw i8, ptr %68, i64 64
  %106 = load double, ptr %105, align 8
  %107 = call double @sin(double noundef %101) #4
  br label %108

108:                                              ; preds = %98, %108
  %109 = phi double [ %.lcssa3, %98 ], [ %122, %108 ]
  %indvars.iv511 = phi i64 [ 8, %98 ], [ %indvars.iv.next6, %108 ]
  %110 = getelementptr inbounds nuw [8 x i8], ptr %66, i64 %indvars.iv511
  %111 = load double, ptr %110, align 8
  %112 = fmul double %111, %64
  %113 = getelementptr inbounds nuw [8 x i8], ptr %69, i64 %indvars.iv511
  %114 = load double, ptr %113, align 8
  %115 = call double @cos(double noundef %112) #4
  %116 = getelementptr inbounds nuw [8 x i8], ptr %70, i64 %indvars.iv511
  %117 = load double, ptr %116, align 8
  %118 = call double @sin(double noundef %112) #4
  %119 = fmul double %117, %118
  %120 = call double @llvm.fmuladd.f64(double %114, double %115, double %119)
  %121 = fmul double %10, %120
  %122 = call double @llvm.fmuladd.f64(double %121, double f0x3E7AD7F29ABCAF48, double %109)
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv511, 1
  %exitcond8 = icmp ne i64 %indvars.iv.next6, 10
  br i1 %exitcond8, label %108, label %123, !llvm.loop !9

123:                                              ; preds = %108
  %.lcssa1 = phi double [ %122, %108 ]
  %124 = call double @llvm.fmuladd.f64(double %35, double %10, double %33)
  %125 = call double @llvm.fmuladd.f64(double %124, double %10, double %31)
  %126 = call double @fmod(double noundef %.lcssa1, double noundef f0x401921FB54442D18) #4
  %127 = fsub double %126, %46
  %128 = call double @sin(double noundef %127) #4
  %129 = call double @llvm.fmuladd.f64(double %125, double %128, double %127)
  %130 = fneg double %125
  %131 = fsub double %127, %129
  %132 = call double @sin(double noundef %129) #4
  %133 = call double @llvm.fmuladd.f64(double %125, double %132, double %131)
  %134 = call double @cos(double noundef %129) #4
  %135 = call double @llvm.fmuladd.f64(double %130, double %134, double 1.000000e+00)
...
138:                                              ; preds = %149
  %139 = phi i32 [ %150, %149 ]
  %140 = phi double [ %151, %149 ]
  %141 = fsub double %127, %140
  %142 = call double @sin(double noundef %140) #4
  %143 = call double @llvm.fmuladd.f64(double %125, double %142, double %141)
  %144 = call double @cos(double noundef %140) #4
  %145 = call double @llvm.fmuladd.f64(double %130, double %144, double 1.000000e+00)
  %146 = fdiv double %143, %145
  %147 = fadd double %140, %146
  %148 = add nuw nsw i32 %139, 1
  %exitcond9 = icmp eq i32 %139, 9
  br i1 %exitcond9, label %155, label %149

149:                                              ; preds = %123, %138
  %150 = phi i32 [ 1, %123 ], [ %148, %138 ]
  %151 = phi double [ %137, %123 ], [ %147, %138 ]
  %152 = phi double [ %136, %123 ], [ %146, %138 ]
  %153 = call double @llvm.fabs.f64(double %152)
  %154 = fcmp olt double %153, f0x3D719799812DEA11
  br i1 %154, label %155, label %138

155:                                              ; preds = %149, %138
  %.lcssa = phi double [ %151, %149 ], [ %147, %138 ]
  %156 = fmul double %106, %107
  %157 = call double @llvm.fmuladd.f64(double %103, double %104, double %156)
  %158 = fmul double %10, %157
  %159 = call double @llvm.fmuladd.f64(double %158, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %160 = call double @llvm.fmuladd.f64(double %52, double %10, double %50)
  %161 = fmul double %160, %10
  %162 = call double @llvm.fmuladd.f64(double %48, double 3.600000e+03, double %161)
  %163 = fmul double %162, f0x3ED455A5B2FF8F9D
  %164 = fmul double %.lcssa, 5.000000e-01
  %165 = fadd double %125, 1.000000e+00
  %166 = fsub double 1.000000e+00, %125
  ...
  %175 = call double @llvm.fmuladd.f64(double %130, double %174, double 1.000000e+00)
  ...
  %188 = call double @cos(double noundef %63) #4
  %189 = fmul double %187, %188
  %190 = call double @sin(double noundef %63) #4
  %191 = fmul double %187, %190
  %192 = fadd double %173, %46
  ...
  %199 = call double @llvm.fmuladd.f64(double %130, double %125, double 1.000000e+00)
  %200 = call double @sqrt(double noundef %199) #4
  %201 = fdiv double %159, %200
  %202 = call double @cos(double noundef %186) #4
  %203 = call double @sin(double noundef %46) #4
  %204 = call double @llvm.fmuladd.f64(double %125, double %203, double %193)
  %205 = fmul double %204, %201
  %206 = call double @cos(double noundef %46) #4
  %207 = call double @llvm.fmuladd.f64(double %125, double %206, double %194)
...
9:                                                ; preds = %11
  ...
  br i1 %exitcond, label %11, label %.loopexit, !llvm.loop !10
...
31:                                               ; preds = %29
  ...
  br i1 %exitcond4, label %20, label %33, !llvm.loop !13
