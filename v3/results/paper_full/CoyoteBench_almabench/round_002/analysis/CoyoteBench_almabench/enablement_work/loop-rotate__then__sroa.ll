...
72:                                               ; preds = %3, %72
  %73 = phi i32 [ 0, %3 ], [ %101, %72 ]
  %74 = phi double [ %18, %3 ], [ %91, %72 ]
  %75 = phi double [ %28, %3 ], [ %100, %72 ]
  %76 = zext nneg i32 %73 to i64
  %77 = getelementptr inbounds nuw [8 x i8], ptr %66, i64 %76
  %78 = load double, ptr %77, align 8
  %79 = fmul double %78, %65
  %80 = getelementptr inbounds nuw [8 x i8], ptr %67, i64 %76
  %81 = load double, ptr %80, align 8
  %82 = fmul double %81, %65
  %83 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 %76
  %84 = load double, ptr %83, align 8
  %85 = call double @cos(double noundef %79) #4
  %86 = getelementptr inbounds nuw [8 x i8], ptr %69, i64 %76
  %87 = load double, ptr %86, align 8
  %88 = call double @sin(double noundef %79) #4
  %89 = fmul double %87, %88
  %90 = call double @llvm.fmuladd.f64(double %84, double %85, double %89)
  %91 = call double @llvm.fmuladd.f64(double %90, double f0x3E7AD7F29ABCAF48, double %74)
  %92 = getelementptr inbounds nuw [8 x i8], ptr %70, i64 %76
  %93 = load double, ptr %92, align 8
  %94 = call double @cos(double noundef %82) #4
  %95 = getelementptr inbounds nuw [8 x i8], ptr %71, i64 %76
  %96 = load double, ptr %95, align 8
  %97 = call double @sin(double noundef %82) #4
  %98 = fmul double %96, %97
  %99 = call double @llvm.fmuladd.f64(double %93, double %94, double %98)
  %100 = call double @llvm.fmuladd.f64(double %99, double f0x3E7AD7F29ABCAF48, double %75)
  %101 = add nuw nsw i32 %73, 1
  %102 = icmp samesign ult i32 %101, 8
  br i1 %102, label %72, label %103, !llvm.loop !7

103:                                              ; preds = %72
  %.lcssa3 = phi double [ %100, %72 ]
  %.lcssa2 = phi double [ %91, %72 ]
  %104 = getelementptr inbounds nuw i8, ptr %66, i64 64
  %105 = load double, ptr %104, align 8
  %106 = fmul double %105, %65
  %107 = getelementptr inbounds nuw i8, ptr %68, i64 64
  %108 = load double, ptr %107, align 8
  %109 = call double @cos(double noundef %106) #4
  %110 = getelementptr inbounds nuw i8, ptr %69, i64 64
  %111 = load double, ptr %110, align 8
  %112 = call double @sin(double noundef %106) #4
  br label %113

113:                                              ; preds = %103, %113
  %114 = phi i32 [ 8, %103 ], [ %130, %113 ]
  %115 = phi double [ %.lcssa3, %103 ], [ %129, %113 ]
  %116 = zext nneg i32 %114 to i64
  %117 = getelementptr inbounds nuw [8 x i8], ptr %67, i64 %116
  %118 = load double, ptr %117, align 8
  %119 = fmul double %118, %65
  %120 = getelementptr inbounds nuw [8 x i8], ptr %70, i64 %116
  %121 = load double, ptr %120, align 8
  %122 = call double @cos(double noundef %119) #4
  %123 = getelementptr inbounds nuw [8 x i8], ptr %71, i64 %116
  ...
  %129 = call double @llvm.fmuladd.f64(double %128, double f0x3E7AD7F29ABCAF48, double %115)
  %130 = add nuw nsw i32 %114, 1
  %131 = icmp samesign ult i32 %130, 10
  br i1 %131, label %113, label %132, !llvm.loop !9

132:                                              ; preds = %113
  %.lcssa1 = phi double [ %129, %113 ]
  %133 = call double @fmod(double noundef %.lcssa1, double noundef f0x401921FB54442D18) #4
  %134 = fsub double %133, %47
  %135 = call double @sin(double noundef %134) #4
  %136 = call double @llvm.fmuladd.f64(double %36, double %135, double %134)
  %137 = fneg double %36
  %138 = fsub double %134, %136
  %139 = call double @sin(double noundef %136) #4
  %140 = call double @llvm.fmuladd.f64(double %36, double %139, double %138)
  %141 = call double @cos(double noundef %136) #4
  %142 = call double @llvm.fmuladd.f64(double %137, double %141, double 1.000000e+00)
...
145:                                              ; preds = %157
  ...
  %152 = call double @llvm.fmuladd.f64(double %137, double %151, double 1.000000e+00)
  %153 = fdiv double %150, %152
  %154 = fadd double %147, %153
  %155 = add nuw nsw i32 %146, 1
  %156 = icmp samesign ugt i32 %146, 8
  br i1 %156, label %163, label %157

157:                                              ; preds = %132, %145
  %158 = phi i32 [ 1, %132 ], [ %155, %145 ]
  %159 = phi double [ %144, %132 ], [ %154, %145 ]
  %160 = phi double [ %143, %132 ], [ %153, %145 ]
  %161 = call double @llvm.fabs.f64(double %160)
  %162 = fcmp olt double %161, f0x3D719799812DEA11
  br i1 %162, label %163, label %145

163:                                              ; preds = %157, %145
  %.lcssa = phi double [ %159, %157 ], [ %154, %145 ]
  %164 = fmul double %111, %112
  %165 = call double @llvm.fmuladd.f64(double %108, double %109, double %164)
  %166 = fmul double %9, %165
  %167 = call double @llvm.fmuladd.f64(double %166, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %168 = call double @llvm.fmuladd.f64(double %53, double %9, double %51)
  %169 = fmul double %168, %9
  %170 = call double @llvm.fmuladd.f64(double %49, double 3.600000e+03, double %169)
  %171 = fmul double %170, f0x3ED455A5B2FF8F9D
  %172 = fmul double %.lcssa, 5.000000e-01
  %173 = fadd double %36, 1.000000e+00
  %174 = fsub double 1.000000e+00, %36
  ...
  %183 = call double @llvm.fmuladd.f64(double %137, double %182, double 1.000000e+00)
  %184 = fmul double %167, %183
  %185 = getelementptr inbounds [8 x i8], ptr @amas, i64 %10
  ...
  %196 = call double @cos(double noundef %64) #4
  %197 = fmul double %195, %196
  %198 = call double @sin(double noundef %64) #4
  %199 = fmul double %195, %198
  %200 = fadd double %181, %47
  ...
  %207 = call double @llvm.fmuladd.f64(double %137, double %36, double 1.000000e+00)
  %208 = call double @sqrt(double noundef %207) #4
  %209 = fdiv double %167, %208
  %210 = call double @cos(double noundef %194) #4
  %211 = call double @sin(double noundef %47) #4
  %212 = call double @llvm.fmuladd.f64(double %36, double %211, double %201)
  %213 = fmul double %212, %209
  %214 = call double @cos(double noundef %47) #4
  %215 = call double @llvm.fmuladd.f64(double %36, double %214, double %202)
