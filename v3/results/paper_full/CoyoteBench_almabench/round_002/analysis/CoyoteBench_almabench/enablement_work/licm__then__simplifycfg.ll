...
115:                                              ; preds = %119, %105
  %116 = phi double [ %133, %119 ], [ %.lcssa3, %105 ]
...
135:                                              ; preds = %115
  %.lcssa1 = phi double [ %116, %115 ]
  %136 = call double @fmod(double noundef %.lcssa1, double noundef f0x401921FB54442D18) #4
