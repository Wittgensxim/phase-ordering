...
105:                                              ; preds = %73
  ...
  %127 = call double @llvm.fmuladd.f64(double %126, double f0x3E7AD7F29ABCAF48, double %74)
  ...
  br i1 false, label %141, label %147

141:                                              ; preds = %105
  %142 = getelementptr inbounds nuw [8 x i8], ptr %68, i64 10
  %143 = load double, ptr %142, align 8
  %144 = fmul double %143, %66
  %145 = call double @cos(double noundef %144) #4
  %146 = call double @sin(double noundef %144) #4
  unreachable

147:                                              ; preds = %105
  %148 = call double @fmod(double noundef %140, double noundef f0x401921FB54442D18) #4
  %149 = fsub double %148, %48
  %150 = call double @sin(double noundef %149) #4
  %151 = call double @llvm.fmuladd.f64(double %37, double %150, double %149)
  %152 = fneg double %37
  %153 = fsub double %149, %151
  %154 = call double @sin(double noundef %151) #4
  %155 = call double @llvm.fmuladd.f64(double %37, double %154, double %153)
  %156 = call double @cos(double noundef %151) #4
  %157 = call double @llvm.fmuladd.f64(double %152, double %156, double 1.000000e+00)
  %158 = fdiv double %155, %157
  %159 = fadd double %151, %158
  %160 = call double @llvm.fabs.f64(double %158)
  %161 = fcmp olt double %160, f0x3D719799812DEA11
  br i1 %161, label %162, label %253

162:                                              ; preds = %._crit_edge, %333, %323, %313, %303, %293, %283, %273, %263, %253, %147
  %.lcssa = phi double [ %159, %147 ], [ poison, %._crit_edge ], [ %340, %333 ], [ %260, %253 ], [ %330, %323 ], [ %270, %263 ], [ %300, %293 ], [ %280, %273 ], [ %320, %313 ], [ %290, %283 ], [ %310, %303 ]
  %163 = fmul double %113, %114
  %164 = call double @llvm.fmuladd.f64(double %110, double %111, double %163)
  %165 = fmul double %10, %164
  %166 = call double @llvm.fmuladd.f64(double %165, double f0x3E7AD7F29ABCAF48, double %75)
  %167 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %168 = fmul double %167, %10
  ...
  %182 = call double @llvm.fmuladd.f64(double %152, double %181, double 1.000000e+00)
  ...
  %206 = call double @llvm.fmuladd.f64(double %152, double %37, double 1.000000e+00)
...
253:                                              ; preds = %147
  %254 = fsub double %149, %159
  %255 = call double @sin(double noundef %159) #4
  %256 = call double @llvm.fmuladd.f64(double %37, double %255, double %254)
  %257 = call double @cos(double noundef %159) #4
  %258 = call double @llvm.fmuladd.f64(double %152, double %257, double 1.000000e+00)
  %259 = fdiv double %256, %258
  %260 = fadd double %159, %259
  %261 = call double @llvm.fabs.f64(double %259)
  %262 = fcmp olt double %261, f0x3D719799812DEA11
  br i1 %262, label %162, label %263

263:                                              ; preds = %253
  %264 = fsub double %149, %260
  %265 = call double @sin(double noundef %260) #4
  %266 = call double @llvm.fmuladd.f64(double %37, double %265, double %264)
  %267 = call double @cos(double noundef %260) #4
  %268 = call double @llvm.fmuladd.f64(double %152, double %267, double 1.000000e+00)
  ...
  br i1 %272, label %162, label %273

273:                                              ; preds = %263
  %274 = fsub double %149, %270
  %275 = call double @sin(double noundef %270) #4
  %276 = call double @llvm.fmuladd.f64(double %37, double %275, double %274)
  %277 = call double @cos(double noundef %270) #4
  %278 = call double @llvm.fmuladd.f64(double %152, double %277, double 1.000000e+00)
  %279 = fdiv double %276, %278
  %280 = fadd double %270, %279
  %281 = call double @llvm.fabs.f64(double %279)
  %282 = fcmp olt double %281, f0x3D719799812DEA11
  br i1 %282, label %162, label %283

283:                                              ; preds = %273
  %284 = fsub double %149, %280
  %285 = call double @sin(double noundef %280) #4
  %286 = call double @llvm.fmuladd.f64(double %37, double %285, double %284)
  %287 = call double @cos(double noundef %280) #4
  %288 = call double @llvm.fmuladd.f64(double %152, double %287, double 1.000000e+00)
  %289 = fdiv double %286, %288
  %290 = fadd double %280, %289
  %291 = call double @llvm.fabs.f64(double %289)
  %292 = fcmp olt double %291, f0x3D719799812DEA11
  br i1 %292, label %162, label %293

293:                                              ; preds = %283
  %294 = fsub double %149, %290
  %295 = call double @sin(double noundef %290) #4
  %296 = call double @llvm.fmuladd.f64(double %37, double %295, double %294)
  %297 = call double @cos(double noundef %290) #4
  %298 = call double @llvm.fmuladd.f64(double %152, double %297, double 1.000000e+00)
  %299 = fdiv double %296, %298
  %300 = fadd double %290, %299
  %301 = call double @llvm.fabs.f64(double %299)
  %302 = fcmp olt double %301, f0x3D719799812DEA11
  br i1 %302, label %162, label %303

303:                                              ; preds = %293
  %304 = fsub double %149, %300
  %305 = call double @sin(double noundef %300) #4
  %306 = call double @llvm.fmuladd.f64(double %37, double %305, double %304)
  %307 = call double @cos(double noundef %300) #4
  %308 = call double @llvm.fmuladd.f64(double %152, double %307, double 1.000000e+00)
  ...
  br i1 %312, label %162, label %313

313:                                              ; preds = %303
  %314 = fsub double %149, %310
  %315 = call double @sin(double noundef %310) #4
  %316 = call double @llvm.fmuladd.f64(double %37, double %315, double %314)
  %317 = call double @cos(double noundef %310) #4
  %318 = call double @llvm.fmuladd.f64(double %152, double %317, double 1.000000e+00)
  %319 = fdiv double %316, %318
  %320 = fadd double %310, %319
  %321 = call double @llvm.fabs.f64(double %319)
  %322 = fcmp olt double %321, f0x3D719799812DEA11
  br i1 %322, label %162, label %323

323:                                              ; preds = %313
  %324 = fsub double %149, %320
  %325 = call double @sin(double noundef %320) #4
  %326 = call double @llvm.fmuladd.f64(double %37, double %325, double %324)
  %327 = call double @cos(double noundef %320) #4
  %328 = call double @llvm.fmuladd.f64(double %152, double %327, double 1.000000e+00)
  %329 = fdiv double %326, %328
  %330 = fadd double %320, %329
  %331 = call double @llvm.fabs.f64(double %329)
  %332 = fcmp olt double %331, f0x3D719799812DEA11
  br i1 %332, label %162, label %333

333:                                              ; preds = %323
  %334 = fsub double %149, %330
  %335 = call double @sin(double noundef %330) #4
  %336 = call double @llvm.fmuladd.f64(double %37, double %335, double %334)
  %337 = call double @cos(double noundef %330) #4
  %338 = call double @llvm.fmuladd.f64(double %152, double %337, double 1.000000e+00)
  %339 = fdiv double %336, %338
  %340 = fadd double %330, %339
  br i1 true, label %162, label %341

341:                                              ; preds = %333
  %342 = call double @llvm.fabs.f64(double %339)
  %343 = fcmp olt double %342, f0x3D719799812DEA11
