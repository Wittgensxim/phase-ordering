...
105:                                              ; preds = %73
  ...
  %153 = call double @llvm.fabs.f64(double %151)
  %154 = fcmp olt double %153, f0x3D719799812DEA11
  br i1 %154, label %155, label %246

155:                                              ; preds = %326, %316, %306, %296, %286, %276, %266, %256, %246, %105
  %.lcssa = phi double [ %152, %105 ], [ %303, %296 ], [ %333, %326 ], [ %253, %246 ], [ %323, %316 ], [ %263, %256 ], [ %293, %286 ], [ %273, %266 ], [ %313, %306 ], [ %283, %276 ]
  %156 = fmul double %113, %114
  %157 = call double @llvm.fmuladd.f64(double %110, double %111, double %156)
  %158 = fmul double %10, %157
  %159 = call double @llvm.fmuladd.f64(double %158, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %160 = call double @llvm.fmuladd.f64(double %54, double %10, double %52)
  %161 = fmul double %160, %10
  %162 = call double @llvm.fmuladd.f64(double %50, double 3.600000e+03, double %161)
  %163 = fmul double %162, f0x3ED455A5B2FF8F9D
  %164 = fmul double %.lcssa, 5.000000e-01
  %165 = fadd double %37, 1.000000e+00
  %166 = fsub double 1.000000e+00, %37
  ...
  %174 = call double @cos(double noundef %.lcssa) #4
  %175 = call double @llvm.fmuladd.f64(double %145, double %174, double 1.000000e+00)
  %176 = fmul double %159, %175
  %177 = getelementptr inbounds [8 x i8], ptr @amas, i64 %11
  ...
  %188 = call double @cos(double noundef %65) #4
  %189 = fmul double %187, %188
  %190 = call double @sin(double noundef %65) #4
  %191 = fmul double %187, %190
  %192 = fadd double %173, %48
  ...
  %199 = call double @llvm.fmuladd.f64(double %145, double %37, double 1.000000e+00)
  %200 = call double @sqrt(double noundef %199) #4
  %201 = fdiv double %159, %200
  %202 = call double @cos(double noundef %186) #4
  %203 = call double @sin(double noundef %48) #4
  %204 = call double @llvm.fmuladd.f64(double %37, double %203, double %193)
  %205 = fmul double %204, %201
  %206 = call double @cos(double noundef %48) #4
  %207 = call double @llvm.fmuladd.f64(double %37, double %206, double %194)
...
246:                                              ; preds = %105
  %247 = fsub double %142, %152
  %248 = call double @sin(double noundef %152) #4
  %249 = call double @llvm.fmuladd.f64(double %37, double %248, double %247)
  %250 = call double @cos(double noundef %152) #4
  %251 = call double @llvm.fmuladd.f64(double %145, double %250, double 1.000000e+00)
  %252 = fdiv double %249, %251
  %253 = fadd double %152, %252
  %254 = call double @llvm.fabs.f64(double %252)
  %255 = fcmp olt double %254, f0x3D719799812DEA11
  br i1 %255, label %155, label %256

256:                                              ; preds = %246
  %257 = fsub double %142, %253
  %258 = call double @sin(double noundef %253) #4
  %259 = call double @llvm.fmuladd.f64(double %37, double %258, double %257)
  %260 = call double @cos(double noundef %253) #4
  %261 = call double @llvm.fmuladd.f64(double %145, double %260, double 1.000000e+00)
  %262 = fdiv double %259, %261
  %263 = fadd double %253, %262
  %264 = call double @llvm.fabs.f64(double %262)
  %265 = fcmp olt double %264, f0x3D719799812DEA11
  br i1 %265, label %155, label %266

266:                                              ; preds = %256
  %267 = fsub double %142, %263
  %268 = call double @sin(double noundef %263) #4
  %269 = call double @llvm.fmuladd.f64(double %37, double %268, double %267)
  %270 = call double @cos(double noundef %263) #4
  %271 = call double @llvm.fmuladd.f64(double %145, double %270, double 1.000000e+00)
  %272 = fdiv double %269, %271
  %273 = fadd double %263, %272
  %274 = call double @llvm.fabs.f64(double %272)
  %275 = fcmp olt double %274, f0x3D719799812DEA11
  br i1 %275, label %155, label %276

276:                                              ; preds = %266
  %277 = fsub double %142, %273
  %278 = call double @sin(double noundef %273) #4
  %279 = call double @llvm.fmuladd.f64(double %37, double %278, double %277)
  %280 = call double @cos(double noundef %273) #4
  %281 = call double @llvm.fmuladd.f64(double %145, double %280, double 1.000000e+00)
  %282 = fdiv double %279, %281
  %283 = fadd double %273, %282
  %284 = call double @llvm.fabs.f64(double %282)
  %285 = fcmp olt double %284, f0x3D719799812DEA11
  br i1 %285, label %155, label %286

286:                                              ; preds = %276
  %287 = fsub double %142, %283
  %288 = call double @sin(double noundef %283) #4
  %289 = call double @llvm.fmuladd.f64(double %37, double %288, double %287)
  %290 = call double @cos(double noundef %283) #4
  %291 = call double @llvm.fmuladd.f64(double %145, double %290, double 1.000000e+00)
  ...
  br i1 %295, label %155, label %296

296:                                              ; preds = %286
  %297 = fsub double %142, %293
  %298 = call double @sin(double noundef %293) #4
  %299 = call double @llvm.fmuladd.f64(double %37, double %298, double %297)
  %300 = call double @cos(double noundef %293) #4
  %301 = call double @llvm.fmuladd.f64(double %145, double %300, double 1.000000e+00)
  %302 = fdiv double %299, %301
  %303 = fadd double %293, %302
  %304 = call double @llvm.fabs.f64(double %302)
  %305 = fcmp olt double %304, f0x3D719799812DEA11
  br i1 %305, label %155, label %306

306:                                              ; preds = %296
  %307 = fsub double %142, %303
  %308 = call double @sin(double noundef %303) #4
  %309 = call double @llvm.fmuladd.f64(double %37, double %308, double %307)
  %310 = call double @cos(double noundef %303) #4
  %311 = call double @llvm.fmuladd.f64(double %145, double %310, double 1.000000e+00)
  %312 = fdiv double %309, %311
  %313 = fadd double %303, %312
  %314 = call double @llvm.fabs.f64(double %312)
  %315 = fcmp olt double %314, f0x3D719799812DEA11
  br i1 %315, label %155, label %316

316:                                              ; preds = %306
  %317 = fsub double %142, %313
  %318 = call double @sin(double noundef %313) #4
  %319 = call double @llvm.fmuladd.f64(double %37, double %318, double %317)
  %320 = call double @cos(double noundef %313) #4
  %321 = call double @llvm.fmuladd.f64(double %145, double %320, double 1.000000e+00)
  %322 = fdiv double %319, %321
  %323 = fadd double %313, %322
  %324 = call double @llvm.fabs.f64(double %322)
  %325 = fcmp olt double %324, f0x3D719799812DEA11
  br i1 %325, label %155, label %326

326:                                              ; preds = %316
  %327 = fsub double %142, %323
  %328 = call double @sin(double noundef %323) #4
  %329 = call double @llvm.fmuladd.f64(double %37, double %328, double %327)
  %330 = call double @cos(double noundef %323) #4
  %331 = call double @llvm.fmuladd.f64(double %145, double %330, double 1.000000e+00)
  %332 = fdiv double %329, %331
  %333 = fadd double %323, %332
  br label %155
}
...
.loopexit:                                        ; preds = %12, %9, %2
  %17 = getelementptr inbounds nuw i8, ptr %3, i64 8
  br label %18

18:                                               ; preds = %36, %.loopexit
  %19 = phi i32 [ %37, %36 ], [ 0, %.loopexit ]
  %20 = icmp samesign ult i32 %19, 20
