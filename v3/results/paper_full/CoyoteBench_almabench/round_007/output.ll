; ModuleID = 'results\paper_full\CoyoteBench_almabench\round_007\output.ll'
...
145:                                              ; preds = %132
  ...
  %149 = call double @llvm.fmuladd.f64(double %148, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
