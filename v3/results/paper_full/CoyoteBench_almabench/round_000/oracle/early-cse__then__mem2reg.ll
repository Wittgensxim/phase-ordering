...
75:                                               ; preds = %120, %3
  %.04 = phi double [ %18, %3 ], [ %104, %120 ]
  %.02 = phi double [ %29, %3 ], [ %119, %120 ]
  %.01 = phi i32 [ 0, %3 ], [ %121, %120 ]
  %76 = icmp slt i32 %.01, 8
...
77:                                               ; preds = %75
  ...
  %104 = call double @llvm.fmuladd.f64(double %103, double f0x3E7AD7F29ABCAF48, double %.04)
  ...
  %119 = call double @llvm.fmuladd.f64(double %118, double f0x3E7AD7F29ABCAF48, double %.02)
  br label %120
...
122:                                              ; preds = %75
  ...
  %141 = call double @llvm.fmuladd.f64(double %140, double f0x3E7AD7F29ABCAF48, double %.04)
  br label %142

142:                                              ; preds = %167, %122
  %.13 = phi double [ %.02, %122 ], [ %166, %167 ]
...
144:                                              ; preds = %142
  ...
  %166 = call double @llvm.fmuladd.f64(double %165, double f0x3E7AD7F29ABCAF48, double %.13)
  br label %167
...
169:                                              ; preds = %142
  %170 = call double @fmod(double noundef %.13, double noundef f0x401921FB54442D18) #4
...
174:                                              ; preds = %189, %169
  ...
  %176 = call double @sin(double noundef %.0) #4
  %177 = call double @llvm.fmuladd.f64(double %38, double %176, double %175)
  %178 = call double @cos(double noundef %.0) #4
  %179 = fneg double %38
