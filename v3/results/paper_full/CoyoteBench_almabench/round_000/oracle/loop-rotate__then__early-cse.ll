...
define dso_local void @planetpv(ptr noundef %0, i32 noundef %1, ptr noundef %2) #0 {
  ...
  br i1 true, label %.lr.ph, label %191
...
124:                                              ; preds = %.lr.ph, %187
  ...
  %127 = getelementptr inbounds [8 x [9 x double]], ptr @kp, i64 0, i64 %126
  %128 = load i32, ptr %7, align 4
  %129 = sext i32 %128 to i64
  %130 = getelementptr inbounds [9 x double], ptr %127, i64 0, i64 %129
  ...
  %136 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %135
  %137 = load i32, ptr %7, align 4
  %138 = sext i32 %137 to i64
  %139 = getelementptr inbounds [10 x double], ptr %136, i64 0, i64 %138
  ...
  %149 = getelementptr inbounds [9 x double], ptr %146, i64 0, i64 %148
  %150 = load double, ptr %149, align 8
  %151 = load double, ptr %16, align 8
  %152 = call double @cos(double noundef %151) #4
  %153 = load i32, ptr %5, align 4
  %154 = sext i32 %153 to i64
  %155 = getelementptr inbounds [8 x [9 x double]], ptr @sa, i64 0, i64 %154
  %156 = load i32, ptr %7, align 4
  %157 = sext i32 %156 to i64
  %158 = getelementptr inbounds [9 x double], ptr %155, i64 0, i64 %157
  %159 = load double, ptr %158, align 8
  %160 = load double, ptr %16, align 8
  %161 = call double @sin(double noundef %160) #4
  %162 = fmul double %159, %161
  %163 = call double @llvm.fmuladd.f64(double %150, double %152, double %162)
  %164 = call double @llvm.fmuladd.f64(double %163, double f0x3E7AD7F29ABCAF48, double %143)
  store double %164, ptr %9, align 8
  %165 = load double, ptr %10, align 8
  %166 = load i32, ptr %5, align 4
  %167 = sext i32 %166 to i64
  %168 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %167
  %169 = load i32, ptr %7, align 4
  %170 = sext i32 %169 to i64
  %171 = getelementptr inbounds [10 x double], ptr %168, i64 0, i64 %170
  %172 = load double, ptr %171, align 8
  %173 = load double, ptr %17, align 8
  %174 = call double @cos(double noundef %173) #4
  %175 = load i32, ptr %5, align 4
  %176 = sext i32 %175 to i64
  %177 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %176
  %178 = load i32, ptr %7, align 4
  %179 = sext i32 %178 to i64
  %180 = getelementptr inbounds [10 x double], ptr %177, i64 0, i64 %179
  %181 = load double, ptr %180, align 8
  %182 = load double, ptr %17, align 8
  %183 = call double @sin(double noundef %182) #4
  %184 = fmul double %181, %183
  %185 = call double @llvm.fmuladd.f64(double %172, double %174, double %184)
  %186 = call double @llvm.fmuladd.f64(double %185, double f0x3E7AD7F29ABCAF48, double %165)
...
187:                                              ; preds = %124
  ...
  br i1 %190, label %124, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %187
  br label %191

191:                                              ; preds = %._crit_edge, %3
  ...
  br i1 true, label %.lr.ph2, label %255

.lr.ph2:                                          ; preds = %191
  br label %218

218:                                              ; preds = %.lr.ph2, %251
  %219 = load i32, ptr %5, align 4
  %220 = sext i32 %219 to i64
  %221 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %220
  ...
  %232 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %231
  %233 = load i32, ptr %7, align 4
  %234 = sext i32 %233 to i64
  %235 = getelementptr inbounds [10 x double], ptr %232, i64 0, i64 %234
  %236 = load double, ptr %235, align 8
  %237 = call double @cos(double noundef %227) #4
  %238 = load i32, ptr %5, align 4
  %239 = sext i32 %238 to i64
  %240 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %239
  %241 = load i32, ptr %7, align 4
  %242 = sext i32 %241 to i64
  %243 = getelementptr inbounds [10 x double], ptr %240, i64 0, i64 %242
  %244 = load double, ptr %243, align 8
  %245 = load double, ptr %17, align 8
  %246 = call double @sin(double noundef %245) #4
  %247 = fmul double %244, %246
  %248 = call double @llvm.fmuladd.f64(double %236, double %237, double %247)
  %249 = fmul double %229, %248
  %250 = call double @llvm.fmuladd.f64(double %249, double f0x3E7AD7F29ABCAF48, double %228)
...
251:                                              ; preds = %218
  ...
  br i1 %254, label %218, label %._crit_edge3, !llvm.loop !9

._crit_edge3:                                     ; preds = %251
  br label %255

255:                                              ; preds = %._crit_edge3, %191
...
286:                                              ; preds = %285
  ...
  %310 = getelementptr inbounds [8 x double], ptr @amas, i64 0, i64 %309
  ...
  %317 = fdiv double %313, %316
  %318 = call double @sqrt(double noundef %317) #4
  %319 = fmul double f0x3F919D6D51A6B69A, %318
  store double %319, ptr %24, align 8
  %320 = load double, ptr %13, align 8
  %321 = fdiv double %320, 2.000000e+00
  ...
  %340 = fneg double %339
  %341 = call double @llvm.fmuladd.f64(double %336, double %335, double %340)
  %342 = fmul double 2.000000e+00, %341
  store double %342, ptr %31, align 8
  %343 = load double, ptr %9, align 8
  ...
  store double %358, ptr %34, align 8
  ...
  store double %365, ptr %35, align 8
  ...
  %371 = load double, ptr %30, align 8
  %372 = load double, ptr %31, align 8
  %373 = load double, ptr %27, align 8
  %374 = fneg double %372
  ...
  store double %382, ptr %38, align 8
  ...
  store double %388, ptr %39, align 8
  ...
  %393 = fmul double %392, f0x3FD9752E50F4B399
  %394 = fneg double %393
  %395 = call double @llvm.fmuladd.f64(double %391, double f0x3FED5C0357681EF3, double %394)
  %396 = load ptr, ptr %6, align 8
  %397 = getelementptr inbounds [3 x double], ptr %396, i64 0, i64 1
  store double %395, ptr %397, align 8
  %398 = load double, ptr %38, align 8
  %399 = load double, ptr %39, align 8
  %400 = fmul double %399, f0x3FED5C0357681EF3
  %401 = call double @llvm.fmuladd.f64(double %398, double f0x3FD9752E50F4B399, double %400)
  %402 = load ptr, ptr %6, align 8
  %403 = getelementptr inbounds [3 x double], ptr %402, i64 0, i64 2
  ...
  store double %413, ptr %37, align 8
  %414 = load double, ptr %24, align 8
  %415 = load double, ptr %26, align 8
  %416 = fmul double 2.000000e+00, %415
  %417 = fneg double %416
  %418 = call double @llvm.fmuladd.f64(double %417, double %415, double 1.000000e+00)
  %419 = load double, ptr %35, align 8
  %420 = load double, ptr %36, align 8
  %421 = load double, ptr %34, align 8
  %422 = fmul double %420, %421
  %423 = fneg double %422
  %424 = call double @llvm.fmuladd.f64(double %418, double %419, double %423)
  %425 = fmul double %414, %424
  store double %425, ptr %38, align 8
  %426 = load double, ptr %24, align 8
  ...
  %434 = call double @llvm.fmuladd.f64(double %429, double %430, double %433)
  %435 = fmul double %428, %434
  %436 = fmul double %426, %435
  store double %436, ptr %39, align 8
  %437 = load double, ptr %37, align 8
  %438 = load ptr, ptr %6, align 8
  %439 = getelementptr inbounds [3 x double], ptr %438, i64 1
  store double %437, ptr %439, align 8
  %440 = load double, ptr %38, align 8
  %441 = load double, ptr %39, align 8
  %442 = fmul double %441, f0x3FD9752E50F4B399
  %443 = fneg double %442
  %444 = call double @llvm.fmuladd.f64(double %440, double f0x3FED5C0357681EF3, double %443)
  %445 = load ptr, ptr %6, align 8
  %446 = getelementptr inbounds [3 x double], ptr %445, i64 1
  %447 = getelementptr inbounds [3 x double], ptr %446, i64 0, i64 1
  store double %444, ptr %447, align 8
  %448 = load double, ptr %38, align 8
  %449 = load double, ptr %39, align 8
  %450 = fmul double %449, f0x3FED5C0357681EF3
  %451 = call double @llvm.fmuladd.f64(double %448, double f0x3FD9752E50F4B399, double %450)
  %452 = load ptr, ptr %6, align 8
  %453 = getelementptr inbounds [3 x double], ptr %452, i64 1
  %454 = getelementptr inbounds [3 x double], ptr %453, i64 0, i64 2
  store double %451, ptr %454, align 8
  ret void
}
...
26:                                               ; preds = %25
  ...
  br i1 %30, label %18, label %..loopexit_crit_edge, !llvm.loop !10
...
32:                                               ; preds = %31, %2
  ...
  br i1 true, label %.lr.ph6, label %57
...
33:                                               ; preds = %.lr.ph6, %53
  ...
  %34 = getelementptr inbounds [2 x double], ptr %9, i64 0, i64 1
  store double 0.000000e+00, ptr %34, align 8
  store i32 0, ptr %7, align 4
  br i1 true, label %.lr.ph3, label %52

.lr.ph3:                                          ; preds = %33
  br label %35

35:                                               ; preds = %.lr.ph3, %48
  %36 = load double, ptr %9, align 16
  %37 = fadd double %36, 1.000000e+00
  store double %37, ptr %9, align 16
  store i32 0, ptr %8, align 4
  br i1 true, label %.lr.ph1, label %47
...
38:                                               ; preds = %.lr.ph1, %43
  ...
  call void @planetpv(ptr noundef %9, i32 noundef %39, ptr noundef %10)
  %40 = load i32, ptr %8, align 4
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds [8 x [3 x double]], ptr %11, i64 0, i64 %41
...
43:                                               ; preds = %38
  ...
  br i1 %46, label %38, label %._crit_edge, !llvm.loop !11
...
48:                                               ; preds = %47
  ...
  %51 = icmp slt i32 %50, 36525
  br i1 %51, label %35, label %._crit_edge4, !llvm.loop !12

._crit_edge4:                                     ; preds = %48
  br label %52

52:                                               ; preds = %._crit_edge4, %33
  br label %53
...
53:                                               ; preds = %52
  ...
  br i1 %56, label %33, label %._crit_edge7, !llvm.loop !13

._crit_edge7:                                     ; preds = %53
  br label %57

57:                                               ; preds = %._crit_edge7, %32
  store i32 0, ptr %8, align 4
  br i1 true, label %.lr.ph9, label %72
...
68:                                               ; preds = %58
  ...
  br i1 %71, label %58, label %._crit_edge10, !llvm.loop !14

._crit_edge10:                                    ; preds = %68
  br label %72

72:                                               ; preds = %._crit_edge10, %57
