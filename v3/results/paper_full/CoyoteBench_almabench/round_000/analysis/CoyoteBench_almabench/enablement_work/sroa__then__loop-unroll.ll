...
421:                                              ; preds = %404
  %.0177.lcssa = phi double [ %403, %404 ]
  %.0176.lcssa = phi double [ %390, %404 ]
  ...
  %440 = call double @llvm.fmuladd.f64(double %439, double f0x3E7AD7F29ABCAF48, double %.0176.lcssa)
  br label %441
...
442:                                              ; preds = %441
  ...
  %461 = call double @llvm.fmuladd.f64(double %460, double f0x3E7AD7F29ABCAF48, double %.0177.lcssa)
  br label %462
...
493:                                              ; preds = %483
  %.1178.lcssa = phi double [ %482, %483 ]
  %494 = call double @fmod(double noundef %.1178.lcssa, double noundef f0x401921FB54442D18) #4
