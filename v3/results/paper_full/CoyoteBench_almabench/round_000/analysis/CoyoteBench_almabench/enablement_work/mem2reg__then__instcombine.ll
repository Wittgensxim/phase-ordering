...
95:                                               ; preds = %134, %3
  %.03 = phi i32 [ 0, %3 ], [ %141, %134 ]
  %.02 = phi double [ %22, %3 ], [ %140, %134 ]
  %.01 = phi double [ %37, %3 ], [ %137, %134 ]
  %96 = icmp samesign ult i32 %.03, 8
  br i1 %96, label %97, label %142

97:                                               ; preds = %95
  %98 = sext i32 %1 to i64
  %99 = getelementptr inbounds [72 x i8], ptr @kp, i64 %98
  %100 = zext nneg i32 %.03 to i64
...
134:                                              ; preds = %97
  ...
  %140 = call double @llvm.fmuladd.f64(double %139, double f0x3E7AD7F29ABCAF48, double %.02)
  %141 = add nuw nsw i32 %.03, 1
...
158:                                              ; preds = %179, %142
  %.14 = phi i32 [ 8, %142 ], [ %184, %179 ]
  %.1 = phi double [ %.01, %142 ], [ %183, %179 ]
  %159 = icmp samesign ult i32 %.14, 10
  br i1 %159, label %160, label %185

160:                                              ; preds = %158
  %161 = sext i32 %1 to i64
  %162 = getelementptr inbounds [80 x i8], ptr @kq, i64 %161
  %163 = zext nneg i32 %.14 to i64
...
179:                                              ; preds = %160
  ...
  %183 = call double @llvm.fmuladd.f64(double %182, double f0x3E7AD7F29ABCAF48, double %.1)
  %184 = add nuw nsw i32 %.14, 1
  br label %158, !llvm.loop !9

185:                                              ; preds = %158
  %186 = call double @fmod(double noundef %.1, double noundef f0x401921FB54442D18) #4
...
206:                                              ; preds = %204
  ...
  %210 = call double @llvm.fmuladd.f64(double %209, double f0x3E7AD7F29ABCAF48, double %.02)
...
24:                                               ; preds = %37, %22
  %.01 = phi i32 [ 0, %22 ], [ %38, %37 ]
  %25 = icmp samesign ult i32 %.01, 36525
