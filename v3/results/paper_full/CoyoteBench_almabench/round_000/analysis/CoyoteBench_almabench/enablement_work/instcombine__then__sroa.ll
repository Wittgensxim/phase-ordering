...
define dso_local void @planetpv(ptr noundef %0, i32 noundef %1, ptr noundef %2) #0 {
  ...
  %78 = call double @llvm.fmuladd.f64(double %77, double %9, double %73)
  %79 = fmul double %78, %9
  %80 = call double @llvm.fmuladd.f64(double %69, double 3.600000e+03, double %79)
  %81 = fmul double %80, f0x3ED455A5B2FF8F9D
  %82 = sext i32 %1 to i64
  %83 = getelementptr inbounds [24 x i8], ptr @omega, i64 %82
  ...
  %90 = getelementptr inbounds [24 x i8], ptr @omega, i64 %89
  %91 = getelementptr inbounds nuw i8, ptr %90, i64 16
  %92 = load double, ptr %91, align 8
  %93 = call double @llvm.fmuladd.f64(double %92, double %9, double %88)
  %94 = fmul double %93, %9
  %95 = call double @llvm.fmuladd.f64(double %84, double 3.600000e+03, double %94)
  %96 = fmul double %95, f0x3ED455A5B2FF8F9D
  %97 = call double @anpm(double noundef %96)
  %98 = fmul double %9, f0x3FD702A41F2E9970
  br label %99

99:                                               ; preds = %144, %3
  %.0133 = phi double [ %37, %3 ], [ %143, %144 ]
  %.0132 = phi double [ %22, %3 ], [ %128, %144 ]
  %storemerge = phi i32 [ 0, %3 ], [ %145, %144 ]
  %100 = icmp slt i32 %storemerge, 8
  br i1 %100, label %101, label %146

101:                                              ; preds = %99
  %102 = sext i32 %1 to i64
  %103 = getelementptr inbounds [72 x i8], ptr @kp, i64 %102
  %104 = sext i32 %storemerge to i64
  %105 = getelementptr inbounds [8 x i8], ptr %103, i64 %104
  %106 = load double, ptr %105, align 8
  %107 = fmul double %106, %98
  %108 = sext i32 %1 to i64
  %109 = getelementptr inbounds [80 x i8], ptr @kq, i64 %108
  %110 = sext i32 %storemerge to i64
  %111 = getelementptr inbounds [8 x i8], ptr %109, i64 %110
  %112 = load double, ptr %111, align 8
  %113 = fmul double %112, %98
  %114 = sext i32 %1 to i64
  %115 = getelementptr inbounds [72 x i8], ptr @ca, i64 %114
  %116 = sext i32 %storemerge to i64
  %117 = getelementptr inbounds [8 x i8], ptr %115, i64 %116
  %118 = load double, ptr %117, align 8
  %119 = call double @cos(double noundef %107) #4
  %120 = sext i32 %1 to i64
  %121 = getelementptr inbounds [72 x i8], ptr @sa, i64 %120
  %122 = sext i32 %storemerge to i64
  %123 = getelementptr inbounds [8 x i8], ptr %121, i64 %122
  %124 = load double, ptr %123, align 8
  %125 = call double @sin(double noundef %107) #4
  %126 = fmul double %124, %125
  %127 = call double @llvm.fmuladd.f64(double %118, double %119, double %126)
  %128 = call double @llvm.fmuladd.f64(double %127, double f0x3E7AD7F29ABCAF48, double %.0132)
  %129 = sext i32 %1 to i64
  %130 = getelementptr inbounds [80 x i8], ptr @cl, i64 %129
  %131 = sext i32 %storemerge to i64
  %132 = getelementptr inbounds [8 x i8], ptr %130, i64 %131
  %133 = load double, ptr %132, align 8
  %134 = call double @cos(double noundef %113) #4
  %135 = sext i32 %1 to i64
  %136 = getelementptr inbounds [80 x i8], ptr @sl, i64 %135
  %137 = sext i32 %storemerge to i64
  %138 = getelementptr inbounds [8 x i8], ptr %136, i64 %137
  %139 = load double, ptr %138, align 8
  %140 = call double @sin(double noundef %113) #4
  %141 = fmul double %139, %140
  %142 = call double @llvm.fmuladd.f64(double %133, double %134, double %141)
  %143 = call double @llvm.fmuladd.f64(double %142, double f0x3E7AD7F29ABCAF48, double %.0133)
  br label %144

144:                                              ; preds = %101
  %145 = add nsw i32 %storemerge, 1
  br label %99, !llvm.loop !7

146:                                              ; preds = %99
  %147 = sext i32 %1 to i64
  %148 = getelementptr inbounds [72 x i8], ptr @kp, i64 %147
  %149 = getelementptr inbounds nuw i8, ptr %148, i64 64
  %150 = load double, ptr %149, align 8
  %151 = fmul double %150, %98
  %152 = sext i32 %1 to i64
  %153 = getelementptr inbounds [72 x i8], ptr @ca, i64 %152
  %154 = getelementptr inbounds nuw i8, ptr %153, i64 64
  %155 = load double, ptr %154, align 8
  %156 = call double @cos(double noundef %151) #4
  %157 = sext i32 %1 to i64
  %158 = getelementptr inbounds [72 x i8], ptr @sa, i64 %157
  %159 = getelementptr inbounds nuw i8, ptr %158, i64 64
  %160 = load double, ptr %159, align 8
  %161 = call double @sin(double noundef %151) #4
  %162 = fmul double %160, %161
  %163 = call double @llvm.fmuladd.f64(double %155, double %156, double %162)
  %164 = fmul double %9, %163
  %165 = call double @llvm.fmuladd.f64(double %164, double f0x3E7AD7F29ABCAF48, double %.0132)
  br label %166

166:                                              ; preds = %191, %146
  %.1 = phi double [ %.0133, %146 ], [ %190, %191 ]
  %storemerge1 = phi i32 [ 8, %146 ], [ %192, %191 ]
  %167 = icmp slt i32 %storemerge1, 10
  br i1 %167, label %168, label %193

168:                                              ; preds = %166
  %169 = sext i32 %1 to i64
  %170 = getelementptr inbounds [80 x i8], ptr @kq, i64 %169
  %171 = sext i32 %storemerge1 to i64
  %172 = getelementptr inbounds [8 x i8], ptr %170, i64 %171
  %173 = load double, ptr %172, align 8
  %174 = fmul double %173, %98
  %175 = sext i32 %1 to i64
  %176 = getelementptr inbounds [80 x i8], ptr @cl, i64 %175
  %177 = sext i32 %storemerge1 to i64
  %178 = getelementptr inbounds [8 x i8], ptr %176, i64 %177
  %179 = load double, ptr %178, align 8
  %180 = call double @cos(double noundef %174) #4
  %181 = sext i32 %1 to i64
  %182 = getelementptr inbounds [80 x i8], ptr @sl, i64 %181
  %183 = sext i32 %storemerge1 to i64
  %184 = getelementptr inbounds [8 x i8], ptr %182, i64 %183
  %185 = load double, ptr %184, align 8
  %186 = call double @sin(double noundef %174) #4
  %187 = fmul double %185, %186
  %188 = call double @llvm.fmuladd.f64(double %179, double %180, double %187)
  %189 = fmul double %9, %188
  %190 = call double @llvm.fmuladd.f64(double %189, double f0x3E7AD7F29ABCAF48, double %.1)
  br label %191

191:                                              ; preds = %168
  %192 = add nsw i32 %storemerge1, 1
  br label %166, !llvm.loop !9

193:                                              ; preds = %166
  %194 = call double @fmod(double noundef %.1, double noundef f0x401921FB54442D18) #4
  %195 = fsub double %194, %66
  %196 = call double @sin(double noundef %195) #4
  %197 = call double @llvm.fmuladd.f64(double %50, double %196, double %195)
  br label %198

198:                                              ; preds = %213, %193
  %.0134 = phi double [ %197, %193 ], [ %206, %213 ]
  %.0 = phi i32 [ 0, %193 ], [ %207, %213 ]
  %199 = fsub double %195, %.0134
  %200 = call double @sin(double noundef %.0134) #4
  %201 = call double @llvm.fmuladd.f64(double %50, double %200, double %199)
  %202 = call double @cos(double noundef %.0134) #4
  %203 = fneg double %50
  %204 = call double @llvm.fmuladd.f64(double %203, double %202, double 1.000000e+00)
  %205 = fdiv double %201, %204
  %206 = fadd double %.0134, %205
  %207 = add nsw i32 %.0, 1
  %208 = icmp sgt i32 %.0, 8
  br i1 %208, label %212, label %209

209:                                              ; preds = %198
  %210 = call double @llvm.fabs.f64(double %205)
  %211 = fcmp olt double %210, f0x3D719799812DEA11
...
214:                                              ; preds = %212
  %215 = fmul double %206, 5.000000e-01
  ...
  %255 = fdiv double %165, %254
  %256 = fmul double %81, 5.000000e-01
...
8:                                                ; preds = %16, %7
  %storemerge = phi i32 [ 1, %7 ], [ %17, %16 ]
  %9 = icmp slt i32 %storemerge, %0
...
20:                                               ; preds = %40, %19
  %storemerge1 = phi i32 [ 0, %19 ], [ %41, %40 ]
  %21 = icmp slt i32 %storemerge1, 20
...
24:                                               ; preds = %37, %22
  %storemerge3 = phi i32 [ 0, %22 ], [ %38, %37 ]
  %25 = icmp slt i32 %storemerge3, 36525
...
29:                                               ; preds = %34, %26
  %storemerge4 = phi i32 [ 0, %26 ], [ %35, %34 ]
  %30 = icmp slt i32 %storemerge4, 8
  br i1 %30, label %31, label %36

31:                                               ; preds = %29
  call void @planetpv(ptr noundef nonnull %3, i32 noundef %storemerge4, ptr noundef nonnull %4)
  %32 = sext i32 %storemerge4 to i64
  %33 = getelementptr inbounds [24 x i8], ptr %5, i64 %32
...
43:                                               ; preds = %58, %42
  %storemerge2 = phi i32 [ 0, %42 ], [ %59, %58 ]
  %44 = icmp slt i32 %storemerge2, 8
  br i1 %44, label %45, label %60

45:                                               ; preds = %43
  %46 = sext i32 %storemerge2 to i64
  %47 = getelementptr inbounds [24 x i8], ptr %5, i64 %46
  %48 = load double, ptr %47, align 8
  %49 = sext i32 %storemerge2 to i64
  %50 = getelementptr inbounds [24 x i8], ptr %5, i64 %49
  %51 = getelementptr inbounds nuw i8, ptr %50, i64 8
  %52 = load double, ptr %51, align 8
  %53 = sext i32 %storemerge2 to i64
  %54 = getelementptr inbounds [24 x i8], ptr %5, i64 %53
