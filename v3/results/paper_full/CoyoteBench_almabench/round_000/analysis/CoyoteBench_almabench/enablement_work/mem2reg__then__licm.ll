...
120:                                              ; preds = %118
  ...
  %139 = call double @llvm.fmuladd.f64(double %138, double f0x3E7AD7F29ABCAF48, double %.02)
...
153:                                              ; preds = %118
  %.02.lcssa = phi double [ %.02, %118 ]
  %.01.lcssa = phi double [ %.01, %118 ]
  ...
  %172 = call double @llvm.fmuladd.f64(double %171, double f0x3E7AD7F29ABCAF48, double %.02.lcssa)
...
179:                                              ; preds = %198, %153
  ...
  %.1 = phi double [ %.01.lcssa, %153 ], [ %197, %198 ]
...
200:                                              ; preds = %179
  %.1.lcssa = phi double [ %.1, %179 ]
  %201 = call double @fmod(double noundef %.1.lcssa, double noundef f0x401921FB54442D18) #4
...
206:                                              ; preds = %220, %200
  ...
  %208 = call double @sin(double noundef %.0) #4
  %209 = call double @llvm.fmuladd.f64(double %54, double %208, double %207)
  %210 = call double @cos(double noundef %.0) #4
