...
define dso_local void @planetpv(ptr noundef %0, i32 noundef %1, ptr noundef %2) #0 {
  ...
  br i1 true, label %.lr.ph, label %218
...
214:                                              ; preds = %151
  ...
  %217 = icmp slt i32 %215, 7
  br i1 %217, label %151, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %214
  br label %218

218:                                              ; preds = %._crit_edge, %3
  ...
  br i1 true, label %.lr.ph2, label %284

.lr.ph2:                                          ; preds = %218
  br label %246

246:                                              ; preds = %.lr.ph2, %280
...
280:                                              ; preds = %246
  ...
  %283 = icmp slt i32 %281, 9
  br i1 %283, label %246, label %._crit_edge3, !llvm.loop !9

._crit_edge3:                                     ; preds = %280
  br label %284

284:                                              ; preds = %._crit_edge3, %218
...
28:                                               ; preds = %27, %2
  ...
  br i1 true, label %.lr.ph6, label %52
...
29:                                               ; preds = %.lr.ph6, %48
  ...
  store i32 0, ptr %6, align 4
  br i1 true, label %.lr.ph3, label %47
...
31:                                               ; preds = %.lr.ph3, %43
  ...
  br i1 true, label %.lr.ph1, label %42
...
38:                                               ; preds = %34
  ...
  br i1 %41, label %34, label %._crit_edge, !llvm.loop !11
...
43:                                               ; preds = %42
  ...
  %46 = icmp slt i32 %44, 36524
  br i1 %46, label %31, label %._crit_edge4, !llvm.loop !12

._crit_edge4:                                     ; preds = %43
  br label %47

47:                                               ; preds = %._crit_edge4, %29
  br label %48
...
48:                                               ; preds = %47
  ...
  br i1 %51, label %29, label %._crit_edge7, !llvm.loop !13

._crit_edge7:                                     ; preds = %48
  br label %52

52:                                               ; preds = %._crit_edge7, %28
  store i32 0, ptr %7, align 4
...
68:                                               ; preds = %53
  ...
  %71 = icmp slt i32 %69, 7
  br i1 %71, label %53, label %._crit_edge10, !llvm.loop !14

._crit_edge10:                                    ; preds = %68
  br label %72

72:                                               ; preds = %._crit_edge10, %52
