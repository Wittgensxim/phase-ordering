...
108:                                              ; preds = %3, %108
  %109 = phi i32 [ 0, %3 ], [ %143, %108 ]
  %110 = phi double [ %56, %3 ], [ %131, %108 ]
  %111 = phi double [ %66, %3 ], [ %142, %108 ]
  ...
  br i1 %144, label %108, label %145, !llvm.loop !7

145:                                              ; preds = %108
  %.lcssa4 = phi double [ %142, %108 ]
  %.lcssa3 = phi double [ %131, %108 ]
  %146 = getelementptr inbounds [8 x [9 x double]], ptr @kp, i64 0, i64 %48
  %147 = getelementptr inbounds [9 x double], ptr %146, i64 0, i64 8
  %148 = load double, ptr %147, align 8
  %149 = fmul double %148, %107
  store double %149, ptr %18, align 8
  %150 = getelementptr inbounds [8 x [9 x double]], ptr @ca, i64 0, i64 %48
  %151 = getelementptr inbounds [9 x double], ptr %150, i64 0, i64 8
  %152 = load double, ptr %151, align 8
  %153 = call double @cos(double noundef %149) #4
  %154 = getelementptr inbounds [8 x [9 x double]], ptr @sa, i64 0, i64 %48
  %155 = getelementptr inbounds [9 x double], ptr %154, i64 0, i64 8
  %156 = load double, ptr %155, align 8
  %157 = call double @sin(double noundef %149) #4
  %158 = fmul double %156, %157
  %159 = call double @llvm.fmuladd.f64(double %152, double %153, double %158)
  %160 = fmul double %47, %159
  %161 = call double @llvm.fmuladd.f64(double %160, double f0x3E7AD7F29ABCAF48, double %.lcssa3)
  store double %161, ptr %11, align 8
  store i32 8, ptr %9, align 4
  br label %162

162:                                              ; preds = %145, %162
  %163 = phi i32 [ 8, %145 ], [ %182, %162 ]
  %164 = phi double [ %.lcssa4, %145 ], [ %181, %162 ]
  %165 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %48
  %166 = sext i32 %163 to i64
  %167 = getelementptr inbounds [10 x double], ptr %165, i64 0, i64 %166
  %168 = load double, ptr %167, align 8
  %169 = fmul double %168, %107
  store double %169, ptr %19, align 8
  %170 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %48
  %171 = getelementptr inbounds [10 x double], ptr %170, i64 0, i64 %166
  %172 = load double, ptr %171, align 8
  %173 = call double @cos(double noundef %169) #4
  %174 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %48
  %175 = getelementptr inbounds [10 x double], ptr %174, i64 0, i64 %166
  %176 = load double, ptr %175, align 8
  %177 = call double @sin(double noundef %169) #4
  %178 = fmul double %176, %177
  %179 = call double @llvm.fmuladd.f64(double %172, double %173, double %178)
  %180 = fmul double %47, %179
  %181 = call double @llvm.fmuladd.f64(double %180, double f0x3E7AD7F29ABCAF48, double %164)
  store double %181, ptr %12, align 8
  %182 = add nsw i32 %163, 1
  store i32 %182, ptr %9, align 4
  %183 = icmp sle i32 %182, 9
  br i1 %183, label %162, label %184, !llvm.loop !9

184:                                              ; preds = %162
  %.lcssa2 = phi double [ %181, %162 ]
  %185 = call double @fmod(double noundef %.lcssa2, double noundef f0x401921FB54442D18) #4
  store double %185, ptr %12, align 8
  %186 = fsub double %185, %85
  store double %186, ptr %20, align 8
  %187 = call double @sin(double noundef %186) #4
  %188 = call double @llvm.fmuladd.f64(double %74, double %187, double %186)
...
197:                                              ; preds = %209
  %198 = phi i32 [ %210, %209 ]
  %199 = phi double [ %211, %209 ]
  %200 = fsub double %186, %199
  %201 = call double @sin(double noundef %199) #4
  %202 = call double @llvm.fmuladd.f64(double %74, double %201, double %200)
  %203 = call double @cos(double noundef %199) #4
  %204 = call double @llvm.fmuladd.f64(double %193, double %203, double 1.000000e+00)
...
209:                                              ; preds = %184, %197
  %210 = phi i32 [ 1, %184 ], [ %207, %197 ]
  %211 = phi double [ %196, %184 ], [ %206, %197 ]
  %212 = phi double [ %195, %184 ], [ %205, %197 ]
  %213 = call double @llvm.fabs.f64(double %212)
  %214 = fcmp olt double %213, f0x3D719799812DEA11
  br i1 %214, label %215, label %197

215:                                              ; preds = %209, %197
  %.lcssa1 = phi double [ %193, %209 ], [ %193, %197 ]
  %.lcssa = phi double [ %211, %209 ], [ %206, %197 ]
...
22:                                               ; preds = %15
  ...
  br i1 %24, label %15, label %.loopexit, !llvm.loop !10
...
34:                                               ; preds = %30, %34
  ...
  br i1 %39, label %34, label %40, !llvm.loop !11
...
47:                                               ; preds = %46, %47
  ...
  br i1 %58, label %47, label %59, !llvm.loop !14
