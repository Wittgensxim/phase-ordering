...
153:                                              ; preds = %106
  ...
  %172 = call double @llvm.fmuladd.f64(double %171, double f0x3E7AD7F29ABCAF48, double %.02)
  br label %173
...
175:                                              ; preds = %173
  ...
  %197 = call double @llvm.fmuladd.f64(double %196, double f0x3E7AD7F29ABCAF48, double %.1)
  br label %198
...
200:                                              ; preds = %173
  %201 = call double @fmod(double noundef %.1, double noundef f0x401921FB54442D18) #4
