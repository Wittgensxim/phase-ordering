...
.loopexit:                                        ; preds = %26, %16, %2
  store i32 0, ptr %6, align 4
  br label %30

30:                                               ; preds = %60, %.loopexit
...
33:                                               ; preds = %30
  ...
  store double f0x4142B42C80000000, ptr %34, align 16
...
39:                                               ; preds = %36
  %40 = getelementptr inbounds [2 x double], ptr %9, i64 0, i64 0
...
67:                                               ; preds = %64
  ...
  %83 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %72, double noundef %77, double noundef %82)
