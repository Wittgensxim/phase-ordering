...
106:                                              ; preds = %108, %3
  %.0177 = phi double [ %40, %3 ], [ %150, %108 ]
  %.0176 = phi double [ %24, %3 ], [ %135, %108 ]
  %.0 = phi i32 [ 0, %3 ], [ %151, %108 ]
...
152:                                              ; preds = %106
  ...
  %171 = call double @llvm.fmuladd.f64(double %170, double f0x3E7AD7F29ABCAF48, double %.0176)
  br label %172

172:                                              ; preds = %174, %152
  %.1178 = phi double [ %.0177, %152 ], [ %196, %174 ]
  %.1 = phi i32 [ 8, %152 ], [ %197, %174 ]
  %173 = icmp sle i32 %.1, 9
...
174:                                              ; preds = %172
  ...
  %196 = call double @llvm.fmuladd.f64(double %195, double f0x3E7AD7F29ABCAF48, double %.1178)
  %197 = add nsw i32 %.1, 1
  br label %172, !llvm.loop !9

198:                                              ; preds = %172
  %199 = call double @fmod(double noundef %.1178, double noundef f0x401921FB54442D18) #4
...
216:                                              ; preds = %203
  ...
  %222 = call double @sin(double noundef %217) #4
  %223 = fmul double %221, %222
  %224 = call double @cos(double noundef %217) #4
  %225 = call double @atan2(double noundef %223, double noundef %224) #4
  %226 = fmul double 2.000000e+00, %225
  %227 = call double @cos(double noundef %211) #4
  %228 = fneg double %54
  ...
  %278 = fmul double %275, f0x3FD9752E50F4B399
  %279 = fneg double %278
  ...
  %283 = fmul double %275, f0x3FED5C0357681EF3
  %284 = call double @llvm.fmuladd.f64(double %272, double f0x3FD9752E50F4B399, double %283)
  ...
  %306 = fmul double %303, f0x3FD9752E50F4B399
  %307 = fneg double %306
  %308 = call double @llvm.fmuladd.f64(double %298, double f0x3FED5C0357681EF3, double %307)
  ...
  %311 = fmul double %303, f0x3FED5C0357681EF3
  %312 = call double @llvm.fmuladd.f64(double %298, double f0x3FD9752E50F4B399, double %311)
...
7:                                                ; preds = %2, %14
  %.018 = phi i32 [ %15, %14 ], [ 1, %2 ]
  %8 = icmp slt i32 %.018, %0
...
17:                                               ; preds = %40, %16
  %.119 = phi i32 [ 0, %16 ], [ %41, %40 ]
  %18 = icmp slt i32 %.119, 20
  br i1 %18, label %19, label %42

19:                                               ; preds = %17
  %20 = getelementptr inbounds [2 x double], ptr %3, i64 0, i64 0
  store double f0x4142B42C80000000, ptr %20, align 16
  %21 = getelementptr inbounds [2 x double], ptr %3, i64 0, i64 1
  store double 0.000000e+00, ptr %21, align 8
  br label %22

22:                                               ; preds = %38, %19
  %.017 = phi i32 [ 0, %19 ], [ %39, %38 ]
  %23 = icmp slt i32 %.017, 36525
