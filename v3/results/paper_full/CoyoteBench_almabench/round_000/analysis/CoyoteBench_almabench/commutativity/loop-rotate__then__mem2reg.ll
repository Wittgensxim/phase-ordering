...
107:                                              ; preds = %.lr.ph, %150
  %.07 = phi i32 [ 0, %.lr.ph ], [ %151, %150 ]
  %.05 = phi double [ %24, %.lr.ph ], [ %134, %150 ]
  %.04 = phi double [ %40, %.lr.ph ], [ %149, %150 ]
  ...
  %134 = call double @llvm.fmuladd.f64(double %133, double f0x3E7AD7F29ABCAF48, double %.05)
  ...
  %149 = call double @llvm.fmuladd.f64(double %148, double f0x3E7AD7F29ABCAF48, double %.04)
  br label %150
...
153:                                              ; preds = %._crit_edge, %3
  %.16 = phi double [ %134, %._crit_edge ], [ %24, %3 ]
  %.1 = phi double [ %149, %._crit_edge ], [ %40, %3 ]
  ...
  %172 = call double @llvm.fmuladd.f64(double %171, double f0x3E7AD7F29ABCAF48, double %.16)
...
174:                                              ; preds = %.lr.ph2, %197
  %.18 = phi i32 [ 8, %.lr.ph2 ], [ %198, %197 ]
  %.2 = phi double [ %.1, %.lr.ph2 ], [ %196, %197 ]
  ...
  %196 = call double @llvm.fmuladd.f64(double %195, double f0x3E7AD7F29ABCAF48, double %.2)
  br label %197

197:                                              ; preds = %174
  %198 = add nsw i32 %.18, 1
...
200:                                              ; preds = %._crit_edge3, %153
  %.3 = phi double [ %196, %._crit_edge3 ], [ %.1, %153 ]
