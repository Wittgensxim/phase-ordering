...
.lr.ph:                                           ; preds = %3, %.lr.ph
  ...
  store double %240, ptr %12, align 8
  %241 = load i32, ptr %9, align 4
  %242 = add nsw i32 %241, 1
  store i32 %242, ptr %9, align 4
  %243 = load i32, ptr %9, align 4
  %244 = icmp slt i32 %243, 8
  br i1 %244, label %.lr.ph, label %._crit_edge, !llvm.loop !7
...
._crit_edge:                                      ; preds = %.lr.ph, %3
  ...
  br i1 %273, label %.lr.ph2, label %._crit_edge3

.lr.ph2:                                          ; preds = %._crit_edge, %.lr.ph2
  %274 = load i32, ptr %5, align 4
  %275 = sext i32 %274 to i64
  %276 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %275
  %277 = load i32, ptr %9, align 4
  %278 = sext i32 %277 to i64
  %279 = getelementptr inbounds [10 x double], ptr %276, i64 0, i64 %278
  ...
  %287 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %286
  %288 = load i32, ptr %9, align 4
  %289 = sext i32 %288 to i64
  %290 = getelementptr inbounds [10 x double], ptr %287, i64 0, i64 %289
  %291 = load double, ptr %290, align 8
  %292 = load double, ptr %19, align 8
  %293 = call double @cos(double noundef %292) #4
  %294 = load i32, ptr %5, align 4
  %295 = sext i32 %294 to i64
  %296 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %295
  %297 = load i32, ptr %9, align 4
  %298 = sext i32 %297 to i64
  %299 = getelementptr inbounds [10 x double], ptr %296, i64 0, i64 %298
  %300 = load double, ptr %299, align 8
  %301 = load double, ptr %19, align 8
  %302 = call double @sin(double noundef %301) #4
  %303 = fmul double %300, %302
  %304 = call double @llvm.fmuladd.f64(double %291, double %293, double %303)
  %305 = fmul double %284, %304
  %306 = call double @llvm.fmuladd.f64(double %305, double f0x3E7AD7F29ABCAF48, double %283)
  store double %306, ptr %12, align 8
  %307 = load i32, ptr %9, align 4
  %308 = add nsw i32 %307, 1
  store i32 %308, ptr %9, align 4
  %309 = load i32, ptr %9, align 4
  %310 = icmp sle i32 %309, 9
  br i1 %310, label %.lr.ph2, label %._crit_edge3, !llvm.loop !9
...
._crit_edge3:                                     ; preds = %.lr.ph2, %._crit_edge
  ...
  store double %320, ptr %21, align 8
  store i32 0, ptr %9, align 4
  br label %321

321:                                              ; preds = %342, %._crit_edge3
...
346:                                              ; preds = %321, %342
  ...
  store double %361, ptr %24, align 8
  ...
  store double %368, ptr %25, align 8
  ...
  %411 = load double, ptr %13, align 8
  %412 = fneg double %410
  ...
  store double %425, ptr %36, align 8
  ...
  %435 = load double, ptr %28, align 8
  %436 = fmul double %434, %435
  store double %436, ptr %38, align 8
  ...
  store double %443, ptr %39, align 8
  ...
  store double %455, ptr %41, align 8
  %456 = load double, ptr %39, align 8
  ...
  %468 = load double, ptr %40, align 8
  %469 = load double, ptr %41, align 8
  ...
  %481 = load double, ptr %38, align 8
  ...
  store double %485, ptr %39, align 8
  ...
  %492 = load double, ptr %37, align 8
  %493 = load double, ptr %38, align 8
  ...
  store double %498, ptr %40, align 8
  %499 = load double, ptr %26, align 8
  %500 = load double, ptr %35, align 8
  ...
  store double %509, ptr %41, align 8
  ...
  %515 = load double, ptr %41, align 8
  ...
  %522 = load double, ptr %40, align 8
  %523 = load double, ptr %41, align 8
...
25:                                               ; preds = %.lr.ph
  ...
  br i1 %30, label %.lr.ph, label %.loopexit, !llvm.loop !10

.loopexit:                                        ; preds = %24, %25, %15, %2
  store i32 0, ptr %6, align 4
  %31 = load i32, ptr %6, align 4
  %32 = icmp slt i32 %31, 20
  br i1 %32, label %.lr.ph6, label %._crit_edge7

.lr.ph6:                                          ; preds = %.loopexit, %._crit_edge4
  %33 = getelementptr inbounds [2 x double], ptr %9, i64 0, i64 0
  store double f0x4142B42C80000000, ptr %33, align 16
  %34 = getelementptr inbounds [2 x double], ptr %9, i64 0, i64 1
  store double 0.000000e+00, ptr %34, align 8
  store i32 0, ptr %7, align 4
  %35 = load i32, ptr %7, align 4
  %36 = icmp slt i32 %35, 36525
  br i1 %36, label %.lr.ph3, label %._crit_edge4

.lr.ph3:                                          ; preds = %.lr.ph6, %._crit_edge
  ...
  br i1 %41, label %.lr.ph1, label %._crit_edge

.lr.ph1:                                          ; preds = %.lr.ph3, %.lr.ph1
  %42 = getelementptr inbounds [2 x double], ptr %9, i64 0, i64 0
  %43 = load i32, ptr %8, align 4
  %44 = getelementptr inbounds [2 x [3 x double]], ptr %10, i64 0, i64 0
  call void @planetpv(ptr noundef %42, i32 noundef %43, ptr noundef %44)
  %45 = getelementptr inbounds [2 x [3 x double]], ptr %10, i64 0, i64 0
  ...
  call void @radecdist(ptr noundef %45, ptr noundef %49)
  %50 = load i32, ptr %8, align 4
  %51 = add nsw i32 %50, 1
  store i32 %51, ptr %8, align 4
  %52 = load i32, ptr %8, align 4
  %53 = icmp slt i32 %52, 8
  br i1 %53, label %.lr.ph1, label %._crit_edge, !llvm.loop !11

._crit_edge:                                      ; preds = %.lr.ph3, %.lr.ph1
  %54 = load i32, ptr %7, align 4
  %55 = add nsw i32 %54, 1
  store i32 %55, ptr %7, align 4
  %56 = load i32, ptr %7, align 4
  %57 = icmp slt i32 %56, 36525
  br i1 %57, label %.lr.ph3, label %._crit_edge4, !llvm.loop !12

._crit_edge4:                                     ; preds = %.lr.ph6, %._crit_edge
  %58 = load i32, ptr %6, align 4
  %59 = add nsw i32 %58, 1
  store i32 %59, ptr %6, align 4
  %60 = load i32, ptr %6, align 4
  %61 = icmp slt i32 %60, 20
  br i1 %61, label %.lr.ph6, label %._crit_edge7, !llvm.loop !13

._crit_edge7:                                     ; preds = %._crit_edge4, %.loopexit
  store i32 0, ptr %8, align 4
  %62 = load i32, ptr %8, align 4
  %63 = icmp slt i32 %62, 8
  br i1 %63, label %.lr.ph9, label %._crit_edge10

.lr.ph9:                                          ; preds = %._crit_edge7, %.lr.ph9
  ...
  %79 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %68, double noundef %73, double noundef %78)
  %80 = load i32, ptr %8, align 4
  %81 = add nsw i32 %80, 1
  store i32 %81, ptr %8, align 4
  %82 = load i32, ptr %8, align 4
  %83 = icmp slt i32 %82, 8
  br i1 %83, label %.lr.ph9, label %._crit_edge10, !llvm.loop !14

._crit_edge10:                                    ; preds = %.lr.ph9, %._crit_edge7
