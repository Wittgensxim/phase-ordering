...
106:                                              ; preds = %3, %149
  ...
  %133 = call double @llvm.fmuladd.f64(double %132, double f0x3E7AD7F29ABCAF48, double %.026)
  ...
  %148 = call double @llvm.fmuladd.f64(double %147, double f0x3E7AD7F29ABCAF48, double %.017)
  br label %149
...
152:                                              ; preds = %149
  ...
  %171 = call double @llvm.fmuladd.f64(double %170, double f0x3E7AD7F29ABCAF48, double %.02.lcssa)
  br label %172
...
172:                                              ; preds = %152, %195
  ...
  %194 = call double @llvm.fmuladd.f64(double %193, double f0x3E7AD7F29ABCAF48, double %.19)
  br label %195
...
198:                                              ; preds = %195
  ...
  %199 = call double @fmod(double noundef %.1.lcssa, double noundef f0x401921FB54442D18) #4
...
211:                                              ; preds = %221
  ...
  %213 = call double @sin(double noundef %.0) #4
  %214 = call double @llvm.fmuladd.f64(double %54, double %213, double %212)
  %215 = call double @cos(double noundef %.0) #4
