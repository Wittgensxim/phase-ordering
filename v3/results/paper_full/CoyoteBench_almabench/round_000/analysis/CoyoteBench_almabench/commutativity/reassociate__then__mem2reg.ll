...
106:                                              ; preds = %151, %3
  %.04 = phi double [ %24, %3 ], [ %135, %151 ]
  %.02 = phi double [ %40, %3 ], [ %150, %151 ]
  %.01 = phi i32 [ 0, %3 ], [ %152, %151 ]
  %107 = icmp slt i32 %.01, 8
...
108:                                              ; preds = %106
  ...
  %135 = call double @llvm.fmuladd.f64(double %134, double f0x3E7AD7F29ABCAF48, double %.04)
  ...
  %150 = call double @llvm.fmuladd.f64(double %149, double f0x3E7AD7F29ABCAF48, double %.02)
  br label %151
...
153:                                              ; preds = %106
  ...
  %172 = call double @llvm.fmuladd.f64(double %171, double f0x3E7AD7F29ABCAF48, double %.04)
  br label %173

173:                                              ; preds = %198, %153
  %.13 = phi double [ %.02, %153 ], [ %197, %198 ]
...
175:                                              ; preds = %173
  ...
  %197 = call double @llvm.fmuladd.f64(double %196, double f0x3E7AD7F29ABCAF48, double %.13)
  br label %198
...
200:                                              ; preds = %173
  %201 = call double @fmod(double noundef %.13, double noundef f0x401921FB54442D18) #4
