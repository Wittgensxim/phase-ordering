...
70:                                               ; preds = %104, %3
  %.03 = phi i32 [ 0, %3 ], [ %105, %104 ]
  %.02 = phi double [ %18, %3 ], [ %92, %104 ]
  %.01 = phi double [ %28, %3 ], [ %103, %104 ]
...
106:                                              ; preds = %70
  ...
  %122 = call double @llvm.fmuladd.f64(double %121, double f0x3E7AD7F29ABCAF48, double %.02)
  br label %123

123:                                              ; preds = %143, %106
  %.14 = phi i32 [ 8, %106 ], [ %144, %143 ]
  %.1 = phi double [ %.01, %106 ], [ %142, %143 ]
  %124 = icmp sle i32 %.14, 9
...
125:                                              ; preds = %123
  ...
  %142 = call double @llvm.fmuladd.f64(double %141, double f0x3E7AD7F29ABCAF48, double %.1)
  br label %143

143:                                              ; preds = %125
  %144 = add nsw i32 %.14, 1
  br label %123, !llvm.loop !9

145:                                              ; preds = %123
  %146 = call double @fmod(double noundef %.1, double noundef f0x401921FB54442D18) #4
...
25:                                               ; preds = %38, %23
  %.01 = phi i32 [ 0, %23 ], [ %39, %38 ]
  %26 = icmp slt i32 %.01, 36525
