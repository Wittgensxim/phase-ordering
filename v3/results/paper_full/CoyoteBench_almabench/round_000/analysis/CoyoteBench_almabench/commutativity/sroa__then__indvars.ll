...
100:                                              ; preds = %138, %3
  ...
  %.0177 = phi double [ %40, %3 ], [ %137, %138 ]
  %.0176 = phi double [ %24, %3 ], [ %124, %138 ]
...
101:                                              ; preds = %100
  ...
  %124 = call double @llvm.fmuladd.f64(double %123, double f0x3E7AD7F29ABCAF48, double %.0176)
...
139:                                              ; preds = %100
  %.0177.lcssa = phi double [ %.0177, %100 ]
  %.0176.lcssa = phi double [ %.0176, %100 ]
...
155:                                              ; preds = %176, %139
  %indvars.iv181 = phi i64 [ %indvars.iv.next182, %176 ], [ 8, %139 ]
  %.1178 = phi double [ %.0177.lcssa, %139 ], [ %175, %176 ]
  %exitcond184 = icmp ne i64 %indvars.iv181, 10
  br i1 %exitcond184, label %156, label %177

156:                                              ; preds = %155
  %157 = sext i32 %1 to i64
  %158 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %157
  %159 = getelementptr inbounds [10 x double], ptr %158, i64 0, i64 %indvars.iv181
  %160 = load double, ptr %159, align 8
  %161 = fmul double %160, %99
  %162 = sext i32 %1 to i64
  %163 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %162
  %164 = getelementptr inbounds [10 x double], ptr %163, i64 0, i64 %indvars.iv181
  ...
  %169 = getelementptr inbounds [10 x double], ptr %168, i64 0, i64 %indvars.iv181
  ...
  %175 = call double @llvm.fmuladd.f64(double %174, double f0x3E7AD7F29ABCAF48, double %.1178)
  br label %176
...
177:                                              ; preds = %155
  %.1178.lcssa = phi double [ %.1178, %155 ]
  ...
  %187 = call double @llvm.fmuladd.f64(double %186, double f0x3E7AD7F29ABCAF48, double %.0176.lcssa)
  %188 = call double @fmod(double noundef %.1178.lcssa, double noundef f0x401921FB54442D18) #4
...
192:                                              ; preds = %206, %177
  %.0179 = phi double [ %191, %177 ], [ %200, %206 ]
  %.2 = phi i32 [ 0, %177 ], [ %201, %206 ]
  %193 = fsub double %189, %.0179
  %194 = call double @sin(double noundef %.0179) #4
  %195 = call double @llvm.fmuladd.f64(double %179, double %194, double %193)
  %196 = call double @cos(double noundef %.0179) #4
  %197 = fneg double %179
  %198 = call double @llvm.fmuladd.f64(double %197, double %196, double 1.000000e+00)
  %199 = fdiv double %195, %198
  %200 = fadd double %.0179, %199
  %201 = add nuw nsw i32 %.2, 1
  %exitcond185 = icmp eq i32 %.2, 9
  br i1 %exitcond185, label %205, label %202
...
20:                                               ; preds = %41, %19
  %.119 = phi i32 [ 0, %19 ], [ %42, %41 ]
  %exitcond23 = icmp ne i32 %.119, 20
  br i1 %exitcond23, label %21, label %43
...
24:                                               ; preds = %38, %21
  %.017 = phi i32 [ 0, %21 ], [ %39, %38 ]
  %exitcond22 = icmp ne i32 %.017, 36525
  br i1 %exitcond22, label %25, label %40
...
29:                                               ; preds = %36, %25
  ...
  %exitcond21 = icmp ne i64 %indvars.iv, 8
  br i1 %exitcond21, label %30, label %37
...
44:                                               ; preds = %55, %43
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %55 ], [ 0, %43 ]
  %exitcond27 = icmp ne i64 %indvars.iv24, 8
  br i1 %exitcond27, label %45, label %56

45:                                               ; preds = %44
  %46 = getelementptr inbounds [8 x [3 x double]], ptr %5, i64 0, i64 %indvars.iv24
  %47 = load double, ptr %46, align 8
  %48 = getelementptr inbounds [8 x [3 x double]], ptr %5, i64 0, i64 %indvars.iv24
  %49 = getelementptr inbounds [3 x double], ptr %48, i64 0, i64 1
  %50 = load double, ptr %49, align 8
  %51 = getelementptr inbounds [8 x [3 x double]], ptr %5, i64 0, i64 %indvars.iv24
