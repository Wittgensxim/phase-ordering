...
118:                                              ; preds = %151, %3
  ...
  %.0176 = phi double [ %24, %3 ], [ %139, %151 ]
  %.0 = phi i32 [ 0, %3 ], [ %152, %151 ]
  %119 = icmp slt i32 %.0, 8
  br i1 %119, label %120, label %153

120:                                              ; preds = %118
  %121 = sext i32 %.0 to i64
  %122 = getelementptr inbounds [9 x double], ptr %107, i64 0, i64 %121
  %123 = load double, ptr %122, align 8
  %124 = fmul double %123, %105
  %125 = sext i32 %.0 to i64
  %126 = getelementptr inbounds [10 x double], ptr %109, i64 0, i64 %125
  %127 = load double, ptr %126, align 8
  %128 = fmul double %127, %105
  %129 = sext i32 %.0 to i64
  %130 = getelementptr inbounds [9 x double], ptr %111, i64 0, i64 %129
  %131 = load double, ptr %130, align 8
  %132 = call double @cos(double noundef %124) #4
  %133 = sext i32 %.0 to i64
  %134 = getelementptr inbounds [9 x double], ptr %113, i64 0, i64 %133
  %135 = load double, ptr %134, align 8
  %136 = call double @sin(double noundef %124) #4
  %137 = fmul double %135, %136
  %138 = call double @llvm.fmuladd.f64(double %131, double %132, double %137)
  %139 = call double @llvm.fmuladd.f64(double %138, double f0x3E7AD7F29ABCAF48, double %.0176)
  %140 = sext i32 %.0 to i64
  %141 = getelementptr inbounds [10 x double], ptr %115, i64 0, i64 %140
...
153:                                              ; preds = %118
  %.0177.lcssa = phi double [ %.0177, %118 ]
  %.0176.lcssa = phi double [ %.0176, %118 ]
  ...
  %172 = call double @llvm.fmuladd.f64(double %171, double f0x3E7AD7F29ABCAF48, double %.0176.lcssa)
  %173 = sext i32 %1 to i64
  %174 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %173
  %175 = sext i32 %1 to i64
  %176 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %175
  %177 = sext i32 %1 to i64
  %178 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %177
  br label %179

179:                                              ; preds = %198, %153
  %.1178 = phi double [ %.0177.lcssa, %153 ], [ %197, %198 ]
  %.1 = phi i32 [ 8, %153 ], [ %199, %198 ]
  %180 = icmp sle i32 %.1, 9
  br i1 %180, label %181, label %200

181:                                              ; preds = %179
  %182 = sext i32 %.1 to i64
  %183 = getelementptr inbounds [10 x double], ptr %174, i64 0, i64 %182
  %184 = load double, ptr %183, align 8
  %185 = fmul double %184, %105
  %186 = sext i32 %.1 to i64
  %187 = getelementptr inbounds [10 x double], ptr %176, i64 0, i64 %186
...
200:                                              ; preds = %179
  %.1178.lcssa = phi double [ %.1178, %179 ]
  %201 = call double @fmod(double noundef %.1178.lcssa, double noundef f0x401921FB54442D18) #4
...
206:                                              ; preds = %220, %200
  ...
  %207 = fsub double %202, %.0179
  %208 = call double @sin(double noundef %.0179) #4
  %209 = call double @llvm.fmuladd.f64(double %54, double %208, double %207)
  %210 = call double @cos(double noundef %.0179) #4
...
219:                                              ; preds = %216, %206
  %.lcssa = phi double [ %213, %216 ], [ %213, %206 ]
  br label %221
...
221:                                              ; preds = %219
  %222 = fdiv double %.lcssa, 2.000000e+00
  ...
  %232 = call double @cos(double noundef %.lcssa) #4
  %233 = fneg double %54
...
30:                                               ; preds = %44, %29
  %.017 = phi i32 [ 0, %29 ], [ %45, %44 ]
  %31 = icmp slt i32 %.017, 36525
