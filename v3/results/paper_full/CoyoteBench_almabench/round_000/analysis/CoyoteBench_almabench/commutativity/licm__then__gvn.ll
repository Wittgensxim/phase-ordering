...
114:                                              ; preds = %121, %3
  %115 = phi double [ %146, %121 ], [ %66, %3 ]
  %116 = phi double [ %137, %121 ], [ %56, %3 ]
  %117 = phi double [ %128, %121 ], [ %.promoted3, %3 ]
  %118 = phi double [ %125, %121 ], [ %.promoted1, %3 ]
  %119 = phi i32 [ %147, %121 ], [ 0, %3 ]
  %120 = icmp slt i32 %119, 8
  br i1 %120, label %121, label %148

121:                                              ; preds = %114
  %122 = sext i32 %119 to i64
  %123 = getelementptr inbounds [9 x double], ptr %108, i64 0, i64 %122
  %124 = load double, ptr %123, align 8
  %125 = fmul double %124, %107
  %126 = getelementptr inbounds [10 x double], ptr %109, i64 0, i64 %122
  %127 = load double, ptr %126, align 8
  %128 = fmul double %127, %107
  %129 = getelementptr inbounds [9 x double], ptr %110, i64 0, i64 %122
  %130 = load double, ptr %129, align 8
  %131 = call double @cos(double noundef %125) #4
  %132 = getelementptr inbounds [9 x double], ptr %111, i64 0, i64 %122
  %133 = load double, ptr %132, align 8
  %134 = call double @sin(double noundef %125) #4
  %135 = fmul double %133, %134
  %136 = call double @llvm.fmuladd.f64(double %130, double %131, double %135)
  %137 = call double @llvm.fmuladd.f64(double %136, double f0x3E7AD7F29ABCAF48, double %116)
  %138 = getelementptr inbounds [10 x double], ptr %112, i64 0, i64 %122
  %139 = load double, ptr %138, align 8
  %140 = call double @cos(double noundef %128) #4
  %141 = getelementptr inbounds [10 x double], ptr %113, i64 0, i64 %122
  %142 = load double, ptr %141, align 8
  %143 = call double @sin(double noundef %128) #4
  %144 = fmul double %142, %143
  %145 = call double @llvm.fmuladd.f64(double %139, double %140, double %144)
  %146 = call double @llvm.fmuladd.f64(double %145, double f0x3E7AD7F29ABCAF48, double %115)
...
148:                                              ; preds = %114
  ...
  %149 = getelementptr inbounds [9 x double], ptr %108, i64 0, i64 8
  %150 = load double, ptr %149, align 8
  %151 = fmul double %150, %107
  store double %151, ptr %18, align 8
  %152 = getelementptr inbounds [9 x double], ptr %110, i64 0, i64 8
  %153 = load double, ptr %152, align 8
  %154 = call double @cos(double noundef %151) #4
  %155 = getelementptr inbounds [9 x double], ptr %111, i64 0, i64 8
  %156 = load double, ptr %155, align 8
  %157 = call double @sin(double noundef %151) #4
  %158 = fmul double %156, %157
  %159 = call double @llvm.fmuladd.f64(double %153, double %154, double %158)
  %160 = fmul double %47, %159
  %161 = call double @llvm.fmuladd.f64(double %160, double f0x3E7AD7F29ABCAF48, double %116)
  store double %161, ptr %11, align 8
  store i32 8, ptr %9, align 4
  br label %162

162:                                              ; preds = %167, %148
  %163 = phi double [ %181, %167 ], [ %115, %148 ]
  %164 = phi double [ %171, %167 ], [ %117, %148 ]
  %165 = phi i32 [ %182, %167 ], [ 8, %148 ]
  %166 = icmp sle i32 %165, 9
  br i1 %166, label %167, label %183

167:                                              ; preds = %162
  %168 = sext i32 %165 to i64
  %169 = getelementptr inbounds [10 x double], ptr %109, i64 0, i64 %168
  %170 = load double, ptr %169, align 8
  %171 = fmul double %170, %107
  %172 = getelementptr inbounds [10 x double], ptr %112, i64 0, i64 %168
  %173 = load double, ptr %172, align 8
  %174 = call double @cos(double noundef %171) #4
  %175 = getelementptr inbounds [10 x double], ptr %113, i64 0, i64 %168
  %176 = load double, ptr %175, align 8
  %177 = call double @sin(double noundef %171) #4
  %178 = fmul double %176, %177
  %179 = call double @llvm.fmuladd.f64(double %173, double %174, double %178)
  %180 = fmul double %47, %179
  %181 = call double @llvm.fmuladd.f64(double %180, double f0x3E7AD7F29ABCAF48, double %163)
  %182 = add nsw i32 %165, 1
  br label %162, !llvm.loop !9

183:                                              ; preds = %162
  store i32 %165, ptr %9, align 4
  store double %164, ptr %19, align 8
  store double %163, ptr %12, align 8
  %184 = call double @fmod(double noundef %163, double noundef f0x401921FB54442D18) #4
  store double %184, ptr %12, align 8
  %185 = fsub double %184, %85
  store double %185, ptr %20, align 8
  %186 = call double @sin(double noundef %185) #4
  %187 = call double @llvm.fmuladd.f64(double %74, double %186, double %185)
...
189:                                              ; preds = %291, %183
  %190 = phi i32 [ %199, %291 ], [ 0, %183 ]
  %191 = phi double [ %198, %291 ], [ %187, %183 ]
  %192 = fsub double %185, %191
  %193 = call double @sin(double noundef %191) #4
  %194 = call double @llvm.fmuladd.f64(double %74, double %193, double %192)
  %195 = call double @cos(double noundef %191) #4
  %196 = call double @llvm.fmuladd.f64(double %188, double %195, double 1.000000e+00)
...
204:                                              ; preds = %201, %189
  ...
  store double %197, ptr %22, align 8
  store i32 %199, ptr %9, align 4
  %205 = fdiv double %198, 2.000000e+00
  store double %205, ptr %23, align 8
  %206 = fadd double 1.000000e+00, %74
  %207 = fsub double 1.000000e+00, %74
  ...
  %213 = call double @atan2(double noundef %211, double noundef %212) #4
  %214 = fmul double 2.000000e+00, %213
  store double %214, ptr %24, align 8
  %215 = call double @cos(double noundef %198) #4
  %216 = call double @llvm.fmuladd.f64(double %188, double %215, double 1.000000e+00)
  %217 = fmul double %161, %216
  store double %217, ptr %25, align 8
  %218 = getelementptr inbounds [8 x double], ptr @amas, i64 0, i64 %48
  %219 = load double, ptr %218, align 8
  %220 = fdiv double 1.000000e+00, %219
  %221 = fadd double 1.000000e+00, %220
  %222 = fmul double %161, %161
  %223 = fmul double %222, %161
  %224 = fdiv double %221, %223
  %225 = call double @sqrt(double noundef %224) #4
  %226 = fmul double f0x3F919D6D51A6B69A, %225
  store double %226, ptr %26, align 8
  %227 = fdiv double %95, 2.000000e+00
  %228 = call double @sin(double noundef %227) #4
  store double %228, ptr %27, align 8
  %229 = call double @cos(double noundef %106) #4
  %230 = fmul double %228, %229
  store double %230, ptr %28, align 8
  %231 = call double @sin(double noundef %106) #4
  %232 = fmul double %228, %231
  store double %232, ptr %29, align 8
  %233 = fadd double %214, %85
  store double %233, ptr %30, align 8
  %234 = call double @sin(double noundef %233) #4
  store double %234, ptr %31, align 8
  %235 = call double @cos(double noundef %233) #4
  store double %235, ptr %32, align 8
  %236 = fmul double %230, %234
  %237 = fneg double %236
  %238 = call double @llvm.fmuladd.f64(double %232, double %235, double %237)
  %239 = fmul double 2.000000e+00, %238
  store double %239, ptr %33, align 8
  %240 = call double @llvm.fmuladd.f64(double %188, double %74, double 1.000000e+00)
  %241 = call double @sqrt(double noundef %240) #4
  %242 = fdiv double %161, %241
  store double %242, ptr %34, align 8
  %243 = call double @cos(double noundef %227) #4
  store double %243, ptr %35, align 8
  %244 = call double @sin(double noundef %85) #4
  %245 = call double @llvm.fmuladd.f64(double %74, double %244, double %234)
  %246 = fmul double %245, %242
  store double %246, ptr %36, align 8
  %247 = call double @cos(double noundef %85) #4
  %248 = call double @llvm.fmuladd.f64(double %74, double %247, double %235)
  %249 = fmul double %248, %242
  store double %249, ptr %37, align 8
  %250 = fmul double 2.000000e+00, %232
  %251 = fmul double %250, %230
  store double %251, ptr %38, align 8
  %252 = fneg double %239
  %253 = call double @llvm.fmuladd.f64(double %252, double %232, double %235)
  %254 = fmul double %217, %253
  store double %254, ptr %39, align 8
  %255 = call double @llvm.fmuladd.f64(double %239, double %230, double %234)
  %256 = fmul double %217, %255
  store double %256, ptr %40, align 8
  %257 = fmul double %252, %243
  %258 = fmul double %217, %257
  store double %258, ptr %41, align 8
  store double %254, ptr %2, align 8
  %259 = fmul double %258, f0x3FD9752E50F4B399
  %260 = fneg double %259
  %261 = call double @llvm.fmuladd.f64(double %256, double f0x3FED5C0357681EF3, double %260)
  %262 = getelementptr inbounds [3 x double], ptr %2, i64 0, i64 1
  store double %261, ptr %262, align 8
  %263 = fmul double %258, f0x3FED5C0357681EF3
  %264 = call double @llvm.fmuladd.f64(double %256, double f0x3FD9752E50F4B399, double %263)
  %265 = getelementptr inbounds [3 x double], ptr %2, i64 0, i64 2
  store double %264, ptr %265, align 8
  %266 = call double @llvm.fmuladd.f64(double %250, double %232, double -1.000000e+00)
  %267 = fmul double %251, %249
  %268 = call double @llvm.fmuladd.f64(double %266, double %246, double %267)
  %269 = fmul double %226, %268
  store double %269, ptr %39, align 8
  %270 = fmul double 2.000000e+00, %230
  %271 = fneg double %270
  %272 = call double @llvm.fmuladd.f64(double %271, double %230, double 1.000000e+00)
  %273 = fmul double %251, %246
  %274 = fneg double %273
  %275 = call double @llvm.fmuladd.f64(double %272, double %249, double %274)
  %276 = fmul double %226, %275
  store double %276, ptr %40, align 8
  %277 = fmul double 2.000000e+00, %243
  %278 = fmul double %230, %249
  %279 = call double @llvm.fmuladd.f64(double %232, double %246, double %278)
  %280 = fmul double %277, %279
  %281 = fmul double %226, %280
  store double %281, ptr %41, align 8
  %282 = load ptr, ptr %6, align 8
  %283 = getelementptr inbounds [3 x double], ptr %282, i64 1
  store double %269, ptr %283, align 8
  %284 = fmul double %281, f0x3FD9752E50F4B399
  %285 = fneg double %284
  %286 = call double @llvm.fmuladd.f64(double %276, double f0x3FED5C0357681EF3, double %285)
  %287 = getelementptr inbounds [3 x double], ptr %283, i64 0, i64 1
  store double %286, ptr %287, align 8
  %288 = fmul double %281, f0x3FED5C0357681EF3
  %289 = call double @llvm.fmuladd.f64(double %276, double f0x3FD9752E50F4B399, double %288)
...
27:                                               ; preds = %26, %2
  ...
  %28 = getelementptr inbounds [2 x double], ptr %9, i64 0, i64 1
  br label %29

29:                                               ; preds = %48, %27
  %.lcssa37.lcssa13 = phi i32 [ %.lcssa37, %48 ], [ undef, %27 ]
  %.lcssa511 = phi i32 [ %34, %48 ], [ undef, %27 ]
  %30 = phi i32 [ %49, %48 ], [ 0, %27 ]
...
33:                                               ; preds = %46, %32
  %.lcssa37 = phi i32 [ %40, %46 ], [ %.lcssa37.lcssa13, %32 ]
...
50:                                               ; preds = %29
  ...
  store i32 %.lcssa37.lcssa13, ptr %8, align 4
