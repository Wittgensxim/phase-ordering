...
106:                                              ; preds = %3, %149
  %.0182 = phi i32 [ 0, %3 ], [ %150, %149 ]
  %.0176181 = phi double [ %24, %3 ], [ %133, %149 ]
  %.0177180 = phi double [ %40, %3 ], [ %148, %149 ]
...
152:                                              ; preds = %149
  ...
  %171 = call double @llvm.fmuladd.f64(double %170, double f0x3E7AD7F29ABCAF48, double %.0176.lcssa)
  br label %172

172:                                              ; preds = %152, %195
  %.1184 = phi i32 [ 8, %152 ], [ %196, %195 ]
  %.1178183 = phi double [ %.0177.lcssa, %152 ], [ %194, %195 ]
  %173 = sext i32 %1 to i64
  %174 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %173
  %175 = sext i32 %.1184 to i64
  ...
  %181 = sext i32 %.1184 to i64
  %182 = getelementptr inbounds [10 x double], ptr %180, i64 0, i64 %181
  %183 = load double, ptr %182, align 8
  %184 = call double @cos(double noundef %178) #4
  %185 = sext i32 %1 to i64
  %186 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %185
  %187 = sext i32 %.1184 to i64
  %188 = getelementptr inbounds [10 x double], ptr %186, i64 0, i64 %187
  %189 = load double, ptr %188, align 8
  %190 = call double @sin(double noundef %178) #4
  %191 = fmul double %189, %190
  %192 = call double @llvm.fmuladd.f64(double %183, double %184, double %191)
  %193 = fmul double %10, %192
  %194 = call double @llvm.fmuladd.f64(double %193, double f0x3E7AD7F29ABCAF48, double %.1178183)
  br label %195

195:                                              ; preds = %172
  %196 = add nsw i32 %.1184, 1
  %197 = icmp sle i32 %196, 9
  br i1 %197, label %172, label %198, !llvm.loop !9

198:                                              ; preds = %195
  %.1178.lcssa = phi double [ %194, %195 ]
  %199 = call double @fmod(double noundef %.1178.lcssa, double noundef f0x401921FB54442D18) #4
...
221:                                              ; preds = %198, %211
  ...
  %226 = fcmp olt double %225, f0x3D719799812DEA11
...
228:                                              ; preds = %227
  ...
  %233 = call double @sqrt(double noundef %232) #4
  %234 = call double @sin(double noundef %229) #4
  %235 = fmul double %233, %234
  %236 = call double @cos(double noundef %229) #4
  %237 = call double @atan2(double noundef %235, double noundef %236) #4
  %238 = fmul double 2.000000e+00, %237
  %239 = call double @cos(double noundef %.lcssa) #4
  %240 = fneg double %54
  ...
  %252 = fmul double f0x3F919D6D51A6B69A, %251
  %253 = fdiv double %87, 2.000000e+00
  %254 = call double @sin(double noundef %253) #4
  %255 = call double @cos(double noundef %104) #4
  %256 = fmul double %254, %255
  %257 = call double @sin(double noundef %104) #4
  %258 = fmul double %254, %257
  %259 = fadd double %238, %71
  %260 = call double @sin(double noundef %259) #4
  %261 = call double @cos(double noundef %259) #4
  ...
  %271 = call double @cos(double noundef %270) #4
  %272 = call double @sin(double noundef %71) #4
  %273 = call double @llvm.fmuladd.f64(double %54, double %272, double %260)
  %274 = fmul double %273, %269
  %275 = call double @cos(double noundef %71) #4
  ...
  %290 = fmul double %287, f0x3FD9752E50F4B399
  %291 = fneg double %290
  %292 = call double @llvm.fmuladd.f64(double %284, double f0x3FED5C0357681EF3, double %291)
  ...
  %295 = fmul double %287, f0x3FED5C0357681EF3
  %296 = call double @llvm.fmuladd.f64(double %284, double f0x3FD9752E50F4B399, double %295)
  ...
  %318 = fmul double %315, f0x3FD9752E50F4B399
  %319 = fneg double %318
  %320 = call double @llvm.fmuladd.f64(double %310, double f0x3FED5C0357681EF3, double %319)
  ...
  %323 = fmul double %315, f0x3FED5C0357681EF3
  %324 = call double @llvm.fmuladd.f64(double %310, double f0x3FD9752E50F4B399, double %323)
...
8:                                                ; preds = %7, %15
  %.01820 = phi i32 [ 1, %7 ], [ %16, %15 ]
  %9 = getelementptr inbounds ptr, ptr %1, i64 1
  %10 = load ptr, ptr %9, align 8
  %11 = call i32 @strcmp(ptr noundef %10, ptr noundef @.str) #4
  %12 = icmp ne i32 %11, 0
...
27:                                               ; preds = %23, %34
  %.021 = phi i32 [ 0, %23 ], [ %35, %34 ]
  %28 = getelementptr inbounds [2 x double], ptr %3, i64 0, i64 0
  %29 = getelementptr inbounds [2 x [3 x double]], ptr %4, i64 0, i64 0
  call void @planetpv(ptr noundef %28, i32 noundef %.021, ptr noundef %29)
  %30 = getelementptr inbounds [2 x [3 x double]], ptr %4, i64 0, i64 0
  %31 = sext i32 %.021 to i64
  %32 = getelementptr inbounds [8 x [3 x double]], ptr %5, i64 0, i64 %31
  %33 = getelementptr inbounds [3 x double], ptr %32, i64 0, i64 0
  call void @radecdist(ptr noundef %30, ptr noundef %33)
  br label %34

34:                                               ; preds = %27
  %35 = add nsw i32 %.021, 1
...
38:                                               ; preds = %37
  %39 = add nsw i32 %.01722, 1
  %40 = icmp slt i32 %39, 36525
  br i1 %40, label %23, label %41, !llvm.loop !12

41:                                               ; preds = %38
  br label %42

42:                                               ; preds = %41
  %43 = add nsw i32 %.11923, 1
