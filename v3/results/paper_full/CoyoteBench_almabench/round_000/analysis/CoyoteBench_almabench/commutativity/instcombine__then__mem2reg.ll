...
99:                                               ; preds = %144, %3
  %.04 = phi double [ %37, %3 ], [ %143, %144 ]
  %.03 = phi double [ %22, %3 ], [ %128, %144 ]
...
101:                                              ; preds = %99
  ...
  %128 = call double @llvm.fmuladd.f64(double %127, double f0x3E7AD7F29ABCAF48, double %.03)
  ...
  %143 = call double @llvm.fmuladd.f64(double %142, double f0x3E7AD7F29ABCAF48, double %.04)
  br label %144
...
146:                                              ; preds = %99
  ...
  %165 = call double @llvm.fmuladd.f64(double %164, double f0x3E7AD7F29ABCAF48, double %.03)
  br label %166

166:                                              ; preds = %191, %146
  %.1 = phi double [ %.04, %146 ], [ %190, %191 ]
...
198:                                              ; preds = %213, %193
  %.02 = phi i32 [ 0, %193 ], [ %207, %213 ]
  %.0 = phi double [ %197, %193 ], [ %206, %213 ]
  %199 = fsub double %195, %.0
  %200 = call double @sin(double noundef %.0) #4
  %201 = call double @llvm.fmuladd.f64(double %50, double %200, double %199)
  %202 = call double @cos(double noundef %.0) #4
  %203 = fneg double %50
  %204 = call double @llvm.fmuladd.f64(double %203, double %202, double 1.000000e+00)
  %205 = fdiv double %201, %204
  %206 = fadd double %.0, %205
  %207 = add nsw i32 %.02, 1
  %208 = icmp sgt i32 %.02, 8
