...
313:                                              ; preds = %313, %298
  %314 = phi i32 [ %.promoted19, %298 ], [ %323, %313 ]
  %315 = phi double [ %.promoted15, %298 ], [ %322, %313 ]
  ...
  %325 = call double @llvm.fabs.f64(double %321)
  %326 = fcmp olt double %325, f0x3D719799812DEA11
  %or.cond = select i1 %324, i1 true, i1 %326
  br i1 %or.cond, label %327, label %313
...
327:                                              ; preds = %313
  ...
  store double %329, ptr %23, align 8
  ...
  %341 = call double @atan2(double noundef %338, double noundef %340) #4
  ...
  %346 = call double @cos(double noundef %345) #4
  %347 = fneg double %344
  %348 = call double @llvm.fmuladd.f64(double %347, double %346, double 1.000000e+00)
  %349 = fmul double %343, %348
  store double %349, ptr %25, align 8
  %350 = load i32, ptr %5, align 4
  %351 = sext i32 %350 to i64
  %352 = getelementptr inbounds [8 x double], ptr @amas, i64 0, i64 %351
  ...
  %362 = call double @sqrt(double noundef %361) #4
  %363 = fmul double f0x3F919D6D51A6B69A, %362
  store double %363, ptr %26, align 8
  %364 = load double, ptr %15, align 8
  %365 = fdiv double %364, 2.000000e+00
  %366 = call double @sin(double noundef %365) #4
  store double %366, ptr %27, align 8
  %367 = load double, ptr %27, align 8
  %368 = load double, ptr %16, align 8
  %369 = call double @cos(double noundef %368) #4
  %370 = fmul double %367, %369
  store double %370, ptr %28, align 8
  ...
  store double %374, ptr %29, align 8
  %375 = load double, ptr %24, align 8
  %376 = load double, ptr %14, align 8
  %377 = fadd double %375, %376
  store double %377, ptr %30, align 8
  ...
  %381 = call double @cos(double noundef %380) #4
  store double %381, ptr %32, align 8
  %382 = load double, ptr %29, align 8
  %383 = load double, ptr %32, align 8
  %384 = load double, ptr %28, align 8
  %385 = load double, ptr %31, align 8
  %386 = fmul double %384, %385
  %387 = fneg double %386
  %388 = call double @llvm.fmuladd.f64(double %382, double %383, double %387)
  %389 = fmul double 2.000000e+00, %388
  store double %389, ptr %33, align 8
  %390 = load double, ptr %11, align 8
  %391 = load double, ptr %13, align 8
  %392 = load double, ptr %13, align 8
  %393 = fneg double %391
  %394 = call double @llvm.fmuladd.f64(double %393, double %392, double 1.000000e+00)
  %395 = call double @sqrt(double noundef %394) #4
  %396 = fdiv double %390, %395
  store double %396, ptr %34, align 8
  %397 = load double, ptr %15, align 8
  %398 = fdiv double %397, 2.000000e+00
  %399 = call double @cos(double noundef %398) #4
  store double %399, ptr %35, align 8
  ...
  %404 = call double @llvm.fmuladd.f64(double %400, double %402, double %403)
  %405 = load double, ptr %34, align 8
  %406 = fmul double %404, %405
  store double %406, ptr %36, align 8
  %407 = load double, ptr %13, align 8
  %408 = load double, ptr %14, align 8
  %409 = call double @cos(double noundef %408) #4
  %410 = load double, ptr %32, align 8
  %411 = call double @llvm.fmuladd.f64(double %407, double %409, double %410)
  ...
  %416 = load double, ptr %28, align 8
  %417 = fmul double %415, %416
  store double %417, ptr %38, align 8
  ...
  store double %424, ptr %39, align 8
  ...
  store double %430, ptr %40, align 8
  %431 = load double, ptr %25, align 8
  %432 = load double, ptr %33, align 8
  %433 = fneg double %432
  %434 = load double, ptr %35, align 8
  %435 = fmul double %433, %434
  %436 = fmul double %431, %435
  store double %436, ptr %41, align 8
  %437 = load double, ptr %39, align 8
  %438 = load ptr, ptr %6, align 8
  %439 = getelementptr inbounds [3 x double], ptr %438, i64 0
  %440 = getelementptr inbounds [3 x double], ptr %439, i64 0, i64 0
  store double %437, ptr %440, align 8
  %441 = load double, ptr %40, align 8
  %442 = load double, ptr %41, align 8
  %443 = fmul double %442, f0x3FD9752E50F4B399
  %444 = fneg double %443
  %445 = call double @llvm.fmuladd.f64(double %441, double f0x3FED5C0357681EF3, double %444)
  %446 = load ptr, ptr %6, align 8
  %447 = getelementptr inbounds [3 x double], ptr %446, i64 0
  %448 = getelementptr inbounds [3 x double], ptr %447, i64 0, i64 1
  store double %445, ptr %448, align 8
  %449 = load double, ptr %40, align 8
  %450 = load double, ptr %41, align 8
  %451 = fmul double %450, f0x3FED5C0357681EF3
  %452 = call double @llvm.fmuladd.f64(double %449, double f0x3FD9752E50F4B399, double %451)
  %453 = load ptr, ptr %6, align 8
  %454 = getelementptr inbounds [3 x double], ptr %453, i64 0
  %455 = getelementptr inbounds [3 x double], ptr %454, i64 0, i64 2
  store double %452, ptr %455, align 8
  %456 = load double, ptr %26, align 8
  %457 = load double, ptr %29, align 8
  %458 = fmul double 2.000000e+00, %457
  %459 = load double, ptr %29, align 8
  %460 = call double @llvm.fmuladd.f64(double %458, double %459, double -1.000000e+00)
  ...
  %466 = fmul double %456, %465
  store double %466, ptr %39, align 8
  %467 = load double, ptr %26, align 8
  %468 = load double, ptr %28, align 8
  %469 = fmul double 2.000000e+00, %468
  %470 = load double, ptr %28, align 8
  %471 = fneg double %469
  %472 = call double @llvm.fmuladd.f64(double %471, double %470, double 1.000000e+00)
  %473 = load double, ptr %37, align 8
  ...
  %479 = fmul double %467, %478
  store double %479, ptr %40, align 8
  ...
  store double %490, ptr %41, align 8
  %491 = load double, ptr %39, align 8
  %492 = load ptr, ptr %6, align 8
  %493 = getelementptr inbounds [3 x double], ptr %492, i64 1
  %494 = getelementptr inbounds [3 x double], ptr %493, i64 0, i64 0
  store double %491, ptr %494, align 8
  %495 = load double, ptr %40, align 8
  %496 = load double, ptr %41, align 8
  %497 = fmul double %496, f0x3FD9752E50F4B399
  %498 = fneg double %497
  %499 = call double @llvm.fmuladd.f64(double %495, double f0x3FED5C0357681EF3, double %498)
  %500 = load ptr, ptr %6, align 8
  %501 = getelementptr inbounds [3 x double], ptr %500, i64 1
  %502 = getelementptr inbounds [3 x double], ptr %501, i64 0, i64 1
  store double %499, ptr %502, align 8
  %503 = load double, ptr %40, align 8
  %504 = load double, ptr %41, align 8
  %505 = fmul double %504, f0x3FED5C0357681EF3
  %506 = call double @llvm.fmuladd.f64(double %503, double f0x3FD9752E50F4B399, double %505)
  %507 = load ptr, ptr %6, align 8
  %508 = getelementptr inbounds [3 x double], ptr %507, i64 1
  %509 = getelementptr inbounds [3 x double], ptr %508, i64 0, i64 2
  store double %506, ptr %509, align 8
  ret void
}
