...
70:                                               ; preds = %72, %3
  %.0177 = phi double [ %28, %3 ], [ %103, %72 ]
  %.0176 = phi double [ %18, %3 ], [ %92, %72 ]
  %.0 = phi i32 [ 0, %3 ], [ %104, %72 ]
  %71 = icmp slt i32 %.0, 8
...
105:                                              ; preds = %70
  ...
  %121 = call double @llvm.fmuladd.f64(double %120, double f0x3E7AD7F29ABCAF48, double %.0176)
  br label %122

122:                                              ; preds = %124, %105
  %.1178 = phi double [ %.0177, %105 ], [ %141, %124 ]
  %.1 = phi i32 [ 8, %105 ], [ %142, %124 ]
  %123 = icmp sle i32 %.1, 9
...
124:                                              ; preds = %122
  ...
  %141 = call double @llvm.fmuladd.f64(double %140, double f0x3E7AD7F29ABCAF48, double %.1178)
  %142 = add nsw i32 %.1, 1
  br label %122, !llvm.loop !9

143:                                              ; preds = %122
  %144 = call double @fmod(double noundef %.1178, double noundef f0x401921FB54442D18) #4
...
20:                                               ; preds = %37, %19
  %.119 = phi i32 [ 0, %19 ], [ %38, %37 ]
  %21 = icmp slt i32 %.119, 20
...
24:                                               ; preds = %35, %22
  %.017 = phi i32 [ 0, %22 ], [ %36, %35 ]
  %25 = icmp slt i32 %.017, 36525
...
35:                                               ; preds = %29
  %36 = add nsw i32 %.017, 1
  br label %24, !llvm.loop !12

37:                                               ; preds = %24
  %38 = add nsw i32 %.119, 1
