...
137:                                              ; preds = %147
  %138 = phi double [ %149, %147 ]
  %139 = fsub double %126, %138
  %140 = call double @sin(double noundef %138) #4
  %141 = call double @llvm.fmuladd.f64(double %124, double %140, double %139)
  %142 = call double @cos(double noundef %138) #4
  %143 = call double @llvm.fmuladd.f64(double %129, double %142, double 1.000000e+00)
  %144 = fdiv double %141, %143
  %145 = fadd double %138, %144
  %146 = add nuw nsw i32 %148, 1
  %exitcond9 = icmp eq i32 %148, 9
  br i1 %exitcond9, label %153, label %147

147:                                              ; preds = %122, %137
  %148 = phi i32 [ 1, %122 ], [ %146, %137 ]
  %149 = phi double [ %136, %122 ], [ %145, %137 ]
  %150 = phi double [ %135, %122 ], [ %144, %137 ]
  %151 = call double @llvm.fabs.f64(double %150)
  %152 = fcmp olt double %151, f0x3D719799812DEA11
  br i1 %152, label %153, label %137

153:                                              ; preds = %147, %137
  %.lcssa = phi double [ %149, %147 ], [ %145, %137 ]
  %154 = fmul double %105, %106
  %155 = call double @llvm.fmuladd.f64(double %102, double %103, double %154)
  %156 = fmul double %9, %155
  %157 = call double @llvm.fmuladd.f64(double %156, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %158 = call double @llvm.fmuladd.f64(double %51, double %9, double %49)
  %159 = fmul double %158, %9
  %160 = call double @llvm.fmuladd.f64(double %47, double 3.600000e+03, double %159)
  %161 = fmul double %160, f0x3ED455A5B2FF8F9D
  %162 = fmul double %.lcssa, 5.000000e-01
  %163 = fadd double %124, 1.000000e+00
  %164 = fsub double 1.000000e+00, %124
  ...
  %173 = call double @llvm.fmuladd.f64(double %129, double %172, double 1.000000e+00)
  %174 = fmul double %157, %173
  %175 = getelementptr inbounds [8 x i8], ptr @amas, i64 %10
  ...
  %186 = call double @cos(double noundef %62) #4
  %187 = fmul double %185, %186
  %188 = call double @sin(double noundef %62) #4
  %189 = fmul double %185, %188
  %190 = fadd double %171, %45
  ...
  %197 = call double @llvm.fmuladd.f64(double %129, double %124, double 1.000000e+00)
  %198 = call double @sqrt(double noundef %197) #4
  %199 = fdiv double %157, %198
  %200 = call double @cos(double noundef %184) #4
  %201 = call double @sin(double noundef %45) #4
  %202 = call double @llvm.fmuladd.f64(double %124, double %201, double %191)
  %203 = fmul double %202, %199
  %204 = call double @cos(double noundef %45) #4
  %205 = call double @llvm.fmuladd.f64(double %124, double %204, double %192)
...
25:                                               ; preds = %21, %25
  %indvars.iv1 = phi i64 [ 0, %21 ], [ %indvars.iv.next, %25 ]
  %26 = trunc nuw nsw i64 %indvars.iv1 to i32
  call void @planetpv(ptr noundef nonnull %3, i32 noundef %26, ptr noundef nonnull %4)
  %27 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %indvars.iv1
  call void @radecdist(ptr noundef nonnull %4, ptr noundef nonnull %27)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
  %exitcond2.not = icmp eq i64 %indvars.iv.next, 8
  br i1 %exitcond2.not, label %28, label %25, !llvm.loop !11

28:                                               ; preds = %25
  %29 = add nuw nsw i32 %22, 1
  %exitcond3.not = icmp eq i32 %29, 36525
  br i1 %exitcond3.not, label %30, label %21, !llvm.loop !12

30:                                               ; preds = %28
  %31 = add nuw nsw i32 %20, 1
  %exitcond4.not = icmp eq i32 %31, 20
  br i1 %exitcond4.not, label %32, label %19, !llvm.loop !13

32:                                               ; preds = %30
  br label %33

33:                                               ; preds = %32, %33
  %indvars.iv52 = phi i64 [ 0, %32 ], [ %indvars.iv.next6, %33 ]
  %34 = getelementptr inbounds nuw [24 x i8], ptr %5, i64 %indvars.iv52
  ...
  br i1 %exitcond8.not, label %41, label %33, !llvm.loop !14
