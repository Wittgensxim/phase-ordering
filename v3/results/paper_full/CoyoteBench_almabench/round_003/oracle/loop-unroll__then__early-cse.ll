...
109:                                              ; preds = %108
  ...
  %122 = call double @llvm.fmuladd.f64(double %121, double f0x3E7AD7F29ABCAF48, double %71)
  br label %123
...
143:                                              ; preds = %123
  ...
  %146 = call double @fmod(double noundef %136, double noundef f0x401921FB54442D18) #4
...
162:                                              ; preds = %349, %341, %338, %327, %316, %305, %294, %283, %272, %261, %159
  ...
  %166 = call double @llvm.fmuladd.f64(double %165, double f0x3E7AD7F29ABCAF48, double %72)
...
20:                                               ; preds = %48, %18
  ...
  br i1 %exitcond4.not, label %50, label %22
...
23:                                               ; preds = %46, %22
  ...
  br i1 %exitcond3.not, label %48, label %25
