...
122:                                              ; preds = %107
  ...
  %125 = call double @fmod(double noundef %121, double noundef f0x401921FB54442D18) #4
...
137:                                              ; preds = %146
  %138 = fsub double %126, %148
  %139 = call double @sin(double noundef %148) #4
  %140 = call double @llvm.fmuladd.f64(double %124, double %139, double %138)
  %141 = call double @cos(double noundef %148) #4
  %142 = call double @llvm.fmuladd.f64(double %129, double %141, double 1.000000e+00)
  %143 = fdiv double %140, %142
  %144 = fadd double %148, %143
  %145 = add nuw nsw i32 %147, 1
  %exitcond9 = icmp eq i32 %147, 9
  br i1 %exitcond9, label %152, label %146

146:                                              ; preds = %122, %137
  %147 = phi i32 [ 1, %122 ], [ %145, %137 ]
  %148 = phi double [ %136, %122 ], [ %144, %137 ]
  %149 = phi double [ %135, %122 ], [ %143, %137 ]
  %150 = call double @llvm.fabs.f64(double %149)
  %151 = fcmp olt double %150, f0x3D719799812DEA11
  br i1 %151, label %152, label %137

152:                                              ; preds = %146, %137
  %.lcssa = phi double [ %148, %146 ], [ %144, %137 ]
  %153 = fmul double %105, %106
  %154 = call double @llvm.fmuladd.f64(double %102, double %103, double %153)
  %155 = fmul double %9, %154
  %156 = call double @llvm.fmuladd.f64(double %155, double f0x3E7AD7F29ABCAF48, double %87)
  ...
  %162 = fadd double %124, 1.000000e+00
  %163 = fsub double 1.000000e+00, %124
  ...
  %172 = call double @llvm.fmuladd.f64(double %129, double %171, double 1.000000e+00)
  ...
  %196 = call double @llvm.fmuladd.f64(double %129, double %124, double 1.000000e+00)
  ...
  %201 = call double @llvm.fmuladd.f64(double %124, double %200, double %190)
  %202 = fmul double %201, %198
  %203 = call double @cos(double noundef %45) #4
  %204 = call double @llvm.fmuladd.f64(double %124, double %203, double %191)
