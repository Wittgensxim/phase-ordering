...
146:                                              ; preds = %143, %132
  ...
  %150 = call double @llvm.fmuladd.f64(double %149, double f0x3E7AD7F29ABCAF48, double %72)
  ...
  %155 = fmul double %141, 5.000000e-01
  ...
  %165 = call double @cos(double noundef %141) #4
