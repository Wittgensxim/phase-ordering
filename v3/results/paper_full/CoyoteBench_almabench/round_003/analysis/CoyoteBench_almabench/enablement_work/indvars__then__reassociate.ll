...
108:                                              ; preds = %110, %98
  ...
  %109 = phi double [ %123, %110 ], [ %.lcssa3, %98 ]
...
124:                                              ; preds = %108
  ...
  %127 = call double @fmod(double noundef %.lcssa1, double noundef f0x401921FB54442D18) #4
...
132:                                              ; preds = %237, %124
  %133 = phi i32 [ %142, %237 ], [ 0, %124 ]
  %134 = phi double [ %141, %237 ], [ %130, %124 ]
  ...
  br i1 %exitcond9, label %146, label %143
...
146:                                              ; preds = %143, %132
  %.lcssa = phi double [ %141, %143 ], [ %141, %132 ]
  %147 = fmul double %106, %107
  %148 = call double @llvm.fmuladd.f64(double %103, double %104, double %147)
  %149 = fmul double %9, %148
  %150 = call double @llvm.fmuladd.f64(double %149, double f0x3E7AD7F29ABCAF48, double %.lcssa2)
  %151 = call double @llvm.fmuladd.f64(double %51, double %9, double %49)
  %152 = fmul double %9, %151
  %153 = call double @llvm.fmuladd.f64(double %47, double 3.600000e+03, double %152)
  %154 = fmul double %153, f0x3ED455A5B2FF8F9D
  %155 = fmul double %.lcssa, 5.000000e-01
  %156 = fadd double %126, 1.000000e+00
  %157 = fsub double 1.000000e+00, %126
  ...
  %165 = call double @cos(double noundef %.lcssa) #4
  %166 = call double @llvm.fmuladd.f64(double %131, double %165, double 1.000000e+00)
  %167 = fmul double %150, %166
  %168 = getelementptr inbounds [8 x i8], ptr @amas, i64 %10
  ...
  %179 = call double @cos(double noundef %62) #4
  %180 = fmul double %178, %179
  %181 = call double @sin(double noundef %62) #4
  %182 = fmul double %178, %181
  %183 = fadd double %45, %164
  ...
  %190 = call double @llvm.fmuladd.f64(double %131, double %126, double 1.000000e+00)
  %191 = call double @sqrt(double noundef %190) #4
  %192 = fdiv double %150, %191
  %193 = call double @cos(double noundef %177) #4
  %194 = call double @sin(double noundef %45) #4
  %195 = call double @llvm.fmuladd.f64(double %126, double %194, double %184)
  %196 = fmul double %192, %195
  %197 = call double @cos(double noundef %45) #4
  %198 = call double @llvm.fmuladd.f64(double %126, double %197, double %185)
  %199 = fmul double %192, %198
  %200 = fmul double %182, 2.000000e+00
  %201 = fmul double %180, %200
  %202 = fneg double %189
...
20:                                               ; preds = %34, %18
  ...
  br i1 %exitcond4.not, label %36, label %22
