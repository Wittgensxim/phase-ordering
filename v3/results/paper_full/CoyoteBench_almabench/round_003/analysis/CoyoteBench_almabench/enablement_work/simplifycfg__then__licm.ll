...
108:                                              ; preds = %110, %98
  ...
  %109 = phi double [ %123, %110 ], [ %.lcssa4, %98 ]
...
124:                                              ; preds = %108
  ...
  %127 = call double @fmod(double noundef %.lcssa2, double noundef f0x401921FB54442D18) #4
...
145:                                              ; preds = %132
  ...
  %164 = call double @cos(double noundef %.lcssa) #4
...
33:                                               ; preds = %.preheader, %34
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %34 ], [ 0, %.preheader ]
