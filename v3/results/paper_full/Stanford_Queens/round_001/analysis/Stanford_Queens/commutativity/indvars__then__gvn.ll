...
8:                                                ; preds = %42, %6
  %9 = phi i32 [ %.pre, %42 ], [ 0, %6 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %42 ], [ 0, %6 ]
  %10 = icmp ne i32 %9, 0
...
15:                                               ; preds = %13
  ...
  store i32 0, ptr %1, align 4
  %16 = getelementptr inbounds i32, ptr %3, i64 %indvars.iv.next
  %17 = load i32, ptr %16, align 4
  %18 = icmp ne i32 %17, 0
  br i1 %18, label %19, label %42

19:                                               ; preds = %15
  %20 = add nsw i64 %7, %indvars.iv.next
...
24:                                               ; preds = %19
  %25 = sub nsw i64 %7, %indvars.iv.next
  %26 = add nsw i64 %25, 7
...
30:                                               ; preds = %24
  %31 = getelementptr inbounds i32, ptr %5, i64 %7
...
34:                                               ; preds = %30
  %35 = add nsw i32 %0, 1
  call void @Try(i32 noundef %35, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5)
...
39:                                               ; preds = %38, %34
  %.pre.pre.pre = phi i32 [ %.pre.pre.pre.pre, %38 ], [ %36, %34 ]
  br label %41
...
41:                                               ; preds = %40, %39
  %.pre.pre = phi i32 [ 1, %40 ], [ %.pre.pre.pre, %39 ]
  br label %42

42:                                               ; preds = %41, %24, %19, %15
  %.pre = phi i32 [ %.pre.pre, %41 ], [ 0, %24 ], [ 0, %19 ], [ 0, %15 ]
