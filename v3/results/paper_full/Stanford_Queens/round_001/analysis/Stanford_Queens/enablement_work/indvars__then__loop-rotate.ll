...
20:                                               ; preds = %16
  %21 = add nsw i64 %7, %indvars.iv.next
...
25:                                               ; preds = %20
  %26 = sub nsw i64 %8, %indvars.iv.next
  %27 = add nsw i64 %26, 7
...
36:                                               ; preds = %31
  %37 = add nsw i32 %0, 1
  call void @Try(i32 noundef %37, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5)
...
6:                                                ; preds = %0, %21
  %indvars.iv2 = phi i64 [ -7, %0 ], [ %indvars.iv.next, %21 ]
  %7 = icmp sge i64 %indvars.iv2, 1
  br i1 %7, label %8, label %12

8:                                                ; preds = %6
  %9 = icmp sle i64 %indvars.iv2, 8
  br i1 %9, label %10, label %12

10:                                               ; preds = %8
  %11 = getelementptr inbounds [9 x i32], ptr %2, i64 0, i64 %indvars.iv2
  store i32 1, ptr %11, align 4
  br label %12

12:                                               ; preds = %10, %8, %6
  %13 = icmp sge i64 %indvars.iv2, 2
  br i1 %13, label %14, label %16

14:                                               ; preds = %12
  %15 = getelementptr inbounds [17 x i32], ptr %3, i64 0, i64 %indvars.iv2
  store i32 1, ptr %15, align 4
  br label %16

16:                                               ; preds = %14, %12
  %17 = icmp sle i64 %indvars.iv2, 7
  br i1 %17, label %18, label %21

18:                                               ; preds = %16
  %19 = add nsw i64 %indvars.iv2, 7
...
21:                                               ; preds = %18, %16
  ...
  br i1 %exitcond, label %6, label %22, !llvm.loop !9
...
3:                                                ; preds = %2
  ...
  %exitcond = icmp ne i32 %4, 51
  br i1 %exitcond, label %2, label %5, !llvm.loop !10
