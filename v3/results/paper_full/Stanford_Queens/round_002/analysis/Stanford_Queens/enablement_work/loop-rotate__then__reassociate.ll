...
define dso_local void @Try(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5) #0 {
  ...
  br i1 %.not5, label %.lr.ph, label %36

.lr.ph:                                           ; preds = %6
  br label %8

8:                                                ; preds = %.lr.ph, %33
  %.06 = phi i32 [ 0, %.lr.ph ], [ %9, %33 ]
...
28:                                               ; preds = %24
  %29 = add nsw i32 %0, 1
  call void @Try(i32 noundef %29, ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5)
...
33:                                               ; preds = %32, %31, %28, %18, %13, %8
  %34 = load i32, ptr %1, align 4
  %.not = icmp eq i32 %34, 0
  %35 = icmp ne i32 %9, 8
  %spec.select = and i1 %35, %.not
  br i1 %spec.select, label %8, label %._crit_edge, !llvm.loop !7
