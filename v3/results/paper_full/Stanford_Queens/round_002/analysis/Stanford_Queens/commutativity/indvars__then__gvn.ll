...
8:                                                ; preds = %32, %6
  %9 = phi i32 [ %.pre, %32 ], [ 0, %6 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %32 ], [ 0, %6 ]
  %.not = icmp eq i32 %9, 0
  %10 = icmp ne i64 %indvars.iv, 8
  %spec.select = and i1 %.not, %10
  br i1 %spec.select, label %11, label %33
...
23:                                               ; preds = %18
  %24 = getelementptr inbounds [4 x i8], ptr %5, i64 %7
...
32:                                               ; preds = %31, %30, %27, %18, %14, %11
  %.pre = phi i32 [ 1, %31 ], [ %.pre.pre, %30 ], [ %29, %27 ], [ 0, %18 ], [ 0, %14 ], [ 0, %11 ]
