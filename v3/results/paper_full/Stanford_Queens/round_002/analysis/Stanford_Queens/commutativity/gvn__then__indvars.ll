...
9:                                                ; preds = %34, %6
  ...
  %10 = phi i32 [ 0, %6 ], [ %.pre, %34 ]
  %.not = icmp eq i32 %10, 0
  %11 = icmp ne i64 %indvars.iv, 8
  %spec.select = and i1 %.not, %11
  br i1 %spec.select, label %12, label %35
...
12:                                               ; preds = %9
  ...
  br i1 %.not1, label %34, label %15

15:                                               ; preds = %12
  %16 = add nsw i64 %7, %indvars.iv.next
  %17 = getelementptr inbounds [4 x i8], ptr %2, i64 %16
  %18 = load i32, ptr %17, align 4
  %.not2 = icmp eq i32 %18, 0
  br i1 %.not2, label %34, label %19

19:                                               ; preds = %15
  %20 = sub nsw i64 %8, %indvars.iv.next
  %21 = getelementptr [4 x i8], ptr %4, i64 %20
...
29:                                               ; preds = %24
  %30 = add nsw i32 %0, 1
  call void @Try(i32 noundef %30, ptr noundef nonnull %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5)
...
34:                                               ; preds = %33, %32, %29, %19, %15, %12
  %.pre = phi i32 [ 1, %33 ], [ %.pre.pre, %32 ], [ %31, %29 ], [ 0, %19 ], [ 0, %15 ], [ 0, %12 ]
