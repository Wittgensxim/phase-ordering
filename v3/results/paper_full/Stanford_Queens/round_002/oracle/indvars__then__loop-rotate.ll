; ModuleID = 'results\paper_full\Stanford_Queens\round_001\output.ll'
...
define dso_local void @Try(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5) #0 {
  ...
  br i1 %.not5, label %.lr.ph, label %35
...
10:                                               ; preds = %.lr.ph, %32
  ...
  store i32 0, ptr %1, align 4
  %11 = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv.next
  %12 = load i32, ptr %11, align 4
  %.not1 = icmp eq i32 %12, 0
  br i1 %.not1, label %32, label %13

13:                                               ; preds = %10
  %14 = add nsw i64 %7, %indvars.iv.next
...
32:                                               ; preds = %31, %30, %27, %17, %13, %10
  %33 = load i32, ptr %1, align 4
  %.not = icmp eq i32 %33, 0
  %34 = icmp ne i64 %indvars.iv.next, 8
  %spec.select = and i1 %.not, %34
  br i1 %spec.select, label %10, label %._crit_edge, !llvm.loop !7
...
6:                                                ; preds = %0, %20
  %indvars.iv2 = phi i64 [ -7, %0 ], [ %indvars.iv.next, %20 ]
...
9:                                                ; preds = %6
  %10 = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv2
  store i32 1, ptr %10, align 4
  br label %11

11:                                               ; preds = %9, %6
  %12 = icmp sgt i64 %indvars.iv2, 1
  br i1 %12, label %13, label %15

13:                                               ; preds = %11
  %14 = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv2
  store i32 1, ptr %14, align 4
  br label %15

15:                                               ; preds = %13, %11
  %16 = icmp slt i64 %indvars.iv2, 8
  br i1 %16, label %17, label %20

17:                                               ; preds = %15
  %18 = getelementptr [4 x i8], ptr %4, i64 %indvars.iv2
