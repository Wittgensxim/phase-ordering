...
define dso_local void @Try(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5) #0 {
  ...
  br i1 true, label %.lr.ph, label %._crit_edge7
...
32:                                               ; preds = %31, %30, %27, %17, %12, %7
  %33 = phi i32 [ 1, %31 ], [ %.pre, %30 ], [ %29, %27 ], [ 0, %17 ], [ 0, %12 ], [ 0, %7 ]
  %.not = icmp eq i32 %33, 0
  %34 = icmp ne i32 %8, 8
  %spec.select = and i1 %.not, %34
  br i1 %spec.select, label %7, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %32
  br label %35

35:                                               ; preds = %._crit_edge7, %._crit_edge
  ret void
}
