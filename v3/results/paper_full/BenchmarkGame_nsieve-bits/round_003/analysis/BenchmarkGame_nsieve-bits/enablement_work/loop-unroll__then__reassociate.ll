...
17:                                               ; preds = %7
  %18 = add i32 %9, 1
  %19 = shl i32 %8, 1
  %.not31 = icmp ugt i32 %19, 40960000
...
34:                                               ; preds = %33, %7
  ...
  %36 = add i32 %8, 1
  %.not1 = icmp ugt i32 %36, 40960000
  br i1 %.not1, label %37, label %7, !llvm.loop !9

37:                                               ; preds = %34
  %.lcssa = phi i32 [ %35, %34 ]
  %38 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 40960000, i32 noundef %.lcssa) #5
...
49:                                               ; preds = %39
  %50 = add i32 %41, 1
  %51 = shl i32 %40, 1
  %.not31.1 = icmp ugt i32 %51, 20480000
...
66:                                               ; preds = %65, %39
  ...
  %68 = add i32 %40, 1
  %.not1.1 = icmp ugt i32 %68, 20480000
  br i1 %.not1.1, label %69, label %39, !llvm.loop !9

69:                                               ; preds = %66
  %.lcssa.1 = phi i32 [ %67, %66 ]
  %70 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 20480000, i32 noundef %.lcssa.1) #5
...
81:                                               ; preds = %71
  %82 = add i32 %73, 1
  %83 = shl i32 %72, 1
  %.not31.2 = icmp ugt i32 %83, 10240000
...
98:                                               ; preds = %97, %71
  ...
  %100 = add i32 %72, 1
  %.not1.2 = icmp ugt i32 %100, 10240000
  br i1 %.not1.2, label %101, label %71, !llvm.loop !9

101:                                              ; preds = %98
  %.lcssa.2 = phi i32 [ %99, %98 ]
  %102 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 10240000, i32 noundef %.lcssa.2) #5
