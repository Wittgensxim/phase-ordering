...
22:                                               ; preds = %12
  %23 = add i32 %14, 1
  %24 = shl nuw i32 %13, 1
  %.not31 = icmp samesign ugt i32 %24, %8
...
36:                                               ; preds = %34, %25
  %37 = add nuw nsw i32 %26, %13
  %.not3 = icmp samesign ugt i32 %37, %8
...
39:                                               ; preds = %38, %12
  ...
  %exitcond = icmp eq i32 %13, %8
  br i1 %exitcond, label %42, label %12, !llvm.loop !9

42:                                               ; preds = %39
  %43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8, i32 noundef %40) #6
  %44 = add nuw nsw i32 %7, 1
  %exitcond1.not = icmp eq i32 %44, 3
  br i1 %exitcond1.not, label %45, label %6, !llvm.loop !10
