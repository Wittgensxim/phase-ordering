...
15:                                               ; preds = %5
  %16 = add i32 %7, 1
  %17 = shl i32 %6, 1
  %.not31 = icmp ugt i32 %17, 40960000
  br i1 %.not31, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %15, %28
  %18 = phi i32 [ %29, %28 ], [ %17, %15 ]
  %19 = lshr i32 %18, 5
...
28:                                               ; preds = %26, %.lr.ph
  %29 = add i32 %18, %6
  %.not3 = icmp ugt i32 %29, 40960000
  br i1 %.not3, label %._crit_edge, label %.lr.ph, !llvm.loop !7

._crit_edge:                                      ; preds = %15, %28, %5
  %30 = phi i32 [ %7, %5 ], [ %16, %28 ], [ %16, %15 ]
  %31 = add i32 %6, 1
  %.not1 = icmp ugt i32 %31, 40960000
  br i1 %.not1, label %32, label %5, !llvm.loop !9

32:                                               ; preds = %._crit_edge
  %.lcssa = phi i32 [ %30, %._crit_edge ]
  %33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 40960000, i32 noundef %.lcssa) #5
...
44:                                               ; preds = %34
  %45 = add i32 %36, 1
  %46 = shl i32 %35, 1
  %.not31.1 = icmp ugt i32 %46, 20480000
  br i1 %.not31.1, label %._crit_edge.1, label %.lr.ph.1

.lr.ph.1:                                         ; preds = %44, %57
  %47 = phi i32 [ %58, %57 ], [ %46, %44 ]
  %48 = lshr i32 %47, 5
...
57:                                               ; preds = %55, %.lr.ph.1
  %58 = add i32 %47, %35
  %.not3.1 = icmp ugt i32 %58, 20480000
  br i1 %.not3.1, label %._crit_edge.1, label %.lr.ph.1, !llvm.loop !7

._crit_edge.1:                                    ; preds = %44, %57, %34
  %59 = phi i32 [ %36, %34 ], [ %45, %57 ], [ %45, %44 ]
  %60 = add i32 %35, 1
  %.not1.1 = icmp ugt i32 %60, 20480000
  br i1 %.not1.1, label %61, label %34, !llvm.loop !9

61:                                               ; preds = %._crit_edge.1
  %.lcssa.1 = phi i32 [ %59, %._crit_edge.1 ]
  %62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 20480000, i32 noundef %.lcssa.1) #5
...
73:                                               ; preds = %63
  %74 = add i32 %65, 1
  %75 = shl i32 %64, 1
  %.not31.2 = icmp ugt i32 %75, 10240000
  br i1 %.not31.2, label %._crit_edge.2, label %.lr.ph.2

.lr.ph.2:                                         ; preds = %73, %86
  %76 = phi i32 [ %87, %86 ], [ %75, %73 ]
  %77 = lshr i32 %76, 5
...
86:                                               ; preds = %84, %.lr.ph.2
  %87 = add i32 %76, %64
  %.not3.2 = icmp ugt i32 %87, 10240000
  br i1 %.not3.2, label %._crit_edge.2, label %.lr.ph.2, !llvm.loop !7

._crit_edge.2:                                    ; preds = %73, %86, %63
  %88 = phi i32 [ %65, %63 ], [ %74, %86 ], [ %74, %73 ]
  %89 = add i32 %64, 1
  %.not1.2 = icmp ugt i32 %89, 10240000
  br i1 %.not1.2, label %90, label %63, !llvm.loop !9

90:                                               ; preds = %._crit_edge.2
  %.lcssa.2 = phi i32 [ %88, %._crit_edge.2 ]
  %91 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 10240000, i32 noundef %.lcssa.2) #5
