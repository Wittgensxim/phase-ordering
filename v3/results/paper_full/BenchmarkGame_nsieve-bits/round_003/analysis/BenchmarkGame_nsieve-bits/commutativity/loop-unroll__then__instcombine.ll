...
6:                                                ; preds = %5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(5120004) %3, i8 -1, i64 5120004, i1 false)
  br label %7
...
17:                                               ; preds = %7
  %18 = add i32 %9, 1
  %.not31 = icmp samesign ugt i32 %8, 20480000
  br i1 %.not31, label %33, label %.lr.ph

.lr.ph:                                           ; preds = %17
  %19 = shl nuw nsw i32 %8, 1
  br label %20
...
34:                                               ; preds = %33, %7
  ...
  %.not1 = icmp samesign ugt i32 %8, 40959999
  br i1 %.not1, label %37, label %7, !llvm.loop !9

37:                                               ; preds = %34
  %38 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 40960000, i32 noundef %35) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(2560004) %3, i8 -1, i64 2560004, i1 false)
  br label %39
...
49:                                               ; preds = %39
  %50 = add i32 %41, 1
  %.not31.1 = icmp samesign ugt i32 %40, 10240000
...
63:                                               ; preds = %61, %52
  %64 = add nuw i32 %53, %40
  %.not3.1 = icmp ugt i32 %64, 20480000
...
66:                                               ; preds = %65, %39
  ...
  %.not1.1 = icmp samesign ugt i32 %40, 20479999
  br i1 %.not1.1, label %69, label %39, !llvm.loop !9

69:                                               ; preds = %66
  %70 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 20480000, i32 noundef %67) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1280004) %3, i8 -1, i64 1280004, i1 false)
  br label %71
...
81:                                               ; preds = %71
  %82 = add i32 %73, 1
  %.not31.2 = icmp samesign ugt i32 %72, 5120000
...
95:                                               ; preds = %93, %84
  %96 = add nuw i32 %85, %72
  %.not3.2 = icmp ugt i32 %96, 10240000
...
98:                                               ; preds = %97, %71
  ...
  %.not1.2 = icmp samesign ugt i32 %72, 10239999
  br i1 %.not1.2, label %101, label %71, !llvm.loop !9

101:                                              ; preds = %98
  %102 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 10240000, i32 noundef %99) #5
