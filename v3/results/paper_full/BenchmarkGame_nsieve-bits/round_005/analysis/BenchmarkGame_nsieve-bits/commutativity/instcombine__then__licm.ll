...
4:                                                ; preds = %37, %.preheader
  %5 = phi i32 [ %39, %37 ], [ 0, %.preheader ]
...
20:                                               ; preds = %10
  %21 = add i32 %12, 1
  %22 = shl nuw i32 %11, 1
  %.not31 = icmp samesign ugt i32 %22, %6
...
.lr.ph:                                           ; preds = %33, %.lr.ph.preheader
  %23 = phi i32 [ %34, %33 ], [ %22, %.lr.ph.preheader ]
  %24 = lshr i32 %23, 5
...
33:                                               ; preds = %31, %.lr.ph
  ...
  %.not3 = icmp samesign ugt i32 %34, %6
  br i1 %.not3, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !7

._crit_edge.loopexit:                             ; preds = %33
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %20, %10
  %35 = phi i32 [ %12, %10 ], [ %21, %20 ], [ %21, %._crit_edge.loopexit ]
  %36 = add nuw nsw i32 %11, 1
  %exitcond = icmp eq i32 %11, %6
  br i1 %exitcond, label %37, label %10, !llvm.loop !9

37:                                               ; preds = %._crit_edge
  %.lcssa = phi i32 [ %35, %._crit_edge ]
  %38 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6, i32 noundef %.lcssa) #6
  %39 = add nuw nsw i32 %5, 1
  %exitcond1.not = icmp eq i32 %39, 3
  br i1 %exitcond1.not, label %40, label %4, !llvm.loop !10
