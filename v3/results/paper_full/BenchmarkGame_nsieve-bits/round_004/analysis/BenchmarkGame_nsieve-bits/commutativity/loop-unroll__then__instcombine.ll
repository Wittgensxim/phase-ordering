...
15:                                               ; preds = %5
  %16 = add i32 %7, 1
  %.not31 = icmp samesign ugt i32 %6, 20480000
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %15, %5
  ...
  %exitcond = icmp eq i32 %31, 40960001
  br i1 %exitcond, label %32, label %5, !llvm.loop !9

32:                                               ; preds = %._crit_edge
  %33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 40960000, i32 noundef %30) #6
...
44:                                               ; preds = %34
  %45 = add i32 %36, 1
  %.not31.1 = icmp samesign ugt i32 %35, 10240000
...
._crit_edge.1:                                    ; preds = %._crit_edge.loopexit.1, %44, %34
  ...
  %exitcond.1 = icmp eq i32 %60, 20480001
  br i1 %exitcond.1, label %61, label %34, !llvm.loop !9

61:                                               ; preds = %._crit_edge.1
  %62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 20480000, i32 noundef %59) #6
...
73:                                               ; preds = %63
  %74 = add i32 %65, 1
  %.not31.2 = icmp samesign ugt i32 %64, 5120000
...
._crit_edge.2:                                    ; preds = %._crit_edge.loopexit.2, %73, %63
  ...
  %exitcond.2 = icmp eq i32 %89, 10240001
  br i1 %exitcond.2, label %90, label %63, !llvm.loop !9

90:                                               ; preds = %._crit_edge.2
  %91 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 10240000, i32 noundef %88) #6
