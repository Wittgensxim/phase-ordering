...
._crit_edge:                                      ; preds = %27, %14, %4
  %29 = phi i32 [ %6, %4 ], [ %15, %14 ], [ %15, %27 ]
  %30 = add nuw nsw i32 %5, 1
  %exitcond = icmp eq i32 %30, 40960001
  br i1 %exitcond, label %31, label %4, !llvm.loop !9

31:                                               ; preds = %._crit_edge
  %.lcssa = phi i32 [ %29, %._crit_edge ]
  %32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 40960000, i32 noundef %.lcssa) #6
...
._crit_edge.1:                                    ; preds = %56, %43, %33
  %58 = phi i32 [ %35, %33 ], [ %44, %43 ], [ %44, %56 ]
  %59 = add nuw nsw i32 %34, 1
  %exitcond.1 = icmp eq i32 %59, 20480001
  br i1 %exitcond.1, label %60, label %33, !llvm.loop !9

60:                                               ; preds = %._crit_edge.1
  %.lcssa.1 = phi i32 [ %58, %._crit_edge.1 ]
  %61 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 20480000, i32 noundef %.lcssa.1) #6
...
._crit_edge.2:                                    ; preds = %85, %72, %62
  %87 = phi i32 [ %64, %62 ], [ %73, %72 ], [ %73, %85 ]
  %88 = add nuw nsw i32 %63, 1
  %exitcond.2 = icmp eq i32 %88, 10240001
  br i1 %exitcond.2, label %89, label %62, !llvm.loop !9

89:                                               ; preds = %._crit_edge.2
  %.lcssa.2 = phi i32 [ %87, %._crit_edge.2 ]
  %90 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 10240000, i32 noundef %.lcssa.2) #6
