...
.preheader:                                       ; preds = %2, %37
  ...
  %umax = call i32 @llvm.umax.i32(i32 %9, i32 3)
  br label %10

10:                                               ; preds = %._crit_edge, %.preheader
  %11 = phi i32 [ 2, %.preheader ], [ %36, %._crit_edge ]
  %12 = phi i32 [ 0, %.preheader ], [ %35, %._crit_edge ]
  %13 = lshr i32 %11, 5
...
20:                                               ; preds = %10
  %21 = add i32 %12, 1
  %22 = shl i32 %11, 1
  %.not31 = icmp samesign ugt i32 %22, %5
...
33:                                               ; preds = %31, %.lr.ph
  %34 = add nuw nsw i32 %23, %11
  %.not3 = icmp samesign ugt i32 %34, %5
  br i1 %.not3, label %._crit_edge, label %.lr.ph, !llvm.loop !7

._crit_edge:                                      ; preds = %33, %20, %10
  %35 = phi i32 [ %12, %10 ], [ %21, %20 ], [ %21, %33 ]
  %36 = add nuw nsw i32 %11, 1
  %exitcond = icmp eq i32 %36, %umax
  br i1 %exitcond, label %37, label %10, !llvm.loop !9

37:                                               ; preds = %._crit_edge
  %.lcssa = phi i32 [ %35, %._crit_edge ]
  %38 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5, i32 noundef %.lcssa) #6
  %39 = add nuw nsw i32 %4, 1
  %exitcond1 = icmp ne i32 %39, 3
  br i1 %exitcond1, label %.preheader, label %40, !llvm.loop !10
