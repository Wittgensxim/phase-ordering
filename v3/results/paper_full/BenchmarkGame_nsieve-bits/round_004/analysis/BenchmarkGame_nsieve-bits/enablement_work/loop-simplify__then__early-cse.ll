...
4:                                                ; preds = %.preheader, %38
  %5 = phi i32 [ %40, %38 ], [ 0, %.preheader ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %34
  %24 = phi i32 [ %35, %34 ], [ %23, %.lr.ph.preheader ]
  %25 = lshr i32 %24, 5
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %21, %11
  %36 = phi i32 [ %13, %11 ], [ %22, %21 ], [ %22, %._crit_edge.loopexit ]
  %37 = add nuw nsw i32 %12, 1
  %exitcond = icmp eq i32 %37, %umax
  br i1 %exitcond, label %38, label %11, !llvm.loop !9

38:                                               ; preds = %._crit_edge
  %39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6, i32 noundef %36) #6
