; ModuleID = 'results\paper_full\BenchmarkGame_nsieve-bits\round_009\output.ll'
...
.preheader.1:                                     ; preds = %._crit_edge
  ...
  %31 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 40960000, i32 noundef %.lcssa) #6
...
._crit_edge.1:                                    ; preds = %55, %42, %32
  %57 = phi i32 [ %34, %32 ], [ %43, %42 ], [ %43, %55 ]
...
.preheader.2:                                     ; preds = %._crit_edge.1
  %.lcssa.1 = phi i32 [ %57, %._crit_edge.1 ]
  %59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 20480000, i32 noundef %.lcssa.1) #6
...
._crit_edge.2:                                    ; preds = %83, %70, %60
  %85 = phi i32 [ %62, %60 ], [ %71, %70 ], [ %71, %83 ]
...
87:                                               ; preds = %._crit_edge.2
  %.lcssa.2 = phi i32 [ %85, %._crit_edge.2 ]
  %88 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 10240000, i32 noundef %.lcssa.2) #6
