...
7:                                                ; preds = %52, %6
  %.021 = phi i32 [ 0, %6 ], [ %53, %52 ]
  %8 = icmp ule i32 %.021, 2
  br i1 %8, label %9, label %54

9:                                                ; preds = %7
  %10 = lshr i32 40960000, %.021
  %11 = udiv i32 %10, 8
...
14:                                               ; preds = %48, %9
  %.020 = phi i32 [ 2, %9 ], [ %49, %48 ]
  %.018 = phi i32 [ 0, %9 ], [ %.1, %48 ]
  %15 = icmp ule i32 %.020, %10
  br i1 %15, label %16, label %50

16:                                               ; preds = %14
  %17 = zext i32 %.020 to i64
  %18 = udiv i64 %17, 32
...
29:                                               ; preds = %44, %26
  %.019 = phi i32 [ %28, %26 ], [ %45, %44 ]
  %30 = icmp ule i32 %.019, %10
  br i1 %30, label %31, label %46

31:                                               ; preds = %29
  %32 = zext i32 %.019 to i64
  %33 = udiv i64 %32, 32
...
50:                                               ; preds = %14
  %51 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %10, i32 noundef %.018)
  br label %52
