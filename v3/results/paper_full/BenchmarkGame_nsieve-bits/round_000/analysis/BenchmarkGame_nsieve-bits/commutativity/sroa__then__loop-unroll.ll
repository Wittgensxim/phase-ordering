...
17:                                               ; preds = %61, %12
  %.032 = phi i32 [ 2, %12 ], [ %62, %61 ]
  %.030 = phi i32 [ 0, %12 ], [ %.1, %61 ]
...
63:                                               ; preds = %17
  %.030.lcssa = phi i32 [ %.030, %17 ]
  %64 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13, i32 noundef %.030.lcssa)
  br label %65
