...
32:                                               ; preds = %56, %30
  %.02 = phi i32 [ %factor, %30 ], [ %57, %56 ]
  %33 = icmp ule i32 %.02, %13
...
62:                                               ; preds = %17
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13, i32 noundef %.01)
  br label %64
