...
27:                                               ; preds = %83, %21
  %.lcssa7.lcssa16 = phi i32 [ %.lcssa7.lcssa, %83 ], [ %.promoted15, %21 ]
  %.lcssa214 = phi i32 [ %.lcssa2, %83 ], [ %.promoted13, %21 ]
  %28 = phi i32 [ %32, %83 ], [ %.promoted11, %21 ]
  %.lcssa410 = phi i32 [ %.lcssa4, %83 ], [ %.promoted9, %21 ]
  %29 = phi i32 [ %85, %83 ], [ %.promoted, %21 ]
...
36:                                               ; preds = %80, %31
  %.lcssa7 = phi i32 [ %.lcssa6, %80 ], [ %.lcssa7.lcssa16, %31 ]
  %37 = phi i32 [ %81, %80 ], [ 0, %31 ]
  %38 = phi i32 [ %82, %80 ], [ 2, %31 ]
...
80:                                               ; preds = %.loopexit, %40
  %.lcssa6 = phi i32 [ %.lcssa, %.loopexit ], [ %.lcssa7, %40 ]
  %81 = phi i32 [ %52, %.loopexit ], [ %37, %40 ]
  %82 = add i32 %38, 1
...
83:                                               ; preds = %36
  ...
  %84 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %32, i32 noundef %.lcssa4)
  %85 = add i32 %29, 1
