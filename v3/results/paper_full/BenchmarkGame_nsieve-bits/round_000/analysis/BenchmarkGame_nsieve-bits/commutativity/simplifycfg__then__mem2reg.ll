...
17:                                               ; preds = %58, %12
  %.04 = phi i32 [ 2, %12 ], [ %59, %58 ]
  %.01 = phi i32 [ 0, %12 ], [ %.1, %58 ]
...
60:                                               ; preds = %17
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13, i32 noundef %.01)
  %62 = add i32 %.03, 1
