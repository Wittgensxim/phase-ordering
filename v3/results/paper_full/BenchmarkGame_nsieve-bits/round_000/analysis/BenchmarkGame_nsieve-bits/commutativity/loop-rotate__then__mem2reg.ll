...
11:                                               ; preds = %.lr.ph5, %64
  %.09 = phi i32 [ 0, %.lr.ph5 ], [ %65, %64 ]
  %12 = lshr i32 40960000, %.09
  %13 = udiv i32 %12, 8
...
17:                                               ; preds = %.lr.ph2, %59
  %.010 = phi i32 [ 2, %.lr.ph2 ], [ %60, %59 ]
  %.07 = phi i32 [ 0, %.lr.ph2 ], [ %.2, %59 ]
  %18 = zext i32 %.010 to i64
  %19 = udiv i64 %18, 32
  %20 = getelementptr inbounds nuw i32, ptr %6, i64 %19
  %21 = load i32, ptr %20, align 4
  %22 = zext i32 %.010 to i64
  %23 = urem i64 %22, 32
