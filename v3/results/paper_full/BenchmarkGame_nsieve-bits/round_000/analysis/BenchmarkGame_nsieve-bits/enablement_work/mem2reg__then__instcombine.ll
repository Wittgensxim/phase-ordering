...
6:                                                ; preds = %51, %5
  %.03 = phi i32 [ 0, %5 ], [ %52, %51 ]
  %7 = icmp samesign ult i32 %.03, 3
  br i1 %7, label %8, label %53

8:                                                ; preds = %6
  %9 = lshr exact i32 40960000, %.03
  %10 = lshr exact i32 5120000, %.03
...
13:                                               ; preds = %47, %8
  %.04 = phi i32 [ 2, %8 ], [ %48, %47 ]
  %.01 = phi i32 [ 0, %8 ], [ %.1, %47 ]
  %.not5 = icmp ugt i32 %.04, %9
...
49:                                               ; preds = %13
  %50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %9, i32 noundef %.01) #5
  br label %51
