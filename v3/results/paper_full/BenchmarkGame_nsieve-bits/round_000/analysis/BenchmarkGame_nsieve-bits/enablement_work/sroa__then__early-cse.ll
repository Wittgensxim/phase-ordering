...
14:                                               ; preds = %48, %9
  %.032 = phi i32 [ 2, %9 ], [ %49, %48 ]
  %.030 = phi i32 [ 0, %9 ], [ %.1, %48 ]
  %15 = icmp ule i32 %.032, %10
  br i1 %15, label %16, label %50

16:                                               ; preds = %14
  %17 = zext i32 %.032 to i64
  %18 = udiv i64 %17, 32
...
29:                                               ; preds = %44, %26
  %.031 = phi i32 [ %28, %26 ], [ %45, %44 ]
  %30 = icmp ule i32 %.031, %10
...
50:                                               ; preds = %14
  %51 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %10, i32 noundef %.030)
  br label %52
