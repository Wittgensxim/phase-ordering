...
4:                                                ; preds = %2, %44
  ...
  br i1 %exitcond1, label %6, label %47
...
12:                                               ; preds = %41, %6
  ...
  %14 = phi i32 [ %43, %41 ], [ 2, %6 ]
  %exitcond = icmp eq i32 %14, %umax
  br i1 %exitcond, label %44, label %15
...
41:                                               ; preds = %39, %15
  %42 = phi i32 [ %40, %39 ], [ %13, %15 ]
  %43 = add nuw nsw i32 %14, 1
  br label %12, !llvm.loop !9

44:                                               ; preds = %12
  %.lcssa = phi i32 [ %13, %12 ]
  %45 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7, i32 noundef %.lcssa) #6
