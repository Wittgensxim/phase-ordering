...
6:                                                ; preds = %46, %5
  %7 = phi i32 [ 0, %5 ], [ %48, %46 ]
  %exitcond5 = icmp ne i32 %7, 3
  br i1 %exitcond5, label %8, label %49
...
14:                                               ; preds = %43, %8
  ...
  %16 = phi i32 [ %45, %43 ], [ 2, %8 ]
  %exitcond = icmp eq i32 %16, %umax
  br i1 %exitcond, label %46, label %17
...
27:                                               ; preds = %39, %25
  %28 = phi i32 [ %40, %39 ], [ %26, %25 ]
  %.not3 = icmp samesign ugt i32 %28, %9
...
43:                                               ; preds = %41, %17
  %44 = phi i32 [ %42, %41 ], [ %15, %17 ]
  %45 = add nuw nsw i32 %16, 1
  br label %14, !llvm.loop !9

46:                                               ; preds = %14
  %.lcssa = phi i32 [ %15, %14 ]
  %47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %9, i32 noundef %.lcssa) #6
