...
26:                                               ; preds = %38, %23
  ...
  br i1 %.not3, label %.loopexit, label %28
...
40:                                               ; preds = %.loopexit, %15
  %41 = phi i32 [ %13, %15 ], [ %24, %.loopexit ]
  %42 = add i32 %14, 1
  br label %12, !llvm.loop !9

43:                                               ; preds = %12
  %.lcssa = phi i32 [ %13, %12 ]
  %44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8, i32 noundef %.lcssa) #5
