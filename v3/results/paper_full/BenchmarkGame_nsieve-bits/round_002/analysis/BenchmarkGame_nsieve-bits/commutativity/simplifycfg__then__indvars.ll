...
4:                                                ; preds = %.preheader, %43
  %5 = phi i32 [ %45, %43 ], [ 0, %.preheader ]
  %exitcond1 = icmp ne i32 %5, 3
  br i1 %exitcond1, label %6, label %46

6:                                                ; preds = %4
  %7 = lshr exact i32 40960000, %5
  %8 = lshr exact i32 5120000, %5
  %9 = or disjoint i32 %8, 4
  %10 = zext nneg i32 %9 to i64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %3, i8 -1, i64 %10, i1 false)
  %11 = add nuw nsw i32 %7, 1
  %umax = call i32 @llvm.umax.i32(i32 %11, i32 2)
  br label %12

12:                                               ; preds = %40, %6
  %13 = phi i32 [ %41, %40 ], [ 0, %6 ]
  %14 = phi i32 [ %42, %40 ], [ 2, %6 ]
  %exitcond = icmp eq i32 %14, %umax
  br i1 %exitcond, label %43, label %15
...
25:                                               ; preds = %37, %23
  %26 = phi i32 [ %38, %37 ], [ %24, %23 ]
  %.not3 = icmp ugt i32 %26, %7
  br i1 %.not3, label %.loopexit, label %27
...
40:                                               ; preds = %.loopexit, %15
  %41 = phi i32 [ %13, %15 ], [ %39, %.loopexit ]
  %42 = add nuw nsw i32 %14, 1
  br label %12, !llvm.loop !9

43:                                               ; preds = %12
  %.lcssa = phi i32 [ %13, %12 ]
  %44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7, i32 noundef %.lcssa) #6
