...
6:                                                ; preds = %5, %43
  ...
  %exitcond3 = icmp eq i32 2, %umax
  br i1 %exitcond3, label %43, label %.lr.ph5

.lr.ph5:                                          ; preds = %6
  br label %13

13:                                               ; preds = %.lr.ph5, %40
  %14 = phi i32 [ 2, %.lr.ph5 ], [ %42, %40 ]
  %15 = phi i32 [ 0, %.lr.ph5 ], [ %41, %40 ]
  %16 = lshr i32 %14, 5
...
23:                                               ; preds = %13
  %24 = shl i32 %14, 1
  %.not32 = icmp ugt i32 %24, %8
  br i1 %.not32, label %38, label %.lr.ph
...
40:                                               ; preds = %38, %13
  %41 = phi i32 [ %39, %38 ], [ %15, %13 ]
  %42 = add nuw nsw i32 %14, 1
  %exitcond = icmp eq i32 %42, %umax
  br i1 %exitcond, label %._crit_edge6, label %13, !llvm.loop !9

._crit_edge6:                                     ; preds = %40
  %split = phi i32 [ %41, %40 ]
  br label %43

43:                                               ; preds = %._crit_edge6, %6
  %.lcssa = phi i32 [ %split, %._crit_edge6 ], [ 0, %6 ]
