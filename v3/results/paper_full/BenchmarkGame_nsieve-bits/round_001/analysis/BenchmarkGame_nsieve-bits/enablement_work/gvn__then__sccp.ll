...
16:                                               ; preds = %45, %11
  ...
  %18 = phi i32 [ %47, %45 ], [ 2, %11 ]
  %.not1 = icmp ugt i32 %18, %12
  br i1 %.not1, label %48, label %19
...
48:                                               ; preds = %16
  %49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12, i32 noundef %17) #5
