...
8:                                                ; preds = %7, %45
  %storemerge6 = phi i32 [ 0, %7 ], [ %49, %45 ]
  store i32 0, ptr %4, align 4
  %9 = lshr exact i32 40960000, %storemerge6
  %10 = lshr exact i32 5120000, %storemerge6
  ...
  %exitcond2 = icmp eq i32 2, %umax
  br i1 %exitcond2, label %45, label %.lr.ph4

.lr.ph4:                                          ; preds = %8
  br label %14

14:                                               ; preds = %.lr.ph4, %43
  %15 = phi i32 [ 2, %.lr.ph4 ], [ %44, %43 ]
  %16 = lshr i32 %15, 5
...
43:                                               ; preds = %42, %14
  ...
  %exitcond = icmp eq i32 %44, %umax
  br i1 %exitcond, label %._crit_edge5, label %14, !llvm.loop !9

._crit_edge5:                                     ; preds = %43
  br label %45

45:                                               ; preds = %._crit_edge5, %8
  %46 = load i32, ptr %4, align 4
  %47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %9, i32 noundef %46) #6
