...
14:                                               ; preds = %8, %41
  %15 = phi i32 [ 0, %8 ], [ %42, %41 ]
  %16 = phi i32 [ 2, %8 ], [ %43, %41 ]
  %17 = lshr i32 %16, 5
...
41:                                               ; preds = %40, %14
  %42 = phi i32 [ %25, %40 ], [ %15, %14 ]
  %43 = add i32 %16, 1
  %.not1 = icmp ugt i32 %43, %10
  br i1 %.not1, label %44, label %14, !llvm.loop !9

44:                                               ; preds = %41
  %45 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %10, i32 noundef %42) #5
  %46 = add i32 %9, 1
