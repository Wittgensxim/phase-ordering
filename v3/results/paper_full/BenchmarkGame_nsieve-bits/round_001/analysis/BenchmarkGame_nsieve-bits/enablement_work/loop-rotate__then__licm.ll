...
8:                                                ; preds = %7, %46
  %9 = phi i32 [ %.promoted, %7 ], [ %48, %46 ]
  %storemerge2 = phi i32 [ 0, %7 ], [ %48, %46 ]
  %10 = lshr exact i32 40960000, %storemerge2
  %11 = lshr exact i32 5120000, %storemerge2
...
14:                                               ; preds = %8, %43
  %15 = phi i32 [ 0, %8 ], [ %44, %43 ]
  %16 = phi i32 [ 2, %8 ], [ %45, %43 ]
  %17 = lshr i32 %16, 5
...
24:                                               ; preds = %14
  ...
  br i1 %.not31, label %42, label %.lr.ph

.lr.ph:                                           ; preds = %24
  br label %27

27:                                               ; preds = %.lr.ph, %40
  %28 = phi i32 [ %26, %.lr.ph ], [ %41, %40 ]
  %29 = lshr i32 %28, 5
...
36:                                               ; preds = %27
  %37 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %30
...
43:                                               ; preds = %42, %14
  %44 = phi i32 [ %25, %42 ], [ %15, %14 ]
  %45 = add i32 %16, 1
  %.not1 = icmp ugt i32 %45, %10
  br i1 %.not1, label %46, label %14, !llvm.loop !9

46:                                               ; preds = %43
  %.lcssa = phi i32 [ %44, %43 ]
  %47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %10, i32 noundef %.lcssa) #5
  %48 = add i32 %9, 1
...
50:                                               ; preds = %46
  ...
  %.lcssa.lcssa = phi i32 [ %.lcssa, %46 ]
  store i32 %.lcssa.lcssa, ptr %4, align 4
