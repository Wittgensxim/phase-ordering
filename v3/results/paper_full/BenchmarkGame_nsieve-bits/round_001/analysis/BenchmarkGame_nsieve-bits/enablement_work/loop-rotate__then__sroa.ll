...
6:                                                ; preds = %5, %41
  %.05 = phi i32 [ 0, %5 ], [ %43, %41 ]
  %storemerge2 = phi i32 [ 0, %5 ], [ %43, %41 ]
...
39:                                               ; preds = %38, %11
  %.0 = phi i32 [ %.1, %11 ], [ %21, %38 ]
  %40 = add i32 %12, 1
  %.not1 = icmp ugt i32 %40, %7
  br i1 %.not1, label %41, label %11, !llvm.loop !9

41:                                               ; preds = %39
  %42 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7, i32 noundef %.0) #5
  %43 = add i32 %.05, 1
