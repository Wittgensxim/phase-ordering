...
8:                                                ; preds = %7, %45
  ...
  %umax = call i32 @llvm.umax.i32(i32 %13, i32 3)
  br label %14

14:                                               ; preds = %8, %43
  %15 = phi i32 [ 2, %8 ], [ %44, %43 ]
  %16 = lshr i32 %15, 5
...
23:                                               ; preds = %14
  ...
  %26 = shl i32 %15, 1
  %.not31 = icmp samesign ugt i32 %26, %9
...
40:                                               ; preds = %36, %27
  %41 = add nuw nsw i32 %28, %15
  %.not3 = icmp samesign ugt i32 %41, %9
...
43:                                               ; preds = %42, %14
  ...
  br i1 %exitcond, label %45, label %14, !llvm.loop !9
