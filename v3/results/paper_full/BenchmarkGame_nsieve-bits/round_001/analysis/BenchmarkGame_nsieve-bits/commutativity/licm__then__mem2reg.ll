...
6:                                                ; preds = %47, %5
  %.lcssa3 = phi i32 [ undef, %5 ], [ %.lcssa, %47 ]
  %storemerge = phi i32 [ 0, %5 ], [ %49, %47 ]
...
13:                                               ; preds = %44, %8
  %14 = phi i32 [ %45, %44 ], [ 0, %8 ]
  %15 = phi i32 [ %46, %44 ], [ 2, %8 ]
  %.not1 = icmp ugt i32 %15, %9
  br i1 %.not1, label %47, label %16
...
37:                                               ; preds = %29
  %38 = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %31
...
44:                                               ; preds = %43, %16
  %45 = phi i32 [ %25, %43 ], [ %14, %16 ]
  %46 = add i32 %15, 1
  br label %13, !llvm.loop !9

47:                                               ; preds = %13
  %.lcssa = phi i32 [ %14, %13 ]
  %48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %9, i32 noundef %.lcssa) #5
