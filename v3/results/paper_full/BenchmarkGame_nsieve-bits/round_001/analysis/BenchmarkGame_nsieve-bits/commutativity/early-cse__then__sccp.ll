...
15:                                               ; preds = %44, %10
  %16 = phi i32 [ %45, %44 ], [ 2, %10 ]
  %.not1 = icmp ugt i32 %16, %11
...
46:                                               ; preds = %15
  ...
  %48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11, i32 noundef %47) #5
