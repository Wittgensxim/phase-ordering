...
8:                                                ; preds = %50, %7
  %.lcssa14 = phi i32 [ %.promoted3, %7 ], [ %.lcssa1, %50 ]
  %9 = phi i32 [ 0, %7 ], [ %52, %50 ]
  %10 = icmp ult i32 %9, 3
...
16:                                               ; preds = %46, %11
  ...
  %19 = phi i32 [ %49, %46 ], [ 2, %11 ]
  %.not1 = icmp ugt i32 %19, %12
  br i1 %.not1, label %50, label %20
...
46:                                               ; preds = %45, %20
  %47 = phi i32 [ %29, %45 ], [ %17, %20 ]
  %48 = phi i32 [ %29, %45 ], [ %18, %20 ]
  %49 = add i32 %19, 1
...
50:                                               ; preds = %16
  ...
  %.lcssa = phi i32 [ %18, %16 ]
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12, i32 noundef %.lcssa) #5
  %52 = add i32 %9, 1
  br label %8, !llvm.loop !10

53:                                               ; preds = %8
  %.lcssa14.lcssa = phi i32 [ %.lcssa14, %8 ]
  %.lcssa2 = phi i32 [ %9, %8 ]
