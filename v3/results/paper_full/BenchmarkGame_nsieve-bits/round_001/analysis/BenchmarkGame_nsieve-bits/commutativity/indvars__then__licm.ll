...
8:                                                ; preds = %50, %7
  %.lcssa3 = phi i32 [ %.promoted2, %7 ], [ %.lcssa, %50 ]
  %storemerge = phi i32 [ 0, %7 ], [ %52, %50 ]
...
16:                                               ; preds = %47, %10
  %17 = phi i32 [ %48, %47 ], [ 0, %10 ]
  %18 = phi i32 [ %49, %47 ], [ 2, %10 ]
  %exitcond = icmp eq i32 %18, %umax
  br i1 %exitcond, label %50, label %19
...
47:                                               ; preds = %46, %19
  %48 = phi i32 [ %28, %46 ], [ %17, %19 ]
  %49 = add nuw nsw i32 %18, 1
  br label %16, !llvm.loop !9

50:                                               ; preds = %16
  %.lcssa = phi i32 [ %17, %16 ]
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11, i32 noundef %.lcssa) #6
  %52 = add i32 %storemerge, 1
