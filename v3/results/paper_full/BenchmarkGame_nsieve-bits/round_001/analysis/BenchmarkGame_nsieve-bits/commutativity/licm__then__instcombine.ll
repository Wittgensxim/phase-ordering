...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  %4 = call dereferenceable_or_null(5120004) ptr @malloc(i64 noundef 5120004) #4
...
7:                                                ; preds = %48, %6
  %.lcssa3 = phi i32 [ %.promoted2, %6 ], [ %15, %48 ]
  %storemerge = phi i32 [ 0, %6 ], [ %50, %48 ]
  %8 = icmp samesign ult i32 %storemerge, 3
...
9:                                                ; preds = %7
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %4, i8 -1, i64 %13, i1 false)
  br label %14

14:                                               ; preds = %45, %9
  %15 = phi i32 [ %46, %45 ], [ 0, %9 ]
  %16 = phi i32 [ %47, %45 ], [ 2, %9 ]
...
38:                                               ; preds = %30
  %39 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %32
...
45:                                               ; preds = %44, %17
  %46 = phi i32 [ %26, %44 ], [ %15, %17 ]
  %47 = add i32 %16, 1
  br label %14, !llvm.loop !9

48:                                               ; preds = %14
  %49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %10, i32 noundef %15) #5
  %50 = add nuw nsw i32 %storemerge, 1
