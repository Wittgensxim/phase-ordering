...
16:                                               ; preds = %45, %10
  %17 = phi i32 [ %46, %45 ], [ 2, %10 ]
  %exitcond = icmp eq i32 %17, %umax
  br i1 %exitcond, label %47, label %18
...
47:                                               ; preds = %16
  ...
  %49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11, i32 noundef %48) #6
