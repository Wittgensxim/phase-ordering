...
._crit_edge:                                      ; preds = %32, %19, %9
  %34 = phi i32 [ %11, %9 ], [ %20, %19 ], [ %20, %32 ]
  %35 = add nuw nsw i32 %10, 1
  %exitcond = icmp eq i32 %10, %5
  br i1 %exitcond, label %36, label %9, !llvm.loop !9

36:                                               ; preds = %._crit_edge
  %.lcssa = phi i32 [ %34, %._crit_edge ]
  %37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5, i32 noundef %.lcssa) #6
