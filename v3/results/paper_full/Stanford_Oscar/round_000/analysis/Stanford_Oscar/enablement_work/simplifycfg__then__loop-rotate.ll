...
15:                                               ; preds = %.lr.ph, %15
  ...
  br i1 %31, label %15, label %._crit_edge, !llvm.loop !10
...
71:                                               ; preds = %71, %67
  ...
  br i1 %137, label %71, label %138, !llvm.loop !11

138:                                              ; preds = %71
  %139 = load i32, ptr %9, align 4
  %140 = add nsw i32 %139, 1
  %141 = call i32 @Min0(i32 noundef %140, i32 noundef 25)
  store i32 %141, ptr %9, align 4
  %142 = load i32, ptr %8, align 4
  store i32 %142, ptr %11, align 4
  %143 = load i32, ptr %11, align 4
  %144 = icmp sgt i32 %143, 1
  br i1 %144, label %67, label %145, !llvm.loop !12
...
209:                                              ; preds = %202
  ...
  br i1 %212, label %.lr.ph, label %246
...
213:                                              ; preds = %.lr.ph, %213
  ...
  %218 = getelementptr inbounds %struct.complex, ptr %215, i64 %217
  %219 = getelementptr inbounds nuw %struct.complex, ptr %218, i32 0, i32 0
  %220 = load float, ptr %219, align 4
  %221 = fmul float %214, %220
  %222 = load ptr, ptr %7, align 8
  %223 = load i32, ptr %11, align 4
  %224 = sext i32 %223 to i64
  %225 = getelementptr inbounds %struct.complex, ptr %222, i64 %224
  %226 = getelementptr inbounds nuw %struct.complex, ptr %225, i32 0, i32 0
  store float %221, ptr %226, align 4
  %227 = load float, ptr %10, align 4
  %228 = fneg float %227
  %229 = load ptr, ptr %7, align 8
  %230 = load i32, ptr %11, align 4
  %231 = sext i32 %230 to i64
  %232 = getelementptr inbounds %struct.complex, ptr %229, i64 %231
  %233 = getelementptr inbounds nuw %struct.complex, ptr %232, i32 0, i32 1
  %234 = load float, ptr %233, align 4
  %235 = fmul float %228, %234
  %236 = load ptr, ptr %7, align 8
  %237 = load i32, ptr %11, align 4
  %238 = sext i32 %237 to i64
  %239 = getelementptr inbounds %struct.complex, ptr %236, i64 %238
  %240 = getelementptr inbounds nuw %struct.complex, ptr %239, i32 0, i32 1
  store float %235, ptr %240, align 4
  ...
  br i1 %245, label %213, label %._crit_edge, !llvm.loop !17

._crit_edge:                                      ; preds = %213
  br label %246

246:                                              ; preds = %._crit_edge, %209
  ret void
}
...
5:                                                ; preds = %.lr.ph, %5
  ...
  br i1 %24, label %5, label %._crit_edge, !llvm.loop !18
...
25:                                               ; preds = %._crit_edge, %0
  ...
  br i1 %27, label %.lr.ph2, label %33
...
28:                                               ; preds = %.lr.ph2, %28
  ...
  br i1 %32, label %28, label %._crit_edge3, !llvm.loop !19

._crit_edge3:                                     ; preds = %28
  br label %33

33:                                               ; preds = %._crit_edge3, %25
