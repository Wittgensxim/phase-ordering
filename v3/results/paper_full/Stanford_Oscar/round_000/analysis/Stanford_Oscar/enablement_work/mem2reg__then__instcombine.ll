...
7:                                                ; preds = %114, %5
  %.01 = phi i32 [ 1, %5 ], [ %115, %114 ]
  br label %8

8:                                                ; preds = %102, %7
  %.04 = phi i32 [ 1, %7 ], [ %99, %102 ]
  %.03 = phi i32 [ %.01, %7 ], [ %103, %102 ]
  %.02 = phi i32 [ 0, %7 ], [ %.03, %102 ]
  br label %9

9:                                                ; preds = %100, %8
  %.1 = phi i32 [ %.04, %8 ], [ %99, %100 ]
...
111:                                              ; preds = %105
  ...
  br i1 %.not5.not, label %105, label %113, !llvm.loop !15

113:                                              ; preds = %111
  br label %114

114:                                              ; preds = %113
  %115 = shl nsw i32 %.01, 1
  %.not6 = icmp sgt i32 %115, %6
  br i1 %.not6, label %116, label %7, !llvm.loop !16
...
117:                                              ; preds = %134, %116
  ...
  br i1 %.not7, label %136, label %118
