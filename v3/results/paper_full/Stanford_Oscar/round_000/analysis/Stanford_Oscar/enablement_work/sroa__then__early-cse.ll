...
7:                                                ; preds = %73, %5
  %.084 = phi i32 [ 1, %5 ], [ %72, %73 ]
  br label %8

8:                                                ; preds = %61, %7
  %.086 = phi i32 [ %.084, %7 ], [ %60, %61 ]
  %.085 = phi i32 [ 0, %7 ], [ %.086, %61 ]
  %.083 = phi i32 [ 1, %7 ], [ %56, %61 ]
  br label %9

9:                                                ; preds = %57, %8
  %.1 = phi i32 [ %.083, %8 ], [ %56, %57 ]
...
57:                                               ; preds = %9
  %58 = icmp sle i32 %56, %.086
  br i1 %58, label %9, label %59, !llvm.loop !13

59:                                               ; preds = %57
  %60 = add nsw i32 %.086, %.084
  br label %61
...
78:                                               ; preds = %76
  ...
  %83 = fneg float %4
  %84 = getelementptr inbounds nuw %struct.complex, ptr %80, i32 0, i32 1
