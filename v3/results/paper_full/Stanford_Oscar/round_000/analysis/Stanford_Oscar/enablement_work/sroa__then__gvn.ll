...
28:                                               ; preds = %55, %15
  %.047 = phi i32 [ 1, %15 ], [ %57, %55 ]
  %.045 = phi i32 [ %17, %15 ], [ %29, %55 ]
  %29 = sdiv i32 %.045, 2
  %.phi.trans.insert = sext i32 %.047 to i64
  %.phi.trans.insert49 = getelementptr inbounds [26 x float], ptr %3, i64 0, i64 %.phi.trans.insert
  %.pre = load float, ptr %.phi.trans.insert49, align 4
  br label %30

30:                                               ; preds = %30, %28
  %.046 = phi i32 [ %29, %28 ], [ %53, %30 ]
  %31 = add nsw i32 %.046, %29
  %32 = add nsw i32 %31, 1
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds %struct.complex, ptr %1, i64 %33
  %35 = load float, ptr %34, align 4
  %36 = sub nsw i32 %.046, %29
  %37 = add nsw i32 %36, 1
...
7:                                                ; preds = %68, %5
  %.084 = phi i32 [ 1, %5 ], [ %69, %68 ]
  br label %8

8:                                                ; preds = %58, %7
  %.086 = phi i32 [ %.084, %7 ], [ %59, %58 ]
  %.085 = phi i32 [ 0, %7 ], [ %.086, %58 ]
  %.083 = phi i32 [ 1, %7 ], [ %56, %58 ]
  br label %9

9:                                                ; preds = %9, %8
  %.1 = phi i32 [ %.083, %8 ], [ %56, %9 ]
  ...
  %56 = add nsw i32 %.1, 1
  %57 = icmp sle i32 %56, %.086
  br i1 %57, label %9, label %58, !llvm.loop !13

58:                                               ; preds = %9
  %59 = add nsw i32 %.086, %.084
