...
3:                                                ; preds = %.lr.ph, %21
  %.018 = phi i32 [ 2, %.lr.ph ], [ %22, %21 ]
  %.017 = phi i32 [ 1, %.lr.ph ], [ %4, %21 ]
  %.016 = phi float [ 1.000000e+00, %.lr.ph ], [ %.2, %21 ]
  %.0 = phi float [ %0, %.lr.ph ], [ %5, %21 ]
  %4 = mul nsw i32 %.017, %.018
  %5 = fmul float %.0, %0
  %6 = and i32 %.018, 1
  %7 = icmp eq i32 %6, 0
...
11:                                               ; preds = %8
  ...
  %13 = fdiv float %5, %12
  %14 = fadd float %.016, %13
  br label %19

15:                                               ; preds = %8
  %16 = sitofp i32 %4 to float
  %17 = fdiv float %5, %16
  %18 = fsub float %.016, %17
  br label %19
...
20:                                               ; preds = %19, %3
  %.2 = phi float [ %.3, %19 ], [ %.016, %3 ]
  br label %21

21:                                               ; preds = %20
  %22 = add nsw i32 %.018, 1
...
5:                                                ; preds = %.lr.ph, %13
  %.049 = phi i32 [ 1, %.lr.ph ], [ %14, %13 ]
  %.0 = phi float [ 4.000000e+00, %.lr.ph ], [ %12, %13 ]
...
39:                                               ; preds = %90, %16
  %.048 = phi i32 [ 1, %16 ], [ %89, %90 ]
  %.046 = phi i32 [ %18, %16 ], [ %40, %90 ]
  %40 = sdiv i32 %.046, 2
  br label %41

41:                                               ; preds = %85, %39
  %.047 = phi i32 [ %40, %39 ], [ %84, %85 ]
  %42 = sext i32 %.048 to i64
  %43 = getelementptr inbounds [26 x float], ptr %3, i64 0, i64 %42
  %44 = load float, ptr %43, align 4
  %45 = add nsw i32 %.047, %40
  %46 = add nsw i32 %45, 1
...
7:                                                ; preds = %129, %5
  %.086 = phi i32 [ 1, %5 ], [ %128, %129 ]
  br label %8

8:                                                ; preds = %116, %7
  %.088 = phi i32 [ %.086, %7 ], [ %115, %116 ]
  %.087 = phi i32 [ 0, %7 ], [ %.088, %116 ]
  %.085 = phi i32 [ 1, %7 ], [ %111, %116 ]
  br label %9

9:                                                ; preds = %112, %8
  %.1 = phi i32 [ %.085, %8 ], [ %111, %112 ]
...
112:                                              ; preds = %9
  %113 = icmp sle i32 %111, %.088
  br i1 %113, label %9, label %114, !llvm.loop !13

114:                                              ; preds = %112
  %115 = add nsw i32 %.088, %.086
  br label %116
