...
7:                                                ; preds = %102, %5
  %.01 = phi i32 [ 1, %5 ], [ %101, %102 ]
  br label %8

8:                                                ; preds = %90, %7
  %.04 = phi i32 [ 1, %7 ], [ %85, %90 ]
  %.03 = phi i32 [ %.01, %7 ], [ %89, %90 ]
  %.02 = phi i32 [ 0, %7 ], [ %.03, %90 ]
  br label %9

9:                                                ; preds = %86, %8
  %.1 = phi i32 [ %.04, %8 ], [ %85, %86 ]
...
86:                                               ; preds = %9
  %87 = icmp sle i32 %85, %.03
  br i1 %87, label %9, label %88, !llvm.loop !13

88:                                               ; preds = %86
  %89 = add nsw i32 %.03, %.01
  br label %90
