...
2:                                                ; preds = %22, %1
  %.03 = phi i32 [ 1, %1 ], [ %5, %22 ]
  %.02 = phi float [ 1.000000e+00, %1 ], [ %.1, %22 ]
...
21:                                               ; preds = %20, %4
  %.1 = phi float [ %storemerge1, %20 ], [ %.02, %4 ]
  br label %22
...
33:                                               ; preds = %77, %16
  %.02 = phi i32 [ 1, %16 ], [ %76, %77 ]
  %.0 = phi i32 [ %18, %16 ], [ %34, %77 ]
  %34 = sdiv i32 %.0, 2
  br label %35
...
7:                                                ; preds = %115, %5
  %.05 = phi i32 [ 1, %5 ], [ %114, %115 ]
  br label %8

8:                                                ; preds = %103, %7
  %.08 = phi i32 [ 1, %7 ], [ %99, %103 ]
  %.07 = phi i32 [ %.05, %7 ], [ %102, %103 ]
  %.06 = phi i32 [ 0, %7 ], [ %.07, %103 ]
  br label %9

9:                                                ; preds = %100, %8
  %.1 = phi i32 [ %.08, %8 ], [ %99, %100 ]
...
100:                                              ; preds = %9
  %.not = icmp sgt i32 %99, %.07
  br i1 %.not, label %101, label %9, !llvm.loop !13

101:                                              ; preds = %100
  %102 = add nsw i32 %.07, %.05
  br label %103
