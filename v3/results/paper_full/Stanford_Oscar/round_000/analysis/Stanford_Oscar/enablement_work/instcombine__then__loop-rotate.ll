...
35:                                               ; preds = %28, %21
  %storemerge1 = phi float [ %34, %28 ], [ %27, %21 ]
...
37:                                               ; preds = %36
  ...
  br i1 %40, label %7, label %41, !llvm.loop !7
...
182:                                              ; preds = %179
  ...
  %.not45 = icmp sgt i32 1, %183
  br i1 %.not45, label %212, label %.lr.ph
...
208:                                              ; preds = %184
  ...
  %.not4 = icmp sgt i32 %210, %211
  br i1 %.not4, label %._crit_edge, label %184, !llvm.loop !17

._crit_edge:                                      ; preds = %208
  br label %212

212:                                              ; preds = %._crit_edge, %182
  ret void
}
...
17:                                               ; preds = %3
  ...
  br i1 %20, label %3, label %21, !llvm.loop !18
...
23:                                               ; preds = %22
  ...
  br i1 %26, label %22, label %27, !llvm.loop !19
...
3:                                                ; preds = %2
  ...
  %6 = icmp slt i32 %5, 10
  br i1 %6, label %2, label %7, !llvm.loop !20
