...
2:                                                ; preds = %1, %20
  %.021 = phi float [ %0, %1 ], [ %4, %20 ]
  %.01520 = phi float [ 1.000000e+00, %1 ], [ %.1, %20 ]
  %.01619 = phi i32 [ 1, %1 ], [ %3, %20 ]
  %.01718 = phi i32 [ 2, %1 ], [ %21, %20 ]
  %3 = mul nsw i32 %.01619, %.01718
  %4 = fmul float %.021, %0
  %5 = and i32 %.01718, 1
  %6 = icmp eq i32 %5, 0
...
10:                                               ; preds = %7
  ...
  %12 = fdiv float %4, %11
  %13 = fadd float %.01520, %12
  br label %18

14:                                               ; preds = %7
  %15 = sitofp i32 %3 to float
  %16 = fdiv float %4, %15
  %17 = fsub float %.01520, %16
  br label %18
...
19:                                               ; preds = %18, %2
  %.1 = phi float [ %.2, %18 ], [ %.01520, %2 ]
  br label %20

20:                                               ; preds = %19
  %21 = add nsw i32 %.01718, 1
  %22 = icmp sle i32 %21, 10
  br i1 %22, label %2, label %23, !llvm.loop !7

23:                                               ; preds = %20
  %.015.lcssa = phi float [ %.1, %20 ]
  ret float %.015.lcssa
}
...
38:                                               ; preds = %89, %15
  %.047 = phi i32 [ 1, %15 ], [ %88, %89 ]
  %.045 = phi i32 [ %17, %15 ], [ %39, %89 ]
  %39 = sdiv i32 %.045, 2
  br label %40

40:                                               ; preds = %84, %38
  %.046 = phi i32 [ %39, %38 ], [ %83, %84 ]
...
84:                                               ; preds = %40
  %85 = icmp sle i32 %83, %16
  br i1 %85, label %40, label %86, !llvm.loop !11

86:                                               ; preds = %84
  %87 = add nsw i32 %.047, 1
  %88 = call i32 @Min0(i32 noundef %87, i32 noundef 25)
  br label %89

89:                                               ; preds = %86
  %90 = icmp sgt i32 %39, 1
  br i1 %90, label %38, label %91, !llvm.loop !12
...
133:                                              ; preds = %.lr.ph, %151
  %.287 = phi i32 [ 1, %.lr.ph ], [ %152, %151 ]
  %134 = sext i32 %.287 to i64
...
16:                                               ; preds = %2
  ...
  br i1 %18, label %2, label %19, !llvm.loop !18

19:                                               ; preds = %16
  br label %20

20:                                               ; preds = %19, %21
  %.17 = phi i32 [ 1, %19 ], [ %22, %21 ]
...
21:                                               ; preds = %20
  ...
  br i1 %23, label %20, label %24, !llvm.loop !19
