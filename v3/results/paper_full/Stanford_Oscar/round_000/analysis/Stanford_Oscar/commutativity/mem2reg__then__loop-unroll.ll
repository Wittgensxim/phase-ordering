...
8:                                                ; preds = %141, %5
  %.01 = phi i32 [ 1, %5 ], [ %140, %141 ]
  br label %9

9:                                                ; preds = %117, %8
  %.04 = phi i32 [ 1, %8 ], [ %.lcssa, %117 ]
  %.03 = phi i32 [ %.01, %8 ], [ %116, %117 ]
  %.02 = phi i32 [ 0, %8 ], [ %.03, %117 ]
  br label %10

10:                                               ; preds = %113, %9
  %.1 = phi i32 [ %.04, %9 ], [ %112, %113 ]
