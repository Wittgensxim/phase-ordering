...
2:                                                ; preds = %21, %1
  %.017 = phi i32 [ 2, %1 ], [ %22, %21 ]
  %.016 = phi i32 [ 1, %1 ], [ %4, %21 ]
  %.015 = phi float [ 1.000000e+00, %1 ], [ %.1, %21 ]
  %.0 = phi float [ %0, %1 ], [ %5, %21 ]
  %exitcond = icmp ne i32 %.017, 11
  br i1 %exitcond, label %3, label %23

3:                                                ; preds = %2
  %4 = mul nsw i32 %.016, %.017
  %5 = fmul float %.0, %0
  %6 = and i32 %.017, 1
  %7 = icmp eq i32 %6, 0
...
11:                                               ; preds = %8
  ...
  %13 = fdiv float %5, %12
  %14 = fadd float %.015, %13
  br label %19

15:                                               ; preds = %8
  %16 = sitofp i32 %4 to float
  %17 = fdiv float %5, %16
  %18 = fsub float %.015, %17
  br label %19
...
37:                                               ; preds = %84, %13
  %.047 = phi i32 [ 1, %13 ], [ %83, %84 ]
  %.045 = phi i32 [ %15, %13 ], [ %38, %84 ]
  %38 = sdiv i32 %.045, 2
...
45:                                               ; preds = %79, %37
  ...
  %69 = sub nsw i64 %indvars.iv50, %44
  %70 = add nsw i64 %69, 1
  ...
  %indvars.iv.next51 = add nsw i64 %indvars.iv50, %40
  br label %79

79:                                               ; preds = %45
  %80 = icmp sle i64 %indvars.iv.next51, %36
  br i1 %80, label %45, label %81, !llvm.loop !11

81:                                               ; preds = %79
  %82 = add nsw i32 %.047, 1
...
define dso_local void @Fft(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, float noundef %4) #0 {
  ...
  %smax94 = call i32 @llvm.smax.i32(i32 %0, i32 1)
  %14 = add nuw i32 %smax94, 1
  br label %15

15:                                               ; preds = %113, %5
  %.084 = phi i32 [ 1, %5 ], [ %112, %113 ]
  %16 = sext i32 %.084 to i64
  br label %17

17:                                               ; preds = %103, %15
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %103 ], [ %16, %15 ]
  %.085 = phi i32 [ 0, %15 ], [ %105, %103 ]
  %.083 = phi i32 [ 1, %15 ], [ %102, %103 ]
  %18 = sext i32 %.083 to i64
  %19 = sext i32 %.085 to i64
  %20 = sext i32 %.085 to i64
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv88, i64 %18)
  %21 = add i64 %smax, 1
  br label %22
...
22:                                               ; preds = %100, %17
  ...
  %69 = add nsw i64 %indvars.iv, %indvars.iv88
  ...
  %97 = add nsw i64 %indvars.iv, %indvars.iv88
...
101:                                              ; preds = %100
  ...
  %indvars.iv.next89 = add nsw i64 %indvars.iv88, %16
  br label %103

103:                                              ; preds = %101
  %104 = icmp sle i64 %indvars.iv.next89, %13
  %105 = trunc nsw i64 %indvars.iv88 to i32
...
107:                                              ; preds = %110, %106
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %110 ], [ 1, %106 ]
  %108 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv91
  %109 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv91
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %108, ptr align 4 %109, i64 8, i1 false)
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  br label %110

110:                                              ; preds = %107
  %exitcond95 = icmp ne i64 %indvars.iv.next92, %wide.trip.count
  br i1 %exitcond95, label %107, label %111, !llvm.loop !15

111:                                              ; preds = %110
  %112 = add nsw i32 %.084, %.084
  br label %113
...
115:                                              ; preds = %113
  %smax99 = call i32 @llvm.smax.i32(i32 %0, i32 0)
  %116 = add nuw i32 %smax99, 1
  %wide.trip.count100 = zext i32 %116 to i64
  br label %117

117:                                              ; preds = %130, %115
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %130 ], [ 1, %115 ]
  %exitcond101 = icmp ne i64 %indvars.iv96, %wide.trip.count100
  br i1 %exitcond101, label %118, label %131

118:                                              ; preds = %117
  %119 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv96
  %120 = load float, ptr %119, align 4
  %121 = fmul float %4, %120
  %122 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv96
  store float %121, ptr %122, align 4
  %123 = fneg float %4
  %124 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv96
  %125 = getelementptr inbounds nuw %struct.complex, ptr %124, i32 0, i32 1
  %126 = load float, ptr %125, align 4
  %127 = fmul float %123, %126
  %128 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv96
...
16:                                               ; preds = %18, %15
  ...
  %exitcond7 = icmp ne i32 %.1, 21
  br i1 %exitcond7, label %17, label %20
