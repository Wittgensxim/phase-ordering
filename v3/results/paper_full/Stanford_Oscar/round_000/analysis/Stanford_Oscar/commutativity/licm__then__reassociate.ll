...
80:                                               ; preds = %111, %70
  ...
  %.reass4 = add i32 %invariant.op3, %81
  ...
  %.reass6 = add i32 %invariant.op5, %81
  ...
  %.reass8 = add i32 %invariant.op7, %81
...
50:                                               ; preds = %176, %5
  %51 = phi i32 [ %factor, %176 ], [ %.promoted9, %5 ]
  br label %52
...
176:                                              ; preds = %175
  %177 = icmp sle i32 %factor, %49
  br i1 %177, label %50, label %178, !llvm.loop !16

178:                                              ; preds = %176
  %.lcssa7.lcssa = phi i32 [ %.lcssa7, %176 ]
  %.lcssa.lcssa.lcssa = phi i32 [ %.lcssa.lcssa, %176 ]
  %.lcssa4.lcssa = phi i32 [ %.lcssa4, %176 ]
  %.lcssa10 = phi i32 [ %factor, %176 ]
  %.lcssa2.lcssa = phi i32 [ %.lcssa2, %176 ]
...
187:                                              ; preds = %207, %178
  %188 = phi i32 [ %208, %207 ], [ %.promoted, %178 ]
  %189 = icmp sle i32 %188, %179
  br i1 %189, label %190, label %209

190:                                              ; preds = %187
  %191 = sext i32 %188 to i64
  %192 = getelementptr inbounds %struct.complex, ptr %181, i64 %191
  %193 = getelementptr inbounds nuw %struct.complex, ptr %192, i32 0, i32 0
  %194 = load float, ptr %193, align 4
  %195 = fmul float %180, %194
  ...
  %200 = getelementptr inbounds %struct.complex, ptr %185, i64 %199
  %201 = getelementptr inbounds nuw %struct.complex, ptr %200, i32 0, i32 1
  %202 = load float, ptr %201, align 4
  %203 = fmul float %184, %202
  %204 = sext i32 %188 to i64
  %205 = getelementptr inbounds %struct.complex, ptr %186, i64 %204
