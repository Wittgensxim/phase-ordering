...
2:                                                ; preds = %22, %1
  %.015 = phi i32 [ 1, %1 ], [ %5, %22 ]
  %.014 = phi float [ 1.000000e+00, %1 ], [ %.1, %22 ]
  %.0 = phi float [ %0, %1 ], [ %6, %22 ]
  %storemerge = phi i32 [ 2, %1 ], [ %23, %22 ]
  %3 = icmp slt i32 %storemerge, 11
  br i1 %3, label %4, label %24

4:                                                ; preds = %2
  %5 = mul nsw i32 %.015, %storemerge
  %6 = fmul float %.0, %0
  %7 = and i32 %storemerge, 1
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %21

9:                                                ; preds = %4
  %10 = and i32 %storemerge, 3
  %11 = icmp eq i32 %10, 0
...
12:                                               ; preds = %9
  ...
  %14 = fdiv float %6, %13
  %15 = fadd float %.014, %14
  br label %20

16:                                               ; preds = %9
  %17 = sitofp i32 %5 to float
  %18 = fdiv float %6, %17
  %19 = fsub float %.014, %18
  br label %20

20:                                               ; preds = %16, %12
  %storemerge1 = phi float [ %19, %16 ], [ %15, %12 ]
  br label %21

21:                                               ; preds = %20, %4
  %.1 = phi float [ %storemerge1, %20 ], [ %.014, %4 ]
  br label %22
...
define dso_local void @Uniform11(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %9 = fmul nnan float %8, f0x39000000
...
4:                                                ; preds = %14, %2
  ...
  %storemerge = phi i32 [ 1, %2 ], [ %15, %14 ]
  %5 = icmp slt i32 %storemerge, 26
...
7:                                                ; preds = %115, %5
  %.069 = phi i32 [ 1, %5 ], [ %114, %115 ]
  br label %8

8:                                                ; preds = %103, %7
  %.071 = phi i32 [ %.069, %7 ], [ %102, %103 ]
  %.070 = phi i32 [ 0, %7 ], [ %.071, %103 ]
  %.068 = phi i32 [ 1, %7 ], [ %99, %103 ]
  br label %9

9:                                                ; preds = %100, %8
  %.1 = phi i32 [ %.068, %8 ], [ %99, %100 ]
...
100:                                              ; preds = %9
  %.not = icmp sgt i32 %99, %.071
  br i1 %.not, label %101, label %9, !llvm.loop !13

101:                                              ; preds = %100
  %102 = add nsw i32 %.071, %.069
  br label %103

103:                                              ; preds = %101
  %.not1 = icmp sgt i32 %102, %6
  br i1 %.not1, label %104, label %8, !llvm.loop !14

104:                                              ; preds = %103
  br label %105

105:                                              ; preds = %112, %104
  %.0 = phi i32 [ 1, %104 ], [ %111, %112 ]
...
112:                                              ; preds = %105
  %.not2 = icmp sgt i32 %111, %0
  br i1 %.not2, label %113, label %105, !llvm.loop !15

113:                                              ; preds = %112
  %114 = shl nsw i32 %.069, 1
  br label %115

115:                                              ; preds = %113
  %.not3 = icmp sgt i32 %114, %6
  br i1 %.not3, label %116, label %7, !llvm.loop !16

116:                                              ; preds = %115
  br label %117

117:                                              ; preds = %134, %116
  %storemerge = phi i32 [ 1, %116 ], [ %135, %134 ]
  %.not4 = icmp sgt i32 %storemerge, %0
  br i1 %.not4, label %136, label %118

118:                                              ; preds = %117
  %119 = sext i32 %storemerge to i64
  %120 = getelementptr inbounds [8 x i8], ptr %1, i64 %119
  %121 = load float, ptr %120, align 4
  %122 = fmul float %4, %121
  %123 = sext i32 %storemerge to i64
...
2:                                                ; preds = %17, %0
  %storemerge = phi i32 [ 1, %0 ], [ %18, %17 ]
  %3 = icmp slt i32 %storemerge, 257
...
20:                                               ; preds = %23, %19
  %storemerge1 = phi i32 [ 1, %19 ], [ %24, %23 ]
  %21 = icmp slt i32 %storemerge1, 21
