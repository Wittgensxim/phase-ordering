...
4:                                                ; preds = %14, %2
  %.05 = phi i32 [ 1, %2 ], [ %15, %14 ]
  %.04 = phi float [ 4.000000e+00, %2 ], [ %13, %14 ]
  %5 = icmp sle i32 %.05, 25
  br i1 %5, label %6, label %16

6:                                                ; preds = %4
  %7 = fdiv float f0x40490FDB, %.04
...
39:                                               ; preds = %90, %16
  %.03 = phi i32 [ 1, %16 ], [ %89, %90 ]
  %.0 = phi i32 [ %18, %16 ], [ %40, %90 ]
  %40 = sdiv i32 %.0, 2
  br label %41

41:                                               ; preds = %85, %39
  %.02 = phi i32 [ %40, %39 ], [ %84, %85 ]
