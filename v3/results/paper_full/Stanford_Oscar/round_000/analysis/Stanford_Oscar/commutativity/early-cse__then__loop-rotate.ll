...
66:                                               ; preds = %117, %63
  ...
  %82 = getelementptr inbounds %struct.complex, ptr %71, i64 %81
  %83 = load float, ptr %82, align 4
  %84 = fadd float %78, %83
  %85 = fmul float %70, %84
  %86 = add nsw i32 %72, 1
  %87 = sext i32 %86 to i64
  %88 = getelementptr inbounds %struct.complex, ptr %71, i64 %87
  store float %85, ptr %88, align 4
  %89 = load i32, ptr %9, align 4
  %90 = sext i32 %89 to i64
  %91 = getelementptr inbounds [26 x float], ptr %7, i64 0, i64 %90
  ...
  %99 = getelementptr inbounds %struct.complex, ptr %93, i64 %98
  %100 = getelementptr inbounds nuw %struct.complex, ptr %99, i32 0, i32 1
  %101 = load float, ptr %100, align 4
  %102 = sub nsw i32 %94, %95
  %103 = add nsw i32 %102, 1
  %104 = sext i32 %103 to i64
  %105 = getelementptr inbounds %struct.complex, ptr %93, i64 %104
  ...
  %112 = getelementptr inbounds %struct.complex, ptr %93, i64 %111
...
117:                                              ; preds = %66
  ...
  br i1 %119, label %66, label %120, !llvm.loop !11

120:                                              ; preds = %117
  %121 = load i32, ptr %9, align 4
  %122 = add nsw i32 %121, 1
  %123 = call i32 @Min0(i32 noundef %122, i32 noundef 25)
...
125:                                              ; preds = %120
  ...
  br i1 %126, label %63, label %127, !llvm.loop !12
...
127:                                              ; preds = %124
  %.lcssa = phi i32 [ %125, %124 ]
  store i32 %.lcssa, ptr %13, align 4
  %128 = load i32, ptr %14, align 4
  %129 = add nsw i32 %.lcssa, %128
...
152:                                              ; preds = %149
  ...
  br i1 %155, label %.lr.ph, label %179

.lr.ph:                                           ; preds = %152
  br label %156

156:                                              ; preds = %.lr.ph, %173
  %157 = phi i32 [ %153, %.lr.ph ], [ %176, %173 ]
...
173:                                              ; preds = %156
  ...
  br i1 %178, label %156, label %._crit_edge, !llvm.loop !17

._crit_edge:                                      ; preds = %173
  br label %179

179:                                              ; preds = %._crit_edge, %152
  ret void
}
...
25:                                               ; preds = %._crit_edge, %0
  ...
  br i1 %27, label %.lr.ph2, label %34
...
29:                                               ; preds = %28
  ...
  br i1 %33, label %28, label %._crit_edge3, !llvm.loop !19

._crit_edge3:                                     ; preds = %29
  br label %34

34:                                               ; preds = %._crit_edge3, %25
