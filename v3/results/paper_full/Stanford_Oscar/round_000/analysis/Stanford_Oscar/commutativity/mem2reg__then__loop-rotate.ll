...
2:                                                ; preds = %1, %20
  %.07 = phi float [ %0, %1 ], [ %4, %20 ]
  %.016 = phi i32 [ 2, %1 ], [ %21, %20 ]
  %.025 = phi i32 [ 1, %1 ], [ %3, %20 ]
  %.034 = phi float [ 1.000000e+00, %1 ], [ %.1, %20 ]
  %3 = mul nsw i32 %.025, %.016
  %4 = fmul float %.07, %0
  %5 = and i32 %.016, 1
  %6 = icmp eq i32 %5, 0
...
4:                                                ; preds = %2, %12
  %.036 = phi float [ 4.000000e+00, %2 ], [ %11, %12 ]
  %.045 = phi i32 [ 1, %2 ], [ %13, %12 ]
  ...
  %11 = fadd float %.036, %.036
  br label %12

12:                                               ; preds = %4
  %13 = add nsw i32 %.045, 1
...
38:                                               ; preds = %89, %15
  %.02 = phi i32 [ 1, %15 ], [ %88, %89 ]
  %.0 = phi i32 [ %17, %15 ], [ %39, %89 ]
  %39 = sdiv i32 %.0, 2
  br label %40

40:                                               ; preds = %84, %38
  %.01 = phi i32 [ %39, %38 ], [ %83, %84 ]
...
133:                                              ; preds = %.lr.ph, %151
  %.25 = phi i32 [ 1, %.lr.ph ], [ %152, %151 ]
  %134 = sext i32 %.25 to i64
