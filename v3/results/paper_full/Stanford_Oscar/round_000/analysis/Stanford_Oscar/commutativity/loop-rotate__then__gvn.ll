...
7:                                                ; preds = %.lr.ph, %29
  %8 = phi float [ 1.000000e+00, %.lr.ph ], [ %30, %29 ]
  %9 = phi float [ %0, %.lr.ph ], [ %13, %29 ]
  %10 = phi i32 [ 2, %.lr.ph ], [ %31, %29 ]
  %11 = phi i32 [ 1, %.lr.ph ], [ %12, %29 ]
...
29:                                               ; preds = %27, %7
  %30 = phi float [ %28, %27 ], [ %8, %7 ]
  %31 = add nsw i32 %10, 1
  store i32 %31, ptr %3, align 4
  %32 = icmp sle i32 %31, 10
  br i1 %32, label %7, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %29
  br label %33

33:                                               ; preds = %._crit_edge1, %._crit_edge
  %34 = phi float [ 1.000000e+00, %._crit_edge1 ], [ %30, %._crit_edge ]
  ret float %34
}
...
13:                                               ; preds = %.lr.ph, %13
  %14 = phi i32 [ 1, %.lr.ph ], [ %23, %13 ]
  %15 = phi float [ 4.000000e+00, %.lr.ph ], [ %22, %13 ]
...
25:                                               ; preds = %._crit_edge1, %._crit_edge
  %26 = sdiv i32 %0, 2
...
38:                                               ; preds = %95, %25
  %39 = phi ptr [ %70, %95 ], [ %1, %25 ]
  %40 = phi i32 [ %97, %95 ], [ 1, %25 ]
  %41 = phi i32 [ %72, %95 ], [ %27, %25 ]
  %42 = sdiv i32 %41, 2
  store i32 %42, ptr %8, align 4
  store i32 %42, ptr %10, align 4
  %.phi.trans.insert = sext i32 %40 to i64
  %.phi.trans.insert2 = getelementptr inbounds [26 x float], ptr %7, i64 0, i64 %.phi.trans.insert
  %.pre = load float, ptr %.phi.trans.insert2, align 4
  br label %43
...
113:                                              ; preds = %110
  store i32 1, ptr %11, align 4
  %114 = icmp sle i32 1, %.pre
  br i1 %114, label %.lr.ph, label %127

.lr.ph:                                           ; preds = %113
  %.pre1 = load float, ptr %10, align 4
  br label %115

115:                                              ; preds = %.lr.ph, %115
  %116 = phi i32 [ 1, %.lr.ph ], [ %125, %115 ]
  %117 = sext i32 %116 to i64
  %118 = getelementptr inbounds %struct.complex, ptr %46, i64 %117
  %119 = load float, ptr %118, align 4
  %120 = fmul float %.pre1, %119
  store float %120, ptr %118, align 4
  %121 = fneg float %.pre1
  %122 = getelementptr inbounds nuw %struct.complex, ptr %118, i32 0, i32 1
  %123 = load float, ptr %122, align 4
  %124 = fmul float %121, %123
  store float %124, ptr %122, align 4
  %125 = add nsw i32 %116, 1
  store i32 %125, ptr %11, align 4
  %126 = icmp sle i32 %125, %.pre
  br i1 %126, label %115, label %._crit_edge, !llvm.loop !17
...
3:                                                ; preds = %.lr.ph, %3
  %4 = phi i32 [ 1, %.lr.ph ], [ %15, %3 ]
  %5 = phi i32 [ 5767, %.lr.ph ], [ %7, %3 ]
  ...
  br i1 %16, label %3, label %._crit_edge, !llvm.loop !18

._crit_edge:                                      ; preds = %3
  br label %17

17:                                               ; preds = %._crit_edge4, %._crit_edge
  store i32 1, ptr %1, align 4
...
18:                                               ; preds = %.lr.ph2, %18
  ...
  br i1 %21, label %18, label %._crit_edge3, !llvm.loop !19

._crit_edge3:                                     ; preds = %18
  br label %22

22:                                               ; preds = %._crit_edge5, %._crit_edge3
...
3:                                                ; preds = %.lr.ph, %3
  ...
  store i32 %5, ptr %2, align 4
  %6 = icmp slt i32 %5, 10
  br i1 %6, label %3, label %._crit_edge, !llvm.loop !20
