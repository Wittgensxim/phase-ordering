...
12:                                               ; preds = %80, %7
  %.011 = phi i32 [ %11, %7 ], [ %81, %80 ]
  %.010 = phi i32 [ 0, %7 ], [ %.011, %80 ]
  %.0 = phi i32 [ 1, %7 ], [ %78, %80 ]
  %13 = phi i32 [ %.011, %80 ], [ 0, %7 ]
  %14 = phi ptr [ %2, %80 ], [ %8, %7 ]
  %15 = phi i32 [ %6, %80 ], [ %9, %7 ]
...
18:                                               ; preds = %18, %12
  %.1 = phi i32 [ %.0, %12 ], [ %78, %18 ]
  %19 = phi i32 [ %.010, %18 ], [ %13, %12 ]
  ...
  %78 = add nsw i32 %.1, 1
  %79 = icmp sle i32 %78, %.011
  br i1 %79, label %18, label %80, !llvm.loop !13

80:                                               ; preds = %18
  %81 = add nsw i32 %.011, %.09
