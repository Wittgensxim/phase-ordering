...
127:                                              ; preds = %125
  %factor = mul i32 %.084, 2
  br label %128

128:                                              ; preds = %127
  %129 = icmp sle i32 %factor, %6
  br i1 %129, label %7, label %130, !llvm.loop !16

130:                                              ; preds = %128
  br label %131

131:                                              ; preds = %151, %130
  %.2 = phi i32 [ 1, %130 ], [ %152, %151 ]
  %132 = icmp sle i32 %.2, %0
