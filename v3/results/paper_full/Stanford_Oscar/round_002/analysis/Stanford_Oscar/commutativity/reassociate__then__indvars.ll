...
25:                                               ; preds = %54, %11
  %.02 = phi i32 [ 1, %11 ], [ %56, %54 ]
  %.0 = phi i32 [ %13, %11 ], [ %26, %54 ]
  %26 = sdiv i32 %.0, 2
...
29:                                               ; preds = %29, %25
  ...
  %30 = add i32 %26, 1
  %31 = trunc nsw i64 %indvars.iv2 to i32
  %32 = add i32 %30, %31
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds %struct.complex, ptr %1, i64 %33
  %35 = load float, ptr %34, align 4
  %.neg = sub i32 0, %26
  %36 = add nsw i64 %indvars.iv2, 1
  ...
  %53 = icmp sle i64 %indvars.iv.next3, %24
...
.lr.ph:                                           ; preds = %69
  %71 = add i32 %0, 1
  %wide.trip.count13 = zext i32 %71 to i64
  br label %72

72:                                               ; preds = %72, %.lr.ph
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %72 ], [ 1, %.lr.ph ]
  ...
  br i1 %exitcond14, label %72, label %._crit_edge, !llvm.loop !17
