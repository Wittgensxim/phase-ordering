...
14:                                               ; preds = %4
  %15 = sdiv i32 %0, 2
  %16 = sdiv i32 %15, 2
  %17 = getelementptr inbounds nuw %struct.complex, ptr %1, i64 1
...
90:                                               ; preds = %87
  %91 = icmp sle i32 1, %0
  br i1 %91, label %.lr.ph, label %121

.lr.ph:                                           ; preds = %90
  %92 = add i32 %0, -1
  %xtraiter12 = and i32 %0, 1
  %93 = icmp ult i32 %92, 1
  br i1 %93, label %.epil.preheader11, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter16 = sub i32 %0, %xtraiter12
  br label %94

94:                                               ; preds = %94, %.lr.ph.new
  %.21 = phi i32 [ 1, %.lr.ph.new ], [ %112, %94 ]
  %niter17 = phi i32 [ 0, %.lr.ph.new ], [ %niter17.next.1, %94 ]
  ...
  %99 = fneg float %4
  %100 = getelementptr inbounds nuw %struct.complex, ptr %96, i32 0, i32 1
  ...
  %108 = fneg float %4
  %109 = getelementptr inbounds nuw %struct.complex, ptr %105, i32 0, i32 1
  %110 = load float, ptr %109, align 4
  %111 = fmul float %108, %110
  store float %111, ptr %109, align 4
  %112 = add nsw i32 %.21, 2
  %niter17.next.1 = add i32 %niter17, 2
  %niter17.ncmp.1 = icmp ne i32 %niter17.next.1, %unroll_iter16
  br i1 %niter17.ncmp.1, label %94, label %._crit_edge.unr-lcssa, !llvm.loop !18

._crit_edge.unr-lcssa:                            ; preds = %94
  %.21.unr = phi i32 [ %112, %94 ]
  %lcmp.mod14 = icmp ne i32 %xtraiter12, 0
  br i1 %lcmp.mod14, label %.epil.preheader11, label %._crit_edge

.epil.preheader11:                                ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  %.21.epil.init = phi i32 [ 1, %.lr.ph ], [ %.21.unr, %._crit_edge.unr-lcssa ]
  %lcmp.mod15 = icmp ne i32 %xtraiter12, 0
  call void @llvm.assume(i1 %lcmp.mod15)
  br label %._crit_edge.epilog-lcssa

._crit_edge.epilog-lcssa:                         ; preds = %.epil.preheader11
  %113 = sext i32 %.21.epil.init to i64
  %114 = getelementptr inbounds %struct.complex, ptr %1, i64 %113
  %115 = load float, ptr %114, align 4
  %116 = fmul float %4, %115
  store float %116, ptr %114, align 4
  %117 = fneg float %4
  %118 = getelementptr inbounds nuw %struct.complex, ptr %114, i32 0, i32 1
