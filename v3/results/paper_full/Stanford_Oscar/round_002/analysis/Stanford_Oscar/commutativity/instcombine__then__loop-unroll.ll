...
29:                                               ; preds = %29, %27
  ...
  br i1 %.not, label %53, label %29, !llvm.loop !10

53:                                               ; preds = %29
  %54 = add nsw i32 %.02, 1
  %55 = call i32 @Min0(i32 noundef %54, i32 noundef 25)
  %56 = icmp sgt i32 %.0, 3
  br i1 %56, label %27, label %57, !llvm.loop !11
...
10:                                               ; preds = %10, %9
  ...
  br i1 %.not.not, label %10, label %58, !llvm.loop !12
...
91:                                               ; preds = %89
  %92 = icmp sgt i32 %0, 0
  br i1 %92, label %.lr.ph, label %122

.lr.ph:                                           ; preds = %91
  %93 = add i32 %0, -1
  %xtraiter6 = and i32 %0, 1
  %94 = icmp ult i32 %93, 1
  br i1 %94, label %.epil.preheader5, label %.lr.ph.new
...
95:                                               ; preds = %95, %.lr.ph.new
  %.21 = phi i32 [ 1, %.lr.ph.new ], [ %113, %95 ]
  %niter11 = phi i32 [ 0, %.lr.ph.new ], [ %niter11.next.1, %95 ]
...
._crit_edge.epilog-lcssa:                         ; preds = %.epil.preheader5
  %114 = zext nneg i32 %.21.epil.init to i64
  %115 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %114
  %116 = load float, ptr %115, align 4
  %117 = fmul float %4, %116
