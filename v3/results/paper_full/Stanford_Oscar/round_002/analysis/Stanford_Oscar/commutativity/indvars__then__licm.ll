...
25:                                               ; preds = %48, %11
  %.02 = phi i32 [ 1, %11 ], [ %50, %48 ]
  %.0 = phi i32 [ %13, %11 ], [ %26, %48 ]
  %26 = sdiv i32 %.0, 2
  ...
  %invariant.op = add i64 %29, 1
  %invariant.op5 = sub i64 1, %30
  br label %31

31:                                               ; preds = %31, %25
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %31 ], [ %27, %25 ]
  %.reass = add i64 %indvars.iv2, %invariant.op
  %32 = getelementptr inbounds %struct.complex, ptr %1, i64 %.reass
  %33 = load float, ptr %32, align 4
  %.reass6 = add i64 %indvars.iv2, %invariant.op5
  %34 = getelementptr inbounds %struct.complex, ptr %1, i64 %.reass6
  %35 = load float, ptr %34, align 4
  %36 = fadd float %33, %35
  %37 = fmul float %.pre, %36
  %38 = add nsw i64 %indvars.iv2, 1
  %39 = getelementptr inbounds %struct.complex, ptr %1, i64 %38
  store float %37, ptr %39, align 4
  %40 = getelementptr inbounds nuw %struct.complex, ptr %32, i32 0, i32 1
  %41 = load float, ptr %40, align 4
  %42 = getelementptr inbounds nuw %struct.complex, ptr %34, i32 0, i32 1
  %43 = load float, ptr %42, align 4
  %44 = fadd float %41, %43
  %45 = fmul float %.pre, %44
  %46 = getelementptr inbounds nuw %struct.complex, ptr %39, i32 0, i32 1
  store float %45, ptr %46, align 4
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, %28
  %47 = icmp sle i64 %indvars.iv.next3, %24
  br i1 %47, label %31, label %48, !llvm.loop !11

48:                                               ; preds = %31
  %49 = add nsw i32 %.02, 1
  %50 = call i32 @Min0(i32 noundef %49, i32 noundef 25)
...
74:                                               ; preds = %74, %.lr.ph
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %74 ], [ 1, %.lr.ph ]
  %75 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv10
  %76 = load float, ptr %75, align 4
  %77 = fmul float %4, %76
  store float %77, ptr %75, align 4
  %78 = getelementptr inbounds nuw %struct.complex, ptr %75, i32 0, i32 1
  %79 = load float, ptr %78, align 4
  %80 = fmul float %73, %79
  store float %80, ptr %78, align 4
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond14 = icmp ne i64 %indvars.iv.next11, %wide.trip.count13
  br i1 %exitcond14, label %74, label %._crit_edge, !llvm.loop !17
