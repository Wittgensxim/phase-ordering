...
29:                                               ; preds = %29, %25
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %29 ], [ %27, %25 ]
  %30 = trunc nsw i64 %indvars.iv4 to i32
  %.reass = add i32 %30, %invariant.op
  %31 = sext i32 %.reass to i64
  %32 = getelementptr inbounds %struct.complex, ptr %1, i64 %31
  %33 = load float, ptr %32, align 4
  %34 = trunc nsw i64 %indvars.iv4 to i32
  ...
  %49 = icmp sle i64 %indvars.iv.next5, %24
...
.lr.ph:                                           ; preds = %70
  %72 = fneg float %4
  %73 = add i32 %0, 1
  %wide.trip.count13 = zext i32 %73 to i64
  br label %74
