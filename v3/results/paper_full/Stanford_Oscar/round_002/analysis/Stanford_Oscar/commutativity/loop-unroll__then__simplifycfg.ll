...
8:                                                ; preds = %.epilog-lcssa, %5
  %.01 = phi i32 [ 1, %5 ], [ %87, %.epilog-lcssa ]
  br label %9
...
._crit_edge:                                      ; preds = %.epil.preheader2, %._crit_edge.unr-lcssa, %89
  ret void
}
