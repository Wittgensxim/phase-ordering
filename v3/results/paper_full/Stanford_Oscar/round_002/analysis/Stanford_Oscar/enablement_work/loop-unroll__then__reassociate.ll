...
86:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  %factor = mul i32 %.01, 2
  %87 = icmp sle i32 %factor, %6
  br i1 %87, label %8, label %88, !llvm.loop !17

88:                                               ; preds = %86
  %89 = icmp sle i32 1, %0
  br i1 %89, label %.lr.ph, label %119

.lr.ph:                                           ; preds = %88
  %90 = add i32 %0, -1
  %xtraiter3 = and i32 %0, 1
  %91 = icmp ult i32 %90, 1
  br i1 %91, label %.epil.preheader2, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter7 = sub i32 %0, %xtraiter3
  br label %92

92:                                               ; preds = %92, %.lr.ph.new
  %.21 = phi i32 [ 1, %.lr.ph.new ], [ %110, %92 ]
  %niter8 = phi i32 [ 0, %.lr.ph.new ], [ %niter8.next.1, %92 ]
  ...
  br i1 %niter8.ncmp.1, label %92, label %._crit_edge.unr-lcssa, !llvm.loop !18

._crit_edge.unr-lcssa:                            ; preds = %92
  %.21.unr = phi i32 [ %110, %92 ]
