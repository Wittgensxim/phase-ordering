...
60:                                               ; preds = %60, %59
  ...
  %.not10.not = icmp slt i32 %.0, %0
  br i1 %.not10.not, label %60, label %66, !llvm.loop !15

66:                                               ; preds = %60
  %67 = shl nsw i32 %.01, 1
  %.not11 = icmp sgt i32 %67, %6
  br i1 %.not11, label %68, label %7, !llvm.loop !16
...
70:                                               ; preds = %70, %.lr.ph
  ...
  %.not12.not = icmp slt i32 %.21, %0
  br i1 %.not12.not, label %70, label %._crit_edge, !llvm.loop !17
