...
.lr.ph:                                           ; preds = %90
  ...
  br i1 %93, label %.lr.ph..epil.preheader2_crit_edge, label %.lr.ph.new

.lr.ph..epil.preheader2_crit_edge:                ; preds = %.lr.ph
  %.pre = fneg float %4
  br label %.epil.preheader2
...
.epil.preheader2:                                 ; preds = %.lr.ph..epil.preheader2_crit_edge, %._crit_edge.unr-lcssa
  %.pre-phi = phi float [ %.pre, %.lr.ph..epil.preheader2_crit_edge ], [ %99, %._crit_edge.unr-lcssa ]
  %.21.epil.init = phi i32 [ 1, %.lr.ph..epil.preheader2_crit_edge ], [ %111, %._crit_edge.unr-lcssa ]
