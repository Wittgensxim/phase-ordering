...
10:                                               ; preds = %60, %9
  %.04 = phi i32 [ 1, %9 ], [ %.lcssa, %60 ]
  %.03 = phi i32 [ %.01, %9 ], [ %61, %60 ]
  %.02 = phi i32 [ 0, %9 ], [ %.03, %60 ]
  %11 = add nsw i32 %.02, 1
...
86:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  ...
  br i1 %88, label %9, label %89, !llvm.loop !17
