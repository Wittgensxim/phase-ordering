...
31:                                               ; preds = %31, %25
  ...
  %51 = icmp sle i64 %indvars.iv.next3, %24
...
52:                                               ; preds = %31
  ...
  br i1 %55, label %25, label %56, !llvm.loop !11
...
17:                                               ; preds = %17, %13
  %indvars.iv = phi i64 [ %indvars.iv.next, %17 ], [ %14, %13 ]
  ...
  br i1 %exitcond, label %17, label %60, !llvm.loop !12

60:                                               ; preds = %17
  %.lcssa.wide = phi i64 [ %indvars.iv.next, %17 ]
...
81:                                               ; preds = %78
  %82 = icmp sle i32 1, %0
  br i1 %82, label %.lr.ph, label %107

.lr.ph:                                           ; preds = %81
  %83 = add i32 %0, -1
  %xtraiter17 = and i32 %0, 1
  %84 = icmp ult i32 %83, 1
  br i1 %84, label %.epil.preheader16, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter21 = sub i32 %0, %xtraiter17
  br label %85

85:                                               ; preds = %85, %.lr.ph.new
  %indvars.iv10 = phi i64 [ 1, %.lr.ph.new ], [ %indvars.iv.next11.1, %85 ]
  %niter22 = phi i32 [ 0, %.lr.ph.new ], [ %niter22.next.1, %85 ]
  %86 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv10
  %87 = load float, ptr %86, align 4
  %88 = fmul float %4, %87
  store float %88, ptr %86, align 4
  %89 = fneg float %4
  %90 = getelementptr inbounds nuw %struct.complex, ptr %86, i32 0, i32 1
  ...
  br i1 %niter22.ncmp.1, label %85, label %._crit_edge.unr-lcssa, !llvm.loop !18

._crit_edge.unr-lcssa:                            ; preds = %85
  %indvars.iv10.unr = phi i64 [ %indvars.iv.next11.1, %85 ]
...
._crit_edge.epilog-lcssa:                         ; preds = %.epil.preheader16
  %100 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv10.epil.init
