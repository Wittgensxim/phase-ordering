...
12:                                               ; preds = %59, %10
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %59 ], [ %11, %10 ]
...
15:                                               ; preds = %15, %12
  ...
  %45 = add nsw i64 %indvars.iv, %indvars.iv10
  ...
  %58 = icmp sle i64 %indvars.iv.next, %indvars.iv10
  br i1 %58, label %15, label %59, !llvm.loop !12

59:                                               ; preds = %15
  %.lcssa.wide = phi i64 [ %indvars.iv.next, %15 ]
  %60 = trunc nsw i64 %.lcssa.wide to i32
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, %11
  %61 = icmp sle i64 %indvars.iv.next11, %9
  %62 = trunc nsw i64 %indvars.iv10 to i32
  br i1 %61, label %12, label %63, !llvm.loop !13

63:                                               ; preds = %59
  %xtraiter = and i32 %smax, 3
  %64 = icmp ult i32 %7, 3
  br i1 %64, label %.epil.preheader, label %.new
...
65:                                               ; preds = %65, %.new
  %.0 = phi i32 [ 1, %.new ], [ %81, %65 ]
  %niter = phi i32 [ 0, %.new ], [ %niter.next.3, %65 ]
  %66 = sext i32 %.0 to i64
  %67 = getelementptr inbounds %struct.complex, ptr %1, i64 %66
  %68 = getelementptr inbounds %struct.complex, ptr %2, i64 %66
  ...
  br i1 %niter.ncmp.3, label %65, label %.unr-lcssa, !llvm.loop !14
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %63
  %.0.epil.init = phi i32 [ 1, %63 ], [ %.0.unr, %.unr-lcssa ]
  %lcmp.mod1 = icmp ne i32 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod1)
  %82 = sext i32 %.0.epil.init to i64
  br label %83

83:                                               ; preds = %83, %.epil.preheader
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %83 ], [ %82, %.epil.preheader ]
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %83 ]
  %84 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv13
  %85 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv13
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %84, ptr align 4 %85, i64 8, i1 false)
...
86:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  ...
  br i1 %88, label %10, label %89, !llvm.loop !17

89:                                               ; preds = %86
  %90 = icmp sle i32 1, %0
  br i1 %90, label %.lr.ph, label %120

.lr.ph:                                           ; preds = %89
  %91 = add i32 %0, -1
  %xtraiter3 = and i32 %0, 1
  %92 = icmp ult i32 %91, 1
  br i1 %92, label %.epil.preheader2, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter7 = sub i32 %0, %xtraiter3
  br label %93

93:                                               ; preds = %93, %.lr.ph.new
  %.21 = phi i32 [ 1, %.lr.ph.new ], [ %111, %93 ]
  %niter8 = phi i32 [ 0, %.lr.ph.new ], [ %niter8.next.1, %93 ]
  ...
  %98 = fneg float %4
  %99 = getelementptr inbounds nuw %struct.complex, ptr %95, i32 0, i32 1
  ...
  %107 = fneg float %4
  %108 = getelementptr inbounds nuw %struct.complex, ptr %104, i32 0, i32 1
  ...
  br i1 %niter8.ncmp.1, label %93, label %._crit_edge.unr-lcssa, !llvm.loop !18

._crit_edge.unr-lcssa:                            ; preds = %93
  %.21.unr = phi i32 [ %111, %93 ]
...
._crit_edge.epilog-lcssa:                         ; preds = %.epil.preheader2
  ...
  %116 = fneg float %4
  %117 = getelementptr inbounds nuw %struct.complex, ptr %113, i32 0, i32 1
