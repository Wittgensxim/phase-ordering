...
9:                                                ; preds = %9, %8
  ...
  br i1 %.not.not, label %9, label %57, !llvm.loop !12
...
90:                                               ; preds = %88
  %91 = icmp sgt i32 %0, 0
  br i1 %91, label %.lr.ph, label %120
...
93:                                               ; preds = %93, %.lr.ph.new
  ...
  %111 = add nuw nsw i32 %.21, 2
  %niter8.next.1 = add i32 %niter8, 2
  %niter8.ncmp.1.not = icmp eq i32 %niter8.next.1, %unroll_iter7
  br i1 %niter8.ncmp.1.not, label %._crit_edge.unr-lcssa, label %93, !llvm.loop !18
