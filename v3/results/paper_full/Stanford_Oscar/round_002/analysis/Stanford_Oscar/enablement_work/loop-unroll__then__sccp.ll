...
62:                                               ; preds = %59
  ...
  %63 = icmp slt i32 %smax, 4
  br i1 %63, label %.epil.preheader, label %.new

.new:                                             ; preds = %62
  %unroll_iter = sub nsw i32 %smax, %xtraiter
  br label %64
...
.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter7 = sub nuw nsw i32 %0, %xtraiter3
  br label %94
