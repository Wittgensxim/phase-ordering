...
27:                                               ; preds = %52, %14
  %.02 = phi i32 [ 1, %14 ], [ %54, %52 ]
  %.0 = phi i32 [ %16, %14 ], [ %28, %52 ]
  %28 = sdiv i32 %.0, 2
...
30:                                               ; preds = %30, %27
  ...
  %45 = getelementptr inbounds nuw %struct.complex, ptr %36, i32 0, i32 1
  ...
  br i1 %51, label %30, label %52, !llvm.loop !11

52:                                               ; preds = %30
  %53 = add nsw i32 %.02, 1
  %54 = call i32 @Min0(i32 noundef %53, i32 noundef 25)
  %55 = icmp sgt i32 %28, 1
  br i1 %55, label %27, label %56, !llvm.loop !12
