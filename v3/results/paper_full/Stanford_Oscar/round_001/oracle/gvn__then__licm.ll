...
28:                                               ; preds = %51, %15
  %.02 = phi i32 [ 1, %15 ], [ %53, %51 ]
  %.0 = phi i32 [ %17, %15 ], [ %29, %51 ]
  %29 = sdiv i32 %.0, 2
  ...
  %invariant.op5 = sub i32 1, %29
  br label %30

30:                                               ; preds = %30, %28
  %.01 = phi i32 [ %29, %28 ], [ %49, %30 ]
  ...
  %44 = getelementptr inbounds nuw %struct.complex, ptr %35, i32 0, i32 1
...
51:                                               ; preds = %30
  ...
  br i1 %54, label %28, label %55, !llvm.loop !12
