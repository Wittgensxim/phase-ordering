...
28:                                               ; preds = %55, %15
  ...
  %invariant.op1 = sub i32 1, %29
  %33 = load float, ptr %31, align 4
  br label %34

34:                                               ; preds = %34, %28
  %.01 = phi i32 [ %29, %28 ], [ %53, %34 ]
  ...
  br i1 %54, label %34, label %55, !llvm.loop !11
...
71:                                               ; preds = %.preheader, %73
  %.2 = phi i32 [ %81, %73 ], [ 1, %.preheader ]
  %72 = icmp sle i32 %.2, %0
