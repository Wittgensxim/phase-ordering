...
27:                                               ; preds = %58, %14
  %.02 = phi i32 [ 1, %14 ], [ %60, %58 ]
  %.0 = phi i32 [ %16, %14 ], [ %28, %58 ]
  %28 = sdiv i32 %.0, 2
  br label %29

29:                                               ; preds = %29, %27
  %.01 = phi i32 [ %28, %27 ], [ %56, %29 ]
  %30 = sext i32 %.02 to i64
  %31 = getelementptr inbounds [26 x float], ptr %3, i64 0, i64 %30
  %32 = load float, ptr %31, align 4
  %33 = add nsw i32 %.01, %28
  %34 = add nsw i32 %33, 1
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds %struct.complex, ptr %1, i64 %35
  %37 = load float, ptr %36, align 4
  %38 = sub nsw i32 %.01, %28
  %39 = add nsw i32 %38, 1
  ...
  %49 = getelementptr inbounds nuw %struct.complex, ptr %36, i32 0, i32 1
  %50 = load float, ptr %49, align 4
  %51 = getelementptr inbounds nuw %struct.complex, ptr %41, i32 0, i32 1
...
58:                                               ; preds = %9
  ...
  br i1 %60, label %8, label %.preheader1, !llvm.loop !14

.preheader1:                                      ; preds = %58
  br label %61

61:                                               ; preds = %.preheader1, %61
  %.0 = phi i32 [ %65, %61 ], [ 1, %.preheader1 ]
  %62 = sext i32 %.0 to i64
  %63 = getelementptr inbounds %struct.complex, ptr %1, i64 %62
  %64 = getelementptr inbounds %struct.complex, ptr %2, i64 %62
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %63, ptr align 4 %64, i64 8, i1 false)
  %65 = add nsw i32 %.0, 1
  %66 = icmp sle i32 %65, %0
  br i1 %66, label %61, label %67, !llvm.loop !15

67:                                               ; preds = %61
  %68 = add nsw i32 %.01, %.01
  %69 = icmp sle i32 %68, %6
  br i1 %69, label %7, label %.preheader, !llvm.loop !16
...
71:                                               ; preds = %.lr.ph, %71
  ...
  br i1 %81, label %71, label %._crit_edge, !llvm.loop !17

._crit_edge:                                      ; preds = %71
  br label %82

82:                                               ; preds = %._crit_edge, %.preheader
  ret void
}
