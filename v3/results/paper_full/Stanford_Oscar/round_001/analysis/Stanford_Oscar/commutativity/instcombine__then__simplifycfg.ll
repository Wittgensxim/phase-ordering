...
28:                                               ; preds = %58, %15
  %.02 = phi i32 [ 1, %15 ], [ %60, %58 ]
  %.0 = phi i32 [ %17, %15 ], [ %29, %58 ]
  %29 = sdiv i32 %.0, 2
  br label %30
...
30:                                               ; preds = %30, %28
  ...
  %57 = add nsw i32 %.01, %.0
  %.not = icmp sgt i32 %57, %16
  br i1 %.not, label %58, label %30, !llvm.loop !11

58:                                               ; preds = %30
  %59 = add nsw i32 %.02, 1
  %60 = call i32 @Min0(i32 noundef %59, i32 noundef 25)
  %61 = icmp sgt i32 %.0, 3
  br i1 %61, label %28, label %62, !llvm.loop !12
...
59:                                               ; preds = %57, %59
  ...
  br i1 %.not1.not, label %59, label %65, !llvm.loop !15

65:                                               ; preds = %59
  %66 = shl nsw i32 %.01, 1
  %.not2 = icmp sgt i32 %66, %6
  br i1 %.not2, label %67, label %7, !llvm.loop !16

67:                                               ; preds = %65, %68
  %.2 = phi i32 [ %77, %68 ], [ 1, %65 ]
  %.not3 = icmp sgt i32 %.2, %0
  br i1 %.not3, label %78, label %68
