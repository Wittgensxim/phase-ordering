...
70:                                               ; preds = %69
  %factor = shl i32 %.01, 1
  %.not2 = icmp sgt i32 %factor, %6
  br i1 %.not2, label %71, label %7, !llvm.loop !16

71:                                               ; preds = %70
  br label %72

72:                                               ; preds = %82, %71
  %.2 = phi i32 [ 1, %71 ], [ %83, %82 ]
  %.not3 = icmp sgt i32 %.2, %0
  br i1 %.not3, label %84, label %73
