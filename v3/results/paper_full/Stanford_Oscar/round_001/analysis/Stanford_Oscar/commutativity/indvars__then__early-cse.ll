...
27:                                               ; preds = %60, %13
  %.02 = phi i32 [ 1, %13 ], [ %59, %60 ]
  %.0 = phi i32 [ %15, %13 ], [ %28, %60 ]
  %28 = sdiv i32 %.0, 2
...
31:                                               ; preds = %55, %27
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %55 ], [ %29, %27 ]
  ...
  %39 = sub nsw i64 %indvars.iv2, %29
  %40 = add nsw i64 %39, 1
  %41 = getelementptr inbounds %struct.complex, ptr %1, i64 %40
  %42 = load float, ptr %41, align 4
  %43 = fadd float %38, %42
  %44 = fmul float %34, %43
  %45 = add nsw i64 %indvars.iv2, 1
  %46 = getelementptr inbounds %struct.complex, ptr %1, i64 %45
  store float %44, ptr %46, align 4
  %47 = load float, ptr %33, align 4
  %48 = getelementptr inbounds nuw %struct.complex, ptr %37, i32 0, i32 1
  %49 = load float, ptr %48, align 4
  %50 = getelementptr inbounds nuw %struct.complex, ptr %41, i32 0, i32 1
  %51 = load float, ptr %50, align 4
  %52 = fadd float %49, %51
  %53 = fmul float %47, %52
  %54 = getelementptr inbounds nuw %struct.complex, ptr %46, i32 0, i32 1
  store float %53, ptr %54, align 4
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, %30
  br label %55

55:                                               ; preds = %31
  %56 = icmp sle i64 %indvars.iv.next3, %26
...
60:                                               ; preds = %57
  ...
  br i1 %61, label %27, label %62, !llvm.loop !12
...
9:                                                ; preds = %71, %5
  %.01 = phi i32 [ 1, %5 ], [ %70, %71 ]
  %10 = sext i32 %.01 to i64
  br label %11

11:                                               ; preds = %61, %9
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %61 ], [ %10, %9 ]
  %.04 = phi i32 [ 1, %9 ], [ %60, %61 ]
  %.02 = phi i32 [ 0, %9 ], [ %63, %61 ]
...
15:                                               ; preds = %58, %11
  %indvars.iv = phi i64 [ %indvars.iv.next, %58 ], [ %12, %11 ]
...
58:                                               ; preds = %15
  ...
  br i1 %exitcond, label %15, label %59, !llvm.loop !13
...
61:                                               ; preds = %59
  %62 = icmp sle i64 %indvars.iv.next3, %7
  %63 = trunc nsw i64 %indvars.iv2 to i32
  br i1 %62, label %11, label %64, !llvm.loop !14
...
65:                                               ; preds = %68, %64
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %68 ], [ 1, %64 ]
  %66 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv5
  %67 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv5
...
68:                                               ; preds = %65
  ...
  br i1 %exitcond9, label %65, label %69, !llvm.loop !15

69:                                               ; preds = %68
  %70 = add nsw i32 %.01, %.01
  br label %71

71:                                               ; preds = %69
  %72 = icmp sle i32 %70, %6
