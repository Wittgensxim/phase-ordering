...
29:                                               ; preds = %62, %16
  %.02 = phi i32 [ 1, %16 ], [ %61, %62 ]
  %.0 = phi i32 [ %18, %16 ], [ %30, %62 ]
  %30 = sdiv i32 %.0, 2
...
36:                                               ; preds = %57, %29
  ...
  %49 = getelementptr inbounds nuw %struct.complex, ptr %39, i32 0, i32 1
  %50 = load float, ptr %49, align 4
  %51 = getelementptr inbounds nuw %struct.complex, ptr %42, i32 0, i32 1
  %52 = load float, ptr %51, align 4
  %53 = fadd float %50, %52
  %54 = fmul float %35, %53
  %55 = getelementptr inbounds nuw %struct.complex, ptr %48, i32 0, i32 1
  store float %54, ptr %55, align 4
  %56 = add nsw i32 %.01, %.0
  br label %57

57:                                               ; preds = %36
  %58 = icmp sle i32 %56, %17
...
62:                                               ; preds = %59
  ...
  br i1 %63, label %29, label %64, !llvm.loop !12
