...
64:                                               ; preds = %62
  ...
  %65 = icmp eq i32 %smax, 1
  br i1 %65, label %.epil.preheader, label %.new

.new:                                             ; preds = %64
  %unroll_iter = sub nuw nsw i32 %smax, %xtraiter
  br label %66
