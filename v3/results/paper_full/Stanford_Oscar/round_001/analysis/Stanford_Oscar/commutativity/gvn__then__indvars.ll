...
26:                                               ; preds = %53, %12
  %.02 = phi i32 [ 1, %12 ], [ %55, %53 ]
  %.0 = phi i32 [ %14, %12 ], [ %27, %53 ]
  %27 = sdiv i32 %.0, 2
...
32:                                               ; preds = %32, %26
  ...
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, %29
  %52 = icmp sle i64 %indvars.iv.next7, %25
