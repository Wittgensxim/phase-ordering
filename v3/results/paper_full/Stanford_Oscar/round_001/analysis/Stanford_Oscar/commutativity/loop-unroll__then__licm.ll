...
55:                                               ; preds = %35
  ...
  br i1 %56, label %35, label %57, !llvm.loop !10
...
60:                                               ; preds = %57
  ...
  br i1 %61, label %29, label %62, !llvm.loop !11
...
10:                                               ; preds = %63, %9
  %.04 = phi i32 [ 1, %9 ], [ %.lcssa, %63 ]
  %.03 = phi i32 [ %.01, %9 ], [ %62, %63 ]
  %.02 = phi i32 [ 0, %9 ], [ %.03, %63 ]
  %11 = add nsw i32 %.02, 1
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds %struct.complex, ptr %3, i64 %12
  %14 = getelementptr inbounds nuw %struct.complex, ptr %13, i32 0, i32 1
  br label %15

15:                                               ; preds = %59, %10
  %.1 = phi i32 [ %.04, %10 ], [ %58, %59 ]
  ...
  %26 = getelementptr inbounds %struct.complex, ptr %2, i64 %25
  store float %23, ptr %26, align 4
  %27 = getelementptr inbounds nuw %struct.complex, ptr %17, i32 0, i32 1
  %28 = load float, ptr %27, align 4
  %29 = getelementptr inbounds nuw %struct.complex, ptr %21, i32 0, i32 1
  %30 = load float, ptr %29, align 4
  %31 = fadd float %28, %30
  %32 = getelementptr inbounds nuw %struct.complex, ptr %26, i32 0, i32 1
  ...
  %41 = fmul float %37, %40
  %42 = fneg float %41
  %43 = call float @llvm.fmuladd.f32(float %33, float %36, float %42)
  %44 = add nsw i32 %.1, %.03
  %45 = sext i32 %44 to i64
...
59:                                               ; preds = %15
  %60 = icmp sle i32 %58, %.03
  br i1 %60, label %15, label %61, !llvm.loop !12

61:                                               ; preds = %59
  %.lcssa = phi i32 [ %58, %59 ]
  %62 = add nsw i32 %.03, %.01
  br label %63

63:                                               ; preds = %61
  %64 = icmp sle i32 %62, %6
  br i1 %64, label %10, label %65, !llvm.loop !13

65:                                               ; preds = %63
  br i1 %8, label %.epil.preheader, label %.new
...
83:                                               ; preds = %81
  ...
  br i1 %84, label %9, label %85, !llvm.loop !15
...
89:                                               ; preds = %87
  ...
  %94 = getelementptr inbounds nuw %struct.complex, ptr %91, i32 0, i32 1
