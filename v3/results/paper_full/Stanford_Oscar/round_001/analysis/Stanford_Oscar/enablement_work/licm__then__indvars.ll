...
27:                                               ; preds = %60, %13
  ...
  %30 = getelementptr inbounds [26 x float], ptr %3, i64 0, i64 %29
...
35:                                               ; preds = %55, %27
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %55 ], [ %33, %27 ]
  %36 = trunc nsw i64 %indvars.iv4 to i32
  %.reass = add i32 %36, %invariant.op
  %37 = sext i32 %.reass to i64
  %38 = getelementptr inbounds %struct.complex, ptr %1, i64 %37
  %39 = load float, ptr %38, align 4
  %40 = trunc nsw i64 %indvars.iv4 to i32
  %.reass2 = add i32 %40, %invariant.op1
  %41 = sext i32 %.reass2 to i64
  ...
  %48 = getelementptr inbounds nuw %struct.complex, ptr %38, i32 0, i32 1
  %49 = load float, ptr %48, align 4
  %50 = getelementptr inbounds nuw %struct.complex, ptr %42, i32 0, i32 1
  %51 = load float, ptr %50, align 4
  %52 = fadd float %49, %51
  %53 = fmul float %32, %52
  %54 = getelementptr inbounds nuw %struct.complex, ptr %47, i32 0, i32 1
  store float %53, ptr %54, align 4
  %indvars.iv.next5 = add nsw i64 %indvars.iv4, %34
  br label %55

55:                                               ; preds = %35
  %56 = icmp sle i64 %indvars.iv.next5, %26
...
20:                                               ; preds = %59, %12
  %indvars.iv = phi i64 [ %indvars.iv.next, %59 ], [ %17, %12 ]
...
59:                                               ; preds = %20
  ...
  br i1 %exitcond, label %20, label %60, !llvm.loop !13
...
74:                                               ; preds = %72
  ...
  %76 = add nuw i32 %smax13, 1
  %wide.trip.count14 = zext i32 %76 to i64
  br label %77

77:                                               ; preds = %85, %74
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %85 ], [ 1, %74 ]
  %exitcond15 = icmp ne i64 %indvars.iv10, %wide.trip.count14
  br i1 %exitcond15, label %78, label %86

78:                                               ; preds = %77
  %79 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv10
  %80 = load float, ptr %79, align 4
  %81 = fmul float %4, %80
  store float %81, ptr %79, align 4
  %82 = getelementptr inbounds nuw %struct.complex, ptr %79, i32 0, i32 1
