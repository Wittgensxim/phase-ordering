...
13:                                               ; preds = %4
  %14 = sdiv i32 %0, 2
  %15 = sdiv i32 %14, 2
  %16 = getelementptr inbounds nuw %struct.complex, ptr %1, i64 1
...
33:                                               ; preds = %57, %27
  ...
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, %30
  br label %57

57:                                               ; preds = %33
  %58 = icmp sle i64 %indvars.iv.next9, %26
...
define dso_local void @Fft(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, float noundef %4) #0 {
  ...
  %7 = sext i32 %6 to i64
  %8 = sext i32 %6 to i64
  %smax19 = call i32 @llvm.smax.i32(i32 %0, i32 1)
  %9 = add nuw i32 %smax19, 1
  br label %10
...
12:                                               ; preds = %62, %10
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %62 ], [ %11, %10 ]
  %.04 = phi i32 [ 1, %10 ], [ %61, %62 ]
  %.02 = phi i32 [ 0, %10 ], [ %64, %62 ]
  %13 = sext i32 %.04 to i64
  %14 = sext i32 %.02 to i64
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv13, i64 %13)
  %15 = add i64 %smax, 1
  br label %16
...
16:                                               ; preds = %59, %12
  ...
  %46 = add nsw i64 %indvars.iv, %indvars.iv13
...
60:                                               ; preds = %59
  ...
  %indvars.iv.next14 = add nsw i64 %indvars.iv13, %11
  br label %62

62:                                               ; preds = %60
  %63 = icmp sle i64 %indvars.iv.next14, %8
  %64 = trunc nsw i64 %indvars.iv13 to i32
...
66:                                               ; preds = %69, %65
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %69 ], [ 1, %65 ]
  %67 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv16
  %68 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv16
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %67, ptr align 4 %68, i64 8, i1 false)
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %69

69:                                               ; preds = %66
  %exitcond20 = icmp ne i64 %indvars.iv.next17, %wide.trip.count
  br i1 %exitcond20, label %66, label %70, !llvm.loop !15
...
74:                                               ; preds = %72
  ...
  %75 = add nuw i32 %smax24, 1
  %wide.trip.count25 = zext i32 %75 to i64
  br label %76

76:                                               ; preds = %85, %74
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %85 ], [ 1, %74 ]
  %exitcond26 = icmp ne i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26, label %77, label %86

77:                                               ; preds = %76
  %78 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv21
  %79 = load float, ptr %78, align 4
  %80 = fmul float %4, %79
  store float %80, ptr %78, align 4
  %81 = fneg float %4
  %82 = getelementptr inbounds nuw %struct.complex, ptr %78, i32 0, i32 1
