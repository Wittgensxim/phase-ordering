...
4:                                                ; preds = %2, %12
  %.034 = phi float [ 4.000000e+00, %2 ], [ %11, %12 ]
  %.043 = phi i32 [ 1, %2 ], [ %13, %12 ]
  %5 = fdiv float f0x40490FDB, %.034
  ...
  %11 = fadd float %.034, %.034
  br label %12

12:                                               ; preds = %4
  %13 = add nsw i32 %.043, 1
...
54:                                               ; preds = %34
  %55 = icmp sle i32 %53, %16
  br i1 %55, label %34, label %56, !llvm.loop !11

56:                                               ; preds = %54
  %57 = add nsw i32 %.02, 1
  %58 = call i32 @Min0(i32 noundef %57, i32 noundef 25)
  br label %59

59:                                               ; preds = %56
  %60 = icmp sgt i32 %29, 1
  br i1 %60, label %28, label %61, !llvm.loop !12
...
86:                                               ; preds = %78
  ...
  br i1 %88, label %78, label %._crit_edge, !llvm.loop !17
