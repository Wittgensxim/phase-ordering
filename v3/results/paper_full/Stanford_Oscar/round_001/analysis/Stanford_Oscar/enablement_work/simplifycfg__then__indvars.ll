...
12:                                               ; preds = %59, %10
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %59 ], [ %11, %10 ]
...
59:                                               ; preds = %16
  ...
  %61 = icmp sle i64 %indvars.iv.next4, %8
  %62 = trunc nsw i64 %indvars.iv3 to i32
  br i1 %61, label %12, label %.preheader1, !llvm.loop !14

.preheader1:                                      ; preds = %59
  %wide.trip.count = zext i32 %9 to i64
  br label %63

63:                                               ; preds = %.preheader1, %63
  %indvars.iv6 = phi i64 [ 1, %.preheader1 ], [ %indvars.iv.next7, %63 ]
  %64 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv6
  %65 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv6
  ...
  br i1 %exitcond10, label %63, label %66, !llvm.loop !15

66:                                               ; preds = %63
  %67 = add nsw i32 %.01, %.01
  %68 = icmp sle i32 %67, %6
  br i1 %68, label %10, label %.preheader, !llvm.loop !16

.preheader:                                       ; preds = %66
  %smax14 = call i32 @llvm.smax.i32(i32 %0, i32 0)
  %69 = add nuw i32 %smax14, 1
  %wide.trip.count15 = zext i32 %69 to i64
  br label %70

70:                                               ; preds = %.preheader, %71
  %indvars.iv11 = phi i64 [ 1, %.preheader ], [ %indvars.iv.next12, %71 ]
  %exitcond16 = icmp ne i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16, label %71, label %79

71:                                               ; preds = %70
  %72 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv11
  %73 = load float, ptr %72, align 4
  %74 = fmul float %4, %73
  store float %74, ptr %72, align 4
  %75 = fneg float %4
  %76 = getelementptr inbounds nuw %struct.complex, ptr %72, i32 0, i32 1
