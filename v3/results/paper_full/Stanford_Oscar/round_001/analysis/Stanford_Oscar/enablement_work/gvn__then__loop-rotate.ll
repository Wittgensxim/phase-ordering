...
4:                                                ; preds = %2, %4
  %.036 = phi float [ 4.000000e+00, %2 ], [ %11, %4 ]
  %.045 = phi i32 [ 1, %2 ], [ %12, %4 ]
...
73:                                               ; preds = %.lr.ph, %73
  ...
  %78 = fneg float %4
  %79 = getelementptr inbounds nuw %struct.complex, ptr %75, i32 0, i32 1
  %80 = load float, ptr %79, align 4
  %81 = fmul float %78, %80
  store float %81, ptr %79, align 4
  %82 = add nsw i32 %.21, 1
  %83 = icmp sle i32 %82, %0
  br i1 %83, label %73, label %._crit_edge, !llvm.loop !17
