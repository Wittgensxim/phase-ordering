...
20:                                               ; preds = %19
  ...
  %22 = icmp samesign ult i32 %.013, 10
...
11:                                               ; preds = %4
  ...
  %14 = icmp samesign ult i32 %.041, 25
...
67:                                               ; preds = %62
  ...
  %.not2.not = icmp slt i32 %.0, %0
  br i1 %.not2.not, label %62, label %69, !llvm.loop !15
...
70:                                               ; preds = %69
  %71 = shl nsw i32 %.01, 1
  %.not3 = icmp sgt i32 %71, %6
  br i1 %.not3, label %72, label %7, !llvm.loop !16

72:                                               ; preds = %70
  %73 = icmp sgt i32 %0, 0
  br i1 %73, label %.lr.ph, label %85

.lr.ph:                                           ; preds = %72
  br label %74

74:                                               ; preds = %.lr.ph, %83
  %.21 = phi i32 [ 1, %.lr.ph ], [ %84, %83 ]
  %75 = zext nneg i32 %.21 to i64
...
83:                                               ; preds = %74
  ...
  %.not4.not = icmp slt i32 %.21, %0
  br i1 %.not4.not, label %74, label %._crit_edge, !llvm.loop !17

._crit_edge:                                      ; preds = %83
  br label %85

85:                                               ; preds = %._crit_edge, %72
  ret void
}
...
13:                                               ; preds = %2
  ...
  %15 = icmp samesign ult i32 %.01, 256
...
18:                                               ; preds = %17
  ...
  %20 = icmp samesign ult i32 %.12, 20
