...
4:                                                ; preds = %11, %2
  ...
  %.03 = phi float [ 4.000000e+00, %2 ], [ %12, %11 ]
...
10:                                               ; preds = %71, %5
  %.01 = phi i32 [ 1, %5 ], [ %72, %71 ]
  %11 = sext i32 %.01 to i64
  br label %12

12:                                               ; preds = %62, %10
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %62 ], [ %11, %10 ]
  %.04 = phi i32 [ 1, %10 ], [ %61, %62 ]
  %.02 = phi i32 [ 0, %10 ], [ %63, %62 ]
...
62:                                               ; preds = %60
  ...
  %63 = trunc nsw i64 %indvars.iv5 to i32
  br i1 %.not, label %64, label %12, !llvm.loop !14
...
65:                                               ; preds = %69, %64
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %69 ], [ 1, %64 ]
  %66 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv8
  %67 = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv8
...
69:                                               ; preds = %65
  ...
  br i1 %exitcond12, label %65, label %70, !llvm.loop !15
...
71:                                               ; preds = %70
  %72 = shl nsw i32 %.01, 1
  %.not2 = icmp sgt i32 %72, %6
  br i1 %.not2, label %73, label %10, !llvm.loop !16

73:                                               ; preds = %71
  %smax16 = call i32 @llvm.smax.i32(i32 %0, i32 0)
  %74 = add nuw i32 %smax16, 1
  %wide.trip.count17 = zext i32 %74 to i64
  br label %75

75:                                               ; preds = %84, %73
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %84 ], [ 1, %73 ]
  %exitcond18 = icmp eq i64 %indvars.iv13, %wide.trip.count17
  br i1 %exitcond18, label %85, label %76

76:                                               ; preds = %75
  %77 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv13
