...
28:                                               ; preds = %54, %15
  ...
  %.phi.trans.insert1 = getelementptr inbounds [4 x i8], ptr %3, i64 %.phi.trans.insert
...
30:                                               ; preds = %30, %28
  ...
  %48 = getelementptr i8, ptr %38, i64 12
  ...
  br i1 %.not, label %54, label %30, !llvm.loop !11
...
69:                                               ; preds = %70, %68
  %.2 = phi i32 [ 1, %68 ], [ %79, %70 ]
  %.not3 = icmp sgt i32 %.2, %0
  br i1 %.not3, label %80, label %70
