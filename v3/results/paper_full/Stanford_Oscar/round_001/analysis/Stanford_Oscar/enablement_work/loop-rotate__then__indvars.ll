...
4:                                                ; preds = %2, %11
  ...
  %.032 = phi float [ 4.000000e+00, %2 ], [ %10, %11 ]
...
56:                                               ; preds = %32
  %57 = icmp sle i64 %indvars.iv.next5, %25
...
define dso_local void @Fft(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, float noundef %4) #0 {
  ...
  %7 = sext i32 %6 to i64
  %8 = sext i32 %6 to i64
  %smax9 = call i32 @llvm.smax.i32(i32 %0, i32 1)
  %9 = add nuw i32 %smax9, 1
  br label %10
...
12:                                               ; preds = %62, %10
  ...
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv3, i64 %13)
  %15 = add i64 %smax, 1
  br label %16
...
16:                                               ; preds = %59, %12
  ...
  %46 = add nsw i64 %indvars.iv, %indvars.iv3
...
62:                                               ; preds = %60
  %63 = icmp sle i64 %indvars.iv.next4, %8
...
66:                                               ; preds = %69, %65
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %69 ], [ 1, %65 ]
  %67 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv6
  %68 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv6
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %67, ptr align 4 %68, i64 8, i1 false)
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br label %69

69:                                               ; preds = %66
  %exitcond10 = icmp ne i64 %indvars.iv.next7, %wide.trip.count
  br i1 %exitcond10, label %66, label %70, !llvm.loop !15
...
74:                                               ; preds = %72
  %75 = icmp sle i32 1, %0
  br i1 %75, label %.lr.ph, label %86

.lr.ph:                                           ; preds = %74
  %76 = add i32 %0, 1
  %wide.trip.count14 = zext i32 %76 to i64
  br label %77

77:                                               ; preds = %.lr.ph, %85
  %indvars.iv11 = phi i64 [ 1, %.lr.ph ], [ %indvars.iv.next12, %85 ]
  %78 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv11
...
85:                                               ; preds = %77
  ...
  br i1 %exitcond15, label %77, label %._crit_edge, !llvm.loop !17
...
2:                                                ; preds = %0, %12
  %indvars.iv = phi i64 [ 1, %0 ], [ %indvars.iv.next, %12 ]
