...
27:                                               ; preds = %58, %13
  %.02 = phi i32 [ 1, %13 ], [ %57, %58 ]
  %.0 = phi i32 [ %15, %13 ], [ %28, %58 ]
  %28 = sdiv i32 %.0, 2
  ...
  %invariant.op = add i64 %31, 1
  %invariant.op5 = sub i64 1, %32
  %36 = load float, ptr %34, align 4
  br label %37

37:                                               ; preds = %53, %27
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %53 ], [ %29, %27 ]
  %.reass = add i64 %indvars.iv2, %invariant.op
  %38 = getelementptr inbounds %struct.complex, ptr %1, i64 %.reass
  %39 = load float, ptr %38, align 4
  %.reass6 = add i64 %indvars.iv2, %invariant.op5
  %40 = getelementptr inbounds %struct.complex, ptr %1, i64 %.reass6
  %41 = load float, ptr %40, align 4
  %42 = fadd float %39, %41
  %43 = fmul float %35, %42
  %44 = add nsw i64 %indvars.iv2, 1
...
53:                                               ; preds = %37
  %54 = icmp sle i64 %indvars.iv.next3, %26
