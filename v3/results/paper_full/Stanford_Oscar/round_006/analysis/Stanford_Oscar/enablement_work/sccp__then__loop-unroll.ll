...
27:                                               ; preds = %50, %14
  ...
  %invariant.op1 = sub nsw i32 1, %28
  br label %29
...
.lr.ph:                                           ; preds = %90
  ...
  br i1 %94, label %.epil.preheader11, label %.lr.ph.new
...
95:                                               ; preds = %95, %.lr.ph.new
  ...
  %niter17 = phi i32 [ 0, %.lr.ph.new ], [ %niter17.next.1, %95 ]
  ...
  br i1 %niter17.ncmp.1, label %95, label %._crit_edge.unr-lcssa, !llvm.loop !18
