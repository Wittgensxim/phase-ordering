...
25:                                               ; preds = %50, %11
  ...
  %invariant.op = add nsw i32 %26, 1
  %invariant.op1 = sub nsw i32 1, %26
  %27 = sext i32 %26 to i64
  %28 = sext i32 %.0 to i64
  br label %29

29:                                               ; preds = %29, %25
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %29 ], [ %27, %25 ]
  ...
  %34 = trunc nsw i64 %indvars.iv5 to i32
  ...
  %49 = icmp sle i64 %indvars.iv.next6, %24
...
12:                                               ; preds = %59, %10
  ...
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv11, i64 %17)
  %19 = add i64 %smax, 1
  br label %20
...
.lr.ph:                                           ; preds = %70
  %72 = fneg float %4
  %73 = add i32 %0, 1
  %wide.trip.count22 = zext i32 %73 to i64
  br label %74

74:                                               ; preds = %74, %.lr.ph
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %74 ], [ 1, %.lr.ph ]
  %75 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv19
  ...
  br i1 %exitcond23, label %74, label %._crit_edge, !llvm.loop !17
