...
4:                                                ; preds = %4, %2
  ...
  br i1 %exitcond, label %4, label %11, !llvm.loop !9
...
11:                                               ; preds = %78, %5
  %.01 = phi i32 [ 1, %5 ], [ %79, %78 ]
  %12 = sext i32 %.01 to i64
  br label %13

13:                                               ; preds = %60, %11
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %60 ], [ %12, %11 ]
  %.04 = phi i32 [ 1, %11 ], [ %61, %60 ]
  %.02 = phi i32 [ 0, %11 ], [ %63, %60 ]
  %14 = add nsw i32 %.02, 1
  %15 = sext i32 %14 to i64
  %16 = getelementptr inbounds %struct.complex, ptr %3, i64 %15
  %17 = getelementptr inbounds nuw %struct.complex, ptr %16, i32 0, i32 1
  %18 = sext i32 %.04 to i64
  %19 = sext i32 %.02 to i64
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv2, i64 %18)
  %20 = add i64 %smax, 1
  br label %21

21:                                               ; preds = %21, %13
  %indvars.iv = phi i64 [ %indvars.iv.next, %21 ], [ %18, %13 ]
  %22 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv
  %23 = load float, ptr %22, align 4
  %24 = add nsw i64 %7, %indvars.iv
  %25 = getelementptr inbounds %struct.complex, ptr %1, i64 %24
  %26 = load float, ptr %25, align 4
  %27 = fadd float %23, %26
  %28 = add nsw i64 %indvars.iv, %19
  %29 = getelementptr inbounds %struct.complex, ptr %2, i64 %28
  store float %27, ptr %29, align 4
  %30 = getelementptr inbounds nuw %struct.complex, ptr %22, i32 0, i32 1
  %31 = load float, ptr %30, align 4
  %32 = getelementptr inbounds nuw %struct.complex, ptr %25, i32 0, i32 1
  %33 = load float, ptr %32, align 4
  %34 = fadd float %31, %33
  %35 = getelementptr inbounds nuw %struct.complex, ptr %29, i32 0, i32 1
  ...
  %44 = fmul float %40, %43
  %45 = fneg float %44
  %46 = call float @llvm.fmuladd.f32(float %36, float %39, float %45)
  ...
  br i1 %exitcond, label %21, label %60, !llvm.loop !12

60:                                               ; preds = %21
  %.lcssa.wide = phi i64 [ %indvars.iv.next, %21 ]
  %61 = trunc nsw i64 %.lcssa.wide to i32
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, %12
  %62 = icmp sle i64 %indvars.iv.next3, %8
  %63 = trunc nsw i64 %indvars.iv2 to i32
  br i1 %62, label %13, label %64, !llvm.loop !13

64:                                               ; preds = %60
  %wide.trip.count = zext i32 %9 to i64
  %xtraiter = and i32 %smax8, 3
  %65 = icmp ult i32 %10, 3
...
66:                                               ; preds = %66, %.new
  %indvars.iv5 = phi i64 [ 1, %.new ], [ %indvars.iv.next6.3, %66 ]
  %niter = phi i32 [ 0, %.new ], [ %niter.next.3, %66 ]
  ...
  %69 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv.next6
  %70 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv.next6
  ...
  %71 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv.next6.1
  %72 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv.next6.1
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %71, ptr align 4 %72, i64 8, i1 false)
  %indvars.iv.next6.2 = add nuw nsw i64 %indvars.iv5, 3
  %73 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv.next6.2
  %74 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv.next6.2
  ...
  br i1 %niter.ncmp.3, label %66, label %.unr-lcssa, !llvm.loop !14

.unr-lcssa:                                       ; preds = %66
  %indvars.iv5.unr = phi i64 [ %indvars.iv.next6.3, %66 ]
  %lcmp.mod = icmp ne i32 %xtraiter, 0
  br i1 %lcmp.mod, label %.epil.preheader, label %78

.epil.preheader:                                  ; preds = %.unr-lcssa, %64
  %indvars.iv5.epil.init = phi i64 [ 1, %64 ], [ %indvars.iv5.unr, %.unr-lcssa ]
  %lcmp.mod15 = icmp ne i32 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod15)
  br label %75

75:                                               ; preds = %75, %.epil.preheader
  %indvars.iv5.epil = phi i64 [ %indvars.iv.next6.epil, %75 ], [ %indvars.iv5.epil.init, %.epil.preheader ]
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %75 ]
  %76 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv5.epil
  %77 = getelementptr inbounds %struct.complex, ptr %2, i64 %indvars.iv5.epil
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %76, ptr align 4 %77, i64 8, i1 false)
  ...
  br i1 %epil.iter.cmp, label %75, label %.epilog-lcssa, !llvm.loop !15

.epilog-lcssa:                                    ; preds = %75
  br label %78

78:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  %79 = add nsw i32 %.01, %.01
  %80 = icmp sle i32 %79, %6
  br i1 %80, label %11, label %81, !llvm.loop !17

81:                                               ; preds = %78
  %82 = icmp sle i32 1, %0
  br i1 %82, label %.lr.ph, label %105

.lr.ph:                                           ; preds = %81
  %83 = fneg float %4
  %84 = add i32 %0, -1
  %xtraiter17 = and i32 %0, 1
  %85 = icmp ult i32 %84, 1
  br i1 %85, label %.epil.preheader16, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter21 = sub i32 %0, %xtraiter17
  br label %86

86:                                               ; preds = %86, %.lr.ph.new
  %indvars.iv10 = phi i64 [ 1, %.lr.ph.new ], [ %indvars.iv.next11.1, %86 ]
  %niter22 = phi i32 [ 0, %.lr.ph.new ], [ %niter22.next.1, %86 ]
  %87 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv10
  %88 = load float, ptr %87, align 4
  %89 = fmul float %4, %88
  store float %89, ptr %87, align 4
  %90 = getelementptr inbounds nuw %struct.complex, ptr %87, i32 0, i32 1
  %91 = load float, ptr %90, align 4
  %92 = fmul float %83, %91
  store float %92, ptr %90, align 4
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %93 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv.next11
  %94 = load float, ptr %93, align 4
  %95 = fmul float %4, %94
  store float %95, ptr %93, align 4
  %96 = getelementptr inbounds nuw %struct.complex, ptr %93, i32 0, i32 1
  %97 = load float, ptr %96, align 4
  %98 = fmul float %83, %97
  store float %98, ptr %96, align 4
  %indvars.iv.next11.1 = add nuw nsw i64 %indvars.iv10, 2
  %niter22.next.1 = add i32 %niter22, 2
  %niter22.ncmp.1 = icmp ne i32 %niter22.next.1, %unroll_iter21
  br i1 %niter22.ncmp.1, label %86, label %._crit_edge.unr-lcssa, !llvm.loop !18

._crit_edge.unr-lcssa:                            ; preds = %86
  %indvars.iv10.unr = phi i64 [ %indvars.iv.next11.1, %86 ]
  %lcmp.mod19 = icmp ne i32 %xtraiter17, 0
  br i1 %lcmp.mod19, label %.epil.preheader16, label %._crit_edge

.epil.preheader16:                                ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  %indvars.iv10.epil.init = phi i64 [ 1, %.lr.ph ], [ %indvars.iv10.unr, %._crit_edge.unr-lcssa ]
  %lcmp.mod20 = icmp ne i32 %xtraiter17, 0
  call void @llvm.assume(i1 %lcmp.mod20)
  br label %._crit_edge.epilog-lcssa

._crit_edge.epilog-lcssa:                         ; preds = %.epil.preheader16
  %99 = getelementptr inbounds %struct.complex, ptr %1, i64 %indvars.iv10.epil.init
  %100 = load float, ptr %99, align 4
  %101 = fmul float %4, %100
  store float %101, ptr %99, align 4
  %102 = getelementptr inbounds nuw %struct.complex, ptr %99, i32 0, i32 1
...
2:                                                ; preds = %2, %0
  ...
  br i1 %exitcond, label %2, label %12, !llvm.loop !19
