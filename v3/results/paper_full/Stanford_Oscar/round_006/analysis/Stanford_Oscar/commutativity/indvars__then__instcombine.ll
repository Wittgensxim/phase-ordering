...
29:                                               ; preds = %29, %25
  ...
  %40 = getelementptr [8 x i8], ptr %1, i64 %indvars.iv2
...
19:                                               ; preds = %19, %12
  ...
  %20 = getelementptr inbounds [8 x i8], ptr %1, i64 %indvars.iv
  ...
  %27 = getelementptr [8 x i8], ptr %26, i64 %18
  ...
  br i1 %exitcond.not, label %58, label %19, !llvm.loop !13
...
.lr.ph:                                           ; preds = %67
  %69 = fneg float %4
  %70 = add nuw i32 %0, 1
  %wide.trip.count13 = zext i32 %70 to i64
  br label %71

71:                                               ; preds = %71, %.lr.ph
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %71 ], [ 1, %.lr.ph ]
  %72 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv10
  ...
  br i1 %exitcond14.not, label %._crit_edge, label %71, !llvm.loop !17
