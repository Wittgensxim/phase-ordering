...
94:                                               ; preds = %94, %.lr.ph.new
  ...
  br i1 %niter8.ncmp.1, label %94, label %._crit_edge.loopexit.unr-lcssa, !llvm.loop !18

._crit_edge.loopexit.unr-lcssa:                   ; preds = %94
  %.21.unr = phi i32 [ %110, %94 ]
  %lcmp.mod5 = icmp ne i32 %xtraiter3, 0
  br i1 %lcmp.mod5, label %.epil.preheader2, label %._crit_edge.loopexit

.epil.preheader2:                                 ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  %.21.epil.init = phi i32 [ 1, %.lr.ph ], [ %.21.unr, %._crit_edge.loopexit.unr-lcssa ]
  %lcmp.mod6 = icmp ne i32 %xtraiter3, 0
  call void @llvm.assume(i1 %lcmp.mod6)
  br label %._crit_edge.loopexit.epilog-lcssa

._crit_edge.loopexit.epilog-lcssa:                ; preds = %.epil.preheader2
