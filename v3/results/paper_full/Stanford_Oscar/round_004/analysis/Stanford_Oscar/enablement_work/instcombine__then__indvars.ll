...
12:                                               ; preds = %59, %10
  ...
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv5, i64 %17)
  %19 = add i64 %smax, 1
  br label %20
...
.lr.ph:                                           ; preds = %69
  %71 = fneg float %4
  %72 = add i32 %0, 1
  %wide.trip.count16 = zext i32 %72 to i64
  br label %73

73:                                               ; preds = %73, %.lr.ph
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %73 ], [ 1, %.lr.ph ]
  %74 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv13
  ...
  br i1 %exitcond17, label %73, label %._crit_edge, !llvm.loop !17
