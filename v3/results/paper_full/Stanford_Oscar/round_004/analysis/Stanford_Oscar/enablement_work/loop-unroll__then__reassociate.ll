...
29:                                               ; preds = %29, %27
  ...
  %.reass2 = add i32 %invariant.op1, %.01
...
88:                                               ; preds = %86
  %89 = icmp sle i32 1, %0
  br i1 %89, label %.lr.ph, label %117
...
93:                                               ; preds = %93, %.lr.ph.new
  ...
  %98 = getelementptr inbounds nuw %struct.complex, ptr %95, i32 0, i32 1
  ...
  %106 = getelementptr inbounds nuw %struct.complex, ptr %103, i32 0, i32 1
...
._crit_edge.epilog-lcssa:                         ; preds = %.epil.preheader2
  %110 = sext i32 %.21.epil.init to i64
  %111 = getelementptr inbounds %struct.complex, ptr %1, i64 %110
  %112 = load float, ptr %111, align 4
  %113 = fmul float %4, %112
  store float %113, ptr %111, align 4
  %114 = getelementptr inbounds nuw %struct.complex, ptr %111, i32 0, i32 1
  %115 = load float, ptr %114, align 4
  %116 = fmul float %90, %115
