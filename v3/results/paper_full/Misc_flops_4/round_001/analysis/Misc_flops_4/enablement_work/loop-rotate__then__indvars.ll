...
30:                                               ; preds = %9
  ...
  %48 = call double @llvm.fmuladd.f64(double %47, double %.lcssa, double %46)
  %49 = fmul double %8, %48
  %50 = fdiv double %49, %47
  store double %50, ptr @sa, align 8
  %51 = load double, ptr @A6, align 8
  %52 = call double @llvm.fmuladd.f64(double %51, double %32, double %4)
  %53 = load double, ptr @A4, align 8
  %54 = call double @llvm.fmuladd.f64(double %52, double %32, double %53)
  %55 = call double @llvm.fmuladd.f64(double %54, double %32, double %2)
  %56 = load double, ptr @A2, align 8
  %57 = call double @llvm.fmuladd.f64(double %55, double %32, double %56)
  %58 = load double, ptr @A1, align 8
  %59 = call double @llvm.fmuladd.f64(double %57, double %32, double %58)
  %60 = load double, ptr @A0, align 8
  %61 = call double @llvm.fmuladd.f64(double %59, double %32, double %60)
