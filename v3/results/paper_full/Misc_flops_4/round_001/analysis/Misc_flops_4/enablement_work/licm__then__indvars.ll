...
16:                                               ; preds = %19, %0
  %17 = phi double [ %29, %19 ], [ 0.000000e+00, %0 ]
  %18 = phi i32 [ %30, %19 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %18, 156250000
  br i1 %exitcond, label %19, label %31

19:                                               ; preds = %16
  %20 = uitofp nneg i32 %18 to double
  %21 = fmul double %8, %20
  %22 = fmul double %21, %21
  %23 = call double @llvm.fmuladd.f64(double %9, double %22, double %10)
  %24 = call double @llvm.fmuladd.f64(double %22, double %23, double %11)
  %25 = call double @llvm.fmuladd.f64(double %22, double %24, double %12)
  %26 = call double @llvm.fmuladd.f64(double %22, double %25, double %13)
  %27 = call double @llvm.fmuladd.f64(double %22, double %26, double %14)
  %28 = call double @llvm.fmuladd.f64(double %22, double %27, double %17)
