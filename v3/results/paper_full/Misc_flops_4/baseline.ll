...
9:                                                ; preds = %0, %9
  %.05 = phi i32 [ 1, %0 ], [ %27, %9 ]
  %.014 = phi double [ 0.000000e+00, %0 ], [ %26, %9 ]
  %10 = uitofp nneg i32 %.05 to double
  %11 = fmul double %8, %10
  %12 = fmul double %11, %11
  %13 = load double, ptr @B6, align 8
  %14 = load double, ptr @B5, align 8
  %15 = call double @llvm.fmuladd.f64(double %13, double %12, double %14)
  %16 = load double, ptr @B4, align 8
  %17 = call double @llvm.fmuladd.f64(double %12, double %15, double %16)
  %18 = load double, ptr @B3, align 8
  %19 = call double @llvm.fmuladd.f64(double %12, double %17, double %18)
  %20 = load double, ptr @B2, align 8
  %21 = call double @llvm.fmuladd.f64(double %12, double %19, double %20)
  %22 = load double, ptr @B1, align 8
  %23 = call double @llvm.fmuladd.f64(double %12, double %21, double %22)
  %24 = call double @llvm.fmuladd.f64(double %12, double %23, double %.014)
  %25 = load double, ptr @one, align 8
  %26 = fadd double %24, %25
  %27 = add nuw nsw i32 %.05, 1
  %28 = icmp samesign ult i32 %27, 156250000
  br i1 %28, label %9, label %29, !llvm.loop !7

29:                                               ; preds = %9
  %.01.lcssa = phi double [ %26, %9 ]
  %30 = fdiv double %5, %6
  %31 = fmul double %30, %30
  %32 = load double, ptr @B6, align 8
  %33 = load double, ptr @B5, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %31, double %33)
  ...
  %40 = call double @llvm.fmuladd.f64(double %31, double %38, double %39)
  ...
  %51 = call double @llvm.fmuladd.f64(double %50, double %31, double %4)
  %52 = load double, ptr @A4, align 8
  %53 = call double @llvm.fmuladd.f64(double %51, double %31, double %52)
  %54 = call double @llvm.fmuladd.f64(double %53, double %31, double %2)
  %55 = load double, ptr @A2, align 8
  %56 = call double @llvm.fmuladd.f64(double %54, double %31, double %55)
  %57 = load double, ptr @A1, align 8
  %58 = call double @llvm.fmuladd.f64(double %56, double %31, double %57)
  %59 = load double, ptr @A0, align 8
  %60 = call double @llvm.fmuladd.f64(double %58, double %31, double %59)
  ...
  %64 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %63, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
