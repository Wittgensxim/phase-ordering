...
24:                                               ; preds = %0, %24
  %25 = phi i32 [ 1, %0 ], [ %44, %24 ]
  %26 = phi double [ 0.000000e+00, %0 ], [ %43, %24 ]
  ...
  %32 = call double @llvm.fmuladd.f64(double %30, double %29, double %31)
  %33 = load double, ptr @B4, align 8
  %34 = call double @llvm.fmuladd.f64(double %29, double %32, double %33)
  %35 = load double, ptr @B3, align 8
  %36 = call double @llvm.fmuladd.f64(double %29, double %34, double %35)
  %37 = load double, ptr @B2, align 8
  %38 = call double @llvm.fmuladd.f64(double %29, double %36, double %37)
  ...
  %45 = icmp sle i32 %44, 156249999
  br i1 %45, label %24, label %46, !llvm.loop !7

46:                                               ; preds = %24
  %.lcssa = phi double [ %43, %24 ]
  %47 = fdiv double %20, %21
  ...
  %64 = call double @llvm.fmuladd.f64(double %63, double %.lcssa, double %62)
  %65 = fmul double %23, %64
  %66 = fdiv double %65, %63
  store double %66, ptr @sa, align 8
  store double %47, ptr %3, align 8
  store double %48, ptr %5, align 8
  %67 = load double, ptr @A6, align 8
  %68 = call double @llvm.fmuladd.f64(double %67, double %48, double %19)
  %69 = load double, ptr @A4, align 8
  %70 = call double @llvm.fmuladd.f64(double %68, double %48, double %69)
  %71 = call double @llvm.fmuladd.f64(double %70, double %48, double %17)
  %72 = load double, ptr @A2, align 8
  %73 = call double @llvm.fmuladd.f64(double %71, double %48, double %72)
  %74 = load double, ptr @A1, align 8
  %75 = call double @llvm.fmuladd.f64(double %73, double %48, double %74)
  %76 = load double, ptr @A0, align 8
  %77 = call double @llvm.fmuladd.f64(double %75, double %48, double %76)
