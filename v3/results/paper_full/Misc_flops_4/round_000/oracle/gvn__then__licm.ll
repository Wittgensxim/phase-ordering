...
31:                                               ; preds = %39, %0
  %32 = phi i32 [ %50, %39 ], [ poison, %0 ]
  %33 = phi double [ %49, %39 ], [ poison, %0 ]
  %34 = phi double [ %42, %39 ], [ poison, %0 ]
  %35 = phi double [ %41, %39 ], [ poison, %0 ]
  %36 = phi double [ %49, %39 ], [ 0.000000e+00, %0 ]
  %37 = phi i32 [ %50, %39 ], [ 1, %0 ]
...
39:                                               ; preds = %31
  ...
  %43 = call double @llvm.fmuladd.f64(double %24, double %42, double %25)
  %44 = call double @llvm.fmuladd.f64(double %42, double %43, double %26)
  %45 = call double @llvm.fmuladd.f64(double %42, double %44, double %27)
  %46 = call double @llvm.fmuladd.f64(double %42, double %45, double %28)
  %47 = call double @llvm.fmuladd.f64(double %42, double %46, double %29)
  %48 = call double @llvm.fmuladd.f64(double %42, double %47, double %36)
  %49 = fadd double %48, %30
  %50 = add nsw i32 %37, 1
  br label %31, !llvm.loop !7

51:                                               ; preds = %31
  %.lcssa4 = phi i32 [ %32, %31 ]
  %.lcssa3 = phi double [ %33, %31 ]
  %.lcssa2 = phi double [ %34, %31 ]
  %.lcssa1 = phi double [ %35, %31 ]
  %.lcssa = phi double [ %36, %31 ]
  ...
  %52 = fdiv double %20, %21
  store double %52, ptr %3, align 8
  %53 = fmul double %52, %52
  store double %53, ptr %5, align 8
  %54 = load double, ptr @B6, align 8
  %55 = load double, ptr @B5, align 8
  %56 = call double @llvm.fmuladd.f64(double %54, double %53, double %55)
  %57 = load double, ptr @B4, align 8
  %58 = call double @llvm.fmuladd.f64(double %53, double %56, double %57)
  %59 = load double, ptr @B3, align 8
  %60 = call double @llvm.fmuladd.f64(double %53, double %58, double %59)
  %61 = load double, ptr @B2, align 8
  %62 = call double @llvm.fmuladd.f64(double %53, double %60, double %61)
  %63 = load double, ptr @B1, align 8
  %64 = call double @llvm.fmuladd.f64(double %53, double %62, double %63)
  %65 = load double, ptr @one, align 8
  %66 = call double @llvm.fmuladd.f64(double %53, double %64, double %65)
  store double %66, ptr @sa, align 8
  %67 = fadd double %66, %65
  %68 = load double, ptr @two, align 8
  %69 = call double @llvm.fmuladd.f64(double %68, double %.lcssa, double %67)
  %70 = fmul double %23, %69
  %71 = fdiv double %70, %68
  store double %71, ptr @sa, align 8
  store double %52, ptr %3, align 8
  store double %53, ptr %5, align 8
  %72 = load double, ptr @A6, align 8
  %73 = call double @llvm.fmuladd.f64(double %72, double %53, double %19)
  %74 = load double, ptr @A4, align 8
  %75 = call double @llvm.fmuladd.f64(double %73, double %53, double %74)
  %76 = call double @llvm.fmuladd.f64(double %75, double %53, double %17)
  %77 = load double, ptr @A2, align 8
  %78 = call double @llvm.fmuladd.f64(double %76, double %53, double %77)
  %79 = load double, ptr @A1, align 8
  %80 = call double @llvm.fmuladd.f64(double %78, double %53, double %79)
  %81 = load double, ptr @A0, align 8
  %82 = call double @llvm.fmuladd.f64(double %80, double %53, double %81)
