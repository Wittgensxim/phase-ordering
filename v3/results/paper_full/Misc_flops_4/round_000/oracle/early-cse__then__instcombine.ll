...
define dso_local i32 @main() #0 {
  ...
  %9 = fneg double %8
  store double %9, ptr @A3, align 8
  %10 = load double, ptr @A5, align 8
  %11 = fneg double %10
  store double %11, ptr @A5, align 8
  %12 = load double, ptr @piref, align 8
  %13 = load double, ptr @three, align 8
...
18:                                               ; preds = %40, %0
  %storemerge = phi i32 [ 1, %0 ], [ %42, %40 ]
  store i32 %storemerge, ptr %4, align 4
  %19 = load i32, ptr %5, align 4
  %.not.not = icmp slt i32 %storemerge, %19
  br i1 %.not.not, label %20, label %43

20:                                               ; preds = %18
  %21 = sitofp i32 %storemerge to double
  ...
  %28 = call double @llvm.fmuladd.f64(double %26, double %24, double %27)
  %29 = load double, ptr @B4, align 8
  %30 = call double @llvm.fmuladd.f64(double %24, double %28, double %29)
  %31 = load double, ptr @B3, align 8
  %32 = call double @llvm.fmuladd.f64(double %24, double %30, double %31)
  %33 = load double, ptr @B2, align 8
  %34 = call double @llvm.fmuladd.f64(double %24, double %32, double %33)
  %35 = load double, ptr @B1, align 8
  %36 = call double @llvm.fmuladd.f64(double %24, double %34, double %35)
  %37 = call double @llvm.fmuladd.f64(double %24, double %36, double %25)
...
43:                                               ; preds = %18
  ...
  %56 = call double @llvm.fmuladd.f64(double %47, double %54, double %55)
  %57 = load double, ptr @B1, align 8
  %58 = call double @llvm.fmuladd.f64(double %47, double %56, double %57)
  %59 = load double, ptr @one, align 8
  %60 = call double @llvm.fmuladd.f64(double %47, double %58, double %59)
  store double %60, ptr @sa, align 8
  %61 = load double, ptr %2, align 8
  %62 = fadd double %60, %59
  ...
  %73 = load double, ptr @A5, align 8
  %74 = call double @llvm.fmuladd.f64(double %72, double %71, double %73)
  %75 = load double, ptr @A4, align 8
  %76 = call double @llvm.fmuladd.f64(double %74, double %71, double %75)
  %77 = load double, ptr @A3, align 8
  %78 = call double @llvm.fmuladd.f64(double %76, double %71, double %77)
  %79 = load double, ptr @A2, align 8
  %80 = call double @llvm.fmuladd.f64(double %78, double %71, double %79)
  %81 = load double, ptr @A1, align 8
  %82 = call double @llvm.fmuladd.f64(double %80, double %71, double %81)
  %83 = load double, ptr @A0, align 8
  %84 = call double @llvm.fmuladd.f64(double %82, double %71, double %83)
  ...
  %89 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %88, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
