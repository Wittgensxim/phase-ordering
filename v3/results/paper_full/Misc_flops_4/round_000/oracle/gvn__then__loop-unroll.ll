...
24:                                               ; preds = %28, %0
  %25 = phi double [ %45, %28 ], [ 0.000000e+00, %0 ]
  %26 = phi i32 [ %46, %28 ], [ 1, %0 ]
  %27 = icmp sle i32 %26, 156249999
...
28:                                               ; preds = %24
  ...
  %43 = call double @llvm.fmuladd.f64(double %31, double %42, double %25)
...
47:                                               ; preds = %24
  ...
  %65 = call double @llvm.fmuladd.f64(double %64, double %.lcssa, double %63)
  ...
  %69 = call double @llvm.fmuladd.f64(double %68, double %49, double %19)
  %70 = load double, ptr @A4, align 8
  %71 = call double @llvm.fmuladd.f64(double %69, double %49, double %70)
  %72 = call double @llvm.fmuladd.f64(double %71, double %49, double %17)
  %73 = load double, ptr @A2, align 8
  %74 = call double @llvm.fmuladd.f64(double %72, double %49, double %73)
  %75 = load double, ptr @A1, align 8
  %76 = call double @llvm.fmuladd.f64(double %74, double %49, double %75)
  %77 = load double, ptr @A0, align 8
  %78 = call double @llvm.fmuladd.f64(double %76, double %49, double %77)
