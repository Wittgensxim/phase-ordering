...
13:                                               ; preds = %15, %0
  %.034 = phi i32 [ 1, %0 ], [ %33, %15 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %32, %15 ]
  %14 = icmp sle i32 %.034, 156249999
  br i1 %14, label %15, label %34

15:                                               ; preds = %13
  %16 = sitofp i32 %.034 to double
  ...
  %30 = call double @llvm.fmuladd.f64(double %18, double %29, double %.0)
...
34:                                               ; preds = %13
  ...
  %53 = fmul double %12, %52
  %54 = fdiv double %53, %51
  store double %54, ptr @sa, align 8
  %55 = load double, ptr @A6, align 8
  %56 = call double @llvm.fmuladd.f64(double %55, double %36, double %8)
  %57 = load double, ptr @A4, align 8
  %58 = call double @llvm.fmuladd.f64(double %56, double %36, double %57)
  %59 = call double @llvm.fmuladd.f64(double %58, double %36, double %6)
  %60 = load double, ptr @A2, align 8
  %61 = call double @llvm.fmuladd.f64(double %59, double %36, double %60)
  %62 = load double, ptr @A1, align 8
  %63 = call double @llvm.fmuladd.f64(double %61, double %36, double %62)
  %64 = load double, ptr @A0, align 8
  %65 = call double @llvm.fmuladd.f64(double %63, double %36, double %64)
