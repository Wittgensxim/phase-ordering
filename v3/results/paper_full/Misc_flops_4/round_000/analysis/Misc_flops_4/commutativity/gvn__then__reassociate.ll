...
23:                                               ; preds = %27, %0
  %24 = phi double [ %44, %27 ], [ 0.000000e+00, %0 ]
  %25 = phi i32 [ %45, %27 ], [ 1, %0 ]
  %26 = icmp sle i32 %25, 156249999
...
27:                                               ; preds = %23
  ...
  %33 = call double @llvm.fmuladd.f64(double %31, double %30, double %32)
  ...
  %39 = call double @llvm.fmuladd.f64(double %30, double %37, double %38)
  %40 = load double, ptr @B1, align 8
  %41 = call double @llvm.fmuladd.f64(double %30, double %39, double %40)
  %42 = call double @llvm.fmuladd.f64(double %30, double %41, double %24)
...
46:                                               ; preds = %23
  ...
  %64 = call double @llvm.fmuladd.f64(double %63, double %24, double %62)
  %65 = fmul double %22, %64
  %66 = fdiv double %65, %63
  store double %66, ptr @sa, align 8
  store double %47, ptr %3, align 8
  store double %48, ptr %5, align 8
  %67 = load double, ptr @A6, align 8
  %68 = call double @llvm.fmuladd.f64(double %67, double %48, double %18)
  %69 = load double, ptr @A4, align 8
  %70 = call double @llvm.fmuladd.f64(double %68, double %48, double %69)
  %71 = call double @llvm.fmuladd.f64(double %70, double %48, double %16)
