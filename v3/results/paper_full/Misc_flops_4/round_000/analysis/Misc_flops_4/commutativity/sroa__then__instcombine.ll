...
9:                                                ; preds = %12, %0
  %.034 = phi i32 [ 1, %0 ], [ %30, %12 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %29, %12 ]
  %10 = icmp samesign ult i32 %.034, 156250000
...
12:                                               ; preds = %11
  %13 = uitofp nneg i32 %.034 to double
  %14 = fmul double %8, %13
...
31:                                               ; preds = %9
  ...
  %51 = call double @llvm.fmuladd.f64(double %50, double %.0, double %49)
  %52 = fmul double %8, %51
