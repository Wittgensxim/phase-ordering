...
define dso_local i32 @main() #0 {
  ...
  %.promoted = load double, ptr %2, align 1
  %.promoted3 = load double, ptr %1, align 8
  br label %28

28:                                               ; preds = %42, %0
  %29 = phi double [ %.promoted3, %0 ], [ %41, %42 ]
  %30 = phi double [ %.promoted, %0 ], [ %34, %42 ]
  %storemerge = phi i32 [ 1, %0 ], [ %43, %42 ]
  %.not.not = icmp slt i32 %storemerge, %19
  br i1 %.not.not, label %31, label %44

31:                                               ; preds = %28
  %32 = sitofp i32 %storemerge to double
  %33 = fmul double %20, %32
  %34 = fmul double %33, %33
  %35 = call double @llvm.fmuladd.f64(double %21, double %34, double %22)
  %36 = call double @llvm.fmuladd.f64(double %34, double %35, double %23)
  %37 = call double @llvm.fmuladd.f64(double %34, double %36, double %24)
  %38 = call double @llvm.fmuladd.f64(double %34, double %37, double %25)
  %39 = call double @llvm.fmuladd.f64(double %34, double %38, double %26)
  %40 = call double @llvm.fmuladd.f64(double %34, double %39, double %29)
  %41 = fadd double %40, %27
  br label %42
...
44:                                               ; preds = %28
  %.lcssa4 = phi double [ %29, %28 ]
  %.lcssa = phi double [ %30, %28 ]
  %storemerge.lcssa = phi i32 [ %storemerge, %28 ]
  store i32 %storemerge.lcssa, ptr %5, align 4
  store double %.lcssa, ptr %2, align 1
  store double %.lcssa4, ptr %1, align 8
  %45 = load double, ptr @piref, align 8
  %46 = load double, ptr @three, align 8
  ...
  %77 = call double @llvm.fmuladd.f64(double %75, double %72, double %76)
  %78 = load double, ptr @A3, align 8
  %79 = call double @llvm.fmuladd.f64(double %77, double %72, double %78)
  ...
  %84 = call double @llvm.fmuladd.f64(double %82, double %80, double %83)
  %85 = load double, ptr @A0, align 8
  %86 = call double @llvm.fmuladd.f64(double %84, double %80, double %85)
  ...
  %91 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %90, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
