...
define dso_local i32 @main() #0 {
  ...
  %11 = fneg double %10
  store double %11, ptr @A3, align 8
  %12 = load double, ptr @A5, align 8
  %13 = fneg double %12
  store double %13, ptr @A5, align 8
  %14 = load double, ptr @piref, align 8
  %15 = load double, ptr @three, align 8
...
28:                                               ; preds = %34, %0
  %29 = phi double [ %44, %34 ], [ %.promoted5, %0 ]
  %30 = phi double [ %37, %34 ], [ %.promoted3, %0 ]
  %31 = phi double [ %36, %34 ], [ %.promoted1, %0 ]
  %32 = phi i32 [ %45, %34 ], [ %.promoted, %0 ]
  %.not.not = icmp slt i32 %32, %20
  br i1 %.not.not, label %33, label %46
...
34:                                               ; preds = %33
  ...
  %38 = call double @llvm.fmuladd.f64(double %21, double %37, double %22)
  %39 = call double @llvm.fmuladd.f64(double %37, double %38, double %23)
  %40 = call double @llvm.fmuladd.f64(double %37, double %39, double %24)
  %41 = call double @llvm.fmuladd.f64(double %37, double %40, double %25)
  %42 = call double @llvm.fmuladd.f64(double %37, double %41, double %26)
...
46:                                               ; preds = %28
  ...
  %55 = call double @llvm.fmuladd.f64(double %50, double %53, double %54)
  ...
  %78 = load double, ptr @A4, align 8
  %79 = call double @llvm.fmuladd.f64(double %77, double %74, double %78)
  %80 = load double, ptr @A3, align 8
  %81 = call double @llvm.fmuladd.f64(double %79, double %74, double %80)
  ...
  %86 = call double @llvm.fmuladd.f64(double %84, double %82, double %85)
  %87 = load double, ptr @A0, align 8
  %88 = call double @llvm.fmuladd.f64(double %86, double %82, double %87)
  ...
  %93 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %92, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
