...
53:                                               ; preds = %32
  ...
  br i1 %59, label %32, label %._crit_edge, !llvm.loop !7
...
60:                                               ; preds = %._crit_edge, %0
  ...
  %62 = load double, ptr @three, align 8
  ...
  %71 = call double @llvm.fmuladd.f64(double %64, double %69, double %70)
  %72 = load double, ptr @B2, align 8
  %73 = call double @llvm.fmuladd.f64(double %64, double %71, double %72)
  %74 = load double, ptr @B1, align 8
  %75 = call double @llvm.fmuladd.f64(double %64, double %73, double %74)
  %76 = load double, ptr @one, align 8
  %77 = call double @llvm.fmuladd.f64(double %64, double %75, double %76)
  ...
  %91 = load double, ptr @A6, align 8
  %92 = load double, ptr @A5, align 8
  %93 = call double @llvm.fmuladd.f64(double %91, double %89, double %92)
  %94 = load double, ptr @A4, align 8
  %95 = call double @llvm.fmuladd.f64(double %93, double %89, double %94)
  %96 = load double, ptr @A3, align 8
  %97 = call double @llvm.fmuladd.f64(double %95, double %89, double %96)
  %98 = load double, ptr @A2, align 8
  %99 = call double @llvm.fmuladd.f64(double %97, double %89, double %98)
  %100 = load double, ptr @A1, align 8
  %101 = call double @llvm.fmuladd.f64(double %99, double %89, double %100)
  %102 = load double, ptr @A0, align 8
  %103 = call double @llvm.fmuladd.f64(double %101, double %89, double %102)
