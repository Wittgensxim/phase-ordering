...
56:                                               ; preds = %28
  ...
  %67 = call double @llvm.fmuladd.f64(double %60, double %65, double %66)
  %68 = load double, ptr @B2, align 8
  %69 = call double @llvm.fmuladd.f64(double %60, double %67, double %68)
  %70 = load double, ptr @B1, align 8
  %71 = call double @llvm.fmuladd.f64(double %60, double %69, double %70)
  %72 = load double, ptr @one, align 8
  %73 = call double @llvm.fmuladd.f64(double %60, double %71, double %72)
  ...
  %82 = load double, ptr @piref, align 8
  %83 = load double, ptr @three, align 8
  %84 = fdiv double %82, %83
  store double %84, ptr %3, align 8
  %85 = fmul double %84, %84
  store double %85, ptr %5, align 8
  %86 = load double, ptr %3, align 8
  %87 = load double, ptr @A6, align 8
  %88 = load double, ptr @A5, align 8
  %89 = call double @llvm.fmuladd.f64(double %87, double %85, double %88)
  %90 = load double, ptr @A4, align 8
  %91 = call double @llvm.fmuladd.f64(double %89, double %85, double %90)
  %92 = load double, ptr @A3, align 8
  %93 = call double @llvm.fmuladd.f64(double %91, double %85, double %92)
  %94 = load double, ptr @A2, align 8
  %95 = call double @llvm.fmuladd.f64(double %93, double %85, double %94)
  %96 = load double, ptr @A1, align 8
  %97 = call double @llvm.fmuladd.f64(double %95, double %85, double %96)
  %98 = load double, ptr @A0, align 8
  %99 = call double @llvm.fmuladd.f64(double %97, double %85, double %98)
