...
42:                                               ; preds = %21
  ...
  %46 = add nsw i32 %45, -1
  %.not.not = icmp slt i32 %43, %46
  br i1 %.not.not, label %21, label %._crit_edge, !llvm.loop !7
...
47:                                               ; preds = %._crit_edge, %0
  ...
  %73 = load double, ptr @three, align 8
  %74 = fdiv double %72, %73
  %75 = fmul double %74, %74
  store double %75, ptr %2, align 8
  %76 = load double, ptr @A6, align 8
  %77 = load double, ptr @A5, align 8
  %78 = call double @llvm.fmuladd.f64(double %76, double %75, double %77)
  %79 = load double, ptr @A4, align 8
  %80 = call double @llvm.fmuladd.f64(double %78, double %75, double %79)
  %81 = load double, ptr @A3, align 8
  %82 = call double @llvm.fmuladd.f64(double %80, double %75, double %81)
  ...
  %87 = call double @llvm.fmuladd.f64(double %85, double %83, double %86)
  %88 = load double, ptr @A0, align 8
  %89 = call double @llvm.fmuladd.f64(double %87, double %83, double %88)
  ...
  %94 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %93, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
