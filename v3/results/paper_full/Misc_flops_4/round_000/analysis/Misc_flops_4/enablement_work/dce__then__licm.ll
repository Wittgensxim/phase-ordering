...
57:                                               ; preds = %38
  ...
  %74 = call double @llvm.fmuladd.f64(double %68, double %72, double %73)
  %75 = load double, ptr @B3, align 8
  %76 = call double @llvm.fmuladd.f64(double %67, double %74, double %75)
  %77 = load double, ptr @B2, align 8
  %78 = call double @llvm.fmuladd.f64(double %66, double %76, double %77)
  %79 = load double, ptr @B1, align 8
  %80 = call double @llvm.fmuladd.f64(double %65, double %78, double %79)
  %81 = load double, ptr @one, align 8
  %82 = call double @llvm.fmuladd.f64(double %64, double %80, double %81)
  ...
  %93 = load double, ptr @piref, align 8
  %94 = load double, ptr @three, align 8
  ...
  store double %122, ptr @sc, align 8
  %123 = load double, ptr @sc, align 8
  %124 = fmul double %123, 1.000000e-30
  %125 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %124, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
