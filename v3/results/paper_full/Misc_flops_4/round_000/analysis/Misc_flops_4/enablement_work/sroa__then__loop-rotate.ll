...
17:                                               ; preds = %0, %35
  %.036 = phi double [ 0.000000e+00, %0 ], [ %34, %35 ]
  %.03435 = phi i32 [ 1, %0 ], [ %36, %35 ]
  %18 = sitofp i32 %.03435 to double
  ...
  %32 = call double @llvm.fmuladd.f64(double %20, double %31, double %.036)
  %33 = load double, ptr @one, align 8
  %34 = fadd double %32, %33
  br label %35

35:                                               ; preds = %17
  %36 = add nsw i32 %.03435, 1
  %37 = icmp sle i32 %36, %16
  br i1 %37, label %17, label %38, !llvm.loop !7

38:                                               ; preds = %35
  %.0.lcssa = phi double [ %34, %35 ]
