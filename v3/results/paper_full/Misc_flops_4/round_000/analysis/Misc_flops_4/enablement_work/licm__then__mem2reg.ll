...
24:                                               ; preds = %41, %0
  %25 = phi double [ %40, %41 ], [ 0.000000e+00, %0 ]
  %26 = phi double [ %33, %41 ], [ undef, %0 ]
  %27 = phi double [ %32, %41 ], [ undef, %0 ]
  %28 = phi i32 [ %42, %41 ], [ 1, %0 ]
...
30:                                               ; preds = %24
  ...
  %34 = call double @llvm.fmuladd.f64(double %17, double %33, double %18)
  %35 = call double @llvm.fmuladd.f64(double %33, double %34, double %19)
  %36 = call double @llvm.fmuladd.f64(double %33, double %35, double %20)
  %37 = call double @llvm.fmuladd.f64(double %33, double %36, double %21)
  %38 = call double @llvm.fmuladd.f64(double %33, double %37, double %22)
  %39 = call double @llvm.fmuladd.f64(double %33, double %38, double %25)
  %40 = fadd double %39, %23
  br label %41
...
43:                                               ; preds = %24
  %.lcssa6 = phi double [ %25, %24 ]
  %.lcssa4 = phi double [ %26, %24 ]
  %.lcssa2 = phi double [ %27, %24 ]
  %.lcssa = phi i32 [ %28, %24 ]
  ...
  %65 = call double @llvm.fmuladd.f64(double %64, double %.lcssa6, double %63)
  %66 = fmul double %15, %65
  %67 = load double, ptr @two, align 8
  ...
  %81 = call double @llvm.fmuladd.f64(double %79, double %72, double %80)
  %82 = load double, ptr @A1, align 8
  %83 = call double @llvm.fmuladd.f64(double %81, double %72, double %82)
  %84 = load double, ptr @A0, align 8
  %85 = call double @llvm.fmuladd.f64(double %83, double %72, double %84)
