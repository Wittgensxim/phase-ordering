...
39:                                               ; preds = %56, %0
  %40 = phi double [ %55, %56 ], [ %.promoted5, %0 ]
  %41 = phi double [ %48, %56 ], [ %.promoted3, %0 ]
  %42 = phi double [ %47, %56 ], [ %.promoted1, %0 ]
  %43 = phi i32 [ %57, %56 ], [ %.promoted, %0 ]
  %44 = icmp sle i32 %43, %30
  br i1 %44, label %45, label %58

45:                                               ; preds = %39
  %46 = sitofp i32 %43 to double
  %47 = fmul double %46, %31
  %48 = fmul double %47, %47
  %49 = call double @llvm.fmuladd.f64(double %32, double %48, double %33)
  %50 = call double @llvm.fmuladd.f64(double %48, double %49, double %34)
  %51 = call double @llvm.fmuladd.f64(double %48, double %50, double %35)
  %52 = call double @llvm.fmuladd.f64(double %48, double %51, double %36)
  %53 = call double @llvm.fmuladd.f64(double %48, double %52, double %37)
  %54 = call double @llvm.fmuladd.f64(double %48, double %53, double %40)
  %55 = fadd double %54, %38
  br label %56
...
58:                                               ; preds = %39
  ...
  %72 = load double, ptr @B5, align 8
  %73 = call double @llvm.fmuladd.f64(double %70, double %71, double %72)
  %74 = load double, ptr @B4, align 8
  %75 = call double @llvm.fmuladd.f64(double %69, double %73, double %74)
  %76 = load double, ptr @B3, align 8
  %77 = call double @llvm.fmuladd.f64(double %68, double %75, double %76)
  %78 = load double, ptr @B2, align 8
  %79 = call double @llvm.fmuladd.f64(double %67, double %77, double %78)
  %80 = load double, ptr @B1, align 8
  %81 = call double @llvm.fmuladd.f64(double %66, double %79, double %80)
  %82 = load double, ptr @one, align 8
  %83 = call double @llvm.fmuladd.f64(double %65, double %81, double %82)
  ...
  %94 = load double, ptr @piref, align 8
  %95 = load double, ptr @three, align 8
