...
define dso_local i32 @main() #0 {
  ...
  %3 = fneg double %2
  store double %3, ptr @A3, align 8
  %4 = load double, ptr @A5, align 8
  %5 = fneg double %4
  store double %5, ptr @A5, align 8
...
11:                                               ; preds = %30, %0
  %.0 = phi double [ 0.000000e+00, %0 ], [ %29, %30 ]
  %storemerge = phi i32 [ 1, %0 ], [ %31, %30 ]
  %.not.not = icmp slt i32 %storemerge, %1
  br i1 %.not.not, label %12, label %32

12:                                               ; preds = %11
  %13 = sitofp i32 %storemerge to double
  ...
  %27 = call double @llvm.fmuladd.f64(double %15, double %26, double %.0)
...
32:                                               ; preds = %11
  ...
  %34 = load double, ptr @three, align 8
