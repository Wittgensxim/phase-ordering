...
define dso_local i32 @main() #0 {
  ...
  %34 = load double, ptr @B3, align 8
  %35 = load double, ptr @B2, align 8
  %36 = load double, ptr @B1, align 8
  %37 = load double, ptr @one, align 8
  %.promoted = load i32, ptr %9, align 4
  %.promoted1 = load double, ptr %3, align 1
  %.promoted3 = load double, ptr %5, align 1
  %.promoted5 = load double, ptr %2, align 8
  br label %38

38:                                               ; preds = %55, %0
  %39 = phi double [ %54, %55 ], [ %.promoted5, %0 ]
  %40 = phi double [ %47, %55 ], [ %.promoted3, %0 ]
  %41 = phi double [ %46, %55 ], [ %.promoted1, %0 ]
  %42 = phi i32 [ %56, %55 ], [ %.promoted, %0 ]
  %43 = icmp sle i32 %42, %29
...
44:                                               ; preds = %38
  ...
  %48 = call double @llvm.fmuladd.f64(double %31, double %47, double %32)
  %49 = call double @llvm.fmuladd.f64(double %47, double %48, double %33)
  %50 = call double @llvm.fmuladd.f64(double %47, double %49, double %34)
  %51 = call double @llvm.fmuladd.f64(double %47, double %50, double %35)
  %52 = call double @llvm.fmuladd.f64(double %47, double %51, double %36)
  %53 = call double @llvm.fmuladd.f64(double %47, double %52, double %39)
  %54 = fadd double %53, %37
  br label %55
...
57:                                               ; preds = %38
  %.lcssa6 = phi double [ %39, %38 ]
  %.lcssa4 = phi double [ %40, %38 ]
  %.lcssa2 = phi double [ %41, %38 ]
  %.lcssa = phi i32 [ %42, %38 ]
  store i32 %.lcssa, ptr %9, align 4
  store double %.lcssa2, ptr %3, align 1
  store double %.lcssa4, ptr %5, align 1
  ...
  %72 = call double @llvm.fmuladd.f64(double %61, double %70, double %71)
  ...
  %83 = load double, ptr @piref, align 8
  %84 = load double, ptr @three, align 8
  %85 = fdiv double %83, %84
  store double %85, ptr %3, align 8
  %86 = fmul double %85, %85
  store double %86, ptr %5, align 8
  %87 = load double, ptr %3, align 8
  %88 = load double, ptr @A6, align 8
  %89 = load double, ptr @A5, align 8
  %90 = call double @llvm.fmuladd.f64(double %88, double %86, double %89)
  %91 = load double, ptr @A4, align 8
  %92 = call double @llvm.fmuladd.f64(double %90, double %86, double %91)
  %93 = load double, ptr @A3, align 8
  %94 = call double @llvm.fmuladd.f64(double %92, double %86, double %93)
  %95 = load double, ptr @A2, align 8
  %96 = call double @llvm.fmuladd.f64(double %94, double %86, double %95)
  %97 = load double, ptr @A1, align 8
  %98 = call double @llvm.fmuladd.f64(double %96, double %86, double %97)
  %99 = load double, ptr @A0, align 8
  %100 = call double @llvm.fmuladd.f64(double %98, double %86, double %99)
