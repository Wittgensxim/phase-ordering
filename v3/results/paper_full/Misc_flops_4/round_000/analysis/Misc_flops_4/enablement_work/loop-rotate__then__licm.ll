...
43:                                               ; preds = %.lr.ph, %56
  ...
  %45 = phi i32 [ %.promoted, %.lr.ph ], [ %57, %56 ]
  %46 = sitofp i32 %45 to double
  %47 = fmul double %46, %33
  %48 = fmul double %47, %47
  %49 = call double @llvm.fmuladd.f64(double %34, double %48, double %35)
  %50 = call double @llvm.fmuladd.f64(double %48, double %49, double %36)
  %51 = call double @llvm.fmuladd.f64(double %48, double %50, double %37)
  %52 = call double @llvm.fmuladd.f64(double %48, double %51, double %38)
  %53 = call double @llvm.fmuladd.f64(double %48, double %52, double %39)
  %54 = call double @llvm.fmuladd.f64(double %48, double %53, double %44)
  %55 = fadd double %54, %40
  br label %56

56:                                               ; preds = %43
  %57 = add nsw i32 %45, 1
  %58 = icmp sle i32 %57, %42
  br i1 %58, label %43, label %._crit_edge, !llvm.loop !7
...
59:                                               ; preds = %._crit_edge, %0
  ...
  %80 = call double @llvm.fmuladd.f64(double %68, double %78, double %79)
  %81 = load double, ptr @B1, align 8
  %82 = call double @llvm.fmuladd.f64(double %67, double %80, double %81)
  %83 = load double, ptr @one, align 8
  %84 = call double @llvm.fmuladd.f64(double %66, double %82, double %83)
  ...
  %96 = load double, ptr @three, align 8
  ...
  %127 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %126, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
