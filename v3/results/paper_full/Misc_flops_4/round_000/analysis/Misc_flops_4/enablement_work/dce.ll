...
65:                                               ; preds = %28
  ...
  %86 = call double @llvm.fmuladd.f64(double %74, double %84, double %85)
  %87 = load double, ptr @B1, align 8
  %88 = call double @llvm.fmuladd.f64(double %73, double %86, double %87)
  %89 = load double, ptr @one, align 8
  %90 = call double @llvm.fmuladd.f64(double %72, double %88, double %89)
  ...
  %101 = load double, ptr @piref, align 8
  %102 = load double, ptr @three, align 8
