...
18:                                               ; preds = %.lr.ph, %36
  %.036 = phi i32 [ 1, %.lr.ph ], [ %37, %36 ]
  %.0 = phi double [ 0.000000e+00, %.lr.ph ], [ %35, %36 ]
  %19 = sitofp i32 %.036 to double
  ...
  %33 = call double @llvm.fmuladd.f64(double %21, double %32, double %.0)
  %34 = load double, ptr @one, align 8
  %35 = fadd double %33, %34
  br label %36

36:                                               ; preds = %18
  %37 = add nsw i32 %.036, 1
  %38 = sub nsw i32 %6, 1
  %39 = icmp sle i32 %37, %38
  br i1 %39, label %18, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %36
  br label %40

40:                                               ; preds = %._crit_edge, %0
  %.1 = phi double [ %35, %._crit_edge ], [ 0.000000e+00, %0 ]
  %41 = load double, ptr @piref, align 8
  %42 = load double, ptr @three, align 8
  %43 = fdiv double %41, %42
  %44 = fmul double %43, %43
  %45 = load double, ptr @B6, align 8
  %46 = load double, ptr @B5, align 8
  %47 = call double @llvm.fmuladd.f64(double %45, double %44, double %46)
  %48 = load double, ptr @B4, align 8
  %49 = call double @llvm.fmuladd.f64(double %44, double %47, double %48)
  %50 = load double, ptr @B3, align 8
  %51 = call double @llvm.fmuladd.f64(double %44, double %49, double %50)
  %52 = load double, ptr @B2, align 8
  %53 = call double @llvm.fmuladd.f64(double %44, double %51, double %52)
  %54 = load double, ptr @B1, align 8
  %55 = call double @llvm.fmuladd.f64(double %44, double %53, double %54)
  %56 = load double, ptr @one, align 8
  %57 = call double @llvm.fmuladd.f64(double %44, double %55, double %56)
  ...
  %70 = load double, ptr @A6, align 8
  %71 = load double, ptr @A5, align 8
  %72 = call double @llvm.fmuladd.f64(double %70, double %69, double %71)
  %73 = load double, ptr @A4, align 8
  %74 = call double @llvm.fmuladd.f64(double %72, double %69, double %73)
  %75 = load double, ptr @A3, align 8
  %76 = call double @llvm.fmuladd.f64(double %74, double %69, double %75)
  %77 = load double, ptr @A2, align 8
  %78 = call double @llvm.fmuladd.f64(double %76, double %69, double %77)
  %79 = load double, ptr @A1, align 8
  %80 = call double @llvm.fmuladd.f64(double %78, double %69, double %79)
  %81 = load double, ptr @A0, align 8
  %82 = call double @llvm.fmuladd.f64(double %80, double %69, double %81)
