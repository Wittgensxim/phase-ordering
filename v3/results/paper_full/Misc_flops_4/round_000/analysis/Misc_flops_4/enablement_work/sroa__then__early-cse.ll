...
14:                                               ; preds = %34, %0
  %.034 = phi i32 [ 1, %0 ], [ %35, %34 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %33, %34 ]
  %15 = icmp sle i32 %.034, 156249999
  br i1 %15, label %16, label %36

16:                                               ; preds = %14
  %17 = sitofp i32 %.034 to double
  ...
  %31 = call double @llvm.fmuladd.f64(double %19, double %30, double %.0)
...
36:                                               ; preds = %14
  ...
  %57 = call double @llvm.fmuladd.f64(double %56, double %.0, double %55)
