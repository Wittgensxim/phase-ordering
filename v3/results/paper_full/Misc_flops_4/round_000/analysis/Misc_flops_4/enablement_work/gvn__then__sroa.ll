...
13:                                               ; preds = %17, %0
  %14 = phi double [ %34, %17 ], [ 0.000000e+00, %0 ]
  %15 = phi i32 [ %35, %17 ], [ 1, %0 ]
  %16 = icmp sle i32 %15, 156249999
...
17:                                               ; preds = %13
  ...
  %32 = call double @llvm.fmuladd.f64(double %20, double %31, double %14)
...
36:                                               ; preds = %13
  ...
  %54 = call double @llvm.fmuladd.f64(double %53, double %14, double %52)
  %55 = fmul double %12, %54
  %56 = fdiv double %55, %53
  store double %56, ptr @sa, align 8
  %57 = load double, ptr @A6, align 8
  %58 = call double @llvm.fmuladd.f64(double %57, double %38, double %8)
  %59 = load double, ptr @A4, align 8
  %60 = call double @llvm.fmuladd.f64(double %58, double %38, double %59)
  %61 = call double @llvm.fmuladd.f64(double %60, double %38, double %6)
  %62 = load double, ptr @A2, align 8
  %63 = call double @llvm.fmuladd.f64(double %61, double %38, double %62)
  %64 = load double, ptr @A1, align 8
  %65 = call double @llvm.fmuladd.f64(double %63, double %38, double %64)
  %66 = load double, ptr @A0, align 8
  %67 = call double @llvm.fmuladd.f64(double %65, double %38, double %66)
