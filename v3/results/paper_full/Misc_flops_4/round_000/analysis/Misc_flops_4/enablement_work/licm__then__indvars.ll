...
38:                                               ; preds = %54, %0
  %39 = phi double [ %53, %54 ], [ %.promoted5, %0 ]
  %40 = phi double [ %46, %54 ], [ %.promoted3, %0 ]
  %41 = phi double [ %45, %54 ], [ %.promoted1, %0 ]
...
43:                                               ; preds = %38
  ...
  %47 = call double @llvm.fmuladd.f64(double %31, double %46, double %32)
  %48 = call double @llvm.fmuladd.f64(double %46, double %47, double %33)
  %49 = call double @llvm.fmuladd.f64(double %46, double %48, double %34)
  %50 = call double @llvm.fmuladd.f64(double %46, double %49, double %35)
  %51 = call double @llvm.fmuladd.f64(double %46, double %50, double %36)
  %52 = call double @llvm.fmuladd.f64(double %46, double %51, double %39)
  %53 = fadd double %52, %37
  br label %54
