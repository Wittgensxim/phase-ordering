...
24:                                               ; preds = %37, %0
  %.034 = phi i32 [ 1, %0 ], [ %38, %37 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %36, %37 ]
  %25 = icmp sle i32 %.034, %16
  br i1 %25, label %26, label %39

26:                                               ; preds = %24
  %27 = sitofp i32 %.034 to double
  ...
  %35 = call double @llvm.fmuladd.f64(double %29, double %34, double %.0)
  %36 = fadd double %35, %23
  br label %37

37:                                               ; preds = %26
  %38 = add nsw i32 %.034, 1
  br label %24, !llvm.loop !7

39:                                               ; preds = %24
  %.0.lcssa = phi double [ %.0, %24 ]
