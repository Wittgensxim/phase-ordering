...
19:                                               ; preds = %41, %0
  %storemerge = phi i32 [ 1, %0 ], [ %43, %41 ]
  store i32 %storemerge, ptr %5, align 4
  %20 = load i32, ptr %6, align 4
  %.not.not = icmp slt i32 %storemerge, %20
  br i1 %.not.not, label %21, label %44

21:                                               ; preds = %19
  %22 = sitofp i32 %storemerge to double
  ...
  %29 = call double @llvm.fmuladd.f64(double %27, double %25, double %28)
  %30 = load double, ptr @B4, align 8
  %31 = call double @llvm.fmuladd.f64(double %25, double %29, double %30)
  %32 = load double, ptr @B3, align 8
  %33 = call double @llvm.fmuladd.f64(double %25, double %31, double %32)
  %34 = load double, ptr @B2, align 8
  %35 = call double @llvm.fmuladd.f64(double %25, double %33, double %34)
  %36 = load double, ptr @B1, align 8
  %37 = call double @llvm.fmuladd.f64(double %25, double %35, double %36)
  %38 = call double @llvm.fmuladd.f64(double %25, double %37, double %26)
...
44:                                               ; preds = %19
  ...
  %90 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %89, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
