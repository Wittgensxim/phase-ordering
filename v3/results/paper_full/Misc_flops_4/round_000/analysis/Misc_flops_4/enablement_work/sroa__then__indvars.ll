...
16:                                               ; preds = %35, %0
  %.034 = phi i32 [ 1, %0 ], [ %36, %35 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %34, %35 ]
  %exitcond = icmp ne i32 %.034, 156250000
  br i1 %exitcond, label %17, label %37

17:                                               ; preds = %16
  %18 = sitofp i32 %.034 to double
  ...
  %32 = call double @llvm.fmuladd.f64(double %20, double %31, double %.0)
  %33 = load double, ptr @one, align 8
  %34 = fadd double %32, %33
  br label %35

35:                                               ; preds = %17
  %36 = add nuw nsw i32 %.034, 1
  br label %16, !llvm.loop !7

37:                                               ; preds = %16
  %.0.lcssa = phi double [ %.0, %16 ]
  ...
  %46 = call double @llvm.fmuladd.f64(double %41, double %44, double %45)
  %47 = load double, ptr @B3, align 8
  %48 = call double @llvm.fmuladd.f64(double %41, double %46, double %47)
  %49 = load double, ptr @B2, align 8
  %50 = call double @llvm.fmuladd.f64(double %41, double %48, double %49)
  %51 = load double, ptr @B1, align 8
  %52 = call double @llvm.fmuladd.f64(double %41, double %50, double %51)
  %53 = load double, ptr @one, align 8
  %54 = call double @llvm.fmuladd.f64(double %41, double %52, double %53)
  ...
  %59 = call double @llvm.fmuladd.f64(double %58, double %.0.lcssa, double %57)
  %60 = fmul double %15, %59
  %61 = load double, ptr @two, align 8
  %62 = fdiv double %60, %61
  store double %62, ptr @sa, align 8
  %63 = load double, ptr @piref, align 8
  %64 = load double, ptr @three, align 8
  %65 = fdiv double %63, %64
  %66 = fmul double %65, %65
  %67 = load double, ptr @A6, align 8
  %68 = load double, ptr @A5, align 8
  %69 = call double @llvm.fmuladd.f64(double %67, double %66, double %68)
  %70 = load double, ptr @A4, align 8
  %71 = call double @llvm.fmuladd.f64(double %69, double %66, double %70)
  %72 = load double, ptr @A3, align 8
  %73 = call double @llvm.fmuladd.f64(double %71, double %66, double %72)
  %74 = load double, ptr @A2, align 8
  %75 = call double @llvm.fmuladd.f64(double %73, double %66, double %74)
  %76 = load double, ptr @A1, align 8
  %77 = call double @llvm.fmuladd.f64(double %75, double %66, double %76)
  %78 = load double, ptr @A0, align 8
  %79 = call double @llvm.fmuladd.f64(double %77, double %66, double %78)
