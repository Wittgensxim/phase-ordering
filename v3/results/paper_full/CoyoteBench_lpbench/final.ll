; ModuleID = 'results\paper_full\CoyoteBench_lpbench\round_007\input.ll'
...
15:                                               ; preds = %.lr.ph, %15
  ...
  %.014 = phi i32 [ %10, %.lr.ph ], [ %22, %15 ]
  %.023 = phi i32 [ 1, %.lr.ph ], [ %23, %15 ]
  %.042 = phi double [ %14, %.lr.ph ], [ %.15, %15 ]
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %25
  %.5.lcssa = phi i32 [ %.6, %..loopexit_crit_edge ], [ poison, %25 ]
  br label %39
...
.loopexit1:                                       ; preds = %..loopexit1_crit_edge, %9
  %.2.lcssa = phi i32 [ %.3, %..loopexit1_crit_edge ], [ poison, %9 ]
  br label %39
...
.preheader:                                       ; preds = %7
  br i1 true, label %.lr.ph4, label %.loopexit
...
20:                                               ; preds = %17, %._crit_edge
  ...
  %24 = icmp samesign ult i32 %.014, 1999
...
37:                                               ; preds = %.loopexit, %3
  %38 = icmp samesign ult i32 %.014, 1998
