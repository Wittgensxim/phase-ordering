...
18:                                               ; preds = %.lr.ph9, %28
  %.27 = phi i32 [ 0, %.lr.ph9 ], [ %.3, %28 ]
  %.016 = phi i32 [ %17, %.lr.ph9 ], [ %27, %28 ]
  %.025 = phi i32 [ 1, %.lr.ph9 ], [ %29, %28 ]
  %.044 = phi double [ %16, %.lr.ph9 ], [ %.15, %28 ]
  %19 = add nsw i32 %.016, %2
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds double, ptr %1, i64 %20
  %22 = load double, ptr %21, align 8
  %23 = call double @llvm.fabs.f64(double %22)
  %24 = fcmp ogt double %23, %.044
...
26:                                               ; preds = %25, %18
  %.15 = phi double [ %23, %25 ], [ %.044, %18 ]
  %.3 = phi i32 [ %.025, %25 ], [ %.27, %18 ]
...
28:                                               ; preds = %26
  ...
  br i1 %30, label %18, label %._crit_edge10, !llvm.loop !13

._crit_edge10:                                    ; preds = %28
  %split11 = phi i32 [ %.3, %28 ]
  br label %31

31:                                               ; preds = %._crit_edge10
  br label %50
...
45:                                               ; preds = %44, %37
  %.37 = phi double [ %42, %44 ], [ %.261, %37 ]
  %.6 = phi i32 [ %.132, %44 ], [ %.53, %37 ]
  br label %46

46:                                               ; preds = %45
  %47 = add nsw i32 %.132, 1
  %48 = icmp slt i32 %47, %0
  br i1 %48, label %37, label %._crit_edge, !llvm.loop !14
...
29:                                               ; preds = %23
  ...
  br i1 %31, label %23, label %._crit_edge, !llvm.loop !16
...
27:                                               ; preds = %.lr.ph6, %39
  %.14 = phi i32 [ %.0, %.lr.ph6 ], [ %38, %39 ]
  %.123 = phi i32 [ %.01, %.lr.ph6 ], [ %37, %39 ]
  %.032 = phi i32 [ 0, %.lr.ph6 ], [ %40, %39 ]
...
39:                                               ; preds = %27
  %40 = add nsw i32 %.032, 1
  %41 = icmp slt i32 %40, %0
  br i1 %41, label %27, label %._crit_edge7, !llvm.loop !17

._crit_edge7:                                     ; preds = %39
  br label %42

42:                                               ; preds = %._crit_edge7
  br label %59
...
44:                                               ; preds = %.lr.ph, %54
  %.141 = phi i32 [ 0, %.lr.ph ], [ %55, %54 ]
  %45 = add nsw i32 %.141, %3
  %46 = sext i32 %45 to i64
  %47 = getelementptr inbounds double, ptr %2, i64 %46
  %48 = load double, ptr %47, align 8
  %49 = add nsw i32 %.141, %6
...
54:                                               ; preds = %44
  %55 = add nsw i32 %.141, 1
  %56 = icmp slt i32 %55, %0
  br i1 %56, label %44, label %._crit_edge, !llvm.loop !18
