...
30:                                               ; preds = %27
  ...
  %32 = icmp samesign ult i32 %31, 2000
...
39:                                               ; preds = %69, %38
  ...
  %40 = icmp samesign ult i32 %.1, 2000
...
42:                                               ; preds = %66, %41
  %.2 = phi i32 [ 0, %41 ], [ %67, %66 ]
  %43 = icmp samesign ult i32 %.2, 2000
...
44:                                               ; preds = %42
  ...
  %51 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %48
...
56:                                               ; preds = %54
  ...
  %63 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %60
...
21:                                               ; preds = %19
  %22 = call dereferenceable_or_null(16008) ptr @malloc(i64 noundef 16008) #6
  %23 = zext nneg i32 %.12 to i64
...
27:                                               ; preds = %19
  ...
  %30 = call dereferenceable_or_null(8000) ptr @malloc(i64 noundef 8000) #6
...
33:                                               ; preds = %31
  ...
  %35 = getelementptr inbounds nuw [8 x i8], ptr %18, i64 %34
...
39:                                               ; preds = %31
  ...
  br i1 %.0, label %43, label %40

40:                                               ; preds = %39
  %41 = call ptr @__acrt_iob_func(i32 noundef 1) #5
  %42 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %41, ptr noundef nonnull @.str.1, double noundef 0.000000e+00) #5
  br label %46

43:                                               ; preds = %39
  %44 = call ptr @__acrt_iob_func(i32 noundef 1) #5
  %45 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %44, ptr noundef nonnull @.str.2, double noundef 0.000000e+00) #5
  br label %46

46:                                               ; preds = %43, %40
  %47 = call ptr @__acrt_iob_func(i32 noundef 1) #5
  %48 = call i32 @fflush(ptr noundef %47) #5
  ret i32 0
}
