...
3:                                                ; preds = %10, %2
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %10 ], [ 0, %2 ]
  %exitcond5 = icmp ne i64 %indvars.iv2, 2000
  br i1 %exitcond5, label %4, label %11
...
5:                                                ; preds = %4
  ...
  %9 = getelementptr inbounds double, ptr %8, i64 %indvars.iv2
...
11:                                               ; preds = %3, %12
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %12 ], [ 0, %3 ]
  %exitcond9 = icmp ne i64 %indvars.iv6, 2000
  br i1 %exitcond9, label %12, label %14

12:                                               ; preds = %11
  %13 = getelementptr inbounds double, ptr %1, i64 %indvars.iv6
  store double 0.000000e+00, ptr %13, align 8
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br label %11, !llvm.loop !10

14:                                               ; preds = %11, %24
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %24 ], [ 0, %11 ]
  %exitcond17 = icmp ne i64 %indvars.iv14, 2000
  br i1 %exitcond17, label %15, label %25

15:                                               ; preds = %14, %16
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %16 ], [ 0, %14 ]
  %exitcond13 = icmp ne i64 %indvars.iv10, 2000
  br i1 %exitcond13, label %16, label %24

16:                                               ; preds = %15
  %17 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv14
  %18 = load ptr, ptr %17, align 8
  %19 = getelementptr inbounds double, ptr %18, i64 %indvars.iv10
  %20 = load double, ptr %19, align 8
  %21 = getelementptr inbounds double, ptr %1, i64 %indvars.iv10
...
19:                                               ; preds = %20, %10
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %20 ], [ %16, %10 ]
  %.04 = phi double [ %14, %10 ], [ %.15, %20 ]
  %.02 = phi i32 [ 1, %10 ], [ %26, %20 ]
  %.2 = phi i32 [ 0, %10 ], [ %.3, %20 ]
  %exitcond5 = icmp ne i32 %.02, %0
  br i1 %exitcond5, label %20, label %41

20:                                               ; preds = %19
  %21 = add nsw i64 %indvars.iv2, %18
  ...
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, %17
  %26 = add nuw i32 %.02, 1
...
33:                                               ; preds = %34, %27
  ...
  br i1 %exitcond, label %34, label %41
...
23:                                               ; preds = %24, %21
  ...
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %24, label %29
...
11:                                               ; preds = %8
  %12 = icmp ne i32 %4, 1
  %13 = icmp ne i32 %7, 1
  %or.cond10 = or i1 %12, %13
  br i1 %or.cond10, label %14, label %37
...
27:                                               ; preds = %28, %14
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %28 ], [ %24, %14 ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %28 ], [ %21, %14 ]
  %.03 = phi i32 [ 0, %14 ], [ %36, %28 ]
  %exitcond9 = icmp ne i32 %.03, %smax
  br i1 %exitcond9, label %28, label %49

28:                                               ; preds = %27
  %29 = add nsw i64 %indvars.iv2, %23
  %30 = getelementptr inbounds double, ptr %2, i64 %29
  %31 = load double, ptr %30, align 8
  %32 = add nsw i64 %indvars.iv4, %26
  ...
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, %22
  %indvars.iv.next5 = add nsw i64 %indvars.iv4, %25
  %36 = add nuw i32 %.03, 1
...
40:                                               ; preds = %41, %37
  %indvars.iv = phi i64 [ %indvars.iv.next, %41 ], [ 0, %37 ]
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %41, label %49

41:                                               ; preds = %40
  %42 = add nsw i64 %indvars.iv, %38
  %43 = getelementptr inbounds double, ptr %2, i64 %42
  %44 = load double, ptr %43, align 8
  %45 = add nsw i64 %indvars.iv, %39
  %46 = getelementptr inbounds double, ptr %5, i64 %45
  %47 = load double, ptr %46, align 8
  %48 = call double @llvm.fmuladd.f64(double %1, double %44, double %47)
...
29:                                               ; preds = %38, %23
  ...
  br i1 %exitcond, label %30, label %40
...
21:                                               ; preds = %4, %22
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %22 ], [ 0, %4 ]
