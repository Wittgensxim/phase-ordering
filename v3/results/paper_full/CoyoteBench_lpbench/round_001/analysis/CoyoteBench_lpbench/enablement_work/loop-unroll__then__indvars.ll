...
15:                                               ; preds = %27, %14
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %27 ], [ 0, %14 ]
  br label %16
...
18:                                               ; preds = %16
  %19 = add nuw nsw i64 %indvars.iv6, 1
  br label %20

20:                                               ; preds = %18
  %21 = getelementptr inbounds double, ptr %1, i64 %19
  store double 0.000000e+00, ptr %21, align 8
  br label %22

22:                                               ; preds = %20
  %23 = add nuw nsw i64 %indvars.iv6, 2
  %24 = icmp samesign ult i64 %23, 2000
...
27:                                               ; preds = %25
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 3
...
29:                                               ; preds = %53, %28
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %53 ], [ 0, %28 ]
  %exitcond15 = icmp ne i64 %indvars.iv12, 2000
  br i1 %exitcond15, label %30, label %54

30:                                               ; preds = %29
  br label %31

31:                                               ; preds = %51, %30
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %51 ], [ 0, %30 ]
  %32 = icmp samesign ult i64 %indvars.iv9, 2000
  br i1 %32, label %33, label %52

33:                                               ; preds = %31
  %34 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv12
  %35 = load ptr, ptr %34, align 8
  %36 = getelementptr inbounds double, ptr %35, i64 %indvars.iv9
  %37 = load double, ptr %36, align 8
  %38 = getelementptr inbounds double, ptr %1, i64 %indvars.iv9
...
41:                                               ; preds = %33
  %42 = add nuw nsw i64 %indvars.iv9, 1
  br label %43

43:                                               ; preds = %41
  %44 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv12
  %45 = load ptr, ptr %44, align 8
  %46 = getelementptr inbounds double, ptr %45, i64 %42
  %47 = load double, ptr %46, align 8
  %48 = getelementptr inbounds double, ptr %1, i64 %42
