...
17:                                               ; preds = %.lr.ph9, %17
  %.28 = phi i32 [ 0, %.lr.ph9 ], [ %.3, %17 ]
  %.017 = phi i32 [ %15, %.lr.ph9 ], [ %24, %17 ]
  %.026 = phi i32 [ 1, %.lr.ph9 ], [ %25, %17 ]
  %.045 = phi double [ %14, %.lr.ph9 ], [ %.15, %17 ]
  %18 = add nsw i32 %.017, %2
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds double, ptr %1, i64 %19
  %21 = load double, ptr %20, align 8
  %22 = call double @llvm.fabs.f64(double %21)
  %23 = fcmp ogt double %22, %.045
  %.15 = select i1 %23, double %22, double %.045
  %.3 = select i1 %23, i32 %.026, i32 %.28
  %24 = add nsw i32 %.017, %3
...
33:                                               ; preds = %.lr.ph, %33
  %.54 = phi i32 [ 0, %.lr.ph ], [ %.6, %33 ]
  %.133 = phi i32 [ 1, %.lr.ph ], [ %40, %33 ]
  %.262 = phi double [ %31, %.lr.ph ], [ %.37, %33 ]
  %34 = add nsw i32 %.133, %2
  ...
  %.6 = select i1 %39, i32 %.133, i32 %.54
  %40 = add nsw i32 %.133, 1
  %41 = icmp slt i32 %40, %0
  br i1 %41, label %33, label %..loopexit1_crit_edge, !llvm.loop !14

..loopexit_crit_edge:                             ; preds = %17
  %split10 = phi i32 [ %.3, %17 ]
  br label %.loopexit
...
21:                                               ; preds = %.lr.ph, %21
  ...
  br i1 %28, label %21, label %..loopexit1_crit_edge, !llvm.loop !16
...
15:                                               ; preds = %11
  ...
  %20 = sub nsw i32 1, %0
  %21 = mul nsw i32 %20, %7
  %.0 = select i1 %19, i32 %21, i32 0
  %22 = icmp slt i32 0, %0
  br i1 %22, label %.lr.ph7, label %.loopexit

.lr.ph7:                                          ; preds = %15
  br label %23

23:                                               ; preds = %.lr.ph7, %23
  %.16 = phi i32 [ %.0, %.lr.ph7 ], [ %34, %23 ]
  %.125 = phi i32 [ %.01, %.lr.ph7 ], [ %33, %23 ]
  %.034 = phi i32 [ 0, %.lr.ph7 ], [ %35, %23 ]
  %24 = add nsw i32 %.125, %3
  ...
  %33 = add nsw i32 %.125, %4
  %34 = add nsw i32 %.16, %7
  %35 = add nsw i32 %.034, 1
  %36 = icmp slt i32 %35, %0
  br i1 %36, label %23, label %..loopexit_crit_edge, !llvm.loop !17

37:                                               ; preds = %.lr.ph, %37
  %.143 = phi i32 [ 0, %.lr.ph ], [ %47, %37 ]
  %38 = add nsw i32 %.143, %3
  %39 = sext i32 %38 to i64
  %40 = getelementptr inbounds double, ptr %2, i64 %39
  %41 = load double, ptr %40, align 8
  %42 = add nsw i32 %.143, %6
  %43 = sext i32 %42 to i64
  %44 = getelementptr inbounds double, ptr %5, i64 %43
  %45 = load double, ptr %44, align 8
  %46 = call double @llvm.fmuladd.f64(double %1, double %41, double %45)
  store double %46, ptr %44, align 8
  %47 = add nsw i32 %.143, 1
  %48 = icmp slt i32 %47, %0
  br i1 %48, label %37, label %..loopexit2_crit_edge, !llvm.loop !18
...
..loopexit2_crit_edge:                            ; preds = %37
  br label %.loopexit2

.loopexit2:                                       ; preds = %..loopexit2_crit_edge, %.preheader
  br label %49
