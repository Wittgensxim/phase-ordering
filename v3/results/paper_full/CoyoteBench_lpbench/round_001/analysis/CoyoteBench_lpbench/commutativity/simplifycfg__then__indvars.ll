...
29:                                               ; preds = %30, %16
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %30 ], [ %26, %16 ]
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %30 ], [ %23, %16 ]
  %.03 = phi i32 [ 0, %16 ], [ %38, %30 ]
  %exitcond11 = icmp ne i32 %.03, %0
  br i1 %exitcond11, label %30, label %.loopexit

30:                                               ; preds = %29
  %31 = add nsw i64 %indvars.iv4, %25
  %32 = getelementptr inbounds double, ptr %2, i64 %31
  %33 = load double, ptr %32, align 8
  %34 = add nsw i64 %indvars.iv6, %28
  %35 = getelementptr inbounds double, ptr %5, i64 %34
  %36 = load double, ptr %35, align 8
  %37 = call double @llvm.fmuladd.f64(double %1, double %33, double %36)
  store double %37, ptr %35, align 8
  %indvars.iv.next5 = add nsw i64 %indvars.iv4, %24
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, %27
  %38 = add nuw i32 %.03, 1
  br label %29, !llvm.loop !17

39:                                               ; preds = %.preheader, %40
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %40 ]
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %40, label %.loopexit2

40:                                               ; preds = %39
  %41 = add nsw i64 %indvars.iv, %14
  %42 = getelementptr inbounds double, ptr %2, i64 %41
  %43 = load double, ptr %42, align 8
  %44 = add nsw i64 %indvars.iv, %15
  %45 = getelementptr inbounds double, ptr %5, i64 %44
  %46 = load double, ptr %45, align 8
  %47 = call double @llvm.fmuladd.f64(double %1, double %43, double %46)
