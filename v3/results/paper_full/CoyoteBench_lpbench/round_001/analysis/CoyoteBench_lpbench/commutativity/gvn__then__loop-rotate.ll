...
23:                                               ; preds = %.lr.ph, %23
  ...
  %29 = add nsw i32 %.11, 1
  %30 = icmp slt i32 %29, %0
  br i1 %30, label %23, label %._crit_edge, !llvm.loop !16
...
26:                                               ; preds = %23, %21
  ...
  %27 = icmp slt i32 0, %0
  br i1 %27, label %.lr.ph6, label %42

.lr.ph6:                                          ; preds = %26
  br label %28

28:                                               ; preds = %.lr.ph6, %28
  %.14 = phi i32 [ %.0, %.lr.ph6 ], [ %39, %28 ]
  %.123 = phi i32 [ %.01, %.lr.ph6 ], [ %38, %28 ]
  %.032 = phi i32 [ 0, %.lr.ph6 ], [ %40, %28 ]
  ...
  br i1 %41, label %28, label %._crit_edge7, !llvm.loop !17
...
45:                                               ; preds = %.lr.ph, %45
  %.141 = phi i32 [ 0, %.lr.ph ], [ %55, %45 ]
  %46 = add nsw i32 %.141, %3
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds double, ptr %2, i64 %47
  %49 = load double, ptr %48, align 8
  %50 = add nsw i32 %.141, %6
  ...
  br i1 %56, label %45, label %._crit_edge, !llvm.loop !18
...
3:                                                ; preds = %2, %40
  %.015 = phi i32 [ 0, %2 ], [ %7, %40 ]
  %4 = sext i32 %.015 to i64
  %5 = getelementptr inbounds ptr, ptr %0, i64 %4
  %6 = load ptr, ptr %5, align 8
  %7 = add nsw i32 %.015, 1
  %8 = sub nsw i32 2000, %.015
...
36:                                               ; preds = %33, %27
  ...
  %37 = add nsw i32 %.02, 1
  %38 = icmp slt i32 %37, 2000
  br i1 %38, label %27, label %._crit_edge4, !llvm.loop !19

._crit_edge4:                                     ; preds = %36
  br label %39

39:                                               ; preds = %._crit_edge4, %21
  br label %40
