...
18:                                               ; preds = %19, %9
  ...
  %.2 = phi i32 [ %.3, %19 ], [ 0, %9 ]
  %exitcond.not = icmp eq i32 %.02, %0
  br i1 %exitcond.not, label %.loopexit1, label %19
...
32:                                               ; preds = %33, %26
  ...
  %.5 = phi i32 [ %.6, %33 ], [ 0, %26 ]
  %exitcond6.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond6.not, label %.loopexit, label %33

33:                                               ; preds = %32
  %34 = getelementptr [8 x i8], ptr %1, i64 %indvars.iv3
...
40:                                               ; preds = %.loopexit1, %.loopexit, %6, %4
  %.0 = phi i32 [ -1, %4 ], [ 0, %6 ], [ %.5, %.loopexit ], [ %.2, %.loopexit1 ]
  ret i32 %.0
}
...
22:                                               ; preds = %21
  %23 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv3
...
3:                                                ; preds = %37, %2
  ...
  br i1 %exitcond7.not, label %38, label %4
...
20:                                               ; preds = %.preheader, %21
  ...
  br i1 %exitcond5.not, label %33, label %21
