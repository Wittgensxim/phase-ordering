...
11:                                               ; preds = %19, %.preheader2
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %19 ], [ 0, %.preheader2 ]
  br label %12
...
15:                                               ; preds = %12
  %16 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %14
  store double 0.000000e+00, ptr %16, align 8
  %17 = add nuw nsw i64 %indvars.iv9, 2
  %18 = icmp samesign ult i64 %17, 2000
  br i1 %18, label %19, label %.preheader1

19:                                               ; preds = %15
  %20 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %17
  store double 0.000000e+00, ptr %20, align 8
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 3
  br label %11, !llvm.loop !10

21:                                               ; preds = %.preheader1, %50
  %indvars.iv15 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next16, %50 ]
  %exitcond18 = icmp ne i64 %indvars.iv15, 2000
  br i1 %exitcond18, label %.preheader, label %51

.preheader:                                       ; preds = %21
  %22 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv15
  br label %23

23:                                               ; preds = %42, %.preheader
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %42 ], [ 0, %.preheader ]
  br label %24

24:                                               ; preds = %23
  %25 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv15
  %26 = load ptr, ptr %25, align 8
  %27 = getelementptr inbounds nuw [8 x i8], ptr %26, i64 %indvars.iv12
  %28 = load double, ptr %27, align 8
  %29 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv12
  %30 = load double, ptr %29, align 8
  %31 = fadd double %30, %28
  store double %31, ptr %29, align 8
  %32 = add nuw nsw i64 %indvars.iv12, 1
  br label %33
...
33:                                               ; preds = %24
  ...
  %37 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %32
  %38 = load double, ptr %37, align 8
  %39 = fadd double %38, %36
  store double %39, ptr %37, align 8
  %40 = add nuw nsw i64 %indvars.iv12, 2
  %41 = icmp samesign ult i64 %40, 2000
  br i1 %41, label %42, label %50

42:                                               ; preds = %33
  %43 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv15
  %44 = load ptr, ptr %43, align 8
  %45 = getelementptr inbounds nuw [8 x i8], ptr %44, i64 %40
  %46 = load double, ptr %45, align 8
  %47 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %40
  %48 = load double, ptr %47, align 8
  %49 = fadd double %48, %46
  store double %49, ptr %47, align 8
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 3
