...
17:                                               ; preds = %18, %9
  %indvars.iv = phi i64 [ %indvars.iv.next, %18 ], [ %15, %9 ]
  %.04 = phi double [ %13, %9 ], [ %.15, %18 ]
  %.02 = phi i32 [ 1, %9 ], [ %24, %18 ]
  %.2 = phi i32 [ 0, %9 ], [ %.3, %18 ]
  %exitcond = icmp ne i32 %.02, %0
  br i1 %exitcond, label %18, label %.loopexit1
...
30:                                               ; preds = %31, %25
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %31 ], [ 1, %25 ]
  %.26 = phi double [ %29, %25 ], [ %.37, %31 ]
  %.5 = phi i32 [ 0, %25 ], [ %.6, %31 ]
  %exitcond6 = icmp ne i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond6, label %31, label %.loopexit

31:                                               ; preds = %30
  %32 = add nsw i64 %indvars.iv3, %26
  ...
  %37 = trunc nuw nsw i64 %indvars.iv3 to i32
  %.6 = select i1 %36, i32 %37, i32 %.5
...
3:                                                ; preds = %34, %2
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %34 ], [ 0, %2 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %34 ], [ 1, %2 ]
  %indvars6 = trunc i64 %indvars.iv4 to i32
  %exitcond7 = icmp ne i64 %indvars.iv4, 1999
  br i1 %exitcond7, label %4, label %35
...
4:                                                ; preds = %3
  ...
  %10 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv4
...
16:                                               ; preds = %15
  %17 = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv4
...
19:                                               ; preds = %16, %._crit_edge
  %20 = phi double [ %.pre, %._crit_edge ], [ %13, %16 ]
  %21 = fdiv double -1.000000e+00, %20
  %22 = sub nuw nsw i32 1999, %indvars6
  %23 = trunc nuw nsw i64 %indvars.iv.next5 to i32
  call void @dscal(i32 noundef %22, double noundef %21, ptr noundef %6, i32 noundef %23, i32 noundef 1)
  br label %24

24:                                               ; preds = %33, %19
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %33 ], [ %indvars.iv, %19 ]
  %exitcond = icmp ne i64 %indvars.iv1, 2000
  br i1 %exitcond, label %25, label %.loopexit

25:                                               ; preds = %24
  %26 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv1
...
30:                                               ; preds = %25
  %31 = getelementptr inbounds nuw [8 x i8], ptr %27, i64 %indvars.iv4
  %32 = load double, ptr %31, align 8
...
33:                                               ; preds = %30, %25
  call void @daxpy(i32 noundef %22, double noundef %29, ptr noundef %6, i32 noundef %23, i32 noundef 1, ptr noundef %27, i32 noundef %23, i32 noundef 1)
...
35:                                               ; preds = %3
  %36 = getelementptr inbounds nuw i8, ptr %1, i64 7996
  store i32 1999, ptr %36, align 4
  ret void
}
