...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %26
  %.5.lcssa = phi i32 [ %.6, %..loopexit_crit_edge ], [ 0, %26 ]
  br label %41
...
.loopexit1:                                       ; preds = %..loopexit1_crit_edge, %9
  %.2.lcssa = phi i32 [ %.3, %..loopexit1_crit_edge ], [ 0, %9 ]
  br label %41
...
.preheader:                                       ; preds = %7
  br i1 true, label %.lr.ph4, label %.preheader..loopexit_crit_edge
...
.loopexit:                                        ; preds = %.preheader..loopexit_crit_edge, %..loopexit_crit_edge
  br label %27
