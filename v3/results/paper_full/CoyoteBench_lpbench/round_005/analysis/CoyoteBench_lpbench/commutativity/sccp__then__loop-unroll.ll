...
5:                                                ; preds = %.preheader3, %7
  ...
  %6 = icmp samesign ult i32 %.0, 2000
...
17:                                               ; preds = %27, %.preheader2
  %.12 = phi i32 [ 0, %.preheader2 ], [ %30, %27 ]
  br label %18
...
22:                                               ; preds = %18
  ...
  %26 = icmp samesign ult i32 %25, 2000
  br i1 %26, label %27, label %.preheader1

27:                                               ; preds = %22
  %28 = zext nneg i32 %25 to i64
  %29 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %28
  store double 0.000000e+00, ptr %29, align 8
  %30 = add nuw nsw i32 %.12, 3
  br label %17, !llvm.loop !10

31:                                               ; preds = %.preheader1, %68
  %.1 = phi i32 [ %69, %68 ], [ 0, %.preheader1 ]
  %32 = icmp samesign ult i32 %.1, 2000
  br i1 %32, label %.preheader, label %70
...
35:                                               ; preds = %57, %.preheader
  %.2 = phi i32 [ 0, %.preheader ], [ %67, %57 ]
  br label %36
...
47:                                               ; preds = %36
  ...
  %52 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %49
  %53 = load double, ptr %52, align 8
  %54 = fadd double %53, %51
  store double %54, ptr %52, align 8
  %55 = add nuw nsw i32 %.2, 2
  %56 = icmp samesign ult i32 %55, 2000
...
57:                                               ; preds = %47
  ...
  %64 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %61
...
15:                                               ; preds = %17, %9
  ...
  br i1 %16, label %17, label %.loopexit6
...
.loopexit:                                        ; preds = %31
  %.5.lcssa = phi i32 [ %.5, %31 ]
  br label %41

.loopexit6:                                       ; preds = %15
  %.2.lcssa = phi i32 [ %.2, %15 ]
  br label %41
