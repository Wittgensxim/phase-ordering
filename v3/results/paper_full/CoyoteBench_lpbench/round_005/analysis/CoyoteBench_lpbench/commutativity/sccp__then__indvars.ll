; ModuleID = 'results\paper_full\CoyoteBench_lpbench\round_004\input.ll'
...
15:                                               ; preds = %.preheader, %16
  %indvars.iv13 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next14, %16 ]
  %exitcond16 = icmp ne i64 %indvars.iv13, 2000
  br i1 %exitcond16, label %16, label %24

16:                                               ; preds = %15
  %17 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv17
...
18:                                               ; preds = %19, %9
  ...
  br i1 %exitcond, label %19, label %.loopexit6
...
32:                                               ; preds = %33, %26
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %33 ], [ 1, %26 ]
  %.26 = phi double [ %30, %26 ], [ %.37, %33 ]
  %.5 = phi i32 [ 0, %26 ], [ %.6, %33 ]
  %exitcond11 = icmp ne i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond11, label %33, label %.loopexit

33:                                               ; preds = %32
  %34 = add nsw i64 %indvars.iv8, %31
...
40:                                               ; preds = %.loopexit6, %.loopexit, %6, %4
  %.0 = phi i32 [ -1, %4 ], [ 0, %6 ], [ %.5.lcssa, %.loopexit ], [ %.2.lcssa, %.loopexit6 ]
  ret i32 %.0
}
...
14:                                               ; preds = %16, %9
  ...
  br i1 %15, label %16, label %.loopexit3
...
21:                                               ; preds = %.preheader, %22
  %indvars.iv5 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next6, %22 ]
  %exitcond = icmp ne i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond, label %22, label %.loopexit

22:                                               ; preds = %21
  %23 = add nsw i64 %indvars.iv5, %8
...
28:                                               ; preds = %29, %16
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %29 ], [ %25, %16 ]
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %29 ], [ %22, %16 ]
  %.03 = phi i32 [ 0, %16 ], [ %37, %29 ]
  %exitcond14 = icmp ne i32 %.03, %0
  br i1 %exitcond14, label %29, label %.loopexit

29:                                               ; preds = %28
  %30 = add nsw i64 %indvars.iv7, %24
  %31 = getelementptr inbounds [8 x i8], ptr %2, i64 %30
  %32 = load double, ptr %31, align 8
  %33 = add nsw i64 %indvars.iv9, %27
  %34 = getelementptr inbounds [8 x i8], ptr %5, i64 %33
  %35 = load double, ptr %34, align 8
  %36 = call double @llvm.fmuladd.f64(double %1, double %32, double %35)
  store double %36, ptr %34, align 8
  %indvars.iv.next8 = add nsw i64 %indvars.iv7, %23
  %indvars.iv.next10 = add nsw i64 %indvars.iv9, %26
  %37 = add nuw i32 %.03, 1
...
38:                                               ; preds = %.preheader, %39
  ...
  br i1 %exitcond, label %39, label %.loopexit5

39:                                               ; preds = %38
  %40 = add nsw i64 %indvars.iv, %15
...
3:                                                ; preds = %37, %2
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %37 ], [ 0, %2 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %37 ], [ 1, %2 ]
  %indvars8 = trunc i64 %indvars.iv6 to i32
  %exitcond9 = icmp ne i64 %indvars.iv6, 1999
  br i1 %exitcond9, label %4, label %38

4:                                                ; preds = %3
  %5 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv6
  %6 = load ptr, ptr %5, align 8
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %indvars = trunc i64 %indvars.iv.next7 to i32
  %7 = sub nuw nsw i32 2000, %indvars8
  %8 = trunc nuw nsw i64 %indvars.iv6 to i32
  %9 = call i32 @idamax(i32 noundef %7, ptr noundef %6, i32 noundef %8, i32 noundef 1)
  %10 = trunc nuw nsw i64 %indvars.iv6 to i32
  %11 = add nsw i32 %9, %10
  %12 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv6
...
._crit_edge:                                      ; preds = %17
  %.phi.trans.insert = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv6
  %.pre = load double, ptr %.phi.trans.insert, align 8
  br label %21

18:                                               ; preds = %17
  %19 = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv6
  %20 = load double, ptr %19, align 8
...
21:                                               ; preds = %18, %._crit_edge
  ...
  %24 = sub nuw nsw i64 1999, %indvars.iv6
  %25 = trunc nuw nsw i64 %24 to i32
  call void @dscal(i32 noundef %25, double noundef %23, ptr noundef %6, i32 noundef %indvars, i32 noundef 1)
  br label %26

26:                                               ; preds = %35, %21
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %35 ], [ %indvars.iv, %21 ]
  %exitcond = icmp ne i64 %indvars.iv3, 2000
  br i1 %exitcond, label %27, label %.loopexit

27:                                               ; preds = %26
  %28 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv3
...
32:                                               ; preds = %27
  %33 = getelementptr inbounds nuw [8 x i8], ptr %29, i64 %indvars.iv6
...
35:                                               ; preds = %32, %27
  %36 = trunc nuw nsw i64 %24 to i32
  call void @daxpy(i32 noundef %36, double noundef %31, ptr noundef %6, i32 noundef %indvars, i32 noundef 1, ptr noundef %29, i32 noundef %indvars, i32 noundef 1)
...
15:                                               ; preds = %12, %5
  ...
  %16 = sub nuw nsw i64 1999, %indvars.iv
  %17 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv
  %18 = load ptr, ptr %17, align 8
  %19 = trunc nuw nsw i64 %16 to i32
  call void @daxpy(i32 noundef %19, double noundef %10, ptr noundef %18, i32 noundef %indvars, i32 noundef 1, ptr noundef %2, i32 noundef %indvars, i32 noundef 1)
