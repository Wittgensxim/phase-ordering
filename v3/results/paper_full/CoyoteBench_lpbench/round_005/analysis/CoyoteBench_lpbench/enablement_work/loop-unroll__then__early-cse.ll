...
31:                                               ; preds = %.preheader1, %64
  %.1 = phi i32 [ %65, %64 ], [ 0, %.preheader1 ]
  %32 = icmp samesign ult i32 %.1, 2000
  br i1 %32, label %.preheader, label %66
...
35:                                               ; preds = %55, %.preheader
  %.2 = phi i32 [ 0, %.preheader ], [ %63, %55 ]
  br label %36
...
45:                                               ; preds = %36
  ...
  %50 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %47
  %51 = load double, ptr %50, align 8
  %52 = fadd double %51, %49
  store double %52, ptr %50, align 8
  %53 = add nuw nsw i32 %.2, 2
  %54 = icmp samesign ult i32 %53, 2000
...
55:                                               ; preds = %45
  ...
  %60 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %57
