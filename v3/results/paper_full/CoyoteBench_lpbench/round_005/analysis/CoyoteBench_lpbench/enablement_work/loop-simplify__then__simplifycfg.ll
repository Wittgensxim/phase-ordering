...
.preheader2:                                      ; preds = %3, %17
  %.12 = phi i32 [ %20, %17 ], [ 0, %3 ]
  %16 = icmp samesign ult i32 %.12, 2000
...
.preheader1:                                      ; preds = %.preheader2, %34
  %.1 = phi i32 [ %35, %34 ], [ 0, %.preheader2 ]
  %21 = icmp samesign ult i32 %.1, 2000
  br i1 %21, label %.preheader, label %36

.preheader:                                       ; preds = %.preheader1, %23
  %.2 = phi i32 [ %33, %23 ], [ 0, %.preheader1 ]
  %22 = icmp samesign ult i32 %.2, 2000
...
23:                                               ; preds = %.preheader
  ...
  %30 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %27
