...
29:                                               ; preds = %.preheader1, %60
  %.1 = phi i32 [ %61, %60 ], [ 0, %.preheader1 ]
  %30 = icmp samesign ult i32 %.1, 2000
  br i1 %30, label %.preheader, label %62
...
33:                                               ; preds = %51, %.preheader
  %.2 = phi i32 [ 0, %.preheader ], [ %59, %51 ]
  ...
  %46 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %43
...
51:                                               ; preds = %33
  ...
  %56 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %53
  %57 = load double, ptr %56, align 8
  %58 = fadd double %57, %55
  store double %58, ptr %56, align 8
  %59 = add nuw nsw i32 %.2, 3
