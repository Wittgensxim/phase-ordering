...
9:                                                ; preds = %8
  ...
  %14 = add nsw i32 %3, 1
  %15 = icmp slt i32 1, %0
  br i1 %15, label %.lr.ph, label %.loopexit6

.lr.ph:                                           ; preds = %9
  br label %16

16:                                               ; preds = %.lr.ph, %16
  %.210 = phi i32 [ 0, %.lr.ph ], [ %.3, %16 ]
  %.019 = phi i32 [ %14, %.lr.ph ], [ %23, %16 ]
  %.028 = phi i32 [ 1, %.lr.ph ], [ %24, %16 ]
  %.047 = phi double [ %13, %.lr.ph ], [ %.15, %16 ]
  %17 = add nsw i32 %.019, %2
  %18 = sext i32 %17 to i64
  %19 = getelementptr inbounds [8 x i8], ptr %1, i64 %18
  %20 = load double, ptr %19, align 8
  %21 = call double @llvm.fabs.f64(double %20)
  %22 = fcmp ogt double %21, %.047
  %.15 = select i1 %22, double %21, double %.047
  %.3 = select i1 %22, i32 %.028, i32 %.210
  %23 = add nsw i32 %.019, %3
  %24 = add nuw nsw i32 %.028, 1
  %25 = icmp slt i32 %24, %0
  br i1 %25, label %16, label %..loopexit6_crit_edge, !llvm.loop !13
...
26:                                               ; preds = %8
  ...
  %31 = icmp slt i32 1, %0
  br i1 %31, label %.lr.ph14, label %.loopexit

.lr.ph14:                                         ; preds = %26
  br label %32

32:                                               ; preds = %.lr.ph14, %32
  %.513 = phi i32 [ 0, %.lr.ph14 ], [ %.6, %32 ]
  %.1312 = phi i32 [ 1, %.lr.ph14 ], [ %39, %32 ]
  %.2611 = phi double [ %30, %.lr.ph14 ], [ %.37, %32 ]
  %33 = add nsw i32 %.1312, %2
  %34 = sext i32 %33 to i64
  %35 = getelementptr inbounds [8 x i8], ptr %1, i64 %34
  %36 = load double, ptr %35, align 8
  %37 = call double @llvm.fabs.f64(double %36)
  %38 = fcmp ogt double %37, %.2611
  %.37 = select i1 %38, double %37, double %.2611
  %.6 = select i1 %38, i32 %.1312, i32 %.513
  %39 = add nuw nsw i32 %.1312, 1
  %40 = icmp slt i32 %39, %0
  br i1 %40, label %32, label %..loopexit_crit_edge, !llvm.loop !14

..loopexit_crit_edge:                             ; preds = %32
  %split15 = phi i32 [ %.6, %32 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %26
  %.5.lcssa = phi i32 [ %split15, %..loopexit_crit_edge ], [ 0, %26 ]
  br label %41

..loopexit6_crit_edge:                            ; preds = %16
  %split = phi i32 [ %.3, %16 ]
  br label %.loopexit6

.loopexit6:                                       ; preds = %..loopexit6_crit_edge, %9
  %.2.lcssa = phi i32 [ %split, %..loopexit6_crit_edge ], [ 0, %9 ]
  br label %41
...
3:                                                ; preds = %2, %37
  %.015 = phi i32 [ 0, %2 ], [ %7, %37 ]
  %4 = zext nneg i32 %.015 to i64
  %5 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %4
  %6 = load ptr, ptr %5, align 8
  %7 = add nuw nsw i32 %.015, 1
  %8 = sub nuw nsw i32 2000, %.015
  %9 = call i32 @idamax(i32 noundef %8, ptr noundef %6, i32 noundef %.015, i32 noundef 1)
...
25:                                               ; preds = %.lr.ph, %34
  %.03 = phi i32 [ %7, %.lr.ph ], [ %35, %34 ]
  %26 = zext nneg i32 %.03 to i64
