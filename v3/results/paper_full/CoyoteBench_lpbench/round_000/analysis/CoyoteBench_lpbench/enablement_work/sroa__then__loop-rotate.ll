...
19:                                               ; preds = %18, %22
  %.12023 = phi i32 [ 0, %18 ], [ %23, %22 ]
  %20 = sext i32 %.12023 to i64
  %21 = getelementptr inbounds double, ptr %1, i64 %20
  store double 0.000000e+00, ptr %21, align 8
  br label %22

22:                                               ; preds = %19
  %23 = add nsw i32 %.12023, 1
...
12:                                               ; preds = %10
  ...
  %17 = add nsw i32 1, %3
  %18 = icmp slt i32 1, %0
  br i1 %18, label %.lr.ph45, label %32

.lr.ph45:                                         ; preds = %12
  br label %19

19:                                               ; preds = %.lr.ph45, %29
  %.243 = phi i32 [ 0, %.lr.ph45 ], [ %.3, %29 ]
  %.03042 = phi i32 [ %17, %.lr.ph45 ], [ %28, %29 ]
  %.03141 = phi i32 [ 1, %.lr.ph45 ], [ %30, %29 ]
  %.03340 = phi double [ %16, %.lr.ph45 ], [ %.134, %29 ]
  %20 = add nsw i32 %.03042, %2
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds double, ptr %1, i64 %21
  %23 = load double, ptr %22, align 8
  %24 = call double @llvm.fabs.f64(double %23)
  %25 = fcmp ogt double %24, %.03340
...
27:                                               ; preds = %26, %19
  %.134 = phi double [ %24, %26 ], [ %.03340, %19 ]
  %.3 = phi i32 [ %.03141, %26 ], [ %.243, %19 ]
  %28 = add nsw i32 %.03042, %3
  br label %29

29:                                               ; preds = %27
  %30 = add nsw i32 %.03141, 1
  %31 = icmp slt i32 %30, %0
  br i1 %31, label %19, label %._crit_edge46, !llvm.loop !13

._crit_edge46:                                    ; preds = %29
  %split47 = phi i32 [ %.3, %29 ]
  br label %32

32:                                               ; preds = %._crit_edge46, %12
  %.2.lcssa = phi i32 [ %split47, %._crit_edge46 ], [ 0, %12 ]
  br label %52
...
39:                                               ; preds = %.lr.ph, %48
  %.539 = phi i32 [ 0, %.lr.ph ], [ %.6, %48 ]
  %.13238 = phi i32 [ 1, %.lr.ph ], [ %49, %48 ]
  %.23537 = phi double [ %37, %.lr.ph ], [ %.336, %48 ]
  %40 = add nsw i32 %.13238, %2
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds double, ptr %1, i64 %41
  %43 = load double, ptr %42, align 8
  %44 = call double @llvm.fabs.f64(double %43)
  %45 = fcmp ogt double %44, %.23537
...
47:                                               ; preds = %46, %39
  %.336 = phi double [ %44, %46 ], [ %.23537, %39 ]
  %.6 = phi i32 [ %.13238, %46 ], [ %.539, %39 ]
  br label %48

48:                                               ; preds = %47
  %49 = add nsw i32 %.13238, 1
...
9:                                                ; preds = %7
  ...
  br i1 %11, label %.lr.ph21, label %21

.lr.ph21:                                         ; preds = %9
  br label %12

12:                                               ; preds = %.lr.ph21, %18
  %.019 = phi i32 [ 0, %.lr.ph21 ], [ %19, %18 ]
  %13 = add nsw i32 %.019, %3
...
18:                                               ; preds = %12
  %19 = add nsw i32 %.019, %4
  %20 = icmp slt i32 %19, %10
  br i1 %20, label %12, label %._crit_edge22, !llvm.loop !15

._crit_edge22:                                    ; preds = %18
  br label %21

21:                                               ; preds = %._crit_edge22, %9
  br label %34
...
24:                                               ; preds = %.lr.ph, %30
  %.118 = phi i32 [ 0, %.lr.ph ], [ %31, %30 ]
  %25 = add nsw i32 %.118, %3
...
26:                                               ; preds = %23, %21
  ...
  %27 = icmp slt i32 0, %0
  br i1 %27, label %.lr.ph42, label %43

.lr.ph42:                                         ; preds = %26
  br label %28

28:                                               ; preds = %.lr.ph42, %40
  %.140 = phi i32 [ %.0, %.lr.ph42 ], [ %39, %40 ]
  %.13439 = phi i32 [ %.033, %.lr.ph42 ], [ %38, %40 ]
  %.03538 = phi i32 [ 0, %.lr.ph42 ], [ %41, %40 ]
  %29 = add nsw i32 %.13439, %3
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds double, ptr %2, i64 %30
  %32 = load double, ptr %31, align 8
  %33 = add nsw i32 %.140, %6
  %34 = sext i32 %33 to i64
  %35 = getelementptr inbounds double, ptr %5, i64 %34
  %36 = load double, ptr %35, align 8
  %37 = call double @llvm.fmuladd.f64(double %1, double %32, double %36)
  store double %37, ptr %35, align 8
  %38 = add nsw i32 %.13439, %4
  %39 = add nsw i32 %.140, %7
  br label %40

40:                                               ; preds = %28
  %41 = add nsw i32 %.03538, 1
  %42 = icmp slt i32 %41, %0
  br i1 %42, label %28, label %._crit_edge43, !llvm.loop !17

._crit_edge43:                                    ; preds = %40
  br label %43

43:                                               ; preds = %._crit_edge43, %26
  br label %61
...
46:                                               ; preds = %.lr.ph, %56
  %.13637 = phi i32 [ 0, %.lr.ph ], [ %57, %56 ]
  %47 = add nsw i32 %.13637, %3
  %48 = sext i32 %47 to i64
  %49 = getelementptr inbounds double, ptr %2, i64 %48
  %50 = load double, ptr %49, align 8
  %51 = add nsw i32 %.13637, %6
...
3:                                                ; preds = %2, %60
  %.055 = phi i32 [ 0, %2 ], [ %61, %60 ]
  %4 = sext i32 %.055 to i64
  %5 = getelementptr inbounds ptr, ptr %0, i64 %4
  %6 = load ptr, ptr %5, align 8
  %7 = add nsw i32 %.055, 1
  %8 = sub nsw i32 2000, %.055
  %9 = call i32 @idamax(i32 noundef %8, ptr noundef %6, i32 noundef %.055, i32 noundef 1)
  %10 = add nsw i32 %9, %.055
  %11 = sext i32 %.055 to i64
...
4:                                                ; preds = %3, %26
  %.038 = phi i32 [ 0, %3 ], [ %27, %26 ]
  %5 = sext i32 %.038 to i64
  %6 = getelementptr inbounds i32, ptr %1, i64 %5
  %7 = load i32, ptr %6, align 4
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds double, ptr %2, i64 %8
  %10 = load double, ptr %9, align 8
  %11 = icmp ne i32 %7, %.038
...
30:                                               ; preds = %29, %50
  %.03739 = phi i32 [ 0, %29 ], [ %51, %50 ]
  %31 = add nsw i32 %.03739, 1
...
29:                                               ; preds = %25, %33
  %.230 = phi i32 [ 0, %25 ], [ %34, %33 ]
  %30 = sext i32 %.230 to i64
