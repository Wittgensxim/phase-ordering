...
3:                                                ; preds = %13, %2
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %13 ], [ 0, %2 ]
  %exitcond25 = icmp ne i64 %indvars.iv22, 2000
  br i1 %exitcond25, label %4, label %14
...
6:                                                ; preds = %5
  ...
  %10 = getelementptr inbounds double, ptr %9, i64 %indvars.iv22
...
15:                                               ; preds = %18, %14
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %18 ], [ 0, %14 ]
  %exitcond29 = icmp ne i64 %indvars.iv26, 2000
  br i1 %exitcond29, label %16, label %19

16:                                               ; preds = %15
  %17 = getelementptr inbounds double, ptr %1, i64 %indvars.iv26
...
20:                                               ; preds = %33, %19
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %33 ], [ 0, %19 ]
  %exitcond37 = icmp ne i64 %indvars.iv34, 2000
  br i1 %exitcond37, label %21, label %34

21:                                               ; preds = %20
  br label %22

22:                                               ; preds = %31, %21
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %31 ], [ 0, %21 ]
  %exitcond33 = icmp ne i64 %indvars.iv30, 2000
  br i1 %exitcond33, label %23, label %32

23:                                               ; preds = %22
  %24 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv34
  %25 = load ptr, ptr %24, align 8
  %26 = getelementptr inbounds double, ptr %25, i64 %indvars.iv30
  %27 = load double, ptr %26, align 8
  %28 = getelementptr inbounds double, ptr %1, i64 %indvars.iv30
...
21:                                               ; preds = %30, %12
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %30 ], [ %18, %12 ]
  %.033 = phi double [ %16, %12 ], [ %.134, %30 ]
  %.031 = phi i32 [ 1, %12 ], [ %31, %30 ]
  %.2 = phi i32 [ 0, %12 ], [ %.3, %30 ]
  %exitcond41 = icmp ne i32 %.031, %0
  br i1 %exitcond41, label %22, label %32

22:                                               ; preds = %21
  %23 = add nsw i64 %indvars.iv38, %20
  %24 = getelementptr inbounds double, ptr %1, i64 %23
  %25 = load double, ptr %24, align 8
  %26 = call double @llvm.fabs.f64(double %25)
  %27 = fcmp ogt double %26, %.033
...
29:                                               ; preds = %28, %22
  %.134 = phi double [ %26, %28 ], [ %.033, %22 ]
  %.3 = phi i32 [ %.031, %28 ], [ %.2, %22 ]
  %indvars.iv.next39 = add nsw i64 %indvars.iv38, %19
  br label %30
...
14:                                               ; preds = %21, %9
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %21 ], [ 0, %9 ]
  %15 = icmp slt i64 %indvars.iv19, %12
  br i1 %15, label %16, label %22

16:                                               ; preds = %14
  %17 = add nsw i64 %indvars.iv19, %13
...
21:                                               ; preds = %16
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, %11
...
33:                                               ; preds = %42, %26
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %42 ], [ %30, %26 ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %42 ], [ %27, %26 ]
  %.035 = phi i32 [ 0, %26 ], [ %43, %42 ]
  %exitcond45 = icmp ne i32 %.035, %smax
  br i1 %exitcond45, label %34, label %44

34:                                               ; preds = %33
  %35 = add nsw i64 %indvars.iv38, %29
  %36 = getelementptr inbounds double, ptr %2, i64 %35
  %37 = load double, ptr %36, align 8
  %38 = add nsw i64 %indvars.iv40, %32
  %39 = getelementptr inbounds double, ptr %5, i64 %38
  %40 = load double, ptr %39, align 8
  %41 = call double @llvm.fmuladd.f64(double %1, double %37, double %40)
  store double %41, ptr %39, align 8
  %indvars.iv.next39 = add nsw i64 %indvars.iv38, %28
  %indvars.iv.next41 = add nsw i64 %indvars.iv40, %31
  br label %42

42:                                               ; preds = %34
  %43 = add nuw i32 %.035, 1
...
3:                                                ; preds = %57, %2
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %57 ], [ 0, %2 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %57 ], [ 1, %2 ]
  %indvars59 = trunc i64 %indvars.iv57 to i32
  %exitcond60 = icmp ne i64 %indvars.iv57, 1999
  br i1 %exitcond60, label %4, label %58

4:                                                ; preds = %3
  %5 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv57
  %6 = load ptr, ptr %5, align 8
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %7 = add nuw nsw i32 %indvars59, 1
  %8 = sub nuw nsw i32 2000, %indvars59
  %9 = trunc nuw nsw i64 %indvars.iv57 to i32
  %10 = call i32 @idamax(i32 noundef %8, ptr noundef %6, i32 noundef %9, i32 noundef 1)
  %11 = trunc nuw nsw i64 %indvars.iv57 to i32
  %12 = add nsw i32 %10, %11
  %13 = getelementptr inbounds i32, ptr %1, i64 %indvars.iv57
...
18:                                               ; preds = %4
  ...
  %20 = icmp ne i64 %19, %indvars.iv57
...
21:                                               ; preds = %18
  ...
  %25 = getelementptr inbounds double, ptr %6, i64 %indvars.iv57
  %26 = load double, ptr %25, align 8
  %27 = sext i32 %12 to i64
  %28 = getelementptr inbounds double, ptr %6, i64 %27
  store double %26, ptr %28, align 8
  %29 = getelementptr inbounds double, ptr %6, i64 %indvars.iv57
  store double %24, ptr %29, align 8
  br label %30

30:                                               ; preds = %21, %18
  %31 = getelementptr inbounds double, ptr %6, i64 %indvars.iv57
  %32 = load double, ptr %31, align 8
  %33 = fdiv double -1.000000e+00, %32
  %34 = sub nuw nsw i32 2000, %7
  %35 = trunc nuw nsw i64 %indvars.iv.next58 to i32
  call void @dscal(i32 noundef %34, double noundef %33, ptr noundef %6, i32 noundef %35, i32 noundef 1)
  %36 = zext i32 %12 to i64
  br label %37

37:                                               ; preds = %54, %30
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %54 ], [ %indvars.iv, %30 ]
  %exitcond = icmp ne i64 %indvars.iv54, 2000
  br i1 %exitcond, label %38, label %55

38:                                               ; preds = %37
  %39 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv54
  %40 = load ptr, ptr %39, align 8
  %41 = sext i32 %12 to i64
  %42 = getelementptr inbounds double, ptr %40, i64 %41
  %43 = load double, ptr %42, align 8
  %44 = icmp ne i64 %36, %indvars.iv57
  br i1 %44, label %45, label %51

45:                                               ; preds = %38
  %46 = getelementptr inbounds double, ptr %40, i64 %indvars.iv57
  %47 = load double, ptr %46, align 8
  %48 = sext i32 %12 to i64
  %49 = getelementptr inbounds double, ptr %40, i64 %48
  store double %47, ptr %49, align 8
  %50 = getelementptr inbounds double, ptr %40, i64 %indvars.iv57
  store double %43, ptr %50, align 8
  br label %51

51:                                               ; preds = %45, %38
  %52 = sub nuw nsw i32 2000, %7
  %53 = trunc nuw nsw i64 %indvars.iv.next58 to i32
...
19:                                               ; preds = %13, %5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %20 = add nuw nsw i32 %indvars38, 1
...
27:                                               ; preds = %43, %26
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %43 ], [ 0, %26 ]
  %exitcond42 = icmp ne i64 %indvars.iv39, 2000
  br i1 %exitcond42, label %28, label %44

28:                                               ; preds = %27
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %29 = sub nsw i64 2000, %indvars.iv.next40
...
15:                                               ; preds = %.loopexit, %11
  %.127 = phi i8 [ 1, %11 ], [ 0, %.loopexit ]
  br label %16

16:                                               ; preds = %15, %2
  %.026 = phi i8 [ %.127, %15 ], [ 0, %2 ]
  %17 = call ptr @malloc(i64 noundef 16000) #6
  br label %18

18:                                               ; preds = %22, %16
  %indvars.iv = phi i64 [ %indvars.iv.next, %22 ], [ 0, %16 ]
  %exitcond29 = icmp ne i64 %indvars.iv, 2000
  br i1 %exitcond29, label %19, label %23
...
27:                                               ; preds = %31, %23
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %31 ], [ 0, %23 ]
  %exitcond33 = icmp ne i64 %indvars.iv30, 2000
  br i1 %exitcond33, label %28, label %32

28:                                               ; preds = %27
  %29 = getelementptr inbounds ptr, ptr %17, i64 %indvars.iv30
