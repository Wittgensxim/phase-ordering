...
22:                                               ; preds = %.lr.ph5, %25
  %.137 = phi i32 [ 0, %.lr.ph5 ], [ %26, %25 ]
  %23 = sext i32 %.137 to i64
  %24 = getelementptr inbounds double, ptr %1, i64 %23
  store double 0.000000e+00, ptr %24, align 8
  br label %25

25:                                               ; preds = %22
  %26 = add nsw i32 %.137, 1
...
19:                                               ; preds = %.lr.ph2, %29
  %.040 = phi double [ %16, %.lr.ph2 ], [ %.141, %29 ]
  %.038 = phi i32 [ 1, %.lr.ph2 ], [ %30, %29 ]
  %.037 = phi i32 [ %17, %.lr.ph2 ], [ %28, %29 ]
  %.2 = phi i32 [ 0, %.lr.ph2 ], [ %.4, %29 ]
  %20 = add nsw i32 %.037, %2
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds double, ptr %1, i64 %21
  %23 = load double, ptr %22, align 8
  %24 = call double @llvm.fabs.f64(double %23)
  %25 = fcmp ogt double %24, %.040
...
27:                                               ; preds = %26, %19
  %.141 = phi double [ %24, %26 ], [ %.040, %19 ]
  %.4 = phi i32 [ %.038, %26 ], [ %.2, %19 ]
  %28 = add nsw i32 %.037, %3
  br label %29

29:                                               ; preds = %27
  %30 = add nsw i32 %.038, 1
...
39:                                               ; preds = %.lr.ph, %48
  %.242 = phi double [ %37, %.lr.ph ], [ %.343, %48 ]
...
47:                                               ; preds = %46, %39
  %.343 = phi double [ %44, %46 ], [ %.242, %39 ]
  %.8 = phi i32 [ %.139, %46 ], [ %.6, %39 ]
  br label %48
...
28:                                               ; preds = %.lr.ph2, %40
  %.042 = phi i32 [ 0, %.lr.ph2 ], [ %41, %40 ]
  %.141 = phi i32 [ %.040, %.lr.ph2 ], [ %38, %40 ]
  %.1 = phi i32 [ %.0, %.lr.ph2 ], [ %39, %40 ]
  %29 = add nsw i32 %.141, %3
...
46:                                               ; preds = %.lr.ph, %56
  %.143 = phi i32 [ 0, %.lr.ph ], [ %57, %56 ]
  %47 = add nsw i32 %.143, %3
  %48 = sext i32 %47 to i64
  %49 = getelementptr inbounds double, ptr %2, i64 %48
  %50 = load double, ptr %49, align 8
  %51 = add nsw i32 %.143, %6
...
4:                                                ; preds = %.lr.ph2, %61
  %.0 = phi i32 [ 0, %.lr.ph2 ], [ %62, %61 ]
  %5 = sext i32 %.0 to i64
  %6 = getelementptr inbounds ptr, ptr %0, i64 %5
  %7 = load ptr, ptr %6, align 8
  %8 = add nsw i32 %.0, 1
  %9 = sub nsw i32 2000, %.0
  %10 = call i32 @idamax(i32 noundef %9, ptr noundef %7, i32 noundef %.0, i32 noundef 1)
  %11 = add nsw i32 %10, %.0
...
32:                                               ; preds = %.lr.ph2, %52
  %.042 = phi i32 [ 0, %.lr.ph2 ], [ %53, %52 ]
  %33 = add nsw i32 %.042, 1
...
16:                                               ; preds = %.loopexit, %11
  %.135 = phi i8 [ 0, %.loopexit ], [ 1, %11 ]
  br label %17

17:                                               ; preds = %16, %2
  %.034 = phi i8 [ %.135, %16 ], [ 0, %2 ]
