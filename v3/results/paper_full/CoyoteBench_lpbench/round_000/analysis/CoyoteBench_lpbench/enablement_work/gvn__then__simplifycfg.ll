...
68:                                               ; preds = %18, %51, %27, %15
  %69 = phi i32 [ -1, %15 ], [ 0, %18 ], [ %28, %27 ], [ %52, %51 ]
  ret i32 %69
}
...
22:                                               ; preds = %8
  %23 = icmp ne i32 %4, 1
  %24 = icmp ne i32 %7, 1
  %or.cond1 = or i1 %23, %24
  br i1 %or.cond1, label %25, label %56
...
12:                                               ; preds = %66, %2
  %13 = phi ptr [ %68, %66 ], [ %0, %2 ]
  %14 = phi i32 [ %.pre-phi, %66 ], [ 0, %2 ]
...
65:                                               ; preds = %39
  %.pre1 = add nsw i32 %41, 1
  br label %66

66:                                               ; preds = %65, %16
  %.pre-phi = phi i32 [ %.pre1, %65 ], [ %20, %16 ]
  %67 = phi i32 [ %41, %65 ], [ %14, %16 ]
  %68 = phi ptr [ %44, %65 ], [ %13, %16 ]
  store i32 %.pre-phi, ptr %6, align 4
  br label %12, !llvm.loop !20

69:                                               ; preds = %12
  %70 = getelementptr inbounds i32, ptr %1, i64 1999
  store i32 1999, ptr %70, align 4
  ret void
}
