...
51:                                               ; preds = %64, %46
  ...
  %53 = phi double [ %66, %64 ], [ %50, %46 ]
  %54 = phi i32 [ %67, %64 ], [ 1, %46 ]
...
64:                                               ; preds = %56, %63
  %65 = phi i32 [ %52, %56 ], [ %54, %63 ]
  %66 = phi double [ %53, %56 ], [ %61, %63 ]
  %67 = add nsw i32 %54, 1
  store i32 %67, ptr %11, align 4
  br label %51, !llvm.loop !14

68:                                               ; preds = %18, %51, %27, %15
  %69 = phi i32 [ 0, %18 ], [ %52, %51 ], [ %28, %27 ], [ -1, %15 ]
  ret i32 %69
}
...
define dso_local void @daxpy(i32 noundef %0, double noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %4, ptr noundef %5, i32 noundef %6, i32 noundef %7) #0 {
  ...
  br i1 %or.cond, label %22, label %71

22:                                               ; preds = %8
  %23 = icmp ne i32 %4, 1
  %24 = icmp ne i32 %7, 1
  %or.cond3 = select i1 %23, i1 true, i1 %24
  br i1 %or.cond3, label %25, label %56
...
38:                                               ; preds = %43, %36
  %39 = phi i32 [ %54, %43 ], [ %37, %36 ]
  %40 = phi i32 [ %53, %43 ], [ %31, %36 ]
  %41 = phi i32 [ %55, %43 ], [ 0, %36 ]
...
39:                                               ; preds = %60, %34
  %40 = phi i32 [ %61, %60 ], [ %14, %34 ]
  %41 = phi i32 [ %62, %60 ], [ %14, %34 ]
  %42 = phi i32 [ %63, %60 ], [ %23, %34 ]
  %43 = phi i32 [ %64, %60 ], [ %20, %34 ]
  %44 = phi ptr [ %0, %60 ], [ %13, %34 ]
  %45 = icmp slt i32 %43, 2000
  br i1 %45, label %46, label %._crit_edge1

._crit_edge1:                                     ; preds = %39
  %.pre2 = add nsw i32 %41, 1
  br label %65
...
54:                                               ; preds = %46
  ...
  %58 = getelementptr inbounds double, ptr %49, i64 %25
  store double %57, ptr %58, align 8
  %59 = getelementptr inbounds double, ptr %49, i64 %17
  store double %52, ptr %59, align 8
  br label %60

60:                                               ; preds = %54, %46
  %61 = phi i32 [ %14, %54 ], [ %40, %46 ]
  %62 = phi i32 [ %14, %54 ], [ %41, %46 ]
  %63 = phi i32 [ %23, %54 ], [ %41, %46 ]
  call void @daxpy(i32 noundef %38, double noundef %52, ptr noundef %19, i32 noundef %20, i32 noundef 1, ptr noundef %49, i32 noundef %20, i32 noundef 1)
  %64 = add nsw i32 %43, 1
  store i32 %64, ptr %7, align 4
  br label %39, !llvm.loop !19

65:                                               ; preds = %._crit_edge1, %16
  %.pre-phi = phi i32 [ %.pre2, %._crit_edge1 ], [ %20, %16 ]
  %66 = phi i32 [ %14, %16 ], [ %41, %._crit_edge1 ]
  %67 = phi ptr [ %13, %16 ], [ %44, %._crit_edge1 ]
  store i32 %.pre-phi, ptr %6, align 4
  br label %12, !llvm.loop !20

68:                                               ; preds = %12
  %69 = getelementptr inbounds i32, ptr %1, i64 1999
...
37:                                               ; preds = %29
  ...
  %40 = call ptr @malloc(i64 noundef 8000) #6
  store ptr %40, ptr %11, align 8
  store double f0x41F3E5E475555555, ptr %12, align 8
  call void @matgen(ptr noundef %28, ptr noundef %38)
  call void @dgefa(ptr noundef %28, ptr noundef %40)
  call void @dgesl(ptr noundef %28, ptr noundef %40, ptr noundef %38)
...
52:                                               ; preds = %49
  ...
  %55 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %53, ptr noundef @.str.1, double noundef %54) #5
  br label %60

56:                                               ; preds = %49
  %57 = call ptr @__acrt_iob_func(i32 noundef 1)
  %58 = load double, ptr %13, align 8
  %59 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %57, ptr noundef @.str.2, double noundef %58) #5
  br label %60
