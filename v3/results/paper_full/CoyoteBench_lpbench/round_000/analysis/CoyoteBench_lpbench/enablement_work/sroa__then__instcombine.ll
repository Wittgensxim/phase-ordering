...
3:                                                ; preds = %18, %2
  ...
  %4 = icmp samesign ult i32 %.019, 2000
...
21:                                               ; preds = %26, %20
  ...
  %22 = icmp samesign ult i32 %.120, 2000
  br i1 %22, label %23, label %28

23:                                               ; preds = %21
  %24 = zext nneg i32 %.120 to i64
  %25 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %24
  store double 0.000000e+00, ptr %25, align 8
  br label %26

26:                                               ; preds = %23
  %27 = add nuw nsw i32 %.120, 1
...
17:                                               ; preds = %28, %11
  %.033 = phi double [ %15, %11 ], [ %.134, %28 ]
  %.031 = phi i32 [ 1, %11 ], [ %30, %28 ]
  %.030 = phi i32 [ %16, %11 ], [ %29, %28 ]
  %.2 = phi i32 [ 0, %11 ], [ %.3, %28 ]
  %18 = icmp slt i32 %.031, %0
  br i1 %18, label %19, label %31

19:                                               ; preds = %17
  %20 = add nsw i32 %.030, %2
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [8 x i8], ptr %1, i64 %21
  %23 = load double, ptr %22, align 8
  %24 = call double @llvm.fabs.f64(double %23)
  %25 = fcmp ogt double %24, %.033
...
27:                                               ; preds = %26, %19
  %.134 = phi double [ %24, %26 ], [ %.033, %19 ]
  %.3 = phi i32 [ %.031, %26 ], [ %.2, %19 ]
  br label %28
...
37:                                               ; preds = %48, %32
  %.235 = phi double [ %36, %32 ], [ %.336, %48 ]
  %.132 = phi i32 [ 1, %32 ], [ %49, %48 ]
  %.5 = phi i32 [ 0, %32 ], [ %.6, %48 ]
  %38 = icmp slt i32 %.132, %0
  br i1 %38, label %39, label %50

39:                                               ; preds = %37
  %40 = add nsw i32 %.132, %2
...
47:                                               ; preds = %46, %39
  %.336 = phi double [ %44, %46 ], [ %.235, %39 ]
  %.6 = phi i32 [ %.132, %46 ], [ %.5, %39 ]
  br label %48

48:                                               ; preds = %47
  %49 = add nuw nsw i32 %.132, 1
...
13:                                               ; preds = %12
  %.not37 = icmp eq i32 %7, 1
  br i1 %.not37, label %42, label %14
...
25:                                               ; preds = %37, %24
  %.035 = phi i32 [ 0, %24 ], [ %40, %37 ]
  %.134 = phi i32 [ %.033, %24 ], [ %39, %37 ]
  %.1 = phi i32 [ %.0, %24 ], [ %38, %37 ]
  %26 = icmp slt i32 %.035, %0
  br i1 %26, label %27, label %41

27:                                               ; preds = %25
  %28 = add nsw i32 %.134, %3
...
43:                                               ; preds = %55, %42
  %.136 = phi i32 [ 0, %42 ], [ %56, %55 ]
  %44 = icmp slt i32 %.136, %0
  br i1 %44, label %45, label %57

45:                                               ; preds = %43
  %46 = add nsw i32 %.136, %3
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds [8 x i8], ptr %2, i64 %47
  %49 = load double, ptr %48, align 8
  %50 = add nsw i32 %.136, %6
...
3:                                                ; preds = %60, %2
  %.0 = phi i32 [ 0, %2 ], [ %61, %60 ]
  %4 = icmp samesign ult i32 %.0, 1999
...
31:                                               ; preds = %20, %19
  ...
  %33 = getelementptr inbounds nuw [8 x i8], ptr %8, i64 %32
  %34 = load double, ptr %33, align 8
  %35 = fdiv double -1.000000e+00, %34
  %36 = sub nsw i32 1999, %.0
  call void @dscal(i32 noundef %36, double noundef %35, ptr noundef %8, i32 noundef %9, i32 noundef 1)
  br label %37

37:                                               ; preds = %56, %31
  %.053 = phi i32 [ %9, %31 ], [ %57, %56 ]
  %38 = icmp samesign ult i32 %.053, 2000
  br i1 %38, label %39, label %58

39:                                               ; preds = %37
  %40 = zext nneg i32 %.053 to i64
...
4:                                                ; preds = %27, %3
  %.0 = phi i32 [ 0, %3 ], [ %28, %27 ]
  %5 = icmp samesign ult i32 %.0, 1999
...
30:                                               ; preds = %51, %29
  %.037 = phi i32 [ 0, %29 ], [ %52, %51 ]
  %31 = icmp samesign ult i32 %.037, 2000
  br i1 %31, label %32, label %53

32:                                               ; preds = %30
  %33 = sub nuw nsw i32 1999, %.037
...
16:                                               ; preds = %15, %2
  %.026 = phi i1 [ %6, %15 ], [ true, %2 ]
  %17 = call dereferenceable_or_null(16000) ptr @malloc(i64 noundef 16000) #6
  br label %18

18:                                               ; preds = %24, %16
  %.1 = phi i32 [ 0, %16 ], [ %25, %24 ]
  %19 = icmp samesign ult i32 %.1, 2000
