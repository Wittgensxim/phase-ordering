...
17:                                               ; preds = %3, %19
  %.120 = phi i32 [ %22, %19 ], [ 0, %3 ]
  %18 = icmp slt i32 %.120, 2000
  br i1 %18, label %19, label %23

19:                                               ; preds = %17
  %20 = sext i32 %.120 to i64
  %21 = getelementptr inbounds double, ptr %1, i64 %20
  store double 0.000000e+00, ptr %21, align 8
  %22 = add nsw i32 %.120, 1
...
16:                                               ; preds = %18, %10
  %.033 = phi double [ %14, %10 ], [ %.134, %18 ]
  %.031 = phi i32 [ 1, %10 ], [ %26, %18 ]
  %.030 = phi i32 [ %15, %10 ], [ %25, %18 ]
  %.2 = phi i32 [ 0, %10 ], [ %.3, %18 ]
  %17 = icmp slt i32 %.031, %0
  br i1 %17, label %18, label %42

18:                                               ; preds = %16
  %19 = add nsw i32 %.030, %2
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds double, ptr %1, i64 %20
  %22 = load double, ptr %21, align 8
  %23 = call double @llvm.fabs.f64(double %22)
  %24 = fcmp ogt double %23, %.033
  %.134 = select i1 %24, double %23, double %.033
  %.3 = select i1 %24, i32 %.031, i32 %.2
  %25 = add nsw i32 %.030, %3
  %26 = add nsw i32 %.031, 1
...
32:                                               ; preds = %34, %27
  %.235 = phi double [ %31, %27 ], [ %.336, %34 ]
  %.132 = phi i32 [ 1, %27 ], [ %41, %34 ]
  %.5 = phi i32 [ 0, %27 ], [ %.6, %34 ]
  %33 = icmp slt i32 %.132, %0
  br i1 %33, label %34, label %42

34:                                               ; preds = %32
  %35 = add nsw i32 %.132, %2
  %36 = sext i32 %35 to i64
  %37 = getelementptr inbounds double, ptr %1, i64 %36
  %38 = load double, ptr %37, align 8
  %39 = call double @llvm.fabs.f64(double %38)
  %40 = fcmp ogt double %39, %.235
  %.336 = select i1 %40, double %39, double %.235
  %.6 = select i1 %40, i32 %.132, i32 %.5
  %41 = add nsw i32 %.132, 1
...
11:                                               ; preds = %8
  ...
  br i1 %or.cond37, label %14, label %36

14:                                               ; preds = %11
  %15 = icmp slt i32 %4, 0
  %16 = sub nsw i32 1, %0
  %17 = mul nsw i32 %16, %4
  %.033 = select i1 %15, i32 %17, i32 0
  %18 = icmp slt i32 %7, 0
  %19 = sub nsw i32 1, %0
  %20 = mul nsw i32 %19, %7
...
21:                                               ; preds = %23, %14
  %.035 = phi i32 [ 0, %14 ], [ %35, %23 ]
  %.134 = phi i32 [ %.033, %14 ], [ %33, %23 ]
  %.1 = phi i32 [ %.0, %14 ], [ %34, %23 ]
  %22 = icmp slt i32 %.035, %0
  br i1 %22, label %23, label %49

23:                                               ; preds = %21
  %24 = add nsw i32 %.134, %3
  ...
  %33 = add nsw i32 %.134, %4
  %34 = add nsw i32 %.1, %7
  %35 = add nsw i32 %.035, 1
  br label %21, !llvm.loop !17

36:                                               ; preds = %11, %38
  %.136 = phi i32 [ %48, %38 ], [ 0, %11 ]
  %37 = icmp slt i32 %.136, %0
  br i1 %37, label %38, label %49

38:                                               ; preds = %36
  %39 = add nsw i32 %.136, %3
  %40 = sext i32 %39 to i64
  %41 = getelementptr inbounds double, ptr %2, i64 %40
  %42 = load double, ptr %41, align 8
  %43 = add nsw i32 %.136, %6
...
38:                                               ; preds = %56, %32
  %.053 = phi i32 [ %9, %32 ], [ %58, %56 ]
  %39 = icmp slt i32 %.053, 2000
...
29:                                               ; preds = %4, %31
  %.037 = phi i32 [ %51, %31 ], [ 0, %4 ]
  %30 = icmp slt i32 %.037, 2000
...
13:                                               ; preds = %4, %6, %2
  %.026 = phi i8 [ 0, %2 ], [ 0, %4 ], [ 1, %6 ]
  %14 = call ptr @malloc(i64 noundef 16000) #6
  br label %15

15:                                               ; preds = %17, %13
  %.1 = phi i32 [ 0, %13 ], [ %21, %17 ]
  %16 = icmp slt i32 %.1, 2000
