...
37:                                               ; preds = %._crit_edge6, %27
  store i32 0, ptr %6, align 4
  br i1 true, label %.lr.ph11, label %63
...
38:                                               ; preds = %.lr.ph11, %59
  store i32 0, ptr %5, align 4
  br i1 true, label %.lr.ph8, label %58
...
54:                                               ; preds = %39
  ...
  %57 = icmp slt i32 %55, 1999
  br i1 %57, label %39, label %._crit_edge9, !llvm.loop !11

._crit_edge9:                                     ; preds = %54
  br label %58

58:                                               ; preds = %._crit_edge9, %38
  br label %59
...
59:                                               ; preds = %58
  ...
  %62 = icmp slt i32 %60, 1999
  br i1 %62, label %38, label %._crit_edge12, !llvm.loop !12

._crit_edge12:                                    ; preds = %59
  br label %63

63:                                               ; preds = %._crit_edge12, %37
  ret void
}
...
22:                                               ; preds = %20
  ...
  br i1 %32, label %.lr.ph2, label %56
...
51:                                               ; preds = %47
  ...
  br i1 %55, label %33, label %._crit_edge3, !llvm.loop !13

._crit_edge3:                                     ; preds = %51
  br label %56

56:                                               ; preds = %._crit_edge3, %22
  br label %87
...
81:                                               ; preds = %80
  ...
  br i1 %85, label %66, label %._crit_edge, !llvm.loop !14

._crit_edge:                                      ; preds = %81
  br label %86

86:                                               ; preds = %._crit_edge, %57
  br label %87
...
45:                                               ; preds = %40, %37
  ...
  br i1 %47, label %.lr.ph2, label %76
...
71:                                               ; preds = %48
  ...
  br i1 %75, label %48, label %._crit_edge3, !llvm.loop !17

._crit_edge3:                                     ; preds = %71
  br label %76

76:                                               ; preds = %._crit_edge3, %45
  br label %104
...
77:                                               ; preds = %27
  ...
  br i1 %79, label %.lr.ph, label %102
...
97:                                               ; preds = %80
  ...
  br i1 %101, label %80, label %._crit_edge, !llvm.loop !18
...
define dso_local void @dgefa(ptr noundef %0, ptr noundef %1) #0 {
  ...
  store ptr %1, ptr %4, align 8
  store i32 0, ptr %6, align 4
  br i1 true, label %.lr.ph2, label %104
...
63:                                               ; preds = %.lr.ph, %94
  ...
  %.not4 = icmp eq i32 %69, %73
  br i1 %.not4, label %88, label %74
...
100:                                              ; preds = %99
  ...
  %103 = icmp slt i32 %101, 1998
  br i1 %103, label %12, label %._crit_edge3, !llvm.loop !20

._crit_edge3:                                     ; preds = %100
  br label %104

104:                                              ; preds = %._crit_edge3, %2
...
52:                                               ; preds = %._crit_edge, %3
  store i32 0, ptr %9, align 4
  br i1 true, label %.lr.ph2, label %85
...
81:                                               ; preds = %53
  ...
  %84 = icmp slt i32 %82, 1999
  br i1 %84, label %53, label %._crit_edge3, !llvm.loop !22

._crit_edge3:                                     ; preds = %81
  br label %85

85:                                               ; preds = %._crit_edge3, %52
  ret void
}
...
29:                                               ; preds = %28, %2
  ...
  store i32 0, ptr %5, align 4
  br i1 true, label %.lr.ph1, label %41
...
37:                                               ; preds = %31
  ...
  %40 = icmp slt i32 %38, 1999
  br i1 %40, label %31, label %._crit_edge, !llvm.loop !24
...
41:                                               ; preds = %._crit_edge, %29
  ...
  store i32 0, ptr %5, align 4
  br i1 true, label %.lr.ph3, label %60
...
56:                                               ; preds = %50
  ...
  %59 = icmp slt i32 %57, 1999
  br i1 %59, label %50, label %._crit_edge4, !llvm.loop !25

._crit_edge4:                                     ; preds = %56
  br label %60

60:                                               ; preds = %._crit_edge4, %41
  %61 = load ptr, ptr %7, align 8
  call void @free(ptr noundef %61) #5
  %62 = load i8, ptr %6, align 1
  %.not5 = icmp eq i8 %62, 0
  br i1 %.not5, label %67, label %63
