...
.peel.next2:                                      ; preds = %.peel.next
  br label %.peel.newph

.peel.newph:                                      ; preds = %.peel.next2
  br label %22

22:                                               ; preds = %25, %.peel.newph
  %23 = phi i32 [ %32, %25 ], [ %21, %.peel.newph ]
  %24 = icmp samesign ult i32 %23, 2000
  br i1 %24, label %25, label %.loopexit

25:                                               ; preds = %22
  %26 = call double @random_double()
...
.loopexit:                                        ; preds = %22
  %.lcssa.ph = phi ptr [ %0, %22 ]
  br label %33

33:                                               ; preds = %.loopexit, %12
  %.lcssa = phi ptr [ %8, %12 ], [ %.lcssa.ph, %.loopexit ]
  %34 = add nsw i32 %9, 1
...
56:                                               ; preds = %70, %55
  %57 = phi i32 [ 0, %55 ], [ %80, %70 ]
  %58 = icmp samesign ult i32 %57, 2000
  br i1 %58, label %59, label %81

59:                                               ; preds = %56
  %60 = sext i32 %53 to i64
  %61 = getelementptr inbounds ptr, ptr %.lcssa1, i64 %60
  %62 = load ptr, ptr %61, align 8
  %63 = sext i32 %57 to i64
  %64 = getelementptr inbounds double, ptr %62, i64 %63
  %65 = load double, ptr %64, align 8
  %66 = getelementptr inbounds double, ptr %1, i64 %63
...
70:                                               ; preds = %59
  ...
  %72 = getelementptr inbounds ptr, ptr %.lcssa1, i64 %71
  %73 = load ptr, ptr %72, align 8
  %74 = sext i32 %69 to i64
  %75 = getelementptr inbounds double, ptr %73, i64 %74
  %76 = load double, ptr %75, align 8
  %77 = getelementptr inbounds double, ptr %1, i64 %74
...
12:                                               ; preds = %86, %2
  %13 = phi ptr [ %88, %86 ], [ %0, %2 ]
  %14 = phi i32 [ %.pre-phi, %86 ], [ 0, %2 ]
...
49:                                               ; preds = %41
  ...
  %53 = getelementptr inbounds double, ptr %44, i64 %25
  store double %52, ptr %53, align 8
  %54 = getelementptr inbounds double, ptr %44, i64 %17
  store double %47, ptr %54, align 8
  br label %55

55:                                               ; preds = %49, %41
  %56 = phi i32 [ %14, %49 ], [ %14, %41 ]
  %57 = phi i32 [ %14, %49 ], [ %14, %41 ]
  %58 = phi i32 [ %23, %49 ], [ %14, %41 ]
  call void @daxpy(i32 noundef %38, double noundef %47, ptr noundef %19, i32 noundef %20, i32 noundef 1, ptr noundef %44, i32 noundef %20, i32 noundef 1)
  %59 = add nsw i32 %20, 1
...
.peel.next3:                                      ; preds = %.peel.next
  br label %.peel.newph

.peel.newph:                                      ; preds = %.peel.next3
  br label %60

60:                                               ; preds = %80, %.peel.newph
  %61 = phi i32 [ %81, %80 ], [ %56, %.peel.newph ]
  %62 = phi i32 [ %82, %80 ], [ %57, %.peel.newph ]
  %63 = phi i32 [ %83, %80 ], [ %58, %.peel.newph ]
  %64 = phi i32 [ %84, %80 ], [ %59, %.peel.newph ]
...
74:                                               ; preds = %66
  ...
  %78 = getelementptr inbounds double, ptr %69, i64 %25
  store double %77, ptr %78, align 8
  %79 = getelementptr inbounds double, ptr %69, i64 %17
  store double %72, ptr %79, align 8
  br label %80

80:                                               ; preds = %74, %66
  %81 = phi i32 [ %14, %74 ], [ %61, %66 ]
  %82 = phi i32 [ %14, %74 ], [ %62, %66 ]
  %83 = phi i32 [ %23, %74 ], [ %62, %66 ]
  call void @daxpy(i32 noundef %38, double noundef %72, ptr noundef %19, i32 noundef %20, i32 noundef 1, ptr noundef %69, i32 noundef %20, i32 noundef 1)
  %84 = add nsw i32 %64, 1
  store i32 %84, ptr %7, align 4
  br label %60, !llvm.loop !20

.loopexit:                                        ; preds = %60
  %.lcssa2.ph = phi i32 [ %62, %60 ]
  %.lcssa.ph = phi ptr [ %0, %60 ]
  br label %85

85:                                               ; preds = %.loopexit, %39
  %.lcssa2 = phi i32 [ %14, %39 ], [ %.lcssa2.ph, %.loopexit ]
  %.lcssa = phi ptr [ %13, %39 ], [ %.lcssa.ph, %.loopexit ]
  %.pre1 = add nsw i32 %.lcssa2, 1
  br label %86

86:                                               ; preds = %85, %16
  %.pre-phi = phi i32 [ %.pre1, %85 ], [ %20, %16 ]
  %87 = phi i32 [ %.lcssa2, %85 ], [ %14, %16 ]
  %88 = phi ptr [ %.lcssa, %85 ], [ %13, %16 ]
  store i32 %.pre-phi, ptr %6, align 4
  br label %12, !llvm.loop !21

89:                                               ; preds = %12
  %90 = getelementptr inbounds i32, ptr %1, i64 1999
  store i32 1999, ptr %90, align 4
  ret void
}
