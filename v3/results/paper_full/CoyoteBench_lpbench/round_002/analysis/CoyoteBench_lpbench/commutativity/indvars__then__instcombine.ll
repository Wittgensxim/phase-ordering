...
3:                                                ; preds = %10, %2
  ...
  %exitcond8.not = icmp eq i64 %indvars.iv5, 2000
  br i1 %exitcond8.not, label %.preheader2, label %.preheader3
...
11:                                               ; preds = %.preheader2, %12
  ...
  %exitcond12.not = icmp eq i64 %indvars.iv9, 2000
  br i1 %exitcond12.not, label %.preheader1, label %12
...
14:                                               ; preds = %.preheader1, %24
  ...
  %exitcond20.not = icmp eq i64 %indvars.iv17, 2000
  br i1 %exitcond20.not, label %25, label %.preheader
...
15:                                               ; preds = %.preheader, %16
  ...
  %exitcond16.not = icmp eq i64 %indvars.iv13, 2000
  br i1 %exitcond16.not, label %24, label %16
...
18:                                               ; preds = %19, %9
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %19 ], [ %15, %9 ]
  %.04 = phi double [ %.15, %19 ], [ %13, %9 ]
  %.02 = phi i32 [ %25, %19 ], [ 1, %9 ]
  %.2 = phi i32 [ %.3, %19 ], [ 0, %9 ]
  %exitcond6.not = icmp eq i32 %.02, %0
  br i1 %exitcond6.not, label %.loopexit, label %19

19:                                               ; preds = %18
  %20 = getelementptr [8 x i8], ptr %1, i64 %indvars.iv3
  ...
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, %16
  %25 = add nuw i32 %.02, 1
...
32:                                               ; preds = %33, %26
  %indvars.iv = phi i64 [ %indvars.iv.next, %33 ], [ 1, %26 ]
  %.26 = phi double [ %.37, %33 ], [ %30, %26 ]
  %.5 = phi i32 [ %.6, %33 ], [ 0, %26 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit1, label %33
...
14:                                               ; preds = %16, %9
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %16 ], [ 0, %9 ]
  %15 = icmp slt i64 %indvars.iv3, %12
  br i1 %15, label %16, label %.loopexit

16:                                               ; preds = %14
  %17 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv3
...
21:                                               ; preds = %.preheader, %22
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit1, label %22

22:                                               ; preds = %21
  %23 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv
...
28:                                               ; preds = %29, %16
  ...
  %.03 = phi i32 [ %37, %29 ], [ 0, %16 ]
  %exitcond10.not = icmp eq i32 %.03, %0
  br i1 %exitcond10.not, label %.loopexit, label %29

29:                                               ; preds = %28
  %30 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv3
  %31 = getelementptr [8 x i8], ptr %30, i64 %24
  %32 = load double, ptr %31, align 8
  %33 = getelementptr [8 x i8], ptr %5, i64 %indvars.iv5
...
38:                                               ; preds = %.preheader, %39
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit1, label %39

39:                                               ; preds = %38
  %40 = getelementptr [8 x i8], ptr %2, i64 %indvars.iv
  %41 = getelementptr [8 x i8], ptr %40, i64 %14
  %42 = load double, ptr %41, align 8
  %43 = getelementptr [8 x i8], ptr %5, i64 %indvars.iv
  %44 = getelementptr [8 x i8], ptr %43, i64 %15
...
3:                                                ; preds = %39, %2
  ...
  br i1 %exitcond7.not, label %40, label %4
...
28:                                               ; preds = %37, %22
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %37 ], [ %indvars.iv, %22 ]
...
40:                                               ; preds = %3
  %41 = getelementptr inbounds nuw i8, ptr %1, i64 7996
...
20:                                               ; preds = %.preheader, %21
  ...
  br i1 %exitcond6.not, label %33, label %21

21:                                               ; preds = %20
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %22 = sub nsw i64 1999, %indvars.iv2
  %23 = getelementptr inbounds [8 x i8], ptr %0, i64 %22
  %24 = load ptr, ptr %23, align 8
  %25 = getelementptr inbounds [8 x i8], ptr %24, i64 %22
  %26 = load double, ptr %25, align 8
  %27 = getelementptr inbounds [8 x i8], ptr %2, i64 %22
...
11:                                               ; preds = %.loopexit, %2
  %.0 = phi i1 [ true, %2 ], [ %exitcond.not, %.loopexit ]
...
13:                                               ; preds = %14, %11
  ...
  br i1 %exitcond2.not, label %17, label %14
...
21:                                               ; preds = %22, %17
  ...
  br i1 %exitcond6.not, label %25, label %22
