...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %10
  %.2.lcssa = phi i32 [ %.3, %..loopexit_crit_edge ], [ 0, %10 ]
  br label %42
...
.loopexit1:                                       ; preds = %..loopexit1_crit_edge, %27
  %.5.lcssa = phi i32 [ %.6, %..loopexit1_crit_edge ], [ 0, %27 ]
  br label %42
...
.preheader:                                       ; preds = %7
  br i1 true, label %.lr.ph, label %.preheader..loopexit1_crit_edge

.preheader..loopexit1_crit_edge:                  ; preds = %.preheader
  br label %.loopexit1
...
.loopexit1:                                       ; preds = %.preheader..loopexit1_crit_edge, %..loopexit1_crit_edge
  br label %28
...
14:                                               ; preds = %11
  ...
  br i1 true, label %.lr.ph6, label %..loopexit_crit_edge7

..loopexit_crit_edge7:                            ; preds = %14
  br label %.loopexit
...
.loopexit:                                        ; preds = %..loopexit_crit_edge7, %..loopexit_crit_edge
  br label %46
...
21:                                               ; preds = %._crit_edge, %18
  %22 = phi double [ %.pre, %._crit_edge ], [ %14, %18 ]
