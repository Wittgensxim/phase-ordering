...
31:                                               ; preds = %.preheader1, %57
  %.1 = phi i32 [ %58, %57 ], [ 0, %.preheader1 ]
  %32 = icmp slt i32 %.1, 2000
  br i1 %32, label %.preheader, label %59

.preheader:                                       ; preds = %31
  br label %33

33:                                               ; preds = %46, %.preheader
  %.2 = phi i32 [ 0, %.preheader ], [ %56, %46 ]
  %34 = icmp samesign ult i32 %.2, 2000
...
35:                                               ; preds = %33
  ...
  %42 = getelementptr inbounds double, ptr %1, i64 %39
...
32:                                               ; preds = %34, %27
  ...
  br i1 %33, label %34, label %.loopexit6
...
42:                                               ; preds = %3
  %43 = getelementptr inbounds nuw i32, ptr %1, i64 1999
