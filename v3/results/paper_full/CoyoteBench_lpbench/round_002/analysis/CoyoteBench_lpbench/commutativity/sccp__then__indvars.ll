...
16:                                               ; preds = %15
  %17 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv17
  %18 = load ptr, ptr %17, align 8
  %19 = getelementptr inbounds double, ptr %18, i64 %indvars.iv13
  %20 = load double, ptr %19, align 8
  %21 = getelementptr inbounds double, ptr %1, i64 %indvars.iv13
...
19:                                               ; preds = %20, %10
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %20 ], [ %16, %10 ]
  %.04 = phi double [ %14, %10 ], [ %.15, %20 ]
  %.02 = phi i32 [ 1, %10 ], [ %26, %20 ]
  %.2 = phi i32 [ 0, %10 ], [ %.3, %20 ]
  %exitcond11 = icmp ne i32 %.02, %0
  br i1 %exitcond11, label %20, label %.loopexit

20:                                               ; preds = %19
  %21 = add nsw i64 %indvars.iv8, %18
  ...
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, %17
  %26 = add nuw i32 %.02, 1
...
33:                                               ; preds = %34, %27
  ...
  br i1 %exitcond, label %34, label %.loopexit6
...
41:                                               ; preds = %.loopexit6, %.loopexit, %6, %4
  %.0 = phi i32 [ -1, %4 ], [ 0, %6 ], [ %.2.lcssa, %.loopexit ], [ %.5.lcssa, %.loopexit6 ]
  ret i32 %.0
}
...
15:                                               ; preds = %17, %10
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %17 ], [ 0, %10 ]
  %16 = icmp slt i64 %indvars.iv5, %13
  br i1 %16, label %17, label %.loopexit

17:                                               ; preds = %15
  %18 = add nsw i64 %indvars.iv5, %14
  %19 = getelementptr inbounds double, ptr %2, i64 %18
  %20 = load double, ptr %19, align 8
  %21 = fmul double %20, %1
  store double %21, ptr %19, align 8
  %indvars.iv.next6 = add nsw i64 %indvars.iv5, %12
  br label %15, !llvm.loop !15

22:                                               ; preds = %.preheader, %23
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %23 ]
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %23, label %.loopexit3
...
3:                                                ; preds = %40, %2
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %40 ], [ 0, %2 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %40 ], [ 1, %2 ]
  %indvars8 = trunc i64 %indvars.iv6 to i32
  %exitcond9 = icmp ne i64 %indvars.iv6, 1999
  br i1 %exitcond9, label %4, label %41

4:                                                ; preds = %3
  %5 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv6
  ...
  %11 = add nsw i32 %9, %10
  %12 = getelementptr inbounds i32, ptr %1, i64 %indvars.iv6
...
17:                                               ; preds = %4
  ...
  %19 = icmp ne i64 %18, %indvars.iv6
  br i1 %19, label %20, label %23

20:                                               ; preds = %17
  %21 = getelementptr inbounds double, ptr %6, i64 %indvars.iv6
  %22 = load double, ptr %21, align 8
...
35:                                               ; preds = %30
  %36 = getelementptr inbounds double, ptr %32, i64 %indvars.iv6
  %37 = load double, ptr %36, align 8
...
38:                                               ; preds = %35, %30
  %39 = trunc nuw nsw i64 %indvars.iv.next7 to i32
