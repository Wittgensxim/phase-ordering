...
.preheader:                                       ; preds = %.preheader1, %52
  %.17 = phi i32 [ 0, %.preheader1 ], [ %53, %52 ]
  br label %29

29:                                               ; preds = %.preheader, %40
  %.26 = phi i32 [ 0, %.preheader ], [ %50, %40 ]
  ...
  %36 = getelementptr inbounds double, ptr %1, i64 %33
...
40:                                               ; preds = %29
  ...
  %50 = add nuw nsw i32 %.26, 2
  %51 = icmp samesign ult i32 %50, 2000
  br i1 %51, label %29, label %52, !llvm.loop !11

52:                                               ; preds = %40
  %53 = add nsw i32 %.17, 1
  %54 = icmp slt i32 %53, 2000
  br i1 %54, label %.preheader, label %55, !llvm.loop !12
