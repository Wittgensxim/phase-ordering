...
13:                                               ; preds = %14, %11
  ...
  %exitcond3 = icmp ne i64 %indvars.iv, 2000
  br i1 %exitcond3, label %14, label %17
...
21:                                               ; preds = %22, %17
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %22 ], [ 0, %17 ]
  %exitcond7 = icmp ne i64 %indvars.iv4, 2000
  br i1 %exitcond7, label %22, label %25

22:                                               ; preds = %21
  %23 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %indvars.iv4
  %24 = load ptr, ptr %23, align 8
