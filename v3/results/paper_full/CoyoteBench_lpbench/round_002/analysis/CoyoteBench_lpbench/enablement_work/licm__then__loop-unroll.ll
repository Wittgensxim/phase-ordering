...
31:                                               ; preds = %.preheader1, %55
  %.1 = phi i32 [ %56, %55 ], [ 0, %.preheader1 ]
  %32 = icmp slt i32 %.1, 2000
  br i1 %32, label %.preheader, label %57
...
35:                                               ; preds = %46, %.preheader
  %.2 = phi i32 [ 0, %.preheader ], [ %54, %46 ]
  %36 = icmp samesign ult i32 %.2, 2000
...
46:                                               ; preds = %37
  ...
  %51 = getelementptr inbounds double, ptr %1, i64 %48
