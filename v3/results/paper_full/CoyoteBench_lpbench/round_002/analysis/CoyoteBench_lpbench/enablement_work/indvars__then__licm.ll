...
.preheader:                                       ; preds = %14
  %15 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv17
  br label %16
...
23:                                               ; preds = %20, %17
  ...
  %29 = trunc nuw nsw i64 %indvars.iv.next5 to i32
  br label %30

30:                                               ; preds = %39, %23
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %39 ], [ %indvars.iv, %23 ]
  %exitcond = icmp ne i64 %indvars.iv1, 2000
  br i1 %exitcond, label %31, label %.loopexit

31:                                               ; preds = %30
  %32 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv1
  %33 = load ptr, ptr %32, align 8
  %34 = getelementptr inbounds double, ptr %33, i64 %13
  %35 = load double, ptr %34, align 8
  br i1 %19, label %36, label %39

36:                                               ; preds = %31
  %37 = getelementptr inbounds double, ptr %33, i64 %indvars.iv4
...
39:                                               ; preds = %36, %31
  call void @daxpy(i32 noundef %27, double noundef %35, ptr noundef %6, i32 noundef %29, i32 noundef 1, ptr noundef %33, i32 noundef %29, i32 noundef 1)
