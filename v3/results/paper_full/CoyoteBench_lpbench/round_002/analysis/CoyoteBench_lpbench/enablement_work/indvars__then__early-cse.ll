...
18:                                               ; preds = %19, %10
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %19 ], [ %16, %10 ]
  %.04 = phi double [ %14, %10 ], [ %.15, %19 ]
  %.02 = phi i32 [ 1, %10 ], [ %25, %19 ]
  %.2 = phi i32 [ 0, %10 ], [ %.3, %19 ]
  %exitcond6 = icmp ne i32 %.02, %0
  br i1 %exitcond6, label %19, label %.loopexit

19:                                               ; preds = %18
  %20 = add nsw i64 %indvars.iv3, %11
...
31:                                               ; preds = %32, %26
  %indvars.iv = phi i64 [ %indvars.iv.next, %32 ], [ 1, %26 ]
  %.26 = phi double [ %30, %26 ], [ %.37, %32 ]
  %.5 = phi i32 [ 0, %26 ], [ %.6, %32 ]
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %32, label %.loopexit1
...
32:                                               ; preds = %31
  ...
  %.37 = select i1 %37, double %36, double %.26
  %38 = trunc nuw nsw i64 %indvars.iv to i32
  %.6 = select i1 %37, i32 %38, i32 %.5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
3:                                                ; preds = %36, %2
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %36 ], [ 0, %2 ]
...
37:                                               ; preds = %3
  %38 = getelementptr inbounds i32, ptr %1, i64 1999
