...
3:                                                ; preds = %.preheader3, %3
  ...
  %11 = icmp samesign ult i32 %.04, 1999
  br i1 %11, label %3, label %12, !llvm.loop !7

12:                                               ; preds = %3
  %13 = add nuw nsw i32 %.015, 1
  %14 = icmp samesign ult i32 %.015, 1999
...
15:                                               ; preds = %.preheader2, %15
  ...
  %19 = icmp samesign ult i32 %.126, 1999
...
20:                                               ; preds = %.preheader, %20
  ...
  %31 = icmp samesign ult i32 %.27, 1999
  br i1 %31, label %20, label %32, !llvm.loop !11

32:                                               ; preds = %20
  %33 = add nuw nsw i32 %.18, 1
  %34 = icmp samesign ult i32 %.18, 1999
...
15:                                               ; preds = %.lr.ph9, %15
  %.28 = phi i32 [ 0, %.lr.ph9 ], [ %.3, %15 ]
  %.017 = phi i32 [ %10, %.lr.ph9 ], [ %22, %15 ]
  %.026 = phi i32 [ 1, %.lr.ph9 ], [ %23, %15 ]
  %.045 = phi double [ %14, %.lr.ph9 ], [ %.15, %15 ]
  %16 = add nsw i32 %.017, %2
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds [8 x i8], ptr %1, i64 %17
  %19 = load double, ptr %18, align 8
  %20 = call double @llvm.fabs.f64(double %19)
  %21 = fcmp ogt double %20, %.045
  %.15 = select i1 %21, double %20, double %.045
  %.3 = select i1 %21, i32 %.026, i32 %.28
  %22 = add nsw i32 %.017, %3
  %23 = add nuw nsw i32 %.026, 1
  %24 = icmp slt i32 %23, %0
  br i1 %24, label %15, label %..loopexit_crit_edge, !llvm.loop !13

25:                                               ; preds = %8
  br i1 true, label %.lr.ph, label %.loopexit1
...
30:                                               ; preds = %.lr.ph, %30
  %.54 = phi i32 [ 0, %.lr.ph ], [ %.6, %30 ]
  %.133 = phi i32 [ 1, %.lr.ph ], [ %37, %30 ]
  %.262 = phi double [ %29, %.lr.ph ], [ %.37, %30 ]
  %31 = add nsw i32 %.133, %2
  %32 = sext i32 %31 to i64
  %33 = getelementptr inbounds [8 x i8], ptr %1, i64 %32
  %34 = load double, ptr %33, align 8
  %35 = call double @llvm.fabs.f64(double %34)
  %36 = fcmp ogt double %35, %.262
  %.37 = select i1 %36, double %35, double %.262
  %.6 = select i1 %36, i32 %.133, i32 %.54
  %37 = add nuw nsw i32 %.133, 1
  %38 = icmp slt i32 %37, %0
  br i1 %38, label %30, label %..loopexit1_crit_edge, !llvm.loop !14

..loopexit_crit_edge:                             ; preds = %15
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %9
  %.2.lcssa = phi i32 [ %.3, %..loopexit_crit_edge ], [ poison, %9 ]
  br label %39

..loopexit1_crit_edge:                            ; preds = %30
  br label %.loopexit1

.loopexit1:                                       ; preds = %..loopexit1_crit_edge, %25
  %.5.lcssa = phi i32 [ %.6, %..loopexit1_crit_edge ], [ poison, %25 ]
  br label %39
...
8:                                                ; preds = %7
  %9 = mul nsw i32 %0, %4
  %10 = icmp sgt i32 %9, 0
  br i1 %10, label %.lr.ph4, label %.loopexit

.lr.ph4:                                          ; preds = %8
  br label %11

11:                                               ; preds = %.lr.ph4, %11
  %.03 = phi i32 [ 0, %.lr.ph4 ], [ %17, %11 ]
  %12 = add nsw i32 %.03, %3
  ...
  br i1 %18, label %11, label %..loopexit_crit_edge, !llvm.loop !15

19:                                               ; preds = %.lr.ph, %19
  %.12 = phi i32 [ 0, %.lr.ph ], [ %25, %19 ]
  %20 = add nsw i32 %.12, %3
  ...
  br i1 %26, label %19, label %..loopexit1_crit_edge, !llvm.loop !16
...
14:                                               ; preds = %11
  br i1 true, label %.lr.ph6, label %.loopexit

.lr.ph6:                                          ; preds = %14
  %15 = icmp slt i32 %7, 0
  %16 = sub nsw i32 1, %0
  %17 = mul nsw i32 %16, %7
  %.0 = select i1 %15, i32 %17, i32 0
  %18 = icmp slt i32 %4, 0
  %19 = mul nsw i32 %16, %4
  %.01 = select i1 %18, i32 %19, i32 0
  br label %20
...
35:                                               ; preds = %32, %26
  ...
  %37 = icmp samesign ult i32 %.02, 1999
  br i1 %37, label %26, label %..loopexit_crit_edge, !llvm.loop !19
...
38:                                               ; preds = %.loopexit, %3
  %39 = icmp samesign ult i32 %.013, 1998
  br i1 %39, label %3, label %40, !llvm.loop !20
...
20:                                               ; preds = %.preheader, %20
  ...
  %33 = icmp samesign ult i32 %.02, 1999
...
5:                                                ; preds = %8
  ...
  %7 = icmp slt i32 %6, %0
  br i1 %7, label %8, label %.loopexit, !llvm.loop !23
...
13:                                               ; preds = %11, %13
  ...
  %18 = icmp samesign ult i32 %.122, 1999
...
23:                                               ; preds = %19, %23
  ...
  %28 = icmp samesign ult i32 %.23, 1999
