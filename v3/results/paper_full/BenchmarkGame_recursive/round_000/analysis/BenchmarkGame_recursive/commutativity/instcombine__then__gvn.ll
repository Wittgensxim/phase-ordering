...
14:                                               ; preds = %13, %10
  ...
  %16 = call i32 @ack(i32 noundef %9, i32 noundef %15)
  br label %17

17:                                               ; preds = %14, %6
  %storemerge = phi i32 [ %16, %14 ], [ %7, %6 ]
  ret i32 %storemerge
}
...
8:                                                ; preds = %3
  ...
  %11 = add nsw i32 %1, -1
  %12 = call i32 @tak(i32 noundef %11, i32 noundef %2, i32 noundef %0)
  %13 = add nsw i32 %2, -1
  %14 = call i32 @tak(i32 noundef %13, i32 noundef %0, i32 noundef %1)
  %15 = call i32 @tak(i32 noundef %10, i32 noundef %12, i32 noundef %14)
  br label %17
...
8:                                                ; preds = %3
  ...
  %12 = call double @takFP(double noundef %11, double noundef %2, double noundef %0)
  %13 = fadd double %2, -1.000000e+00
  %14 = call double @takFP(double noundef %13, double noundef %0, double noundef %1)
  %15 = call double @takFP(double noundef %10, double noundef %12, double noundef %14)
  br label %17
...
17:                                               ; preds = %16, %8
  %storemerge = phi double [ %2, %16 ], [ %15, %8 ]
  ret double %storemerge
}
