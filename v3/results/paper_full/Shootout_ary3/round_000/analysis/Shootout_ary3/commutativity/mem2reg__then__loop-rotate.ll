...
24:                                               ; preds = %23, %39
  %.07 = phi i32 [ 0, %23 ], [ %40, %39 ]
  %25 = sub nsw i32 %10, 1
  %26 = icmp sge i32 %25, 0
  br i1 %26, label %.lr.ph5, label %38

.lr.ph5:                                          ; preds = %24
  br label %27

27:                                               ; preds = %.lr.ph5, %35
  %.13 = phi i32 [ %25, %.lr.ph5 ], [ %36, %35 ]
...
35:                                               ; preds = %27
  ...
  br i1 %37, label %27, label %._crit_edge6, !llvm.loop !9

._crit_edge6:                                     ; preds = %35
  br label %38

38:                                               ; preds = %._crit_edge6, %24
  br label %39
