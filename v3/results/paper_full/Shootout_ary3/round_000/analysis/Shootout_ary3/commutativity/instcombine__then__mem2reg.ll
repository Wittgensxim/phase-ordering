...
15:                                               ; preds = %21, %9
  %storemerge = phi i32 [ 0, %9 ], [ %22, %21 ]
  %16 = icmp slt i32 %storemerge, %10
...
24:                                               ; preds = %39, %23
  %storemerge1 = phi i32 [ 0, %23 ], [ %40, %39 ]
  %25 = icmp slt i32 %storemerge1, 1000
...
27:                                               ; preds = %37, %26
  %storemerge2.in = phi i32 [ %10, %26 ], [ %storemerge2, %37 ]
  %storemerge2 = add nsw i32 %storemerge2.in, -1
  %28 = icmp sgt i32 %storemerge2.in, 0
