...
.lr.ph:                                           ; preds = %8, %.lr.ph
  ...
  br i1 %exitcond, label %.lr.ph, label %.preheader1, !llvm.loop !7

.preheader:                                       ; preds = %.preheader1, %._crit_edge
  %15 = phi i32 [ 0, %.preheader1 ], [ %23, %._crit_edge ]
  %16 = icmp sgt i64 %10, 0
  br i1 %16, label %.lr.ph5, label %._crit_edge

.lr.ph5:                                          ; preds = %.preheader, %.lr.ph5
  %indvars.iv24 = phi i64 [ %indvars.iv.next3, %.lr.ph5 ], [ %10, %.preheader ]
  ...
  br i1 %22, label %.lr.ph5, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %.lr.ph5, %.preheader
  %23 = add nuw nsw i32 %15, 1
  %exitcond5 = icmp ne i32 %23, 1000
  br i1 %exitcond5, label %.preheader, label %24, !llvm.loop !10
