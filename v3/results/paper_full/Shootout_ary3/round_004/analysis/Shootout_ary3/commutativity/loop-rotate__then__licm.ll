...
14:                                               ; preds = %.lr.ph, %14
  ...
  %15 = getelementptr inbounds nuw [4 x i8], ptr %11, i64 %indvars.iv3
  %16 = trunc nuw i64 %indvars.iv.next to i32
  store i32 %16, ptr %15, align 4
  %exitcond = icmp ne i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %14, label %..preheader1_crit_edge, !llvm.loop !7

.preheader:                                       ; preds = %.preheader1, %25
  %17 = phi i32 [ 0, %.preheader1 ], [ %26, %25 ]
  br i1 %13, label %.lr.ph5, label %25
...
25:                                               ; preds = %._crit_edge, %.preheader
  ...
  %exitcond5 = icmp ne i32 %26, 1000
  br i1 %exitcond5, label %.preheader, label %27, !llvm.loop !10
