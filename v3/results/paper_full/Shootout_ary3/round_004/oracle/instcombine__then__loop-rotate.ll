...
8:                                                ; preds = %4, %2
  ...
  %exitcond.not2 = icmp eq i64 0, %wide.trip.count
  br i1 %exitcond.not2, label %.preheader1, label %.lr.ph
...
13:                                               ; preds = %.lr.ph, %13
  ...
  br i1 %exitcond.not, label %..preheader1_crit_edge, label %13, !llvm.loop !7

.preheader:                                       ; preds = %.preheader1, %25
  %16 = phi i32 [ 0, %.preheader1 ], [ %26, %25 ]
...
25:                                               ; preds = %._crit_edge, %.preheader
  ...
  %exitcond5.not = icmp eq i32 %26, 1000
  br i1 %exitcond5.not, label %27, label %.preheader, !llvm.loop !10
