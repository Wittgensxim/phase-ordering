...
20:                                               ; preds = %36, %.preheader1
  %21 = phi i32 [ 0, %.preheader1 ], [ %37, %36 ]
...
.preheader.1:                                     ; preds = %33
  br label %34

34:                                               ; preds = %38, %.preheader.1
  %.in.1 = phi i32 [ %39, %38 ], [ %9, %.preheader.1 ]
  %35 = icmp sgt i32 %.in.1, 0
...
38:                                               ; preds = %34
  %39 = add nsw i32 %.in.1, -1
  %40 = sext i32 %39 to i64
  %41 = getelementptr inbounds [4 x i8], ptr %11, i64 %40
  %42 = load i32, ptr %41, align 4
  %43 = getelementptr inbounds [4 x i8], ptr %12, i64 %40
...
46:                                               ; preds = %20
  ...
  %48 = getelementptr [4 x i8], ptr %12, i64 %10
  %49 = getelementptr i8, ptr %48, i64 -4
  %50 = load i32, ptr %49, align 4
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %47, i32 noundef %50) #3
