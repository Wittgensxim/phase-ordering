...
19:                                               ; preds = %._crit_edge, %._crit_edge4
  %20 = phi i32 [ 0, %._crit_edge ], [ %30, %._crit_edge4 ]
  %21 = icmp sgt i32 %9, 0
  br i1 %21, label %.lr.ph3, label %._crit_edge4

.lr.ph3:                                          ; preds = %19, %.lr.ph3
  %.in1 = phi i32 [ %22, %.lr.ph3 ], [ %9, %19 ]
  %22 = add nsw i32 %.in1, -1
  ...
  br i1 %29, label %.lr.ph3, label %._crit_edge4, !llvm.loop !9

._crit_edge4:                                     ; preds = %.lr.ph3, %19
  %30 = add nuw nsw i32 %20, 1
  %31 = icmp samesign ult i32 %30, 1000
  br i1 %31, label %19, label %32, !llvm.loop !10

32:                                               ; preds = %._crit_edge4
