...
20:                                               ; preds = %33, %18
  %21 = phi i32 [ %34, %33 ], [ 0, %18 ]
  %exitcond7 = icmp ne i32 %21, 1000
  br i1 %exitcond7, label %22, label %35

22:                                               ; preds = %20
  br label %23

23:                                               ; preds = %26, %22
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %26 ], [ %19, %22 ]
  %24 = trunc nuw i64 %indvars.iv4 to i32
  %25 = icmp sgt i32 %24, 0
  br i1 %25, label %26, label %33

26:                                               ; preds = %23
  %27 = add nsw i64 %indvars.iv4, -1
...
35:                                               ; preds = %20
  ...
  %37 = getelementptr [4 x i8], ptr %13, i64 %11
  %38 = getelementptr i8, ptr %37, i64 -4
  %39 = load i32, ptr %38, align 4
  %40 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %36, i32 noundef %39) #4
