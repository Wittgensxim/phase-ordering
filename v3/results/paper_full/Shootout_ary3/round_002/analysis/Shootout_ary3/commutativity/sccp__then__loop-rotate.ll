...
22:                                               ; preds = %21, %34
  %23 = phi i32 [ 0, %21 ], [ %35, %34 ]
  %24 = icmp sgt i32 %10, 0
  br i1 %24, label %.lr.ph5, label %34

.lr.ph5:                                          ; preds = %22
  br label %25

25:                                               ; preds = %.lr.ph5, %25
  %.in3 = phi i32 [ %10, %.lr.ph5 ], [ %26, %25 ]
  %26 = add nsw i32 %.in3, -1
  ...
  br i1 %33, label %25, label %._crit_edge6, !llvm.loop !9

._crit_edge6:                                     ; preds = %25
  br label %34

34:                                               ; preds = %._crit_edge6, %22
  %35 = add nuw nsw i32 %23, 1
  %36 = icmp samesign ult i32 %35, 1000
  br i1 %36, label %22, label %37, !llvm.loop !10

37:                                               ; preds = %34
  %38 = load i32, ptr %13, align 4
  %39 = getelementptr [4 x i8], ptr %13, i64 %11
