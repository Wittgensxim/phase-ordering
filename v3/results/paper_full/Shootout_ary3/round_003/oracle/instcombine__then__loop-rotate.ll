...
8:                                                ; preds = %4, %2
  ...
  %exitcond.not1 = icmp eq i64 0, %wide.trip.count
  br i1 %exitcond.not1, label %16, label %.lr.ph
...
27:                                               ; preds = %._crit_edge6, %.preheader
  ...
  %exitcond5.not = icmp eq i32 %28, 1000
  br i1 %exitcond5.not, label %29, label %.preheader, !llvm.loop !10

29:                                               ; preds = %27
  %30 = load i32, ptr %12, align 4
  %31 = getelementptr [4 x i8], ptr %12, i64 %10
  %32 = getelementptr i8, ptr %31, i64 -4
  %33 = load i32, ptr %32, align 4
  %34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %30, i32 noundef %33) #4
