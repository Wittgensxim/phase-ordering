...
.preheader:                                       ; preds = %16, %29
  %18 = phi i32 [ 0, %16 ], [ %30, %29 ]
  %19 = icmp sgt i64 %17, 0
  br i1 %19, label %.lr.ph5, label %27

.lr.ph5:                                          ; preds = %.preheader
  br label %20

20:                                               ; preds = %.lr.ph5, %20
  %indvars.iv24 = phi i64 [ %17, %.lr.ph5 ], [ %indvars.iv.next3, %20 ]
  %indvars.iv.next3 = add nsw i64 %indvars.iv24, -1
  %21 = getelementptr inbounds [4 x i8], ptr %11, i64 %indvars.iv.next3
  %22 = load i32, ptr %21, align 4
  %23 = getelementptr inbounds [4 x i8], ptr %12, i64 %indvars.iv.next3
  %24 = load i32, ptr %23, align 4
  %25 = add nsw i32 %24, %22
  store i32 %25, ptr %23, align 4
  %26 = icmp sgt i64 %indvars.iv.next3, 0
  br i1 %26, label %20, label %._crit_edge6, !llvm.loop !9

._crit_edge6:                                     ; preds = %20
  br label %27

27:                                               ; preds = %._crit_edge6, %.preheader
  br label %.preheader.1

.preheader.1:                                     ; preds = %27
  %28 = icmp sgt i64 %17, 0
  br i1 %28, label %.lr.ph8, label %29

.lr.ph8:                                          ; preds = %.preheader.1
  br label %31

._crit_edge9:                                     ; preds = %31
  br label %29

29:                                               ; preds = %._crit_edge9, %.preheader.1
  %30 = add nuw nsw i32 %18, 2
  %exitcond5 = icmp ne i32 %30, 1000
  br i1 %exitcond5, label %.preheader, label %38, !llvm.loop !10

31:                                               ; preds = %.lr.ph8, %31
  %indvars.iv2.17 = phi i64 [ %17, %.lr.ph8 ], [ %indvars.iv.next3.1, %31 ]
  %indvars.iv.next3.1 = add nsw i64 %indvars.iv2.17, -1
  %32 = getelementptr inbounds [4 x i8], ptr %11, i64 %indvars.iv.next3.1
  %33 = load i32, ptr %32, align 4
  %34 = getelementptr inbounds [4 x i8], ptr %12, i64 %indvars.iv.next3.1
  %35 = load i32, ptr %34, align 4
  %36 = add nsw i32 %35, %33
  store i32 %36, ptr %34, align 4
  %37 = icmp sgt i64 %indvars.iv.next3.1, 0
  br i1 %37, label %31, label %._crit_edge9, !llvm.loop !9
