...
.preheader:                                       ; preds = %._crit_edge, %._crit_edge6
  %16 = phi i32 [ 0, %._crit_edge ], [ %24, %._crit_edge6 ]
  %17 = icmp sgt i64 %15, 0
  br i1 %17, label %.lr.ph5, label %._crit_edge6

.lr.ph5:                                          ; preds = %.preheader, %.lr.ph5
  %indvars.iv24 = phi i64 [ %indvars.iv.next3, %.lr.ph5 ], [ %15, %.preheader ]
  ...
  br i1 %23, label %.lr.ph5, label %._crit_edge6, !llvm.loop !9

._crit_edge6:                                     ; preds = %.lr.ph5, %.preheader
  %24 = add nuw nsw i32 %16, 1
  %exitcond5 = icmp ne i32 %24, 1000
  br i1 %exitcond5, label %.preheader, label %25, !llvm.loop !10
