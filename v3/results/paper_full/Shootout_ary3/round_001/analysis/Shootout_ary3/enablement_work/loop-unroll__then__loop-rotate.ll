...
23:                                               ; preds = %22, %38
  %24 = phi i32 [ 0, %22 ], [ %39, %38 ]
  %25 = icmp sgt i32 %11, 0
  br i1 %25, label %.lr.ph3, label %35

.lr.ph3:                                          ; preds = %23
  br label %26

26:                                               ; preds = %.lr.ph3, %26
  %.in1 = phi i32 [ %11, %.lr.ph3 ], [ %27, %26 ]
  %27 = add nsw i32 %.in1, -1
  ...
  br i1 %34, label %26, label %._crit_edge4, !llvm.loop !9

._crit_edge4:                                     ; preds = %26
  br label %35

35:                                               ; preds = %._crit_edge4, %23
  br label %36

36:                                               ; preds = %35
  %37 = icmp sgt i32 %11, 0
  br i1 %37, label %.lr.ph7, label %38
...
38:                                               ; preds = %._crit_edge8, %36
  %39 = add nuw nsw i32 %24, 2
  %40 = icmp samesign ult i32 %39, 1000
  br i1 %40, label %23, label %50, !llvm.loop !10

41:                                               ; preds = %.lr.ph7, %41
  %.in.15 = phi i32 [ %11, %.lr.ph7 ], [ %42, %41 ]
  %42 = add nsw i32 %.in.15, -1
  %43 = sext i32 %42 to i64
  %44 = getelementptr inbounds [4 x i8], ptr %13, i64 %43
  %45 = load i32, ptr %44, align 4
  %46 = getelementptr inbounds [4 x i8], ptr %14, i64 %43
  %47 = load i32, ptr %46, align 4
  %48 = add nsw i32 %47, %45
  store i32 %48, ptr %46, align 4
  %49 = icmp sgt i32 %42, 0
  br i1 %49, label %41, label %._crit_edge8, !llvm.loop !9

50:                                               ; preds = %38
  %51 = load i32, ptr %14, align 4
  %52 = sext i32 %11 to i64
  %53 = getelementptr [4 x i8], ptr %14, i64 %52
  %54 = getelementptr i8, ptr %53, i64 -4
  %55 = load i32, ptr %54, align 4
  %56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %51, i32 noundef %55) #3
