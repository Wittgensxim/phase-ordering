...
8:                                                ; preds = %4, %2
  ...
  br i1 %exitcond.not1, label %.preheader1.preheader, label %.lr.ph
...
13:                                               ; preds = %.lr.ph, %13
  ...
  br i1 %exitcond.not, label %..preheader1.preheader_crit_edge, label %13, !llvm.loop !7
...
.preheader1:                                      ; preds = %.preheader._crit_edge, %.preheader.preheader
  ...
  %exitcond5.not = icmp eq i32 %24, 1000
  br i1 %exitcond5.not, label %25, label %.preheader.preheader, !llvm.loop !10
