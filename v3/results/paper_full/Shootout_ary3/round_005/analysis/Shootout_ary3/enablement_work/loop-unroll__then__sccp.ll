...
13:                                               ; preds = %14, %8
  ...
  br i1 %exitcond, label %14, label %.preheader1.preheader

.preheader1.preheader:                            ; preds = %13
  br label %.preheader1
...
.preheader1:                                      ; preds = %26, %.preheader1.preheader
  %17 = phi i32 [ 0, %.preheader1.preheader ], [ %27, %26 ]
  %exitcond5 = icmp ne i32 %17, 1000
  br i1 %exitcond5, label %.preheader.preheader, label %34

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %19
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %19 ], [ %10, %.preheader.preheader ]
  %18 = icmp sgt i64 %indvars.iv2, 0
  br i1 %18, label %19, label %.preheader1.1
...
.preheader.1:                                     ; preds = %28, %.preheader.preheader.1
  %indvars.iv2.1 = phi i64 [ %indvars.iv.next3.1, %28 ], [ %10, %.preheader.preheader.1 ]
  %25 = icmp sgt i64 %indvars.iv2.1, 0
  br i1 %25, label %28, label %26

26:                                               ; preds = %.preheader.1
  %27 = add nuw nsw i32 %17, 2
  br label %.preheader1, !llvm.loop !10

28:                                               ; preds = %.preheader.1
  %indvars.iv.next3.1 = add nsw i64 %indvars.iv2.1, -1
  %29 = getelementptr inbounds nuw [4 x i8], ptr %11, i64 %indvars.iv.next3.1
  %30 = load i32, ptr %29, align 4
  %31 = getelementptr inbounds nuw [4 x i8], ptr %12, i64 %indvars.iv.next3.1
  %32 = load i32, ptr %31, align 4
  %33 = add nsw i32 %32, %30
  store i32 %33, ptr %31, align 4
  br label %.preheader.1, !llvm.loop !9
...
34:                                               ; preds = %.preheader1
  ...
  %39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %35, i32 noundef %38) #4
