...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %exitcond.not, label %.preheader1.preheader.loopexit, label %.lr.ph, !llvm.loop !7

.preheader.preheader:                             ; preds = %.preheader1, %.preheader1.preheader
  %16 = phi i32 [ 0, %.preheader1.preheader ], [ %23, %.preheader1 ]
  br i1 %13, label %.preheader.preheader1, label %.preheader1

.preheader.preheader1:                            ; preds = %.preheader.preheader
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader1, %.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv.next3, %.preheader ], [ %10, %.preheader.preheader1 ]
