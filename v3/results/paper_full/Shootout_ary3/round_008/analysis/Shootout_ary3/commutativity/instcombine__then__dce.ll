...
8:                                                ; preds = %4, %2
  ...
  br i1 %exitcond1.not, label %.preheader1.preheader, label %.lr.ph

.preheader1.preheader:                            ; preds = %.lr.ph, %8
  br label %.preheader.preheader

.lr.ph:                                           ; preds = %.lr.ph, %8
  %indvars.iv3 = phi i64 [ %indvars.iv.next, %.lr.ph ], [ 0, %8 ]
  ...
  br i1 %exitcond.not, label %.preheader1.preheader, label %.lr.ph, !llvm.loop !7
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv.next3, %.preheader ], [ %10, %.preheader.preheader ]
  ...
  %22 = icmp sgt i64 %indvars.iv24, 1
  br i1 %22, label %.preheader, label %.preheader1, !llvm.loop !9

.preheader1:                                      ; preds = %.preheader, %.preheader.preheader
  %23 = add nuw nsw i32 %15, 1
  %exitcond5.not = icmp eq i32 %23, 1000
  br i1 %exitcond5.not, label %24, label %.preheader.preheader, !llvm.loop !10
