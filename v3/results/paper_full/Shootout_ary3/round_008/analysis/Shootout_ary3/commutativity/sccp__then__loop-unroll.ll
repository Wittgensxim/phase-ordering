...
.preheader.preheader:                             ; preds = %.preheader1, %.preheader1.preheader
  ...
  br i1 %35, label %.preheader.preheader2, label %.preheader1

.preheader.preheader2:                            ; preds = %.preheader.preheader
  %xtraiter4 = and i64 %10, 3
  %lcmp.mod5 = icmp ne i64 %xtraiter4, 0
  br i1 %lcmp.mod5, label %.preheader.prol.preheader, label %.preheader.prol.loopexit

.preheader.prol.preheader:                        ; preds = %.preheader.preheader2
...
.preheader.prol:                                  ; preds = %.preheader.prol, %.preheader.prol.preheader
  ...
  %prol.iter.cmp = icmp ne i64 %prol.iter.next, %xtraiter4
...
.preheader.prol.loopexit:                         ; preds = %.preheader.prol.loopexit.unr-lcssa, %.preheader.preheader2
  %indvars.iv24.unr = phi i64 [ %10, %.preheader.preheader2 ], [ %indvars.iv24.unr.ph, %.preheader.prol.loopexit.unr-lcssa ]
  %42 = icmp ult i64 %17, 3
  br i1 %42, label %.preheader1.loopexit, label %.preheader.preheader2.new

.preheader.preheader2.new:                        ; preds = %.preheader.prol.loopexit
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader2.new
  %indvars.iv24 = phi i64 [ %indvars.iv24.unr, %.preheader.preheader2.new ], [ %indvars.iv.next3.3, %.preheader ]
