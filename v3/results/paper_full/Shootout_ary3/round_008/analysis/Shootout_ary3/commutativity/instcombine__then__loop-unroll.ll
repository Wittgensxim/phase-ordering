...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  br i1 %niter.ncmp.7, label %.preheader1.preheader.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !9
...
.preheader.prol:                                  ; preds = %.preheader.prol, %.preheader.prol.preheader
  ...
  %41 = icmp sgt i64 %indvars.iv24.prol, 1
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader1.new
  ...
  %63 = icmp sgt i64 %indvars.iv.next3.2, 1
...
.preheader1:                                      ; preds = %.preheader1.loopexit, %.preheader.preheader
  ...
  %exitcond5.not = icmp eq i32 %64, 1000
  br i1 %exitcond5.not, label %65, label %.preheader.preheader, !llvm.loop !13
