...
55:                                               ; preds = %64, %54
  %.017 = phi double [ 0.000000e+00, %54 ], [ %63, %64 ]
...
66:                                               ; preds = %55
  %67 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %.017)
...
72:                                               ; preds = %84, %71
  %.016 = phi double [ 0.000000e+00, %71 ], [ %83, %84 ]
...
27:                                               ; preds = %24
  %28 = load double, ptr %11, align 8
  %29 = load double, ptr %.114, align 8
  store double %29, ptr %11, align 8
...
13:                                               ; preds = %15, %12
  %.pn = phi ptr [ %.010, %12 ], [ %storemerge, %15 ]
...
12:                                               ; preds = %14, %11
  %.pn = phi ptr [ %.010, %11 ], [ %storemerge, %14 ]
  %storemerge = getelementptr inbounds i8, ptr %.pn, i64 -8
...
13:                                               ; preds = %18, %10
  ...
  %14 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %storemerge
  %15 = load double, ptr %14, align 8
