...
55:                                               ; preds = %59, %54
  %.016 = phi double [ 0.000000e+00, %54 ], [ %64, %59 ]
...
72:                                               ; preds = %83, %71
  %.015 = phi double [ 0.000000e+00, %71 ], [ %84, %83 ]
...
45:                                               ; preds = %49, %44
  %.012 = phi double [ 0.000000e+00, %44 ], [ %54, %49 ]
...
3:                                                ; preds = %11, %2
  %.pn = phi ptr [ %0, %2 ], [ %.03, %11 ]
  %.0 = phi ptr [ %0, %2 ], [ %12, %11 ]
  %.03 = getelementptr inbounds nuw i8, ptr %.pn, i64 8
  %.not = icmp eq ptr %.03, %1
  br i1 %.not, label %13, label %4

4:                                                ; preds = %3
  %5 = load double, ptr %.03, align 8
...
13:                                               ; preds = %10
  %14 = add nsw i64 %.0, -1
  %15 = call noundef ptr @_ZSt27__unguarded_partition_pivotIPdN9__gnu_cxx5__ops15_Iter_comp_iterIPFbddEEEET_S7_S7_T0_(ptr noundef %0, ptr noundef %.05, i64 %3)
  call void @_ZSt16__introsort_loopIPdxN9__gnu_cxx5__ops15_Iter_comp_iterIPFbddEEEEvT_S7_T0_T1_(ptr noundef %15, ptr noundef %.05, i64 noundef %14, i64 %3)
...
5:                                                ; preds = %4
  ...
  call void @_ZSt25__unguarded_linear_insertIPdN9__gnu_cxx5__ops14_Val_comp_iterIPFbddEEEEvT_T0_(ptr noundef %storemerge, i64 %6)
  br label %7
...
21:                                               ; preds = %20, %7
  %storemerge4 = phi ptr [ %storemerge, %20 ], [ %9, %7 ]
