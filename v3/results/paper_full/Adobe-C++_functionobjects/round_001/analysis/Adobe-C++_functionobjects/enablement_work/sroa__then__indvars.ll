...
29:                                               ; preds = %51, %21
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %51 ], [ 0, %21 ]
  %30 = load i32, ptr @current_test, align 4
  %31 = sext i32 %30 to i64
  %32 = icmp slt i64 %indvars.iv18, %31
  br i1 %32, label %33, label %52

33:                                               ; preds = %29
  %34 = load ptr, ptr @results, align 8
  %35 = getelementptr inbounds [16 x i8], ptr %34, i64 %indvars.iv18
  ...
  %42 = getelementptr inbounds [16 x i8], ptr %41, i64 %indvars.iv18
  ...
  %49 = trunc nuw nsw i64 %indvars.iv18 to i32
...
53:                                               ; preds = %62, %52
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %62 ], [ 0, %52 ]
  %.016 = phi double [ 0.000000e+00, %52 ], [ %61, %62 ]
  %54 = load i32, ptr @current_test, align 4
  %55 = sext i32 %54 to i64
  %56 = icmp slt i64 %indvars.iv21, %55
  br i1 %56, label %57, label %63

57:                                               ; preds = %53
  %58 = load ptr, ptr @results, align 8
  %59 = getelementptr inbounds [16 x i8], ptr %58, i64 %indvars.iv21
  %60 = load double, ptr %59, align 8
  %61 = fadd double %.016, %60
  br label %62
...
63:                                               ; preds = %53
  %.016.lcssa = phi double [ %.016, %53 ]
  %64 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %.016.lcssa)
...
69:                                               ; preds = %81, %68
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %81 ], [ 1, %68 ]
  %.015 = phi double [ 0.000000e+00, %68 ], [ %80, %81 ]
  %70 = load i32, ptr @current_test, align 4
  %71 = sext i32 %70 to i64
  %72 = icmp slt i64 %indvars.iv24, %71
  br i1 %72, label %73, label %82

73:                                               ; preds = %69
  %74 = load ptr, ptr @results, align 8
  %75 = getelementptr inbounds [16 x i8], ptr %74, i64 %indvars.iv24
  %76 = load double, ptr %75, align 8
  %77 = load double, ptr %74, align 8
  %78 = fdiv double %76, %77
  %79 = call double @log(double noundef %78) #15
  %80 = fadd double %.015, %79
  br label %81
...
82:                                               ; preds = %69
  %.015.lcssa = phi double [ %.015, %69 ]
  %.lcssa = phi i32 [ %70, %69 ]
  %83 = add nsw i32 %.lcssa, -1
  %84 = sitofp i32 %83 to double
  %85 = fdiv double %.015.lcssa, %84
...
22:                                               ; preds = %41, %18
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %41 ], [ 0, %18 ]
  %23 = load i32, ptr @current_test, align 4
  %24 = sext i32 %23 to i64
  %25 = icmp slt i64 %indvars.iv14, %24
  br i1 %25, label %26, label %42

26:                                               ; preds = %22
  %27 = load ptr, ptr @results, align 8
  %28 = getelementptr inbounds [16 x i8], ptr %27, i64 %indvars.iv14
  ...
  %34 = load ptr, ptr @results, align 8
  %35 = getelementptr inbounds [16 x i8], ptr %34, i64 %indvars.iv14
  %36 = getelementptr inbounds nuw i8, ptr %35, i64 8
  %37 = load ptr, ptr %36, align 8
  %38 = load double, ptr %35, align 8
  %39 = trunc nuw nsw i64 %indvars.iv14 to i32
...
43:                                               ; preds = %52, %42
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %52 ], [ 0, %42 ]
  %.012 = phi double [ 0.000000e+00, %42 ], [ %51, %52 ]
  %44 = load i32, ptr @current_test, align 4
  %45 = sext i32 %44 to i64
  %46 = icmp slt i64 %indvars.iv17, %45
  br i1 %46, label %47, label %53

47:                                               ; preds = %43
  %48 = load ptr, ptr @results, align 8
  %49 = getelementptr inbounds [16 x i8], ptr %48, i64 %indvars.iv17
  %50 = load double, ptr %49, align 8
  %51 = fadd double %.012, %50
  br label %52
...
53:                                               ; preds = %43
  %.012.lcssa = phi double [ %.012, %43 ]
  %54 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef nonnull @.str.6, ptr noundef %1, double noundef %.012.lcssa)
  store i32 0, ptr @current_test, align 4
  ret void
}
...
31:                                               ; preds = %25
  ...
  %smax87 = call i32 @llvm.smax.i32(i32 %10, i32 0)
  br label %37

37:                                               ; preds = %45, %31
  %storemerge1 = phi i32 [ 0, %31 ], [ %46, %45 ]
  %exitcond88 = icmp ne i32 %storemerge1, %smax87
  br i1 %exitcond88, label %38, label %47
...
48:                                               ; preds = %57, %47
  ...
  %exitcond89 = icmp ne i32 %storemerge2, %smax87
  br i1 %exitcond89, label %49, label %59
...
60:                                               ; preds = %69, %59
  ...
  %exitcond90 = icmp ne i32 %storemerge3, %smax87
  br i1 %exitcond90, label %61, label %71
...
72:                                               ; preds = %81, %71
  ...
  %exitcond91 = icmp ne i32 %storemerge4, %smax87
  br i1 %exitcond91, label %73, label %83
...
84:                                               ; preds = %93, %83
  ...
  %exitcond92 = icmp ne i32 %storemerge5, %smax87
  br i1 %exitcond92, label %85, label %95
...
96:                                               ; preds = %105, %95
  ...
  %exitcond93 = icmp ne i32 %storemerge6, %smax87
  br i1 %exitcond93, label %97, label %107
...
108:                                              ; preds = %117, %107
  ...
  %exitcond94 = icmp ne i32 %storemerge7, %smax87
  br i1 %exitcond94, label %109, label %119
...
120:                                              ; preds = %129, %119
  ...
  %exitcond95 = icmp ne i32 %storemerge8, %smax87
  br i1 %exitcond95, label %121, label %131
...
132:                                              ; preds = %141, %131
  ...
  %exitcond96 = icmp ne i32 %storemerge9, %smax87
  br i1 %exitcond96, label %133, label %143
...
144:                                              ; preds = %153, %143
  ...
  %exitcond97 = icmp ne i32 %storemerge10, %smax87
  br i1 %exitcond97, label %145, label %155
...
156:                                              ; preds = %165, %155
  ...
  %exitcond98 = icmp ne i32 %storemerge11, %smax87
  br i1 %exitcond98, label %157, label %167
...
168:                                              ; preds = %177, %167
  ...
  %exitcond99 = icmp ne i32 %storemerge12, %smax87
  br i1 %exitcond99, label %169, label %179
...
180:                                              ; preds = %189, %179
  ...
  %exitcond100 = icmp ne i32 %storemerge13, %smax87
  br i1 %exitcond100, label %181, label %191
