...
66:                                               ; preds = %55
  %.02.lcssa = phi double [ %.02, %55 ]
  %67 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %.02.lcssa)
...
86:                                               ; preds = %72
  %.01.lcssa = phi double [ %.01, %72 ]
  %.lcssa = phi i32 [ %73, %72 ]
  %87 = add nsw i32 %.lcssa, -1
  %88 = sitofp i32 %87 to double
  %89 = fdiv double %.01.lcssa, %88
...
56:                                               ; preds = %45
  %.01.lcssa = phi double [ %.01, %45 ]
  %57 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef nonnull @.str.6, ptr noundef %1, double noundef %.01.lcssa)
  store i32 0, ptr @current_test, align 4
  ret void
}
