...
55:                                               ; preds = %64, %54
  %.03 = phi double [ 0.000000e+00, %54 ], [ %63, %64 ]
...
66:                                               ; preds = %55
  %67 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %.03)
...
72:                                               ; preds = %84, %71
  %.02 = phi double [ 0.000000e+00, %71 ], [ %83, %84 ]
...
13:                                               ; preds = %15, %12
  %.pn = phi ptr [ %.02, %12 ], [ %storemerge, %15 ]
...
12:                                               ; preds = %14, %11
  %.pn = phi ptr [ %.02, %11 ], [ %storemerge, %14 ]
  %storemerge = getelementptr inbounds i8, ptr %.pn, i64 -8
