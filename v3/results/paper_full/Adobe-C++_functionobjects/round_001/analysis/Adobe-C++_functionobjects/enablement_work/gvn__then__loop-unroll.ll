...
35:                                               ; preds = %17
  ...
  %36 = add nsw i32 %.lcssa4, -12
  %37 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.1, i32 noundef %36, ptr noundef nonnull @.str.2)
  %38 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.3, i32 noundef %.lcssa4, ptr noundef nonnull @.str.2)
  br label %39
...
74:                                               ; preds = %63
  %.lcssa2 = phi double [ %64, %63 ]
  %75 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %.lcssa2)
...
95:                                               ; preds = %80
  %.lcssa1 = phi double [ %81, %80 ]
  %.lcssa = phi i32 [ %82, %80 ]
  %96 = add nsw i32 %.lcssa, -1
  %97 = sitofp i32 %96 to double
  %98 = fdiv double %.lcssa1, %97
...
26:                                               ; preds = %8
  ...
  %29 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef nonnull @.str.9, i32 noundef %.lcssa2, ptr noundef nonnull @.str.2)
  br label %30
...
62:                                               ; preds = %51
  ...
  %63 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef nonnull @.str.6, ptr noundef %1, double noundef %.lcssa)
  store i32 0, ptr @current_test, align 4
  ret void
}
...
56:                                               ; preds = %44
  %.lcssa12 = phi i32 [ %45, %44 ]
  br label %57

57:                                               ; preds = %60, %56
  %58 = phi i32 [ %.lcssa12, %56 ], [ %65, %60 ]
...
70:                                               ; preds = %57
  %.lcssa11 = phi i32 [ %58, %57 ]
  br label %71

71:                                               ; preds = %74, %70
  %72 = phi i32 [ %.lcssa11, %70 ], [ %79, %74 ]
...
84:                                               ; preds = %71
  %.lcssa10 = phi i32 [ %72, %71 ]
  br label %85

85:                                               ; preds = %88, %84
  %86 = phi i32 [ %.lcssa10, %84 ], [ %93, %88 ]
...
112:                                              ; preds = %99
  %.lcssa8 = phi i32 [ %100, %99 ]
  br label %113

113:                                              ; preds = %116, %112
  %114 = phi i32 [ %.lcssa8, %112 ], [ %121, %116 ]
...
126:                                              ; preds = %113
  %.lcssa7 = phi i32 [ %114, %113 ]
  br label %127

127:                                              ; preds = %131, %126
  %128 = phi i32 [ %.lcssa7, %126 ], [ %135, %131 ]
...
142:                                              ; preds = %127
  ...
  %.pre.lcssa = phi ptr [ %.pre, %127 ]
  %.lcssa5 = phi ptr [ %129, %127 ]
  br label %143

143:                                              ; preds = %146, %142
  %144 = phi i32 [ %.lcssa6, %142 ], [ %151, %146 ]
...
146:                                              ; preds = %143
  ...
  %148 = getelementptr inbounds [8 x i8], ptr %.pre.lcssa, i64 %147
  %149 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.pre.lcssa, ptr noundef %148, ptr noundef %.lcssa5)
  %150 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %147
  call void @_Z9quicksortIPd24inline_less_than_functorEvT_S2_T0_(ptr noundef %.lcssa5, ptr noundef %150, i8 undef)
  %151 = load i32, ptr %7, align 4
  %152 = sext i32 %151 to i64
  %153 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %152
  call void @_Z13verify_sortedIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %153)
  %154 = load i32, ptr %5, align 4
  %155 = add nsw i32 %154, 1
  br label %143, !llvm.loop !29

156:                                              ; preds = %143
  %.lcssa4 = phi i32 [ %144, %143 ]
  br label %157

157:                                              ; preds = %160, %156
  %158 = phi i32 [ %.lcssa4, %156 ], [ %165, %160 ]
...
160:                                              ; preds = %157
  ...
  %162 = getelementptr inbounds [8 x i8], ptr %.pre.lcssa, i64 %161
  %163 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.pre.lcssa, ptr noundef %162, ptr noundef %.lcssa5)
  %164 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %161
  call void @_ZSt4sortIPd24inline_less_than_functorEvT_S2_T0_(ptr noundef %.lcssa5, ptr noundef %164, i8 undef)
  %165 = load i32, ptr %7, align 4
  %166 = sext i32 %165 to i64
  %167 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %166
  call void @_Z13verify_sortedIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %167)
  %168 = load i32, ptr %5, align 4
  %169 = add nsw i32 %168, 1
  br label %157, !llvm.loop !30

170:                                              ; preds = %157
  %.lcssa3 = phi i32 [ %158, %157 ]
  br label %171

171:                                              ; preds = %174, %170
  %172 = phi i32 [ %.lcssa3, %170 ], [ %179, %174 ]
...
174:                                              ; preds = %171
  ...
  %176 = getelementptr inbounds [8 x i8], ptr %.pre.lcssa, i64 %175
  %177 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.pre.lcssa, ptr noundef %176, ptr noundef %.lcssa5)
  %178 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %175
  call void @_Z9quicksortIPdSt4lessIdEEvT_S3_T0_(ptr noundef %.lcssa5, ptr noundef %178, i8 undef)
  %179 = load i32, ptr %7, align 4
  %180 = sext i32 %179 to i64
  %181 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %180
  call void @_Z13verify_sortedIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %181)
  %182 = load i32, ptr %5, align 4
  %183 = add nsw i32 %182, 1
  br label %171, !llvm.loop !31

184:                                              ; preds = %171
  %.lcssa2 = phi i32 [ %172, %171 ]
  br label %185

185:                                              ; preds = %188, %184
  %186 = phi i32 [ %.lcssa2, %184 ], [ %193, %188 ]
...
188:                                              ; preds = %185
  ...
  %190 = getelementptr inbounds [8 x i8], ptr %.pre.lcssa, i64 %189
  %191 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.pre.lcssa, ptr noundef %190, ptr noundef %.lcssa5)
  %192 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %189
  call void @_ZSt4sortIPdSt4lessIdEEvT_S3_T0_(ptr noundef %.lcssa5, ptr noundef %192, i8 undef)
  %193 = load i32, ptr %7, align 4
  %194 = sext i32 %193 to i64
  %195 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %194
  call void @_Z13verify_sortedIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %195)
  %196 = load i32, ptr %5, align 4
  %197 = add nsw i32 %196, 1
  br label %185, !llvm.loop !32

198:                                              ; preds = %185
  %.lcssa1 = phi i32 [ %186, %185 ]
  br label %199

199:                                              ; preds = %202, %198
  %200 = phi i32 [ %.lcssa1, %198 ], [ %207, %202 ]
...
202:                                              ; preds = %199
  ...
  %204 = getelementptr inbounds [8 x i8], ptr %.pre.lcssa, i64 %203
  %205 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.pre.lcssa, ptr noundef %204, ptr noundef %.lcssa5)
  %206 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %203
  call void @_Z9quicksortIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %206)
  %207 = load i32, ptr %7, align 4
  %208 = sext i32 %207 to i64
  %209 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %208
  call void @_Z13verify_sortedIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %209)
...
216:                                              ; preds = %213
  ...
  %218 = getelementptr inbounds [8 x i8], ptr %.pre.lcssa, i64 %217
  %219 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.pre.lcssa, ptr noundef %218, ptr noundef %.lcssa5)
  %220 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %217
  call void @_ZSt4sortIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %220)
  %221 = load i32, ptr %7, align 4
  %222 = sext i32 %221 to i64
  %223 = getelementptr inbounds [8 x i8], ptr %.lcssa5, i64 %222
  call void @_Z13verify_sortedIPdEvT_S1_(ptr noundef %.lcssa5, ptr noundef %223)
