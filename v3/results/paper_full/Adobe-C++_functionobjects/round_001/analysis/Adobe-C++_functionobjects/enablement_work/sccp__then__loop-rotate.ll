...
49:                                               ; preds = %._crit_edge, %27
  ...
  br i1 %56, label %.lr.ph4, label %73
...
68:                                               ; preds = %57
  ...
  br i1 %72, label %57, label %._crit_edge5, !llvm.loop !22

._crit_edge5:                                     ; preds = %68
  br label %73

73:                                               ; preds = %._crit_edge5, %49
  store i32 0, ptr %5, align 4
  %74 = load i32, ptr %6, align 4
  %75 = icmp slt i32 0, %74
  br i1 %75, label %.lr.ph7, label %93
...
88:                                               ; preds = %76
  ...
  br i1 %92, label %76, label %._crit_edge8, !llvm.loop !23

._crit_edge8:                                     ; preds = %88
  br label %93

93:                                               ; preds = %._crit_edge8, %73
  store i32 0, ptr %5, align 4
  %94 = load i32, ptr %6, align 4
  %95 = icmp slt i32 0, %94
  br i1 %95, label %.lr.ph10, label %113

.lr.ph10:                                         ; preds = %93
  br label %96

96:                                               ; preds = %.lr.ph10, %108
...
108:                                              ; preds = %96
  ...
  br i1 %112, label %96, label %._crit_edge11, !llvm.loop !24

._crit_edge11:                                    ; preds = %108
  br label %113

113:                                              ; preds = %._crit_edge11, %93
  store i32 0, ptr %5, align 4
  %114 = load i32, ptr %6, align 4
  %115 = icmp slt i32 0, %114
  br i1 %115, label %.lr.ph13, label %133

.lr.ph13:                                         ; preds = %113
  br label %116

116:                                              ; preds = %.lr.ph13, %128
...
128:                                              ; preds = %116
  ...
  br i1 %132, label %116, label %._crit_edge14, !llvm.loop !25

._crit_edge14:                                    ; preds = %128
  br label %133

133:                                              ; preds = %._crit_edge14, %113
  store i32 0, ptr %5, align 4
  %134 = load i32, ptr %6, align 4
  %135 = icmp slt i32 0, %134
  br i1 %135, label %.lr.ph16, label %153

.lr.ph16:                                         ; preds = %133
  br label %136

136:                                              ; preds = %.lr.ph16, %148
...
148:                                              ; preds = %136
  ...
  br i1 %152, label %136, label %._crit_edge17, !llvm.loop !26

._crit_edge17:                                    ; preds = %148
  br label %153

153:                                              ; preds = %._crit_edge17, %133
  store i32 0, ptr %5, align 4
  %154 = load i32, ptr %6, align 4
  %155 = icmp slt i32 0, %154
  br i1 %155, label %.lr.ph19, label %173

.lr.ph19:                                         ; preds = %153
  br label %156

156:                                              ; preds = %.lr.ph19, %168
...
168:                                              ; preds = %156
  ...
  br i1 %172, label %156, label %._crit_edge20, !llvm.loop !27

._crit_edge20:                                    ; preds = %168
  br label %173

173:                                              ; preds = %._crit_edge20, %153
  store i32 0, ptr %5, align 4
  %174 = load i32, ptr %6, align 4
  %175 = icmp slt i32 0, %174
  br i1 %175, label %.lr.ph22, label %194

.lr.ph22:                                         ; preds = %173
  br label %176

176:                                              ; preds = %.lr.ph22, %189
...
189:                                              ; preds = %176
  ...
  br i1 %193, label %176, label %._crit_edge23, !llvm.loop !28

._crit_edge23:                                    ; preds = %189
  br label %194

194:                                              ; preds = %._crit_edge23, %173
  store i32 0, ptr %5, align 4
  %195 = load i32, ptr %6, align 4
  %196 = icmp slt i32 0, %195
  br i1 %196, label %.lr.ph25, label %214

.lr.ph25:                                         ; preds = %194
  br label %197

197:                                              ; preds = %.lr.ph25, %209
...
209:                                              ; preds = %197
  ...
  br i1 %213, label %197, label %._crit_edge26, !llvm.loop !29

._crit_edge26:                                    ; preds = %209
  br label %214

214:                                              ; preds = %._crit_edge26, %194
  store i32 0, ptr %5, align 4
  %215 = load i32, ptr %6, align 4
  %216 = icmp slt i32 0, %215
  br i1 %216, label %.lr.ph28, label %234

.lr.ph28:                                         ; preds = %214
  br label %217

217:                                              ; preds = %.lr.ph28, %229
...
229:                                              ; preds = %217
  ...
  br i1 %233, label %217, label %._crit_edge29, !llvm.loop !30

._crit_edge29:                                    ; preds = %229
  br label %234

234:                                              ; preds = %._crit_edge29, %214
  store i32 0, ptr %5, align 4
  %235 = load i32, ptr %6, align 4
  %236 = icmp slt i32 0, %235
  br i1 %236, label %.lr.ph31, label %254

.lr.ph31:                                         ; preds = %234
  br label %237

237:                                              ; preds = %.lr.ph31, %249
...
249:                                              ; preds = %237
  ...
  br i1 %253, label %237, label %._crit_edge32, !llvm.loop !31

._crit_edge32:                                    ; preds = %249
  br label %254

254:                                              ; preds = %._crit_edge32, %234
  store i32 0, ptr %5, align 4
  %255 = load i32, ptr %6, align 4
  %256 = icmp slt i32 0, %255
  br i1 %256, label %.lr.ph34, label %274

.lr.ph34:                                         ; preds = %254
  br label %257

257:                                              ; preds = %.lr.ph34, %269
...
269:                                              ; preds = %257
  ...
  br i1 %273, label %257, label %._crit_edge35, !llvm.loop !32

._crit_edge35:                                    ; preds = %269
  br label %274

274:                                              ; preds = %._crit_edge35, %254
  store i32 0, ptr %5, align 4
  %275 = load i32, ptr %6, align 4
  %276 = icmp slt i32 0, %275
  br i1 %276, label %.lr.ph37, label %294

.lr.ph37:                                         ; preds = %274
  br label %277

277:                                              ; preds = %.lr.ph37, %289
...
289:                                              ; preds = %277
  ...
  br i1 %293, label %277, label %._crit_edge38, !llvm.loop !33

._crit_edge38:                                    ; preds = %289
  br label %294

294:                                              ; preds = %._crit_edge38, %274
  store i32 0, ptr %5, align 4
  %295 = load i32, ptr %6, align 4
  %296 = icmp slt i32 0, %295
  br i1 %296, label %.lr.ph40, label %314

.lr.ph40:                                         ; preds = %294
  br label %297

297:                                              ; preds = %.lr.ph40, %309
...
309:                                              ; preds = %297
  ...
  br i1 %313, label %297, label %._crit_edge41, !llvm.loop !34

._crit_edge41:                                    ; preds = %309
  br label %314

314:                                              ; preds = %._crit_edge41, %294
...
20:                                               ; preds = %._crit_edge, %10
  ...
  %storemerge2 = getelementptr inbounds i8, ptr %21, i64 -8
  store ptr %storemerge2, ptr %7, align 8
  %22 = load ptr, ptr %8, align 8
  %23 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterIPFbddEEclIPdS6_EEbT_T0_(ptr noundef nonnull align 8 dereferenceable(8) %5, ptr noundef %22, ptr noundef nonnull %storemerge2)
  br i1 %23, label %.lr.ph4, label %28
...
24:                                               ; preds = %.lr.ph4, %24
  ...
  br i1 %27, label %24, label %._crit_edge5, !llvm.loop !60

._crit_edge5:                                     ; preds = %24
  br label %28

28:                                               ; preds = %._crit_edge5, %20
  %29 = load ptr, ptr %6, align 8
...
19:                                               ; preds = %._crit_edge, %9
  ...
  %storemerge2 = getelementptr inbounds i8, ptr %20, i64 -8
  store ptr %storemerge2, ptr %7, align 8
  %21 = load ptr, ptr %8, align 8
  %22 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterI17less_than_functorEclIPdS5_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %21, ptr noundef nonnull %storemerge2)
  br i1 %22, label %.lr.ph4, label %27
...
23:                                               ; preds = %.lr.ph4, %23
  ...
  br i1 %26, label %23, label %._crit_edge5, !llvm.loop !72

._crit_edge5:                                     ; preds = %23
  br label %27

27:                                               ; preds = %._crit_edge5, %19
  %28 = load ptr, ptr %6, align 8
  %29 = load ptr, ptr %7, align 8
...
19:                                               ; preds = %._crit_edge, %9
  ...
  store ptr %storemerge2, ptr %7, align 8
  %21 = load ptr, ptr %8, align 8
  %22 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterI24inline_less_than_functorEclIPdS5_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %21, ptr noundef nonnull %storemerge2)
  br i1 %22, label %.lr.ph4, label %27
...
23:                                               ; preds = %.lr.ph4, %23
  ...
  br i1 %26, label %23, label %._crit_edge5, !llvm.loop !84
...
19:                                               ; preds = %._crit_edge, %9
  ...
  store ptr %storemerge2, ptr %7, align 8
  %21 = load ptr, ptr %8, align 8
  %22 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterISt4lessIdEEclIPdS6_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %21, ptr noundef nonnull %storemerge2)
  br i1 %22, label %.lr.ph4, label %27
...
23:                                               ; preds = %.lr.ph4, %23
  ...
  br i1 %26, label %23, label %._crit_edge5, !llvm.loop !96
...
19:                                               ; preds = %._crit_edge, %9
  ...
  store ptr %storemerge2, ptr %7, align 8
  %21 = load ptr, ptr %8, align 8
  %22 = call noundef zeroext i1 @_ZNK9__gnu_cxx5__ops15_Iter_less_iterclIPdS3_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %21, ptr noundef nonnull %storemerge2)
  br i1 %22, label %.lr.ph4, label %27
...
23:                                               ; preds = %.lr.ph4, %23
  ...
  br i1 %26, label %23, label %._crit_edge5, !llvm.loop !108
