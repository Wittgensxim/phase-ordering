...
8:                                                ; preds = %2
  ...
  %11 = shl nsw i64 %10, 4
  %12 = call ptr @realloc(ptr noundef %5, i64 noundef %11) #13
...
14:                                               ; preds = %8
  ...
  %16 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str, i32 noundef %15)
...
18:                                               ; preds = %2, %17
  %19 = phi i32 [ %.pre1, %17 ], [ %7, %2 ]
  %20 = phi ptr [ %12, %17 ], [ %5, %2 ]
...
62:                                               ; preds = %39, %66
  %63 = phi double [ %71, %66 ], [ 0.000000e+00, %39 ]
  %64 = phi i32 [ %72, %66 ], [ 0, %39 ]
...
73:                                               ; preds = %62
  %74 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %63)
  %75 = load i32, ptr @current_test, align 4
  %76 = icmp sle i32 %75, 1
  %.not = icmp eq i32 %4, 0
  %or.cond = or i1 %76, %.not
  br i1 %or.cond, label %98, label %77

77:                                               ; preds = %73, %82
  %78 = phi double [ %90, %82 ], [ 0.000000e+00, %73 ]
  %79 = phi i32 [ %.pre, %82 ], [ %75, %73 ]
  %80 = phi i32 [ %91, %82 ], [ 1, %73 ]
...
92:                                               ; preds = %77
  ...
  %95 = fdiv double %78, %94
  %96 = call double @exp(double noundef %95) #15
  %97 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.7, ptr noundef %0, double noundef %96)
  br label %98
...
50:                                               ; preds = %30, %54
  %51 = phi double [ %59, %54 ], [ 0.000000e+00, %30 ]
  %52 = phi i32 [ %60, %54 ], [ 0, %30 ]
...
61:                                               ; preds = %50
  %62 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef nonnull @.str.6, ptr noundef %1, double noundef %51)
  store i32 0, ptr @current_test, align 4
  ret void
}
...
25:                                               ; preds = %23, %29
  %26 = phi ptr [ %30, %29 ], [ %15, %23 ]
  %27 = phi double [ %.pre, %29 ], [ %16, %23 ]
...
12:                                               ; preds = %19, %5
  %13 = phi ptr [ %0, %5 ], [ %20, %19 ]
  %14 = phi i64 [ %1, %5 ], [ %21, %19 ]
