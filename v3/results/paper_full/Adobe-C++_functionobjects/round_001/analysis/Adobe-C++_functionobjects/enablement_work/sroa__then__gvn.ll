...
52:                                               ; preds = %54, %51
  %.016 = phi double [ 0.000000e+00, %51 ], [ %59, %54 ]
...
54:                                               ; preds = %52
  ...
  %59 = fadd double %.016, %58
  %60 = add nsw i32 %storemerge2, 1
  br label %52, !llvm.loop !10

61:                                               ; preds = %52
  %62 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %.016)
...
67:                                               ; preds = %70, %66
  ...
  %.015 = phi double [ 0.000000e+00, %66 ], [ %78, %70 ]
...
42:                                               ; preds = %44, %41
  %.012 = phi double [ 0.000000e+00, %41 ], [ %49, %44 ]
...
51:                                               ; preds = %42
  %52 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef nonnull @.str.6, ptr noundef %1, double noundef %.012)
  store i32 0, ptr @current_test, align 4
  ret void
}
...
140:                                              ; preds = %._crit_edge, %139
  br i1 false, label %._crit_edge86, label %141

._crit_edge86:                                    ; preds = %140
  br label %142
...
20:                                               ; preds = %23, %19
  ...
  %.114 = phi ptr [ %.013, %19 ], [ %24, %23 ]
  %22 = fcmp olt double %21, %8
  br i1 %22, label %23, label %25

23:                                               ; preds = %20
  %24 = getelementptr inbounds nuw i8, ptr %.114, i64 8
  %.pre = load double, ptr %24, align 8
  br label %20, !llvm.loop !49

25:                                               ; preds = %20
  %26 = icmp ult ptr %.114, %12
  br i1 %26, label %28, label %27
...
28:                                               ; preds = %25
  ...
  store double %13, ptr %.114, align 8
