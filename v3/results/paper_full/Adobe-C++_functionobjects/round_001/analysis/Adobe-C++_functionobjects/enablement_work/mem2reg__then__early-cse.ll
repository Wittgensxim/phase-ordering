...
54:                                               ; preds = %63, %53
  %.02 = phi double [ 0.000000e+00, %53 ], [ %62, %63 ]
...
65:                                               ; preds = %54
  %66 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.6, ptr noundef %0, double noundef %.02)
...
71:                                               ; preds = %83, %70
  %.01 = phi double [ 0.000000e+00, %70 ], [ %82, %83 ]
...
44:                                               ; preds = %53, %43
  %.01 = phi double [ 0.000000e+00, %43 ], [ %52, %53 ]
...
55:                                               ; preds = %44
  %56 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef nonnull @.str.6, ptr noundef %1, double noundef %.01)
  store i32 0, ptr @current_test, align 4
  ret void
}
