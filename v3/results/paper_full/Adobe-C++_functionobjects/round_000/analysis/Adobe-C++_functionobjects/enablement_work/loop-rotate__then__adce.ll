...
139:                                              ; preds = %.lr.ph8, %154
  ...
  %147 = getelementptr inbounds %struct.one_result, ptr %146, i64 0
...
63:                                               ; preds = %._crit_edge, %36
  ...
  br i1 %73, label %.lr.ph2, label %96
...
90:                                               ; preds = %74
  ...
  %95 = icmp slt i32 %93, %94
  br i1 %95, label %74, label %._crit_edge3, !llvm.loop !24

._crit_edge3:                                     ; preds = %90
  br label %96

96:                                               ; preds = %._crit_edge3, %63
  store i32 0, ptr %6, align 4
  %97 = load i32, ptr %6, align 4
  %98 = load i32, ptr %7, align 4
  %99 = icmp slt i32 %97, %98
  br i1 %99, label %.lr.ph5, label %124

.lr.ph5:                                          ; preds = %96
  br label %100

100:                                              ; preds = %.lr.ph5, %118
...
118:                                              ; preds = %100
  ...
  br i1 %123, label %100, label %._crit_edge6, !llvm.loop !25

._crit_edge6:                                     ; preds = %118
  br label %124

124:                                              ; preds = %._crit_edge6, %96
  store i32 0, ptr %6, align 4
...
146:                                              ; preds = %128
  ...
  br i1 %151, label %128, label %._crit_edge9, !llvm.loop !26

._crit_edge9:                                     ; preds = %146
  br label %152

152:                                              ; preds = %._crit_edge9, %124
  store i32 0, ptr %6, align 4
  %153 = load i32, ptr %6, align 4
  %154 = load i32, ptr %7, align 4
  %155 = icmp slt i32 %153, %154
  br i1 %155, label %.lr.ph11, label %180

.lr.ph11:                                         ; preds = %152
  br label %156

156:                                              ; preds = %.lr.ph11, %174
...
174:                                              ; preds = %156
  ...
  br i1 %179, label %156, label %._crit_edge12, !llvm.loop !27

._crit_edge12:                                    ; preds = %174
  br label %180

180:                                              ; preds = %._crit_edge12, %152
  store i32 0, ptr %6, align 4
  %181 = load i32, ptr %6, align 4
  %182 = load i32, ptr %7, align 4
  %183 = icmp slt i32 %181, %182
  br i1 %183, label %.lr.ph14, label %208

.lr.ph14:                                         ; preds = %180
  br label %184

184:                                              ; preds = %.lr.ph14, %202
...
202:                                              ; preds = %184
  ...
  br i1 %207, label %184, label %._crit_edge15, !llvm.loop !28

._crit_edge15:                                    ; preds = %202
  br label %208

208:                                              ; preds = %._crit_edge15, %180
  store i32 0, ptr %6, align 4
  %209 = load i32, ptr %6, align 4
  %210 = load i32, ptr %7, align 4
  %211 = icmp slt i32 %209, %210
  br i1 %211, label %.lr.ph17, label %238

.lr.ph17:                                         ; preds = %208
  br label %212

212:                                              ; preds = %.lr.ph17, %232
...
232:                                              ; preds = %212
  ...
  br i1 %237, label %212, label %._crit_edge18, !llvm.loop !29

._crit_edge18:                                    ; preds = %232
  br label %238

238:                                              ; preds = %._crit_edge18, %208
  store i32 0, ptr %6, align 4
  %239 = load i32, ptr %6, align 4
  %240 = load i32, ptr %7, align 4
  %241 = icmp slt i32 %239, %240
  br i1 %241, label %.lr.ph20, label %268

.lr.ph20:                                         ; preds = %238
  br label %242

242:                                              ; preds = %.lr.ph20, %262
...
262:                                              ; preds = %242
  ...
  br i1 %267, label %242, label %._crit_edge21, !llvm.loop !30

._crit_edge21:                                    ; preds = %262
  br label %268

268:                                              ; preds = %._crit_edge21, %238
  store i32 0, ptr %6, align 4
  %269 = load i32, ptr %6, align 4
  %270 = load i32, ptr %7, align 4
  %271 = icmp slt i32 %269, %270
  br i1 %271, label %.lr.ph23, label %298

.lr.ph23:                                         ; preds = %268
  br label %272

272:                                              ; preds = %.lr.ph23, %292
...
292:                                              ; preds = %272
  ...
  br i1 %297, label %272, label %._crit_edge24, !llvm.loop !31

._crit_edge24:                                    ; preds = %292
  br label %298

298:                                              ; preds = %._crit_edge24, %268
  store i32 0, ptr %6, align 4
  %299 = load i32, ptr %6, align 4
  %300 = load i32, ptr %7, align 4
  %301 = icmp slt i32 %299, %300
  br i1 %301, label %.lr.ph26, label %328

.lr.ph26:                                         ; preds = %298
  br label %302

302:                                              ; preds = %.lr.ph26, %322
...
322:                                              ; preds = %302
  ...
  br i1 %327, label %302, label %._crit_edge27, !llvm.loop !32

._crit_edge27:                                    ; preds = %322
  br label %328

328:                                              ; preds = %._crit_edge27, %298
  store i32 0, ptr %6, align 4
  %329 = load i32, ptr %6, align 4
  %330 = load i32, ptr %7, align 4
  %331 = icmp slt i32 %329, %330
  br i1 %331, label %.lr.ph29, label %358

.lr.ph29:                                         ; preds = %328
  br label %332

332:                                              ; preds = %.lr.ph29, %352
...
352:                                              ; preds = %332
  ...
  br i1 %357, label %332, label %._crit_edge30, !llvm.loop !33

._crit_edge30:                                    ; preds = %352
  br label %358

358:                                              ; preds = %._crit_edge30, %328
  store i32 0, ptr %6, align 4
  %359 = load i32, ptr %6, align 4
  %360 = load i32, ptr %7, align 4
  %361 = icmp slt i32 %359, %360
  br i1 %361, label %.lr.ph32, label %388

.lr.ph32:                                         ; preds = %358
  br label %362

362:                                              ; preds = %.lr.ph32, %382
...
382:                                              ; preds = %362
  ...
  br i1 %387, label %362, label %._crit_edge33, !llvm.loop !34

._crit_edge33:                                    ; preds = %382
  br label %388

388:                                              ; preds = %._crit_edge33, %358
  store i32 0, ptr %6, align 4
  %389 = load i32, ptr %6, align 4
  %390 = load i32, ptr %7, align 4
  %391 = icmp slt i32 %389, %390
  br i1 %391, label %.lr.ph35, label %416

.lr.ph35:                                         ; preds = %388
  br label %392

392:                                              ; preds = %.lr.ph35, %410
...
410:                                              ; preds = %392
  ...
  br i1 %415, label %392, label %._crit_edge36, !llvm.loop !35

._crit_edge36:                                    ; preds = %410
  br label %416

416:                                              ; preds = %._crit_edge36, %388
  store i32 0, ptr %6, align 4
  %417 = load i32, ptr %6, align 4
  %418 = load i32, ptr %7, align 4
  %419 = icmp slt i32 %417, %418
  br i1 %419, label %.lr.ph38, label %444

.lr.ph38:                                         ; preds = %416
  br label %420

420:                                              ; preds = %.lr.ph38, %438
...
438:                                              ; preds = %420
  ...
  br i1 %443, label %420, label %._crit_edge39, !llvm.loop !36

._crit_edge39:                                    ; preds = %438
  br label %444

444:                                              ; preds = %._crit_edge39, %416
...
77:                                               ; preds = %76
  ...
  br i1 %82, label %37, label %..loopexit_crit_edge, !llvm.loop !62
...
73:                                               ; preds = %72
  ...
  br i1 %78, label %36, label %..loopexit_crit_edge, !llvm.loop !74
...
73:                                               ; preds = %72
  ...
  %77 = load ptr, ptr %20, align 8
  %78 = icmp ne ptr %76, %77
  br i1 %78, label %36, label %..loopexit_crit_edge, !llvm.loop !86
...
73:                                               ; preds = %72
  ...
  %77 = load ptr, ptr %20, align 8
  %78 = icmp ne ptr %76, %77
  br i1 %78, label %36, label %..loopexit_crit_edge, !llvm.loop !98
...
72:                                               ; preds = %71
  ...
  br i1 %77, label %36, label %..loopexit_crit_edge, !llvm.loop !110
