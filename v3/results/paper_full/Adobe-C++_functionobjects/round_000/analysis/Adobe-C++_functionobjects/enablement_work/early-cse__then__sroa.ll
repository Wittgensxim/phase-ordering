...
26:                                               ; preds = %10
  %27 = sub nsw i32 %.022, 12
  %28 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.1, i32 noundef %27, ptr noundef @.str.2)
  %29 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.3, i32 noundef %.022, ptr noundef @.str.2)
  br label %30

30:                                               ; preds = %53, %26
  %.1 = phi i32 [ 0, %26 ], [ %54, %53 ]
  %31 = load i32, ptr @current_test, align 4
...
33:                                               ; preds = %30
  ...
  %52 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.4, i32 noundef %.1, i32 noundef %42, ptr noundef @.str.5, ptr noundef %47, double noundef %48, double noundef %49, double noundef %51)
  br label %53
...
56:                                               ; preds = %65, %55
  %.025 = phi double [ 0.000000e+00, %55 ], [ %64, %65 ]
...
67:                                               ; preds = %56
  %68 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.6, ptr noundef %0, double noundef %.025)
...
74:                                               ; preds = %86, %73
  %.024 = phi double [ 0.000000e+00, %73 ], [ %85, %86 ]
...
19:                                               ; preds = %3
  %20 = sub nsw i32 %.017, 12
  %21 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef @.str.8, i32 noundef %20, ptr noundef @.str.2)
  %22 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef @.str.9, i32 noundef %.017, ptr noundef @.str.2)
  br label %23
...
26:                                               ; preds = %23
  ...
  %42 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef @.str.10, i32 noundef %.1, i32 noundef %35, ptr noundef @.str.5, ptr noundef %40, double noundef %41)
  br label %43
...
46:                                               ; preds = %55, %45
  %.019 = phi double [ 0.000000e+00, %45 ], [ %54, %55 ]
...
57:                                               ; preds = %46
  %58 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef @.str.6, ptr noundef %1, double noundef %.019)
  store i32 0, ptr @current_test, align 4
  ret void
}
...
11:                                               ; preds = %29, %9
  %.025 = phi ptr [ %1, %9 ], [ %13, %29 ]
  %.0 = phi ptr [ %0, %9 ], [ %.1, %29 ]
  br label %12

12:                                               ; preds = %16, %11
  %.126 = phi ptr [ %.025, %11 ], [ %13, %16 ]
  %13 = getelementptr inbounds double, ptr %.126, i32 -1
...
26:                                               ; preds = %33, %17
  %.0145 = phi i32 [ 0, %17 ], [ %34, %33 ]
  %27 = icmp slt i32 %.0145, %18
  br i1 %27, label %28, label %35

28:                                               ; preds = %26
  %29 = call i32 @rand()
  %30 = sitofp i32 %29 to double
  %31 = sext i32 %.0145 to i64
  %32 = getelementptr inbounds double, ptr %25, i64 %31
  store double %30, ptr %32, align 8
  br label %33

33:                                               ; preds = %28
  %34 = add nsw i32 %.0145, 1
...
6:                                                ; preds = %4
  %7 = getelementptr inbounds nuw double, ptr %.05, i32 1
  %8 = load double, ptr %.05, align 8
...
10:                                               ; preds = %28, %8
  %.020 = phi ptr [ %1, %8 ], [ %12, %28 ]
  %.0 = phi ptr [ %0, %8 ], [ %.1, %28 ]
  br label %11

11:                                               ; preds = %15, %10
  %.121 = phi ptr [ %.020, %10 ], [ %12, %15 ]
  %12 = getelementptr inbounds double, ptr %.121, i32 -1
...
13:                                               ; preds = %29, %11
  %.019 = phi ptr [ %1, %11 ], [ %15, %29 ]
  %.0 = phi ptr [ %0, %11 ], [ %.1, %29 ]
  br label %14

14:                                               ; preds = %17, %13
  %.120 = phi ptr [ %.019, %13 ], [ %15, %17 ]
  %15 = getelementptr inbounds double, ptr %.120, i32 -1
...
10:                                               ; preds = %28, %8
  %.017 = phi ptr [ %1, %8 ], [ %12, %28 ]
  %.0 = phi ptr [ %0, %8 ], [ %.1, %28 ]
  br label %11

11:                                               ; preds = %15, %10
  %.118 = phi ptr [ %.017, %10 ], [ %12, %15 ]
  %12 = getelementptr inbounds double, ptr %.118, i32 -1
  %13 = load double, ptr %12, align 8
...
22:                                               ; preds = %20, %13
  ...
  %25 = getelementptr inbounds double, ptr %0, i64 %.016
...
33:                                               ; preds = %29
  ...
  %39 = getelementptr inbounds double, ptr %0, i64 %.016
  store double %38, ptr %39, align 8
  %40 = sub nsw i64 %35, 1
  br label %41

41:                                               ; preds = %33, %29, %26
  %.117 = phi i64 [ %40, %33 ], [ %.016, %29 ], [ %.016, %26 ]
  ...
  call void @_ZSt11__push_heapIPdxdN9__gnu_cxx5__ops14_Iter_comp_valIPFbddEEEEvT_T0_S8_T1_RT2_(ptr noundef %0, i64 noundef %.117, i64 noundef %1, double noundef %3, ptr noundef nonnull align 8 dereferenceable(8) %7)
  ret void
}
...
9:                                                ; preds = %16, %5
  %.011 = phi i64 [ %1, %5 ], [ %.0, %16 ]
  %.0 = phi i64 [ %8, %5 ], [ %21, %16 ]
  %10 = icmp sgt i64 %.011, %2
...
16:                                               ; preds = %14
  ...
  %19 = getelementptr inbounds double, ptr %0, i64 %.011
...
22:                                               ; preds = %14
  ...
  %24 = getelementptr inbounds double, ptr %0, i64 %.011
...
12:                                               ; preds = %8
  %13 = getelementptr inbounds double, ptr %.010, i32 -1
  br label %14

14:                                               ; preds = %16, %12
  %.111 = phi ptr [ %13, %12 ], [ %17, %16 ]
  %15 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterIPFbddEEclIPdS6_EEbT_T0_(ptr noundef nonnull align 8 dereferenceable(8) %5, ptr noundef %2, ptr noundef %.111)
  br i1 %15, label %16, label %18

16:                                               ; preds = %14
  %17 = getelementptr inbounds double, ptr %.111, i32 -1
  br label %14, !llvm.loop !58

18:                                               ; preds = %14
  %19 = icmp ult ptr %.1, %.111
  br i1 %19, label %21, label %20
...
21:                                               ; preds = %18
  call void @_ZSt9iter_swapIPdS0_EvT_T0_(ptr noundef %.1, ptr noundef %.111)
...
21:                                               ; preds = %19, %12
  ...
  %24 = getelementptr inbounds double, ptr %0, i64 %.016
  store double %23, ptr %24, align 8
...
32:                                               ; preds = %28
  ...
  %38 = getelementptr inbounds double, ptr %0, i64 %.016
  store double %37, ptr %38, align 8
  %39 = sub nsw i64 %34, 1
  br label %40

40:                                               ; preds = %32, %28, %25
  %.117 = phi i64 [ %39, %32 ], [ %.016, %28 ], [ %.016, %25 ]
  ...
  call void @_ZSt11__push_heapIPdxdN9__gnu_cxx5__ops14_Iter_comp_valI17less_than_functorEEEvT_T0_S7_T1_RT2_(ptr noundef %0, i64 noundef %.117, i64 noundef %1, double noundef %3, ptr noundef nonnull align 1 dereferenceable(1) %7)
  ret void
}
...
11:                                               ; preds = %7
  %12 = getelementptr inbounds double, ptr %.010, i32 -1
  br label %13

13:                                               ; preds = %15, %11
  %.111 = phi ptr [ %12, %11 ], [ %16, %15 ]
  %14 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterI17less_than_functorEclIPdS5_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %2, ptr noundef %.111)
  br i1 %14, label %15, label %17

15:                                               ; preds = %13
  %16 = getelementptr inbounds double, ptr %.111, i32 -1
  br label %13, !llvm.loop !70

17:                                               ; preds = %13
  %18 = icmp ult ptr %.1, %.111
  br i1 %18, label %20, label %19
...
9:                                                ; preds = %7
  %10 = load double, ptr %.0, align 8
  store double %10, ptr %.07, align 8
  %11 = getelementptr inbounds double, ptr %.0, i32 -1
  br label %7, !llvm.loop !74

12:                                               ; preds = %7
  %13 = load double, ptr %4, align 8
  store double %13, ptr %.07, align 8
  ret void
}
...
40:                                               ; preds = %32, %28, %25
  ...
  call void @_ZSt11__push_heapIPdxdN9__gnu_cxx5__ops14_Iter_comp_valI24inline_less_than_functorEEEvT_T0_S7_T1_RT2_(ptr noundef %0, i64 noundef %.117, i64 noundef %1, double noundef %3, ptr noundef nonnull align 1 dereferenceable(1) %7)
  ret void
}
...
13:                                               ; preds = %15, %11
  %.111 = phi ptr [ %12, %11 ], [ %16, %15 ]
  %14 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterI24inline_less_than_functorEclIPdS5_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %2, ptr noundef %.111)
  br i1 %14, label %15, label %17
...
40:                                               ; preds = %32, %28, %25
  ...
  call void @_ZSt11__push_heapIPdxdN9__gnu_cxx5__ops14_Iter_comp_valISt4lessIdEEEEvT_T0_S8_T1_RT2_(ptr noundef %0, i64 noundef %.117, i64 noundef %1, double noundef %3, ptr noundef nonnull align 1 dereferenceable(1) %7)
  ret void
}
...
13:                                               ; preds = %15, %11
  %.111 = phi ptr [ %12, %11 ], [ %16, %15 ]
  %14 = call noundef zeroext i1 @_ZN9__gnu_cxx5__ops15_Iter_comp_iterISt4lessIdEEclIPdS6_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %2, ptr noundef %.111)
  br i1 %14, label %15, label %17
...
8:                                                ; preds = %21, %5
  %.016 = phi i64 [ %1, %5 ], [ %.117, %21 ]
  %.0 = phi i64 [ %1, %5 ], [ %.117, %21 ]
  %9 = sub nsw i64 %2, 1
  %10 = sdiv i64 %9, 2
...
21:                                               ; preds = %19, %12
  %.117 = phi i64 [ %20, %19 ], [ %14, %12 ]
  %22 = getelementptr inbounds double, ptr %0, i64 %.117
  %23 = load double, ptr %22, align 8
...
28:                                               ; preds = %25
  %29 = sub nsw i64 %2, 2
  %30 = sdiv i64 %29, 2
  %31 = icmp eq i64 %.016, %30
  br i1 %31, label %32, label %40

32:                                               ; preds = %28
  %33 = add nsw i64 %.016, 1
  %34 = mul nsw i64 2, %33
  %35 = sub nsw i64 %34, 1
  %36 = getelementptr inbounds double, ptr %0, i64 %35
  %37 = load double, ptr %36, align 8
...
13:                                               ; preds = %15, %11
  %.111 = phi ptr [ %12, %11 ], [ %16, %15 ]
  %14 = call noundef zeroext i1 @_ZNK9__gnu_cxx5__ops15_Iter_less_iterclIPdS3_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %5, ptr noundef %2, ptr noundef %.111)
  br i1 %14, label %15, label %17
