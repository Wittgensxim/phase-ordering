...
39:                                               ; preds = %21
  ...
  %40 = sub nsw i32 %.lcssa4, 12
  %41 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.1, i32 noundef %40, ptr noundef @.str.2)
  %42 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.3, i32 noundef %.lcssa4, ptr noundef @.str.2)
  store i32 0, ptr %11, align 4
  br label %43
...
79:                                               ; preds = %68
  %.lcssa2 = phi double [ %69, %68 ]
  %80 = call noundef i32 (ptr, ...) @__mingw_printf(ptr noundef @.str.6, ptr noundef %0, double noundef %.lcssa2)
...
101:                                              ; preds = %86
  %.lcssa1 = phi double [ %87, %86 ]
  %.lcssa = phi i32 [ %88, %86 ]
  %102 = sub nsw i32 %.lcssa, 1
  %103 = sitofp i32 %102 to double
  %104 = fdiv double %.lcssa1, %103
...
27:                                               ; preds = %9
  %.lcssa2 = phi i32 [ %10, %9 ]
  %28 = sub nsw i32 %.lcssa2, 12
  %29 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef @.str.8, i32 noundef %28, ptr noundef @.str.2)
  %30 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef @.str.9, i32 noundef %.lcssa2, ptr noundef @.str.2)
  store i32 0, ptr %5, align 4
  br label %31
...
64:                                               ; preds = %53
  %.lcssa = phi double [ %54, %53 ]
  %65 = call noundef i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %0, ptr noundef @.str.6, ptr noundef %1, double noundef %.lcssa)
  store i32 0, ptr @current_test, align 4
  ret void
}
...
67:                                               ; preds = %52
  %.lcssa25 = phi i32 [ %53, %52 ]
  %.lcssa24 = phi ptr [ %54, %52 ]
  store i32 0, ptr %6, align 4
  br label %68

68:                                               ; preds = %73, %67
  %69 = phi i32 [ %78, %73 ], [ %.lcssa25, %67 ]
  %70 = phi ptr [ %77, %73 ], [ %.lcssa24, %67 ]
...
83:                                               ; preds = %68
  %.lcssa23 = phi i32 [ %69, %68 ]
  %.lcssa22 = phi ptr [ %70, %68 ]
  store i32 0, ptr %6, align 4
  br label %84

84:                                               ; preds = %89, %83
  %85 = phi i32 [ %94, %89 ], [ %.lcssa23, %83 ]
  %86 = phi ptr [ %93, %89 ], [ %.lcssa22, %83 ]
...
99:                                               ; preds = %84
  %.lcssa21 = phi i32 [ %85, %84 ]
  %.lcssa20 = phi ptr [ %86, %84 ]
  store i32 0, ptr %6, align 4
  br label %100

100:                                              ; preds = %105, %99
  %101 = phi i32 [ %110, %105 ], [ %.lcssa21, %99 ]
  %102 = phi ptr [ %109, %105 ], [ %.lcssa20, %99 ]
...
115:                                              ; preds = %100
  %.lcssa19 = phi i32 [ %101, %100 ]
  %.lcssa18 = phi ptr [ %102, %100 ]
  store i32 0, ptr %6, align 4
  br label %116

116:                                              ; preds = %121, %115
  %117 = phi i32 [ %126, %121 ], [ %.lcssa19, %115 ]
  %118 = phi ptr [ %125, %121 ], [ %.lcssa18, %115 ]
...
131:                                              ; preds = %116
  %.lcssa17 = phi i32 [ %117, %116 ]
  %.lcssa16 = phi ptr [ %118, %116 ]
  store i32 0, ptr %6, align 4
  br label %132

132:                                              ; preds = %137, %131
  %133 = phi i32 [ %142, %137 ], [ %.lcssa17, %131 ]
  %134 = phi ptr [ %141, %137 ], [ %.lcssa16, %131 ]
...
148:                                              ; preds = %132
  %.lcssa15 = phi i32 [ %133, %132 ]
  %.lcssa14 = phi ptr [ %134, %132 ]
  store i32 0, ptr %6, align 4
  br label %149

149:                                              ; preds = %155, %148
  %150 = phi i32 [ %160, %155 ], [ %.lcssa15, %148 ]
  %151 = phi ptr [ %163, %155 ], [ %40, %148 ]
  %152 = phi ptr [ %159, %155 ], [ %.lcssa14, %148 ]
...
168:                                              ; preds = %149
  %.lcssa13 = phi i32 [ %150, %149 ]
  %.lcssa12 = phi ptr [ %151, %149 ]
  %.lcssa11 = phi ptr [ %152, %149 ]
  store i32 0, ptr %6, align 4
  br label %169

169:                                              ; preds = %174, %168
  %170 = phi i32 [ %179, %174 ], [ %.lcssa13, %168 ]
  %171 = phi ptr [ %178, %174 ], [ %.lcssa11, %168 ]
...
174:                                              ; preds = %169
  ...
  %176 = getelementptr inbounds double, ptr %.lcssa12, i64 %175
  %177 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.lcssa12, ptr noundef %176, ptr noundef %171)
...
185:                                              ; preds = %169
  %.lcssa10 = phi i32 [ %170, %169 ]
  %.lcssa9 = phi ptr [ %171, %169 ]
  store i32 0, ptr %6, align 4
  br label %186

186:                                              ; preds = %191, %185
  %187 = phi i32 [ %196, %191 ], [ %.lcssa10, %185 ]
  %188 = phi ptr [ %195, %191 ], [ %.lcssa9, %185 ]
...
191:                                              ; preds = %186
  ...
  %193 = getelementptr inbounds double, ptr %.lcssa12, i64 %192
  %194 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.lcssa12, ptr noundef %193, ptr noundef %188)
...
202:                                              ; preds = %186
  %.lcssa8 = phi i32 [ %187, %186 ]
  %.lcssa7 = phi ptr [ %188, %186 ]
  store i32 0, ptr %6, align 4
  br label %203

203:                                              ; preds = %208, %202
  %204 = phi i32 [ %213, %208 ], [ %.lcssa8, %202 ]
  %205 = phi ptr [ %212, %208 ], [ %.lcssa7, %202 ]
...
208:                                              ; preds = %203
  ...
  %210 = getelementptr inbounds double, ptr %.lcssa12, i64 %209
  %211 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.lcssa12, ptr noundef %210, ptr noundef %205)
...
219:                                              ; preds = %203
  %.lcssa6 = phi i32 [ %204, %203 ]
  %.lcssa5 = phi ptr [ %205, %203 ]
  store i32 0, ptr %6, align 4
  br label %220

220:                                              ; preds = %225, %219
  %221 = phi i32 [ %230, %225 ], [ %.lcssa6, %219 ]
  %222 = phi ptr [ %229, %225 ], [ %.lcssa5, %219 ]
...
225:                                              ; preds = %220
  ...
  %227 = getelementptr inbounds double, ptr %.lcssa12, i64 %226
  %228 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.lcssa12, ptr noundef %227, ptr noundef %222)
...
236:                                              ; preds = %220
  %.lcssa4 = phi i32 [ %221, %220 ]
  %.lcssa3 = phi ptr [ %222, %220 ]
  store i32 0, ptr %6, align 4
  br label %237

237:                                              ; preds = %242, %236
  %238 = phi i32 [ %247, %242 ], [ %.lcssa4, %236 ]
  %239 = phi ptr [ %246, %242 ], [ %.lcssa3, %236 ]
...
242:                                              ; preds = %237
  ...
  %244 = getelementptr inbounds double, ptr %.lcssa12, i64 %243
  %245 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.lcssa12, ptr noundef %244, ptr noundef %239)
...
252:                                              ; preds = %237
  %.lcssa2 = phi i32 [ %238, %237 ]
  %.lcssa1 = phi ptr [ %239, %237 ]
  store i32 0, ptr %6, align 4
  br label %253

253:                                              ; preds = %258, %252
  %254 = phi i32 [ %263, %258 ], [ %.lcssa2, %252 ]
  %255 = phi ptr [ %262, %258 ], [ %.lcssa1, %252 ]
...
258:                                              ; preds = %253
  ...
  %260 = getelementptr inbounds double, ptr %.lcssa12, i64 %259
  %261 = call noundef ptr @_ZSt4copyIPdS0_ET0_T_S2_S1_(ptr noundef %.lcssa12, ptr noundef %260, ptr noundef %255)
...
268:                                              ; preds = %253
  %.lcssa = phi ptr [ %255, %253 ]
  %269 = icmp eq ptr %.lcssa, null
...
271:                                              ; preds = %270, %268
  %272 = phi ptr [ %.pre, %270 ], [ %.lcssa12, %268 ]
