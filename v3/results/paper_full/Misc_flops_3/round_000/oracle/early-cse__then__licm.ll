...
define dso_local i32 @main() #0 {
  ...
  %.promoted5 = load double, ptr %5, align 1
  %.promoted7 = load double, ptr %2, align 8
  br label %36

36:                                               ; preds = %54, %0
  %37 = phi double [ %53, %54 ], [ %.promoted7, %0 ]
  %38 = phi double [ %46, %54 ], [ %.promoted5, %0 ]
  %39 = phi double [ %45, %54 ], [ %.promoted3, %0 ]
  %40 = phi double [ %44, %54 ], [ %.promoted1, %0 ]
  %41 = phi i32 [ %55, %54 ], [ %.promoted, %0 ]
  %42 = icmp sle i32 %41, %24
  br i1 %42, label %43, label %56

43:                                               ; preds = %36
  %44 = fadd double %40, %25
  %45 = fmul double %44, %26
  %46 = fmul double %45, %45
  %47 = call double @llvm.fmuladd.f64(double %27, double %46, double %29)
  %48 = call double @llvm.fmuladd.f64(double %47, double %46, double %30)
  %49 = call double @llvm.fmuladd.f64(double %48, double %46, double %32)
  %50 = call double @llvm.fmuladd.f64(double %49, double %46, double %33)
  %51 = call double @llvm.fmuladd.f64(double %50, double %46, double %34)
  %52 = call double @llvm.fmuladd.f64(double %51, double %46, double %35)
  %53 = call double @llvm.fmuladd.f64(double %45, double %52, double %37)
  br label %54
...
56:                                               ; preds = %36
  %.lcssa8 = phi double [ %37, %36 ]
  %.lcssa6 = phi double [ %38, %36 ]
  %.lcssa4 = phi double [ %39, %36 ]
  %.lcssa2 = phi double [ %40, %36 ]
  %.lcssa = phi i32 [ %41, %36 ]
  store i32 %.lcssa, ptr %9, align 4
  store double %.lcssa2, ptr %4, align 8
  store double %.lcssa4, ptr %3, align 8
  store double %.lcssa6, ptr %5, align 1
