...
15:                                               ; preds = %41, %0
  ...
  br i1 %.not.not, label %17, label %44
...
17:                                               ; preds = %15
  ...
  %25 = load double, ptr @A6, align 8
  %26 = load double, ptr @A5, align 8
  %27 = fneg double %26
  %28 = call double @llvm.fmuladd.f64(double %25, double %23, double %27)
  %29 = load double, ptr @A4, align 8
  %30 = call double @llvm.fmuladd.f64(double %28, double %23, double %29)
  %31 = load double, ptr @A3, align 8
  %32 = fneg double %31
  %33 = call double @llvm.fmuladd.f64(double %30, double %23, double %32)
  %34 = load double, ptr @A2, align 8
  %35 = call double @llvm.fmuladd.f64(double %33, double %23, double %34)
  %36 = load double, ptr @A1, align 8
  %37 = call double @llvm.fmuladd.f64(double %35, double %23, double %36)
  %38 = load double, ptr @one, align 8
  %39 = call double @llvm.fmuladd.f64(double %37, double %23, double %38)
  %40 = call double @llvm.fmuladd.f64(double %22, double %39, double %24)
...
44:                                               ; preds = %15
  ...
  %68 = call double @llvm.fmuladd.f64(double %66, double %67, double %64)
