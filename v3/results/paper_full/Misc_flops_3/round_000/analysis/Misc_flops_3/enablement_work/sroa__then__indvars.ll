...
12:                                               ; preds = %34, %0
  %.029 = phi double [ 0.000000e+00, %0 ], [ %15, %34 ]
  %.028 = phi i32 [ 1, %0 ], [ %35, %34 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %33, %34 ]
  %exitcond = icmp ne i32 %.028, 312500000
  br i1 %exitcond, label %13, label %36

13:                                               ; preds = %12
  %14 = load double, ptr @one, align 8
  %15 = fadd double %.029, %14
  %16 = fmul double %15, %11
  %17 = fmul double %16, %16
  %18 = load double, ptr @A6, align 8
  %19 = load double, ptr @A5, align 8
  %20 = fneg double %19
  %21 = call double @llvm.fmuladd.f64(double %18, double %17, double %20)
  %22 = load double, ptr @A4, align 8
  %23 = call double @llvm.fmuladd.f64(double %21, double %17, double %22)
  %24 = load double, ptr @A3, align 8
  %25 = fneg double %24
  %26 = call double @llvm.fmuladd.f64(double %23, double %17, double %25)
  ...
  %32 = call double @llvm.fmuladd.f64(double %30, double %17, double %31)
  %33 = call double @llvm.fmuladd.f64(double %16, double %32, double %.0)
  br label %34

34:                                               ; preds = %13
  %35 = add nuw nsw i32 %.028, 1
...
36:                                               ; preds = %12
  ...
  %43 = fneg double %42
  %44 = call double @llvm.fmuladd.f64(double %41, double %40, double %43)
  %45 = load double, ptr @A4, align 8
  %46 = call double @llvm.fmuladd.f64(double %44, double %40, double %45)
  %47 = load double, ptr @A3, align 8
  %48 = fneg double %47
  %49 = call double @llvm.fmuladd.f64(double %46, double %40, double %48)
  ...
  %55 = call double @llvm.fmuladd.f64(double %53, double %40, double %54)
