...
12:                                               ; preds = %36, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %17, %36 ]
  %.01 = phi double [ 0.000000e+00, %0 ], [ %35, %36 ]
  %.0 = phi i32 [ 1, %0 ], [ %37, %36 ]
  %13 = sub nsw i32 %6, 1
...
15:                                               ; preds = %12
  ...
  %17 = fadd double %.02, %16
  %18 = fmul double %17, %11
  %19 = fmul double %18, %18
  %20 = load double, ptr @A6, align 8
  %21 = load double, ptr @A5, align 8
  %22 = fneg double %21
  %23 = call double @llvm.fmuladd.f64(double %20, double %19, double %22)
  %24 = load double, ptr @A4, align 8
  %25 = call double @llvm.fmuladd.f64(double %23, double %19, double %24)
  %26 = load double, ptr @A3, align 8
  %27 = fneg double %26
  %28 = call double @llvm.fmuladd.f64(double %25, double %19, double %27)
  %29 = load double, ptr @A2, align 8
  %30 = call double @llvm.fmuladd.f64(double %28, double %19, double %29)
  %31 = load double, ptr @A1, align 8
  %32 = call double @llvm.fmuladd.f64(double %30, double %19, double %31)
  %33 = load double, ptr @one, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %19, double %33)
  %35 = call double @llvm.fmuladd.f64(double %18, double %34, double %.01)
  br label %36
...
38:                                               ; preds = %12
  ...
  %60 = call double @llvm.fmuladd.f64(double %59, double %.01, double %58)
  %61 = fmul double %11, %60
  ...
  %66 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %65, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
