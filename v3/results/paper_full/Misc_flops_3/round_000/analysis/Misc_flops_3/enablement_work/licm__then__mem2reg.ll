...
23:                                               ; preds = %41, %0
  %24 = phi double [ %40, %41 ], [ 0.000000e+00, %0 ]
  %25 = phi double [ %33, %41 ], [ undef, %0 ]
  %26 = phi double [ %32, %41 ], [ undef, %0 ]
  %27 = phi double [ %31, %41 ], [ 0.000000e+00, %0 ]
  %28 = phi i32 [ %42, %41 ], [ 1, %0 ]
  %29 = icmp sle i32 %28, %12
  br i1 %29, label %30, label %43

30:                                               ; preds = %23
  %31 = fadd double %27, %13
  %32 = fmul double %31, %11
  %33 = fmul double %32, %32
  %34 = call double @llvm.fmuladd.f64(double %14, double %33, double %16)
  %35 = call double @llvm.fmuladd.f64(double %34, double %33, double %17)
  %36 = call double @llvm.fmuladd.f64(double %35, double %33, double %19)
  %37 = call double @llvm.fmuladd.f64(double %36, double %33, double %20)
  %38 = call double @llvm.fmuladd.f64(double %37, double %33, double %21)
  %39 = call double @llvm.fmuladd.f64(double %38, double %33, double %22)
  %40 = call double @llvm.fmuladd.f64(double %32, double %39, double %24)
  br label %41
...
43:                                               ; preds = %23
  %.lcssa8 = phi double [ %24, %23 ]
  %.lcssa6 = phi double [ %25, %23 ]
  %.lcssa4 = phi double [ %26, %23 ]
  %.lcssa2 = phi double [ %27, %23 ]
  %.lcssa = phi i32 [ %28, %23 ]
  ...
  %66 = call double @llvm.fmuladd.f64(double %65, double %.lcssa8, double %64)
  ...
  %75 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %74, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
