...
27:                                               ; preds = %42, %0
  %28 = phi double [ %.promoted5, %0 ], [ %41, %42 ]
  %29 = phi double [ %.promoted3, %0 ], [ %34, %42 ]
  %30 = phi double [ %.promoted, %0 ], [ %32, %42 ]
  %storemerge = phi i32 [ 1, %0 ], [ %43, %42 ]
  %.not.not = icmp slt i32 %storemerge, %15
  br i1 %.not.not, label %31, label %44

31:                                               ; preds = %27
  %32 = fadd double %30, %16
  %33 = fmul double %32, %17
  %34 = fmul double %33, %33
  %35 = call double @llvm.fmuladd.f64(double %18, double %34, double %20)
  %36 = call double @llvm.fmuladd.f64(double %35, double %34, double %21)
  %37 = call double @llvm.fmuladd.f64(double %36, double %34, double %23)
  %38 = call double @llvm.fmuladd.f64(double %37, double %34, double %24)
  %39 = call double @llvm.fmuladd.f64(double %38, double %34, double %25)
  %40 = call double @llvm.fmuladd.f64(double %39, double %34, double %26)
...
44:                                               ; preds = %27
  %.lcssa6 = phi double [ %28, %27 ]
  %.lcssa4 = phi double [ %29, %27 ]
