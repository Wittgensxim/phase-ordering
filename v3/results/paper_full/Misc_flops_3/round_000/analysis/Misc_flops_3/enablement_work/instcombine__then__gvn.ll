...
define dso_local i32 @main() #0 {
  ...
  store i32 312500000, ptr %7, align 4
  %8 = load double, ptr @piref, align 8
  %9 = load double, ptr @three, align 8
  %10 = fmul double %9, 3.125000e+08
  %11 = fdiv double %8, %10
...
12:                                               ; preds = %16, %0
  %13 = phi double [ 0.000000e+00, %0 ], [ %18, %16 ]
  %14 = phi double [ 0.000000e+00, %0 ], [ %35, %16 ]
  %15 = phi i32 [ 1, %0 ], [ %36, %16 ]
  store i32 %15, ptr %6, align 4
  %.not.not = icmp slt i32 %15, 312500000
  br i1 %.not.not, label %16, label %37

16:                                               ; preds = %12
  %17 = load double, ptr @one, align 8
  %18 = fadd double %13, %17
  store double %18, ptr %2, align 8
  %19 = fmul double %18, %11
  %20 = fmul double %19, %19
  store double %20, ptr %3, align 8
  %21 = load double, ptr @A6, align 8
  %22 = load double, ptr @A5, align 8
  %23 = fneg double %22
  %24 = call double @llvm.fmuladd.f64(double %21, double %20, double %23)
  %25 = load double, ptr @A4, align 8
  %26 = call double @llvm.fmuladd.f64(double %24, double %20, double %25)
  %27 = load double, ptr @A3, align 8
  %28 = fneg double %27
  %29 = call double @llvm.fmuladd.f64(double %26, double %20, double %28)
  ...
  %34 = call double @llvm.fmuladd.f64(double %33, double %20, double %17)
  %35 = call double @llvm.fmuladd.f64(double %19, double %34, double %14)
...
37:                                               ; preds = %12
  ...
  %42 = fneg double %41
  %43 = call double @llvm.fmuladd.f64(double %40, double %39, double %42)
  %44 = load double, ptr @A4, align 8
  %45 = call double @llvm.fmuladd.f64(double %43, double %39, double %44)
  %46 = load double, ptr @A3, align 8
  %47 = fneg double %46
  %48 = call double @llvm.fmuladd.f64(double %45, double %39, double %47)
  %49 = load double, ptr @A2, align 8
  %50 = call double @llvm.fmuladd.f64(double %48, double %39, double %49)
  %51 = load double, ptr @A1, align 8
  %52 = call double @llvm.fmuladd.f64(double %50, double %39, double %51)
  %53 = load double, ptr @one, align 8
  %54 = call double @llvm.fmuladd.f64(double %52, double %39, double %53)
  %55 = fmul double %38, %54
  store double %55, ptr @sa, align 8
  %56 = load double, ptr @two, align 8
  %57 = call double @llvm.fmuladd.f64(double %56, double %14, double %55)
  ...
  %62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %61, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
