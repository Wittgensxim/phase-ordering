...
39:                                               ; preds = %.lr.ph, %53
  %40 = phi i32 [ %.promoted, %.lr.ph ], [ %54, %53 ]
  %41 = phi double [ %.promoted1, %.lr.ph ], [ %43, %53 ]
  %42 = phi double [ %.promoted7, %.lr.ph ], [ %52, %53 ]
  %43 = fadd double %41, %27
  %44 = fmul double %43, %28
  %45 = fmul double %44, %44
  %46 = call double @llvm.fmuladd.f64(double %29, double %45, double %31)
  %47 = call double @llvm.fmuladd.f64(double %46, double %45, double %32)
  %48 = call double @llvm.fmuladd.f64(double %47, double %45, double %34)
  %49 = call double @llvm.fmuladd.f64(double %48, double %45, double %35)
  %50 = call double @llvm.fmuladd.f64(double %49, double %45, double %36)
  %51 = call double @llvm.fmuladd.f64(double %50, double %45, double %37)
  %52 = call double @llvm.fmuladd.f64(double %44, double %51, double %42)
  br label %53

53:                                               ; preds = %39
  %54 = add nsw i32 %40, 1
  %55 = icmp sle i32 %54, %26
  br i1 %55, label %39, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %53
  %split = phi double [ %52, %53 ]
  %split9 = phi double [ %45, %53 ]
  %split10 = phi double [ %44, %53 ]
  %split11 = phi double [ %43, %53 ]
  %split12 = phi i32 [ %54, %53 ]
  br label %56
