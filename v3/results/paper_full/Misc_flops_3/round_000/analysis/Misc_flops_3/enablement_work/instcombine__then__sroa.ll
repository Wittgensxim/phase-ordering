...
7:                                                ; preds = %29, %0
  %.013 = phi double [ 0.000000e+00, %0 ], [ %10, %29 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %28, %29 ]
  %storemerge = phi i32 [ 1, %0 ], [ %30, %29 ]
  %.not.not = icmp slt i32 %storemerge, %1
  br i1 %.not.not, label %8, label %31

8:                                                ; preds = %7
  %9 = load double, ptr @one, align 8
  %10 = fadd double %.013, %9
  %11 = fmul double %10, %6
  ...
  %27 = call double @llvm.fmuladd.f64(double %25, double %12, double %26)
  %28 = call double @llvm.fmuladd.f64(double %11, double %27, double %.0)
  br label %29
...
31:                                               ; preds = %7
  ...
  %33 = load double, ptr @three, align 8
  %34 = fdiv double %32, %33
  %35 = fmul double %34, %34
  %36 = load double, ptr @A6, align 8
  %37 = load double, ptr @A5, align 8
  %38 = fneg double %37
  %39 = call double @llvm.fmuladd.f64(double %36, double %35, double %38)
  %40 = load double, ptr @A4, align 8
  %41 = call double @llvm.fmuladd.f64(double %39, double %35, double %40)
  %42 = load double, ptr @A3, align 8
  %43 = fneg double %42
  %44 = call double @llvm.fmuladd.f64(double %41, double %35, double %43)
  %45 = load double, ptr @A2, align 8
  %46 = call double @llvm.fmuladd.f64(double %44, double %35, double %45)
  %47 = load double, ptr @A1, align 8
  %48 = call double @llvm.fmuladd.f64(double %46, double %35, double %47)
  ...
  %53 = call double @llvm.fmuladd.f64(double %52, double %.0, double %51)
  %54 = fmul double %6, %53
