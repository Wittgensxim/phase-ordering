...
9:                                                ; preds = %14, %0
  %10 = phi double [ %16, %14 ], [ 0.000000e+00, %0 ]
  %11 = phi double [ %33, %14 ], [ 0.000000e+00, %0 ]
  %12 = phi i32 [ %34, %14 ], [ 1, %0 ]
  %13 = icmp sle i32 %12, 312499999
...
14:                                               ; preds = %9
  ...
  %32 = call double @llvm.fmuladd.f64(double %31, double %18, double %15)
  %33 = call double @llvm.fmuladd.f64(double %17, double %32, double %11)
  %34 = add nsw i32 %12, 1
...
35:                                               ; preds = %9
  ...
  %40 = fneg double %39
  %41 = call double @llvm.fmuladd.f64(double %38, double %37, double %40)
  %42 = load double, ptr @A4, align 8
  %43 = call double @llvm.fmuladd.f64(double %41, double %37, double %42)
  %44 = load double, ptr @A3, align 8
  %45 = fneg double %44
  %46 = call double @llvm.fmuladd.f64(double %43, double %37, double %45)
  %47 = load double, ptr @A2, align 8
  %48 = call double @llvm.fmuladd.f64(double %46, double %37, double %47)
  %49 = load double, ptr @A1, align 8
  %50 = call double @llvm.fmuladd.f64(double %48, double %37, double %49)
  %51 = load double, ptr @one, align 8
  %52 = call double @llvm.fmuladd.f64(double %50, double %37, double %51)
  %53 = fmul double %36, %52
  store double %53, ptr @sa, align 8
  %54 = load double, ptr @two, align 8
  %55 = call double @llvm.fmuladd.f64(double %54, double %11, double %53)
  %56 = fmul double %8, %55
  %57 = fdiv double %56, %54
  store double %57, ptr @sa, align 8
  store double 5.000000e-01, ptr @sb, align 8
  %58 = fsub double %57, 5.000000e-01
  store double %58, ptr @sc, align 8
  %59 = fmul double %58, 1.000000e-30
  %60 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %59, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
