...
10:                                               ; preds = %32, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %14, %32 ]
  %.01 = phi double [ 0.000000e+00, %0 ], [ %31, %32 ]
  %.0 = phi i32 [ 1, %0 ], [ %33, %32 ]
...
12:                                               ; preds = %10
  ...
  %31 = call double @llvm.fmuladd.f64(double %15, double %30, double %.01)
  br label %32
...
34:                                               ; preds = %10
  ...
  %56 = call double @llvm.fmuladd.f64(double %55, double %.01, double %54)
  %57 = fmul double %9, %56
