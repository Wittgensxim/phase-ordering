...
10:                                               ; preds = %33, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %14, %33 ]
  %.01 = phi double [ 0.000000e+00, %0 ], [ %32, %33 ]
  %.0 = phi i32 [ 1, %0 ], [ %34, %33 ]
  %11 = icmp sle i32 %.0, 312499999
...
12:                                               ; preds = %10
  ...
  %32 = call double @llvm.fmuladd.f64(double %15, double %31, double %.01)
  br label %33
