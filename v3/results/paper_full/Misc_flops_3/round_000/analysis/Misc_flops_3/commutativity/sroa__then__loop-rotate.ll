...
13:                                               ; preds = %0, %34
  %.032 = phi double [ 0.000000e+00, %0 ], [ %33, %34 ]
  %.02831 = phi i32 [ 1, %0 ], [ %35, %34 ]
  %.02930 = phi double [ 0.000000e+00, %0 ], [ %15, %34 ]
  %14 = load double, ptr @one, align 8
  %15 = fadd double %.02930, %14
  ...
  %33 = call double @llvm.fmuladd.f64(double %16, double %32, double %.032)
  br label %34

34:                                               ; preds = %13
  %35 = add nsw i32 %.02831, 1
  %36 = icmp sle i32 %35, %12
  br i1 %36, label %13, label %37, !llvm.loop !7

37:                                               ; preds = %34
  %.0.lcssa = phi double [ %33, %34 ]
  ...
  %60 = call double @llvm.fmuladd.f64(double %59, double %.0.lcssa, double %58)
