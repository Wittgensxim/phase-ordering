...
26:                                               ; preds = %.lr.ph, %51
  ...
  %37 = fneg double %36
  %38 = call double @llvm.fmuladd.f64(double %35, double %32, double %37)
  %39 = load double, ptr @A4, align 8
  %40 = call double @llvm.fmuladd.f64(double %38, double %32, double %39)
  %41 = load double, ptr @A3, align 8
  %42 = fneg double %41
  %43 = call double @llvm.fmuladd.f64(double %40, double %32, double %42)
  ...
  %49 = call double @llvm.fmuladd.f64(double %47, double %32, double %48)
  %50 = call double @llvm.fmuladd.f64(double %34, double %49, double %33)
...
51:                                               ; preds = %26
  ...
  br i1 %56, label %26, label %._crit_edge, !llvm.loop !7
...
57:                                               ; preds = %._crit_edge, %0
  ...
  %65 = fneg double %64
  %66 = call double @llvm.fmuladd.f64(double %63, double %61, double %65)
  ...
  %73 = call double @llvm.fmuladd.f64(double %71, double %61, double %72)
  %74 = load double, ptr @A1, align 8
  %75 = call double @llvm.fmuladd.f64(double %73, double %61, double %74)
  %76 = load double, ptr @one, align 8
  %77 = call double @llvm.fmuladd.f64(double %75, double %61, double %76)
