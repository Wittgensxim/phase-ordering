...
37:                                               ; preds = %54, %0
  %38 = phi double [ %53, %54 ], [ %.promoted7, %0 ]
  %39 = phi double [ %46, %54 ], [ %.promoted5, %0 ]
  %40 = phi double [ %45, %54 ], [ %.promoted3, %0 ]
  %41 = phi double [ %44, %54 ], [ %.promoted1, %0 ]
  %42 = phi i32 [ %55, %54 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %42, %smax
  br i1 %exitcond, label %43, label %56

43:                                               ; preds = %37
  %44 = fadd double %41, %26
  %45 = fmul double %44, %27
  %46 = fmul double %45, %45
  %47 = call double @llvm.fmuladd.f64(double %28, double %46, double %30)
  %48 = call double @llvm.fmuladd.f64(double %47, double %46, double %31)
  %49 = call double @llvm.fmuladd.f64(double %48, double %46, double %33)
  %50 = call double @llvm.fmuladd.f64(double %49, double %46, double %34)
  %51 = call double @llvm.fmuladd.f64(double %50, double %46, double %35)
  %52 = call double @llvm.fmuladd.f64(double %51, double %46, double %36)
  %53 = call double @llvm.fmuladd.f64(double %45, double %52, double %38)
  br label %54
