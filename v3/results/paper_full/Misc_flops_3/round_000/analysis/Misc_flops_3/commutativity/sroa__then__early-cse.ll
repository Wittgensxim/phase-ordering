...
10:                                               ; preds = %32, %0
  %.029 = phi double [ 0.000000e+00, %0 ], [ %14, %32 ]
  %.028 = phi i32 [ 1, %0 ], [ %33, %32 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %31, %32 ]
...
12:                                               ; preds = %10
  ...
  %30 = call double @llvm.fmuladd.f64(double %29, double %16, double %13)
  %31 = call double @llvm.fmuladd.f64(double %15, double %30, double %.0)
  br label %32

32:                                               ; preds = %12
  %33 = add nsw i32 %.028, 1
  br label %10, !llvm.loop !7

34:                                               ; preds = %10
  %35 = load double, ptr @piref, align 8
  %36 = load double, ptr @three, align 8
  %37 = fdiv double %35, %36
  %38 = fmul double %37, %37
  %39 = load double, ptr @A6, align 8
  %40 = load double, ptr @A5, align 8
  %41 = fneg double %40
  %42 = call double @llvm.fmuladd.f64(double %39, double %38, double %41)
  %43 = load double, ptr @A4, align 8
  %44 = call double @llvm.fmuladd.f64(double %42, double %38, double %43)
  %45 = load double, ptr @A3, align 8
  %46 = fneg double %45
  %47 = call double @llvm.fmuladd.f64(double %44, double %38, double %46)
  %48 = load double, ptr @A2, align 8
  %49 = call double @llvm.fmuladd.f64(double %47, double %38, double %48)
  %50 = load double, ptr @A1, align 8
  %51 = call double @llvm.fmuladd.f64(double %49, double %38, double %50)
  %52 = load double, ptr @one, align 8
  %53 = call double @llvm.fmuladd.f64(double %51, double %38, double %52)
  %54 = fmul double %37, %53
  store double %54, ptr @sa, align 8
  %55 = load double, ptr @two, align 8
  %56 = call double @llvm.fmuladd.f64(double %55, double %.0, double %54)
  %57 = fmul double %9, %56
