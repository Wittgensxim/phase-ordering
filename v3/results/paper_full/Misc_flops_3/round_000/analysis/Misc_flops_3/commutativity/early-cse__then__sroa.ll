...
12:                                               ; preds = %36, %0
  %.011 = phi double [ 0.000000e+00, %0 ], [ %17, %36 ]
  %.010 = phi i32 [ 1, %0 ], [ %37, %36 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %35, %36 ]
  %13 = sub nsw i32 %6, 1
  %14 = icmp sle i32 %.010, %13
...
15:                                               ; preds = %12
  ...
  %35 = call double @llvm.fmuladd.f64(double %18, double %34, double %.0)
  br label %36

36:                                               ; preds = %15
  %37 = add nsw i32 %.010, 1
