...
5:                                                ; preds = %8, %0
  %.02 = phi double [ 0.000000e+00, %0 ], [ %10, %8 ]
  %.01 = phi double [ 0.000000e+00, %0 ], [ %28, %8 ]
  %.0 = phi i32 [ 1, %0 ], [ %29, %8 ]
  %6 = icmp samesign ult i32 %.0, 312500000
...
8:                                                ; preds = %7
  ...
  %28 = call double @llvm.fmuladd.f64(double %11, double %27, double %.01)
