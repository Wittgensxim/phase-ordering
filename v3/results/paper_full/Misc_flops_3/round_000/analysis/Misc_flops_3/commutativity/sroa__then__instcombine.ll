...
5:                                                ; preds = %8, %0
  %.029 = phi double [ 0.000000e+00, %0 ], [ %10, %8 ]
  %.028 = phi i32 [ 1, %0 ], [ %29, %8 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %28, %8 ]
  %6 = icmp samesign ult i32 %.028, 312500000
...
8:                                                ; preds = %7
  ...
  %18 = call double @llvm.fmuladd.f64(double %16, double %13, double %17)
  %19 = load double, ptr @A3, align 8
  %20 = fneg double %19
  %21 = call double @llvm.fmuladd.f64(double %18, double %13, double %20)
  %22 = load double, ptr @A2, align 8
  %23 = call double @llvm.fmuladd.f64(double %21, double %13, double %22)
  %24 = load double, ptr @A1, align 8
  %25 = call double @llvm.fmuladd.f64(double %23, double %13, double %24)
  %26 = load double, ptr @one, align 8
  %27 = call double @llvm.fmuladd.f64(double %25, double %13, double %26)
...
30:                                               ; preds = %5
  ...
  %32 = load double, ptr @three, align 8
