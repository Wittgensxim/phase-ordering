...
20:                                               ; preds = %0, %20
  %21 = phi i32 [ 1, %0 ], [ %43, %20 ]
  %22 = phi double [ 0.000000e+00, %0 ], [ %42, %20 ]
  %23 = phi double [ 0.000000e+00, %0 ], [ %25, %20 ]
  ...
  %30 = fneg double %29
  %31 = call double @llvm.fmuladd.f64(double %28, double %27, double %30)
  %32 = load double, ptr @A4, align 8
  %33 = call double @llvm.fmuladd.f64(double %31, double %27, double %32)
  %34 = load double, ptr @A3, align 8
  %35 = fneg double %34
  %36 = call double @llvm.fmuladd.f64(double %33, double %27, double %35)
  ...
  %41 = call double @llvm.fmuladd.f64(double %40, double %27, double %24)
  %42 = call double @llvm.fmuladd.f64(double %26, double %41, double %22)
  store double %42, ptr %2, align 8
  %43 = add nsw i32 %21, 1
  store i32 %43, ptr %9, align 4
  %44 = icmp sle i32 %43, 312499999
  br i1 %44, label %20, label %45, !llvm.loop !7

45:                                               ; preds = %20
  %.lcssa = phi double [ %42, %20 ]
  %46 = fdiv double %16, %17
