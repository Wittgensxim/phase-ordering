...
27:                                               ; preds = %34, %0
  %28 = phi double [ %44, %34 ], [ %.promoted7, %0 ]
  %29 = phi double [ %37, %34 ], [ %.promoted5, %0 ]
  %30 = phi double [ %36, %34 ], [ %.promoted3, %0 ]
  %31 = phi double [ %35, %34 ], [ %.promoted1, %0 ]
  %32 = phi i32 [ %45, %34 ], [ %.promoted, %0 ]
  %.not.not = icmp slt i32 %32, %16
...
34:                                               ; preds = %33
  %35 = fadd double %31, %17
  %36 = fmul double %35, %15
  %37 = fmul double %36, %36
  %38 = call double @llvm.fmuladd.f64(double %18, double %37, double %20)
  %39 = call double @llvm.fmuladd.f64(double %38, double %37, double %21)
  %40 = call double @llvm.fmuladd.f64(double %39, double %37, double %23)
  %41 = call double @llvm.fmuladd.f64(double %40, double %37, double %24)
  %42 = call double @llvm.fmuladd.f64(double %41, double %37, double %25)
  %43 = call double @llvm.fmuladd.f64(double %42, double %37, double %26)
  %44 = call double @llvm.fmuladd.f64(double %36, double %43, double %28)
  %45 = add nsw i32 %32, 1
