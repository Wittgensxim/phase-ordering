...
15:                                               ; preds = %17, %0
  %storemerge = phi i32 [ 1, %0 ], [ %44, %17 ]
  store i32 %storemerge, ptr %6, align 4
  %16 = load i32, ptr %7, align 4
  %.not.not = icmp slt i32 %storemerge, %16
  br i1 %.not.not, label %17, label %45
...
17:                                               ; preds = %15
  ...
  %36 = call double @llvm.fmuladd.f64(double %34, double %31, double %35)
  %37 = load double, ptr @A1, align 8
  %38 = call double @llvm.fmuladd.f64(double %36, double %31, double %37)
  %39 = load double, ptr %3, align 8
  %40 = load double, ptr @one, align 8
  %41 = call double @llvm.fmuladd.f64(double %38, double %39, double %40)
  %42 = call double @llvm.fmuladd.f64(double %22, double %41, double %24)
...
45:                                               ; preds = %15
  ...
  %52 = fneg double %51
  %53 = call double @llvm.fmuladd.f64(double %50, double %49, double %52)
  %54 = load double, ptr @A4, align 8
  %55 = call double @llvm.fmuladd.f64(double %53, double %49, double %54)
