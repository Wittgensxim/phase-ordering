...
define dso_local i32 @main() #0 {
  ...
  %8 = fmul double %7, 3.125000e+08
  %9 = fdiv double %6, %8
  br label %10

10:                                               ; preds = %33, %0
  %.029 = phi double [ 0.000000e+00, %0 ], [ %14, %33 ]
  %.028 = phi i32 [ 1, %0 ], [ %34, %33 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %32, %33 ]
  %11 = icmp sle i32 %.028, 312499999
  br i1 %11, label %12, label %35

12:                                               ; preds = %10
  %13 = load double, ptr @one, align 8
  %14 = fadd double %.029, %13
  %15 = fmul double %14, %9
  %16 = fmul double %15, %15
  %17 = load double, ptr @A6, align 8
  %18 = load double, ptr @A5, align 8
  %19 = fneg double %18
  %20 = call double @llvm.fmuladd.f64(double %17, double %16, double %19)
  %21 = load double, ptr @A4, align 8
  %22 = call double @llvm.fmuladd.f64(double %20, double %16, double %21)
  %23 = load double, ptr @A3, align 8
  %24 = fneg double %23
  %25 = call double @llvm.fmuladd.f64(double %22, double %16, double %24)
  ...
  %31 = call double @llvm.fmuladd.f64(double %29, double %16, double %30)
  %32 = call double @llvm.fmuladd.f64(double %15, double %31, double %.0)
  br label %33

33:                                               ; preds = %12
  %34 = add nsw i32 %.028, 1
  br label %10, !llvm.loop !7

35:                                               ; preds = %10
  %36 = load double, ptr @piref, align 8
  %37 = load double, ptr @three, align 8
  ...
  %58 = call double @llvm.fmuladd.f64(double %57, double %.0, double %56)
  %59 = fmul double %9, %58
  ...
  %63 = load double, ptr @sb, align 8
  %64 = fsub double %62, %63
  store double %64, ptr @sc, align 8
  %65 = load double, ptr @sc, align 8
  %66 = fmul double %65, 1.000000e-30
  %67 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %66, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
