...
14:                                               ; preds = %40, %0
  ...
  br i1 %.not.not, label %16, label %43
...
16:                                               ; preds = %14
  ...
  %31 = fneg double %30
  %32 = call double @llvm.fmuladd.f64(double %29, double %22, double %31)
  %33 = load double, ptr @A2, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %22, double %33)
  %35 = load double, ptr @A1, align 8
  %36 = call double @llvm.fmuladd.f64(double %34, double %22, double %35)
  %37 = load double, ptr @one, align 8
  %38 = call double @llvm.fmuladd.f64(double %36, double %22, double %37)
  %39 = call double @llvm.fmuladd.f64(double %21, double %38, double %23)
