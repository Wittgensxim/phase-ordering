...
13:                                               ; preds = %0, %34
  %.05 = phi i32 [ 1, %0 ], [ %35, %34 ]
  %.014 = phi double [ 0.000000e+00, %0 ], [ %33, %34 ]
  %.023 = phi double [ 0.000000e+00, %0 ], [ %15, %34 ]
  %14 = load double, ptr @one, align 8
  %15 = fadd double %.023, %14
  ...
  %33 = call double @llvm.fmuladd.f64(double %16, double %32, double %.014)
  br label %34
