...
29:                                               ; preds = %5
  ...
  %34 = fneg double %33
  %35 = call double @llvm.fmuladd.f64(double %32, double %31, double %34)
  %36 = load double, ptr @A4, align 8
  %37 = call double @llvm.fmuladd.f64(double %35, double %31, double %36)
  %38 = load double, ptr @A3, align 8
  %39 = fneg double %38
  %40 = call double @llvm.fmuladd.f64(double %37, double %31, double %39)
  %41 = load double, ptr @A2, align 8
  %42 = call double @llvm.fmuladd.f64(double %40, double %31, double %41)
  %43 = load double, ptr @A1, align 8
  %44 = call double @llvm.fmuladd.f64(double %42, double %31, double %43)
  %45 = load double, ptr @one, align 8
  %46 = call double @llvm.fmuladd.f64(double %44, double %31, double %45)
  %47 = fmul double %30, %46
  store double %47, ptr @sa, align 8
  %48 = load double, ptr @two, align 8
  %49 = call double @llvm.fmuladd.f64(double %48, double %.lcssa, double %47)
  %50 = fmul double %4, %49
