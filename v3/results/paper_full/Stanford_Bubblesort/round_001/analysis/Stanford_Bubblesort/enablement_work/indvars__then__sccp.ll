...
1:                                                ; preds = %15, %0
  ...
  br i1 %exitcond, label %2, label %16
...
2:                                                ; preds = %15, %1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %15 ], [ 500, %1 ]
...
6:                                                ; preds = %14, %5
  ...
  br i1 %exitcond, label %7, label %15
...
16:                                               ; preds = %2
  %17 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %18 = load i32, ptr @littlest, align 4
  %.not = icmp eq i32 %17, %18
  br i1 %.not, label %19, label %22

19:                                               ; preds = %16
  %20 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
  %21 = load i32, ptr @biggest, align 4
...
23:                                               ; preds = %22, %19
  ...
  %28 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %27) #3
  ret void
}
