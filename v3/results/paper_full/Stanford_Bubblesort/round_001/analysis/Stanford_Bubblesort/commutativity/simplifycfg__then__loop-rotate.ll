...
.preheader:                                       ; preds = %1, %15
  %storemerge1 = phi i32 [ 500, %1 ], [ %16, %15 ]
  br label %2

2:                                                ; preds = %.preheader, %13
  %3 = phi i32 [ 1, %.preheader ], [ %7, %13 ]
...
13:                                               ; preds = %12, %2
  %14 = icmp slt i32 %7, %storemerge1
  br i1 %14, label %2, label %15, !llvm.loop !9

15:                                               ; preds = %13
  %16 = add nsw i32 %storemerge1, -1
  store i32 %16, ptr @top, align 4
  %17 = icmp sgt i32 %16, 1
  br i1 %17, label %.preheader, label %18, !llvm.loop !10

18:                                               ; preds = %15
  %19 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %20 = load i32, ptr @littlest, align 4
  %.not = icmp eq i32 %19, %20
  br i1 %.not, label %21, label %24

21:                                               ; preds = %18
  %22 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
...
25:                                               ; preds = %24, %21
  ...
  %30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %29) #3
  ret void
}
