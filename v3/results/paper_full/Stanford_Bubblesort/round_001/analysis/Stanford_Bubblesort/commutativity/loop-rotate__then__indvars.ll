...
1:                                                ; preds = %0, %14
  %indvars.iv = phi i64 [ 1, %0 ], [ %indvars.iv.next, %14 ]
  %2 = call i32 @Rand()
  %.fr = freeze i32 %2
...
2:                                                ; preds = %1, %11
  %indvars.iv3 = phi i64 [ 500, %1 ], [ %indvars.iv.next4, %11 ]
  br label %3
...
11:                                               ; preds = %10
  ...
  %12 = trunc nuw nsw i64 %indvars.iv.next4 to i32
  store i32 %12, ptr @top, align 4
  %13 = icmp samesign ugt i64 %indvars.iv.next4, 1
