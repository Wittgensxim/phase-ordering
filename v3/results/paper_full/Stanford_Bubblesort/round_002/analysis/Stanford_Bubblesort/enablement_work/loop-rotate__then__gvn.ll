...
.preheader:                                       ; preds = %1, %11
  %indvars.iv22 = phi i64 [ 500, %1 ], [ %indvars.iv.next3, %11 ]
  %.pre = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  br label %2

2:                                                ; preds = %.preheader, %9
  %3 = phi i32 [ %.pre, %.preheader ], [ %10, %9 ]
  %indvars.iv1 = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %9 ]
  %4 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
...
9:                                                ; preds = %8, %2
  %10 = phi i32 [ %3, %8 ], [ %6, %2 ]
  %exitcond = icmp ne i64 %indvars.iv.next, %indvars.iv22
  br i1 %exitcond, label %2, label %11, !llvm.loop !9
...
11:                                               ; preds = %9
  ...
  br i1 %13, label %.preheader, label %14, !llvm.loop !10
