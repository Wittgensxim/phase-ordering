; ModuleID = 'results\paper_full\Stanford_Bubblesort\round_001\output.ll'
...
.preheader:                                       ; preds = %1, %28
  %indvar = phi i64 [ 0, %1 ], [ %indvar.next, %28 ]
