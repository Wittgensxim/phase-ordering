...
13:                                               ; preds = %12, %6
  ...
  %15 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
...
22:                                               ; preds = %.epil.preheader
  %23 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1.epil.init
...
.epilog-lcssa:                                    ; preds = %27, %22
  br label %28

28:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  %indvars.iv.next3 = add nsw i64 %indvars.iv22, -1
  %29 = trunc nuw nsw i64 %indvars.iv.next3 to i32
  %30 = icmp samesign ugt i64 %indvars.iv.next3, 1
