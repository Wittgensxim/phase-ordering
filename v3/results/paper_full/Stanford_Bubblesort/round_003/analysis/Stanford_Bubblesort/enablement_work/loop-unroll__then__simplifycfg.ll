...
13:                                               ; preds = %12, %9, %8
  ...
  br i1 %exitcond, label %1, label %14, !llvm.loop !7
...
6:                                                ; preds = %20, %.preheader.new
  ...
  %7 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1
...
13:                                               ; preds = %12, %6
  %14 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
...
20:                                               ; preds = %19, %13
  ...
  br i1 %niter.ncmp.1, label %6, label %.unr-lcssa, !llvm.loop !9
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader
  ...
  %21 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1.epil.init
  %22 = load i32, ptr %21, align 4
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv1.epil.init, 1
  %23 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next.epil
...
.epilog-lcssa:                                    ; preds = %.epil.preheader, %26, %.unr-lcssa
  %indvars.iv.next3 = add nsw i64 %indvars.iv22, -1
  %27 = trunc nuw nsw i64 %indvars.iv.next3 to i32
  %28 = icmp samesign ugt i64 %indvars.iv.next3, 1
  %indvar.next = add i64 %indvar, 1
  br i1 %28, label %.preheader, label %29, !llvm.loop !10

29:                                               ; preds = %.epilog-lcssa
  %.lcssa = phi i32 [ %27, %.epilog-lcssa ]
...
36:                                               ; preds = %35, %32
  ...
  %41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %40) #4
  ret void
}
