...
.preheader:                                       ; preds = %27, %1
  ...
  %indvars.iv22 = phi i64 [ 500, %1 ], [ %indvars.iv.next3, %27 ]
  %2 = mul nsw i64 %indvar, -1
  %3 = add i64 %2, 499
  %4 = add i64 %2, 498
  %xtraiter = and i64 %3, 1
  %5 = icmp ult i64 %4, 1
  br i1 %5, label %.preheader..epil.preheader_crit_edge, label %.preheader.new

.preheader..epil.preheader_crit_edge:             ; preds = %.preheader
...
6:                                                ; preds = %19, %.preheader.new
  ...
  %8 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
...
.unr-lcssa:                                       ; preds = %19
  ...
  br i1 %lcmp.mod, label %.epil.preheader, label %27

.epil.preheader:                                  ; preds = %.preheader..epil.preheader_crit_edge, %.unr-lcssa
  %21 = phi i32 [ %.pre2, %.preheader..epil.preheader_crit_edge ], [ %20, %.unr-lcssa ]
  %indvars.iv1.epil.init = phi i64 [ 1, %.preheader..epil.preheader_crit_edge ], [ %indvars.iv.next.1, %.unr-lcssa ]
