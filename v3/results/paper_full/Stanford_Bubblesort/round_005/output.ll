...
.preheader:                                       ; preds = %26, %1
  %indvar = phi i64 [ %indvar.next, %26 ], [ 0, %1 ]
  %indvars.iv22 = phi i64 [ 500, %1 ], [ %indvars.iv.next3, %26 ]
...
6:                                                ; preds = %19, %.preheader.new
  %7 = phi i32 [ %.pre, %.preheader.new ], [ %20, %19 ]
  %indvars.iv1 = phi i64 [ 1, %.preheader.new ], [ %indvars.iv.next.1, %19 ]
  %niter = phi i64 [ 0, %.preheader.new ], [ %niter.next.1, %19 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
...
.unr-lcssa:                                       ; preds = %19
  ...
  br i1 %lcmp.mod, label %.epil.preheader, label %26

.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader
  %.epil.init = phi i32 [ %.pre, %.preheader ], [ %20, %.unr-lcssa ]
  ...
  %21 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next.epil
  %22 = load i32, ptr %21, align 4
  %23 = icmp sgt i32 %.epil.init, %22
  br i1 %23, label %24, label %.epilog-lcssa

24:                                               ; preds = %.epil.preheader
  %25 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1.epil.init
  store i32 %22, ptr %25, align 4
  store i32 %.epil.init, ptr %21, align 4
  br label %.epilog-lcssa

.epilog-lcssa:                                    ; preds = %24, %.epil.preheader
  br label %26

26:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
