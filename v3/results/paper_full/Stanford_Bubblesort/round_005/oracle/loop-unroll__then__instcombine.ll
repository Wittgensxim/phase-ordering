...
4:                                                ; preds = %18, %.preheader.new
  %5 = phi i32 [ %.pre, %.preheader.new ], [ %19, %18 ]
  %indvars.iv1 = phi i64 [ 1, %.preheader.new ], [ %indvars.iv.next.1, %18 ]
  %niter = phi i64 [ 0, %.preheader.new ], [ %niter.next.1, %18 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
  %6 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
  %7 = load i32, ptr %6, align 4
  %8 = icmp sgt i32 %5, %7
  br i1 %8, label %9, label %11

9:                                                ; preds = %4
  %10 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1
...
11:                                               ; preds = %9, %4
  ...
  %13 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next.1
...
18:                                               ; preds = %16, %11
  %19 = phi i32 [ %12, %16 ], [ %14, %11 ]
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %4, !llvm.loop !9
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader
  %.epil.init = phi i32 [ %.pre, %.preheader ], [ %19, %.unr-lcssa ]
