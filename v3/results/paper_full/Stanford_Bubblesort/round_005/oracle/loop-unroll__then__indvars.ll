...
22:                                               ; preds = %.epil.preheader
  ...
  %25 = icmp sgt i32 %.epil.init, %24
  br i1 %25, label %26, label %.epilog-lcssa

26:                                               ; preds = %22
  %27 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1.epil.init
  store i32 %24, ptr %27, align 4
  store i32 %.epil.init, ptr %23, align 4
  br label %.epilog-lcssa

.epilog-lcssa:                                    ; preds = %26, %22
  br label %28

28:                                               ; preds = %.unr-lcssa, %.epilog-lcssa
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond = icmp ne i64 %indvar.next, 499
  br i1 %exitcond, label %.preheader, label %29, !llvm.loop !10
