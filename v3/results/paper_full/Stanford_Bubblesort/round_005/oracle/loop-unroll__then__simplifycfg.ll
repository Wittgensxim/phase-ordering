; ModuleID = 'results\paper_full\Stanford_Bubblesort\round_004\output.ll'
...
.preheader:                                       ; preds = %.epilog-lcssa, %1
  %indvar = phi i64 [ %indvar.next, %.epilog-lcssa ], [ 0, %1 ]
  %indvars.iv22 = phi i64 [ 500, %1 ], [ %indvars.iv.next3, %.epilog-lcssa ]
  %2 = mul nsw i64 %indvar, -1
  %3 = add i64 %2, 499
  %4 = add i64 %2, 498
  %.pre = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
  %xtraiter = and i64 %3, 1
  %5 = icmp ult i64 %4, 1
  br i1 %5, label %.epil.preheader, label %.preheader.new

.preheader.new:                                   ; preds = %.preheader
  %unroll_iter = sub i64 %3, %xtraiter
  br label %6

6:                                                ; preds = %20, %.preheader.new
  %7 = phi i32 [ %.pre, %.preheader.new ], [ %21, %20 ]
  %indvars.iv1 = phi i64 [ 1, %.preheader.new ], [ %indvars.iv.next.1, %20 ]
  %niter = phi i64 [ 0, %.preheader.new ], [ %niter.next.1, %20 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
...
11:                                               ; preds = %6
  %12 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1
...
18:                                               ; preds = %13
  %19 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next
  store i32 %16, ptr %19, align 4
  store i32 %14, ptr %15, align 4
  br label %20

20:                                               ; preds = %18, %13
  %21 = phi i32 [ %14, %18 ], [ %16, %13 ]
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %6, !llvm.loop !9

.unr-lcssa:                                       ; preds = %20
  %.unr = phi i32 [ %21, %20 ]
  %indvars.iv1.unr = phi i64 [ %indvars.iv.next.1, %20 ]
  %lcmp.mod = icmp ne i64 %xtraiter, 0
  br i1 %lcmp.mod, label %.epil.preheader, label %.epilog-lcssa

.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader
  %.epil.init = phi i32 [ %.pre, %.preheader ], [ %.unr, %.unr-lcssa ]
  %indvars.iv1.epil.init = phi i64 [ 1, %.preheader ], [ %indvars.iv1.unr, %.unr-lcssa ]
  %lcmp.mod1 = icmp ne i64 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod1)
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv1.epil.init, 1
  %22 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv.next.epil
  %23 = load i32, ptr %22, align 4
  %24 = icmp sgt i32 %.epil.init, %23
  br i1 %24, label %25, label %.epilog-lcssa

25:                                               ; preds = %.epil.preheader
  %26 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %indvars.iv1.epil.init
  store i32 %23, ptr %26, align 4
  store i32 %.epil.init, ptr %22, align 4
  br label %.epilog-lcssa

.epilog-lcssa:                                    ; preds = %.epil.preheader, %25, %.unr-lcssa
  %indvars.iv.next3 = add nsw i64 %indvars.iv22, -1
  %27 = icmp sgt i64 %indvars.iv22, 2
  %indvar.next = add i64 %indvar, 1
  br i1 %27, label %.preheader, label %28, !llvm.loop !10

28:                                               ; preds = %.epilog-lcssa
...
35:                                               ; preds = %34, %31
  ...
  %37 = getelementptr [4 x i8], ptr @sortlist, i64 %36
  %38 = getelementptr i8, ptr %37, i64 4
  %39 = load i32, ptr %38, align 4
  %40 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %39) #4
  ret void
}
