...
5:                                                ; preds = %36, %1
  %storemerge2.lcssa5 = phi i32 [ poison, %1 ], [ %storemerge2.lcssa, %36 ]
  %.lcssa4 = phi i32 [ %.promoted3, %1 ], [ %.lcssa, %36 ]
  %storemerge = phi i32 [ 500, %1 ], [ %37, %36 ]
...
8:                                                ; preds = %33, %7
  %9 = phi i32 [ %.lcssa4, %7 ], [ %34, %33 ]
  %storemerge2 = phi i32 [ 1, %7 ], [ %35, %33 ]
  %10 = icmp slt i32 %storemerge2, %storemerge
...
11:                                               ; preds = %8
  ...
  %15 = sext i32 %storemerge2 to i64
...
20:                                               ; preds = %11
  ...
  %31 = getelementptr [4 x i8], ptr @sortlist, i64 %30
  %32 = getelementptr i8, ptr %31, i64 4
  store i32 %23, ptr %32, align 4
  br label %33

33:                                               ; preds = %20, %11
  %34 = phi i32 [ %23, %20 ], [ %9, %11 ]
  %35 = add nsw i32 %storemerge2, 1
  br label %8, !llvm.loop !9

36:                                               ; preds = %8
  %.lcssa = phi i32 [ %9, %8 ]
  %storemerge2.lcssa = phi i32 [ %storemerge2, %8 ]
  %37 = add nsw i32 %storemerge, -1
  br label %5, !llvm.loop !10

38:                                               ; preds = %5
  %storemerge2.lcssa5.lcssa = phi i32 [ %storemerge2.lcssa5, %5 ]
  ...
  store i32 %storemerge2.lcssa5.lcssa, ptr %3, align 4
...
45:                                               ; preds = %44, %41
  ...
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %50) #3
  ret void
}
