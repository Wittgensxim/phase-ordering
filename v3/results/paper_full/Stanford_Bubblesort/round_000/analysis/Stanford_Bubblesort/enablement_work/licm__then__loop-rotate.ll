...
6:                                                ; preds = %.lr.ph, %36
  %7 = phi i32 [ %top.promoted, %.lr.ph ], [ %37, %36 ]
  %.lcssa256 = phi i32 [ %.promoted, %.lr.ph ], [ %.lcssa2, %36 ]
  br label %8

8:                                                ; preds = %6, %32
  %9 = phi i32 [ 1, %6 ], [ %34, %32 ]
  %10 = phi i32 [ %.lcssa256, %6 ], [ %33, %32 ]
...
36:                                               ; preds = %32
  ...
  br i1 %38, label %6, label %._crit_edge, !llvm.loop !10

._crit_edge:                                      ; preds = %36
  %split = phi i32 [ %.lcssa2, %36 ]
  %split7 = phi i32 [ %.lcssa, %36 ]
  br label %39

39:                                               ; preds = %._crit_edge, %1
  %.lcssa25.lcssa = phi i32 [ %split, %._crit_edge ], [ %.promoted, %1 ]
  %.lcssa4.lcssa = phi i32 [ %split7, %._crit_edge ], [ %.promoted3, %1 ]
