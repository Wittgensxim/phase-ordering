...
5:                                                ; preds = %38, %1
  %.lcssa25 = phi i32 [ %.lcssa2, %38 ], [ %.promoted, %1 ]
  %.lcssa4 = phi i32 [ %.lcssa, %38 ], [ %.promoted3, %1 ]
  %6 = phi i32 [ %39, %38 ], [ %top.promoted, %1 ]
  %7 = icmp sgt i32 %6, 1
...
38:                                               ; preds = %9
  %.lcssa2 = phi i32 [ %10, %9 ]
  %.lcssa = phi i32 [ %11, %9 ]
  %39 = sub nuw nsw i32 %6, 1
  store i32 %39, ptr @top, align 4
  br label %5, !llvm.loop !10

40:                                               ; preds = %5
  %.lcssa25.lcssa = phi i32 [ %.lcssa25, %5 ]
