...
15:                                               ; preds = %48, %3
  %16 = phi i32 [ %49, %48 ], [ %2, %3 ]
  %17 = phi i32 [ %50, %48 ], [ %1, %3 ]
  %18 = phi ptr [ %51, %48 ], [ %0, %3 ]
  br label %19
...
48:                                               ; preds = %37, %36
  %49 = phi i32 [ %47, %37 ], [ %29, %36 ]
  %50 = phi i32 [ %46, %37 ], [ %20, %36 ]
  %51 = phi ptr [ %41, %37 ], [ %18, %36 ]
  %.not1 = icmp sgt i32 %50, %49
  br i1 %.not1, label %52, label %15, !llvm.loop !11
...
55:                                               ; preds = %52
  call void @Quicksort(ptr noundef %51, i32 noundef %53, i32 noundef %49)
  %.pre = load i32, ptr %7, align 4
  br label %56

56:                                               ; preds = %55, %52
  %57 = phi i32 [ %.pre, %55 ], [ %50, %52 ]
