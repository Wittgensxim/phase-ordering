...
3:                                                ; preds = %36, %0
  %4 = phi i32 [ %8, %36 ], [ %.promoted1, %0 ]
  %5 = phi i32 [ %37, %36 ], [ %.promoted, %0 ]
...
29:                                               ; preds = %65, %3
  %30 = phi i32 [ %64, %65 ], [ %.promoted8, %3 ]
  %.lcssa26 = phi i32 [ %.lcssa27, %65 ], [ %.promoted, %3 ]
  %.lcssa4 = phi i32 [ %.lcssa5, %65 ], [ %.promoted3, %3 ]
  br label %31
...
65:                                               ; preds = %63
  %66 = icmp sle i32 %.lcssa5, %.lcssa27
  br i1 %66, label %29, label %67, !llvm.loop !11

67:                                               ; preds = %65
  %.lcssa9 = phi i32 [ %64, %65 ]
  %.lcssa27.lcssa = phi i32 [ %.lcssa27, %65 ]
  %.lcssa5.lcssa = phi i32 [ %.lcssa5, %65 ]
