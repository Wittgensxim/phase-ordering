...
16:                                               ; preds = %51, %3
  %17 = phi i32 [ %50, %51 ], [ %.promoted8, %3 ]
  %.lcssa26 = phi i32 [ %.lcssa27, %51 ], [ %.promoted, %3 ]
  %.lcssa4 = phi i32 [ %.lcssa5, %51 ], [ %.promoted3, %3 ]
  br label %18
...
49:                                               ; preds = %36, %35
  ...
  %.lcssa27 = phi i32 [ %48, %36 ], [ %28, %35 ]
  %.lcssa5 = phi i32 [ %47, %36 ], [ %19, %35 ]
  br label %51

51:                                               ; preds = %49
  %.not10 = icmp sgt i32 %.lcssa5, %.lcssa27
  br i1 %.not10, label %52, label %16, !llvm.loop !11

52:                                               ; preds = %51
  store i32 %.lcssa5, ptr %7, align 4
  store i32 %.lcssa27, ptr %8, align 4
  store i32 %50, ptr %9, align 4
  %53 = load i32, ptr %5, align 4
  %54 = icmp slt i32 %53, %.lcssa27
...
55:                                               ; preds = %52
  ...
  call void @Quicksort(ptr noundef %56, i32 noundef %57, i32 noundef %58)
  br label %59
...
63:                                               ; preds = %59
  ...
  call void @Quicksort(ptr noundef %64, i32 noundef %65, i32 noundef %66)
  br label %67
