...
18:                                               ; preds = %18, %17
  %.19 = phi double [ %.lcssa3, %17 ], [ %.19, %18 ]
  %.018 = phi double [ %.lcssa2, %17 ], [ %27, %18 ]
  %.027 = phi double [ 0.000000e+00, %17 ], [ %28, %18 ]
  %.036 = phi double [ 0.000000e+00, %17 ], [ %30, %18 ]
  %.165 = phi i32 [ 1, %17 ], [ %31, %18 ]
  %19 = phi double [ %.lcssa2, %17 ], [ %26, %18 ]
  %20 = fneg double %.19
  %21 = fsub double %19, %.19
  store double %21, ptr @sa, align 8
  %22 = fadd double %.018, %.pre
  ...
  %27 = fadd double %22, %.pre
  %28 = call double @llvm.fmuladd.f64(double %20, double %27, double %23)
  %29 = fdiv double %20, %27
  %30 = fsub double %25, %29
  %31 = add nuw nsw i32 %.165, 2
  %32 = icmp samesign ult i32 %31, 156250001
  br i1 %32, label %18, label %33, !llvm.loop !9

33:                                               ; preds = %18
  %.lcssa1 = phi double [ %28, %18 ]
  %.lcssa = phi double [ %30, %18 ]
  %34 = load double, ptr @four, align 8
  %35 = fmul double %34, %.lcssa
  %36 = fdiv double %35, %1
  store double %36, ptr @sa, align 8
  %37 = fdiv double %1, %.lcssa1
  %38 = fadd double %36, %37
  store double %38, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %39 = fmul double %.lcssa1, %.lcssa1
  %40 = fmul double %39, %.lcssa1
  %41 = fdiv double 3.125000e+01, %40
  %42 = fsub double %38, %41
  store double %42, ptr @piprg, align 8
  %43 = load double, ptr @piref, align 8
  %44 = fsub double %42, %43
  store double %44, ptr @pierr, align 8
