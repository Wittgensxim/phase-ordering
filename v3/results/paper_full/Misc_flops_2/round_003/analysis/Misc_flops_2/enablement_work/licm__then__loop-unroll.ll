...
5:                                                ; preds = %5, %0
  ...
  %16 = fneg double %.04
  %17 = fsub double %15, %.04
  %18 = fsub double %17, %16
  %19 = add nuw nsw i32 %.051, 8
  %20 = icmp samesign ult i32 %19, 156250001
  br i1 %20, label %5, label %21, !llvm.loop !7

21:                                               ; preds = %5
  %.lcssa4 = phi double [ %18, %5 ]
  %.lcssa3 = phi double [ %.04, %5 ]
  %.lcssa2 = phi double [ %18, %5 ]
...
23:                                               ; preds = %23, %21
  %.19 = phi double [ %.lcssa3, %21 ], [ %.19, %23 ]
  %.018 = phi double [ %.lcssa2, %21 ], [ %32, %23 ]
  %.027 = phi double [ 0.000000e+00, %21 ], [ %33, %23 ]
  %.036 = phi double [ 0.000000e+00, %21 ], [ %35, %23 ]
  %.165 = phi i32 [ 1, %21 ], [ %36, %23 ]
  %24 = phi double [ %.lcssa2, %21 ], [ %31, %23 ]
  %25 = fneg double %.19
  %26 = fsub double %24, %.19
  %27 = fadd double %.018, %22
  %28 = call double @llvm.fmuladd.f64(double %.19, double %27, double %.027)
  %29 = fdiv double %.19, %27
  %30 = fsub double %.036, %29
  %31 = fsub double %26, %25
  %32 = fadd double %27, %22
  %33 = call double @llvm.fmuladd.f64(double %25, double %32, double %28)
  %34 = fdiv double %25, %32
  %35 = fsub double %30, %34
  %36 = add nuw nsw i32 %.165, 2
  %37 = icmp samesign ult i32 %36, 156250001
  br i1 %37, label %23, label %38, !llvm.loop !9

38:                                               ; preds = %23
  %.lcssa5 = phi double [ %31, %23 ]
  %.lcssa1 = phi double [ %33, %23 ]
  %.lcssa = phi double [ %35, %23 ]
  store double %.lcssa5, ptr @sa, align 8
  %39 = load double, ptr @four, align 8
  %40 = fmul double %39, %.lcssa
  %41 = fdiv double %40, %1
  store double %41, ptr @sa, align 8
  %42 = fdiv double %1, %.lcssa1
  %43 = fadd double %41, %42
  store double %43, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %44 = fmul double %.lcssa1, %.lcssa1
  %45 = fmul double %44, %.lcssa1
