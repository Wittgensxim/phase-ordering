...
5:                                                ; preds = %5, %0
  ...
  %10 = fadd double %9, %.04
  %11 = fneg double %.04
  %12 = fsub double %10, %.04
  store double %12, ptr @sa, align 8
  %13 = add nuw nsw i32 %.051, 5
  %14 = icmp samesign ult i32 %.051, 156249996
...
16:                                               ; preds = %16, %15
  %.018 = phi double [ %12, %15 ], [ %25, %16 ]
  %.027 = phi double [ 0.000000e+00, %15 ], [ %26, %16 ]
  %.036 = phi double [ 0.000000e+00, %15 ], [ %28, %16 ]
  %.165 = phi i32 [ 1, %15 ], [ %29, %16 ]
  %17 = phi double [ %12, %15 ], [ %24, %16 ]
  %18 = fadd double %17, %.04
  store double %18, ptr @sa, align 8
  %19 = load double, ptr @two, align 8
  %20 = fadd double %.018, %19
  %21 = call double @llvm.fmuladd.f64(double %11, double %20, double %.027)
  %22 = fdiv double %.04, %20
  %23 = fadd double %.036, %22
  %24 = fsub double %18, %.04
  store double %24, ptr @sa, align 8
  %25 = fadd double %20, %19
  %26 = call double @llvm.fmuladd.f64(double %.04, double %25, double %21)
  %27 = fdiv double %.04, %25
  %28 = fsub double %23, %27
  %29 = add nuw nsw i32 %.165, 2
  %30 = icmp samesign ult i32 %.165, 156249999
  br i1 %30, label %16, label %31, !llvm.loop !9
