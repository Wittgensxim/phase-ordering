...
17:                                               ; preds = %5
  ...
  %18 = fneg double %.lcssa3
  %19 = load double, ptr @two, align 8
  br label %20

20:                                               ; preds = %20, %17
  %.018 = phi double [ %.lcssa2, %17 ], [ %28, %20 ]
  %.027 = phi double [ 0.000000e+00, %17 ], [ %29, %20 ]
  %.036 = phi double [ 0.000000e+00, %17 ], [ %31, %20 ]
  %.165 = phi i32 [ 1, %17 ], [ %32, %20 ]
  %21 = phi double [ %.lcssa2, %17 ], [ %27, %20 ]
  %22 = fsub double %21, %.lcssa3
  %23 = fadd double %.018, %19
  %24 = call double @llvm.fmuladd.f64(double %.lcssa3, double %23, double %.027)
  %25 = fdiv double %.lcssa3, %23
  %26 = fsub double %.036, %25
  %27 = fsub double %22, %18
  %28 = fadd double %23, %19
  %29 = call double @llvm.fmuladd.f64(double %18, double %28, double %24)
  %30 = fdiv double %18, %28
...
34:                                               ; preds = %20
  %.lcssa5 = phi double [ %27, %20 ]
  %.lcssa1 = phi double [ %29, %20 ]
  %.lcssa = phi double [ %31, %20 ]
