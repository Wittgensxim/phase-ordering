...
22:                                               ; preds = %34, %19
  %.032 = phi double [ 0.000000e+00, %19 ], [ %31, %34 ]
  %.031 = phi double [ 0.000000e+00, %19 ], [ %33, %34 ]
  %.029 = phi double [ %21, %19 ], [ %29, %34 ]
  %.128 = phi double [ %.027, %19 ], [ %25, %34 ]
...
24:                                               ; preds = %22
  ...
  %30 = fneg double %25
  %31 = call double @llvm.fmuladd.f64(double %30, double %29, double %.032)
  %32 = fdiv double %25, %29
  %33 = fadd double %.031, %32
  br label %34
