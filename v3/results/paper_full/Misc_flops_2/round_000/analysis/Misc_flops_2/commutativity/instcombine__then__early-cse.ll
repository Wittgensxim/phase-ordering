...
28:                                               ; preds = %50, %25
  %storemerge3 = phi i32 [ 1, %25 ], [ %52, %50 ]
  store i32 %storemerge3, ptr %7, align 4
  %29 = load i32, ptr %8, align 4
  %.not4 = icmp sgt i32 %storemerge3, %29
  br i1 %.not4, label %53, label %30
...
30:                                               ; preds = %28
  ...
  %44 = fneg double %39
  %45 = call double @llvm.fmuladd.f64(double %44, double %43, double %42)
...
53:                                               ; preds = %28
  ...
  %60 = load double, ptr @four, align 8
  ...
  %70 = fdiv double 3.125000e+01, %69
  %71 = fsub double %67, %70
  store double %71, ptr @piprg, align 8
  %72 = load double, ptr @piref, align 8
  %73 = fsub double %71, %72
  store double %73, ptr @pierr, align 8
