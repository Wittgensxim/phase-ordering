...
define dso_local i32 @main() #0 {
  ...
  store i32 156250000, ptr %8, align 4
...
13:                                               ; preds = %17, %0
  %14 = phi double [ %12, %0 ], [ %19, %17 ]
  %15 = phi double [ %10, %0 ], [ %18, %17 ]
  %16 = phi i32 [ 1, %0 ], [ %20, %17 ]
  store i32 %16, ptr %7, align 4
  %.not = icmp sgt i32 %16, 156250000
  br i1 %.not, label %21, label %17

17:                                               ; preds = %13
  %18 = fneg double %15
  store double %18, ptr %1, align 8
  %19 = fsub double %14, %15
...
22:                                               ; preds = %30, %21
  %23 = phi double [ 0.000000e+00, %21 ], [ %39, %30 ]
  %24 = phi double [ 0.000000e+00, %21 ], [ %37, %30 ]
  %25 = phi double [ 0.000000e+00, %21 ], [ %36, %30 ]
  %26 = phi double [ %14, %21 ], [ %34, %30 ]
  %27 = phi double [ %14, %21 ], [ %32, %30 ]
  %28 = phi double [ %15, %21 ], [ %31, %30 ]
  %29 = phi i32 [ 1, %21 ], [ %40, %30 ]
  store i32 %29, ptr %7, align 4
  %.not4 = icmp sgt i32 %29, 156250000
  br i1 %.not4, label %41, label %30

30:                                               ; preds = %22
  %31 = fneg double %28
  store double %31, ptr %1, align 8
  %32 = fsub double %27, %28
  ...
  %37 = call double @llvm.fmuladd.f64(double %28, double %34, double %24)
  store double %37, ptr %3, align 8
  %38 = fdiv double %31, %34
...
41:                                               ; preds = %22
  %42 = fmul double %27, %25
  %43 = fdiv double %42, 1.562500e+08
  %44 = fptosi double %43 to i32
  store i32 %44, ptr %8, align 4
  %45 = load double, ptr @four, align 8
  %46 = fmul double %45, %23
  %47 = fdiv double %46, %9
  ...
  %50 = fmul double %24, %24
  %51 = fmul double %50, %24
  ...
  %57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %56, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
