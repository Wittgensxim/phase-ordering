...
21:                                               ; preds = %34, %17
  %.16 = phi i32 [ 1, %17 ], [ %35, %34 ]
  %.04 = phi double [ 0.000000e+00, %17 ], [ %29, %34 ]
  %.03 = phi double [ 0.000000e+00, %17 ], [ %33, %34 ]
  %.02 = phi double [ 0.000000e+00, %17 ], [ %31, %34 ]
  %.01 = phi double [ %20, %17 ], [ %27, %34 ]
  %.1 = phi double [ %.0.lcssa, %17 ], [ %23, %34 ]
  %exitcond7 = icmp ne i32 %.16, 156250001
  br i1 %exitcond7, label %22, label %36
...
22:                                               ; preds = %21
  ...
  %30 = fneg double %23
  %31 = call double @llvm.fmuladd.f64(double %30, double %27, double %.02)
