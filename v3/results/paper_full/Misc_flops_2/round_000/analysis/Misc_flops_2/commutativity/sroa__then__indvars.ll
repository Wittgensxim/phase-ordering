...
10:                                               ; preds = %15, %0
  %.027 = phi double [ %7, %0 ], [ %12, %15 ]
  %.0 = phi i32 [ 1, %0 ], [ %16, %15 ]
  %exitcond = icmp ne i32 %.0, 156250001
...
17:                                               ; preds = %10
  %.027.lcssa = phi double [ %.027, %10 ]
  %18 = mul nsw i32 15625, 10000
...
21:                                               ; preds = %34, %17
  %.032 = phi double [ 0.000000e+00, %17 ], [ %31, %34 ]
  %.031 = phi double [ 0.000000e+00, %17 ], [ %33, %34 ]
  %.030 = phi double [ 0.000000e+00, %17 ], [ %29, %34 ]
  %.029 = phi double [ %20, %17 ], [ %27, %34 ]
  %.128 = phi double [ %.027.lcssa, %17 ], [ %23, %34 ]
  %.1 = phi i32 [ 1, %17 ], [ %35, %34 ]
  %exitcond33 = icmp ne i32 %.1, 156250001
  br i1 %exitcond33, label %22, label %36
...
22:                                               ; preds = %21
  ...
  %27 = fadd double %.029, %26
  %28 = fsub double %23, %27
  %29 = fadd double %.030, %28
  %30 = fneg double %23
  %31 = call double @llvm.fmuladd.f64(double %30, double %27, double %.032)
  %32 = fdiv double %23, %27
...
36:                                               ; preds = %21
  %.032.lcssa = phi double [ %.032, %21 ]
  %.031.lcssa = phi double [ %.031, %21 ]
  %.030.lcssa = phi double [ %.030, %21 ]
