...
20:                                               ; preds = %33, %18
  %.032 = phi double [ 0.000000e+00, %18 ], [ %30, %33 ]
  %.031 = phi double [ 0.000000e+00, %18 ], [ %32, %33 ]
  %.030 = phi double [ 0.000000e+00, %18 ], [ %29, %33 ]
  %.029 = phi double [ %19, %18 ], [ %27, %33 ]
  %.128 = phi double [ %.027, %18 ], [ %23, %33 ]
  %.1 = phi i32 [ 1, %18 ], [ %34, %33 ]
  %21 = icmp sle i32 %.1, 156250000
...
22:                                               ; preds = %20
  ...
  %30 = call double @llvm.fmuladd.f64(double %.128, double %27, double %.032)
  %31 = fdiv double %23, %27
  %32 = fadd double %.031, %31
  br label %33
