...
define dso_local i32 @main() #0 {
  ...
  %puts33 = call i32 @puts(ptr nonnull dereferenceable(1) @str.1)
...
5:                                                ; preds = %10, %0
  %.027 = phi double [ %2, %0 ], [ %11, %10 ]
  %.0 = phi i32 [ 1, %0 ], [ %12, %10 ]
  %6 = icmp samesign ult i32 %.0, 156250001
...
15:                                               ; preds = %20, %13
  %.032 = phi double [ 0.000000e+00, %13 ], [ %26, %20 ]
  %.031 = phi double [ 0.000000e+00, %13 ], [ %25, %20 ]
  %.029 = phi double [ %14, %13 ], [ %22, %20 ]
  %.128 = phi double [ %.027, %13 ], [ %23, %20 ]
  %.1 = phi i32 [ 1, %13 ], [ %27, %20 ]
  %16 = icmp samesign ult i32 %.1, 156250001
  br i1 %16, label %17, label %28

17:                                               ; preds = %15
  %18 = load double, ptr @sa, align 8
  %19 = fsub double %18, %.128
  store double %19, ptr @sa, align 8
  br label %20

20:                                               ; preds = %17
  %21 = load double, ptr @two, align 8
  %22 = fadd double %.029, %21
  %23 = fneg double %.128
  %24 = fdiv double %.128, %22
  %25 = fsub double %.031, %24
  %26 = call double @llvm.fmuladd.f64(double %.128, double %22, double %.032)
  %27 = add nuw nsw i32 %.1, 1
  br label %15, !llvm.loop !9

28:                                               ; preds = %15
  %29 = load double, ptr @four, align 8
  %30 = fmul double %29, %.031
  %31 = load double, ptr @five, align 8
  %32 = fdiv double %30, %31
  store double %32, ptr @sa, align 8
  %33 = fdiv double %31, %.032
  %34 = fadd double %32, %33
  store double %34, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %35 = fmul double %.032, %.032
  %36 = fmul double %35, %.032
