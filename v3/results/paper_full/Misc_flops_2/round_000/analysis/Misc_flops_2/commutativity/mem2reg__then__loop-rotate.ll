...
11:                                               ; preds = %0, %15
  %.08 = phi double [ %8, %0 ], [ %12, %15 ]
  %.057 = phi i32 [ 1, %0 ], [ %16, %15 ]
  %12 = fneg double %.08
...
21:                                               ; preds = %18, %33
  %.114 = phi double [ %.0.lcssa, %18 ], [ %22, %33 ]
  %.0113 = phi double [ %20, %18 ], [ %26, %33 ]
  %.0212 = phi double [ 0.000000e+00, %18 ], [ %30, %33 ]
  %.0311 = phi double [ 0.000000e+00, %18 ], [ %32, %33 ]
  %.0410 = phi double [ 0.000000e+00, %18 ], [ %28, %33 ]
  %.169 = phi i32 [ 1, %18 ], [ %34, %33 ]
  %22 = fneg double %.114
  %23 = load double, ptr @sa, align 8
  %24 = fadd double %23, %22
  store double %24, ptr @sa, align 8
  %25 = load double, ptr @two, align 8
  %26 = fadd double %.0113, %25
  %27 = fsub double %22, %26
  %28 = fadd double %.0410, %27
  %29 = fneg double %22
  %30 = call double @llvm.fmuladd.f64(double %29, double %26, double %.0212)
  %31 = fdiv double %22, %26
  %32 = fadd double %.0311, %31
  br label %33

33:                                               ; preds = %21
  %34 = add nsw i32 %.169, 1
  %35 = icmp sle i32 %34, %6
  br i1 %35, label %21, label %36, !llvm.loop !9

36:                                               ; preds = %33
  %.04.lcssa = phi double [ %28, %33 ]
  %.03.lcssa = phi double [ %32, %33 ]
  %.02.lcssa = phi double [ %30, %33 ]
  %37 = load double, ptr @sa, align 8
  %38 = fmul double %37, %.04.lcssa
  ...
  %52 = fmul double %.02.lcssa, %.02.lcssa
  %53 = fmul double %52, %.02.lcssa
