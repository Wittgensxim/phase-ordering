...
32:                                               ; preds = %26
  ...
  br i1 %37, label %26, label %._crit_edge, !llvm.loop !7
...
38:                                               ; preds = %._crit_edge, %0
  ...
  br i1 %44, label %.lr.ph2, label %75
...
45:                                               ; preds = %.lr.ph2, %69
  ...
  %62 = fneg double %60
  %63 = call double @llvm.fmuladd.f64(double %62, double %61, double %59)
...
69:                                               ; preds = %45
  ...
  br i1 %74, label %45, label %._crit_edge3, !llvm.loop !9

._crit_edge3:                                     ; preds = %69
  br label %75

75:                                               ; preds = %._crit_edge3, %38
  ...
  %82 = load double, ptr @four, align 8
  ...
  %88 = load double, ptr @five, align 8
  ...
  store double %100, ptr @piprg, align 8
  %101 = load double, ptr @piprg, align 8
  %102 = load double, ptr @piref, align 8
  %103 = fsub double %101, %102
  store double %103, ptr @pierr, align 8
  %104 = load double, ptr @pierr, align 8
