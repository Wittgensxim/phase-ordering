...
18:                                               ; preds = %10
  %19 = sitofp i32 156250000 to double
  store double %19, ptr @sc, align 8
  %20 = load double, ptr @sa, align 8
  br label %21

21:                                               ; preds = %35, %18
  %.032 = phi double [ 0.000000e+00, %18 ], [ %32, %35 ]
  %.031 = phi double [ 0.000000e+00, %18 ], [ %34, %35 ]
  %.030 = phi double [ 0.000000e+00, %18 ], [ %30, %35 ]
  %.029 = phi double [ %20, %18 ], [ %28, %35 ]
  %.128 = phi double [ %.027, %18 ], [ %24, %35 ]
  %.1 = phi i32 [ 1, %18 ], [ %36, %35 ]
  %22 = icmp sle i32 %.1, 156250000
...
23:                                               ; preds = %21
  ...
  %28 = fadd double %.029, %27
  %29 = fsub double %24, %28
  %30 = fadd double %.030, %29
  %31 = fneg double %24
  %32 = call double @llvm.fmuladd.f64(double %31, double %28, double %.032)
