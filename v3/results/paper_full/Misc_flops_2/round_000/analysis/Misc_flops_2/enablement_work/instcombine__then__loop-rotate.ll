...
define dso_local i32 @main() #0 {
  ...
  %.not5 = icmp sgt i32 1, %15
  br i1 %.not5, label %25, label %.lr.ph
...
25:                                               ; preds = %._crit_edge, %0
  ...
  %.not46 = icmp sgt i32 1, %29
  br i1 %.not46, label %54, label %.lr.ph8
...
50:                                               ; preds = %30
  ...
  %.not4 = icmp sgt i32 %52, %53
  br i1 %.not4, label %._crit_edge9, label %30, !llvm.loop !9

._crit_edge9:                                     ; preds = %50
  br label %54

54:                                               ; preds = %._crit_edge9, %25
