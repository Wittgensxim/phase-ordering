...
20:                                               ; preds = %0, %20
  %21 = phi i32 [ 1, %0 ], [ %26, %20 ]
  %22 = phi double [ %19, %0 ], [ %25, %20 ]
  %23 = phi double [ %17, %0 ], [ %24, %20 ]
  %24 = fneg double %23
...
29:                                               ; preds = %28, %29
  %30 = phi i32 [ 1, %28 ], [ %46, %29 ]
  %31 = phi double [ %.lcssa4, %28 ], [ %38, %29 ]
  %32 = phi double [ 0.000000e+00, %28 ], [ %42, %29 ]
  %33 = phi double [ 0.000000e+00, %28 ], [ %45, %29 ]
  %34 = phi double [ 0.000000e+00, %28 ], [ %43, %29 ]
  %35 = phi double [ %.lcssa5, %28 ], [ %37, %29 ]
  %36 = phi double [ %.lcssa4, %28 ], [ %40, %29 ]
  %37 = fneg double %35
  ...
  %43 = call double @llvm.fmuladd.f64(double %35, double %40, double %34)
  ...
  %47 = icmp sle i32 %46, 156250000
  br i1 %47, label %29, label %48, !llvm.loop !9

48:                                               ; preds = %29
  %.lcssa3 = phi double [ %43, %29 ]
  %.lcssa2 = phi double [ %45, %29 ]
  %.lcssa1 = phi double [ %42, %29 ]
