...
5:                                                ; preds = %10, %0
  %6 = phi double [ %11, %10 ], [ %2, %0 ]
  %7 = phi double [ %12, %10 ], [ %4, %0 ]
  %8 = phi i32 [ %13, %10 ], [ 1, %0 ]
  %9 = icmp samesign ult i32 %8, 156250001
...
15:                                               ; preds = %23, %14
  %16 = phi double [ %27, %23 ], [ %7, %14 ]
  %17 = phi double [ %24, %23 ], [ %6, %14 ]
  %18 = phi double [ %28, %23 ], [ 0.000000e+00, %14 ]
  %19 = phi double [ %30, %23 ], [ 0.000000e+00, %14 ]
  %20 = phi double [ %25, %23 ], [ %7, %14 ]
  %21 = phi i32 [ %31, %23 ], [ 1, %14 ]
  %22 = icmp samesign ult i32 %21, 156250001
  br i1 %22, label %23, label %32

23:                                               ; preds = %15
  %24 = fneg double %17
  %25 = fsub double %20, %17
  store double %25, ptr @sa, align 8
  %26 = load double, ptr @two, align 8
  %27 = fadd double %16, %26
  %28 = call double @llvm.fmuladd.f64(double %17, double %27, double %18)
