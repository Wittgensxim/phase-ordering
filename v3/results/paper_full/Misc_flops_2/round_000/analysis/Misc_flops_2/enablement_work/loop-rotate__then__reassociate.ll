...
31:                                               ; preds = %25
  ...
  br i1 %36, label %25, label %._crit_edge, !llvm.loop !7
...
37:                                               ; preds = %._crit_edge, %0
  ...
  br i1 %43, label %.lr.ph2, label %74
...
68:                                               ; preds = %44
  ...
  br i1 %73, label %44, label %._crit_edge3, !llvm.loop !9
...
74:                                               ; preds = %._crit_edge3, %37
  ...
  %81 = load double, ptr @four, align 8
  ...
  store double %99, ptr @piprg, align 8
  %100 = load double, ptr @piprg, align 8
  %101 = load double, ptr @piref, align 8
  %102 = fsub double %100, %101
  store double %102, ptr @pierr, align 8
  %103 = load double, ptr @pierr, align 8
