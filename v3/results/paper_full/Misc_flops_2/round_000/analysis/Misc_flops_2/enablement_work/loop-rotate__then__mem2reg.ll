...
12:                                               ; preds = %.lr.ph, %16
  %.011 = phi i32 [ 1, %.lr.ph ], [ %17, %16 ]
  %.0 = phi double [ %8, %.lr.ph ], [ %13, %16 ]
  %13 = fneg double %.0
...
19:                                               ; preds = %._crit_edge, %0
  %.1 = phi double [ %13, %._crit_edge ], [ %8, %0 ]
...
23:                                               ; preds = %.lr.ph2, %35
  %.112 = phi i32 [ 1, %.lr.ph2 ], [ %36, %35 ]
  %.09 = phi double [ 0.000000e+00, %.lr.ph2 ], [ %30, %35 ]
  %.07 = phi double [ 0.000000e+00, %.lr.ph2 ], [ %34, %35 ]
  %.05 = phi double [ 0.000000e+00, %.lr.ph2 ], [ %32, %35 ]
  %.04 = phi double [ %21, %.lr.ph2 ], [ %28, %35 ]
  %.2 = phi double [ %.1, %.lr.ph2 ], [ %24, %35 ]
  %24 = fneg double %.2
  ...
  %30 = fadd double %.09, %29
  %31 = fneg double %24
  %32 = call double @llvm.fmuladd.f64(double %31, double %28, double %.05)
  %33 = fdiv double %24, %28
  %34 = fadd double %.07, %33
  br label %35

35:                                               ; preds = %23
  %36 = add nsw i32 %.112, 1
...
38:                                               ; preds = %._crit_edge3, %19
  %.110 = phi double [ %30, %._crit_edge3 ], [ 0.000000e+00, %19 ]
  %.18 = phi double [ %34, %._crit_edge3 ], [ 0.000000e+00, %19 ]
  %.16 = phi double [ %32, %._crit_edge3 ], [ 0.000000e+00, %19 ]
