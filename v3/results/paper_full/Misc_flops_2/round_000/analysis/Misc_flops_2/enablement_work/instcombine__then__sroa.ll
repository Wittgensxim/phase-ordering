...
define dso_local i32 @main() #0 {
  ...
  %2 = load double, ptr @five, align 8
  %3 = fneg double %2
  %4 = load double, ptr @one, align 8
  %5 = fneg double %4
  store double %5, ptr @sa, align 8
  br label %6

6:                                                ; preds = %11, %0
  %.0 = phi double [ %3, %0 ], [ %8, %11 ]
  %storemerge = phi i32 [ 1, %0 ], [ %12, %11 ]
  %.not = icmp sgt i32 %storemerge, %1
...
13:                                               ; preds = %6
  ...
  store double %14, ptr @sc, align 8
  %15 = load double, ptr @sa, align 8
  br label %16

16:                                               ; preds = %29, %13
  %.024 = phi double [ %15, %13 ], [ %22, %29 ]
  %.023 = phi double [ 0.000000e+00, %13 ], [ %26, %29 ]
  %.022 = phi double [ 0.000000e+00, %13 ], [ %28, %29 ]
  %.021 = phi double [ 0.000000e+00, %13 ], [ %24, %29 ]
  %.1 = phi double [ %.0, %13 ], [ %18, %29 ]
  %storemerge3 = phi i32 [ 1, %13 ], [ %30, %29 ]
  %.not4 = icmp sgt i32 %storemerge3, %1
...
17:                                               ; preds = %16
  ...
  %22 = fadd double %.024, %21
  %23 = fsub double %18, %22
  %24 = fadd double %.021, %23
  %25 = fneg double %18
  %26 = call double @llvm.fmuladd.f64(double %25, double %22, double %.023)
  %27 = fdiv double %18, %22
  %28 = fadd double %.022, %27
  br label %29

29:                                               ; preds = %17
  %30 = add nsw i32 %storemerge3, 1
  br label %16, !llvm.loop !9

31:                                               ; preds = %16
  %32 = load double, ptr @sa, align 8
  %33 = fmul double %32, %.021
  %34 = load double, ptr @sc, align 8
  %35 = fdiv double %33, %34
  %36 = fptosi double %35 to i32
  %37 = load double, ptr @four, align 8
  %38 = fmul double %37, %.022
  %39 = load double, ptr @five, align 8
  %40 = fdiv double %38, %39
  store double %40, ptr @sa, align 8
  %41 = fdiv double %39, %.023
  %42 = fadd double %40, %41
  store double %42, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %43 = fmul double %.023, %.023
  %44 = fmul double %43, %.023
  %45 = fdiv double 3.125000e+01, %44
  %46 = fsub double %42, %45
  store double %46, ptr @piprg, align 8
  %47 = load double, ptr @piref, align 8
  %48 = fsub double %46, %47
  store double %48, ptr @pierr, align 8
