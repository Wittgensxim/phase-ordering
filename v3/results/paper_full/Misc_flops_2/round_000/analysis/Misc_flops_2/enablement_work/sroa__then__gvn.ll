...
9:                                                ; preds = %12, %0
  ...
  %.027 = phi double [ %6, %0 ], [ %13, %12 ]
  %.0 = phi i32 [ 1, %0 ], [ %15, %12 ]
  %11 = icmp sle i32 %.0, 156250000
...
17:                                               ; preds = %20, %16
  ...
  %.032 = phi double [ 0.000000e+00, %16 ], [ %27, %20 ]
  %.031 = phi double [ 0.000000e+00, %16 ], [ %29, %20 ]
  %.030 = phi double [ 0.000000e+00, %16 ], [ %26, %20 ]
  %.029 = phi double [ %10, %16 ], [ %24, %20 ]
  %.128 = phi double [ %.027, %16 ], [ %21, %20 ]
  %.1 = phi i32 [ 1, %16 ], [ %30, %20 ]
  %19 = icmp sle i32 %.1, 156250000
...
20:                                               ; preds = %17
  ...
  %24 = fadd double %.029, %23
  %25 = fsub double %21, %24
  %26 = fadd double %.030, %25
  %27 = call double @llvm.fmuladd.f64(double %.128, double %24, double %.032)
  %28 = fdiv double %21, %24
  %29 = fadd double %.031, %28
  %30 = add nsw i32 %.1, 1
  br label %17, !llvm.loop !9

31:                                               ; preds = %17
  %32 = fmul double %18, %.030
  %33 = fdiv double %32, 1.562500e+08
  %34 = fptosi double %33 to i32
  %35 = load double, ptr @four, align 8
  %36 = fmul double %35, %.031
  %37 = fdiv double %36, %5
  store double %37, ptr @sa, align 8
  %38 = fdiv double %5, %.032
  %39 = fadd double %37, %38
  store double %39, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %40 = fmul double %.032, %.032
  %41 = fmul double %40, %.032
  ...
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %46, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
