...
22:                                               ; preds = %34, %19
  %.16 = phi i32 [ 1, %19 ], [ %35, %34 ]
  %.03 = phi double [ 0.000000e+00, %19 ], [ %33, %34 ]
  %.02 = phi double [ 0.000000e+00, %19 ], [ %31, %34 ]
  %.01 = phi double [ %21, %19 ], [ %29, %34 ]
  %.1 = phi double [ %.0, %19 ], [ %25, %34 ]
...
24:                                               ; preds = %22
  ...
  %30 = fneg double %25
  %31 = call double @llvm.fmuladd.f64(double %30, double %29, double %.02)
  %32 = fdiv double %25, %29
  %33 = fadd double %.03, %32
  br label %34
