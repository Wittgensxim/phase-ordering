...
10:                                               ; preds = %15, %0
  ...
  %.0 = phi double [ %7, %0 ], [ %12, %15 ]
  %exitcond = icmp ne i32 %.05, 156250001
  br i1 %exitcond, label %11, label %17
...
19:                                               ; preds = %31, %17
  %.16 = phi i32 [ 1, %17 ], [ %32, %31 ]
  %.04 = phi double [ 0.000000e+00, %17 ], [ %27, %31 ]
  %.03 = phi double [ 0.000000e+00, %17 ], [ %30, %31 ]
  %.02 = phi double [ 0.000000e+00, %17 ], [ %28, %31 ]
  %.01 = phi double [ %18, %17 ], [ %25, %31 ]
  %.1 = phi double [ %.0.lcssa, %17 ], [ %21, %31 ]
  %exitcond1 = icmp ne i32 %.16, 156250001
  br i1 %exitcond1, label %20, label %33
...
20:                                               ; preds = %19
  ...
  %27 = fadd double %.04, %26
  %28 = call double @llvm.fmuladd.f64(double %.1, double %25, double %.02)
  %29 = fdiv double %21, %25
...
33:                                               ; preds = %19
  ...
  %39 = load double, ptr @five, align 8
  %40 = fdiv double %38, %39
  store double %40, ptr @sa, align 8
  %41 = load double, ptr @five, align 8
  %42 = fdiv double %41, %.02.lcssa
  %43 = fadd double %40, %42
  store double %43, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %44 = load double, ptr @sb, align 8
  %45 = fmul double %.02.lcssa, %.02.lcssa
  %46 = fmul double %45, %.02.lcssa
  %47 = fdiv double 3.125000e+01, %46
  %48 = fsub double %44, %47
  store double %48, ptr @piprg, align 8
  %49 = load double, ptr @piref, align 8
  %50 = fsub double %48, %49
  store double %50, ptr @pierr, align 8
  %51 = fmul double %50, 1.000000e-30
  %52 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %51, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
