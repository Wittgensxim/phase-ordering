...
16:                                               ; preds = %18, %15
  ...
  %.01 = phi double [ %10, %15 ], [ %22, %18 ]
  %.1 = phi double [ %.0, %15 ], [ %19, %18 ]
  %exitcond1 = icmp ne i32 %.16, 156250001
  br i1 %exitcond1, label %18, label %29
...
29:                                               ; preds = %16
  ...
  %37 = fmul double %.02, %.02
  %38 = fmul double %37, %.02
