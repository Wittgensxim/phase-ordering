...
9:                                                ; preds = %11, %0
  %10 = phi double [ %8, %0 ], [ %13, %11 ]
  %.05 = phi i32 [ 1, %0 ], [ %14, %11 ]
  %.0 = phi double [ %6, %0 ], [ %12, %11 ]
  %exitcond = icmp ne i32 %.05, 156250001
  br i1 %exitcond, label %11, label %15
...
15:                                               ; preds = %9
  %.lcssa1 = phi double [ %10, %9 ]
  %.0.lcssa = phi double [ %.0, %9 ]
  store double 1.562500e+08, ptr @sc, align 8
  br label %16

16:                                               ; preds = %18, %15
  %17 = phi double [ %.lcssa1, %15 ], [ %20, %18 ]
  %.16 = phi i32 [ 1, %15 ], [ %28, %18 ]
  %.04 = phi double [ 0.000000e+00, %15 ], [ %24, %18 ]
  %.03 = phi double [ 0.000000e+00, %15 ], [ %27, %18 ]
  %.02 = phi double [ 0.000000e+00, %15 ], [ %25, %18 ]
  %.01 = phi double [ %.lcssa1, %15 ], [ %22, %18 ]
  %.1 = phi double [ %.0.lcssa, %15 ], [ %19, %18 ]
  %exitcond2 = icmp ne i32 %.16, 156250001
  br i1 %exitcond2, label %18, label %29
...
18:                                               ; preds = %16
  ...
  %25 = call double @llvm.fmuladd.f64(double %.1, double %22, double %.02)
  %26 = fdiv double %19, %22
  %27 = fadd double %.03, %26
  %28 = add nuw nsw i32 %.16, 1
  br label %16, !llvm.loop !9

29:                                               ; preds = %16
  %.lcssa = phi double [ %17, %16 ]
  %.04.lcssa = phi double [ %.04, %16 ]
