...
18:                                               ; preds = %23, %16
  %.16 = phi i32 [ 1, %16 ], [ %30, %23 ]
  %.03 = phi double [ 0.000000e+00, %16 ], [ %28, %23 ]
  %.02 = phi double [ 0.000000e+00, %16 ], [ %29, %23 ]
  %.01 = phi double [ %17, %16 ], [ %25, %23 ]
  %.1 = phi double [ %2, %16 ], [ %26, %23 ]
  %19 = icmp samesign ult i32 %.16, 156250001
...
23:                                               ; preds = %20
  ...
  %29 = call double @llvm.fmuladd.f64(double %.1, double %25, double %.02)
  %30 = add nuw nsw i32 %.16, 1
  br label %18, !llvm.loop !9

31:                                               ; preds = %18
  %32 = load double, ptr @four, align 8
  %33 = fmul double %32, %.03
  %34 = load double, ptr @five, align 8
  %35 = fdiv double %33, %34
  store double %35, ptr @sa, align 8
  %36 = fdiv double %34, %.02
