...
19:                                               ; preds = %21, %17
  %.16 = phi i32 [ 1, %17 ], [ %30, %21 ]
  %.03 = phi double [ 0.000000e+00, %17 ], [ %29, %21 ]
  %.02 = phi double [ 0.000000e+00, %17 ], [ %27, %21 ]
...
21:                                               ; preds = %19
  ...
  %27 = call double @llvm.fmuladd.f64(double %.1, double %26, double %.02)
  %28 = fdiv double %22, %26
