...
15:                                               ; preds = %14
  %16 = load double, ptr @sa, align 8
  %17 = fadd double %16, %7
  store double %17, ptr @sa, align 8
  br label %18

18:                                               ; preds = %15
  %19 = add nuw nsw i32 %.051, 2
  %20 = icmp samesign ule i32 %19, 156250000
  br i1 %20, label %10, label %21, !llvm.loop !7

21:                                               ; preds = %18
  %.0.lcssa = phi double [ %7, %18 ]
  store double 1.562500e+08, ptr @sc, align 8
  %22 = load double, ptr @sa, align 8
  br label %23

23:                                               ; preds = %21, %34
  %.17 = phi double [ %.0.lcssa, %21 ], [ %24, %34 ]
  %.016 = phi double [ %22, %21 ], [ %28, %34 ]
  %.025 = phi double [ 0.000000e+00, %21 ], [ %31, %34 ]
  %.034 = phi double [ 0.000000e+00, %21 ], [ %33, %34 ]
  %.043 = phi double [ 0.000000e+00, %21 ], [ %30, %34 ]
  %.162 = phi i32 [ 1, %21 ], [ %35, %34 ]
  %24 = fneg double %.17
  %25 = load double, ptr @sa, align 8
  %26 = fadd double %25, %24
  store double %26, ptr @sa, align 8
  %27 = load double, ptr @two, align 8
  %28 = fadd double %.016, %27
  %29 = fsub double %24, %28
  %30 = fadd double %.043, %29
  %31 = call double @llvm.fmuladd.f64(double %.17, double %28, double %.025)
  %32 = fdiv double %24, %28
  %33 = fadd double %.034, %32
  br label %34

34:                                               ; preds = %23
  %35 = add nsw i32 %.162, 1
  %36 = icmp sle i32 %35, 156250000
  br i1 %36, label %23, label %37, !llvm.loop !9

37:                                               ; preds = %34
  %.04.lcssa = phi double [ %30, %34 ]
  %.03.lcssa = phi double [ %33, %34 ]
  %.02.lcssa = phi double [ %31, %34 ]
  %38 = load double, ptr @sa, align 8
  %39 = fmul double %38, %.04.lcssa
  %40 = load double, ptr @sc, align 8
  %41 = fdiv double %39, %40
  %42 = load double, ptr @four, align 8
  %43 = fmul double %42, %.03.lcssa
  %44 = load double, ptr @five, align 8
  %45 = fdiv double %43, %44
  store double %45, ptr @sa, align 8
  %46 = load double, ptr @five, align 8
  %47 = fdiv double %46, %.02.lcssa
  %48 = fadd double %45, %47
  store double %48, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %49 = load double, ptr @sb, align 8
  %50 = fmul double %.02.lcssa, %.02.lcssa
  %51 = fmul double %50, %.02.lcssa
  %52 = fdiv double 3.125000e+01, %51
  %53 = fsub double %49, %52
  store double %53, ptr @piprg, align 8
  %54 = load double, ptr @piref, align 8
  %55 = fsub double %53, %54
  store double %55, ptr @pierr, align 8
