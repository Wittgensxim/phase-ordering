...
10:                                               ; preds = %19, %0
  %.05 = phi i32 [ 1, %0 ], [ %20, %19 ]
  %.0 = phi double [ %7, %0 ], [ %.0, %19 ]
  %exitcond = icmp ne i32 %.05, 156250001
  br i1 %exitcond, label %11, label %21
...
23:                                               ; preds = %35, %21
  %.16 = phi i32 [ 1, %21 ], [ %36, %35 ]
  %.04 = phi double [ 0.000000e+00, %21 ], [ %31, %35 ]
  %.03 = phi double [ 0.000000e+00, %21 ], [ %34, %35 ]
  %.02 = phi double [ 0.000000e+00, %21 ], [ %32, %35 ]
  %.01 = phi double [ %22, %21 ], [ %29, %35 ]
  %.1 = phi double [ %.0.lcssa, %21 ], [ %25, %35 ]
  %exitcond1 = icmp ne i32 %.16, 156250001
  br i1 %exitcond1, label %24, label %37
...
24:                                               ; preds = %23
  ...
  %32 = call double @llvm.fmuladd.f64(double %.1, double %29, double %.02)
  %33 = fdiv double %25, %29
...
37:                                               ; preds = %23
  %.04.lcssa = phi double [ %.04, %23 ]
  %.03.lcssa = phi double [ %.03, %23 ]
  %.02.lcssa = phi double [ %.02, %23 ]
