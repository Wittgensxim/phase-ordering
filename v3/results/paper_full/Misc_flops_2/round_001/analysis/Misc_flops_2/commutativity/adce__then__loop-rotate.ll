...
19:                                               ; preds = %17, %28
  %.19 = phi double [ %.0.lcssa, %17 ], [ %20, %28 ]
  %.018 = phi double [ %18, %17 ], [ %24, %28 ]
  %.027 = phi double [ 0.000000e+00, %17 ], [ %25, %28 ]
  %.036 = phi double [ 0.000000e+00, %17 ], [ %27, %28 ]
  %.165 = phi i32 [ 1, %17 ], [ %29, %28 ]
  %20 = fneg double %.19
  ...
  %27 = fadd double %.036, %26
  br label %28

28:                                               ; preds = %19
  %29 = add nsw i32 %.165, 1
