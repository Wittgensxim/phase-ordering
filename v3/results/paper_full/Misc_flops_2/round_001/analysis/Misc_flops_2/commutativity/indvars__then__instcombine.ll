...
5:                                                ; preds = %9, %0
  ...
  %exitcond.not = icmp eq i32 %.05, 156250001
...
14:                                               ; preds = %18, %12
  ...
  %.03 = phi double [ 0.000000e+00, %12 ], [ %23, %18 ]
  %.02 = phi double [ 0.000000e+00, %12 ], [ %24, %18 ]
  %.01 = phi double [ %13, %12 ], [ %20, %18 ]
  %.1 = phi double [ %.0, %12 ], [ %21, %18 ]
  %exitcond1.not = icmp eq i32 %.16, 156250001
  br i1 %exitcond1.not, label %26, label %15
