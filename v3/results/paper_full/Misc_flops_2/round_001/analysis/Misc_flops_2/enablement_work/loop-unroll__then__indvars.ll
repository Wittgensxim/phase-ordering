...
22:                                               ; preds = %10
  %.0.lcssa = phi double [ %7, %10 ]
  store double 1.562500e+08, ptr @sc, align 8
  %23 = load double, ptr @sa, align 8
  br label %24

24:                                               ; preds = %36, %22
  %.16 = phi i32 [ 1, %22 ], [ %37, %36 ]
  %.04 = phi double [ 0.000000e+00, %22 ], [ %32, %36 ]
  %.03 = phi double [ 0.000000e+00, %22 ], [ %35, %36 ]
  %.02 = phi double [ 0.000000e+00, %22 ], [ %33, %36 ]
  %.01 = phi double [ %23, %22 ], [ %30, %36 ]
  %.1 = phi double [ %.0.lcssa, %22 ], [ %26, %36 ]
  %exitcond = icmp ne i32 %.16, 156250001
  br i1 %exitcond, label %25, label %38
