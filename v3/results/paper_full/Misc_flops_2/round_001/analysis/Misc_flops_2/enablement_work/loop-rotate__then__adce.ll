...
19:                                               ; preds = %17, %28
  %.112 = phi double [ %.0.lcssa, %17 ], [ %20, %28 ]
  %.0111 = phi double [ %18, %17 ], [ %24, %28 ]
  %.0210 = phi double [ 0.000000e+00, %17 ], [ %25, %28 ]
  %.039 = phi double [ 0.000000e+00, %17 ], [ %27, %28 ]
  %.167 = phi i32 [ 1, %17 ], [ %29, %28 ]
  %20 = fneg double %.112
  %21 = load double, ptr @sa, align 8
  %22 = fadd double %21, %20
  store double %22, ptr @sa, align 8
  %23 = load double, ptr @two, align 8
  %24 = fadd double %.0111, %23
  %25 = call double @llvm.fmuladd.f64(double %.112, double %24, double %.0210)
  %26 = fdiv double %20, %24
  %27 = fadd double %.039, %26
  br label %28

28:                                               ; preds = %19
  %29 = add nsw i32 %.167, 1
  %30 = icmp sle i32 %29, 156250000
  br i1 %30, label %19, label %31, !llvm.loop !9

31:                                               ; preds = %28
  %.03.lcssa = phi double [ %27, %28 ]
  %.02.lcssa = phi double [ %25, %28 ]
  ...
  %37 = fdiv double %36, %.02.lcssa
  %38 = fadd double %35, %37
  store double %38, ptr @sb, align 8
  store double 3.125000e+01, ptr @sc, align 8
  %39 = load double, ptr @sb, align 8
  %40 = fmul double %.02.lcssa, %.02.lcssa
  %41 = fmul double %40, %.02.lcssa
