...
9:                                                ; preds = %20, %0
  %10 = phi double [ %8, %0 ], [ %21, %20 ]
  %.05 = phi i32 [ 1, %0 ], [ %22, %20 ]
  %.0 = phi double [ %6, %0 ], [ %.0, %20 ]
...
24:                                               ; preds = %37, %23
  %25 = phi double [ %.lcssa1, %23 ], [ %38, %37 ]
  %.16 = phi i32 [ 1, %23 ], [ %45, %37 ]
  %.04 = phi double [ 0.000000e+00, %23 ], [ %41, %37 ]
  %.03 = phi double [ 0.000000e+00, %23 ], [ %44, %37 ]
  %.02 = phi double [ 0.000000e+00, %23 ], [ %42, %37 ]
  %.01 = phi double [ %.lcssa1, %23 ], [ %39, %37 ]
  %.1 = phi double [ %.0.lcssa, %23 ], [ %.1, %37 ]
  %26 = icmp samesign ule i32 %.16, 156250000
...
37:                                               ; preds = %27
  ...
  %42 = call double @llvm.fmuladd.f64(double %28, double %39, double %34)
  %43 = fdiv double %.1, %39
...
46:                                               ; preds = %24
  ...
  %47 = fmul double %.lcssa, %.04.lcssa
  %48 = fdiv double %47, 1.562500e+08
  %49 = load double, ptr @four, align 8
  %50 = fmul double %49, %.03.lcssa
  %51 = fdiv double %50, %5
  store double %51, ptr @sa, align 8
  %52 = fdiv double %5, %.02.lcssa
