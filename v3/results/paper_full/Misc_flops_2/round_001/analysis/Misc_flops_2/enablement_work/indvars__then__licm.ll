...
10:                                               ; preds = %15, %0
  %11 = phi double [ %sa.promoted, %0 ], [ %14, %15 ]
  %.05 = phi i32 [ 1, %0 ], [ %16, %15 ]
  %.0 = phi double [ %7, %0 ], [ %13, %15 ]
  %exitcond = icmp ne i32 %.05, 156250001
  br i1 %exitcond, label %12, label %17
...
17:                                               ; preds = %10
  ...
  %sa.promoted2 = load double, ptr @sa, align 8
  br label %20

20:                                               ; preds = %31, %17
  %21 = phi double [ %sa.promoted2, %17 ], [ %24, %31 ]
...
33:                                               ; preds = %20
  %.lcssa3 = phi double [ %21, %20 ]
  %.04.lcssa = phi double [ %.04, %20 ]
