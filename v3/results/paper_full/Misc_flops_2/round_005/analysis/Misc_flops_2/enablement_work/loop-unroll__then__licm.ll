...
9:                                                ; preds = %9, %0
  %.051 = phi i32 [ 1, %0 ], [ %19, %9 ]
  %10 = phi double [ %4, %0 ], [ %18, %9 ]
  %11 = fsub double %10, %2
  %12 = fsub double %11, %5
  %13 = fsub double %12, %2
  %14 = fsub double %13, %6
  ...
  br i1 %exitcond.7, label %9, label %20, !llvm.loop !7

20:                                               ; preds = %9
  %.lcssa4 = phi double [ %2, %9 ]
  %.lcssa3 = phi double [ %18, %9 ]
  store double %.lcssa3, ptr @sa, align 8
  store double 1.562500e+08, ptr @sc, align 8
  %21 = load double, ptr @two, align 8
  %22 = fneg double %.lcssa4
  br label %23

23:                                               ; preds = %23, %20
  %.018 = phi double [ %.lcssa3, %20 ], [ %31, %23 ]
  %.027 = phi double [ 0.000000e+00, %20 ], [ %32, %23 ]
  %.036 = phi double [ 0.000000e+00, %20 ], [ %34, %23 ]
  %.165 = phi i32 [ 1, %20 ], [ %35, %23 ]
  %24 = phi double [ %.lcssa3, %20 ], [ %30, %23 ]
  %25 = fsub double %24, %.lcssa4
  ...
  %30 = fsub double %25, %22
  %31 = fadd double %26, %21
  %32 = call double @llvm.fmuladd.f64(double %22, double %31, double %27)
  %33 = fdiv double %22, %31
  %34 = fsub double %29, %33
  %35 = add nuw nsw i32 %.165, 2
  %exitcond4.1 = icmp ne i32 %35, 156250001
  br i1 %exitcond4.1, label %23, label %36, !llvm.loop !9

36:                                               ; preds = %23
  %.lcssa2 = phi double [ %30, %23 ]
  %.lcssa1 = phi double [ %32, %23 ]
  %.lcssa = phi double [ %34, %23 ]
