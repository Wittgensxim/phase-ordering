...
5:                                                ; preds = %5, %0
  ...
  %exitcond.not.7 = icmp eq i32 %19, 156250001
  br i1 %exitcond.not.7, label %20, label %5, !llvm.loop !7

20:                                               ; preds = %5
  %.lcssa4 = phi double [ %.04, %5 ]
...
22:                                               ; preds = %22, %20
  ...
  %24 = fneg double %.19
  %25 = fsub double %23, %.19
  %26 = fadd double %.018, %21
  %27 = call double @llvm.fmuladd.f64(double %.19, double %26, double %.027)
  ...
  %exitcond4.not.1 = icmp eq i32 %35, 156250001
  br i1 %exitcond4.not.1, label %36, label %22, !llvm.loop !9
