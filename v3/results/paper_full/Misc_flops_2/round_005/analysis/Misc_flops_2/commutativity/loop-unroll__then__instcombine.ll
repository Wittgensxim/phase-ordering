...
5:                                                ; preds = %5, %0
  ...
  %13 = fadd double %12, %1
  %14 = fsub double %13, %1
  %15 = add nuw nsw i32 %.051, 8
  %exitcond.7.not = icmp eq i32 %15, 156250001
  br i1 %exitcond.7.not, label %16, label %5, !llvm.loop !7
...
18:                                               ; preds = %18, %16
  %.018 = phi double [ %14, %16 ], [ %26, %18 ]
  %.027 = phi double [ 0.000000e+00, %16 ], [ %27, %18 ]
  %.036 = phi double [ 0.000000e+00, %16 ], [ %29, %18 ]
  %.165 = phi i32 [ 1, %16 ], [ %30, %18 ]
  %19 = phi double [ %14, %16 ], [ %25, %18 ]
  %20 = fadd double %19, %1
  %21 = fadd double %.018, %17
  %22 = call double @llvm.fmuladd.f64(double %2, double %21, double %.027)
  %23 = fdiv double %1, %21
  %24 = fadd double %.036, %23
  %25 = fsub double %20, %1
  %26 = fadd double %21, %17
  %27 = call double @llvm.fmuladd.f64(double %1, double %26, double %22)
  %28 = fdiv double %1, %26
  %29 = fsub double %24, %28
  %30 = add nuw nsw i32 %.165, 2
  %exitcond4.1.not = icmp eq i32 %30, 156250001
  br i1 %exitcond4.1.not, label %31, label %18, !llvm.loop !9
