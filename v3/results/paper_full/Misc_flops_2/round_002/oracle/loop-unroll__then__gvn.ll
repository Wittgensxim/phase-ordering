...
15:                                               ; preds = %18, %14
  %16 = phi double [ %6, %14 ], [ %25, %18 ]
  %.16 = phi i32 [ 1, %14 ], [ %30, %18 ]
  %.03 = phi double [ 0.000000e+00, %14 ], [ %29, %18 ]
  %.02 = phi double [ 0.000000e+00, %14 ], [ %27, %18 ]
  %.01 = phi double [ %6, %14 ], [ %26, %18 ]
...
18:                                               ; preds = %15
  ...
  %22 = call double @llvm.fmuladd.f64(double %2, double %21, double %.02)
  %23 = fdiv double %2, %21
  %24 = fsub double %.03, %23
  %25 = fsub double %19, %1
  store double %25, ptr @sa, align 8
  %26 = fadd double %21, %20
