...
5:                                                ; preds = %14, %0
  %6 = phi double [ %4, %0 ], [ %15, %14 ]
  %.05 = phi i32 [ 1, %0 ], [ %16, %14 ]
...
18:                                               ; preds = %28, %17
  %19 = phi double [ %6, %17 ], [ %29, %28 ]
  %.16 = phi i32 [ 1, %17 ], [ %34, %28 ]
  %.03 = phi double [ 0.000000e+00, %17 ], [ %33, %28 ]
  %.02 = phi double [ 0.000000e+00, %17 ], [ %31, %28 ]
  %.01 = phi double [ %6, %17 ], [ %30, %28 ]
...
21:                                               ; preds = %18
  ...
  %25 = call double @llvm.fmuladd.f64(double %2, double %24, double %.02)
  %26 = fdiv double %2, %24
  %27 = fsub double %.03, %26
  br label %28
...
28:                                               ; preds = %21
  ...
  %31 = call double @llvm.fmuladd.f64(double %1, double %30, double %25)
  %32 = fdiv double %1, %30
...
35:                                               ; preds = %18
  ...
  %41 = fmul double %.02, %.02
  %42 = fmul double %41, %.02
  ...
  %48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %47, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
