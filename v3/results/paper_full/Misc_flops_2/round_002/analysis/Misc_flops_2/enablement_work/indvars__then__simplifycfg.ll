...
12:                                               ; preds = %14, %11
  %13 = phi double [ %.lcssa, %11 ], [ %16, %14 ]
  %.16 = phi i32 [ 1, %11 ], [ %22, %14 ]
  %.03 = phi double [ 0.000000e+00, %11 ], [ %21, %14 ]
  %.02 = phi double [ 0.000000e+00, %11 ], [ %19, %14 ]
  %.01 = phi double [ %.lcssa, %11 ], [ %18, %14 ]
  %.1 = phi double [ %.0.lcssa, %11 ], [ %15, %14 ]
  %exitcond1 = icmp ne i32 %.16, 156250001
  br i1 %exitcond1, label %14, label %23
...
14:                                               ; preds = %12
  ...
  %19 = call double @llvm.fmuladd.f64(double %.1, double %18, double %.02)
  %20 = fdiv double %.1, %18
  %21 = fsub double %.03, %20
  %22 = add nuw nsw i32 %.16, 1
  br label %12, !llvm.loop !9

23:                                               ; preds = %12
  %.03.lcssa = phi double [ %.03, %12 ]
  %.02.lcssa = phi double [ %.02, %12 ]
