...
7:                                                ; preds = %17, %0
  %8 = phi double [ poison, %0 ], [ %18, %17 ]
  %9 = phi double [ %4, %0 ], [ %18, %17 ]
  %.05 = phi i32 [ 1, %0 ], [ %19, %17 ]
  %10 = icmp samesign ult i32 %.05, 156250001
...
20:                                               ; preds = %7
  %.lcssa1 = phi double [ %8, %7 ]
  %.lcssa = phi double [ %9, %7 ]
  %.0.lcssa = phi double [ %2, %7 ]
  store double %.lcssa1, ptr @sa, align 8
  store double 1.562500e+08, ptr @sc, align 8
  %21 = fneg double %.0.lcssa
  %22 = load double, ptr @two, align 8
  br label %23

23:                                               ; preds = %33, %20
  %24 = phi double [ poison, %20 ], [ %34, %33 ]
  %25 = phi double [ %.lcssa, %20 ], [ %34, %33 ]
  %.16 = phi i32 [ 1, %20 ], [ %39, %33 ]
  %.03 = phi double [ 0.000000e+00, %20 ], [ %38, %33 ]
  %.02 = phi double [ 0.000000e+00, %20 ], [ %36, %33 ]
  %.01 = phi double [ %.lcssa, %20 ], [ %35, %33 ]
  %26 = icmp samesign ult i32 %.16, 156250001
  br i1 %26, label %27, label %40

27:                                               ; preds = %23
  %28 = fsub double %25, %.0.lcssa
  %29 = fadd double %.01, %22
  %30 = call double @llvm.fmuladd.f64(double %.0.lcssa, double %29, double %.02)
  %31 = fdiv double %.0.lcssa, %29
  %32 = fsub double %.03, %31
  br label %33

33:                                               ; preds = %27
  %34 = fsub double %28, %21
  %35 = fadd double %29, %22
  %36 = call double @llvm.fmuladd.f64(double %21, double %35, double %30)
  %37 = fdiv double %21, %35
