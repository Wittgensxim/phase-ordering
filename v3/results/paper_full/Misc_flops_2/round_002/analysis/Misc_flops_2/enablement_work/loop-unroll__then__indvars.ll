...
23:                                               ; preds = %20
  %24 = fneg double %.0.lcssa
  %25 = fsub double %21, %.0.lcssa
  store double %25, ptr @sa, align 8
  %26 = load double, ptr @two, align 8
  %27 = fadd double %.01, %26
  %28 = call double @llvm.fmuladd.f64(double %.0.lcssa, double %27, double %.02)
  %29 = fdiv double %.0.lcssa, %27
