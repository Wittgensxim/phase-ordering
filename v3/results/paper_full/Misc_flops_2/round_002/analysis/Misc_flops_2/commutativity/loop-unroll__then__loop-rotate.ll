...
14:                                               ; preds = %11
  ...
  %16 = add nuw nsw i32 %.051, 4
  %17 = icmp samesign ult i32 %16, 156250001
  br i1 %17, label %5, label %18, !llvm.loop !7

18:                                               ; preds = %14
  %.lcssa = phi double [ %15, %14 ]
  %.0.lcssa = phi double [ %2, %14 ]
  store double 1.562500e+08, ptr @sc, align 8
  br label %19

19:                                               ; preds = %18, %28
  %.015 = phi double [ %.lcssa, %18 ], [ %30, %28 ]
  %.024 = phi double [ 0.000000e+00, %18 ], [ %31, %28 ]
  %.033 = phi double [ 0.000000e+00, %18 ], [ %33, %28 ]
  %.162 = phi i32 [ 1, %18 ], [ %34, %28 ]
  %20 = phi double [ %.lcssa, %18 ], [ %29, %28 ]
  %21 = fneg double %.0.lcssa
  %22 = fsub double %20, %.0.lcssa
  store double %22, ptr @sa, align 8
  %23 = load double, ptr @two, align 8
  %24 = fadd double %.015, %23
  %25 = call double @llvm.fmuladd.f64(double %.0.lcssa, double %24, double %.024)
  %26 = fdiv double %.0.lcssa, %24
  %27 = fsub double %.033, %26
  br label %28
...
28:                                               ; preds = %19
  ...
  %34 = add nuw nsw i32 %.162, 2
  %35 = icmp samesign ult i32 %34, 156250001
  br i1 %35, label %19, label %36, !llvm.loop !9

36:                                               ; preds = %28
  %.03.lcssa = phi double [ %33, %28 ]
  %.02.lcssa = phi double [ %31, %28 ]
