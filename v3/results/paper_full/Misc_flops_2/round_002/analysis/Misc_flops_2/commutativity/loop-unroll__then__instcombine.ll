...
18:                                               ; preds = %23, %17
  %19 = phi double [ %6, %17 ], [ %29, %23 ]
  %.16 = phi i32 [ 1, %17 ], [ %34, %23 ]
  %.03 = phi double [ 0.000000e+00, %17 ], [ %33, %23 ]
  %.02 = phi double [ 0.000000e+00, %17 ], [ %31, %23 ]
  %.01 = phi double [ %6, %17 ], [ %30, %23 ]
...
23:                                               ; preds = %21
  ...
  %28 = call double @llvm.fmuladd.f64(double %2, double %25, double %.02)
  %29 = fsub double %22, %1
  store double %29, ptr @sa, align 8
  %30 = fadd double %25, %24
  %31 = call double @llvm.fmuladd.f64(double %1, double %30, double %28)
  %32 = fdiv double %1, %30
