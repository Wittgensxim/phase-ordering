...
12:                                               ; preds = %23, %5
  %13 = phi double [ 0.000000e+00, %5 ], [ %28, %23 ]
  %14 = phi i32 [ 1, %5 ], [ %29, %23 ]
...
16:                                               ; preds = %12
  ...
  %gep = getelementptr [328 x i8], ptr %invariant.gep, i64 %17
  %20 = load double, ptr %gep, align 8
  %21 = call double @llvm.fmuladd.f64(double %19, double %20, double %13)
...
23:                                               ; preds = %16
  ...
  %gep2 = getelementptr [328 x i8], ptr %invariant.gep1, i64 %24
  %27 = load double, ptr %gep2, align 8
  %28 = call double @llvm.fmuladd.f64(double %26, double %27, double %21)
