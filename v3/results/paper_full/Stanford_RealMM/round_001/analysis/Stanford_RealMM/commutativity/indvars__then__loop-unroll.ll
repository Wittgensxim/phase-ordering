...
6:                                                ; preds = %18, %5
  %indvars.iv = phi i64 [ 1, %5 ], [ %indvars.iv.next.1, %18 ]
  %7 = phi double [ 0.000000e+00, %5 ], [ %27, %18 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
  br i1 %exitcond, label %8, label %28
...
18:                                               ; preds = %8
  ...
  %20 = getelementptr inbounds [328 x i8], ptr %1, i64 %19
  %21 = getelementptr inbounds nuw [8 x i8], ptr %20, i64 %indvars.iv.next
  %22 = load double, ptr %21, align 8
  %23 = getelementptr inbounds nuw [328 x i8], ptr %2, i64 %indvars.iv.next
  %24 = sext i32 %4 to i64
  %25 = getelementptr inbounds [8 x i8], ptr %23, i64 %24
  %26 = load double, ptr %25, align 8
  %27 = call double @llvm.fmuladd.f64(double %22, double %26, double %17)
