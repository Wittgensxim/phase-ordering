...
9:                                                ; preds = %20, %5
  %10 = phi double [ 0.000000e+00, %5 ], [ %25, %20 ]
  %11 = phi i32 [ 1, %5 ], [ %26, %20 ]
...
20:                                               ; preds = %13
  ...
  %gep.1 = getelementptr [328 x i8], ptr %invariant.gep, i64 %21
  %24 = load double, ptr %gep.1, align 8
  %25 = call double @llvm.fmuladd.f64(double %23, double %24, double %18)
