...
3:                                                ; preds = %.preheader, %3
  ...
  %11 = getelementptr inbounds nuw [328 x i8], ptr %0, i64 %10
  %12 = zext nneg i32 %4 to i64
  %13 = getelementptr inbounds nuw [8 x i8], ptr %11, i64 %12
  store double %9, ptr %13, align 8
  %14 = add nuw nsw i32 %4, 1
  %15 = icmp samesign ult i32 %14, 41
  br i1 %15, label %3, label %16, !llvm.loop !7

16:                                               ; preds = %3
  %17 = add nuw nsw i32 %2, 1
  %18 = icmp samesign ult i32 %17, 41
  br i1 %18, label %.preheader, label %19, !llvm.loop !9
...
6:                                                ; preds = %5, %6
  %7 = phi i32 [ 1, %5 ], [ %19, %6 ]
  %8 = phi double [ 0.000000e+00, %5 ], [ %18, %6 ]
  %9 = sext i32 %3 to i64
...
3:                                                ; preds = %.preheader, %3
  %4 = phi i32 [ 1, %.preheader ], [ %9, %3 ]
  %5 = zext nneg i32 %2 to i64
  %6 = getelementptr inbounds nuw [328 x i8], ptr @rmr, i64 %5
  %7 = zext nneg i32 %4 to i64
  %8 = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %7
  call void @rInnerproduct(ptr noundef nonnull %8, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %2, i32 noundef %4)
...
11:                                               ; preds = %3
  ...
  br i1 %13, label %.preheader, label %14, !llvm.loop !12

14:                                               ; preds = %11
  %15 = add nsw i32 %0, 1
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [328 x i8], ptr @rmr, i64 %16
  %18 = getelementptr inbounds [8 x i8], ptr %17, i64 %16
  %19 = load double, ptr %18, align 8
  %20 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %19) #3
  ret void
}
