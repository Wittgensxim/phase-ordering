...
8:                                                ; preds = %5
  ...
  %15 = getelementptr inbounds nuw [328 x i8], ptr %0, i64 %14
...
6:                                                ; preds = %22, %5
  %7 = phi double [ 0.000000e+00, %5 ], [ %32, %22 ]
  %8 = phi i32 [ 1, %5 ], [ %33, %22 ]
...
10:                                               ; preds = %6
  ...
  %12 = getelementptr inbounds [328 x i8], ptr %1, i64 %11
  %13 = zext nneg i32 %8 to i64
  %14 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %13
  %15 = load double, ptr %14, align 8
  %16 = getelementptr inbounds nuw [328 x i8], ptr %2, i64 %13
...
22:                                               ; preds = %10
  ...
  %24 = getelementptr inbounds [328 x i8], ptr %1, i64 %23
  %25 = zext nneg i32 %21 to i64
  %26 = getelementptr inbounds nuw [8 x i8], ptr %24, i64 %25
  %27 = load double, ptr %26, align 8
  %28 = getelementptr inbounds nuw [328 x i8], ptr %2, i64 %25
  %29 = sext i32 %4 to i64
  %30 = getelementptr inbounds [8 x i8], ptr %28, i64 %29
  %31 = load double, ptr %30, align 8
  %32 = call double @llvm.fmuladd.f64(double %27, double %31, double %20)
...
5:                                                ; preds = %.preheader, %8
  %6 = phi i32 [ %13, %8 ], [ 1, %.preheader ]
  %7 = icmp samesign ult i32 %6, 41
  br i1 %7, label %8, label %14

8:                                                ; preds = %5
  %9 = zext nneg i32 %3 to i64
  %10 = getelementptr inbounds nuw [328 x i8], ptr @rmr, i64 %9
  %11 = zext nneg i32 %6 to i64
  %12 = getelementptr inbounds nuw [8 x i8], ptr %10, i64 %11
  call void @rInnerproduct(ptr noundef nonnull %12, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %3, i32 noundef %6)
...
16:                                               ; preds = %2
  ...
  %19 = getelementptr inbounds [328 x i8], ptr @rmr, i64 %18
  %20 = getelementptr inbounds [8 x i8], ptr %19, i64 %18
  %21 = load double, ptr %20, align 8
  %22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %21) #3
  ret void
}
