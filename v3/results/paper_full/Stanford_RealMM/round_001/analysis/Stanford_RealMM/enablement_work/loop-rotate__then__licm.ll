...
2:                                                ; preds = %1, %17
  ...
  %5 = getelementptr inbounds nuw [328 x i8], ptr %0, i64 %4
  br label %6
...
9:                                                ; preds = %5, %9
  %10 = phi i32 [ 1, %5 ], [ %17, %9 ]
  %11 = phi double [ 0.000000e+00, %5 ], [ %16, %9 ]
  %12 = zext nneg i32 %10 to i64
  %13 = getelementptr inbounds nuw [8 x i8], ptr %7, i64 %12
  %14 = load double, ptr %13, align 8
  %gep = getelementptr [328 x i8], ptr %invariant.gep, i64 %12
  %15 = load double, ptr %gep, align 8
  %16 = call double @llvm.fmuladd.f64(double %14, double %15, double %11)
...
2:                                                ; preds = %1, %12
  %3 = phi i32 [ 1, %1 ], [ %13, %12 ]
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr inbounds nuw [328 x i8], ptr @rmr, i64 %4
  br label %6
...
6:                                                ; preds = %2, %6
  ...
  call void @rInnerproduct(ptr noundef nonnull %9, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %3, i32 noundef %7)
