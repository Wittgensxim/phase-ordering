...
2:                                                ; preds = %12, %1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %12 ], [ 1, %1 ]
  %exitcond5 = icmp ne i64 %indvars.iv2, 41
  br i1 %exitcond5, label %.preheader, label %13
...
3:                                                ; preds = %.preheader, %4
  ...
  br i1 %exitcond, label %4, label %12
...
4:                                                ; preds = %3
  ...
  %10 = getelementptr inbounds nuw [328 x i8], ptr %0, i64 %indvars.iv2
...
4:                                                ; preds = %3
  %5 = getelementptr inbounds nuw [328 x i8], ptr @rmr, i64 %indvars.iv2
  %6 = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv
  %7 = trunc nuw nsw i64 %indvars.iv to i32
  %8 = trunc nuw nsw i64 %indvars.iv2 to i32
  call void @rInnerproduct(ptr noundef nonnull %6, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %8, i32 noundef %7)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
10:                                               ; preds = %2
  ...
  %16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %15) #3
  ret void
}
