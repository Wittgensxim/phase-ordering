...
2:                                                ; preds = %13, %1
  ...
  br i1 %exitcond5, label %3, label %14

3:                                                ; preds = %2
  %4 = getelementptr inbounds nuw [328 x i8], ptr %0, i64 %indvars.iv2
  br label %5
...
9:                                                ; preds = %11, %5
  ...
  %10 = phi double [ %15, %11 ], [ 0.000000e+00, %5 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
...
11:                                               ; preds = %9
  ...
  %gep = getelementptr [328 x i8], ptr %invariant.gep, i64 %indvars.iv
  %14 = load double, ptr %gep, align 8
...
3:                                                ; preds = %2
  %4 = getelementptr inbounds nuw [328 x i8], ptr @rmr, i64 %indvars.iv2
...
7:                                                ; preds = %6
  ...
  call void @rInnerproduct(ptr noundef nonnull %8, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %5, i32 noundef %9)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
