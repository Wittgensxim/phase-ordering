...
4:                                                ; preds = %4, %2
  ...
  br i1 %exitcond.not, label %11, label %4, !llvm.loop !7

11:                                               ; preds = %4
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond5.not = icmp eq i64 %indvars.iv.next3, 41
  br i1 %exitcond5.not, label %12, label %2, !llvm.loop !9
...
9:                                                ; preds = %9, %5
  %10 = phi double [ 0.000000e+00, %5 ], [ %14, %9 ]
  %indvars.iv2 = phi i64 [ 1, %5 ], [ %indvars.iv.next, %9 ]
  %11 = getelementptr inbounds nuw [8 x i8], ptr %7, i64 %indvars.iv2
  %12 = load double, ptr %11, align 8
  %gep = getelementptr [328 x i8], ptr %invariant.gep, i64 %indvars.iv2
  %13 = load double, ptr %gep, align 8
  %14 = call double @llvm.fmuladd.f64(double %12, double %13, double %10)
  store double %14, ptr %0, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv2, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 41
  br i1 %exitcond.not, label %15, label %9, !llvm.loop !10
