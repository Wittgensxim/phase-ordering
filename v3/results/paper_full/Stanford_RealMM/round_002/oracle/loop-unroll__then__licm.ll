; ModuleID = 'results\paper_full\Stanford_RealMM\round_001\output.ll'
...
2:                                                ; preds = %11, %1
  ...
  %3 = getelementptr inbounds nuw [328 x i8], ptr %0, i64 %indvars.iv27
  br label %4
...
4:                                                ; preds = %4, %2
  ...
  %10 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv6
  store double %9, ptr %10, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv6, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 41
  br i1 %exitcond, label %4, label %11, !llvm.loop !7
...
define dso_local void @rInnerproduct(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %4) #0 {
  ...
  %invariant.gep1 = getelementptr [8 x i8], ptr %2, i64 %11
  br label %12

12:                                               ; preds = %12, %5
  %13 = phi double [ 0.000000e+00, %5 ], [ %21, %12 ]
  %indvars.iv2 = phi i64 [ 1, %5 ], [ %indvars.iv.next.1, %12 ]
  %14 = getelementptr inbounds nuw [8 x i8], ptr %7, i64 %indvars.iv2
  %15 = load double, ptr %14, align 8
  %gep = getelementptr [328 x i8], ptr %invariant.gep, i64 %indvars.iv2
  ...
  %18 = getelementptr inbounds nuw [8 x i8], ptr %10, i64 %indvars.iv.next
  %19 = load double, ptr %18, align 8
  %gep2 = getelementptr [328 x i8], ptr %invariant.gep1, i64 %indvars.iv.next
  %20 = load double, ptr %gep2, align 8
  ...
  br i1 %exitcond.1, label %12, label %22, !llvm.loop !10
...
2:                                                ; preds = %8, %1
  ...
  %3 = getelementptr inbounds nuw [328 x i8], ptr @rmr, i64 %indvars.iv27
  %4 = trunc nuw nsw i64 %indvars.iv27 to i32
  br label %5

5:                                                ; preds = %5, %2
  %indvars.iv6 = phi i64 [ 1, %2 ], [ %indvars.iv.next, %5 ]
  %6 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv6
  %7 = trunc nuw nsw i64 %indvars.iv6 to i32
  call void @rInnerproduct(ptr noundef nonnull %6, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %4, i32 noundef %7)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv6, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 41
