...
7:                                                ; preds = %5
  ...
  %13 = zext nneg i32 %.08 to i64
  %14 = getelementptr inbounds nuw [328 x i8], ptr %0, i64 %13
...
8:                                                ; preds = %6
  ...
  %15 = zext nneg i32 %.0 to i64
  %16 = getelementptr inbounds nuw [328 x i8], ptr %2, i64 %15
...
2:                                                ; preds = %15, %1
  ...
  %3 = icmp samesign ult i32 %.010, 41
...
7:                                                ; preds = %5
  %8 = zext nneg i32 %.010 to i64
  %9 = getelementptr inbounds nuw [328 x i8], ptr @rmr, i64 %8
  %10 = zext nneg i32 %.0 to i64
  %11 = getelementptr inbounds nuw [8 x i8], ptr %9, i64 %10
  call void @rInnerproduct(ptr noundef nonnull %11, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %.010, i32 noundef %.0)
  br label %12
