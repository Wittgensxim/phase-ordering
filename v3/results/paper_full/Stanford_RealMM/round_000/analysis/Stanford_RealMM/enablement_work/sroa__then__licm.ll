...
2:                                                ; preds = %22, %1
  %.08 = phi i32 [ 1, %1 ], [ %23, %22 ]
  %3 = icmp sle i32 %.08, 40
  br i1 %3, label %4, label %24

4:                                                ; preds = %2
  %5 = sext i32 %.08 to i64
  %6 = getelementptr inbounds [41 x double], ptr %0, i64 %5
  br label %7
...
9:                                                ; preds = %7
  ...
  %18 = getelementptr inbounds [41 x double], ptr %6, i64 0, i64 %17
...
9:                                                ; preds = %19, %5
  %10 = phi double [ %.promoted, %5 ], [ %18, %19 ]
  %.0 = phi i32 [ 1, %5 ], [ %20, %19 ]
...
12:                                               ; preds = %9
  ...
  %14 = getelementptr inbounds [41 x double], ptr %7, i64 0, i64 %13
  %15 = load double, ptr %14, align 8
  %16 = sext i32 %.0 to i64
  %gep = getelementptr [41 x double], ptr %invariant.gep, i64 %16
  %17 = load double, ptr %gep, align 8
  %18 = call double @llvm.fmuladd.f64(double %15, double %17, double %10)
...
4:                                                ; preds = %2
  ...
  %6 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %5
  br label %7
...
9:                                                ; preds = %7
  ...
  %11 = getelementptr inbounds [41 x double], ptr %6, i64 0, i64 %10
  call void @rInnerproduct(ptr noundef %11, ptr noundef @rma, ptr noundef @rmb, i32 noundef %.010, i32 noundef %.0)
  br label %12
