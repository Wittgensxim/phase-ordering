...
7:                                                ; preds = %29, %1
  %.lcssa27 = phi i32 [ %.lcssa2, %29 ], [ %.promoted, %1 ]
  %.lcssa6 = phi i32 [ %.lcssa, %29 ], [ %.promoted5, %1 ]
  %8 = phi i32 [ %30, %29 ], [ %.promoted3, %1 ]
  %9 = icmp sle i32 %8, 40
...
13:                                               ; preds = %26, %10
  %14 = phi i32 [ %18, %26 ], [ %.lcssa27, %10 ]
  %15 = phi i32 [ %27, %26 ], [ 1, %10 ]
...
17:                                               ; preds = %13
  ...
  %25 = getelementptr inbounds [41 x double], ptr %12, i64 0, i64 %24
