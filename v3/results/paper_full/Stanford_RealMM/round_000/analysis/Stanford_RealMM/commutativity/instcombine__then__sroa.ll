...
2:                                                ; preds = %20, %1
  %storemerge = phi i32 [ 1, %1 ], [ %21, %20 ]
  %3 = icmp slt i32 %storemerge, 41
...
5:                                                ; preds = %17, %4
  %storemerge1 = phi i32 [ 1, %4 ], [ %18, %17 ]
  %6 = icmp slt i32 %storemerge1, 41
...
7:                                                ; preds = %5
  ...
  %14 = getelementptr inbounds [328 x i8], ptr %0, i64 %13
...
7:                                                ; preds = %5
  ...
  call void @rInnerproduct(ptr noundef nonnull %11, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %storemerge, i32 noundef %storemerge1)
  br label %12

12:                                               ; preds = %7
  %13 = add nsw i32 %storemerge1, 1
...
17:                                               ; preds = %2
  ...
  %19 = getelementptr [328 x i8], ptr @rmr, i64 %18
  %20 = sext i32 %0 to i64
  %21 = getelementptr [8 x i8], ptr %19, i64 %20
  %22 = getelementptr i8, ptr %21, i64 336
  %23 = load double, ptr %22, align 8
  %24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %23) #3
  ret void
}
