...
7:                                                ; preds = %30, %1
  %.lcssa27 = phi i32 [ %.lcssa2, %30 ], [ %.promoted, %1 ]
  %.lcssa6 = phi i32 [ %.lcssa, %30 ], [ %.promoted5, %1 ]
  %8 = phi i32 [ %31, %30 ], [ %.promoted3, %1 ]
  %9 = icmp sle i32 %8, 40
...
13:                                               ; preds = %27, %10
  %14 = phi i32 [ %18, %27 ], [ %.lcssa27, %10 ]
  %15 = phi i32 [ %28, %27 ], [ 1, %10 ]
...
32:                                               ; preds = %7
  ...
  store i32 %.lcssa27.lcssa, ptr %3, align 1
  ret void
}
...
24:                                               ; preds = %21
  ...
  %gep = getelementptr [41 x double], ptr %invariant.gep, i64 %26
  %29 = load double, ptr %gep, align 8
  %30 = call double @llvm.fmuladd.f64(double %28, double %29, double %25)
