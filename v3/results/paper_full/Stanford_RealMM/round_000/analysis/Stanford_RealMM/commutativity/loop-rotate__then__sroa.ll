...
5:                                                ; preds = %.lr.ph, %10
  ...
  call void @rInnerproduct(ptr noundef %9, ptr noundef @rma, ptr noundef @rmb, i32 noundef %.015, i32 noundef %.0)
  br label %10
