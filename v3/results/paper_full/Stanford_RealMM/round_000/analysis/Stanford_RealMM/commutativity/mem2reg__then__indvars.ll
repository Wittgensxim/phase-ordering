...
2:                                                ; preds = %17, %1
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %17 ], [ 1, %1 ]
  %exitcond6 = icmp ne i64 %indvars.iv3, 41
  br i1 %exitcond6, label %3, label %18

3:                                                ; preds = %2
  br label %4

4:                                                ; preds = %15, %3
  %indvars.iv = phi i64 [ %indvars.iv.next, %15 ], [ 1, %3 ]
...
5:                                                ; preds = %4
  ...
  %13 = getelementptr inbounds [41 x double], ptr %0, i64 %indvars.iv3
  %14 = getelementptr inbounds [41 x double], ptr %13, i64 0, i64 %indvars.iv
...
6:                                                ; preds = %18, %5
  %indvars.iv = phi i64 [ %indvars.iv.next, %18 ], [ 1, %5 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
...
7:                                                ; preds = %6
  ...
  %11 = getelementptr inbounds [41 x double], ptr %10, i64 0, i64 %indvars.iv
  %12 = load double, ptr %11, align 8
  %13 = getelementptr inbounds [41 x double], ptr %2, i64 %indvars.iv
  %14 = sext i32 %4 to i64
  %15 = getelementptr inbounds [41 x double], ptr %13, i64 0, i64 %14
  %16 = load double, ptr %15, align 8
  %17 = call double @llvm.fmuladd.f64(double %12, double %16, double %8)
...
2:                                                ; preds = %12, %1
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %12 ], [ 1, %1 ]
  %exitcond6 = icmp ne i64 %indvars.iv3, 41
  br i1 %exitcond6, label %3, label %13
...
5:                                                ; preds = %4
  %6 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %indvars.iv3
  %7 = getelementptr inbounds [41 x double], ptr %6, i64 0, i64 %indvars.iv
  %8 = trunc nuw nsw i64 %indvars.iv to i32
  %9 = trunc nuw nsw i64 %indvars.iv3 to i32
  call void @rInnerproduct(ptr noundef %7, ptr noundef @rma, ptr noundef @rmb, i32 noundef %9, i32 noundef %8)
  br label %10
...
13:                                               ; preds = %2
  ...
  %16 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %15
  %17 = add nsw i32 %0, 1
  %18 = sext i32 %17 to i64
  %19 = getelementptr inbounds [41 x double], ptr %16, i64 0, i64 %18
