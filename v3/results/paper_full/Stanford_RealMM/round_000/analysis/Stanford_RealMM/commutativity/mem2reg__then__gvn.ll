...
2:                                                ; preds = %20, %1
  %.01 = phi i32 [ 1, %1 ], [ %21, %20 ]
  %3 = icmp sle i32 %.01, 40
...
7:                                                ; preds = %5
  ...
  %16 = getelementptr inbounds [41 x double], ptr %0, i64 %15
...
6:                                                ; preds = %9, %5
  %7 = phi double [ 0.000000e+00, %5 ], [ %19, %9 ]
  %.0 = phi i32 [ 1, %5 ], [ %20, %9 ]
  %8 = icmp sle i32 %.0, 40
...
9:                                                ; preds = %6
  ...
  %15 = getelementptr inbounds [41 x double], ptr %2, i64 %12
  %16 = sext i32 %4 to i64
  %17 = getelementptr inbounds [41 x double], ptr %15, i64 0, i64 %16
  %18 = load double, ptr %17, align 8
  %19 = call double @llvm.fmuladd.f64(double %14, double %18, double %7)
...
7:                                                ; preds = %5
  ...
  call void @rInnerproduct(ptr noundef %11, ptr noundef @rma, ptr noundef @rmb, i32 noundef %.01, i32 noundef %.0)
  %12 = add nsw i32 %.0, 1
...
15:                                               ; preds = %2
  ...
  %19 = getelementptr inbounds [41 x double], ptr %18, i64 0, i64 %17
