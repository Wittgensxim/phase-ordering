...
2:                                                ; preds = %1, %19
  %.0810 = phi i32 [ 1, %1 ], [ %20, %19 ]
  br label %3

3:                                                ; preds = %2, %15
  %.09 = phi i32 [ 1, %2 ], [ %16, %15 ]
  %4 = call i32 @Rand()
  %5 = sdiv i32 %4, 120
  %6 = mul nsw i32 %5, 120
  %7 = sub nsw i32 %4, %6
...
19:                                               ; preds = %18
  %20 = add nsw i32 %.0810, 1
  %21 = icmp sle i32 %20, 40
  br i1 %21, label %2, label %22, !llvm.loop !9
...
6:                                                ; preds = %5, %19
  %.010 = phi i32 [ 1, %5 ], [ %20, %19 ]
  %7 = load double, ptr %0, align 8
  %8 = sext i32 %3 to i64
  %9 = getelementptr inbounds [41 x double], ptr %1, i64 %8
  %10 = sext i32 %.010 to i64
  %11 = getelementptr inbounds [41 x double], ptr %9, i64 0, i64 %10
  %12 = load double, ptr %11, align 8
  %13 = sext i32 %.010 to i64
  %14 = getelementptr inbounds [41 x double], ptr %2, i64 %13
  %15 = sext i32 %4 to i64
  %16 = getelementptr inbounds [41 x double], ptr %14, i64 0, i64 %15
  %17 = load double, ptr %16, align 8
  %18 = call double @llvm.fmuladd.f64(double %12, double %17, double %7)
...
2:                                                ; preds = %1, %12
  %.01012 = phi i32 [ 1, %1 ], [ %13, %12 ]
  br label %3

3:                                                ; preds = %2, %8
  %.011 = phi i32 [ 1, %2 ], [ %9, %8 ]
  %4 = sext i32 %.01012 to i64
  %5 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %4
  %6 = sext i32 %.011 to i64
  %7 = getelementptr inbounds [41 x double], ptr %5, i64 0, i64 %6
  call void @rInnerproduct(ptr noundef %7, ptr noundef @rma, ptr noundef @rmb, i32 noundef %.01012, i32 noundef %.011)
  br label %8
...
12:                                               ; preds = %11
  %13 = add nsw i32 %.01012, 1
  %14 = icmp sle i32 %13, 40
  br i1 %14, label %2, label %15, !llvm.loop !12

15:                                               ; preds = %12
  %16 = add nsw i32 %0, 1
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %17
  %19 = add nsw i32 %0, 1
