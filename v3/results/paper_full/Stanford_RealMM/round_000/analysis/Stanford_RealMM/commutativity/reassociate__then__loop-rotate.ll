...
11:                                               ; preds = %.lr.ph, %27
  ...
  %23 = getelementptr inbounds [41 x double], ptr %20, i64 %22
  %24 = load i32, ptr %5, align 4
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds [41 x double], ptr %23, i64 0, i64 %25
...
27:                                               ; preds = %11
  ...
  br i1 %31, label %11, label %._crit_edge, !llvm.loop !7
...
33:                                               ; preds = %32
  ...
  br i1 %37, label %8, label %._crit_edge3, !llvm.loop !9
...
15:                                               ; preds = %.lr.ph, %36
  ...
  %21 = getelementptr inbounds [41 x double], ptr %18, i64 %20
  %22 = load i32, ptr %11, align 4
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [41 x double], ptr %21, i64 0, i64 %23
  %25 = load double, ptr %24, align 8
  %26 = load ptr, ptr %8, align 8
  %27 = load i32, ptr %11, align 4
  %28 = sext i32 %27 to i64
  %29 = getelementptr inbounds [41 x double], ptr %26, i64 %28
  %30 = load i32, ptr %10, align 4
  %31 = sext i32 %30 to i64
  %32 = getelementptr inbounds [41 x double], ptr %29, i64 0, i64 %31
  %33 = load double, ptr %32, align 8
  %34 = call double @llvm.fmuladd.f64(double %25, double %33, double %17)
...
10:                                               ; preds = %.lr.ph, %19
  ...
  %13 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %12
  %14 = load i32, ptr %4, align 4
  %15 = sext i32 %14 to i64
  %16 = getelementptr inbounds [41 x double], ptr %13, i64 0, i64 %15
  %17 = load i32, ptr %3, align 4
  %18 = load i32, ptr %4, align 4
  call void @rInnerproduct(ptr noundef %16, ptr noundef @rma, ptr noundef @rmb, i32 noundef %17, i32 noundef %18)
  br label %19
...
25:                                               ; preds = %24
  ...
  br i1 %29, label %7, label %._crit_edge3, !llvm.loop !12
...
30:                                               ; preds = %._crit_edge3, %1
  ...
  %34 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %33
  %35 = load i32, ptr %2, align 4
  %36 = add nsw i32 %35, 1
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [41 x double], ptr %34, i64 0, i64 %37
