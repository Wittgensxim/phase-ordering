...
4:                                                ; preds = %25, %1
  %.lcssa27 = phi i32 [ %11, %25 ], [ %.promoted, %1 ]
  %.lcssa6 = phi i32 [ %12, %25 ], [ %.promoted5, %1 ]
  %5 = phi i32 [ %26, %25 ], [ 1, %1 ]
...
10:                                               ; preds = %22, %7
  %11 = phi i32 [ %.fr, %22 ], [ %.lcssa27, %7 ]
  %12 = phi i32 [ %23, %22 ], [ 1, %7 ]
...
define dso_local void @rInnerproduct(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %4) #0 {
  ...
  %14 = getelementptr inbounds [328 x i8], ptr %12, i64 %13
  %15 = load ptr, ptr %8, align 8
  %16 = load i32, ptr %9, align 4
  %17 = sext i32 %16 to i64
  %invariant.gep = getelementptr [8 x i8], ptr %15, i64 %17
  %18 = load ptr, ptr %6, align 8
  %.promoted = load i32, ptr %10, align 4
  br label %19

19:                                               ; preds = %30, %5
  %20 = phi i32 [ %31, %30 ], [ %.promoted, %5 ]
...
22:                                               ; preds = %19
  ...
  %gep = getelementptr [328 x i8], ptr %invariant.gep, i64 %27
...
13:                                               ; preds = %10
  ...
  call void @rInnerproduct(ptr noundef nonnull %15, ptr noundef nonnull @rma, ptr noundef nonnull @rmb, i32 noundef %5, i32 noundef %11)
  br label %16
