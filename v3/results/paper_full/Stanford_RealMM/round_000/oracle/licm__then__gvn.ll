...
6:                                                ; preds = %27, %1
  %.lcssa27 = phi i32 [ %13, %27 ], [ undef, %1 ]
  %.lcssa6 = phi i32 [ %14, %27 ], [ undef, %1 ]
  %7 = phi i32 [ %28, %27 ], [ 1, %1 ]
  %8 = icmp sle i32 %7, 40
...
9:                                                ; preds = %6
  ...
  %11 = getelementptr inbounds [41 x double], ptr %0, i64 %10
  br label %12

12:                                               ; preds = %16, %9
  %13 = phi i32 [ %17, %16 ], [ %.lcssa27, %9 ]
  %14 = phi i32 [ %26, %16 ], [ 1, %9 ]
...
16:                                               ; preds = %12
  ...
  %21 = sub nsw i32 %20, 60
  %22 = sitofp i32 %21 to double
  %23 = fdiv double %22, 3.000000e+00
  %24 = sext i32 %14 to i64
  %25 = getelementptr inbounds [41 x double], ptr %11, i64 0, i64 %24
...
15:                                               ; preds = %19, %5
  %16 = phi double [ %24, %19 ], [ 0.000000e+00, %5 ]
  %17 = phi i32 [ %25, %19 ], [ 1, %5 ]
  %18 = icmp sle i32 %17, 40
  br i1 %18, label %19, label %26

19:                                               ; preds = %15
  %20 = sext i32 %17 to i64
  %21 = getelementptr inbounds [41 x double], ptr %13, i64 0, i64 %20
  %22 = load double, ptr %21, align 8
  %gep = getelementptr [41 x double], ptr %invariant.gep, i64 %20
  %23 = load double, ptr %gep, align 8
  %24 = call double @llvm.fmuladd.f64(double %22, double %23, double %16)
...
11:                                               ; preds = %14, %8
  %12 = phi i32 [ %17, %14 ], [ 1, %8 ]
  %13 = icmp sle i32 %12, 40
  br i1 %13, label %14, label %18

14:                                               ; preds = %11
  %15 = sext i32 %12 to i64
  %16 = getelementptr inbounds [41 x double], ptr %10, i64 0, i64 %15
  call void @rInnerproduct(ptr noundef %16, ptr noundef @rma, ptr noundef @rmb, i32 noundef %6, i32 noundef %12)
  %17 = add nsw i32 %12, 1
