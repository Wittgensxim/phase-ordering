...
6:                                                ; preds = %20, %1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %20 ], [ 1, %1 ]
  %exitcond5 = icmp ne i64 %indvars.iv2, 41
  br i1 %exitcond5, label %7, label %22
...
8:                                                ; preds = %9, %7
  %indvars.iv = phi i64 [ %indvars.iv.next, %9 ], [ 1, %7 ]
...
9:                                                ; preds = %8
  ...
  %17 = getelementptr inbounds [41 x double], ptr %0, i64 %indvars.iv2
  %18 = getelementptr inbounds [41 x double], ptr %17, i64 0, i64 %indvars.iv
...
20:                                               ; preds = %8
  ...
  %21 = trunc nuw nsw i64 %indvars.iv.next3 to i32
...
12:                                               ; preds = %14, %5
  ...
  %13 = phi double [ %23, %14 ], [ 0.000000e+00, %5 ]
  %exitcond = icmp ne i64 %indvars.iv, 41
  br i1 %exitcond, label %14, label %25

14:                                               ; preds = %12
  %15 = sext i32 %3 to i64
  %16 = getelementptr inbounds [41 x double], ptr %1, i64 %15
  %17 = getelementptr inbounds [41 x double], ptr %16, i64 0, i64 %indvars.iv
  %18 = load double, ptr %17, align 8
  %19 = getelementptr inbounds [41 x double], ptr %2, i64 %indvars.iv
  %20 = sext i32 %4 to i64
  %21 = getelementptr inbounds [41 x double], ptr %19, i64 0, i64 %20
  %22 = load double, ptr %21, align 8
  %23 = call double @llvm.fmuladd.f64(double %18, double %22, double %13)
...
5:                                                ; preds = %14, %1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %14 ], [ 1, %1 ]
  %exitcond5 = icmp ne i64 %indvars.iv2, 41
  br i1 %exitcond5, label %6, label %16
...
8:                                                ; preds = %7
  %9 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %indvars.iv2
  %10 = getelementptr inbounds [41 x double], ptr %9, i64 0, i64 %indvars.iv
  %11 = trunc nuw nsw i64 %indvars.iv to i32
  %12 = trunc nuw nsw i64 %indvars.iv2 to i32
  call void @rInnerproduct(ptr noundef %10, ptr noundef @rma, ptr noundef @rmb, i32 noundef %12, i32 noundef %11)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
14:                                               ; preds = %7
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %15 = trunc nuw nsw i64 %indvars.iv.next3 to i32
...
16:                                               ; preds = %5
  ...
  %19 = getelementptr inbounds [41 x [41 x double]], ptr @rmr, i64 0, i64 %18
  %20 = getelementptr inbounds [41 x double], ptr %19, i64 0, i64 %18
