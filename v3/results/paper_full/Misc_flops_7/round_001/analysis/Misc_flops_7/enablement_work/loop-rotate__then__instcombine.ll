...
2:                                                ; preds = %0, %3
  %.02 = phi double [ 0.000000e+00, %0 ], [ %15, %3 ]
  %.011 = phi i32 [ 1, %0 ], [ %16, %3 ]
  br label %3

3:                                                ; preds = %2
  %4 = uitofp nneg i32 %.011 to double
  ...
  %17 = icmp samesign ult i32 %.011, 156249999
...
18:                                               ; preds = %3
  ...
  %32 = call double @llvm.fmuladd.f64(double %31, double %15, double %30)
