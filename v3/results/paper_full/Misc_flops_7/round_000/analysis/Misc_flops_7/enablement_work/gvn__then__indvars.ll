...
17:                                               ; preds = %20, %0
  %18 = phi double [ %32, %20 ], [ 0.000000e+00, %0 ]
  %19 = phi i32 [ %33, %20 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %19, 156250000
  br i1 %exitcond, label %20, label %34

20:                                               ; preds = %17
  %21 = sitofp i32 %19 to double
  %22 = fmul double %21, f0x3EA5F9C4FF20F589
  ...
  %27 = fadd double %23, %16
  %28 = fdiv double %22, %27
  %29 = fsub double %26, %28
  %30 = call double @llvm.fmuladd.f64(double %22, double %23, double %16)
