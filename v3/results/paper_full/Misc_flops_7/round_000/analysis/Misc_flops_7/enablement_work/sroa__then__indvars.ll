...
11:                                               ; preds = %25, %0
  %.035 = phi double [ 0.000000e+00, %0 ], [ %24, %25 ]
  %.0 = phi i32 [ 1, %0 ], [ %26, %25 ]
...
27:                                               ; preds = %11
  ...
  %43 = call double @llvm.fmuladd.f64(double %42, double %.035.lcssa, double %41)
