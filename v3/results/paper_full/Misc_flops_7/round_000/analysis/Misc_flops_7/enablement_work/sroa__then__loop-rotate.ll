...
12:                                               ; preds = %0, %25
  %.037 = phi i32 [ 1, %0 ], [ %26, %25 ]
  %.03536 = phi double [ 0.000000e+00, %0 ], [ %24, %25 ]
  %13 = sitofp i32 %.037 to double
  %14 = fmul double %13, %10
  %15 = fmul double %14, %14
  %16 = fadd double %14, %7
  %17 = fdiv double %7, %16
  %18 = fsub double %.03536, %17
  %19 = fadd double %15, %7
...
28:                                               ; preds = %25
  ...
  %44 = call double @llvm.fmuladd.f64(double %43, double %.035.lcssa, double %42)
