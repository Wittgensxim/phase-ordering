...
define dso_local i32 @main() #0 {
  ...
  br i1 %.not.not3, label %.lr.ph, label %39
...
39:                                               ; preds = %._crit_edge, %0
  ...
  %53 = call double @llvm.fmuladd.f64(double %47, double %48, double %49)
  %54 = fdiv double %48, %53
  %55 = fsub double %52, %54
  store double %55, ptr @sa, align 8
  %56 = load double, ptr %3, align 8
  %57 = fmul double %56, 1.800000e+01
  ...
  %69 = fadd double %68, 5.002000e+02
