...
define dso_local i32 @main() #0 {
  ...
  %9 = fdiv double f0x40599541F7F192A4, %8
  br label %10

10:                                               ; preds = %26, %0
  %.012 = phi double [ 0.000000e+00, %0 ], [ %25, %26 ]
  %.0 = phi i32 [ 1, %0 ], [ %27, %26 ]
  %11 = sub nsw i32 %6, 1
...
28:                                               ; preds = %10
  ...
  %41 = fmul double 1.800000e+01, %9
  %42 = load double, ptr @two, align 8
  %43 = call double @llvm.fmuladd.f64(double %42, double %.012, double %40)
