...
17:                                               ; preds = %.lr.ph, %17
  %18 = phi double [ 0.000000e+00, %.lr.ph ], [ %31, %17 ]
  %19 = phi i32 [ 1, %.lr.ph ], [ %32, %17 ]
  ...
  br i1 %33, label %17, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %17
  br label %34

34:                                               ; preds = %._crit_edge1, %._crit_edge
  %35 = phi double [ 0.000000e+00, %._crit_edge1 ], [ %31, %._crit_edge ]
  ...
  %47 = call double @llvm.fmuladd.f64(double %46, double %35, double %45)
