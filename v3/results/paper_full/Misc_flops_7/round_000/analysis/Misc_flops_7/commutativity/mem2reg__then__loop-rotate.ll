...
12:                                               ; preds = %0, %25
  %.03 = phi double [ 0.000000e+00, %0 ], [ %24, %25 ]
  %.012 = phi i32 [ 1, %0 ], [ %26, %25 ]
  %13 = sitofp i32 %.012 to double
  %14 = fmul double %13, %10
  %15 = fmul double %14, %14
  %16 = fadd double %14, %7
  %17 = fdiv double %7, %16
  %18 = fsub double %.03, %17
  %19 = fadd double %15, %7
...
28:                                               ; preds = %25
  ...
  %38 = call double @llvm.fmuladd.f64(double %29, double %30, double %7)
  %39 = fdiv double %30, %38
  %40 = fsub double %37, %39
  store double %40, ptr @sa, align 8
  %41 = fmul double 1.800000e+01, %10
