...
define dso_local i32 @main() #0 {
  ...
  %smax = call i32 @llvm.smax.i32(i32 %.promoted, i32 %24)
  br label %30

30:                                               ; preds = %48, %0
  %31 = phi double [ %47, %48 ], [ %.promoted5, %0 ]
  %32 = phi double [ %38, %48 ], [ %.promoted3, %0 ]
  %33 = phi double [ %37, %48 ], [ %.promoted1, %0 ]
  %34 = phi i32 [ %49, %48 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %34, %smax
  br i1 %exitcond, label %35, label %50

35:                                               ; preds = %30
  %36 = sitofp i32 %34 to double
  %37 = fmul double %36, %25
  %38 = fmul double %37, %37
  %39 = fadd double %37, %27
  %40 = fdiv double %26, %39
  %41 = fsub double %31, %40
  %42 = fadd double %38, %28
  %43 = fdiv double %37, %42
  %44 = fsub double %41, %43
  %45 = call double @llvm.fmuladd.f64(double %37, double %38, double %29)
