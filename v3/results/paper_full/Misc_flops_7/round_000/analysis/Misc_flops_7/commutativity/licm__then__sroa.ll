...
12:                                               ; preds = %31, %0
  %13 = phi double [ %30, %31 ], [ 0.000000e+00, %0 ]
  %14 = phi double [ %21, %31 ], [ undef, %0 ]
  %15 = phi double [ %20, %31 ], [ undef, %0 ]
...
18:                                               ; preds = %12
  ...
  %28 = call double @llvm.fmuladd.f64(double %20, double %21, double %7)
...
33:                                               ; preds = %12
  %.lcssa6 = phi double [ %13, %12 ]
  %.lcssa4 = phi double [ %14, %12 ]
