...
10:                                               ; preds = %26, %0
  %.035 = phi double [ 0.000000e+00, %0 ], [ %25, %26 ]
  %.0 = phi i32 [ 1, %0 ], [ %27, %26 ]
  %11 = sub nsw i32 156250000, 1
...
13:                                               ; preds = %10
  ...
  %17 = fadd double %6, %15
  %18 = fdiv double %6, %17
  %19 = fsub double %.035, %18
  %20 = fadd double %6, %16
  %21 = fdiv double %15, %20
  %22 = fsub double %19, %21
  %23 = call double @llvm.fmuladd.f64(double %15, double %16, double %6)
...
28:                                               ; preds = %10
  ...
  %38 = call double @llvm.fmuladd.f64(double %29, double %30, double %6)
  %39 = fdiv double %30, %38
  %40 = fsub double %37, %39
  store double %40, ptr @sa, align 8
  %41 = fmul double %9, 1.800000e+01
  %42 = load double, ptr @sa, align 8
  %43 = load double, ptr @two, align 8
  %44 = call double @llvm.fmuladd.f64(double %43, double %.035, double %42)
