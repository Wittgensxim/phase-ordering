...
17:                                               ; preds = %23, %0
  %18 = phi double [ %35, %23 ], [ 0.000000e+00, %0 ]
  %19 = phi double [ %26, %23 ], [ undef, %0 ]
  %20 = phi double [ %25, %23 ], [ undef, %0 ]
...
23:                                               ; preds = %17
  ...
  %25 = fmul double %24, f0x3EA5F9C4FF20F589
  ...
  %33 = call double @llvm.fmuladd.f64(double %25, double %26, double %16)
...
37:                                               ; preds = %17
  ...
  %38 = fneg double %16
  %39 = fadd double f0x40599541F7F192A4, %16
  %40 = fdiv double %16, %39
  %41 = fsub double %38, %40
  %42 = fadd double f0x40C473EF42466D8C, %16
  %43 = fdiv double f0x40599541F7F192A4, %42
  %44 = fsub double %41, %43
  %45 = call double @llvm.fmuladd.f64(double f0x40599541F7F192A4, double f0x40C473EF42466D8C, double %16)
  %46 = fdiv double f0x40C473EF42466D8C, %45
  %47 = fsub double %44, %46
  store double %47, ptr @sa, align 8
  %48 = load double, ptr @two, align 8
  %49 = call double @llvm.fmuladd.f64(double %48, double %18, double %47)
  %50 = fmul double f0x3EE8B8FD9F05143A, %49
  store double %50, ptr @sa, align 8
  %51 = fptosi double %50 to i32
  %52 = mul nsw i32 -2000, %51
  ...
  %57 = fadd double %50, 5.002000e+02
