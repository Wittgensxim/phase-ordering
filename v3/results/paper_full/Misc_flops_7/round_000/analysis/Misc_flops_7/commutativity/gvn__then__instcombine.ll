...
2:                                                ; preds = %6, %0
  %3 = phi double [ %18, %6 ], [ 0.000000e+00, %0 ]
  %4 = phi i32 [ %19, %6 ], [ 1, %0 ]
  %5 = icmp samesign ult i32 %4, 156250000
  br i1 %5, label %6, label %20

6:                                                ; preds = %2
  %7 = uitofp nneg i32 %4 to double
  %8 = fmul nnan double %7, f0x3EA5F9C4FF20F589
  %9 = fmul nnan double %8, %8
  %10 = fadd double %8, %1
  %11 = fdiv double %1, %10
  %12 = fsub double %3, %11
  %13 = fadd double %9, %1
  ...
  %16 = call double @llvm.fmuladd.f64(double %8, double %9, double %1)
  %17 = fdiv double %9, %16
...
20:                                               ; preds = %2
  %21 = fneg double %1
  %22 = fadd double %1, f0x40599541F7F192A4
  %23 = fdiv double %1, %22
  %24 = fsub double %21, %23
  %25 = fadd double %1, f0x40C473EF42466D8C
  %26 = fdiv double f0x40599541F7F192A4, %25
  %27 = fsub double %24, %26
  %28 = fadd double %1, f0x413059F8E7CAE1C6
  %29 = fdiv double f0x40C473EF42466D8C, %28
  %30 = fsub double %27, %29
  store double %30, ptr @sa, align 8
  %31 = load double, ptr @two, align 8
  %32 = call double @llvm.fmuladd.f64(double %31, double %3, double %30)
