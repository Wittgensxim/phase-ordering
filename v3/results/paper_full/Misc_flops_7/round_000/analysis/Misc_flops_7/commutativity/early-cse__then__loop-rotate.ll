...
26:                                               ; preds = %.lr.ph, %44
  ...
  %38 = fadd double %31, %33
  %39 = fdiv double %34, %38
  %40 = fsub double %37, %39
  %41 = call double @llvm.fmuladd.f64(double %34, double %31, double %33)
...
44:                                               ; preds = %26
  ...
  br i1 %50, label %26, label %._crit_edge, !llvm.loop !7
...
51:                                               ; preds = %._crit_edge, %0
  ...
  %60 = fadd double %53, %54
  %61 = fdiv double %56, %60
  %62 = fsub double %59, %61
  %63 = call double @llvm.fmuladd.f64(double %56, double %53, double %54)
  %64 = fdiv double %53, %63
  %65 = fsub double %62, %64
  store double %65, ptr @sa, align 8
  %66 = load double, ptr %4, align 8
  %67 = fmul double 1.800000e+01, %66
  %68 = load double, ptr @two, align 8
  %69 = load double, ptr %2, align 8
  %70 = call double @llvm.fmuladd.f64(double %68, double %69, double %65)
  %71 = fmul double %67, %70
  store double %71, ptr @sa, align 8
  %72 = fptosi double %71 to i32
  %73 = mul nsw i32 -2000, %72
  store i32 %73, ptr %10, align 4
  %74 = sitofp i32 %73 to double
  %75 = load double, ptr @scale, align 8
  %76 = fdiv double %74, %75
  %77 = fptosi double %76 to i32
  store i32 %77, ptr %10, align 4
  %78 = load double, ptr @sa, align 8
  %79 = fadd double %78, 5.002000e+02
