...
define dso_local i32 @main() #0 {
  ...
  %2 = load double, ptr @one, align 8
  store double f0x40599541F7F192A4, ptr @sa, align 8
  %3 = sitofp i32 %1 to double
  %4 = fdiv double f0x40599541F7F192A4, %3
  br label %5

5:                                                ; preds = %19, %0
  %.0 = phi double [ 0.000000e+00, %0 ], [ %18, %19 ]
  %storemerge = phi i32 [ 1, %0 ], [ %20, %19 ]
  %.not.not = icmp slt i32 %storemerge, %1
  br i1 %.not.not, label %6, label %21
...
6:                                                ; preds = %5
  ...
  %16 = call double @llvm.fmuladd.f64(double %8, double %9, double %2)
  %17 = fdiv double %9, %16
...
21:                                               ; preds = %5
  ...
  %31 = call double @llvm.fmuladd.f64(double %22, double %23, double %2)
  %32 = fdiv double %23, %31
  %33 = fsub double %30, %32
  store double %33, ptr @sa, align 8
  %34 = fmul double %4, 1.800000e+01
  %35 = load double, ptr @two, align 8
  %36 = call double @llvm.fmuladd.f64(double %35, double %.0, double %33)
  ...
  %45 = fadd double %44, 5.002000e+02
