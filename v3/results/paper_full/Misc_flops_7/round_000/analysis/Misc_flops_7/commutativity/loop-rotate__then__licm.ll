...
35:                                               ; preds = %.lr.ph, %50
  %36 = phi double [ %.promoted5, %.lr.ph ], [ %49, %50 ]
  %37 = phi i32 [ %.promoted, %.lr.ph ], [ %51, %50 ]
  %38 = sitofp i32 %37 to double
  %39 = fmul double %38, %28
  %40 = fmul double %39, %39
  %41 = fadd double %39, %30
  %42 = fdiv double %29, %41
  %43 = fsub double %36, %42
  %44 = fadd double %40, %31
  %45 = fdiv double %39, %44
  %46 = fsub double %43, %45
  %47 = call double @llvm.fmuladd.f64(double %39, double %40, double %32)
...
50:                                               ; preds = %35
  %51 = add nsw i32 %37, 1
  %52 = icmp sle i32 %51, %34
  br i1 %52, label %35, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %50
  %.lcssa6 = phi double [ %49, %50 ]
  %.lcssa4 = phi double [ %40, %50 ]
  %.lcssa2 = phi double [ %39, %50 ]
  %.lcssa = phi i32 [ %51, %50 ]
...
53:                                               ; preds = %._crit_edge, %0
  ...
  %80 = fmul double 1.800000e+01, %79
  ...
  %88 = mul nsw i32 -2000, %87
  store i32 %88, ptr %10, align 4
  %89 = load i32, ptr %10, align 4
  %90 = sitofp i32 %89 to double
  %91 = load double, ptr @scale, align 8
  %92 = fdiv double %90, %91
  %93 = fptosi double %92 to i32
  store i32 %93, ptr %10, align 4
  %94 = load double, ptr @sa, align 8
  %95 = fadd double %94, 5.002000e+02
