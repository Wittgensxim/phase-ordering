...
define dso_local i32 @main() #0 {
  ...
  %11 = fdiv double f0x40599541F7F192A4, %10
  store double %11, ptr %2, align 8
  br label %12

12:                                               ; preds = %30, %0
  %storemerge = phi i32 [ 1, %0 ], [ %32, %30 ]
  store i32 %storemerge, ptr %5, align 4
  %13 = load i32, ptr %6, align 4
  %.not.not = icmp slt i32 %storemerge, %13
  br i1 %.not.not, label %14, label %33

14:                                               ; preds = %12
  %15 = sitofp i32 %storemerge to double
  ...
  %27 = call double @llvm.fmuladd.f64(double %17, double %18, double %20)
...
33:                                               ; preds = %12
  ...
  %60 = fadd double %59, 5.002000e+02
