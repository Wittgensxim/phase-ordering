...
31:                                               ; preds = %28
  ...
  %33 = fcmp ole double %.0.vec.extract6, 2.500000e+06
...
34:                                               ; preds = %.lr.ph, %49
  %.05812 = phi <2 x double> [ %3, %.lr.ph ], [ %40, %49 ]
  %.05911 = phi <2 x double> [ %7, %.lr.ph ], [ %50, %49 ]
  %.06010 = phi <2 x double> [ %3, %.lr.ph ], [ %43, %49 ]
  %.0619 = phi <2 x double> [ %3, %.lr.ph ], [ %38, %49 ]
  %.0628 = phi <2 x double> [ %3, %.lr.ph ], [ %45, %49 ]
  %.0637 = phi <2 x double> [ %3, %.lr.ph ], [ %48, %49 ]
  %35 = fadd <2 x double> %.05911, %4
  %36 = fmul <2 x double> %.05911, %35
  %37 = fdiv <2 x double> %4, %36
  %38 = fadd <2 x double> %.0619, %37
  %39 = fdiv <2 x double> %4, %.05911
  %40 = fadd <2 x double> %.05812, %39
  %41 = fmul <2 x double> %.05911, %.05911
  %42 = fdiv <2 x double> %4, %41
  %43 = fadd <2 x double> %.06010, %42
  %44 = fdiv <2 x double> %8, %.05911
  %45 = fadd <2 x double> %.0628, %44
  %46 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.05911, <2 x double> %32)
  %47 = fdiv <2 x double> %8, %46
  %48 = fadd <2 x double> %.0637, %47
  br label %49
...
49:                                               ; preds = %34
  ...
  br i1 %51, label %34, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %49
  %split = phi <2 x double> [ %48, %49 ]
  %split13 = phi <2 x double> [ %45, %49 ]
  %split14 = phi <2 x double> [ %38, %49 ]
  %split15 = phi <2 x double> [ %43, %49 ]
  %split16 = phi <2 x double> [ %40, %49 ]
  br label %52
