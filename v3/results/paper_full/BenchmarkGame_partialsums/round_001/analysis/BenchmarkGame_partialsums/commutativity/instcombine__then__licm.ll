...
34:                                               ; preds = %37, %32
  %.063 = phi <2 x double> [ %3, %32 ], [ %40, %37 ]
  %.062 = phi <2 x double> [ %3, %32 ], [ %42, %37 ]
  %.061 = phi <2 x double> [ %3, %32 ], [ %51, %37 ]
  %.060 = phi <2 x double> [ %3, %32 ], [ %45, %37 ]
  %.059 = phi <2 x double> [ %7, %32 ], [ %52, %37 ]
  %.058 = phi <2 x double> [ %3, %32 ], [ %47, %37 ]
  %.0.vec.extract = extractelement <2 x double> %.059, i64 0
  %35 = fcmp ugt double %.0.vec.extract, 2.500000e+06
...
37:                                               ; preds = %36
  %38 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.059, <2 x double> %33)
...
53:                                               ; preds = %34
  ...
  %54 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.0.lcssa, ptr noundef nonnull @.str.1) #4
  %55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.054.lcssa, ptr noundef nonnull @.str.2) #4
  ...
  %58 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.055.lcssa, ptr noundef nonnull @.str.4) #4
  %59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.056.lcssa, ptr noundef nonnull @.str.5) #4
