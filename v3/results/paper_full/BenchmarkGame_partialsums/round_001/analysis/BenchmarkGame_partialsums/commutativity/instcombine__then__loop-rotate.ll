...
31:                                               ; preds = %15
  %.056.lcssa = phi double [ %21, %15 ]
  %.055.lcssa = phi double [ %25, %15 ]
  %.054.lcssa = phi double [ %27, %15 ]
  %.0.lcssa = phi double [ %28, %15 ]
...
._crit_edge:                                      ; preds = %34
  %split = phi <2 x double> [ %38, %34 ]
  %split13 = phi <2 x double> [ %40, %34 ]
  %split14 = phi <2 x double> [ %49, %34 ]
  %split15 = phi <2 x double> [ %43, %34 ]
  %split16 = phi <2 x double> [ %45, %34 ]
  br label %52
...
52:                                               ; preds = %._crit_edge, %31
  ...
  %53 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.0.lcssa, ptr noundef nonnull @.str.1) #4
  %54 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.054.lcssa, ptr noundef nonnull @.str.2) #4
  ...
  %57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.055.lcssa, ptr noundef nonnull @.str.4) #4
  %58 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.056.lcssa, ptr noundef nonnull @.str.5) #4
