...
31:                                               ; preds = %9, %33
  %.063 = phi <2 x double> [ %37, %33 ], [ %3, %9 ]
  %.062 = phi <2 x double> [ %39, %33 ], [ %3, %9 ]
  %.061 = phi <2 x double> [ %48, %33 ], [ %3, %9 ]
  %.060 = phi <2 x double> [ %42, %33 ], [ %3, %9 ]
  %.059 = phi <2 x double> [ %49, %33 ], [ %7, %9 ]
  %.058 = phi <2 x double> [ %44, %33 ], [ %3, %9 ]
  %.0.vec.extract = extractelement <2 x double> %.059, i64 0
  %32 = fcmp ugt double %.0.vec.extract, 2.500000e+06
  br i1 %32, label %50, label %33

33:                                               ; preds = %31
  %34 = fneg <2 x double> %4
  %35 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.059, <2 x double> %34)
  %36 = fdiv <2 x double> %8, %35
  %37 = fadd <2 x double> %.063, %36
  %38 = fdiv <2 x double> %8, %.059
  %39 = fadd <2 x double> %.062, %38
  %40 = fmul <2 x double> %.059, %.059
  %41 = fdiv <2 x double> %4, %40
  %42 = fadd <2 x double> %.060, %41
  %43 = fdiv <2 x double> %4, %.059
  %44 = fadd <2 x double> %.058, %43
  %45 = fadd <2 x double> %.059, %4
  %46 = fmul <2 x double> %.059, %45
  %47 = fdiv <2 x double> %4, %46
  %48 = fadd <2 x double> %.061, %47
  %49 = fadd <2 x double> %.059, %5
  br label %31, !llvm.loop !9

50:                                               ; preds = %31
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.0, ptr noundef nonnull @.str.1) #4
  %52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.054, ptr noundef nonnull @.str.2) #4
  %53 = call double @sum_vec(<2 x double> noundef %.061)
  %54 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %53, ptr noundef nonnull @.str.3) #4
  %55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.055, ptr noundef nonnull @.str.4) #4
  %56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.056, ptr noundef nonnull @.str.5) #4
  %57 = call double @sum_vec(<2 x double> noundef %.058)
  %58 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %57, ptr noundef nonnull @.str.6) #4
  %59 = call double @sum_vec(<2 x double> noundef %.060)
  %60 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %59, ptr noundef nonnull @.str.7) #4
  %61 = call double @sum_vec(<2 x double> noundef %.062)
  %62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %61, ptr noundef nonnull @.str.8) #4
  %63 = call double @sum_vec(<2 x double> noundef %.063)
