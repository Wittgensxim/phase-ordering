...
33:                                               ; preds = %51, %32
  ...
  %.062 = phi <2 x double> [ %3, %32 ], [ %46, %51 ]
  %.061 = phi <2 x double> [ %3, %32 ], [ %39, %51 ]
  %.060 = phi <2 x double> [ %3, %32 ], [ %44, %51 ]
  %.059 = phi <2 x double> [ %7, %32 ], [ %52, %51 ]
  %.058 = phi <2 x double> [ %3, %32 ], [ %41, %51 ]
...
51:                                               ; preds = %35
  %52 = fadd <2 x double> %5, %.059
  br label %33, !llvm.loop !9

53:                                               ; preds = %33
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.0, ptr noundef @.str.1)
  %55 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.054, ptr noundef @.str.2)
  %56 = call double @sum_vec(<2 x double> noundef %.061)
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %56, ptr noundef @.str.3)
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.055, ptr noundef @.str.4)
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.056, ptr noundef @.str.5)
