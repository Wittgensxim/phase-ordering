...
52:                                               ; preds = %._crit_edge, %31
  %.063.lcssa = phi <2 x double> [ %48, %._crit_edge ], [ %3, %31 ]
  %.062.lcssa = phi <2 x double> [ %44, %._crit_edge ], [ %3, %31 ]
  %.061.lcssa = phi <2 x double> [ %37, %._crit_edge ], [ %3, %31 ]
  %.060.lcssa = phi <2 x double> [ %42, %._crit_edge ], [ %3, %31 ]
  %.058.lcssa = phi <2 x double> [ %39, %._crit_edge ], [ %3, %31 ]
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %12, ptr noundef @.str.1)
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %15, ptr noundef @.str.2)
  ...
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %23, ptr noundef @.str.4)
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %27, ptr noundef @.str.5)
