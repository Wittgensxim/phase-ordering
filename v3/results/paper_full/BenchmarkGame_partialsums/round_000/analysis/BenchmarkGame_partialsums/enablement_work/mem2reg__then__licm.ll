...
34:                                               ; preds = %11
  %.06.lcssa = phi double [ %.06, %11 ]
  %.05.lcssa = phi double [ %.05, %11 ]
  %.04.lcssa = phi double [ %.04, %11 ]
  %.03.lcssa = phi double [ %.03, %11 ]
...
65:                                               ; preds = %37
  %.09.lcssa = phi <2 x double> [ %.09, %37 ]
  %.08.lcssa = phi <2 x double> [ %.08, %37 ]
  %.07.lcssa = phi <2 x double> [ %.07, %37 ]
  %.02.lcssa = phi <2 x double> [ %.02, %37 ]
  %.01.lcssa = phi <2 x double> [ %.01, %37 ]
