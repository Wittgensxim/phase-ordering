...
9:                                                ; preds = %31, %2
  %.049 = phi double [ 1.000000e+00, %2 ], [ %32, %31 ]
  %.048 = phi double [ 0.000000e+00, %2 ], [ %30, %31 ]
  %.047 = phi double [ 0.000000e+00, %2 ], [ %26, %31 ]
  %.046 = phi double [ 0.000000e+00, %2 ], [ %18, %31 ]
  %.0 = phi double [ 0.000000e+00, %2 ], [ %15, %31 ]
  %10 = sitofp i32 2500000 to double
  %11 = fcmp ole double %.049, %10
  br i1 %11, label %12, label %33

12:                                               ; preds = %9
  %13 = fsub double %.049, 1.000000e+00
  %14 = call double @pow(double noundef f0x3FE5555555555555, double noundef %13) #4
  %15 = fadd double %.0, %14
  %16 = call double @sqrt(double noundef %.049) #4
  %17 = fdiv double 1.000000e+00, %16
  %18 = fadd double %.046, %17
  %19 = fmul double %.049, %.049
  %20 = fmul double %19, %.049
  %21 = call double @sin(double noundef %.049) #4
  %22 = call double @cos(double noundef %.049) #4
  %23 = fmul double %20, %21
  %24 = fmul double %23, %21
  %25 = fdiv double 1.000000e+00, %24
  %26 = fadd double %.047, %25
  %27 = fmul double %20, %22
  %28 = fmul double %27, %22
  %29 = fdiv double 1.000000e+00, %28
  %30 = fadd double %.048, %29
  br label %31

31:                                               ; preds = %12
  %32 = fadd double %.049, 1.000000e+00
...
34:                                               ; preds = %53, %33
  %.055 = phi <2 x double> [ %3, %33 ], [ %52, %53 ]
  %.054 = phi <2 x double> [ %3, %33 ], [ %48, %53 ]
  %.053 = phi <2 x double> [ %3, %33 ], [ %41, %53 ]
  %.052 = phi <2 x double> [ %3, %33 ], [ %46, %53 ]
  %.051 = phi <2 x double> [ %7, %33 ], [ %54, %53 ]
  %.050 = phi <2 x double> [ %3, %33 ], [ %43, %53 ]
  %.0.vec.extract = extractelement <2 x double> %.051, i32 0
  %35 = sitofp i32 2500000 to double
  %36 = fcmp ole double %.0.vec.extract, %35
  br i1 %36, label %37, label %55

37:                                               ; preds = %34
  %38 = fadd <2 x double> %.051, %4
  %39 = fmul <2 x double> %.051, %38
  %40 = fdiv <2 x double> %4, %39
  %41 = fadd <2 x double> %.053, %40
  %42 = fdiv <2 x double> %4, %.051
  %43 = fadd <2 x double> %.050, %42
  %44 = fmul <2 x double> %.051, %.051
  %45 = fdiv <2 x double> %4, %44
  %46 = fadd <2 x double> %.052, %45
  %47 = fdiv <2 x double> %8, %.051
  %48 = fadd <2 x double> %.054, %47
  %49 = fneg <2 x double> %4
  %50 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.051, <2 x double> %49)
  %51 = fdiv <2 x double> %8, %50
  %52 = fadd <2 x double> %.055, %51
  br label %53

53:                                               ; preds = %37
  %54 = fadd <2 x double> %.051, %5
  br label %34, !llvm.loop !9

55:                                               ; preds = %34
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.0, ptr noundef @.str.1)
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.046, ptr noundef @.str.2)
  %58 = call double @sum_vec(<2 x double> noundef %.053)
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %58, ptr noundef @.str.3)
  %60 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.047, ptr noundef @.str.4)
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.048, ptr noundef @.str.5)
  %62 = call double @sum_vec(<2 x double> noundef %.050)
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %62, ptr noundef @.str.6)
  %64 = call double @sum_vec(<2 x double> noundef %.052)
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %64, ptr noundef @.str.7)
  %66 = call double @sum_vec(<2 x double> noundef %.054)
  %67 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %66, ptr noundef @.str.8)
  %68 = call double @sum_vec(<2 x double> noundef %.055)
