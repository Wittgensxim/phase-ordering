...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  %31 = fcmp ugt double 1.000000e+00, %30
  br i1 %31, label %65, label %.lr.ph
...
32:                                               ; preds = %.lr.ph, %59
  ...
  %38 = call double @sqrt(double noundef %33) #4
...
59:                                               ; preds = %32
  ...
  br i1 %64, label %._crit_edge, label %32, !llvm.loop !7

._crit_edge:                                      ; preds = %59
  br label %65

65:                                               ; preds = %._crit_edge, %2
  %66 = load <2 x double>, ptr %15, align 16
  store <2 x double> %66, ptr %16, align 16
  %67 = load double, ptr %16, align 16
  %68 = load i32, ptr %21, align 4
  %69 = sitofp i32 %68 to double
  %70 = fcmp ugt double %67, %69
  br i1 %70, label %108, label %.lr.ph3

.lr.ph3:                                          ; preds = %65
  br label %71

71:                                               ; preds = %.lr.ph3, %100
  %72 = load <2 x double>, ptr %13, align 16
  %73 = load <2 x double>, ptr %16, align 16
  %74 = fadd <2 x double> %73, %72
  %75 = fmul <2 x double> %73, %74
  %76 = fdiv <2 x double> %72, %75
  %77 = load <2 x double>, ptr %9, align 16
  %78 = fadd <2 x double> %77, %76
  store <2 x double> %78, ptr %9, align 16
  %79 = load <2 x double>, ptr %13, align 16
  %80 = load <2 x double>, ptr %16, align 16
  %81 = fdiv <2 x double> %79, %80
  %82 = load <2 x double>, ptr %7, align 16
  %83 = fadd <2 x double> %82, %81
  store <2 x double> %83, ptr %7, align 16
  %84 = fmul <2 x double> %80, %80
  %85 = fdiv <2 x double> %79, %84
  %86 = load <2 x double>, ptr %8, align 16
  %87 = fadd <2 x double> %86, %85
  store <2 x double> %87, ptr %8, align 16
  %88 = load <2 x double>, ptr %17, align 16
  ...
  %93 = load <2 x double>, ptr %14, align 16
  %94 = load <2 x double>, ptr %13, align 16
  %95 = fneg <2 x double> %94
  %96 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %93, <2 x double> %89, <2 x double> %95)
  %97 = fdiv <2 x double> %88, %96
...
100:                                              ; preds = %71
  %101 = load <2 x double>, ptr %14, align 16
  %102 = load <2 x double>, ptr %16, align 16
  %103 = fadd <2 x double> %102, %101
  store <2 x double> %103, ptr %16, align 16
  %104 = load double, ptr %16, align 16
  %105 = load i32, ptr %21, align 4
  %106 = sitofp i32 %105 to double
  %107 = fcmp ugt double %104, %106
  br i1 %107, label %._crit_edge4, label %71, !llvm.loop !9

._crit_edge4:                                     ; preds = %100
  br label %108

108:                                              ; preds = %._crit_edge4, %65
  %109 = load double, ptr %3, align 8
  %110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %109, ptr noundef nonnull @.str.1) #4
  %111 = load double, ptr %4, align 8
  %112 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %111, ptr noundef nonnull @.str.2) #4
  %113 = load <2 x double>, ptr %9, align 16
  %114 = call double @sum_vec(<2 x double> noundef %113)
  %115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %114, ptr noundef nonnull @.str.3) #4
  %116 = load double, ptr %5, align 8
  %117 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %116, ptr noundef nonnull @.str.4) #4
  %118 = load double, ptr %6, align 8
  %119 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %118, ptr noundef nonnull @.str.5) #4
  %120 = load <2 x double>, ptr %7, align 16
  %121 = call double @sum_vec(<2 x double> noundef %120)
  %122 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %121, ptr noundef nonnull @.str.6) #4
  %123 = load <2 x double>, ptr %8, align 16
  %124 = call double @sum_vec(<2 x double> noundef %123)
  %125 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %124, ptr noundef nonnull @.str.7) #4
  %126 = load <2 x double>, ptr %10, align 16
  %127 = call double @sum_vec(<2 x double> noundef %126)
  %128 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %127, ptr noundef nonnull @.str.8) #4
  %129 = load <2 x double>, ptr %11, align 16
  %130 = call double @sum_vec(<2 x double> noundef %129)
  %131 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %130, ptr noundef nonnull @.str.9) #4
  ret i32 0
}
