...
53:                                               ; preds = %37
  %54 = fadd <2 x double> %5, %.059
  br label %34, !llvm.loop !9

55:                                               ; preds = %34
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.0, ptr noundef @.str.1)
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.054, ptr noundef @.str.2)
  %58 = call double @sum_vec(<2 x double> noundef %.061)
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %58, ptr noundef @.str.3)
  %60 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.055, ptr noundef @.str.4)
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.056, ptr noundef @.str.5)
  %62 = call double @sum_vec(<2 x double> noundef %.058)
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %62, ptr noundef @.str.6)
  %64 = call double @sum_vec(<2 x double> noundef %.060)
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %64, ptr noundef @.str.7)
  %66 = call double @sum_vec(<2 x double> noundef %.062)
  %67 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %66, ptr noundef @.str.8)
  %68 = call double @sum_vec(<2 x double> noundef %.063)
