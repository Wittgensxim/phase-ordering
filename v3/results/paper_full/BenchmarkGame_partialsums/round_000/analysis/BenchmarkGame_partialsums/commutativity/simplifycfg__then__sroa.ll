...
33:                                               ; preds = %36, %32
  %.063 = phi <2 x double> [ %3, %32 ], [ %51, %36 ]
  %.062 = phi <2 x double> [ %3, %32 ], [ %47, %36 ]
  %.061 = phi <2 x double> [ %3, %32 ], [ %40, %36 ]
  %.060 = phi <2 x double> [ %3, %32 ], [ %45, %36 ]
  %.059 = phi <2 x double> [ %7, %32 ], [ %52, %36 ]
  %.058 = phi <2 x double> [ %3, %32 ], [ %42, %36 ]
  %.0.vec.extract = extractelement <2 x double> %.059, i32 0
  %34 = sitofp i32 2500000 to double
  %35 = fcmp ole double %.0.vec.extract, %34
...
36:                                               ; preds = %33
  ...
  %49 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.059, <2 x double> %48)
  %50 = fdiv <2 x double> %8, %49
  %51 = fadd <2 x double> %.063, %50
