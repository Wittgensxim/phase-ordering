...
34:                                               ; preds = %10
  %.06.lcssa = phi double [ %.06, %10 ]
  %.05.lcssa = phi double [ %.05, %10 ]
  %.04.lcssa = phi double [ %.04, %10 ]
  %.03.lcssa = phi double [ %.03, %10 ]
...
65:                                               ; preds = %35
  %.09.lcssa = phi <2 x double> [ %.09, %35 ]
  %.08.lcssa = phi <2 x double> [ %.08, %35 ]
  %.07.lcssa = phi <2 x double> [ %.07, %35 ]
  %.02.lcssa = phi <2 x double> [ %.02, %35 ]
  %.01.lcssa = phi <2 x double> [ %.01, %35 ]
  %66 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.03.lcssa, ptr noundef @.str.1)
  %67 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.04.lcssa, ptr noundef @.str.2)
  %68 = call double @sum_vec(<2 x double> noundef %.09.lcssa)
  %69 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %68, ptr noundef @.str.3)
  %70 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.05.lcssa, ptr noundef @.str.4)
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.06.lcssa, ptr noundef @.str.5)
  %72 = call double @sum_vec(<2 x double> noundef %.07.lcssa)
  %73 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %72, ptr noundef @.str.6)
  %74 = call double @sum_vec(<2 x double> noundef %.08.lcssa)
  %75 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %74, ptr noundef @.str.7)
  %76 = call double @sum_vec(<2 x double> noundef %.02.lcssa)
  %77 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %76, ptr noundef @.str.8)
  %78 = call double @sum_vec(<2 x double> noundef %.01.lcssa)
