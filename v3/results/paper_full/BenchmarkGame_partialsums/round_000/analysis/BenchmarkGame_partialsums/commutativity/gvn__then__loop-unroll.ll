...
60:                                               ; preds = %33
  %.lcssa8 = phi double [ %34, %33 ]
  %.lcssa7 = phi double [ %35, %33 ]
  %.lcssa6 = phi double [ %36, %33 ]
  %.lcssa5 = phi double [ %37, %33 ]
...
73:                                               ; preds = %64
  %74 = fadd <2 x double> %65, %28
  %75 = fmul <2 x double> %65, %74
  %76 = fdiv <2 x double> %28, %75
  %77 = fadd <2 x double> %70, %76
...
93:                                               ; preds = %64
  %.lcssa4 = phi <2 x double> [ %66, %64 ]
  %.lcssa3 = phi <2 x double> [ %67, %64 ]
  %.lcssa2 = phi <2 x double> [ %68, %64 ]
  %.lcssa1 = phi <2 x double> [ %69, %64 ]
  %.lcssa = phi <2 x double> [ %70, %64 ]
  %94 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.lcssa5, ptr noundef @.str.1)
  %95 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.lcssa6, ptr noundef @.str.2)
  %96 = call double @sum_vec(<2 x double> noundef %.lcssa)
  %97 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %96, ptr noundef @.str.3)
  %98 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.lcssa7, ptr noundef @.str.4)
  %99 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.lcssa8, ptr noundef @.str.5)
  %100 = call double @sum_vec(<2 x double> noundef %.lcssa1)
  %101 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %100, ptr noundef @.str.6)
  %102 = call double @sum_vec(<2 x double> noundef %.lcssa2)
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %102, ptr noundef @.str.7)
  %104 = call double @sum_vec(<2 x double> noundef %.lcssa3)
  %105 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %104, ptr noundef @.str.8)
  %106 = call double @sum_vec(<2 x double> noundef %.lcssa4)
