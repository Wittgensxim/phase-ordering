...
33:                                               ; preds = %10
  %.056.lcssa = phi double [ %.056, %10 ]
  %.055.lcssa = phi double [ %.055, %10 ]
  %.054.lcssa = phi double [ %.054, %10 ]
...
36:                                               ; preds = %53, %33
  ...
  %.062 = phi <2 x double> [ %3, %33 ], [ %49, %53 ]
  %.061 = phi <2 x double> [ %3, %33 ], [ %42, %53 ]
  %.060 = phi <2 x double> [ %3, %33 ], [ %47, %53 ]
  %.059 = phi <2 x double> [ %7, %33 ], [ %54, %53 ]
  %.058 = phi <2 x double> [ %3, %33 ], [ %44, %53 ]
  %.0.vec.extract = extractelement <2 x double> %.059, i32 0
  %37 = fcmp ole double %.0.vec.extract, %34
  br i1 %37, label %38, label %55

38:                                               ; preds = %36
  %39 = fadd <2 x double> %.059, %4
  %40 = fmul <2 x double> %.059, %39
  %41 = fdiv <2 x double> %4, %40
  %42 = fadd <2 x double> %.061, %41
  %43 = fdiv <2 x double> %4, %.059
  %44 = fadd <2 x double> %.058, %43
  %45 = fmul <2 x double> %.059, %.059
  %46 = fdiv <2 x double> %4, %45
  %47 = fadd <2 x double> %.060, %46
  %48 = fdiv <2 x double> %8, %.059
  %49 = fadd <2 x double> %.062, %48
  %50 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.059, <2 x double> %35)
...
55:                                               ; preds = %36
  %.063.lcssa = phi <2 x double> [ %.063, %36 ]
  %.062.lcssa = phi <2 x double> [ %.062, %36 ]
  %.061.lcssa = phi <2 x double> [ %.061, %36 ]
  %.060.lcssa = phi <2 x double> [ %.060, %36 ]
  %.058.lcssa = phi <2 x double> [ %.058, %36 ]
