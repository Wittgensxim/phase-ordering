...
34:                                               ; preds = %53, %33
  %.018 = phi <2 x double> [ %7, %33 ], [ %54, %53 ]
  %.09 = phi <2 x double> [ %3, %33 ], [ %41, %53 ]
  %.08 = phi <2 x double> [ %3, %33 ], [ %46, %53 ]
  %.07 = phi <2 x double> [ %3, %33 ], [ %43, %53 ]
  %.02 = phi <2 x double> [ %3, %33 ], [ %48, %53 ]
  %.01 = phi <2 x double> [ %3, %33 ], [ %52, %53 ]
  %.0.vec.extract = extractelement <2 x double> %.018, i32 0
  %35 = sitofp i32 2500000 to double
  %36 = fcmp ole double %.0.vec.extract, %35
  br i1 %36, label %37, label %55

37:                                               ; preds = %34
  %38 = fadd <2 x double> %.018, %4
  %39 = fmul <2 x double> %.018, %38
  %40 = fdiv <2 x double> %4, %39
  %41 = fadd <2 x double> %.09, %40
  %42 = fdiv <2 x double> %4, %.018
  %43 = fadd <2 x double> %.07, %42
  %44 = fmul <2 x double> %.018, %.018
  %45 = fdiv <2 x double> %4, %44
  %46 = fadd <2 x double> %.08, %45
  %47 = fdiv <2 x double> %8, %.018
  %48 = fadd <2 x double> %.02, %47
  %49 = fneg <2 x double> %4
  %50 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.018, <2 x double> %49)
  %51 = fdiv <2 x double> %8, %50
  %52 = fadd <2 x double> %.01, %51
  br label %53

53:                                               ; preds = %37
  %54 = fadd <2 x double> %.018, %5
  br label %34, !llvm.loop !9

55:                                               ; preds = %34
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.03, ptr noundef @.str.1)
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.04, ptr noundef @.str.2)
  %58 = call double @sum_vec(<2 x double> noundef %.09)
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %58, ptr noundef @.str.3)
  %60 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.05, ptr noundef @.str.4)
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.06, ptr noundef @.str.5)
  %62 = call double @sum_vec(<2 x double> noundef %.07)
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %62, ptr noundef @.str.6)
  %64 = call double @sum_vec(<2 x double> noundef %.08)
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %64, ptr noundef @.str.7)
  %66 = call double @sum_vec(<2 x double> noundef %.02)
  %67 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %66, ptr noundef @.str.8)
  %68 = call double @sum_vec(<2 x double> noundef %.01)
