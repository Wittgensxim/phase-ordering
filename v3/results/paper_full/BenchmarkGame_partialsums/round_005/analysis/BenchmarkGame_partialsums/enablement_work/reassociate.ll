...
51:                                               ; preds = %33
  %52 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.0, ptr noundef @.str.1)
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.054, ptr noundef @.str.2)
  %54 = call double @sum_vec(<2 x double> noundef %.061)
  %55 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %54, ptr noundef @.str.3)
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.055, ptr noundef @.str.4)
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.056, ptr noundef @.str.5)
