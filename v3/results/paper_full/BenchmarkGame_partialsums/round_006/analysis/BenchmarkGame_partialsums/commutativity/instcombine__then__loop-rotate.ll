...
33:                                               ; preds = %.lr.ph, %33
  ...
  br i1 %49, label %._crit_edge, label %33, !llvm.loop !9

._crit_edge:                                      ; preds = %33
  %split = phi <2 x double> [ %47, %33 ]
  %split13 = phi <2 x double> [ %44, %33 ]
  %split14 = phi <2 x double> [ %37, %33 ]
  %split15 = phi <2 x double> [ %42, %33 ]
  %split16 = phi <2 x double> [ %39, %33 ]
  br label %50
