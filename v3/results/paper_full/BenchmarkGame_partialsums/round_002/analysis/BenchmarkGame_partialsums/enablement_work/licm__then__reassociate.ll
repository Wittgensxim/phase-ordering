...
31:                                               ; preds = %9
  ...
  %32 = fneg <2 x double> %4
  br label %33

33:                                               ; preds = %35, %31
  %.063 = phi <2 x double> [ %3, %31 ], [ %49, %35 ]
  %.062 = phi <2 x double> [ %3, %31 ], [ %46, %35 ]
  %.061 = phi <2 x double> [ %3, %31 ], [ %39, %35 ]
  %.060 = phi <2 x double> [ %3, %31 ], [ %44, %35 ]
  %.059 = phi <2 x double> [ %7, %31 ], [ %50, %35 ]
  %.058 = phi <2 x double> [ %3, %31 ], [ %41, %35 ]
  %.0.vec.extract = extractelement <2 x double> %.059, i32 0
  %34 = fcmp ole double %.0.vec.extract, 2.500000e+06
  br i1 %34, label %35, label %51

35:                                               ; preds = %33
  %36 = fadd <2 x double> %4, %.059
  %37 = fmul <2 x double> %.059, %36
  %38 = fdiv <2 x double> %4, %37
  %39 = fadd <2 x double> %.061, %38
  %40 = fdiv <2 x double> %4, %.059
  %41 = fadd <2 x double> %.058, %40
  %42 = fmul <2 x double> %.059, %.059
  %43 = fdiv <2 x double> %4, %42
  %44 = fadd <2 x double> %.060, %43
  %45 = fdiv <2 x double> %8, %.059
  %46 = fadd <2 x double> %.062, %45
  %47 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.059, <2 x double> %32)
  %48 = fdiv <2 x double> %8, %47
  %49 = fadd <2 x double> %.063, %48
  %50 = fadd <2 x double> %5, %.059
  br label %33, !llvm.loop !9

51:                                               ; preds = %33
  %.063.lcssa = phi <2 x double> [ %.063, %33 ]
  %.062.lcssa = phi <2 x double> [ %.062, %33 ]
  %.061.lcssa = phi <2 x double> [ %.061, %33 ]
  %.060.lcssa = phi <2 x double> [ %.060, %33 ]
  %.058.lcssa = phi <2 x double> [ %.058, %33 ]
  %52 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.0.lcssa, ptr noundef @.str.1)
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.054.lcssa, ptr noundef @.str.2)
  %54 = call double @sum_vec(<2 x double> noundef %.061.lcssa)
  %55 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %54, ptr noundef @.str.3)
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.055.lcssa, ptr noundef @.str.4)
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %.056.lcssa, ptr noundef @.str.5)
  %58 = call double @sum_vec(<2 x double> noundef %.058.lcssa)
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %58, ptr noundef @.str.6)
  %60 = call double @sum_vec(<2 x double> noundef %.060.lcssa)
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %60, ptr noundef @.str.7)
  %62 = call double @sum_vec(<2 x double> noundef %.062.lcssa)
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %62, ptr noundef @.str.8)
  %64 = call double @sum_vec(<2 x double> noundef %.063.lcssa)
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %64, ptr noundef @.str.9)
  ret i32 0
}
