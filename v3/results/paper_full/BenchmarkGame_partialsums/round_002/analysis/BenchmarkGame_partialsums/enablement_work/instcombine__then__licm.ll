...
51:                                               ; preds = %33
  ...
  %52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.0.lcssa, ptr noundef nonnull @.str.1) #4
  %53 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.054.lcssa, ptr noundef nonnull @.str.2) #4
  ...
  %56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.055.lcssa, ptr noundef nonnull @.str.4) #4
  %57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.056.lcssa, ptr noundef nonnull @.str.5) #4
