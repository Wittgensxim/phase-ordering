...
32:                                               ; preds = %34, %31
  %.063 = phi <2 x double> [ %3, %31 ], [ %49, %34 ]
  %.062 = phi <2 x double> [ %3, %31 ], [ %45, %34 ]
  %.061 = phi <2 x double> [ %3, %31 ], [ %38, %34 ]
  %.060 = phi <2 x double> [ %3, %31 ], [ %43, %34 ]
  %.059 = phi <2 x double> [ %7, %31 ], [ %50, %34 ]
  %.058 = phi <2 x double> [ %3, %31 ], [ %40, %34 ]
  %.0.vec.extract = extractelement <2 x double> %.059, i32 0
  %33 = fcmp ole double %.0.vec.extract, 2.500000e+06
  br i1 %33, label %34, label %51

34:                                               ; preds = %32
  %35 = fadd <2 x double> %4, %.059
  %36 = fmul <2 x double> %.059, %35
  %37 = fdiv <2 x double> %4, %36
  %38 = fadd <2 x double> %.061, %37
  %39 = fdiv <2 x double> %4, %.059
  %40 = fadd <2 x double> %.058, %39
  %41 = fmul <2 x double> %.059, %.059
  %42 = fdiv <2 x double> %4, %41
  %43 = fadd <2 x double> %.060, %42
  %44 = fdiv <2 x double> %8, %.059
  %45 = fadd <2 x double> %.062, %44
  %46 = fneg <2 x double> %4
  %47 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.059, <2 x double> %46)
...
51:                                               ; preds = %32
  %.063.lcssa = phi <2 x double> [ %.063, %32 ]
  %.062.lcssa = phi <2 x double> [ %.062, %32 ]
  %.061.lcssa = phi <2 x double> [ %.061, %32 ]
  %.060.lcssa = phi <2 x double> [ %.060, %32 ]
  %.058.lcssa = phi <2 x double> [ %.058, %32 ]
