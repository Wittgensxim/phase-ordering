...
32:                                               ; preds = %.lr.ph, %32
  ...
  %47 = fadd <2 x double> %46, %.0637
  %48 = fadd <2 x double> %5, %.05911
  %.0.vec.extract = extractelement <2 x double> %48, i32 0
  %49 = fcmp ole double %.0.vec.extract, 2.500000e+06
  br i1 %49, label %32, label %._crit_edge, !llvm.loop !9
