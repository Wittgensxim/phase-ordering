; ModuleID = 'results\paper_full\BenchmarkGame_partialsums\round_001\output.ll'
...
9:                                                ; preds = %2, %9
  ...
  %29 = fcmp ugt double %28, 2.500000e+06
...
30:                                               ; preds = %9
  ...
  %31 = fcmp ugt double %.0.vec.extract6, 2.500000e+06
  br i1 %31, label %50, label %.lr.ph

.lr.ph:                                           ; preds = %30
  br label %32

32:                                               ; preds = %.lr.ph, %32
  %.05812 = phi <2 x double> [ %3, %.lr.ph ], [ %38, %32 ]
  %.05911 = phi <2 x double> [ %7, %.lr.ph ], [ %48, %32 ]
  %.06010 = phi <2 x double> [ %3, %.lr.ph ], [ %41, %32 ]
  %.0619 = phi <2 x double> [ %3, %.lr.ph ], [ %36, %32 ]
  %.0628 = phi <2 x double> [ %3, %.lr.ph ], [ %43, %32 ]
  %.0637 = phi <2 x double> [ %3, %.lr.ph ], [ %47, %32 ]
  %33 = fadd <2 x double> %.05911, %4
  %34 = fmul <2 x double> %.05911, %33
  %35 = fdiv <2 x double> %4, %34
  %36 = fadd <2 x double> %.0619, %35
  %37 = fdiv <2 x double> %4, %.05911
  %38 = fadd <2 x double> %.05812, %37
  %39 = fmul <2 x double> %.05911, %.05911
  %40 = fdiv <2 x double> %4, %39
  %41 = fadd <2 x double> %.06010, %40
  %42 = fdiv <2 x double> %8, %.05911
  %43 = fadd <2 x double> %.0628, %42
  %44 = fneg <2 x double> %4
  %45 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.05911, <2 x double> %44)
  %46 = fdiv <2 x double> %8, %45
  %47 = fadd <2 x double> %.0637, %46
  %48 = fadd <2 x double> %.05911, %5
  %.0.vec.extract = extractelement <2 x double> %48, i64 0
  %49 = fcmp ugt double %.0.vec.extract, 2.500000e+06
  br i1 %49, label %._crit_edge, label %32, !llvm.loop !9

._crit_edge:                                      ; preds = %32
  %split = phi <2 x double> [ %47, %32 ]
  %split13 = phi <2 x double> [ %43, %32 ]
  %split14 = phi <2 x double> [ %36, %32 ]
  %split15 = phi <2 x double> [ %41, %32 ]
  %split16 = phi <2 x double> [ %38, %32 ]
  br label %50

50:                                               ; preds = %._crit_edge, %30
  %.063.lcssa = phi <2 x double> [ %split, %._crit_edge ], [ %3, %30 ]
  %.062.lcssa = phi <2 x double> [ %split13, %._crit_edge ], [ %3, %30 ]
  %.061.lcssa = phi <2 x double> [ %split14, %._crit_edge ], [ %3, %30 ]
  %.060.lcssa = phi <2 x double> [ %split15, %._crit_edge ], [ %3, %30 ]
  %.058.lcssa = phi <2 x double> [ %split16, %._crit_edge ], [ %3, %30 ]
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.0.lcssa, ptr noundef nonnull @.str.1) #4
  %52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.054.lcssa, ptr noundef nonnull @.str.2) #4
  %53 = call double @sum_vec(<2 x double> noundef %.061.lcssa)
  %54 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %53, ptr noundef nonnull @.str.3) #4
  %55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.055.lcssa, ptr noundef nonnull @.str.4) #4
  %56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.056.lcssa, ptr noundef nonnull @.str.5) #4
  %57 = call double @sum_vec(<2 x double> noundef %.058.lcssa)
  %58 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %57, ptr noundef nonnull @.str.6) #4
  %59 = call double @sum_vec(<2 x double> noundef %.060.lcssa)
  %60 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %59, ptr noundef nonnull @.str.7) #4
  %61 = call double @sum_vec(<2 x double> noundef %.062.lcssa)
  %62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %61, ptr noundef nonnull @.str.8) #4
  %63 = call double @sum_vec(<2 x double> noundef %.063.lcssa)
  %64 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %63, ptr noundef nonnull @.str.9) #4
  ret i32 0
}
