...
28:                                               ; preds = %9
  ...
  %29 = fcmp ole double %.0.vec.extract6, 2.500000e+06
...
30:                                               ; preds = %.lr.ph, %30
  %.05812 = phi <2 x double> [ %3, %.lr.ph ], [ %36, %30 ]
  %.05911 = phi <2 x double> [ %7, %.lr.ph ], [ %46, %30 ]
  %.06010 = phi <2 x double> [ %3, %.lr.ph ], [ %39, %30 ]
  %.0619 = phi <2 x double> [ %3, %.lr.ph ], [ %34, %30 ]
  %.0628 = phi <2 x double> [ %3, %.lr.ph ], [ %41, %30 ]
  %.0637 = phi <2 x double> [ %3, %.lr.ph ], [ %45, %30 ]
  %31 = fadd <2 x double> %.05911, %4
  %32 = fmul <2 x double> %.05911, %31
  %33 = fdiv <2 x double> %4, %32
  %34 = fadd <2 x double> %.0619, %33
  %35 = fdiv <2 x double> %4, %.05911
  %36 = fadd <2 x double> %.05812, %35
  %37 = fmul <2 x double> %.05911, %.05911
  %38 = fdiv <2 x double> %4, %37
  %39 = fadd <2 x double> %.06010, %38
  %40 = fdiv <2 x double> %8, %.05911
  %41 = fadd <2 x double> %.0628, %40
  %42 = fneg <2 x double> %4
  %43 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %.05911, <2 x double> %42)
  ...
  br i1 %47, label %30, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %30
  %split = phi <2 x double> [ %45, %30 ]
  %split13 = phi <2 x double> [ %41, %30 ]
  %split14 = phi <2 x double> [ %34, %30 ]
  %split15 = phi <2 x double> [ %39, %30 ]
  %split16 = phi <2 x double> [ %36, %30 ]
  br label %48
