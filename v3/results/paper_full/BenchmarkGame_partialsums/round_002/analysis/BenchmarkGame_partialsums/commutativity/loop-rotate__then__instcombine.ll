...
50:                                               ; preds = %._crit_edge, %30
  ...
  %.062.lcssa = phi <2 x double> [ %43, %._crit_edge ], [ %3, %30 ]
  %.061.lcssa = phi <2 x double> [ %36, %._crit_edge ], [ %3, %30 ]
  %.060.lcssa = phi <2 x double> [ %41, %._crit_edge ], [ %3, %30 ]
  %.058.lcssa = phi <2 x double> [ %38, %._crit_edge ], [ %3, %30 ]
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %12, ptr noundef nonnull @.str.1) #4
  %52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %15, ptr noundef nonnull @.str.2) #4
  ...
  %55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %23, ptr noundef nonnull @.str.4) #4
  %56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %27, ptr noundef nonnull @.str.5) #4
