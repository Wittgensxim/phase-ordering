...
5:                                                ; preds = %0, %5
  ...
  %39 = icmp samesign ult i32 %38, 156250000
  br i1 %39, label %5, label %40, !llvm.loop !7

40:                                               ; preds = %5
  %41 = fdiv double %1, %2
  %42 = fmul double %41, %41
  %43 = call double @llvm.fmuladd.f64(double %11, double %42, double %12)
  %44 = call double @llvm.fmuladd.f64(double %43, double %42, double %14)
  %45 = call double @llvm.fmuladd.f64(double %44, double %42, double %16)
  %46 = call double @llvm.fmuladd.f64(double %45, double %42, double %18)
  %47 = call double @llvm.fmuladd.f64(double %46, double %42, double %20)
  %48 = call double @llvm.fmuladd.f64(double %47, double %42, double %22)
  %49 = fmul double %41, %48
  store double %49, ptr @sa, align 8
  %50 = load double, ptr @B6, align 8
  %51 = load double, ptr @B5, align 8
  %52 = call double @llvm.fmuladd.f64(double %50, double %42, double %51)
  %53 = load double, ptr @B4, align 8
  %54 = call double @llvm.fmuladd.f64(double %42, double %52, double %53)
  %55 = load double, ptr @B3, align 8
  %56 = call double @llvm.fmuladd.f64(double %42, double %54, double %55)
  %57 = load double, ptr @B2, align 8
  %58 = call double @llvm.fmuladd.f64(double %42, double %56, double %57)
  %59 = load double, ptr @B1, align 8
  %60 = call double @llvm.fmuladd.f64(double %42, double %58, double %59)
  %61 = call double @llvm.fmuladd.f64(double %42, double %60, double %22)
  store double %61, ptr @sb, align 8
  %62 = fmul double %49, %61
  store double %62, ptr @sa, align 8
  %63 = load double, ptr @two, align 8
  %64 = call double @llvm.fmuladd.f64(double %63, double %37, double %62)
  %65 = fmul double %4, %64
  %66 = fdiv double %65, %63
  store double %66, ptr @sa, align 8
  store double 2.500000e-01, ptr @sb, align 8
  %67 = fadd double %66, -2.500000e-01
