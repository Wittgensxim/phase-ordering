...
5:                                                ; preds = %8, %0
  %6 = phi double [ %38, %8 ], [ 0.000000e+00, %0 ]
  %7 = phi i32 [ %39, %8 ], [ 1, %0 ]
  %exitcond.not = icmp eq i32 %7, 156250000
  br i1 %exitcond.not, label %40, label %8
...
8:                                                ; preds = %5
  ...
  %38 = call double @llvm.fmuladd.f64(double %25, double %37, double %6)
...
40:                                               ; preds = %5
  ...
  %71 = call double @llvm.fmuladd.f64(double %70, double %6, double %69)
  %72 = fmul double %4, %71
