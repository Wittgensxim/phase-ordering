...
18:                                               ; preds = %21, %0
  %19 = phi double [ %38, %21 ], [ 0.000000e+00, %0 ]
  %20 = phi i32 [ %39, %21 ], [ 1, %0 ]
  %exitcond = icmp ne i32 %20, 156250000
  br i1 %exitcond, label %21, label %40
...
21:                                               ; preds = %18
  ...
  %26 = call double @llvm.fmuladd.f64(double %25, double %24, double %7)
  %27 = call double @llvm.fmuladd.f64(double %26, double %24, double %8)
  %28 = call double @llvm.fmuladd.f64(double %27, double %24, double %9)
  %29 = call double @llvm.fmuladd.f64(double %28, double %24, double %10)
  %30 = call double @llvm.fmuladd.f64(double %29, double %24, double %11)
  %31 = fmul double %23, %30
  %32 = call double @llvm.fmuladd.f64(double %12, double %24, double %13)
  %33 = call double @llvm.fmuladd.f64(double %24, double %32, double %14)
  %34 = call double @llvm.fmuladd.f64(double %24, double %33, double %15)
  %35 = call double @llvm.fmuladd.f64(double %24, double %34, double %16)
  %36 = call double @llvm.fmuladd.f64(double %24, double %35, double %17)
  %37 = call double @llvm.fmuladd.f64(double %24, double %36, double %11)
  %38 = call double @llvm.fmuladd.f64(double %31, double %37, double %19)
