...
18:                                               ; preds = %22, %0
  %19 = phi double [ %39, %22 ], [ 0.000000e+00, %0 ]
  %20 = phi i32 [ %40, %22 ], [ 1, %0 ]
...
41:                                               ; preds = %18
  ...
  %44 = call double @llvm.fmuladd.f64(double %5, double %43, double %6)
  %45 = call double @llvm.fmuladd.f64(double %44, double %43, double %7)
  %46 = call double @llvm.fmuladd.f64(double %45, double %43, double %8)
  %47 = call double @llvm.fmuladd.f64(double %46, double %43, double %9)
  %48 = call double @llvm.fmuladd.f64(double %47, double %43, double %10)
  %49 = call double @llvm.fmuladd.f64(double %48, double %43, double %11)
  %50 = fmul double %42, %49
  store double %50, ptr @sa, align 8
  %51 = call double @llvm.fmuladd.f64(double %12, double %43, double %13)
  %52 = call double @llvm.fmuladd.f64(double %43, double %51, double %14)
  %53 = call double @llvm.fmuladd.f64(double %43, double %52, double %15)
  %54 = call double @llvm.fmuladd.f64(double %43, double %53, double %16)
  %55 = call double @llvm.fmuladd.f64(double %43, double %54, double %17)
  %56 = call double @llvm.fmuladd.f64(double %43, double %55, double %11)
  store double %56, ptr @sb, align 8
  %57 = fmul double %50, %56
  store double %57, ptr @sa, align 8
  %58 = load double, ptr @two, align 8
  %59 = call double @llvm.fmuladd.f64(double %58, double %19, double %57)
  %60 = fmul double %4, %59
