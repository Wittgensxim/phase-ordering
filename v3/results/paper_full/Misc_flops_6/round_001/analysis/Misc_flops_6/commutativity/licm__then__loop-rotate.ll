...
18:                                               ; preds = %0, %18
  %19 = phi i32 [ 1, %0 ], [ %38, %18 ]
  %20 = phi double [ 0.000000e+00, %0 ], [ %37, %18 ]
  ...
  %37 = call double @llvm.fmuladd.f64(double %30, double %36, double %20)
  %38 = add nuw nsw i32 %19, 1
  %39 = icmp samesign ult i32 %38, 156250000
  br i1 %39, label %18, label %40, !llvm.loop !7

40:                                               ; preds = %18
  %.lcssa = phi double [ %37, %18 ]
  %41 = fdiv double %1, %2
