...
5:                                                ; preds = %0, %5
  ...
  %exitcond = icmp ne i32 %38, 156250000
  br i1 %exitcond, label %5, label %39, !llvm.loop !7

39:                                               ; preds = %5
  %.lcssa = phi double [ %37, %5 ]
  %40 = fdiv double %1, %2
  ...
  %70 = call double @llvm.fmuladd.f64(double %69, double %.lcssa, double %68)
  %71 = fmul double %4, %70
