...
5:                                                ; preds = %0, %5
  %.05 = phi i32 [ 1, %0 ], [ %36, %5 ]
  %.014 = phi double [ 0.000000e+00, %0 ], [ %35, %5 ]
  ...
  %35 = call double @llvm.fmuladd.f64(double %22, double %34, double %.014)
  %36 = add nuw nsw i32 %.05, 1
  %37 = icmp samesign ult i32 %36, 156250000
  br i1 %37, label %5, label %38, !llvm.loop !7

38:                                               ; preds = %5
  %.01.lcssa = phi double [ %35, %5 ]
  %39 = fdiv double %1, %2
  ...
  %45 = call double @llvm.fmuladd.f64(double %43, double %40, double %44)
  %46 = load double, ptr @A3, align 8
  %47 = call double @llvm.fmuladd.f64(double %45, double %40, double %46)
  %48 = load double, ptr @A2, align 8
  %49 = call double @llvm.fmuladd.f64(double %47, double %40, double %48)
  %50 = load double, ptr @A1, align 8
  %51 = call double @llvm.fmuladd.f64(double %49, double %40, double %50)
  %52 = load double, ptr @one, align 8
  %53 = call double @llvm.fmuladd.f64(double %51, double %40, double %52)
  %54 = fmul double %39, %53
  store double %54, ptr @sa, align 8
  %55 = load double, ptr @B6, align 8
  %56 = load double, ptr @B5, align 8
  %57 = call double @llvm.fmuladd.f64(double %55, double %40, double %56)
  %58 = load double, ptr @B4, align 8
  %59 = call double @llvm.fmuladd.f64(double %40, double %57, double %58)
  %60 = load double, ptr @B3, align 8
  %61 = call double @llvm.fmuladd.f64(double %40, double %59, double %60)
  %62 = load double, ptr @B2, align 8
  %63 = call double @llvm.fmuladd.f64(double %40, double %61, double %62)
  %64 = load double, ptr @B1, align 8
  %65 = call double @llvm.fmuladd.f64(double %40, double %63, double %64)
  %66 = call double @llvm.fmuladd.f64(double %40, double %65, double %52)
  store double %66, ptr @sb, align 8
  %67 = fmul double %54, %66
  store double %67, ptr @sa, align 8
  %68 = load double, ptr @two, align 8
  %69 = call double @llvm.fmuladd.f64(double %68, double %.01.lcssa, double %67)
  %70 = fmul double %4, %69
  %71 = fdiv double %70, %68
  store double %71, ptr @sa, align 8
  store double 2.500000e-01, ptr @sb, align 8
  %72 = fadd double %71, -2.500000e-01
