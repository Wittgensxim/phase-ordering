...
define dso_local i32 @main() #0 {
  ...
  br i1 %13, label %.lr.ph, label %50

.lr.ph:                                           ; preds = %0
  br label %14

14:                                               ; preds = %.lr.ph, %46
  %.042 = phi i32 [ 1, %.lr.ph ], [ %47, %46 ]
  %.0 = phi double [ 0.000000e+00, %.lr.ph ], [ %45, %46 ]
  ...
  %45 = call double @llvm.fmuladd.f64(double %31, double %44, double %.0)
  br label %46

46:                                               ; preds = %14
  %47 = add nsw i32 %.042, 1
  %48 = sub nsw i32 %6, 1
  %49 = icmp sle i32 %47, %48
  br i1 %49, label %14, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %46
  br label %50

50:                                               ; preds = %._crit_edge, %0
  %.1 = phi double [ %45, %._crit_edge ], [ 0.000000e+00, %0 ]
  ...
  %87 = call double @llvm.fmuladd.f64(double %86, double %.1, double %85)
