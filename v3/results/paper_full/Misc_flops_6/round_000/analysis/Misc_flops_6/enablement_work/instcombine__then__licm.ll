...
30:                                               ; preds = %51, %0
  %31 = phi double [ %.promoted3, %0 ], [ %50, %51 ]
  %32 = phi double [ %.promoted, %0 ], [ %36, %51 ]
  %storemerge = phi i32 [ 1, %0 ], [ %52, %51 ]
  %.not.not = icmp slt i32 %storemerge, %14
  br i1 %.not.not, label %33, label %53
...
33:                                               ; preds = %30
  ...
  %50 = call double @llvm.fmuladd.f64(double %43, double %49, double %31)
  br label %51

51:                                               ; preds = %33
  %52 = add nsw i32 %storemerge, 1
...
53:                                               ; preds = %30
  ...
  %55 = load double, ptr @four, align 8
  ...
  %69 = call double @llvm.fmuladd.f64(double %67, double %65, double %68)
  %70 = load double, ptr @one, align 8
  %71 = call double @llvm.fmuladd.f64(double %69, double %65, double %70)
