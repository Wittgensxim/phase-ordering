...
14:                                               ; preds = %49, %0
  %storemerge = phi i32 [ 1, %0 ], [ %51, %49 ]
  store i32 %storemerge, ptr %5, align 4
  %15 = load i32, ptr %6, align 4
  %.not.not = icmp slt i32 %storemerge, %15
  br i1 %.not.not, label %16, label %52
...
16:                                               ; preds = %14
  ...
  %48 = call double @llvm.fmuladd.f64(double %34, double %47, double %35)
...
52:                                               ; preds = %14
  %53 = load double, ptr @piref, align 8
  %54 = load double, ptr @four, align 8
  %55 = fdiv double %53, %54
  %56 = fmul double %55, %55
  store double %56, ptr %2, align 8
  %57 = load double, ptr @A6, align 8
  %58 = load double, ptr @A5, align 8
  %59 = call double @llvm.fmuladd.f64(double %57, double %56, double %58)
  %60 = load double, ptr @A4, align 8
  %61 = call double @llvm.fmuladd.f64(double %59, double %56, double %60)
  %62 = load double, ptr @A3, align 8
  %63 = call double @llvm.fmuladd.f64(double %61, double %56, double %62)
  %64 = load double, ptr @A2, align 8
  %65 = call double @llvm.fmuladd.f64(double %63, double %56, double %64)
  %66 = load double, ptr @A1, align 8
  %67 = call double @llvm.fmuladd.f64(double %65, double %56, double %66)
  %68 = load double, ptr @one, align 8
  %69 = call double @llvm.fmuladd.f64(double %67, double %56, double %68)
  ...
  %76 = call double @llvm.fmuladd.f64(double %71, double %74, double %75)
  ...
  %82 = call double @llvm.fmuladd.f64(double %71, double %80, double %81)
  %83 = load double, ptr @one, align 8
  %84 = call double @llvm.fmuladd.f64(double %71, double %82, double %83)
  ...
  %93 = fadd double %92, -2.500000e-01
  store double %93, ptr @sc, align 8
  %94 = fmul double %93, 1.000000e-30
  %95 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %94, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
