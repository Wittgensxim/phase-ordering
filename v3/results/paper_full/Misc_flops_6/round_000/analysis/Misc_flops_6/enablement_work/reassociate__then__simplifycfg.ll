...
82:                                               ; preds = %24
  ...
  %84 = load double, ptr @four, align 8
  ...
  %115 = load double, ptr @B6, align 8
  %116 = load double, ptr %5, align 8
  %117 = load double, ptr @B5, align 8
  %118 = call double @llvm.fmuladd.f64(double %115, double %116, double %117)
  %119 = load double, ptr @B4, align 8
  %120 = call double @llvm.fmuladd.f64(double %114, double %118, double %119)
  %121 = load double, ptr @B3, align 8
  %122 = call double @llvm.fmuladd.f64(double %113, double %120, double %121)
  %123 = load double, ptr @B2, align 8
  %124 = call double @llvm.fmuladd.f64(double %112, double %122, double %123)
  %125 = load double, ptr @B1, align 8
  %126 = call double @llvm.fmuladd.f64(double %111, double %124, double %125)
  %127 = load double, ptr @one, align 8
  %128 = call double @llvm.fmuladd.f64(double %110, double %126, double %127)
  ...
  %134 = load double, ptr @two, align 8
  ...
  store double %139, ptr @sa, align 8
  ...
  %145 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %144, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
