...
9:                                                ; preds = %11, %0
  %.01 = phi double [ 0.000000e+00, %0 ], [ %41, %11 ]
  %.0 = phi i32 [ 1, %0 ], [ %42, %11 ]
...
11:                                               ; preds = %9
  ...
  %41 = call double @llvm.fmuladd.f64(double %28, double %40, double %.01)
  %42 = add nsw i32 %.0, 1
...
43:                                               ; preds = %9
  ...
  %74 = call double @llvm.fmuladd.f64(double %73, double %.01, double %72)
  %75 = fmul double %8, %74
