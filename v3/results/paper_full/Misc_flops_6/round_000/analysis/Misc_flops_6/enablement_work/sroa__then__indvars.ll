...
12:                                               ; preds = %45, %0
  ...
  %exitcond = icmp ne i32 %.040, 156250000
  br i1 %exitcond, label %13, label %47

13:                                               ; preds = %12
  %14 = sitofp i32 %.040 to double
...
47:                                               ; preds = %12
  ...
  %84 = call double @llvm.fmuladd.f64(double %83, double %.0.lcssa, double %82)
