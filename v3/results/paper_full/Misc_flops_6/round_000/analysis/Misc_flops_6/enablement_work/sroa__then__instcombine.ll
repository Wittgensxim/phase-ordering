...
5:                                                ; preds = %8, %0
  %.040 = phi i32 [ 1, %0 ], [ %40, %8 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %39, %8 ]
...
8:                                                ; preds = %7
  ...
  %39 = call double @llvm.fmuladd.f64(double %25, double %38, double %.0)
  %40 = add nuw nsw i32 %.040, 1
...
41:                                               ; preds = %5
  ...
  %81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %80, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
