...
5:                                                ; preds = %9, %0
  %6 = phi double [ %39, %9 ], [ 0.000000e+00, %0 ]
  %7 = phi i32 [ %40, %9 ], [ 1, %0 ]
...
9:                                                ; preds = %5
  ...
  %16 = load double, ptr @A4, align 8
  %17 = call double @llvm.fmuladd.f64(double %15, double %12, double %16)
  %18 = load double, ptr @A3, align 8
  %19 = call double @llvm.fmuladd.f64(double %17, double %12, double %18)
  %20 = load double, ptr @A2, align 8
  %21 = call double @llvm.fmuladd.f64(double %19, double %12, double %20)
  ...
  %29 = call double @llvm.fmuladd.f64(double %27, double %12, double %28)
  %30 = load double, ptr @B4, align 8
  %31 = call double @llvm.fmuladd.f64(double %12, double %29, double %30)
  %32 = load double, ptr @B3, align 8
  %33 = call double @llvm.fmuladd.f64(double %12, double %31, double %32)
  %34 = load double, ptr @B2, align 8
  %35 = call double @llvm.fmuladd.f64(double %12, double %33, double %34)
  %36 = load double, ptr @B1, align 8
  %37 = call double @llvm.fmuladd.f64(double %12, double %35, double %36)
  %38 = call double @llvm.fmuladd.f64(double %12, double %37, double %24)
  %39 = call double @llvm.fmuladd.f64(double %26, double %38, double %6)
...
41:                                               ; preds = %5
  ...
  %72 = call double @llvm.fmuladd.f64(double %71, double %6, double %70)
  %73 = fmul double %4, %72
  %74 = fdiv double %73, %71
  store double %74, ptr @sa, align 8
  store double 2.500000e-01, ptr @sb, align 8
  %75 = fadd double %74, -2.500000e-01
