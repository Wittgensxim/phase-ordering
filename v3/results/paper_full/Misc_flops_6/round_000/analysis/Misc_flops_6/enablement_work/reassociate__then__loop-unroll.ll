...
83:                                               ; preds = %24
  ...
  %85 = load double, ptr @four, align 8
  ...
  %116 = load double, ptr @B6, align 8
  %117 = load double, ptr %5, align 8
  %118 = load double, ptr @B5, align 8
  %119 = call double @llvm.fmuladd.f64(double %116, double %117, double %118)
  %120 = load double, ptr @B4, align 8
  %121 = call double @llvm.fmuladd.f64(double %115, double %119, double %120)
  %122 = load double, ptr @B3, align 8
  %123 = call double @llvm.fmuladd.f64(double %114, double %121, double %122)
  %124 = load double, ptr @B2, align 8
  %125 = call double @llvm.fmuladd.f64(double %113, double %123, double %124)
  %126 = load double, ptr @B1, align 8
  %127 = call double @llvm.fmuladd.f64(double %112, double %125, double %126)
  %128 = load double, ptr @one, align 8
  %129 = call double @llvm.fmuladd.f64(double %111, double %127, double %128)
  ...
  %146 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %145, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
