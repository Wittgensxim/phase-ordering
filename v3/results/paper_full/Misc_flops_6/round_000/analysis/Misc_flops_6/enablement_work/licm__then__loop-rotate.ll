...
define dso_local i32 @main() #0 {
  ...
  %20 = load double, ptr @four, align 8
...
43:                                               ; preds = %.lr.ph, %63
  %44 = phi i32 [ %.promoted, %.lr.ph ], [ %64, %63 ]
  %45 = phi double [ %.promoted7, %.lr.ph ], [ %62, %63 ]
  %46 = sitofp i32 %44 to double
  %47 = fmul double %46, %27
  %48 = fmul double %47, %47
  %49 = call double @llvm.fmuladd.f64(double %28, double %48, double %29)
  %50 = call double @llvm.fmuladd.f64(double %49, double %48, double %30)
  %51 = call double @llvm.fmuladd.f64(double %50, double %48, double %31)
  %52 = call double @llvm.fmuladd.f64(double %51, double %48, double %32)
  %53 = call double @llvm.fmuladd.f64(double %52, double %48, double %33)
  %54 = call double @llvm.fmuladd.f64(double %53, double %48, double %34)
  %55 = fmul double %47, %54
  %56 = call double @llvm.fmuladd.f64(double %35, double %48, double %36)
  %57 = call double @llvm.fmuladd.f64(double %48, double %56, double %37)
  %58 = call double @llvm.fmuladd.f64(double %48, double %57, double %38)
  %59 = call double @llvm.fmuladd.f64(double %48, double %58, double %39)
  %60 = call double @llvm.fmuladd.f64(double %48, double %59, double %40)
  %61 = call double @llvm.fmuladd.f64(double %48, double %60, double %41)
  %62 = call double @llvm.fmuladd.f64(double %55, double %61, double %45)
  br label %63
...
._crit_edge:                                      ; preds = %63
  %split = phi double [ %62, %63 ]
  %split9 = phi double [ %55, %63 ]
  %split10 = phi double [ %48, %63 ]
  %split11 = phi double [ %47, %63 ]
  %split12 = phi i32 [ %64, %63 ]
  br label %66

66:                                               ; preds = %._crit_edge, %0
  %.lcssa8 = phi double [ %split, %._crit_edge ], [ %.promoted7, %0 ]
  %.lcssa6 = phi double [ %split9, %._crit_edge ], [ %.promoted5, %0 ]
  %.lcssa4 = phi double [ %split10, %._crit_edge ], [ %.promoted3, %0 ]
  %.lcssa2 = phi double [ %split11, %._crit_edge ], [ %.promoted1, %0 ]
  %.lcssa = phi i32 [ %split12, %._crit_edge ], [ %.promoted, %0 ]
  ...
  %99 = load double, ptr @B6, align 8
  %100 = load double, ptr %5, align 8
  %101 = load double, ptr @B5, align 8
  %102 = call double @llvm.fmuladd.f64(double %99, double %100, double %101)
  %103 = load double, ptr @B4, align 8
  %104 = call double @llvm.fmuladd.f64(double %98, double %102, double %103)
  %105 = load double, ptr @B3, align 8
  %106 = call double @llvm.fmuladd.f64(double %97, double %104, double %105)
  %107 = load double, ptr @B2, align 8
  %108 = call double @llvm.fmuladd.f64(double %96, double %106, double %107)
  %109 = load double, ptr @B1, align 8
  %110 = call double @llvm.fmuladd.f64(double %95, double %108, double %109)
  %111 = load double, ptr @one, align 8
  %112 = call double @llvm.fmuladd.f64(double %94, double %110, double %111)
  store double %112, ptr @sb, align 8
  %113 = load double, ptr @sa, align 8
  %114 = load double, ptr @sb, align 8
  ...
  %127 = load double, ptr @sc, align 8
  %128 = fmul double %127, 1.000000e-30
  %129 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %128, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
