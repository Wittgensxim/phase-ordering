...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  br i1 %84, label %.lr.ph, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %.lr.ph, %0
  %85 = load double, ptr @piref, align 8
  %86 = load double, ptr @four, align 8
  ...
  %136 = load double, ptr @two, align 8
  %137 = load double, ptr %2, align 8
  ...
  %147 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %146, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
