...
define dso_local i32 @main() #0 {
  ...
  br i1 %26, label %.lr.ph, label %71

.lr.ph:                                           ; preds = %0
  br label %27

27:                                               ; preds = %.lr.ph, %64
  %28 = phi i32 [ %23, %.lr.ph ], [ %67, %64 ]
...
64:                                               ; preds = %27
  ...
  br i1 %70, label %27, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %64
  br label %71

71:                                               ; preds = %._crit_edge, %0
  %72 = load double, ptr @piref, align 8
  ...
  %79 = call double @llvm.fmuladd.f64(double %77, double %75, double %78)
  %80 = load double, ptr @A4, align 8
  %81 = call double @llvm.fmuladd.f64(double %79, double %75, double %80)
  %82 = load double, ptr @A3, align 8
  %83 = call double @llvm.fmuladd.f64(double %81, double %75, double %82)
  %84 = load double, ptr @A2, align 8
  %85 = call double @llvm.fmuladd.f64(double %83, double %75, double %84)
  %86 = load double, ptr @A1, align 8
  %87 = call double @llvm.fmuladd.f64(double %85, double %75, double %86)
  %88 = load double, ptr @one, align 8
  %89 = call double @llvm.fmuladd.f64(double %87, double %75, double %88)
  %90 = fmul double %76, %89
  store double %90, ptr @sa, align 8
  %91 = load double, ptr %5, align 8
  %92 = load double, ptr @B6, align 8
  %93 = load double, ptr @B5, align 8
  %94 = call double @llvm.fmuladd.f64(double %92, double %91, double %93)
  %95 = load double, ptr @B4, align 8
  %96 = call double @llvm.fmuladd.f64(double %91, double %94, double %95)
  %97 = load double, ptr @B3, align 8
  %98 = call double @llvm.fmuladd.f64(double %91, double %96, double %97)
  %99 = load double, ptr @B2, align 8
  %100 = call double @llvm.fmuladd.f64(double %91, double %98, double %99)
  %101 = load double, ptr @B1, align 8
  %102 = call double @llvm.fmuladd.f64(double %91, double %100, double %101)
  %103 = load double, ptr @one, align 8
  %104 = call double @llvm.fmuladd.f64(double %91, double %102, double %103)
  ...
  %108 = load double, ptr @two, align 8
  ...
  %114 = fsub double %113, 2.500000e-01
  store double %114, ptr @sc, align 8
  %115 = fmul double %114, 1.000000e-30
  %116 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %115, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
