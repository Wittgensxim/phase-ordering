...
27:                                               ; preds = %47, %0
  %.040 = phi i32 [ 1, %0 ], [ %48, %47 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %46, %47 ]
...
29:                                               ; preds = %27
  ...
  %46 = call double @llvm.fmuladd.f64(double %39, double %45, double %.0)
  br label %47
...
49:                                               ; preds = %27
  ...
  %51 = load double, ptr @four, align 8
  ...
  %86 = call double @llvm.fmuladd.f64(double %85, double %.0.lcssa, double %84)
