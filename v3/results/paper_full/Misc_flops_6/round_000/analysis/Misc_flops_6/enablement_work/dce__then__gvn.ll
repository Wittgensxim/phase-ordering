...
define dso_local i32 @main() #0 {
  ...
  %16 = load double, ptr @four, align 8
...
19:                                               ; preds = %23, %0
  %20 = phi double [ %53, %23 ], [ 0.000000e+00, %0 ]
  %21 = phi i32 [ %54, %23 ], [ 1, %0 ]
...
23:                                               ; preds = %19
  ...
  %53 = call double @llvm.fmuladd.f64(double %40, double %52, double %20)
...
55:                                               ; preds = %19
  ...
  %86 = call double @llvm.fmuladd.f64(double %85, double %20, double %84)
