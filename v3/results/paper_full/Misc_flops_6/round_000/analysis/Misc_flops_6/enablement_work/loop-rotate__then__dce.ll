...
28:                                               ; preds = %.lr.ph, %79
  ...
  %69 = call double @llvm.fmuladd.f64(double %63, double %67, double %68)
  %70 = load double, ptr @B3, align 8
  %71 = call double @llvm.fmuladd.f64(double %62, double %69, double %70)
  %72 = load double, ptr @B2, align 8
  %73 = call double @llvm.fmuladd.f64(double %61, double %71, double %72)
  %74 = load double, ptr @B1, align 8
  %75 = call double @llvm.fmuladd.f64(double %60, double %73, double %74)
  %76 = load double, ptr @one, align 8
  %77 = call double @llvm.fmuladd.f64(double %59, double %75, double %76)
  %78 = call double @llvm.fmuladd.f64(double %58, double %77, double %57)
...
79:                                               ; preds = %28
  ...
  br i1 %85, label %28, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %79
  br label %86

86:                                               ; preds = %._crit_edge, %0
  %87 = load double, ptr @piref, align 8
  %88 = load double, ptr @four, align 8
  ...
  %119 = load double, ptr @B6, align 8
  %120 = load double, ptr %5, align 8
  %121 = load double, ptr @B5, align 8
  %122 = call double @llvm.fmuladd.f64(double %119, double %120, double %121)
  %123 = load double, ptr @B4, align 8
  %124 = call double @llvm.fmuladd.f64(double %118, double %122, double %123)
  %125 = load double, ptr @B3, align 8
  %126 = call double @llvm.fmuladd.f64(double %117, double %124, double %125)
  %127 = load double, ptr @B2, align 8
  %128 = call double @llvm.fmuladd.f64(double %116, double %126, double %127)
  %129 = load double, ptr @B1, align 8
  %130 = call double @llvm.fmuladd.f64(double %115, double %128, double %129)
  %131 = load double, ptr @one, align 8
  %132 = call double @llvm.fmuladd.f64(double %114, double %130, double %131)
  ...
  %145 = load double, ptr @sb, align 8
  %146 = fsub double %144, %145
  store double %146, ptr @sc, align 8
  %147 = load double, ptr @sc, align 8
  %148 = fmul double %147, 1.000000e-30
  %149 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %148, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
