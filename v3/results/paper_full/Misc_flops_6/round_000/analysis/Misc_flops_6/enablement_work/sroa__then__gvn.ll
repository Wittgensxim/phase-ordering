...
define dso_local i32 @main() #0 {
  ...
  %6 = load double, ptr @four, align 8
  %7 = fmul double %6, 1.562500e+08
  %8 = fdiv double %5, %7
  br label %9

9:                                                ; preds = %11, %0
  %.040 = phi i32 [ 1, %0 ], [ %42, %11 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %41, %11 ]
  %10 = icmp sle i32 %.040, 156249999
  br i1 %10, label %11, label %43

11:                                               ; preds = %9
  %12 = sitofp i32 %.040 to double
  %13 = fmul double %12, %8
  %14 = fmul double %13, %13
  %15 = load double, ptr @A6, align 8
  %16 = load double, ptr @A5, align 8
  %17 = call double @llvm.fmuladd.f64(double %15, double %14, double %16)
  %18 = load double, ptr @A4, align 8
  %19 = call double @llvm.fmuladd.f64(double %17, double %14, double %18)
  %20 = load double, ptr @A3, align 8
  %21 = call double @llvm.fmuladd.f64(double %19, double %14, double %20)
  %22 = load double, ptr @A2, align 8
  %23 = call double @llvm.fmuladd.f64(double %21, double %14, double %22)
  %24 = load double, ptr @A1, align 8
  %25 = call double @llvm.fmuladd.f64(double %23, double %14, double %24)
  %26 = load double, ptr @one, align 8
  %27 = call double @llvm.fmuladd.f64(double %25, double %14, double %26)
  %28 = fmul double %13, %27
  %29 = load double, ptr @B6, align 8
  %30 = load double, ptr @B5, align 8
  %31 = call double @llvm.fmuladd.f64(double %29, double %14, double %30)
  %32 = load double, ptr @B4, align 8
  %33 = call double @llvm.fmuladd.f64(double %14, double %31, double %32)
  %34 = load double, ptr @B3, align 8
  %35 = call double @llvm.fmuladd.f64(double %14, double %33, double %34)
  %36 = load double, ptr @B2, align 8
  %37 = call double @llvm.fmuladd.f64(double %14, double %35, double %36)
  %38 = load double, ptr @B1, align 8
  %39 = call double @llvm.fmuladd.f64(double %14, double %37, double %38)
  %40 = call double @llvm.fmuladd.f64(double %14, double %39, double %26)
  %41 = call double @llvm.fmuladd.f64(double %28, double %40, double %.0)
  %42 = add nsw i32 %.040, 1
