...
41:                                               ; preds = %65, %0
  %42 = phi double [ %64, %65 ], [ %.promoted7, %0 ]
  %43 = phi double [ %57, %65 ], [ %.promoted5, %0 ]
  %44 = phi double [ %50, %65 ], [ %.promoted3, %0 ]
  %45 = phi double [ %49, %65 ], [ %.promoted1, %0 ]
  %46 = phi i32 [ %66, %65 ], [ %.promoted, %0 ]
  %exitcond = icmp ne i32 %46, %smax
  br i1 %exitcond, label %47, label %67
...
47:                                               ; preds = %41
  ...
  %64 = call double @llvm.fmuladd.f64(double %57, double %63, double %42)
  br label %65
