...
define dso_local i32 @main() #0 {
  ...
  %.not.not3 = icmp slt i32 1, %14
  br i1 %.not.not3, label %.lr.ph, label %56
...
15:                                               ; preds = %.lr.ph, %52
  ...
  %29 = load double, ptr @A2, align 8
  %30 = call double @llvm.fmuladd.f64(double %27, double %28, double %29)
  %31 = load double, ptr @A1, align 8
  %32 = call double @llvm.fmuladd.f64(double %30, double %28, double %31)
  ...
  %40 = call double @llvm.fmuladd.f64(double %38, double %37, double %39)
  ...
  %46 = call double @llvm.fmuladd.f64(double %37, double %44, double %45)
  %47 = load double, ptr @B1, align 8
  %48 = call double @llvm.fmuladd.f64(double %37, double %46, double %47)
  %49 = load double, ptr @one, align 8
  %50 = call double @llvm.fmuladd.f64(double %37, double %48, double %49)
  %51 = call double @llvm.fmuladd.f64(double %35, double %50, double %36)
...
52:                                               ; preds = %15
  ...
  %.not.not = icmp slt i32 %54, %55
  br i1 %.not.not, label %15, label %._crit_edge, !llvm.loop !7
...
56:                                               ; preds = %._crit_edge, %0
  ...
  %58 = load double, ptr @four, align 8
  ...
  store double %98, ptr @sc, align 8
  %99 = fmul double %98, 1.000000e-30
  %100 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %99, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
