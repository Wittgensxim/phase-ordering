...
define dso_local i32 @main() #0 {
  ...
  %8 = load double, ptr @four, align 8
...
27:                                               ; preds = %52, %0
  %28 = phi double [ %51, %52 ], [ 0.000000e+00, %0 ]
  %29 = phi double [ %44, %52 ], [ 0.000000e+00, %0 ]
  %30 = phi double [ %37, %52 ], [ undef, %0 ]
  %31 = phi double [ %36, %52 ], [ undef, %0 ]
  %32 = phi i32 [ %53, %52 ], [ 1, %0 ]
...
34:                                               ; preds = %27
  ...
  %39 = call double @llvm.fmuladd.f64(double %38, double %37, double %15)
  %40 = call double @llvm.fmuladd.f64(double %39, double %37, double %16)
  %41 = call double @llvm.fmuladd.f64(double %40, double %37, double %17)
  %42 = call double @llvm.fmuladd.f64(double %41, double %37, double %18)
  %43 = call double @llvm.fmuladd.f64(double %42, double %37, double %19)
  %44 = fmul double %36, %43
  %45 = call double @llvm.fmuladd.f64(double %20, double %37, double %21)
  %46 = call double @llvm.fmuladd.f64(double %37, double %45, double %22)
  %47 = call double @llvm.fmuladd.f64(double %37, double %46, double %23)
  %48 = call double @llvm.fmuladd.f64(double %37, double %47, double %24)
  %49 = call double @llvm.fmuladd.f64(double %37, double %48, double %25)
  %50 = call double @llvm.fmuladd.f64(double %37, double %49, double %26)
  %51 = call double @llvm.fmuladd.f64(double %44, double %50, double %28)
  br label %52
...
54:                                               ; preds = %27
  ...
  %85 = call double @llvm.fmuladd.f64(double %58, double %83, double %84)
  ...
  %91 = call double @llvm.fmuladd.f64(double %90, double %.lcssa8, double %89)
