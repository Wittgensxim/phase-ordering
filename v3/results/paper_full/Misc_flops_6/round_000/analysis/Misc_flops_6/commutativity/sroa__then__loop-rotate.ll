...
13:                                               ; preds = %0, %45
  %.042 = phi double [ 0.000000e+00, %0 ], [ %44, %45 ]
  %.04041 = phi i32 [ 1, %0 ], [ %46, %45 ]
  %14 = sitofp i32 %.04041 to double
  ...
  %44 = call double @llvm.fmuladd.f64(double %30, double %43, double %.042)
  br label %45

45:                                               ; preds = %13
  %46 = add nsw i32 %.04041, 1
  %47 = icmp sle i32 %46, %12
  br i1 %47, label %13, label %48, !llvm.loop !7

48:                                               ; preds = %45
  %.0.lcssa = phi double [ %44, %45 ]
  ...
  %85 = call double @llvm.fmuladd.f64(double %84, double %.0.lcssa, double %83)
