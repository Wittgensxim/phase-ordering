...
14:                                               ; preds = %16, %0
  %storemerge = phi i32 [ 1, %0 ], [ %54, %16 ]
  store i32 %storemerge, ptr %5, align 4
  %15 = load i32, ptr %6, align 4
  %.not.not = icmp slt i32 %storemerge, %15
  br i1 %.not.not, label %16, label %55
...
16:                                               ; preds = %14
  ...
  %52 = call double @llvm.fmuladd.f64(double %36, double %51, double %37)
...
55:                                               ; preds = %14
  ...
  %71 = call double @llvm.fmuladd.f64(double %69, double %67, double %70)
  %72 = load double, ptr @one, align 8
  %73 = call double @llvm.fmuladd.f64(double %71, double %67, double %72)
  %74 = fmul double %58, %73
  store double %74, ptr @sa, align 8
  %75 = load double, ptr %2, align 8
  %76 = load double, ptr @B6, align 8
  %77 = load double, ptr @B5, align 8
  %78 = call double @llvm.fmuladd.f64(double %76, double %75, double %77)
  %79 = load double, ptr @B4, align 8
  %80 = call double @llvm.fmuladd.f64(double %75, double %78, double %79)
  %81 = load double, ptr @B3, align 8
  %82 = call double @llvm.fmuladd.f64(double %75, double %80, double %81)
  %83 = load double, ptr @B2, align 8
  %84 = call double @llvm.fmuladd.f64(double %75, double %82, double %83)
  %85 = load double, ptr @B1, align 8
  %86 = call double @llvm.fmuladd.f64(double %75, double %84, double %85)
  %87 = load double, ptr @one, align 8
  %88 = call double @llvm.fmuladd.f64(double %75, double %86, double %87)
  ...
  %97 = fadd double %96, -2.500000e-01
