...
33:                                               ; preds = %42, %0
  %34 = phi i32 [ %60, %42 ], [ poison, %0 ]
  %35 = phi double [ %59, %42 ], [ poison, %0 ]
  %36 = phi double [ %52, %42 ], [ poison, %0 ]
  %37 = phi double [ %45, %42 ], [ poison, %0 ]
  %38 = phi double [ %44, %42 ], [ poison, %0 ]
  %39 = phi double [ %59, %42 ], [ 0.000000e+00, %0 ]
  %40 = phi i32 [ %60, %42 ], [ 1, %0 ]
...
42:                                               ; preds = %33
  ...
  %59 = call double @llvm.fmuladd.f64(double %52, double %58, double %39)
  %60 = add nsw i32 %40, 1
...
61:                                               ; preds = %33
  ...
  %72 = call double @llvm.fmuladd.f64(double %70, double %63, double %71)
  %73 = load double, ptr @A1, align 8
  %74 = call double @llvm.fmuladd.f64(double %72, double %63, double %73)
  %75 = load double, ptr @one, align 8
  %76 = call double @llvm.fmuladd.f64(double %74, double %63, double %75)
  %77 = fmul double %62, %76
  store double %77, ptr @sa, align 8
  %78 = load double, ptr @B6, align 8
  %79 = load double, ptr @B5, align 8
  %80 = call double @llvm.fmuladd.f64(double %78, double %63, double %79)
  %81 = load double, ptr @B4, align 8
  %82 = call double @llvm.fmuladd.f64(double %63, double %80, double %81)
  %83 = load double, ptr @B3, align 8
  %84 = call double @llvm.fmuladd.f64(double %63, double %82, double %83)
  %85 = load double, ptr @B2, align 8
  %86 = call double @llvm.fmuladd.f64(double %63, double %84, double %85)
  %87 = load double, ptr @B1, align 8
  %88 = call double @llvm.fmuladd.f64(double %63, double %86, double %87)
  %89 = call double @llvm.fmuladd.f64(double %63, double %88, double %75)
  store double %89, ptr @sb, align 8
  %90 = fmul double %77, %89
  store double %90, ptr @sa, align 8
  %91 = load double, ptr @two, align 8
  %92 = call double @llvm.fmuladd.f64(double %91, double %.lcssa, double %90)
  %93 = fmul double %19, %92
  %94 = fdiv double %93, %91
  store double %94, ptr @sa, align 8
  store double 2.500000e-01, ptr @sb, align 8
  %95 = fsub double %94, 2.500000e-01
