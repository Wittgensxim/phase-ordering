...
9:                                                ; preds = %13, %0
  %10 = phi double [ %43, %13 ], [ 0.000000e+00, %0 ]
  %11 = phi i32 [ %44, %13 ], [ 1, %0 ]
...
13:                                               ; preds = %9
  ...
  %43 = call double @llvm.fmuladd.f64(double %30, double %42, double %10)
  %44 = add nsw i32 %11, 1
