...
20:                                               ; preds = %0, %20
  %21 = phi i32 [ 1, %0 ], [ %53, %20 ]
  %22 = phi double [ 0.000000e+00, %0 ], [ %52, %20 ]
  ...
  %28 = call double @llvm.fmuladd.f64(double %26, double %25, double %27)
  %29 = load double, ptr @A4, align 8
  %30 = call double @llvm.fmuladd.f64(double %28, double %25, double %29)
  %31 = load double, ptr @A3, align 8
  %32 = call double @llvm.fmuladd.f64(double %30, double %25, double %31)
  %33 = load double, ptr @A2, align 8
  %34 = call double @llvm.fmuladd.f64(double %32, double %25, double %33)
  %35 = load double, ptr @A1, align 8
  %36 = call double @llvm.fmuladd.f64(double %34, double %25, double %35)
  %37 = load double, ptr @one, align 8
  %38 = call double @llvm.fmuladd.f64(double %36, double %25, double %37)
  %39 = fmul double %24, %38
  store double %39, ptr %4, align 8
  %40 = load double, ptr @B6, align 8
  %41 = load double, ptr @B5, align 8
  %42 = call double @llvm.fmuladd.f64(double %40, double %25, double %41)
  %43 = load double, ptr @B4, align 8
  %44 = call double @llvm.fmuladd.f64(double %25, double %42, double %43)
  %45 = load double, ptr @B3, align 8
  %46 = call double @llvm.fmuladd.f64(double %25, double %44, double %45)
  %47 = load double, ptr @B2, align 8
  %48 = call double @llvm.fmuladd.f64(double %25, double %46, double %47)
  %49 = load double, ptr @B1, align 8
  %50 = call double @llvm.fmuladd.f64(double %25, double %48, double %49)
  %51 = call double @llvm.fmuladd.f64(double %25, double %50, double %37)
  %52 = call double @llvm.fmuladd.f64(double %39, double %51, double %22)
  store double %52, ptr %2, align 8
  %53 = add nsw i32 %21, 1
  store i32 %53, ptr %9, align 4
  %54 = icmp sle i32 %53, 156249999
  br i1 %54, label %20, label %55, !llvm.loop !7

55:                                               ; preds = %20
  %.lcssa = phi double [ %52, %20 ]
  %56 = fdiv double %16, %17
  ...
  %72 = load double, ptr @B6, align 8
  %73 = load double, ptr @B5, align 8
  %74 = call double @llvm.fmuladd.f64(double %72, double %57, double %73)
  %75 = load double, ptr @B4, align 8
  %76 = call double @llvm.fmuladd.f64(double %57, double %74, double %75)
  %77 = load double, ptr @B3, align 8
  %78 = call double @llvm.fmuladd.f64(double %57, double %76, double %77)
  %79 = load double, ptr @B2, align 8
  %80 = call double @llvm.fmuladd.f64(double %57, double %78, double %79)
  %81 = load double, ptr @B1, align 8
  %82 = call double @llvm.fmuladd.f64(double %57, double %80, double %81)
  %83 = call double @llvm.fmuladd.f64(double %57, double %82, double %69)
  store double %83, ptr @sb, align 8
  %84 = fmul double %71, %83
  store double %84, ptr @sa, align 8
  %85 = load double, ptr @two, align 8
  %86 = call double @llvm.fmuladd.f64(double %85, double %.lcssa, double %84)
  %87 = fmul double %19, %86
  %88 = fdiv double %87, %85
  store double %88, ptr @sa, align 8
  store double 2.500000e-01, ptr @sb, align 8
  %89 = fsub double %88, 2.500000e-01
