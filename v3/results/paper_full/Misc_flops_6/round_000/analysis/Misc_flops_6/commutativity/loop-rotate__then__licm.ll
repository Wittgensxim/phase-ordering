...
46:                                               ; preds = %.lr.ph, %66
  %47 = phi double [ %.promoted7, %.lr.ph ], [ %65, %66 ]
  %48 = phi i32 [ %.promoted, %.lr.ph ], [ %67, %66 ]
  ...
  %65 = call double @llvm.fmuladd.f64(double %58, double %64, double %47)
  br label %66

66:                                               ; preds = %46
  %67 = add nsw i32 %48, 1
  %68 = icmp sle i32 %67, %45
  br i1 %68, label %46, label %._crit_edge, !llvm.loop !7

._crit_edge:                                      ; preds = %66
  %.lcssa8 = phi double [ %65, %66 ]
  %.lcssa6 = phi double [ %58, %66 ]
  %.lcssa4 = phi double [ %51, %66 ]
  %.lcssa2 = phi double [ %50, %66 ]
  %.lcssa = phi i32 [ %67, %66 ]
