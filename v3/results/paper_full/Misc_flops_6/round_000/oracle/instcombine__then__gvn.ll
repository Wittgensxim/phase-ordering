...
11:                                               ; preds = %14, %0
  %12 = phi double [ 0.000000e+00, %0 ], [ %44, %14 ]
  %13 = phi i32 [ 1, %0 ], [ %45, %14 ]
  store i32 %13, ptr %5, align 4
  %.not.not = icmp slt i32 %13, 156250000
  br i1 %.not.not, label %14, label %46
...
14:                                               ; preds = %11
  ...
  %43 = call double @llvm.fmuladd.f64(double %17, double %42, double %29)
  %44 = call double @llvm.fmuladd.f64(double %31, double %43, double %12)
...
46:                                               ; preds = %11
  ...
  %77 = call double @llvm.fmuladd.f64(double %76, double %12, double %75)
  %78 = fmul double %10, %77
  %79 = fdiv double %78, %76
  store double %79, ptr @sa, align 8
  store double 2.500000e-01, ptr @sb, align 8
  %80 = fadd double %79, -2.500000e-01
