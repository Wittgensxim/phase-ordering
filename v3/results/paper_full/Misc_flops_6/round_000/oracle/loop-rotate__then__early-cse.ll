...
26:                                               ; preds = %.lr.ph, %63
  ...
  %62 = call double @llvm.fmuladd.f64(double %46, double %61, double %47)
...
63:                                               ; preds = %26
  ...
  br i1 %68, label %26, label %._crit_edge, !llvm.loop !7
...
69:                                               ; preds = %._crit_edge, %0
  ...
  %77 = call double @llvm.fmuladd.f64(double %75, double %73, double %76)
  %78 = load double, ptr @A4, align 8
  %79 = call double @llvm.fmuladd.f64(double %77, double %73, double %78)
  %80 = load double, ptr @A3, align 8
  %81 = call double @llvm.fmuladd.f64(double %79, double %73, double %80)
  %82 = load double, ptr @A2, align 8
  %83 = call double @llvm.fmuladd.f64(double %81, double %73, double %82)
  %84 = load double, ptr @A1, align 8
  %85 = call double @llvm.fmuladd.f64(double %83, double %73, double %84)
  %86 = load double, ptr @one, align 8
  %87 = call double @llvm.fmuladd.f64(double %85, double %73, double %86)
  %88 = fmul double %74, %87
  store double %88, ptr @sa, align 8
  %89 = load double, ptr %5, align 8
  %90 = load double, ptr @B6, align 8
  %91 = load double, ptr @B5, align 8
  %92 = call double @llvm.fmuladd.f64(double %90, double %89, double %91)
  %93 = load double, ptr @B4, align 8
  %94 = call double @llvm.fmuladd.f64(double %89, double %92, double %93)
  %95 = load double, ptr @B3, align 8
  %96 = call double @llvm.fmuladd.f64(double %89, double %94, double %95)
  %97 = load double, ptr @B2, align 8
  %98 = call double @llvm.fmuladd.f64(double %89, double %96, double %97)
  %99 = load double, ptr @B1, align 8
  %100 = call double @llvm.fmuladd.f64(double %89, double %98, double %99)
  %101 = load double, ptr @one, align 8
  %102 = call double @llvm.fmuladd.f64(double %89, double %100, double %101)
  ...
  %112 = fsub double %111, 2.500000e-01
