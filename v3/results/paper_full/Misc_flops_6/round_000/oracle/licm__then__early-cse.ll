...
39:                                               ; preds = %64, %0
  %40 = phi double [ %63, %64 ], [ %.promoted7, %0 ]
  %41 = phi double [ %56, %64 ], [ %.promoted5, %0 ]
  %42 = phi double [ %49, %64 ], [ %.promoted3, %0 ]
  %43 = phi double [ %48, %64 ], [ %.promoted1, %0 ]
  %44 = phi i32 [ %65, %64 ], [ 1, %0 ]
...
46:                                               ; preds = %39
  ...
  %63 = call double @llvm.fmuladd.f64(double %56, double %62, double %40)
  br label %64
...
66:                                               ; preds = %39
  ...
  %78 = call double @llvm.fmuladd.f64(double %76, double %70, double %77)
  %79 = load double, ptr @A2, align 8
  %80 = call double @llvm.fmuladd.f64(double %78, double %70, double %79)
  %81 = load double, ptr @A1, align 8
  %82 = call double @llvm.fmuladd.f64(double %80, double %70, double %81)
  %83 = load double, ptr @one, align 8
  %84 = call double @llvm.fmuladd.f64(double %82, double %70, double %83)
  %85 = fmul double %71, %84
  store double %85, ptr @sa, align 8
  %86 = load double, ptr %5, align 8
  %87 = load double, ptr @B6, align 8
  %88 = load double, ptr @B5, align 8
  %89 = call double @llvm.fmuladd.f64(double %87, double %86, double %88)
  %90 = load double, ptr @B4, align 8
  %91 = call double @llvm.fmuladd.f64(double %86, double %89, double %90)
  %92 = load double, ptr @B3, align 8
  %93 = call double @llvm.fmuladd.f64(double %86, double %91, double %92)
  %94 = load double, ptr @B2, align 8
  %95 = call double @llvm.fmuladd.f64(double %86, double %93, double %94)
  %96 = load double, ptr @B1, align 8
  %97 = call double @llvm.fmuladd.f64(double %86, double %95, double %96)
  %98 = load double, ptr @one, align 8
  %99 = call double @llvm.fmuladd.f64(double %86, double %97, double %98)
  ...
  %111 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %110, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
