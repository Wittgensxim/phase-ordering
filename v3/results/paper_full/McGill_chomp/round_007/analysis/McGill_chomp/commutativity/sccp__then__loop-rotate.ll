...
3:                                                ; preds = %4
  ...
  br i1 %.not, label %._crit_edge6, label %4, !llvm.loop !12
...
._crit_edge6:                                     ; preds = %3
  %split7 = phi i1 [ true, %3 ]
  br label %10

10:                                               ; preds = %._crit_edge6, %._crit_edge, %1
  %.not.lcssa = phi i1 [ %split, %._crit_edge ], [ %split7, %._crit_edge6 ], [ true, %1 ]
