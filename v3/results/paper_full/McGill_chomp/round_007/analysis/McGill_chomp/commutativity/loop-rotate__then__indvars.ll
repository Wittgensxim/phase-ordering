...
8:                                                ; preds = %.lr.ph, %8
  ...
  %11 = getelementptr inbounds [4 x i8], ptr %5, i64 %indvars.iv.next
...
6:                                                ; preds = %.lr.ph, %13
  ...
  %7 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv
  %8 = load i32, ptr %7, align 4
  %9 = getelementptr inbounds [4 x i8], ptr %1, i64 %indvars.iv
  %10 = load i32, ptr %9, align 4
...
define dso_local i32 @valid_data(ptr noundef %0) #0 {
  ...
  br i1 %.not1, label %9, label %.lr.ph
...
4:                                                ; preds = %5
  ...
  br i1 %.not, label %._crit_edge4, label %5, !llvm.loop !12

5:                                                ; preds = %.lr.ph, %4
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %4 ]
  %.012 = phi i32 [ %2, %.lr.ph ], [ %.01, %4 ]
...
._crit_edge4:                                     ; preds = %4
  %split5 = phi i1 [ true, %4 ]
  br label %9

9:                                                ; preds = %._crit_edge4, %._crit_edge, %1
...
2:                                                ; preds = %.lr.ph, %11
  ...
  %5 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %4) #5
  %6 = load i32, ptr @ncol, align 4
  %7 = zext i32 %6 to i64
  %.not1 = icmp eq i64 %indvars.iv.next, %7
...
13:                                               ; preds = %.lr.ph6, %13
  %indvars.iv8 = phi i64 [ %9, %.lr.ph6 ], [ %indvars.iv.next9, %13 ]
  %14 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv8
  store i32 %0, ptr %14, align 4
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %15 = load i32, ptr @ncol, align 4
  %16 = zext i32 %15 to i64
  %.not1 = icmp eq i64 %indvars.iv.next9, %16
