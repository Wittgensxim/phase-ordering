...
7:                                                ; preds = %.lr.ph, %14
  %indvars.iv = phi i64 [ %6, %.lr.ph ], [ %indvars.iv.next, %14 ]
...
._crit_edge:                                      ; preds = %5
  %split.wide = phi i64 [ %indvars.iv, %5 ]
  %13 = trunc nuw nsw i64 %split.wide to i32
  br label %15

._crit_edge3:                                     ; preds = %9
  %split4.wide = phi i64 [ %indvars.iv.next, %9 ]
  %14 = trunc nsw i64 %split4.wide to i32
  br label %15

15:                                               ; preds = %._crit_edge3, %._crit_edge, %1
  %.0.lcssa = phi i32 [ %13, %._crit_edge ], [ %14, %._crit_edge3 ], [ 0, %1 ]
  %16 = load i32, ptr @ncol, align 4
  %17 = icmp eq i32 %.0.lcssa, %16
...
..preheader_crit_edge:                            ; preds = %13
  %split.wide = phi i64 [ %indvars.iv.next, %13 ]
  %9 = trunc nuw nsw i64 %split.wide to i32
  br label %.preheader

.preheader:                                       ; preds = %..preheader_crit_edge, %2
  %.0.lcssa = phi i32 [ %9, %..preheader_crit_edge ], [ 0, %2 ]
  %10 = load i32, ptr @ncol, align 4
  %11 = icmp ne i32 %.0.lcssa, %10
  br i1 %11, label %.lr.ph3, label %22
...
13:                                               ; preds = %.lr.ph, %13
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %16 = icmp ne i64 %indvars.iv.next, %8
  br i1 %16, label %13, label %..preheader_crit_edge, !llvm.loop !18

17:                                               ; preds = %.lr.ph3, %17
  %indvars.iv5 = phi i64 [ %12, %.lr.ph3 ], [ %indvars.iv.next6, %17 ]
  %18 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv5
  store i32 %0, ptr %18, align 4
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %19 = load i32, ptr @ncol, align 4
  %20 = trunc nsw i64 %indvars.iv.next6 to i32
  %21 = icmp ne i32 %20, %19
  br i1 %21, label %17, label %._crit_edge, !llvm.loop !19
