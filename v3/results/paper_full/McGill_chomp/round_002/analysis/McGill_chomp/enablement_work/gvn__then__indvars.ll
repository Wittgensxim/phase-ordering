...
12:                                               ; preds = %7, %4
  %.0.lcssa = phi i32 [ %6, %7 ], [ %.pre, %4 ]
  %13 = icmp eq i32 %.0.lcssa, %.pre
...
11:                                               ; preds = %8
  ...
  %13 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv
  store i32 %12, ptr %13, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %8, !llvm.loop !18

14:                                               ; preds = %.preheader, %18
  %indvars.iv2 = phi i64 [ %10, %.preheader ], [ %indvars.iv.next3, %18 ]
  %15 = load i32, ptr @ncol, align 4
  %16 = trunc nsw i64 %indvars.iv2 to i32
  %17 = icmp ne i32 %16, %15
  br i1 %17, label %18, label %20

18:                                               ; preds = %14
  %19 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv2
...
48:                                               ; preds = %42, %41, %34, %32, %28
  %.3 = phi i32 [ %.4, %42 ], [ %.15, %28 ], [ %.15, %32 ], [ %38, %41 ], [ %38, %34 ]
  %.23 = phi i32 [ %47, %42 ], [ %.01, %28 ], [ %.01, %32 ], [ %36, %41 ], [ %36, %34 ]
  %.2 = phi ptr [ %.1, %42 ], [ %23, %34 ], [ %23, %41 ], [ %23, %32 ], [ %23, %28 ]
