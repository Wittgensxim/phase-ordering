...
5:                                                ; preds = %7, %2
  ...
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %6 = icmp ne i64 %indvars.iv, 0
  br i1 %6, label %7, label %.critedge.split.loop.exit2
...
7:                                                ; preds = %5
  ...
  %11 = load i32, ptr %10, align 4
  %12 = icmp eq i32 %9, %11
  br i1 %12, label %5, label %.critedge.split.loop.exit, !llvm.loop !11

.critedge.split.loop.exit:                        ; preds = %7
  %indvars.iv.next.lcssa = phi i64 [ %indvars.iv.next, %7 ]
  %13 = trunc nsw i64 %indvars.iv.next.lcssa to i32
  br label %.critedge

.critedge.split.loop.exit2:                       ; preds = %5
  %.lcssa.ph3 = phi i32 [ -1, %5 ]
  br label %.critedge

.critedge:                                        ; preds = %.critedge.split.loop.exit2, %.critedge.split.loop.exit
  %.lcssa = phi i32 [ %13, %.critedge.split.loop.exit ], [ %.lcssa.ph3, %.critedge.split.loop.exit2 ]
...
12:                                               ; preds = %7, %5
  %indvars.iv.lcssa = phi i64 [ %indvars.iv, %7 ], [ %indvars.iv, %5 ]
  %13 = trunc nuw nsw i64 %indvars.iv.lcssa to i32
...
11:                                               ; preds = %4
  %.01.lcssa1 = phi ptr [ %.01, %4 ]
  %12 = icmp eq ptr %.01.lcssa1, null
...
13:                                               ; preds = %.loopexit, %11
  %.0 = phi i32 [ %spec.select, %11 ], [ 0, %.loopexit ]
  ret i32 %.0
}
...
13:                                               ; preds = %.preheader, %17
  %indvars.iv2 = phi i64 [ %indvars.iv.lcssa, %.preheader ], [ %indvars.iv.next3, %17 ]
  %14 = load i32, ptr @ncol, align 4
  %15 = zext i32 %14 to i64
  %16 = icmp ne i64 %indvars.iv2, %15
  br i1 %16, label %17, label %19

17:                                               ; preds = %13
  %18 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv2
