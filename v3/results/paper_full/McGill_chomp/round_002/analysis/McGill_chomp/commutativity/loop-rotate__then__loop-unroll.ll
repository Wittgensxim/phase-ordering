...
9:                                                ; preds = %9, %.prol.preheader
  %10 = phi i32 [ %7, %.prol.preheader ], [ %15, %9 ]
  %prol.iter = phi i32 [ 0, %.prol.preheader ], [ %prol.iter.next, %9 ]
  ...
  br i1 %prol.iter.cmp, label %9, label %.prol.loopexit.unr-lcssa, !llvm.loop !7
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph
  %.unr = phi i32 [ %7, %.lr.ph ], [ %.unr.ph, %.prol.loopexit.unr-lcssa ]
  %17 = icmp ult i32 %7, 3
  br i1 %17, label %._crit_edge, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.prol.loopexit
  br label %18

18:                                               ; preds = %18, %.lr.ph.new
  %19 = phi i32 [ %.unr, %.lr.ph.new ], [ %39, %18 ]
  ...
  %38 = getelementptr inbounds i32, ptr %5, i64 %35
  store i32 %37, ptr %38, align 4
  %39 = add nsw i32 %19, -4
  %40 = icmp ne i32 %34, 0
  br i1 %40, label %18, label %._crit_edge.unr-lcssa, !llvm.loop !9
...
6:                                                ; preds = %.prol.preheader
  ...
  br i1 %12, label %13, label %.prol.loopexit.unr-lcssa

13:                                               ; preds = %6
  store i32 %11, ptr %8, align 4
  br label %.prol.loopexit.unr-lcssa

.prol.loopexit.unr-lcssa:                         ; preds = %13, %6
  %14 = add nsw i32 %4, -1
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph
  %.unr = phi i32 [ %4, %.lr.ph ], [ %14, %.prol.loopexit.unr-lcssa ]
  %15 = icmp ult i32 %4, 1
...
16:                                               ; preds = %34, %.lr.ph.new
  %17 = phi i32 [ %.unr, %.lr.ph.new ], [ %35, %34 ]
...
25:                                               ; preds = %24, %16
  ...
  %30 = getelementptr inbounds i32, ptr %1, i64 %27
...
34:                                               ; preds = %33, %25
  %35 = add nsw i32 %17, -2
  %36 = icmp ne i32 %26, 0
  br i1 %36, label %16, label %._crit_edge.unr-lcssa, !llvm.loop !12
...
7:                                                ; preds = %4
  ...
  br i1 %13, label %4, label %.critedge, !llvm.loop !13
...
10:                                               ; preds = %5
  ...
  br i1 %13, label %5, label %._crit_edge3, !llvm.loop !14
...
3:                                                ; preds = %.lr.ph, %3
  ...
  br i1 %7, label %3, label %._crit_edge, !llvm.loop !17
...
3:                                                ; preds = %.lr.ph, %3
  ...
  br i1 %14, label %3, label %._crit_edge, !llvm.loop !18
...
..preheader_crit_edge.unr-lcssa:                  ; preds = %18
  %split.ph = phi i32 [ %34, %18 ]
  %.01.unr = phi i32 [ %34, %18 ]
  %lcmp.mod = icmp ne i32 %xtraiter, 0
  br i1 %lcmp.mod, label %.epil.preheader, label %..preheader_crit_edge

.epil.preheader:                                  ; preds = %..preheader_crit_edge.unr-lcssa, %.lr.ph
  %.01.epil.init = phi i32 [ 0, %.lr.ph ], [ %.01.unr, %..preheader_crit_edge.unr-lcssa ]
  %lcmp.mod5 = icmp ne i32 %xtraiter, 0
  call void @llvm.assume(i1 %lcmp.mod5)
  br label %10

10:                                               ; preds = %10, %.epil.preheader
  %.01.epil = phi i32 [ %.01.epil.init, %.epil.preheader ], [ %14, %10 ]
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %10 ]
  %11 = load i32, ptr @nrow, align 4
  %12 = sext i32 %.01.epil to i64
  %13 = getelementptr inbounds i32, ptr %6, i64 %12
  store i32 %11, ptr %13, align 4
  %14 = add nsw i32 %.01.epil, 1
  %15 = icmp ne i32 %14, %1
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp = icmp ne i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp, label %10, label %..preheader_crit_edge.epilog-lcssa, !llvm.loop !20

..preheader_crit_edge.epilog-lcssa:               ; preds = %10
  %split.ph4 = phi i32 [ %14, %10 ]
  br label %..preheader_crit_edge

..preheader_crit_edge:                            ; preds = %..preheader_crit_edge.unr-lcssa, %..preheader_crit_edge.epilog-lcssa
  %split = phi i32 [ %split.ph, %..preheader_crit_edge.unr-lcssa ], [ %split.ph4, %..preheader_crit_edge.epilog-lcssa ]
  br label %.preheader
...
.preheader:                                       ; preds = %..preheader_crit_edge, %2
  ...
  br i1 %17, label %.lr.ph3, label %41

.lr.ph3:                                          ; preds = %.preheader
  br label %35

18:                                               ; preds = %18, %.lr.ph.new
  %.01 = phi i32 [ 0, %.lr.ph.new ], [ %34, %18 ]
  ...
  br i1 %niter.ncmp.3, label %18, label %..preheader_crit_edge.unr-lcssa, !llvm.loop !21

35:                                               ; preds = %.lr.ph3, %35
  %.12 = phi i32 [ %.0.lcssa, %.lr.ph3 ], [ %38, %35 ]
  ...
  br i1 %40, label %35, label %._crit_edge, !llvm.loop !22

._crit_edge:                                      ; preds = %35
  br label %41

41:                                               ; preds = %._crit_edge, %.preheader
  ret ptr %6
}
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %4 = call ptr @malloc(i64 noundef 16) #4
...
14:                                               ; preds = %10
  %15 = call ptr @malloc(i64 noundef 16) #4
...
46:                                               ; preds = %40, %39, %32, %29, %26
  ...
  br i1 %49, label %10, label %._crit_edge, !llvm.loop !23
...
50:                                               ; preds = %._crit_edge, %.preheader
  ...
  br i1 %53, label %.preheader, label %._crit_edge7, !llvm.loop !24
...
define dso_local ptr @make_play(i32 noundef %0) #0 {
  ...
  %4 = call ptr @malloc(i64 noundef 32) #4
...
13:                                               ; preds = %10
  %14 = call ptr @malloc(i64 noundef 32) #4
...
37:                                               ; preds = %33, %19, %10
  ...
  %39 = icmp ne i32 %38, 0
  br i1 %39, label %10, label %._crit_edge, !llvm.loop !25
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  %2 = call ptr @malloc(i64 noundef 16) #4
...
12:                                               ; preds = %8
  %13 = call ptr @malloc(i64 noundef 16) #4
...
26:                                               ; preds = %20, %12
  ...
  br i1 %29, label %8, label %._crit_edge, !llvm.loop !26
...
30:                                               ; preds = %._crit_edge, %.preheader
  ...
  br i1 %33, label %.preheader, label %._crit_edge7, !llvm.loop !27
...
11:                                               ; preds = %6
  ...
  br i1 %15, label %6, label %..critedge_crit_edge2, !llvm.loop !28
...
2:                                                ; preds = %2, %1
  ...
  %4 = load ptr, ptr %3, align 8
  %5 = icmp ne ptr %4, null
  br i1 %5, label %2, label %6, !llvm.loop !29
...
8:                                                ; preds = %.lr.ph, %8
  ...
  %14 = icmp ne i32 %13, 0
  %15 = xor i1 %14, true
  br i1 %15, label %8, label %._crit_edge, !llvm.loop !30
...
12:                                               ; preds = %.lr.ph, %12
  ...
  br i1 %21, label %12, label %._crit_edge, !llvm.loop !31
...
23:                                               ; preds = %18, %14
  ...
  br i1 %24, label %14, label %._crit_edge, !llvm.loop !32
