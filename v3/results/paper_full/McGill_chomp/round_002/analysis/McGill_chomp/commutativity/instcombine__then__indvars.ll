...
12:                                               ; preds = %.preheader, %15
  %indvars.iv3 = phi i64 [ %indvars.iv.lcssa, %.preheader ], [ %indvars.iv.next4, %15 ]
  %13 = load i32, ptr @ncol, align 4
  %14 = zext i32 %13 to i64
  %.not1 = icmp eq i64 %indvars.iv3, %14
  br i1 %.not1, label %17, label %15

15:                                               ; preds = %12
  %16 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv3
