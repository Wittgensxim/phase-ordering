...
9:                                                ; preds = %4
  ...
  br i1 %11, label %4, label %._crit_edge3, !llvm.loop !12
...
define dso_local i32 @in_wanted(ptr noundef %0) #0 {
  ...
  %magicptr1 = ptrtoint ptr %2 to i64
  %cond2 = icmp eq i64 %magicptr1, 0
...
46:                                               ; preds = %40, %39, %32, %30, %26
  %.3 = phi i32 [ %.4, %40 ], [ %.151, %26 ], [ %.151, %30 ], [ %36, %39 ], [ %36, %32 ]
  %.23 = phi i32 [ %45, %40 ], [ %.012, %26 ], [ %.012, %30 ], [ %34, %39 ], [ %34, %32 ]
  %.2 = phi ptr [ %.13, %40 ], [ %21, %32 ], [ %21, %39 ], [ %21, %30 ], [ %21, %26 ]
