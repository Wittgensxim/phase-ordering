...
.preheader:                                       ; preds = %8, %16
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %16 ], [ %indvars.iv, %8 ]
  %13 = load i32, ptr @ncol, align 4
  %14 = zext i32 %13 to i64
  %15 = icmp ne i64 %indvars.iv2, %14
  br i1 %15, label %16, label %18

16:                                               ; preds = %.preheader
  %17 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv2
...
49:                                               ; preds = %.preheader
  %.15.lcssa = phi i32 [ %.15, %.preheader ]
  %.1.lcssa = phi ptr [ %.1, %.preheader ]
  %50 = add nsw i32 %.15.lcssa, 1
...
29:                                               ; preds = %.preheader
  %.12.lcssa = phi i32 [ %.12, %.preheader ]
  %.1.lcssa = phi ptr [ %.1, %.preheader ]
  %30 = add nsw i32 %.12.lcssa, 1
...
.critedge:                                        ; preds = %6, %.preheader
  %.01.lcssa = phi ptr [ %.01, %6 ], [ %.01, %.preheader ]
