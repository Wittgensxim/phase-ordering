...
3:                                                ; preds = %.lr.ph, %13
  %.02 = phi i32 [ 0, %.lr.ph ], [ %.1, %13 ]
  %.011 = phi i32 [ 0, %.lr.ph ], [ %.12, %13 ]
...
13:                                               ; preds = %11, %9
  ...
  %or.cond = select i1 %15, i1 %.not3, i1 false
  br i1 %or.cond, label %3, label %..critedge_crit_edge, !llvm.loop !9
...
9:                                                ; preds = %4
  ...
  %.not5 = icmp eq i32 %10, %11
  br i1 %.not5, label %._crit_edge3, label %4, !llvm.loop !12
...
12:                                               ; preds = %._crit_edge3, %._crit_edge, %1
  %.0.lcssa = phi i32 [ %.02, %._crit_edge ], [ %10, %._crit_edge3 ], [ 0, %1 ]
...
.preheader:                                       ; preds = %..preheader_crit_edge, %2
  %.0.lcssa = phi i32 [ %12, %..preheader_crit_edge ], [ 0, %2 ]
  %7 = load i32, ptr @ncol, align 4
  %.not5 = icmp eq i32 %.0.lcssa, %7
  br i1 %.not5, label %18, label %.lr.ph3
...
8:                                                ; preds = %.lr.ph, %8
  ...
  br i1 %.not4, label %..preheader_crit_edge, label %8, !llvm.loop !18

13:                                               ; preds = %.lr.ph3, %13
  %.12 = phi i32 [ %.0.lcssa, %.lr.ph3 ], [ %16, %13 ]
  ...
  br i1 %.not6, label %._crit_edge, label %13, !llvm.loop !19
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %.not = icmp eq i32 %6, 0
  br i1 %.not, label %47, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %3
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %44
  %.06 = phi ptr [ %4, %.preheader.lr.ph ], [ %.1.lcssa, %44 ]
  %.045 = phi i32 [ 0, %.preheader.lr.ph ], [ %45, %44 ]
  %7 = load i32, ptr @ncol, align 4
  %.not8 = icmp eq i32 %7, 0
  br i1 %.not8, label %44, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %8

8:                                                ; preds = %.lr.ph, %41
  %.13 = phi ptr [ %.06, %.lr.ph ], [ %.2, %41 ]
  %.012 = phi i32 [ 0, %.lr.ph ], [ %42, %41 ]
  %.151 = phi i32 [ %.045, %.lr.ph ], [ %.3, %41 ]
  %9 = call ptr @make_data(i32 noundef %.151, i32 noundef %.012)
  call void @melt_data(ptr noundef %9, ptr noundef %0)
  %10 = call i32 @equal_data(ptr noundef %9, ptr noundef %0)
  %.not9 = icmp eq i32 %10, 0
  br i1 %.not9, label %11, label %35
...
35:                                               ; preds = %8
  %36 = icmp eq i32 %.012, 0
  %37 = load i32, ptr @nrow, align 4
  %38 = add nsw i32 %37, -1
  %.4 = select i1 %36, i32 %38, i32 %.151
  %39 = load i32, ptr @ncol, align 4
  %40 = add nsw i32 %39, -1
  br label %41

41:                                               ; preds = %35, %34, %28, %25, %23
  %.3 = phi i32 [ %.4, %35 ], [ %.151, %23 ], [ %.151, %25 ], [ %32, %34 ], [ %32, %28 ]
  %.23 = phi i32 [ %40, %35 ], [ %.012, %23 ], [ %.012, %25 ], [ %30, %34 ], [ %30, %28 ]
  %.2 = phi ptr [ %.13, %35 ], [ %18, %23 ], [ %18, %25 ], [ %18, %34 ], [ %18, %28 ]
  call void @free(ptr noundef %9) #5
  %42 = add nsw i32 %.23, 1
  %43 = load i32, ptr @ncol, align 4
  %.not12 = icmp eq i32 %42, %43
  br i1 %.not12, label %._crit_edge, label %8, !llvm.loop !20
...
44:                                               ; preds = %._crit_edge, %.preheader
  ...
  %.not13 = icmp eq i32 %45, %46
  br i1 %.not13, label %._crit_edge7, label %.preheader, !llvm.loop !21

._crit_edge7:                                     ; preds = %44
  br label %47

47:                                               ; preds = %._crit_edge7, %3
...
9:                                                ; preds = %.lr.ph, %35
  %.02 = phi ptr [ %5, %.lr.ph ], [ %.1, %35 ]
  %.011 = phi ptr [ %4, %.lr.ph ], [ %.12, %35 ]
...
35:                                               ; preds = %31, %17, %9
  %.12 = phi ptr [ %.011, %9 ], [ %28, %31 ], [ %28, %17 ]
  %.1 = phi ptr [ %.02, %9 ], [ %34, %31 ], [ %.02, %17 ]
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  %.not = icmp eq i32 %4, 0
  br i1 %.not, label %28, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %25
  %.06 = phi ptr [ %2, %.preheader.lr.ph ], [ %.1.lcssa, %25 ]
  %.015 = phi i32 [ 0, %.preheader.lr.ph ], [ %26, %25 ]
  %5 = load i32, ptr @ncol, align 4
  %.not8 = icmp eq i32 %5, 0
  br i1 %.not8, label %25, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %6

6:                                                ; preds = %.lr.ph, %23
  %.13 = phi ptr [ %.06, %.lr.ph ], [ %.2, %23 ]
  %.122 = phi i32 [ %.015, %.lr.ph ], [ %.23, %23 ]
  %.041 = phi i32 [ 0, %.lr.ph ], [ %.15, %23 ]
  %7 = call ptr @make_data(i32 noundef %.122, i32 noundef %.041)
  call void @melt_data(ptr noundef %7, ptr noundef %0)
  %8 = call i32 @equal_data(ptr noundef %7, ptr noundef %0)
  %.not9 = icmp eq i32 %8, 0
  br i1 %.not9, label %9, label %18
...
18:                                               ; preds = %6
  %19 = icmp eq i32 %.041, 0
  %20 = load i32, ptr @nrow, align 4
  %21 = add nsw i32 %20, -1
  %.3 = select i1 %19, i32 %21, i32 %.122
  %22 = load i32, ptr @ncol, align 4
  br label %23

23:                                               ; preds = %18, %9
  %.15 = phi i32 [ %22, %18 ], [ %17, %9 ]
  %.23 = phi i32 [ %.3, %18 ], [ %.122, %9 ]
  %.2 = phi ptr [ %.13, %18 ], [ %16, %9 ]
  call void @free(ptr noundef %7) #5
  %24 = load i32, ptr @ncol, align 4
  %.not10 = icmp eq i32 %.15, %24
  br i1 %.not10, label %._crit_edge, label %6, !llvm.loop !23
...
25:                                               ; preds = %._crit_edge, %.preheader
  ...
  %.not11 = icmp eq i32 %26, %27
  br i1 %.not11, label %._crit_edge7, label %.preheader, !llvm.loop !24

._crit_edge7:                                     ; preds = %25
  br label %28

28:                                               ; preds = %._crit_edge7, %1
...
5:                                                ; preds = %.lr.ph, %9
  ...
  %.011 = phi ptr [ %0, %.lr.ph ], [ %10, %9 ]
  %7 = load ptr, ptr %.011, align 8
  %8 = call i32 @get_value(ptr noundef %7)
  %.not4 = icmp eq i32 %8, 0
  br i1 %.not4, label %..critedge_crit_edge, label %9
...
9:                                                ; preds = %5
  ...
  br i1 %.not5, label %..critedge_crit_edge2, label %5, !llvm.loop !25

..critedge_crit_edge:                             ; preds = %5
  br label %.critedge

..critedge_crit_edge2:                            ; preds = %9
  br label %.critedge

.critedge:                                        ; preds = %..critedge_crit_edge2, %..critedge_crit_edge, %.preheader
  %.01.lcssa = phi ptr [ %.011, %..critedge_crit_edge ], [ %10, %..critedge_crit_edge2 ], [ %0, %.preheader ]
...
10:                                               ; preds = %.lr.ph, %18
  %.012 = phi i32 [ 0, %.lr.ph ], [ %.1, %18 ]
  %.021 = phi ptr [ %9, %.lr.ph ], [ %12, %18 ]
  %11 = call ptr @where(ptr noundef nonnull %.021, ptr noundef %6)
  %12 = call ptr @get_good_move(ptr noundef %11)
  %.not5 = icmp eq ptr %12, null
  br i1 %.not5, label %18, label %13

13:                                               ; preds = %10
  call void @get_real_move(ptr noundef nonnull %12, ptr noundef nonnull %.021, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %14 = load i32, ptr %1, align 4
  %15 = load i32, ptr %2, align 4
  %16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %.012, i32 noundef %14, i32 noundef %15) #5
  %17 = sub nsw i32 1, %.012
  call void @free(ptr noundef nonnull %.021) #5
  br label %18

18:                                               ; preds = %13, %10
  %.1 = phi i32 [ %17, %13 ], [ %.012, %10 ]
  %.not6 = icmp eq ptr %12, null
  br i1 %.not6, label %._crit_edge, label %10, !llvm.loop !29
...
20:                                               ; preds = %._crit_edge, %0
  %.01.lcssa = phi i32 [ %19, %._crit_edge ], [ 1, %0 ]
  call void @dump_play(ptr noundef %6)
  %21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.16, i32 noundef %.01.lcssa) #5
  ret i32 0
}
