...
8:                                                ; preds = %5
  %9 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv.next
  %10 = load i32, ptr %9, align 4
...
6:                                                ; preds = %11
  %indvars.iv = phi i64 [ %indvars.iv.next, %11 ]
  %.01 = phi i32 [ %14, %11 ]
  %7 = load i32, ptr @ncol, align 4
  %8 = zext i32 %7 to i64
  %9 = icmp ne i64 %indvars.iv, %8
  %10 = trunc nuw nsw i64 %indvars.iv to i32
  br i1 %9, label %11, label %._crit_edge4, !llvm.loop !12

11:                                               ; preds = %.lr.ph, %6
  %12 = phi i32 [ 0, %.lr.ph ], [ %10, %6 ]
  %.013 = phi i32 [ %2, %.lr.ph ], [ %.01, %6 ]
  %indvars.iv2 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv, %6 ]
  %13 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv2
  %14 = load i32, ptr %13, align 4
  %15 = icmp sgt i32 %14, %.013
  %indvars.iv.next = add nuw nsw i64 %indvars.iv2, 1
  br i1 %15, label %._crit_edge, label %6
...
16:                                               ; preds = %._crit_edge4, %._crit_edge, %1
...
..preheader_crit_edge:                            ; preds = %12
  %split = phi i64 [ %indvars.iv.next, %12 ]
  br label %.preheader

.preheader:                                       ; preds = %..preheader_crit_edge, %2
  %indvars.iv.lcssa = phi i64 [ %split, %..preheader_crit_edge ], [ 0, %2 ]
  %9 = load i32, ptr @ncol, align 4
  %10 = zext i32 %9 to i64
  %11 = icmp ne i64 %indvars.iv.lcssa, %10
  br i1 %11, label %.lr.ph7, label %21
...
12:                                               ; preds = %.lr.ph, %12
  ...
  %14 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv5
  store i32 %13, ptr %14, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv5, 1
  %15 = icmp ne i64 %indvars.iv.next, %7
  br i1 %15, label %12, label %..preheader_crit_edge, !llvm.loop !18

16:                                               ; preds = %.lr.ph7, %16
  %indvars.iv26 = phi i64 [ %indvars.iv.lcssa, %.lr.ph7 ], [ %indvars.iv.next3, %16 ]
  %17 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv26
  store i32 %0, ptr %17, align 4
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv26, 1
  %18 = load i32, ptr @ncol, align 4
  %19 = zext i32 %18 to i64
  %20 = icmp ne i64 %indvars.iv.next3, %19
  br i1 %20, label %16, label %._crit_edge, !llvm.loop !19
