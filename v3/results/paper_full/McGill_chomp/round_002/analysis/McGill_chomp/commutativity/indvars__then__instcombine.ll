...
5:                                                ; preds = %6, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %6 ], [ %4, %2 ]
  %.not = icmp eq i64 %indvars.iv, 0
...
.critedge:                                        ; preds = %6, %5
  %.lcssa = phi i32 [ %7, %6 ], [ -1, %5 ]
  %.lcssa.lobit = lshr i32 %.lcssa, 31
  ret i32 %.lcssa.lobit
}
...
12:                                               ; preds = %.preheader, %15
  %indvars.iv2 = phi i64 [ %indvars.iv, %.preheader ], [ %indvars.iv.next3, %15 ]
  %13 = load i32, ptr @ncol, align 4
  %14 = zext i32 %13 to i64
  %.not5 = icmp eq i64 %indvars.iv2, %14
...
43:                                               ; preds = %37, %36, %30, %27, %25
  %.3 = phi i32 [ %.4, %37 ], [ %.15, %25 ], [ %.15, %27 ], [ %34, %36 ], [ %34, %30 ]
  %.23 = phi i32 [ %42, %37 ], [ %.01, %25 ], [ %.01, %27 ], [ %32, %36 ], [ %32, %30 ]
  %.2 = phi ptr [ %.1, %37 ], [ %20, %25 ], [ %20, %27 ], [ %20, %36 ], [ %20, %30 ]
