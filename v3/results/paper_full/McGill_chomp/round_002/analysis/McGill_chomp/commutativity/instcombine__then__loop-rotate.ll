...
12:                                               ; preds = %._crit_edge4, %._crit_edge, %1
  %.0.lcssa = phi i32 [ %split, %._crit_edge ], [ %split5, %._crit_edge4 ], [ 0, %1 ]
...
13:                                               ; preds = %.lr.ph6, %13
  %.15 = phi i32 [ %.0.lcssa, %.lr.ph6 ], [ %16, %13 ]
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  br i1 %.not11, label %47, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %3
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %44
  %.013 = phi ptr [ %4, %.preheader.lr.ph ], [ %.1.lcssa, %44 ]
  %.0412 = phi i32 [ 0, %.preheader.lr.ph ], [ %45, %44 ]
  %7 = load i32, ptr @ncol, align 4
  %.not26 = icmp eq i32 0, %7
  br i1 %.not26, label %44, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %8

8:                                                ; preds = %.lr.ph, %41
  %.19 = phi ptr [ %.013, %.lr.ph ], [ %.2, %41 ]
  %.018 = phi i32 [ 0, %.lr.ph ], [ %42, %41 ]
  %.157 = phi i32 [ %.0412, %.lr.ph ], [ %.3, %41 ]
  %9 = call ptr @make_data(i32 noundef %.157, i32 noundef %.018)
...
35:                                               ; preds = %8
  %36 = icmp eq i32 %.018, 0
  %37 = load i32, ptr @nrow, align 4
  %38 = add nsw i32 %37, -1
  %.4 = select i1 %36, i32 %38, i32 %.157
  %39 = load i32, ptr @ncol, align 4
  %40 = add nsw i32 %39, -1
  br label %41

41:                                               ; preds = %35, %34, %28, %25, %23
  %.3 = phi i32 [ %.4, %35 ], [ %.157, %23 ], [ %.157, %25 ], [ %32, %34 ], [ %32, %28 ]
  %.23 = phi i32 [ %40, %35 ], [ %.018, %23 ], [ %.018, %25 ], [ %30, %34 ], [ %30, %28 ]
  %.2 = phi ptr [ %.19, %35 ], [ %18, %23 ], [ %18, %25 ], [ %18, %34 ], [ %18, %28 ]
...
._crit_edge:                                      ; preds = %41
  %split = phi i32 [ %.3, %41 ]
  %split10 = phi ptr [ %.2, %41 ]
  br label %44

44:                                               ; preds = %._crit_edge, %.preheader
  %.15.lcssa = phi i32 [ %split, %._crit_edge ], [ %.0412, %.preheader ]
  %.1.lcssa = phi ptr [ %split10, %._crit_edge ], [ %.013, %.preheader ]
  %45 = add nsw i32 %.15.lcssa, 1
  %46 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %45, %46
  br i1 %.not, label %._crit_edge14, label %.preheader, !llvm.loop !21

._crit_edge14:                                    ; preds = %44
  br label %47

47:                                               ; preds = %._crit_edge14, %3
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  br i1 %.not8, label %28, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %25
  %.010 = phi ptr [ %2, %.preheader.lr.ph ], [ %.1.lcssa, %25 ]
  %.019 = phi i32 [ 0, %.preheader.lr.ph ], [ %26, %25 ]
  %5 = load i32, ptr @ncol, align 4
  %.not13 = icmp eq i32 0, %5
  br i1 %.not13, label %25, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %6

6:                                                ; preds = %.lr.ph, %23
  %.16 = phi ptr [ %.010, %.lr.ph ], [ %.2, %23 ]
  %.125 = phi i32 [ %.019, %.lr.ph ], [ %.23, %23 ]
  %.044 = phi i32 [ 0, %.lr.ph ], [ %.15, %23 ]
  %7 = call ptr @make_data(i32 noundef %.125, i32 noundef %.044)
...
9:                                                ; preds = %6
  ...
  %11 = getelementptr inbounds nuw i8, ptr %.16, i64 8
  ...
  %17 = add nsw i32 %.044, 1
  br label %23

18:                                               ; preds = %6
  %19 = icmp eq i32 %.044, 0
  %20 = load i32, ptr @nrow, align 4
  %21 = add nsw i32 %20, -1
  %.3 = select i1 %19, i32 %21, i32 %.125
  %22 = load i32, ptr @ncol, align 4
  br label %23

23:                                               ; preds = %18, %9
  %.15 = phi i32 [ %22, %18 ], [ %17, %9 ]
  %.23 = phi i32 [ %.3, %18 ], [ %.125, %9 ]
  %.2 = phi ptr [ %.16, %18 ], [ %16, %9 ]
...
25:                                               ; preds = %._crit_edge, %.preheader
  %.12.lcssa = phi i32 [ %split, %._crit_edge ], [ %.019, %.preheader ]
  %.1.lcssa = phi ptr [ %split7, %._crit_edge ], [ %.010, %.preheader ]
  %26 = add nsw i32 %.12.lcssa, 1
  %27 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %26, %27
  br i1 %.not, label %._crit_edge11, label %.preheader, !llvm.loop !24

._crit_edge11:                                    ; preds = %25
  br label %28

28:                                               ; preds = %._crit_edge11, %1
...
10:                                               ; preds = %.lr.ph, %18
  %.016 = phi i32 [ 0, %.lr.ph ], [ %.1, %18 ]
  %.025 = phi ptr [ %9, %.lr.ph ], [ %12, %18 ]
  %11 = call ptr @where(ptr noundef nonnull %.025, ptr noundef %6)
  %12 = call ptr @get_good_move(ptr noundef %11)
  %.not3 = icmp eq ptr %12, null
  br i1 %.not3, label %18, label %13

13:                                               ; preds = %10
  call void @get_real_move(ptr noundef nonnull %12, ptr noundef nonnull %.025, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %14 = load i32, ptr %1, align 4
  %15 = load i32, ptr %2, align 4
  %16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %.016, i32 noundef %14, i32 noundef %15) #5
  %17 = sub nsw i32 1, %.016
  call void @free(ptr noundef nonnull %.025) #5
  br label %18

18:                                               ; preds = %13, %10
  %.1 = phi i32 [ %17, %13 ], [ %.016, %10 ]
  %.not = icmp eq ptr %12, null
