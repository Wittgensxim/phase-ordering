...
10:                                               ; preds = %5
  ...
  br i1 %13, label %5, label %._crit_edge5, !llvm.loop !12

._crit_edge:                                      ; preds = %5
  %split = phi i32 [ %.04, %5 ]
  br label %14

._crit_edge5:                                     ; preds = %10
  %split6 = phi i32 [ %11, %10 ]
  br label %14

14:                                               ; preds = %._crit_edge5, %._crit_edge, %1
  %.0.lcssa = phi i32 [ %split, %._crit_edge ], [ %split6, %._crit_edge5 ], [ 0, %1 ]
  %15 = load i32, ptr @ncol, align 4
...
11:                                               ; preds = %6
  ...
  br i1 %15, label %6, label %..critedge_crit_edge4, !llvm.loop !25

..critedge_crit_edge:                             ; preds = %6
  %split = phi ptr [ %.013, %6 ]
  br label %.critedge

..critedge_crit_edge4:                            ; preds = %11
  %split5 = phi ptr [ %12, %11 ]
  br label %.critedge
