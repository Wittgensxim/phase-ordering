...
define dso_local range(i32 0, 2) i32 @valid_data(ptr noundef %0) #0 {
  ...
  %.not3 = icmp eq i32 0, %.pre
  br i1 %.not3, label %10, label %.lr.ph
...
3:                                                ; preds = %4
  ...
  br i1 %.not, label %._crit_edge7, label %4, !llvm.loop !12

4:                                                ; preds = %.lr.ph, %3
  %.not6 = phi i1 [ %.not3, %.lr.ph ], [ %.not, %3 ]
  %.05 = phi i32 [ 0, %.lr.ph ], [ %.0, %3 ]
  %.014 = phi i32 [ %2, %.lr.ph ], [ %.01, %3 ]
...
10:                                               ; preds = %._crit_edge7, %._crit_edge, %1
  %.not.lcssa = phi i1 [ %split, %._crit_edge ], [ %split8, %._crit_edge7 ], [ %.not3, %1 ]
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  br i1 %.not8, label %47, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %3
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %44
  %.010 = phi ptr [ %4, %.preheader.lr.ph ], [ %.1.lcssa, %44 ]
  %.049 = phi i32 [ 0, %.preheader.lr.ph ], [ %45, %44 ]
  %7 = load i32, ptr @ncol, align 4
  %.not23 = icmp eq i32 0, %7
  br i1 %.not23, label %44, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %8

8:                                                ; preds = %.lr.ph, %41
  %.16 = phi ptr [ %.010, %.lr.ph ], [ %.2, %41 ]
  %.015 = phi i32 [ 0, %.lr.ph ], [ %42, %41 ]
  %.154 = phi i32 [ %.049, %.lr.ph ], [ %.3, %41 ]
  %9 = call ptr @make_data(i32 noundef %.154, i32 noundef %.015)
...
35:                                               ; preds = %8
  %36 = icmp eq i32 %.015, 0
  %37 = load i32, ptr @nrow, align 4
  %38 = add nsw i32 %37, -1
  %.4 = select i1 %36, i32 %38, i32 %.154
  %39 = load i32, ptr @ncol, align 4
  %40 = add nsw i32 %39, -1
  br label %41

41:                                               ; preds = %35, %34, %28, %26, %23
  %.3 = phi i32 [ %.4, %35 ], [ %.154, %23 ], [ %.154, %26 ], [ %32, %34 ], [ %32, %28 ]
  %.23 = phi i32 [ %40, %35 ], [ %.015, %23 ], [ %.015, %26 ], [ %30, %34 ], [ %30, %28 ]
  %.2 = phi ptr [ %.16, %35 ], [ %18, %23 ], [ %18, %26 ], [ %18, %34 ], [ %18, %28 ]
...
44:                                               ; preds = %._crit_edge, %.preheader
  %.15.lcssa = phi i32 [ %split, %._crit_edge ], [ %.049, %.preheader ]
...
9:                                                ; preds = %5
  ...
  br i1 %.not, label %..critedge_crit_edge5, label %5, !llvm.loop !25
