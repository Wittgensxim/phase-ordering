...
5:                                                ; preds = %7, %2
  ...
  %6 = icmp eq i64 %indvars.iv, 0
  br i1 %6, label %.critedge.split.loop.exit2, label %7
...
.critedge.split.loop.exit:                        ; preds = %7
  %indvars.iv.lcssa = phi i64 [ %indvars.iv, %7 ]
  %13 = trunc nsw i64 %indvars.iv.lcssa to i32
  br label %.critedge

.critedge.split.loop.exit2:                       ; preds = %5
  %.0.lcssa.ph3 = phi i32 [ 0, %5 ]
  br label %.critedge

.critedge:                                        ; preds = %.critedge.split.loop.exit2, %.critedge.split.loop.exit
  %.0.lcssa = phi i32 [ %13, %.critedge.split.loop.exit ], [ %.0.lcssa.ph3, %.critedge.split.loop.exit2 ]
