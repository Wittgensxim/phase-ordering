...
.preheader:                                       ; preds = %8, %14
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %14 ], [ %7, %8 ]
  %12 = load i32, ptr @ncol, align 4
  %13 = zext i32 %12 to i64
  %.not1 = icmp eq i64 %indvars.iv2, %13
  br i1 %.not1, label %16, label %14

14:                                               ; preds = %.preheader
  %15 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv2
...
.preheader:                                       ; preds = %4, %24
  %.04 = phi i32 [ %.15, %24 ], [ 0, %4 ]
  %.12 = phi i32 [ %.23, %24 ], [ %.01, %4 ]
  %.1 = phi ptr [ %.2, %24 ], [ %.0, %4 ]
  %6 = load i32, ptr @ncol, align 4
...
.critedge:                                        ; preds = %5, %.preheader
  %.01.lcssa = phi ptr [ %.01, %5 ], [ %.01, %.preheader ]
  %10 = load ptr, ptr %.01.lcssa, align 8
