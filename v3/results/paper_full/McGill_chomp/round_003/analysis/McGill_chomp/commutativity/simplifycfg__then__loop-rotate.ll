...
define dso_local i32 @in_wanted(ptr noundef %0) #0 {
  ...
  br i1 %cond2, label %7, label %.lr.ph
...
2:                                                ; preds = %3
  ...
  br i1 %cond, label %._crit_edge4, label %3, !llvm.loop !17
...
3:                                                ; preds = %.lr.ph, %2
  ...
  br i1 %.not, label %2, label %._crit_edge
...
7:                                                ; preds = %._crit_edge4, %._crit_edge, %1
  %.0 = phi i32 [ %split5, %._crit_edge4 ], [ %split, %._crit_edge ], [ 0, %1 ]
  ret i32 %.0
}
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  br i1 %.not6, label %46, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %3
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %43
  %.08 = phi ptr [ %4, %.preheader.lr.ph ], [ %.1.lcssa, %43 ]
  %.047 = phi i32 [ 0, %.preheader.lr.ph ], [ %44, %43 ]
  %7 = load i32, ptr @ncol, align 4
  %.not21 = icmp eq i32 0, %7
  br i1 %.not21, label %43, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %8

8:                                                ; preds = %.lr.ph, %40
  %.14 = phi ptr [ %.08, %.lr.ph ], [ %.2, %40 ]
  %.013 = phi i32 [ 0, %.lr.ph ], [ %41, %40 ]
  %.152 = phi i32 [ %.047, %.lr.ph ], [ %.3, %40 ]
