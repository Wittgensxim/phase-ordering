...
3:                                                ; preds = %5
  ...
  %.not = icmp eq i32 %4, %.pre
  br i1 %.not, label %._crit_edge5, label %5, !llvm.loop !12

5:                                                ; preds = %.lr.ph, %3
  %.03 = phi i32 [ 0, %.lr.ph ], [ %4, %3 ]
  %.012 = phi i32 [ %2, %.lr.ph ], [ %8, %3 ]
  %6 = zext nneg i32 %.03 to i64
  %7 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %6
  %8 = load i32, ptr %7, align 4
  %9 = icmp sgt i32 %8, %.012
  br i1 %9, label %._crit_edge, label %3
...
10:                                               ; preds = %._crit_edge5, %._crit_edge, %1
  %.not.lcssa = phi i32 [ 0, %._crit_edge ], [ 1, %._crit_edge5 ], [ 1, %1 ]
  ret i32 %.not.lcssa
}
...
9:                                                ; preds = %2
  ...
  %.pre = load i32, ptr @ncol, align 4
  %11 = icmp eq i32 %3, %.pre
  br label %12

12:                                               ; preds = %9, %2
  %.not = phi i1 [ %11, %9 ], [ true, %2 ]
...
2:                                                ; preds = %4
  ...
  %.01 = load ptr, ptr %3, align 8
  %cond = icmp eq ptr %.01, null
  br i1 %cond, label %..loopexit_crit_edge, label %4, !llvm.loop !17
