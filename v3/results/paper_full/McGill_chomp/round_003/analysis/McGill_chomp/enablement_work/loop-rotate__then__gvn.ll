; ModuleID = 'results\paper_full\McGill_chomp\round_002\output.ll'
...
4:                                                ; preds = %.lr.ph, %3
  %.03 = phi i32 [ 0, %.lr.ph ], [ %9, %3 ]
  %.012 = phi i32 [ %2, %.lr.ph ], [ %7, %3 ]
...
10:                                               ; preds = %._crit_edge5, %._crit_edge, %1
  %.not.lcssa = phi i1 [ false, %._crit_edge ], [ true, %._crit_edge5 ], [ true, %1 ]
...
12:                                               ; preds = %.lr.ph6, %12
  ...
  br i1 %.not1, label %._crit_edge, label %12, !llvm.loop !19
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  br i1 %.not6, label %49, label %.preheader.lr.ph
...
.preheader:                                       ; preds = %.preheader.lr.ph, %45
  %7 = phi i32 [ %6, %.preheader.lr.ph ], [ %46, %45 ]
  %8 = phi i32 [ %.pre, %.preheader.lr.ph ], [ %47, %45 ]
  %.08 = phi ptr [ %4, %.preheader.lr.ph ], [ %.1.lcssa, %45 ]
  %.047 = phi i32 [ 0, %.preheader.lr.ph ], [ %48, %45 ]
  %.not21 = icmp eq i32 0, %8
  br i1 %.not21, label %45, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %9

9:                                                ; preds = %.lr.ph, %42
  %.14 = phi ptr [ %.08, %.lr.ph ], [ %.2, %42 ]
  %.013 = phi i32 [ 0, %.lr.ph ], [ %43, %42 ]
  %.152 = phi i32 [ %.047, %.lr.ph ], [ %.3, %42 ]
  %10 = call ptr @make_data(i32 noundef %.152, i32 noundef %.013)
  call void @melt_data(ptr noundef %10, ptr noundef %0)
  %11 = call i32 @equal_data(ptr noundef %10, ptr noundef %0)
  %.not3 = icmp eq i32 %11, 0
  br i1 %.not3, label %12, label %36

12:                                               ; preds = %9
  %13 = call dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #4
  %14 = getelementptr inbounds nuw i8, ptr %.14, i64 8
...
36:                                               ; preds = %9
  %37 = icmp eq i32 %.013, 0
  %38 = load i32, ptr @nrow, align 4
  %39 = add nsw i32 %38, -1
  %.4 = select i1 %37, i32 %39, i32 %.152
  %40 = load i32, ptr @ncol, align 4
  %41 = add nsw i32 %40, -1
  br label %42

42:                                               ; preds = %36, %35, %29, %27, %24
  %.3 = phi i32 [ %.4, %36 ], [ %.152, %24 ], [ %.152, %27 ], [ %33, %35 ], [ %33, %29 ]
  %.23 = phi i32 [ %41, %36 ], [ %.013, %24 ], [ %.013, %27 ], [ %31, %35 ], [ %31, %29 ]
  %.2 = phi ptr [ %.14, %36 ], [ %19, %24 ], [ %19, %27 ], [ %19, %35 ], [ %19, %29 ]
  call void @free(ptr noundef %10) #5
  %43 = add nsw i32 %.23, 1
  %44 = load i32, ptr @ncol, align 4
  %.not2 = icmp eq i32 %43, %44
  br i1 %.not2, label %._crit_edge, label %9, !llvm.loop !20

._crit_edge:                                      ; preds = %42
  %.pre10 = load i32, ptr @nrow, align 4
  br label %45

45:                                               ; preds = %._crit_edge, %.preheader
  %46 = phi i32 [ %.pre10, %._crit_edge ], [ %7, %.preheader ]
  %47 = phi i32 [ %43, %._crit_edge ], [ 0, %.preheader ]
  %.15.lcssa = phi i32 [ %.3, %._crit_edge ], [ %.047, %.preheader ]
  %.1.lcssa = phi ptr [ %.2, %._crit_edge ], [ %.08, %.preheader ]
  %48 = add nsw i32 %.15.lcssa, 1
  %.not = icmp eq i32 %48, %46
...
49:                                               ; preds = %._crit_edge9, %3
  %50 = phi ptr [ %.pre11, %._crit_edge9 ], [ null, %3 ]
  call void @free(ptr noundef %4) #5
  %.not1 = icmp eq ptr %50, null
  br i1 %.not1, label %54, label %51
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  br i1 %.not6, label %30, label %.preheader.lr.ph
...
.preheader:                                       ; preds = %.preheader.lr.ph, %26
  %5 = phi i32 [ %4, %.preheader.lr.ph ], [ %27, %26 ]
  %6 = phi i32 [ %.pre, %.preheader.lr.ph ], [ %28, %26 ]
  %.08 = phi ptr [ %2, %.preheader.lr.ph ], [ %.1.lcssa, %26 ]
  %.017 = phi i32 [ 0, %.preheader.lr.ph ], [ %29, %26 ]
  %.not11 = icmp eq i32 0, %6
  br i1 %.not11, label %26, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %7

7:                                                ; preds = %.lr.ph, %24
  %.14 = phi ptr [ %.08, %.lr.ph ], [ %.2, %24 ]
  %.123 = phi i32 [ %.017, %.lr.ph ], [ %.23, %24 ]
  %.042 = phi i32 [ 0, %.lr.ph ], [ %.15, %24 ]
  %8 = call ptr @make_data(i32 noundef %.123, i32 noundef %.042)
...
19:                                               ; preds = %7
  %20 = icmp eq i32 %.042, 0
  %21 = load i32, ptr @nrow, align 4
  %22 = add nsw i32 %21, -1
  %.3 = select i1 %20, i32 %22, i32 %.123
  %23 = load i32, ptr @ncol, align 4
  br label %24

24:                                               ; preds = %19, %10
  %.15 = phi i32 [ %23, %19 ], [ %18, %10 ]
  %.23 = phi i32 [ %.3, %19 ], [ %.123, %10 ]
  %.2 = phi ptr [ %.14, %19 ], [ %17, %10 ]
  call void @free(ptr noundef %8) #5
  %25 = load i32, ptr @ncol, align 4
  %.not1 = icmp eq i32 %.15, %25
...
26:                                               ; preds = %._crit_edge, %.preheader
  %27 = phi i32 [ %.pre10, %._crit_edge ], [ %5, %.preheader ]
  %28 = phi i32 [ %.15, %._crit_edge ], [ 0, %.preheader ]
  %.12.lcssa = phi i32 [ %.23, %._crit_edge ], [ %.017, %.preheader ]
  %.1.lcssa = phi ptr [ %.2, %._crit_edge ], [ %.08, %.preheader ]
...
30:                                               ; preds = %._crit_edge9, %1
  %31 = phi ptr [ %.pre11, %._crit_edge9 ], [ null, %1 ]
  call void @free(ptr noundef %2) #5
  store ptr %31, ptr @wanted, align 8
  ret void
}
...
.critedge:                                        ; preds = %..critedge_crit_edge4, %..critedge_crit_edge, %.preheader
  %.01.lcssa = phi ptr [ %.013, %..critedge_crit_edge ], [ %10, %..critedge_crit_edge4 ], [ %0, %.preheader ]
...
18:                                               ; preds = %13, %10
  ...
  br i1 %.not3, label %._crit_edge, label %10, !llvm.loop !29
