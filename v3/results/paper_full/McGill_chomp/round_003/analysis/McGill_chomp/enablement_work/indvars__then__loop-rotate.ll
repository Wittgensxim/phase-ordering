...
define dso_local ptr @copy_data(ptr noundef %0) #0 {
  ...
  %7 = sext i32 %6 to i64
  %8 = icmp eq i64 %7, 0
  br i1 %8, label %14, label %.lr.ph

.lr.ph:                                           ; preds = %1
  br label %9

9:                                                ; preds = %.lr.ph, %9
  %indvars.iv2 = phi i64 [ %7, %.lr.ph ], [ %indvars.iv.next, %9 ]
  %indvars.iv.next = add nsw i64 %indvars.iv2, -1
  %10 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv.next
  %11 = load i32, ptr %10, align 4
  %12 = getelementptr inbounds [4 x i8], ptr %5, i64 %indvars.iv.next
  store i32 %11, ptr %12, align 4
  %13 = icmp eq i64 %indvars.iv.next, 0
  br i1 %13, label %._crit_edge, label %9, !llvm.loop !7
...
6:                                                ; preds = %.lr.ph, %13
  ...
  %7 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv.next3
  %8 = load i32, ptr %7, align 4
  %9 = getelementptr inbounds [4 x i8], ptr %1, i64 %indvars.iv.next3
...
13:                                               ; preds = %12, %6
  ...
  %14 = icmp eq i64 %indvars.iv.next3, 0
  br i1 %14, label %._crit_edge, label %6, !llvm.loop !10
...
4:                                                ; preds = %5
  %indvars.iv = phi i64 [ %indvars.iv.next, %5 ]
  %.01 = phi i32 [ %7, %5 ]
  %.not = icmp eq i64 %indvars.iv, %3
  br i1 %.not, label %._crit_edge6, label %5, !llvm.loop !12

5:                                                ; preds = %.lr.ph, %4
  %.not5 = phi i1 [ %.not2, %.lr.ph ], [ %.not, %4 ]
  %.014 = phi i32 [ %2, %.lr.ph ], [ %.01, %4 ]
  %indvars.iv3 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv, %4 ]
  %6 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv3
  %7 = load i32, ptr %6, align 4
...
define dso_local void @show_data(ptr noundef %0) #0 {
  ...
  %2 = zext i32 %.pre2 to i64
  %.not2 = icmp eq i64 0, %2
  br i1 %.not2, label %15, label %.lr.ph
...
.preheader:                                       ; preds = %..preheader_crit_edge, %2
  ...
  %9 = zext i32 %8 to i64
  %.not17 = icmp eq i64 %7, %9
  br i1 %.not17, label %17, label %.lr.ph9

.lr.ph9:                                          ; preds = %.preheader
  br label %13

10:                                               ; preds = %.lr.ph, %10
  %indvars.iv6 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %10 ]
  %11 = load i32, ptr @nrow, align 4
  %12 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv6
  store i32 %11, ptr %12, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv6, 1
  %.not = icmp eq i64 %indvars.iv.next, %7
  br i1 %.not, label %..preheader_crit_edge, label %10, !llvm.loop !18

13:                                               ; preds = %.lr.ph9, %13
  %indvars.iv28 = phi i64 [ %7, %.lr.ph9 ], [ %indvars.iv.next3, %13 ]
  %14 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv28
  store i32 %0, ptr %14, align 4
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv28, 1
  %15 = load i32, ptr @ncol, align 4
  %16 = zext i32 %15 to i64
  %.not1 = icmp eq i64 %indvars.iv.next3, %16
...
5:                                                ; preds = %5, %4
  ...
  br i1 %11, label %5, label %12, !llvm.loop !28
