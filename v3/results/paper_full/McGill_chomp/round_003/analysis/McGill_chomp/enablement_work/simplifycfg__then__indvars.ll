...
12:                                               ; preds = %.preheader, %15
  %indvars.iv2 = phi i64 [ %7, %.preheader ], [ %indvars.iv.next3, %15 ]
...
6:                                                ; preds = %44, %3
  %.04 = phi i32 [ 0, %3 ], [ %45, %44 ]
  %.0 = phi ptr [ %4, %3 ], [ %.1.lcssa, %44 ]
...
8:                                                ; preds = %.preheader, %42
  %.15 = phi i32 [ %.3, %42 ], [ %.04, %.preheader ]
  %.01 = phi i32 [ %43, %42 ], [ 0, %.preheader ]
  %.1 = phi ptr [ %.2, %42 ], [ %.0, %.preheader ]
  %9 = load i32, ptr @ncol, align 4
  %.not2 = icmp eq i32 %.01, %9
  br i1 %.not2, label %44, label %10
...
25:                                               ; preds = %23, %13
  ...
  %28 = icmp eq i32 %26, 0
  %or.cond = select i1 %.not4, i1 %28, i1 false
...
29:                                               ; preds = %25
  ...
  %33 = add nsw i32 %32, -1
  %34 = call i32 @in_wanted(ptr noundef %11)
...
36:                                               ; preds = %10
  ...
  %39 = add nsw i32 %38, -1
  %.4 = select i1 %37, i32 %39, i32 %.15
  %40 = load i32, ptr @ncol, align 4
  %41 = add nsw i32 %40, -1
  br label %42

42:                                               ; preds = %36, %35, %29, %25
  %.3 = phi i32 [ %.4, %36 ], [ %.15, %25 ], [ %33, %29 ], [ %33, %35 ]
  %.23 = phi i32 [ %41, %36 ], [ %.01, %25 ], [ %31, %29 ], [ %31, %35 ]
  %.2 = phi ptr [ %.1, %36 ], [ %20, %25 ], [ %20, %29 ], [ %20, %35 ]
  call void @free(ptr noundef %11) #5
  %43 = add nsw i32 %.23, 1
  br label %8, !llvm.loop !20

44:                                               ; preds = %8
  %.15.lcssa = phi i32 [ %.15, %8 ]
  %.1.lcssa = phi ptr [ %.1, %8 ]
...
.critedge:                                        ; preds = %6, %3
  %.01.lcssa = phi ptr [ %.01, %6 ], [ %.01, %3 ]
  %11 = load ptr, ptr %.01.lcssa, align 8
