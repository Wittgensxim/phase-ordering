...
4:                                                ; preds = %.lr.ph, %14
  %.03 = phi i32 [ 0, %.lr.ph ], [ %.1, %14 ]
  %.012 = phi i32 [ 0, %.lr.ph ], [ %.12, %14 ]
...
14:                                               ; preds = %12, %10
  %.12 = phi i32 [ %11, %10 ], [ %.012, %12 ]
  %.1 = phi i32 [ %.03, %10 ], [ 1, %12 ]
...
6:                                                ; preds = %.lr.ph, %11
  ...
  %10 = icmp ne i32 %9, 0
  br i1 %10, label %11, label %..critedge_crit_edge2
...
11:                                               ; preds = %6
  ...
  br i1 %15, label %6, label %..critedge_crit_edge, !llvm.loop !25

..critedge_crit_edge:                             ; preds = %11
  %split = phi ptr [ %12, %11 ]
  br label %.critedge

..critedge_crit_edge2:                            ; preds = %6
  %split3 = phi ptr [ %.011, %6 ]
  br label %.critedge
...
15:                                               ; preds = %.lr.ph, %24
  %.012 = phi i32 [ 0, %.lr.ph ], [ %.1, %24 ]
  %.021 = phi ptr [ %13, %.lr.ph ], [ %17, %24 ]
  %16 = call ptr @where(ptr noundef %.021, ptr noundef %10)
  %17 = call ptr @get_good_move(ptr noundef %16)
  %18 = icmp ne ptr %17, null
  br i1 %18, label %19, label %24

19:                                               ; preds = %15
  call void @get_real_move(ptr noundef %17, ptr noundef %.021, ptr noundef %1, ptr noundef %2)
  %20 = load i32, ptr %1, align 4
  %21 = load i32, ptr %2, align 4
  %22 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.012, i32 noundef %20, i32 noundef %21)
  %23 = sub nsw i32 1, %.012
  call void @free(ptr noundef %.021)
  br label %24

24:                                               ; preds = %19, %15
  %.1 = phi i32 [ %23, %19 ], [ %.012, %15 ]
  %25 = icmp ne ptr %17, null
  br i1 %25, label %15, label %._crit_edge, !llvm.loop !29
