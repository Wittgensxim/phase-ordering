...
15:                                               ; preds = %.loopexit, %10
  %.04 = phi i32 [ %.0.lcssa, %.loopexit ], [ %.0.lcssa3, %10 ]
...
16:                                               ; preds = %.lr.ph, %25
  %.016 = phi i32 [ 0, %.lr.ph ], [ %.1, %25 ]
  %.025 = phi ptr [ %14, %.lr.ph ], [ %18, %25 ]
  %17 = call ptr @where(ptr noundef %.025, ptr noundef %11)
  %18 = call ptr @get_good_move(ptr noundef %17)
  %19 = icmp ne ptr %18, null
  br i1 %19, label %20, label %25

20:                                               ; preds = %16
  call void @get_real_move(ptr noundef %18, ptr noundef %.025, ptr noundef %1, ptr noundef %2)
  %21 = load i32, ptr %1, align 4
  %22 = load i32, ptr %2, align 4
  %23 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.016, i32 noundef %21, i32 noundef %22)
  %24 = sub nuw nsw i32 1, %.016
  call void @free(ptr noundef %.025)
  br label %25

25:                                               ; preds = %20, %16
  %.1 = phi i32 [ %24, %20 ], [ %.016, %16 ]
  %26 = icmp ne ptr %18, null
  br i1 %26, label %16, label %._crit_edge, !llvm.loop !29
...
27:                                               ; preds = %._crit_edge, %8
  %.01.lcssa = phi i32 [ %split, %._crit_edge ], [ 0, %8 ]
