...
9:                                                ; preds = %5
  %.0.lcssa1.wide = phi i64 [ %indvars.iv, %5 ]
  %10 = trunc nuw nsw i64 %.0.lcssa1.wide to i32
  br label %16
...
..loopexit_crit_edge:                             ; preds = %11
  %split.wide = phi i64 [ %indvars.iv.next, %11 ]
  %15 = trunc nsw i64 %split.wide to i32
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %1
  %.0.lcssa = phi i32 [ %15, %..loopexit_crit_edge ], [ 0, %1 ]
  br label %16

16:                                               ; preds = %.loopexit, %9
  %.02 = phi i32 [ %.0.lcssa, %.loopexit ], [ %10, %9 ]
  %17 = load i32, ptr @ncol, align 4
  %18 = icmp eq i32 %.02, %17
...
12:                                               ; preds = %9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %13 = icmp ne i64 %indvars.iv.next, %8
  br i1 %13, label %9, label %._crit_edge, !llvm.loop !18

._crit_edge:                                      ; preds = %12
  %split.wide = phi i64 [ %indvars.iv.next, %12 ]
  %14 = trunc nuw nsw i64 %split.wide to i32
  br label %15

15:                                               ; preds = %._crit_edge, %2
  %.0.lcssa = phi i32 [ %14, %._crit_edge ], [ 0, %2 ]
...
19:                                               ; preds = %.lr.ph4, %21
  %indvars.iv7 = phi i64 [ %18, %.lr.ph4 ], [ %indvars.iv.next8, %21 ]
  %20 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv7
...
21:                                               ; preds = %19
  ...
  %23 = trunc nsw i64 %indvars.iv.next8 to i32
  %24 = icmp ne i32 %23, %22
  br i1 %24, label %19, label %._crit_edge5, !llvm.loop !19
