...
6:                                                ; preds = %.lr.ph, %12
  ...
  %.013 = phi i32 [ %2, %.lr.ph ], [ %9, %12 ]
  %7 = sext i32 %.04 to i64
  %8 = getelementptr inbounds i32, ptr %0, i64 %7
  %9 = load i32, ptr %8, align 4
  %10 = icmp sgt i32 %9, %.013
  br i1 %10, label %11, label %12

11:                                               ; preds = %6
  %.0.lcssa1 = phi i32 [ %.04, %6 ]
  br label %15

12:                                               ; preds = %6
  %13 = add nsw i32 %.04, 1
  %14 = icmp ne i32 %13, %5
  br i1 %14, label %6, label %..loopexit_crit_edge, !llvm.loop !12
...
15:                                               ; preds = %.loopexit, %11
  %.02 = phi i32 [ %.0.lcssa, %.loopexit ], [ %.0.lcssa1, %11 ]
