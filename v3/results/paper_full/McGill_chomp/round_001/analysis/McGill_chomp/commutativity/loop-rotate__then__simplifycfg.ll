...
.loopexit:                                        ; preds = %1, %9, %.lr.ph
  %.02 = phi i32 [ %.04, %.lr.ph ], [ 0, %1 ], [ %10, %9 ]
  %13 = load i32, ptr @ncol, align 4
  %14 = icmp eq i32 %.02, %13
  %15 = zext i1 %14 to i32
  ret i32 %15
}
...
7:                                                ; preds = %.lr.ph
  %8 = getelementptr inbounds nuw %struct._list, ptr %.013, i32 0, i32 1
  %9 = load ptr, ptr %8, align 8
  %10 = icmp ne ptr %9, null
  br i1 %10, label %.lr.ph, label %.loopexit, !llvm.loop !17

.loopexit:                                        ; preds = %1, %7, %.lr.ph
  %.012 = phi ptr [ %.013, %.lr.ph ], [ %2, %1 ], [ %9, %7 ]
  %11 = icmp eq ptr %.012, null
...
.lr.ph4:                                          ; preds = %._crit_edge, %.lr.ph4
  ...
  br i1 %19, label %.lr.ph4, label %._crit_edge5, !llvm.loop !19
...
.lr.ph:                                           ; preds = %.lr.ph8, %45
  %.13 = phi ptr [ %.2, %45 ], [ %.06, %.lr.ph8 ]
  %.012 = phi i32 [ %46, %45 ], [ 0, %.lr.ph8 ]
  %.151 = phi i32 [ %.3, %45 ], [ %.045, %.lr.ph8 ]
...
._crit_edge:                                      ; preds = %.lr.ph8, %45
  %.15.lcssa = phi i32 [ %.045, %.lr.ph8 ], [ %.3, %45 ]
  %.1.lcssa = phi ptr [ %.06, %.lr.ph8 ], [ %.2, %45 ]
  %49 = add nsw i32 %.15.lcssa, 1
  %50 = load i32, ptr @nrow, align 4
  %51 = icmp ne i32 %49, %50
  br i1 %51, label %.lr.ph8, label %._crit_edge9, !llvm.loop !21
...
.lr.ph:                                           ; preds = %.lr.ph8, %25
  %.13 = phi ptr [ %.2, %25 ], [ %.06, %.lr.ph8 ]
  %.122 = phi i32 [ %.23, %25 ], [ %.015, %.lr.ph8 ]
  %.041 = phi i32 [ %26, %25 ], [ 0, %.lr.ph8 ]
...
._crit_edge:                                      ; preds = %.lr.ph8, %25
  %.12.lcssa = phi i32 [ %.015, %.lr.ph8 ], [ %.23, %25 ]
  %.1.lcssa = phi ptr [ %.06, %.lr.ph8 ], [ %.2, %25 ]
  %29 = add nsw i32 %.12.lcssa, 1
  %30 = load i32, ptr @nrow, align 4
  %31 = icmp ne i32 %29, %30
  br i1 %31, label %.lr.ph8, label %._crit_edge9, !llvm.loop !24
...
define dso_local i32 @main() #0 {
  ...
  br i1 %14, label %.lr.ph7, label %._crit_edge8

.lr.ph7:                                          ; preds = %0, %23
  %.015 = phi i32 [ %.1, %23 ], [ 0, %0 ]
  %.024 = phi ptr [ %16, %23 ], [ %13, %0 ]
  %15 = call ptr @where(ptr noundef %.024, ptr noundef %10)
  %16 = call ptr @get_good_move(ptr noundef %15)
  %17 = icmp ne ptr %16, null
  br i1 %17, label %18, label %23

18:                                               ; preds = %.lr.ph7
  call void @get_real_move(ptr noundef %16, ptr noundef %.024, ptr noundef %1, ptr noundef %2)
  %19 = load i32, ptr %1, align 4
  %20 = load i32, ptr %2, align 4
  %21 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.015, i32 noundef %19, i32 noundef %20)
  %22 = sub nsw i32 1, %.015
  call void @free(ptr noundef %.024)
  br label %23

23:                                               ; preds = %18, %.lr.ph7
  %.1 = phi i32 [ %22, %18 ], [ %.015, %.lr.ph7 ]
  %24 = icmp ne ptr %16, null
  br i1 %24, label %.lr.ph7, label %._crit_edge8, !llvm.loop !29

._crit_edge8:                                     ; preds = %23, %0
  %.01.lcssa = phi i32 [ 0, %0 ], [ %.1, %23 ]
