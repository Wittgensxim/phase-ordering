...
11:                                               ; preds = %5
  ...
  br i1 %14, label %5, label %..loopexit_crit_edge, !llvm.loop !14
...
9:                                                ; preds = %4
  ...
  br i1 %12, label %4, label %..loopexit_crit_edge, !llvm.loop !19
...
10:                                               ; preds = %29, %.lr.ph.new
  %.01 = phi i32 [ 0, %.lr.ph.new ], [ %30, %29 ]
...
29:                                               ; preds = %24
  ...
  br i1 %niter.ncmp.3, label %10, label %._crit_edge.unr-lcssa, !llvm.loop !20

._crit_edge.unr-lcssa:                            ; preds = %29
  %split.ph = phi i32 [ %30, %29 ]
  %.01.unr = phi i32 [ %30, %29 ]
  %lcmp.mod = icmp ne i32 %xtraiter, 0
...
31:                                               ; preds = %35, %.epil.preheader
  %.01.epil = phi i32 [ %.01.epil.init, %.epil.preheader ], [ %36, %35 ]
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %35 ]
  %32 = load i32, ptr @nrow, align 4
  %33 = sext i32 %.01.epil to i64
  %34 = getelementptr inbounds i32, ptr %6, i64 %33
  store i32 %32, ptr %34, align 4
  br label %35

35:                                               ; preds = %31
  %36 = add nsw i32 %.01.epil, 1
  %37 = icmp ne i32 %36, %1
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp = icmp ne i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp, label %31, label %._crit_edge.epilog-lcssa, !llvm.loop !21

._crit_edge.epilog-lcssa:                         ; preds = %35
  %split.ph6 = phi i32 [ %36, %35 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %._crit_edge.epilog-lcssa
  %split = phi i32 [ %split.ph, %._crit_edge.unr-lcssa ], [ %split.ph6, %._crit_edge.epilog-lcssa ]
  br label %38

38:                                               ; preds = %._crit_edge, %2
  %.0.lcssa = phi i32 [ %split, %._crit_edge ], [ 0, %2 ]
  %39 = load i32, ptr @ncol, align 4
  %40 = icmp ne i32 %.0.lcssa, %39
  br i1 %40, label %.lr.ph4, label %48

.lr.ph4:                                          ; preds = %38
  br label %41

41:                                               ; preds = %.lr.ph4, %44
  %.12 = phi i32 [ %.0.lcssa, %.lr.ph4 ], [ %45, %44 ]
...
44:                                               ; preds = %41
  ...
  br i1 %47, label %41, label %._crit_edge5, !llvm.loop !22

._crit_edge5:                                     ; preds = %44
  br label %48

48:                                               ; preds = %._crit_edge5, %38
  ret ptr %6
}
...
15:                                               ; preds = %11
  %16 = call ptr @malloc(i64 noundef 16) #4
...
52:                                               ; preds = %51
  ...
  br i1 %55, label %11, label %._crit_edge, !llvm.loop !23
...
57:                                               ; preds = %56
  ...
  br i1 %60, label %8, label %._crit_edge9, !llvm.loop !24
...
38:                                               ; preds = %37, %10
  ...
  %40 = icmp ne i32 %39, 0
  br i1 %40, label %10, label %._crit_edge, !llvm.loop !25
...
13:                                               ; preds = %9
  %14 = call ptr @malloc(i64 noundef 16) #4
...
35:                                               ; preds = %34
  ...
  br i1 %38, label %6, label %._crit_edge9, !llvm.loop !27
...
33:                                               ; preds = %18
  ...
  br i1 %38, label %18, label %._crit_edge11, !llvm.loop !32
...
57:                                               ; preds = %52, %48
  ...
  br i1 %58, label %48, label %._crit_edge8, !llvm.loop !33
...
76:                                               ; preds = %73, %70
  ...
  br i1 %79, label %70, label %._crit_edge, !llvm.loop !34
