...
16:                                               ; preds = %13
  %.0.lcssa.wide = phi i64 [ %indvars.iv, %13 ]
  %17 = trunc nsw i64 %.0.lcssa.wide to i32
...
10:                                               ; preds = %6
  %.0.lcssa1.wide = phi i64 [ %indvars.iv, %6 ]
...
.loopexit:                                        ; preds = %3
  ...
  %13 = trunc nuw nsw i64 %.0.lcssa.wide to i32
  br label %14

14:                                               ; preds = %.loopexit, %10
  %.02 = phi i32 [ %13, %.loopexit ], [ %11, %10 ]
...
8:                                                ; preds = %2
  %.0.lcssa = phi ptr [ %.0, %2 ]
  %9 = load i32, ptr %.0.lcssa, align 8
  ret i32 %9
}
...
.loopexit:                                        ; preds = %2
  %.01.lcssa = phi ptr [ %.01, %2 ]
  br label %9

9:                                                ; preds = %.loopexit, %6
  %.013 = phi ptr [ %.01.lcssa, %.loopexit ], [ %.01.lcssa2, %6 ]
...
14:                                               ; preds = %19, %13
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %19 ], [ %indvars.iv.lcssa, %13 ]
  %15 = load i32, ptr @ncol, align 4
  %16 = zext i32 %15 to i64
  %.not1 = icmp eq i64 %indvars.iv3, %16
  br i1 %.not1, label %20, label %17

17:                                               ; preds = %14
  %18 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv3
...
6:                                                ; preds = %51, %3
  %.04 = phi i32 [ 0, %3 ], [ %52, %51 ]
  %.0 = phi ptr [ %4, %3 ], [ %.1.lcssa, %51 ]
...
9:                                                ; preds = %49, %8
  %.15 = phi i32 [ %.04, %8 ], [ %.3, %49 ]
  %.01 = phi i32 [ 0, %8 ], [ %.23, %49 ]
  %.1 = phi ptr [ %.0, %8 ], [ %.2, %49 ]
  %10 = load i32, ptr @ncol, align 4
  %.not2 = icmp eq i32 %.01, %10
  br i1 %.not2, label %50, label %11
...
39:                                               ; preds = %38, %28, %26
  %.26 = phi i32 [ %.15, %26 ], [ %35, %38 ], [ %.15, %28 ]
  %.12 = phi i32 [ %.01, %26 ], [ %33, %38 ], [ %.01, %28 ]
  %40 = add nsw i32 %.12, 1
  br label %48
...
7:                                                ; preds = %29, %6
  %.04 = phi i32 [ 0, %6 ], [ %.15, %29 ]
  %.12 = phi i32 [ %.01, %6 ], [ %.23, %29 ]
  %.1 = phi ptr [ %.0, %6 ], [ %.2, %29 ]
  %8 = load i32, ptr @ncol, align 4
  %.not1 = icmp eq i32 %.04, %8
  br i1 %.not1, label %30, label %9
...
6:                                                ; preds = %2
  %.0.lcssa = phi ptr [ %.0, %2 ]
  %7 = getelementptr inbounds nuw i8, ptr %.0.lcssa, i64 16
  %8 = load ptr, ptr %7, align 8
...
26:                                               ; preds = %16
  %.01.lcssa = phi i32 [ %.01, %16 ]
  call void @dump_play(ptr noundef %12)
  %27 = sub nsw i32 1, %.01.lcssa
