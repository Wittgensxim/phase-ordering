...
2:                                                ; preds = %14, %1
  %.01 = phi i32 [ 0, %1 ], [ %.12, %14 ]
  %.0 = phi i32 [ 0, %1 ], [ %.1, %14 ]
  %3 = load i32, ptr @ncol, align 4
  %.not = icmp eq i32 %.01, %3
  %.not1 = icmp eq i32 %.0, 0
  %spec.select = select i1 %.not, i1 false, i1 %.not1
  br i1 %spec.select, label %4, label %15
...
8:                                                ; preds = %3
  %9 = icmp eq ptr %.01, null
  %spec.select = select i1 %9, i32 0, i32 1
  br label %10
...
8:                                                ; preds = %6, %44
  %.15 = phi i32 [ %.3, %44 ], [ %.04, %6 ]
  %.01 = phi i32 [ %.23, %44 ], [ 0, %6 ]
  %.1 = phi ptr [ %.2, %44 ], [ %.0, %6 ]
...
37:                                               ; preds = %30, %36, %27, %25
  %.26 = phi i32 [ %.15, %25 ], [ %.15, %27 ], [ %34, %36 ], [ %34, %30 ]
  %.12 = phi i32 [ %.01, %25 ], [ %.01, %27 ], [ %32, %36 ], [ %32, %30 ]
  %38 = add nsw i32 %.12, 1
  br label %44
...
39:                                               ; preds = %10
  ...
  %42 = add nsw i32 %41, -1
  %.4 = select i1 %40, i32 %42, i32 %.15
  %43 = load i32, ptr @ncol, align 4
  br label %44

44:                                               ; preds = %39, %37
  %.3 = phi i32 [ %.4, %39 ], [ %.26, %37 ]
  %.23 = phi i32 [ %43, %39 ], [ %38, %37 ]
  %.2 = phi ptr [ %.1, %39 ], [ %20, %37 ]
