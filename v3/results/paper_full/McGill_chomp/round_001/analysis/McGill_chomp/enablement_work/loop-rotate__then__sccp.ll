...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %1
  %.01.lcssa = phi ptr [ %split, %..loopexit_crit_edge ], [ null, %1 ]
  br label %13
...
8:                                                ; preds = %0
  ...
  br i1 %15, label %.lr.ph7, label %27

.lr.ph7:                                          ; preds = %8
  br label %16

16:                                               ; preds = %.lr.ph7, %25
  %.015 = phi i32 [ 0, %.lr.ph7 ], [ %.1, %25 ]
  %.024 = phi ptr [ %14, %.lr.ph7 ], [ %18, %25 ]
  %17 = call ptr @where(ptr noundef %.024, ptr noundef %11)
  %18 = call ptr @get_good_move(ptr noundef %17)
  %19 = icmp ne ptr %18, null
  br i1 %19, label %20, label %25

20:                                               ; preds = %16
  call void @get_real_move(ptr noundef %18, ptr noundef %.024, ptr noundef %1, ptr noundef %2)
  %21 = load i32, ptr %1, align 4
  %22 = load i32, ptr %2, align 4
  %23 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.015, i32 noundef %21, i32 noundef %22)
  %24 = sub nuw nsw i32 1, %.015
  call void @free(ptr noundef %.024)
  br label %25

25:                                               ; preds = %20, %16
  %.1 = phi i32 [ %24, %20 ], [ %.015, %16 ]
  %26 = icmp ne ptr %18, null
  br i1 %26, label %16, label %._crit_edge8, !llvm.loop !29

._crit_edge8:                                     ; preds = %25
  %split = phi i32 [ %.1, %25 ]
  br label %27

27:                                               ; preds = %._crit_edge8, %8
  %.01.lcssa = phi i32 [ %split, %._crit_edge8 ], [ 0, %8 ]
