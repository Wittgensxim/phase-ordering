...
4:                                                ; preds = %.lr.ph, %10
  %.05 = phi i32 [ 0, %.lr.ph ], [ %11, %10 ]
  %.014 = phi i32 [ %2, %.lr.ph ], [ %7, %10 ]
  %5 = zext nneg i32 %.05 to i64
  %6 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %5
  %7 = load i32, ptr %6, align 4
  %8 = icmp sgt i32 %7, %.014
  br i1 %8, label %9, label %10

9:                                                ; preds = %4
  %.0.lcssa1 = phi i32 [ %.05, %4 ]
  br label %13
...
10:                                               ; preds = %4
  ...
  br i1 %.not, label %..loopexit_crit_edge, label %4, !llvm.loop !12
...
define dso_local void @show_data(ptr noundef %0) #0 {
  %2 = load i32, ptr @ncol, align 4
  %.not2 = icmp eq i32 0, %2
  br i1 %.not2, label %14, label %.lr.ph

.lr.ph:                                           ; preds = %1
  br label %3

3:                                                ; preds = %.lr.ph, %12
  %.03 = phi i32 [ 0, %.lr.ph ], [ %4, %12 ]
...
12:                                               ; preds = %10, %3
  ...
  br i1 %.not, label %._crit_edge, label %3, !llvm.loop !14
...
define dso_local i32 @in_wanted(ptr noundef %0) #0 {
  %.014 = load ptr, ptr @wanted, align 8
  %.not5 = icmp eq ptr %.014, null
...
2:                                                ; preds = %.lr.ph, %6
  %.016 = phi ptr [ %.014, %.lr.ph ], [ %.01, %6 ]
  %3 = load ptr, ptr %.016, align 8
  %4 = call i32 @equal_data(ptr noundef %3, ptr noundef %0)
  %.not1 = icmp eq i32 %4, 0
  br i1 %.not1, label %6, label %5

5:                                                ; preds = %2
  %.01.lcssa2 = phi ptr [ %.016, %2 ]
  br label %8
...
6:                                                ; preds = %2
  ...
  br i1 %.not, label %..loopexit_crit_edge, label %2, !llvm.loop !17
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %1
  %.01.lcssa = phi ptr [ %split, %..loopexit_crit_edge ], [ %.014, %1 ]
  br label %8

8:                                                ; preds = %.loopexit, %5
  %.013 = phi ptr [ %.01.lcssa, %.loopexit ], [ %.01.lcssa2, %5 ]
  %9 = icmp eq ptr %.013, null
...
13:                                               ; preds = %._crit_edge, %2
  ...
  %14 = load i32, ptr @ncol, align 4
  %.not14 = icmp eq i32 %.0.lcssa, %14
  br i1 %.not14, label %21, label %.lr.ph7

.lr.ph7:                                          ; preds = %13
  br label %15

15:                                               ; preds = %.lr.ph7, %18
  %.15 = phi i32 [ %.0.lcssa, %.lr.ph7 ], [ %19, %18 ]
...
18:                                               ; preds = %15
  ...
  br i1 %.not1, label %._crit_edge8, label %15, !llvm.loop !19

._crit_edge8:                                     ; preds = %18
  br label %21

21:                                               ; preds = %._crit_edge8, %13
  ret ptr %6
}
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %.not11 = icmp eq i32 0, %6
  br i1 %.not11, label %53, label %.lr.ph15

.lr.ph15:                                         ; preds = %3
  br label %7

7:                                                ; preds = %.lr.ph15, %50
  %.013 = phi ptr [ %4, %.lr.ph15 ], [ %.1.lcssa, %50 ]
  %.0412 = phi i32 [ 0, %.lr.ph15 ], [ %51, %50 ]
  %8 = load i32, ptr @ncol, align 4
  %.not26 = icmp eq i32 0, %8
  br i1 %.not26, label %49, label %.lr.ph

.lr.ph:                                           ; preds = %7
  br label %9

9:                                                ; preds = %.lr.ph, %47
  %.19 = phi ptr [ %.013, %.lr.ph ], [ %.2, %47 ]
  %.018 = phi i32 [ 0, %.lr.ph ], [ %.23, %47 ]
  %.157 = phi i32 [ %.0412, %.lr.ph ], [ %.3, %47 ]
  %10 = call ptr @make_data(i32 noundef %.157, i32 noundef %.018)
  call void @melt_data(ptr noundef %10, ptr noundef %0)
  %11 = call i32 @equal_data(ptr noundef %10, ptr noundef %0)
  %.not3 = icmp eq i32 %11, 0
  br i1 %.not3, label %12, label %39
...
37:                                               ; preds = %36, %26, %24
  %.26 = phi i32 [ %.157, %24 ], [ %33, %36 ], [ %.157, %26 ]
  %.12 = phi i32 [ %.018, %24 ], [ %31, %36 ], [ %.018, %26 ]
  %38 = add nsw i32 %.12, 1
  br label %46

39:                                               ; preds = %9
  %40 = icmp eq i32 %.018, 0
...
46:                                               ; preds = %44, %37
  ...
  %.2 = phi ptr [ %.19, %44 ], [ %19, %37 ]
  call void @free(ptr noundef %10) #5
  br label %47

47:                                               ; preds = %46
  %48 = load i32, ptr @ncol, align 4
  %.not2 = icmp eq i32 %.23, %48
  br i1 %.not2, label %._crit_edge, label %9, !llvm.loop !20

._crit_edge:                                      ; preds = %47
  %split = phi i32 [ %.3, %47 ]
  %split10 = phi ptr [ %.2, %47 ]
  br label %49

49:                                               ; preds = %._crit_edge, %7
  %.15.lcssa = phi i32 [ %split, %._crit_edge ], [ %.0412, %7 ]
  %.1.lcssa = phi ptr [ %split10, %._crit_edge ], [ %.013, %7 ]
  br label %50
...
50:                                               ; preds = %49
  ...
  br i1 %.not, label %._crit_edge16, label %7, !llvm.loop !21

._crit_edge16:                                    ; preds = %50
  br label %53

53:                                               ; preds = %._crit_edge16, %3
  %54 = load ptr, ptr %5, align 8
  call void @free(ptr noundef %4) #5
  %.not1 = icmp eq ptr %54, null
  br i1 %.not1, label %58, label %55
...
define dso_local ptr @make_play(i32 noundef %0) #0 {
  ...
  br i1 %.not2, label %38, label %.lr.ph

.lr.ph:                                           ; preds = %1
  br label %9

9:                                                ; preds = %.lr.ph, %36
  %.04 = phi ptr [ %5, %.lr.ph ], [ %.1, %36 ]
  %.013 = phi ptr [ %4, %.lr.ph ], [ %.12, %36 ]
  %10 = call i32 @valid_data(ptr noundef %.04)
  %.not1 = icmp eq i32 %10, 0
  br i1 %.not1, label %36, label %11
...
35:                                               ; preds = %31, %17
  %.2 = phi ptr [ %34, %31 ], [ %.04, %17 ]
  br label %36

36:                                               ; preds = %35, %9
  %.12 = phi ptr [ %28, %35 ], [ %.013, %9 ]
  %.1 = phi ptr [ %.2, %35 ], [ %.04, %9 ]
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  %.not8 = icmp eq i32 0, %4
  br i1 %.not8, label %33, label %.lr.ph12

.lr.ph12:                                         ; preds = %1
  br label %5

5:                                                ; preds = %.lr.ph12, %30
  %.010 = phi ptr [ %2, %.lr.ph12 ], [ %.1.lcssa, %30 ]
  %.019 = phi i32 [ 0, %.lr.ph12 ], [ %31, %30 ]
  %6 = load i32, ptr @ncol, align 4
  %.not13 = icmp eq i32 0, %6
  br i1 %.not13, label %29, label %.lr.ph

.lr.ph:                                           ; preds = %5
  br label %7

7:                                                ; preds = %.lr.ph, %27
  %.16 = phi ptr [ %.010, %.lr.ph ], [ %.2, %27 ]
  %.125 = phi i32 [ %.019, %.lr.ph ], [ %.23, %27 ]
  %.044 = phi i32 [ 0, %.lr.ph ], [ %.15, %27 ]
  %8 = call ptr @make_data(i32 noundef %.125, i32 noundef %.044)
...
10:                                               ; preds = %7
  ...
  %12 = getelementptr inbounds nuw i8, ptr %.16, i64 8
...
24:                                               ; preds = %21, %19
  %.3 = phi i32 [ %23, %21 ], [ %.125, %19 ]
  %25 = load i32, ptr @ncol, align 4
  br label %26

26:                                               ; preds = %24, %10
  %.15 = phi i32 [ %25, %24 ], [ %18, %10 ]
  %.23 = phi i32 [ %.3, %24 ], [ %.125, %10 ]
  %.2 = phi ptr [ %.16, %24 ], [ %17, %10 ]
  call void @free(ptr noundef %8) #5
  br label %27

27:                                               ; preds = %26
  %28 = load i32, ptr @ncol, align 4
  %.not1 = icmp eq i32 %.15, %28
  br i1 %.not1, label %._crit_edge, label %7, !llvm.loop !23
...
29:                                               ; preds = %._crit_edge, %5
  %.12.lcssa = phi i32 [ %split, %._crit_edge ], [ %.019, %5 ]
  %.1.lcssa = phi ptr [ %split7, %._crit_edge ], [ %.010, %5 ]
  br label %30
...
30:                                               ; preds = %29
  ...
  br i1 %.not, label %._crit_edge13, label %5, !llvm.loop !24

._crit_edge13:                                    ; preds = %30
  br label %33

33:                                               ; preds = %._crit_edge13, %1
...
16:                                               ; preds = %12
  %.01.lcssa = phi ptr [ %.01, %12 ]
  %17 = load ptr, ptr %.01.lcssa, align 8
...
4:                                                ; preds = %0
  br i1 false, label %.lr.ph11, label %7
...
6:                                                ; preds = %5
  br i1 false, label %5, label %._crit_edge12, !llvm.loop !29
...
8:                                                ; preds = %0
  ...
  br i1 %.not4, label %24, label %.lr.ph8

.lr.ph8:                                          ; preds = %8
  br label %15

15:                                               ; preds = %.lr.ph8, %23
  %.016 = phi i32 [ 0, %.lr.ph8 ], [ %.1, %23 ]
  %.025 = phi ptr [ %14, %.lr.ph8 ], [ %17, %23 ]
  %16 = call ptr @where(ptr noundef nonnull %.025, ptr noundef %11)
  %17 = call ptr @get_good_move(ptr noundef %16)
  %.not3 = icmp eq ptr %17, null
  br i1 %.not3, label %23, label %18

18:                                               ; preds = %15
  call void @get_real_move(ptr noundef nonnull %17, ptr noundef nonnull %.025, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %19 = load i32, ptr %1, align 4
  %20 = load i32, ptr %2, align 4
  %21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %.016, i32 noundef %19, i32 noundef %20) #5
  %22 = sub nsw i32 1, %.016
  call void @free(ptr noundef nonnull %.025) #5
  br label %23

23:                                               ; preds = %18, %15
  %.1 = phi i32 [ %22, %18 ], [ %.016, %15 ]
  %.not = icmp eq ptr %17, null
  br i1 %.not, label %._crit_edge9, label %15, !llvm.loop !30

._crit_edge9:                                     ; preds = %23
  %split = phi i32 [ %.1, %23 ]
  br label %24

24:                                               ; preds = %._crit_edge9, %8
  %.01.lcssa = phi i32 [ %split, %._crit_edge9 ], [ 0, %8 ]
  call void @dump_play(ptr noundef %11)
  %25 = sub nsw i32 1, %.01.lcssa
  %26 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.16, i32 noundef %25) #5
  br label %32

27:                                               ; preds = %0
  br i1 false, label %.lr.ph, label %31
...
30:                                               ; preds = %29, %28
  br i1 false, label %28, label %._crit_edge, !llvm.loop !31
