...
11:                                               ; preds = %5
  ...
  br i1 %14, label %5, label %..loopexit_crit_edge, !llvm.loop !12

..loopexit_crit_edge:                             ; preds = %11
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %1
  %.0.lcssa = phi i32 [ %12, %..loopexit_crit_edge ], [ 0, %1 ]
  br label %15
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %1
  %.01.lcssa = phi ptr [ %11, %..loopexit_crit_edge ], [ %2, %1 ]
  br label %13

13:                                               ; preds = %.loopexit, %8
  %.012 = phi ptr [ %.01.lcssa, %.loopexit ], [ %.013, %8 ]
...
15:                                               ; preds = %._crit_edge, %2
  %.0.lcssa = phi i32 [ %13, %._crit_edge ], [ 0, %2 ]
  %16 = load i32, ptr @ncol, align 4
...
8:                                                ; preds = %0
  ...
  br i1 %17, label %.lr.ph10, label %38

.lr.ph10:                                         ; preds = %8
  br label %18

18:                                               ; preds = %.lr.ph10, %33
  %19 = phi i32 [ %15, %.lr.ph10 ], [ %35, %33 ]
...
33:                                               ; preds = %18
  ...
  br i1 %37, label %18, label %._crit_edge11, !llvm.loop !29

._crit_edge11:                                    ; preds = %33
  br label %38

38:                                               ; preds = %._crit_edge11, %8
  br label %79
...
39:                                               ; preds = %0
  ...
  br i1 %46, label %.lr.ph7, label %57

.lr.ph7:                                          ; preds = %39
  br label %47

47:                                               ; preds = %.lr.ph7, %56
  %.015 = phi i32 [ 0, %.lr.ph7 ], [ %.1, %56 ]
  %.024 = phi ptr [ %45, %.lr.ph7 ], [ %49, %56 ]
  %48 = call ptr @where(ptr noundef %.024, ptr noundef %42)
  %49 = call ptr @get_good_move(ptr noundef %48)
  %50 = icmp ne ptr %49, null
  br i1 %50, label %51, label %56

51:                                               ; preds = %47
  call void @get_real_move(ptr noundef %49, ptr noundef %.024, ptr noundef %1, ptr noundef %2)
  %52 = load i32, ptr %1, align 4
  %53 = load i32, ptr %2, align 4
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.015, i32 noundef %52, i32 noundef %53)
  %55 = sub nsw i32 1, %.015
  call void @free(ptr noundef %.024)
  br label %56

56:                                               ; preds = %51, %47
  %.1 = phi i32 [ %55, %51 ], [ %.015, %47 ]
  br i1 %50, label %47, label %._crit_edge8, !llvm.loop !30

._crit_edge8:                                     ; preds = %56
  br label %57

57:                                               ; preds = %._crit_edge8, %39
  %.01.lcssa = phi i32 [ %.1, %._crit_edge8 ], [ 0, %39 ]
  call void @dump_play(ptr noundef %42)
  %58 = sub nsw i32 1, %.01.lcssa
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str.16, i32 noundef %58)
  br label %79

60:                                               ; preds = %0
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str.13)
  %62 = call i32 (ptr, ...) @scanf(ptr noundef @.str, ptr noundef @ncol)
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str.14)
  %64 = call i32 (ptr, ...) @scanf(ptr noundef @.str, ptr noundef @nrow)
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str.17)
  %66 = call ptr @make_play(i32 noundef 1)
  %67 = icmp ne ptr %66, null
  br i1 %67, label %.lr.ph, label %78

.lr.ph:                                           ; preds = %60
  br label %68

68:                                               ; preds = %.lr.ph, %74
  %.03 = phi ptr [ %66, %.lr.ph ], [ %76, %74 ]
  %69 = load i32, ptr %.03, align 8
  %70 = icmp eq i32 %69, 0
  br i1 %70, label %71, label %74

71:                                               ; preds = %68
  %72 = getelementptr inbounds nuw %struct._play, ptr %.03, i32 0, i32 1
  %73 = load ptr, ptr %72, align 8
  call void @show_move(ptr noundef %73)
  br label %74

74:                                               ; preds = %71, %68
  %75 = getelementptr inbounds nuw %struct._play, ptr %.03, i32 0, i32 3
  %76 = load ptr, ptr %75, align 8
  %77 = icmp ne ptr %76, null
  br i1 %77, label %68, label %._crit_edge, !llvm.loop !31

._crit_edge:                                      ; preds = %74
  br label %78

78:                                               ; preds = %._crit_edge, %60
  call void @dump_play(ptr noundef %66)
  br label %79
