...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %1
  %.0.lcssa = phi i32 [ %3, %..loopexit_crit_edge ], [ 0, %1 ]
  br label %14

14:                                               ; preds = %.loopexit, %10
  %.02 = phi i32 [ %.0.lcssa, %.loopexit ], [ %.04, %10 ]
  %15 = icmp eq i32 %.02, %3
...
13:                                               ; preds = %.loopexit, %8
  %.012 = phi ptr [ null, %.loopexit ], [ %.013, %8 ]
...
8:                                                ; preds = %.lr.ph, %8
  %.01 = phi i32 [ 0, %.lr.ph ], [ %11, %8 ]
  %9 = sext i32 %.01 to i64
  %10 = getelementptr inbounds i32, ptr %6, i64 %9
  store i32 %.pre, ptr %10, align 4
  %11 = add nsw i32 %.01, 1
  %12 = icmp ne i32 %11, %1
  br i1 %12, label %8, label %._crit_edge, !llvm.loop !18

._crit_edge:                                      ; preds = %8
  br label %13

13:                                               ; preds = %._crit_edge, %2
  %.0.lcssa = phi i32 [ %1, %._crit_edge ], [ 0, %2 ]
  %14 = load i32, ptr @ncol, align 4
  %15 = icmp ne i32 %.0.lcssa, %14
  br i1 %15, label %.lr.ph4, label %22

.lr.ph4:                                          ; preds = %13
  br label %16

16:                                               ; preds = %.lr.ph4, %16
  %.12 = phi i32 [ %.0.lcssa, %.lr.ph4 ], [ %19, %16 ]
  ...
  br i1 %21, label %16, label %._crit_edge5, !llvm.loop !19

._crit_edge5:                                     ; preds = %16
  br label %22

22:                                               ; preds = %._crit_edge5, %13
  ret ptr %6
}
...
8:                                                ; preds = %.lr.ph8, %56
  %9 = phi i32 [ %6, %.lr.ph8 ], [ %57, %56 ]
  %10 = phi i32 [ %.pre, %.lr.ph8 ], [ %58, %56 ]
  %.06 = phi ptr [ %4, %.lr.ph8 ], [ %.1.lcssa, %56 ]
  %.045 = phi i32 [ 0, %.lr.ph8 ], [ %59, %56 ]
  %11 = icmp ne i32 0, %10
...
12:                                               ; preds = %.lr.ph, %52
  ...
  %13 = call ptr @make_data(i32 noundef %.151, i32 noundef %.012)
...
16:                                               ; preds = %12
  ...
  %18 = getelementptr inbounds nuw %struct._list, ptr %.13, i32 0, i32 1
...
43:                                               ; preds = %42, %32, %28
  %.26 = phi i32 [ %.151, %28 ], [ %38, %42 ], [ %.151, %32 ]
  %.12 = phi i32 [ %.012, %28 ], [ %36, %42 ], [ %.012, %32 ]
  br label %52

44:                                               ; preds = %12
  %45 = icmp eq i32 %.012, 0
...
49:                                               ; preds = %46, %44
  %.4 = phi i32 [ %48, %46 ], [ %.151, %44 ]
  %50 = load i32, ptr @ncol, align 4
  %51 = sub nsw i32 %50, 1
  br label %52

52:                                               ; preds = %49, %43
  %.3 = phi i32 [ %.4, %49 ], [ %.26, %43 ]
  %.23 = phi i32 [ %51, %49 ], [ %.12, %43 ]
  %.2 = phi ptr [ %.13, %49 ], [ %23, %43 ]
  call void @free(ptr noundef %13)
  %53 = add nsw i32 %.23, 1
  %54 = load i32, ptr @ncol, align 4
  %55 = icmp ne i32 %53, %54
  br i1 %55, label %12, label %._crit_edge, !llvm.loop !20
...
56:                                               ; preds = %._crit_edge, %8
  %57 = phi i32 [ %.pre10, %._crit_edge ], [ %9, %8 ]
  %58 = phi i32 [ %53, %._crit_edge ], [ 0, %8 ]
  %.15.lcssa = phi i32 [ %.3, %._crit_edge ], [ %.045, %8 ]
  %.1.lcssa = phi ptr [ %.2, %._crit_edge ], [ %.06, %8 ]
  %59 = add nsw i32 %.15.lcssa, 1
...
61:                                               ; preds = %._crit_edge9, %3
  %62 = phi ptr [ %.pre11, %._crit_edge9 ], [ null, %3 ]
...
6:                                                ; preds = %.lr.ph8, %34
  %7 = phi i32 [ %4, %.lr.ph8 ], [ %35, %34 ]
  %8 = phi i32 [ %.pre, %.lr.ph8 ], [ %36, %34 ]
  %.06 = phi ptr [ %2, %.lr.ph8 ], [ %.1.lcssa, %34 ]
  %.015 = phi i32 [ 0, %.lr.ph8 ], [ %37, %34 ]
  %9 = icmp ne i32 0, %8
...
10:                                               ; preds = %.lr.ph, %30
  ...
  %11 = call ptr @make_data(i32 noundef %.122, i32 noundef %.041)
...
27:                                               ; preds = %24, %22
  %.3 = phi i32 [ %26, %24 ], [ %.122, %22 ]
  %28 = load i32, ptr @ncol, align 4
  %29 = sub nsw i32 %28, 1
  br label %30

30:                                               ; preds = %27, %14
  %.15 = phi i32 [ %29, %27 ], [ %.041, %14 ]
  %.23 = phi i32 [ %.3, %27 ], [ %.122, %14 ]
  %.2 = phi ptr [ %.13, %27 ], [ %21, %14 ]
  call void @free(ptr noundef %11)
  %31 = add nsw i32 %.15, 1
  %32 = load i32, ptr @ncol, align 4
  %33 = icmp ne i32 %31, %32
  br i1 %33, label %10, label %._crit_edge, !llvm.loop !23
...
34:                                               ; preds = %._crit_edge, %6
  %35 = phi i32 [ %.pre10, %._crit_edge ], [ %7, %6 ]
  %36 = phi i32 [ %31, %._crit_edge ], [ 0, %6 ]
  %.12.lcssa = phi i32 [ %.23, %._crit_edge ], [ %.015, %6 ]
  %.1.lcssa = phi ptr [ %.2, %._crit_edge ], [ %.06, %6 ]
  %37 = add nsw i32 %.12.lcssa, 1
...
39:                                               ; preds = %._crit_edge9, %1
  %40 = phi ptr [ %.pre11, %._crit_edge9 ], [ null, %1 ]
...
8:                                                ; preds = %0
  ...
  br i1 %17, label %.lr.ph10, label %37

.lr.ph10:                                         ; preds = %8
  br label %18

18:                                               ; preds = %.lr.ph10, %18
  %19 = phi i32 [ %15, %.lr.ph10 ], [ %34, %18 ]
  %20 = load i32, ptr @ncol, align 4
  ...
  br i1 %36, label %18, label %._crit_edge11, !llvm.loop !29

._crit_edge11:                                    ; preds = %18
  br label %37

37:                                               ; preds = %._crit_edge11, %8
  br label %78
...
38:                                               ; preds = %0
  ...
  %41 = call ptr @make_play(i32 noundef 1)
  %42 = load i32, ptr @nrow, align 4
  %43 = load i32, ptr @ncol, align 4
  %44 = call ptr @make_data(i32 noundef %42, i32 noundef %43)
  %45 = icmp ne ptr %44, null
  br i1 %45, label %.lr.ph7, label %56

.lr.ph7:                                          ; preds = %38
  br label %46

46:                                               ; preds = %.lr.ph7, %55
  %.015 = phi i32 [ 0, %.lr.ph7 ], [ %.1, %55 ]
  %.024 = phi ptr [ %44, %.lr.ph7 ], [ %48, %55 ]
  %47 = call ptr @where(ptr noundef %.024, ptr noundef %41)
  %48 = call ptr @get_good_move(ptr noundef %47)
  %49 = icmp ne ptr %48, null
  br i1 %49, label %50, label %55

50:                                               ; preds = %46
  call void @get_real_move(ptr noundef %48, ptr noundef %.024, ptr noundef %1, ptr noundef %2)
  %51 = load i32, ptr %1, align 4
  %52 = load i32, ptr %2, align 4
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.015, i32 noundef %51, i32 noundef %52)
  %54 = sub nsw i32 1, %.015
  call void @free(ptr noundef %.024)
  br label %55

55:                                               ; preds = %50, %46
  %.1 = phi i32 [ %54, %50 ], [ %.015, %46 ]
  br i1 %49, label %46, label %._crit_edge8, !llvm.loop !30

._crit_edge8:                                     ; preds = %55
  br label %56

56:                                               ; preds = %._crit_edge8, %38
  %.01.lcssa = phi i32 [ %.1, %._crit_edge8 ], [ 0, %38 ]
