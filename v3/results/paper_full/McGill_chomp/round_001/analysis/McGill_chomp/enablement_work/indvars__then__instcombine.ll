...
8:                                                ; preds = %9, %1
  %indvars.iv = phi i64 [ %indvars.iv.next, %9 ], [ %7, %1 ]
...
6:                                                ; preds = %5
  %7 = getelementptr inbounds [4 x i8], ptr %0, i64 %indvars.iv.next
  %8 = load i32, ptr %7, align 4
  %9 = getelementptr inbounds [4 x i8], ptr %1, i64 %indvars.iv.next
  %10 = load i32, ptr %9, align 4
...
12:                                               ; preds = %.loopexit, %10
  %.02 = trunc i64 %indvars.iv to i32
  %13 = load i32, ptr @ncol, align 4
  %14 = icmp eq i32 %13, %.02
...
14:                                               ; preds = %19, %13
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %19 ], [ %indvars.iv, %13 ]
  %15 = load i32, ptr @ncol, align 4
  %16 = zext i32 %15 to i64
  %.not5 = icmp eq i64 %indvars.iv2, %16
  br i1 %.not5, label %20, label %17

17:                                               ; preds = %14
  %18 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %indvars.iv2
