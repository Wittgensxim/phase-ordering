...
define dso_local i32 @main() #0 {
  ...
  %puts5 = call i32 @puts(ptr nonnull dereferenceable(1) @str.4)
  %puts6 = call i32 @puts(ptr nonnull dereferenceable(1) @str.5)
  %3 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8) #5
  store i32 2, ptr %1, align 4
  br label %4

4:                                                ; preds = %0
  %5 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.13) #5
  store i32 7, ptr @ncol, align 4
  %6 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.14) #5
  store i32 8, ptr @nrow, align 4
  %7 = call ptr @make_play(i32 noundef 1)
  %8 = load i32, ptr @nrow, align 4
  %9 = load i32, ptr @ncol, align 4
  %10 = call ptr @make_data(i32 noundef %8, i32 noundef %9)
  br label %11

11:                                               ; preds = %20, %4
  %.02 = phi ptr [ %10, %4 ], [ %14, %20 ]
  %.01 = phi i32 [ 0, %4 ], [ %.1, %20 ]
  %.not = icmp eq ptr %.02, null
  br i1 %.not, label %21, label %12

12:                                               ; preds = %11
  %13 = call ptr @where(ptr noundef nonnull %.02, ptr noundef %7)
  %14 = call ptr @get_good_move(ptr noundef %13)
  %.not7 = icmp eq ptr %14, null
  br i1 %.not7, label %20, label %15

15:                                               ; preds = %12
  call void @get_real_move(ptr noundef nonnull %14, ptr noundef nonnull %.02, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %16 = load i32, ptr %1, align 4
  %17 = load i32, ptr %2, align 4
  %18 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %.01, i32 noundef %16, i32 noundef %17) #5
  %19 = xor i32 %.01, 1
  call void @free(ptr noundef nonnull %.02) #5
  br label %20

20:                                               ; preds = %15, %12
  %.1 = phi i32 [ %19, %15 ], [ %.01, %12 ]
  br label %11, !llvm.loop !29

21:                                               ; preds = %11
  call void @dump_play(ptr noundef %7)
  %22 = xor i32 %.01, 1
  %23 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.16, i32 noundef %22) #5
  br label %24
