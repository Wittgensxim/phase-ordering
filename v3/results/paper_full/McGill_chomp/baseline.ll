...
define dso_local range(i32 0, 2) i32 @next_data(ptr noundef %0) #0 {
  %2 = load i32, ptr @ncol, align 4
  %.not5 = icmp eq i32 0, %2
  %spec.select6 = select i1 %.not5, i1 false, i1 true
  br i1 %spec.select6, label %.lr.ph, label %15

.lr.ph:                                           ; preds = %1
  br label %3

3:                                                ; preds = %.lr.ph, %13
  %.08 = phi i32 [ 0, %.lr.ph ], [ %.1, %13 ]
  %.017 = phi i32 [ 0, %.lr.ph ], [ %.12, %13 ]
  %4 = sext i32 %.017 to i64
...
13:                                               ; preds = %11, %9
  %.12 = phi i32 [ %10, %9 ], [ %.017, %11 ]
  %.1 = phi i32 [ %.08, %9 ], [ 1, %11 ]
  %14 = load i32, ptr @ncol, align 4
  %.not = icmp eq i32 %.12, %14
  %.not3 = icmp eq i32 %.1, 0
  %spec.select = select i1 %.not, i1 false, i1 %.not3
  br i1 %spec.select, label %3, label %._crit_edge, !llvm.loop !9
...
15:                                               ; preds = %._crit_edge, %1
  %.0.lcssa = phi i32 [ %split, %._crit_edge ], [ 0, %1 ]
  ret i32 %.0.lcssa
}
...
define dso_local void @melt_data(ptr noundef %0, ptr noundef %1) #0 {
  ...
  br i1 %.not2, label %16, label %.lr.ph
...
define dso_local range(i32 0, 2) i32 @valid_data(ptr noundef %0) #0 {
  ...
  %.not2 = icmp eq i32 0, %.pre
  br i1 %.not2, label %9, label %.lr.ph
...
2:                                                ; preds = %3
  ...
  br i1 %.not, label %._crit_edge6, label %3, !llvm.loop !12

3:                                                ; preds = %.lr.ph, %2
  %.not5 = phi i1 [ %.not2, %.lr.ph ], [ %.not, %2 ]
  %.04 = phi i32 [ 0, %.lr.ph ], [ %.0, %2 ]
  %.01.in3 = phi ptr [ @nrow, %.lr.ph ], [ %.01.in, %2 ]
  %.01 = load i32, ptr %.01.in3, align 4
...
9:                                                ; preds = %._crit_edge6, %._crit_edge, %1
  %.not.lcssa = phi i1 [ %split, %._crit_edge ], [ %split7, %._crit_edge6 ], [ %.not2, %1 ]
  %10 = zext i1 %.not.lcssa to i32
  ret i32 %10
}
...
2:                                                ; preds = %.lr.ph, %11
  %.05 = phi i32 [ 0, %.lr.ph ], [ %3, %11 ]
  %3 = add nuw nsw i32 %.05, 1
...
define dso_local void @show_play(ptr noundef %0) #0 {
  ...
  br i1 %.not2, label %11, label %.lr.ph

.lr.ph:                                           ; preds = %1
  br label %2

2:                                                ; preds = %.lr.ph, %2
  %.03 = phi ptr [ %0, %.lr.ph ], [ %10, %2 ]
  %puts = call i32 @puts(ptr nonnull dereferenceable(1) @str.1)
  %3 = getelementptr inbounds nuw i8, ptr %.03, i64 8
  %4 = load ptr, ptr %3, align 8
  call void @show_data(ptr noundef %4)
  %5 = load i32, ptr %.03, align 8
  ...
  %7 = getelementptr inbounds nuw i8, ptr %.03, i64 16
  %8 = load ptr, ptr %7, align 8
  call void @show_list(ptr noundef %8)
  %9 = getelementptr inbounds nuw i8, ptr %.03, i64 24
...
define dso_local range(i32 0, 2) i32 @in_wanted(ptr noundef %0) #0 {
  %.013 = load ptr, ptr @wanted, align 8
  %magicptr4 = ptrtoint ptr %.013 to i64
  %cond5 = icmp eq i64 %magicptr4, 0
...
define dso_local ptr @make_data(i32 noundef %0, i32 noundef %1) #0 {
  ...
  br i1 %.not3, label %.preheader, label %.lr.ph
...
.preheader:                                       ; preds = %..preheader_crit_edge, %2
  ...
  %.not15 = icmp eq i32 %1, %7
  br i1 %.not15, label %18, label %.lr.ph7

.lr.ph7:                                          ; preds = %.preheader
  br label %13

8:                                                ; preds = %.lr.ph, %8
  %.04 = phi i32 [ 0, %.lr.ph ], [ %12, %8 ]
  %9 = load i32, ptr @nrow, align 4
  %10 = zext nneg i32 %.04 to i64
...
13:                                               ; preds = %.lr.ph7, %13
  %.16 = phi i32 [ %1, %.lr.ph7 ], [ %16, %13 ]
  %14 = zext nneg i32 %.16 to i64
  %15 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %14
  store i32 %0, ptr %15, align 4
  %16 = add nuw nsw i32 %.16, 1
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %.not18 = icmp eq i32 0, %6
  br i1 %.not18, label %47, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %3
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %44
  %.020 = phi ptr [ %4, %.preheader.lr.ph ], [ %.1.lcssa, %44 ]
  %.0419 = phi i32 [ 0, %.preheader.lr.ph ], [ %45, %44 ]
  %7 = load i32, ptr @ncol, align 4
  %.not813 = icmp eq i32 0, %7
  br i1 %.not813, label %44, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %8

8:                                                ; preds = %.lr.ph, %42
  %.116 = phi ptr [ %.020, %.lr.ph ], [ %.2, %42 ]
  %.0115 = phi i32 [ 0, %.lr.ph ], [ %.23, %42 ]
  %.1514 = phi i32 [ %.0419, %.lr.ph ], [ %.3, %42 ]
  %9 = call ptr @make_data(i32 noundef %.1514, i32 noundef %.0115)
  call void @melt_data(ptr noundef %9, ptr noundef %0)
  %10 = call i32 @equal_data(ptr noundef %9, ptr noundef %0)
  %.not9 = icmp eq i32 %10, 0
  br i1 %.not9, label %11, label %37

11:                                               ; preds = %8
  %12 = call dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #4
  %13 = getelementptr inbounds nuw i8, ptr %.116, i64 8
...
35:                                               ; preds = %28, %34, %26, %23
  %.26 = phi i32 [ %.1514, %23 ], [ %.1514, %26 ], [ %32, %34 ], [ %32, %28 ]
  %.12 = phi i32 [ %.0115, %23 ], [ %.0115, %26 ], [ %30, %34 ], [ %30, %28 ]
  %36 = add nsw i32 %.12, 1
  br label %42

37:                                               ; preds = %8
  %38 = icmp eq i32 %.0115, 0
  %39 = load i32, ptr @nrow, align 4
  %40 = add nsw i32 %39, -1
  %.4 = select i1 %38, i32 %40, i32 %.1514
  %41 = load i32, ptr @ncol, align 4
  br label %42

42:                                               ; preds = %37, %35
  %.3 = phi i32 [ %.4, %37 ], [ %.26, %35 ]
  %.23 = phi i32 [ %41, %37 ], [ %36, %35 ]
  %.2 = phi ptr [ %.116, %37 ], [ %18, %35 ]
  call void @free(ptr noundef %9) #5
  %43 = load i32, ptr @ncol, align 4
  %.not8 = icmp eq i32 %.23, %43
  br i1 %.not8, label %._crit_edge, label %8, !llvm.loop !20

._crit_edge:                                      ; preds = %42
  %split = phi i32 [ %.3, %42 ]
  %split17 = phi ptr [ %.2, %42 ]
  br label %44

44:                                               ; preds = %._crit_edge, %.preheader
  %.15.lcssa = phi i32 [ %split, %._crit_edge ], [ %.0419, %.preheader ]
  %.1.lcssa = phi ptr [ %split17, %._crit_edge ], [ %.020, %.preheader ]
  %45 = add nsw i32 %.15.lcssa, 1
  %46 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %45, %46
  br i1 %.not, label %._crit_edge21, label %.preheader, !llvm.loop !21

._crit_edge21:                                    ; preds = %44
  br label %47

47:                                               ; preds = %._crit_edge21, %3
  %48 = load ptr, ptr %5, align 8
  call void @free(ptr noundef %4) #5
  %.not7 = icmp eq ptr %48, null
  br i1 %.not7, label %52, label %49
...
define dso_local ptr @make_play(i32 noundef %0) #0 {
  ...
  br i1 %.not4, label %37, label %.lr.ph

.lr.ph:                                           ; preds = %1
  br label %9

9:                                                ; preds = %.lr.ph, %35
  %.06 = phi ptr [ %5, %.lr.ph ], [ %.1, %35 ]
  %.015 = phi ptr [ %4, %.lr.ph ], [ %.12, %35 ]
  %10 = call i32 @valid_data(ptr noundef %.06)
  %.not3 = icmp eq i32 %10, 0
  br i1 %.not3, label %35, label %11
...
17:                                               ; preds = %16, %11
  %18 = call ptr @copy_data(ptr noundef %.06)
  %19 = load ptr, ptr %13, align 8
  %20 = getelementptr inbounds nuw i8, ptr %19, i64 8
  store ptr %18, ptr %20, align 8
  %21 = call ptr @make_list(ptr noundef %.06, ptr noundef nonnull %3, ptr noundef nonnull %2)
...
35:                                               ; preds = %17, %31, %9
  %.12 = phi ptr [ %.015, %9 ], [ %28, %31 ], [ %28, %17 ]
  %.1 = phi ptr [ %.06, %9 ], [ %34, %31 ], [ %.06, %17 ]
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  %.not13 = icmp eq i32 0, %4
  br i1 %.not13, label %28, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %25
  %.015 = phi ptr [ %2, %.preheader.lr.ph ], [ %.1.lcssa, %25 ]
  %.0114 = phi i32 [ 0, %.preheader.lr.ph ], [ %26, %25 ]
  %5 = load i32, ptr @ncol, align 4
  %.not68 = icmp eq i32 0, %5
  br i1 %.not68, label %25, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  br label %6

6:                                                ; preds = %.lr.ph, %23
  %.111 = phi ptr [ %.015, %.lr.ph ], [ %.2, %23 ]
  %.1210 = phi i32 [ %.0114, %.lr.ph ], [ %.23, %23 ]
  %.049 = phi i32 [ 0, %.lr.ph ], [ %.15, %23 ]
  %7 = call ptr @make_data(i32 noundef %.1210, i32 noundef %.049)
  call void @melt_data(ptr noundef %7, ptr noundef %0)
  %8 = call i32 @equal_data(ptr noundef %7, ptr noundef %0)
  %.not7 = icmp eq i32 %8, 0
  br i1 %.not7, label %9, label %18

9:                                                ; preds = %6
  %10 = call dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #4
  %11 = getelementptr inbounds nuw i8, ptr %.111, i64 8
  ...
  %17 = add nsw i32 %.049, 1
  br label %23

18:                                               ; preds = %6
  %19 = icmp eq i32 %.049, 0
  %20 = load i32, ptr @nrow, align 4
  %21 = add nsw i32 %20, -1
  %.3 = select i1 %19, i32 %21, i32 %.1210
  %22 = load i32, ptr @ncol, align 4
  br label %23

23:                                               ; preds = %18, %9
  %.15 = phi i32 [ %22, %18 ], [ %17, %9 ]
  %.23 = phi i32 [ %.3, %18 ], [ %.1210, %9 ]
  %.2 = phi ptr [ %.111, %18 ], [ %16, %9 ]
  call void @free(ptr noundef %7) #5
  %24 = load i32, ptr @ncol, align 4
  %.not6 = icmp eq i32 %.15, %24
  br i1 %.not6, label %._crit_edge, label %6, !llvm.loop !23

._crit_edge:                                      ; preds = %23
  %split = phi i32 [ %.23, %23 ]
  %split12 = phi ptr [ %.2, %23 ]
  br label %25

25:                                               ; preds = %._crit_edge, %.preheader
  %.12.lcssa = phi i32 [ %split, %._crit_edge ], [ %.0114, %.preheader ]
  %.1.lcssa = phi ptr [ %split12, %._crit_edge ], [ %.015, %.preheader ]
  %26 = add nsw i32 %.12.lcssa, 1
  %27 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %26, %27
  br i1 %.not, label %._crit_edge16, label %.preheader, !llvm.loop !24

._crit_edge16:                                    ; preds = %25
  br label %28

28:                                               ; preds = %._crit_edge16, %1
...
5:                                                ; preds = %.lr.ph, %10
  %6 = phi ptr [ %3, %.lr.ph ], [ %12, %10 ]
  %.014 = phi ptr [ %0, %.lr.ph ], [ %11, %10 ]
...
10:                                               ; preds = %5
  ...
  br i1 %.not, label %..critedge_crit_edge, label %5, !llvm.loop !25

..critedge_crit_edge:                             ; preds = %10
  %split = phi ptr [ %11, %10 ]
  br label %.critedge

..critedge_crit_edge5:                            ; preds = %5
  %split6 = phi ptr [ %.014, %5 ]
  br label %.critedge

.critedge:                                        ; preds = %..critedge_crit_edge5, %..critedge_crit_edge, %.preheader
  %.01.lcssa = phi ptr [ %split, %..critedge_crit_edge ], [ %split6, %..critedge_crit_edge5 ], [ %0, %.preheader ]
  %14 = load ptr, ptr %.01.lcssa, align 8
  %15 = call ptr @copy_data(ptr noundef %14)
  br label %16

16:                                               ; preds = %1, %.critedge
  %.0 = phi ptr [ %15, %.critedge ], [ null, %1 ]
  ret ptr %.0
}
...
define dso_local i32 @main() #0 {
  ...
  br i1 %.not6, label %19, label %.lr.ph

.lr.ph:                                           ; preds = %0
  br label %10

10:                                               ; preds = %.lr.ph, %18
  %.018 = phi i32 [ 0, %.lr.ph ], [ %.1, %18 ]
  %.027 = phi ptr [ %9, %.lr.ph ], [ %12, %18 ]
  %11 = call ptr @where(ptr noundef nonnull %.027, ptr noundef %6)
  %12 = call ptr @get_good_move(ptr noundef %11)
  %.not5 = icmp eq ptr %12, null
  br i1 %.not5, label %18, label %13

13:                                               ; preds = %10
  call void @get_real_move(ptr noundef nonnull %12, ptr noundef nonnull %.027, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %14 = load i32, ptr %1, align 4
  %15 = load i32, ptr %2, align 4
  %16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %.018, i32 noundef %14, i32 noundef %15) #5
  %17 = sub nuw nsw i32 1, %.018
  call void @free(ptr noundef nonnull %.027) #5
  br label %18

18:                                               ; preds = %13, %10
  %.1 = phi i32 [ %17, %13 ], [ %.018, %10 ]
