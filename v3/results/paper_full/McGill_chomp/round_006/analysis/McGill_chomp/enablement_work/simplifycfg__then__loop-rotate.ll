...
._crit_edge:                                      ; preds = %4
  %split = phi i1 [ false, %4 ]
  br label %10

._crit_edge4:                                     ; preds = %3
  %split5 = phi i1 [ true, %3 ]
  br label %10

10:                                               ; preds = %._crit_edge4, %._crit_edge, %1
  %.not.lcssa = phi i1 [ %split, %._crit_edge ], [ %split5, %._crit_edge4 ], [ true, %1 ]
...
3:                                                ; preds = %.lr.ph, %2
  ...
  br i1 %.not, label %2, label %..loopexit_crit_edge4

..loopexit_crit_edge:                             ; preds = %2
  %split = phi i32 [ 0, %2 ]
  br label %.loopexit

..loopexit_crit_edge4:                            ; preds = %3
  %split5 = phi i32 [ 1, %3 ]
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge4, %..loopexit_crit_edge, %1
  %.0 = phi i32 [ %split5, %..loopexit_crit_edge4 ], [ %split, %..loopexit_crit_edge ], [ 0, %1 ]
  ret i32 %.0
}
...
define dso_local ptr @make_data(i32 noundef %0, i32 noundef %1) #0 {
  ...
  br i1 %.not2, label %.preheader.preheader, label %.lr.ph

.lr.ph:                                           ; preds = %2
  br label %8

..preheader.preheader_crit_edge:                  ; preds = %8
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %..preheader.preheader_crit_edge, %2
  %7 = load i32, ptr @ncol, align 4
  %.not14 = icmp eq i32 %1, %7
  br i1 %.not14, label %17, label %.lr.ph6

.lr.ph6:                                          ; preds = %.preheader.preheader
  br label %.preheader
...
8:                                                ; preds = %.lr.ph, %8
  ...
  br i1 %.not, label %..preheader.preheader_crit_edge, label %8, !llvm.loop !18

.preheader:                                       ; preds = %.lr.ph6, %.preheader
  %.15 = phi i32 [ %1, %.lr.ph6 ], [ %15, %.preheader ]
  %13 = zext nneg i32 %.15 to i64
  %14 = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %13
  store i32 %0, ptr %14, align 4
  %15 = add nuw nsw i32 %.15, 1
  %16 = load i32, ptr @ncol, align 4
  %.not1 = icmp eq i32 %15, %16
  br i1 %.not1, label %.preheader._crit_edge, label %.preheader, !llvm.loop !19

.preheader._crit_edge:                            ; preds = %.preheader
  br label %17

17:                                               ; preds = %.preheader._crit_edge, %.preheader.preheader
  ret ptr %6
}
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  br i1 %.not6, label %45, label %.preheader.preheader.lr.ph

.preheader.preheader.lr.ph:                       ; preds = %3
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader.preheader.lr.ph, %42
  %.08 = phi ptr [ %4, %.preheader.preheader.lr.ph ], [ %.1.lcssa, %42 ]
  %.047 = phi i32 [ 0, %.preheader.preheader.lr.ph ], [ %43, %42 ]
  %7 = load i32, ptr @ncol, align 4
  %.not21 = icmp eq i32 0, %7
  br i1 %.not21, label %42, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader.preheader
  br label %8

8:                                                ; preds = %.lr.ph, %.preheader
  %.14 = phi ptr [ %.08, %.lr.ph ], [ %.2, %.preheader ]
  %.013 = phi i32 [ 0, %.lr.ph ], [ %40, %.preheader ]
  %.152 = phi i32 [ %.047, %.lr.ph ], [ %.3, %.preheader ]
...
23:                                               ; preds = %21, %11
  ...
  %26 = icmp eq i32 %24, 0
  %or.cond = select i1 %.not4, i1 %26, i1 false
...
27:                                               ; preds = %23
  ...
  %31 = add nsw i32 %30, -1
  %32 = call i32 @in_wanted(ptr noundef %9)
  %.not5 = icmp eq i32 %32, 0
  br i1 %.not5, label %.preheader, label %33
...
34:                                               ; preds = %8
  %35 = icmp eq i32 %.013, 0
  %36 = load i32, ptr @nrow, align 4
  %37 = add nsw i32 %36, -1
  %.4 = select i1 %35, i32 %37, i32 %.152
  %38 = load i32, ptr @ncol, align 4
  %39 = add nsw i32 %38, -1
  br label %.preheader

.preheader:                                       ; preds = %34, %33, %27, %23
  %.3 = phi i32 [ %.4, %34 ], [ %.152, %23 ], [ %31, %27 ], [ %31, %33 ]
  %.23 = phi i32 [ %39, %34 ], [ %.013, %23 ], [ %29, %27 ], [ %29, %33 ]
  %.2 = phi ptr [ %.14, %34 ], [ %18, %23 ], [ %18, %27 ], [ %18, %33 ]
  call void @free(ptr noundef %9) #5
  %40 = add nsw i32 %.23, 1
  %41 = load i32, ptr @ncol, align 4
  %.not2 = icmp eq i32 %40, %41
  br i1 %.not2, label %.preheader._crit_edge, label %8, !llvm.loop !20

.preheader._crit_edge:                            ; preds = %.preheader
  %split = phi i32 [ %.3, %.preheader ]
  %split5 = phi ptr [ %.2, %.preheader ]
  br label %42

42:                                               ; preds = %.preheader._crit_edge, %.preheader.preheader
  %.15.lcssa = phi i32 [ %split, %.preheader._crit_edge ], [ %.047, %.preheader.preheader ]
  %.1.lcssa = phi ptr [ %split5, %.preheader._crit_edge ], [ %.08, %.preheader.preheader ]
  %43 = add nsw i32 %.15.lcssa, 1
  %44 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %43, %44
  br i1 %.not, label %._crit_edge, label %.preheader.preheader, !llvm.loop !21
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  br i1 %.not6, label %27, label %.preheader.preheader.lr.ph

.preheader.preheader.lr.ph:                       ; preds = %1
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader.preheader.lr.ph, %24
  %.08 = phi ptr [ %2, %.preheader.preheader.lr.ph ], [ %.1.lcssa, %24 ]
  %.017 = phi i32 [ 0, %.preheader.preheader.lr.ph ], [ %25, %24 ]
  %5 = load i32, ptr @ncol, align 4
  %.not11 = icmp eq i32 0, %5
  br i1 %.not11, label %24, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader.preheader
  br label %6

6:                                                ; preds = %.lr.ph, %.preheader
  %.14 = phi ptr [ %.08, %.lr.ph ], [ %.2, %.preheader ]
  %.123 = phi i32 [ %.017, %.lr.ph ], [ %.23, %.preheader ]
  %.042 = phi i32 [ 0, %.lr.ph ], [ %.15, %.preheader ]
...
.preheader:                                       ; preds = %18, %9
  ...
  br i1 %.not1, label %.preheader._crit_edge, label %6, !llvm.loop !23
...
24:                                               ; preds = %.preheader._crit_edge, %.preheader.preheader
  %.12.lcssa = phi i32 [ %split, %.preheader._crit_edge ], [ %.017, %.preheader.preheader ]
  %.1.lcssa = phi ptr [ %split5, %.preheader._crit_edge ], [ %.08, %.preheader.preheader ]
  %25 = add nsw i32 %.12.lcssa, 1
  %26 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %25, %26
  br i1 %.not, label %._crit_edge, label %.preheader.preheader, !llvm.loop !24
...
define dso_local ptr @get_good_move(ptr noundef %0) #0 {
  ...
  br i1 %2, label %14, label %.preheader.preheader
...
5:                                                ; preds = %.lr.ph, %.preheader
  %6 = phi ptr [ %3, %.lr.ph ], [ %10, %.preheader ]
  %.013 = phi ptr [ %0, %.lr.ph ], [ %9, %.preheader ]
  %7 = load ptr, ptr %.013, align 8
  %8 = call i32 @get_value(ptr noundef %7)
  %.not1 = icmp eq i32 %8, 0
  br i1 %.not1, label %..critedge_crit_edge, label %.preheader
...
.preheader:                                       ; preds = %5
  ...
  br i1 %.not, label %.preheader..critedge_crit_edge, label %5, !llvm.loop !25
...
.preheader..critedge_crit_edge:                   ; preds = %.preheader
  %split4 = phi ptr [ %9, %.preheader ]
  br label %.critedge

.critedge:                                        ; preds = %.preheader..critedge_crit_edge, %..critedge_crit_edge, %.preheader.preheader
  %.01.lcssa = phi ptr [ %split, %..critedge_crit_edge ], [ %split4, %.preheader..critedge_crit_edge ], [ %0, %.preheader.preheader ]
