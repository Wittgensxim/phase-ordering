...
4:                                                ; preds = %5
  ...
  br i1 %.not, label %._crit_edge5, label %5, !llvm.loop !12
...
._crit_edge:                                      ; preds = %5
  %split = phi i1 [ false, %5 ]
  br label %9

._crit_edge5:                                     ; preds = %4
  %split6 = phi i1 [ true, %4 ]
  br label %9

9:                                                ; preds = %._crit_edge5, %._crit_edge, %1
  %.not.lcssa = phi i1 [ %split, %._crit_edge ], [ %split6, %._crit_edge5 ], [ true, %1 ]
