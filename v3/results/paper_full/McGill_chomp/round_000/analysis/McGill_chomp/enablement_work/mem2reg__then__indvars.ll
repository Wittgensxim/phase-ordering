...
8:                                                ; preds = %10, %1
  ...
  %9 = icmp ne i64 %indvars.iv, 0
  br i1 %9, label %10, label %14

10:                                               ; preds = %8
  %11 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv.next
  %12 = load i32, ptr %11, align 4
  %13 = getelementptr inbounds i32, ptr %5, i64 %indvars.iv.next
...
5:                                                ; preds = %17, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %17 ], [ %4, %2 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
...
13:                                               ; preds = %7
  ...
  %16 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv.next
...
5:                                                ; preds = %15, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %15 ], [ %4, %2 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %6 = icmp ne i64 %indvars.iv, 0
...
16:                                               ; preds = %13
  ...
  %17 = trunc nsw i64 %.lcssa.wide to i32
...
3:                                                ; preds = %13, %1
  ...
  %.01 = phi i32 [ %2, %1 ], [ %15, %13 ]
  %4 = load i32, ptr @ncol, align 4
  %5 = zext i32 %4 to i64
  %6 = icmp ne i64 %indvars.iv, %5
...
11:                                               ; preds = %7
  %.0.lcssa2.wide = phi i64 [ %indvars.iv, %7 ]
  %12 = trunc nuw nsw i64 %.0.lcssa2.wide to i32
  br label %17
...
8:                                                ; preds = %13, %2
  ...
  %9 = icmp ne i64 %indvars.iv, %7
  br i1 %9, label %10, label %14

10:                                               ; preds = %8
  %11 = load i32, ptr @nrow, align 4
  %12 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv
...
14:                                               ; preds = %8
  %indvars.iv.lcssa = phi i64 [ %indvars.iv, %8 ]
  br label %15

15:                                               ; preds = %21, %14
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %21 ], [ %indvars.iv.lcssa, %14 ]
  %16 = load i32, ptr @ncol, align 4
  %17 = zext i32 %16 to i64
  %18 = icmp ne i64 %indvars.iv2, %17
  br i1 %18, label %19, label %22

19:                                               ; preds = %15
  %20 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv2
...
10:                                               ; preds = %58, %9
  %.15 = phi i32 [ %.04, %9 ], [ %.3, %58 ]
  %.01 = phi i32 [ 0, %9 ], [ %59, %58 ]
  %.1 = phi ptr [ %.0, %9 ], [ %.2, %58 ]
...
48:                                               ; preds = %47, %36, %33
  %.26 = phi i32 [ %.15, %33 ], [ %43, %47 ], [ %.15, %36 ]
  %.12 = phi i32 [ %.01, %33 ], [ %41, %47 ], [ %.01, %36 ]
  br label %57
...
54:                                               ; preds = %51, %49
  %.4 = phi i32 [ %53, %51 ], [ %.15, %49 ]
  %55 = load i32, ptr @ncol, align 4
  %56 = sub nsw i32 %55, 1
  br label %57

57:                                               ; preds = %54, %48
  %.3 = phi i32 [ %.4, %54 ], [ %.26, %48 ]
  %.23 = phi i32 [ %56, %54 ], [ %.12, %48 ]
...
47:                                               ; preds = %43, %23
  %.2 = phi ptr [ %46, %43 ], [ %.0, %23 ]
  br label %48

48:                                               ; preds = %47, %12
  %.12 = phi ptr [ %40, %47 ], [ %.01, %12 ]
  %.1 = phi ptr [ %.2, %47 ], [ %.0, %12 ]
...
18:                                               ; preds = %13
  ...
  %19 = getelementptr inbounds nuw %struct._list, ptr %.01.lcssa, i32 0, i32 0
  %20 = load ptr, ptr %19, align 8
  %21 = call ptr @copy_data(ptr noundef %20)
  br label %22

22:                                               ; preds = %18, %3
  %.0 = phi ptr [ null, %3 ], [ %21, %18 ]
  ret ptr %.0
}
...
46:                                               ; preds = %57, %39
  %.02 = phi ptr [ %45, %39 ], [ %50, %57 ]
  %.01 = phi i32 [ 0, %39 ], [ %.1, %57 ]
  %47 = icmp ne ptr %.02, null
  br i1 %47, label %48, label %58

48:                                               ; preds = %46
  %49 = call ptr @where(ptr noundef %.02, ptr noundef %42)
  %50 = call ptr @get_good_move(ptr noundef %49)
  %51 = icmp ne ptr %50, null
  br i1 %51, label %52, label %57

52:                                               ; preds = %48
  call void @get_real_move(ptr noundef %50, ptr noundef %.02, ptr noundef %1, ptr noundef %2)
  %53 = load i32, ptr %1, align 4
  %54 = load i32, ptr %2, align 4
  %55 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.01, i32 noundef %53, i32 noundef %54)
  %56 = sub nsw i32 1, %.01
  call void @free(ptr noundef %.02)
  br label %57

57:                                               ; preds = %52, %48
  %.1 = phi i32 [ %56, %52 ], [ %.01, %48 ]
  br label %46, !llvm.loop !30

58:                                               ; preds = %46
  %.01.lcssa = phi i32 [ %.01, %46 ]
  call void @dump_play(ptr noundef %42)
  %59 = sub nsw i32 1, %.01.lcssa
...
73:                                               ; preds = %70
  %74 = getelementptr inbounds nuw %struct._play, ptr %.0, i32 0, i32 1
  %75 = load ptr, ptr %74, align 8
  call void @show_move(ptr noundef %75)
  br label %76

76:                                               ; preds = %73, %70
  %77 = getelementptr inbounds nuw %struct._play, ptr %.0, i32 0, i32 3
