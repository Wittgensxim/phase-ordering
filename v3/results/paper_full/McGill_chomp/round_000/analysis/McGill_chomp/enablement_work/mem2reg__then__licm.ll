...
17:                                               ; preds = %.loopexit, %11
  %.03 = phi i32 [ %.0.lcssa, %.loopexit ], [ %.0.lcssa2, %11 ]
...
11:                                               ; preds = %5
  %12 = getelementptr inbounds nuw %struct._list, ptr %.01, i32 0, i32 1
  %13 = load ptr, ptr %12, align 8
...
14:                                               ; preds = %.loopexit, %10
  %.013 = phi ptr [ %.01.lcssa, %.loopexit ], [ %.01.lcssa2, %10 ]
