...
15:                                               ; preds = %0
  ...
  %18 = call ptr @make_play(i32 noundef 1)
...
22:                                               ; preds = %35, %15
  %23 = phi i32 [ %36, %35 ], [ 0, %15 ]
  %24 = phi ptr [ %28, %35 ], [ %21, %15 ]
  %25 = icmp ne ptr %24, null
  br i1 %25, label %26, label %37

26:                                               ; preds = %22
  %27 = call ptr @where(ptr noundef %24, ptr noundef %18)
  %28 = call ptr @get_good_move(ptr noundef %27)
  store ptr %28, ptr %8, align 8
  %29 = icmp ne ptr %28, null
  br i1 %29, label %30, label %35

30:                                               ; preds = %26
  call void @get_real_move(ptr noundef %28, ptr noundef %24, ptr noundef %2, ptr noundef %3)
  %31 = load i32, ptr %2, align 4
  %32 = load i32, ptr %3, align 4
  %33 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %23, i32 noundef %31, i32 noundef %32)
  %34 = sub nuw nsw i32 1, %23
  store i32 %34, ptr %5, align 4
  call void @free(ptr noundef %24)
  br label %35

35:                                               ; preds = %30, %26
  %36 = phi i32 [ %34, %30 ], [ %23, %26 ]
  store ptr %28, ptr %7, align 8
  br label %22, !llvm.loop !29

37:                                               ; preds = %22
  call void @dump_play(ptr noundef %18)
  %38 = sub nuw nsw i32 1, %23
  %39 = call i32 (ptr, ...) @printf(ptr noundef @.str.16, i32 noundef %38)
  br label %40
