...
10:                                               ; preds = %55, %9
  %.035 = phi i32 [ 0, %9 ], [ %56, %55 ]
  %.133 = phi i32 [ %.032, %9 ], [ %.3, %55 ]
  %.1 = phi ptr [ %.0, %9 ], [ %.2, %55 ]
  %11 = load i32, ptr @ncol, align 4
...
52:                                               ; preds = %49, %47
  %.234 = phi i32 [ %51, %49 ], [ %.133, %47 ]
  %53 = load i32, ptr @ncol, align 4
  %54 = sub nsw i32 %53, 1
  br label %55

55:                                               ; preds = %33, %36, %46, %39, %52
  %.136 = phi i32 [ %54, %52 ], [ %.035, %33 ], [ %41, %46 ], [ %41, %39 ], [ %.035, %36 ]
  %.3 = phi i32 [ %.234, %52 ], [ %.133, %33 ], [ %43, %46 ], [ %43, %39 ], [ %.133, %36 ]
  %.2 = phi ptr [ %.1, %52 ], [ %28, %33 ], [ %28, %46 ], [ %28, %39 ], [ %28, %36 ]
  call void @free(ptr noundef %14)
  %56 = add nsw i32 %.136, 1
...
47:                                               ; preds = %23, %43, %12
  %.118 = phi ptr [ %46, %43 ], [ %.017, %23 ], [ %.017, %12 ]
  %.1 = phi ptr [ %40, %43 ], [ %40, %23 ], [ %.0, %12 ]
...
8:                                                ; preds = %35, %7
  %.024 = phi i32 [ 0, %7 ], [ %36, %35 ]
  %.122 = phi i32 [ %.021, %7 ], [ %.3, %35 ]
  %.1 = phi ptr [ %.0, %7 ], [ %.2, %35 ]
...
8:                                                ; preds = %4
  %9 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 0
...
13:                                               ; preds = %8
  %14 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 1
  %15 = load ptr, ptr %14, align 8
  br label %4, !llvm.loop !25

.critedge:                                        ; preds = %4, %8
  %16 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 0
  %17 = load ptr, ptr %16, align 8
  %18 = call ptr @copy_data(ptr noundef %17)
  br label %19

19:                                               ; preds = %.critedge, %3
  %.06 = phi ptr [ null, %3 ], [ %18, %.critedge ]
  ret ptr %.06
}
