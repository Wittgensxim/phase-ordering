...
2:                                                ; preds = %22, %1
  %.09 = phi i32 [ 0, %1 ], [ %.110, %22 ]
  %.0 = phi i32 [ 0, %1 ], [ %.1, %22 ]
  %3 = load i32, ptr @ncol, align 4
  %.not = icmp eq i32 %.09, %3
...
2:                                                ; preds = %6, %1
  %storemerge.in = phi ptr [ @game_tree, %1 ], [ %7, %6 ]
  %storemerge = load ptr, ptr %storemerge.in, align 8
  %3 = getelementptr inbounds nuw i8, ptr %storemerge, i64 8
  %4 = load ptr, ptr %3, align 8
...
8:                                                ; preds = %2
  %9 = load i32, ptr %storemerge, align 8
  ret i32 %9
}
...
2:                                                ; preds = %3, %1
  %storemerge = phi ptr [ %0, %1 ], [ %6, %3 ]
  %.not = icmp eq ptr %storemerge, null
  br i1 %.not, label %7, label %3

3:                                                ; preds = %2
  %4 = load ptr, ptr %storemerge, align 8
...
2:                                                ; preds = %3, %1
  %storemerge = phi ptr [ %0, %1 ], [ %11, %3 ]
  %.not = icmp eq ptr %storemerge, null
  br i1 %.not, label %12, label %3

3:                                                ; preds = %2
  %puts = call i32 @puts(ptr nonnull dereferenceable(1) @str.1)
  %4 = getelementptr inbounds nuw i8, ptr %storemerge, i64 8
  %5 = load ptr, ptr %4, align 8
  call void @show_data(ptr noundef %5)
  %6 = load i32, ptr %storemerge, align 8
...
2:                                                ; preds = %7, %1
  %storemerge.in = phi ptr [ @wanted, %1 ], [ %8, %7 ]
  %storemerge = load ptr, ptr %storemerge.in, align 8
  %.not = icmp eq ptr %storemerge, null
...
9:                                                ; preds = %6, %2
  %10 = icmp eq ptr %storemerge, null
...
15:                                               ; preds = %20, %14
  %.0 = phi i32 [ %storemerge, %14 ], [ %21, %20 ]
  %16 = load i32, ptr @ncol, align 4
  %.not1 = icmp eq i32 %.0, %16
...
6:                                                ; preds = %55, %3
  %.0 = phi ptr [ %4, %3 ], [ %.1, %55 ]
  %storemerge = phi i32 [ 0, %3 ], [ %56, %55 ]
  %7 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %storemerge, %7
...
9:                                                ; preds = %52, %8
  %.025 = phi i32 [ %storemerge, %8 ], [ %.227, %52 ]
  %.1 = phi ptr [ %.0, %8 ], [ %.2, %52 ]
  %storemerge2 = phi i32 [ 0, %8 ], [ %53, %52 ]
  %10 = load i32, ptr @ncol, align 4
  %.not3 = icmp eq i32 %storemerge2, %10
  br i1 %.not3, label %54, label %11

11:                                               ; preds = %9
  %12 = call ptr @make_data(i32 noundef %.025, i32 noundef %storemerge2)
  call void @melt_data(ptr noundef %12, ptr noundef %0)
  %13 = call i32 @equal_data(ptr noundef %12, ptr noundef %0)
  %.not4 = icmp eq i32 %13, 0
  br i1 %.not4, label %14, label %43
...
42:                                               ; preds = %41, %31, %29
  %.028 = phi i32 [ %36, %41 ], [ %storemerge2, %31 ], [ %storemerge2, %29 ]
  %.126 = phi i32 [ %38, %41 ], [ %.025, %31 ], [ %.025, %29 ]
  br label %51

43:                                               ; preds = %11
  %44 = icmp eq i32 %storemerge2, 0
...
48:                                               ; preds = %45, %43
  %.3 = phi i32 [ %47, %45 ], [ %.025, %43 ]
  %49 = load i32, ptr @ncol, align 4
  %50 = add nsw i32 %49, -1
  br label %51

51:                                               ; preds = %48, %42
  %.129 = phi i32 [ %.028, %42 ], [ %50, %48 ]
  %.227 = phi i32 [ %.126, %42 ], [ %.3, %48 ]
  %.2 = phi ptr [ %24, %42 ], [ %.1, %48 ]
  call void @free(ptr noundef %12) #5
  br label %52

52:                                               ; preds = %51
  %53 = add nsw i32 %.129, 1
...
8:                                                ; preds = %44, %1
  %.012 = phi ptr [ %5, %1 ], [ %.113, %44 ]
  %.0 = phi ptr [ %4, %1 ], [ %.1, %44 ]
  %9 = call i32 @next_data(ptr noundef %.012)
  %.not = icmp eq i32 %9, 0
  br i1 %.not, label %45, label %10

10:                                               ; preds = %8
  %11 = call i32 @valid_data(ptr noundef %.012)
  %.not1 = icmp eq i32 %11, 0
  br i1 %.not1, label %44, label %12
...
20:                                               ; preds = %17, %12
  %21 = call ptr @copy_data(ptr noundef %.012)
  %22 = getelementptr inbounds nuw i8, ptr %.0, i64 24
  %23 = load ptr, ptr %22, align 8
  %24 = getelementptr inbounds nuw i8, ptr %23, i64 8
  store ptr %21, ptr %24, align 8
  %25 = call ptr @make_list(ptr noundef %.012, ptr noundef nonnull %3, ptr noundef nonnull %2)
...
39:                                               ; preds = %20
  call void @free(ptr noundef %.012) #5
...
43:                                               ; preds = %39, %20
  %.2 = phi ptr [ %42, %39 ], [ %.012, %20 ]
  br label %44

44:                                               ; preds = %43, %10
  %.113 = phi ptr [ %.012, %10 ], [ %.2, %43 ]
  %.1 = phi ptr [ %.0, %10 ], [ %36, %43 ]
...
4:                                                ; preds = %35, %1
  %.0 = phi ptr [ %2, %1 ], [ %.1, %35 ]
  %storemerge = phi i32 [ 0, %1 ], [ %36, %35 ]
  %5 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %storemerge, %5
...
7:                                                ; preds = %32, %6
  %.013 = phi i32 [ %storemerge, %6 ], [ %.114, %32 ]
  %.1 = phi ptr [ %.0, %6 ], [ %.2, %32 ]
  %storemerge1 = phi i32 [ 0, %6 ], [ %33, %32 ]
  %8 = load i32, ptr @ncol, align 4
  %.not2 = icmp eq i32 %storemerge1, %8
  br i1 %.not2, label %34, label %9

9:                                                ; preds = %7
  %10 = call ptr @make_data(i32 noundef %.013, i32 noundef %storemerge1)
  call void @melt_data(ptr noundef %10, ptr noundef %0)
  %11 = call i32 @equal_data(ptr noundef %10, ptr noundef %0)
  %.not3 = icmp eq i32 %11, 0
  br i1 %.not3, label %12, label %23
...
28:                                               ; preds = %25, %23
  %.215 = phi i32 [ %27, %25 ], [ %.013, %23 ]
  %29 = load i32, ptr @ncol, align 4
  %30 = add nsw i32 %29, -1
  br label %31

31:                                               ; preds = %28, %12
  %.016 = phi i32 [ %storemerge1, %12 ], [ %30, %28 ]
  %.114 = phi i32 [ %.013, %12 ], [ %.215, %28 ]
  %.2 = phi ptr [ %22, %12 ], [ %.1, %28 ]
  call void @free(ptr noundef %10) #5
  br label %32

32:                                               ; preds = %31
  %33 = add nsw i32 %.016, 1
...
37:                                               ; preds = %4
  ...
  store ptr %39, ptr @wanted, align 8
  ret void
}
...
20:                                               ; preds = %17, %3
  %storemerge = phi ptr [ %19, %17 ], [ null, %3 ]
  ret ptr %storemerge
}
...
5:                                                ; preds = %2
  %6 = getelementptr inbounds nuw i8, ptr %storemerge, i64 24
  %7 = load ptr, ptr %6, align 8
...
7:                                                ; preds = %3
  %8 = getelementptr inbounds nuw i8, ptr %storemerge, i64 24
  %9 = load ptr, ptr %8, align 8
  br label %3, !llvm.loop !27

10:                                               ; preds = %3
  %11 = getelementptr inbounds nuw i8, ptr %storemerge, i64 16
...
16:                                               ; preds = %25, %9
  %.0 = phi i32 [ 0, %9 ], [ %.1, %25 ]
  %storemerge = phi ptr [ %15, %9 ], [ %19, %25 ]
  %.not = icmp eq ptr %storemerge, null
  br i1 %.not, label %26, label %17

17:                                               ; preds = %16
  %18 = call ptr @where(ptr noundef %storemerge, ptr noundef %12)
  %19 = call ptr @get_good_move(ptr noundef %18)
  %.not3 = icmp eq ptr %19, null
  br i1 %.not3, label %25, label %20

20:                                               ; preds = %17
  call void @get_real_move(ptr noundef %19, ptr noundef %storemerge, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %21 = load i32, ptr %1, align 4
  %22 = load i32, ptr %2, align 4
  %23 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %.0, i32 noundef %21, i32 noundef %22) #5
  %24 = sub nsw i32 1, %.0
  call void @free(ptr noundef %storemerge) #5
  br label %25

25:                                               ; preds = %20, %17
  %.1 = phi i32 [ %.0, %17 ], [ %24, %20 ]
