...
16:                                               ; preds = %15
  ...
  %19 = call ptr @where(ptr noundef %17, ptr noundef %18)
  %20 = call ptr @get_good_move(ptr noundef %19)
  store ptr %20, ptr %5, align 8
  %.not3 = icmp eq ptr %20, null
  br i1 %.not3, label %30, label %21

21:                                               ; preds = %16
  %22 = load ptr, ptr %5, align 8
  %23 = load ptr, ptr %4, align 8
  call void @get_real_move(ptr noundef %22, ptr noundef %23, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %24 = load i32, ptr %3, align 4
  %25 = load i32, ptr %1, align 4
  %26 = load i32, ptr %2, align 4
  %27 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %24, i32 noundef %25, i32 noundef %26) #5
  %28 = sub nsw i32 1, %24
...
32:                                               ; preds = %15
  ...
  %35 = sub nsw i32 1, %34
  %36 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.16, i32 noundef %35) #5
  br label %37
