...
11:                                               ; preds = %7
  %.0.lcssa8.wide = phi i64 [ %indvars.iv, %7 ]
  %12 = trunc nuw nsw i64 %.0.lcssa8.wide to i32
  br label %17
...
15:                                               ; preds = %21, %14
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %21 ], [ %indvars.iv.lcssa, %14 ]
  %16 = load i32, ptr @ncol, align 4
  %17 = zext i32 %16 to i64
  %18 = icmp ne i64 %indvars.iv11, %17
  br i1 %18, label %19, label %22

19:                                               ; preds = %15
  %20 = getelementptr inbounds i32, ptr %6, i64 %indvars.iv11
...
18:                                               ; preds = %13
  %.0.lcssa = phi ptr [ %.0, %13 ]
  %19 = getelementptr inbounds nuw %struct._list, ptr %.0.lcssa, i32 0, i32 0
  %20 = load ptr, ptr %19, align 8
  %21 = call ptr @copy_data(ptr noundef %20)
  br label %22

22:                                               ; preds = %18, %3
  %.06 = phi ptr [ null, %3 ], [ %21, %18 ]
  ret ptr %.06
}
