...
11:                                               ; preds = %7
  ...
  br i1 %19, label %7, label %.critedge, !llvm.loop !11
...
90:                                               ; preds = %16
  ...
  %92 = getelementptr inbounds nuw %struct._list, ptr %91, i32 0, i32 1
...
53:                                               ; preds = %50
  ...
  %55 = call ptr @where(ptr noundef %51, ptr noundef %54)
...
58:                                               ; preds = %53
  ...
  call void @get_real_move(ptr noundef %56, ptr noundef %59, ptr noundef %2, ptr noundef %3)
  %60 = load i32, ptr %5, align 4
  %61 = load i32, ptr %2, align 4
  %62 = load i32, ptr %3, align 4
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %60, i32 noundef %61, i32 noundef %62)
...
69:                                               ; preds = %50
  ...
  call void @dump_play(ptr noundef %70)
...
87:                                               ; preds = %84
  %88 = getelementptr inbounds nuw %struct._play, ptr %82, i32 0, i32 1
  %89 = load ptr, ptr %88, align 8
  call void @show_move(ptr noundef %89)
  br label %90

90:                                               ; preds = %87, %84
  %91 = load ptr, ptr %10, align 8
  %92 = getelementptr inbounds nuw %struct._play, ptr %91, i32 0, i32 3
  %93 = load ptr, ptr %92, align 8
