...
17:                                               ; preds = %8
  ...
  br i1 %.not, label %..loopexit_crit_edge, label %8, !llvm.loop !12
...
define dso_local i32 @get_value(ptr noundef %0) #0 {
  ...
  %3 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %storemerge1 = load ptr, ptr @game_tree, align 8
  store ptr %storemerge1, ptr %3, align 8
  %4 = getelementptr inbounds nuw i8, ptr %storemerge1, i64 8
  %5 = load ptr, ptr %4, align 8
  %6 = load ptr, ptr %2, align 8
  %7 = call i32 @equal_data(ptr noundef %5, ptr noundef %6)
  %.not2 = icmp eq i32 %7, 0
  br i1 %.not2, label %.lr.ph, label %15
...
8:                                                ; preds = %.lr.ph, %8
  ...
  %storemerge = load ptr, ptr %10, align 8
  ...
  br i1 %.not, label %8, label %._crit_edge, !llvm.loop !13
...
define dso_local void @show_data(ptr noundef %0) #0 {
  ...
  br i1 %.not2, label %20, label %.lr.ph
...
3:                                                ; preds = %.lr.ph, %3
  ...
  br i1 %.not, label %._crit_edge, label %3, !llvm.loop !16
...
define dso_local i32 @in_wanted(ptr noundef %0) #0 {
  ...
  %3 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %storemerge3 = load ptr, ptr @wanted, align 8
  store ptr %storemerge3, ptr %3, align 8
  %.not4 = icmp eq ptr %storemerge3, null
...
10:                                               ; preds = %4
  ...
  %storemerge = load ptr, ptr %12, align 8
  store ptr %storemerge, ptr %3, align 8
  %.not = icmp eq ptr %storemerge, null
  br i1 %.not, label %..loopexit_crit_edge, label %4, !llvm.loop !17
...
22:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %.not13, label %36, label %.lr.ph5
...
31:                                               ; preds = %25
  ...
  br i1 %.not1, label %._crit_edge6, label %25, !llvm.loop !19

._crit_edge6:                                     ; preds = %31
  br label %36

36:                                               ; preds = %._crit_edge6, %22
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %.not8 = icmp eq i32 0, %14
  br i1 %.not8, label %82, label %.lr.ph10
...
15:                                               ; preds = %.lr.ph10, %78
  ...
  %.not37 = icmp eq i32 0, %16
  br i1 %.not37, label %77, label %.lr.ph
...
73:                                               ; preds = %71
  ...
  %.not3 = icmp eq i32 %75, %76
  br i1 %.not3, label %._crit_edge, label %17, !llvm.loop !20
...
78:                                               ; preds = %77
  ...
  %.not = icmp eq i32 %80, %81
  br i1 %.not, label %._crit_edge11, label %15, !llvm.loop !21

._crit_edge11:                                    ; preds = %78
  br label %82

82:                                               ; preds = %._crit_edge11, %3
...
define dso_local ptr @make_play(i32 noundef %0) #0 {
  ...
  br i1 %.not2, label %59, label %.lr.ph
...
13:                                               ; preds = %.lr.ph, %56
  ...
  br i1 %.not1, label %56, label %16

16:                                               ; preds = %13
  %17 = call dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #4
...
22:                                               ; preds = %16
  ...
  store ptr %25, ptr @game_tree, align 8
  br label %26
...
26:                                               ; preds = %22, %16
  ...
  %34 = call ptr @make_list(ptr noundef %33, ptr noundef nonnull %3, ptr noundef nonnull %2)
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  %.not5 = icmp eq i32 0, %10
  br i1 %.not5, label %53, label %.lr.ph7
...
11:                                               ; preds = %.lr.ph7, %49
  ...
  %.not24 = icmp eq i32 0, %12
  br i1 %.not24, label %48, label %.lr.ph
...
44:                                               ; preds = %42
  ...
  %.not2 = icmp eq i32 %46, %47
  br i1 %.not2, label %._crit_edge, label %13, !llvm.loop !23
...
49:                                               ; preds = %48
  ...
  br i1 %.not, label %._crit_edge8, label %11, !llvm.loop !24

._crit_edge8:                                     ; preds = %49
  br label %53

53:                                               ; preds = %._crit_edge8, %1
...
define dso_local ptr @where(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %8 = call i32 @equal_data(ptr noundef %6, ptr noundef %7)
  %.not1 = icmp eq i32 %8, 0
  br i1 %.not1, label %.lr.ph, label %17
...
9:                                                ; preds = %.lr.ph, %9
  ...
  %16 = call i32 @equal_data(ptr noundef %14, ptr noundef %15)
  %.not = icmp eq i32 %16, 0
  br i1 %.not, label %9, label %._crit_edge, !llvm.loop !27
...
20:                                               ; preds = %.lr.ph, %20
  ...
  br i1 %34, label %20, label %._crit_edge, !llvm.loop !28
...
8:                                                ; preds = %0
  br i1 false, label %.lr.ph9, label %11
...
10:                                               ; preds = %9
  br i1 false, label %9, label %._crit_edge10, !llvm.loop !29

._crit_edge10:                                    ; preds = %10
  br label %11

11:                                               ; preds = %._crit_edge10, %8
  br label %45
...
12:                                               ; preds = %0
  ...
  br i1 %.not4, label %35, label %.lr.ph6
...
33:                                               ; preds = %24, %19
  ...
  br i1 %.not, label %._crit_edge7, label %19, !llvm.loop !30

._crit_edge7:                                     ; preds = %33
  br label %35

35:                                               ; preds = %._crit_edge7, %12
...
40:                                               ; preds = %0
  br i1 false, label %.lr.ph, label %44
...
43:                                               ; preds = %42, %41
  br i1 false, label %41, label %._crit_edge, !llvm.loop !31
