...
5:                                                ; preds = %.lr.ph, %11
  %.05 = phi i32 [ 0, %.lr.ph ], [ %15, %11 ]
  %.014 = phi i32 [ %2, %.lr.ph ], [ %14, %11 ]
  %6 = sext i32 %.05 to i64
  %7 = getelementptr inbounds i32, ptr %0, i64 %6
  %8 = load i32, ptr %7, align 4
  %9 = icmp sgt i32 %8, %.014
  br i1 %9, label %10, label %11

10:                                               ; preds = %5
  %.0.lcssa2 = phi i32 [ %.05, %5 ]
  br label %18
...
18:                                               ; preds = %.loopexit, %10
  %.03 = phi i32 [ %.0.lcssa, %.loopexit ], [ %.0.lcssa2, %10 ]
  %19 = load i32, ptr @ncol, align 4
  %20 = icmp eq i32 %.03, %19
...
3:                                                ; preds = %.lr.ph, %3
  %.01 = phi ptr [ %0, %.lr.ph ], [ %7, %3 ]
  %4 = getelementptr inbounds nuw %struct._list, ptr %.01, i32 0, i32 0
  %5 = load ptr, ptr %4, align 8
...
3:                                                ; preds = %.lr.ph, %3
  ...
  %7 = getelementptr inbounds nuw %struct._play, ptr %.01, i32 0, i32 0
  %8 = load i32, ptr %7, align 8
  %9 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %8)
  %10 = call i32 (ptr, ...) @printf(ptr noundef @.str.4)
  %11 = getelementptr inbounds nuw %struct._play, ptr %.01, i32 0, i32 2
  %12 = load ptr, ptr %11, align 8
  call void @show_list(ptr noundef %12)
  %13 = getelementptr inbounds nuw %struct._play, ptr %.01, i32 0, i32 3
...
4:                                                ; preds = %.lr.ph, %10
  %.014 = phi ptr [ %2, %.lr.ph ], [ %12, %10 ]
  %5 = getelementptr inbounds nuw %struct._list, ptr %.014, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
...
9:                                                ; preds = %4
  %.01.lcssa2 = phi ptr [ %.014, %4 ]
  br label %14

10:                                               ; preds = %4
  %11 = getelementptr inbounds nuw %struct._list, ptr %.014, i32 0, i32 1
  %12 = load ptr, ptr %11, align 8
...
14:                                               ; preds = %.loopexit, %9
  %.013 = phi ptr [ %.01.lcssa, %.loopexit ], [ %.01.lcssa2, %9 ]
  %15 = icmp eq ptr %.013, null
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %7 = icmp ne i32 0, %6
  br i1 %7, label %.lr.ph14, label %65

.lr.ph14:                                         ; preds = %3
  br label %8

8:                                                ; preds = %.lr.ph14, %61
  %.012 = phi ptr [ %4, %.lr.ph14 ], [ %.1.lcssa, %61 ]
  %.0411 = phi i32 [ 0, %.lr.ph14 ], [ %62, %61 ]
...
11:                                               ; preds = %.lr.ph, %56
  %.19 = phi ptr [ %.012, %.lr.ph ], [ %.2, %56 ]
  %.018 = phi i32 [ 0, %.lr.ph ], [ %57, %56 ]
  %.157 = phi i32 [ %.0411, %.lr.ph ], [ %.3, %56 ]
  %12 = call ptr @make_data(i32 noundef %.157, i32 noundef %.018)
...
15:                                               ; preds = %11
  ...
  %17 = getelementptr inbounds nuw %struct._list, ptr %.19, i32 0, i32 1
  store ptr %16, ptr %17, align 8
  %18 = call ptr @copy_data(ptr noundef %12)
  %19 = getelementptr inbounds nuw %struct._list, ptr %.19, i32 0, i32 1
  %20 = load ptr, ptr %19, align 8
  %21 = getelementptr inbounds nuw %struct._list, ptr %20, i32 0, i32 0
  store ptr %18, ptr %21, align 8
  %22 = getelementptr inbounds nuw %struct._list, ptr %.19, i32 0, i32 1
  %23 = load ptr, ptr %22, align 8
  %24 = getelementptr inbounds nuw %struct._list, ptr %23, i32 0, i32 1
  store ptr null, ptr %24, align 8
  %25 = getelementptr inbounds nuw %struct._list, ptr %.19, i32 0, i32 1
...
46:                                               ; preds = %45, %34, %31
  %.26 = phi i32 [ %.157, %31 ], [ %41, %45 ], [ %.157, %34 ]
  %.12 = phi i32 [ %.018, %31 ], [ %39, %45 ], [ %.018, %34 ]
  br label %55

47:                                               ; preds = %11
  %48 = icmp eq i32 %.018, 0
...
52:                                               ; preds = %49, %47
  %.4 = phi i32 [ %51, %49 ], [ %.157, %47 ]
  %53 = load i32, ptr @ncol, align 4
  %54 = sub nsw i32 %53, 1
  br label %55

55:                                               ; preds = %52, %46
  %.3 = phi i32 [ %.4, %52 ], [ %.26, %46 ]
  %.23 = phi i32 [ %54, %52 ], [ %.12, %46 ]
  %.2 = phi ptr [ %.19, %52 ], [ %26, %46 ]
...
._crit_edge:                                      ; preds = %56
  %split = phi i32 [ %.3, %56 ]
  %split10 = phi ptr [ %.2, %56 ]
  br label %60

60:                                               ; preds = %._crit_edge, %8
  %.15.lcssa = phi i32 [ %split, %._crit_edge ], [ %.0411, %8 ]
  %.1.lcssa = phi ptr [ %split10, %._crit_edge ], [ %.012, %8 ]
  br label %61

61:                                               ; preds = %60
  %62 = add nsw i32 %.15.lcssa, 1
  %63 = load i32, ptr @nrow, align 4
  %64 = icmp ne i32 %62, %63
  br i1 %64, label %8, label %._crit_edge15, !llvm.loop !21

._crit_edge15:                                    ; preds = %61
  br label %65

65:                                               ; preds = %._crit_edge15, %3
...
11:                                               ; preds = %.lr.ph, %47
  %.04 = phi ptr [ %5, %.lr.ph ], [ %.1, %47 ]
  %.013 = phi ptr [ %4, %.lr.ph ], [ %.12, %47 ]
  %12 = call i32 @valid_data(ptr noundef %.04)
  %13 = icmp ne i32 %12, 0
  br i1 %13, label %14, label %47

14:                                               ; preds = %11
  %15 = call ptr @malloc(i64 noundef 32) #3
  %16 = getelementptr inbounds nuw %struct._play, ptr %.013, i32 0, i32 3
...
19:                                               ; preds = %14
  %20 = getelementptr inbounds nuw %struct._play, ptr %.013, i32 0, i32 3
  %21 = load ptr, ptr %20, align 8
  store ptr %21, ptr @game_tree, align 8
  br label %22

22:                                               ; preds = %19, %14
  %23 = call ptr @copy_data(ptr noundef %.04)
  %24 = getelementptr inbounds nuw %struct._play, ptr %.013, i32 0, i32 3
  %25 = load ptr, ptr %24, align 8
  %26 = getelementptr inbounds nuw %struct._play, ptr %25, i32 0, i32 1
  store ptr %23, ptr %26, align 8
  %27 = call ptr @make_list(ptr noundef %.04, ptr noundef %3, ptr noundef %2)
  %28 = getelementptr inbounds nuw %struct._play, ptr %.013, i32 0, i32 3
  %29 = load ptr, ptr %28, align 8
  %30 = getelementptr inbounds nuw %struct._play, ptr %29, i32 0, i32 2
  store ptr %27, ptr %30, align 8
  %31 = load i32, ptr %3, align 4
  %32 = getelementptr inbounds nuw %struct._play, ptr %.013, i32 0, i32 3
  %33 = load ptr, ptr %32, align 8
  %34 = getelementptr inbounds nuw %struct._play, ptr %33, i32 0, i32 0
  store i32 %31, ptr %34, align 8
  %35 = getelementptr inbounds nuw %struct._play, ptr %.013, i32 0, i32 3
  %36 = load ptr, ptr %35, align 8
  %37 = getelementptr inbounds nuw %struct._play, ptr %36, i32 0, i32 3
  store ptr null, ptr %37, align 8
  %38 = getelementptr inbounds nuw %struct._play, ptr %.013, i32 0, i32 3
...
46:                                               ; preds = %42, %22
  %.2 = phi ptr [ %45, %42 ], [ %.04, %22 ]
  br label %47

47:                                               ; preds = %46, %11
  %.12 = phi ptr [ %39, %46 ], [ %.013, %11 ]
  %.1 = phi ptr [ %.2, %46 ], [ %.04, %11 ]
  %48 = call i32 @next_data(ptr noundef %.1)
  %49 = icmp ne i32 %48, 0
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  %5 = icmp ne i32 0, %4
  br i1 %5, label %.lr.ph13, label %43

.lr.ph13:                                         ; preds = %1
  br label %6

6:                                                ; preds = %.lr.ph13, %39
  %.011 = phi ptr [ %2, %.lr.ph13 ], [ %.1.lcssa, %39 ]
  %.0110 = phi i32 [ 0, %.lr.ph13 ], [ %40, %39 ]
...
9:                                                ; preds = %.lr.ph, %34
  %.18 = phi ptr [ %.011, %.lr.ph ], [ %.2, %34 ]
  %.127 = phi i32 [ %.0110, %.lr.ph ], [ %.23, %34 ]
  %.046 = phi i32 [ 0, %.lr.ph ], [ %35, %34 ]
  %10 = call ptr @make_data(i32 noundef %.127, i32 noundef %.046)
...
13:                                               ; preds = %9
  ...
  %15 = getelementptr inbounds nuw %struct._list, ptr %.18, i32 0, i32 1
  store ptr %14, ptr %15, align 8
  %16 = call ptr @copy_data(ptr noundef %10)
  %17 = getelementptr inbounds nuw %struct._list, ptr %.18, i32 0, i32 1
  %18 = load ptr, ptr %17, align 8
  %19 = getelementptr inbounds nuw %struct._list, ptr %18, i32 0, i32 0
  store ptr %16, ptr %19, align 8
  %20 = getelementptr inbounds nuw %struct._list, ptr %.18, i32 0, i32 1
  %21 = load ptr, ptr %20, align 8
  %22 = getelementptr inbounds nuw %struct._list, ptr %21, i32 0, i32 1
  store ptr null, ptr %22, align 8
  %23 = getelementptr inbounds nuw %struct._list, ptr %.18, i32 0, i32 1
  %24 = load ptr, ptr %23, align 8
  br label %33

25:                                               ; preds = %9
  %26 = icmp eq i32 %.046, 0
...
30:                                               ; preds = %27, %25
  %.3 = phi i32 [ %29, %27 ], [ %.127, %25 ]
  %31 = load i32, ptr @ncol, align 4
  %32 = sub nsw i32 %31, 1
  br label %33

33:                                               ; preds = %30, %13
  %.15 = phi i32 [ %32, %30 ], [ %.046, %13 ]
  %.23 = phi i32 [ %.3, %30 ], [ %.127, %13 ]
  %.2 = phi ptr [ %.18, %30 ], [ %24, %13 ]
...
38:                                               ; preds = %._crit_edge, %6
  %.12.lcssa = phi i32 [ %split, %._crit_edge ], [ %.0110, %6 ]
  %.1.lcssa = phi ptr [ %split9, %._crit_edge ], [ %.011, %6 ]
  br label %39

39:                                               ; preds = %38
  %40 = add nsw i32 %.12.lcssa, 1
  %41 = load i32, ptr @nrow, align 4
  %42 = icmp ne i32 %40, %41
  br i1 %42, label %6, label %._crit_edge14, !llvm.loop !24

._crit_edge14:                                    ; preds = %39
  br label %43

43:                                               ; preds = %._crit_edge14, %1
...
9:                                                ; preds = %5
  %10 = getelementptr inbounds nuw %struct._list, ptr %.01, i32 0, i32 0
...
16:                                               ; preds = %14
  %17 = getelementptr inbounds nuw %struct._list, ptr %.01, i32 0, i32 1
  %18 = load ptr, ptr %17, align 8
  br label %5, !llvm.loop !25

19:                                               ; preds = %14
  %.01.lcssa = phi ptr [ %.01, %14 ]
  %20 = getelementptr inbounds nuw %struct._list, ptr %.01.lcssa, i32 0, i32 0
  %21 = load ptr, ptr %20, align 8
  %22 = call ptr @copy_data(ptr noundef %21)
  br label %23

23:                                               ; preds = %19, %3
  %.0 = phi ptr [ null, %3 ], [ %22, %19 ]
  ret ptr %.0
}
...
5:                                                ; preds = %.lr.ph, %5
  %.01 = phi ptr [ %0, %.lr.ph ], [ %7, %5 ]
  %6 = getelementptr inbounds nuw %struct._play, ptr %.01, i32 0, i32 3
  %7 = load ptr, ptr %6, align 8
...
9:                                                ; preds = %0
  ...
  br i1 %18, label %.lr.ph10, label %40
...
34:                                               ; preds = %19
  ...
  br i1 %39, label %19, label %._crit_edge11, !llvm.loop !29

._crit_edge11:                                    ; preds = %34
  br label %40

40:                                               ; preds = %._crit_edge11, %9
  br label %83
...
41:                                               ; preds = %0
  ...
  br i1 %48, label %.lr.ph7, label %60

.lr.ph7:                                          ; preds = %41
  br label %49

49:                                               ; preds = %.lr.ph7, %58
  %.015 = phi i32 [ 0, %.lr.ph7 ], [ %.1, %58 ]
  %.024 = phi ptr [ %47, %.lr.ph7 ], [ %51, %58 ]
  %50 = call ptr @where(ptr noundef %.024, ptr noundef %44)
  %51 = call ptr @get_good_move(ptr noundef %50)
  %52 = icmp ne ptr %51, null
  br i1 %52, label %53, label %58

53:                                               ; preds = %49
  call void @get_real_move(ptr noundef %51, ptr noundef %.024, ptr noundef %1, ptr noundef %2)
  %54 = load i32, ptr %1, align 4
  %55 = load i32, ptr %2, align 4
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.015, i32 noundef %54, i32 noundef %55)
  %57 = sub nsw i32 1, %.015
  call void @free(ptr noundef %.024)
  br label %58

58:                                               ; preds = %53, %49
  %.1 = phi i32 [ %57, %53 ], [ %.015, %49 ]
  %59 = icmp ne ptr %51, null
  br i1 %59, label %49, label %._crit_edge8, !llvm.loop !30

._crit_edge8:                                     ; preds = %58
  %split = phi i32 [ %.1, %58 ]
  br label %60

60:                                               ; preds = %._crit_edge8, %41
  %.01.lcssa = phi i32 [ %split, %._crit_edge8 ], [ 0, %41 ]
  call void @dump_play(ptr noundef %44)
  %61 = sub nsw i32 1, %.01.lcssa
...
71:                                               ; preds = %.lr.ph, %78
  %.03 = phi ptr [ %69, %.lr.ph ], [ %80, %78 ]
  %72 = getelementptr inbounds nuw %struct._play, ptr %.03, i32 0, i32 0
  %73 = load i32, ptr %72, align 8
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %75, label %78

75:                                               ; preds = %71
  %76 = getelementptr inbounds nuw %struct._play, ptr %.03, i32 0, i32 1
  %77 = load ptr, ptr %76, align 8
  call void @show_move(ptr noundef %77)
  br label %78

78:                                               ; preds = %75, %71
  %79 = getelementptr inbounds nuw %struct._play, ptr %.03, i32 0, i32 3
