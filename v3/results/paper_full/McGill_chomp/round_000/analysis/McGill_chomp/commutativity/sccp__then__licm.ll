...
85:                                               ; preds = %95, %77
  %86 = phi ptr [ %97, %95 ], [ %.promoted, %77 ]
  %87 = icmp ne ptr %86, null
  br i1 %87, label %88, label %98

88:                                               ; preds = %85
  %89 = getelementptr inbounds nuw %struct._play, ptr %86, i32 0, i32 0
  %90 = load i32, ptr %89, align 8
  %91 = icmp eq i32 %90, 0
  br i1 %91, label %92, label %95

92:                                               ; preds = %88
  %93 = getelementptr inbounds nuw %struct._play, ptr %86, i32 0, i32 1
  %94 = load ptr, ptr %93, align 8
  call void @show_move(ptr noundef %94)
  br label %95

95:                                               ; preds = %92, %88
  %96 = getelementptr inbounds nuw %struct._play, ptr %86, i32 0, i32 3
