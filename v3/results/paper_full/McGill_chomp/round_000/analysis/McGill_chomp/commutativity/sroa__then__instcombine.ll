...
6:                                                ; preds = %54, %3
  %.032 = phi i32 [ 0, %3 ], [ %55, %54 ]
  %.0 = phi ptr [ %4, %3 ], [ %.1, %54 ]
  %7 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %.032, %7
...
9:                                                ; preds = %52, %8
  %.035 = phi i32 [ 0, %8 ], [ %.237, %52 ]
  %.133 = phi i32 [ %.032, %8 ], [ %.3, %52 ]
  %.1 = phi ptr [ %.0, %8 ], [ %.2, %52 ]
  %10 = load i32, ptr @ncol, align 4
  %.not39 = icmp eq i32 %.035, %10
  br i1 %.not39, label %53, label %11

11:                                               ; preds = %9
  %12 = call ptr @make_data(i32 noundef %.133, i32 noundef %.035)
...
42:                                               ; preds = %41, %31, %29
  %.136 = phi i32 [ %.035, %29 ], [ %36, %41 ], [ %.035, %31 ]
  %.234 = phi i32 [ %.133, %29 ], [ %38, %41 ], [ %.133, %31 ]
  %43 = add nsw i32 %.136, 1
  br label %51

44:                                               ; preds = %11
  %45 = icmp eq i32 %.035, 0
...
49:                                               ; preds = %46, %44
  %.4 = phi i32 [ %48, %46 ], [ %.133, %44 ]
  %50 = load i32, ptr @ncol, align 4
  br label %51

51:                                               ; preds = %49, %42
  %.237 = phi i32 [ %50, %49 ], [ %43, %42 ]
  %.3 = phi i32 [ %.4, %49 ], [ %.234, %42 ]
...
8:                                                ; preds = %44, %1
  %.017 = phi ptr [ %5, %1 ], [ %.118, %44 ]
  %.0 = phi ptr [ %4, %1 ], [ %.1, %44 ]
  %9 = call i32 @next_data(ptr noundef %.017)
  %.not = icmp eq i32 %9, 0
  br i1 %.not, label %45, label %10

10:                                               ; preds = %8
  %11 = call i32 @valid_data(ptr noundef %.017)
  %.not19 = icmp eq i32 %11, 0
  br i1 %.not19, label %44, label %12
...
20:                                               ; preds = %17, %12
  %21 = call ptr @copy_data(ptr noundef %.017)
  %22 = getelementptr inbounds nuw i8, ptr %.0, i64 24
  %23 = load ptr, ptr %22, align 8
  %24 = getelementptr inbounds nuw i8, ptr %23, i64 8
  store ptr %21, ptr %24, align 8
  %25 = call ptr @make_list(ptr noundef %.017, ptr noundef nonnull %3, ptr noundef nonnull %2)
...
39:                                               ; preds = %20
  call void @free(ptr noundef %.017) #5
...
43:                                               ; preds = %39, %20
  %.2 = phi ptr [ %42, %39 ], [ %.017, %20 ]
  br label %44

44:                                               ; preds = %43, %10
  %.118 = phi ptr [ %.2, %43 ], [ %.017, %10 ]
  %.1 = phi ptr [ %36, %43 ], [ %.0, %10 ]
...
4:                                                ; preds = %34, %1
  %.021 = phi i32 [ 0, %1 ], [ %35, %34 ]
  %.0 = phi ptr [ %2, %1 ], [ %.1, %34 ]
  %5 = load i32, ptr @nrow, align 4
  %.not = icmp eq i32 %.021, %5
...
7:                                                ; preds = %32, %6
  %.024 = phi i32 [ 0, %6 ], [ %.125, %32 ]
  %.122 = phi i32 [ %.021, %6 ], [ %.223, %32 ]
  %.1 = phi ptr [ %.0, %6 ], [ %.2, %32 ]
  %8 = load i32, ptr @ncol, align 4
  %.not26 = icmp eq i32 %.024, %8
  br i1 %.not26, label %33, label %9

9:                                                ; preds = %7
  %10 = call ptr @make_data(i32 noundef %.122, i32 noundef %.024)
...
29:                                               ; preds = %26, %24
  %.3 = phi i32 [ %28, %26 ], [ %.122, %24 ]
  %30 = load i32, ptr @ncol, align 4
  br label %31

31:                                               ; preds = %29, %12
  %.125 = phi i32 [ %30, %29 ], [ %23, %12 ]
  %.223 = phi i32 [ %.3, %29 ], [ %.122, %12 ]
...
define dso_local i32 @main() #0 {
  ...
  %puts23 = call i32 @puts(ptr nonnull dereferenceable(1) @str.5)
...
16:                                               ; preds = %25, %9
  %.021 = phi ptr [ %15, %9 ], [ %19, %25 ]
  %.020 = phi i32 [ 0, %9 ], [ %.1, %25 ]
  %.not = icmp eq ptr %.021, null
  br i1 %.not, label %26, label %17

17:                                               ; preds = %16
  %18 = call ptr @where(ptr noundef nonnull %.021, ptr noundef %12)
  %19 = call ptr @get_good_move(ptr noundef %18)
  %.not24 = icmp eq ptr %19, null
  br i1 %.not24, label %25, label %20

20:                                               ; preds = %17
  call void @get_real_move(ptr noundef nonnull %19, ptr noundef nonnull %.021, ptr noundef nonnull %1, ptr noundef nonnull %2)
  %21 = load i32, ptr %1, align 4
  %22 = load i32, ptr %2, align 4
  %23 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %.020, i32 noundef %21, i32 noundef %22) #5
  %24 = sub nsw i32 1, %.020
  call void @free(ptr noundef nonnull %.021) #5
  br label %25

25:                                               ; preds = %20, %17
  %.1 = phi i32 [ %24, %20 ], [ %.020, %17 ]
  br label %16, !llvm.loop !30

26:                                               ; preds = %16
  call void @dump_play(ptr noundef %12)
  %27 = sub nsw i32 1, %.020
