...
10:                                               ; preds = %54, %9
  %.035 = phi i32 [ 0, %9 ], [ %55, %54 ]
  %.133 = phi i32 [ %.032, %9 ], [ %.3, %54 ]
  %.1 = phi ptr [ %.0, %9 ], [ %.2, %54 ]
  %11 = load i32, ptr @ncol, align 4
...
44:                                               ; preds = %43, %32, %29
  %.136 = phi i32 [ %.035, %29 ], [ %37, %43 ], [ %.035, %32 ]
  %.234 = phi i32 [ %.133, %29 ], [ %39, %43 ], [ %.133, %32 ]
  br label %53
...
8:                                                ; preds = %32, %7
  %.024 = phi i32 [ 0, %7 ], [ %33, %32 ]
  %.122 = phi i32 [ %.021, %7 ], [ %.223, %32 ]
  %.1 = phi ptr [ %.0, %7 ], [ %.2, %32 ]
