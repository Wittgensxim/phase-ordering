...
23:                                               ; preds = %87, %3
  %.lcssa613 = phi ptr [ %.lcssa6, %87 ], [ %.promoted12, %3 ]
  %.lcssa411 = phi ptr [ %.lcssa4, %87 ], [ %.promoted, %3 ]
  %.lcssa10 = phi i32 [ %.lcssa, %87 ], [ %.promoted9, %3 ]
  %.lcssa28 = phi i32 [ %88, %87 ], [ %.promoted7, %3 ]
  %24 = load i32, ptr @nrow, align 4
  %25 = icmp ne i32 %.lcssa28, %24
...
27:                                               ; preds = %84, %26
  %28 = phi ptr [ %81, %84 ], [ %.lcssa613, %26 ]
  %29 = phi ptr [ %35, %84 ], [ %.lcssa411, %26 ]
  %30 = phi i32 [ %82, %84 ], [ %.lcssa28, %26 ]
  %31 = phi i32 [ %85, %84 ], [ 0, %26 ]
...
34:                                               ; preds = %27
  ...
  call void @melt_data(ptr noundef %35, ptr noundef %16)
  %36 = call i32 @equal_data(ptr noundef %35, ptr noundef %17)
  %37 = icmp ne i32 %36, 0
...
38:                                               ; preds = %34
  ...
  %44 = getelementptr inbounds nuw %struct._list, ptr %28, i32 0, i32 1
  %45 = load ptr, ptr %44, align 8
  %46 = getelementptr inbounds nuw %struct._list, ptr %45, i32 0, i32 1
  store ptr null, ptr %46, align 8
  %47 = getelementptr inbounds nuw %struct._list, ptr %28, i32 0, i32 1
...
51:                                               ; preds = %38
  %52 = call i32 @get_value(ptr noundef %35)
...
59:                                               ; preds = %56
  ...
  %63 = sub nsw i32 %62, 1
  %64 = call i32 @in_wanted(ptr noundef %35)
  %65 = icmp ne i32 %64, 0
...
68:                                               ; preds = %67, %56, %53
  %69 = phi i32 [ %63, %67 ], [ %30, %56 ], [ %30, %53 ]
  %70 = phi i32 [ %61, %67 ], [ %31, %56 ], [ %31, %53 ]
  br label %80
...
76:                                               ; preds = %73, %71
  %77 = phi i32 [ %75, %73 ], [ %30, %71 ]
  %78 = load i32, ptr @ncol, align 4
  %79 = sub nsw i32 %78, 1
  br label %80

80:                                               ; preds = %76, %68
  %81 = phi ptr [ %28, %76 ], [ %48, %68 ]
  %82 = phi i32 [ %77, %76 ], [ %69, %68 ]
  %83 = phi i32 [ %79, %76 ], [ %70, %68 ]
...
87:                                               ; preds = %86
  %88 = add nsw i32 %.lcssa2, 1
  br label %23, !llvm.loop !21

89:                                               ; preds = %23
  %.lcssa613.lcssa = phi ptr [ %.lcssa613, %23 ]
  %.lcssa411.lcssa = phi ptr [ %.lcssa411, %23 ]
  %.lcssa10.lcssa = phi i32 [ %.lcssa10, %23 ]
  %.lcssa28.lcssa = phi i32 [ %.lcssa28, %23 ]
  ...
  %91 = getelementptr inbounds nuw %struct._list, ptr %90, i32 0, i32 1
...
11:                                               ; preds = %52, %1
  %12 = phi ptr [ %53, %52 ], [ %.promoted1, %1 ]
  %13 = phi ptr [ %54, %52 ], [ %.promoted, %1 ]
...
24:                                               ; preds = %19
  %25 = getelementptr inbounds nuw %struct._play, ptr %12, i32 0, i32 3
  %26 = load ptr, ptr %25, align 8
  store ptr %26, ptr @game_tree, align 8
  br label %27

27:                                               ; preds = %24, %19
  %28 = call ptr @copy_data(ptr noundef %13)
  %29 = getelementptr inbounds nuw %struct._play, ptr %12, i32 0, i32 3
  %30 = load ptr, ptr %29, align 8
  %31 = getelementptr inbounds nuw %struct._play, ptr %30, i32 0, i32 1
  store ptr %28, ptr %31, align 8
  %32 = call ptr @make_list(ptr noundef %13, ptr noundef %3, ptr noundef %2)
  %33 = getelementptr inbounds nuw %struct._play, ptr %12, i32 0, i32 3
  %34 = load ptr, ptr %33, align 8
  %35 = getelementptr inbounds nuw %struct._play, ptr %34, i32 0, i32 2
  store ptr %32, ptr %35, align 8
  %36 = load i32, ptr %3, align 4
  %37 = getelementptr inbounds nuw %struct._play, ptr %12, i32 0, i32 3
  %38 = load ptr, ptr %37, align 8
  store i32 %36, ptr %38, align 8
  %39 = getelementptr inbounds nuw %struct._play, ptr %12, i32 0, i32 3
  %40 = load ptr, ptr %39, align 8
  %41 = getelementptr inbounds nuw %struct._play, ptr %40, i32 0, i32 3
  store ptr null, ptr %41, align 8
  %42 = getelementptr inbounds nuw %struct._play, ptr %12, i32 0, i32 3
  %43 = load ptr, ptr %42, align 8
...
50:                                               ; preds = %46, %27
  %51 = phi ptr [ %49, %46 ], [ %13, %27 ]
  br label %52

52:                                               ; preds = %50, %16
  %53 = phi ptr [ %43, %50 ], [ %12, %16 ]
  %54 = phi ptr [ %51, %50 ], [ %13, %16 ]
...
55:                                               ; preds = %11
  ...
  %57 = getelementptr inbounds nuw %struct._play, ptr %56, i32 0, i32 3
...
17:                                               ; preds = %52, %16
  %18 = phi ptr [ %49, %52 ], [ %.lcssa613, %16 ]
  %19 = phi ptr [ %25, %52 ], [ %.lcssa411, %16 ]
  %20 = phi i32 [ %50, %52 ], [ %.lcssa28, %16 ]
  %21 = phi i32 [ %53, %52 ], [ 0, %16 ]
  %22 = load i32, ptr @ncol, align 4
...
24:                                               ; preds = %17
  ...
  call void @melt_data(ptr noundef %25, ptr noundef %11)
  %26 = call i32 @equal_data(ptr noundef %25, ptr noundef %12)
  %27 = icmp ne i32 %26, 0
...
28:                                               ; preds = %24
  ...
  %34 = getelementptr inbounds nuw %struct._list, ptr %18, i32 0, i32 1
  %35 = load ptr, ptr %34, align 8
  %36 = getelementptr inbounds nuw %struct._list, ptr %35, i32 0, i32 1
  store ptr null, ptr %36, align 8
  %37 = getelementptr inbounds nuw %struct._list, ptr %18, i32 0, i32 1
  %38 = load ptr, ptr %37, align 8
  br label %48
...
48:                                               ; preds = %44, %28
  %49 = phi ptr [ %18, %44 ], [ %38, %28 ]
  %50 = phi i32 [ %45, %44 ], [ %20, %28 ]
  %51 = phi i32 [ %47, %44 ], [ %21, %28 ]
...
57:                                               ; preds = %13
  %.lcssa613.lcssa = phi ptr [ %.lcssa613, %13 ]
  %.lcssa411.lcssa = phi ptr [ %.lcssa411, %13 ]
  %.lcssa10.lcssa = phi i32 [ %.lcssa10, %13 ]
  %.lcssa28.lcssa = phi i32 [ %.lcssa28, %13 ]
...
18:                                               ; preds = %16
  %19 = getelementptr inbounds nuw %struct._list, ptr %8, i32 0, i32 1
...
10:                                               ; preds = %4
  %.lcssa1 = phi ptr [ %5, %4 ]
  %.lcssa = phi ptr [ %5, %4 ]
  store ptr %.lcssa1, ptr %2, align 8
...
22:                                               ; preds = %12
  ...
  store i32 %.lcssa, ptr %23, align 4
  ret void
}
...
15:                                               ; preds = %0
  ...
  %.promoted9 = load ptr, ptr %6, align 1
  br label %22
...
45:                                               ; preds = %22
  %.lcssa10 = phi ptr [ %23, %22 ]
  %.lcssa8 = phi ptr [ %24, %22 ]
  store ptr %.lcssa8, ptr %9, align 8
  store ptr %.lcssa10, ptr %6, align 1
  br label %96
