...
10:                                               ; preds = %57, %9
  %.031 = phi i32 [ 0, %9 ], [ %58, %57 ]
  %.129 = phi i32 [ %.028, %9 ], [ %.3, %57 ]
  %.1 = phi ptr [ %.0, %9 ], [ %.2, %57 ]
  %11 = load i32, ptr @ncol, align 4
  %12 = icmp ne i32 %.031, %11
  br i1 %12, label %13, label %59

13:                                               ; preds = %10
  %14 = call ptr @make_data(i32 noundef %.129, i32 noundef %.031)
...
47:                                               ; preds = %46, %35, %32
  %.132 = phi i32 [ %.031, %32 ], [ %40, %46 ], [ %.031, %35 ]
  %.230 = phi i32 [ %.129, %32 ], [ %42, %46 ], [ %.129, %35 ]
  br label %56

48:                                               ; preds = %13
  %49 = icmp eq i32 %.031, 0
...
53:                                               ; preds = %50, %48
  %.4 = phi i32 [ %52, %50 ], [ %.129, %48 ]
  %54 = load i32, ptr @ncol, align 4
  %55 = sub nsw i32 %54, 1
  br label %56

56:                                               ; preds = %53, %47
  %.233 = phi i32 [ %55, %53 ], [ %.132, %47 ]
  %.3 = phi i32 [ %.4, %53 ], [ %.230, %47 ]
  %.2 = phi ptr [ %.1, %53 ], [ %27, %47 ]
  call void @free(ptr noundef %14)
  br label %57

57:                                               ; preds = %56
  %58 = add nsw i32 %.233, 1
...
8:                                                ; preds = %46, %1
  %.015 = phi ptr [ %5, %1 ], [ %.116, %46 ]
  %.0 = phi ptr [ %4, %1 ], [ %.1, %46 ]
  %9 = call i32 @next_data(ptr noundef %.015)
  %10 = icmp ne i32 %9, 0
  br i1 %10, label %11, label %47

11:                                               ; preds = %8
  %12 = call i32 @valid_data(ptr noundef %.015)
  %13 = icmp ne i32 %12, 0
...
22:                                               ; preds = %19, %14
  %23 = call ptr @copy_data(ptr noundef %.015)
  ...
  %27 = call ptr @make_list(ptr noundef %.015, ptr noundef %3, ptr noundef %2)
  ...
  %34 = getelementptr inbounds nuw %struct._play, ptr %.0, i32 0, i32 3
  %35 = load ptr, ptr %34, align 8
  %36 = getelementptr inbounds nuw %struct._play, ptr %35, i32 0, i32 3
  store ptr null, ptr %36, align 8
  %37 = getelementptr inbounds nuw %struct._play, ptr %.0, i32 0, i32 3
...
41:                                               ; preds = %22
  call void @free(ptr noundef %.015)
...
45:                                               ; preds = %41, %22
  %.2 = phi ptr [ %44, %41 ], [ %.015, %22 ]
  br label %46

46:                                               ; preds = %45, %11
  %.116 = phi ptr [ %.2, %45 ], [ %.015, %11 ]
  %.1 = phi ptr [ %38, %45 ], [ %.0, %11 ]
...
8:                                                ; preds = %35, %7
  %.021 = phi i32 [ 0, %7 ], [ %36, %35 ]
  %.119 = phi i32 [ %.018, %7 ], [ %.220, %35 ]
  %.1 = phi ptr [ %.0, %7 ], [ %.2, %35 ]
  %9 = load i32, ptr @ncol, align 4
  %10 = icmp ne i32 %.021, %9
  br i1 %10, label %11, label %37

11:                                               ; preds = %8
  %12 = call ptr @make_data(i32 noundef %.119, i32 noundef %.021)
...
31:                                               ; preds = %28, %26
  %.3 = phi i32 [ %30, %28 ], [ %.119, %26 ]
  %32 = load i32, ptr @ncol, align 4
  %33 = sub nsw i32 %32, 1
  br label %34

34:                                               ; preds = %31, %15
  %.122 = phi i32 [ %33, %31 ], [ %.021, %15 ]
  %.220 = phi i32 [ %.3, %31 ], [ %.119, %15 ]
  %.2 = phi ptr [ %.1, %31 ], [ %25, %15 ]
  call void @free(ptr noundef %12)
  br label %35

35:                                               ; preds = %34
  %36 = add nsw i32 %.122, 1
...
15:                                               ; preds = %13
  %16 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 1
...
44:                                               ; preds = %55, %37
  %.013 = phi ptr [ %43, %37 ], [ %48, %55 ]
  %.012 = phi i32 [ 0, %37 ], [ %.1, %55 ]
  %45 = icmp ne ptr %.013, null
  br i1 %45, label %46, label %56

46:                                               ; preds = %44
  %47 = call ptr @where(ptr noundef %.013, ptr noundef %40)
  %48 = call ptr @get_good_move(ptr noundef %47)
  %49 = icmp ne ptr %48, null
  br i1 %49, label %50, label %55

50:                                               ; preds = %46
  call void @get_real_move(ptr noundef %48, ptr noundef %.013, ptr noundef %1, ptr noundef %2)
  %51 = load i32, ptr %1, align 4
  %52 = load i32, ptr %2, align 4
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.012, i32 noundef %51, i32 noundef %52)
  %54 = sub nsw i32 1, %.012
  call void @free(ptr noundef %.013)
  br label %55

55:                                               ; preds = %50, %46
  %.1 = phi i32 [ %54, %50 ], [ %.012, %46 ]
  br label %44, !llvm.loop !30

56:                                               ; preds = %44
  call void @dump_play(ptr noundef %40)
  %57 = sub nsw i32 1, %.012
