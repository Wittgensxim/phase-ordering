...
define dso_local void @show_data(ptr noundef %0) #0 {
  %.pre3 = load i32, ptr @ncol, align 4
  br label %2

2:                                                ; preds = %15, %1
  %3 = phi i32 [ %.pre3, %1 ], [ %16, %15 ]
  %.0 = phi i32 [ 0, %1 ], [ %6, %15 ]
  %4 = icmp ne i32 %.0, %3
...
10:                                               ; preds = %53, %9
  %.035 = phi i32 [ 0, %9 ], [ %54, %53 ]
  %.133 = phi i32 [ %.032, %9 ], [ %.3, %53 ]
  %.1 = phi ptr [ %.0, %9 ], [ %.2, %53 ]
  %11 = load i32, ptr @ncol, align 4
...
44:                                               ; preds = %43, %33, %29
  %.136 = phi i32 [ %.035, %29 ], [ %37, %43 ], [ %.035, %33 ]
  %.234 = phi i32 [ %.133, %29 ], [ %39, %43 ], [ %.133, %33 ]
  br label %53
...
50:                                               ; preds = %47, %45
  %.4 = phi i32 [ %49, %47 ], [ %.133, %45 ]
  %51 = load i32, ptr @ncol, align 4
  %52 = sub nsw i32 %51, 1
  br label %53

53:                                               ; preds = %50, %44
  %.237 = phi i32 [ %52, %50 ], [ %.136, %44 ]
  %.3 = phi i32 [ %.4, %50 ], [ %.234, %44 ]
  %.2 = phi ptr [ %.1, %50 ], [ %24, %44 ]
  call void @free(ptr noundef %14)
  %54 = add nsw i32 %.237, 1
  br label %10, !llvm.loop !20

55:                                               ; preds = %10
  %56 = add nsw i32 %.133, 1
...
11:                                               ; preds = %8
  %12 = call i32 @valid_data(ptr noundef %.017)
  %13 = icmp ne i32 %12, 0
...
20:                                               ; preds = %19, %14
  ...
  %24 = call ptr @make_list(ptr noundef %.017, ptr noundef %3, ptr noundef %2)
...
38:                                               ; preds = %34, %20
  %.2 = phi ptr [ %37, %34 ], [ %.017, %20 ]
  br label %39

39:                                               ; preds = %38, %11
  %.118 = phi ptr [ %.2, %38 ], [ %.017, %11 ]
  %.1 = phi ptr [ %31, %38 ], [ %.0, %11 ]
...
8:                                                ; preds = %31, %7
  %.024 = phi i32 [ 0, %7 ], [ %32, %31 ]
  %.122 = phi i32 [ %.021, %7 ], [ %.223, %31 ]
  %.1 = phi ptr [ %.0, %7 ], [ %.2, %31 ]
...
28:                                               ; preds = %25, %23
  %.3 = phi i32 [ %27, %25 ], [ %.122, %23 ]
  %29 = load i32, ptr @ncol, align 4
  %30 = sub nsw i32 %29, 1
  br label %31

31:                                               ; preds = %28, %15
  %.125 = phi i32 [ %30, %28 ], [ %.024, %15 ]
  %.223 = phi i32 [ %.3, %28 ], [ %.122, %15 ]
  %.2 = phi ptr [ %.1, %28 ], [ %22, %15 ]
  call void @free(ptr noundef %12)
  %32 = add nsw i32 %.125, 1
  br label %8, !llvm.loop !23

33:                                               ; preds = %8
  %34 = add nsw i32 %.122, 1
...
43:                                               ; preds = %54, %36
  %.021 = phi ptr [ %42, %36 ], [ %47, %54 ]
  %.020 = phi i32 [ 0, %36 ], [ %.1, %54 ]
  %44 = icmp ne ptr %.021, null
  br i1 %44, label %45, label %55

45:                                               ; preds = %43
  %46 = call ptr @where(ptr noundef %.021, ptr noundef %39)
  %47 = call ptr @get_good_move(ptr noundef %46)
  %48 = icmp ne ptr %47, null
  br i1 %48, label %49, label %54

49:                                               ; preds = %45
  call void @get_real_move(ptr noundef %47, ptr noundef %.021, ptr noundef %1, ptr noundef %2)
  %50 = load i32, ptr %1, align 4
  %51 = load i32, ptr %2, align 4
  %52 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.020, i32 noundef %50, i32 noundef %51)
  %53 = sub nsw i32 1, %.020
  call void @free(ptr noundef %.021)
  br label %54

54:                                               ; preds = %49, %45
  %.1 = phi i32 [ %53, %49 ], [ %.020, %45 ]
