...
11:                                               ; preds = %14, %1
  %indvars.iv = phi i64 [ %indvars.iv.next, %14 ], [ %10, %1 ]
...
14:                                               ; preds = %11
  %15 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv.next
...
8:                                                ; preds = %23, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %23 ], [ %7, %2 ]
  %9 = phi ptr [ %24, %23 ], [ %1, %2 ]
  %10 = phi ptr [ %25, %23 ], [ %0, %2 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
...
13:                                               ; preds = %8
  %14 = getelementptr inbounds i32, ptr %10, i64 %indvars.iv.next
  %15 = load i32, ptr %14, align 4
  %16 = getelementptr inbounds i32, ptr %9, i64 %indvars.iv.next
  %17 = load i32, ptr %16, align 4
  %18 = icmp sgt i32 %15, %17
  br i1 %18, label %19, label %23

19:                                               ; preds = %13
  %20 = getelementptr inbounds i32, ptr %1, i64 %indvars.iv.next
  %21 = load i32, ptr %20, align 4
  %22 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv.next
  store i32 %21, ptr %22, align 4
  br label %23

23:                                               ; preds = %19, %13
  %24 = phi ptr [ %1, %19 ], [ %9, %13 ]
  %25 = phi ptr [ %0, %19 ], [ %10, %13 ]
...
8:                                                ; preds = %19, %2
  %indvars.iv = phi i64 [ %indvars.iv.next, %19 ], [ %7, %2 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %9 = trunc nsw i64 %indvars.iv.next to i32
  store i32 %9, ptr %5, align 4
  %10 = icmp ne i64 %indvars.iv, 0
...
14:                                               ; preds = %10
  %.lcssa1.wide = phi i64 [ %indvars.iv, %10 ]
  %15 = trunc nuw nsw i64 %.lcssa1.wide to i32
  br label %19
...
.loopexit:                                        ; preds = %7
  %.lcssa.wide = phi i64 [ %indvars.iv, %7 ]
  %18 = trunc nuw nsw i64 %.lcssa.wide to i32
  br label %19

19:                                               ; preds = %.loopexit, %14
  %20 = phi i32 [ %18, %.loopexit ], [ %15, %14 ]
  %21 = icmp eq i32 %20, %.pre
...
4:                                                ; preds = %19, %1
  ...
  %5 = phi i32 [ %20, %19 ], [ %.pre1, %1 ]
  %6 = zext i32 %5 to i64
  %7 = icmp ne i64 %indvars.iv, %6
...
17:                                               ; preds = %.loopexit, %13
  %18 = phi ptr [ %.lcssa, %.loopexit ], [ %.lcssa1, %13 ]
...
20:                                               ; preds = %24, %18
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %24 ], [ %19, %18 ]
...
24:                                               ; preds = %20
  %25 = getelementptr inbounds i32, ptr %10, i64 %indvars.iv2
  store i32 %0, ptr %25, align 4
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, 1
  %26 = trunc nsw i64 %indvars.iv.next3 to i32
...
15:                                               ; preds = %5
  %.lcssa = phi ptr [ %6, %5 ]
  %16 = getelementptr inbounds nuw %struct._play, ptr %.lcssa, i32 0, i32 2
