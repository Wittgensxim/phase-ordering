...
56:                                               ; preds = %._crit_edge, %55, %44
  %.110 = phi i32 [ %.09, %._crit_edge ], [ %49, %55 ], [ %.09, %44 ]
...
12:                                               ; preds = %8
  %13 = call i32 @valid_data(ptr noundef %.03)
  %14 = icmp ne i32 %13, 0
...
21:                                               ; preds = %20, %15
  %22 = call ptr @copy_data(ptr noundef %.03)
  %23 = load ptr, ptr %17, align 8
  %24 = getelementptr inbounds nuw %struct._play, ptr %23, i32 0, i32 1
  store ptr %22, ptr %24, align 8
  %25 = call ptr @make_list(ptr noundef %.03, ptr noundef %3, ptr noundef %2)
...
39:                                               ; preds = %35, %21
  %.2 = phi ptr [ %38, %35 ], [ %.03, %21 ]
  %40 = phi ptr [ %38, %35 ], [ %.03, %21 ]
  br label %41

41:                                               ; preds = %39, %12
  %.14 = phi ptr [ %.2, %39 ], [ %.03, %12 ]
  %.1 = phi ptr [ %32, %39 ], [ %.0, %12 ]
  %42 = phi ptr [ %40, %39 ], [ %.03, %12 ]
