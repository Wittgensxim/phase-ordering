...
9:                                                ; preds = %52, %8
  %.09 = phi i32 [ %storemerge, %8 ], [ %.211, %52 ]
  %.1 = phi ptr [ %.0, %8 ], [ %.2, %52 ]
...
11:                                               ; preds = %9
  %12 = call ptr @make_data(i32 noundef %.09, i32 noundef %storemerge2)
...
42:                                               ; preds = %41, %31, %29
  %.110 = phi i32 [ %38, %41 ], [ %.09, %31 ], [ %.09, %29 ]
  %.07 = phi i32 [ %36, %41 ], [ %storemerge2, %31 ], [ %storemerge2, %29 ]
  br label %51
...
48:                                               ; preds = %45, %43
  %.3 = phi i32 [ %47, %45 ], [ %.09, %43 ]
  %49 = load i32, ptr @ncol, align 4
  %50 = add nsw i32 %49, -1
  br label %51

51:                                               ; preds = %48, %42
  %.211 = phi i32 [ %.110, %42 ], [ %.3, %48 ]
  %.18 = phi i32 [ %.07, %42 ], [ %50, %48 ]
...
12:                                               ; preds = %10
  ...
  %14 = getelementptr inbounds nuw i8, ptr %.02, i64 24
...
20:                                               ; preds = %17, %12
  ...
  %22 = getelementptr inbounds nuw i8, ptr %.02, i64 24
  %23 = load ptr, ptr %22, align 8
  %24 = getelementptr inbounds nuw i8, ptr %23, i64 8
  store ptr %21, ptr %24, align 8
  %25 = call ptr @make_list(ptr noundef %.0, ptr noundef nonnull %3, ptr noundef nonnull %2)
  %26 = getelementptr inbounds nuw i8, ptr %.02, i64 24
  %27 = load ptr, ptr %26, align 8
  %28 = getelementptr inbounds nuw i8, ptr %27, i64 16
  store ptr %25, ptr %28, align 8
  %29 = load i32, ptr %3, align 4
  %30 = getelementptr inbounds nuw i8, ptr %.02, i64 24
  %31 = load ptr, ptr %30, align 8
  store i32 %29, ptr %31, align 8
  %32 = getelementptr inbounds nuw i8, ptr %.02, i64 24
  %33 = load ptr, ptr %32, align 8
  %34 = getelementptr inbounds nuw i8, ptr %33, i64 24
  store ptr null, ptr %34, align 8
  %35 = getelementptr inbounds nuw i8, ptr %.02, i64 24
...
9:                                                ; preds = %7
  %10 = call ptr @make_data(i32 noundef %.04, i32 noundef %storemerge1)
...
28:                                               ; preds = %25, %23
  %.26 = phi i32 [ %27, %25 ], [ %.04, %23 ]
  %29 = load i32, ptr @ncol, align 4
  %30 = add nsw i32 %29, -1
  br label %31

31:                                               ; preds = %28, %12
  %.07 = phi i32 [ %storemerge1, %12 ], [ %30, %28 ]
  %.15 = phi i32 [ %.04, %12 ], [ %.26, %28 ]
