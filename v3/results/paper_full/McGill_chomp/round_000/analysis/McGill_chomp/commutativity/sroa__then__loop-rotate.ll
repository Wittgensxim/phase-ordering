...
9:                                                ; preds = %.lr.ph, %9
  ...
  %16 = add nsw i32 %10, -1
  %17 = icmp ne i32 %10, 0
  br i1 %17, label %9, label %._crit_edge, !llvm.loop !7
...
21:                                               ; preds = %15, %6
  %22 = add nsw i32 %7, -1
  %23 = icmp ne i32 %7, 0
  br i1 %23, label %6, label %._crit_edge, !llvm.loop !10
...
5:                                                ; preds = %.lr.ph, %11
  %.011 = phi i32 [ 0, %.lr.ph ], [ %15, %11 ]
  %.0710 = phi i32 [ %2, %.lr.ph ], [ %14, %11 ]
  %6 = sext i32 %.011 to i64
  %7 = getelementptr inbounds i32, ptr %0, i64 %6
  %8 = load i32, ptr %7, align 4
  %9 = icmp sgt i32 %8, %.0710
  br i1 %9, label %10, label %11

10:                                               ; preds = %5
  %.0.lcssa8 = phi i32 [ %.011, %5 ]
  br label %18
...
18:                                               ; preds = %.loopexit, %10
  %.09 = phi i32 [ %.0.lcssa, %.loopexit ], [ %.0.lcssa8, %10 ]
  %19 = load i32, ptr @ncol, align 4
  %20 = icmp eq i32 %.09, %19
...
8:                                                ; preds = %.lr.ph, %8
  %.04 = phi ptr [ %2, %.lr.ph ], [ %10, %8 ]
  %9 = getelementptr inbounds nuw %struct._play, ptr %.04, i32 0, i32 3
...
16:                                               ; preds = %._crit_edge, %1
  ...
  %17 = getelementptr inbounds nuw %struct._play, ptr %.0.lcssa, i32 0, i32 0
...
3:                                                ; preds = %.lr.ph, %3
  %.03 = phi ptr [ %0, %.lr.ph ], [ %7, %3 ]
  %4 = getelementptr inbounds nuw %struct._list, ptr %.03, i32 0, i32 0
  %5 = load ptr, ptr %4, align 8
  call void @show_move(ptr noundef %5)
  %6 = getelementptr inbounds nuw %struct._list, ptr %.03, i32 0, i32 1
  %7 = load ptr, ptr %6, align 8
...
3:                                                ; preds = %.lr.ph, %3
  %.05 = phi ptr [ %0, %.lr.ph ], [ %14, %3 ]
  %4 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  %5 = getelementptr inbounds nuw %struct._play, ptr %.05, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  call void @show_data(ptr noundef %6)
  %7 = getelementptr inbounds nuw %struct._play, ptr %.05, i32 0, i32 0
  %8 = load i32, ptr %7, align 8
  %9 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %8)
  %10 = call i32 (ptr, ...) @printf(ptr noundef @.str.4)
  %11 = getelementptr inbounds nuw %struct._play, ptr %.05, i32 0, i32 2
  %12 = load ptr, ptr %11, align 8
  call void @show_list(ptr noundef %12)
  %13 = getelementptr inbounds nuw %struct._play, ptr %.05, i32 0, i32 3
...
4:                                                ; preds = %.lr.ph, %10
  %.08 = phi ptr [ %2, %.lr.ph ], [ %12, %10 ]
  %5 = getelementptr inbounds nuw %struct._list, ptr %.08, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
...
9:                                                ; preds = %4
  %.0.lcssa6 = phi ptr [ %.08, %4 ]
  br label %14

10:                                               ; preds = %4
  %11 = getelementptr inbounds nuw %struct._list, ptr %.08, i32 0, i32 1
  %12 = load ptr, ptr %11, align 8
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %1
  %.0.lcssa = phi ptr [ %split, %..loopexit_crit_edge ], [ %2, %1 ]
  br label %14

14:                                               ; preds = %.loopexit, %9
  %.07 = phi ptr [ %.0.lcssa, %.loopexit ], [ %.0.lcssa6, %9 ]
...
15:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %17, label %.lr.ph13, label %25

.lr.ph13:                                         ; preds = %15
  br label %18

18:                                               ; preds = %.lr.ph13, %21
  %.111 = phi i32 [ %.0.lcssa, %.lr.ph13 ], [ %22, %21 ]
  %19 = sext i32 %.111 to i64
  %20 = getelementptr inbounds i32, ptr %6, i64 %19
  store i32 %0, ptr %20, align 4
  br label %21

21:                                               ; preds = %18
  %22 = add nsw i32 %.111, 1
  %23 = load i32, ptr @ncol, align 4
  %24 = icmp ne i32 %22, %23
  br i1 %24, label %18, label %._crit_edge14, !llvm.loop !19

._crit_edge14:                                    ; preds = %21
  br label %25

25:                                               ; preds = %._crit_edge14, %15
  ret ptr %6
}
...
define dso_local ptr @make_list(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %7 = icmp ne i32 0, %6
  br i1 %7, label %.lr.ph45, label %65

.lr.ph45:                                         ; preds = %3
  br label %8

8:                                                ; preds = %.lr.ph45, %61
  %.043 = phi ptr [ %4, %.lr.ph45 ], [ %.1.lcssa, %61 ]
  %.03242 = phi i32 [ 0, %.lr.ph45 ], [ %62, %61 ]
...
11:                                               ; preds = %.lr.ph, %56
  %.140 = phi ptr [ %.043, %.lr.ph ], [ %.2, %56 ]
  %.13339 = phi i32 [ %.03242, %.lr.ph ], [ %.3, %56 ]
  %.03538 = phi i32 [ 0, %.lr.ph ], [ %57, %56 ]
  %12 = call ptr @make_data(i32 noundef %.13339, i32 noundef %.03538)
...
15:                                               ; preds = %11
  ...
  %17 = getelementptr inbounds nuw %struct._list, ptr %.140, i32 0, i32 1
  store ptr %16, ptr %17, align 8
  %18 = call ptr @copy_data(ptr noundef %12)
  %19 = getelementptr inbounds nuw %struct._list, ptr %.140, i32 0, i32 1
  %20 = load ptr, ptr %19, align 8
  %21 = getelementptr inbounds nuw %struct._list, ptr %20, i32 0, i32 0
  store ptr %18, ptr %21, align 8
  %22 = getelementptr inbounds nuw %struct._list, ptr %.140, i32 0, i32 1
  %23 = load ptr, ptr %22, align 8
  %24 = getelementptr inbounds nuw %struct._list, ptr %23, i32 0, i32 1
  store ptr null, ptr %24, align 8
  %25 = getelementptr inbounds nuw %struct._list, ptr %.140, i32 0, i32 1
...
46:                                               ; preds = %45, %34, %31
  %.136 = phi i32 [ %.03538, %31 ], [ %39, %45 ], [ %.03538, %34 ]
  %.234 = phi i32 [ %.13339, %31 ], [ %41, %45 ], [ %.13339, %34 ]
  br label %55

47:                                               ; preds = %11
  %48 = icmp eq i32 %.03538, 0
...
52:                                               ; preds = %49, %47
  %.4 = phi i32 [ %51, %49 ], [ %.13339, %47 ]
  %53 = load i32, ptr @ncol, align 4
  %54 = sub nsw i32 %53, 1
  br label %55

55:                                               ; preds = %52, %46
  %.237 = phi i32 [ %54, %52 ], [ %.136, %46 ]
  %.3 = phi i32 [ %.4, %52 ], [ %.234, %46 ]
  %.2 = phi ptr [ %.140, %52 ], [ %26, %46 ]
  call void @free(ptr noundef %12)
  br label %56

56:                                               ; preds = %55
  %57 = add nsw i32 %.237, 1
...
._crit_edge:                                      ; preds = %56
  %split = phi i32 [ %.3, %56 ]
  %split41 = phi ptr [ %.2, %56 ]
  br label %60

60:                                               ; preds = %._crit_edge, %8
  %.133.lcssa = phi i32 [ %split, %._crit_edge ], [ %.03242, %8 ]
  %.1.lcssa = phi ptr [ %split41, %._crit_edge ], [ %.043, %8 ]
  br label %61
...
61:                                               ; preds = %60
  ...
  br i1 %64, label %8, label %._crit_edge46, !llvm.loop !21

._crit_edge46:                                    ; preds = %61
  br label %65

65:                                               ; preds = %._crit_edge46, %3
...
11:                                               ; preds = %.lr.ph, %47
  %.020 = phi ptr [ %4, %.lr.ph ], [ %.1, %47 ]
  %.01719 = phi ptr [ %5, %.lr.ph ], [ %.118, %47 ]
  %12 = call i32 @valid_data(ptr noundef %.01719)
  %13 = icmp ne i32 %12, 0
  br i1 %13, label %14, label %47

14:                                               ; preds = %11
  %15 = call ptr @malloc(i64 noundef 32) #3
  %16 = getelementptr inbounds nuw %struct._play, ptr %.020, i32 0, i32 3
...
19:                                               ; preds = %14
  %20 = getelementptr inbounds nuw %struct._play, ptr %.020, i32 0, i32 3
  %21 = load ptr, ptr %20, align 8
  store ptr %21, ptr @game_tree, align 8
  br label %22

22:                                               ; preds = %19, %14
  %23 = call ptr @copy_data(ptr noundef %.01719)
  %24 = getelementptr inbounds nuw %struct._play, ptr %.020, i32 0, i32 3
  %25 = load ptr, ptr %24, align 8
  %26 = getelementptr inbounds nuw %struct._play, ptr %25, i32 0, i32 1
  store ptr %23, ptr %26, align 8
  %27 = call ptr @make_list(ptr noundef %.01719, ptr noundef %3, ptr noundef %2)
  %28 = getelementptr inbounds nuw %struct._play, ptr %.020, i32 0, i32 3
  %29 = load ptr, ptr %28, align 8
  %30 = getelementptr inbounds nuw %struct._play, ptr %29, i32 0, i32 2
  store ptr %27, ptr %30, align 8
  %31 = load i32, ptr %3, align 4
  %32 = getelementptr inbounds nuw %struct._play, ptr %.020, i32 0, i32 3
  %33 = load ptr, ptr %32, align 8
  %34 = getelementptr inbounds nuw %struct._play, ptr %33, i32 0, i32 0
  store i32 %31, ptr %34, align 8
  %35 = getelementptr inbounds nuw %struct._play, ptr %.020, i32 0, i32 3
  %36 = load ptr, ptr %35, align 8
  %37 = getelementptr inbounds nuw %struct._play, ptr %36, i32 0, i32 3
  store ptr null, ptr %37, align 8
  %38 = getelementptr inbounds nuw %struct._play, ptr %.020, i32 0, i32 3
...
42:                                               ; preds = %22
  call void @free(ptr noundef %.01719)
...
46:                                               ; preds = %42, %22
  %.2 = phi ptr [ %45, %42 ], [ %.01719, %22 ]
  br label %47

47:                                               ; preds = %46, %11
  %.118 = phi ptr [ %.2, %46 ], [ %.01719, %11 ]
  %.1 = phi ptr [ %39, %46 ], [ %.020, %11 ]
  %48 = call i32 @next_data(ptr noundef %.118)
  %49 = icmp ne i32 %48, 0
...
define dso_local void @make_wanted(ptr noundef %0) #0 {
  ...
  %5 = icmp ne i32 0, %4
  br i1 %5, label %.lr.ph33, label %43

.lr.ph33:                                         ; preds = %1
  br label %6

6:                                                ; preds = %.lr.ph33, %39
  %.031 = phi ptr [ %2, %.lr.ph33 ], [ %.1.lcssa, %39 ]
  %.02130 = phi i32 [ 0, %.lr.ph33 ], [ %40, %39 ]
...
9:                                                ; preds = %.lr.ph, %34
  %.128 = phi ptr [ %.031, %.lr.ph ], [ %.2, %34 ]
  %.12227 = phi i32 [ %.02130, %.lr.ph ], [ %.223, %34 ]
  %.02426 = phi i32 [ 0, %.lr.ph ], [ %35, %34 ]
  %10 = call ptr @make_data(i32 noundef %.12227, i32 noundef %.02426)
...
13:                                               ; preds = %9
  ...
  %15 = getelementptr inbounds nuw %struct._list, ptr %.128, i32 0, i32 1
  store ptr %14, ptr %15, align 8
  %16 = call ptr @copy_data(ptr noundef %10)
  %17 = getelementptr inbounds nuw %struct._list, ptr %.128, i32 0, i32 1
  %18 = load ptr, ptr %17, align 8
  %19 = getelementptr inbounds nuw %struct._list, ptr %18, i32 0, i32 0
  store ptr %16, ptr %19, align 8
  %20 = getelementptr inbounds nuw %struct._list, ptr %.128, i32 0, i32 1
  %21 = load ptr, ptr %20, align 8
  %22 = getelementptr inbounds nuw %struct._list, ptr %21, i32 0, i32 1
  store ptr null, ptr %22, align 8
  %23 = getelementptr inbounds nuw %struct._list, ptr %.128, i32 0, i32 1
  %24 = load ptr, ptr %23, align 8
  br label %33

25:                                               ; preds = %9
  %26 = icmp eq i32 %.02426, 0
...
30:                                               ; preds = %27, %25
  %.3 = phi i32 [ %29, %27 ], [ %.12227, %25 ]
  %31 = load i32, ptr @ncol, align 4
  %32 = sub nsw i32 %31, 1
  br label %33

33:                                               ; preds = %30, %13
  %.125 = phi i32 [ %32, %30 ], [ %.02426, %13 ]
  %.223 = phi i32 [ %.3, %30 ], [ %.12227, %13 ]
  %.2 = phi ptr [ %.128, %30 ], [ %24, %13 ]
  call void @free(ptr noundef %10)
  br label %34

34:                                               ; preds = %33
  %35 = add nsw i32 %.125, 1
  %36 = load i32, ptr @ncol, align 4
  %37 = icmp ne i32 %35, %36
  br i1 %37, label %9, label %._crit_edge, !llvm.loop !23

._crit_edge:                                      ; preds = %34
  %split = phi i32 [ %.223, %34 ]
  %split29 = phi ptr [ %.2, %34 ]
  br label %38

38:                                               ; preds = %._crit_edge, %6
  %.122.lcssa = phi i32 [ %split, %._crit_edge ], [ %.02130, %6 ]
  %.1.lcssa = phi ptr [ %split29, %._crit_edge ], [ %.031, %6 ]
  br label %39
...
39:                                               ; preds = %38
  ...
  br i1 %42, label %6, label %._crit_edge34, !llvm.loop !24

._crit_edge34:                                    ; preds = %39
  br label %43

43:                                               ; preds = %._crit_edge34, %1
...
5:                                                ; preds = %.lr.ph, %5
  ...
  %6 = getelementptr inbounds nuw %struct._play, ptr %.04, i32 0, i32 3
  %7 = load ptr, ptr %6, align 8
...
11:                                               ; preds = %._crit_edge, %1
  %.0.lcssa = phi ptr [ %split, %._crit_edge ], [ %0, %1 ]
  %12 = getelementptr inbounds nuw %struct._play, ptr %.0.lcssa, i32 0, i32 2
...
9:                                                ; preds = %0
  ...
  br i1 %18, label %.lr.ph29, label %40
...
34:                                               ; preds = %19
  ...
  br i1 %39, label %19, label %._crit_edge30, !llvm.loop !29

._crit_edge30:                                    ; preds = %34
  br label %40

40:                                               ; preds = %._crit_edge30, %9
  br label %83
...
41:                                               ; preds = %0
  ...
  br i1 %48, label %.lr.ph26, label %60

.lr.ph26:                                         ; preds = %41
  br label %49

49:                                               ; preds = %.lr.ph26, %58
  %.02024 = phi i32 [ 0, %.lr.ph26 ], [ %.1, %58 ]
  %.02123 = phi ptr [ %47, %.lr.ph26 ], [ %51, %58 ]
  %50 = call ptr @where(ptr noundef %.02123, ptr noundef %44)
  %51 = call ptr @get_good_move(ptr noundef %50)
  %52 = icmp ne ptr %51, null
  br i1 %52, label %53, label %58

53:                                               ; preds = %49
  call void @get_real_move(ptr noundef %51, ptr noundef %.02123, ptr noundef %1, ptr noundef %2)
  %54 = load i32, ptr %1, align 4
  %55 = load i32, ptr %2, align 4
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.02024, i32 noundef %54, i32 noundef %55)
  %57 = sub nsw i32 1, %.02024
  call void @free(ptr noundef %.02123)
  br label %58

58:                                               ; preds = %53, %49
  %.1 = phi i32 [ %57, %53 ], [ %.02024, %49 ]
  %59 = icmp ne ptr %51, null
  br i1 %59, label %49, label %._crit_edge27, !llvm.loop !30

._crit_edge27:                                    ; preds = %58
  %split = phi i32 [ %.1, %58 ]
  br label %60

60:                                               ; preds = %._crit_edge27, %41
  %.020.lcssa = phi i32 [ %split, %._crit_edge27 ], [ 0, %41 ]
  call void @dump_play(ptr noundef %44)
  %61 = sub nsw i32 1, %.020.lcssa
...
71:                                               ; preds = %.lr.ph, %78
  %.022 = phi ptr [ %69, %.lr.ph ], [ %80, %78 ]
  %72 = getelementptr inbounds nuw %struct._play, ptr %.022, i32 0, i32 0
  %73 = load i32, ptr %72, align 8
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %75, label %78

75:                                               ; preds = %71
  %76 = getelementptr inbounds nuw %struct._play, ptr %.022, i32 0, i32 1
  %77 = load ptr, ptr %76, align 8
  call void @show_move(ptr noundef %77)
  br label %78

78:                                               ; preds = %75, %71
  %79 = getelementptr inbounds nuw %struct._play, ptr %.022, i32 0, i32 3
