...
11:                                               ; preds = %.lr.ph, %56
  %.18 = phi i32 [ %.07, %.lr.ph ], [ %.4, %56 ]
  %.04 = phi i32 [ 0, %.lr.ph ], [ %57, %56 ]
  %.1 = phi ptr [ %.0, %.lr.ph ], [ %.3, %56 ]
  %12 = call ptr @make_data(i32 noundef %.18, i32 noundef %.04)
...
46:                                               ; preds = %45, %34, %31
  %.310 = phi i32 [ %.18, %31 ], [ %41, %45 ], [ %.18, %34 ]
  %.15 = phi i32 [ %.04, %31 ], [ %39, %45 ], [ %.04, %34 ]
  br label %55
...
52:                                               ; preds = %49, %47
  %.5 = phi i32 [ %51, %49 ], [ %.18, %47 ]
  %53 = load i32, ptr @ncol, align 4
  %54 = sub nsw i32 %53, 1
  br label %55

55:                                               ; preds = %52, %46
  %.4 = phi i32 [ %.5, %52 ], [ %.310, %46 ]
  %.26 = phi i32 [ %54, %52 ], [ %.15, %46 ]
...
11:                                               ; preds = %.lr.ph, %47
  %.01 = phi ptr [ %4, %.lr.ph ], [ %.12, %47 ]
  %.0 = phi ptr [ %5, %.lr.ph ], [ %.1, %47 ]
...
22:                                               ; preds = %19, %14
  ...
  %35 = getelementptr inbounds nuw %struct._play, ptr %.01, i32 0, i32 3
  %36 = load ptr, ptr %35, align 8
  %37 = getelementptr inbounds nuw %struct._play, ptr %36, i32 0, i32 3
  store ptr null, ptr %37, align 8
  %38 = getelementptr inbounds nuw %struct._play, ptr %.01, i32 0, i32 3
...
46:                                               ; preds = %42, %22
  %.2 = phi ptr [ %45, %42 ], [ %.0, %22 ]
  br label %47

47:                                               ; preds = %46, %11
  %.12 = phi ptr [ %39, %46 ], [ %.01, %11 ]
  %.1 = phi ptr [ %.2, %46 ], [ %.0, %11 ]
...
9:                                                ; preds = %.lr.ph, %34
  %.08 = phi i32 [ 0, %.lr.ph ], [ %35, %34 ]
  %.15 = phi i32 [ %.04, %.lr.ph ], [ %.37, %34 ]
  %.1 = phi ptr [ %.0, %.lr.ph ], [ %.3, %34 ]
  %10 = call ptr @make_data(i32 noundef %.15, i32 noundef %.08)
...
30:                                               ; preds = %27, %25
  %.4 = phi i32 [ %29, %27 ], [ %.15, %25 ]
  %31 = load i32, ptr @ncol, align 4
  %32 = sub nsw i32 %31, 1
  br label %33

33:                                               ; preds = %30, %13
  %.19 = phi i32 [ %32, %30 ], [ %.08, %13 ]
  %.37 = phi i32 [ %.4, %30 ], [ %.15, %13 ]
...
19:                                               ; preds = %14
  %20 = getelementptr inbounds nuw %struct._list, ptr %.01, i32 0, i32 0
  %21 = load ptr, ptr %20, align 8
...
49:                                               ; preds = %.lr.ph2, %58
  %.08 = phi ptr [ %47, %.lr.ph2 ], [ %51, %58 ]
  %.07 = phi i32 [ 0, %.lr.ph2 ], [ %.2, %58 ]
  %50 = call ptr @where(ptr noundef %.08, ptr noundef %44)
  %51 = call ptr @get_good_move(ptr noundef %50)
  %52 = icmp ne ptr %51, null
  br i1 %52, label %53, label %58

53:                                               ; preds = %49
  call void @get_real_move(ptr noundef %51, ptr noundef %.08, ptr noundef %1, ptr noundef %2)
  %54 = load i32, ptr %1, align 4
  %55 = load i32, ptr %2, align 4
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.07, i32 noundef %54, i32 noundef %55)
  %57 = sub nsw i32 1, %.07
  call void @free(ptr noundef %.08)
  br label %58

58:                                               ; preds = %53, %49
  %.2 = phi i32 [ %57, %53 ], [ %.07, %49 ]
