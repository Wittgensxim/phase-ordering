...
9:                                                ; preds = %4
  %10 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 1
  %11 = load ptr, ptr %10, align 8
...
9:                                                ; preds = %6, %52
  %.035 = phi i32 [ %53, %52 ], [ 0, %6 ]
  %.133 = phi i32 [ %.3, %52 ], [ %.032, %6 ]
  %.1 = phi ptr [ %.2, %52 ], [ %.0, %6 ]
  %10 = load i32, ptr @ncol, align 4
  %11 = icmp ne i32 %.035, %10
  br i1 %11, label %12, label %54

12:                                               ; preds = %9
  %13 = call ptr @make_data(i32 noundef %.133, i32 noundef %.035)
...
46:                                               ; preds = %12
  %47 = icmp eq i32 %.035, 0
  %48 = load i32, ptr @nrow, align 4
  %49 = sub nsw i32 %48, 1
  %.4 = select i1 %47, i32 %49, i32 %.133
  %50 = load i32, ptr @ncol, align 4
  %51 = sub nsw i32 %50, 1
  br label %52

52:                                               ; preds = %32, %35, %45, %38, %46
  %.237 = phi i32 [ %51, %46 ], [ %.035, %32 ], [ %.035, %35 ], [ %40, %45 ], [ %40, %38 ]
  %.3 = phi i32 [ %.4, %46 ], [ %.133, %32 ], [ %.133, %35 ], [ %42, %45 ], [ %42, %38 ]
  %.2 = phi ptr [ %.1, %46 ], [ %27, %38 ], [ %27, %45 ], [ %27, %35 ], [ %27, %32 ]
  call void @free(ptr noundef %13)
  %53 = add nsw i32 %.237, 1
...
47:                                               ; preds = %23, %43, %12
  %.118 = phi ptr [ %.017, %12 ], [ %46, %43 ], [ %.017, %23 ]
  %.1 = phi ptr [ %.0, %12 ], [ %40, %43 ], [ %40, %23 ]
...
7:                                                ; preds = %4, %32
  %.024 = phi i32 [ %33, %32 ], [ 0, %4 ]
  %.122 = phi i32 [ %.223, %32 ], [ %.021, %4 ]
  %.1 = phi ptr [ %.2, %32 ], [ %.0, %4 ]
...
10:                                               ; preds = %7
  %11 = call ptr @make_data(i32 noundef %.122, i32 noundef %.024)
...
26:                                               ; preds = %10
  %27 = icmp eq i32 %.024, 0
  %28 = load i32, ptr @nrow, align 4
  %29 = sub nsw i32 %28, 1
  %.3 = select i1 %27, i32 %29, i32 %.122
  %30 = load i32, ptr @ncol, align 4
  %31 = sub nsw i32 %30, 1
  br label %32

32:                                               ; preds = %26, %14
  %.125 = phi i32 [ %31, %26 ], [ %.024, %14 ]
  %.223 = phi i32 [ %.3, %26 ], [ %.122, %14 ]
  %.2 = phi ptr [ %.1, %26 ], [ %25, %14 ]
  call void @free(ptr noundef %11)
  %33 = add nsw i32 %.125, 1
...
7:                                                ; preds = %3
  %8 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 0
  %9 = load ptr, ptr %8, align 8
...
12:                                               ; preds = %7
  %13 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 1
  %14 = load ptr, ptr %13, align 8
  br label %3, !llvm.loop !25

.critedge:                                        ; preds = %3, %7
  %15 = getelementptr inbounds nuw %struct._list, ptr %.0, i32 0, i32 0
  %16 = load ptr, ptr %15, align 8
  %17 = call ptr @copy_data(ptr noundef %16)
  br label %18

18:                                               ; preds = %1, %.critedge
  %.06 = phi ptr [ %17, %.critedge ], [ null, %1 ]
  ret ptr %.06
}
...
44:                                               ; preds = %55, %37
  %.021 = phi ptr [ %43, %37 ], [ %48, %55 ]
  %.020 = phi i32 [ 0, %37 ], [ %.1, %55 ]
  %45 = icmp ne ptr %.021, null
  br i1 %45, label %46, label %56

46:                                               ; preds = %44
  %47 = call ptr @where(ptr noundef %.021, ptr noundef %40)
  %48 = call ptr @get_good_move(ptr noundef %47)
  %49 = icmp ne ptr %48, null
  br i1 %49, label %50, label %55

50:                                               ; preds = %46
  call void @get_real_move(ptr noundef %48, ptr noundef %.021, ptr noundef %1, ptr noundef %2)
  %51 = load i32, ptr %1, align 4
  %52 = load i32, ptr %2, align 4
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str.15, i32 noundef %.020, i32 noundef %51, i32 noundef %52)
  %54 = sub nsw i32 1, %.020
  call void @free(ptr noundef %.021)
  br label %55

55:                                               ; preds = %50, %46
  %.1 = phi i32 [ %54, %50 ], [ %.020, %46 ]
  br label %44, !llvm.loop !30

56:                                               ; preds = %44
  call void @dump_play(ptr noundef %40)
  %57 = sub nsw i32 1, %.020
