...
.preheader2:                                      ; preds = %4, %85
  %.02 = phi i32 [ %86, %85 ], [ 1, %4 ]
  %exitcond8 = icmp ne i32 %.02, 5
  br i1 %exitcond8, label %.preheader1, label %.loopexit3

.preheader1:                                      ; preds = %.preheader2, %.loopexit
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %.loopexit ], [ 0, %.preheader2 ]
  %32 = load i32, ptr @listLength, align 4
  %33 = add nsw i32 %32, %0
  %34 = sext i32 %33 to i64
  %35 = icmp slt i64 %indvars.iv5, %34
  br i1 %35, label %36, label %85

36:                                               ; preds = %.preheader1
  %37 = trunc nuw nsw i64 %indvars.iv5 to i32
  %38 = shl nuw i32 1, %37
  %39 = and i32 %38, %1
  %.not1 = icmp eq i32 %39, 0
  br i1 %.not1, label %.preheader, label %.loopexit

.preheader:                                       ; preds = %36, %84
  %indvars.iv = phi i64 [ %indvars.iv.next, %84 ], [ 0, %36 ]
  %exitcond = icmp ne i64 %indvars.iv, %indvars.iv5
  br i1 %exitcond, label %40, label %.loopexit
...
44:                                               ; preds = %40
  ...
  %46 = getelementptr inbounds nuw [4 x i8], ptr %45, i64 %indvars.iv5
  %47 = load i32, ptr %46, align 4
  %48 = getelementptr inbounds nuw [4 x i8], ptr %45, i64 %indvars.iv
  %49 = load i32, ptr %48, align 4
  switch i32 %.02, label %53 [
    i32 3, label %50
    i32 4, label %50
  ]
...
20:                                               ; preds = %15, %25
  %21 = phi i32 [ %.pre1, %25 ], [ %.pre, %15 ]
  %storemerge = phi i32 [ %27, %25 ], [ 1, %15 ]
...
split:                                            ; preds = %23, %._crit_edge
  %28 = phi i32 [ %.pre2, %._crit_edge ], [ %24, %23 ]
  %29 = icmp eq i32 %28, 0
