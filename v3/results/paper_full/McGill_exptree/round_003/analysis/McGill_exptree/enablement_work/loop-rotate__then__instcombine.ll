...
28:                                               ; preds = %26
  ...
  %31 = icmp slt i32 %30, %.pre1
  br i1 %31, label %26, label %.._crit_edge_crit_edge, !llvm.loop !17

split:                                            ; preds = %26
  br label %32

32:                                               ; preds = %split, %._crit_edge
  %33 = phi i1 [ false, %split ], [ %25, %._crit_edge ]
