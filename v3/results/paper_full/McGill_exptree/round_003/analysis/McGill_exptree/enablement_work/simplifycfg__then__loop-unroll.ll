...
23:                                               ; preds = %.preheader, %28
  %24 = phi i32 [ %.pre1, %28 ], [ %.pre, %.preheader ]
  %storemerge = phi i32 [ %30, %28 ], [ 1, %.preheader ]
...
26:                                               ; preds = %23
  ...
  br i1 %.not, label %28, label %split.loopexit
...
split:                                            ; preds = %split.loopexit, %._crit_edge
  %31 = phi i32 [ %.pre2, %._crit_edge ], [ %.lcssa, %split.loopexit ]
  %32 = icmp eq i32 %31, 0
