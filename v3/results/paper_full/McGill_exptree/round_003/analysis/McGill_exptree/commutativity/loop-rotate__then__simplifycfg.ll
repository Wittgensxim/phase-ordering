...
4:                                                ; preds = %2
  ...
  %8 = icmp eq i32 %0, %7
  br i1 %8, label %9, label %.preheader1
...
.preheader1:                                      ; preds = %4, %._crit_edge
  %.027 = phi i32 [ %89, %._crit_edge ], [ 1, %4 ]
  %32 = load i32, ptr @listLength, align 4
  %33 = add nsw i32 %32, %0
  %34 = icmp slt i32 0, %33
  br i1 %34, label %.lr.ph6, label %._crit_edge

.lr.ph6:                                          ; preds = %.preheader1, %.loopexit
  %.045 = phi i32 [ %85, %.loopexit ], [ 0, %.preheader1 ]
  %35 = shl nuw i32 1, %.045
  %36 = and i32 %35, %1
  %.not1 = icmp eq i32 %36, 0
  %37 = icmp samesign ult i32 0, %.045
  %or.cond9 = select i1 %.not1, i1 %37, i1 false
  br i1 %or.cond9, label %.lr.ph, label %.loopexit

.lr.ph:                                           ; preds = %.lr.ph6, %82
  %.034 = phi i32 [ %83, %82 ], [ 0, %.lr.ph6 ]
  %38 = shl nuw i32 1, %.034
  %39 = and i32 %38, %1
  %.not2 = icmp eq i32 %39, 0
  br i1 %.not2, label %40, label %82

40:                                               ; preds = %.lr.ph
  %41 = load ptr, ptr @workList, align 8
  %42 = zext nneg i32 %.045 to i64
  %43 = getelementptr inbounds nuw [4 x i8], ptr %41, i64 %42
  %44 = load i32, ptr %43, align 4
  %45 = zext nneg i32 %.034 to i64
  %46 = getelementptr inbounds nuw [4 x i8], ptr %41, i64 %45
  %47 = load i32, ptr %46, align 4
  switch i32 %.027, label %51 [
    i32 3, label %48
    i32 4, label %48
  ]
...
48:                                               ; preds = %40, %40
  ...
  br i1 %or.cond, label %82, label %51

51:                                               ; preds = %48, %40
  %52 = icmp eq i32 %44, 0
  %53 = icmp eq i32 %47, 0
  %or.cond1 = select i1 %52, i1 true, i1 %53
  br i1 %or.cond1, label %82, label %54

54:                                               ; preds = %51
  %55 = icmp eq i32 %.027, 4
  br i1 %55, label %56, label %.critedge

56:                                               ; preds = %54
  %57 = srem i32 %44, %47
  %.not3 = icmp eq i32 %57, 0
  br i1 %.not3, label %58, label %82

58:                                               ; preds = %56
  %.old3 = icmp slt i32 %44, %47
  br i1 %.old3, label %60, label %61

.critedge:                                        ; preds = %54
  %.old = icmp eq i32 %.027, 2
  %59 = icmp slt i32 %44, %47
  %or.cond4 = select i1 %.old, i1 %59, i1 false
  br i1 %or.cond4, label %60, label %61

60:                                               ; preds = %.critedge, %58
  br label %61

61:                                               ; preds = %60, %.critedge, %58
  %.01 = phi i32 [ %47, %60 ], [ %44, %58 ], [ %44, %.critedge ]
  %.0 = phi i32 [ %44, %60 ], [ %47, %58 ], [ %47, %.critedge ]
  %62 = or i32 %1, %35
  %63 = or i32 %62, %38
  %64 = load ptr, ptr @combList, align 8
  %65 = sext i32 %0 to i64
  %66 = getelementptr inbounds [12 x i8], ptr %64, i64 %65
  store i32 %.01, ptr %66, align 4
  ...
  %71 = getelementptr inbounds [12 x i8], ptr %70, i64 %65
  %72 = getelementptr inbounds nuw i8, ptr %71, i64 8
  store i32 %.027, ptr %72, align 4
  %73 = load ptr, ptr @combList, align 8
  %74 = getelementptr inbounds [12 x i8], ptr %73, i64 %65
  %75 = call i32 @calculate(ptr noundef %74)
  ...
  %81 = add nsw i32 %0, 1
  call void @recSearch(i32 noundef %81, i32 noundef %63)
  br label %82

82:                                               ; preds = %61, %56, %51, %48, %.lr.ph
  %83 = add nuw nsw i32 %.034, 1
  %84 = icmp samesign ult i32 %83, %.045
  br i1 %84, label %.lr.ph, label %.loopexit, !llvm.loop !13

.loopexit:                                        ; preds = %82, %.lr.ph6
  %85 = add nuw nsw i32 %.045, 1
  %86 = load i32, ptr @listLength, align 4
  %87 = add nsw i32 %86, %0
  %88 = icmp slt i32 %85, %87
  br i1 %88, label %.lr.ph6, label %._crit_edge, !llvm.loop !14

._crit_edge:                                      ; preds = %.loopexit, %.preheader1
  %89 = add nuw nsw i32 %.027, 1
  %90 = icmp samesign ult i32 %89, 5
  br i1 %90, label %.preheader1, label %.loopexit3, !llvm.loop !15

.loopexit3:                                       ; preds = %._crit_edge, %30, %24, %9, %2
  ret void
}
...
.lr.ph:                                           ; preds = %0, %14
  %.01 = phi i32 [ %15, %14 ], [ 0, %0 ]
  %2 = load ptr, ptr @workList, align 8
  %3 = zext nneg i32 %.01 to i64
...
14:                                               ; preds = %13, %.lr.ph
  ...
  br i1 %16, label %.lr.ph, label %._crit_edge3, !llvm.loop !16

._crit_edge3:                                     ; preds = %14, %0
  %17 = load i32, ptr @best, align 4
  %18 = load i32, ptr @goal, align 4
  %19 = icmp eq i32 %17, %18
  br i1 %19, label %20, label %21

20:                                               ; preds = %._crit_edge3
  %puts = call i32 @puts(ptr nonnull dereferenceable(1) @str.1)
  br label %33

21:                                               ; preds = %._crit_edge3
  store i32 1, ptr @dmax, align 4
  %22 = icmp slt i32 1, %.pre
  br i1 %22, label %.lr.ph5, label %._crit_edge
...
24:                                               ; preds = %.lr.ph5
  ...
  br i1 %27, label %.lr.ph5, label %._crit_edge, !llvm.loop !17

split:                                            ; preds = %.lr.ph5, %._crit_edge
  %28 = phi i32 [ %.pre2, %._crit_edge ], [ %23, %.lr.ph5 ]
  %29 = icmp eq i32 %28, 0
