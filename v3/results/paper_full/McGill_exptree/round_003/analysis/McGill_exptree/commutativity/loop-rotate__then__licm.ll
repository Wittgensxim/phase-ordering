...
60:                                               ; preds = %57
  br i1 %37, label %61, label %.critedge
...
15:                                               ; preds = %14, %4
  ...
  br i1 %18, label %4, label %._crit_edge3, !llvm.loop !16
...
24:                                               ; preds = %19
  ...
  br i1 %25, label %.lr.ph5, label %._crit_edge
...
32:                                               ; preds = %split, %._crit_edge
  %33 = phi i32 [ %.lcssa, %split ], [ %.pre2, %._crit_edge ]
  %34 = icmp eq i32 %33, 0
