...
3:                                                ; preds = %28, %2
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %29, label %4
...
32:                                               ; preds = %.preheader2, %89
  %.02 = phi i32 [ %90, %89 ], [ 1, %.preheader2 ]
  %exitcond8.not = icmp eq i32 %.02, 5
  br i1 %exitcond8.not, label %.loopexit3, label %.preheader1

.preheader1:                                      ; preds = %32
  br label %33

33:                                               ; preds = %.preheader1, %88
  %indvars.iv5 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next6, %88 ]
  %34 = load i32, ptr @listLength, align 4
  %35 = add nsw i32 %34, %0
  %36 = sext i32 %35 to i64
  %37 = icmp slt i64 %indvars.iv5, %36
  br i1 %37, label %38, label %89

38:                                               ; preds = %33
  %39 = trunc nuw nsw i64 %indvars.iv5 to i32
  %40 = shl nuw i32 1, %39
  %41 = and i32 %40, %1
...
42:                                               ; preds = %.preheader, %87
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv5
...
47:                                               ; preds = %43
  ...
  %49 = getelementptr inbounds nuw [4 x i8], ptr %48, i64 %indvars.iv5
...
21:                                               ; preds = %27, %20
  %22 = phi i32 [ %.pre, %20 ], [ %.pre1, %27 ]
  %storemerge = phi i32 [ 1, %20 ], [ %29, %27 ]
  store i32 %storemerge, ptr @dmax, align 4
  %23 = icmp slt i32 %storemerge, %22
  br i1 %23, label %25, label %._crit_edge
...
30:                                               ; preds = %split, %._crit_edge
  %31 = phi i1 [ false, %split ], [ %24, %._crit_edge ]
