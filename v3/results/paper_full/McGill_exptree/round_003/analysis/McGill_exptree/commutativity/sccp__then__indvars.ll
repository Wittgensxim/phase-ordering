...
32:                                               ; preds = %.preheader9, %89
  %.02 = phi i32 [ %90, %89 ], [ 1, %.preheader9 ]
  %exitcond15 = icmp ne i32 %.02, 5
  br i1 %exitcond15, label %.preheader8, label %.loopexit10

.preheader8:                                      ; preds = %32
  br label %33

33:                                               ; preds = %.preheader8, %88
  %indvars.iv12 = phi i64 [ 0, %.preheader8 ], [ %indvars.iv.next13, %88 ]
  %34 = load i32, ptr @listLength, align 4
  %35 = add nsw i32 %34, %0
  %36 = sext i32 %35 to i64
  %37 = icmp slt i64 %indvars.iv12, %36
...
42:                                               ; preds = %.preheader, %87
  ...
  %exitcond = icmp ne i64 %indvars.iv, %indvars.iv12
...
47:                                               ; preds = %43
  ...
  %49 = getelementptr inbounds nuw [4 x i8], ptr %48, i64 %indvars.iv12
...
21:                                               ; preds = %26, %20
  %22 = phi i32 [ %.pre, %20 ], [ %.pre1, %26 ]
  %storemerge = phi i32 [ 1, %20 ], [ %28, %26 ]
...
29:                                               ; preds = %split, %._crit_edge
  %30 = phi i32 [ %.lcssa, %split ], [ %.pre2, %._crit_edge ]
  %31 = icmp eq i32 %30, 0
