...
24:                                               ; preds = %.preheader, %29
  %25 = phi i32 [ %.pre1, %29 ], [ %.pre, %.preheader ]
  %storemerge = phi i32 [ %31, %29 ], [ 1, %.preheader ]
...
27:                                               ; preds = %24
  ...
  br i1 %.not, label %29, label %split.loopexit
...
split:                                            ; preds = %split.loopexit, %._crit_edge
  %32 = phi i32 [ %.pre2, %._crit_edge ], [ %.lcssa, %split.loopexit ]
  %33 = icmp eq i32 %32, 0
