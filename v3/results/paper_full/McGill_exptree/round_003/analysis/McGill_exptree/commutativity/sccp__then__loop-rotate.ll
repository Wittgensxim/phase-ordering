...
4:                                                ; preds = %2
  ...
  %8 = icmp eq i32 %0, %7
  br i1 %8, label %9, label %.preheader9
...
.preheader8:                                      ; preds = %.preheader9, %92
  %.0215 = phi i32 [ 1, %.preheader9 ], [ %93, %92 ]
  %32 = load i32, ptr @listLength, align 4
  %33 = add nsw i32 %32, %0
  %34 = icmp slt i32 0, %33
  br i1 %34, label %.lr.ph14, label %92

.lr.ph14:                                         ; preds = %.preheader8
  br label %35

35:                                               ; preds = %.lr.ph14, %87
  %.0412 = phi i32 [ 0, %.lr.ph14 ], [ %88, %87 ]
  %36 = shl nuw i32 1, %.0412
  %37 = and i32 %36, %1
  %.not1 = icmp eq i32 %37, 0
  br i1 %.not1, label %.preheader, label %87

.preheader:                                       ; preds = %35
  %38 = icmp samesign ult i32 0, %.0412
...
39:                                               ; preds = %.lr.ph, %84
  %.0311 = phi i32 [ 0, %.lr.ph ], [ %85, %84 ]
  %40 = shl nuw i32 1, %.0311
  %41 = and i32 %40, %1
...
84:                                               ; preds = %63, %58, %53, %50, %39
  %85 = add nuw nsw i32 %.0311, 1
  %86 = icmp samesign ult i32 %85, %.0412
...
87:                                               ; preds = %.loopexit, %35
  %.0413 = phi i32 [ %.0412, %.loopexit ], [ %.0412, %35 ]
  %88 = add nuw nsw i32 %.0413, 1
...
92:                                               ; preds = %._crit_edge, %.preheader8
  %93 = add nuw nsw i32 %.0215, 1
  %94 = icmp samesign ult i32 %93, 5
  br i1 %94, label %.preheader8, label %.loopexit10, !llvm.loop !15

.loopexit10:                                      ; preds = %92
  br label %95

95:                                               ; preds = %.loopexit10, %30, %24, %9, %2
  ret void
}
...
15:                                               ; preds = %14, %2
  ...
  br i1 %17, label %2, label %._crit_edge4, !llvm.loop !16

._crit_edge4:                                     ; preds = %15
  br label %18

18:                                               ; preds = %._crit_edge4, %0
...
23:                                               ; preds = %18
  ...
  br i1 %24, label %.lr.ph6, label %._crit_edge
