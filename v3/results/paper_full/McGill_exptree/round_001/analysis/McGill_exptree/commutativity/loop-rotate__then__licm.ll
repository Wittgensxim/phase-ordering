...
35:                                               ; preds = %34
  ...
  br i1 %37, label %5, label %._crit_edge, !llvm.loop !11
...
39:                                               ; preds = %36, %117
  ...
  br i1 %42, label %.lr.ph4, label %116

.lr.ph4:                                          ; preds = %39
  %43 = icmp eq i32 %.026, 3
  %44 = icmp eq i32 %.026, 4
  %45 = icmp eq i32 %.026, 4
  %46 = icmp eq i32 %.026, 2
  br label %47
...
52:                                               ; preds = %47
  %53 = icmp slt i32 0, %.042
  br i1 %53, label %.lr.ph, label %110
...
84:                                               ; preds = %80, %79
  br i1 %45, label %86, label %85

85:                                               ; preds = %84
  br i1 %46, label %86, label %89

86:                                               ; preds = %85, %84
  %87 = icmp slt i32 %64, %67
...
89:                                               ; preds = %88, %86, %85
  %.01 = phi i32 [ %67, %88 ], [ %64, %86 ], [ %64, %85 ]
  %.0 = phi i32 [ %64, %88 ], [ %67, %86 ], [ %67, %85 ]
  %90 = or i32 %55, %57
  %91 = load ptr, ptr @combList, align 8
  %92 = getelementptr inbounds %struct.Comb, ptr %91, i64 %37
  store i32 %.01, ptr %92, align 4
  %93 = load ptr, ptr @combList, align 8
  %94 = getelementptr inbounds %struct.Comb, ptr %93, i64 %37
  %95 = getelementptr inbounds nuw %struct.Comb, ptr %94, i32 0, i32 1
  store i32 %.0, ptr %95, align 4
  %96 = load ptr, ptr @combList, align 8
  %97 = getelementptr inbounds %struct.Comb, ptr %96, i64 %37
  %98 = getelementptr inbounds nuw %struct.Comb, ptr %97, i32 0, i32 2
  store i32 %.026, ptr %98, align 4
  ...
  call void @recSearch(i32 noundef %38, i32 noundef %90)
  br label %107

107:                                              ; preds = %89, %83, %78, %73, %60
  %108 = add nsw i32 %.031, 1
  %109 = icmp slt i32 %108, %.042
  br i1 %109, label %56, label %._crit_edge, !llvm.loop !13

._crit_edge:                                      ; preds = %107
  br label %110

110:                                              ; preds = %._crit_edge, %52
  br label %111
...
111:                                              ; preds = %110, %51
  ...
  br i1 %115, label %47, label %._crit_edge5, !llvm.loop !14

._crit_edge5:                                     ; preds = %111
  br label %116

116:                                              ; preds = %._crit_edge5, %39
  br label %117

117:                                              ; preds = %116
  %118 = add nsw i32 %.026, 1
  %119 = icmp sle i32 %118, 4
  br i1 %119, label %39, label %120, !llvm.loop !15
...
6:                                                ; preds = %.lr.ph, %19
  %7 = phi i32 [ %best.promoted, %.lr.ph ], [ %18, %19 ]
...
19:                                               ; preds = %17
  ...
  br i1 %21, label %6, label %._crit_edge, !llvm.loop !16
...
28:                                               ; preds = %22
  ...
  br i1 %31, label %.lr.ph3, label %.loopexit
...
37:                                               ; preds = %36
  ...
  br i1 %42, label %32, label %..loopexit_crit_edge, !llvm.loop !17
