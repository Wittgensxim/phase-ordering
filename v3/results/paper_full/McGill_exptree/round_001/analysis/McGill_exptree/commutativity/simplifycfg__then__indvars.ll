...
33:                                               ; preds = %.preheader7, %93
  %.02 = phi i32 [ %94, %93 ], [ 1, %.preheader7 ]
  %exitcond13 = icmp ne i32 %.02, 5
  br i1 %exitcond13, label %.preheader6, label %.loopexit8

.preheader6:                                      ; preds = %33
  br label %34

34:                                               ; preds = %.preheader6, %92
  %indvars.iv10 = phi i64 [ 0, %.preheader6 ], [ %indvars.iv.next11, %92 ]
  %35 = load i32, ptr @listLength, align 4
  %36 = add nsw i32 %35, %0
  %37 = sext i32 %36 to i64
  %38 = icmp slt i64 %indvars.iv10, %37
  br i1 %38, label %39, label %93

39:                                               ; preds = %34
  %40 = trunc nuw nsw i64 %indvars.iv10 to i32
  %41 = shl i32 1, %40
  %42 = and i32 %41, %1
  %43 = icmp ne i32 %42, 0
...
50:                                               ; preds = %45
  ...
  %52 = getelementptr inbounds i32, ptr %51, i64 %indvars.iv10
...
69:                                               ; preds = %67, %.critedge
  br label %70

70:                                               ; preds = %67, %69, %.critedge
