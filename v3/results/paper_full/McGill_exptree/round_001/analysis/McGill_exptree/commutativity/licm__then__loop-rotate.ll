...
39:                                               ; preds = %36, %117
  ...
  %40 = icmp eq i32 %.026, 3
  %41 = icmp eq i32 %.026, 4
  %42 = icmp eq i32 %.026, 4
  %43 = icmp eq i32 %.026, 2
  %44 = load i32, ptr @listLength, align 4
  %45 = add nsw i32 %44, %0
  %46 = icmp slt i32 0, %45
  br i1 %46, label %.lr.ph4, label %116
...
52:                                               ; preds = %47
  ...
  %54 = or i32 %1, %48
  %55 = icmp slt i32 0, %.042
  br i1 %55, label %.lr.ph, label %110
...
5:                                                ; preds = %.lr.ph, %18
  %.01 = phi i32 [ 0, %.lr.ph ], [ %19, %18 ]
  %6 = phi i32 [ %best.promoted, %.lr.ph ], [ %17, %18 ]
...
18:                                               ; preds = %16
  ...
  br i1 %20, label %5, label %._crit_edge, !llvm.loop !16
