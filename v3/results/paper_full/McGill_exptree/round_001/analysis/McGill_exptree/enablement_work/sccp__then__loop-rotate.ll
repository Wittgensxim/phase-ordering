...
37:                                               ; preds = %36, %117
  %.0214 = phi i32 [ 1, %36 ], [ %118, %117 ]
  %38 = load i32, ptr @listLength, align 4
  %39 = add nsw i32 %38, %0
  %40 = icmp slt i32 0, %39
  br i1 %40, label %.lr.ph12, label %116

.lr.ph12:                                         ; preds = %37
  br label %41

41:                                               ; preds = %.lr.ph12, %111
  %.049 = phi i32 [ 0, %.lr.ph12 ], [ %112, %111 ]
  %42 = shl nuw i32 1, %.049
  %43 = and i32 %42, %1
  %44 = icmp ne i32 %43, 0
...
53:                                               ; preds = %48
  ...
  %61 = icmp eq i32 %.0214, 3
  br i1 %61, label %64, label %62

62:                                               ; preds = %53
  %63 = icmp eq i32 %.0214, 4
...
107:                                              ; preds = %86, %79, %73, %68, %52
  %108 = add nsw i32 %.038, 1
  %109 = icmp slt i32 %108, %.049
...
111:                                              ; preds = %110, %45
  %.0410 = phi i32 [ %.049, %110 ], [ %.049, %45 ]
  %112 = add nsw i32 %.0410, 1
  %113 = load i32, ptr @listLength, align 4
  %114 = add nsw i32 %113, %0
  %115 = icmp slt i32 %112, %114
  br i1 %115, label %41, label %._crit_edge13, !llvm.loop !14

._crit_edge13:                                    ; preds = %111
  br label %116

116:                                              ; preds = %._crit_edge13, %37
  br label %117

117:                                              ; preds = %116
  %118 = add nsw i32 %.0214, 1
