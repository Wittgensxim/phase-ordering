...
33:                                               ; preds = %5, %94
  %.02 = phi i32 [ %95, %94 ], [ 1, %5 ]
  %exitcond5 = icmp ne i32 %.02, 5
  br i1 %exitcond5, label %34, label %96

34:                                               ; preds = %33, %93
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %93 ], [ 0, %33 ]
  %35 = load i32, ptr @listLength, align 4
  %36 = add nsw i32 %35, %0
  %37 = sext i32 %36 to i64
  %38 = icmp slt i64 %indvars.iv2, %37
  br i1 %38, label %39, label %94

39:                                               ; preds = %34
  %40 = trunc nuw nsw i64 %indvars.iv2 to i32
  %41 = shl i32 1, %40
  %42 = and i32 %41, %1
  %43 = icmp ne i32 %42, 0
...
44:                                               ; preds = %39, %92
  %indvars.iv = phi i64 [ %indvars.iv.next, %92 ], [ 0, %39 ]
  %exitcond = icmp ne i64 %indvars.iv, %indvars.iv2
  br i1 %exitcond, label %45, label %93
...
50:                                               ; preds = %45
  ...
  %52 = getelementptr inbounds i32, ptr %51, i64 %indvars.iv2
...
56:                                               ; preds = %50, %50
  ...
  br i1 %or.cond, label %92, label %59

59:                                               ; preds = %56, %50
  %60 = icmp eq i32 %53, 0
  %61 = icmp eq i32 %55, 0
  %or.cond6 = select i1 %60, i1 true, i1 %61
  br i1 %or.cond6, label %92, label %62
...
67:                                               ; preds = %64
  %68 = icmp eq i32 %.02, 2
  %or.cond7 = or i1 %63, %68
  %.old8 = icmp slt i32 %53, %55
  %or.cond10 = select i1 %or.cond7, i1 %.old8, i1 false
  br i1 %or.cond10, label %70, label %71

.critedge:                                        ; preds = %62
  %.old = icmp eq i32 %.02, 2
  %69 = icmp slt i32 %53, %55
  %or.cond9 = select i1 %.old, i1 %69, i1 false
  br i1 %or.cond9, label %70, label %71

70:                                               ; preds = %67, %.critedge
  br label %71

71:                                               ; preds = %67, %70, %.critedge
  %.01 = phi i32 [ %55, %70 ], [ %53, %67 ], [ %53, %.critedge ]
  %.0 = phi i32 [ %53, %70 ], [ %55, %67 ], [ %55, %.critedge ]
  %72 = or i32 %1, %41
  %73 = or i32 %72, %47
...
13:                                               ; preds = %5, %5
  %.0.lcssa.wide = phi i64 [ %indvars.iv, %5 ], [ %indvars.iv, %5 ]
  %14 = trunc nuw nsw i64 %.0.lcssa.wide to i32
  %15 = icmp eq i32 %14, 0
  %spec.select2 = select i1 %15, i32 4, i32 %14
  %16 = sub nsw i32 %spec.select2, 1
