...
33:                                               ; preds = %5, %._crit_edge5
  %.026 = phi i32 [ %95, %._crit_edge5 ], [ 1, %5 ]
  %34 = load i32, ptr @listLength, align 4
  %35 = add nsw i32 %34, %0
  %36 = icmp slt i32 0, %35
  br i1 %36, label %.lr.ph4, label %._crit_edge5

.lr.ph4:                                          ; preds = %33, %._crit_edge
  %.042 = phi i32 [ %91, %._crit_edge ], [ 0, %33 ]
  %37 = shl i32 1, %.042
  %38 = and i32 %37, %1
  %39 = icmp eq i32 %38, 0
  %40 = icmp slt i32 0, %.042
  %or.cond13 = and i1 %39, %40
  br i1 %or.cond13, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %.lr.ph4, %88
  %.031 = phi i32 [ %89, %88 ], [ 0, %.lr.ph4 ]
  %41 = shl i32 1, %.031
  %42 = and i32 %41, %1
  %43 = icmp ne i32 %42, 0
...
52:                                               ; preds = %44, %44
  ...
  br i1 %or.cond, label %88, label %55

55:                                               ; preds = %52, %44
  %56 = icmp eq i32 %48, 0
  %57 = icmp eq i32 %51, 0
  %or.cond7 = select i1 %56, i1 true, i1 %57
  br i1 %or.cond7, label %88, label %58
...
63:                                               ; preds = %60
  %64 = icmp eq i32 %.026, 2
  %or.cond8 = or i1 %59, %64
  %.old9 = icmp slt i32 %48, %51
  %or.cond11 = select i1 %or.cond8, i1 %.old9, i1 false
  br i1 %or.cond11, label %66, label %67

.critedge:                                        ; preds = %58
  %.old = icmp eq i32 %.026, 2
  %65 = icmp slt i32 %48, %51
  %or.cond10 = select i1 %.old, i1 %65, i1 false
  br i1 %or.cond10, label %66, label %67

66:                                               ; preds = %63, %.critedge
  br label %67

67:                                               ; preds = %63, %66, %.critedge
  %.01 = phi i32 [ %51, %66 ], [ %48, %63 ], [ %48, %.critedge ]
  %.0 = phi i32 [ %48, %66 ], [ %51, %63 ], [ %51, %.critedge ]
  %68 = or i32 %1, %37
  %69 = or i32 %68, %41
...
88:                                               ; preds = %60, %55, %52, %.lr.ph, %67
  %89 = add nsw i32 %.031, 1
  %90 = icmp slt i32 %89, %.042
  br i1 %90, label %.lr.ph, label %._crit_edge, !llvm.loop !13

._crit_edge:                                      ; preds = %88, %.lr.ph4
  %91 = add nsw i32 %.042, 1
  %92 = load i32, ptr @listLength, align 4
  %93 = add nsw i32 %92, %0
  %94 = icmp slt i32 %91, %93
  br i1 %94, label %.lr.ph4, label %._crit_edge5, !llvm.loop !14

._crit_edge5:                                     ; preds = %33, %._crit_edge
  %95 = add nsw i32 %.026, 1
  %96 = icmp sle i32 %95, 4
  br i1 %96, label %33, label %97, !llvm.loop !15

97:                                               ; preds = %._crit_edge5, %10, %31, %25, %2
  ret void
}
...
24:                                               ; preds = %._crit_edge
  ...
  br i1 %27, label %.lr.ph3, label %.loopexit
...
30:                                               ; preds = %.lr.ph3
  ...
  br i1 %35, label %.lr.ph3, label %.loopexit, !llvm.loop !17

.loopexit:                                        ; preds = %24, %30, %.lr.ph3
