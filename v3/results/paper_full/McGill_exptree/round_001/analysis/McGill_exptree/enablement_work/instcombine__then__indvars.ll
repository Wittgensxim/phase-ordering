...
3:                                                ; preds = %29, %2
  ...
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %4, label %30
...
36:                                               ; preds = %110, %35
  ...
  br i1 %exitcond8, label %37, label %112

37:                                               ; preds = %36
  br label %38

38:                                               ; preds = %108, %37
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %108 ], [ 0, %37 ]
  %39 = load i32, ptr @listLength, align 4
  %40 = add nsw i32 %39, %0
  %41 = sext i32 %40 to i64
  %42 = icmp slt i64 %indvars.iv5, %41
  br i1 %42, label %43, label %109

43:                                               ; preds = %38
  %44 = trunc nuw nsw i64 %indvars.iv5 to i32
  %45 = shl nuw i32 1, %44
  %46 = and i32 %45, %1
...
49:                                               ; preds = %106, %48
  ...
  br i1 %exitcond, label %50, label %107
...
55:                                               ; preds = %50
  ...
  %57 = getelementptr inbounds nuw [4 x i8], ptr %56, i64 %indvars.iv5
...
17:                                               ; preds = %9
  %.0.lcssa.wide = phi i64 [ %indvars.iv, %9 ]
  %18 = trunc nuw nsw i64 %.0.lcssa.wide to i32
  %19 = icmp eq i32 %18, 0
