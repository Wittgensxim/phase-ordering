...
33:                                               ; preds = %5, %97
  %.02 = phi i32 [ %98, %97 ], [ 1, %5 ]
  %34 = icmp sle i32 %.02, 4
  br i1 %34, label %35, label %99

35:                                               ; preds = %33, %95
  %.04 = phi i32 [ %96, %95 ], [ 0, %33 ]
...
57:                                               ; preds = %49, %49
  ...
  br i1 %or.cond, label %93, label %60

60:                                               ; preds = %57, %49
  %61 = icmp eq i32 %53, 0
  %62 = icmp eq i32 %56, 0
  %or.cond8 = select i1 %61, i1 true, i1 %62
  br i1 %or.cond8, label %93, label %63
...
68:                                               ; preds = %65
  %69 = icmp eq i32 %.02, 2
  %or.cond9 = or i1 %64, %69
  %.old10 = icmp slt i32 %53, %56
  %or.cond12 = select i1 %or.cond9, i1 %.old10, i1 false
  br i1 %or.cond12, label %71, label %72

.critedge:                                        ; preds = %63
  %.old = icmp eq i32 %.02, 2
  %70 = icmp slt i32 %53, %56
  %or.cond11 = select i1 %.old, i1 %70, i1 false
  br i1 %or.cond11, label %71, label %72

71:                                               ; preds = %68, %.critedge
  br label %72

72:                                               ; preds = %68, %71, %.critedge
  %.01 = phi i32 [ %56, %71 ], [ %53, %68 ], [ %53, %.critedge ]
  %.0 = phi i32 [ %53, %71 ], [ %56, %68 ], [ %56, %.critedge ]
  %73 = or i32 %1, %40
  %74 = or i32 %73, %46
  %75 = load ptr, ptr @combList, align 8
  %76 = sext i32 %0 to i64
  %77 = getelementptr inbounds %struct.Comb, ptr %75, i64 %76
  store i32 %.01, ptr %77, align 4
  %78 = load ptr, ptr @combList, align 8
  %79 = getelementptr inbounds %struct.Comb, ptr %78, i64 %76
  %80 = getelementptr inbounds nuw %struct.Comb, ptr %79, i32 0, i32 1
  store i32 %.0, ptr %80, align 4
  %81 = load ptr, ptr @combList, align 8
  %82 = getelementptr inbounds %struct.Comb, ptr %81, i64 %76
  %83 = getelementptr inbounds nuw %struct.Comb, ptr %82, i32 0, i32 2
  store i32 %.02, ptr %83, align 4
  %84 = load ptr, ptr @combList, align 8
  %85 = getelementptr inbounds %struct.Comb, ptr %84, i64 %76
  ...
  %92 = add nsw i32 %0, 1
  call void @recSearch(i32 noundef %92, i32 noundef %74)
  br label %93

93:                                               ; preds = %65, %60, %57, %45, %72
  %94 = add nsw i32 %.03, 1
...
15:                                               ; preds = %5, %5
  %16 = icmp eq i32 %.0, 0
  %spec.select2 = select i1 %16, i32 4, i32 %.0
  %17 = sub nuw nsw i32 %spec.select2, 1
