...
5:                                                ; preds = %2
  ...
  %9 = icmp eq i32 %0, %8
  br i1 %9, label %10, label %.preheader7
...
.preheader6:                                      ; preds = %.preheader7, %97
  %.0212 = phi i32 [ 1, %.preheader7 ], [ %98, %97 ]
  %33 = load i32, ptr @listLength, align 4
  %34 = add nsw i32 %33, %0
  %35 = icmp slt i32 0, %34
  br i1 %35, label %.lr.ph11, label %97

.lr.ph11:                                         ; preds = %.preheader6
  br label %36

36:                                               ; preds = %.lr.ph11, %92
  %.0410 = phi i32 [ 0, %.lr.ph11 ], [ %93, %92 ]
  %37 = shl i32 1, %.0410
  %38 = and i32 %37, %1
  %39 = icmp ne i32 %38, 0
...
89:                                               ; preds = %61, %56, %53, %41, %68
  %90 = add nsw i32 %.039, 1
  %91 = icmp slt i32 %90, %.0410
  br i1 %91, label %41, label %..loopexit_crit_edge, !llvm.loop !13
...
92:                                               ; preds = %.loopexit, %36
  %93 = add nsw i32 %.0410, 1
  %94 = load i32, ptr @listLength, align 4
  %95 = add nsw i32 %94, %0
  %96 = icmp slt i32 %93, %95
  br i1 %96, label %36, label %._crit_edge, !llvm.loop !14

._crit_edge:                                      ; preds = %92
  br label %97

97:                                               ; preds = %._crit_edge, %.preheader6
  %98 = add nsw i32 %.0212, 1
  %99 = icmp sle i32 %98, 4
  br i1 %99, label %.preheader6, label %.loopexit8, !llvm.loop !15

.loopexit8:                                       ; preds = %97
  br label %100

100:                                              ; preds = %.loopexit8, %10, %31, %25, %2
  ret void
}
...
33:                                               ; preds = %30
  ...
  br i1 %38, label %30, label %._crit_edge5, !llvm.loop !17
