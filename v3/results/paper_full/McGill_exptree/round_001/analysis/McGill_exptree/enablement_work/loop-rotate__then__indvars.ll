...
37:                                               ; preds = %36, %115
  %.026 = phi i32 [ 1, %36 ], [ %116, %115 ]
  %38 = load i32, ptr @listLength, align 4
  %39 = add nsw i32 %38, %0
  %40 = icmp slt i32 0, %39
  br i1 %40, label %.lr.ph4, label %114

.lr.ph4:                                          ; preds = %37
  br label %41

41:                                               ; preds = %.lr.ph4, %109
  %indvars.iv8 = phi i64 [ 0, %.lr.ph4 ], [ %indvars.iv.next9, %109 ]
  %42 = trunc nuw nsw i64 %indvars.iv8 to i32
  %43 = shl i32 1, %42
  %44 = and i32 %43, %1
  %45 = icmp ne i32 %44, 0
...
47:                                               ; preds = %41
  %48 = icmp samesign ult i64 0, %indvars.iv8
  br i1 %48, label %.lr.ph, label %108
...
55:                                               ; preds = %49
  ...
  %57 = getelementptr inbounds i32, ptr %56, i64 %indvars.iv8
  %58 = load i32, ptr %57, align 4
  %59 = getelementptr inbounds i32, ptr %56, i64 %indvars.iv
...
107:                                              ; preds = %86, %79, %73, %68, %54
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp ne i64 %indvars.iv.next, %indvars.iv8
  br i1 %exitcond, label %49, label %._crit_edge, !llvm.loop !13

._crit_edge:                                      ; preds = %107
  br label %108

108:                                              ; preds = %._crit_edge, %47
  br label %109
...
109:                                              ; preds = %108, %46
  ...
  %113 = icmp slt i64 %indvars.iv.next9, %112
  br i1 %113, label %41, label %._crit_edge5, !llvm.loop !14

._crit_edge5:                                     ; preds = %109
  br label %114

114:                                              ; preds = %._crit_edge5, %37
  br label %115

115:                                              ; preds = %114
  %116 = add nuw nsw i32 %.026, 1
  %exitcond11 = icmp ne i32 %116, 5
  br i1 %exitcond11, label %37, label %117, !llvm.loop !15
...
26:                                               ; preds = %20
  ...
  br i1 %29, label %.lr.ph3, label %.loopexit
...
35:                                               ; preds = %34
  ...
  br i1 %40, label %30, label %..loopexit_crit_edge, !llvm.loop !17
