...
7:                                                ; preds = %30, %.lr.ph.new
  %.01 = phi i32 [ 0, %.lr.ph.new ], [ %31, %30 ]
...
32:                                               ; preds = %37, %.epil.preheader
  %.01.epil = phi i32 [ %.01.epil.init, %.epil.preheader ], [ %38, %37 ]
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %37 ]
...
._crit_edge.epilog-lcssa:                         ; preds = %37
  br label %._crit_edge
...
6:                                                ; preds = %25, %.lr.ph.new
  %.01 = phi i32 [ 0, %.lr.ph.new ], [ %26, %25 ]
  %niter = phi i32 [ 0, %.lr.ph.new ], [ %niter.next.3, %25 ]
...
20:                                               ; preds = %15
  %21 = add nuw nsw i32 %.01, 3
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds %struct.Comb, ptr %0, i64 %22
...
27:                                               ; preds = %31, %.epil.preheader
  %.01.epil = phi i32 [ %.01.epil.init, %.epil.preheader ], [ %32, %31 ]
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %31 ]
  %28 = sext i32 %.01.epil to i64
...
31:                                               ; preds = %27
  %32 = add nsw i32 %.01.epil, 1
  %33 = icmp slt i32 %32, %1
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp = icmp ne i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp, label %27, label %._crit_edge.epilog-lcssa, !llvm.loop !12

._crit_edge.epilog-lcssa:                         ; preds = %31
  br label %._crit_edge
...
18:                                               ; preds = %7
  ...
  %22 = load i32, ptr %21, align 4
  %23 = getelementptr inbounds %struct.Comb, ptr %0, i64 %20
  store i32 %22, ptr %23, align 4
  %24 = getelementptr inbounds nuw %struct.Comb, ptr %21, i32 0, i32 1
  %25 = load i32, ptr %24, align 4
  %26 = getelementptr inbounds nuw %struct.Comb, ptr %23, i32 0, i32 1
  store i32 %25, ptr %26, align 4
  %27 = getelementptr inbounds nuw %struct.Comb, ptr %21, i32 0, i32 2
  %28 = load i32, ptr %27, align 4
  %29 = getelementptr inbounds nuw %struct.Comb, ptr %23, i32 0, i32 2
  store i32 %28, ptr %29, align 4
  br label %30
...
32:                                               ; preds = %.epil.preheader
  %33 = sext i32 %.01.epil.init to i64
  %34 = getelementptr inbounds %struct.Comb, ptr %1, i64 %33
  %35 = load i32, ptr %34, align 4
  %36 = getelementptr inbounds %struct.Comb, ptr %0, i64 %33
  store i32 %35, ptr %36, align 4
  %37 = getelementptr inbounds nuw %struct.Comb, ptr %34, i32 0, i32 1
  %38 = load i32, ptr %37, align 4
  %39 = getelementptr inbounds nuw %struct.Comb, ptr %36, i32 0, i32 1
  store i32 %38, ptr %39, align 4
  %40 = getelementptr inbounds nuw %struct.Comb, ptr %34, i32 0, i32 2
  %41 = load i32, ptr %40, align 4
  %42 = getelementptr inbounds nuw %struct.Comb, ptr %36, i32 0, i32 2
...
43:                                               ; preds = %._crit_edge, %3
  ...
  %45 = getelementptr inbounds %struct.Comb, ptr %0, i64 %44
...
35:                                               ; preds = %34
  ...
  br i1 %37, label %4, label %._crit_edge, !llvm.loop !14
...
15:                                               ; preds = %10, %9
  ...
  br i1 %17, label %5, label %._crit_edge, !llvm.loop !15
...
107:                                              ; preds = %86, %79, %73, %68, %52
  ...
  br i1 %109, label %48, label %._crit_edge, !llvm.loop !16
...
111:                                              ; preds = %110, %45
  ...
  br i1 %115, label %41, label %._crit_edge5, !llvm.loop !17
...
117:                                              ; preds = %116
  ...
  br i1 %119, label %37, label %120, !llvm.loop !18
...
17:                                               ; preds = %16
  ...
  br i1 %20, label %3, label %._crit_edge, !llvm.loop !19
...
36:                                               ; preds = %35
  ...
  br i1 %41, label %31, label %..loopexit_crit_edge, !llvm.loop !20
