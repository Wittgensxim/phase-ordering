...
37:                                               ; preds = %114, %36
  ...
  br i1 %exitcond12, label %38, label %116

38:                                               ; preds = %37
  br label %39

39:                                               ; preds = %112, %38
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %112 ], [ 0, %38 ]
  %40 = load i32, ptr @listLength, align 4
  %41 = add nsw i32 %40, %0
  %42 = sext i32 %41 to i64
  %43 = icmp slt i64 %indvars.iv9, %42
  br i1 %43, label %44, label %113

44:                                               ; preds = %39
  %45 = trunc nuw nsw i64 %indvars.iv9 to i32
  %46 = shl nuw i32 1, %45
  %47 = and i32 %46, %1
  %48 = icmp ne i32 %47, 0
...
58:                                               ; preds = %52
  ...
  %60 = getelementptr inbounds i32, ptr %59, i64 %indvars.iv9
