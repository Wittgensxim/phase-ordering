...
.preheader1:                                      ; preds = %.preheader2, %92
  %.0212 = phi i32 [ 1, %.preheader2 ], [ %93, %92 ]
  %34 = icmp eq i32 %.0212, 4
  %.old = icmp eq i32 %.0212, 2
  %35 = load i32, ptr @listLength, align 4
  %36 = add nsw i32 %35, %0
  %37 = icmp slt i32 0, %36
  br i1 %37, label %.lr.ph11, label %92

.lr.ph11:                                         ; preds = %.preheader1
  br label %38

38:                                               ; preds = %.lr.ph11, %87
  %.049 = phi i32 [ 0, %.lr.ph11 ], [ %88, %87 ]
  %39 = shl nuw i32 1, %.049
  %40 = and i32 %39, %1
  %.not1 = icmp eq i32 %40, 0
  br i1 %.not1, label %.preheader, label %87

.preheader:                                       ; preds = %38
  %41 = zext nneg i32 %.049 to i64
  %42 = or i32 %1, %39
  %43 = icmp samesign ult i32 0, %.049
...
44:                                               ; preds = %.lr.ph, %84
  %.038 = phi i32 [ 0, %.lr.ph ], [ %85, %84 ]
  %45 = shl nuw i32 1, %.038
  %46 = and i32 %45, %1
...
84:                                               ; preds = %66, %61, %57, %54, %44
  %85 = add nuw nsw i32 %.038, 1
  %86 = icmp samesign ult i32 %85, %.049
...
87:                                               ; preds = %.loopexit, %38
  %.0410 = phi i32 [ %.049, %.loopexit ], [ %.049, %38 ]
  %88 = add nuw nsw i32 %.0410, 1
...
15:                                               ; preds = %14, %4
  ...
  br i1 %18, label %4, label %._crit_edge5, !llvm.loop !16

._crit_edge5:                                     ; preds = %15
  %split6 = phi i32 [ %16, %15 ]
  br label %19

19:                                               ; preds = %._crit_edge5, %0
  %.lcssa2 = phi i32 [ %split6, %._crit_edge5 ], [ %best.promoted, %0 ]
  %20 = icmp eq i32 %.lcssa2, %2
...
22:                                               ; preds = %19
  ...
  br i1 %23, label %.lr.ph8, label %._crit_edge
