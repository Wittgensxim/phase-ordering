...
38:                                               ; preds = %.lr.ph3, %.loopexit
  %.042 = phi i32 [ 0, %.lr.ph3 ], [ %87, %.loopexit ]
...
84:                                               ; preds = %66, %61, %57, %54, %44
  ...
  br i1 %86, label %44, label %..loopexit.loopexit_crit_edge, !llvm.loop !13

..loopexit.loopexit_crit_edge:                    ; preds = %84
  br label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %..loopexit.loopexit_crit_edge, %.preheader
  br label %.loopexit
...
91:                                               ; preds = %._crit_edge, %.preheader1
  ...
  br i1 %93, label %.preheader1, label %.loopexit3.loopexit, !llvm.loop !15

.loopexit3.loopexit:                              ; preds = %91
  br label %.loopexit3
...
.preheader:                                       ; preds = %19
  ...
  br i1 %21, label %.lr.ph6, label %._crit_edge
...
23:                                               ; preds = %.lr.ph6, %25
  ...
  br i1 %.not, label %25, label %split.loopexit
...
split:                                            ; preds = %split.loopexit, %._crit_edge
  %29 = phi i32 [ %.pre2, %._crit_edge ], [ %.lcssa, %split.loopexit ]
  %30 = icmp eq i32 %29, 0
