...
34:                                               ; preds = %88, %.preheader2
  ...
  br i1 %exitcond5, label %.preheader1, label %.loopexit3
...
19:                                               ; preds = %16, %24
  %20 = phi i32 [ %.pre1, %24 ], [ %.pre, %16 ]
  %storemerge = phi i32 [ %26, %24 ], [ 1, %16 ]
...
split:                                            ; preds = %22, %._crit_edge
  %27 = phi i32 [ %.pre2, %._crit_edge ], [ %23, %22 ]
  %28 = icmp eq i32 %27, 0
