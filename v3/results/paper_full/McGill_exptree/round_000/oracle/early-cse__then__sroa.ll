...
6:                                                ; preds = %4
  ...
  %15 = getelementptr inbounds %struct.Comb, ptr %0, i64 %11
  %16 = getelementptr inbounds nuw %struct.Comb, ptr %15, i32 0, i32 1
  store i32 %14, ptr %16, align 4
  %17 = sext i32 %.0 to i64
  %18 = getelementptr inbounds %struct.Comb, ptr %1, i64 %17
  %19 = getelementptr inbounds nuw %struct.Comb, ptr %18, i32 0, i32 2
  %20 = load i32, ptr %19, align 4
  %21 = getelementptr inbounds %struct.Comb, ptr %0, i64 %17
...
24:                                               ; preds = %5
  %25 = call i32 (ptr, ...) @printf(ptr noundef @.str.8, i32 noundef %13)
  br label %26
...
26:                                               ; preds = %24, %22, %20, %18, %16, %14
  ...
  %31 = call i32 @calculate(ptr noundef %28)
...
40:                                               ; preds = %121, %39
  %.042 = phi i32 [ 0, %39 ], [ %122, %121 ]
  %41 = load i32, ptr @listLength, align 4
  %42 = add nsw i32 %41, %0
  %43 = icmp slt i32 %.042, %42
...
50:                                               ; preds = %118, %49
  %.041 = phi i32 [ 0, %49 ], [ %119, %118 ]
  %51 = icmp slt i32 %.041, %.042
...
92:                                               ; preds = %91, %89, %87
  %.040 = phi i32 [ %65, %91 ], [ %61, %89 ], [ %61, %87 ]
  %.039 = phi i32 [ %61, %91 ], [ %65, %89 ], [ %65, %87 ]
  %93 = shl i32 1, %.042
  %94 = or i32 %1, %93
  %95 = shl i32 1, %.041
  %96 = or i32 %94, %95
  ...
  store i32 %.040, ptr %99, align 4
  %100 = load ptr, ptr @combList, align 8
  %101 = sext i32 %0 to i64
  %102 = getelementptr inbounds %struct.Comb, ptr %100, i64 %101
  %103 = getelementptr inbounds nuw %struct.Comb, ptr %102, i32 0, i32 1
  store i32 %.039, ptr %103, align 4
  %104 = load ptr, ptr @combList, align 8
  %105 = sext i32 %0 to i64
  %106 = getelementptr inbounds %struct.Comb, ptr %104, i64 %105
  %107 = getelementptr inbounds nuw %struct.Comb, ptr %106, i32 0, i32 2
  store i32 %.0, ptr %107, align 4
  %108 = load ptr, ptr @combList, align 8
  %109 = sext i32 %0 to i64
  %110 = getelementptr inbounds %struct.Comb, ptr %108, i64 %109
  %111 = call i32 @calculate(ptr noundef %110)
  %112 = load ptr, ptr @workList, align 8
  ...
  %117 = add nsw i32 %0, 1
  call void @recSearch(i32 noundef %117, i32 noundef %96)
  br label %118

118:                                              ; preds = %92, %84, %78, %73, %56
  %119 = add nsw i32 %.041, 1
