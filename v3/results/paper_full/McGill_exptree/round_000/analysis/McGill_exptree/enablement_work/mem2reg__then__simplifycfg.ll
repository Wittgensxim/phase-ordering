...
41:                                               ; preds = %5, %110
  %.02 = phi i32 [ %111, %110 ], [ 1, %5 ]
  %42 = icmp sle i32 %.02, 4
  br i1 %42, label %43, label %112

43:                                               ; preds = %41, %108
  %.04 = phi i32 [ %109, %108 ], [ 0, %41 ]
...
51:                                               ; preds = %47, %106
  %.03 = phi i32 [ %107, %106 ], [ 0, %47 ]
  %52 = icmp slt i32 %.03, %.04
...
69:                                               ; preds = %66, %57
  %70 = icmp eq i32 %61, 0
  %71 = icmp eq i32 %65, 0
  %or.cond5 = select i1 %70, i1 true, i1 %71
  br i1 %or.cond5, label %106, label %72

72:                                               ; preds = %69
  switch i32 %.02, label %79 [
    i32 4, label %73
    i32 2, label %77
  ]
...
77:                                               ; preds = %72, %76, %76
  ...
  %spec.select6 = select i1 %78, i32 %61, i32 %65
  br label %79

79:                                               ; preds = %77, %72, %76
  %.01 = phi i32 [ %61, %76 ], [ %spec.select, %77 ], [ %61, %72 ]
  %.0 = phi i32 [ %65, %76 ], [ %spec.select6, %77 ], [ %65, %72 ]
  %80 = shl i32 1, %.04
  %81 = or i32 %1, %80
  %82 = shl i32 1, %.03
  %83 = or i32 %81, %82
