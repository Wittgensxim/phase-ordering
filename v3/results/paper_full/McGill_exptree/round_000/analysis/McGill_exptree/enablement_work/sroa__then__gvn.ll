...
40:                                               ; preds = %114, %39
  %.052 = phi i32 [ 0, %39 ], [ %115, %114 ]
  %41 = load i32, ptr @listLength, align 4
  %42 = add nsw i32 %41, %0
  %43 = icmp slt i32 %.052, %42
...
50:                                               ; preds = %111, %49
  %.051 = phi i32 [ 0, %49 ], [ %112, %111 ]
  %51 = icmp slt i32 %.051, %.052
...
25:                                               ; preds = %33, %24
  %26 = phi i32 [ %.pre4, %33 ], [ %.pre, %24 ]
  %27 = phi i32 [ %35, %33 ], [ 1, %24 ]
  %28 = icmp slt i32 %27, %26
  br i1 %28, label %29, label %._crit_edge

._crit_edge:                                      ; preds = %25
  %.pre5 = load i32, ptr @stopSearch, align 4
  br label %36
...
33:                                               ; preds = %29
  ...
  %.pre4 = load i32, ptr @listLength, align 4
  br label %25, !llvm.loop !17

36:                                               ; preds = %._crit_edge, %32
  %37 = phi i32 [ %.pre5, %._crit_edge ], [ %30, %32 ]
  %38 = icmp eq i32 %37, 0
