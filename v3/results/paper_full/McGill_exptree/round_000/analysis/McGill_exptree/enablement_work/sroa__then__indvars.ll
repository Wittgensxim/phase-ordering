...
45:                                               ; preds = %132, %44
  %.0 = phi i32 [ 1, %44 ], [ %133, %132 ]
  %exitcond57 = icmp ne i32 %.0, 5
  br i1 %exitcond57, label %46, label %134

46:                                               ; preds = %45
  br label %47

47:                                               ; preds = %130, %46
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %130 ], [ 0, %46 ]
...
52:                                               ; preds = %47
  %53 = trunc nuw nsw i64 %indvars.iv54 to i32
  %54 = shl i32 1, %53
  %55 = and i32 %54, %1
  %56 = icmp ne i32 %55, 0
...
59:                                               ; preds = %128, %58
  ...
  %exitcond = icmp ne i64 %indvars.iv, %indvars.iv54
...
66:                                               ; preds = %60
  ...
  %68 = getelementptr inbounds i32, ptr %67, i64 %indvars.iv54
...
99:                                               ; preds = %98, %96, %94
  %.050 = phi i32 [ %72, %98 ], [ %69, %96 ], [ %69, %94 ]
  %.049 = phi i32 [ %69, %98 ], [ %72, %96 ], [ %72, %94 ]
  %100 = trunc nuw nsw i64 %indvars.iv54 to i32
  %101 = shl i32 1, %100
  %102 = or i32 %1, %101
