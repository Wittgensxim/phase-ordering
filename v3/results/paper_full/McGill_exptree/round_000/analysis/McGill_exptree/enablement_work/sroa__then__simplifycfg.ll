...
28:                                               ; preds = %1, %22, %16, %10, %4
  %.0 = phi i32 [ %27, %22 ], [ %9, %4 ], [ %15, %10 ], [ %21, %16 ], [ 0, %1 ]
  ret i32 %.0
}
...
41:                                               ; preds = %5, %110
  %.0 = phi i32 [ %111, %110 ], [ 1, %5 ]
  %42 = icmp sle i32 %.0, 4
  br i1 %42, label %43, label %112

43:                                               ; preds = %41, %108
  %.052 = phi i32 [ %109, %108 ], [ 0, %41 ]
  %44 = load i32, ptr @listLength, align 4
  %45 = add nsw i32 %44, %0
  %46 = icmp slt i32 %.052, %45
...
51:                                               ; preds = %47, %106
  %.051 = phi i32 [ %107, %106 ], [ 0, %47 ]
  %52 = icmp slt i32 %.051, %.052
...
66:                                               ; preds = %57, %57
  ...
  br i1 %or.cond, label %106, label %69

69:                                               ; preds = %66, %57
  %70 = icmp eq i32 %61, 0
  %71 = icmp eq i32 %65, 0
  %or.cond53 = select i1 %70, i1 true, i1 %71
  br i1 %or.cond53, label %106, label %72
...
77:                                               ; preds = %72, %76, %76
  %78 = icmp slt i32 %61, %65
  %spec.select = select i1 %78, i32 %65, i32 %61
  %spec.select54 = select i1 %78, i32 %61, i32 %65
  br label %79

79:                                               ; preds = %77, %72, %76
  %.050 = phi i32 [ %61, %76 ], [ %spec.select, %77 ], [ %61, %72 ]
  %.049 = phi i32 [ %65, %76 ], [ %spec.select54, %77 ], [ %65, %72 ]
  %80 = shl i32 1, %.052
  %81 = or i32 %1, %80
  %82 = shl i32 1, %.051
  %83 = or i32 %81, %82
  ...
  %86 = getelementptr inbounds %struct.Comb, ptr %84, i64 %85
  %87 = getelementptr inbounds nuw %struct.Comb, ptr %86, i32 0, i32 0
  store i32 %.050, ptr %87, align 4
  %88 = load ptr, ptr @combList, align 8
  %89 = sext i32 %0 to i64
  %90 = getelementptr inbounds %struct.Comb, ptr %88, i64 %89
  %91 = getelementptr inbounds nuw %struct.Comb, ptr %90, i32 0, i32 1
  store i32 %.049, ptr %91, align 4
  %92 = load ptr, ptr @combList, align 8
  %93 = sext i32 %0 to i64
  %94 = getelementptr inbounds %struct.Comb, ptr %92, i64 %93
  %95 = getelementptr inbounds nuw %struct.Comb, ptr %94, i32 0, i32 2
  store i32 %.0, ptr %95, align 4
  %96 = load ptr, ptr @combList, align 8
  %97 = sext i32 %0 to i64
  %98 = getelementptr inbounds %struct.Comb, ptr %96, i64 %97
  ...
  %105 = add nsw i32 %0, 1
  call void @recSearch(i32 noundef %105, i32 noundef %83)
  br label %106

106:                                              ; preds = %73, %69, %66, %53, %79
  %107 = add nsw i32 %.051, 1
  br label %51, !llvm.loop !13

108:                                              ; preds = %51, %47
  %109 = add nsw i32 %.052, 1
...
8:                                                ; preds = %6
  ...
  %13 = getelementptr inbounds [16 x i32], ptr %1, i64 0, i64 %12
  %14 = call i32 (ptr, ptr, ...) @fscanf(ptr noundef %11, ptr noundef @.str.2, ptr noundef %13)
  %15 = add nsw i32 %.0, 1
  br label %6, !llvm.loop !18

16:                                               ; preds = %6, %6
  %17 = icmp eq i32 %.0, 0
  %spec.select6 = select i1 %17, i32 4, i32 %.0
  %18 = sub nsw i32 %spec.select6, 1
  ...
  %31 = getelementptr inbounds [16 x i32], ptr %1, i64 0, i64 0
  %32 = load i32, ptr @listLength, align 4
  call void @initWorkList(ptr noundef %30, ptr noundef %31, i32 noundef %32)
  %33 = load ptr, ptr @combList, align 8
  %34 = load i32, ptr @listLength, align 4
  call void @initCombList(ptr noundef %33, i32 noundef %34)
