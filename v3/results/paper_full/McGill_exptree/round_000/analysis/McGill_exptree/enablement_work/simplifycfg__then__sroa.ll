...
54:                                               ; preds = %115, %53
  %.058 = phi i32 [ 0, %53 ], [ %116, %115 ]
  %55 = icmp slt i32 %.058, %.059
...
88:                                               ; preds = %82, %87, %85
  %.057 = phi i32 [ %68, %87 ], [ %64, %85 ], [ %64, %82 ]
  %.056 = phi i32 [ %64, %87 ], [ %68, %85 ], [ %68, %82 ]
  %89 = shl i32 1, %.059
  %90 = or i32 %1, %89
  %91 = shl i32 1, %.058
  %92 = or i32 %90, %91
