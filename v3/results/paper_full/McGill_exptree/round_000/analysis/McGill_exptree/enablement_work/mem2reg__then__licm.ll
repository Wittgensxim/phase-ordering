...
50:                                               ; preds = %133, %44
  %.02 = phi i32 [ 1, %44 ], [ %134, %133 ]
  %51 = icmp sle i32 %.02, 4
...
71:                                               ; preds = %127, %67
  %.03 = phi i32 [ 0, %67 ], [ %128, %127 ]
  %72 = icmp slt i32 %.03, %.04
...
107:                                              ; preds = %106, %104, %103
  %.01 = phi i32 [ %85, %106 ], [ %81, %104 ], [ %81, %103 ]
  %.0 = phi i32 [ %81, %106 ], [ %85, %104 ], [ %85, %103 ]
  %108 = shl i32 1, %.03
  %109 = or i32 %70, %108
