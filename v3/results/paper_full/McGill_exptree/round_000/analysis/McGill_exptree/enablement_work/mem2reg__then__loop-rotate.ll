...
45:                                               ; preds = %44, %133
  %.0212 = phi i32 [ 1, %44 ], [ %134, %133 ]
  %46 = load i32, ptr @listLength, align 4
  %47 = add nsw i32 %46, %0
  %48 = icmp slt i32 0, %47
  br i1 %48, label %.lr.ph10, label %132

.lr.ph10:                                         ; preds = %45
  br label %49

49:                                               ; preds = %.lr.ph10, %127
  %.047 = phi i32 [ 0, %.lr.ph10 ], [ %128, %127 ]
  %50 = shl i32 1, %.047
  %51 = and i32 %50, %1
  %52 = icmp ne i32 %51, 0
...
61:                                               ; preds = %56
  ...
  %70 = icmp eq i32 %.0212, 3
  br i1 %70, label %73, label %71

71:                                               ; preds = %61
  %72 = icmp eq i32 %.0212, 4
...
89:                                               ; preds = %85, %83
  %90 = icmp eq i32 %.0212, 4
  br i1 %90, label %93, label %91

91:                                               ; preds = %89
  %92 = icmp eq i32 %.0212, 2
...
96:                                               ; preds = %95, %93, %91
  %.01 = phi i32 [ %69, %95 ], [ %65, %93 ], [ %65, %91 ]
  %.0 = phi i32 [ %65, %95 ], [ %69, %93 ], [ %69, %91 ]
  %97 = shl i32 1, %.047
  %98 = or i32 %1, %97
  %99 = shl i32 1, %.035
  %100 = or i32 %98, %99
  ...
  store i32 %.0212, ptr %112, align 4
...
123:                                              ; preds = %96, %88, %82, %77, %60
  %.036 = phi i32 [ %.035, %96 ], [ %.035, %88 ], [ %.035, %82 ], [ %.035, %77 ], [ %.035, %60 ]
  %124 = add nsw i32 %.036, 1
  %125 = icmp slt i32 %124, %.047
...
127:                                              ; preds = %126, %53
  %.048 = phi i32 [ %.047, %126 ], [ %.047, %53 ]
  %128 = add nsw i32 %.048, 1
  %129 = load i32, ptr @listLength, align 4
  %130 = add nsw i32 %129, %0
  %131 = icmp slt i32 %128, %130
  br i1 %131, label %49, label %._crit_edge11, !llvm.loop !14

._crit_edge11:                                    ; preds = %127
  br label %132

132:                                              ; preds = %._crit_edge11, %45
  br label %133

133:                                              ; preds = %132
  %134 = add nsw i32 %.0212, 1
...
32:                                               ; preds = %26
  ...
  br i1 %35, label %.lr.ph3, label %.loopexit
