...
6:                                                ; preds = %4
  ...
  %13 = getelementptr inbounds nuw [12 x i8], ptr %1, i64 %12
...
15:                                               ; preds = %5
  %putchar17 = call i32 @putchar(i32 43)
  br label %25

16:                                               ; preds = %5
  %putchar16 = call i32 @putchar(i32 45)
  br label %25

17:                                               ; preds = %5
  %putchar15 = call i32 @putchar(i32 42)
  br label %25

18:                                               ; preds = %5
  %putchar14 = call i32 @putchar(i32 58)
  br label %25

19:                                               ; preds = %5
  %20 = zext nneg i32 %.0 to i64
  %21 = getelementptr inbounds nuw [12 x i8], ptr %0, i64 %20
...
46:                                               ; preds = %123, %45
  %.052 = phi i32 [ 0, %45 ], [ %124, %123 ]
  %47 = load i32, ptr @listLength, align 4
  %48 = add nsw i32 %47, %0
  %49 = icmp slt i32 %.052, %48
  br i1 %49, label %50, label %125

50:                                               ; preds = %46
  %51 = shl nuw i32 1, %.052
  %52 = and i32 %51, %1
...
55:                                               ; preds = %120, %54
  %.051 = phi i32 [ 0, %54 ], [ %121, %120 ]
  %56 = icmp samesign ult i32 %.051, %.052
  br i1 %56, label %57, label %122

57:                                               ; preds = %55
  %58 = shl nuw i32 1, %.051
  %59 = and i32 %58, %1
