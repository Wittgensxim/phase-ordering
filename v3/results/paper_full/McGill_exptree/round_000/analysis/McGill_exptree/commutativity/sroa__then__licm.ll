...
26:                                               ; preds = %6
  ...
  %28 = getelementptr inbounds %struct.Comb, ptr %0, i64 %27
  %29 = getelementptr inbounds nuw %struct.Comb, ptr %28, i32 0, i32 2
  %30 = load i32, ptr %29, align 4
  %31 = call i32 (ptr, ...) @printf(ptr noundef @.str.8, i32 noundef %30)
  br label %32

32:                                               ; preds = %26, %24, %22, %20, %18, %16
  %33 = sext i32 %.0 to i64
  %34 = getelementptr inbounds %struct.Comb, ptr %0, i64 %33
  %35 = getelementptr inbounds nuw %struct.Comb, ptr %34, i32 0, i32 1
  %36 = load i32, ptr %35, align 4
  %37 = sext i32 %.0 to i64
  %38 = getelementptr inbounds %struct.Comb, ptr %0, i64 %37
  %39 = call i32 @calculate(ptr noundef %38)
  %40 = call i32 (ptr, ...) @printf(ptr noundef @.str.9, i32 noundef %36, i32 noundef %39)
  %41 = icmp slt i32 %.0, %3
...
58:                                               ; preds = %130, %52
  %.052 = phi i32 [ 0, %52 ], [ %131, %130 ]
  %59 = load i32, ptr @listLength, align 4
  %60 = add nsw i32 %59, %0
  %61 = icmp slt i32 %.052, %60
...
67:                                               ; preds = %62
  %68 = sext i32 %.052 to i64
  %69 = shl i32 1, %.052
  %70 = or i32 %1, %69
  br label %71

71:                                               ; preds = %127, %67
  %.051 = phi i32 [ 0, %67 ], [ %128, %127 ]
  %72 = icmp slt i32 %.051, %.052
...
102:                                              ; preds = %98, %97
  br i1 %56, label %104, label %103

103:                                              ; preds = %102
  br i1 %57, label %104, label %107

104:                                              ; preds = %103, %102
  %105 = icmp slt i32 %81, %85
...
107:                                              ; preds = %106, %104, %103
  %.050 = phi i32 [ %85, %106 ], [ %81, %104 ], [ %81, %103 ]
  %.049 = phi i32 [ %81, %106 ], [ %85, %104 ], [ %85, %103 ]
  %108 = shl i32 1, %.051
  %109 = or i32 %70, %108
  %110 = load ptr, ptr @combList, align 8
  %111 = getelementptr inbounds %struct.Comb, ptr %110, i64 %45
  %112 = getelementptr inbounds nuw %struct.Comb, ptr %111, i32 0, i32 0
  store i32 %.050, ptr %112, align 4
  %113 = load ptr, ptr @combList, align 8
  %114 = getelementptr inbounds %struct.Comb, ptr %113, i64 %46
  %115 = getelementptr inbounds nuw %struct.Comb, ptr %114, i32 0, i32 1
  store i32 %.049, ptr %115, align 4
  %116 = load ptr, ptr @combList, align 8
  %117 = getelementptr inbounds %struct.Comb, ptr %116, i64 %47
  %118 = getelementptr inbounds nuw %struct.Comb, ptr %117, i32 0, i32 2
  store i32 %.0, ptr %118, align 4
  %119 = load ptr, ptr @combList, align 8
  %120 = getelementptr inbounds %struct.Comb, ptr %119, i64 %48
  ...
  call void @recSearch(i32 noundef %49, i32 noundef %109)
  br label %127

127:                                              ; preds = %107, %101, %96, %91, %77
...
42:                                               ; preds = %41
  %43 = load i32, ptr @dmax, align 4
  %44 = add nsw i32 %43, 1
  store i32 %44, ptr @dmax, align 4
  br label %33, !llvm.loop !17

.loopexit:                                        ; preds = %33
  br label %45

45:                                               ; preds = %.loopexit, %40
