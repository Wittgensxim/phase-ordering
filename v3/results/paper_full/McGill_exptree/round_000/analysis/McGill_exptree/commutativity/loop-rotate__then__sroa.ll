...
97:                                               ; preds = %96, %94, %92
  %.061 = phi i32 [ %70, %96 ], [ %66, %94 ], [ %66, %92 ]
  %.060 = phi i32 [ %66, %96 ], [ %70, %94 ], [ %70, %92 ]
  %98 = shl i32 1, %.063
  %99 = or i32 %1, %98
  %100 = shl i32 1, %.062
  %101 = or i32 %99, %100
...
124:                                              ; preds = %97, %89, %83, %78, %61
  %125 = add nsw i32 %.062, 1
  %126 = icmp slt i32 %125, %.063
