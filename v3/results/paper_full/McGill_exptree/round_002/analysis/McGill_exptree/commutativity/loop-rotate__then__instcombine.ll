...
.preheader1:                                      ; preds = %.preheader2, %91
  %.027 = phi i32 [ 1, %.preheader2 ], [ %92, %91 ]
  %32 = load i32, ptr @listLength, align 4
  %33 = add nsw i32 %32, %0
  %34 = icmp sgt i32 %33, 0
  br i1 %34, label %.lr.ph6, label %91

.lr.ph6:                                          ; preds = %.preheader1
  br label %35

35:                                               ; preds = %.lr.ph6, %86
  %.045 = phi i32 [ 0, %.lr.ph6 ], [ %87, %86 ]
  %36 = shl nuw i32 1, %.045
  %37 = and i32 %36, %1
  %.not8 = icmp eq i32 %37, 0
  br i1 %.not8, label %.preheader, label %86

.preheader:                                       ; preds = %35
  %.not9 = icmp eq i32 %.045, 0
...
49:                                               ; preds = %41, %41
  ...
  br i1 %or.cond, label %83, label %52

52:                                               ; preds = %49, %41
  %53 = icmp eq i32 %45, 0
  %54 = icmp eq i32 %48, 0
  %or.cond1 = select i1 %53, i1 true, i1 %54
  br i1 %or.cond1, label %83, label %55

55:                                               ; preds = %52
  %56 = icmp eq i32 %.027, 4
  br i1 %56, label %57, label %.critedge

57:                                               ; preds = %55
  %58 = srem i32 %45, %48
  %.not11 = icmp eq i32 %58, 0
  br i1 %.not11, label %59, label %83

59:                                               ; preds = %57
  %.old3 = icmp slt i32 %45, %48
  br i1 %.old3, label %61, label %62

.critedge:                                        ; preds = %55
  %.old = icmp eq i32 %.027, 2
  %60 = icmp slt i32 %45, %48
  %or.cond4 = select i1 %.old, i1 %60, i1 false
  br i1 %or.cond4, label %61, label %62

61:                                               ; preds = %.critedge, %59
  br label %62

62:                                               ; preds = %61, %.critedge, %59
  %.01 = phi i32 [ %48, %61 ], [ %45, %59 ], [ %45, %.critedge ]
  %.0 = phi i32 [ %45, %61 ], [ %48, %59 ], [ %48, %.critedge ]
  %63 = or i32 %1, %36
  %64 = or i32 %63, %39
...
83:                                               ; preds = %62, %57, %52, %49, %38
  %84 = add nuw nsw i32 %.034, 1
  %85 = icmp samesign ult i32 %84, %.045
  br i1 %85, label %38, label %..loopexit_crit_edge, !llvm.loop !13
...
91:                                               ; preds = %._crit_edge, %.preheader1
  %92 = add nuw nsw i32 %.027, 1
  %93 = icmp samesign ult i32 %.027, 4
  br i1 %93, label %.preheader1, label %.loopexit3, !llvm.loop !15

.loopexit3:                                       ; preds = %91
  br label %94

94:                                               ; preds = %.loopexit3, %30, %24, %9, %2
  ret void
}
...
16:                                               ; preds = %15, %3
  ...
  br i1 %19, label %3, label %._crit_edge, !llvm.loop !16
...
25:                                               ; preds = %20
  ...
  br i1 %27, label %.lr.ph3, label %35
...
28:                                               ; preds = %.lr.ph3, %30
  ...
  br i1 %.not, label %30, label %._crit_edge4
...
30:                                               ; preds = %28
  ...
  br i1 %34, label %28, label %._crit_edge5, !llvm.loop !17
...
35:                                               ; preds = %._crit_edge5, %._crit_edge4, %25
