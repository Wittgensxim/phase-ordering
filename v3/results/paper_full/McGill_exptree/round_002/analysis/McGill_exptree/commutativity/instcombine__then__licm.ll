...
4:                                                ; preds = %2
  ...
  %8 = icmp eq i32 %0, %7
  br i1 %8, label %11, label %.preheader5
...
34:                                               ; preds = %.preheader5, %92
  %.02 = phi i32 [ %93, %92 ], [ 1, %.preheader5 ]
  %35 = icmp samesign ult i32 %.02, 5
  br i1 %35, label %.preheader4, label %.loopexit6
