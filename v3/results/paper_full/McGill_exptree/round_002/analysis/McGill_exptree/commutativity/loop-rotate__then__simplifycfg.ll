...
.lr.ph:                                           ; preds = %2, %.lr.ph
  ...
  %5 = getelementptr inbounds %struct.Comb, ptr %0, i64 %4
...
.lr.ph:                                           ; preds = %3, %.lr.ph
  ...
  %5 = sext i32 %.01 to i64
  %6 = getelementptr inbounds %struct.Comb, ptr %1, i64 %5
  %7 = load i32, ptr %6, align 4
  %8 = getelementptr inbounds %struct.Comb, ptr %0, i64 %5
  store i32 %7, ptr %8, align 4
...
5:                                                ; preds = %2
  ...
  %9 = icmp eq i32 %0, %8
  br i1 %9, label %10, label %.preheader1
...
25:                                               ; preds = %10
  ...
  br i1 %30, label %31, label %.loopexit3
...
.preheader1:                                      ; preds = %5, %._crit_edge
  %.027 = phi i32 [ %94, %._crit_edge ], [ 1, %5 ]
...
.lr.ph6:                                          ; preds = %.preheader1, %.loopexit
  %.045 = phi i32 [ %90, %.loopexit ], [ 0, %.preheader1 ]
  %36 = shl i32 1, %.045
  %37 = and i32 %36, %1
  %38 = icmp eq i32 %37, 0
  %39 = icmp slt i32 0, %.045
  %or.cond9 = and i1 %38, %39
  br i1 %or.cond9, label %.lr.ph, label %.loopexit

.lr.ph:                                           ; preds = %.lr.ph6, %87
  %.034 = phi i32 [ %88, %87 ], [ 0, %.lr.ph6 ]
  %40 = shl i32 1, %.034
  %41 = and i32 %40, %1
  %42 = icmp ne i32 %41, 0
...
51:                                               ; preds = %43, %43
  ...
  br i1 %or.cond, label %87, label %54

54:                                               ; preds = %51, %43
  %55 = icmp eq i32 %47, 0
  %56 = icmp eq i32 %50, 0
  %or.cond1 = select i1 %55, i1 true, i1 %56
  br i1 %or.cond1, label %87, label %57

57:                                               ; preds = %54
  %58 = icmp eq i32 %.027, 4
...
62:                                               ; preds = %59
  %63 = icmp eq i32 %.027, 2
  %.old3 = icmp slt i32 %47, %50
  br i1 %.old3, label %65, label %66

.critedge:                                        ; preds = %57
  %.old = icmp eq i32 %.027, 2
  %64 = icmp slt i32 %47, %50
  %or.cond4 = select i1 %.old, i1 %64, i1 false
  br i1 %or.cond4, label %65, label %66

65:                                               ; preds = %.critedge, %62
  br label %66

66:                                               ; preds = %65, %.critedge, %62
  %.01 = phi i32 [ %50, %65 ], [ %47, %62 ], [ %47, %.critedge ]
  %.0 = phi i32 [ %47, %65 ], [ %50, %62 ], [ %50, %.critedge ]
  %67 = or i32 %1, %36
  %68 = or i32 %67, %40
  %69 = load ptr, ptr @combList, align 8
  %70 = sext i32 %0 to i64
  %71 = getelementptr inbounds %struct.Comb, ptr %69, i64 %70
  store i32 %.01, ptr %71, align 4
  %72 = load ptr, ptr @combList, align 8
  %73 = getelementptr inbounds %struct.Comb, ptr %72, i64 %70
  %74 = getelementptr inbounds nuw %struct.Comb, ptr %73, i32 0, i32 1
  store i32 %.0, ptr %74, align 4
  %75 = load ptr, ptr @combList, align 8
  %76 = getelementptr inbounds %struct.Comb, ptr %75, i64 %70
  %77 = getelementptr inbounds nuw %struct.Comb, ptr %76, i32 0, i32 2
  store i32 %.027, ptr %77, align 4
  %78 = load ptr, ptr @combList, align 8
  %79 = getelementptr inbounds %struct.Comb, ptr %78, i64 %70
...
87:                                               ; preds = %66, %59, %54, %51, %.lr.ph
  %88 = add nsw i32 %.034, 1
  %89 = icmp slt i32 %88, %.045
  br i1 %89, label %.lr.ph, label %.loopexit, !llvm.loop !13

.loopexit:                                        ; preds = %87, %.lr.ph6
  %90 = add nsw i32 %.045, 1
  %91 = load i32, ptr @listLength, align 4
  %92 = add nsw i32 %91, %0
  %93 = icmp slt i32 %90, %92
  br i1 %93, label %.lr.ph6, label %._crit_edge, !llvm.loop !14

._crit_edge:                                      ; preds = %.loopexit, %.preheader1
  %94 = add nsw i32 %.027, 1
  %95 = icmp sle i32 %94, 4
  br i1 %95, label %.preheader1, label %.loopexit3, !llvm.loop !15

.loopexit3:                                       ; preds = %._crit_edge, %31, %25, %10, %2
  ret void
}
...
24:                                               ; preds = %._crit_edge
  ...
  br i1 %27, label %.lr.ph3, label %._crit_edge4

.lr.ph3:                                          ; preds = %24, %30
  call void @recSearch(i32 noundef 0, i32 noundef 0)
  %28 = load i32, ptr @stopSearch, align 4
  %29 = icmp ne i32 %28, 0
  br i1 %29, label %._crit_edge4, label %30
