...
33:                                               ; preds = %.preheader2, %97
  %.02 = phi i32 [ %98, %97 ], [ 1, %.preheader2 ]
  %34 = icmp sle i32 %.02, 4
  br i1 %34, label %.preheader1, label %.loopexit3

.preheader1:                                      ; preds = %33
  br label %35

35:                                               ; preds = %.preheader1, %95
  %.04 = phi i32 [ %96, %95 ], [ 0, %.preheader1 ]
...
39:                                               ; preds = %35
  ...
  %41 = and i32 %40, %1
  %42 = icmp ne i32 %41, 0
  br i1 %42, label %95, label %.preheader

.preheader:                                       ; preds = %39
  br label %43

43:                                               ; preds = %.preheader, %93
...
60:                                               ; preds = %57, %49
  ...
  br i1 %or.cond1, label %93, label %63
...
68:                                               ; preds = %65
  ...
  br i1 %.old3, label %71, label %72

.critedge:                                        ; preds = %63
  %.old = icmp eq i32 %.02, 2
  %70 = icmp slt i32 %53, %56
  %or.cond4 = select i1 %.old, i1 %70, i1 false
  br i1 %or.cond4, label %71, label %72

71:                                               ; preds = %.critedge, %68
  br label %72

72:                                               ; preds = %71, %.critedge, %68
