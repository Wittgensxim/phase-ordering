...
.preheader4:                                      ; preds = %.preheader5, %92
  %.0211 = phi i32 [ 1, %.preheader5 ], [ %93, %92 ]
  %32 = load i32, ptr @listLength, align 4
  %33 = add nsw i32 %32, %0
  %34 = icmp slt i32 0, %33
  br i1 %34, label %.lr.ph10, label %92

.lr.ph10:                                         ; preds = %.preheader4
  br label %35

35:                                               ; preds = %.lr.ph10, %87
  %.048 = phi i32 [ 0, %.lr.ph10 ], [ %88, %87 ]
  %36 = shl nuw i32 1, %.048
  %37 = and i32 %36, %1
  %.not1 = icmp eq i32 %37, 0
  br i1 %.not1, label %.preheader, label %87

.preheader:                                       ; preds = %35
  %38 = icmp samesign ult i32 0, %.048
...
39:                                               ; preds = %.lr.ph, %84
  %.037 = phi i32 [ 0, %.lr.ph ], [ %85, %84 ]
  %40 = shl nuw i32 1, %.037
  %41 = and i32 %40, %1
...
84:                                               ; preds = %63, %58, %53, %50, %39
  %85 = add nuw nsw i32 %.037, 1
  %86 = icmp samesign ult i32 %85, %.048
...
87:                                               ; preds = %.loopexit, %35
  %.049 = phi i32 [ %.048, %.loopexit ], [ %.048, %35 ]
  %88 = add nuw nsw i32 %.049, 1
...
92:                                               ; preds = %._crit_edge, %.preheader4
  %93 = add nuw nsw i32 %.0211, 1
  %94 = icmp samesign ult i32 %93, 5
  br i1 %94, label %.preheader4, label %.loopexit6, !llvm.loop !15

.loopexit6:                                       ; preds = %92
  br label %95

95:                                               ; preds = %.loopexit6, %30, %24, %9, %2
  ret void
}
