...
33:                                               ; preds = %.preheader9, %96
  %.02 = phi i32 [ %97, %96 ], [ 1, %.preheader9 ]
  %34 = icmp sle i32 %.02, 4
  br i1 %34, label %.preheader8, label %.loopexit10

.preheader8:                                      ; preds = %33
  br label %35

35:                                               ; preds = %.preheader8, %94
  %.04 = phi i32 [ %95, %94 ], [ 0, %.preheader8 ]
...
98:                                               ; preds = %.loopexit10, %31, %25, %10, %2
  ret void
}
