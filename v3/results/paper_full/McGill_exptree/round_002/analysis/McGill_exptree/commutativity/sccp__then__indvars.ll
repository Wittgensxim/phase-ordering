...
33:                                               ; preds = %.preheader9, %93
  %.02 = phi i32 [ %94, %93 ], [ 1, %.preheader9 ]
...
34:                                               ; preds = %.preheader8, %92
  %indvars.iv12 = phi i64 [ 0, %.preheader8 ], [ %indvars.iv.next13, %92 ]
  %35 = load i32, ptr @listLength, align 4
  %36 = add nsw i32 %35, %0
  %37 = sext i32 %36 to i64
  %38 = icmp slt i64 %indvars.iv12, %37
  br i1 %38, label %39, label %93

39:                                               ; preds = %34
  %40 = trunc nuw nsw i64 %indvars.iv12 to i32
  %41 = shl nuw i32 1, %40
  %42 = and i32 %41, %1
  %43 = icmp ne i32 %42, 0
...
50:                                               ; preds = %45
  ...
  %52 = getelementptr inbounds i32, ptr %51, i64 %indvars.iv12
...
95:                                               ; preds = %.loopexit10, %31, %25, %10, %2
  ret void
}
