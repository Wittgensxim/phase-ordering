...
5:                                                ; preds = %.lr.ph, %16
  %.01 = phi i32 [ 0, %.lr.ph ], [ %18, %16 ]
  %6 = phi i32 [ %best.promoted, %.lr.ph ], [ %17, %16 ]
...
16:                                               ; preds = %15, %5
  ...
  br i1 %19, label %5, label %._crit_edge, !llvm.loop !16
