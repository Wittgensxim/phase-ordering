...
.preheader2:                                      ; preds = %5, %89
  %.02 = phi i32 [ %90, %89 ], [ 1, %5 ]
...
.preheader1:                                      ; preds = %.preheader2, %.loopexit
  ...
  %36 = icmp slt i64 %indvars.iv5, %35
  br i1 %36, label %37, label %89

37:                                               ; preds = %.preheader1
  %38 = trunc nuw nsw i64 %indvars.iv5 to i32
  %39 = shl i32 1, %38
  %40 = and i32 %39, %1
  %41 = icmp ne i32 %40, 0
  br i1 %41, label %.loopexit, label %.preheader

.preheader:                                       ; preds = %37, %88
  %indvars.iv = phi i64 [ %indvars.iv.next, %88 ], [ 0, %37 ]
  %exitcond = icmp ne i64 %indvars.iv, %indvars.iv5
  br i1 %exitcond, label %42, label %.loopexit
...
47:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds i32, ptr %48, i64 %indvars.iv5
