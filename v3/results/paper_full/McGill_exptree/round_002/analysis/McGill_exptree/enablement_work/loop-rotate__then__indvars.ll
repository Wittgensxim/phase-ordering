...
.preheader1:                                      ; preds = %.preheader2, %94
  %.027 = phi i32 [ 1, %.preheader2 ], [ %95, %94 ]
...
36:                                               ; preds = %.lr.ph6, %89
  %indvars.iv9 = phi i64 [ 0, %.lr.ph6 ], [ %indvars.iv.next10, %89 ]
  %37 = trunc nuw nsw i64 %indvars.iv9 to i32
  %38 = shl i32 1, %37
  %39 = and i32 %38, %1
  %40 = icmp ne i32 %39, 0
  br i1 %40, label %89, label %.preheader

.preheader:                                       ; preds = %36
  %41 = icmp samesign ult i64 0, %indvars.iv9
...
47:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds i32, ptr %48, i64 %indvars.iv9
  %50 = load i32, ptr %49, align 4
  %51 = getelementptr inbounds i32, ptr %48, i64 %indvars.iv
...
89:                                               ; preds = %.loopexit, %36
  ...
  %93 = icmp slt i64 %indvars.iv.next10, %92
...
94:                                               ; preds = %._crit_edge, %.preheader1
  %95 = add nuw nsw i32 %.027, 1
  %exitcond12 = icmp ne i32 %95, 5
...
15:                                               ; preds = %14, %3
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %16 = load i32, ptr @listLength, align 4
  %17 = sext i32 %16 to i64
  %18 = icmp slt i64 %indvars.iv.next, %17
  br i1 %18, label %3, label %._crit_edge, !llvm.loop !16
...
25:                                               ; preds = %19
  ...
  br i1 %28, label %.lr.ph3, label %38
...
29:                                               ; preds = %.lr.ph3, %32
  ...
  %31 = icmp ne i32 %30, 0
  br i1 %31, label %._crit_edge4, label %32
...
32:                                               ; preds = %29
  ...
  br i1 %37, label %29, label %._crit_edge5, !llvm.loop !17
...
38:                                               ; preds = %._crit_edge5, %._crit_edge4, %25
