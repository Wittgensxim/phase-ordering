...
28:                                               ; preds = %24
  ...
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %split, label %31

31:                                               ; preds = %28
  %32 = load i32, ptr @dmax, align 4
  %33 = add nsw i32 %32, 1
  store i32 %33, ptr @dmax, align 4
...
34:                                               ; preds = %split, %._crit_edge
  %35 = phi i32 [ %29, %split ], [ %.pre3, %._crit_edge ]
  %36 = icmp eq i32 %35, 0
...
14:                                               ; preds = %5, %5
  %15 = icmp eq i32 %7, 0
  %spec.select1 = select i1 %15, i32 4, i32 %7
  ...
  %20 = mul nsw i32 2, %16
  %21 = call ptr @newWorkList(i32 noundef %20)
  store ptr %21, ptr @workList, align 8
  %22 = load i32, ptr @listLength, align 4
  %23 = call ptr @newCombList(i32 noundef %22)
  store ptr %23, ptr @combList, align 8
  %24 = load i32, ptr @listLength, align 4
  %25 = call ptr @newCombList(i32 noundef %24)
  store ptr %25, ptr @solution, align 8
  %26 = load ptr, ptr @workList, align 8
  %27 = load i32, ptr @listLength, align 4
  call void @initWorkList(ptr noundef %26, ptr noundef %1, i32 noundef %27)
  %28 = load ptr, ptr @combList, align 8
  %29 = load i32, ptr @listLength, align 4
  call void @initCombList(ptr noundef %28, i32 noundef %29)
