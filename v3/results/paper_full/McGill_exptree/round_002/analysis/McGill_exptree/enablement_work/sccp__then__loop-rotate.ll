...
5:                                                ; preds = %2
  ...
  %9 = icmp eq i32 %0, %8
  br i1 %9, label %10, label %.preheader9
...
.preheader8:                                      ; preds = %.preheader9, %96
  %.0215 = phi i32 [ 1, %.preheader9 ], [ %97, %96 ]
  %33 = load i32, ptr @listLength, align 4
  %34 = add nsw i32 %33, %0
  %35 = icmp slt i32 0, %34
  br i1 %35, label %.lr.ph14, label %96

.lr.ph14:                                         ; preds = %.preheader8
  br label %36

36:                                               ; preds = %.lr.ph14, %91
  %.0412 = phi i32 [ 0, %.lr.ph14 ], [ %92, %91 ]
  %37 = shl nuw i32 1, %.0412
  %38 = and i32 %37, %1
  %39 = icmp ne i32 %38, 0
  br i1 %39, label %91, label %.preheader

.preheader:                                       ; preds = %36
  %40 = icmp slt i32 0, %.0412
...
41:                                               ; preds = %.lr.ph, %88
  %.0311 = phi i32 [ 0, %.lr.ph ], [ %89, %88 ]
  %42 = shl nuw i32 1, %.0311
  %43 = and i32 %42, %1
  %44 = icmp ne i32 %43, 0
...
45:                                               ; preds = %41
  ...
  %47 = sext i32 %.0412 to i64
  %48 = getelementptr inbounds i32, ptr %46, i64 %47
  %49 = load i32, ptr %48, align 4
  %50 = sext i32 %.0311 to i64
  %51 = getelementptr inbounds i32, ptr %46, i64 %50
  %52 = load i32, ptr %51, align 4
  switch i32 %.0215, label %56 [
    i32 3, label %53
    i32 4, label %53
  ]
...
88:                                               ; preds = %67, %61, %56, %53, %41
  %89 = add nsw i32 %.0311, 1
  %90 = icmp slt i32 %89, %.0412
...
91:                                               ; preds = %.loopexit, %36
  %.0413 = phi i32 [ %.0412, %.loopexit ], [ %.0412, %36 ]
  %92 = add nsw i32 %.0413, 1
...
96:                                               ; preds = %._crit_edge, %.preheader8
  %97 = add nsw i32 %.0215, 1
  %98 = icmp sle i32 %97, 4
  br i1 %98, label %.preheader8, label %.loopexit10, !llvm.loop !15

.loopexit10:                                      ; preds = %96
  br label %99

99:                                               ; preds = %.loopexit10, %31, %25, %10, %2
  ret void
}
