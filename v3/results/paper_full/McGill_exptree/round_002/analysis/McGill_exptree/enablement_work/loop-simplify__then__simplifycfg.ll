...
.preheader2:                                      ; preds = %5, %93
  %.02 = phi i32 [ %94, %93 ], [ 1, %5 ]
  %33 = icmp sle i32 %.02, 4
  br i1 %33, label %.preheader1, label %.loopexit3

.preheader1:                                      ; preds = %.preheader2, %.loopexit
  %.04 = phi i32 [ %92, %.loopexit ], [ 0, %.preheader2 ]
...
.preheader:                                       ; preds = %37, %90
  %.03 = phi i32 [ %91, %90 ], [ 0, %37 ]
  %41 = icmp slt i32 %.03, %.04
...
54:                                               ; preds = %46, %46
  ...
  br i1 %or.cond, label %90, label %57

57:                                               ; preds = %54, %46
  %58 = icmp eq i32 %50, 0
  %59 = icmp eq i32 %53, 0
  %or.cond1 = select i1 %58, i1 true, i1 %59
  br i1 %or.cond1, label %90, label %60
...
.critedge:                                        ; preds = %60
  ...
  %67 = icmp slt i32 %50, %53
  %or.cond4 = select i1 %.old, i1 %67, i1 false
  br i1 %or.cond4, label %68, label %69

68:                                               ; preds = %.critedge, %65
  br label %69

69:                                               ; preds = %68, %.critedge, %65
  %.01 = phi i32 [ %53, %68 ], [ %50, %65 ], [ %50, %.critedge ]
  %.0 = phi i32 [ %50, %68 ], [ %53, %65 ], [ %53, %.critedge ]
  %70 = or i32 %1, %38
  %71 = or i32 %70, %43
...
.loopexit3:                                       ; preds = %.preheader2, %31, %25, %10, %2
  ret void
}
