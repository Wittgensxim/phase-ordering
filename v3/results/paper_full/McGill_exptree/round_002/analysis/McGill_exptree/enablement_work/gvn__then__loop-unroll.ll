...
39:                                               ; preds = %35
  ...
  %41 = and i32 %40, %1
  %42 = icmp ne i32 %41, 0
  br i1 %42, label %94, label %.preheader

.preheader:                                       ; preds = %39
  br label %43

43:                                               ; preds = %.preheader, %92
...
35:                                               ; preds = %split, %._crit_edge
  %36 = phi i32 [ %.lcssa, %split ], [ %.pre2, %._crit_edge ]
  %37 = icmp eq i32 %36, 0
