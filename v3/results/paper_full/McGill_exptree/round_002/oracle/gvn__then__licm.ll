...
35:                                               ; preds = %.preheader2, %96
  %.02 = phi i32 [ %97, %96 ], [ 1, %.preheader2 ]
...
38:                                               ; preds = %.preheader1, %94
  %.04 = phi i32 [ %95, %94 ], [ 0, %.preheader1 ]
...
42:                                               ; preds = %38
  ...
  %44 = and i32 %43, %1
  %45 = icmp ne i32 %44, 0
  br i1 %45, label %94, label %.preheader
...
26:                                               ; preds = %33, %25
  %27 = phi i32 [ %.pre1, %33 ], [ %.pre, %25 ]
  %28 = phi i32 [ %35, %33 ], [ 1, %25 ]
...
36:                                               ; preds = %split, %._crit_edge
  %37 = phi i32 [ %.lcssa, %split ], [ %.pre2, %._crit_edge ]
  %38 = icmp eq i32 %37, 0
