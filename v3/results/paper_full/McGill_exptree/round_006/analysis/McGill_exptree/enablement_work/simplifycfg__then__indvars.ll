...
5:                                                ; preds = %28, %2
  ...
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %6, label %29
...
34:                                               ; preds = %88, %.preheader2
  %.02 = phi i32 [ %89, %88 ], [ 1, %.preheader2 ]
  %exitcond5 = icmp ne i32 %.02, 5
  br i1 %exitcond5, label %.preheader1, label %.loopexit3.loopexit
...
36:                                               ; preds = %.loopexit, %.preheader1
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %.loopexit ], [ 0, %.preheader1 ]
...
46:                                               ; preds = %87, %.preheader
  ...
  br i1 %exitcond, label %47, label %.loopexit.loopexit
...
.loopexit3.loopexit:                              ; preds = %34
  br label %.loopexit3

.loopexit3:                                       ; preds = %.loopexit3.loopexit, %32, %26, %11, %2
  ret void
}
...
3:                                                ; preds = %14, %0
  ...
  %4 = phi i32 [ %best.promoted, %0 ], [ %15, %14 ]
  %exitcond = icmp ne i64 %indvars.iv, %wide.trip.count
...
19:                                               ; preds = %.preheader, %24
  %20 = phi i32 [ %.pre1, %24 ], [ %.pre, %.preheader ]
  %storemerge = phi i32 [ %26, %24 ], [ 1, %.preheader ]
...
22:                                               ; preds = %19
  ...
  br i1 %.not, label %24, label %split.loopexit
...
split.loopexit:                                   ; preds = %22
  %.lcssa = phi i32 [ %23, %22 ]
  br label %split

split:                                            ; preds = %split.loopexit, %._crit_edge
  %27 = phi i32 [ %.pre2, %._crit_edge ], [ %.lcssa, %split.loopexit ]
  %28 = icmp eq i32 %27, 0
