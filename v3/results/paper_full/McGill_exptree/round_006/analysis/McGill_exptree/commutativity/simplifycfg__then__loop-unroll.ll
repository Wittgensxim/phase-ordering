...
34:                                               ; preds = %91, %.preheader2
  %.02 = phi i32 [ %92, %91 ], [ 1, %.preheader2 ]
  %35 = icmp samesign ult i32 %.02, 5
  br i1 %35, label %.preheader1, label %.loopexit3.loopexit
...
37:                                               ; preds = %.loopexit, %.preheader1
  %.04 = phi i32 [ %90, %.loopexit ], [ 0, %.preheader1 ]
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %41
  %90 = add nuw nsw i32 %.04, 1
  br label %37, !llvm.loop !14

91:                                               ; preds = %37
  %92 = add nuw nsw i32 %.02, 1
...
22:                                               ; preds = %.preheader, %27
  %23 = phi i32 [ %.pre1, %27 ], [ %.pre, %.preheader ]
  %storemerge = phi i32 [ %29, %27 ], [ 1, %.preheader ]
...
25:                                               ; preds = %22
  ...
  br i1 %.not, label %27, label %split.loopexit
...
split:                                            ; preds = %split.loopexit, %._crit_edge
  %30 = phi i32 [ %.pre2, %._crit_edge ], [ %.lcssa, %split.loopexit ]
  %31 = icmp eq i32 %30, 0
