...
34:                                               ; preds = %89, %.preheader2
  ...
  %exitcond12 = icmp ne i32 %.02, 5
  br i1 %exitcond12, label %.preheader1, label %.loopexit3
...
36:                                               ; preds = %88, %.preheader1
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %88 ], [ 0, %.preheader1 ]
  %37 = load i32, ptr @listLength, align 4
  %38 = add nsw i32 %37, %0
  %39 = sext i32 %38 to i64
  %40 = icmp slt i64 %indvars.iv9, %39
  br i1 %40, label %41, label %89

41:                                               ; preds = %36
  %42 = trunc nuw nsw i64 %indvars.iv9 to i32
  %43 = shl nuw i32 1, %42
  %44 = and i32 %43, %1
...
46:                                               ; preds = %87, %.preheader
  ...
  %exitcond = icmp ne i64 %indvars.iv, %indvars.iv9
...
51:                                               ; preds = %47
  ...
  %53 = getelementptr inbounds nuw [4 x i8], ptr %52, i64 %indvars.iv9
...
20:                                               ; preds = %25, %19
  %21 = phi i32 [ %.pre, %19 ], [ %.pre1, %25 ]
  %storemerge = phi i32 [ 1, %19 ], [ %27, %25 ]
