...
.preheader1:                                      ; preds = %.preheader2, %94
  %.pre56 = phi i32 [ %.pre, %.preheader2 ], [ %.pre57, %94 ]
  %34 = phi i32 [ %.pre, %.preheader2 ], [ %95, %94 ]
  %35 = phi i32 [ %.pre, %.preheader2 ], [ %96, %94 ]
  %.024 = phi i32 [ 1, %.preheader2 ], [ %97, %94 ]
  %36 = icmp eq i32 %.024, 4
  %.old = icmp eq i32 %.024, 2
  %37 = add nsw i32 %35, %0
  %38 = icmp slt i32 0, %37
  br i1 %38, label %.lr.ph3, label %94

.lr.ph3:                                          ; preds = %.preheader1
  br label %39

39:                                               ; preds = %.lr.ph3, %89
  %.pre58 = phi i32 [ %.pre56, %.lr.ph3 ], [ %.pre59, %89 ]
  %40 = phi i32 [ %34, %.lr.ph3 ], [ %90, %89 ]
  %.042 = phi i32 [ 0, %.lr.ph3 ], [ %91, %89 ]
...
.preheader:                                       ; preds = %39
  ...
  %44 = or i32 %1, %41
  %45 = icmp samesign ult i32 0, %.042
...
56:                                               ; preds = %49, %49
  ...
  br i1 %or.cond, label %86, label %59

59:                                               ; preds = %56, %49
  %60 = icmp eq i32 %52, 0
  %61 = icmp eq i32 %55, 0
  %or.cond1 = select i1 %60, i1 true, i1 %61
  br i1 %or.cond1, label %86, label %62

62:                                               ; preds = %59
  br i1 %36, label %63, label %.critedge

63:                                               ; preds = %62
  %64 = srem i32 %52, %55
  %.not3 = icmp eq i32 %64, 0
  br i1 %.not3, label %65, label %86

65:                                               ; preds = %63
  %.old3 = icmp slt i32 %52, %55
  br i1 %.old3, label %67, label %68

.critedge:                                        ; preds = %62
  %66 = icmp slt i32 %52, %55
...
68:                                               ; preds = %67, %.critedge, %65
  %.01 = phi i32 [ %55, %67 ], [ %52, %65 ], [ %52, %.critedge ]
  %.0 = phi i32 [ %52, %67 ], [ %55, %65 ], [ %55, %.critedge ]
  %69 = or i32 %44, %47
  ...
  %79 = getelementptr inbounds [12 x i8], ptr %78, i64 %9
  ...
  call void @recSearch(i32 noundef %10, i32 noundef %69)
  br label %86

86:                                               ; preds = %68, %63, %59, %56, %46
  %87 = add nuw nsw i32 %.031, 1
  %88 = icmp samesign ult i32 %87, %.042
  br i1 %88, label %46, label %..loopexit_crit_edge, !llvm.loop !13

..loopexit_crit_edge:                             ; preds = %86
  %.pre5.pre = load i32, ptr @listLength, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %.preheader
  %.pre5 = phi i32 [ %.pre5.pre, %..loopexit_crit_edge ], [ %.pre58, %.preheader ]
  br label %89

89:                                               ; preds = %.loopexit, %39
  %.pre59 = phi i32 [ %.pre5, %.loopexit ], [ %.pre58, %39 ]
  %90 = phi i32 [ %.pre5, %.loopexit ], [ %40, %39 ]
  %91 = add nuw nsw i32 %.042, 1
  %92 = add nsw i32 %90, %0
  %93 = icmp slt i32 %91, %92
  br i1 %93, label %39, label %._crit_edge, !llvm.loop !14

._crit_edge:                                      ; preds = %89
  br label %94

94:                                               ; preds = %._crit_edge, %.preheader1
  %.pre57 = phi i32 [ %.pre59, %._crit_edge ], [ %.pre56, %.preheader1 ]
  %95 = phi i32 [ %90, %._crit_edge ], [ %34, %.preheader1 ]
  %96 = phi i32 [ %90, %._crit_edge ], [ %35, %.preheader1 ]
  %97 = add nuw nsw i32 %.024, 1
...
22:                                               ; preds = %19
  ...
  br i1 %23, label %.lr.ph7, label %.._crit_edge_crit_edge8

.._crit_edge_crit_edge8:                          ; preds = %22
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge8, %.._crit_edge_crit_edge
  %.pre2 = phi i32 [ %.pre2.pre, %.._crit_edge_crit_edge8 ], [ 0, %.._crit_edge_crit_edge ]
  br label %30
...
30:                                               ; preds = %split, %._crit_edge
  %31 = phi i32 [ %25, %split ], [ %.pre2, %._crit_edge ]
  %32 = icmp eq i32 %31, 0
