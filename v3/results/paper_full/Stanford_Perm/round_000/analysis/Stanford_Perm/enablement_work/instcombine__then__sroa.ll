...
1:                                                ; preds = %7, %0
  %storemerge = phi i32 [ 1, %0 ], [ %8, %7 ]
  %2 = icmp slt i32 %storemerge, 8
...
6:                                                ; preds = %18, %4
  %storemerge.in = phi i32 [ %0, %4 ], [ %storemerge, %18 ]
  %storemerge = add nsw i32 %storemerge.in, -1
  %7 = icmp sgt i32 %storemerge.in, 1
  br i1 %7, label %8, label %19

8:                                                ; preds = %6
  %9 = sext i32 %0 to i64
  %10 = getelementptr inbounds [4 x i8], ptr @permarray, i64 %9
  %11 = sext i32 %storemerge to i64
  %12 = getelementptr inbounds [4 x i8], ptr @permarray, i64 %11
  call void @Swap(ptr noundef nonnull %10, ptr noundef nonnull %12)
  %13 = add nsw i32 %0, -1
  call void @Permute(i32 noundef %13)
  %14 = sext i32 %0 to i64
  %15 = getelementptr inbounds [4 x i8], ptr @permarray, i64 %14
  %16 = sext i32 %storemerge to i64
  %17 = getelementptr inbounds [4 x i8], ptr @permarray, i64 %16
  call void @Swap(ptr noundef nonnull %15, ptr noundef nonnull %17)
  br label %18
