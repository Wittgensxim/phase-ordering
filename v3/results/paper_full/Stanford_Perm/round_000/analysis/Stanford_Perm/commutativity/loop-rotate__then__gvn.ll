...
2:                                                ; preds = %.lr.ph, %2
  ...
  %8 = icmp sle i32 %7, 7
  br i1 %8, label %2, label %._crit_edge, !llvm.loop !7
...
2:                                                ; preds = %.lr.ph, %2
  %3 = phi i32 [ 1, %.lr.ph ], [ %4, %2 ]
  call void @Initialize()
  call void @Permute(i32 noundef 7)
  %4 = add nsw i32 %3, 1
  store i32 %4, ptr %1, align 4
  %5 = icmp sle i32 %4, 5
  br i1 %5, label %2, label %._crit_edge, !llvm.loop !10
...
6:                                                ; preds = %._crit_edge1, %._crit_edge
  %7 = phi i32 [ 0, %._crit_edge1 ], [ %.pre, %._crit_edge ]
  %8 = icmp ne i32 %7, 43300
  br i1 %8, label %9, label %11

9:                                                ; preds = %6
  %10 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  %.pre2 = load i32, ptr @pctr, align 4
  br label %11

11:                                               ; preds = %9, %6
  %12 = phi i32 [ %.pre2, %9 ], [ 43300, %6 ]
