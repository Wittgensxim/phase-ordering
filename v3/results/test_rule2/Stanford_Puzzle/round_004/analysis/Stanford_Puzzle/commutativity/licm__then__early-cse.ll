...
31:                                               ; preds = %37, %22
  ...
  br i1 %exitcond, label %33, label %.loopexit
...
38:                                               ; preds = %.loopexit, %36
  %storemerge2 = phi i32 [ %32, %36 ], [ 0, %.loopexit ]
  ret i32 %storemerge2
}
...
8:                                                ; preds = %25, %1
  %9 = phi i32 [ %.promoted, %1 ], [ %26, %25 ]
  %storemerge = phi i32 [ 0, %1 ], [ %27, %25 ]
...
25:                                               ; preds = %24, %18, %11
  %26 = phi i32 [ %21, %24 ], [ %9, %18 ], [ %9, %11 ]
  %27 = add nsw i32 %storemerge, 1
  br label %8, !llvm.loop !12

28:                                               ; preds = %20, %8
  %29 = phi i32 [ %21, %20 ], [ %9, %8 ]
  %storemerge1 = phi i32 [ 1, %20 ], [ 0, %8 ]
