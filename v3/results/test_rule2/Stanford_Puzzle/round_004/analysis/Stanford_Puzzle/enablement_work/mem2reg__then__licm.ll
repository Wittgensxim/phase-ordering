...
.preheader24:                                     ; preds = %37
  ...
  %invariant.op1 = add i32 %39, %storemerge3
  br label %40
...
42:                                               ; preds = %40
  ...
  %.reass2 = add i32 %43, %invariant.op1
  %44 = sext i32 %.reass2 to i64
...
.preheader22:                                     ; preds = %54
  ...
  %invariant.op3 = add i32 %56, %storemerge4
  br label %57
...
59:                                               ; preds = %57
  ...
  %.reass4 = add i32 %60, %invariant.op3
  %61 = sext i32 %.reass4 to i64
...
.preheader20:                                     ; preds = %71
  ...
  %invariant.op5 = add i32 %73, %storemerge5
  br label %74
...
76:                                               ; preds = %74
  ...
  %.reass6 = add i32 %77, %invariant.op5
  %78 = sext i32 %.reass6 to i64
...
.preheader18:                                     ; preds = %88
  ...
  %invariant.op7 = add i32 %90, %storemerge6
  br label %91
...
93:                                               ; preds = %91
  ...
  %.reass8 = add i32 %94, %invariant.op7
  %95 = sext i32 %.reass8 to i64
...
.preheader16:                                     ; preds = %105
  ...
  %invariant.op9 = add i32 %107, %storemerge7
  br label %108
...
110:                                              ; preds = %108
  ...
  %.reass10 = add i32 %111, %invariant.op9
  %112 = sext i32 %.reass10 to i64
...
.preheader14:                                     ; preds = %122
  ...
  %invariant.op11 = add i32 %124, %storemerge8
  br label %125
...
127:                                              ; preds = %125
  ...
  %.reass12 = add i32 %128, %invariant.op11
  %129 = sext i32 %.reass12 to i64
...
.preheader12:                                     ; preds = %139
  ...
  %invariant.op13 = add i32 %141, %storemerge9
  br label %142
...
144:                                              ; preds = %142
  ...
  %.reass14 = add i32 %145, %invariant.op13
  %146 = sext i32 %.reass14 to i64
...
.preheader10:                                     ; preds = %156
  ...
  %invariant.op15 = add i32 %158, %storemerge10
  br label %159
...
161:                                              ; preds = %159
  ...
  %.reass16 = add i32 %162, %invariant.op15
  %163 = sext i32 %.reass16 to i64
...
.preheader8:                                      ; preds = %173
  ...
  %invariant.op17 = add i32 %175, %storemerge11
  br label %176
...
178:                                              ; preds = %176
  ...
  %.reass18 = add i32 %179, %invariant.op17
  %180 = sext i32 %.reass18 to i64
...
.preheader6:                                      ; preds = %190
  ...
  %invariant.op19 = add i32 %192, %storemerge12
  br label %193
...
195:                                              ; preds = %193
  ...
  %.reass20 = add i32 %196, %invariant.op19
  %197 = sext i32 %.reass20 to i64
...
.preheader4:                                      ; preds = %207
  ...
  %invariant.op21 = add i32 %209, %storemerge13
  br label %210
...
212:                                              ; preds = %210
  ...
  %.reass22 = add i32 %213, %invariant.op21
  %214 = sext i32 %.reass22 to i64
...
.preheader2:                                      ; preds = %224
  ...
  %invariant.op23 = add i32 %226, %storemerge14
  br label %227
...
229:                                              ; preds = %227
  ...
  %.reass24 = add i32 %230, %invariant.op23
  %231 = sext i32 %.reass24 to i64
...
.preheader:                                       ; preds = %241
  ...
  %invariant.op25 = add i32 %243, %storemerge15
  br label %244
...
246:                                              ; preds = %244
  ...
  %.reass26 = add i32 %247, %invariant.op25
  %248 = sext i32 %.reass26 to i64
