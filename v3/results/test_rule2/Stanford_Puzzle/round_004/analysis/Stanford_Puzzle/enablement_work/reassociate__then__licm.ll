...
.preheader29:                                     ; preds = %13
  ...
  %invariant.op = add i32 %storemerge1, %15
  br label %16
...
.preheader24:                                     ; preds = %41
  %43 = mul i32 %storemerge44, 8
  %invariant.op5 = add i32 %storemerge3, %43
  br label %44
...
.preheader22:                                     ; preds = %58
  %60 = mul i32 %storemerge42, 8
  %invariant.op10 = add i32 %storemerge4, %60
  br label %61
...
.preheader20:                                     ; preds = %75
  %77 = mul i32 %storemerge40, 8
  %invariant.op15 = add i32 %storemerge5, %77
  br label %78
...
.preheader18:                                     ; preds = %92
  %94 = mul i32 %storemerge38, 8
  %invariant.op20 = add i32 %storemerge6, %94
  br label %95
...
.preheader16:                                     ; preds = %109
  %111 = mul i32 %storemerge36, 8
  %invariant.op25 = add i32 %storemerge7, %111
  br label %112
...
.preheader14:                                     ; preds = %126
  %128 = mul i32 %storemerge34, 8
  %invariant.op30 = add i32 %storemerge8, %128
  br label %129
...
.preheader12:                                     ; preds = %143
  %145 = mul i32 %storemerge32, 8
  %invariant.op35 = add i32 %storemerge9, %145
  br label %146
...
.preheader10:                                     ; preds = %160
  %162 = mul i32 %storemerge30, 8
  %invariant.op40 = add i32 %storemerge10, %162
  br label %163
...
.preheader8:                                      ; preds = %177
  %179 = mul i32 %storemerge28, 8
  %invariant.op45 = add i32 %storemerge11, %179
  br label %180
...
.preheader6:                                      ; preds = %194
  %196 = mul i32 %storemerge26, 8
  %invariant.op50 = add i32 %storemerge12, %196
  br label %197
...
.preheader4:                                      ; preds = %211
  %213 = mul i32 %storemerge24, 8
  %invariant.op55 = add i32 %storemerge13, %213
  br label %214
...
.preheader2:                                      ; preds = %228
  %230 = mul i32 %storemerge22, 8
  %invariant.op60 = add i32 %storemerge14, %230
  br label %231
...
.preheader:                                       ; preds = %245
  %247 = mul i32 %storemerge20, 8
  %invariant.op65 = add i32 %storemerge15, %247
  br label %248
