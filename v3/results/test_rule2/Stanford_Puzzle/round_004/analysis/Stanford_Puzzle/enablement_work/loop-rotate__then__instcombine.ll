...
9:                                                ; preds = %.lr.ph, %21
  %10 = phi i64 [ %6, %.lr.ph ], [ %25, %21 ]
  %storemerge2 = phi i32 [ 0, %.lr.ph ], [ %23, %21 ]
...
21:                                               ; preds = %15, %9
  ...
  %.not.not = icmp slt i32 %22, %27
  br i1 %.not.not, label %9, label %._crit_edge3, !llvm.loop !7
...
28:                                               ; preds = %._crit_edge3, %._crit_edge, %2
...
9:                                                ; preds = %.lr.ph, %20
  %10 = phi i64 [ %6, %.lr.ph ], [ %24, %20 ]
  %storemerge3 = phi i32 [ 0, %.lr.ph ], [ %22, %20 ]
  %11 = getelementptr inbounds [2048 x i8], ptr @p, i64 %10
...
20:                                               ; preds = %15, %9
  ...
  %.not.not = icmp slt i32 %21, %26
  br i1 %.not.not, label %9, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %20
  br label %27

27:                                               ; preds = %._crit_edge, %2
  %.lcssa = phi i64 [ %24, %._crit_edge ], [ %6, %2 ]
  %28 = getelementptr inbounds [4 x i8], ptr @class, i64 %.lcssa
  ...
  %smax = call i32 @llvm.smax.i32(i32 %34, i32 512)
  %wide.trip.count = zext nneg i32 %smax to i64
  store i32 %34, ptr %5, align 4
  %exitcond4.not = icmp sgt i32 %34, 511
  br i1 %exitcond4.not, label %.loopexit, label %.lr.ph7
...
36:                                               ; preds = %.lr.ph7, %41
  %indvars.iv5 = phi i64 [ %35, %.lr.ph7 ], [ %indvars.iv.next, %41 ]
  %37 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv5
  %38 = load i32, ptr %37, align 4
  %.not3 = icmp eq i32 %38, 0
  br i1 %.not3, label %39, label %41

39:                                               ; preds = %36
  %40 = trunc nsw i64 %indvars.iv5 to i32
  br label %43
...
41:                                               ; preds = %36
  ...
  br i1 %exitcond.not, label %..loopexit_crit_edge, label %36, !llvm.loop !10
...
43:                                               ; preds = %.loopexit, %39
  %storemerge2 = phi i32 [ %40, %39 ], [ 0, %.loopexit ]
  ret i32 %storemerge2
}
...
define dso_local void @Remove(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %7 = getelementptr inbounds [4 x i8], ptr @piecemax, i64 %6
  %8 = load i32, ptr %7, align 4
  %.not2 = icmp slt i32 %8, 0
  br i1 %.not2, label %27, label %.lr.ph
...
11:                                               ; preds = %.preheader29, %11
  %storemerge4817 = phi i32 [ 1, %.preheader29 ], [ %21, %11 ]
  %12 = load i32, ptr %1, align 4
  %13 = load i32, ptr %2, align 4
  %14 = shl i32 %storemerge4817, 6
  %15 = shl i32 %13, 3
  %16 = add i32 %14, %15
...
44:                                               ; preds = %.preheader24, %44
  %storemerge4519 = phi i32 [ 0, %.preheader24 ], [ %54, %44 ]
  %45 = load i32, ptr %1, align 4
  %46 = load i32, ptr %2, align 4
  %47 = shl i32 %storemerge4519, 6
  %48 = shl i32 %46, 3
  %49 = add i32 %47, %48
...
65:                                               ; preds = %.preheader22, %65
  %storemerge4320 = phi i32 [ 0, %.preheader22 ], [ %75, %65 ]
  %66 = load i32, ptr %1, align 4
  %67 = load i32, ptr %2, align 4
  %68 = shl i32 %storemerge4320, 6
  %69 = shl i32 %67, 3
  %70 = add i32 %68, %69
...
86:                                               ; preds = %.preheader20, %86
  %storemerge4121 = phi i32 [ 0, %.preheader20 ], [ %96, %86 ]
  %87 = load i32, ptr %1, align 4
  %88 = load i32, ptr %2, align 4
  %89 = shl i32 %storemerge4121, 6
  %90 = shl i32 %88, 3
  %91 = add i32 %89, %90
...
107:                                              ; preds = %.preheader18, %107
  %storemerge3922 = phi i32 [ 0, %.preheader18 ], [ %117, %107 ]
  %108 = load i32, ptr %1, align 4
  %109 = load i32, ptr %2, align 4
  %110 = shl i32 %storemerge3922, 6
  %111 = shl i32 %109, 3
  %112 = add i32 %110, %111
...
128:                                              ; preds = %.preheader16, %128
  %storemerge3723 = phi i32 [ 0, %.preheader16 ], [ %138, %128 ]
  %129 = load i32, ptr %1, align 4
  %130 = load i32, ptr %2, align 4
  %131 = shl i32 %storemerge3723, 6
  %132 = shl i32 %130, 3
  %133 = add i32 %131, %132
...
149:                                              ; preds = %.preheader14, %149
  %storemerge3524 = phi i32 [ 0, %.preheader14 ], [ %159, %149 ]
  %150 = load i32, ptr %1, align 4
  %151 = load i32, ptr %2, align 4
  %152 = shl i32 %storemerge3524, 6
  %153 = shl i32 %151, 3
  %154 = add i32 %152, %153
...
170:                                              ; preds = %.preheader12, %170
  %storemerge3325 = phi i32 [ 0, %.preheader12 ], [ %180, %170 ]
  %171 = load i32, ptr %1, align 4
  %172 = load i32, ptr %2, align 4
  %173 = shl i32 %storemerge3325, 6
  %174 = shl i32 %172, 3
  %175 = add i32 %173, %174
...
191:                                              ; preds = %.preheader10, %191
  %storemerge3126 = phi i32 [ 0, %.preheader10 ], [ %201, %191 ]
  %192 = load i32, ptr %1, align 4
  %193 = load i32, ptr %2, align 4
  %194 = shl i32 %storemerge3126, 6
  %195 = shl i32 %193, 3
  %196 = add i32 %194, %195
...
212:                                              ; preds = %.preheader8, %212
  %storemerge2927 = phi i32 [ 0, %.preheader8 ], [ %222, %212 ]
  %213 = load i32, ptr %1, align 4
  %214 = load i32, ptr %2, align 4
  %215 = shl i32 %storemerge2927, 6
  %216 = shl i32 %214, 3
  %217 = add i32 %215, %216
...
233:                                              ; preds = %.preheader6, %233
  %storemerge2728 = phi i32 [ 0, %.preheader6 ], [ %243, %233 ]
  %234 = load i32, ptr %1, align 4
  %235 = load i32, ptr %2, align 4
  %236 = shl i32 %storemerge2728, 6
  %237 = shl i32 %235, 3
  %238 = add i32 %236, %237
...
254:                                              ; preds = %.preheader4, %254
  %storemerge2529 = phi i32 [ 0, %.preheader4 ], [ %264, %254 ]
  %255 = load i32, ptr %1, align 4
  %256 = load i32, ptr %2, align 4
  %257 = shl i32 %storemerge2529, 6
  %258 = shl i32 %256, 3
  %259 = add i32 %257, %258
...
275:                                              ; preds = %.preheader2, %275
  %storemerge2330 = phi i32 [ 0, %.preheader2 ], [ %285, %275 ]
  %276 = load i32, ptr %1, align 4
  %277 = load i32, ptr %2, align 4
  %278 = shl i32 %storemerge2330, 6
  %279 = shl i32 %277, 3
  %280 = add i32 %278, %279
...
296:                                              ; preds = %.preheader, %296
  %storemerge2131 = phi i32 [ 0, %.preheader ], [ %306, %296 ]
  %297 = load i32, ptr %1, align 4
  %298 = load i32, ptr %2, align 4
  %299 = shl i32 %storemerge2131, 6
  %300 = shl i32 %298, 3
  %301 = add i32 %299, %300
