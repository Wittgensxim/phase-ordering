...
33:                                               ; preds = %41, %25
  %storemerge1 = phi i32 [ %32, %25 ], [ %42, %41 ]
  store i32 %storemerge1, ptr %5, align 4
  %34 = icmp slt i32 %storemerge1, 512
...
44:                                               ; preds = %43, %39
  %storemerge2 = phi i32 [ 0, %43 ], [ %storemerge1, %39 ]
  ret i32 %storemerge2
}
