...
4:                                                ; preds = %25, %1
  %.09 = phi i32 [ 0, %1 ], [ %26, %25 ]
  %5 = icmp samesign ult i32 %.09, 13
...
13:                                               ; preds = %6
  %14 = call i32 @Fit(i32 noundef %.09, i32 noundef %0)
  %.not10 = icmp eq i32 %14, 0
  br i1 %.not10, label %23, label %15

15:                                               ; preds = %13
  %16 = call i32 @Place(i32 noundef %.09, i32 noundef %0)
...
9:                                                ; preds = %30, %8
  %.0137 = phi i32 [ 1, %8 ], [ %31, %30 ]
  %10 = icmp samesign ult i32 %.0137, 6
...
12:                                               ; preds = %27, %11
  %.0123 = phi i32 [ 1, %11 ], [ %28, %27 ]
  %13 = icmp samesign ult i32 %.0123, 6
...
15:                                               ; preds = %24, %14
  %.0121 = phi i32 [ 1, %14 ], [ %25, %24 ]
  %16 = icmp samesign ult i32 %.0121, 6
  br i1 %16, label %17, label %26

17:                                               ; preds = %15
  %18 = shl nuw nsw i32 %.0121, 6
  %19 = shl nuw nsw i32 %.0123, 3
  %20 = or disjoint i32 %18, %19
  %21 = or disjoint i32 %.0137, %20
...
33:                                               ; preds = %46, %32
  %.1138 = phi i32 [ 0, %32 ], [ %47, %46 ]
  %34 = icmp samesign ult i32 %.1138, 13
...
49:                                               ; preds = %66, %48
  %.2139 = phi i32 [ 0, %48 ], [ %67, %66 ]
  %50 = icmp samesign ult i32 %.2139, 4
...
52:                                               ; preds = %63, %51
  %.1124 = phi i32 [ 0, %51 ], [ %64, %63 ]
  %53 = icmp samesign ult i32 %.1124, 2
...
55:                                               ; preds = %61, %54
  %.1122 = phi i1 [ true, %54 ], [ false, %61 ]
  br i1 %.1122, label %56, label %62

56:                                               ; preds = %55
  %57 = shl nuw nsw i32 %.1124, 3
  %58 = or disjoint i32 %.2139, %57
...
69:                                               ; preds = %87, %68
  %.3140 = phi i32 [ 0, %68 ], [ %88, %87 ]
  %70 = icmp samesign ult i32 %.3140, 2
...
75:                                               ; preds = %82, %74
  %.2 = phi i32 [ 0, %74 ], [ %83, %82 ]
  %76 = icmp samesign ult i32 %.2, 4
  br i1 %76, label %77, label %84

77:                                               ; preds = %75
  %78 = shl nuw nsw i32 %.2, 6
  %79 = or disjoint i32 %.3140, %78
...
93:                                               ; preds = %107, %92
  %.3126 = phi i32 [ 0, %92 ], [ %108, %107 ]
  %94 = icmp samesign ult i32 %.3126, 4
...
96:                                               ; preds = %104, %95
  ...
  %97 = icmp samesign ult i32 %.3, 2
  br i1 %97, label %98, label %106

98:                                               ; preds = %96
  %99 = shl nuw nsw i32 %.3, 6
  %100 = shl nuw nsw i32 %.3126, 3
...
112:                                              ; preds = %129, %111
  %.5142 = phi i32 [ 0, %111 ], [ %130, %129 ]
  %113 = icmp samesign ult i32 %.5142, 2
...
115:                                              ; preds = %126, %114
  %.4127 = phi i32 [ 0, %114 ], [ %127, %126 ]
  %116 = icmp samesign ult i32 %.4127, 4
...
118:                                              ; preds = %124, %117
  %.4 = phi i1 [ true, %117 ], [ false, %124 ]
  br i1 %.4, label %119, label %125

119:                                              ; preds = %118
  %120 = shl nuw nsw i32 %.4127, 3
  %121 = or disjoint i32 %.5142, %120
...
132:                                              ; preds = %150, %131
  %.6143 = phi i32 [ 0, %131 ], [ %151, %150 ]
  %133 = icmp samesign ult i32 %.6143, 4
...
138:                                              ; preds = %145, %137
  %.5 = phi i32 [ 0, %137 ], [ %146, %145 ]
  %139 = icmp samesign ult i32 %.5, 2
  br i1 %139, label %140, label %147

140:                                              ; preds = %138
  %141 = shl nuw nsw i32 %.5, 6
  %142 = or disjoint i32 %.6143, %141
...
156:                                              ; preds = %170, %155
  %.6129 = phi i32 [ 0, %155 ], [ %171, %170 ]
  %157 = icmp samesign ult i32 %.6129, 2
...
159:                                              ; preds = %167, %158
  %.6 = phi i32 [ 0, %158 ], [ %168, %167 ]
  %160 = icmp samesign ult i32 %.6, 4
  br i1 %160, label %161, label %169

161:                                              ; preds = %159
  %162 = shl nuw nsw i32 %.6, 6
  %163 = shl nuw nsw i32 %.6129, 3
...
175:                                              ; preds = %189, %174
  %.8145 = phi i32 [ 0, %174 ], [ %190, %189 ]
  %176 = icmp samesign ult i32 %.8145, 3
...
181:                                              ; preds = %185, %180
  %.7 = phi i1 [ true, %180 ], [ false, %185 ]
  br i1 %.7, label %182, label %186

182:                                              ; preds = %181
  %183 = zext nneg i32 %.8145 to i64
...
195:                                              ; preds = %205, %194
  %.8131 = phi i32 [ 0, %194 ], [ %206, %205 ]
  %196 = icmp samesign ult i32 %.8131, 3
...
198:                                              ; preds = %203, %197
  %.8 = phi i1 [ true, %197 ], [ false, %203 ]
  br i1 %.8, label %199, label %204

199:                                              ; preds = %198
  %200 = shl nuw nsw i32 %.8131, 3
...
216:                                              ; preds = %222, %215
  %.9 = phi i32 [ 0, %215 ], [ %223, %222 ]
  %217 = icmp samesign ult i32 %.9, 3
  br i1 %217, label %218, label %224

218:                                              ; preds = %216
  %219 = shl nuw nsw i32 %.9, 6
...
229:                                              ; preds = %246, %228
  %.11148 = phi i32 [ 0, %228 ], [ %247, %246 ]
  %230 = icmp samesign ult i32 %.11148, 2
...
232:                                              ; preds = %243, %231
  %.10133 = phi i32 [ 0, %231 ], [ %244, %243 ]
  %233 = icmp samesign ult i32 %.10133, 2
...
235:                                              ; preds = %241, %234
  %.10 = phi i1 [ true, %234 ], [ false, %241 ]
  br i1 %.10, label %236, label %242

236:                                              ; preds = %235
  %237 = shl nuw nsw i32 %.10133, 3
  %238 = or disjoint i32 %.11148, %237
...
249:                                              ; preds = %267, %248
  %.12149 = phi i32 [ 0, %248 ], [ %268, %267 ]
  %250 = icmp samesign ult i32 %.12149, 2
...
255:                                              ; preds = %262, %254
  ...
  %256 = icmp samesign ult i32 %.11, 2
  br i1 %256, label %257, label %264

257:                                              ; preds = %255
  %258 = shl nuw nsw i32 %.11, 6
  %259 = or disjoint i32 %.12149, %258
...
273:                                              ; preds = %287, %272
  %.12135 = phi i32 [ 0, %272 ], [ %288, %287 ]
  %274 = icmp samesign ult i32 %.12135, 2
...
276:                                              ; preds = %284, %275
  %.12 = phi i32 [ 0, %275 ], [ %285, %284 ]
  %277 = icmp samesign ult i32 %.12, 2
  br i1 %277, label %278, label %286

278:                                              ; preds = %276
  %279 = shl nuw nsw i32 %.12, 6
  %280 = shl nuw nsw i32 %.12135, 3
...
295:                                              ; preds = %310, %294
  %.13136 = phi i32 [ 0, %294 ], [ %311, %310 ]
  %296 = icmp samesign ult i32 %.13136, 2
...
298:                                              ; preds = %307, %297
  %.13 = phi i32 [ 0, %297 ], [ %308, %307 ]
  %299 = icmp samesign ult i32 %.13, 2
  br i1 %299, label %300, label %309

300:                                              ; preds = %298
  %301 = shl nuw nsw i32 %.13, 6
  %302 = shl nuw nsw i32 %.13136, 3
...
320:                                              ; preds = %319, %317
  ...
  %.not151 = icmp eq i32 %322, 0
  br i1 %.not151, label %323, label %324

323:                                              ; preds = %320
  %puts152 = call i32 @puts(ptr nonnull dereferenceable(1) @str.1)
  br label %328

324:                                              ; preds = %320
  %325 = load i32, ptr @kount, align 4
  %.not153 = icmp eq i32 %325, 2005
  br i1 %.not153, label %327, label %326
