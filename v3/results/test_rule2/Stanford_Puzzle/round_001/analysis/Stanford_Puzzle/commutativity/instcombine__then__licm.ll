...
22:                                               ; preds = %17
  %storemerge.lcssa4 = phi i32 [ %storemerge, %17 ]
...
32:                                               ; preds = %40, %24
  %storemerge1 = phi i32 [ %31, %24 ], [ %41, %40 ]
...
38:                                               ; preds = %34
  %storemerge1.lcssa6 = phi i32 [ %storemerge1, %34 ]
  %storemerge1.lcssa5 = phi i32 [ %storemerge1, %34 ]
  store i32 %storemerge1.lcssa6, ptr %5, align 4
  br label %43
...
42:                                               ; preds = %32
  %storemerge1.lcssa = phi i32 [ %storemerge1, %32 ]
  store i32 %storemerge1.lcssa, ptr %5, align 4
  br label %43

43:                                               ; preds = %42, %38
  %storemerge2 = phi i32 [ 0, %42 ], [ %storemerge1.lcssa5, %38 ]
  ret i32 %storemerge2
}
