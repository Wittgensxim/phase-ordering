...
define dso_local i32 @Fit(i32 noundef %0, i32 noundef %1) #0 {
  ...
  br i1 %.not4, label %32, label %.lr.ph
...
10:                                               ; preds = %.lr.ph, %25
  ...
  %storemerge5 = phi i32 [ 0, %.lr.ph ], [ %27, %25 ]
...
define dso_local i32 @Place(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %8 = getelementptr inbounds [4 x i8], ptr @piecemax, i64 %7
  %9 = load i32, ptr %8, align 4
  %.not6 = icmp sgt i32 0, %9
  br i1 %.not6, label %29, label %.lr.ph
...
10:                                               ; preds = %.lr.ph, %22
  ...
  %storemerge7 = phi i32 [ 0, %.lr.ph ], [ %24, %22 ]
  %12 = getelementptr inbounds [2048 x i8], ptr @p, i64 %11
  %13 = sext i32 %storemerge7 to i64
  %14 = getelementptr inbounds [4 x i8], ptr %12, i64 %13
  %15 = load i32, ptr %14, align 4
...
29:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %37, label %.lr.ph10, label %47

.lr.ph10:                                         ; preds = %29
  br label %38

38:                                               ; preds = %.lr.ph10, %44
  %storemerge18 = phi i32 [ %36, %.lr.ph10 ], [ %45, %44 ]
  %39 = sext i32 %storemerge18 to i64
  %40 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %39
  %41 = load i32, ptr %40, align 4
  %.not3 = icmp eq i32 %41, 0
  br i1 %.not3, label %42, label %43

42:                                               ; preds = %38
  %storemerge1.lcssa5 = phi i32 [ %storemerge18, %38 ]
  br label %48
...
44:                                               ; preds = %43
  %45 = add nsw i32 %storemerge18, 1
  store i32 %45, ptr %5, align 4
  %46 = icmp slt i32 %45, 512
  br i1 %46, label %38, label %._crit_edge11, !llvm.loop !10

._crit_edge11:                                    ; preds = %44
  br label %47

47:                                               ; preds = %._crit_edge11, %29
  br label %48

48:                                               ; preds = %47, %42
  %storemerge2 = phi i32 [ 0, %47 ], [ %storemerge1.lcssa5, %42 ]
  ret i32 %storemerge2
}
...
14:                                               ; preds = %7
  ...
  %16 = call i32 @Fit(i32 noundef %storemerge4, i32 noundef %15)
...
15:                                               ; preds = %14, %24
  %storemerge4850 = phi i32 [ 1, %14 ], [ %26, %24 ]
  %16 = load i32, ptr %1, align 4
  %17 = load i32, ptr %2, align 4
  %18 = shl i32 %storemerge4850, 6
  %19 = shl i32 %17, 3
  %20 = add i32 %18, %19
...
40:                                               ; preds = %39, %46
  %storemerge4651 = phi i32 [ 0, %39 ], [ %48, %46 ]
  %41 = load i32, ptr %1, align 4
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds [2048 x i8], ptr @p, i64 %42
  %44 = sext i32 %storemerge4651 to i64
...
58:                                               ; preds = %57, %67
  %storemerge4552 = phi i32 [ 0, %57 ], [ %69, %67 ]
  %59 = load i32, ptr %1, align 4
  %60 = load i32, ptr %2, align 4
  %61 = shl i32 %storemerge4552, 6
  %62 = shl i32 %60, 3
  %63 = add i32 %61, %62
...
84:                                               ; preds = %83, %93
  %storemerge4353 = phi i32 [ 0, %83 ], [ %95, %93 ]
  %85 = load i32, ptr %1, align 4
  %86 = load i32, ptr %2, align 4
  %87 = shl i32 %storemerge4353, 6
  %88 = shl i32 %86, 3
  %89 = add i32 %87, %88
...
110:                                              ; preds = %109, %119
  %storemerge4154 = phi i32 [ 0, %109 ], [ %121, %119 ]
  %111 = load i32, ptr %1, align 4
  %112 = load i32, ptr %2, align 4
  %113 = shl i32 %storemerge4154, 6
  %114 = shl i32 %112, 3
  %115 = add i32 %113, %114
...
136:                                              ; preds = %135, %145
  %storemerge3955 = phi i32 [ 0, %135 ], [ %147, %145 ]
  %137 = load i32, ptr %1, align 4
  %138 = load i32, ptr %2, align 4
  %139 = shl i32 %storemerge3955, 6
  %140 = shl i32 %138, 3
  %141 = add i32 %139, %140
...
162:                                              ; preds = %161, %171
  %storemerge3756 = phi i32 [ 0, %161 ], [ %173, %171 ]
  %163 = load i32, ptr %1, align 4
  %164 = load i32, ptr %2, align 4
  %165 = shl i32 %storemerge3756, 6
  %166 = shl i32 %164, 3
  %167 = add i32 %165, %166
...
188:                                              ; preds = %187, %197
  %storemerge3557 = phi i32 [ 0, %187 ], [ %199, %197 ]
  %189 = load i32, ptr %1, align 4
  %190 = load i32, ptr %2, align 4
  %191 = shl i32 %storemerge3557, 6
  %192 = shl i32 %190, 3
  %193 = add i32 %191, %192
...
214:                                              ; preds = %213, %223
  %storemerge3358 = phi i32 [ 0, %213 ], [ %225, %223 ]
  %215 = load i32, ptr %1, align 4
  %216 = load i32, ptr %2, align 4
  %217 = shl i32 %storemerge3358, 6
  %218 = shl i32 %216, 3
  %219 = add i32 %217, %218
...
240:                                              ; preds = %239, %249
  %storemerge3159 = phi i32 [ 0, %239 ], [ %251, %249 ]
  %241 = load i32, ptr %1, align 4
  %242 = load i32, ptr %2, align 4
  %243 = shl i32 %storemerge3159, 6
  %244 = shl i32 %242, 3
  %245 = add i32 %243, %244
...
266:                                              ; preds = %265, %275
  %storemerge2960 = phi i32 [ 0, %265 ], [ %277, %275 ]
  %267 = load i32, ptr %1, align 4
  %268 = load i32, ptr %2, align 4
  %269 = shl i32 %storemerge2960, 6
  %270 = shl i32 %268, 3
  %271 = add i32 %269, %270
...
292:                                              ; preds = %291, %301
  %storemerge2761 = phi i32 [ 0, %291 ], [ %303, %301 ]
  %293 = load i32, ptr %1, align 4
  %294 = load i32, ptr %2, align 4
  %295 = shl i32 %storemerge2761, 6
  %296 = shl i32 %294, 3
  %297 = add i32 %295, %296
...
318:                                              ; preds = %317, %327
  %storemerge2562 = phi i32 [ 0, %317 ], [ %329, %327 ]
  %319 = load i32, ptr %1, align 4
  %320 = load i32, ptr %2, align 4
  %321 = shl i32 %storemerge2562, 6
  %322 = shl i32 %320, 3
  %323 = add i32 %321, %322
...
344:                                              ; preds = %343, %353
  %storemerge2363 = phi i32 [ 0, %343 ], [ %355, %353 ]
  %345 = load i32, ptr %1, align 4
  %346 = load i32, ptr %2, align 4
  %347 = shl i32 %storemerge2363, 6
  %348 = shl i32 %346, 3
  %349 = add i32 %347, %348
...
370:                                              ; preds = %369, %379
  %storemerge2164 = phi i32 [ 0, %369 ], [ %381, %379 ]
  %371 = load i32, ptr %1, align 4
  %372 = load i32, ptr %2, align 4
  %373 = shl i32 %storemerge2164, 6
  %374 = shl i32 %372, 3
  %375 = add i32 %373, %374
...
407:                                              ; preds = %406, %402
  ...
  %411 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %410) #3
  ret void
}
