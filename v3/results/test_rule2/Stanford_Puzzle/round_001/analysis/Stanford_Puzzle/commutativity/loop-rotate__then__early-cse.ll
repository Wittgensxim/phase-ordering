...
12:                                               ; preds = %.lr.ph, %30
  %13 = phi i64 [ %8, %.lr.ph ], [ %34, %30 ]
  %14 = phi i32 [ 0, %.lr.ph ], [ %32, %30 ]
...
30:                                               ; preds = %29
  ...
  br i1 %37, label %12, label %._crit_edge, !llvm.loop !7
...
12:                                               ; preds = %.lr.ph, %26
  %13 = phi i64 [ %8, %.lr.ph ], [ %30, %26 ]
  %14 = phi i32 [ 0, %.lr.ph ], [ %28, %26 ]
  %15 = getelementptr inbounds [13 x [512 x i32]], ptr @p, i64 0, i64 %13
  %16 = sext i32 %14 to i64
  %17 = getelementptr inbounds [512 x i32], ptr %15, i64 0, i64 %16
  %18 = load i32, ptr %17, align 4
...
26:                                               ; preds = %25
  ...
  br i1 %33, label %12, label %._crit_edge, !llvm.loop !9

._crit_edge:                                      ; preds = %26
  br label %34

34:                                               ; preds = %._crit_edge, %2
  %.lcssa = phi i64 [ %30, %._crit_edge ], [ %8, %2 ]
  ...
  br i1 %42, label %.lr.ph2, label %54

.lr.ph2:                                          ; preds = %34
  br label %43

43:                                               ; preds = %.lr.ph2, %51
  %44 = phi i32 [ %41, %.lr.ph2 ], [ %52, %51 ]
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds [512 x i32], ptr @puzzl, i64 0, i64 %45
...
51:                                               ; preds = %50
  ...
  br i1 %53, label %43, label %._crit_edge3, !llvm.loop !10
...
11:                                               ; preds = %.lr.ph, %25
  %12 = phi i64 [ %7, %.lr.ph ], [ %29, %25 ]
  %13 = phi i32 [ 0, %.lr.ph ], [ %27, %25 ]
...
25:                                               ; preds = %24
  ...
  br i1 %32, label %11, label %._crit_edge, !llvm.loop !11

._crit_edge:                                      ; preds = %25
  br label %33

33:                                               ; preds = %._crit_edge, %2
  %.lcssa = phi i64 [ %29, %._crit_edge ], [ %7, %2 ]
...
42:                                               ; preds = %.lr.ph11, %49
  ...
  %48 = getelementptr inbounds [512 x i32], ptr %46, i64 0, i64 %47
