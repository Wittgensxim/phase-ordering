...
33:                                               ; preds = %41, %20
  %storemerge1 = phi i32 [ %1, %20 ], [ %42, %41 ]
...
373:                                              ; preds = %372, %368
  ...
  %375 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %374) #3
  %376 = load i32, ptr @kount, align 4
  %377 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %376) #3
  ret void
}
