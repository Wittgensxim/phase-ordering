...
60:                                               ; preds = %.lr.ph2
  ...
  br i1 %64, label %.lr.ph2, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %60, %._crit_edge
  store i32 0, ptr %3, align 4
  br label %65

65:                                               ; preds = %._crit_edge3, %58
...
18:                                               ; preds = %.lr.ph
  ...
  %21 = call i32 @Fit(i32 noundef %19, i32 noundef %20)
  %22 = icmp ne i32 %21, 0
...
.lr.ph11:                                         ; preds = %.lr.ph14, %.lr.ph11
  ...
  %47 = getelementptr inbounds [13 x [512 x i32]], ptr @p, i64 0, i64 %46
