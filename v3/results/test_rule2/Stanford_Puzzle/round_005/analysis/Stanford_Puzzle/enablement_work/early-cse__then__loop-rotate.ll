...
37:                                               ; preds = %39
  %indvars.iv = phi i64 [ %indvars.iv.next, %39 ]
  %38 = trunc nsw i64 %indvars.iv to i32
  store i32 %38, ptr %5, align 4
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %..loopexit_crit_edge, label %39, !llvm.loop !10

39:                                               ; preds = %.lr.ph7, %37
  %40 = phi i32 [ %35, %.lr.ph7 ], [ %38, %37 ]
  %indvars.iv5 = phi i64 [ %36, %.lr.ph7 ], [ %indvars.iv, %37 ]
  %41 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv5
  %42 = load i32, ptr %41, align 4
  %.not3 = icmp eq i32 %42, 0
  %indvars.iv.next = add nsw i64 %indvars.iv5, 1
  br i1 %.not3, label %43, label %37
...
44:                                               ; preds = %.loopexit, %43
  %storemerge2 = phi i32 [ %.lcssa1, %43 ], [ 0, %.loopexit ]
  ret i32 %storemerge2
}
