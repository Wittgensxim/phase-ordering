...
6:                                                ; preds = %.lr.ph, %17
  %.0 = phi i32 [ 0, %.lr.ph ], [ %18, %17 ]
  %7 = phi i64 [ %3, %.lr.ph ], [ %19, %17 ]
  %storemerge2 = phi i32 [ 0, %.lr.ph ], [ %18, %17 ]
  %8 = getelementptr inbounds [2048 x i8], ptr @p, i64 %7
...
17:                                               ; preds = %12, %6
  ...
  %20 = getelementptr inbounds [4 x i8], ptr @piecemax, i64 %19
...
16:                                               ; preds = %12, %6
  ...
  %19 = getelementptr inbounds [4 x i8], ptr @piecemax, i64 %18
  %20 = load i32, ptr %19, align 4
  %.not = icmp sgt i32 %17, %20
...
21:                                               ; preds = %._crit_edge, %2
  ...
  %22 = getelementptr inbounds [4 x i8], ptr @class, i64 %.lcssa
...
32:                                               ; preds = %29
  %indvars.iv.lcssa1 = phi i64 [ %indvars.iv5, %29 ]
  %33 = trunc nsw i64 %indvars.iv.lcssa1 to i32
  br label %.loopexit
...
13:                                               ; preds = %11
  %14 = call i32 @Place(i32 noundef %.0, i32 noundef %0)
...
17:                                               ; preds = %13
  call void @Remove(i32 noundef %.0, i32 noundef %0)
  br label %18
...
.preheader30.preheader:                           ; preds = %.preheader31.preheader, %.preheader31
  %.0122 = phi i32 [ 1, %.preheader31.preheader ], [ %16, %.preheader31 ]
...
.preheader27.preheader:                           ; preds = %.preheader28.preheader, %.preheader28
  %.1123 = phi i32 [ 0, %.preheader28.preheader ], [ %24, %.preheader28 ]
...
.preheader27:                                     ; preds = %.preheader27.preheader, %.preheader27
  %.1 = phi i32 [ 0, %.preheader27.preheader ], [ %22, %.preheader27 ]
  %storemerge4618 = phi i32 [ 0, %.preheader27.preheader ], [ %22, %.preheader27 ]
  %18 = sext i32 %.1123 to i64
  %19 = getelementptr inbounds [2048 x i8], ptr @p, i64 %18
  %20 = sext i32 %storemerge4618 to i64
...
.preheader23.preheader:                           ; preds = %38, %49
  %.3125 = phi i32 [ 0, %38 ], [ %50, %49 ]
  br label %.preheader22.preheader

.preheader22.preheader:                           ; preds = %.preheader23.preheader, %.preheader23
  %.2110 = phi i32 [ 0, %.preheader23.preheader ], [ %47, %.preheader23 ]
  br label %.preheader22

.preheader22:                                     ; preds = %.preheader22.preheader, %.preheader22
  %.2 = phi i32 [ 0, %.preheader22.preheader ], [ %45, %.preheader22 ]
  %storemerge4320 = phi i32 [ 0, %.preheader22.preheader ], [ %45, %.preheader22 ]
  %39 = shl i32 %storemerge4320, 6
  %40 = shl i32 %.2110, 3
  %41 = add i32 %39, %40
  %42 = add nsw i32 %.3125, %41
...
.preheader21.preheader:                           ; preds = %52, %63
  %.4126 = phi i32 [ 0, %52 ], [ %64, %63 ]
  br label %.preheader20.preheader

.preheader20.preheader:                           ; preds = %.preheader21.preheader, %.preheader21
  %.3111 = phi i32 [ 0, %.preheader21.preheader ], [ %61, %.preheader21 ]
  br label %.preheader20

.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  %.3 = phi i32 [ 0, %.preheader20.preheader ], [ %59, %.preheader20 ]
  %storemerge4121 = phi i32 [ 0, %.preheader20.preheader ], [ %59, %.preheader20 ]
  %53 = shl i32 %storemerge4121, 6
  %54 = shl i32 %.3111, 3
  %55 = add i32 %53, %54
  %56 = add nsw i32 %.4126, %55
...
.preheader19.preheader:                           ; preds = %66, %77
  %.5127 = phi i32 [ 0, %66 ], [ %78, %77 ]
  br label %.preheader18.preheader

.preheader18.preheader:                           ; preds = %.preheader19.preheader, %.preheader19
  %.4112 = phi i32 [ 0, %.preheader19.preheader ], [ %75, %.preheader19 ]
  br label %.preheader18

.preheader18:                                     ; preds = %.preheader18.preheader, %.preheader18
  %.4 = phi i32 [ 0, %.preheader18.preheader ], [ %73, %.preheader18 ]
  %storemerge3922 = phi i32 [ 0, %.preheader18.preheader ], [ %73, %.preheader18 ]
  %67 = shl i32 %storemerge3922, 6
  %68 = shl i32 %.4112, 3
  %69 = add i32 %67, %68
  %70 = add nsw i32 %.5127, %69
...
.preheader17.preheader:                           ; preds = %80, %91
  %.6128 = phi i32 [ 0, %80 ], [ %92, %91 ]
  br label %.preheader16.preheader

.preheader16.preheader:                           ; preds = %.preheader17.preheader, %.preheader17
  %.5113 = phi i32 [ 0, %.preheader17.preheader ], [ %89, %.preheader17 ]
  br label %.preheader16

.preheader16:                                     ; preds = %.preheader16.preheader, %.preheader16
  %.5 = phi i32 [ 0, %.preheader16.preheader ], [ %87, %.preheader16 ]
  %storemerge3723 = phi i32 [ 0, %.preheader16.preheader ], [ %87, %.preheader16 ]
  %81 = shl i32 %storemerge3723, 6
  %82 = shl i32 %.5113, 3
  %83 = add i32 %81, %82
  %84 = add nsw i32 %.6128, %83
...
.preheader15.preheader:                           ; preds = %94, %105
  %.7129 = phi i32 [ 0, %94 ], [ %106, %105 ]
  br label %.preheader14.preheader

.preheader14.preheader:                           ; preds = %.preheader15.preheader, %.preheader15
  %.6114 = phi i32 [ 0, %.preheader15.preheader ], [ %103, %.preheader15 ]
  br label %.preheader14

.preheader14:                                     ; preds = %.preheader14.preheader, %.preheader14
  %.6 = phi i32 [ 0, %.preheader14.preheader ], [ %101, %.preheader14 ]
  %storemerge3524 = phi i32 [ 0, %.preheader14.preheader ], [ %101, %.preheader14 ]
  %95 = shl i32 %storemerge3524, 6
  %96 = shl i32 %.6114, 3
  %97 = add i32 %95, %96
  %98 = add nsw i32 %.7129, %97
...
.preheader13.preheader:                           ; preds = %108, %119
  %.8130 = phi i32 [ 0, %108 ], [ %120, %119 ]
  br label %.preheader12.preheader

.preheader12.preheader:                           ; preds = %.preheader13.preheader, %.preheader13
  %.7115 = phi i32 [ 0, %.preheader13.preheader ], [ %117, %.preheader13 ]
  br label %.preheader12

.preheader12:                                     ; preds = %.preheader12.preheader, %.preheader12
  %.7 = phi i32 [ 0, %.preheader12.preheader ], [ %115, %.preheader12 ]
  %storemerge3325 = phi i32 [ 0, %.preheader12.preheader ], [ %115, %.preheader12 ]
  %109 = shl i32 %storemerge3325, 6
  %110 = shl i32 %.7115, 3
  %111 = add i32 %109, %110
  %112 = add nsw i32 %.8130, %111
...
.preheader11.preheader:                           ; preds = %122, %133
  %.9131 = phi i32 [ 0, %122 ], [ %134, %133 ]
  br label %.preheader10.preheader

.preheader10.preheader:                           ; preds = %.preheader11.preheader, %.preheader11
  %.8116 = phi i32 [ 0, %.preheader11.preheader ], [ %131, %.preheader11 ]
  br label %.preheader10

.preheader10:                                     ; preds = %.preheader10.preheader, %.preheader10
  %.8 = phi i32 [ 0, %.preheader10.preheader ], [ %129, %.preheader10 ]
  %storemerge3126 = phi i32 [ 0, %.preheader10.preheader ], [ %129, %.preheader10 ]
  %123 = shl i32 %storemerge3126, 6
  %124 = shl i32 %.8116, 3
  %125 = add i32 %123, %124
  %126 = add nsw i32 %.9131, %125
...
.preheader9.preheader:                            ; preds = %136, %147
  %.10132 = phi i32 [ 0, %136 ], [ %148, %147 ]
  br label %.preheader8.preheader

.preheader8.preheader:                            ; preds = %.preheader9.preheader, %.preheader9
  %.9117 = phi i32 [ 0, %.preheader9.preheader ], [ %145, %.preheader9 ]
  br label %.preheader8

.preheader8:                                      ; preds = %.preheader8.preheader, %.preheader8
  %.9 = phi i32 [ 0, %.preheader8.preheader ], [ %143, %.preheader8 ]
  %storemerge2927 = phi i32 [ 0, %.preheader8.preheader ], [ %143, %.preheader8 ]
  %137 = shl i32 %storemerge2927, 6
  %138 = shl i32 %.9117, 3
  %139 = add i32 %137, %138
  %140 = add nsw i32 %.10132, %139
...
.preheader7.preheader:                            ; preds = %150, %161
  %.11133 = phi i32 [ 0, %150 ], [ %162, %161 ]
  br label %.preheader6.preheader

.preheader6.preheader:                            ; preds = %.preheader7.preheader, %.preheader7
  %.10118 = phi i32 [ 0, %.preheader7.preheader ], [ %159, %.preheader7 ]
  br label %.preheader6

.preheader6:                                      ; preds = %.preheader6.preheader, %.preheader6
  %.10 = phi i32 [ 0, %.preheader6.preheader ], [ %157, %.preheader6 ]
  %storemerge2728 = phi i32 [ 0, %.preheader6.preheader ], [ %157, %.preheader6 ]
  %151 = shl i32 %storemerge2728, 6
  %152 = shl i32 %.10118, 3
  %153 = add i32 %151, %152
  %154 = add nsw i32 %.11133, %153
...
.preheader5.preheader:                            ; preds = %164, %175
  %.12134 = phi i32 [ 0, %164 ], [ %176, %175 ]
  br label %.preheader4.preheader

.preheader4.preheader:                            ; preds = %.preheader5.preheader, %.preheader5
  %.11119 = phi i32 [ 0, %.preheader5.preheader ], [ %173, %.preheader5 ]
  br label %.preheader4

.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  %.11 = phi i32 [ 0, %.preheader4.preheader ], [ %171, %.preheader4 ]
  %storemerge2529 = phi i32 [ 0, %.preheader4.preheader ], [ %171, %.preheader4 ]
  %165 = shl i32 %storemerge2529, 6
  %166 = shl i32 %.11119, 3
  %167 = add i32 %165, %166
  %168 = add nsw i32 %.12134, %167
...
.preheader3.preheader:                            ; preds = %178, %189
  %.13135 = phi i32 [ 0, %178 ], [ %190, %189 ]
  br label %.preheader2.preheader

.preheader2.preheader:                            ; preds = %.preheader3.preheader, %.preheader3
  %.12120 = phi i32 [ 0, %.preheader3.preheader ], [ %187, %.preheader3 ]
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %.preheader2
  %.12 = phi i32 [ 0, %.preheader2.preheader ], [ %185, %.preheader2 ]
  %storemerge2330 = phi i32 [ 0, %.preheader2.preheader ], [ %185, %.preheader2 ]
  %179 = shl i32 %storemerge2330, 6
  %180 = shl i32 %.12120, 3
  %181 = add i32 %179, %180
  %182 = add nsw i32 %.13135, %181
...
.preheader1.preheader:                            ; preds = %192, %203
  %.14 = phi i32 [ 0, %192 ], [ %204, %203 ]
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader1.preheader, %.preheader1
  %.13121 = phi i32 [ 0, %.preheader1.preheader ], [ %201, %.preheader1 ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %.13 = phi i32 [ 0, %.preheader.preheader ], [ %199, %.preheader ]
  %storemerge2131 = phi i32 [ 0, %.preheader.preheader ], [ %199, %.preheader ]
  %193 = shl i32 %storemerge2131, 6
  %194 = shl i32 %.13121, 3
  %195 = add i32 %193, %194
  %196 = add nsw i32 %.14, %195
