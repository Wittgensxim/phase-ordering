...
41:                                               ; preds = %36
  ...
  br i1 %exitcond.not, label %..loopexit.loopexit_crit_edge, label %36, !llvm.loop !10

..loopexit.loopexit_crit_edge:                    ; preds = %41
  br label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %..loopexit.loopexit_crit_edge, %27
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %39
  %storemerge2 = phi i32 [ %40, %39 ], [ 0, %.loopexit.loopexit ]
  ret i32 %storemerge2
}
