...
27:                                               ; preds = %32, %19
  %indvars.iv = phi i64 [ %indvars.iv.next, %32 ], [ %26, %19 ]
...
29:                                               ; preds = %27
  ...
  br i1 %.not3, label %.loopexit, label %32

32:                                               ; preds = %29
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  br label %27, !llvm.loop !10

.loopexit:                                        ; preds = %27, %29
  %storemerge2 = phi i32 [ %28, %29 ], [ 0, %27 ]
  ret i32 %storemerge2
}
...
.preheader31:                                     ; preds = %5, %30
  %12 = phi i32 [ %31, %30 ], [ 1, %5 ]
  store i32 %12, ptr %1, align 4
  %13 = icmp slt i32 %12, 6
  br i1 %13, label %.preheader30, label %.preheader28

.preheader30:                                     ; preds = %.preheader31, %28
  %14 = phi i32 [ %17, %28 ], [ %12, %.preheader31 ]
  %15 = phi i32 [ %29, %28 ], [ 1, %.preheader31 ]
  store i32 %15, ptr %2, align 4
  %16 = icmp slt i32 %15, 6
  br i1 %16, label %.preheader29, label %30

.preheader29:                                     ; preds = %.preheader30, %20
  %17 = phi i32 [ %12, %20 ], [ %14, %.preheader30 ]
  %18 = phi i32 [ %27, %20 ], [ 1, %.preheader30 ]
...
.preheader26:                                     ; preds = %.preheader28, %62
  %44 = phi i32 [ %63, %62 ], [ 0, %.preheader28 ]
  store i32 %44, ptr %1, align 4
  %45 = icmp slt i32 %44, 4
  br i1 %45, label %.preheader25, label %64

.preheader25:                                     ; preds = %.preheader26, %60
  %46 = phi i32 [ %49, %60 ], [ %44, %.preheader26 ]
  %47 = phi i32 [ %61, %60 ], [ 0, %.preheader26 ]
  store i32 %47, ptr %2, align 4
  %48 = icmp slt i32 %47, 2
  br i1 %48, label %.preheader24, label %62

.preheader24:                                     ; preds = %.preheader25, %52
  %49 = phi i32 [ %44, %52 ], [ %46, %.preheader25 ]
  %50 = phi i32 [ %59, %52 ], [ 0, %.preheader25 ]
...
65:                                               ; preds = %84, %64
  ...
  br i1 %67, label %.preheader23, label %86

.preheader23:                                     ; preds = %65, %82
  %68 = phi i32 [ %71, %82 ], [ %66, %65 ]
  %69 = phi i32 [ %83, %82 ], [ 0, %65 ]
  store i32 %69, ptr %2, align 4
  %70 = icmp slt i32 %69, 1
  br i1 %70, label %.preheader22, label %84

.preheader22:                                     ; preds = %.preheader23, %74
  %71 = phi i32 [ %66, %74 ], [ %68, %.preheader23 ]
  %72 = phi i32 [ %81, %74 ], [ 0, %.preheader23 ]
...
87:                                               ; preds = %106, %86
  ...
  br i1 %89, label %.preheader21, label %108

.preheader21:                                     ; preds = %87, %104
  %90 = phi i32 [ %93, %104 ], [ %88, %87 ]
  %91 = phi i32 [ %105, %104 ], [ 0, %87 ]
  store i32 %91, ptr %2, align 4
  %92 = icmp slt i32 %91, 4
  br i1 %92, label %.preheader20, label %106

.preheader20:                                     ; preds = %.preheader21, %96
  %93 = phi i32 [ %88, %96 ], [ %90, %.preheader21 ]
  %94 = phi i32 [ %103, %96 ], [ 0, %.preheader21 ]
...
109:                                              ; preds = %128, %108
  ...
  br i1 %111, label %.preheader19, label %130

.preheader19:                                     ; preds = %109, %126
  %112 = phi i32 [ %115, %126 ], [ %110, %109 ]
  %113 = phi i32 [ %127, %126 ], [ 0, %109 ]
  store i32 %113, ptr %2, align 4
  %114 = icmp slt i32 %113, 4
  br i1 %114, label %.preheader18, label %128

.preheader18:                                     ; preds = %.preheader19, %118
  %115 = phi i32 [ %110, %118 ], [ %112, %.preheader19 ]
  %116 = phi i32 [ %125, %118 ], [ 0, %.preheader19 ]
...
131:                                              ; preds = %150, %130
  ...
  br i1 %133, label %.preheader17, label %152

.preheader17:                                     ; preds = %131, %148
  %134 = phi i32 [ %137, %148 ], [ %132, %131 ]
  %135 = phi i32 [ %149, %148 ], [ 0, %131 ]
  store i32 %135, ptr %2, align 4
  %136 = icmp slt i32 %135, 1
  br i1 %136, label %.preheader16, label %150

.preheader16:                                     ; preds = %.preheader17, %140
  %137 = phi i32 [ %132, %140 ], [ %134, %.preheader17 ]
  %138 = phi i32 [ %147, %140 ], [ 0, %.preheader17 ]
...
153:                                              ; preds = %172, %152
  ...
  br i1 %155, label %.preheader15, label %174

.preheader15:                                     ; preds = %153, %170
  %156 = phi i32 [ %159, %170 ], [ %154, %153 ]
  %157 = phi i32 [ %171, %170 ], [ 0, %153 ]
  store i32 %157, ptr %2, align 4
  %158 = icmp slt i32 %157, 2
  br i1 %158, label %.preheader14, label %172

.preheader14:                                     ; preds = %.preheader15, %162
  %159 = phi i32 [ %154, %162 ], [ %156, %.preheader15 ]
  %160 = phi i32 [ %169, %162 ], [ 0, %.preheader15 ]
...
175:                                              ; preds = %194, %174
  ...
  br i1 %177, label %.preheader13, label %196

.preheader13:                                     ; preds = %175, %192
  %178 = phi i32 [ %181, %192 ], [ %176, %175 ]
  %179 = phi i32 [ %193, %192 ], [ 0, %175 ]
  store i32 %179, ptr %2, align 4
  %180 = icmp slt i32 %179, 1
  br i1 %180, label %.preheader12, label %194

.preheader12:                                     ; preds = %.preheader13, %184
  %181 = phi i32 [ %176, %184 ], [ %178, %.preheader13 ]
  %182 = phi i32 [ %191, %184 ], [ 0, %.preheader13 ]
...
197:                                              ; preds = %216, %196
  ...
  br i1 %199, label %.preheader11, label %218

.preheader11:                                     ; preds = %197, %214
  %200 = phi i32 [ %203, %214 ], [ %198, %197 ]
  %201 = phi i32 [ %215, %214 ], [ 0, %197 ]
  store i32 %201, ptr %2, align 4
  %202 = icmp slt i32 %201, 3
  br i1 %202, label %.preheader10, label %216

.preheader10:                                     ; preds = %.preheader11, %206
  %203 = phi i32 [ %198, %206 ], [ %200, %.preheader11 ]
  %204 = phi i32 [ %213, %206 ], [ 0, %.preheader11 ]
...
219:                                              ; preds = %238, %218
  ...
  br i1 %221, label %.preheader9, label %240

.preheader9:                                      ; preds = %219, %236
  %222 = phi i32 [ %225, %236 ], [ %220, %219 ]
  %223 = phi i32 [ %237, %236 ], [ 0, %219 ]
  store i32 %223, ptr %2, align 4
  %224 = icmp slt i32 %223, 1
  br i1 %224, label %.preheader8, label %238

.preheader8:                                      ; preds = %.preheader9, %228
  %225 = phi i32 [ %220, %228 ], [ %222, %.preheader9 ]
  %226 = phi i32 [ %235, %228 ], [ 0, %.preheader9 ]
...
241:                                              ; preds = %260, %240
  ...
  br i1 %243, label %.preheader7, label %262

.preheader7:                                      ; preds = %241, %258
  %244 = phi i32 [ %247, %258 ], [ %242, %241 ]
  %245 = phi i32 [ %259, %258 ], [ 0, %241 ]
  store i32 %245, ptr %2, align 4
  %246 = icmp slt i32 %245, 2
  br i1 %246, label %.preheader6, label %260

.preheader6:                                      ; preds = %.preheader7, %250
  %247 = phi i32 [ %242, %250 ], [ %244, %.preheader7 ]
  %248 = phi i32 [ %257, %250 ], [ 0, %.preheader7 ]
...
263:                                              ; preds = %282, %262
  ...
  br i1 %265, label %.preheader5, label %284

.preheader5:                                      ; preds = %263, %280
  %266 = phi i32 [ %269, %280 ], [ %264, %263 ]
  %267 = phi i32 [ %281, %280 ], [ 0, %263 ]
  store i32 %267, ptr %2, align 4
  %268 = icmp slt i32 %267, 1
  br i1 %268, label %.preheader4, label %282

.preheader4:                                      ; preds = %.preheader5, %272
  %269 = phi i32 [ %264, %272 ], [ %266, %.preheader5 ]
  %270 = phi i32 [ %279, %272 ], [ 0, %.preheader5 ]
...
285:                                              ; preds = %304, %284
  ...
  br i1 %287, label %.preheader3, label %306

.preheader3:                                      ; preds = %285, %302
  %288 = phi i32 [ %291, %302 ], [ %286, %285 ]
  %289 = phi i32 [ %303, %302 ], [ 0, %285 ]
  store i32 %289, ptr %2, align 4
  %290 = icmp slt i32 %289, 2
  br i1 %290, label %.preheader2, label %304

.preheader2:                                      ; preds = %.preheader3, %294
  %291 = phi i32 [ %286, %294 ], [ %288, %.preheader3 ]
  %292 = phi i32 [ %301, %294 ], [ 0, %.preheader3 ]
...
307:                                              ; preds = %326, %306
  ...
  br i1 %309, label %.preheader1, label %328

.preheader1:                                      ; preds = %307, %324
  %310 = phi i32 [ %313, %324 ], [ %308, %307 ]
  %311 = phi i32 [ %325, %324 ], [ 0, %307 ]
  store i32 %311, ptr %2, align 4
  %312 = icmp slt i32 %311, 2
  br i1 %312, label %.preheader, label %326

.preheader:                                       ; preds = %.preheader1, %316
  %313 = phi i32 [ %308, %316 ], [ %310, %.preheader1 ]
  %314 = phi i32 [ %323, %316 ], [ 0, %.preheader1 ]
