...
102:                                              ; preds = %.preheader27
  %103 = zext nneg i32 %storemerge2 to i64
  %104 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %103
...
108:                                              ; preds = %.preheader27
  %109 = add nuw nsw i32 %storemerge2, 1
