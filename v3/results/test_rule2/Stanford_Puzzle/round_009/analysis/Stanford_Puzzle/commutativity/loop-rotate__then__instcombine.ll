...
1:                                                ; preds = %0, %1
  ...
  %5 = icmp samesign ult i32 %storemerge5, 511
...
.preheader31:                                     ; preds = %.preheader30
  ...
  %17 = icmp samesign ult i32 %storemerge18, 5
...
.preheader25:                                     ; preds = %.preheader24
  ...
  %31 = icmp eq i32 %storemerge4411, 0
...
.preheader26:                                     ; preds = %.preheader25
  ...
  %33 = icmp samesign ult i32 %storemerge312, 3
...
.preheader22:                                     ; preds = %.preheader22.preheader, %.preheader22
  ...
  %40 = icmp samesign ult i32 %storemerge4313, 3
...
41:                                               ; preds = %.preheader23.loopexit
  ...
  %43 = icmp eq i32 %storemerge414, 0
...
.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  ...
  %51 = icmp eq i32 %storemerge4115, 0
...
.preheader21:                                     ; preds = %.preheader20
  ...
  %53 = icmp samesign ult i32 %storemerge4016, 3
...
.preheader16:                                     ; preds = %.preheader16.preheader, %.preheader16
  ...
  %70 = icmp eq i32 %storemerge3719, 0
...
71:                                               ; preds = %.preheader17.loopexit
  ...
  %73 = icmp samesign ult i32 %storemerge720, 3
...
.preheader14:                                     ; preds = %.preheader14.preheader, %.preheader14
  ...
  %81 = icmp samesign ult i32 %storemerge3521, 3
...
.preheader15:                                     ; preds = %.preheader14
  ...
  %83 = icmp eq i32 %storemerge3422, 0
...
87:                                               ; preds = %.preheader13.loopexit
  ...
  %89 = icmp samesign ult i32 %storemerge923, 2
...
.preheader11:                                     ; preds = %.preheader10
  ...
  %95 = icmp samesign ult i32 %storemerge3024, 2
...
.preheader8:                                      ; preds = %.preheader8.preheader, %.preheader8
  ...
  %101 = icmp samesign ult i32 %storemerge2925, 2
...
.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  ...
  %118 = icmp eq i32 %storemerge2528, 0
...
119:                                              ; preds = %.preheader5.loopexit
  ...
  %121 = icmp eq i32 %storemerge1329, 0
