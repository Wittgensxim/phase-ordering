...
.preheader31:                                     ; preds = %.preheader31.preheader, %20
...
.preheader30:                                     ; preds = %.preheader30.preheader, %18
...
.preheader29:                                     ; preds = %.preheader29.preheader, %10
...
10:                                               ; preds = %.preheader29
  ...
  %14 = add nuw nsw i32 %13, %storemerge1
...
.preheader28:                                     ; preds = %.preheader28.preheader, %30
...
.preheader26:                                     ; preds = %.preheader26.preheader, %41
...
.preheader25:                                     ; preds = %.preheader25.preheader, %39
...
.preheader24:                                     ; preds = %.preheader24.preheader, %34
...
34:                                               ; preds = %.preheader24
  ...
  %36 = add nuw nsw i32 %35, %storemerge3
...
44:                                               ; preds = %54, %43
  ...
  br i1 %45, label %.preheader23.preheader, label %56
...
.preheader23:                                     ; preds = %.preheader23.preheader, %.preheader23.loopexit
  %46 = phi i1 [ false, %.preheader23.loopexit ], [ true, %.preheader23.preheader ]
  br i1 %46, label %.preheader22.preheader, label %54

.preheader22.preheader:                           ; preds = %.preheader23
  br label %.preheader22

.preheader22:                                     ; preds = %.preheader22.preheader, %48
  %storemerge43 = phi i32 [ %53, %48 ], [ 0, %.preheader22.preheader ]
  %47 = icmp samesign ult i32 %storemerge43, 4
  br i1 %47, label %48, label %.preheader23.loopexit

48:                                               ; preds = %.preheader22
  %49 = shl nuw nsw i32 %storemerge43, 6
  %50 = add nuw nsw i32 %49, %storemerge4
...
57:                                               ; preds = %.loopexit4, %56
  %58 = phi i1 [ true, %56 ], [ false, %.loopexit4 ]
  br i1 %58, label %.preheader21.preheader, label %70

.preheader21.preheader:                           ; preds = %57
  br label %.preheader21

.preheader21:                                     ; preds = %.preheader21.preheader, %68
  %storemerge40 = phi i32 [ %69, %68 ], [ 0, %.preheader21.preheader ]
  %59 = icmp samesign ult i32 %storemerge40, 4
  br i1 %59, label %.preheader20.preheader, label %.loopexit4

.preheader20.preheader:                           ; preds = %.preheader21
  br label %.preheader20

.preheader20:                                     ; preds = %.preheader20.preheader, %61
  %storemerge41 = phi i32 [ %67, %61 ], [ 0, %.preheader20.preheader ]
...
.preheader19:                                     ; preds = %.preheader19.preheader, %79
...
.preheader18:                                     ; preds = %.preheader18.preheader, %74
  %storemerge39 = phi i1 [ false, %74 ], [ true, %.preheader18.preheader ]
  br i1 %storemerge39, label %74, label %79

74:                                               ; preds = %.preheader18
  %75 = shl nuw nsw i32 %storemerge38, 3
  %76 = add nuw nsw i32 %75, %storemerge6
...
84:                                               ; preds = %94, %83
  ...
  br i1 %85, label %.preheader17.preheader, label %96
...
.preheader17:                                     ; preds = %.preheader17.preheader, %.preheader17.loopexit
  %86 = phi i1 [ false, %.preheader17.loopexit ], [ true, %.preheader17.preheader ]
  br i1 %86, label %.preheader16.preheader, label %94
...
.preheader16:                                     ; preds = %.preheader16.preheader, %88
  ...
  br i1 %87, label %88, label %.preheader17.loopexit

88:                                               ; preds = %.preheader16
  %89 = shl nuw nsw i32 %storemerge37, 6
  %90 = add nuw nsw i32 %89, %storemerge7
...
97:                                               ; preds = %.loopexit3, %96
  %98 = phi i1 [ true, %96 ], [ false, %.loopexit3 ]
  br i1 %98, label %.preheader15.preheader, label %110

.preheader15.preheader:                           ; preds = %97
  br label %.preheader15

.preheader15:                                     ; preds = %.preheader15.preheader, %108
  %storemerge34 = phi i32 [ %109, %108 ], [ 0, %.preheader15.preheader ]
  %99 = icmp samesign ult i32 %storemerge34, 2
  br i1 %99, label %.preheader14.preheader, label %.loopexit3

.preheader14.preheader:                           ; preds = %.preheader15
  br label %.preheader14

.preheader14:                                     ; preds = %.preheader14.preheader, %101
  %storemerge35 = phi i32 [ %107, %101 ], [ 0, %.preheader14.preheader ]
...
111:                                              ; preds = %117, %110
  ...
  br i1 %112, label %.preheader13.preheader, label %119
...
.preheader13:                                     ; preds = %.preheader13.preheader, %.preheader13.loopexit
  ...
  br i1 %113, label %.preheader12.preheader, label %117
...
120:                                              ; preds = %.loopexit2, %119
  %121 = phi i1 [ true, %119 ], [ false, %.loopexit2 ]
  br i1 %121, label %.preheader11.preheader, label %129

.preheader11.preheader:                           ; preds = %120
  br label %.preheader11

.preheader11:                                     ; preds = %.preheader11.preheader, %127
  %storemerge30 = phi i32 [ %128, %127 ], [ 0, %.preheader11.preheader ]
  %122 = icmp samesign ult i32 %storemerge30, 3
  br i1 %122, label %.preheader10.preheader, label %.loopexit2

.preheader10.preheader:                           ; preds = %.preheader11
  br label %.preheader10

.preheader10:                                     ; preds = %.preheader10.preheader, %123
  %storemerge31 = phi i1 [ false, %123 ], [ true, %.preheader10.preheader ]
...
130:                                              ; preds = %.loopexit1, %129
  %131 = phi i1 [ true, %129 ], [ false, %.loopexit1 ]
  br i1 %131, label %.preheader9.preheader, label %139

.preheader9.preheader:                            ; preds = %130
  br label %.preheader9
...
.preheader9:                                      ; preds = %.preheader9.preheader, %.preheader9.loopexit
  %132 = phi i1 [ false, %.preheader9.loopexit ], [ true, %.preheader9.preheader ]
  br i1 %132, label %.preheader8.preheader, label %.loopexit1

.preheader8.preheader:                            ; preds = %.preheader9
  br label %.preheader8

.preheader8:                                      ; preds = %.preheader8.preheader, %134
  %storemerge29 = phi i32 [ %138, %134 ], [ 0, %.preheader8.preheader ]
  %133 = icmp samesign ult i32 %storemerge29, 3
  br i1 %133, label %134, label %.preheader9.loopexit
...
140:                                              ; preds = %150, %139
  ...
  br i1 %141, label %.preheader7.preheader, label %152

.preheader7.preheader:                            ; preds = %140
  br label %.preheader7

.preheader7:                                      ; preds = %.preheader7.preheader, %148
  %storemerge26 = phi i32 [ %149, %148 ], [ 0, %.preheader7.preheader ]
  %142 = icmp samesign ult i32 %storemerge26, 2
  br i1 %142, label %.preheader6.preheader, label %150

.preheader6.preheader:                            ; preds = %.preheader7
  br label %.preheader6

.preheader6:                                      ; preds = %.preheader6.preheader, %143
  %storemerge27 = phi i1 [ false, %143 ], [ true, %.preheader6.preheader ]
  br i1 %storemerge27, label %143, label %148

143:                                              ; preds = %.preheader6
  %144 = shl nuw nsw i32 %storemerge26, 3
  %145 = add nuw nsw i32 %144, %storemerge12
...
153:                                              ; preds = %163, %152
  ...
  br i1 %154, label %.preheader5.preheader, label %165

.preheader5.preheader:                            ; preds = %153
  br label %.preheader5
...
.preheader5:                                      ; preds = %.preheader5.preheader, %.preheader5.loopexit
  %155 = phi i1 [ false, %.preheader5.loopexit ], [ true, %.preheader5.preheader ]
  br i1 %155, label %.preheader4.preheader, label %163

.preheader4.preheader:                            ; preds = %.preheader5
  br label %.preheader4

.preheader4:                                      ; preds = %.preheader4.preheader, %157
  %storemerge25 = phi i32 [ %162, %157 ], [ 0, %.preheader4.preheader ]
  %156 = icmp samesign ult i32 %storemerge25, 2
  br i1 %156, label %157, label %.preheader5.loopexit

157:                                              ; preds = %.preheader4
  %158 = shl nuw nsw i32 %storemerge25, 6
  %159 = add nuw nsw i32 %158, %storemerge13
...
166:                                              ; preds = %.loopexit, %165
  %167 = phi i1 [ true, %165 ], [ false, %.loopexit ]
  br i1 %167, label %.preheader3.preheader, label %179

.preheader3.preheader:                            ; preds = %166
  br label %.preheader3

.preheader3:                                      ; preds = %.preheader3.preheader, %177
  %storemerge22 = phi i32 [ %178, %177 ], [ 0, %.preheader3.preheader ]
  %168 = icmp samesign ult i32 %storemerge22, 2
  br i1 %168, label %.preheader2.preheader, label %.loopexit

.preheader2.preheader:                            ; preds = %.preheader3
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %170
  %storemerge23 = phi i32 [ %176, %170 ], [ 0, %.preheader2.preheader ]
...
180:                                              ; preds = %194, %179
  ...
  br i1 %181, label %.preheader1.preheader, label %196

.preheader1.preheader:                            ; preds = %180
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader1.preheader, %192
  %storemerge20 = phi i32 [ %193, %192 ], [ 0, %.preheader1.preheader ]
  %182 = icmp samesign ult i32 %storemerge20, 2
  br i1 %182, label %.preheader.preheader, label %194

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %184
  %storemerge21 = phi i32 [ %191, %184 ], [ 0, %.preheader.preheader ]
...
184:                                              ; preds = %.preheader
  ...
  %188 = add nuw nsw i32 %187, %storemerge15
