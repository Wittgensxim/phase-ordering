...
8:                                                ; preds = %.lr.ph, %16
  ...
  %9 = zext nneg i32 %storemerge3 to i64
...
16:                                               ; preds = %12, %8
  %17 = add nuw nsw i32 %storemerge3, 1
...
.preheader30.preheader:                           ; preds = %.preheader31.preheader, %.preheader31
  %storemerge18 = phi i32 [ 1, %.preheader31.preheader ], [ %14, %.preheader31 ]
...
.preheader29.preheader:                           ; preds = %.preheader30.preheader, %.preheader30
  %storemerge477 = phi i32 [ 1, %.preheader30.preheader ], [ %12, %.preheader30 ]
  %6 = shl nuw nsw i32 %storemerge477, 3
  %invariant.op = or disjoint i32 %6, %storemerge18
  br label %.preheader29

.preheader29:                                     ; preds = %.preheader29.preheader, %.preheader29
  %storemerge486 = phi i32 [ 1, %.preheader29.preheader ], [ %10, %.preheader29 ]
  %7 = shl nuw nsw i32 %storemerge486, 6
  %.reass = or disjoint i32 %7, %invariant.op
  %8 = zext nneg i32 %.reass to i64
  %9 = getelementptr inbounds nuw [4 x i8], ptr @puzzl, i64 %8
  store i32 0, ptr %9, align 4
  %10 = add nuw nsw i32 %storemerge486, 1
  %11 = icmp samesign ult i32 %10, 6
  br i1 %11, label %.preheader29, label %.preheader30, !llvm.loop !14

.preheader30:                                     ; preds = %.preheader29
  %12 = add nuw nsw i32 %storemerge477, 1
...
.preheader31:                                     ; preds = %.preheader30
  %14 = add nuw nsw i32 %storemerge18, 1
...
.preheader27.preheader:                           ; preds = %.preheader28.preheader, %.preheader28
  %storemerge210 = phi i32 [ 0, %.preheader28.preheader ], [ %22, %.preheader28 ]
  %16 = zext nneg i32 %storemerge210 to i64
...
.preheader25.preheader:                           ; preds = %.preheader26.preheader, %.preheader26
  %storemerge312 = phi i32 [ 0, %.preheader26.preheader ], [ %30, %.preheader26 ]
  br label %.preheader24.preheader

.preheader24.preheader:                           ; preds = %.preheader25.preheader, %.preheader25
  %storemerge4411 = phi i32 [ 0, %.preheader25.preheader ], [ %28, %.preheader25 ]
  %24 = shl nuw nsw i32 %storemerge4411, 3
  %25 = or disjoint i32 %storemerge312, %24
...
.preheader25:                                     ; preds = %.preheader24
  %28 = add nuw nsw i32 %storemerge4411, 1
...
.preheader26:                                     ; preds = %.preheader25
  %30 = add nuw nsw i32 %storemerge312, 1
...
.preheader23.preheader:                           ; preds = %32, %39
  %storemerge414 = phi i32 [ 0, %32 ], [ %40, %39 ]
...
.preheader22:                                     ; preds = %.preheader22.preheader, %.preheader22
  %storemerge4313 = phi i32 [ 0, %.preheader22.preheader ], [ %37, %.preheader22 ]
  %33 = shl nuw nsw i32 %storemerge4313, 6
  %34 = or disjoint i32 %storemerge414, %33
  %35 = zext nneg i32 %34 to i64
  %36 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 2048), i64 %35
  store i32 1, ptr %36, align 4
  %37 = add nuw nsw i32 %storemerge4313, 1
...
39:                                               ; preds = %.preheader23.loopexit
  %40 = add nuw nsw i32 %storemerge414, 1
...
.preheader19.preheader:                           ; preds = %52, %59
  %storemerge618 = phi i32 [ 0, %52 ], [ %60, %59 ]
  br label %.preheader18.preheader

.preheader18.preheader:                           ; preds = %.preheader19.preheader, %.preheader19
  %storemerge3817 = phi i32 [ 0, %.preheader19.preheader ], [ %57, %.preheader19 ]
  %53 = shl nuw nsw i32 %storemerge3817, 3
  %54 = or disjoint i32 %storemerge618, %53
...
.preheader17.preheader:                           ; preds = %62, %69
  %storemerge720 = phi i32 [ 0, %62 ], [ %70, %69 ]
...
.preheader16:                                     ; preds = %.preheader16.preheader, %.preheader16
  %storemerge3719 = phi i32 [ 0, %.preheader16.preheader ], [ %67, %.preheader16 ]
  %63 = shl nuw nsw i32 %storemerge3719, 6
  %64 = or disjoint i32 %storemerge720, %63
  %65 = zext nneg i32 %64 to i64
  %66 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 8192), i64 %65
  store i32 1, ptr %66, align 4
  %67 = add nuw nsw i32 %storemerge3719, 1
...
69:                                               ; preds = %.preheader17.loopexit
  %70 = add nuw nsw i32 %storemerge720, 1
...
.preheader14.preheader:                           ; preds = %.preheader15.preheader, %.preheader15
  %storemerge3422 = phi i32 [ 0, %.preheader15.preheader ], [ %80, %.preheader15 ]
  %73 = shl nuw nsw i32 %storemerge3422, 3
  br label %.preheader14

.preheader14:                                     ; preds = %.preheader14.preheader, %.preheader14
  %storemerge3521 = phi i32 [ 0, %.preheader14.preheader ], [ %78, %.preheader14 ]
  %74 = shl nuw nsw i32 %storemerge3521, 6
...
.preheader13.preheader:                           ; preds = %82, %85
  %storemerge923 = phi i32 [ 0, %82 ], [ %86, %85 ]
  %83 = zext nneg i32 %storemerge923 to i64
...
85:                                               ; preds = %.preheader13.loopexit
  %86 = add nuw nsw i32 %storemerge923, 1
...
.preheader10.preheader:                           ; preds = %.preheader11.preheader, %.preheader11
  %storemerge3024 = phi i32 [ 0, %.preheader11.preheader ], [ %92, %.preheader11 ]
  %89 = shl nuw nsw i32 %storemerge3024, 3
...
.preheader11:                                     ; preds = %.preheader10
  %92 = add nuw nsw i32 %storemerge3024, 1
...
.preheader8:                                      ; preds = %.preheader8.preheader, %.preheader8
  %storemerge2925 = phi i32 [ 0, %.preheader8.preheader ], [ %98, %.preheader8 ]
  %95 = shl nuw nsw i32 %storemerge2925, 6
  %96 = zext nneg i32 %95 to i64
  %97 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 16384), i64 %96
  store i32 1, ptr %97, align 4
  %98 = add nuw nsw i32 %storemerge2925, 1
...
.preheader7.preheader:                            ; preds = %100, %107
  %storemerge1227 = phi i32 [ 0, %100 ], [ %108, %107 ]
  br label %.preheader6.preheader

.preheader6.preheader:                            ; preds = %.preheader7.preheader, %.preheader7
  %storemerge2626 = phi i32 [ 0, %.preheader7.preheader ], [ %105, %.preheader7 ]
  %101 = shl nuw nsw i32 %storemerge2626, 3
  %102 = or disjoint i32 %storemerge1227, %101
...
.preheader5.preheader:                            ; preds = %110, %117
  %storemerge1329 = phi i32 [ 0, %110 ], [ %118, %117 ]
...
.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  %storemerge2528 = phi i32 [ 0, %.preheader4.preheader ], [ %115, %.preheader4 ]
  %111 = shl nuw nsw i32 %storemerge2528, 6
  %112 = or disjoint i32 %storemerge1329, %111
  %113 = zext nneg i32 %112 to i64
  %114 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %113
  store i32 1, ptr %114, align 4
  %115 = add nuw nsw i32 %storemerge2528, 1
...
117:                                              ; preds = %.preheader5.loopexit
  %118 = add nuw nsw i32 %storemerge1329, 1
...
.preheader2.preheader:                            ; preds = %.preheader3.preheader, %.preheader3
  %storemerge2231 = phi i32 [ 0, %.preheader3.preheader ], [ %128, %.preheader3 ]
  %121 = shl nuw nsw i32 %storemerge2231, 3
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %.preheader2
  %storemerge2330 = phi i32 [ 0, %.preheader2.preheader ], [ %126, %.preheader2 ]
  %122 = shl nuw nsw i32 %storemerge2330, 6
...
.preheader1.preheader:                            ; preds = %130, %139
  %storemerge1534 = phi i32 [ 0, %130 ], [ %140, %139 ]
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader1.preheader, %.preheader1
  %storemerge2033 = phi i32 [ 0, %.preheader1.preheader ], [ %137, %.preheader1 ]
  %131 = shl nuw nsw i32 %storemerge2033, 3
  %invariant.op35 = or disjoint i32 %131, %storemerge1534
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %storemerge2132 = phi i32 [ 0, %.preheader.preheader ], [ %135, %.preheader ]
  %132 = shl nuw nsw i32 %storemerge2132, 6
  %.reass36 = or disjoint i32 %132, %invariant.op35
  %133 = zext nneg i32 %.reass36 to i64
  %134 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %133
  store i32 1, ptr %134, align 4
  %135 = add nuw nsw i32 %storemerge2132, 1
  %136 = icmp samesign ult i32 %135, 2
  br i1 %136, label %.preheader, label %.preheader1, !llvm.loop !55

.preheader1:                                      ; preds = %.preheader
  %137 = add nuw nsw i32 %storemerge2033, 1
  %138 = icmp samesign ult i32 %137, 2
  br i1 %138, label %.preheader.preheader, label %139, !llvm.loop !56

139:                                              ; preds = %.preheader1
  %140 = add nuw nsw i32 %storemerge1534, 1
