...
.preheader24.preheader:                           ; preds = %.preheader25.preheader, %.preheader25
  %storemerge4411 = phi i32 [ 0, %.preheader25.preheader ], [ 1, %.preheader25 ]
...
.preheader23.preheader:                           ; preds = %34, %41
  %storemerge414 = phi i32 [ 0, %34 ], [ 1, %41 ]
...
.preheader22:                                     ; preds = %.preheader22.preheader, %.preheader22
  ...
  br i1 %40, label %.preheader22, label %.preheader23.loopexit, !llvm.loop !21

41:                                               ; preds = %.preheader23.loopexit
  %42 = add nuw nsw i32 %storemerge414, 1
  %43 = icmp samesign ult i32 %42, 2
  br i1 %43, label %.preheader23.preheader, label %44, !llvm.loop !22
...
.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  ...
  br i1 %51, label %.preheader20, label %.preheader21, !llvm.loop !23

.preheader21:                                     ; preds = %.preheader20
  %52 = add nuw nsw i32 %storemerge4016, 1
  %53 = icmp samesign ult i32 %52, 4
  br i1 %53, label %.preheader20.preheader, label %.loopexit4, !llvm.loop !24
...
.preheader19.preheader:                           ; preds = %54, %61
  %storemerge618 = phi i32 [ 0, %54 ], [ 1, %61 ]
...
.preheader19:                                     ; preds = %.preheader18
  ...
  br i1 %60, label %.preheader18.preheader, label %61, !llvm.loop !25

61:                                               ; preds = %.preheader19
  %62 = add nuw nsw i32 %storemerge618, 1
  %63 = icmp samesign ult i32 %62, 2
  br i1 %63, label %.preheader19.preheader, label %64, !llvm.loop !26
...
.preheader16:                                     ; preds = %.preheader16.preheader, %.preheader16
  ...
  br i1 %70, label %.preheader16, label %.preheader17.loopexit, !llvm.loop !27

71:                                               ; preds = %.preheader17.loopexit
  %72 = add nuw nsw i32 %storemerge720, 1
  %73 = icmp samesign ult i32 %72, 4
  br i1 %73, label %.preheader17.preheader, label %74, !llvm.loop !28
...
.preheader14:                                     ; preds = %.preheader14.preheader, %.preheader14
  ...
  br i1 %81, label %.preheader14, label %.preheader15, !llvm.loop !29

.preheader15:                                     ; preds = %.preheader14
  %82 = add nuw nsw i32 %storemerge3422, 1
  %83 = icmp samesign ult i32 %82, 2
  br i1 %83, label %.preheader14.preheader, label %.loopexit3, !llvm.loop !30
...
87:                                               ; preds = %.preheader13.loopexit
  ...
  br i1 %89, label %.preheader13.preheader, label %90, !llvm.loop !31
...
.preheader11.preheader:                           ; preds = %90
...
.preheader11:                                     ; preds = %.preheader10
  ...
  br i1 %95, label %.preheader10.preheader, label %.loopexit2, !llvm.loop !32
...
.preheader8:                                      ; preds = %.preheader8.preheader, %.preheader8
  ...
  br i1 %101, label %.preheader8, label %.preheader9.loopexit, !llvm.loop !33
...
.preheader7.preheader:                            ; preds = %102, %109
  %storemerge1227 = phi i32 [ 0, %102 ], [ 1, %109 ]
  br label %.preheader6.preheader

.preheader6.preheader:                            ; preds = %.preheader7.preheader, %.preheader7
  %storemerge2626 = phi i32 [ 0, %.preheader7.preheader ], [ 1, %.preheader7 ]
  br label %.preheader6
...
.preheader7:                                      ; preds = %.preheader6
  ...
  br i1 %108, label %.preheader6.preheader, label %109, !llvm.loop !34

109:                                              ; preds = %.preheader7
  %110 = add nuw nsw i32 %storemerge1227, 1
  %111 = icmp samesign ult i32 %110, 2
  br i1 %111, label %.preheader7.preheader, label %112, !llvm.loop !35
...
.preheader5.preheader:                            ; preds = %112, %119
  %storemerge1329 = phi i32 [ 0, %112 ], [ 1, %119 ]
...
.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  ...
  br i1 %118, label %.preheader4, label %.preheader5.loopexit, !llvm.loop !36

119:                                              ; preds = %.preheader5.loopexit
  %120 = add nuw nsw i32 %storemerge1329, 1
  %121 = icmp samesign ult i32 %120, 2
  br i1 %121, label %.preheader5.preheader, label %122, !llvm.loop !37
...
.preheader3.preheader:                            ; preds = %122
  br label %.preheader2.preheader

.preheader2.preheader:                            ; preds = %.preheader3.preheader, %.preheader3
  %storemerge2231 = phi i32 [ 0, %.preheader3.preheader ], [ 1, %.preheader3 ]
  br label %.preheader2
...
.preheader2:                                      ; preds = %.preheader2.preheader, %.preheader2
  ...
  br i1 %129, label %.preheader2, label %.preheader3, !llvm.loop !38

.preheader3:                                      ; preds = %.preheader2
  %130 = add nuw nsw i32 %storemerge2231, 1
  %131 = icmp samesign ult i32 %130, 2
  br i1 %131, label %.preheader2.preheader, label %.loopexit, !llvm.loop !39
...
.preheader1.preheader:                            ; preds = %132, %143
  %storemerge1534 = phi i32 [ 0, %132 ], [ 1, %143 ]
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader1.preheader, %.preheader1
  %storemerge2033 = phi i32 [ 0, %.preheader1.preheader ], [ 1, %.preheader1 ]
  br label %.preheader
