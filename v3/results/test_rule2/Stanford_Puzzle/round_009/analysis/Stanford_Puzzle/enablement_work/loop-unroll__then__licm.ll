...
.preheader29.1.5:                                 ; preds = %.preheader29.511
  %97 = or disjoint i32 %storemerge1.lcssa13, 112
...
.preheader29.2.5:                                 ; preds = %.preheader29.1.5
  %100 = or disjoint i32 %storemerge1.lcssa13, 176
...
.preheader29.3.5:                                 ; preds = %.preheader29.2.5
  %103 = or disjoint i32 %storemerge1.lcssa13, 240
...
.preheader29.4.5:                                 ; preds = %.preheader29.3.5
  %106 = or disjoint i32 %storemerge1.lcssa13, 304
...
.preheader29.5.5:                                 ; preds = %.preheader29.4.5
  %109 = or disjoint i32 %storemerge1.lcssa13, 368
...
.preheader27.preheader:                           ; preds = %.preheader28
  ...
  %120 = zext nneg i32 %storemerge2 to i64
...
.preheader27.1:                                   ; preds = %.preheader27
  %122 = zext nneg i32 %storemerge46 to i64
...
.preheader27.2:                                   ; preds = %.preheader27.1
  ...
  %126 = getelementptr inbounds nuw [4 x i8], ptr %117, i64 %125
...
135:                                              ; preds = %.loopexit20, %.preheader24.1.2
  ...
  %137 = or disjoint i32 %storemerge3.lcssa16, %136
...
.preheader24.1.2:                                 ; preds = %.preheader24.2
  %140 = or disjoint i32 %storemerge3.lcssa19, 16
...
.preheader22.2.1:                                 ; preds = %.preheader22.1.1
  %149 = or disjoint i32 %storemerge4.lcssa31, 64
...
.preheader22.3.1:                                 ; preds = %.preheader22.2.1
  %152 = or disjoint i32 %storemerge4.lcssa31, 128
...
.preheader22.4.1:                                 ; preds = %.preheader22.3.1
  %155 = or disjoint i32 %storemerge4.lcssa31, 192
...
158:                                              ; preds = %.loopexit33, %.preheader22.4.1
  ...
  %159 = or disjoint i32 %storemerge4.lcssa29, 256
...
175:                                              ; preds = %.loopexit56, %.preheader18.1.4
  ...
  %177 = or disjoint i32 %storemerge6.lcssa52, %176
...
.preheader18.1.4:                                 ; preds = %.preheader18.4
  %180 = or disjoint i32 %storemerge6.lcssa55, 32
...
.preheader16.2.1:                                 ; preds = %.preheader16.1.1
  %191 = or disjoint i32 %storemerge7.lcssa67, 64
...
194:                                              ; preds = %.loopexit69, %.preheader16.2.1
  ...
  %195 = or disjoint i32 %storemerge7.lcssa65, 128
...
234:                                              ; preds = %.loopexit116, %.preheader6.1.2
  ...
  %236 = or disjoint i32 %storemerge12.lcssa112, %235
...
.preheader6.1.2:                                  ; preds = %.preheader6.2
  %239 = or disjoint i32 %storemerge12.lcssa115, 16
...
.preheader4.2.1:                                  ; preds = %.preheader4.1.1
  %250 = or disjoint i32 %storemerge13.lcssa127, 64
...
253:                                              ; preds = %.loopexit129, %.preheader4.2.1
  ...
  %254 = or disjoint i32 %storemerge13.lcssa125, 128
...
270:                                              ; preds = %.loopexit151, %.preheader.2.2
  ...
  %272 = or disjoint i32 128, %271
  %273 = or disjoint i32 %storemerge15.lcssa146, %272
...
.preheader.1.2:                                   ; preds = %.preheader.2148
  %276 = or disjoint i32 %storemerge15.lcssa150, 16
...
.preheader.2.2:                                   ; preds = %.preheader.1.2
  %279 = or disjoint i32 %storemerge15.lcssa150, 80
