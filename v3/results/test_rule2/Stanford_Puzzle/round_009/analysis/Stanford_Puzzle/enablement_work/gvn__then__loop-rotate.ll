...
3:                                                ; preds = %.lr.ph, %13
  %storemerge5 = phi i32 [ 0, %.lr.ph ], [ %14, %13 ]
  %4 = getelementptr inbounds [2048 x i8], ptr @p, i64 %.phi.trans.insert
  %5 = zext nneg i32 %storemerge5 to i64
...
13:                                               ; preds = %8, %3
  %14 = add nuw nsw i32 %storemerge5, 1
  %.not = icmp sgt i32 %14, %.pre
  br i1 %.not, label %._crit_edge6, label %3, !llvm.loop !7
...
15:                                               ; preds = %._crit_edge6, %._crit_edge, %2
...
3:                                                ; preds = %.lr.ph, %12
  %storemerge6 = phi i32 [ 0, %.lr.ph ], [ %13, %12 ]
  %4 = getelementptr inbounds [2048 x i8], ptr @p, i64 %.phi.trans.insert
  %5 = zext nneg i32 %storemerge6 to i64
  %6 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %5
  %7 = load i32, ptr %6, align 4
...
12:                                               ; preds = %8, %3
  %13 = add nuw nsw i32 %storemerge6, 1
...
14:                                               ; preds = %._crit_edge, %2
  ...
  %exitcond.not7 = icmp eq i64 %21, %wide.trip.count
...
22:                                               ; preds = %.lr.ph10, %27
  %indvars.iv8 = phi i64 [ %21, %.lr.ph10 ], [ %indvars.iv.next, %27 ]
  %23 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv8
  %24 = load i32, ptr %23, align 4
  %.not3 = icmp eq i32 %24, 0
  br i1 %.not3, label %25, label %27

25:                                               ; preds = %22
  %indvars.iv.lcssa2 = phi i64 [ %indvars.iv8, %22 ]
  %26 = trunc nsw i64 %indvars.iv.lcssa2 to i32
  br label %.loopexit

27:                                               ; preds = %22
  %indvars.iv.next = add nsw i64 %indvars.iv8, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %..loopexit.loopexit_crit_edge, label %22, !llvm.loop !10

..loopexit.loopexit_crit_edge:                    ; preds = %27
  br label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %..loopexit.loopexit_crit_edge, %14
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %25
  %storemerge2 = phi i32 [ %26, %25 ], [ 0, %.loopexit.loopexit ]
  ret i32 %storemerge2
}
...
3:                                                ; preds = %.lr.ph, %12
  %storemerge3 = phi i32 [ 0, %.lr.ph ], [ %13, %12 ]
  %4 = getelementptr inbounds [2048 x i8], ptr @p, i64 %.phi.trans.insert
  %5 = zext nneg i32 %storemerge3 to i64
  %6 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %5
  %7 = load i32, ptr %6, align 4
