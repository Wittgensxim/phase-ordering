...
14:                                               ; preds = %.lr.ph, %29
  ...
  %17 = getelementptr inbounds [512 x i32], ptr %11, i64 0, i64 %16
  %18 = load i32, ptr %17, align 4
  %19 = icmp ne i32 %18, 0
  br i1 %19, label %20, label %28

20:                                               ; preds = %14
  %21 = add nsw i32 %12, %15
...
29:                                               ; preds = %28
  ...
  br i1 %31, label %14, label %._crit_edge, !llvm.loop !7
...
28:                                               ; preds = %._crit_edge, %2
  %.lcssa2 = phi i32 [ %split, %._crit_edge ], [ %.promoted, %2 ]
  %.lcssa = phi i64 [ %split6, %._crit_edge ], [ %8, %2 ]
  ...
  %36 = icmp sle i32 %.promoted3, 511
  br i1 %36, label %.lr.ph8, label %48

.lr.ph8:                                          ; preds = %28
  br label %37

37:                                               ; preds = %.lr.ph8, %45
  %38 = phi i32 [ %.promoted3, %.lr.ph8 ], [ %46, %45 ]
...
45:                                               ; preds = %44
  ...
  br i1 %47, label %37, label %._crit_edge9, !llvm.loop !10

._crit_edge9:                                     ; preds = %45
  %split10 = phi i32 [ %46, %45 ]
  br label %48

48:                                               ; preds = %._crit_edge9, %28
  %.lcssa4 = phi i32 [ %split10, %._crit_edge9 ], [ %.promoted3, %28 ]
...
24:                                               ; preds = %23
  ...
  br i1 %26, label %13, label %._crit_edge, !llvm.loop !11
...
27:                                               ; preds = %._crit_edge, %2
  %.lcssa1 = phi i32 [ %split, %._crit_edge ], [ %.promoted, %2 ]
  %.lcssa = phi i64 [ %split2, %._crit_edge ], [ %7, %2 ]
