...
32:                                               ; preds = %38, %24
  %storemerge1 = phi i32 [ %31, %24 ], [ %39, %38 ]
...
40:                                               ; preds = %32, %34
  %storemerge2 = phi i32 [ %storemerge1, %34 ], [ 0, %32 ]
  ret i32 %storemerge2
}
...
374:                                              ; preds = %371, %373, %370
  ...
  %376 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %375) #3
  %377 = load i32, ptr @kount, align 4
  %378 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %377) #3
  ret void
}
