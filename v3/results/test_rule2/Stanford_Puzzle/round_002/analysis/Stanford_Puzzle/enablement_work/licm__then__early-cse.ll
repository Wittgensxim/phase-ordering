...
28:                                               ; preds = %13
  store i32 %14, ptr %6, align 4
  %29 = getelementptr inbounds [13 x i32], ptr @class, i64 0, i64 %8
...
27:                                               ; preds = %12
  ...
  %28 = getelementptr inbounds [13 x i32], ptr @class, i64 0, i64 %7
...
9:                                                ; preds = %37, %1
  %10 = phi i32 [ %36, %37 ], [ %.promoted2, %1 ]
  %11 = phi i32 [ %38, %37 ], [ 0, %1 ]
...
21:                                               ; preds = %13
  %22 = call i32 @Fit(i32 noundef %11, i32 noundef %8)
  %23 = icmp ne i32 %22, 0
  br i1 %23, label %24, label %33

24:                                               ; preds = %21
  %25 = call i32 @Place(i32 noundef %11, i32 noundef %8)
...
31:                                               ; preds = %28
  call void @Remove(i32 noundef %11, i32 noundef %8)
  br label %32
...
33:                                               ; preds = %32, %21
  %34 = phi i32 [ %25, %32 ], [ %10, %21 ]
  br label %35

35:                                               ; preds = %33, %13
  %36 = phi i32 [ %34, %33 ], [ %10, %13 ]
  br label %37
...
14:                                               ; preds = %38, %13
  %.lcssa26.lcssa12 = phi i32 [ %.lcssa26, %38 ], [ %.promoted11, %13 ]
  %.lcssa410 = phi i32 [ %19, %38 ], [ %.promoted9, %13 ]
  %15 = phi i32 [ %39, %38 ], [ 1, %13 ]
...
18:                                               ; preds = %35, %17
  %.lcssa26 = phi i32 [ %23, %35 ], [ %.lcssa26.lcssa12, %17 ]
...
40:                                               ; preds = %14
  ...
  store i32 %.lcssa410, ptr %2, align 4
  store i32 %.lcssa26.lcssa12, ptr %3, align 4
  store i32 0, ptr %1, align 4
  %.promoted17 = load i32, ptr %4, align 4
  br label %41

41:                                               ; preds = %56, %40
  %.lcssa1418 = phi i32 [ %48, %56 ], [ %.promoted17, %40 ]
  %42 = phi i32 [ %57, %56 ], [ 0, %40 ]
...
59:                                               ; preds = %83, %58
  %.lcssa2024.lcssa31 = phi i32 [ %.lcssa2024, %83 ], [ %.promoted30, %58 ]
  %.lcssa2229 = phi i32 [ %64, %83 ], [ %.promoted28, %58 ]
  %60 = phi i32 [ %84, %83 ], [ 0, %58 ]
...
63:                                               ; preds = %80, %62
  %.lcssa2024 = phi i32 [ %68, %80 ], [ %.lcssa2024.lcssa31, %62 ]
...
86:                                               ; preds = %110, %85
  %.lcssa3337.lcssa43 = phi i32 [ %.lcssa3337, %110 ], [ %.promoted42, %85 ]
  %.lcssa3541 = phi i32 [ %91, %110 ], [ %.promoted40, %85 ]
  %87 = phi i32 [ %111, %110 ], [ 0, %85 ]
...
90:                                               ; preds = %107, %89
  %.lcssa3337 = phi i32 [ %95, %107 ], [ %.lcssa3337.lcssa43, %89 ]
...
113:                                              ; preds = %137, %112
  %.lcssa4549.lcssa55 = phi i32 [ %.lcssa4549, %137 ], [ %.promoted54, %112 ]
  %.lcssa4753 = phi i32 [ %118, %137 ], [ %.promoted52, %112 ]
  %114 = phi i32 [ %138, %137 ], [ 0, %112 ]
...
117:                                              ; preds = %134, %116
  %.lcssa4549 = phi i32 [ %122, %134 ], [ %.lcssa4549.lcssa55, %116 ]
...
140:                                              ; preds = %164, %139
  %.lcssa5761.lcssa67 = phi i32 [ %.lcssa5761, %164 ], [ %.promoted66, %139 ]
  %.lcssa5965 = phi i32 [ %145, %164 ], [ %.promoted64, %139 ]
  %141 = phi i32 [ %165, %164 ], [ 0, %139 ]
...
144:                                              ; preds = %161, %143
  %.lcssa5761 = phi i32 [ %149, %161 ], [ %.lcssa5761.lcssa67, %143 ]
...
167:                                              ; preds = %191, %166
  %.lcssa6973.lcssa79 = phi i32 [ %.lcssa6973, %191 ], [ %.promoted78, %166 ]
  %.lcssa7177 = phi i32 [ %172, %191 ], [ %.promoted76, %166 ]
  %168 = phi i32 [ %192, %191 ], [ 0, %166 ]
...
171:                                              ; preds = %188, %170
  %.lcssa6973 = phi i32 [ %176, %188 ], [ %.lcssa6973.lcssa79, %170 ]
...
194:                                              ; preds = %218, %193
  %.lcssa8185.lcssa91 = phi i32 [ %.lcssa8185, %218 ], [ %.promoted90, %193 ]
  %.lcssa8389 = phi i32 [ %199, %218 ], [ %.promoted88, %193 ]
  %195 = phi i32 [ %219, %218 ], [ 0, %193 ]
...
198:                                              ; preds = %215, %197
  %.lcssa8185 = phi i32 [ %203, %215 ], [ %.lcssa8185.lcssa91, %197 ]
...
221:                                              ; preds = %245, %220
  %.lcssa9397.lcssa103 = phi i32 [ %.lcssa9397, %245 ], [ %.promoted102, %220 ]
  %.lcssa95101 = phi i32 [ %226, %245 ], [ %.promoted100, %220 ]
  %222 = phi i32 [ %246, %245 ], [ 0, %220 ]
...
225:                                              ; preds = %242, %224
  %.lcssa9397 = phi i32 [ %230, %242 ], [ %.lcssa9397.lcssa103, %224 ]
...
248:                                              ; preds = %272, %247
  %.lcssa105109.lcssa115 = phi i32 [ %.lcssa105109, %272 ], [ %.promoted114, %247 ]
  %.lcssa107113 = phi i32 [ %253, %272 ], [ %.promoted112, %247 ]
  %249 = phi i32 [ %273, %272 ], [ 0, %247 ]
...
252:                                              ; preds = %269, %251
  %.lcssa105109 = phi i32 [ %257, %269 ], [ %.lcssa105109.lcssa115, %251 ]
...
275:                                              ; preds = %299, %274
  %.lcssa117121.lcssa127 = phi i32 [ %.lcssa117121, %299 ], [ %.promoted126, %274 ]
  %.lcssa119125 = phi i32 [ %280, %299 ], [ %.promoted124, %274 ]
  %276 = phi i32 [ %300, %299 ], [ 0, %274 ]
...
279:                                              ; preds = %296, %278
  %.lcssa117121 = phi i32 [ %284, %296 ], [ %.lcssa117121.lcssa127, %278 ]
...
302:                                              ; preds = %326, %301
  %.lcssa129133.lcssa139 = phi i32 [ %.lcssa129133, %326 ], [ %.promoted138, %301 ]
  %.lcssa131137 = phi i32 [ %307, %326 ], [ %.promoted136, %301 ]
  %303 = phi i32 [ %327, %326 ], [ 0, %301 ]
...
306:                                              ; preds = %323, %305
  %.lcssa129133 = phi i32 [ %311, %323 ], [ %.lcssa129133.lcssa139, %305 ]
...
329:                                              ; preds = %353, %328
  %.lcssa141145.lcssa151 = phi i32 [ %.lcssa141145, %353 ], [ %.promoted150, %328 ]
  %.lcssa143149 = phi i32 [ %334, %353 ], [ %.promoted148, %328 ]
  %330 = phi i32 [ %354, %353 ], [ 0, %328 ]
...
333:                                              ; preds = %350, %332
  %.lcssa141145 = phi i32 [ %338, %350 ], [ %.lcssa141145.lcssa151, %332 ]
...
356:                                              ; preds = %380, %355
  %.lcssa153157.lcssa163 = phi i32 [ %.lcssa153157, %380 ], [ %.promoted162, %355 ]
  %.lcssa155161 = phi i32 [ %361, %380 ], [ %.promoted160, %355 ]
  %357 = phi i32 [ %381, %380 ], [ 0, %355 ]
...
360:                                              ; preds = %377, %359
  %.lcssa153157 = phi i32 [ %365, %377 ], [ %.lcssa153157.lcssa163, %359 ]
...
383:                                              ; preds = %407, %382
  %.lcssa165169.lcssa175 = phi i32 [ %.lcssa165169, %407 ], [ %.promoted174, %382 ]
  %.lcssa167173 = phi i32 [ %388, %407 ], [ %.promoted172, %382 ]
  %384 = phi i32 [ %408, %407 ], [ 0, %382 ]
...
387:                                              ; preds = %404, %386
  %.lcssa165169 = phi i32 [ %392, %404 ], [ %.lcssa165169.lcssa175, %386 ]
