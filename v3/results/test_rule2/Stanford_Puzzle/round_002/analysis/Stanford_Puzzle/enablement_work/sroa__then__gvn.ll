...
define dso_local i32 @Fit(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %.phi.trans.insert6 = getelementptr inbounds [13 x i32], ptr @piecemax, i64 0, i64 %.phi.trans.insert
  %.pre = load i32, ptr %.phi.trans.insert6, align 4
  br label %3
...
define dso_local i32 @Place(i32 noundef %0, i32 noundef %1) #0 {
  %.phi.trans.insert = sext i32 %0 to i64
  %.phi.trans.insert8 = getelementptr inbounds [13 x i32], ptr @piecemax, i64 0, i64 %.phi.trans.insert
  %.pre = load i32, ptr %.phi.trans.insert8, align 4
  br label %3
...
define dso_local void @Remove(i32 noundef %0, i32 noundef %1) #0 {
  %.phi.trans.insert = sext i32 %0 to i64
  %.phi.trans.insert4 = getelementptr inbounds [13 x i32], ptr @piecemax, i64 0, i64 %.phi.trans.insert
...
8:                                                ; preds = %26, %7
  %.0137 = phi i32 [ 1, %7 ], [ %27, %26 ]
  %9 = icmp sle i32 %.0137, 5
...
11:                                               ; preds = %24, %10
  %.0123 = phi i32 [ 1, %10 ], [ %25, %24 ]
  %12 = icmp sle i32 %.0123, 5
...
14:                                               ; preds = %16, %13
  %.0121 = phi i32 [ 1, %13 ], [ %23, %16 ]
  %15 = icmp sle i32 %.0121, 5
  br i1 %15, label %16, label %24

16:                                               ; preds = %14
  %17 = mul nsw i32 8, %.0121
  %18 = add nsw i32 %.0123, %17
  %19 = mul nsw i32 8, %18
  %20 = add nsw i32 %.0137, %19
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [512 x i32], ptr @puzzl, i64 0, i64 %21
  store i32 0, ptr %22, align 4
  %23 = add nsw i32 %.0121, 1
  br label %14, !llvm.loop !14

24:                                               ; preds = %14
  %25 = add nsw i32 %.0123, 1
  br label %11, !llvm.loop !15

26:                                               ; preds = %11
  %27 = add nsw i32 %.0137, 1
...
29:                                               ; preds = %40, %28
  %.1138 = phi i32 [ 0, %28 ], [ %41, %40 ]
  %30 = icmp sle i32 %.1138, 12
...
43:                                               ; preds = %61, %42
  %.2139 = phi i32 [ 0, %42 ], [ %62, %61 ]
  %44 = icmp sle i32 %.2139, 3
...
46:                                               ; preds = %59, %45
  %.1124 = phi i32 [ 0, %45 ], [ %60, %59 ]
  %47 = icmp sle i32 %.1124, 1
...
49:                                               ; preds = %51, %48
  %.1122 = phi i32 [ 0, %48 ], [ %58, %51 ]
  %50 = icmp sle i32 %.1122, 0
  br i1 %50, label %51, label %59

51:                                               ; preds = %49
  %52 = mul nsw i32 8, %.1122
  %53 = add nsw i32 %.1124, %52
  %54 = mul nsw i32 8, %53
  %55 = add nsw i32 %.2139, %54
  %56 = sext i32 %55 to i64
  %57 = getelementptr inbounds [512 x i32], ptr @p, i64 0, i64 %56
  store i32 1, ptr %57, align 4
  %58 = add nsw i32 %.1122, 1
  br label %49, !llvm.loop !19

59:                                               ; preds = %49
  %60 = add nsw i32 %.1124, 1
  br label %46, !llvm.loop !20

61:                                               ; preds = %46
  %62 = add nsw i32 %.2139, 1
...
64:                                               ; preds = %82, %63
  %.3140 = phi i32 [ 0, %63 ], [ %83, %82 ]
  %65 = icmp sle i32 %.3140, 1
...
67:                                               ; preds = %80, %66
  %.2125 = phi i32 [ 0, %66 ], [ %81, %80 ]
  %68 = icmp sle i32 %.2125, 0
...
72:                                               ; preds = %70
  %73 = mul nsw i32 8, %.2
  %74 = add nsw i32 %.2125, %73
  %75 = mul nsw i32 8, %74
  %76 = add nsw i32 %.3140, %75
...
80:                                               ; preds = %70
  %81 = add nsw i32 %.2125, 1
  br label %67, !llvm.loop !23

82:                                               ; preds = %67
  %83 = add nsw i32 %.3140, 1
...
85:                                               ; preds = %103, %84
  %.4141 = phi i32 [ 0, %84 ], [ %104, %103 ]
  %86 = icmp sle i32 %.4141, 0
...
88:                                               ; preds = %101, %87
  %.3126 = phi i32 [ 0, %87 ], [ %102, %101 ]
  %89 = icmp sle i32 %.3126, 3
...
93:                                               ; preds = %91
  %94 = mul nsw i32 8, %.3
  %95 = add nsw i32 %.3126, %94
  %96 = mul nsw i32 8, %95
  %97 = add nsw i32 %.4141, %96
...
101:                                              ; preds = %91
  %102 = add nsw i32 %.3126, 1
  br label %88, !llvm.loop !26

103:                                              ; preds = %88
  %104 = add nsw i32 %.4141, 1
...
106:                                              ; preds = %124, %105
  %.5142 = phi i32 [ 0, %105 ], [ %125, %124 ]
  %107 = icmp sle i32 %.5142, 1
...
109:                                              ; preds = %122, %108
  %.4127 = phi i32 [ 0, %108 ], [ %123, %122 ]
  %110 = icmp sle i32 %.4127, 3
...
114:                                              ; preds = %112
  %115 = mul nsw i32 8, %.4
  %116 = add nsw i32 %.4127, %115
  %117 = mul nsw i32 8, %116
  %118 = add nsw i32 %.5142, %117
...
122:                                              ; preds = %112
  %123 = add nsw i32 %.4127, 1
  br label %109, !llvm.loop !29

124:                                              ; preds = %109
  %125 = add nsw i32 %.5142, 1
...
127:                                              ; preds = %145, %126
  %.6143 = phi i32 [ 0, %126 ], [ %146, %145 ]
  %128 = icmp sle i32 %.6143, 3
...
130:                                              ; preds = %143, %129
  %.5128 = phi i32 [ 0, %129 ], [ %144, %143 ]
  %131 = icmp sle i32 %.5128, 0
...
135:                                              ; preds = %133
  %136 = mul nsw i32 8, %.5
  %137 = add nsw i32 %.5128, %136
  %138 = mul nsw i32 8, %137
  %139 = add nsw i32 %.6143, %138
...
143:                                              ; preds = %133
  %144 = add nsw i32 %.5128, 1
  br label %130, !llvm.loop !32

145:                                              ; preds = %130
  %146 = add nsw i32 %.6143, 1
...
148:                                              ; preds = %166, %147
  %.7144 = phi i32 [ 0, %147 ], [ %167, %166 ]
  %149 = icmp sle i32 %.7144, 0
...
151:                                              ; preds = %164, %150
  %.6129 = phi i32 [ 0, %150 ], [ %165, %164 ]
  %152 = icmp sle i32 %.6129, 1
...
156:                                              ; preds = %154
  %157 = mul nsw i32 8, %.6
  %158 = add nsw i32 %.6129, %157
  %159 = mul nsw i32 8, %158
  %160 = add nsw i32 %.7144, %159
...
164:                                              ; preds = %154
  %165 = add nsw i32 %.6129, 1
  br label %151, !llvm.loop !35

166:                                              ; preds = %151
  %167 = add nsw i32 %.7144, 1
...
169:                                              ; preds = %187, %168
  %.8145 = phi i32 [ 0, %168 ], [ %188, %187 ]
  %170 = icmp sle i32 %.8145, 2
...
172:                                              ; preds = %185, %171
  %.7130 = phi i32 [ 0, %171 ], [ %186, %185 ]
  %173 = icmp sle i32 %.7130, 0
...
177:                                              ; preds = %175
  %178 = mul nsw i32 8, %.7
  %179 = add nsw i32 %.7130, %178
  %180 = mul nsw i32 8, %179
  %181 = add nsw i32 %.8145, %180
...
185:                                              ; preds = %175
  %186 = add nsw i32 %.7130, 1
  br label %172, !llvm.loop !38

187:                                              ; preds = %172
  %188 = add nsw i32 %.8145, 1
...
190:                                              ; preds = %208, %189
  %.9146 = phi i32 [ 0, %189 ], [ %209, %208 ]
  %191 = icmp sle i32 %.9146, 0
...
193:                                              ; preds = %206, %192
  %.8131 = phi i32 [ 0, %192 ], [ %207, %206 ]
  %194 = icmp sle i32 %.8131, 2
...
198:                                              ; preds = %196
  %199 = mul nsw i32 8, %.8
  %200 = add nsw i32 %.8131, %199
  %201 = mul nsw i32 8, %200
  %202 = add nsw i32 %.9146, %201
...
206:                                              ; preds = %196
  %207 = add nsw i32 %.8131, 1
  br label %193, !llvm.loop !41

208:                                              ; preds = %193
  %209 = add nsw i32 %.9146, 1
...
211:                                              ; preds = %229, %210
  %.10147 = phi i32 [ 0, %210 ], [ %230, %229 ]
  %212 = icmp sle i32 %.10147, 0
...
214:                                              ; preds = %227, %213
  %.9132 = phi i32 [ 0, %213 ], [ %228, %227 ]
  %215 = icmp sle i32 %.9132, 0
...
219:                                              ; preds = %217
  %220 = mul nsw i32 8, %.9
  %221 = add nsw i32 %.9132, %220
  %222 = mul nsw i32 8, %221
  %223 = add nsw i32 %.10147, %222
...
227:                                              ; preds = %217
  %228 = add nsw i32 %.9132, 1
  br label %214, !llvm.loop !44

229:                                              ; preds = %214
  %230 = add nsw i32 %.10147, 1
...
232:                                              ; preds = %250, %231
  %.11148 = phi i32 [ 0, %231 ], [ %251, %250 ]
  %233 = icmp sle i32 %.11148, 1
...
235:                                              ; preds = %248, %234
  %.10133 = phi i32 [ 0, %234 ], [ %249, %248 ]
  %236 = icmp sle i32 %.10133, 1
...
240:                                              ; preds = %238
  ...
  %242 = add nsw i32 %.10133, %241
  %243 = mul nsw i32 8, %242
  %244 = add nsw i32 %.11148, %243
...
248:                                              ; preds = %238
  %249 = add nsw i32 %.10133, 1
  br label %235, !llvm.loop !47

250:                                              ; preds = %235
  %251 = add nsw i32 %.11148, 1
...
253:                                              ; preds = %271, %252
  %.12149 = phi i32 [ 0, %252 ], [ %272, %271 ]
  %254 = icmp sle i32 %.12149, 1
...
256:                                              ; preds = %269, %255
  %.11134 = phi i32 [ 0, %255 ], [ %270, %269 ]
  %257 = icmp sle i32 %.11134, 0
...
261:                                              ; preds = %259
  ...
  %263 = add nsw i32 %.11134, %262
  %264 = mul nsw i32 8, %263
  %265 = add nsw i32 %.12149, %264
...
269:                                              ; preds = %259
  %270 = add nsw i32 %.11134, 1
  br label %256, !llvm.loop !50

271:                                              ; preds = %256
  %272 = add nsw i32 %.12149, 1
...
274:                                              ; preds = %292, %273
  %.13150 = phi i32 [ 0, %273 ], [ %293, %292 ]
  %275 = icmp sle i32 %.13150, 0
...
277:                                              ; preds = %290, %276
  %.12135 = phi i32 [ 0, %276 ], [ %291, %290 ]
  %278 = icmp sle i32 %.12135, 1
...
282:                                              ; preds = %280
  ...
  %284 = add nsw i32 %.12135, %283
  %285 = mul nsw i32 8, %284
  %286 = add nsw i32 %.13150, %285
...
290:                                              ; preds = %280
  %291 = add nsw i32 %.12135, 1
  br label %277, !llvm.loop !53

292:                                              ; preds = %277
  %293 = add nsw i32 %.13150, 1
...
298:                                              ; preds = %311, %297
  %.13136 = phi i32 [ 0, %297 ], [ %312, %311 ]
  %299 = icmp sle i32 %.13136, 1
