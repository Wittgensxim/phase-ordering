...
4:                                                ; preds = %24, %1
  %.010 = phi i32 [ 0, %1 ], [ %25, %24 ]
  %5 = icmp sle i32 %.010, 12
...
14:                                               ; preds = %6
  %15 = call i32 @Fit(i32 noundef %.010, i32 noundef %0)
  %16 = icmp ne i32 %15, 0
