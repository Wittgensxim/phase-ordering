...
22:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %29, label %.lr.ph5, label %40

.lr.ph5:                                          ; preds = %22
  br label %30

30:                                               ; preds = %.lr.ph5, %37
  %.13 = phi i32 [ %1, %.lr.ph5 ], [ %38, %37 ]
...
37:                                               ; preds = %36
  ...
  br i1 %39, label %30, label %._crit_edge6, !llvm.loop !10

._crit_edge6:                                     ; preds = %37
  br label %40

40:                                               ; preds = %._crit_edge6, %22
  br label %41

41:                                               ; preds = %40, %35
  %.0 = phi i32 [ %.lcssa1, %35 ], [ 0, %40 ]
  ret i32 %.0
}
