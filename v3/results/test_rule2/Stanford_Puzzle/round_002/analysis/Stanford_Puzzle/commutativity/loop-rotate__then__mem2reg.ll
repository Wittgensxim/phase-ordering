...
15:                                               ; preds = %.lr.ph2, %23
  %.0147 = phi i32 [ 1, %.lr.ph2 ], [ %24, %23 ]
  %16 = phi i32 [ 1, %.lr.ph2 ], [ %24, %23 ]
  %17 = mul nsw i32 8, %16
  %18 = add nsw i32 %.0133, %17
  %19 = mul nsw i32 8, %18
  %20 = add nsw i32 %.0, %19
...
57:                                               ; preds = %.lr.ph17, %65
  %.1148 = phi i32 [ 0, %.lr.ph17 ], [ %66, %65 ]
  %58 = phi i32 [ 0, %.lr.ph17 ], [ %66, %65 ]
  %59 = mul nsw i32 8, %58
  %60 = add nsw i32 %.1134, %59
  %61 = mul nsw i32 8, %60
  %62 = add nsw i32 %.2, %61
...
82:                                               ; preds = %.lr.ph26, %90
  %.2149 = phi i32 [ 0, %.lr.ph26 ], [ %91, %90 ]
  %83 = phi i32 [ 0, %.lr.ph26 ], [ %91, %90 ]
  %84 = mul nsw i32 8, %83
  %85 = add nsw i32 %.2135, %84
  %86 = mul nsw i32 8, %85
  %87 = add nsw i32 %.3, %86
...
105:                                              ; preds = %.lr.ph38, %119
  %.3136 = phi i32 [ 0, %.lr.ph38 ], [ %120, %119 ]
...
107:                                              ; preds = %.lr.ph35, %115
  %.3150 = phi i32 [ 0, %.lr.ph35 ], [ %116, %115 ]
  %108 = phi i32 [ 0, %.lr.ph35 ], [ %116, %115 ]
  %109 = mul nsw i32 8, %108
  %110 = add nsw i32 %.3136, %109
...
130:                                              ; preds = %.lr.ph47, %144
  %.4137 = phi i32 [ 0, %.lr.ph47 ], [ %145, %144 ]
...
132:                                              ; preds = %.lr.ph44, %140
  %.4151 = phi i32 [ 0, %.lr.ph44 ], [ %141, %140 ]
  %133 = phi i32 [ 0, %.lr.ph44 ], [ %141, %140 ]
  %134 = mul nsw i32 8, %133
  %135 = add nsw i32 %.4137, %134
...
155:                                              ; preds = %.lr.ph56, %169
  %.5138 = phi i32 [ 0, %.lr.ph56 ], [ %170, %169 ]
...
157:                                              ; preds = %.lr.ph53, %165
  %.5152 = phi i32 [ 0, %.lr.ph53 ], [ %166, %165 ]
  %158 = phi i32 [ 0, %.lr.ph53 ], [ %166, %165 ]
  %159 = mul nsw i32 8, %158
  %160 = add nsw i32 %.5138, %159
  %161 = mul nsw i32 8, %160
  %162 = add nsw i32 %.6, %161
...
180:                                              ; preds = %.lr.ph65, %194
  %.6139 = phi i32 [ 0, %.lr.ph65 ], [ %195, %194 ]
...
182:                                              ; preds = %.lr.ph62, %190
  %.6153 = phi i32 [ 0, %.lr.ph62 ], [ %191, %190 ]
  %183 = phi i32 [ 0, %.lr.ph62 ], [ %191, %190 ]
  %184 = mul nsw i32 8, %183
  %185 = add nsw i32 %.6139, %184
  %186 = mul nsw i32 8, %185
  %187 = add nsw i32 %.7, %186
...
205:                                              ; preds = %.lr.ph74, %219
  %.7140 = phi i32 [ 0, %.lr.ph74 ], [ %220, %219 ]
...
207:                                              ; preds = %.lr.ph71, %215
  %.7154 = phi i32 [ 0, %.lr.ph71 ], [ %216, %215 ]
  %208 = phi i32 [ 0, %.lr.ph71 ], [ %216, %215 ]
  %209 = mul nsw i32 8, %208
  %210 = add nsw i32 %.7140, %209
...
230:                                              ; preds = %.lr.ph83, %244
  %.8141 = phi i32 [ 0, %.lr.ph83 ], [ %245, %244 ]
...
232:                                              ; preds = %.lr.ph80, %240
  %.8155 = phi i32 [ 0, %.lr.ph80 ], [ %241, %240 ]
  %233 = phi i32 [ 0, %.lr.ph80 ], [ %241, %240 ]
  %234 = mul nsw i32 8, %233
  %235 = add nsw i32 %.8141, %234
  %236 = mul nsw i32 8, %235
  %237 = add nsw i32 %.9, %236
...
255:                                              ; preds = %.lr.ph92, %269
  %.9142 = phi i32 [ 0, %.lr.ph92 ], [ %270, %269 ]
...
257:                                              ; preds = %.lr.ph89, %265
  %.9156 = phi i32 [ 0, %.lr.ph89 ], [ %266, %265 ]
  %258 = phi i32 [ 0, %.lr.ph89 ], [ %266, %265 ]
  %259 = mul nsw i32 8, %258
  %260 = add nsw i32 %.9142, %259
  %261 = mul nsw i32 8, %260
  %262 = add nsw i32 %.10, %261
...
280:                                              ; preds = %.lr.ph101, %294
  %.10143 = phi i32 [ 0, %.lr.ph101 ], [ %295, %294 ]
...
282:                                              ; preds = %.lr.ph98, %290
  %.10157 = phi i32 [ 0, %.lr.ph98 ], [ %291, %290 ]
  %283 = phi i32 [ 0, %.lr.ph98 ], [ %291, %290 ]
  %284 = mul nsw i32 8, %283
  %285 = add nsw i32 %.10143, %284
  %286 = mul nsw i32 8, %285
  %287 = add nsw i32 %.11, %286
...
305:                                              ; preds = %.lr.ph110, %319
  %.11144 = phi i32 [ 0, %.lr.ph110 ], [ %320, %319 ]
...
307:                                              ; preds = %.lr.ph107, %315
  %.11158 = phi i32 [ 0, %.lr.ph107 ], [ %316, %315 ]
  %308 = phi i32 [ 0, %.lr.ph107 ], [ %316, %315 ]
  %309 = mul nsw i32 8, %308
  %310 = add nsw i32 %.11144, %309
...
330:                                              ; preds = %.lr.ph119, %344
  %.12145 = phi i32 [ 0, %.lr.ph119 ], [ %345, %344 ]
...
332:                                              ; preds = %.lr.ph116, %340
  %.12159 = phi i32 [ 0, %.lr.ph116 ], [ %341, %340 ]
  %333 = phi i32 [ 0, %.lr.ph116 ], [ %341, %340 ]
  %334 = mul nsw i32 8, %333
  %335 = add nsw i32 %.12145, %334
  %336 = mul nsw i32 8, %335
  %337 = add nsw i32 %.13, %336
...
355:                                              ; preds = %.lr.ph128, %369
  %.13146 = phi i32 [ 0, %.lr.ph128 ], [ %370, %369 ]
...
357:                                              ; preds = %.lr.ph125, %365
  %.13160 = phi i32 [ 0, %.lr.ph125 ], [ %366, %365 ]
  %358 = phi i32 [ 0, %.lr.ph125 ], [ %366, %365 ]
  %359 = mul nsw i32 8, %358
  %360 = add nsw i32 %.13146, %359
