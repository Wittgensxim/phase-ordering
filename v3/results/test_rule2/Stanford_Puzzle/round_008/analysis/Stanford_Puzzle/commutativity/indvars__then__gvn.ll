...
4:                                                ; preds = %13, %2
  ...
  %5 = sext i32 %.pre to i64
  %.not = icmp sgt i64 %indvars.iv1, %5
  br i1 %.not, label %14, label %6

6:                                                ; preds = %4
  %7 = getelementptr inbounds [2048 x i8], ptr @p, i64 %.phi.trans.insert
  %8 = getelementptr inbounds [4 x i8], ptr %7, i64 %indvars.iv1
  %9 = load i32, ptr %8, align 4
  %.not4 = icmp eq i32 %9, 0
  br i1 %.not4, label %13, label %10

10:                                               ; preds = %6
  %11 = add nsw i64 %3, %indvars.iv1
  %12 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %11
...
21:                                               ; preds = %27, %14
  %indvars.iv = phi i64 [ %indvars.iv.next, %27 ], [ %3, %14 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit.loopexit, label %22

22:                                               ; preds = %21
  %23 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv
