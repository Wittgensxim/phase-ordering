...
.preheader22:                                     ; preds = %.preheader22.preheader, %.preheader22
  ...
  %36 = or disjoint i32 %storemerge414, %35
...
.preheader23:                                     ; preds = %.preheader22
  br i1 false, label %.preheader22.preheader, label %41, !llvm.loop !23
...
.preheader21.preheader:                           ; preds = %44, %54
...
54:                                               ; preds = %.preheader21
  br i1 false, label %.preheader21.preheader, label %55, !llvm.loop !27
...
.preheader19.preheader:                           ; preds = %55, %62
  %storemerge618 = phi i32 [ 0, %55 ], [ %63, %62 ]
  br label %.preheader18.preheader

.preheader18.preheader:                           ; preds = %.preheader19.preheader, %.preheader19
  %storemerge3817 = phi i32 [ 0, %.preheader19.preheader ], [ %60, %.preheader19 ]
  br label %.preheader18

.preheader18:                                     ; preds = %.preheader18.preheader, %.preheader18
  %56 = shl nuw nsw i32 %storemerge3817, 3
  %57 = or disjoint i32 %storemerge618, %56
...
.preheader17.preheader:                           ; preds = %65, %72
  %storemerge720 = phi i32 [ 0, %65 ], [ %73, %72 ]
...
.preheader16:                                     ; preds = %.preheader16.preheader, %.preheader16
  %storemerge3719 = phi i32 [ 0, %.preheader16.preheader ], [ %70, %.preheader16 ]
  %66 = shl nuw nsw i32 %storemerge3719, 6
  %67 = or disjoint i32 %storemerge720, %66
  %68 = zext nneg i32 %67 to i64
  %69 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 8192), i64 %68
  store i32 1, ptr %69, align 4
  %70 = add nuw nsw i32 %storemerge3719, 1
  %71 = icmp samesign ult i32 %70, 2
  br i1 %71, label %.preheader16, label %.preheader17, !llvm.loop !31

.preheader17:                                     ; preds = %.preheader16
  br i1 false, label %.preheader16.preheader, label %72, !llvm.loop !32

72:                                               ; preds = %.preheader17
  %73 = add nuw nsw i32 %storemerge720, 1
  %74 = icmp samesign ult i32 %73, 4
...
.preheader15.preheader:                           ; preds = %75, %85
  br label %.preheader14.preheader

.preheader14.preheader:                           ; preds = %.preheader15.preheader, %.preheader15
  %storemerge3422 = phi i32 [ 0, %.preheader15.preheader ], [ %83, %.preheader15 ]
  br label %.preheader14

.preheader14:                                     ; preds = %.preheader14.preheader, %.preheader14
  %storemerge3521 = phi i32 [ 0, %.preheader14.preheader ], [ %81, %.preheader14 ]
  %76 = shl nuw nsw i32 %storemerge3521, 6
  %77 = shl nuw nsw i32 %storemerge3422, 3
  %78 = or disjoint i32 %76, %77
  %79 = zext nneg i32 %78 to i64
  %80 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 10240), i64 %79
  store i32 1, ptr %80, align 4
  %81 = add nuw nsw i32 %storemerge3521, 1
  %82 = icmp samesign ult i32 %81, 4
  br i1 %82, label %.preheader14, label %.preheader15, !llvm.loop !34

.preheader15:                                     ; preds = %.preheader14
  %83 = add nuw nsw i32 %storemerge3422, 1
  %84 = icmp samesign ult i32 %83, 2
  br i1 %84, label %.preheader14.preheader, label %85, !llvm.loop !35

85:                                               ; preds = %.preheader15
  br i1 false, label %.preheader15.preheader, label %86, !llvm.loop !36
...
.preheader13.preheader:                           ; preds = %86, %89
  %storemerge923 = phi i32 [ 0, %86 ], [ %90, %89 ]
...
.preheader12:                                     ; preds = %.preheader12.preheader, %.preheader12
  %87 = zext nneg i32 %storemerge923 to i64
  %88 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 12288), i64 %87
  store i32 1, ptr %88, align 4
  br i1 false, label %.preheader12, label %.preheader13, !llvm.loop !37

.preheader13:                                     ; preds = %.preheader12
  br i1 false, label %.preheader12.preheader, label %89, !llvm.loop !38

89:                                               ; preds = %.preheader13
  %90 = add nuw nsw i32 %storemerge923, 1
  %91 = icmp samesign ult i32 %90, 3
...
.preheader9.preheader:                            ; preds = %99, %105
...
.preheader8:                                      ; preds = %.preheader8.preheader, %.preheader8
  %storemerge2925 = phi i32 [ 0, %.preheader8.preheader ], [ %103, %.preheader8 ]
  %100 = shl nuw nsw i32 %storemerge2925, 6
  %101 = zext nneg i32 %100 to i64
  %102 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 16384), i64 %101
  store i32 1, ptr %102, align 4
  %103 = add nuw nsw i32 %storemerge2925, 1
  %104 = icmp samesign ult i32 %103, 3
  br i1 %104, label %.preheader8, label %.preheader9, !llvm.loop !43

.preheader9:                                      ; preds = %.preheader8
  br i1 false, label %.preheader8.preheader, label %105, !llvm.loop !44

105:                                              ; preds = %.preheader9
  br i1 false, label %.preheader9.preheader, label %106, !llvm.loop !45
...
.preheader5.preheader:                            ; preds = %116, %123
  %storemerge1329 = phi i32 [ 0, %116 ], [ %124, %123 ]
...
.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  %storemerge2528 = phi i32 [ 0, %.preheader4.preheader ], [ %121, %.preheader4 ]
  %117 = shl nuw nsw i32 %storemerge2528, 6
  %118 = or disjoint i32 %storemerge1329, %117
  %119 = zext nneg i32 %118 to i64
  %120 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %119
  store i32 1, ptr %120, align 4
  %121 = add nuw nsw i32 %storemerge2528, 1
  %122 = icmp samesign ult i32 %121, 2
  br i1 %122, label %.preheader4, label %.preheader5, !llvm.loop !49

.preheader5:                                      ; preds = %.preheader4
  br i1 false, label %.preheader4.preheader, label %123, !llvm.loop !50

123:                                              ; preds = %.preheader5
  %124 = add nuw nsw i32 %storemerge1329, 1
...
.preheader3.preheader:                            ; preds = %126, %136
  br label %.preheader2.preheader

.preheader2.preheader:                            ; preds = %.preheader3.preheader, %.preheader3
  %storemerge2231 = phi i32 [ 0, %.preheader3.preheader ], [ %134, %.preheader3 ]
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %.preheader2
  %storemerge2330 = phi i32 [ 0, %.preheader2.preheader ], [ %132, %.preheader2 ]
  %127 = shl nuw nsw i32 %storemerge2330, 6
  %128 = shl nuw nsw i32 %storemerge2231, 3
  %129 = or disjoint i32 %127, %128
  %130 = zext nneg i32 %129 to i64
  %131 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %130
  store i32 1, ptr %131, align 4
  %132 = add nuw nsw i32 %storemerge2330, 1
  %133 = icmp samesign ult i32 %132, 2
  br i1 %133, label %.preheader2, label %.preheader3, !llvm.loop !52

.preheader3:                                      ; preds = %.preheader2
  %134 = add nuw nsw i32 %storemerge2231, 1
  %135 = icmp samesign ult i32 %134, 2
  br i1 %135, label %.preheader2.preheader, label %136, !llvm.loop !53

136:                                              ; preds = %.preheader3
  br i1 false, label %.preheader3.preheader, label %137, !llvm.loop !54
...
.preheader1.preheader:                            ; preds = %137, %148
  %storemerge1534 = phi i32 [ 0, %137 ], [ %149, %148 ]
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader1.preheader, %.preheader1
  %storemerge2033 = phi i32 [ 0, %.preheader1.preheader ], [ %146, %.preheader1 ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %storemerge2132 = phi i32 [ 0, %.preheader.preheader ], [ %144, %.preheader ]
  %138 = shl nuw nsw i32 %storemerge2132, 6
  %139 = shl nuw nsw i32 %storemerge2033, 3
  %140 = or disjoint i32 %138, %139
  %141 = or disjoint i32 %storemerge1534, %140
  %142 = zext nneg i32 %141 to i64
  %143 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %142
  store i32 1, ptr %143, align 4
  %144 = add nuw nsw i32 %storemerge2132, 1
  %145 = icmp samesign ult i32 %144, 2
  br i1 %145, label %.preheader, label %.preheader1, !llvm.loop !55

.preheader1:                                      ; preds = %.preheader
  %146 = add nuw nsw i32 %storemerge2033, 1
  %147 = icmp samesign ult i32 %146, 2
  br i1 %147, label %.preheader.preheader, label %148, !llvm.loop !56

148:                                              ; preds = %.preheader1
  %149 = add nuw nsw i32 %storemerge1534, 1
