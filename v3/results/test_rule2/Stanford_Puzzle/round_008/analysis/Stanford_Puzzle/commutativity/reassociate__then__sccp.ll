...
35:                                               ; preds = %.preheader24
  %36 = mul nuw nsw i32 %storemerge44, 8
  %37 = add nsw i32 %36, %storemerge3
...
50:                                               ; preds = %.preheader22
  %51 = mul i32 %storemerge43, 64
  %52 = add nuw nsw i32 0, %storemerge4
  %53 = add i32 %52, %51
...
65:                                               ; preds = %.preheader20
  %66 = mul nuw nsw i32 %storemerge41, 64
  %67 = mul i32 %storemerge40, 8
  %68 = add nuw nsw i32 %67, 0
  %69 = add i32 %68, %66
...
81:                                               ; preds = %.preheader18
  %82 = mul i32 %storemerge38, 8
  %83 = add i32 %82, %storemerge6
...
96:                                               ; preds = %.preheader16
  %97 = mul nuw nsw i32 %storemerge37, 64
  %98 = add nuw nsw i32 0, %storemerge7
...
111:                                              ; preds = %.preheader14
  %112 = mul i32 %storemerge35, 64
  %113 = mul nuw nsw i32 %storemerge34, 8
...
123:                                              ; preds = %133, %122
  %storemerge9 = phi i32 [ 0, %122 ], [ %134, %133 ]
  %124 = icmp slt i32 %storemerge9, 3
  br i1 %124, label %.preheader13.preheader, label %135

.preheader13.preheader:                           ; preds = %123
  br label %.preheader13

.preheader13:                                     ; preds = %132, %.preheader13.preheader
  %storemerge32 = phi i32 [ 1, %132 ], [ 0, %.preheader13.preheader ]
  %125 = icmp slt i32 %storemerge32, 1
  br i1 %125, label %.preheader12.preheader, label %133
...
127:                                              ; preds = %.preheader12
  %128 = add nuw nsw i32 0, %storemerge9
  %129 = add nuw nsw i32 %128, 0
...
132:                                              ; preds = %.preheader12
  br label %.preheader13, !llvm.loop !38

133:                                              ; preds = %.preheader13
...
136:                                              ; preds = %148, %135
  %storemerge10 = phi i32 [ 0, %135 ], [ 1, %148 ]
  %137 = icmp slt i32 %storemerge10, 1
  br i1 %137, label %.preheader11.preheader, label %149

.preheader11.preheader:                           ; preds = %136
  br label %.preheader11

.preheader11:                                     ; preds = %146, %.preheader11.preheader
  %storemerge30 = phi i32 [ %147, %146 ], [ 0, %.preheader11.preheader ]
  %138 = icmp slt i32 %storemerge30, 3
  br i1 %138, label %.preheader10.preheader, label %148

.preheader10.preheader:                           ; preds = %.preheader11
  br label %.preheader10

.preheader10:                                     ; preds = %140, %.preheader10.preheader
  %storemerge31 = phi i32 [ 1, %140 ], [ 0, %.preheader10.preheader ]
  %139 = icmp slt i32 %storemerge31, 1
  br i1 %139, label %140, label %146

140:                                              ; preds = %.preheader10
  %141 = mul i32 %storemerge30, 8
  %142 = add nuw nsw i32 %141, 0
  %143 = add nuw nsw i32 %142, 0
  %144 = sext i32 %143 to i64
  %145 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 14336), i64 %144
  store i32 1, ptr %145, align 4
  br label %.preheader10, !llvm.loop !40

146:                                              ; preds = %.preheader10
  %147 = add nsw i32 %storemerge30, 1
...
150:                                              ; preds = %161, %149
  %storemerge11 = phi i32 [ 0, %149 ], [ 1, %161 ]
  %151 = icmp slt i32 %storemerge11, 1
  br i1 %151, label %.preheader9.preheader, label %162

.preheader9.preheader:                            ; preds = %150
  br label %.preheader9

.preheader9:                                      ; preds = %160, %.preheader9.preheader
  %storemerge28 = phi i32 [ 1, %160 ], [ 0, %.preheader9.preheader ]
  %152 = icmp slt i32 %storemerge28, 1
  br i1 %152, label %.preheader8.preheader, label %161

.preheader8.preheader:                            ; preds = %.preheader9
  br label %.preheader8

.preheader8:                                      ; preds = %154, %.preheader8.preheader
  %storemerge29 = phi i32 [ %159, %154 ], [ 0, %.preheader8.preheader ]
...
167:                                              ; preds = %.preheader6
  %168 = mul nuw nsw i32 %storemerge26, 8
  %169 = add nuw nsw i32 %168, %storemerge12
  %170 = add nuw nsw i32 %169, 0
...
182:                                              ; preds = %.preheader4
  %183 = mul nuw nsw i32 %storemerge25, 64
  %184 = add nuw nsw i32 0, %storemerge13
...
197:                                              ; preds = %.preheader2
  %198 = mul nuw nsw i32 %storemerge23, 64
  %199 = mul nuw nsw i32 %storemerge22, 8
  %200 = add nuw nsw i32 %199, 0
...
213:                                              ; preds = %.preheader
  %214 = mul nuw nsw i32 %storemerge21, 64
  %215 = mul nuw nsw i32 %storemerge20, 8
  %216 = add nuw nsw i32 %215, %storemerge15
