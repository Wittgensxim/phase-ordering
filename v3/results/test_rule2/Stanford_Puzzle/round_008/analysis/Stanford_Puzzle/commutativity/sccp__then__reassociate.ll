...
49:                                               ; preds = %.preheader22
  ...
  %51 = add nuw nsw i32 %50, %storemerge4
...
63:                                               ; preds = %.preheader20
  %64 = mul nuw nsw i32 %storemerge41, 64
  %65 = mul i32 %storemerge40, 8
  %66 = add i32 %64, %65
...
78:                                               ; preds = %.preheader18
  %79 = mul i32 %storemerge38, 8
  %80 = add nuw nsw i32 %79, %storemerge6
...
92:                                               ; preds = %.preheader16
  %93 = mul nuw nsw i32 %storemerge37, 64
  %94 = add nsw i32 %93, %storemerge7
...
106:                                              ; preds = %.preheader14
  %107 = mul i32 %storemerge35, 64
  %108 = mul nuw nsw i32 %storemerge34, 8
...
156:                                              ; preds = %.preheader6
  %157 = mul nuw nsw i32 %storemerge26, 8
  %158 = add nuw nsw i32 %157, %storemerge12
...
170:                                              ; preds = %.preheader4
  %171 = mul nuw nsw i32 %storemerge25, 64
  %172 = add nuw nsw i32 %171, %storemerge13
...
184:                                              ; preds = %.preheader2
  %185 = mul nuw nsw i32 %storemerge23, 64
  %186 = mul nuw nsw i32 %storemerge22, 8
...
199:                                              ; preds = %.preheader
  %200 = mul nuw nsw i32 %storemerge21, 64
  %201 = mul nuw nsw i32 %storemerge20, 8
  %202 = add nuw nsw i32 %201, %storemerge15
