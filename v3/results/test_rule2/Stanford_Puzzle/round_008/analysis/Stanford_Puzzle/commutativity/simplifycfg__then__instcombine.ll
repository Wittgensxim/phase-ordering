...
44:                                               ; preds = %55, %43
  ...
  br i1 %45, label %.preheader23, label %57

.preheader23:                                     ; preds = %44, %54
  %46 = phi i1 [ false, %54 ], [ true, %44 ]
  br i1 %46, label %.preheader22, label %55
...
58:                                               ; preds = %71, %57
  ...
  br i1 %59, label %.preheader21, label %72

.preheader21:                                     ; preds = %58, %69
  %storemerge40 = phi i32 [ %70, %69 ], [ 0, %58 ]
  %60 = icmp samesign ult i32 %storemerge40, 4
  br i1 %60, label %.preheader20, label %71

.preheader20:                                     ; preds = %.preheader21, %62
  %storemerge41 = phi i32 [ %68, %62 ], [ 0, %.preheader21 ]
...
73:                                               ; preds = %83, %72
  ...
  br i1 %74, label %.preheader19, label %85

.preheader19:                                     ; preds = %73, %81
  %storemerge38 = phi i32 [ %82, %81 ], [ 0, %73 ]
  %75 = icmp samesign ult i32 %storemerge38, 4
  br i1 %75, label %.preheader18, label %83

.preheader18:                                     ; preds = %.preheader19, %76
  %storemerge39 = phi i1 [ false, %76 ], [ true, %.preheader19 ]
...
86:                                               ; preds = %97, %85
  ...
  br i1 %87, label %.preheader17, label %99

.preheader17:                                     ; preds = %86, %96
  %88 = phi i1 [ false, %96 ], [ true, %86 ]
  br i1 %88, label %.preheader16, label %97

.preheader16:                                     ; preds = %.preheader17, %90
  %storemerge37 = phi i32 [ %95, %90 ], [ 0, %.preheader17 ]
...
100:                                              ; preds = %113, %99
  ...
  br i1 %101, label %.preheader15, label %114

.preheader15:                                     ; preds = %100, %111
  %storemerge34 = phi i32 [ %112, %111 ], [ 0, %100 ]
  %102 = icmp samesign ult i32 %storemerge34, 2
  br i1 %102, label %.preheader14, label %113

.preheader14:                                     ; preds = %.preheader15, %104
  %storemerge35 = phi i32 [ %110, %104 ], [ 0, %.preheader15 ]
...
115:                                              ; preds = %122, %114
  ...
  br i1 %116, label %.preheader13, label %124

.preheader13:                                     ; preds = %115, %121
  %117 = phi i1 [ false, %121 ], [ true, %115 ]
  br i1 %117, label %.preheader12, label %122

.preheader12:                                     ; preds = %.preheader13, %118
  %storemerge33 = phi i1 [ false, %118 ], [ true, %.preheader13 ]
...
125:                                              ; preds = %134, %124
  ...
  br i1 %126, label %.preheader11, label %135

.preheader11:                                     ; preds = %125, %132
  %storemerge30 = phi i32 [ %133, %132 ], [ 0, %125 ]
  %127 = icmp samesign ult i32 %storemerge30, 3
  br i1 %127, label %.preheader10, label %134

.preheader10:                                     ; preds = %.preheader11, %128
  %storemerge31 = phi i1 [ false, %128 ], [ true, %.preheader11 ]
...
136:                                              ; preds = %146, %135
  ...
  br i1 %137, label %.preheader9, label %147

.preheader9:                                      ; preds = %136, %145
  %138 = phi i1 [ false, %145 ], [ true, %136 ]
  br i1 %138, label %.preheader8, label %146

.preheader8:                                      ; preds = %.preheader9, %140
  %storemerge29 = phi i32 [ %144, %140 ], [ 0, %.preheader9 ]
...
148:                                              ; preds = %158, %147
  ...
  br i1 %149, label %.preheader7, label %160

.preheader7:                                      ; preds = %148, %156
  %storemerge26 = phi i32 [ %157, %156 ], [ 0, %148 ]
  %150 = icmp samesign ult i32 %storemerge26, 2
  br i1 %150, label %.preheader6, label %158

.preheader6:                                      ; preds = %.preheader7, %151
  %storemerge27 = phi i1 [ false, %151 ], [ true, %.preheader7 ]
...
161:                                              ; preds = %172, %160
  ...
  br i1 %162, label %.preheader5, label %174

.preheader5:                                      ; preds = %161, %171
  %163 = phi i1 [ false, %171 ], [ true, %161 ]
  br i1 %163, label %.preheader4, label %172

.preheader4:                                      ; preds = %.preheader5, %165
  %storemerge25 = phi i32 [ %170, %165 ], [ 0, %.preheader5 ]
...
175:                                              ; preds = %188, %174
  ...
  br i1 %176, label %.preheader3, label %189

.preheader3:                                      ; preds = %175, %186
  %storemerge22 = phi i32 [ %187, %186 ], [ 0, %175 ]
  %177 = icmp samesign ult i32 %storemerge22, 2
  br i1 %177, label %.preheader2, label %188

.preheader2:                                      ; preds = %.preheader3, %179
  %storemerge23 = phi i32 [ %185, %179 ], [ 0, %.preheader3 ]
...
190:                                              ; preds = %204, %189
  ...
  br i1 %191, label %.preheader1, label %206

.preheader1:                                      ; preds = %190, %202
  %storemerge20 = phi i32 [ %203, %202 ], [ 0, %190 ]
  %192 = icmp samesign ult i32 %storemerge20, 2
  br i1 %192, label %.preheader, label %204

.preheader:                                       ; preds = %.preheader1, %194
  %storemerge21 = phi i32 [ %201, %194 ], [ 0, %.preheader1 ]
