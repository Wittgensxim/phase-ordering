...
4:                                                ; preds = %.preheader29
  %5 = mul i64 %indvars.iv2, 64
  %6 = mul i64 %indvars.iv6, 8
...
16:                                               ; preds = %.preheader24
  %17 = mul i64 %indvars.iv22, 64
  %18 = mul i64 %indvars.iv26, 8
...
26:                                               ; preds = %.preheader22
  %27 = mul i64 %indvars.iv34, 64
  %28 = mul i64 %indvars.iv38, 8
...
36:                                               ; preds = %.preheader20
  %37 = mul i64 %indvars.iv46, 64
  %38 = mul i64 %indvars.iv50, 8
...
46:                                               ; preds = %.preheader18
  %47 = mul i64 %indvars.iv58, 64
  %48 = mul i64 %indvars.iv62, 8
...
56:                                               ; preds = %.preheader16
  %57 = mul i64 %indvars.iv70, 64
  %58 = mul i64 %indvars.iv74, 8
...
66:                                               ; preds = %.preheader14
  %67 = mul i64 %indvars.iv82, 64
  %68 = mul i64 %indvars.iv86, 8
...
76:                                               ; preds = %.preheader12
  %77 = mul i64 %indvars.iv94, 64
  %78 = mul i64 %indvars.iv98, 8
...
86:                                               ; preds = %.preheader10
  %87 = mul i64 %indvars.iv106, 64
  %88 = mul i64 %indvars.iv110, 8
...
96:                                               ; preds = %.preheader8
  %97 = mul i64 %indvars.iv118, 64
  %98 = mul i64 %indvars.iv122, 8
...
106:                                              ; preds = %.preheader6
  %107 = mul i64 %indvars.iv130, 64
  %108 = mul i64 %indvars.iv134, 8
...
116:                                              ; preds = %.preheader4
  %117 = mul i64 %indvars.iv142, 64
  %118 = mul i64 %indvars.iv146, 8
...
126:                                              ; preds = %.preheader2
  %127 = mul i64 %indvars.iv154, 64
  %128 = mul i64 %indvars.iv158, 8
...
136:                                              ; preds = %.preheader
  %137 = mul i64 %indvars.iv166, 64
  %138 = mul i64 %indvars.iv170, 8
