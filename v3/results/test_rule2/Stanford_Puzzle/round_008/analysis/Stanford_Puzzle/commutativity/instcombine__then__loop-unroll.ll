...
31:                                               ; preds = %.loopexit, %.preheader29.5.5
  ...
  %32 = shl nuw nsw i32 %storemerge47.lcssa1, 3
  %33 = or disjoint i32 384, %32
  %34 = or disjoint i32 %storemerge1.lcssa2, %33
...
.preheader29.1.5:                                 ; preds = %.preheader29.57
  %97 = or disjoint i32 %storemerge1.lcssa9, 112
...
.preheader29.2.5:                                 ; preds = %.preheader29.1.5
  %100 = or disjoint i32 %storemerge1.lcssa9, 176
...
.preheader29.3.5:                                 ; preds = %.preheader29.2.5
  %103 = or disjoint i32 %storemerge1.lcssa9, 240
...
.preheader29.4.5:                                 ; preds = %.preheader29.3.5
  %106 = or disjoint i32 %storemerge1.lcssa9, 304
...
.preheader29.5.5:                                 ; preds = %.preheader29.4.5
  %109 = or disjoint i32 %storemerge1.lcssa9, 368
...
135:                                              ; preds = %.loopexit15, %.preheader24.1.2
  ...
  %137 = or disjoint i32 %storemerge3.lcssa11, %136
...
.preheader24.1.2:                                 ; preds = %.preheader24.2
  %140 = or disjoint i32 %storemerge3.lcssa14, 16
...
147:                                              ; preds = %.loopexit28, %.preheader22.4.1
  ...
  %148 = or disjoint i32 %storemerge4.lcssa24, 256
...
.preheader22.1.1:                                 ; preds = %.preheader22.125
  %151 = zext nneg i32 %storemerge4.lcssa26 to i64
...
.preheader22.2.1:                                 ; preds = %.preheader22.1.1
  %153 = or disjoint i32 %storemerge4.lcssa26, 64
...
.preheader22.3.1:                                 ; preds = %.preheader22.2.1
  %156 = or disjoint i32 %storemerge4.lcssa26, 128
  %157 = zext nneg i32 %156 to i64
  %158 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 2048), i64 %157
  store i32 1, ptr %158, align 4
  br label %.preheader22.4.1

.preheader22.4.1:                                 ; preds = %.preheader22.3.1
  %159 = or disjoint i32 %storemerge4.lcssa26, 192
...
168:                                              ; preds = %.loopexit40, %.preheader20.2.4
  ...
  %169 = shl nuw nsw i32 %storemerge40.lcssa37, 3
  %170 = or disjoint i32 128, %169
  %171 = zext nneg i32 %170 to i64
  %172 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 4096), i64 %171
...
178:                                              ; preds = %.loopexit51, %.preheader18.1.4
  ...
  %179 = shl nuw nsw i32 %storemerge38.lcssa46, 3
  %180 = or disjoint i32 %storemerge6.lcssa47, %179
...
.preheader18.1.4:                                 ; preds = %.preheader18.4
  %183 = or disjoint i32 %storemerge6.lcssa50, 32
  %184 = zext nneg i32 %183 to i64
  %185 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 6144), i64 %184
...
192:                                              ; preds = %.loopexit64, %.preheader16.2.1
  ...
  %193 = or disjoint i32 %storemerge7.lcssa60, 128
...
.preheader16.1.1:                                 ; preds = %.preheader16.161
  %196 = zext nneg i32 %storemerge7.lcssa62 to i64
...
.preheader16.2.1:                                 ; preds = %.preheader16.1.1
  %198 = or disjoint i32 %storemerge7.lcssa62, 64
  %199 = zext nneg i32 %198 to i64
  %200 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 8192), i64 %199
...
209:                                              ; preds = %.loopexit74, %.preheader14.4.2
  ...
  %211 = or disjoint i32 256, %210
  %212 = zext nneg i32 %211 to i64
  %213 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 10240), i64 %212
...
219:                                              ; preds = %.loopexit86, %.preheader12.1.1
  ...
  %220 = zext nneg i32 %storemerge9.lcssa82 to i64
  %221 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 12288), i64 %220
  store i32 1, ptr %221, align 4
  unreachable

.preheader13.1:                                   ; preds = %.preheader12.1
  br i1 false, label %.preheader12.preheader.1, label %225
...
.preheader12.1.1:                                 ; preds = %.preheader12.183
  %222 = zext nneg i32 %storemerge9.lcssa84 to i64
  %223 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 12288), i64 %222
  store i32 1, ptr %223, align 4
  br i1 false, label %219, label %224

224:                                              ; preds = %.preheader12.1.1
  unreachable

225:                                              ; preds = %.preheader13.1
  br label %.preheader13.preheader.1

.preheader13.preheader.1:                         ; preds = %225
...
226:                                              ; preds = %.preheader13.1.1
  br label %.preheader13.preheader.2

.preheader13.preheader.2:                         ; preds = %226
...
227:                                              ; preds = %.preheader13.1.2
  br i1 false, label %.preheader13.preheader.3, label %229

.preheader13.preheader.3:                         ; preds = %227
...
.preheader11.preheader:                           ; preds = %230
...
231:                                              ; preds = %.loopexit93, %.preheader10.1.3
  %storemerge30.lcssa91 = phi i32 [ 3, %.preheader10.1.3 ], [ %storemerge30.lcssa91.ph, %.loopexit93 ]
  %232 = shl nuw nsw i32 %storemerge30.lcssa91, 3
  %233 = zext nneg i32 %232 to i64
  %234 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 14336), i64 %233
...
.preheader11.3:                                   ; preds = %.preheader10.1.2
  br i1 false, label %.preheader10.preheader.3, label %236
...
.preheader10.1.3:                                 ; preds = %.preheader10.3
  ...
  br i1 false, label %231, label %235

235:                                              ; preds = %.preheader10.1.3
  unreachable

236:                                              ; preds = %.preheader11.3
  br i1 false, label %.preheader11.preheader.1, label %238

.preheader11.preheader.1:                         ; preds = %236
...
.preheader9.preheader:                            ; preds = %239
  br label %.preheader9
...
241:                                              ; preds = %.preheader8.3.1
  unreachable

242:                                              ; preds = %.preheader9.1
  br i1 false, label %.preheader9.preheader.1, label %244

.preheader9.preheader.1:                          ; preds = %242
...
.preheader7.preheader:                            ; preds = %245
  br label %.preheader7
...
246:                                              ; preds = %.loopexit111, %.preheader6.1.2
  ...
  %247 = shl nuw nsw i32 %storemerge26.lcssa106, 3
  %248 = or disjoint i32 %storemerge12.lcssa107, %247
  %249 = zext nneg i32 %248 to i64
  %250 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 18432), i64 %249
...
.preheader7.2:                                    ; preds = %.preheader6.1.1
  br i1 false, label %.preheader6.preheader.2, label %255
...
.preheader6.1.2:                                  ; preds = %.preheader6.2
  %251 = or disjoint i32 %storemerge12.lcssa110, 16
  %252 = zext nneg i32 %251 to i64
  %253 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 18432), i64 %252
  store i32 1, ptr %253, align 4
  br i1 false, label %246, label %254

254:                                              ; preds = %.preheader6.1.2
  unreachable

255:                                              ; preds = %.preheader7.2
  br label %.preheader7.preheader.1

.preheader7.preheader.1:                          ; preds = %255
...
256:                                              ; preds = %.preheader7.2.1
  br i1 false, label %.preheader7.preheader.2, label %258

.preheader7.preheader.2:                          ; preds = %256
...
260:                                              ; preds = %.loopexit124, %.preheader4.2.1
  %storemerge13.lcssa120 = phi i32 [ %storemerge13.lcssa122, %.preheader4.2.1 ], [ %storemerge13.lcssa120.ph, %.loopexit124 ]
  %261 = or disjoint i32 %storemerge13.lcssa120, 128
  %262 = zext nneg i32 %261 to i64
  %263 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %262
  store i32 1, ptr %263, align 4
  unreachable

.preheader5.1:                                    ; preds = %.preheader4.2
  br i1 false, label %.preheader4.preheader.1, label %270
...
.preheader4.1.1:                                  ; preds = %.preheader4.1121
  %264 = zext nneg i32 %storemerge13.lcssa122 to i64
  %265 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %264
  store i32 1, ptr %265, align 4
  br label %.preheader4.2.1

.preheader4.2.1:                                  ; preds = %.preheader4.1.1
  %266 = or disjoint i32 %storemerge13.lcssa122, 64
  %267 = zext nneg i32 %266 to i64
  %268 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %267
  store i32 1, ptr %268, align 4
  br i1 false, label %260, label %269

269:                                              ; preds = %.preheader4.2.1
  unreachable

270:                                              ; preds = %.preheader5.1
  br label %.preheader5.preheader.1

.preheader5.preheader.1:                          ; preds = %270
...
271:                                              ; preds = %.preheader5.1.1
  br i1 false, label %.preheader5.preheader.2, label %273

.preheader5.preheader.2:                          ; preds = %271
...
.preheader3.preheader:                            ; preds = %274
  br label %.preheader3
...
275:                                              ; preds = %.loopexit134, %.preheader2.2.2
  %storemerge22.lcssa131 = phi i32 [ 2, %.preheader2.2.2 ], [ %storemerge22.lcssa131.ph, %.loopexit134 ]
  %276 = shl nuw nsw i32 %storemerge22.lcssa131, 3
  %277 = or disjoint i32 128, %276
  %278 = zext nneg i32 %277 to i64
  %279 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %278
...
.preheader3.2:                                    ; preds = %.preheader2.2.1
  br i1 false, label %.preheader2.preheader.2, label %281
...
280:                                              ; preds = %.preheader2.2.2
  unreachable

281:                                              ; preds = %.preheader3.2
  br i1 false, label %.preheader3.preheader.1, label %283

.preheader3.preheader.1:                          ; preds = %281
...
.preheader1.preheader:                            ; preds = %284
  br label %.preheader1
...
285:                                              ; preds = %.loopexit146, %.preheader.2.2
  ...
  %286 = shl nuw nsw i32 %storemerge20.lcssa140, 3
  %287 = or disjoint i32 128, %286
  %288 = or disjoint i32 %storemerge15.lcssa141, %287
  %289 = zext nneg i32 %288 to i64
  %290 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %289
...
.preheader1.2:                                    ; preds = %.preheader.2.1
  br i1 false, label %.preheader.preheader.2, label %298
...
.preheader.1.2:                                   ; preds = %.preheader.2143
  %291 = or disjoint i32 %storemerge15.lcssa145, 16
  %292 = zext nneg i32 %291 to i64
  %293 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %292
  store i32 1, ptr %293, align 4
  br label %.preheader.2.2

.preheader.2.2:                                   ; preds = %.preheader.1.2
  %294 = or disjoint i32 %storemerge15.lcssa145, 80
  %295 = zext nneg i32 %294 to i64
  %296 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %295
  store i32 1, ptr %296, align 4
  br i1 false, label %285, label %297

297:                                              ; preds = %.preheader.2.2
  unreachable

298:                                              ; preds = %.preheader1.2
  br label %.preheader1.preheader.1

.preheader1.preheader.1:                          ; preds = %298
...
299:                                              ; preds = %.preheader1.2.1
  br i1 false, label %.preheader1.preheader.2, label %301

.preheader1.preheader.2:                          ; preds = %299
...
313:                                              ; preds = %312, %310, %309
  %314 = load i32, ptr @n, align 4
  %315 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %314) #4
  %316 = load i32, ptr @kount, align 4
  %317 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %316) #4
  ret void
}
