...
16:                                               ; preds = %11, %6
  ...
  %.not.not = icmp slt i32 %storemerge2, %18
  br i1 %.not.not, label %6, label %._crit_edge3, !llvm.loop !7
...
15:                                               ; preds = %11, %6
  ...
  %.not.not = icmp slt i32 %storemerge3, %17
  br i1 %.not.not, label %6, label %._crit_edge, !llvm.loop !9
...
18:                                               ; preds = %._crit_edge, %2
  ...
  %exitcond.not4 = icmp sgt i32 %1, 511
...
15:                                               ; preds = %11, %6
  ...
  %17 = load i32, ptr %4, align 4
  %.not.not = icmp slt i32 %storemerge3, %17
  br i1 %.not.not, label %6, label %._crit_edge, !llvm.loop !11
...
18:                                               ; preds = %17, %11, %4
  ...
  %20 = icmp samesign ult i32 %storemerge2, 12
...
1:                                                ; preds = %0, %1
  ...
  %2 = zext nneg i32 %storemerge16 to i64
  %3 = getelementptr inbounds nuw [4 x i8], ptr @puzzl, i64 %2
  store i32 1, ptr %3, align 4
  %4 = add nuw nsw i32 %storemerge16, 1
  %5 = icmp samesign ult i32 %storemerge16, 511
...
.preheader29:                                     ; preds = %.preheader29.preheader, %.preheader29
  ...
  %12 = add nuw nsw i32 %storemerge4817, 1
  %13 = icmp samesign ult i32 %storemerge4817, 5
  br i1 %13, label %.preheader29, label %.preheader30, !llvm.loop !14

.preheader30:                                     ; preds = %.preheader29
  %14 = add nuw nsw i32 %storemerge4718, 1
  %15 = icmp samesign ult i32 %storemerge4718, 5
  br i1 %15, label %.preheader29.preheader, label %.preheader31, !llvm.loop !15

.preheader31:                                     ; preds = %.preheader30
  %16 = add nuw nsw i32 %storemerge119, 1
  %17 = icmp samesign ult i32 %storemerge119, 5
...
.preheader27:                                     ; preds = %.preheader27.preheader, %.preheader27
  ...
  %18 = zext nneg i32 %storemerge221 to i64
  %19 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %18
  %20 = zext nneg i32 %storemerge4620 to i64
  %21 = getelementptr inbounds nuw [4 x i8], ptr %19, i64 %20
  store i32 0, ptr %21, align 4
  %22 = add nuw nsw i32 %storemerge4620, 1
  %23 = icmp samesign ult i32 %storemerge4620, 511
  br i1 %23, label %.preheader27, label %.preheader28, !llvm.loop !17

.preheader28:                                     ; preds = %.preheader27
  %24 = add nuw nsw i32 %storemerge221, 1
  %25 = icmp samesign ult i32 %storemerge221, 12
...
.preheader25:                                     ; preds = %.preheader24
  %30 = add nuw nsw i32 %storemerge4423, 1
  %31 = icmp eq i32 %storemerge4423, 0
  br i1 %31, label %.preheader24.preheader, label %.preheader26, !llvm.loop !20

.preheader26:                                     ; preds = %.preheader25
  %32 = add nuw nsw i32 %storemerge324, 1
  %33 = icmp samesign ult i32 %storemerge324, 3
...
.preheader22:                                     ; preds = %.preheader22.preheader, %.preheader22
  ...
  %39 = add nuw nsw i32 %storemerge4325, 1
  %40 = icmp samesign ult i32 %storemerge4325, 3
...
41:                                               ; preds = %.preheader23
  %42 = add nuw nsw i32 %storemerge427, 1
  %43 = icmp eq i32 %storemerge427, 0
...
.preheader20:                                     ; preds = %.preheader20.preheader, %.preheader20
  ...
  %50 = add nuw nsw i32 %storemerge4128, 1
  %51 = icmp eq i32 %storemerge4128, 0
  br i1 %51, label %.preheader20, label %.preheader21, !llvm.loop !25

.preheader21:                                     ; preds = %.preheader20
  %52 = add nuw nsw i32 %storemerge4029, 1
  %53 = icmp samesign ult i32 %storemerge4029, 3
...
.preheader19:                                     ; preds = %.preheader18
  %60 = add nuw nsw i32 %storemerge3832, 1
  %61 = icmp samesign ult i32 %storemerge3832, 3
  br i1 %61, label %.preheader18.preheader, label %62, !llvm.loop !29

62:                                               ; preds = %.preheader19
  %63 = add nuw nsw i32 %storemerge633, 1
  %64 = icmp eq i32 %storemerge633, 0
...
.preheader16:                                     ; preds = %.preheader16.preheader, %.preheader16
  ...
  %70 = add nuw nsw i32 %storemerge3734, 1
  %71 = icmp eq i32 %storemerge3734, 0
...
72:                                               ; preds = %.preheader17
  %73 = add nuw nsw i32 %storemerge736, 1
  %74 = icmp samesign ult i32 %storemerge736, 3
...
.preheader14:                                     ; preds = %.preheader14.preheader, %.preheader14
  ...
  %81 = add nuw nsw i32 %storemerge3537, 1
  %82 = icmp samesign ult i32 %storemerge3537, 3
  br i1 %82, label %.preheader14, label %.preheader15, !llvm.loop !34

.preheader15:                                     ; preds = %.preheader14
  %83 = add nuw nsw i32 %storemerge3438, 1
  %84 = icmp eq i32 %storemerge3438, 0
...
.preheader12:                                     ; preds = %.preheader12.preheader, %.preheader12
  %87 = zext nneg i32 %storemerge942 to i64
...
89:                                               ; preds = %.preheader13
  %90 = add nuw nsw i32 %storemerge942, 1
  %91 = icmp samesign ult i32 %storemerge942, 2
...
.preheader11:                                     ; preds = %.preheader10
  %96 = add nuw nsw i32 %storemerge3044, 1
  %97 = icmp samesign ult i32 %storemerge3044, 2
...
.preheader8:                                      ; preds = %.preheader8.preheader, %.preheader8
  ...
  %103 = add nuw nsw i32 %storemerge2946, 1
  %104 = icmp samesign ult i32 %storemerge2946, 2
...
.preheader7:                                      ; preds = %.preheader6
  %111 = add nuw nsw i32 %storemerge2650, 1
  %112 = icmp eq i32 %storemerge2650, 0
  br i1 %112, label %.preheader6.preheader, label %113, !llvm.loop !47

113:                                              ; preds = %.preheader7
  %114 = add nuw nsw i32 %storemerge1251, 1
  %115 = icmp eq i32 %storemerge1251, 0
...
.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  ...
  %121 = add nuw nsw i32 %storemerge2552, 1
  %122 = icmp eq i32 %storemerge2552, 0
...
123:                                              ; preds = %.preheader5
  %124 = add nuw nsw i32 %storemerge1354, 1
  %125 = icmp eq i32 %storemerge1354, 0
...
.preheader2:                                      ; preds = %.preheader2.preheader, %.preheader2
  ...
  %132 = add nuw nsw i32 %storemerge2355, 1
  %133 = icmp eq i32 %storemerge2355, 0
  br i1 %133, label %.preheader2, label %.preheader3, !llvm.loop !52

.preheader3:                                      ; preds = %.preheader2
  %134 = add nuw nsw i32 %storemerge2256, 1
  %135 = icmp eq i32 %storemerge2256, 0
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %144 = add nuw nsw i32 %storemerge2158, 1
  %145 = icmp eq i32 %storemerge2158, 0
  br i1 %145, label %.preheader, label %.preheader1, !llvm.loop !55

.preheader1:                                      ; preds = %.preheader
  %146 = add nuw nsw i32 %storemerge2059, 1
  %147 = icmp eq i32 %storemerge2059, 0
  br i1 %147, label %.preheader.preheader, label %148, !llvm.loop !56

148:                                              ; preds = %.preheader1
  %149 = add nuw nsw i32 %storemerge1560, 1
  %150 = icmp eq i32 %storemerge1560, 0
...
1:                                                ; preds = %0, %1
  ...
  %3 = icmp samesign ult i32 %storemerge1, 99
