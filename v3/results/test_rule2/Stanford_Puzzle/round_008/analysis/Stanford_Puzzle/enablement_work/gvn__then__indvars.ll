...
6:                                                ; preds = %5
  ...
  %8 = getelementptr inbounds [4 x i8], ptr %7, i64 %indvars.iv
...
5:                                                ; preds = %13, %2
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %13 ], [ 0, %2 ]
  %exitcond = icmp eq i64 %indvars.iv3, %wide.trip.count7
  br i1 %exitcond, label %14, label %6

6:                                                ; preds = %5
  %7 = getelementptr inbounds [2048 x i8], ptr @p, i64 %.phi.trans.insert
  %8 = getelementptr inbounds [4 x i8], ptr %7, i64 %indvars.iv3
  %9 = load i32, ptr %8, align 4
  %.not4 = icmp eq i32 %9, 0
  br i1 %.not4, label %13, label %10

10:                                               ; preds = %6
  %11 = add nsw i64 %3, %indvars.iv3
  %12 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %11
...
22:                                               ; preds = %28, %14
  %indvars.iv = phi i64 [ %indvars.iv.next, %28 ], [ %21, %14 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit.loopexit, label %23

23:                                               ; preds = %22
  %24 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv
  %25 = load i32, ptr %24, align 4
  %.not3 = icmp eq i32 %25, 0
  br i1 %.not3, label %26, label %28

26:                                               ; preds = %23
  %indvars.iv.lcssa2 = phi i64 [ %indvars.iv, %23 ]
  %27 = trunc nsw i64 %indvars.iv.lcssa2 to i32
  br label %.loopexit
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %26
  %storemerge2 = phi i32 [ %27, %26 ], [ 0, %.loopexit.loopexit ]
  ret i32 %storemerge2
}
