...
31:                                               ; preds = %.loopexit, %.preheader29.5.5
  ...
  %32 = mul i32 %storemerge47.lcssa1, 8
  %33 = add i32 %storemerge1.lcssa2, 384
  %34 = add i32 %33, %32
...
135:                                              ; preds = %.loopexit15, %.preheader24.1.2
  ...
  %136 = mul i32 %storemerge44.lcssa10, 8
  %137 = add i32 %storemerge3.lcssa11, 64
  %138 = add i32 %137, %136
...
148:                                              ; preds = %.loopexit29, %.preheader22.4.1
  ...
  %149 = mul i32 %storemerge42.lcssa24, 8
  %150 = add i32 %storemerge4.lcssa25, 256
  %151 = add i32 %150, %149
...
172:                                              ; preds = %.loopexit44, %.preheader20.2.4
  ...
  %173 = mul i32 %storemerge40.lcssa38, 8
  %174 = add i32 %storemerge5.lcssa39, 128
  %175 = add i32 %174, %173
...
189:                                              ; preds = %.loopexit55, %.preheader18.1.4
  ...
  %190 = mul i32 %storemerge38.lcssa50, 8
  %191 = add i32 %storemerge6.lcssa51, 64
  %192 = add i32 %191, %190
...
204:                                              ; preds = %.loopexit69, %.preheader16.2.1
  ...
  %205 = mul i32 %storemerge36.lcssa64, 8
  %206 = add i32 %storemerge7.lcssa65, 128
  %207 = add i32 %206, %205
...
224:                                              ; preds = %.loopexit82, %.preheader14.4.2
  ...
  %225 = mul i32 %storemerge34.lcssa76, 8
  %226 = add i32 %storemerge8.lcssa77, 256
  %227 = add i32 %226, %225
...
247:                                              ; preds = %.loopexit95, %.preheader12.1.1
  ...
  %248 = mul i32 %storemerge32.lcssa90, 8
  %249 = add i32 %storemerge9.lcssa91, 64
  %250 = add i32 %249, %248
...
263:                                              ; preds = %.loopexit105, %.preheader10.1.3
  ...
  %264 = mul i32 %storemerge30.lcssa100, 8
  %265 = add i32 %storemerge10.lcssa101, 64
  %266 = add i32 %265, %264
...
277:                                              ; preds = %.loopexit115, %.preheader8.3.1
  ...
  %278 = mul i32 %storemerge28.lcssa110, 8
  %279 = add i32 %storemerge11.lcssa111, 192
  %280 = add i32 %279, %278
...
297:                                              ; preds = %.loopexit127, %.preheader6.1.2
  ...
  %298 = mul i32 %storemerge26.lcssa122, 8
  %299 = add i32 %storemerge12.lcssa123, 64
  %300 = add i32 %299, %298
...
312:                                              ; preds = %.loopexit141, %.preheader4.2.1
  ...
  %313 = mul i32 %storemerge24.lcssa136, 8
  %314 = add i32 %storemerge13.lcssa137, 128
  %315 = add i32 %314, %313
...
330:                                              ; preds = %.loopexit154, %.preheader2.2.2
  ...
  %331 = mul i32 %storemerge22.lcssa148, 8
  %332 = add i32 %storemerge14.lcssa149, 128
  %333 = add i32 %332, %331
...
347:                                              ; preds = %.loopexit166, %.preheader.2.2
  ...
  %348 = mul i32 %storemerge20.lcssa160, 8
  %349 = add i32 %storemerge15.lcssa161, 128
  %350 = add i32 %349, %348
