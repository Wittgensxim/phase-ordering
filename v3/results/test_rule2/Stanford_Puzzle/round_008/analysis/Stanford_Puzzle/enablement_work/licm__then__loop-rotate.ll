...
1:                                                ; preds = %0, %1
  %storemerge49 = phi i32 [ 0, %0 ], [ %4, %1 ]
  %2 = sext i32 %storemerge49 to i64
  %3 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %2
  store i32 1, ptr %3, align 4
  %4 = add nsw i32 %storemerge49, 1
...
.preheader30.preheader:                           ; preds = %.preheader31.preheader, %.preheader31
  %storemerge152 = phi i32 [ 1, %.preheader31.preheader ], [ %14, %.preheader31 ]
...
.preheader27.preheader:                           ; preds = %.preheader28.preheader, %.preheader28
  %storemerge254 = phi i32 [ 0, %.preheader28.preheader ], [ %22, %.preheader28 ]
  %16 = sext i32 %storemerge254 to i64
...
.preheader25.preheader:                           ; preds = %.preheader26.preheader, %.preheader26
  %storemerge357 = phi i32 [ 0, %.preheader26.preheader ], [ %32, %.preheader26 ]
  br label %.preheader24.preheader

.preheader24.preheader:                           ; preds = %.preheader25.preheader, %.preheader25
  %storemerge4456 = phi i32 [ 0, %.preheader25.preheader ], [ %30, %.preheader25 ]
  %24 = shl i32 %storemerge4456, 3
  %invariant.op1 = add i32 %24, %storemerge357
  br label %.preheader24

.preheader24:                                     ; preds = %.preheader24.preheader, %.preheader24
  %storemerge4555 = phi i32 [ 0, %.preheader24.preheader ], [ %28, %.preheader24 ]
  %25 = shl i32 %storemerge4555, 6
  %.reass2 = add i32 %25, %invariant.op1
  %26 = sext i32 %.reass2 to i64
  %27 = getelementptr inbounds [4 x i8], ptr @p, i64 %26
  store i32 1, ptr %27, align 4
  %28 = add nsw i32 %storemerge4555, 1
  %29 = icmp slt i32 %28, 1
  br i1 %29, label %.preheader24, label %.preheader25, !llvm.loop !19

.preheader25:                                     ; preds = %.preheader24
  %30 = add nsw i32 %storemerge4456, 1
  %31 = icmp slt i32 %30, 2
  br i1 %31, label %.preheader24.preheader, label %.preheader26, !llvm.loop !20

.preheader26:                                     ; preds = %.preheader25
  %32 = add nsw i32 %storemerge357, 1
...
.preheader9.preheader:                            ; preds = %118, %127
  %storemerge1181 = phi i32 [ 0, %118 ], [ %128, %127 ]
  br label %.preheader8.preheader

.preheader8.preheader:                            ; preds = %.preheader9.preheader, %.preheader9
  %storemerge2880 = phi i32 [ 0, %.preheader9.preheader ], [ %125, %.preheader9 ]
  %119 = shl i32 %storemerge2880, 3
  %invariant.op17 = add i32 %119, %storemerge1181
  br label %.preheader8

.preheader8:                                      ; preds = %.preheader8.preheader, %.preheader8
  %storemerge2979 = phi i32 [ 0, %.preheader8.preheader ], [ %123, %.preheader8 ]
  %120 = shl i32 %storemerge2979, 6
  %.reass18 = add i32 %120, %invariant.op17
  %121 = sext i32 %.reass18 to i64
  %122 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 16384), i64 %121
  store i32 1, ptr %122, align 4
  %123 = add nsw i32 %storemerge2979, 1
  %124 = icmp slt i32 %123, 3
  br i1 %124, label %.preheader8, label %.preheader9, !llvm.loop !43

.preheader9:                                      ; preds = %.preheader8
  %125 = add nsw i32 %storemerge2880, 1
  %126 = icmp slt i32 %125, 1
  br i1 %126, label %.preheader8.preheader, label %127, !llvm.loop !44

127:                                              ; preds = %.preheader9
  %128 = add nsw i32 %storemerge1181, 1
...
.preheader5.preheader:                            ; preds = %142, %151
  %storemerge1387 = phi i32 [ 0, %142 ], [ %152, %151 ]
  br label %.preheader4.preheader

.preheader4.preheader:                            ; preds = %.preheader5.preheader, %.preheader5
  %storemerge2486 = phi i32 [ 0, %.preheader5.preheader ], [ %149, %.preheader5 ]
  %143 = shl i32 %storemerge2486, 3
  %invariant.op21 = add i32 %143, %storemerge1387
  br label %.preheader4

.preheader4:                                      ; preds = %.preheader4.preheader, %.preheader4
  %storemerge2585 = phi i32 [ 0, %.preheader4.preheader ], [ %147, %.preheader4 ]
  %144 = shl i32 %storemerge2585, 6
  %.reass22 = add i32 %144, %invariant.op21
  %145 = sext i32 %.reass22 to i64
  %146 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %145
  store i32 1, ptr %146, align 4
  %147 = add nsw i32 %storemerge2585, 1
  %148 = icmp slt i32 %147, 2
  br i1 %148, label %.preheader4, label %.preheader5, !llvm.loop !49

.preheader5:                                      ; preds = %.preheader4
  %149 = add nsw i32 %storemerge2486, 1
  %150 = icmp slt i32 %149, 1
  br i1 %150, label %.preheader4.preheader, label %151, !llvm.loop !50

151:                                              ; preds = %.preheader5
  %152 = add nsw i32 %storemerge1387, 1
...
.preheader1.preheader:                            ; preds = %166, %175
  %storemerge1593 = phi i32 [ 0, %166 ], [ %176, %175 ]
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader1.preheader, %.preheader1
  %storemerge2092 = phi i32 [ 0, %.preheader1.preheader ], [ %173, %.preheader1 ]
  %167 = shl i32 %storemerge2092, 3
  %invariant.op25 = add i32 %167, %storemerge1593
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %storemerge2191 = phi i32 [ 0, %.preheader.preheader ], [ %171, %.preheader ]
  %168 = shl i32 %storemerge2191, 6
  %.reass26 = add i32 %168, %invariant.op25
  %169 = sext i32 %.reass26 to i64
  %170 = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %169
  store i32 1, ptr %170, align 4
  %171 = add nsw i32 %storemerge2191, 1
  %172 = icmp slt i32 %171, 2
  br i1 %172, label %.preheader, label %.preheader1, !llvm.loop !55

.preheader1:                                      ; preds = %.preheader
  %173 = add nsw i32 %storemerge2092, 1
  %174 = icmp slt i32 %173, 2
  br i1 %174, label %.preheader.preheader, label %175, !llvm.loop !56

175:                                              ; preds = %.preheader1
  %176 = add nsw i32 %storemerge1593, 1
