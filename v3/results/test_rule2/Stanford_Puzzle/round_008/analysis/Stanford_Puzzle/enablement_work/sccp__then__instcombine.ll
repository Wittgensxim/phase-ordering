...
.preheader24:                                     ; preds = %35, %.preheader24.preheader
  %34 = phi i1 [ false, %35 ], [ true, %.preheader24.preheader ]
  br i1 %34, label %35, label %40

35:                                               ; preds = %.preheader24
  %36 = shl nuw nsw i32 %storemerge44, 3
  %37 = or disjoint i32 %storemerge3, %36
  %38 = zext nneg i32 %37 to i64
  %39 = getelementptr inbounds nuw [4 x i8], ptr @p, i64 %38
...
45:                                               ; preds = %56, %44
  ...
  %46 = icmp samesign ult i32 %storemerge4, 2
...
.preheader23:                                     ; preds = %55, %.preheader23.preheader
  %47 = phi i1 [ false, %55 ], [ true, %.preheader23.preheader ]
...
.preheader22:                                     ; preds = %49, %.preheader22.preheader
  ...
  %48 = icmp samesign ult i32 %storemerge43, 4
  br i1 %48, label %49, label %55

49:                                               ; preds = %.preheader22
  %50 = shl nuw nsw i32 %storemerge43, 6
  %51 = or disjoint i32 %storemerge4, %50
  %52 = zext nneg i32 %51 to i64
  %53 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 2048), i64 %52
  store i32 1, ptr %53, align 4
  %54 = add nuw nsw i32 %storemerge43, 1
...
.preheader21:                                     ; preds = %70, %.preheader21.preheader
  ...
  %61 = icmp samesign ult i32 %storemerge40, 4
...
.preheader20:                                     ; preds = %63, %.preheader20.preheader
  ...
  %62 = icmp samesign ult i32 %storemerge41, 2
  br i1 %62, label %63, label %70

63:                                               ; preds = %.preheader20
  %64 = shl nuw nsw i32 %storemerge41, 6
  %65 = shl nuw nsw i32 %storemerge40, 3
  %66 = or disjoint i32 %64, %65
  %67 = zext nneg i32 %66 to i64
  %68 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 4096), i64 %67
  store i32 1, ptr %68, align 4
  %69 = add nuw nsw i32 %storemerge41, 1
  br label %.preheader20, !llvm.loop !25

70:                                               ; preds = %.preheader20
  %71 = add nuw nsw i32 %storemerge40, 1
...
74:                                               ; preds = %85, %73
  ...
  %75 = icmp samesign ult i32 %storemerge6, 2
...
.preheader19:                                     ; preds = %83, %.preheader19.preheader
  ...
  %76 = icmp samesign ult i32 %storemerge38, 4
...
.preheader18:                                     ; preds = %78, %.preheader18.preheader
  %77 = phi i1 [ false, %78 ], [ true, %.preheader18.preheader ]
  br i1 %77, label %78, label %83

78:                                               ; preds = %.preheader18
  %79 = shl nuw nsw i32 %storemerge38, 3
  %80 = or disjoint i32 %storemerge6, %79
  %81 = zext nneg i32 %80 to i64
  %82 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 6144), i64 %81
  store i32 1, ptr %82, align 4
  br label %.preheader18, !llvm.loop !28

83:                                               ; preds = %.preheader18
  %84 = add nuw nsw i32 %storemerge38, 1
...
88:                                               ; preds = %99, %87
  ...
  %89 = icmp samesign ult i32 %storemerge7, 4
...
.preheader17:                                     ; preds = %98, %.preheader17.preheader
  %90 = phi i1 [ false, %98 ], [ true, %.preheader17.preheader ]
...
.preheader16:                                     ; preds = %92, %.preheader16.preheader
  ...
  %91 = icmp samesign ult i32 %storemerge37, 2
  br i1 %91, label %92, label %98

92:                                               ; preds = %.preheader16
  %93 = shl nuw nsw i32 %storemerge37, 6
  %94 = or disjoint i32 %storemerge7, %93
  %95 = zext nneg i32 %94 to i64
  %96 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 8192), i64 %95
...
99:                                               ; preds = %.preheader17
  %100 = add nuw nsw i32 %storemerge7, 1
...
.preheader15:                                     ; preds = %113, %.preheader15.preheader
  ...
  %104 = icmp samesign ult i32 %storemerge34, 2
...
.preheader14:                                     ; preds = %106, %.preheader14.preheader
  ...
  %105 = icmp samesign ult i32 %storemerge35, 4
  br i1 %105, label %106, label %113

106:                                              ; preds = %.preheader14
  %107 = shl nuw nsw i32 %storemerge35, 6
  %108 = shl nuw nsw i32 %storemerge34, 3
  %109 = or disjoint i32 %107, %108
  %110 = zext nneg i32 %109 to i64
  %111 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 10240), i64 %110
  store i32 1, ptr %111, align 4
  %112 = add nuw nsw i32 %storemerge35, 1
...
117:                                              ; preds = %125, %116
  ...
  %118 = icmp samesign ult i32 %storemerge9, 3
...
.preheader13:                                     ; preds = %124, %.preheader13.preheader
  %119 = phi i1 [ false, %124 ], [ true, %.preheader13.preheader ]
...
.preheader12:                                     ; preds = %121, %.preheader12.preheader
  %120 = phi i1 [ false, %121 ], [ true, %.preheader12.preheader ]
  br i1 %120, label %121, label %124

121:                                              ; preds = %.preheader12
  %122 = zext nneg i32 %storemerge9 to i64
...
125:                                              ; preds = %.preheader13
  %126 = add nuw nsw i32 %storemerge9, 1
...
.preheader11:                                     ; preds = %136, %.preheader11.preheader
  ...
  %130 = icmp samesign ult i32 %storemerge30, 3
...
.preheader10:                                     ; preds = %132, %.preheader10.preheader
  %131 = phi i1 [ false, %132 ], [ true, %.preheader10.preheader ]
  br i1 %131, label %132, label %136

132:                                              ; preds = %.preheader10
  %133 = shl nuw nsw i32 %storemerge30, 3
...
136:                                              ; preds = %.preheader10
  %137 = add nuw nsw i32 %storemerge30, 1
...
.preheader9:                                      ; preds = %149, %.preheader9.preheader
  %142 = phi i1 [ false, %149 ], [ true, %.preheader9.preheader ]
...
.preheader8:                                      ; preds = %144, %.preheader8.preheader
  ...
  %143 = icmp samesign ult i32 %storemerge29, 3
  br i1 %143, label %144, label %149

144:                                              ; preds = %.preheader8
  %145 = shl nuw nsw i32 %storemerge29, 6
  %146 = zext nneg i32 %145 to i64
  %147 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 16384), i64 %146
  store i32 1, ptr %147, align 4
  %148 = add nuw nsw i32 %storemerge29, 1
...
152:                                              ; preds = %163, %151
  ...
  %153 = icmp samesign ult i32 %storemerge12, 2
...
.preheader7:                                      ; preds = %161, %.preheader7.preheader
  ...
  %154 = icmp samesign ult i32 %storemerge26, 2
...
.preheader6:                                      ; preds = %156, %.preheader6.preheader
  %155 = phi i1 [ false, %156 ], [ true, %.preheader6.preheader ]
  br i1 %155, label %156, label %161

156:                                              ; preds = %.preheader6
  %157 = shl nuw nsw i32 %storemerge26, 3
  %158 = or disjoint i32 %storemerge12, %157
  %159 = zext nneg i32 %158 to i64
  %160 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 18432), i64 %159
...
166:                                              ; preds = %177, %165
  ...
  %167 = icmp samesign ult i32 %storemerge13, 2
...
.preheader5:                                      ; preds = %176, %.preheader5.preheader
  %168 = phi i1 [ false, %176 ], [ true, %.preheader5.preheader ]
...
.preheader4:                                      ; preds = %170, %.preheader4.preheader
  ...
  %169 = icmp samesign ult i32 %storemerge25, 2
  br i1 %169, label %170, label %176

170:                                              ; preds = %.preheader4
  %171 = shl nuw nsw i32 %storemerge25, 6
  %172 = or disjoint i32 %storemerge13, %171
  %173 = zext nneg i32 %172 to i64
  %174 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %173
...
.preheader3:                                      ; preds = %191, %.preheader3.preheader
  ...
  %182 = icmp samesign ult i32 %storemerge22, 2
...
.preheader2:                                      ; preds = %184, %.preheader2.preheader
  ...
  %183 = icmp samesign ult i32 %storemerge23, 2
...
184:                                              ; preds = %.preheader2
  ...
  %189 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %188
...
195:                                              ; preds = %209, %194
  ...
  %196 = icmp samesign ult i32 %storemerge15, 2
...
.preheader1:                                      ; preds = %207, %.preheader1.preheader
  ...
  %197 = icmp samesign ult i32 %storemerge20, 2
...
.preheader:                                       ; preds = %199, %.preheader.preheader
  ...
  %198 = icmp samesign ult i32 %storemerge21, 2
...
199:                                              ; preds = %.preheader
  ...
  %203 = or disjoint i32 %storemerge15, %202
  %204 = zext nneg i32 %203 to i64
  %205 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %204
