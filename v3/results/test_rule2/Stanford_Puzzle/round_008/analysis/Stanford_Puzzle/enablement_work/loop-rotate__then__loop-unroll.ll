...
.preheader30.preheader:                           ; preds = %.preheader31.preheader, %.preheader29.4
  %storemerge119 = phi i32 [ 1, %.preheader31.preheader ], [ %90, %.preheader29.4 ]
...
.preheader27.preheader:                           ; preds = %.preheader28.preheader, %.preheader28
  %storemerge221 = phi i32 [ 0, %.preheader28.preheader ], [ %113, %.preheader28 ]
...
.preheader27:                                     ; preds = %.preheader27, %.preheader27.preheader
  %storemerge4620 = phi i32 [ 0, %.preheader27.preheader ], [ %111, %.preheader27 ]
  %92 = sext i32 %storemerge221 to i64
  %93 = getelementptr inbounds [2048 x i8], ptr @p, i64 %92
  %94 = sext i32 %storemerge4620 to i64
  %95 = getelementptr inbounds [4 x i8], ptr %93, i64 %94
  store i32 0, ptr %95, align 4
  %96 = add nuw nsw i32 %storemerge4620, 1
  %97 = sext i32 %storemerge221 to i64
  %98 = getelementptr inbounds [2048 x i8], ptr @p, i64 %97
  %99 = sext i32 %96 to i64
  %100 = getelementptr inbounds [4 x i8], ptr %98, i64 %99
  store i32 0, ptr %100, align 4
  %101 = add nuw nsw i32 %storemerge4620, 2
  %102 = sext i32 %storemerge221 to i64
  %103 = getelementptr inbounds [2048 x i8], ptr @p, i64 %102
  %104 = sext i32 %101 to i64
  %105 = getelementptr inbounds [4 x i8], ptr %103, i64 %104
  store i32 0, ptr %105, align 4
  %106 = add nuw nsw i32 %storemerge4620, 3
  %107 = sext i32 %storemerge221 to i64
  %108 = getelementptr inbounds [2048 x i8], ptr @p, i64 %107
  %109 = sext i32 %106 to i64
  %110 = getelementptr inbounds [4 x i8], ptr %108, i64 %109
  store i32 0, ptr %110, align 4
  %111 = add nuw nsw i32 %storemerge4620, 4
  %112 = icmp samesign ult i32 %111, 512
  br i1 %112, label %.preheader27, label %.preheader28, !llvm.loop !15

.preheader28:                                     ; preds = %.preheader27
  %113 = add nsw i32 %storemerge221, 1
...
.preheader24.preheader.1:                         ; preds = %.preheader24.1
  br label %.preheader24.161

.preheader24.161:                                 ; preds = %.preheader24.preheader.1
  store i32 1, ptr getelementptr inbounds nuw (i8, ptr @p, i64 4), align 4
  br label %.preheader24.1.1

.preheader24.1.1:                                 ; preds = %.preheader24.161
...
.preheader18.preheader.1:                         ; preds = %.preheader18.3
  br label %.preheader18.162

.preheader18.162:                                 ; preds = %.preheader18.preheader.1
  store i32 1, ptr getelementptr inbounds nuw (i8, ptr @p, i64 6148), align 4
  br label %.preheader18.1.1

.preheader18.1.1:                                 ; preds = %.preheader18.162
...
.preheader6.preheader.1:                          ; preds = %.preheader6.1
  br label %.preheader6.163

.preheader6.163:                                  ; preds = %.preheader6.preheader.1
  store i32 1, ptr getelementptr inbounds nuw (i8, ptr @p, i64 18436), align 4
  br label %.preheader6.1.1

.preheader6.1.1:                                  ; preds = %.preheader6.163
...
.preheader.preheader.1:                           ; preds = %.preheader.1
  br label %.preheader.164

.preheader.164:                                   ; preds = %.preheader.preheader.1
...
.preheader.1.1:                                   ; preds = %.preheader.164
