...
.preheader27:                                     ; preds = %26, %.preheader27.preheader
  ...
  %25 = icmp slt i32 %storemerge46, 512
...
.preheader24.preheader:                           ; preds = %.preheader25
  %34 = mul i32 %storemerge44, 8
  %35 = add i32 %34, %storemerge3
  br label %.preheader24

.preheader24:                                     ; preds = %37, %.preheader24.preheader
  %storemerge45 = phi i32 [ %42, %37 ], [ 0, %.preheader24.preheader ]
  %36 = icmp slt i32 %storemerge45, 1
  br i1 %36, label %37, label %43

37:                                               ; preds = %.preheader24
  %38 = mul i32 %storemerge45, 64
  %39 = add i32 %35, %38
...
.preheader22.preheader:                           ; preds = %.preheader23
  %51 = mul i32 %storemerge42, 8
  %52 = add i32 %51, %storemerge4
  br label %.preheader22

.preheader22:                                     ; preds = %54, %.preheader22.preheader
  %storemerge43 = phi i32 [ %59, %54 ], [ 0, %.preheader22.preheader ]
  %53 = icmp slt i32 %storemerge43, 4
  br i1 %53, label %54, label %60

54:                                               ; preds = %.preheader22
  %55 = mul i32 %storemerge43, 64
  %56 = add i32 %52, %55
...
.preheader20.preheader:                           ; preds = %.preheader21
  %68 = mul i32 %storemerge40, 8
  %69 = add i32 %68, %storemerge5
  br label %.preheader20

.preheader20:                                     ; preds = %71, %.preheader20.preheader
  %storemerge41 = phi i32 [ %76, %71 ], [ 0, %.preheader20.preheader ]
  %70 = icmp slt i32 %storemerge41, 2
  br i1 %70, label %71, label %77

71:                                               ; preds = %.preheader20
  %72 = mul i32 %storemerge41, 64
  %73 = add i32 %69, %72
...
.preheader18.preheader:                           ; preds = %.preheader19
  %85 = mul i32 %storemerge38, 8
  %86 = add i32 %85, %storemerge6
  br label %.preheader18

.preheader18:                                     ; preds = %88, %.preheader18.preheader
  %storemerge39 = phi i32 [ %93, %88 ], [ 0, %.preheader18.preheader ]
  %87 = icmp slt i32 %storemerge39, 1
  br i1 %87, label %88, label %94

88:                                               ; preds = %.preheader18
  %89 = mul i32 %storemerge39, 64
  %90 = add i32 %86, %89
...
.preheader16.preheader:                           ; preds = %.preheader17
  %102 = mul i32 %storemerge36, 8
  %103 = add i32 %102, %storemerge7
  br label %.preheader16

.preheader16:                                     ; preds = %105, %.preheader16.preheader
  %storemerge37 = phi i32 [ %110, %105 ], [ 0, %.preheader16.preheader ]
  %104 = icmp slt i32 %storemerge37, 2
  br i1 %104, label %105, label %111

105:                                              ; preds = %.preheader16
  %106 = mul i32 %storemerge37, 64
  %107 = add i32 %103, %106
...
.preheader14.preheader:                           ; preds = %.preheader15
  %119 = mul i32 %storemerge34, 8
  %120 = add i32 %119, %storemerge8
  br label %.preheader14

.preheader14:                                     ; preds = %122, %.preheader14.preheader
  %storemerge35 = phi i32 [ %127, %122 ], [ 0, %.preheader14.preheader ]
  %121 = icmp slt i32 %storemerge35, 4
  br i1 %121, label %122, label %128

122:                                              ; preds = %.preheader14
  %123 = mul i32 %storemerge35, 64
  %124 = add i32 %120, %123
...
.preheader12.preheader:                           ; preds = %.preheader13
  %136 = mul i32 %storemerge32, 8
  %137 = add i32 %136, %storemerge9
  br label %.preheader12

.preheader12:                                     ; preds = %139, %.preheader12.preheader
  %storemerge33 = phi i32 [ %144, %139 ], [ 0, %.preheader12.preheader ]
  %138 = icmp slt i32 %storemerge33, 1
  br i1 %138, label %139, label %145

139:                                              ; preds = %.preheader12
  %140 = mul i32 %storemerge33, 64
  %141 = add i32 %137, %140
...
.preheader10.preheader:                           ; preds = %.preheader11
  %153 = mul i32 %storemerge30, 8
  %154 = add i32 %153, %storemerge10
  br label %.preheader10

.preheader10:                                     ; preds = %156, %.preheader10.preheader
  %storemerge31 = phi i32 [ %161, %156 ], [ 0, %.preheader10.preheader ]
  %155 = icmp slt i32 %storemerge31, 1
  br i1 %155, label %156, label %162

156:                                              ; preds = %.preheader10
  %157 = mul i32 %storemerge31, 64
  %158 = add i32 %154, %157
...
.preheader8.preheader:                            ; preds = %.preheader9
  %170 = mul i32 %storemerge28, 8
  %171 = add i32 %170, %storemerge11
  br label %.preheader8

.preheader8:                                      ; preds = %173, %.preheader8.preheader
  %storemerge29 = phi i32 [ %178, %173 ], [ 0, %.preheader8.preheader ]
  %172 = icmp slt i32 %storemerge29, 3
  br i1 %172, label %173, label %179

173:                                              ; preds = %.preheader8
  %174 = mul i32 %storemerge29, 64
  %175 = add i32 %171, %174
...
.preheader6.preheader:                            ; preds = %.preheader7
  %187 = mul i32 %storemerge26, 8
  %188 = add i32 %187, %storemerge12
  br label %.preheader6

.preheader6:                                      ; preds = %190, %.preheader6.preheader
  %storemerge27 = phi i32 [ %195, %190 ], [ 0, %.preheader6.preheader ]
  %189 = icmp slt i32 %storemerge27, 1
  br i1 %189, label %190, label %196

190:                                              ; preds = %.preheader6
  %191 = mul i32 %storemerge27, 64
  %192 = add i32 %188, %191
...
.preheader4.preheader:                            ; preds = %.preheader5
  %204 = mul i32 %storemerge24, 8
  %205 = add i32 %204, %storemerge13
  br label %.preheader4

.preheader4:                                      ; preds = %207, %.preheader4.preheader
  %storemerge25 = phi i32 [ %212, %207 ], [ 0, %.preheader4.preheader ]
  %206 = icmp slt i32 %storemerge25, 2
  br i1 %206, label %207, label %213

207:                                              ; preds = %.preheader4
  %208 = mul i32 %storemerge25, 64
  %209 = add i32 %205, %208
...
.preheader2.preheader:                            ; preds = %.preheader3
  %221 = mul i32 %storemerge22, 8
  %222 = add i32 %221, %storemerge14
  br label %.preheader2

.preheader2:                                      ; preds = %224, %.preheader2.preheader
  %storemerge23 = phi i32 [ %229, %224 ], [ 0, %.preheader2.preheader ]
  %223 = icmp slt i32 %storemerge23, 2
  br i1 %223, label %224, label %230

224:                                              ; preds = %.preheader2
  %225 = mul i32 %storemerge23, 64
  %226 = add i32 %222, %225
...
.preheader.preheader:                             ; preds = %.preheader1
  %238 = mul i32 %storemerge20, 8
  %239 = add i32 %238, %storemerge15
  br label %.preheader

.preheader:                                       ; preds = %241, %.preheader.preheader
  %storemerge21 = phi i32 [ %246, %241 ], [ 0, %.preheader.preheader ]
  %240 = icmp slt i32 %storemerge21, 2
  br i1 %240, label %241, label %247

241:                                              ; preds = %.preheader
  %242 = mul i32 %storemerge21, 64
  %243 = add i32 %239, %242
