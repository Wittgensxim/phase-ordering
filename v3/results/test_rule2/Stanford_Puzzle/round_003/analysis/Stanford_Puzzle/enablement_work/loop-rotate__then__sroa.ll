...
6:                                                ; preds = %.lr.ph, %20
  ...
  %7 = phi i64 [ %3, %.lr.ph ], [ %22, %20 ]
  %storemerge2 = phi i32 [ 0, %.lr.ph ], [ %21, %20 ]
...
20:                                               ; preds = %19
  ...
  %23 = getelementptr inbounds [4 x i8], ptr @piecemax, i64 %22
  %24 = load i32, ptr %23, align 4
  %.not = icmp sgt i32 %21, %24
...
6:                                                ; preds = %.lr.ph, %17
  ...
  %storemerge3 = phi i32 [ 0, %.lr.ph ], [ %18, %17 ]
  %8 = getelementptr inbounds [2048 x i8], ptr @p, i64 %7
...
22:                                               ; preds = %._crit_edge, %2
  ...
  %exitcond4 = icmp ne i64 %29, %wide.trip.count
  br i1 %exitcond4, label %.lr.ph7, label %38

.lr.ph7:                                          ; preds = %22
  br label %30

30:                                               ; preds = %.lr.ph7, %36
  %indvars.iv5 = phi i64 [ %29, %.lr.ph7 ], [ %indvars.iv.next, %36 ]
  %31 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %indvars.iv5
  %32 = load i32, ptr %31, align 4
  %.not3 = icmp eq i32 %32, 0
  br i1 %.not3, label %33, label %35

33:                                               ; preds = %30
  %storemerge1.lcssa5.wide = phi i64 [ %indvars.iv5, %30 ]
  %34 = trunc nsw i64 %storemerge1.lcssa5.wide to i32
  br label %39
...
36:                                               ; preds = %35
  ...
  br i1 %exitcond, label %30, label %._crit_edge8, !llvm.loop !10

._crit_edge8:                                     ; preds = %36
  br label %38

38:                                               ; preds = %._crit_edge8, %22
  br label %39

39:                                               ; preds = %38, %33
  %storemerge2 = phi i32 [ 0, %38 ], [ %34, %33 ]
  ret i32 %storemerge2
}
...
8:                                                ; preds = %7, %25
  %.0122 = phi i32 [ 1, %7 ], [ %26, %25 ]
  br label %9

9:                                                ; preds = %8, %21
  %.0108 = phi i32 [ 1, %8 ], [ %22, %21 ]
  br label %10

10:                                               ; preds = %9, %17
  %.0106 = phi i32 [ 1, %9 ], [ %18, %17 ]
  %storemerge4817 = phi i32 [ 1, %9 ], [ %18, %17 ]
  %11 = shl i32 %storemerge4817, 6
  %12 = shl i32 %.0108, 3
  %13 = add i32 %11, %12
  %14 = add nsw i32 %.0122, %13
...
29:                                               ; preds = %28, %39
  %.1123 = phi i32 [ 0, %28 ], [ %40, %39 ]
  br label %30

30:                                               ; preds = %29, %35
  %.1 = phi i32 [ 0, %29 ], [ %36, %35 ]
  %storemerge4618 = phi i32 [ 0, %29 ], [ %36, %35 ]
  %31 = sext i32 %.1123 to i64
  %32 = getelementptr inbounds [2048 x i8], ptr @p, i64 %31
  %33 = sext i32 %storemerge4618 to i64
...
43:                                               ; preds = %42, %60
  %.2124 = phi i32 [ 0, %42 ], [ %61, %60 ]
  br label %44

44:                                               ; preds = %43, %56
  %.1109 = phi i32 [ 0, %43 ], [ %57, %56 ]
  br label %45

45:                                               ; preds = %44, %52
  %.1107 = phi i32 [ 0, %44 ], [ %53, %52 ]
  %storemerge4519 = phi i32 [ 0, %44 ], [ %53, %52 ]
  %46 = shl i32 %storemerge4519, 6
  %47 = shl i32 %.1109, 3
  %48 = add i32 %46, %47
  %49 = add nsw i32 %.2124, %48
...
64:                                               ; preds = %63, %81
  %.3125 = phi i32 [ 0, %63 ], [ %82, %81 ]
  br label %65

65:                                               ; preds = %64, %77
  %.2110 = phi i32 [ 0, %64 ], [ %78, %77 ]
  br label %66

66:                                               ; preds = %65, %73
  %.2 = phi i32 [ 0, %65 ], [ %74, %73 ]
  %storemerge4320 = phi i32 [ 0, %65 ], [ %74, %73 ]
  %67 = shl i32 %storemerge4320, 6
  %68 = shl i32 %.2110, 3
  %69 = add i32 %67, %68
  %70 = add nsw i32 %.3125, %69
...
85:                                               ; preds = %84, %102
  %.4126 = phi i32 [ 0, %84 ], [ %103, %102 ]
  br label %86

86:                                               ; preds = %85, %98
  %.3111 = phi i32 [ 0, %85 ], [ %99, %98 ]
  br label %87

87:                                               ; preds = %86, %94
  %.3 = phi i32 [ 0, %86 ], [ %95, %94 ]
  %storemerge4121 = phi i32 [ 0, %86 ], [ %95, %94 ]
  %88 = shl i32 %storemerge4121, 6
  %89 = shl i32 %.3111, 3
  %90 = add i32 %88, %89
  %91 = add nsw i32 %.4126, %90
...
106:                                              ; preds = %105, %123
  %.5127 = phi i32 [ 0, %105 ], [ %124, %123 ]
  br label %107

107:                                              ; preds = %106, %119
  %.4112 = phi i32 [ 0, %106 ], [ %120, %119 ]
  br label %108

108:                                              ; preds = %107, %115
  %.4 = phi i32 [ 0, %107 ], [ %116, %115 ]
  %storemerge3922 = phi i32 [ 0, %107 ], [ %116, %115 ]
  %109 = shl i32 %storemerge3922, 6
  %110 = shl i32 %.4112, 3
  %111 = add i32 %109, %110
  %112 = add nsw i32 %.5127, %111
...
127:                                              ; preds = %126, %144
  %.6128 = phi i32 [ 0, %126 ], [ %145, %144 ]
  br label %128

128:                                              ; preds = %127, %140
  %.5113 = phi i32 [ 0, %127 ], [ %141, %140 ]
  br label %129

129:                                              ; preds = %128, %136
  %.5 = phi i32 [ 0, %128 ], [ %137, %136 ]
  %storemerge3723 = phi i32 [ 0, %128 ], [ %137, %136 ]
  %130 = shl i32 %storemerge3723, 6
  %131 = shl i32 %.5113, 3
  %132 = add i32 %130, %131
  %133 = add nsw i32 %.6128, %132
...
148:                                              ; preds = %147, %165
  %.7129 = phi i32 [ 0, %147 ], [ %166, %165 ]
  br label %149

149:                                              ; preds = %148, %161
  %.6114 = phi i32 [ 0, %148 ], [ %162, %161 ]
  br label %150

150:                                              ; preds = %149, %157
  %.6 = phi i32 [ 0, %149 ], [ %158, %157 ]
  %storemerge3524 = phi i32 [ 0, %149 ], [ %158, %157 ]
  %151 = shl i32 %storemerge3524, 6
  %152 = shl i32 %.6114, 3
  %153 = add i32 %151, %152
  %154 = add nsw i32 %.7129, %153
...
169:                                              ; preds = %168, %186
  %.8130 = phi i32 [ 0, %168 ], [ %187, %186 ]
  br label %170

170:                                              ; preds = %169, %182
  %.7115 = phi i32 [ 0, %169 ], [ %183, %182 ]
  br label %171

171:                                              ; preds = %170, %178
  %.7 = phi i32 [ 0, %170 ], [ %179, %178 ]
  %storemerge3325 = phi i32 [ 0, %170 ], [ %179, %178 ]
  %172 = shl i32 %storemerge3325, 6
  %173 = shl i32 %.7115, 3
  %174 = add i32 %172, %173
  %175 = add nsw i32 %.8130, %174
...
190:                                              ; preds = %189, %207
  %.9131 = phi i32 [ 0, %189 ], [ %208, %207 ]
  br label %191

191:                                              ; preds = %190, %203
  %.8116 = phi i32 [ 0, %190 ], [ %204, %203 ]
  br label %192

192:                                              ; preds = %191, %199
  %.8 = phi i32 [ 0, %191 ], [ %200, %199 ]
  %storemerge3126 = phi i32 [ 0, %191 ], [ %200, %199 ]
  %193 = shl i32 %storemerge3126, 6
  %194 = shl i32 %.8116, 3
  %195 = add i32 %193, %194
  %196 = add nsw i32 %.9131, %195
...
211:                                              ; preds = %210, %228
  %.10132 = phi i32 [ 0, %210 ], [ %229, %228 ]
  br label %212

212:                                              ; preds = %211, %224
  %.9117 = phi i32 [ 0, %211 ], [ %225, %224 ]
  br label %213

213:                                              ; preds = %212, %220
  %.9 = phi i32 [ 0, %212 ], [ %221, %220 ]
  %storemerge2927 = phi i32 [ 0, %212 ], [ %221, %220 ]
  %214 = shl i32 %storemerge2927, 6
  %215 = shl i32 %.9117, 3
  %216 = add i32 %214, %215
  %217 = add nsw i32 %.10132, %216
...
232:                                              ; preds = %231, %249
  %.11133 = phi i32 [ 0, %231 ], [ %250, %249 ]
  br label %233

233:                                              ; preds = %232, %245
  %.10118 = phi i32 [ 0, %232 ], [ %246, %245 ]
  br label %234

234:                                              ; preds = %233, %241
  %.10 = phi i32 [ 0, %233 ], [ %242, %241 ]
  %storemerge2728 = phi i32 [ 0, %233 ], [ %242, %241 ]
  %235 = shl i32 %storemerge2728, 6
  %236 = shl i32 %.10118, 3
  %237 = add i32 %235, %236
  %238 = add nsw i32 %.11133, %237
...
253:                                              ; preds = %252, %270
  %.12134 = phi i32 [ 0, %252 ], [ %271, %270 ]
  br label %254

254:                                              ; preds = %253, %266
  %.11119 = phi i32 [ 0, %253 ], [ %267, %266 ]
  br label %255

255:                                              ; preds = %254, %262
  %.11 = phi i32 [ 0, %254 ], [ %263, %262 ]
  %storemerge2529 = phi i32 [ 0, %254 ], [ %263, %262 ]
  %256 = shl i32 %storemerge2529, 6
  %257 = shl i32 %.11119, 3
  %258 = add i32 %256, %257
  %259 = add nsw i32 %.12134, %258
...
274:                                              ; preds = %273, %291
  %.13135 = phi i32 [ 0, %273 ], [ %292, %291 ]
  br label %275

275:                                              ; preds = %274, %287
  %.12120 = phi i32 [ 0, %274 ], [ %288, %287 ]
  br label %276

276:                                              ; preds = %275, %283
  %.12 = phi i32 [ 0, %275 ], [ %284, %283 ]
  %storemerge2330 = phi i32 [ 0, %275 ], [ %284, %283 ]
  %277 = shl i32 %storemerge2330, 6
  %278 = shl i32 %.12120, 3
  %279 = add i32 %277, %278
  %280 = add nsw i32 %.13135, %279
...
295:                                              ; preds = %294, %312
  %.14 = phi i32 [ 0, %294 ], [ %313, %312 ]
  br label %296

296:                                              ; preds = %295, %308
  %.13121 = phi i32 [ 0, %295 ], [ %309, %308 ]
  br label %297

297:                                              ; preds = %296, %304
  %.13 = phi i32 [ 0, %296 ], [ %305, %304 ]
  %storemerge2131 = phi i32 [ 0, %296 ], [ %305, %304 ]
  %298 = shl i32 %storemerge2131, 6
  %299 = shl i32 %.13121, 3
  %300 = add i32 %298, %299
  %301 = add nsw i32 %.14, %300
