...
18:                                               ; preds = %16
  %19 = mul i32 %storemerge47, 8
  %invariant.op = add i32 %storemerge1, %19
  br label %20
...
56:                                               ; preds = %54
  %57 = mul i32 %storemerge44, 8
  %invariant.op5 = add i32 %storemerge3, %57
  br label %58
...
78:                                               ; preds = %76
  %79 = mul i32 %storemerge42, 8
  %invariant.op10 = add i32 %storemerge4, %79
  br label %80
...
100:                                              ; preds = %98
  %101 = mul i32 %storemerge40, 8
  %invariant.op15 = add i32 %storemerge5, %101
  br label %102
...
122:                                              ; preds = %120
  %123 = mul i32 %storemerge38, 8
  %invariant.op20 = add i32 %storemerge6, %123
  br label %124
...
144:                                              ; preds = %142
  %145 = mul i32 %storemerge36, 8
  %invariant.op25 = add i32 %storemerge7, %145
  br label %146
...
166:                                              ; preds = %164
  %167 = mul i32 %storemerge34, 8
  %invariant.op30 = add i32 %storemerge8, %167
  br label %168
...
188:                                              ; preds = %186
  %189 = mul i32 %storemerge32, 8
  %invariant.op35 = add i32 %storemerge9, %189
  br label %190
...
210:                                              ; preds = %208
  %211 = mul i32 %storemerge30, 8
  %invariant.op40 = add i32 %storemerge10, %211
  br label %212
...
232:                                              ; preds = %230
  %233 = mul i32 %storemerge28, 8
  %invariant.op45 = add i32 %storemerge11, %233
  br label %234
...
254:                                              ; preds = %252
  %255 = mul i32 %storemerge26, 8
  %invariant.op50 = add i32 %storemerge12, %255
  br label %256
...
276:                                              ; preds = %274
  %277 = mul i32 %storemerge24, 8
  %invariant.op55 = add i32 %storemerge13, %277
  br label %278
...
298:                                              ; preds = %296
  %299 = mul i32 %storemerge22, 8
  %invariant.op60 = add i32 %storemerge14, %299
  br label %300
...
320:                                              ; preds = %318
  %321 = mul i32 %storemerge20, 8
  %invariant.op65 = add i32 %storemerge15, %321
  br label %322
