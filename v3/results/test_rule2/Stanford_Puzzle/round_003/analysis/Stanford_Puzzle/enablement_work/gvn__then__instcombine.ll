...
24:                                               ; preds = %30, %16
  ...
  br i1 %exitcond.not, label %31, label %26
...
310:                                              ; preds = %309, %307
  ...
  br i1 %.not16, label %313, label %314
...
314:                                              ; preds = %310
  ...
  %.not18 = icmp eq i32 %315, 2005
  br i1 %.not18, label %317, label %316
...
318:                                              ; preds = %317, %313
  ...
  %320 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %319) #4
  %321 = load i32, ptr @kount, align 4
  %322 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %321) #4
  ret void
}
