...
25:                                               ; preds = %24
  %26 = add nuw nsw i32 %storemerge, 1
...
9:                                                ; preds = %30, %8
  ...
  %10 = icmp samesign ult i32 %storemerge1, 6
...
12:                                               ; preds = %27, %11
  ...
  %13 = icmp samesign ult i32 %storemerge47, 6
...
15:                                               ; preds = %24, %14
  ...
  %16 = icmp samesign ult i32 %storemerge48, 6
  br i1 %16, label %17, label %26

17:                                               ; preds = %15
  %18 = shl nuw nsw i32 %storemerge48, 6
  %19 = shl nuw nsw i32 %storemerge47, 3
  %20 = or disjoint i32 %18, %19
  %21 = or disjoint i32 %storemerge1, %20
...
36:                                               ; preds = %43, %35
  ...
  %37 = icmp samesign ult i32 %storemerge46, 512
  br i1 %37, label %38, label %45

38:                                               ; preds = %36
  %39 = zext nneg i32 %storemerge2 to i64
...
49:                                               ; preds = %66, %48
  %storemerge3 = phi i32 [ 0, %48 ], [ %67, %66 ]
...
52:                                               ; preds = %63, %51
  %storemerge44 = phi i32 [ 0, %51 ], [ %64, %63 ]
...
55:                                               ; preds = %61, %54
  %storemerge45 = phi i1 [ true, %54 ], [ false, %61 ]
  br i1 %storemerge45, label %56, label %62

56:                                               ; preds = %55
  %57 = shl nuw nsw i32 %storemerge44, 3
  %58 = or disjoint i32 %storemerge3, %57
...
63:                                               ; preds = %62
  %64 = add nuw nsw i32 %storemerge44, 1
...
66:                                               ; preds = %65
  %67 = add nuw nsw i32 %storemerge3, 1
...
69:                                               ; preds = %87, %68
  %storemerge4 = phi i32 [ 0, %68 ], [ %88, %87 ]
  %70 = icmp samesign ult i32 %storemerge4, 2
...
75:                                               ; preds = %82, %74
  ...
  %76 = icmp samesign ult i32 %storemerge43, 4
  br i1 %76, label %77, label %84

77:                                               ; preds = %75
  %78 = shl nuw nsw i32 %storemerge43, 6
  %79 = or disjoint i32 %storemerge4, %78
...
82:                                               ; preds = %77
  %83 = add nuw nsw i32 %storemerge43, 1
...
87:                                               ; preds = %86
  %88 = add nuw nsw i32 %storemerge4, 1
...
93:                                               ; preds = %107, %92
  %storemerge40 = phi i32 [ 0, %92 ], [ %108, %107 ]
  %94 = icmp samesign ult i32 %storemerge40, 4
...
96:                                               ; preds = %104, %95
  %storemerge41 = phi i32 [ 0, %95 ], [ %105, %104 ]
  %97 = icmp samesign ult i32 %storemerge41, 2
  br i1 %97, label %98, label %106

98:                                               ; preds = %96
  %99 = shl nuw nsw i32 %storemerge41, 6
  %100 = shl nuw nsw i32 %storemerge40, 3
...
107:                                              ; preds = %106
  %108 = add nuw nsw i32 %storemerge40, 1
...
112:                                              ; preds = %129, %111
  ...
  %113 = icmp samesign ult i32 %storemerge6, 2
...
115:                                              ; preds = %126, %114
  ...
  %116 = icmp samesign ult i32 %storemerge38, 4
...
118:                                              ; preds = %124, %117
  %storemerge39 = phi i1 [ true, %117 ], [ false, %124 ]
  br i1 %storemerge39, label %119, label %125

119:                                              ; preds = %118
  %120 = shl nuw nsw i32 %storemerge38, 3
  %121 = or disjoint i32 %storemerge6, %120
...
126:                                              ; preds = %125
  %127 = add nuw nsw i32 %storemerge38, 1
...
132:                                              ; preds = %150, %131
  %storemerge7 = phi i32 [ 0, %131 ], [ %151, %150 ]
  %133 = icmp samesign ult i32 %storemerge7, 4
...
138:                                              ; preds = %145, %137
  %storemerge37 = phi i32 [ 0, %137 ], [ %146, %145 ]
  %139 = icmp samesign ult i32 %storemerge37, 2
  br i1 %139, label %140, label %147

140:                                              ; preds = %138
  %141 = shl nuw nsw i32 %storemerge37, 6
  %142 = or disjoint i32 %storemerge7, %141
...
145:                                              ; preds = %140
  %146 = add nuw nsw i32 %storemerge37, 1
...
150:                                              ; preds = %149
  %151 = add nuw nsw i32 %storemerge7, 1
...
156:                                              ; preds = %170, %155
  %storemerge34 = phi i32 [ 0, %155 ], [ %171, %170 ]
  %157 = icmp samesign ult i32 %storemerge34, 2
...
159:                                              ; preds = %167, %158
  %storemerge35 = phi i32 [ 0, %158 ], [ %168, %167 ]
  %160 = icmp samesign ult i32 %storemerge35, 4
  br i1 %160, label %161, label %169

161:                                              ; preds = %159
  %162 = shl nuw nsw i32 %storemerge35, 6
  %163 = shl nuw nsw i32 %storemerge34, 3
...
167:                                              ; preds = %161
  %168 = add nuw nsw i32 %storemerge35, 1
...
170:                                              ; preds = %169
  %171 = add nuw nsw i32 %storemerge34, 1
...
175:                                              ; preds = %189, %174
  %storemerge9 = phi i32 [ 0, %174 ], [ %190, %189 ]
  %176 = icmp samesign ult i32 %storemerge9, 3
...
181:                                              ; preds = %185, %180
  %storemerge33 = phi i1 [ true, %180 ], [ false, %185 ]
  br i1 %storemerge33, label %182, label %186

182:                                              ; preds = %181
  %183 = zext nneg i32 %storemerge9 to i64
...
189:                                              ; preds = %188
  %190 = add nuw nsw i32 %storemerge9, 1
...
195:                                              ; preds = %205, %194
  %storemerge30 = phi i32 [ 0, %194 ], [ %206, %205 ]
  %196 = icmp samesign ult i32 %storemerge30, 3
...
198:                                              ; preds = %203, %197
  %storemerge31 = phi i1 [ true, %197 ], [ false, %203 ]
  br i1 %storemerge31, label %199, label %204

199:                                              ; preds = %198
  %200 = shl nuw nsw i32 %storemerge30, 3
...
205:                                              ; preds = %204
  %206 = add nuw nsw i32 %storemerge30, 1
...
216:                                              ; preds = %222, %215
  ...
  %217 = icmp samesign ult i32 %storemerge29, 3
  br i1 %217, label %218, label %224

218:                                              ; preds = %216
  %219 = shl nuw nsw i32 %storemerge29, 6
...
222:                                              ; preds = %218
  %223 = add nuw nsw i32 %storemerge29, 1
...
229:                                              ; preds = %246, %228
  ...
  %230 = icmp samesign ult i32 %storemerge12, 2
...
232:                                              ; preds = %243, %231
  ...
  %233 = icmp samesign ult i32 %storemerge26, 2
...
235:                                              ; preds = %241, %234
  %storemerge27 = phi i1 [ true, %234 ], [ false, %241 ]
  br i1 %storemerge27, label %236, label %242

236:                                              ; preds = %235
  %237 = shl nuw nsw i32 %storemerge26, 3
  %238 = or disjoint i32 %storemerge12, %237
...
249:                                              ; preds = %267, %248
  %storemerge13 = phi i32 [ 0, %248 ], [ %268, %267 ]
  %250 = icmp samesign ult i32 %storemerge13, 2
...
255:                                              ; preds = %262, %254
  %storemerge25 = phi i32 [ 0, %254 ], [ %263, %262 ]
  %256 = icmp samesign ult i32 %storemerge25, 2
  br i1 %256, label %257, label %264

257:                                              ; preds = %255
  %258 = shl nuw nsw i32 %storemerge25, 6
  %259 = or disjoint i32 %storemerge13, %258
...
262:                                              ; preds = %257
  %263 = add nuw nsw i32 %storemerge25, 1
...
267:                                              ; preds = %266
  %268 = add nuw nsw i32 %storemerge13, 1
...
273:                                              ; preds = %287, %272
  %storemerge22 = phi i32 [ 0, %272 ], [ %288, %287 ]
  %274 = icmp samesign ult i32 %storemerge22, 2
...
276:                                              ; preds = %284, %275
  %storemerge23 = phi i32 [ 0, %275 ], [ %285, %284 ]
  %277 = icmp samesign ult i32 %storemerge23, 2
  br i1 %277, label %278, label %286

278:                                              ; preds = %276
  %279 = shl nuw nsw i32 %storemerge23, 6
  %280 = shl nuw nsw i32 %storemerge22, 3
...
284:                                              ; preds = %278
  %285 = add nuw nsw i32 %storemerge23, 1
...
287:                                              ; preds = %286
  %288 = add nuw nsw i32 %storemerge22, 1
...
292:                                              ; preds = %313, %291
  %storemerge15 = phi i32 [ 0, %291 ], [ %314, %313 ]
  %293 = icmp samesign ult i32 %storemerge15, 2
...
295:                                              ; preds = %310, %294
  %storemerge20 = phi i32 [ 0, %294 ], [ %311, %310 ]
  %296 = icmp samesign ult i32 %storemerge20, 2
...
298:                                              ; preds = %307, %297
  %storemerge21 = phi i32 [ 0, %297 ], [ %308, %307 ]
  %299 = icmp samesign ult i32 %storemerge21, 2
  br i1 %299, label %300, label %309

300:                                              ; preds = %298
  %301 = shl nuw nsw i32 %storemerge21, 6
  %302 = shl nuw nsw i32 %storemerge20, 3
  %303 = or disjoint i32 %301, %302
  %304 = or disjoint i32 %storemerge15, %303
...
307:                                              ; preds = %300
  %308 = add nuw nsw i32 %storemerge21, 1
...
310:                                              ; preds = %309
  %311 = add nuw nsw i32 %storemerge20, 1
...
313:                                              ; preds = %312
  %314 = add nuw nsw i32 %storemerge15, 1
