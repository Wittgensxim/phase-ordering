...
define dso_local i32 @Fit(i32 noundef %0, i32 noundef %1) #0 {
  ...
  br i1 %.not1, label %31, label %.lr.ph

.lr.ph:                                           ; preds = %2
  br label %9

9:                                                ; preds = %.lr.ph, %24
  %10 = phi i64 [ %6, %.lr.ph ], [ %28, %24 ]
  %storemerge2 = phi i32 [ 0, %.lr.ph ], [ %26, %24 ]
...
24:                                               ; preds = %23
  ...
  %29 = getelementptr inbounds [4 x i8], ptr @piecemax, i64 %28
  %30 = load i32, ptr %29, align 4
  %.not.not = icmp slt i32 %25, %30
  br i1 %.not.not, label %9, label %._crit_edge, !llvm.loop !7
...
28:                                               ; preds = %._crit_edge, %2
  %.lcssa = phi i64 [ %25, %._crit_edge ], [ %6, %2 ]
  ...
  %exitcond4.not = icmp sgt i32 %35, 511
  br i1 %exitcond4.not, label %45, label %.lr.ph7
...
43:                                               ; preds = %42
  ...
  br i1 %exitcond.not, label %._crit_edge8, label %37, !llvm.loop !10

._crit_edge8:                                     ; preds = %43
  br label %45

45:                                               ; preds = %._crit_edge8, %28
  br label %46

46:                                               ; preds = %45, %40
  %storemerge2 = phi i32 [ 0, %45 ], [ %41, %40 ]
  ret i32 %storemerge2
}
