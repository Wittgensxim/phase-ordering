...
.preheader29.preheader:                           ; preds = %.preheader30
  %13 = mul i32 %storemerge47, 8
  %invariant.op = add i32 %storemerge1, %13
...
.preheader25:                                     ; preds = %43, %.preheader25.preheader
  %storemerge45.lcssa7 = phi i32 [ %storemerge45.lcssa, %43 ], [ poison, %.preheader25.preheader ]
...
.preheader24.preheader:                           ; preds = %.preheader25
  %36 = mul i32 %storemerge44, 8
  %invariant.op5 = add i32 %storemerge3, %36
...
.preheader23:                                     ; preds = %58, %.preheader23.preheader
  %storemerge43.lcssa12 = phi i32 [ %storemerge43.lcssa, %58 ], [ poison, %.preheader23.preheader ]
...
.preheader22.preheader:                           ; preds = %.preheader23
  ...
  %invariant.op10 = add i32 %storemerge4, %51
...
.preheader21:                                     ; preds = %73, %.preheader21.preheader
  %storemerge41.lcssa17 = phi i32 [ %storemerge41.lcssa, %73 ], [ poison, %.preheader21.preheader ]
...
.preheader20.preheader:                           ; preds = %.preheader21
  %66 = mul i32 %storemerge40, 8
  %invariant.op15 = add i32 %storemerge5, %66
...
.preheader19:                                     ; preds = %88, %.preheader19.preheader
  %storemerge39.lcssa22 = phi i32 [ %storemerge39.lcssa, %88 ], [ poison, %.preheader19.preheader ]
...
.preheader18.preheader:                           ; preds = %.preheader19
  %81 = mul i32 %storemerge38, 8
  %invariant.op20 = add i32 %storemerge6, %81
...
.preheader17:                                     ; preds = %103, %.preheader17.preheader
  %storemerge37.lcssa27 = phi i32 [ %storemerge37.lcssa, %103 ], [ poison, %.preheader17.preheader ]
...
.preheader16.preheader:                           ; preds = %.preheader17
  %96 = mul i32 %storemerge36, 8
  %invariant.op25 = add i32 %storemerge7, %96
...
.preheader15:                                     ; preds = %118, %.preheader15.preheader
  %storemerge35.lcssa32 = phi i32 [ %storemerge35.lcssa, %118 ], [ poison, %.preheader15.preheader ]
...
.preheader14.preheader:                           ; preds = %.preheader15
  %111 = mul i32 %storemerge34, 8
  %invariant.op30 = add i32 %storemerge8, %111
...
.preheader13:                                     ; preds = %133, %.preheader13.preheader
  %storemerge33.lcssa37 = phi i32 [ %storemerge33.lcssa, %133 ], [ poison, %.preheader13.preheader ]
...
.preheader12.preheader:                           ; preds = %.preheader13
  %126 = mul i32 %storemerge32, 8
  %invariant.op35 = add i32 %storemerge9, %126
...
.preheader11:                                     ; preds = %148, %.preheader11.preheader
  %storemerge31.lcssa42 = phi i32 [ %storemerge31.lcssa, %148 ], [ poison, %.preheader11.preheader ]
...
.preheader10.preheader:                           ; preds = %.preheader11
  %141 = mul i32 %storemerge30, 8
  %invariant.op40 = add i32 %storemerge10, %141
...
.preheader9:                                      ; preds = %163, %.preheader9.preheader
  %storemerge29.lcssa47 = phi i32 [ %storemerge29.lcssa, %163 ], [ poison, %.preheader9.preheader ]
...
.preheader8.preheader:                            ; preds = %.preheader9
  %156 = mul i32 %storemerge28, 8
  %invariant.op45 = add i32 %storemerge11, %156
  br label %.preheader8
...
.preheader7:                                      ; preds = %178, %.preheader7.preheader
  %storemerge27.lcssa52 = phi i32 [ %storemerge27.lcssa, %178 ], [ poison, %.preheader7.preheader ]
...
.preheader6.preheader:                            ; preds = %.preheader7
  %171 = mul i32 %storemerge26, 8
  %invariant.op50 = add i32 %storemerge12, %171
  br label %.preheader6
...
.preheader5:                                      ; preds = %193, %.preheader5.preheader
  %storemerge25.lcssa57 = phi i32 [ %storemerge25.lcssa, %193 ], [ poison, %.preheader5.preheader ]
...
.preheader4.preheader:                            ; preds = %.preheader5
  %186 = mul i32 %storemerge24, 8
  %invariant.op55 = add i32 %storemerge13, %186
  br label %.preheader4
...
.preheader3:                                      ; preds = %208, %.preheader3.preheader
  %storemerge23.lcssa62 = phi i32 [ %storemerge23.lcssa, %208 ], [ poison, %.preheader3.preheader ]
...
.preheader2.preheader:                            ; preds = %.preheader3
  %201 = mul i32 %storemerge22, 8
  %invariant.op60 = add i32 %storemerge14, %201
  br label %.preheader2
...
.preheader1:                                      ; preds = %223, %.preheader1.preheader
  %storemerge21.lcssa67 = phi i32 [ %storemerge21.lcssa, %223 ], [ poison, %.preheader1.preheader ]
...
.preheader.preheader:                             ; preds = %.preheader1
  %216 = mul i32 %storemerge20, 8
  %invariant.op65 = add i32 %storemerge15, %216
  br label %.preheader
