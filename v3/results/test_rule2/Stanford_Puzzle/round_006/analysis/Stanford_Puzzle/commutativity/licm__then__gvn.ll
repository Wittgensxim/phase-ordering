...
29:                                               ; preds = %35, %21
  ...
  br i1 %exitcond.not, label %.loopexit.loopexit, label %31
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %34
  %storemerge2 = phi i32 [ %30, %34 ], [ 0, %.loopexit.loopexit ]
  ret i32 %storemerge2
}
...
229:                                              ; preds = %227
  %230 = call i32 @Place(i32 noundef 0, i32 noundef 73)
  store i32 %230, ptr @n, align 4
  br label %232
...
232:                                              ; preds = %231, %229
  %233 = phi i32 [ %.pre, %231 ], [ %230, %229 ]
  %234 = call i32 @Trial(i32 noundef %233)
  %.not16 = icmp eq i32 %234, 0
  br i1 %.not16, label %235, label %236
...
236:                                              ; preds = %232
  ...
  %.not18 = icmp eq i32 %237, 2005
  br i1 %.not18, label %239, label %238
...
239:                                              ; preds = %238, %236, %235
  ...
  %242 = load i32, ptr @kount, align 4
  %243 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %242) #4
  ret void
}
