...
8:                                                ; preds = %10, %6
  %storemerge.in = phi i32 [ %0, %6 ], [ %storemerge, %10 ]
  %storemerge = add nsw i32 %storemerge.in, -1
  store i32 %storemerge, ptr %3, align 4
  %9 = icmp sgt i32 %storemerge.in, 1
...
10:                                               ; preds = %8
  ...
  call void @Swap(ptr noundef nonnull %12, ptr noundef nonnull %14)
  call void @Permute(i32 noundef %7)
  call void @Swap(ptr noundef nonnull %12, ptr noundef nonnull %14)
