...
1:                                                ; preds = %6, %0
  %indvars.iv = phi i64 [ %indvars.iv.next, %6 ], [ 1, %0 ]
  %exitcond = icmp ne i64 %indvars.iv, 8
  br i1 %exitcond, label %2, label %7

2:                                                ; preds = %1
  %3 = sub nuw nsw i64 %indvars.iv, 1
  %4 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
...
9:                                                ; preds = %19, %5
  %indvars.iv = phi i64 [ %indvars.iv.next, %19 ], [ %8, %5 ]
...
11:                                               ; preds = %9
  ...
  %14 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
  call void @Swap(ptr noundef %13, ptr noundef %14)
  %15 = sub nsw i32 %0, 1
  call void @Permute(i32 noundef %15)
  %16 = sext i32 %0 to i64
  %17 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %16
  %18 = getelementptr inbounds [11 x i32], ptr @permarray, i64 0, i64 %indvars.iv
  call void @Swap(ptr noundef %17, ptr noundef %18)
  br label %19
