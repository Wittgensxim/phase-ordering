...
1:                                                ; preds = %0, %1
  ...
  %5 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %4
...
9:                                                ; preds = %.lr.ph, %9
  %10 = phi i32 [ %5, %.lr.ph ], [ %13, %9 ]
  %11 = zext nneg i32 %10 to i64
  %12 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %11
  call void @Swap(ptr noundef nonnull %8, ptr noundef nonnull %12)
  call void @Permute(i32 noundef %5)
  call void @Swap(ptr noundef nonnull %8, ptr noundef nonnull %12)
  %13 = add nsw i32 %10, -1
  %14 = icmp sgt i32 %13, 0
  br i1 %14, label %9, label %._crit_edge, !llvm.loop !9
