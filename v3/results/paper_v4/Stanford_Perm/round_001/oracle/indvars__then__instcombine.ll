...
1:                                                ; preds = %2, %0
  ...
  br i1 %exitcond.not, label %6, label %2
...
7:                                                ; preds = %10, %4
  %indvars.iv = phi i64 [ %indvars.iv.next, %10 ], [ %6, %4 ]
...
10:                                               ; preds = %7
  ...
  call void @Swap(ptr noundef nonnull %12, ptr noundef nonnull %13)
  call void @Permute(i32 noundef %5)
  call void @Swap(ptr noundef nonnull %12, ptr noundef nonnull %13)
