; ModuleID = 'results\paper_v4\Stanford_Perm\round_000\output.ll'
...
1:                                                ; preds = %0, %1
  %indvars.iv2 = phi i64 [ 1, %0 ], [ %indvars.iv.next, %1 ]
  %2 = add nsw i64 %indvars.iv2, -1
  %3 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %indvars.iv2
...
8:                                                ; preds = %.lr.ph, %8
  %indvars.iv2 = phi i64 [ %6, %.lr.ph ], [ %indvars.iv.next, %8 ]
  %9 = sext i32 %0 to i64
  %10 = getelementptr inbounds [4 x i8], ptr @permarray, i64 %9
  %11 = getelementptr inbounds nuw [4 x i8], ptr @permarray, i64 %indvars.iv2
  ...
  br i1 %13, label %8, label %._crit_edge, !llvm.loop !9
