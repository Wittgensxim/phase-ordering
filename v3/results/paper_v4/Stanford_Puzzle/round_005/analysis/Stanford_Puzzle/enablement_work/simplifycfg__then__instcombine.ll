...
24:                                               ; preds = %21
  %25 = trunc nsw i64 %indvars.iv3 to i32
...
72:                                               ; preds = %80, %71
  %73 = phi i1 [ true, %71 ], [ false, %80 ]
  %74 = phi i64 [ 0, %71 ], [ 1, %80 ]
  br label %75

75:                                               ; preds = %75, %72
  %76 = phi i1 [ true, %72 ], [ false, %75 ]
  %77 = phi i64 [ 0, %72 ], [ 8, %75 ]
  %78 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 18432), i64 %74
  %79 = getelementptr inbounds nuw [4 x i8], ptr %78, i64 %77
  store i32 1, ptr %79, align 4
  br i1 %76, label %75, label %80, !llvm.loop !34

80:                                               ; preds = %75
  br i1 %73, label %72, label %81, !llvm.loop !35
...
82:                                               ; preds = %88, %81
  %83 = phi i1 [ true, %81 ], [ false, %88 ]
  %84 = phi i64 [ 0, %81 ], [ 1, %88 ]
  br label %85

85:                                               ; preds = %85, %82
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %85 ], [ 0, %82 ]
  %.idx84 = shl nuw nsw i64 %indvars.iv63, 8
  %86 = getelementptr inbounds nuw i8, ptr getelementptr inbounds nuw (i8, ptr @p, i64 20480), i64 %.idx84
  %87 = getelementptr inbounds nuw [4 x i8], ptr %86, i64 %84
  store i32 1, ptr %87, align 4
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %exitcond66.not = icmp eq i64 %indvars.iv.next64, 2
  br i1 %exitcond66.not, label %88, label %85, !llvm.loop !36

88:                                               ; preds = %85
  br i1 %83, label %82, label %89, !llvm.loop !37
...
90:                                               ; preds = %96, %89
  %91 = phi i1 [ true, %89 ], [ false, %96 ]
  %92 = phi i64 [ 0, %89 ], [ 8, %96 ]
  br label %93

93:                                               ; preds = %93, %90
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %93 ], [ 0, %90 ]
  %.idx85 = shl nuw nsw i64 %indvars.iv67, 8
  %94 = getelementptr inbounds nuw i8, ptr getelementptr inbounds nuw (i8, ptr @p, i64 22528), i64 %.idx85
  %95 = getelementptr inbounds nuw [4 x i8], ptr %94, i64 %92
  store i32 1, ptr %95, align 4
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond70.not = icmp eq i64 %indvars.iv.next68, 2
  br i1 %exitcond70.not, label %96, label %93, !llvm.loop !38

96:                                               ; preds = %93
  br i1 %91, label %90, label %97, !llvm.loop !39
...
98:                                               ; preds = %109, %97
  %99 = phi i1 [ true, %97 ], [ false, %109 ]
  %100 = phi i64 [ 0, %97 ], [ 1, %109 ]
  br label %101

101:                                              ; preds = %108, %98
  %102 = phi i1 [ true, %98 ], [ false, %108 ]
  %103 = phi i64 [ 0, %98 ], [ 8, %108 ]
  br label %104

104:                                              ; preds = %104, %101
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %104 ], [ 0, %101 ]
  %.idx86 = shl nuw nsw i64 %indvars.iv71, 8
  %105 = getelementptr inbounds nuw i8, ptr getelementptr inbounds nuw (i8, ptr @p, i64 24576), i64 %.idx86
  %106 = getelementptr inbounds nuw [4 x i8], ptr %105, i64 %103
  %107 = getelementptr inbounds nuw [4 x i8], ptr %106, i64 %100
  store i32 1, ptr %107, align 4
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond74.not = icmp eq i64 %indvars.iv.next72, 2
  br i1 %exitcond74.not, label %108, label %104, !llvm.loop !40

108:                                              ; preds = %104
  br i1 %102, label %101, label %109, !llvm.loop !41

109:                                              ; preds = %108
  br i1 %99, label %98, label %110, !llvm.loop !42
...
110:                                              ; preds = %109
  ...
  %111 = call i32 @Fit(i32 noundef 0, i32 noundef 73)
  %.not = icmp eq i32 %111, 0
  br i1 %.not, label %114, label %112

112:                                              ; preds = %110
  %113 = call i32 @Place(i32 noundef 0, i32 noundef 73)
  store i32 %113, ptr @n, align 4
  br label %115
...
115:                                              ; preds = %114, %112
  %116 = phi i32 [ %.pre, %114 ], [ %113, %112 ]
  %117 = call i32 @Trial(i32 noundef %116)
  %.not1 = icmp eq i32 %117, 0
  br i1 %.not1, label %118, label %119
...
122:                                              ; preds = %119, %121, %118
  %123 = load i32, ptr @n, align 4
  %124 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %123) #3
  %125 = load i32, ptr @kount, align 4
  %126 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %125) #3
  ret void
}
