...
32:                                               ; preds = %._crit_edge, %2
  ...
  br i1 %48, label %.lr.ph2, label %61
...
57:                                               ; preds = %56
  ...
  %60 = icmp slt i32 %58, 511
  br i1 %60, label %49, label %._crit_edge3, !llvm.loop !10

._crit_edge3:                                     ; preds = %57
  br label %61

61:                                               ; preds = %._crit_edge3, %32
  br label %62

62:                                               ; preds = %61, %54
  %storemerge = phi i32 [ %55, %54 ], [ 0, %61 ]
  ret i32 %storemerge
}
...
define dso_local i32 @Trial(i32 noundef %0) #0 {
  ...
  store i32 0, ptr %3, align 4
  br i1 true, label %.lr.ph, label %38
...
34:                                               ; preds = %33
  ...
  br i1 %37, label %7, label %._crit_edge, !llvm.loop !12
