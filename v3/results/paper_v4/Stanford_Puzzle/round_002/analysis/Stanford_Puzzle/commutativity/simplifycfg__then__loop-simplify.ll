...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %12
  %3 = phi i32 [ %13, %12 ], [ 0, %.lr.ph.preheader ]
  %4 = getelementptr inbounds [2048 x i8], ptr @p, i64 %.phi.trans.insert
  %5 = zext nneg i32 %3 to i64
  %6 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %5
  %7 = load i32, ptr %6, align 4
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %2
  ...
  br i1 %20, label %.lr.ph6.preheader, label %._crit_edge7

.lr.ph6.preheader:                                ; preds = %._crit_edge
  br label %.lr.ph6

.lr.ph6:                                          ; preds = %.lr.ph6.preheader, %25
  %21 = phi i32 [ %26, %25 ], [ %1, %.lr.ph6.preheader ]
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [4 x i8], ptr @puzzl, i64 %22
  %24 = load i32, ptr %23, align 4
  %.not2 = icmp eq i32 %24, 0
  br i1 %.not2, label %._crit_edge7.loopexit, label %25

25:                                               ; preds = %.lr.ph6
  %26 = add nsw i32 %21, 1
  %27 = icmp slt i32 %26, 512
  br i1 %27, label %.lr.ph6, label %._crit_edge7.loopexit, !llvm.loop !10

._crit_edge7.loopexit:                            ; preds = %.lr.ph6, %25
  %.ph = phi i32 [ 0, %25 ], [ %21, %.lr.ph6 ]
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7.loopexit, %._crit_edge
  %28 = phi i32 [ 0, %._crit_edge ], [ %.ph, %._crit_edge7.loopexit ]
  ret i32 %28
}
...
1:                                                ; preds = %1, %0
  ...
  br i1 %6, label %1, label %.preheader2, !llvm.loop !13

.preheader2:                                      ; preds = %1
  br label %7

7:                                                ; preds = %.preheader2, %24
  %8 = phi i32 [ %25, %24 ], [ 1, %.preheader2 ]
  br label %9
...
24:                                               ; preds = %21
  ...
  br i1 %26, label %7, label %.preheader1, !llvm.loop !16

.preheader1:                                      ; preds = %24
  br label %27

27:                                               ; preds = %.preheader1, %37
...
37:                                               ; preds = %29
  ...
  br i1 %39, label %27, label %.preheader, !llvm.loop !18

.preheader:                                       ; preds = %37
  br label %40

40:                                               ; preds = %.preheader, %50
  %41 = phi i32 [ %51, %50 ], [ 0, %.preheader ]
  br label %42

42:                                               ; preds = %42, %40
  %43 = phi i32 [ 0, %40 ], [ %48, %42 ]
...
149:                                              ; preds = %159, %148
  %150 = phi i32 [ 0, %148 ], [ %160, %159 ]
  br label %151

151:                                              ; preds = %151, %149
  %152 = phi i32 [ 0, %149 ], [ %157, %151 ]
...
192:                                              ; preds = %209, %191
  %193 = phi i32 [ 0, %191 ], [ %210, %209 ]
  br label %194

194:                                              ; preds = %206, %192
  %195 = phi i32 [ 0, %192 ], [ %207, %206 ]
  br label %196
