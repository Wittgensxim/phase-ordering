...
47:                                               ; preds = %._crit_edge, %45
  ...
  br i1 false, label %._crit_edge, label %52, !llvm.loop !19
...
62:                                               ; preds = %62, %61
  ...
  %69 = icmp samesign ult i32 %63, 3
  br i1 %69, label %62, label %70, !llvm.loop !22

70:                                               ; preds = %62
  br i1 false, label %._crit_edge1, label %71, !llvm.loop !23

._crit_edge1:                                     ; preds = %70
...
87:                                               ; preds = %78
  ...
  %89 = icmp samesign ult i32 %77, 3
  br i1 %89, label %76, label %90, !llvm.loop !26

90:                                               ; preds = %87
  br i1 false, label %._crit_edge2, label %91, !llvm.loop !27
...
96:                                               ; preds = %._crit_edge3, %94
  ...
  br i1 false, label %._crit_edge3, label %101, !llvm.loop !28
...
101:                                              ; preds = %96
  ...
  %103 = icmp samesign ult i32 %95, 3
...
119:                                              ; preds = %111
  br i1 false, label %._crit_edge4, label %120, !llvm.loop !32
...
120:                                              ; preds = %119
  ...
  %122 = icmp samesign ult i32 %109, 3
...
127:                                              ; preds = %127, %125
  ...
  %135 = icmp samesign ult i32 %128, 3
...
139:                                              ; preds = %136
  br i1 false, label %._crit_edge5, label %140, !llvm.loop !36

._crit_edge5:                                     ; preds = %139
...
143:                                              ; preds = %._crit_edge7, %141
  br label %144

144:                                              ; preds = %._crit_edge6, %143
  ...
  br i1 false, label %._crit_edge6, label %147, !llvm.loop !37

._crit_edge6:                                     ; preds = %144
  br label %144, !llvm.loop !37

147:                                              ; preds = %144
  br i1 false, label %._crit_edge7, label %148, !llvm.loop !38
...
148:                                              ; preds = %147
  ...
  %150 = icmp samesign ult i32 %142, 2
...
155:                                              ; preds = %._crit_edge8, %153
  ...
  br i1 false, label %._crit_edge8, label %159, !llvm.loop !40

._crit_edge8:                                     ; preds = %155
  br label %155, !llvm.loop !40

159:                                              ; preds = %155
  %160 = add nuw nsw i32 %154, 1
  %161 = icmp samesign ult i32 %154, 2
  br i1 %161, label %153, label %162, !llvm.loop !41

162:                                              ; preds = %159
  br i1 false, label %._crit_edge9, label %163, !llvm.loop !42
...
164:                                              ; preds = %._crit_edge11, %163
  br label %165

165:                                              ; preds = %._crit_edge10, %164
  br label %166
...
166:                                              ; preds = %166, %165
  ...
  %172 = icmp samesign ult i32 %167, 2
  br i1 %172, label %166, label %173, !llvm.loop !43

173:                                              ; preds = %166
  br i1 false, label %._crit_edge10, label %174, !llvm.loop !44

._crit_edge10:                                    ; preds = %173
  br label %165, !llvm.loop !44

174:                                              ; preds = %173
  br i1 false, label %._crit_edge11, label %175, !llvm.loop !45

._crit_edge11:                                    ; preds = %174
...
180:                                              ; preds = %._crit_edge12, %178
  ...
  br i1 false, label %._crit_edge12, label %185, !llvm.loop !46
...
203:                                              ; preds = %195
  br i1 false, label %._crit_edge13, label %204, !llvm.loop !50

._crit_edge13:                                    ; preds = %203
...
223:                                              ; preds = %220
  br i1 false, label %._crit_edge14, label %224, !llvm.loop !54

._crit_edge14:                                    ; preds = %223
