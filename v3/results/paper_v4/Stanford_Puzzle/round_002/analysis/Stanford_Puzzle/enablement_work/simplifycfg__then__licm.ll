...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %13
  %4 = phi i32 [ %14, %13 ], [ 0, %.lr.ph.preheader ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %12
  %4 = phi i32 [ %13, %12 ], [ 0, %.lr.ph.preheader ]
  %5 = zext nneg i32 %4 to i64
  %6 = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %5
  %7 = load i32, ptr %6, align 4
...
7:                                                ; preds = %.preheader2, %22
  %8 = phi i32 [ %23, %22 ], [ 1, %.preheader2 ]
  br label %9
...
22:                                               ; preds = %19
  ...
  br i1 %24, label %7, label %.preheader1, !llvm.loop !16

.preheader1:                                      ; preds = %22
  br label %25

25:                                               ; preds = %.preheader1, %35
  %26 = phi i32 [ %36, %35 ], [ 0, %.preheader1 ]
...
35:                                               ; preds = %29
  ...
  br i1 %37, label %25, label %.preheader, !llvm.loop !18

.preheader:                                       ; preds = %35
  br label %38

38:                                               ; preds = %.preheader, %48
  %39 = phi i32 [ %49, %48 ], [ 0, %.preheader ]
  br label %40
...
192:                                              ; preds = %202, %190
  ...
  %invariant.op3 = or disjoint i32 %194, %191
  br label %195

195:                                              ; preds = %195, %192
  %196 = phi i32 [ 0, %192 ], [ %200, %195 ]
  %197 = shl nuw nsw i32 %196, 6
  %.reass4 = or disjoint i32 %197, %invariant.op3
  %198 = zext nneg i32 %.reass4 to i64
