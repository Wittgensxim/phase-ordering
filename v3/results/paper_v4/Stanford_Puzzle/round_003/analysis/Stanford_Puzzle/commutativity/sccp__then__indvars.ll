...
4:                                                ; preds = %13, %3
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %13 ], [ 1, %3 ]
  br label %5

5:                                                ; preds = %12, %4
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %12 ], [ 1, %4 ]
  br label %6

6:                                                ; preds = %6, %5
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %6 ], [ 1, %5 ]
  %7 = shl nuw nsw i64 %indvars.iv7, 6
  %8 = shl nuw nsw i64 %indvars.iv11, 3
  %9 = or disjoint i64 %7, %8
  %10 = or disjoint i64 %indvars.iv15, %9
  %11 = getelementptr inbounds nuw [4 x i8], ptr @puzzl, i64 %10
  store i32 0, ptr %11, align 4
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond10 = icmp ne i64 %indvars.iv.next8, 6
  br i1 %exitcond10, label %6, label %12, !llvm.loop !14

12:                                               ; preds = %6
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond14 = icmp ne i64 %indvars.iv.next12, 6
  br i1 %exitcond14, label %5, label %13, !llvm.loop !15

13:                                               ; preds = %12
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond18 = icmp ne i64 %indvars.iv.next16, 6
  br i1 %exitcond18, label %4, label %14, !llvm.loop !16

14:                                               ; preds = %13
  br label %15

15:                                               ; preds = %19, %14
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %19 ], [ 0, %14 ]
  br label %16

16:                                               ; preds = %16, %15
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %16 ], [ 0, %15 ]
  %17 = getelementptr inbounds nuw [2048 x i8], ptr @p, i64 %indvars.iv23
  %18 = getelementptr inbounds nuw [4 x i8], ptr %17, i64 %indvars.iv19
  store i32 0, ptr %18, align 4
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond22 = icmp ne i64 %indvars.iv.next20, 512
  br i1 %exitcond22, label %16, label %19, !llvm.loop !17

19:                                               ; preds = %16
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond26 = icmp ne i64 %indvars.iv.next24, 13
  br i1 %exitcond26, label %15, label %20, !llvm.loop !18
...
30:                                               ; preds = %23
  ...
  %exitcond27 = icmp ne i32 %31, 4
  br i1 %exitcond27, label %21, label %32, !llvm.loop !20
...
36:                                               ; preds = %36, %33
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %36 ], [ 0, %33 ]
  %37 = shl nuw nsw i64 %indvars.iv28, 6
  ...
  br i1 %exitcond31, label %36, label %40, !llvm.loop !21
...
43:                                               ; preds = %49, %42
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %49 ], [ 0, %42 ]
  br label %44

44:                                               ; preds = %44, %43
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %44 ], [ 0, %43 ]
  %45 = shl nuw nsw i64 %indvars.iv32, 6
  %46 = shl nuw nsw i64 %indvars.iv36, 3
  %47 = or disjoint i64 %45, %46
  %48 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 4096), i64 %47
  store i32 1, ptr %48, align 4
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %exitcond35 = icmp ne i64 %indvars.iv.next33, 2
  br i1 %exitcond35, label %44, label %49, !llvm.loop !23

49:                                               ; preds = %44
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %exitcond39 = icmp ne i64 %indvars.iv.next37, 4
  br i1 %exitcond39, label %43, label %50, !llvm.loop !24
...
54:                                               ; preds = %54, %51
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %54 ], [ 0, %51 ]
  %55 = shl nuw nsw i64 %indvars.iv40, 3
  ...
  br i1 %exitcond43, label %54, label %58, !llvm.loop !25
...
61:                                               ; preds = %66, %60
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %66 ], [ 0, %60 ]
  br label %62

62:                                               ; preds = %62, %61
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %62 ], [ 0, %61 ]
  %63 = shl nuw nsw i64 %indvars.iv44, 6
  %64 = or disjoint i64 %indvars.iv48, %63
  %65 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 8192), i64 %64
  store i32 1, ptr %65, align 4
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond47 = icmp ne i64 %indvars.iv.next45, 2
  br i1 %exitcond47, label %62, label %66, !llvm.loop !27

66:                                               ; preds = %62
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %exitcond51 = icmp ne i64 %indvars.iv.next49, 4
  br i1 %exitcond51, label %61, label %67, !llvm.loop !28
...
70:                                               ; preds = %70, %68
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %70 ], [ 0, %68 ]
  %71 = shl nuw nsw i64 %indvars.iv52, 6
  ...
  %exitcond55 = icmp ne i64 %indvars.iv.next53, 4
  br i1 %exitcond55, label %70, label %76, !llvm.loop !29
...
79:                                               ; preds = %79, %78
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %79 ], [ 0, %78 ]
  %80 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 12288), i64 %indvars.iv56
  store i32 1, ptr %80, align 4
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond59 = icmp ne i64 %indvars.iv.next57, 3
  br i1 %exitcond59, label %79, label %81, !llvm.loop !31
...
82:                                               ; preds = %82, %81
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %82 ], [ 0, %81 ]
  %83 = shl nuw nsw i64 %indvars.iv60, 3
  %84 = getelementptr inbounds nuw [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @p, i64 14336), i64 %83
  store i32 1, ptr %84, align 4
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond63 = icmp ne i64 %indvars.iv.next61, 3
  br i1 %exitcond63, label %82, label %85, !llvm.loop !32
...
86:                                               ; preds = %86, %85
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %86 ], [ 0, %85 ]
  %87 = shl nuw nsw i64 %indvars.iv64, 6
  ...
  br i1 %exitcond67, label %86, label %89, !llvm.loop !33
...
105:                                              ; preds = %105, %102
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %105 ], [ 0, %102 ]
  %106 = shl nuw nsw i64 %indvars.iv68, 6
  ...
  br i1 %exitcond71, label %105, label %109, !llvm.loop !36
...
114:                                              ; preds = %114, %112
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %114 ], [ 0, %112 ]
  %115 = shl nuw nsw i64 %indvars.iv72, 6
  ...
  br i1 %exitcond75, label %114, label %120, !llvm.loop !38
...
128:                                              ; preds = %128, %126
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %128 ], [ 0, %126 ]
  %129 = shl nuw nsw i64 %indvars.iv76, 6
  ...
  %exitcond79 = icmp ne i64 %indvars.iv.next77, 2
  br i1 %exitcond79, label %128, label %135, !llvm.loop !40
