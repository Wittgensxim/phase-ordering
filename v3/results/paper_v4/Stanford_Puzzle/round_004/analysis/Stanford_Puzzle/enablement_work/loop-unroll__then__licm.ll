...
7:                                                ; preds = %25, %.lr.ph.new
  %8 = phi i32 [ 0, %.lr.ph.new ], [ %26, %25 ]
...
113:                                              ; preds = %113, %103
  %114 = phi i32 [ 0, %103 ], [ %126, %113 ]
  %115 = zext nneg i32 %114 to i64
  %116 = getelementptr inbounds nuw [4 x i8], ptr %106, i64 %115
  ...
  %122 = getelementptr inbounds nuw [4 x i8], ptr %110, i64 %121
  ...
  br i1 %127, label %113, label %128, !llvm.loop !15
