...
40:                                               ; preds = %66, %0
  ...
  %42 = phi double [ %57, %66 ], [ %.promoted5, %0 ]
...
47:                                               ; preds = %40
  ...
  %52 = call double @llvm.fmuladd.f64(double %51, double %50, double %28)
  %53 = call double @llvm.fmuladd.f64(double %52, double %50, double %29)
  %54 = call double @llvm.fmuladd.f64(double %53, double %50, double %30)
  %55 = call double @llvm.fmuladd.f64(double %54, double %50, double %31)
  %56 = call double @llvm.fmuladd.f64(double %55, double %50, double %32)
  %57 = fmul double %49, %56
  %58 = call double @llvm.fmuladd.f64(double %33, double %50, double %34)
  %59 = call double @llvm.fmuladd.f64(double %50, double %58, double %35)
  %60 = call double @llvm.fmuladd.f64(double %50, double %59, double %36)
  %61 = call double @llvm.fmuladd.f64(double %50, double %60, double %37)
  %62 = call double @llvm.fmuladd.f64(double %50, double %61, double %38)
  %63 = call double @llvm.fmuladd.f64(double %50, double %62, double %39)
...
68:                                               ; preds = %40
  ...
  %105 = load double, ptr @two, align 8
  ...
  %111 = fsub double %110, f0x3FE62E42FEFA39EF
