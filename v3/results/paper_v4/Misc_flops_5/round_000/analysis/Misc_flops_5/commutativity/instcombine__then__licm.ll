...
define dso_local i32 @main() #0 {
  ...
  %.promoted3 = load double, ptr %1, align 8
  br label %30

30:                                               ; preds = %52, %0
  %31 = phi double [ %.promoted3, %0 ], [ %51, %52 ]
  %32 = phi double [ %.promoted, %0 ], [ %36, %52 ]
  %storemerge = phi i32 [ 1, %0 ], [ %53, %52 ]
  %.not.not = icmp slt i32 %storemerge, %14
  br i1 %.not.not, label %33, label %54

33:                                               ; preds = %30
  %34 = sitofp i32 %storemerge to double
  %35 = fmul double %15, %34
  %36 = fmul double %35, %35
  %37 = call double @llvm.fmuladd.f64(double %16, double %36, double %17)
  %38 = call double @llvm.fmuladd.f64(double %37, double %36, double %18)
  %39 = call double @llvm.fmuladd.f64(double %38, double %36, double %19)
  %40 = call double @llvm.fmuladd.f64(double %39, double %36, double %20)
  %41 = call double @llvm.fmuladd.f64(double %40, double %36, double %21)
  %42 = call double @llvm.fmuladd.f64(double %41, double %36, double %22)
  %43 = fmul double %35, %42
  %44 = call double @llvm.fmuladd.f64(double %23, double %36, double %24)
  %45 = call double @llvm.fmuladd.f64(double %36, double %44, double %25)
  %46 = call double @llvm.fmuladd.f64(double %36, double %45, double %26)
  %47 = call double @llvm.fmuladd.f64(double %36, double %46, double %27)
  %48 = call double @llvm.fmuladd.f64(double %36, double %47, double %28)
  %49 = call double @llvm.fmuladd.f64(double %36, double %48, double %29)
  %50 = fdiv double %43, %49
  %51 = fadd double %31, %50
  br label %52

52:                                               ; preds = %33
  %53 = add nsw i32 %storemerge, 1
  br label %30, !llvm.loop !7

54:                                               ; preds = %30
  %.lcssa4 = phi double [ %31, %30 ]
  %.lcssa = phi double [ %32, %30 ]
  %storemerge.lcssa = phi i32 [ %storemerge, %30 ]
  store i32 %storemerge.lcssa, ptr %5, align 4
  store double %.lcssa, ptr %2, align 8
  store double %.lcssa4, ptr %1, align 8
  %55 = load double, ptr @piref, align 8
  %56 = load double, ptr @three, align 8
  ...
  %70 = call double @llvm.fmuladd.f64(double %68, double %66, double %69)
  %71 = load double, ptr @one, align 8
  %72 = call double @llvm.fmuladd.f64(double %70, double %66, double %71)
  %73 = fmul double %57, %72
  store double %73, ptr @sa, align 8
  %74 = load double, ptr %2, align 8
  %75 = load double, ptr @B6, align 8
  %76 = load double, ptr @B5, align 8
  %77 = call double @llvm.fmuladd.f64(double %75, double %74, double %76)
  %78 = load double, ptr @B4, align 8
  %79 = call double @llvm.fmuladd.f64(double %74, double %77, double %78)
  %80 = load double, ptr @B3, align 8
  %81 = call double @llvm.fmuladd.f64(double %74, double %79, double %80)
  %82 = load double, ptr @B2, align 8
  %83 = call double @llvm.fmuladd.f64(double %74, double %81, double %82)
  %84 = load double, ptr @B1, align 8
  %85 = call double @llvm.fmuladd.f64(double %74, double %83, double %84)
  %86 = load double, ptr @one, align 8
  %87 = call double @llvm.fmuladd.f64(double %74, double %85, double %86)
  ...
  %93 = call double @llvm.fmuladd.f64(double %91, double %92, double %89)
  %94 = fmul double %90, %93
  %95 = fdiv double %94, %91
  store double %95, ptr @sa, align 8
  store double f0x3FE62E42FEFA39EF, ptr @sb, align 8
  %96 = fadd double %95, f0xBFE62E42FEFA39EF
  store double %96, ptr @sc, align 8
  %97 = fmul double %96, 1.000000e-30
  %98 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %97, double noundef 0.000000e+00, double noundef 0.000000e+00) #4
  ret i32 0
}
