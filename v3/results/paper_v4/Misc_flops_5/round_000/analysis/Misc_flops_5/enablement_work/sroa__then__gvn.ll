...
9:                                                ; preds = %11, %0
  %.040 = phi i32 [ 1, %0 ], [ %43, %11 ]
  %.0 = phi double [ 0.000000e+00, %0 ], [ %42, %11 ]
...
11:                                               ; preds = %9
  ...
  %41 = fdiv double %28, %40
  %42 = fadd double %.0, %41
  %43 = add nsw i32 %.040, 1
