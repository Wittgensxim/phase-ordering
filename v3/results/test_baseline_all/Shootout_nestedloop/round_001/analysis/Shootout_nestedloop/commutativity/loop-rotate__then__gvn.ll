; ModuleID = 'results\test_baseline_all\Shootout_nestedloop\round_000\output.ll'
...
12:                                               ; preds = %.lr.ph23, %45
  ...
  br i1 true, label %.lr.ph19, label %._crit_edge26

._crit_edge26:                                    ; preds = %12
  br label %45
...
15:                                               ; preds = %.lr.ph19, %42
  ...
  br i1 true, label %.lr.ph15, label %._crit_edge27

._crit_edge27:                                    ; preds = %15
  br label %42
...
18:                                               ; preds = %.lr.ph15, %39
  ...
  br i1 true, label %.lr.ph11, label %._crit_edge28

._crit_edge28:                                    ; preds = %18
  br label %39
...
21:                                               ; preds = %.lr.ph11, %36
  ...
  br i1 true, label %.lr.ph7, label %._crit_edge29
...
24:                                               ; preds = %.lr.ph7, %33
  ...
  br i1 true, label %.lr.ph, label %._crit_edge30

._crit_edge30:                                    ; preds = %24
  br label %33
...
33:                                               ; preds = %._crit_edge30, %._crit_edge
  %.lcssa = phi i32 [ %30, %._crit_edge ], [ poison, %._crit_edge30 ]
...
36:                                               ; preds = %._crit_edge29, %._crit_edge8
  %.lcssa1 = phi i32 [ %.lcssa, %._crit_edge8 ], [ poison, %._crit_edge29 ]
...
39:                                               ; preds = %._crit_edge28, %._crit_edge12
  %.lcssa2 = phi i32 [ %.lcssa1, %._crit_edge12 ], [ poison, %._crit_edge28 ]
...
42:                                               ; preds = %._crit_edge27, %._crit_edge16
  %.lcssa3 = phi i32 [ %.lcssa2, %._crit_edge16 ], [ poison, %._crit_edge27 ]
...
45:                                               ; preds = %._crit_edge26, %._crit_edge20
  %.lcssa4 = phi i32 [ %.lcssa3, %._crit_edge20 ], [ poison, %._crit_edge26 ]
