...
33:                                               ; preds = %._crit_edge, %24
  %.lcssa = phi i32 [ %30, %._crit_edge ], [ poison, %24 ]
...
36:                                               ; preds = %._crit_edge8, %21
  %.lcssa1 = phi i32 [ %.lcssa, %._crit_edge8 ], [ poison, %21 ]
...
39:                                               ; preds = %._crit_edge12, %18
  %.lcssa2 = phi i32 [ %.lcssa1, %._crit_edge12 ], [ poison, %18 ]
...
42:                                               ; preds = %._crit_edge16, %15
  %.lcssa3 = phi i32 [ %.lcssa2, %._crit_edge16 ], [ poison, %15 ]
...
45:                                               ; preds = %._crit_edge20, %12
  %.lcssa4 = phi i32 [ %.lcssa3, %._crit_edge20 ], [ poison, %12 ]
