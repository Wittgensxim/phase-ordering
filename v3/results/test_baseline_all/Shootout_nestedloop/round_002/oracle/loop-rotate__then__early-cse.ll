...
27:                                               ; preds = %._crit_edge, %.preheader
  %.lcssa = phi i32 [ %24, %._crit_edge ], [ %19, %.preheader ]
...
30:                                               ; preds = %._crit_edge10, %.preheader1
  %.lcssa5 = phi i32 [ %.lcssa, %._crit_edge10 ], [ %17, %.preheader1 ]
...
33:                                               ; preds = %._crit_edge12, %.preheader2
  %.lcssa6 = phi i32 [ %.lcssa5, %._crit_edge12 ], [ %15, %.preheader2 ]
...
36:                                               ; preds = %._crit_edge14, %.preheader3
  %.lcssa7 = phi i32 [ %.lcssa6, %._crit_edge14 ], [ %13, %.preheader3 ]
...
39:                                               ; preds = %._crit_edge16, %.preheader4
  %.lcssa8 = phi i32 [ %.lcssa7, %._crit_edge16 ], [ %12, %.preheader4 ]
