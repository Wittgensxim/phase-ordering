...
.preheader4:                                      ; preds = %.preheader4.lr.ph, %39
  ...
  %12 = phi i32 [ 0, %.preheader4.lr.ph ], [ %split17, %39 ]
...
.preheader3:                                      ; preds = %.preheader3.lr.ph, %36
  %13 = phi i32 [ %12, %.preheader3.lr.ph ], [ %split15, %36 ]
...
.preheader2:                                      ; preds = %.preheader2.lr.ph, %33
  %15 = phi i32 [ %13, %.preheader2.lr.ph ], [ %split13, %33 ]
  %16 = phi i32 [ 0, %.preheader2.lr.ph ], [ %34, %33 ]
  br label %.preheader1.lr.ph

.preheader1.lr.ph:                                ; preds = %.preheader2
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader1.lr.ph, %30
  %17 = phi i32 [ %15, %.preheader1.lr.ph ], [ %split11, %30 ]
...
.preheader:                                       ; preds = %.preheader.lr.ph, %27
  %19 = phi i32 [ %17, %.preheader.lr.ph ], [ %split, %27 ]
...
._crit_edge10:                                    ; preds = %27
  %split11 = phi i32 [ %split, %27 ]
  br label %30

30:                                               ; preds = %._crit_edge10
...
._crit_edge12:                                    ; preds = %30
  %split13 = phi i32 [ %split11, %30 ]
  br label %33

33:                                               ; preds = %._crit_edge12
...
._crit_edge14:                                    ; preds = %33
  %split15 = phi i32 [ %split13, %33 ]
  br label %36

36:                                               ; preds = %._crit_edge14
...
._crit_edge16:                                    ; preds = %36
  %split17 = phi i32 [ %split15, %36 ]
  br label %39

39:                                               ; preds = %._crit_edge16
