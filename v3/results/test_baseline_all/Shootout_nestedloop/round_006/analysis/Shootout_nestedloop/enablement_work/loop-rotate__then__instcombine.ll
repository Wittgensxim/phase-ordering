...
.preheader4.preheader:                            ; preds = %.preheader4.preheader.lr.ph, %34
  ...
  br i1 true, label %.preheader3.preheader.lr.ph, label %34
...
.preheader3.preheader:                            ; preds = %.preheader3.preheader.lr.ph, %.preheader4
  ...
  br i1 true, label %.preheader2.preheader.lr.ph, label %.preheader4
...
.preheader2.preheader:                            ; preds = %.preheader2.preheader.lr.ph, %.preheader3
  ...
  br i1 true, label %.preheader1.preheader.lr.ph, label %.preheader3
...
.preheader1.preheader:                            ; preds = %.preheader1.preheader.lr.ph, %.preheader2
  ...
  br i1 true, label %.preheader.preheader.lr.ph, label %.preheader2
...
.preheader.preheader:                             ; preds = %.preheader.preheader.lr.ph, %.preheader1
  ...
  br i1 true, label %.lr.ph, label %.preheader1
...
.preheader1:                                      ; preds = %.preheader._crit_edge, %.preheader.preheader
  %.lcssa = phi i32 [ %23, %.preheader._crit_edge ], [ poison, %.preheader.preheader ]
...
.preheader2:                                      ; preds = %.preheader1._crit_edge, %.preheader1.preheader
  %.lcssa1 = phi i32 [ %.lcssa, %.preheader1._crit_edge ], [ poison, %.preheader1.preheader ]
...
.preheader3:                                      ; preds = %.preheader2._crit_edge, %.preheader2.preheader
  %.lcssa2 = phi i32 [ %.lcssa1, %.preheader2._crit_edge ], [ poison, %.preheader2.preheader ]
...
.preheader4:                                      ; preds = %.preheader3._crit_edge, %.preheader3.preheader
  %.lcssa3 = phi i32 [ %.lcssa2, %.preheader3._crit_edge ], [ poison, %.preheader3.preheader ]
...
34:                                               ; preds = %.preheader4._crit_edge, %.preheader4.preheader
  %.lcssa4 = phi i32 [ %.lcssa3, %.preheader4._crit_edge ], [ poison, %.preheader4.preheader ]
