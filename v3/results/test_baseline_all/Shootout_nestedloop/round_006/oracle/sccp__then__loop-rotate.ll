...
.preheader4.preheader:                            ; preds = %.preheader4.preheader.lr.ph, %39
  ...
  %12 = phi i32 [ 0, %.preheader4.preheader.lr.ph ], [ %.lcssa10, %39 ]
  %13 = icmp slt i32 0, %9
...
.preheader3.preheader:                            ; preds = %.preheader3.preheader.lr.ph, %.preheader4
  %14 = phi i32 [ %12, %.preheader3.preheader.lr.ph ], [ %.lcssa9, %.preheader4 ]
...
.preheader2.preheader:                            ; preds = %.preheader2.preheader.lr.ph, %.preheader3
  %17 = phi i32 [ %14, %.preheader2.preheader.lr.ph ], [ %.lcssa8, %.preheader3 ]
...
.preheader1.preheader:                            ; preds = %.preheader1.preheader.lr.ph, %.preheader2
  %20 = phi i32 [ %17, %.preheader1.preheader.lr.ph ], [ %.lcssa7, %.preheader2 ]
...
.preheader1._crit_edge:                           ; preds = %.preheader1
  %split12 = phi i32 [ %.lcssa, %.preheader1 ]
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader1._crit_edge, %.preheader1.preheader
  %.lcssa7 = phi i32 [ %split12, %.preheader1._crit_edge ], [ %20, %.preheader1.preheader ]
...
.preheader2._crit_edge:                           ; preds = %.preheader2
  %split13 = phi i32 [ %.lcssa7, %.preheader2 ]
  br label %.preheader3

.preheader3:                                      ; preds = %.preheader2._crit_edge, %.preheader2.preheader
  %.lcssa8 = phi i32 [ %split13, %.preheader2._crit_edge ], [ %17, %.preheader2.preheader ]
...
.preheader3._crit_edge:                           ; preds = %.preheader3
  %split14 = phi i32 [ %.lcssa8, %.preheader3 ]
  br label %.preheader4

.preheader4:                                      ; preds = %.preheader3._crit_edge, %.preheader3.preheader
  %.lcssa9 = phi i32 [ %split14, %.preheader3._crit_edge ], [ %14, %.preheader3.preheader ]
...
.preheader4._crit_edge:                           ; preds = %.preheader4
  %split15 = phi i32 [ %.lcssa9, %.preheader4 ]
  br label %39

39:                                               ; preds = %.preheader4._crit_edge, %.preheader4.preheader
  %.lcssa10 = phi i32 [ %split15, %.preheader4._crit_edge ], [ %12, %.preheader4.preheader ]
  %40 = add nuw nsw i32 %11, 1
  %41 = icmp slt i32 %40, %9
  br i1 %41, label %.preheader4.preheader, label %._crit_edge, !llvm.loop !13

._crit_edge:                                      ; preds = %39
  %split16 = phi i32 [ %.lcssa10, %39 ]
  br label %42

42:                                               ; preds = %._crit_edge, %8
  %.lcssa11 = phi i32 [ %split16, %._crit_edge ], [ 0, %8 ]
  %43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %.lcssa11) #2
  ret i32 0
}
