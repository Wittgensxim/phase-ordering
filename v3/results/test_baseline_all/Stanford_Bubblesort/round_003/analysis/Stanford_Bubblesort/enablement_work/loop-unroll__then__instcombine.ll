...
5:                                                ; preds = %26, %.new
  %6 = phi i32 [ %.pre, %.new ], [ %27, %26 ]
  %7 = phi i32 [ 1, %.new ], [ %18, %26 ]
...
28:                                               ; preds = %.epil.preheader
  %29 = sext i32 %.epil.init2 to i64
  %30 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %29
  %31 = getelementptr inbounds nuw i8, ptr %30, i64 4
  %32 = load i32, ptr %31, align 4
  %33 = icmp sgt i32 %.epil.init, %32
  br i1 %33, label %34, label %.epilog-lcssa

34:                                               ; preds = %28
  %35 = zext nneg i32 %.epil.init2 to i64
  %36 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %35
  store i32 %32, ptr %36, align 4
  store i32 %.epil.init, ptr %31, align 4
  br label %.epilog-lcssa

.epilog-lcssa:                                    ; preds = %34, %28
  br label %37
