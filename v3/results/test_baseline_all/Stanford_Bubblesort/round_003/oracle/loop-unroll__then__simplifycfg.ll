...
2:                                                ; preds = %.epilog-lcssa, %1
  ...
  %storemerge1 = phi i32 [ 500, %1 ], [ %38, %.epilog-lcssa ]
...
7:                                                ; preds = %28, %.new
  %8 = phi i32 [ %.pre, %.new ], [ %29, %28 ]
  %9 = phi i32 [ 1, %.new ], [ %20, %28 ]
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %2
  ...
  %.epil.init2 = phi i32 [ 1, %2 ], [ %.unr1, %.unr-lcssa ]
  ...
  br i1 %34, label %35, label %.epilog-lcssa
...
.epilog-lcssa:                                    ; preds = %.epil.preheader, %35, %.unr-lcssa
