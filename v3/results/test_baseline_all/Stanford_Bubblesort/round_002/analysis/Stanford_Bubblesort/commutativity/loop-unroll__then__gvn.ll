...
2:                                                ; preds = %37, %1
  ...
  %storemerge1 = phi i32 [ 500, %1 ], [ %38, %37 ]
...
.unr-lcssa:                                       ; preds = %26
  ...
  br i1 %lcmp.mod, label %.epil.preheader, label %37

.epil.preheader:                                  ; preds = %..epil.preheader_crit_edge, %.unr-lcssa
  %28 = phi i32 [ %.pre2, %..epil.preheader_crit_edge ], [ %27, %.unr-lcssa ]
  %.epil.init = phi i32 [ 1, %..epil.preheader_crit_edge ], [ %20, %.unr-lcssa ]
  ...
  %31 = add nuw nsw i32 %.epil.init, 1
...
.epilog-lcssa:                                    ; preds = %36, %.epil.preheader
  br label %37
