...
18:                                               ; preds = %17, %7
  %19 = phi i32 [ %8, %17 ], [ %15, %7 ]
  %20 = zext nneg i32 %12 to i64
  %21 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %20
...
30:                                               ; preds = %.epil.preheader
  %31 = zext nneg i32 %.epil.init2 to i64
