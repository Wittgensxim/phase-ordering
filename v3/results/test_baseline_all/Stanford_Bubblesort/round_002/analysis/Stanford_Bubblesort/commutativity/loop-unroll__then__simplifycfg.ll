; ModuleID = 'results\test_baseline_all\Stanford_Bubblesort\round_001\output.ll'
...
15:                                               ; preds = %11, %14, %10
  ...
  %17 = icmp samesign ult i32 %16, 501
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %2
  ...
  %32 = add nuw nsw i32 %.epil.init, 1
  %33 = zext nneg i32 %32 to i64
  %34 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %33
  %35 = load i32, ptr %34, align 4
  %36 = icmp sgt i32 %31, %35
  br i1 %36, label %37, label %.epilog-lcssa

37:                                               ; preds = %.epil.preheader
  store i32 %35, ptr %30, align 4
  store i32 %31, ptr %34, align 4
  br label %.epilog-lcssa

.epilog-lcssa:                                    ; preds = %.epil.preheader, %37, %.unr-lcssa
