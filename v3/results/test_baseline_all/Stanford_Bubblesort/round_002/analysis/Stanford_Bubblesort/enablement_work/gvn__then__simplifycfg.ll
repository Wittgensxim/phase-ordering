...
14:                                               ; preds = %13, %3
  %15 = phi i32 [ %4, %13 ], [ %11, %3 ]
  %16 = icmp slt i32 %8, %storemerge1
...
17:                                               ; preds = %14
  ...
  br i1 %19, label %2, label %20, !llvm.loop !10

20:                                               ; preds = %17
  %21 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 4), align 4
