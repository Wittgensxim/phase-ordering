...
15:                                               ; preds = %11, %14, %10
  ...
  %17 = icmp samesign ult i32 %2, 500
  br i1 %17, label %1, label %18, !llvm.loop !7
...
2:                                                ; preds = %.epilog-lcssa, %1
  %indvar = phi i32 [ %indvar.next, %.epilog-lcssa ], [ 0, %1 ]
  %storemerge1 = phi i32 [ %34, %.epilog-lcssa ], [ 500, %1 ]
...
.epilog-lcssa:                                    ; preds = %.epil.preheader, %31, %.unr-lcssa
  %34 = add nsw i32 %storemerge1, -1
  store i32 %34, ptr @top, align 4
  %35 = icmp sgt i32 %storemerge1, 2
  %indvar.next = add i32 %indvar, 1
  br i1 %35, label %2, label %36, !llvm.loop !10

36:                                               ; preds = %.epilog-lcssa
...
43:                                               ; preds = %42, %39
  ...
  %48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %47) #4
  ret void
}
