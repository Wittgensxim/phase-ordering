...
2:                                                ; preds = %.epilog-lcssa, %1
  ...
  %storemerge1 = phi i32 [ 500, %1 ], [ %36, %.epilog-lcssa ]
...
.epilog-lcssa:                                    ; preds = %.epil.preheader, %33, %.unr-lcssa
  %36 = add nsw i32 %storemerge1, -1
  store i32 %36, ptr @top, align 4
  %37 = icmp sgt i32 %storemerge1, 2
  %indvar.next = add i32 %indvar, 1
  br i1 %37, label %2, label %38, !llvm.loop !10

38:                                               ; preds = %.epilog-lcssa
...
41:                                               ; preds = %38
  %42 = load i32, ptr getelementptr inbounds nuw (i8, ptr @sortlist, i64 2000), align 16
  %43 = load i32, ptr @biggest, align 4
  %.not1 = icmp eq i32 %42, %43
...
45:                                               ; preds = %44, %41
  ...
  %47 = getelementptr [4 x i8], ptr @sortlist, i64 %46
  %48 = getelementptr i8, ptr %47, i64 4
  %49 = load i32, ptr %48, align 4
  %50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %49) #4
  ret void
}
