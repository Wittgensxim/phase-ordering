; ModuleID = 'results\test_baseline_all\Stanford_Bubblesort\round_003\output.ll'
...
2:                                                ; preds = %34, %1
  %indvar = phi i32 [ %indvar.next, %34 ], [ 0, %1 ]
  %storemerge1 = phi i32 [ %35, %34 ], [ 500, %1 ]
...
5:                                                ; preds = %24, %.new
  %6 = phi i32 [ %.pre, %.new ], [ %25, %24 ]
  %7 = phi i32 [ 1, %.new ], [ %18, %24 ]
  %niter = phi i32 [ 0, %.new ], [ %niter.next.1, %24 ]
...
13:                                               ; preds = %5
  ...
  %15 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %14
  store i32 %11, ptr %15, align 4
  store i32 %6, ptr %10, align 4
  br label %16

16:                                               ; preds = %13, %5
  %17 = phi i32 [ %6, %13 ], [ %11, %5 ]
...
.unr-lcssa:                                       ; preds = %24
  ...
  br i1 %lcmp.mod.not, label %34, label %.epil.preheader

.epil.preheader:                                  ; preds = %.unr-lcssa, %2
  %.epil.init = phi i32 [ %.pre, %2 ], [ %25, %.unr-lcssa ]
  %.epil.init2 = phi i32 [ 1, %2 ], [ %18, %.unr-lcssa ]
  %lcmp.mod3 = trunc i32 %3 to i1
  call void @llvm.assume(i1 %lcmp.mod3)
  %26 = sext i32 %.epil.init2 to i64
  %27 = getelementptr inbounds nuw [4 x i8], ptr @sortlist, i64 %26
  %28 = getelementptr inbounds nuw i8, ptr %27, i64 4
  %29 = load i32, ptr %28, align 4
  %30 = icmp sgt i32 %.epil.init, %29
  br i1 %30, label %31, label %.epilog-lcssa
...
.epilog-lcssa:                                    ; preds = %31, %.epil.preheader
  br label %34

34:                                               ; preds = %.epilog-lcssa, %.unr-lcssa
  %35 = add nsw i32 %storemerge1, -1
  store i32 %35, ptr @top, align 4
  %36 = icmp sgt i32 %storemerge1, 2
  %indvar.next = add i32 %indvar, 1
  br i1 %36, label %2, label %37, !llvm.loop !10
