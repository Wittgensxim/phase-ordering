; ModuleID = 'results\test_baseline_all\Stanford_Bubblesort\round_005\output.ll'
...
2:                                                ; preds = %.epilog-lcssa, %1
  ...
  %storemerge1 = phi i32 [ %32, %.epilog-lcssa ], [ 500, %1 ]
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %2
  %.epil.init = phi i32 [ %.pre, %2 ], [ %23, %.unr-lcssa ]
  %.epil.init2 = phi i32 [ 1, %2 ], [ %16, %.unr-lcssa ]
...
.epilog-lcssa:                                    ; preds = %29, %.epil.preheader, %.unr-lcssa
  %32 = add nsw i32 %storemerge1, -1
  store i32 %32, ptr @top, align 4
  %33 = icmp sgt i32 %storemerge1, 2
  %indvar.next = add i32 %indvar, 1
  br i1 %33, label %2, label %34, !llvm.loop !10

34:                                               ; preds = %.epilog-lcssa
...
41:                                               ; preds = %40, %37
  ...
  %46 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %45) #4
  ret void
}
