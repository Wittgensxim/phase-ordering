; ModuleID = 'results\test_baseline_all\Stanford_Quicksort\round_004\output.ll'
...
21:                                               ; preds = %.preheader
  ...
  %.lcssa5 = phi ptr [ %17, %.preheader ]
  %.lcssa4 = phi i32 [ %18, %.preheader ]
  %.lcssa3 = phi i32 [ %20, %.preheader ]
...
23:                                               ; preds = %22, %21
  %.239 = phi i32 [ %.lcssa3, %22 ], [ %.138.lcssa, %21 ]
