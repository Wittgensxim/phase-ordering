...
23:                                               ; preds = %17
  ...
  %.lcssa10 = phi ptr [ %19, %17 ]
  %.lcssa9 = phi i32 [ %20, %17 ]
  %.lcssa8 = phi i32 [ %22, %17 ]
  %24 = icmp sle i32 %.1.lcssa, %.138.lcssa
  br i1 %24, label %25, label %26

25:                                               ; preds = %23
  store i32 %.lcssa9, ptr %.lcssa7, align 4
  store i32 %.lcssa6, ptr %.lcssa10, align 4
  br label %26

26:                                               ; preds = %25, %23
  %.239 = phi i32 [ %.lcssa8, %25 ], [ %.138.lcssa, %23 ]
  %.2 = phi i32 [ %.lcssa, %25 ], [ %.1.lcssa, %23 ]
  %27 = icmp sle i32 %.2, %.239
  br i1 %27, label %9, label %28, !llvm.loop !11

28:                                               ; preds = %26
  %.239.lcssa = phi i32 [ %.239, %26 ]
  %.2.lcssa = phi i32 [ %.2, %26 ]
  %29 = icmp slt i32 %1, %.239.lcssa
