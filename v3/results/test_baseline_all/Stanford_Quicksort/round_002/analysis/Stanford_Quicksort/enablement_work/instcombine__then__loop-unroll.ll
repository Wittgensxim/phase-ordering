; ModuleID = 'results\test_baseline_all\Stanford_Quicksort\round_001\output.ll'
...
23:                                               ; preds = %17
  ...
  %.lcssa6 = phi ptr [ %19, %17 ]
  %.lcssa5 = phi i32 [ %20, %17 ]
  %.lcssa4 = phi i32 [ %22, %17 ]
  %.not = icmp sgt i32 %.1.lcssa, %.138.lcssa
...
25:                                               ; preds = %24, %23
  %.239 = phi i32 [ %.lcssa4, %24 ], [ %.138.lcssa, %23 ]
  %.2 = phi i32 [ %.lcssa, %24 ], [ %.1.lcssa, %23 ]
  %.not1 = icmp sgt i32 %.2, %.239
  br i1 %.not1, label %26, label %9, !llvm.loop !11

26:                                               ; preds = %25
  %.239.lcssa = phi i32 [ %.239, %25 ]
  %.2.lcssa = phi i32 [ %.2, %25 ]
  %27 = icmp slt i32 %1, %.239.lcssa
