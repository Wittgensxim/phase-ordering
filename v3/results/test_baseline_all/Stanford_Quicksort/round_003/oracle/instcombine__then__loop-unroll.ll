...
22:                                               ; preds = %16
  ...
  %.lcssa6 = phi ptr [ %18, %16 ]
  %.lcssa5 = phi i32 [ %19, %16 ]
  %.lcssa4 = phi i32 [ %21, %16 ]
...
24:                                               ; preds = %23, %22
  %.239 = phi i32 [ %.lcssa4, %23 ], [ %.138.lcssa, %22 ]
  %.2 = phi i32 [ %.lcssa, %23 ], [ %.1.lcssa, %22 ]
  %.not1 = icmp sgt i32 %.2, %.239
  br i1 %.not1, label %25, label %9, !llvm.loop !11

25:                                               ; preds = %24
  %.239.lcssa = phi i32 [ %.239, %24 ]
  %.2.lcssa = phi i32 [ %.2, %24 ]
  %26 = icmp slt i32 %1, %.239.lcssa
