; ModuleID = 'results\test_baseline_all\Stanford_Quicksort\round_002\output.ll'
...
.preheader:                                       ; preds = %10
  ...
  %.lcssa5 = phi ptr [ %12, %10 ]
  %.lcssa4 = phi i32 [ %13, %10 ]
  %.lcssa = phi i32 [ %15, %10 ]
  br label %16

16:                                               ; preds = %.preheader, %16
  %.138 = phi i32 [ %21, %16 ], [ %.037, %.preheader ]
...
22:                                               ; preds = %16
  ...
  %.lcssa6 = phi i32 [ %21, %16 ]
  %23 = icmp sle i32 %.1.lcssa, %.138.lcssa
  br i1 %23, label %24, label %25

24:                                               ; preds = %22
  store i32 %.lcssa7, ptr %.lcssa5, align 4
  store i32 %.lcssa4, ptr %.lcssa8, align 4
  br label %25

25:                                               ; preds = %24, %22
  %.239 = phi i32 [ %.lcssa6, %24 ], [ %.138.lcssa, %22 ]
  %.2 = phi i32 [ %.lcssa, %24 ], [ %.1.lcssa, %22 ]
  %26 = icmp sle i32 %.2, %.239
  br i1 %26, label %9, label %27, !llvm.loop !11

27:                                               ; preds = %25
  %.239.lcssa = phi i32 [ %.239, %25 ]
  %.2.lcssa = phi i32 [ %.2, %25 ]
  %28 = icmp slt i32 %1, %.239.lcssa
