...
13:                                               ; preds = %12, %9, %8
  ...
  %15 = icmp samesign ult i32 %.01, 5000
...
24:                                               ; preds = %23, %22
  %.239 = phi i32 [ %21, %23 ], [ %.138, %22 ]
  %.2 = phi i32 [ %15, %23 ], [ %.1, %22 ]
  %.not4 = icmp sgt i32 %.2, %.239
  br i1 %.not4, label %25, label %9, !llvm.loop !11

25:                                               ; preds = %24
  %26 = icmp slt i32 %1, %.239
