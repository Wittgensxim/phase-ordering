; ModuleID = 'results\test_baseline_all\Stanford_Quicksort\round_003\output.ll'
...
21:                                               ; preds = %.preheader
  %.138.lcssa = phi i32 [ %.138, %.preheader ]
  %.lcssa6 = phi ptr [ %17, %.preheader ]
  %.lcssa5 = phi i32 [ %18, %.preheader ]
  %.lcssa4 = phi i32 [ %20, %.preheader ]
...
23:                                               ; preds = %22, %21
  %.239 = phi i32 [ %.lcssa4, %22 ], [ %.138.lcssa, %21 ]
  %.2 = phi i32 [ %.lcssa, %22 ], [ %.1.lcssa, %21 ]
  %.not1 = icmp sgt i32 %.2, %.239
  br i1 %.not1, label %24, label %9, !llvm.loop !11

24:                                               ; preds = %23
  %.239.lcssa = phi i32 [ %.239, %23 ]
  %.2.lcssa = phi i32 [ %.2, %23 ]
  %25 = icmp slt i32 %1, %.239.lcssa
