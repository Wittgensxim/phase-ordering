...
21:                                               ; preds = %.preheader
  ...
  %.lcssa8 = phi ptr [ %17, %.preheader ]
  %.lcssa7 = phi i32 [ %18, %.preheader ]
  %.lcssa6 = phi i32 [ %20, %.preheader ]
  %22 = icmp sle i32 %.1.lcssa, %.138.lcssa
...
24:                                               ; preds = %23, %21
  %.239 = phi i32 [ %.lcssa6, %23 ], [ %.138.lcssa, %21 ]
  %.2 = phi i32 [ %.lcssa, %23 ], [ %.1.lcssa, %21 ]
