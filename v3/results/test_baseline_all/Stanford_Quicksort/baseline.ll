...
13:                                               ; preds = %8, %12, %9
  ...
  %15 = icmp samesign ult i32 %14, 5001
...
22:                                               ; preds = %16
  ...
  %.lcssa10 = phi ptr [ %18, %16 ]
  %.lcssa9 = phi i32 [ %19, %16 ]
  %.not = icmp sgt i32 %.12.lcssa, %.1.lcssa
  br i1 %.not, label %26, label %23

23:                                               ; preds = %22
  store i32 %.lcssa9, ptr %.lcssa8, align 4
  store i32 %.lcssa, ptr %.lcssa10, align 4
  %24 = add nsw i32 %.12.lcssa, 1
  %25 = add nsw i32 %.1.lcssa, -1
  br label %26

26:                                               ; preds = %22, %23
  %.23 = phi i32 [ %24, %23 ], [ %.12.lcssa, %22 ]
  %.2 = phi i32 [ %25, %23 ], [ %.1.lcssa, %22 ]
  %.not4 = icmp sgt i32 %.23, %.2
  br i1 %.not4, label %27, label %9, !llvm.loop !11

27:                                               ; preds = %26
  %.23.lcssa = phi i32 [ %.23, %26 ]
  %.2.lcssa = phi i32 [ %.2, %26 ]
  %28 = icmp slt i32 %1, %.2.lcssa
