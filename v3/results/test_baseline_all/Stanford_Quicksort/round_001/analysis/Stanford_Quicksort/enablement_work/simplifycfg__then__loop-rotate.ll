; ModuleID = 'results\test_baseline_all\Stanford_Quicksort\round_000\output.ll'
...
24:                                               ; preds = %22
  %25 = load i32, ptr %.lcssa, align 4
  store i32 %.lcssa1, ptr %.lcssa, align 4
  store i32 %25, ptr %.lcssa2, align 4
  %26 = add nsw i32 %.1.lcssa, 1
  %27 = sub nsw i32 %.138.lcssa, 1
  br label %28

28:                                               ; preds = %22, %24
  %.239 = phi i32 [ %27, %24 ], [ %.138.lcssa, %22 ]
  %.2 = phi i32 [ %26, %24 ], [ %.1.lcssa, %22 ]
  %29 = icmp sle i32 %.2, %.239
  br i1 %29, label %9, label %30, !llvm.loop !11

30:                                               ; preds = %28
  %.239.lcssa = phi i32 [ %.239, %28 ]
