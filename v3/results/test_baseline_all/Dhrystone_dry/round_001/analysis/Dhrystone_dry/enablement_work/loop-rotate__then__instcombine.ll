...
8:                                                ; preds = %7
  ...
  %10 = icmp samesign ult i32 %.01, 99999999
...
38:                                               ; preds = %._crit_edge, %22
  %.lcssa = phi i32 [ %36, %._crit_edge ], [ %27, %22 ]
  ...
  br i1 %44, label %.lr.ph4, label %57

.lr.ph4:                                          ; preds = %38
  br label %45

45:                                               ; preds = %.lr.ph4, %53
  %46 = phi i32 [ 65, %.lr.ph4 ], [ %55, %53 ]
  %.0142 = phi i8 [ 65, %.lr.ph4 ], [ %54, %53 ]
...
53:                                               ; preds = %52
  ...
  %.not7 = icmp sgt i8 %54, %56
  br i1 %.not7, label %._crit_edge5, label %45, !llvm.loop !10

._crit_edge5:                                     ; preds = %53
  br label %57

57:                                               ; preds = %._crit_edge5, %38
...
61:                                               ; preds = %57
  ...
  %63 = icmp samesign ult i32 %.16, 99999999
