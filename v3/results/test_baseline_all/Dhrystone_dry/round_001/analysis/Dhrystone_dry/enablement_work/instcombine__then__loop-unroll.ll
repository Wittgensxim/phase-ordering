...
47:                                               ; preds = %44
  ...
  %51 = call i32 @Proc7(i32 noundef %50, i32 noundef 3, ptr noundef nonnull %2)
...
59:                                               ; preds = %69, %54
  %.014 = phi i8 [ 65, %54 ], [ %70, %69 ]
  %60 = load i8, ptr @Char2Glob, align 1
  %.not1 = icmp sgt i8 %.014, %60
  br i1 %.not1, label %71, label %61

61:                                               ; preds = %59
  %62 = sext i8 %.014 to i32
...
32:                                               ; preds = %25
  ...
  %41 = getelementptr [204 x i8], ptr %1, i64 %40
  %42 = getelementptr i8, ptr %41, i64 5100
