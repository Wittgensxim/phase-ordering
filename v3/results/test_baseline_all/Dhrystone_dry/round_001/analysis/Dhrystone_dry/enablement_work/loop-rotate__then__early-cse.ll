...
46:                                               ; preds = %._crit_edge, %27
  %.lcssa = phi i32 [ %44, %._crit_edge ], [ %35, %27 ]
  ...
  br i1 %53, label %.lr.ph4, label %68

.lr.ph4:                                          ; preds = %46
  br label %54

54:                                               ; preds = %.lr.ph4, %62
  %55 = phi i32 [ 65, %.lr.ph4 ], [ %64, %62 ]
  %.0142 = phi i8 [ 65, %.lr.ph4 ], [ %63, %62 ]
...
62:                                               ; preds = %61
  ...
  br i1 %67, label %54, label %._crit_edge5, !llvm.loop !10

._crit_edge5:                                     ; preds = %62
  br label %68

68:                                               ; preds = %._crit_edge5, %46
...
75:                                               ; preds = %68
  ...
  br i1 %77, label %27, label %78, !llvm.loop !11
