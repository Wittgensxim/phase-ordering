...
41:                                               ; preds = %._crit_edge, %23
  %.lcssa = phi i32 [ %39, %._crit_edge ], [ %31, %23 ]
  ...
  br i1 %48, label %.lr.ph4, label %62

.lr.ph4:                                          ; preds = %41
  br label %49

49:                                               ; preds = %.lr.ph4, %56
  %50 = phi i32 [ 65, %.lr.ph4 ], [ %58, %56 ]
  %.0142 = phi i8 [ 65, %.lr.ph4 ], [ %57, %56 ]
...
56:                                               ; preds = %54, %49
  ...
  br i1 %61, label %49, label %._crit_edge5, !llvm.loop !10

._crit_edge5:                                     ; preds = %56
  br label %62

62:                                               ; preds = %._crit_edge5, %41
  ...
  br i1 %69, label %23, label %70, !llvm.loop !11
...
19:                                               ; preds = %18
  br i1 true, label %20, label %._crit_edge
