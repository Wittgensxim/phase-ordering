...
47:                                               ; preds = %._crit_edge, %27
  ...
  br i1 %54, label %.lr.ph7, label %69

.lr.ph7:                                          ; preds = %47
  br label %55

55:                                               ; preds = %.lr.ph7, %63
  %56 = phi i32 [ 65, %.lr.ph7 ], [ %65, %63 ]
  %.0145 = phi i8 [ 65, %.lr.ph7 ], [ %64, %63 ]
...
63:                                               ; preds = %62
  ...
  br i1 %68, label %55, label %._crit_edge8, !llvm.loop !10

._crit_edge8:                                     ; preds = %63
  br label %69

69:                                               ; preds = %._crit_edge8, %47
