...
26:                                               ; preds = %10, %._crit_edge5
  %.16 = phi i32 [ 0, %10 ], [ %71, %._crit_edge5 ]
  %27 = call i32 @Proc5()
  %28 = call i32 @Proc4()
...
.lr.ph:                                           ; preds = %26, %.lr.ph
  %36 = phi i32 [ %43, %.lr.ph ], [ %34, %26 ]
  %37 = mul nsw i32 5, %36
  %38 = sub nsw i32 %37, 3
  store i32 %38, ptr %2, align 4
  %39 = load i32, ptr %1, align 4
  %40 = call i32 @Proc7(i32 noundef %39, i32 noundef 3, ptr noundef %2)
...
._crit_edge:                                      ; preds = %.lr.ph, %26
  ...
  br i1 %51, label %.lr.ph4, label %._crit_edge5

.lr.ph4:                                          ; preds = %._crit_edge, %58
  %52 = phi i32 [ %60, %58 ], [ 65, %._crit_edge ]
  %.0142 = phi i8 [ %59, %58 ], [ 65, %._crit_edge ]
...
58:                                               ; preds = %.lr.ph4, %56
  ...
  br i1 %63, label %.lr.ph4, label %._crit_edge5, !llvm.loop !10

._crit_edge5:                                     ; preds = %58, %._crit_edge
  ...
  br i1 %72, label %26, label %73, !llvm.loop !11

73:                                               ; preds = %._crit_edge5
  ret i32 undef
}
...
16:                                               ; preds = %3
  %.012.lcssa = phi i32 [ %spec.select, %3 ]
