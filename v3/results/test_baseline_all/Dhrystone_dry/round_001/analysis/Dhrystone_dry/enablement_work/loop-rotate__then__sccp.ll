...
47:                                               ; preds = %._crit_edge, %27
  ...
  br i1 %54, label %.lr.ph4, label %69

.lr.ph4:                                          ; preds = %47
  br label %55

55:                                               ; preds = %.lr.ph4, %63
  %56 = phi i32 [ 65, %.lr.ph4 ], [ %65, %63 ]
  %.0142 = phi i8 [ 65, %.lr.ph4 ], [ %64, %63 ]
...
63:                                               ; preds = %62
  ...
  br i1 %68, label %55, label %._crit_edge5, !llvm.loop !10

._crit_edge5:                                     ; preds = %63
  br label %69

69:                                               ; preds = %._crit_edge5, %47
...
77:                                               ; preds = %69
  ...
  br i1 %79, label %27, label %80, !llvm.loop !11
